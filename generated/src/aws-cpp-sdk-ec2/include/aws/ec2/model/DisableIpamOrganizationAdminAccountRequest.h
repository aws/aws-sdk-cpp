...
class DisableIpamOrganizationAdminAccountRequest : public EC2Request {
 ...
 public:
  ...
  inline DisableIpamOrganizationAdminAccountRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename DelegatedAdminAccountIdT = Aws::String>
  DisableIpamOrganizationAdminAccountRequest& WithDelegatedAdminAccountId(DelegatedAdminAccountIdT&& value) {
