...
class DescribeClientVpnRoutesRequest : public EC2Request {
 public:
  AWS_EC2_API DescribeClientVpnRoutesRequest() = default;
 ...
 public:
  ...
  inline DescribeClientVpnRoutesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeClientVpnRoutesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
