...
class GetReservedInstancesExchangeQuoteRequest : public EC2Request {
 ...
 public:
  ...
  inline GetReservedInstancesExchangeQuoteRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReservedInstanceIdsT = Aws::Vector<Aws::String>>
  GetReservedInstancesExchangeQuoteRequest& WithReservedInstanceIds(ReservedInstanceIdsT&& value) {
    SetReservedInstanceIds(std::forward<ReservedInstanceIdsT>(value));
    return *this;
  }
  template <typename ReservedInstanceIdsT = Aws::String>
  GetReservedInstancesExchangeQuoteRequest& AddReservedInstanceIds(ReservedInstanceIdsT&& value) {
    m_reservedInstanceIdsHasBeenSet = true;
  ...
  template <typename TargetConfigurationsT = Aws::Vector<TargetConfigurationRequest>>
  GetReservedInstancesExchangeQuoteRequest& WithTargetConfigurations(TargetConfigurationsT&& value) {
  ...
  GetReservedInstancesExchangeQuoteRequest& AddTargetConfigurations(TargetConfigurationsT&& value) {
    m_targetConfigurationsHasBeenSet = true;
