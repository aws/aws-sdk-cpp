...
class DescribeVpnGatewaysRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeVpnGatewaysRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
