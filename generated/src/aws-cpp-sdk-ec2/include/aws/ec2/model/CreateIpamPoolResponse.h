...
namespace Model
{
  ...
  public:
    ...
    template<typename IpamPoolT = IpamPool>
    CreateIpamPoolResponse& WithIpamPool(IpamPoolT&& value) { SetIpamPool(std::forward<IpamPoolT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateIpamPoolResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
