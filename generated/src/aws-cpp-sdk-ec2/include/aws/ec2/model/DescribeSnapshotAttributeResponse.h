...
class DescribeSnapshotAttributeResponse {
 public:
  ...
  void SetCreateVolumePermissions(CreateVolumePermissionsT&& value) {
    m_createVolumePermissionsHasBeenSet = true;
    m_createVolumePermissions = std::forward<CreateVolumePermissionsT>(value);
  }
  template <typename CreateVolumePermissionsT = Aws::Vector<CreateVolumePermission>>
  DescribeSnapshotAttributeResponse& WithCreateVolumePermissions(CreateVolumePermissionsT&& value) {
    SetCreateVolumePermissions(std::forward<CreateVolumePermissionsT>(value));
    return *this;
  }
  ...
  DescribeSnapshotAttributeResponse& AddCreateVolumePermissions(CreateVolumePermissionsT&& value) {
    m_createVolumePermissionsHasBeenSet = true;
    m_createVolumePermissions.emplace_back(std::forward<CreateVolumePermissionsT>(value));
    return *this;
  }
  ///@}
