...
class DescribeCapacityBlockOfferingsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeCapacityBlockOfferingsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeCapacityBlockOfferingsRequest& WithInstanceCount(int value) {
  ...
  void SetStartDateRange(StartDateRangeT&& value) {
    m_startDateRangeHasBeenSet = true;
    m_startDateRange = std::forward<StartDateRangeT>(value);
  }
  template <typename StartDateRangeT = Aws::Utils::DateTime>
  DescribeCapacityBlockOfferingsRequest& WithStartDateRange(StartDateRangeT&& value) {
    SetStartDateRange(std::forward<StartDateRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndDateRange(EndDateRangeT&& value) {
    m_endDateRangeHasBeenSet = true;
    m_endDateRange = std::forward<EndDateRangeT>(value);
  }
  template <typename EndDateRangeT = Aws::Utils::DateTime>
  DescribeCapacityBlockOfferingsRequest& WithEndDateRange(EndDateRangeT&& value) {
    SetEndDateRange(std::forward<EndDateRangeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCapacityDurationHours(int value) {
    m_capacityDurationHoursHasBeenSet = true;
    m_capacityDurationHours = value;
  }
  inline DescribeCapacityBlockOfferingsRequest& WithCapacityDurationHours(int value) {
    SetCapacityDurationHours(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeCapacityBlockOfferingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeCapacityBlockOfferingsRequest& WithUltraserverCount(int value) {
