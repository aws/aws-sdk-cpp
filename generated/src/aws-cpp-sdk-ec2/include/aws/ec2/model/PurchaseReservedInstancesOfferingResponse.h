...
class PurchaseReservedInstancesOfferingResponse {
 public:
  ...
  template <typename ReservedInstancesIdT = Aws::String>
  PurchaseReservedInstancesOfferingResponse& WithReservedInstancesId(ReservedInstancesIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  PurchaseReservedInstancesOfferingResponse& WithResponseMetadata(ResponseMetadataT&& value) {
