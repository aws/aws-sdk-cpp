...
class ReservedInstancesModificationResponse {
 public:
  ...
  template <typename ReservedInstancesIdT = Aws::String>
  ReservedInstancesModificationResponse& WithReservedInstancesId(ReservedInstancesIdT&& value) {
  ...
  template <typename TargetConfigurationT = ReservedInstancesConfiguration>
  ReservedInstancesModificationResponse& WithTargetConfiguration(TargetConfigurationT&& value) {
