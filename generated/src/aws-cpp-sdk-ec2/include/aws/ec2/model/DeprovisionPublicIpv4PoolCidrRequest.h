...
class DeprovisionPublicIpv4PoolCidrRequest : public EC2Request {
 ...
 public:
  ...
  inline DeprovisionPublicIpv4PoolCidrRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename PoolIdT = Aws::String>
  DeprovisionPublicIpv4PoolCidrRequest& WithPoolId(PoolIdT&& value) {
  ...
  template <typename CidrT = Aws::String>
  DeprovisionPublicIpv4PoolCidrRequest& WithCidr(CidrT&& value) {
