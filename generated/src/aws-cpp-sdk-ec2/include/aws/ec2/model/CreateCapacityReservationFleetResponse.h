...
class CreateCapacityReservationFleetResponse {
 public:
  ...
  inline CreateCapacityReservationFleetResponse& WithState(CapacityReservationFleetState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline CreateCapacityReservationFleetResponse& WithTotalTargetCapacity(int value) {
  ...
  inline CreateCapacityReservationFleetResponse& WithTotalFulfilledCapacity(double value) {
  ...
  inline CreateCapacityReservationFleetResponse& WithInstanceMatchCriteria(FleetInstanceMatchCriteria value) {
  ...
  inline CreateCapacityReservationFleetResponse& WithTenancy(FleetCapacityReservationTenancy value) {
    SetTenancy(value);
    return *this;
  }
  ///@}
  ...
  void SetFleetCapacityReservations(FleetCapacityReservationsT&& value) {
    ...
    m_fleetCapacityReservations = std::forward<FleetCapacityReservationsT>(value);
  }
  template <typename FleetCapacityReservationsT = Aws::Vector<FleetCapacityReservation>>
  CreateCapacityReservationFleetResponse& WithFleetCapacityReservations(FleetCapacityReservationsT&& value) {
    SetFleetCapacityReservations(std::forward<FleetCapacityReservationsT>(value));
    return *this;
  }
  ...
  CreateCapacityReservationFleetResponse& AddFleetCapacityReservations(FleetCapacityReservationsT&& value) {
    m_fleetCapacityReservationsHasBeenSet = true;
    m_fleetCapacityReservations.emplace_back(std::forward<FleetCapacityReservationsT>(value));
    return *this;
  }
  ///@}
