...
class ListSnapshotsInRecycleBinRequest : public EC2Request {
 public:
  AWS_EC2_API ListSnapshotsInRecycleBinRequest() = default;
 ...
 public:
  ...
  inline ListSnapshotsInRecycleBinRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSnapshotsInRecycleBinRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SnapshotIdsT = Aws::Vector<Aws::String>>
  ListSnapshotsInRecycleBinRequest& WithSnapshotIds(SnapshotIdsT&& value) {
    SetSnapshotIds(std::forward<SnapshotIdsT>(value));
    return *this;
  }
  template <typename SnapshotIdsT = Aws::String>
  ListSnapshotsInRecycleBinRequest& AddSnapshotIds(SnapshotIdsT&& value) {
    m_snapshotIdsHasBeenSet = true;
  ...
  inline ListSnapshotsInRecycleBinRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
