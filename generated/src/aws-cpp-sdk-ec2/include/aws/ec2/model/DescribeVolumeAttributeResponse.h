...
class DescribeVolumeAttributeResponse {
 public:
  ...
  template <typename AutoEnableIOT = AttributeBooleanValue>
  DescribeVolumeAttributeResponse& WithAutoEnableIO(AutoEnableIOT&& value) {
  ...
  template <typename ProductCodesT = Aws::Vector<ProductCode>>
  DescribeVolumeAttributeResponse& WithProductCodes(ProductCodesT&& value) {
    SetProductCodes(std::forward<ProductCodesT>(value));
    return *this;
  }
  template <typename ProductCodesT = ProductCode>
  DescribeVolumeAttributeResponse& AddProductCodes(ProductCodesT&& value) {
    m_productCodesHasBeenSet = true;
  ...
  template <typename VolumeIdT = Aws::String>
  DescribeVolumeAttributeResponse& WithVolumeId(VolumeIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVolumeAttributeResponse& WithResponseMetadata(ResponseMetadataT&& value) {
