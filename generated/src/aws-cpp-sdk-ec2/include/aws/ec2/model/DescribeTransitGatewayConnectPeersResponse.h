...
class DescribeTransitGatewayConnectPeersResponse {
 public:
  ...
  AWS_EC2_API DescribeTransitGatewayConnectPeersResponse& operator=(
  ...
  void SetTransitGatewayConnectPeers(TransitGatewayConnectPeersT&& value) {
    m_transitGatewayConnectPeersHasBeenSet = true;
    m_transitGatewayConnectPeers = std::forward<TransitGatewayConnectPeersT>(value);
  }
  template <typename TransitGatewayConnectPeersT = Aws::Vector<TransitGatewayConnectPeer>>
  DescribeTransitGatewayConnectPeersResponse& WithTransitGatewayConnectPeers(TransitGatewayConnectPeersT&& value) {
    SetTransitGatewayConnectPeers(std::forward<TransitGatewayConnectPeersT>(value));
    return *this;
  }
  template <typename TransitGatewayConnectPeersT = TransitGatewayConnectPeer>
  DescribeTransitGatewayConnectPeersResponse& AddTransitGatewayConnectPeers(TransitGatewayConnectPeersT&& value) {
    m_transitGatewayConnectPeersHasBeenSet = true;
    m_transitGatewayConnectPeers.emplace_back(std::forward<TransitGatewayConnectPeersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeTransitGatewayConnectPeersResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeTransitGatewayConnectPeersResponse& WithResponseMetadata(ResponseMetadataT&& value) {
