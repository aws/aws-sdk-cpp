...
namespace Model
{
  ...
  public:
    ...
    inline UpdateCapacityManagerOrganizationsAccessRequest& WithOrganizationsAccess(bool value) { SetOrganizationsAccess(value); return *this;}
    ///@}
    ...
    inline UpdateCapacityManagerOrganizationsAccessRequest& WithDryRun(bool value) { SetDryRun(value); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    UpdateCapacityManagerOrganizationsAccessRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
  private:
