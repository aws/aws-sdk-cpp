...
class DescribeLaunchTemplatesRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeLaunchTemplatesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetLaunchTemplateIds(LaunchTemplateIdsT&& value) {
    ...
    m_launchTemplateIds = std::forward<LaunchTemplateIdsT>(value);
  }
  template <typename LaunchTemplateIdsT = Aws::Vector<Aws::String>>
  DescribeLaunchTemplatesRequest& WithLaunchTemplateIds(LaunchTemplateIdsT&& value) {
    SetLaunchTemplateIds(std::forward<LaunchTemplateIdsT>(value));
    return *this;
  }
  ...
  DescribeLaunchTemplatesRequest& AddLaunchTemplateIds(LaunchTemplateIdsT&& value) {
    m_launchTemplateIdsHasBeenSet = true;
    m_launchTemplateIds.emplace_back(std::forward<LaunchTemplateIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLaunchTemplateNames(LaunchTemplateNamesT&& value) {
    m_launchTemplateNamesHasBeenSet = true;
    m_launchTemplateNames = std::forward<LaunchTemplateNamesT>(value);
  }
  template <typename LaunchTemplateNamesT = Aws::Vector<Aws::String>>
  DescribeLaunchTemplatesRequest& WithLaunchTemplateNames(LaunchTemplateNamesT&& value) {
    SetLaunchTemplateNames(std::forward<LaunchTemplateNamesT>(value));
    return *this;
  }
  ...
  DescribeLaunchTemplatesRequest& AddLaunchTemplateNames(LaunchTemplateNamesT&& value) {
    m_launchTemplateNamesHasBeenSet = true;
    m_launchTemplateNames.emplace_back(std::forward<LaunchTemplateNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeLaunchTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
