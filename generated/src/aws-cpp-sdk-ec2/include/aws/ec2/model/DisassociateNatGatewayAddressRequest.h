...
class DisassociateNatGatewayAddressRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetMaxDrainDurationSeconds(int value) {
    m_maxDrainDurationSecondsHasBeenSet = true;
    m_maxDrainDurationSeconds = value;
  }
  inline DisassociateNatGatewayAddressRequest& WithMaxDrainDurationSeconds(int value) {
    SetMaxDrainDurationSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline DisassociateNatGatewayAddressRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
