...
class LocalGatewayRouteTableVirtualInterfaceGroupAssociation {
 public:
  ...
  template <typename LocalGatewayRouteTableVirtualInterfaceGroupAssociationIdT = Aws::String>
  LocalGatewayRouteTableVirtualInterfaceGroupAssociation& WithLocalGatewayRouteTableVirtualInterfaceGroupAssociationId(
  ...
  template <typename LocalGatewayVirtualInterfaceGroupIdT = Aws::String>
  LocalGatewayRouteTableVirtualInterfaceGroupAssociation& WithLocalGatewayVirtualInterfaceGroupId(
  ...
  template <typename LocalGatewayIdT = Aws::String>
  LocalGatewayRouteTableVirtualInterfaceGroupAssociation& WithLocalGatewayId(LocalGatewayIdT&& value) {
  ...
  template <typename LocalGatewayRouteTableIdT = Aws::String>
  LocalGatewayRouteTableVirtualInterfaceGroupAssociation& WithLocalGatewayRouteTableId(LocalGatewayRouteTableIdT&& value) {
  ...
  template <typename LocalGatewayRouteTableArnT = Aws::String>
  LocalGatewayRouteTableVirtualInterfaceGroupAssociation& WithLocalGatewayRouteTableArn(LocalGatewayRouteTableArnT&& value) {
  ...
  template <typename OwnerIdT = Aws::String>
  LocalGatewayRouteTableVirtualInterfaceGroupAssociation& WithOwnerId(OwnerIdT&& value) {
  ...
  template <typename StateT = Aws::String>
  LocalGatewayRouteTableVirtualInterfaceGroupAssociation& WithState(StateT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  LocalGatewayRouteTableVirtualInterfaceGroupAssociation& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  LocalGatewayRouteTableVirtualInterfaceGroupAssociation& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
