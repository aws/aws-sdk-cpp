...
class DescribeSecurityGroupReferencesResponse {
 public:
  ...
  void SetSecurityGroupReferenceSet(SecurityGroupReferenceSetT&& value) {
    m_securityGroupReferenceSetHasBeenSet = true;
    m_securityGroupReferenceSet = std::forward<SecurityGroupReferenceSetT>(value);
  }
  template <typename SecurityGroupReferenceSetT = Aws::Vector<SecurityGroupReference>>
  DescribeSecurityGroupReferencesResponse& WithSecurityGroupReferenceSet(SecurityGroupReferenceSetT&& value) {
    SetSecurityGroupReferenceSet(std::forward<SecurityGroupReferenceSetT>(value));
    return *this;
  }
  template <typename SecurityGroupReferenceSetT = SecurityGroupReference>
  DescribeSecurityGroupReferencesResponse& AddSecurityGroupReferenceSet(SecurityGroupReferenceSetT&& value) {
    m_securityGroupReferenceSetHasBeenSet = true;
    m_securityGroupReferenceSet.emplace_back(std::forward<SecurityGroupReferenceSetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeSecurityGroupReferencesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
