...
class AllocateIpamPoolCidrRequest : public EC2Request {
 ...
 public:
  ...
  inline AllocateIpamPoolCidrRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNetmaskLength(int value) {
    m_netmaskLengthHasBeenSet = true;
    m_netmaskLength = value;
  }
  inline AllocateIpamPoolCidrRequest& WithNetmaskLength(int value) {
    SetNetmaskLength(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreviewNextCidr(bool value) {
    m_previewNextCidrHasBeenSet = true;
    m_previewNextCidr = value;
  }
  inline AllocateIpamPoolCidrRequest& WithPreviewNextCidr(bool value) {
    SetPreviewNextCidr(value);
    return *this;
  }
  ///@}
  ...
  void SetAllowedCidrs(AllowedCidrsT&& value) {
    m_allowedCidrsHasBeenSet = true;
    m_allowedCidrs = std::forward<AllowedCidrsT>(value);
  }
  template <typename AllowedCidrsT = Aws::Vector<Aws::String>>
  AllocateIpamPoolCidrRequest& WithAllowedCidrs(AllowedCidrsT&& value) {
    SetAllowedCidrs(std::forward<AllowedCidrsT>(value));
    return *this;
  }
  template <typename AllowedCidrsT = Aws::String>
  AllocateIpamPoolCidrRequest& AddAllowedCidrs(AllowedCidrsT&& value) {
    m_allowedCidrsHasBeenSet = true;
    m_allowedCidrs.emplace_back(std::forward<AllowedCidrsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDisallowedCidrs(DisallowedCidrsT&& value) {
    m_disallowedCidrsHasBeenSet = true;
    m_disallowedCidrs = std::forward<DisallowedCidrsT>(value);
  }
  template <typename DisallowedCidrsT = Aws::Vector<Aws::String>>
  AllocateIpamPoolCidrRequest& WithDisallowedCidrs(DisallowedCidrsT&& value) {
    SetDisallowedCidrs(std::forward<DisallowedCidrsT>(value));
    return *this;
  }
  template <typename DisallowedCidrsT = Aws::String>
  AllocateIpamPoolCidrRequest& AddDisallowedCidrs(DisallowedCidrsT&& value) {
    m_disallowedCidrsHasBeenSet = true;
    m_disallowedCidrs.emplace_back(std::forward<DisallowedCidrsT>(value));
    return *this;
  }
  ///@}
 private:
