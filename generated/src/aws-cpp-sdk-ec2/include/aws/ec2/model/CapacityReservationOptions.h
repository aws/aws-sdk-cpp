...
class CapacityReservationOptions {
 public:
  ...
  inline void SetUsageStrategy(FleetCapacityReservationUsageStrategy value) {
    m_usageStrategyHasBeenSet = true;
    m_usageStrategy = value;
  }
  inline CapacityReservationOptions& WithUsageStrategy(FleetCapacityReservationUsageStrategy value) {
    SetUsageStrategy(value);
    return *this;
  }
  ///@}
 private:
