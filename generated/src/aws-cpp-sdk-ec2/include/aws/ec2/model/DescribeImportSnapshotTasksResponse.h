...
class DescribeImportSnapshotTasksResponse {
 public:
  ...
  void SetImportSnapshotTasks(ImportSnapshotTasksT&& value) {
    m_importSnapshotTasksHasBeenSet = true;
    m_importSnapshotTasks = std::forward<ImportSnapshotTasksT>(value);
  }
  template <typename ImportSnapshotTasksT = Aws::Vector<ImportSnapshotTask>>
  DescribeImportSnapshotTasksResponse& WithImportSnapshotTasks(ImportSnapshotTasksT&& value) {
    SetImportSnapshotTasks(std::forward<ImportSnapshotTasksT>(value));
    return *this;
  }
  template <typename ImportSnapshotTasksT = ImportSnapshotTask>
  DescribeImportSnapshotTasksResponse& AddImportSnapshotTasks(ImportSnapshotTasksT&& value) {
    m_importSnapshotTasksHasBeenSet = true;
    m_importSnapshotTasks.emplace_back(std::forward<ImportSnapshotTasksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeImportSnapshotTasksResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeImportSnapshotTasksResponse& WithResponseMetadata(ResponseMetadataT&& value) {
