...
class CreateFleetRequest : public EC2Request {
 ...
 public:
  ...
  inline CreateFleetRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFleetRequest& WithExcessCapacityTerminationPolicy(FleetExcessCapacityTerminationPolicy value) {
  ...
  inline CreateFleetRequest& WithTerminateInstancesWithExpiration(bool value) {
  ...
  inline CreateFleetRequest& WithType(FleetType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFleetRequest& WithReplaceUnhealthyInstances(bool value) {
