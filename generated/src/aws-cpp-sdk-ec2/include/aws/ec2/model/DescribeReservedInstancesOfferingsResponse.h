...
class DescribeReservedInstancesOfferingsResponse {
 public:
  ...
  AWS_EC2_API DescribeReservedInstancesOfferingsResponse& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  DescribeReservedInstancesOfferingsResponse& WithNextToken(NextTokenT&& value) {
  ...
  void SetReservedInstancesOfferings(ReservedInstancesOfferingsT&& value) {
    m_reservedInstancesOfferingsHasBeenSet = true;
    m_reservedInstancesOfferings = std::forward<ReservedInstancesOfferingsT>(value);
  }
  template <typename ReservedInstancesOfferingsT = Aws::Vector<ReservedInstancesOffering>>
  DescribeReservedInstancesOfferingsResponse& WithReservedInstancesOfferings(ReservedInstancesOfferingsT&& value) {
    SetReservedInstancesOfferings(std::forward<ReservedInstancesOfferingsT>(value));
    return *this;
  }
  template <typename ReservedInstancesOfferingsT = ReservedInstancesOffering>
  DescribeReservedInstancesOfferingsResponse& AddReservedInstancesOfferings(ReservedInstancesOfferingsT&& value) {
    m_reservedInstancesOfferingsHasBeenSet = true;
    m_reservedInstancesOfferings.emplace_back(std::forward<ReservedInstancesOfferingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeReservedInstancesOfferingsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
