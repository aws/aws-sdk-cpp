...
/**
 */
class CreateVpnConcentratorRequest : public EC2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "CreateVpnConcentrator"; }
 ...
 public:
   ...
   */
  inline VpnConcentratorType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(VpnConcentratorType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CreateVpnConcentratorRequest& WithType(VpnConcentratorType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateVpnConcentratorRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
