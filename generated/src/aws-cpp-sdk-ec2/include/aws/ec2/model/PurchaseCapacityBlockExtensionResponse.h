...
class PurchaseCapacityBlockExtensionResponse {
 public:
  ...
  template <typename CapacityBlockExtensionsT = Aws::Vector<CapacityBlockExtension>>
  PurchaseCapacityBlockExtensionResponse& WithCapacityBlockExtensions(CapacityBlockExtensionsT&& value) {
  ...
  PurchaseCapacityBlockExtensionResponse& AddCapacityBlockExtensions(CapacityBlockExtensionsT&& value) {
    m_capacityBlockExtensionsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  PurchaseCapacityBlockExtensionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
