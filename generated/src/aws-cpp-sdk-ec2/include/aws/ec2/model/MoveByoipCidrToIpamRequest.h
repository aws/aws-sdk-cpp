...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API MoveByoipCidrToIpamRequest() = default;
  ...
  public:
    ...
    template<typename CidrT = Aws::String>
    MoveByoipCidrToIpamRequest& WithCidr(CidrT&& value) { SetCidr(std::forward<CidrT>(value)); return *this;}
    ///@}
    ...
    template<typename IpamPoolIdT = Aws::String>
    MoveByoipCidrToIpamRequest& WithIpamPoolId(IpamPoolIdT&& value) { SetIpamPoolId(std::forward<IpamPoolIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IpamPoolOwnerT = Aws::String>
    void SetIpamPoolOwner(IpamPoolOwnerT&& value) { m_ipamPoolOwnerHasBeenSet = true; m_ipamPoolOwner = std::forward<IpamPoolOwnerT>(value); }
    template<typename IpamPoolOwnerT = Aws::String>
    MoveByoipCidrToIpamRequest& WithIpamPoolOwner(IpamPoolOwnerT&& value) { SetIpamPoolOwner(std::forward<IpamPoolOwnerT>(value)); return *this;}
    ///@}
  private:
