...
class InstanceStatusDetails {
 public:
  ...
  template <typename ImpairedSinceT = Aws::Utils::DateTime>
  InstanceStatusDetails& WithImpairedSince(ImpairedSinceT&& value) {
  ...
  inline void SetName(StatusName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline InstanceStatusDetails& WithName(StatusName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceStatusDetails& WithStatus(StatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
