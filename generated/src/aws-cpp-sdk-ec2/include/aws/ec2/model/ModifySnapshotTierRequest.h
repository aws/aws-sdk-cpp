...
class ModifySnapshotTierRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetStorageTier(TargetStorageTier value) {
    m_storageTierHasBeenSet = true;
    m_storageTier = value;
  }
  inline ModifySnapshotTierRequest& WithStorageTier(TargetStorageTier value) {
  ...
  inline ModifySnapshotTierRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
