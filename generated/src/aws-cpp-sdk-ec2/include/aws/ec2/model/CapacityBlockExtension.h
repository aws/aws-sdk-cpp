...
class CapacityBlockExtension {
 public:
  ...
  inline CapacityBlockExtension& WithInstanceCount(int value) {
  ...
  inline CapacityBlockExtension& WithCapacityBlockExtensionDurationHours(int value) {
  ...
  inline void SetCapacityBlockExtensionStatus(CapacityBlockExtensionStatus value) {
    m_capacityBlockExtensionStatusHasBeenSet = true;
    m_capacityBlockExtensionStatus = value;
  }
  inline CapacityBlockExtension& WithCapacityBlockExtensionStatus(CapacityBlockExtensionStatus value) {
    SetCapacityBlockExtensionStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetCapacityBlockExtensionPurchaseDate(CapacityBlockExtensionPurchaseDateT&& value) {
    ...
    m_capacityBlockExtensionPurchaseDate = std::forward<CapacityBlockExtensionPurchaseDateT>(value);
  }
  template <typename CapacityBlockExtensionPurchaseDateT = Aws::Utils::DateTime>
  CapacityBlockExtension& WithCapacityBlockExtensionPurchaseDate(CapacityBlockExtensionPurchaseDateT&& value) {
    SetCapacityBlockExtensionPurchaseDate(std::forward<CapacityBlockExtensionPurchaseDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCapacityBlockExtensionStartDate(CapacityBlockExtensionStartDateT&& value) {
    ...
    m_capacityBlockExtensionStartDate = std::forward<CapacityBlockExtensionStartDateT>(value);
  }
  template <typename CapacityBlockExtensionStartDateT = Aws::Utils::DateTime>
  CapacityBlockExtension& WithCapacityBlockExtensionStartDate(CapacityBlockExtensionStartDateT&& value) {
    SetCapacityBlockExtensionStartDate(std::forward<CapacityBlockExtensionStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCapacityBlockExtensionEndDate(CapacityBlockExtensionEndDateT&& value) {
    ...
    m_capacityBlockExtensionEndDate = std::forward<CapacityBlockExtensionEndDateT>(value);
  }
  template <typename CapacityBlockExtensionEndDateT = Aws::Utils::DateTime>
  CapacityBlockExtension& WithCapacityBlockExtensionEndDate(CapacityBlockExtensionEndDateT&& value) {
    SetCapacityBlockExtensionEndDate(std::forward<CapacityBlockExtensionEndDateT>(value));
    return *this;
  }
  ///@}
