...
class DescribeHostReservationOfferingsResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeHostReservationOfferingsResponse& WithNextToken(NextTokenT&& value) {
  ...
  void SetOfferingSet(OfferingSetT&& value) {
    m_offeringSetHasBeenSet = true;
    m_offeringSet = std::forward<OfferingSetT>(value);
  }
  template <typename OfferingSetT = Aws::Vector<HostOffering>>
  DescribeHostReservationOfferingsResponse& WithOfferingSet(OfferingSetT&& value) {
    SetOfferingSet(std::forward<OfferingSetT>(value));
    return *this;
  }
  template <typename OfferingSetT = HostOffering>
  DescribeHostReservationOfferingsResponse& AddOfferingSet(OfferingSetT&& value) {
    m_offeringSetHasBeenSet = true;
    m_offeringSet.emplace_back(std::forward<OfferingSetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeHostReservationOfferingsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
