...
class DescribeVolumesModificationsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeVolumesModificationsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename VolumeIdsT = Aws::Vector<Aws::String>>
  DescribeVolumesModificationsRequest& WithVolumeIds(VolumeIdsT&& value) {
    SetVolumeIds(std::forward<VolumeIdsT>(value));
    return *this;
  }
  template <typename VolumeIdsT = Aws::String>
  DescribeVolumesModificationsRequest& AddVolumeIds(VolumeIdsT&& value) {
    m_volumeIdsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeVolumesModificationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeVolumesModificationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVolumesModificationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeVolumesModificationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeVolumesModificationsRequest& WithIncludeManagedResources(bool value) {
