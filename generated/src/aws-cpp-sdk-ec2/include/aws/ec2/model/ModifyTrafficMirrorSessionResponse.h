...
class ModifyTrafficMirrorSessionResponse {
 public:
  ...
  template <typename TrafficMirrorSessionT = TrafficMirrorSession>
  ModifyTrafficMirrorSessionResponse& WithTrafficMirrorSession(TrafficMirrorSessionT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyTrafficMirrorSessionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
