...
class GetInstanceMetadataDefaultsResponse {
 public:
  ...
  template <typename AccountLevelT = InstanceMetadataDefaultsResponse>
  GetInstanceMetadataDefaultsResponse& WithAccountLevel(AccountLevelT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetInstanceMetadataDefaultsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
