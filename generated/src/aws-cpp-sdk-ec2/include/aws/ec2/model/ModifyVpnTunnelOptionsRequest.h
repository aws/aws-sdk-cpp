...
class ModifyVpnTunnelOptionsRequest : public EC2Request {
 ...
 public:
  ...
  inline ModifyVpnTunnelOptionsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSkipTunnelReplacement(bool value) {
    m_skipTunnelReplacementHasBeenSet = true;
    m_skipTunnelReplacement = value;
  }
  inline ModifyVpnTunnelOptionsRequest& WithSkipTunnelReplacement(bool value) {
    SetSkipTunnelReplacement(value);
    return *this;
  }
  ///@}
