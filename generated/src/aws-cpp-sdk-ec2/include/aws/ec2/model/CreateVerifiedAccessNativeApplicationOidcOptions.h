...
class CreateVerifiedAccessNativeApplicationOidcOptions {
 public:
  AWS_EC2_API CreateVerifiedAccessNativeApplicationOidcOptions() = default;
  ...
  template <typename PublicSigningKeyEndpointT = Aws::String>
  CreateVerifiedAccessNativeApplicationOidcOptions& WithPublicSigningKeyEndpoint(PublicSigningKeyEndpointT&& value) {
  ...
  template <typename IssuerT = Aws::String>
  CreateVerifiedAccessNativeApplicationOidcOptions& WithIssuer(IssuerT&& value) {
  ...
  template <typename AuthorizationEndpointT = Aws::String>
  CreateVerifiedAccessNativeApplicationOidcOptions& WithAuthorizationEndpoint(AuthorizationEndpointT&& value) {
  ...
  template <typename TokenEndpointT = Aws::String>
  CreateVerifiedAccessNativeApplicationOidcOptions& WithTokenEndpoint(TokenEndpointT&& value) {
  ...
  template <typename UserInfoEndpointT = Aws::String>
  CreateVerifiedAccessNativeApplicationOidcOptions& WithUserInfoEndpoint(UserInfoEndpointT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  CreateVerifiedAccessNativeApplicationOidcOptions& WithClientId(ClientIdT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  CreateVerifiedAccessNativeApplicationOidcOptions& WithClientSecret(ClientSecretT&& value) {
  ...
  template <typename ScopeT = Aws::String>
  CreateVerifiedAccessNativeApplicationOidcOptions& WithScope(ScopeT&& value) {
