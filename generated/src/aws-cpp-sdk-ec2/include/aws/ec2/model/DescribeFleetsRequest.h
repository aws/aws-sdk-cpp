...
class DescribeFleetsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeFleetsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeFleetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FleetIdsT = Aws::Vector<Aws::String>>
  DescribeFleetsRequest& WithFleetIds(FleetIdsT&& value) {
    SetFleetIds(std::forward<FleetIdsT>(value));
    return *this;
  }
  template <typename FleetIdsT = Aws::String>
  DescribeFleetsRequest& AddFleetIds(FleetIdsT&& value) {
    m_fleetIdsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeFleetsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeFleetsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
