...
class LaunchTemplateCapacityReservationSpecificationRequest {
 public:
  ...
  inline LaunchTemplateCapacityReservationSpecificationRequest& WithCapacityReservationPreference(CapacityReservationPreference value) {
  ...
  template <typename CapacityReservationTargetT = CapacityReservationTarget>
  LaunchTemplateCapacityReservationSpecificationRequest& WithCapacityReservationTarget(CapacityReservationTargetT&& value) {
