...
class CreateDelegateMacVolumeOwnershipTaskResponse {
 public:
  ...
  AWS_EC2_API CreateDelegateMacVolumeOwnershipTaskResponse& operator=(
  ...
  template <typename MacModificationTaskT = MacModificationTask>
  CreateDelegateMacVolumeOwnershipTaskResponse& WithMacModificationTask(MacModificationTaskT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateDelegateMacVolumeOwnershipTaskResponse& WithResponseMetadata(ResponseMetadataT&& value) {
