...
class TransitGatewayPolicyTableAssociation {
 public:
  ...
  inline TransitGatewayPolicyTableAssociation& WithResourceType(TransitGatewayAttachmentResourceType value) {
  ...
  inline TransitGatewayPolicyTableAssociation& WithState(TransitGatewayAssociationState value) {
    SetState(value);
    return *this;
  }
  ///@}
