...
namespace Model
{
  ...
  /**
   */
  class EnableRouteServerPropagationRequest : public EC2Request
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "EnableRouteServerPropagation"; }
  ...
  public:
    ...
    template<typename RouteServerIdT = Aws::String>
    EnableRouteServerPropagationRequest& WithRouteServerId(RouteServerIdT&& value) { SetRouteServerId(std::forward<RouteServerIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RouteTableIdT = Aws::String>
    EnableRouteServerPropagationRequest& WithRouteTableId(RouteTableIdT&& value) { SetRouteTableId(std::forward<RouteTableIdT>(value)); return *this;}
    ///@}
    ...
    inline EnableRouteServerPropagationRequest& WithDryRun(bool value) { SetDryRun(value); return *this;}
    ///@}
  private:
