...
class GetConsoleScreenshotResponse {
 public:
  ...
  void SetImageData(ImageDataT&& value) {
    m_imageDataHasBeenSet = true;
    m_imageData = std::forward<ImageDataT>(value);
  }
  template <typename ImageDataT = Aws::String>
  GetConsoleScreenshotResponse& WithImageData(ImageDataT&& value) {
    SetImageData(std::forward<ImageDataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename InstanceIdT = Aws::String>
  GetConsoleScreenshotResponse& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetConsoleScreenshotResponse& WithResponseMetadata(ResponseMetadataT&& value) {
