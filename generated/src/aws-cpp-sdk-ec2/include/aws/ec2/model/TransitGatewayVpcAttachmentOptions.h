...
class TransitGatewayVpcAttachmentOptions {
 public:
  ...
  inline TransitGatewayVpcAttachmentOptions& WithDnsSupport(DnsSupportValue value) {
    SetDnsSupport(value);
    return *this;
  }
  ///@}
  ...
  inline TransitGatewayVpcAttachmentOptions& WithSecurityGroupReferencingSupport(SecurityGroupReferencingSupportValue value) {
  ...
  inline TransitGatewayVpcAttachmentOptions& WithIpv6Support(Ipv6SupportValue value) {
  ...
  inline TransitGatewayVpcAttachmentOptions& WithApplianceModeSupport(ApplianceModeSupportValue value) {
