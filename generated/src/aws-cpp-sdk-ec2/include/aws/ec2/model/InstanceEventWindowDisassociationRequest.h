...
class InstanceEventWindowDisassociationRequest {
 public:
  ...
  template <typename InstanceIdsT = Aws::Vector<Aws::String>>
  InstanceEventWindowDisassociationRequest& WithInstanceIds(InstanceIdsT&& value) {
    SetInstanceIds(std::forward<InstanceIdsT>(value));
    return *this;
  }
  template <typename InstanceIdsT = Aws::String>
  InstanceEventWindowDisassociationRequest& AddInstanceIds(InstanceIdsT&& value) {
    m_instanceIdsHasBeenSet = true;
  ...
  template <typename InstanceTagsT = Aws::Vector<Tag>>
  InstanceEventWindowDisassociationRequest& WithInstanceTags(InstanceTagsT&& value) {
    SetInstanceTags(std::forward<InstanceTagsT>(value));
    return *this;
  }
  template <typename InstanceTagsT = Tag>
  InstanceEventWindowDisassociationRequest& AddInstanceTags(InstanceTagsT&& value) {
    m_instanceTagsHasBeenSet = true;
  ...
  template <typename DedicatedHostIdsT = Aws::Vector<Aws::String>>
  InstanceEventWindowDisassociationRequest& WithDedicatedHostIds(DedicatedHostIdsT&& value) {
    SetDedicatedHostIds(std::forward<DedicatedHostIdsT>(value));
    return *this;
  }
  template <typename DedicatedHostIdsT = Aws::String>
  InstanceEventWindowDisassociationRequest& AddDedicatedHostIds(DedicatedHostIdsT&& value) {
    m_dedicatedHostIdsHasBeenSet = true;
