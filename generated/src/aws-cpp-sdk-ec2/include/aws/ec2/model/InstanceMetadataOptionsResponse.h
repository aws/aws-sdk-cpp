...
class InstanceMetadataOptionsResponse {
 public:
  ...
  inline void SetState(InstanceMetadataOptionsState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline InstanceMetadataOptionsResponse& WithState(InstanceMetadataOptionsState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHttpTokens(HttpTokensState value) {
    m_httpTokensHasBeenSet = true;
    m_httpTokens = value;
  }
  inline InstanceMetadataOptionsResponse& WithHttpTokens(HttpTokensState value) {
    SetHttpTokens(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceMetadataOptionsResponse& WithHttpPutResponseHopLimit(int value) {
  ...
  inline void SetHttpEndpoint(InstanceMetadataEndpointState value) {
    m_httpEndpointHasBeenSet = true;
    m_httpEndpoint = value;
  }
  inline InstanceMetadataOptionsResponse& WithHttpEndpoint(InstanceMetadataEndpointState value) {
  ...
  inline void SetHttpProtocolIpv6(InstanceMetadataProtocolState value) {
    m_httpProtocolIpv6HasBeenSet = true;
    m_httpProtocolIpv6 = value;
  }
  inline InstanceMetadataOptionsResponse& WithHttpProtocolIpv6(InstanceMetadataProtocolState value) {
  ...
  inline void SetInstanceMetadataTags(InstanceMetadataTagsState value) {
    m_instanceMetadataTagsHasBeenSet = true;
    m_instanceMetadataTags = value;
  }
  inline InstanceMetadataOptionsResponse& WithInstanceMetadataTags(InstanceMetadataTagsState value) {
