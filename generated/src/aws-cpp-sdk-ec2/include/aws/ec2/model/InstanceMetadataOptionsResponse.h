...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>IMDSv2 uses token-backed sessions. Indicates whether the use of HTTP tokens
     * is <code>optional</code> (in other words, indicates whether the use of IMDSv2 is
     * <code>optional</code>) or <code>required</code> (in other words, indicates
     * whether the use of IMDSv2 is <code>required</code>).</p> <ul> <li> <p>
     * <code>optional</code> - When IMDSv2 is optional, you can choose to retrieve
     ...
     * token, the IMDSv2 role credentials are returned.</p> </li> <li> <p>
     ...
     * available.</p> </li> </ul> <p>Default: <code>optional</code> </p>
     */
