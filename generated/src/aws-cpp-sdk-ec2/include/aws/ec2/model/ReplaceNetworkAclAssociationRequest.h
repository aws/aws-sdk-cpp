...
class ReplaceNetworkAclAssociationRequest : public EC2Request {
 ...
 public:
  ...
  inline ReplaceNetworkAclAssociationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename AssociationIdT = Aws::String>
  ReplaceNetworkAclAssociationRequest& WithAssociationId(AssociationIdT&& value) {
  ...
  template <typename NetworkAclIdT = Aws::String>
  ReplaceNetworkAclAssociationRequest& WithNetworkAclId(NetworkAclIdT&& value) {
