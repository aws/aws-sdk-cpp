...
class ModifyLaunchTemplateRequest : public EC2Request {
 ...
 public:
  ...
  inline ModifyLaunchTemplateRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  ModifyLaunchTemplateRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename LaunchTemplateIdT = Aws::String>
  ModifyLaunchTemplateRequest& WithLaunchTemplateId(LaunchTemplateIdT&& value) {
  ...
  template <typename LaunchTemplateNameT = Aws::String>
  ModifyLaunchTemplateRequest& WithLaunchTemplateName(LaunchTemplateNameT&& value) {
  ...
  template <typename DefaultVersionT = Aws::String>
  ModifyLaunchTemplateRequest& WithDefaultVersion(DefaultVersionT&& value) {
