...
class ModifyRouteServerRequest : public EC2Request {
 ...
 public:
  ...
  template <typename RouteServerIdT = Aws::String>
  ModifyRouteServerRequest& WithRouteServerId(RouteServerIdT&& value) {
  ...
  inline ModifyRouteServerRequest& WithPersistRoutes(RouteServerPersistRoutesAction value) {
  ...
  inline ModifyRouteServerRequest& WithPersistRoutesDuration(long long value) {
  ...
  inline ModifyRouteServerRequest& WithSnsNotificationsEnabled(bool value) {
  ...
  inline ModifyRouteServerRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
