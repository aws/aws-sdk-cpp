...
class DisassociateIpamResourceDiscoveryRequest : public EC2Request {
 ...
 public:
  ...
  inline DisassociateIpamResourceDiscoveryRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamResourceDiscoveryAssociationIdT = Aws::String>
  DisassociateIpamResourceDiscoveryRequest& WithIpamResourceDiscoveryAssociationId(IpamResourceDiscoveryAssociationIdT&& value) {
