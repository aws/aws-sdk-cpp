...
class DescribeMacHostsResponse {
 public:
  ...
  void SetMacHosts(MacHostsT&& value) {
    m_macHostsHasBeenSet = true;
    m_macHosts = std::forward<MacHostsT>(value);
  }
  template <typename MacHostsT = Aws::Vector<MacHost>>
  DescribeMacHostsResponse& WithMacHosts(MacHostsT&& value) {
    SetMacHosts(std::forward<MacHostsT>(value));
    return *this;
  }
  template <typename MacHostsT = MacHost>
  DescribeMacHostsResponse& AddMacHosts(MacHostsT&& value) {
    m_macHostsHasBeenSet = true;
    m_macHosts.emplace_back(std::forward<MacHostsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMacHostsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeMacHostsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
