...
class DeleteTransitGatewayConnectResponse {
 public:
  ...
  void SetTransitGatewayConnect(TransitGatewayConnectT&& value) {
    m_transitGatewayConnectHasBeenSet = true;
    m_transitGatewayConnect = std::forward<TransitGatewayConnectT>(value);
  }
  template <typename TransitGatewayConnectT = TransitGatewayConnect>
  DeleteTransitGatewayConnectResponse& WithTransitGatewayConnect(TransitGatewayConnectT&& value) {
    SetTransitGatewayConnect(std::forward<TransitGatewayConnectT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteTransitGatewayConnectResponse& WithResponseMetadata(ResponseMetadataT&& value) {
