...
class CreateTrafficMirrorSessionResponse {
 public:
  ...
  void SetTrafficMirrorSession(TrafficMirrorSessionT&& value) {
    m_trafficMirrorSessionHasBeenSet = true;
    m_trafficMirrorSession = std::forward<TrafficMirrorSessionT>(value);
  }
  template <typename TrafficMirrorSessionT = TrafficMirrorSession>
  CreateTrafficMirrorSessionResponse& WithTrafficMirrorSession(TrafficMirrorSessionT&& value) {
    SetTrafficMirrorSession(std::forward<TrafficMirrorSessionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTrafficMirrorSessionResponse& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateTrafficMirrorSessionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
