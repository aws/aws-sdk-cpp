...
class DescribeIpamExternalResourceVerificationTokensRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeIpamExternalResourceVerificationTokensRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeIpamExternalResourceVerificationTokensRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeIpamExternalResourceVerificationTokensRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeIpamExternalResourceVerificationTokensRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeIpamExternalResourceVerificationTokensRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<Aws::String>& GetIpamExternalResourceVerificationTokenIds() const {
    return m_ipamExternalResourceVerificationTokenIds;
  }
  ...
  void SetIpamExternalResourceVerificationTokenIds(IpamExternalResourceVerificationTokenIdsT&& value) {
    m_ipamExternalResourceVerificationTokenIdsHasBeenSet = true;
    m_ipamExternalResourceVerificationTokenIds = std::forward<IpamExternalResourceVerificationTokenIdsT>(value);
  }
  template <typename IpamExternalResourceVerificationTokenIdsT = Aws::Vector<Aws::String>>
  DescribeIpamExternalResourceVerificationTokensRequest& WithIpamExternalResourceVerificationTokenIds(
      IpamExternalResourceVerificationTokenIdsT&& value) {
    SetIpamExternalResourceVerificationTokenIds(std::forward<IpamExternalResourceVerificationTokenIdsT>(value));
    return *this;
  }
  template <typename IpamExternalResourceVerificationTokenIdsT = Aws::String>
  DescribeIpamExternalResourceVerificationTokensRequest& AddIpamExternalResourceVerificationTokenIds(
      IpamExternalResourceVerificationTokenIdsT&& value) {
    m_ipamExternalResourceVerificationTokenIdsHasBeenSet = true;
    m_ipamExternalResourceVerificationTokenIds.emplace_back(std::forward<IpamExternalResourceVerificationTokenIdsT>(value));
    return *this;
  }
  ///@}
 private:
