...
class GetTransitGatewayMulticastDomainAssociationsRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayMulticastDomainIdT = Aws::String>
  GetTransitGatewayMulticastDomainAssociationsRequest& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  GetTransitGatewayMulticastDomainAssociationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  GetTransitGatewayMulticastDomainAssociationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline GetTransitGatewayMulticastDomainAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetTransitGatewayMulticastDomainAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetTransitGatewayMulticastDomainAssociationsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
