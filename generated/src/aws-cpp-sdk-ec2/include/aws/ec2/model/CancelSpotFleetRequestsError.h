...
class CancelSpotFleetRequestsError {
 public:
  ...
  inline void SetCode(CancelBatchErrorCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline CancelSpotFleetRequestsError& WithCode(CancelBatchErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  CancelSpotFleetRequestsError& WithMessage(MessageT&& value) {
