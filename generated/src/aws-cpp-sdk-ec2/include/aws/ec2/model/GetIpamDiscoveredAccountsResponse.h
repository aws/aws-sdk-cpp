...
class GetIpamDiscoveredAccountsResponse {
 public:
  ...
  void SetIpamDiscoveredAccounts(IpamDiscoveredAccountsT&& value) {
    m_ipamDiscoveredAccountsHasBeenSet = true;
    m_ipamDiscoveredAccounts = std::forward<IpamDiscoveredAccountsT>(value);
  }
  template <typename IpamDiscoveredAccountsT = Aws::Vector<IpamDiscoveredAccount>>
  GetIpamDiscoveredAccountsResponse& WithIpamDiscoveredAccounts(IpamDiscoveredAccountsT&& value) {
    SetIpamDiscoveredAccounts(std::forward<IpamDiscoveredAccountsT>(value));
    return *this;
  }
  template <typename IpamDiscoveredAccountsT = IpamDiscoveredAccount>
  GetIpamDiscoveredAccountsResponse& AddIpamDiscoveredAccounts(IpamDiscoveredAccountsT&& value) {
    m_ipamDiscoveredAccountsHasBeenSet = true;
    m_ipamDiscoveredAccounts.emplace_back(std::forward<IpamDiscoveredAccountsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetIpamDiscoveredAccountsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetIpamDiscoveredAccountsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
