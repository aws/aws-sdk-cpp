...
class ModifyIpamResourceDiscoveryResponse {
 public:
  ...
  template <typename IpamResourceDiscoveryT = IpamResourceDiscovery>
  ModifyIpamResourceDiscoveryResponse& WithIpamResourceDiscovery(IpamResourceDiscoveryT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyIpamResourceDiscoveryResponse& WithResponseMetadata(ResponseMetadataT&& value) {
