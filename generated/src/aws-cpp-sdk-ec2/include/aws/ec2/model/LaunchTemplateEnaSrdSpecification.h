...
class LaunchTemplateEnaSrdSpecification {
 public:
  ...
  inline LaunchTemplateEnaSrdSpecification& WithEnaSrdEnabled(bool value) {
  ...
  template <typename EnaSrdUdpSpecificationT = LaunchTemplateEnaSrdUdpSpecification>
  LaunchTemplateEnaSrdSpecification& WithEnaSrdUdpSpecification(EnaSrdUdpSpecificationT&& value) {
