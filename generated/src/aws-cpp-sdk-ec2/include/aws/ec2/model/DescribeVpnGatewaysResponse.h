...
class DescribeVpnGatewaysResponse {
 public:
  ...
  void SetVpnGateways(VpnGatewaysT&& value) {
    m_vpnGatewaysHasBeenSet = true;
    m_vpnGateways = std::forward<VpnGatewaysT>(value);
  }
  template <typename VpnGatewaysT = Aws::Vector<VpnGateway>>
  DescribeVpnGatewaysResponse& WithVpnGateways(VpnGatewaysT&& value) {
    SetVpnGateways(std::forward<VpnGatewaysT>(value));
    return *this;
  }
  template <typename VpnGatewaysT = VpnGateway>
  DescribeVpnGatewaysResponse& AddVpnGateways(VpnGatewaysT&& value) {
    m_vpnGatewaysHasBeenSet = true;
    m_vpnGateways.emplace_back(std::forward<VpnGatewaysT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVpnGatewaysResponse& WithResponseMetadata(ResponseMetadataT&& value) {
