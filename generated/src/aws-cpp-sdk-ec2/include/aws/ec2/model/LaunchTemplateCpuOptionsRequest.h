...
class LaunchTemplateCpuOptionsRequest {
 public:
  ...
  inline LaunchTemplateCpuOptionsRequest& WithCoreCount(int value) {
    SetCoreCount(value);
    return *this;
  }
  ///@}
  ...
  inline LaunchTemplateCpuOptionsRequest& WithThreadsPerCore(int value) {
  ...
  inline LaunchTemplateCpuOptionsRequest& WithAmdSevSnp(AmdSevSnpSpecification value) {
    SetAmdSevSnp(value);
    return *this;
  }
  ///@}
