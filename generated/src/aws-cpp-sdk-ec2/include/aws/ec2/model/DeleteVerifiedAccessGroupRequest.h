...
class DeleteVerifiedAccessGroupRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VerifiedAccessGroupIdT = Aws::String>
  DeleteVerifiedAccessGroupRequest& WithVerifiedAccessGroupId(VerifiedAccessGroupIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteVerifiedAccessGroupRequest& WithClientToken(ClientTokenT&& value) {
  ...
  inline DeleteVerifiedAccessGroupRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
