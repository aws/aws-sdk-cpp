...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DisassociateTransitGatewayMulticastDomainResponse() = default;
    ...
    template<typename AssociationsT = TransitGatewayMulticastDomainAssociations>
    DisassociateTransitGatewayMulticastDomainResponse& WithAssociations(AssociationsT&& value) { SetAssociations(std::forward<AssociationsT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DisassociateTransitGatewayMulticastDomainResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
