...
class DisassociateTransitGatewayMulticastDomainResponse {
 public:
  ...
  AWS_EC2_API DisassociateTransitGatewayMulticastDomainResponse& operator=(
  ...
  template <typename AssociationsT = TransitGatewayMulticastDomainAssociations>
  DisassociateTransitGatewayMulticastDomainResponse& WithAssociations(AssociationsT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisassociateTransitGatewayMulticastDomainResponse& WithResponseMetadata(ResponseMetadataT&& value) {
