...
class CancelReservedInstancesListingResponse {
 public:
  ...
  template <typename ReservedInstancesListingsT = Aws::Vector<ReservedInstancesListing>>
  CancelReservedInstancesListingResponse& WithReservedInstancesListings(ReservedInstancesListingsT&& value) {
  ...
  CancelReservedInstancesListingResponse& AddReservedInstancesListings(ReservedInstancesListingsT&& value) {
    m_reservedInstancesListingsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CancelReservedInstancesListingResponse& WithResponseMetadata(ResponseMetadataT&& value) {
