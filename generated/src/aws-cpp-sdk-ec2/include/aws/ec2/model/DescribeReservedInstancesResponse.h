...
class DescribeReservedInstancesResponse {
 public:
  ...
  void SetReservedInstances(ReservedInstancesT&& value) {
    m_reservedInstancesHasBeenSet = true;
    m_reservedInstances = std::forward<ReservedInstancesT>(value);
  }
  template <typename ReservedInstancesT = Aws::Vector<ReservedInstances>>
  DescribeReservedInstancesResponse& WithReservedInstances(ReservedInstancesT&& value) {
    SetReservedInstances(std::forward<ReservedInstancesT>(value));
    return *this;
  }
  template <typename ReservedInstancesT = ReservedInstances>
  DescribeReservedInstancesResponse& AddReservedInstances(ReservedInstancesT&& value) {
    m_reservedInstancesHasBeenSet = true;
    m_reservedInstances.emplace_back(std::forward<ReservedInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeReservedInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
