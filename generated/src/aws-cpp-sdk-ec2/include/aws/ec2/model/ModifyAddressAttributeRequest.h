...
class ModifyAddressAttributeRequest : public EC2Request {
 ...
 public:
  ...
  template <typename AllocationIdT = Aws::String>
  ModifyAddressAttributeRequest& WithAllocationId(AllocationIdT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  ModifyAddressAttributeRequest& WithDomainName(DomainNameT&& value) {
  ...
  inline ModifyAddressAttributeRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
