...
class DeleteLocalGatewayVirtualInterfaceRequest : public EC2Request {
 ...
 public:
  ...
  void SetLocalGatewayVirtualInterfaceId(LocalGatewayVirtualInterfaceIdT&& value) {
    ...
    m_localGatewayVirtualInterfaceId = std::forward<LocalGatewayVirtualInterfaceIdT>(value);
  }
  template <typename LocalGatewayVirtualInterfaceIdT = Aws::String>
  DeleteLocalGatewayVirtualInterfaceRequest& WithLocalGatewayVirtualInterfaceId(LocalGatewayVirtualInterfaceIdT&& value) {
    SetLocalGatewayVirtualInterfaceId(std::forward<LocalGatewayVirtualInterfaceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DeleteLocalGatewayVirtualInterfaceRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
