...
class Byoasn {
 public:
  ...
  template <typename IpamIdT = Aws::String>
  Byoasn& WithIpamId(IpamIdT&& value) {
  ...
  template <typename StatusMessageT = Aws::String>
  Byoasn& WithStatusMessage(StatusMessageT&& value) {
  ...
  inline void SetState(AsnState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline Byoasn& WithState(AsnState value) {
    SetState(value);
    return *this;
  }
  ///@}
