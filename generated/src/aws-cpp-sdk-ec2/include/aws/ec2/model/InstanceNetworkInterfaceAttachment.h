...
class InstanceNetworkInterfaceAttachment {
 public:
  ...
  inline InstanceNetworkInterfaceAttachment& WithDeleteOnTermination(bool value) {
  ...
  inline InstanceNetworkInterfaceAttachment& WithDeviceIndex(int value) {
  ...
  inline InstanceNetworkInterfaceAttachment& WithStatus(AttachmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceNetworkInterfaceAttachment& WithNetworkCardIndex(int value) {
  ...
  inline InstanceNetworkInterfaceAttachment& WithEnaQueueCount(int value) {
