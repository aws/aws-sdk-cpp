...
class ImportVolumeResponse {
 public:
  ...
  void SetConversionTask(ConversionTaskT&& value) {
    m_conversionTaskHasBeenSet = true;
    m_conversionTask = std::forward<ConversionTaskT>(value);
  }
  template <typename ConversionTaskT = ConversionTask>
  ImportVolumeResponse& WithConversionTask(ConversionTaskT&& value) {
    SetConversionTask(std::forward<ConversionTaskT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ImportVolumeResponse& WithResponseMetadata(ResponseMetadataT&& value) {
