...
namespace Model
{
  ...
  public:
    ...
    template<typename IamInstanceProfileAssociationT = IamInstanceProfileAssociation>
    ReplaceIamInstanceProfileAssociationResponse& WithIamInstanceProfileAssociation(IamInstanceProfileAssociationT&& value) { SetIamInstanceProfileAssociation(std::forward<IamInstanceProfileAssociationT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ReplaceIamInstanceProfileAssociationResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
