...
namespace Model
{
  ...
  public:
    ...
    template<typename S3BucketNameT = Aws::String>
    CreateCapacityManagerDataExportRequest& WithS3BucketName(S3BucketNameT&& value) { SetS3BucketName(std::forward<S3BucketNameT>(value)); return *this;}
    ///@}
    ...
    template<typename S3BucketPrefixT = Aws::String>
    CreateCapacityManagerDataExportRequest& WithS3BucketPrefix(S3BucketPrefixT&& value) { SetS3BucketPrefix(std::forward<S3BucketPrefixT>(value)); return *this;}
    ///@}
    ...
    inline CreateCapacityManagerDataExportRequest& WithSchedule(Schedule value) { SetSchedule(value); return *this;}
    ///@}
    ...
    inline CreateCapacityManagerDataExportRequest& WithOutputFormat(OutputFormat value) { SetOutputFormat(value); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    CreateCapacityManagerDataExportRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    inline CreateCapacityManagerDataExportRequest& WithDryRun(bool value) { SetDryRun(value); return *this;}
    ///@}
    ...
    template<typename TagSpecificationsT = Aws::Vector<TagSpecification>>
    CreateCapacityManagerDataExportRequest& WithTagSpecifications(TagSpecificationsT&& value) { SetTagSpecifications(std::forward<TagSpecificationsT>(value)); return *this;}
    template<typename TagSpecificationsT = TagSpecification>
    CreateCapacityManagerDataExportRequest& AddTagSpecifications(TagSpecificationsT&& value) { m_tagSpecificationsHasBeenSet = true; m_tagSpecifications.emplace_back(std::forward<TagSpecificationsT>(value)); return *this; }
    ///@}
  private:
