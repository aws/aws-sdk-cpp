...
class ModifyInstanceAttributeRequest : public EC2Request {
 ...
 public:
  ...
  inline ModifyInstanceAttributeRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAttribute(InstanceAttributeName value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline ModifyInstanceAttributeRequest& WithAttribute(InstanceAttributeName value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  void SetKernel(KernelT&& value) {
    m_kernelHasBeenSet = true;
    m_kernel = std::forward<KernelT>(value);
  }
  template <typename KernelT = AttributeValue>
  ModifyInstanceAttributeRequest& WithKernel(KernelT&& value) {
    SetKernel(std::forward<KernelT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRamdisk(RamdiskT&& value) {
    m_ramdiskHasBeenSet = true;
    m_ramdisk = std::forward<RamdiskT>(value);
  }
  template <typename RamdiskT = AttributeValue>
  ModifyInstanceAttributeRequest& WithRamdisk(RamdiskT&& value) {
    SetRamdisk(std::forward<RamdiskT>(value));
    return *this;
  }
  ///@}
