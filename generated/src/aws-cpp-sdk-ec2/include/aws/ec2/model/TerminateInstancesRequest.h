...
class TerminateInstancesRequest : public EC2Request {
 ...
 public:
  ...
  inline TerminateInstancesRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
  ...
  inline TerminateInstancesRequest& WithSkipOsShutdown(bool value) {
  ...
  inline TerminateInstancesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
