 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/VerifiedAccessEndpointRdsOptions">AWS
 * API Reference</a></p>
 */
class VerifiedAccessEndpointRdsOptions {
 public:
  ...
  inline VerifiedAccessEndpointRdsOptions& WithProtocol(VerifiedAccessEndpointProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline VerifiedAccessEndpointRdsOptions& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  void SetRdsDbInstanceArn(RdsDbInstanceArnT&& value) {
    ...
    m_rdsDbInstanceArn = std::forward<RdsDbInstanceArnT>(value);
  }
  template <typename RdsDbInstanceArnT = Aws::String>
  VerifiedAccessEndpointRdsOptions& WithRdsDbInstanceArn(RdsDbInstanceArnT&& value) {
    SetRdsDbInstanceArn(std::forward<RdsDbInstanceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRdsDbClusterArn(RdsDbClusterArnT&& value) {
    m_rdsDbClusterArnHasBeenSet = true;
    m_rdsDbClusterArn = std::forward<RdsDbClusterArnT>(value);
  }
  template <typename RdsDbClusterArnT = Aws::String>
  VerifiedAccessEndpointRdsOptions& WithRdsDbClusterArn(RdsDbClusterArnT&& value) {
    SetRdsDbClusterArn(std::forward<RdsDbClusterArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRdsDbProxyArn(RdsDbProxyArnT&& value) {
    m_rdsDbProxyArnHasBeenSet = true;
    m_rdsDbProxyArn = std::forward<RdsDbProxyArnT>(value);
  }
  template <typename RdsDbProxyArnT = Aws::String>
  VerifiedAccessEndpointRdsOptions& WithRdsDbProxyArn(RdsDbProxyArnT&& value) {
    SetRdsDbProxyArn(std::forward<RdsDbProxyArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRdsEndpoint(RdsEndpointT&& value) {
    ...
    m_rdsEndpoint = std::forward<RdsEndpointT>(value);
  }
  template <typename RdsEndpointT = Aws::String>
  VerifiedAccessEndpointRdsOptions& WithRdsEndpoint(RdsEndpointT&& value) {
    SetRdsEndpoint(std::forward<RdsEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  VerifiedAccessEndpointRdsOptions& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  VerifiedAccessEndpointRdsOptions& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
