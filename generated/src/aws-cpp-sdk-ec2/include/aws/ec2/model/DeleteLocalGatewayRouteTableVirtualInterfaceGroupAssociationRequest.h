...
class DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest : public EC2Request {
 ...
 public:
   ...
   * </p>
   */
  inline const Aws::String& GetLocalGatewayRouteTableVirtualInterfaceGroupAssociationId() const {
    return m_localGatewayRouteTableVirtualInterfaceGroupAssociationId;
  }
  inline bool LocalGatewayRouteTableVirtualInterfaceGroupAssociationIdHasBeenSet() const {
    return m_localGatewayRouteTableVirtualInterfaceGroupAssociationIdHasBeenSet;
  }
  template <typename LocalGatewayRouteTableVirtualInterfaceGroupAssociationIdT = Aws::String>
  void SetLocalGatewayRouteTableVirtualInterfaceGroupAssociationId(LocalGatewayRouteTableVirtualInterfaceGroupAssociationIdT&& value) {
    m_localGatewayRouteTableVirtualInterfaceGroupAssociationIdHasBeenSet = true;
    m_localGatewayRouteTableVirtualInterfaceGroupAssociationId =
        std::forward<LocalGatewayRouteTableVirtualInterfaceGroupAssociationIdT>(value);
  }
  template <typename LocalGatewayRouteTableVirtualInterfaceGroupAssociationIdT = Aws::String>
  DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest& WithLocalGatewayRouteTableVirtualInterfaceGroupAssociationId(
      LocalGatewayRouteTableVirtualInterfaceGroupAssociationIdT&& value) {
    SetLocalGatewayRouteTableVirtualInterfaceGroupAssociationId(
        std::forward<LocalGatewayRouteTableVirtualInterfaceGroupAssociationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
