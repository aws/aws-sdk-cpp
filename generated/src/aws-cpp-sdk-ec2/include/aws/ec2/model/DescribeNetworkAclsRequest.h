...
class DescribeNetworkAclsRequest : public EC2Request {
 ...
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeNetworkAclsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeNetworkAclsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeNetworkAclsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetNetworkAclIds(NetworkAclIdsT&& value) {
    m_networkAclIdsHasBeenSet = true;
    m_networkAclIds = std::forward<NetworkAclIdsT>(value);
  }
  template <typename NetworkAclIdsT = Aws::Vector<Aws::String>>
  DescribeNetworkAclsRequest& WithNetworkAclIds(NetworkAclIdsT&& value) {
    SetNetworkAclIds(std::forward<NetworkAclIdsT>(value));
    return *this;
  }
  template <typename NetworkAclIdsT = Aws::String>
  DescribeNetworkAclsRequest& AddNetworkAclIds(NetworkAclIdsT&& value) {
    m_networkAclIdsHasBeenSet = true;
    m_networkAclIds.emplace_back(std::forward<NetworkAclIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeNetworkAclsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeNetworkAclsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
