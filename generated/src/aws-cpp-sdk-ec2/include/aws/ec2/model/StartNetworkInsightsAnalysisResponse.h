...
class StartNetworkInsightsAnalysisResponse {
 public:
  ...
  void SetNetworkInsightsAnalysis(NetworkInsightsAnalysisT&& value) {
    m_networkInsightsAnalysisHasBeenSet = true;
    m_networkInsightsAnalysis = std::forward<NetworkInsightsAnalysisT>(value);
  }
  template <typename NetworkInsightsAnalysisT = NetworkInsightsAnalysis>
  StartNetworkInsightsAnalysisResponse& WithNetworkInsightsAnalysis(NetworkInsightsAnalysisT&& value) {
    SetNetworkInsightsAnalysis(std::forward<NetworkInsightsAnalysisT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  StartNetworkInsightsAnalysisResponse& WithResponseMetadata(ResponseMetadataT&& value) {
