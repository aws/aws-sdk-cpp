...
class ResourceTypeOption {
 public:
  ...
  inline void SetOptionName(ImageReferenceOptionName value) {
    m_optionNameHasBeenSet = true;
    m_optionName = value;
  }
  inline ResourceTypeOption& WithOptionName(ImageReferenceOptionName value) {
    SetOptionName(value);
    return *this;
  }
  ///@}
  ...
  template <typename OptionValuesT = Aws::Vector<Aws::String>>
  ResourceTypeOption& WithOptionValues(OptionValuesT&& value) {
    SetOptionValues(std::forward<OptionValuesT>(value));
    return *this;
  }
  template <typename OptionValuesT = Aws::String>
  ResourceTypeOption& AddOptionValues(OptionValuesT&& value) {
    m_optionValuesHasBeenSet = true;
