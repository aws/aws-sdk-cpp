...
class CapacityReservationFleetCancellationState {
 public:
  ...
  inline void SetCurrentFleetState(CapacityReservationFleetState value) {
    m_currentFleetStateHasBeenSet = true;
    m_currentFleetState = value;
  }
  inline CapacityReservationFleetCancellationState& WithCurrentFleetState(CapacityReservationFleetState value) {
    SetCurrentFleetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreviousFleetState(CapacityReservationFleetState value) {
    m_previousFleetStateHasBeenSet = true;
    m_previousFleetState = value;
  }
  inline CapacityReservationFleetCancellationState& WithPreviousFleetState(CapacityReservationFleetState value) {
    SetPreviousFleetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename CapacityReservationFleetIdT = Aws::String>
  CapacityReservationFleetCancellationState& WithCapacityReservationFleetId(CapacityReservationFleetIdT&& value) {
