...
class GetAssociatedIpv6PoolCidrsRequest : public EC2Request {
 public:
  AWS_EC2_API GetAssociatedIpv6PoolCidrsRequest() = default;
 ...
 public:
  ...
  template <typename PoolIdT = Aws::String>
  GetAssociatedIpv6PoolCidrsRequest& WithPoolId(PoolIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetAssociatedIpv6PoolCidrsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetAssociatedIpv6PoolCidrsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline GetAssociatedIpv6PoolCidrsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
