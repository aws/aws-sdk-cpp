...
class CancelledSpotInstanceRequest {
 public:
  ...
  template <typename SpotInstanceRequestIdT = Aws::String>
  CancelledSpotInstanceRequest& WithSpotInstanceRequestId(SpotInstanceRequestIdT&& value) {
  ...
  inline void SetState(CancelSpotInstanceRequestState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline CancelledSpotInstanceRequest& WithState(CancelSpotInstanceRequestState value) {
    SetState(value);
    return *this;
  }
  ///@}
