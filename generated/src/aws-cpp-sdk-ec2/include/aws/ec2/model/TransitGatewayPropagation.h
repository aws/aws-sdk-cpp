...
class TransitGatewayPropagation {
 public:
  ...
  inline TransitGatewayPropagation& WithResourceType(TransitGatewayAttachmentResourceType value) {
  ...
  inline TransitGatewayPropagation& WithState(TransitGatewayPropagationState value) {
    SetState(value);
    return *this;
  }
  ///@}
