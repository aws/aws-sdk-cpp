...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DisassociateVpcCidrBlockResponse() = default;
    ...
    template<typename Ipv6CidrBlockAssociationT = VpcIpv6CidrBlockAssociation>
    DisassociateVpcCidrBlockResponse& WithIpv6CidrBlockAssociation(Ipv6CidrBlockAssociationT&& value) { SetIpv6CidrBlockAssociation(std::forward<Ipv6CidrBlockAssociationT>(value)); return *this;}
    ///@}
    ...
    template<typename CidrBlockAssociationT = VpcCidrBlockAssociation>
    DisassociateVpcCidrBlockResponse& WithCidrBlockAssociation(CidrBlockAssociationT&& value) { SetCidrBlockAssociation(std::forward<CidrBlockAssociationT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcIdT = Aws::String>
    DisassociateVpcCidrBlockResponse& WithVpcId(VpcIdT&& value) { SetVpcId(std::forward<VpcIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DisassociateVpcCidrBlockResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
