...
class DataResponse {
 public:
  ...
  inline DataResponse& WithMetric(MetricType value) {
    SetMetric(value);
    return *this;
  }
  ///@}
  ...
  inline DataResponse& WithStatistic(StatisticType value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPeriod(PeriodType value) {
    m_periodHasBeenSet = true;
    m_period = value;
  }
  inline DataResponse& WithPeriod(PeriodType value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  void SetMetricPoints(MetricPointsT&& value) {
    ...
    m_metricPoints = std::forward<MetricPointsT>(value);
  }
  template <typename MetricPointsT = Aws::Vector<MetricPoint>>
  DataResponse& WithMetricPoints(MetricPointsT&& value) {
    SetMetricPoints(std::forward<MetricPointsT>(value));
    return *this;
  }
  template <typename MetricPointsT = MetricPoint>
  DataResponse& AddMetricPoints(MetricPointsT&& value) {
    m_metricPointsHasBeenSet = true;
    m_metricPoints.emplace_back(std::forward<MetricPointsT>(value));
    return *this;
  }
  ///@}
 private:
