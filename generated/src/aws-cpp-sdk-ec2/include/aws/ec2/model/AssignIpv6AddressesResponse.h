...
class AssignIpv6AddressesResponse {
 public:
  ...
  void SetAssignedIpv6Addresses(AssignedIpv6AddressesT&& value) {
    m_assignedIpv6AddressesHasBeenSet = true;
    m_assignedIpv6Addresses = std::forward<AssignedIpv6AddressesT>(value);
  }
  template <typename AssignedIpv6AddressesT = Aws::Vector<Aws::String>>
  AssignIpv6AddressesResponse& WithAssignedIpv6Addresses(AssignedIpv6AddressesT&& value) {
    SetAssignedIpv6Addresses(std::forward<AssignedIpv6AddressesT>(value));
    return *this;
  }
  template <typename AssignedIpv6AddressesT = Aws::String>
  AssignIpv6AddressesResponse& AddAssignedIpv6Addresses(AssignedIpv6AddressesT&& value) {
    m_assignedIpv6AddressesHasBeenSet = true;
    m_assignedIpv6Addresses.emplace_back(std::forward<AssignedIpv6AddressesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssignedIpv6Prefixes(AssignedIpv6PrefixesT&& value) {
    m_assignedIpv6PrefixesHasBeenSet = true;
    m_assignedIpv6Prefixes = std::forward<AssignedIpv6PrefixesT>(value);
  }
  template <typename AssignedIpv6PrefixesT = Aws::Vector<Aws::String>>
  AssignIpv6AddressesResponse& WithAssignedIpv6Prefixes(AssignedIpv6PrefixesT&& value) {
    SetAssignedIpv6Prefixes(std::forward<AssignedIpv6PrefixesT>(value));
    return *this;
  }
  template <typename AssignedIpv6PrefixesT = Aws::String>
  AssignIpv6AddressesResponse& AddAssignedIpv6Prefixes(AssignedIpv6PrefixesT&& value) {
    m_assignedIpv6PrefixesHasBeenSet = true;
    m_assignedIpv6Prefixes.emplace_back(std::forward<AssignedIpv6PrefixesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  AssignIpv6AddressesResponse& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AssignIpv6AddressesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
