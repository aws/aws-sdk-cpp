...
class ModifyIpamRequest : public EC2Request {
 ...
 public:
  ...
  inline ModifyIpamRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyIpamRequest& WithTier(IpamTier value) {
    SetTier(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyIpamRequest& WithEnablePrivateGua(bool value) {
  ...
  inline ModifyIpamRequest& WithMeteredAccount(IpamMeteredAccount value) {
