...
class GetGroupsForCapacityReservationResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  GetGroupsForCapacityReservationResponse& WithNextToken(NextTokenT&& value) {
  ...
  void SetCapacityReservationGroups(CapacityReservationGroupsT&& value) {
    m_capacityReservationGroupsHasBeenSet = true;
    m_capacityReservationGroups = std::forward<CapacityReservationGroupsT>(value);
  }
  template <typename CapacityReservationGroupsT = Aws::Vector<CapacityReservationGroup>>
  GetGroupsForCapacityReservationResponse& WithCapacityReservationGroups(CapacityReservationGroupsT&& value) {
    SetCapacityReservationGroups(std::forward<CapacityReservationGroupsT>(value));
    return *this;
  }
  template <typename CapacityReservationGroupsT = CapacityReservationGroup>
  GetGroupsForCapacityReservationResponse& AddCapacityReservationGroups(CapacityReservationGroupsT&& value) {
    m_capacityReservationGroupsHasBeenSet = true;
    m_capacityReservationGroups.emplace_back(std::forward<CapacityReservationGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetGroupsForCapacityReservationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
