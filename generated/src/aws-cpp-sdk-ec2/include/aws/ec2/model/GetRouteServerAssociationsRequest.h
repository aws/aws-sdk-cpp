...
namespace Model
{
  ...
  /**
   */
  class GetRouteServerAssociationsRequest : public EC2Request
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetRouteServerAssociations"; }
  ...
  public:
    ...
    template<typename RouteServerIdT = Aws::String>
    GetRouteServerAssociationsRequest& WithRouteServerId(RouteServerIdT&& value) { SetRouteServerId(std::forward<RouteServerIdT>(value)); return *this;}
    ///@}
    ...
    inline GetRouteServerAssociationsRequest& WithDryRun(bool value) { SetDryRun(value); return *this;}
    ///@}
  private:
