...
class DescribeCoipPoolsResponse {
 public:
  ...
  void SetCoipPools(CoipPoolsT&& value) {
    m_coipPoolsHasBeenSet = true;
    m_coipPools = std::forward<CoipPoolsT>(value);
  }
  template <typename CoipPoolsT = Aws::Vector<CoipPool>>
  DescribeCoipPoolsResponse& WithCoipPools(CoipPoolsT&& value) {
    SetCoipPools(std::forward<CoipPoolsT>(value));
    return *this;
  }
  template <typename CoipPoolsT = CoipPool>
  DescribeCoipPoolsResponse& AddCoipPools(CoipPoolsT&& value) {
    m_coipPoolsHasBeenSet = true;
    m_coipPools.emplace_back(std::forward<CoipPoolsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeCoipPoolsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeCoipPoolsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
