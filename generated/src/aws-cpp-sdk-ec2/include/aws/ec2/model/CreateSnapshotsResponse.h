...
class CreateSnapshotsResponse {
 public:
  ...
  template <typename SnapshotsT = Aws::Vector<SnapshotInfo>>
  CreateSnapshotsResponse& WithSnapshots(SnapshotsT&& value) {
    SetSnapshots(std::forward<SnapshotsT>(value));
    return *this;
  }
  template <typename SnapshotsT = SnapshotInfo>
  CreateSnapshotsResponse& AddSnapshots(SnapshotsT&& value) {
    m_snapshotsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateSnapshotsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
