...
class DescribeFlowLogsResponse {
 public:
  ...
  template <typename FlowLogsT = Aws::Vector<FlowLog>>
  DescribeFlowLogsResponse& WithFlowLogs(FlowLogsT&& value) {
    SetFlowLogs(std::forward<FlowLogsT>(value));
    return *this;
  }
  template <typename FlowLogsT = FlowLog>
  DescribeFlowLogsResponse& AddFlowLogs(FlowLogsT&& value) {
    m_flowLogsHasBeenSet = true;
    m_flowLogs.emplace_back(std::forward<FlowLogsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFlowLogsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeFlowLogsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
