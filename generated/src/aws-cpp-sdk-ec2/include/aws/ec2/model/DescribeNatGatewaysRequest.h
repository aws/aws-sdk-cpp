...
class DescribeNatGatewaysRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeNatGatewaysRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeNatGatewaysRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
