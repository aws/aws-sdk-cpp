...
class ConnectionTrackingSpecificationResponse {
 public:
  AWS_EC2_API ConnectionTrackingSpecificationResponse() = default;
  ...
  inline ConnectionTrackingSpecificationResponse& WithTcpEstablishedTimeout(int value) {
  ...
  inline ConnectionTrackingSpecificationResponse& WithUdpStreamTimeout(int value) {
  ...
  inline ConnectionTrackingSpecificationResponse& WithUdpTimeout(int value) {
    SetUdpTimeout(value);
    return *this;
  }
  ///@}
