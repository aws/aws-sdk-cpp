...
class ModifyInstanceMaintenanceOptionsRequest : public EC2Request {
 ...
 public:
  ...
  inline ModifyInstanceMaintenanceOptionsRequest& WithAutoRecovery(InstanceAutoRecoveryState value) {
  ...
  inline ModifyInstanceMaintenanceOptionsRequest& WithRebootMigration(InstanceRebootMigrationState value) {
  ...
  inline ModifyInstanceMaintenanceOptionsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
