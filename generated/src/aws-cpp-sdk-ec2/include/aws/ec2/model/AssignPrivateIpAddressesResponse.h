...
class AssignPrivateIpAddressesResponse {
 public:
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  AssignPrivateIpAddressesResponse& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
  ...
  void SetAssignedPrivateIpAddresses(AssignedPrivateIpAddressesT&& value) {
    m_assignedPrivateIpAddressesHasBeenSet = true;
    m_assignedPrivateIpAddresses = std::forward<AssignedPrivateIpAddressesT>(value);
  }
  template <typename AssignedPrivateIpAddressesT = Aws::Vector<AssignedPrivateIpAddress>>
  AssignPrivateIpAddressesResponse& WithAssignedPrivateIpAddresses(AssignedPrivateIpAddressesT&& value) {
    SetAssignedPrivateIpAddresses(std::forward<AssignedPrivateIpAddressesT>(value));
    return *this;
  }
  template <typename AssignedPrivateIpAddressesT = AssignedPrivateIpAddress>
  AssignPrivateIpAddressesResponse& AddAssignedPrivateIpAddresses(AssignedPrivateIpAddressesT&& value) {
    m_assignedPrivateIpAddressesHasBeenSet = true;
    m_assignedPrivateIpAddresses.emplace_back(std::forward<AssignedPrivateIpAddressesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssignedIpv4Prefixes(AssignedIpv4PrefixesT&& value) {
    m_assignedIpv4PrefixesHasBeenSet = true;
    m_assignedIpv4Prefixes = std::forward<AssignedIpv4PrefixesT>(value);
  }
  template <typename AssignedIpv4PrefixesT = Aws::Vector<Ipv4PrefixSpecification>>
  AssignPrivateIpAddressesResponse& WithAssignedIpv4Prefixes(AssignedIpv4PrefixesT&& value) {
    SetAssignedIpv4Prefixes(std::forward<AssignedIpv4PrefixesT>(value));
    return *this;
  }
  template <typename AssignedIpv4PrefixesT = Ipv4PrefixSpecification>
  AssignPrivateIpAddressesResponse& AddAssignedIpv4Prefixes(AssignedIpv4PrefixesT&& value) {
    m_assignedIpv4PrefixesHasBeenSet = true;
    m_assignedIpv4Prefixes.emplace_back(std::forward<AssignedIpv4PrefixesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AssignPrivateIpAddressesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
