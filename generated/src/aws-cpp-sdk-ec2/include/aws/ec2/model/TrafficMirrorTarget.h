...
class TrafficMirrorTarget {
 public:
  ...
  template <typename TrafficMirrorTargetIdT = Aws::String>
  TrafficMirrorTarget& WithTrafficMirrorTargetId(TrafficMirrorTargetIdT&& value) {
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  TrafficMirrorTarget& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
  ...
  template <typename NetworkLoadBalancerArnT = Aws::String>
  TrafficMirrorTarget& WithNetworkLoadBalancerArn(NetworkLoadBalancerArnT&& value) {
  ...
  inline void SetType(TrafficMirrorTargetType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TrafficMirrorTarget& WithType(TrafficMirrorTargetType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  TrafficMirrorTarget& WithDescription(DescriptionT&& value) {
  ...
  template <typename OwnerIdT = Aws::String>
  TrafficMirrorTarget& WithOwnerId(OwnerIdT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  TrafficMirrorTarget& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  TrafficMirrorTarget& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename GatewayLoadBalancerEndpointIdT = Aws::String>
  TrafficMirrorTarget& WithGatewayLoadBalancerEndpointId(GatewayLoadBalancerEndpointIdT&& value) {
