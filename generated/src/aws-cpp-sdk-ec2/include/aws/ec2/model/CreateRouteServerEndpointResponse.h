...
class CreateRouteServerEndpointResponse {
 public:
  ...
  void SetRouteServerEndpoint(RouteServerEndpointT&& value) {
    m_routeServerEndpointHasBeenSet = true;
    m_routeServerEndpoint = std::forward<RouteServerEndpointT>(value);
  }
  template <typename RouteServerEndpointT = RouteServerEndpoint>
  CreateRouteServerEndpointResponse& WithRouteServerEndpoint(RouteServerEndpointT&& value) {
    SetRouteServerEndpoint(std::forward<RouteServerEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateRouteServerEndpointResponse& WithResponseMetadata(ResponseMetadataT&& value) {
