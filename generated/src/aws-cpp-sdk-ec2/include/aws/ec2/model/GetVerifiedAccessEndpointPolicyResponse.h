...
class GetVerifiedAccessEndpointPolicyResponse {
 public:
  AWS_EC2_API GetVerifiedAccessEndpointPolicyResponse() = default;
  ...
  inline void SetPolicyEnabled(bool value) {
    m_policyEnabledHasBeenSet = true;
    m_policyEnabled = value;
  }
  inline GetVerifiedAccessEndpointPolicyResponse& WithPolicyEnabled(bool value) {
  ...
  template <typename PolicyDocumentT = Aws::String>
  GetVerifiedAccessEndpointPolicyResponse& WithPolicyDocument(PolicyDocumentT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetVerifiedAccessEndpointPolicyResponse& WithResponseMetadata(ResponseMetadataT&& value) {
