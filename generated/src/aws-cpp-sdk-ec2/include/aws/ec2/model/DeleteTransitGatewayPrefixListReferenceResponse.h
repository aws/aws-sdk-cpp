...
namespace Model
{
  ...
  public:
    ...
    template<typename TransitGatewayPrefixListReferenceT = TransitGatewayPrefixListReference>
    DeleteTransitGatewayPrefixListReferenceResponse& WithTransitGatewayPrefixListReference(TransitGatewayPrefixListReferenceT&& value) { SetTransitGatewayPrefixListReference(std::forward<TransitGatewayPrefixListReferenceT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteTransitGatewayPrefixListReferenceResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
