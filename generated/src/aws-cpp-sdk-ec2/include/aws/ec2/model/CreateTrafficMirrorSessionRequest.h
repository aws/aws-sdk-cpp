...
class CreateTrafficMirrorSessionRequest : public EC2Request {
 ...
 public:
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  CreateTrafficMirrorSessionRequest& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
  ...
  template <typename TrafficMirrorTargetIdT = Aws::String>
  CreateTrafficMirrorSessionRequest& WithTrafficMirrorTargetId(TrafficMirrorTargetIdT&& value) {
  ...
  template <typename TrafficMirrorFilterIdT = Aws::String>
  CreateTrafficMirrorSessionRequest& WithTrafficMirrorFilterId(TrafficMirrorFilterIdT&& value) {
  ...
  inline CreateTrafficMirrorSessionRequest& WithPacketLength(int value) {
  ...
  inline CreateTrafficMirrorSessionRequest& WithSessionNumber(int value) {
  ...
  inline CreateTrafficMirrorSessionRequest& WithVirtualNetworkId(int value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateTrafficMirrorSessionRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagSpecificationsT = Aws::Vector<TagSpecification>>
  CreateTrafficMirrorSessionRequest& WithTagSpecifications(TagSpecificationsT&& value) {
    SetTagSpecifications(std::forward<TagSpecificationsT>(value));
    return *this;
  }
  template <typename TagSpecificationsT = TagSpecification>
  CreateTrafficMirrorSessionRequest& AddTagSpecifications(TagSpecificationsT&& value) {
    m_tagSpecificationsHasBeenSet = true;
  ...
  inline CreateTrafficMirrorSessionRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTrafficMirrorSessionRequest& WithClientToken(ClientTokenT&& value) {
