...
class PrivateDnsNameOptionsOnLaunch {
 public:
  ...
  inline PrivateDnsNameOptionsOnLaunch& WithHostnameType(HostnameType value) {
  ...
  inline PrivateDnsNameOptionsOnLaunch& WithEnableResourceNameDnsARecord(bool value) {
  ...
  inline PrivateDnsNameOptionsOnLaunch& WithEnableResourceNameDnsAAAARecord(bool value) {
