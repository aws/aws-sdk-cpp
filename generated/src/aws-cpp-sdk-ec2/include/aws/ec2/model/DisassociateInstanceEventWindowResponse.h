...
class DisassociateInstanceEventWindowResponse {
 public:
  ...
  template <typename InstanceEventWindowT = InstanceEventWindow>
  DisassociateInstanceEventWindowResponse& WithInstanceEventWindow(InstanceEventWindowT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisassociateInstanceEventWindowResponse& WithResponseMetadata(ResponseMetadataT&& value) {
