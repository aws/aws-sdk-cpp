...
class CreateSnapshotRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetLocation(SnapshotLocationEnum value) {
    m_locationHasBeenSet = true;
    m_location = value;
  }
  inline CreateSnapshotRequest& WithLocation(SnapshotLocationEnum value) {
    SetLocation(value);
    return *this;
  }
  ///@}
  ...
  inline CreateSnapshotRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
