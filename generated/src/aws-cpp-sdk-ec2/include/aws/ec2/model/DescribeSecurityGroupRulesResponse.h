...
class DescribeSecurityGroupRulesResponse {
 public:
  ...
  template <typename SecurityGroupRulesT = Aws::Vector<SecurityGroupRule>>
  DescribeSecurityGroupRulesResponse& WithSecurityGroupRules(SecurityGroupRulesT&& value) {
    SetSecurityGroupRules(std::forward<SecurityGroupRulesT>(value));
    return *this;
  }
  template <typename SecurityGroupRulesT = SecurityGroupRule>
  DescribeSecurityGroupRulesResponse& AddSecurityGroupRules(SecurityGroupRulesT&& value) {
    m_securityGroupRulesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSecurityGroupRulesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeSecurityGroupRulesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
