...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DescribeSecurityGroupRulesResponse() = default;
    ...
    template<typename SecurityGroupRulesT = Aws::Vector<SecurityGroupRule>>
    DescribeSecurityGroupRulesResponse& WithSecurityGroupRules(SecurityGroupRulesT&& value) { SetSecurityGroupRules(std::forward<SecurityGroupRulesT>(value)); return *this;}
    template<typename SecurityGroupRulesT = SecurityGroupRule>
    DescribeSecurityGroupRulesResponse& AddSecurityGroupRules(SecurityGroupRulesT&& value) { m_securityGroupRulesHasBeenSet = true; m_securityGroupRules.emplace_back(std::forward<SecurityGroupRulesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeSecurityGroupRulesResponse& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DescribeSecurityGroupRulesResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
