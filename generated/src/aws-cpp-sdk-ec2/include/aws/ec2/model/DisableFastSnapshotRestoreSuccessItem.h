...
class DisableFastSnapshotRestoreSuccessItem {
 public:
  ...
  template <typename SnapshotIdT = Aws::String>
  DisableFastSnapshotRestoreSuccessItem& WithSnapshotId(SnapshotIdT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  DisableFastSnapshotRestoreSuccessItem& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename AvailabilityZoneIdT = Aws::String>
  DisableFastSnapshotRestoreSuccessItem& WithAvailabilityZoneId(AvailabilityZoneIdT&& value) {
  ...
  inline DisableFastSnapshotRestoreSuccessItem& WithState(FastSnapshotRestoreStateCode value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename StateTransitionReasonT = Aws::String>
  DisableFastSnapshotRestoreSuccessItem& WithStateTransitionReason(StateTransitionReasonT&& value) {
  ...
  template <typename OwnerIdT = Aws::String>
  DisableFastSnapshotRestoreSuccessItem& WithOwnerId(OwnerIdT&& value) {
  ...
  template <typename OwnerAliasT = Aws::String>
  DisableFastSnapshotRestoreSuccessItem& WithOwnerAlias(OwnerAliasT&& value) {
  ...
  template <typename EnablingTimeT = Aws::Utils::DateTime>
  DisableFastSnapshotRestoreSuccessItem& WithEnablingTime(EnablingTimeT&& value) {
  ...
  template <typename OptimizingTimeT = Aws::Utils::DateTime>
  DisableFastSnapshotRestoreSuccessItem& WithOptimizingTime(OptimizingTimeT&& value) {
  ...
  template <typename EnabledTimeT = Aws::Utils::DateTime>
  DisableFastSnapshotRestoreSuccessItem& WithEnabledTime(EnabledTimeT&& value) {
  ...
  template <typename DisablingTimeT = Aws::Utils::DateTime>
  DisableFastSnapshotRestoreSuccessItem& WithDisablingTime(DisablingTimeT&& value) {
  ...
  template <typename DisabledTimeT = Aws::Utils::DateTime>
  DisableFastSnapshotRestoreSuccessItem& WithDisabledTime(DisabledTimeT&& value) {
