...
namespace Model
{
  ...
  public:
    ...
    template<typename LicenseConfigurationArnT = Aws::String>
    ImportImageLicenseConfigurationResponse& WithLicenseConfigurationArn(LicenseConfigurationArnT&& value) { SetLicenseConfigurationArn(std::forward<LicenseConfigurationArnT>(value)); return *this;}
    ///@}
  private:
