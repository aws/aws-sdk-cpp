...
class GetTransitGatewayRouteTablePropagationsRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayRouteTableIdT = Aws::String>
  GetTransitGatewayRouteTablePropagationsRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  GetTransitGatewayRouteTablePropagationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  GetTransitGatewayRouteTablePropagationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline GetTransitGatewayRouteTablePropagationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetTransitGatewayRouteTablePropagationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetTransitGatewayRouteTablePropagationsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
