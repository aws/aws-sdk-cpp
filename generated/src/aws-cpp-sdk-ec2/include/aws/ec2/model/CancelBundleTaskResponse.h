...
class CancelBundleTaskResponse {
 public:
  ...
  void SetBundleTask(BundleTaskT&& value) {
    m_bundleTaskHasBeenSet = true;
    m_bundleTask = std::forward<BundleTaskT>(value);
  }
  template <typename BundleTaskT = BundleTask>
  CancelBundleTaskResponse& WithBundleTask(BundleTaskT&& value) {
    SetBundleTask(std::forward<BundleTaskT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CancelBundleTaskResponse& WithResponseMetadata(ResponseMetadataT&& value) {
