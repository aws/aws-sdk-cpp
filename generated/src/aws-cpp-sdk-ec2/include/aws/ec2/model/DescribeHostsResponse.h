...
class DescribeHostsResponse {
 public:
  ...
  template <typename HostsT = Aws::Vector<Host>>
  DescribeHostsResponse& WithHosts(HostsT&& value) {
    SetHosts(std::forward<HostsT>(value));
    return *this;
  }
  template <typename HostsT = Host>
  DescribeHostsResponse& AddHosts(HostsT&& value) {
    m_hostsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeHostsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeHostsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
