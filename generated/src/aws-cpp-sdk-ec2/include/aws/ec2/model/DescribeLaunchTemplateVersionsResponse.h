...
class DescribeLaunchTemplateVersionsResponse {
 public:
  ...
  void SetLaunchTemplateVersions(LaunchTemplateVersionsT&& value) {
    m_launchTemplateVersionsHasBeenSet = true;
    m_launchTemplateVersions = std::forward<LaunchTemplateVersionsT>(value);
  }
  template <typename LaunchTemplateVersionsT = Aws::Vector<LaunchTemplateVersion>>
  DescribeLaunchTemplateVersionsResponse& WithLaunchTemplateVersions(LaunchTemplateVersionsT&& value) {
    SetLaunchTemplateVersions(std::forward<LaunchTemplateVersionsT>(value));
    return *this;
  }
  template <typename LaunchTemplateVersionsT = LaunchTemplateVersion>
  DescribeLaunchTemplateVersionsResponse& AddLaunchTemplateVersions(LaunchTemplateVersionsT&& value) {
    m_launchTemplateVersionsHasBeenSet = true;
    m_launchTemplateVersions.emplace_back(std::forward<LaunchTemplateVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeLaunchTemplateVersionsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeLaunchTemplateVersionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
