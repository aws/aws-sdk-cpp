...
class ImportInstanceVolumeDetailItem {
 public:
  ...
  template <typename AvailabilityZoneT = Aws::String>
  ImportInstanceVolumeDetailItem& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename AvailabilityZoneIdT = Aws::String>
  ImportInstanceVolumeDetailItem& WithAvailabilityZoneId(AvailabilityZoneIdT&& value) {
  ...
  inline void SetBytesConverted(long long value) {
    m_bytesConvertedHasBeenSet = true;
    m_bytesConverted = value;
  }
  inline ImportInstanceVolumeDetailItem& WithBytesConverted(long long value) {
    SetBytesConverted(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  ImportInstanceVolumeDetailItem& WithDescription(DescriptionT&& value) {
  ...
  template <typename ImageT = DiskImageDescription>
  ImportInstanceVolumeDetailItem& WithImage(ImageT&& value) {
  ...
  template <typename StatusT = Aws::String>
  ImportInstanceVolumeDetailItem& WithStatus(StatusT&& value) {
  ...
  template <typename StatusMessageT = Aws::String>
  ImportInstanceVolumeDetailItem& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename VolumeT = DiskImageVolumeDescription>
  ImportInstanceVolumeDetailItem& WithVolume(VolumeT&& value) {
