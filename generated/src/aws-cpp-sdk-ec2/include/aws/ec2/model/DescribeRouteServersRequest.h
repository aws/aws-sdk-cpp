...
class DescribeRouteServersRequest : public EC2Request {
 ...
 public:
  ...
  void SetRouteServerIds(RouteServerIdsT&& value) {
    m_routeServerIdsHasBeenSet = true;
    m_routeServerIds = std::forward<RouteServerIdsT>(value);
  }
  template <typename RouteServerIdsT = Aws::Vector<Aws::String>>
  DescribeRouteServersRequest& WithRouteServerIds(RouteServerIdsT&& value) {
    SetRouteServerIds(std::forward<RouteServerIdsT>(value));
    return *this;
  }
  template <typename RouteServerIdsT = Aws::String>
  DescribeRouteServersRequest& AddRouteServerIds(RouteServerIdsT&& value) {
    m_routeServerIdsHasBeenSet = true;
    m_routeServerIds.emplace_back(std::forward<RouteServerIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeRouteServersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeRouteServersRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
