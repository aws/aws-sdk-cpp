...
class DescribeTransitGatewayPeeringAttachmentsRequest : public EC2Request {
 ...
 public:
  ...
  void SetTransitGatewayAttachmentIds(TransitGatewayAttachmentIdsT&& value) {
    m_transitGatewayAttachmentIdsHasBeenSet = true;
    m_transitGatewayAttachmentIds = std::forward<TransitGatewayAttachmentIdsT>(value);
  }
  template <typename TransitGatewayAttachmentIdsT = Aws::Vector<Aws::String>>
  DescribeTransitGatewayPeeringAttachmentsRequest& WithTransitGatewayAttachmentIds(TransitGatewayAttachmentIdsT&& value) {
    SetTransitGatewayAttachmentIds(std::forward<TransitGatewayAttachmentIdsT>(value));
    return *this;
  }
  ...
  DescribeTransitGatewayPeeringAttachmentsRequest& AddTransitGatewayAttachmentIds(TransitGatewayAttachmentIdsT&& value) {
    m_transitGatewayAttachmentIdsHasBeenSet = true;
    m_transitGatewayAttachmentIds.emplace_back(std::forward<TransitGatewayAttachmentIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeTransitGatewayPeeringAttachmentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeTransitGatewayPeeringAttachmentsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
