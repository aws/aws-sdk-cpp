...
namespace Model
{
  ...
  public:
    ...
    template<typename TransitGatewayAttachmentIdsT = Aws::Vector<Aws::String>>
    DescribeTransitGatewayPeeringAttachmentsRequest& WithTransitGatewayAttachmentIds(TransitGatewayAttachmentIdsT&& value) { SetTransitGatewayAttachmentIds(std::forward<TransitGatewayAttachmentIdsT>(value)); return *this;}
    template<typename TransitGatewayAttachmentIdsT = Aws::String>
    DescribeTransitGatewayPeeringAttachmentsRequest& AddTransitGatewayAttachmentIds(TransitGatewayAttachmentIdsT&& value) { m_transitGatewayAttachmentIdsHasBeenSet = true; m_transitGatewayAttachmentIds.emplace_back(std::forward<TransitGatewayAttachmentIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    DescribeTransitGatewayPeeringAttachmentsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    DescribeTransitGatewayPeeringAttachmentsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeTransitGatewayPeeringAttachmentsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
