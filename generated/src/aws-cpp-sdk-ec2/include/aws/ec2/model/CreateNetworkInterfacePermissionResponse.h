...
class CreateNetworkInterfacePermissionResponse {
 public:
  ...
  void SetInterfacePermission(InterfacePermissionT&& value) {
    m_interfacePermissionHasBeenSet = true;
    m_interfacePermission = std::forward<InterfacePermissionT>(value);
  }
  template <typename InterfacePermissionT = NetworkInterfacePermission>
  CreateNetworkInterfacePermissionResponse& WithInterfacePermission(InterfacePermissionT&& value) {
    SetInterfacePermission(std::forward<InterfacePermissionT>(value));
    return *this;
  }
  ///@}
