...
class RequestSpotInstancesResponse {
 public:
  ...
  void SetSpotInstanceRequests(SpotInstanceRequestsT&& value) {
    ...
    m_spotInstanceRequests = std::forward<SpotInstanceRequestsT>(value);
  }
  template <typename SpotInstanceRequestsT = Aws::Vector<SpotInstanceRequest>>
  RequestSpotInstancesResponse& WithSpotInstanceRequests(SpotInstanceRequestsT&& value) {
    SetSpotInstanceRequests(std::forward<SpotInstanceRequestsT>(value));
    return *this;
  }
  template <typename SpotInstanceRequestsT = SpotInstanceRequest>
  RequestSpotInstancesResponse& AddSpotInstanceRequests(SpotInstanceRequestsT&& value) {
    m_spotInstanceRequestsHasBeenSet = true;
    m_spotInstanceRequests.emplace_back(std::forward<SpotInstanceRequestsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RequestSpotInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
