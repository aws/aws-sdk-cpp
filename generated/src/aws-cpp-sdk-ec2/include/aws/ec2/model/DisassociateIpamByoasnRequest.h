...
class DisassociateIpamByoasnRequest : public EC2Request {
 ...
 public:
  ...
  inline DisassociateIpamByoasnRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename AsnT = Aws::String>
  DisassociateIpamByoasnRequest& WithAsn(AsnT&& value) {
  ...
  template <typename CidrT = Aws::String>
  DisassociateIpamByoasnRequest& WithCidr(CidrT&& value) {
