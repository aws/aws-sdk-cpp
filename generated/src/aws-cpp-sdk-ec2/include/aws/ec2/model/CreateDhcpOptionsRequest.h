...
class CreateDhcpOptionsRequest : public EC2Request {
 ...
 public:
  ...
  void SetDhcpConfigurations(DhcpConfigurationsT&& value) {
    ...
    m_dhcpConfigurations = std::forward<DhcpConfigurationsT>(value);
  }
  template <typename DhcpConfigurationsT = Aws::Vector<NewDhcpConfiguration>>
  CreateDhcpOptionsRequest& WithDhcpConfigurations(DhcpConfigurationsT&& value) {
    SetDhcpConfigurations(std::forward<DhcpConfigurationsT>(value));
    return *this;
  }
  ...
  CreateDhcpOptionsRequest& AddDhcpConfigurations(DhcpConfigurationsT&& value) {
    m_dhcpConfigurationsHasBeenSet = true;
    m_dhcpConfigurations.emplace_back(std::forward<DhcpConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateDhcpOptionsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
