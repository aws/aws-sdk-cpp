...
namespace Model
{
  ...
  public:
    ...
    template<typename BucketT = Aws::String>
    CreateSpotDatafeedSubscriptionRequest& WithBucket(BucketT&& value) { SetBucket(std::forward<BucketT>(value)); return *this;}
    ///@}
    ...
    template<typename PrefixT = Aws::String>
    CreateSpotDatafeedSubscriptionRequest& WithPrefix(PrefixT&& value) { SetPrefix(std::forward<PrefixT>(value)); return *this;}
    ///@}
  private:
