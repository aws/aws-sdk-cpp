...
class ResetInstanceAttributeRequest : public EC2Request {
 ...
 public:
  ...
  inline ResetInstanceAttributeRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstanceIdT = Aws::String>
  ResetInstanceAttributeRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline ResetInstanceAttributeRequest& WithAttribute(InstanceAttributeName value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
