...
class UnassignPrivateNatGatewayAddressRequest : public EC2Request {
 public:
  AWS_EC2_API UnassignPrivateNatGatewayAddressRequest() = default;
 ...
 public:
  ...
  template <typename NatGatewayIdT = Aws::String>
  UnassignPrivateNatGatewayAddressRequest& WithNatGatewayId(NatGatewayIdT&& value) {
  ...
  template <typename PrivateIpAddressesT = Aws::Vector<Aws::String>>
  UnassignPrivateNatGatewayAddressRequest& WithPrivateIpAddresses(PrivateIpAddressesT&& value) {
    SetPrivateIpAddresses(std::forward<PrivateIpAddressesT>(value));
    return *this;
  }
  template <typename PrivateIpAddressesT = Aws::String>
  UnassignPrivateNatGatewayAddressRequest& AddPrivateIpAddresses(PrivateIpAddressesT&& value) {
    m_privateIpAddressesHasBeenSet = true;
  ...
  inline UnassignPrivateNatGatewayAddressRequest& WithMaxDrainDurationSeconds(int value) {
  ...
  inline UnassignPrivateNatGatewayAddressRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
