...
class DescribeLocalGatewayRouteTableVpcAssociationsRequest : public EC2Request {
 ...
 public:
   ...
   */
  inline const Aws::Vector<Aws::String>& GetLocalGatewayRouteTableVpcAssociationIds() const {
    return m_localGatewayRouteTableVpcAssociationIds;
  }
  ...
  void SetLocalGatewayRouteTableVpcAssociationIds(LocalGatewayRouteTableVpcAssociationIdsT&& value) {
    m_localGatewayRouteTableVpcAssociationIdsHasBeenSet = true;
    m_localGatewayRouteTableVpcAssociationIds = std::forward<LocalGatewayRouteTableVpcAssociationIdsT>(value);
  }
  template <typename LocalGatewayRouteTableVpcAssociationIdsT = Aws::Vector<Aws::String>>
  DescribeLocalGatewayRouteTableVpcAssociationsRequest& WithLocalGatewayRouteTableVpcAssociationIds(
      LocalGatewayRouteTableVpcAssociationIdsT&& value) {
    SetLocalGatewayRouteTableVpcAssociationIds(std::forward<LocalGatewayRouteTableVpcAssociationIdsT>(value));
    return *this;
  }
  template <typename LocalGatewayRouteTableVpcAssociationIdsT = Aws::String>
  DescribeLocalGatewayRouteTableVpcAssociationsRequest& AddLocalGatewayRouteTableVpcAssociationIds(
      LocalGatewayRouteTableVpcAssociationIdsT&& value) {
    m_localGatewayRouteTableVpcAssociationIdsHasBeenSet = true;
    m_localGatewayRouteTableVpcAssociationIds.emplace_back(std::forward<LocalGatewayRouteTableVpcAssociationIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeLocalGatewayRouteTableVpcAssociationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeLocalGatewayRouteTableVpcAssociationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeLocalGatewayRouteTableVpcAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeLocalGatewayRouteTableVpcAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeLocalGatewayRouteTableVpcAssociationsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
