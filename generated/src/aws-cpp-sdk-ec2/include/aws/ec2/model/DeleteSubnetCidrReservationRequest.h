...
class DeleteSubnetCidrReservationRequest : public EC2Request {
 ...
 public:
  ...
  void SetSubnetCidrReservationId(SubnetCidrReservationIdT&& value) {
    ...
    m_subnetCidrReservationId = std::forward<SubnetCidrReservationIdT>(value);
  }
  template <typename SubnetCidrReservationIdT = Aws::String>
  DeleteSubnetCidrReservationRequest& WithSubnetCidrReservationId(SubnetCidrReservationIdT&& value) {
    SetSubnetCidrReservationId(std::forward<SubnetCidrReservationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DeleteSubnetCidrReservationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
