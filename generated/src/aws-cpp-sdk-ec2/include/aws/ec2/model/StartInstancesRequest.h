...
class StartInstancesRequest : public EC2Request {
 ...
 public:
  ...
  template <typename InstanceIdsT = Aws::Vector<Aws::String>>
  StartInstancesRequest& WithInstanceIds(InstanceIdsT&& value) {
    SetInstanceIds(std::forward<InstanceIdsT>(value));
    return *this;
  }
  template <typename InstanceIdsT = Aws::String>
  StartInstancesRequest& AddInstanceIds(InstanceIdsT&& value) {
    m_instanceIdsHasBeenSet = true;
  ...
  template <typename AdditionalInfoT = Aws::String>
  StartInstancesRequest& WithAdditionalInfo(AdditionalInfoT&& value) {
  ...
  inline StartInstancesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
