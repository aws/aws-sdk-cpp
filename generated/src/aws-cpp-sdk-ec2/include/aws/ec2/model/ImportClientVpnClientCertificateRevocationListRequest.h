...
class ImportClientVpnClientCertificateRevocationListRequest : public EC2Request {
 ...
 public:
  ...
  template <typename ClientVpnEndpointIdT = Aws::String>
  ImportClientVpnClientCertificateRevocationListRequest& WithClientVpnEndpointId(ClientVpnEndpointIdT&& value) {
  ...
  void SetCertificateRevocationList(CertificateRevocationListT&& value) {
    m_certificateRevocationListHasBeenSet = true;
    m_certificateRevocationList = std::forward<CertificateRevocationListT>(value);
  }
  template <typename CertificateRevocationListT = Aws::String>
  ImportClientVpnClientCertificateRevocationListRequest& WithCertificateRevocationList(CertificateRevocationListT&& value) {
    SetCertificateRevocationList(std::forward<CertificateRevocationListT>(value));
    return *this;
  }
  ///@}
  ...
  inline ImportClientVpnClientCertificateRevocationListRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
