...
/**
 * <p>Contains the CPU configuration options for a Dedicated Host allocation
 * request. Options include AMD Secure Encrypted Virtualization-Secure Nested
 * Paging (AMD SEV-SNP) settings.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/HostCpuOptionsRequest">AWS
 * API Reference</a></p>
 */
class HostCpuOptionsRequest {
 public:
  AWS_EC2_API HostCpuOptionsRequest() = default;
  AWS_EC2_API HostCpuOptionsRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_EC2_API HostCpuOptionsRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  inline HostCpuOptionsRequest& WithAmdSevSnp(AmdSevSnp value) {
    SetAmdSevSnp(value);
    return *this;
  }
  ///@}
