...
class DeleteTransitGatewayRouteRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayRouteTableIdT = Aws::String>
  DeleteTransitGatewayRouteRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) {
  ...
  template <typename DestinationCidrBlockT = Aws::String>
  DeleteTransitGatewayRouteRequest& WithDestinationCidrBlock(DestinationCidrBlockT&& value) {
  ...
  inline DeleteTransitGatewayRouteRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
