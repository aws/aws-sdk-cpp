...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API PrivateDnsNameOptionsRequest() = default;
    ...
    inline PrivateDnsNameOptionsRequest& WithHostnameType(HostnameType value) { SetHostnameType(value); return *this;}
    ///@}
