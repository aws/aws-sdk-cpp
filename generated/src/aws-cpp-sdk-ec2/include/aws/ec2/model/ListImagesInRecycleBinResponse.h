...
class ListImagesInRecycleBinResponse {
 public:
  ...
  template <typename ImagesT = Aws::Vector<ImageRecycleBinInfo>>
  ListImagesInRecycleBinResponse& WithImages(ImagesT&& value) {
    SetImages(std::forward<ImagesT>(value));
    return *this;
  }
  template <typename ImagesT = ImageRecycleBinInfo>
  ListImagesInRecycleBinResponse& AddImages(ImagesT&& value) {
    m_imagesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListImagesInRecycleBinResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListImagesInRecycleBinResponse& WithResponseMetadata(ResponseMetadataT&& value) {
