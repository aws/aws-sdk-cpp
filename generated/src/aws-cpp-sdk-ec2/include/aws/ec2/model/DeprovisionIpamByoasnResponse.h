...
class DeprovisionIpamByoasnResponse {
 public:
  ...
  void SetByoasn(ByoasnT&& value) {
    m_byoasnHasBeenSet = true;
    m_byoasn = std::forward<ByoasnT>(value);
  }
  template <typename ByoasnT = Byoasn>
  DeprovisionIpamByoasnResponse& WithByoasn(ByoasnT&& value) {
    SetByoasn(std::forward<ByoasnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeprovisionIpamByoasnResponse& WithResponseMetadata(ResponseMetadataT&& value) {
