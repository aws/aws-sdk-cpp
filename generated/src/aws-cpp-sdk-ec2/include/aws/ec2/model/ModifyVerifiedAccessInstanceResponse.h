...
class ModifyVerifiedAccessInstanceResponse {
 public:
  ...
  template <typename VerifiedAccessInstanceT = VerifiedAccessInstance>
  ModifyVerifiedAccessInstanceResponse& WithVerifiedAccessInstance(VerifiedAccessInstanceT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyVerifiedAccessInstanceResponse& WithResponseMetadata(ResponseMetadataT&& value) {
