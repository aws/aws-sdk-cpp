...
class GetRouteServerAssociationsResponse {
 public:
  ...
  void SetRouteServerAssociations(RouteServerAssociationsT&& value) {
    m_routeServerAssociationsHasBeenSet = true;
    m_routeServerAssociations = std::forward<RouteServerAssociationsT>(value);
  }
  template <typename RouteServerAssociationsT = Aws::Vector<RouteServerAssociation>>
  GetRouteServerAssociationsResponse& WithRouteServerAssociations(RouteServerAssociationsT&& value) {
    SetRouteServerAssociations(std::forward<RouteServerAssociationsT>(value));
    return *this;
  }
  ...
  GetRouteServerAssociationsResponse& AddRouteServerAssociations(RouteServerAssociationsT&& value) {
    m_routeServerAssociationsHasBeenSet = true;
    m_routeServerAssociations.emplace_back(std::forward<RouteServerAssociationsT>(value));
    return *this;
  }
  ///@}
