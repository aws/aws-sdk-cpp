...
class DeleteVerifiedAccessTrustProviderRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VerifiedAccessTrustProviderIdT = Aws::String>
  DeleteVerifiedAccessTrustProviderRequest& WithVerifiedAccessTrustProviderId(VerifiedAccessTrustProviderIdT&& value) {
  ...
  inline DeleteVerifiedAccessTrustProviderRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteVerifiedAccessTrustProviderRequest& WithClientToken(ClientTokenT&& value) {
