...
class DeleteRouteServerEndpointResponse {
 public:
  ...
  template <typename RouteServerEndpointT = RouteServerEndpoint>
  DeleteRouteServerEndpointResponse& WithRouteServerEndpoint(RouteServerEndpointT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteRouteServerEndpointResponse& WithResponseMetadata(ResponseMetadataT&& value) {
