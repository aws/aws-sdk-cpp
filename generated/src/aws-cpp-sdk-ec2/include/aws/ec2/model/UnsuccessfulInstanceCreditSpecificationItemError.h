...
class UnsuccessfulInstanceCreditSpecificationItemError {
 public:
  ...
  inline void SetCode(UnsuccessfulInstanceCreditSpecificationErrorCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline UnsuccessfulInstanceCreditSpecificationItemError& WithCode(UnsuccessfulInstanceCreditSpecificationErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  UnsuccessfulInstanceCreditSpecificationItemError& WithMessage(MessageT&& value) {
