...
class DisassociateEnclaveCertificateIamRoleRequest : public EC2Request {
 public:
  AWS_EC2_API DisassociateEnclaveCertificateIamRoleRequest() = default;
 ...
 public:
  ...
  template <typename CertificateArnT = Aws::String>
  DisassociateEnclaveCertificateIamRoleRequest& WithCertificateArn(CertificateArnT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  DisassociateEnclaveCertificateIamRoleRequest& WithRoleArn(RoleArnT&& value) {
  ...
  inline DisassociateEnclaveCertificateIamRoleRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
