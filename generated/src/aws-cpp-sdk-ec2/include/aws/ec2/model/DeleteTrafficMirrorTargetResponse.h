...
class DeleteTrafficMirrorTargetResponse {
 public:
  ...
  template <typename TrafficMirrorTargetIdT = Aws::String>
  DeleteTrafficMirrorTargetResponse& WithTrafficMirrorTargetId(TrafficMirrorTargetIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteTrafficMirrorTargetResponse& WithResponseMetadata(ResponseMetadataT&& value) {
