...
namespace Model
{
  ...
  public:
    ...
    template<typename TunnelInsideCidrT = Aws::String>
    VpnTunnelOptionsSpecification& WithTunnelInsideCidr(TunnelInsideCidrT&& value) { SetTunnelInsideCidr(std::forward<TunnelInsideCidrT>(value)); return *this;}
    ///@}
    ...
    template<typename TunnelInsideIpv6CidrT = Aws::String>
    VpnTunnelOptionsSpecification& WithTunnelInsideIpv6Cidr(TunnelInsideIpv6CidrT&& value) { SetTunnelInsideIpv6Cidr(std::forward<TunnelInsideIpv6CidrT>(value)); return *this;}
    ///@}
    ...
    template<typename PreSharedKeyT = Aws::String>
    VpnTunnelOptionsSpecification& WithPreSharedKey(PreSharedKeyT&& value) { SetPreSharedKey(std::forward<PreSharedKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename DPDTimeoutActionT = Aws::String>
    VpnTunnelOptionsSpecification& WithDPDTimeoutAction(DPDTimeoutActionT&& value) { SetDPDTimeoutAction(std::forward<DPDTimeoutActionT>(value)); return *this;}
    ///@}
    ...
    template<typename Phase1EncryptionAlgorithmsT = Aws::Vector<Phase1EncryptionAlgorithmsRequestListValue>>
    VpnTunnelOptionsSpecification& WithPhase1EncryptionAlgorithms(Phase1EncryptionAlgorithmsT&& value) { SetPhase1EncryptionAlgorithms(std::forward<Phase1EncryptionAlgorithmsT>(value)); return *this;}
    template<typename Phase1EncryptionAlgorithmsT = Phase1EncryptionAlgorithmsRequestListValue>
    VpnTunnelOptionsSpecification& AddPhase1EncryptionAlgorithms(Phase1EncryptionAlgorithmsT&& value) { m_phase1EncryptionAlgorithmsHasBeenSet = true; m_phase1EncryptionAlgorithms.emplace_back(std::forward<Phase1EncryptionAlgorithmsT>(value)); return *this; }
    ///@}
    ...
    template<typename Phase2EncryptionAlgorithmsT = Aws::Vector<Phase2EncryptionAlgorithmsRequestListValue>>
    VpnTunnelOptionsSpecification& WithPhase2EncryptionAlgorithms(Phase2EncryptionAlgorithmsT&& value) { SetPhase2EncryptionAlgorithms(std::forward<Phase2EncryptionAlgorithmsT>(value)); return *this;}
    template<typename Phase2EncryptionAlgorithmsT = Phase2EncryptionAlgorithmsRequestListValue>
    VpnTunnelOptionsSpecification& AddPhase2EncryptionAlgorithms(Phase2EncryptionAlgorithmsT&& value) { m_phase2EncryptionAlgorithmsHasBeenSet = true; m_phase2EncryptionAlgorithms.emplace_back(std::forward<Phase2EncryptionAlgorithmsT>(value)); return *this; }
    ///@}
    ...
    template<typename Phase1IntegrityAlgorithmsT = Aws::Vector<Phase1IntegrityAlgorithmsRequestListValue>>
    VpnTunnelOptionsSpecification& WithPhase1IntegrityAlgorithms(Phase1IntegrityAlgorithmsT&& value) { SetPhase1IntegrityAlgorithms(std::forward<Phase1IntegrityAlgorithmsT>(value)); return *this;}
    template<typename Phase1IntegrityAlgorithmsT = Phase1IntegrityAlgorithmsRequestListValue>
    VpnTunnelOptionsSpecification& AddPhase1IntegrityAlgorithms(Phase1IntegrityAlgorithmsT&& value) { m_phase1IntegrityAlgorithmsHasBeenSet = true; m_phase1IntegrityAlgorithms.emplace_back(std::forward<Phase1IntegrityAlgorithmsT>(value)); return *this; }
    ///@}
    ...
    template<typename Phase2IntegrityAlgorithmsT = Aws::Vector<Phase2IntegrityAlgorithmsRequestListValue>>
    VpnTunnelOptionsSpecification& WithPhase2IntegrityAlgorithms(Phase2IntegrityAlgorithmsT&& value) { SetPhase2IntegrityAlgorithms(std::forward<Phase2IntegrityAlgorithmsT>(value)); return *this;}
    template<typename Phase2IntegrityAlgorithmsT = Phase2IntegrityAlgorithmsRequestListValue>
    VpnTunnelOptionsSpecification& AddPhase2IntegrityAlgorithms(Phase2IntegrityAlgorithmsT&& value) { m_phase2IntegrityAlgorithmsHasBeenSet = true; m_phase2IntegrityAlgorithms.emplace_back(std::forward<Phase2IntegrityAlgorithmsT>(value)); return *this; }
    ///@}
    ...
    template<typename Phase1DHGroupNumbersT = Aws::Vector<Phase1DHGroupNumbersRequestListValue>>
    VpnTunnelOptionsSpecification& WithPhase1DHGroupNumbers(Phase1DHGroupNumbersT&& value) { SetPhase1DHGroupNumbers(std::forward<Phase1DHGroupNumbersT>(value)); return *this;}
    template<typename Phase1DHGroupNumbersT = Phase1DHGroupNumbersRequestListValue>
    VpnTunnelOptionsSpecification& AddPhase1DHGroupNumbers(Phase1DHGroupNumbersT&& value) { m_phase1DHGroupNumbersHasBeenSet = true; m_phase1DHGroupNumbers.emplace_back(std::forward<Phase1DHGroupNumbersT>(value)); return *this; }
    ///@}
    ...
    template<typename Phase2DHGroupNumbersT = Aws::Vector<Phase2DHGroupNumbersRequestListValue>>
    VpnTunnelOptionsSpecification& WithPhase2DHGroupNumbers(Phase2DHGroupNumbersT&& value) { SetPhase2DHGroupNumbers(std::forward<Phase2DHGroupNumbersT>(value)); return *this;}
    template<typename Phase2DHGroupNumbersT = Phase2DHGroupNumbersRequestListValue>
    VpnTunnelOptionsSpecification& AddPhase2DHGroupNumbers(Phase2DHGroupNumbersT&& value) { m_phase2DHGroupNumbersHasBeenSet = true; m_phase2DHGroupNumbers.emplace_back(std::forward<Phase2DHGroupNumbersT>(value)); return *this; }
    ///@}
    ...
    template<typename IKEVersionsT = Aws::Vector<IKEVersionsRequestListValue>>
    VpnTunnelOptionsSpecification& WithIKEVersions(IKEVersionsT&& value) { SetIKEVersions(std::forward<IKEVersionsT>(value)); return *this;}
    template<typename IKEVersionsT = IKEVersionsRequestListValue>
    VpnTunnelOptionsSpecification& AddIKEVersions(IKEVersionsT&& value) { m_iKEVersionsHasBeenSet = true; m_iKEVersions.emplace_back(std::forward<IKEVersionsT>(value)); return *this; }
    ///@}
    ...
    template<typename StartupActionT = Aws::String>
    VpnTunnelOptionsSpecification& WithStartupAction(StartupActionT&& value) { SetStartupAction(std::forward<StartupActionT>(value)); return *this;}
    ///@}
    ...
    template<typename LogOptionsT = VpnTunnelLogOptionsSpecification>
    VpnTunnelOptionsSpecification& WithLogOptions(LogOptionsT&& value) { SetLogOptions(std::forward<LogOptionsT>(value)); return *this;}
    ///@}
    ...
    inline VpnTunnelOptionsSpecification& WithEnableTunnelLifecycleControl(bool value) { SetEnableTunnelLifecycleControl(value); return *this;}
    ///@}
  private:
