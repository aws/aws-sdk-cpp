...
class DescribeCapacityReservationFleetsRequest : public EC2Request {
 ...
 public:
  ...
  void SetCapacityReservationFleetIds(CapacityReservationFleetIdsT&& value) {
    m_capacityReservationFleetIdsHasBeenSet = true;
    m_capacityReservationFleetIds = std::forward<CapacityReservationFleetIdsT>(value);
  }
  template <typename CapacityReservationFleetIdsT = Aws::Vector<Aws::String>>
  DescribeCapacityReservationFleetsRequest& WithCapacityReservationFleetIds(CapacityReservationFleetIdsT&& value) {
    SetCapacityReservationFleetIds(std::forward<CapacityReservationFleetIdsT>(value));
    return *this;
  }
  template <typename CapacityReservationFleetIdsT = Aws::String>
  DescribeCapacityReservationFleetsRequest& AddCapacityReservationFleetIds(CapacityReservationFleetIdsT&& value) {
    m_capacityReservationFleetIdsHasBeenSet = true;
    m_capacityReservationFleetIds.emplace_back(std::forward<CapacityReservationFleetIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeCapacityReservationFleetsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeCapacityReservationFleetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeCapacityReservationFleetsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeCapacityReservationFleetsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeCapacityReservationFleetsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
