...
class AcceptReservedInstancesExchangeQuoteResponse {
 public:
  ...
  AWS_EC2_API AcceptReservedInstancesExchangeQuoteResponse& operator=(
  ...
  void SetExchangeId(ExchangeIdT&& value) {
    m_exchangeIdHasBeenSet = true;
    m_exchangeId = std::forward<ExchangeIdT>(value);
  }
  template <typename ExchangeIdT = Aws::String>
  AcceptReservedInstancesExchangeQuoteResponse& WithExchangeId(ExchangeIdT&& value) {
    SetExchangeId(std::forward<ExchangeIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AcceptReservedInstancesExchangeQuoteResponse& WithResponseMetadata(ResponseMetadataT&& value) {
