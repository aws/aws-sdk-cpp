...
class LaunchTemplateSpotMarketOptionsRequest {
 public:
  ...
  template <typename MaxPriceT = Aws::String>
  LaunchTemplateSpotMarketOptionsRequest& WithMaxPrice(MaxPriceT&& value) {
  ...
  inline void SetSpotInstanceType(SpotInstanceType value) {
    m_spotInstanceTypeHasBeenSet = true;
    m_spotInstanceType = value;
  }
  inline LaunchTemplateSpotMarketOptionsRequest& WithSpotInstanceType(SpotInstanceType value) {
    SetSpotInstanceType(value);
    return *this;
  }
  ///@}
  ...
  inline LaunchTemplateSpotMarketOptionsRequest& WithBlockDurationMinutes(int value) {
  ...
  template <typename ValidUntilT = Aws::Utils::DateTime>
  LaunchTemplateSpotMarketOptionsRequest& WithValidUntil(ValidUntilT&& value) {
  ...
  inline void SetInstanceInterruptionBehavior(InstanceInterruptionBehavior value) {
    m_instanceInterruptionBehaviorHasBeenSet = true;
    m_instanceInterruptionBehavior = value;
  }
  inline LaunchTemplateSpotMarketOptionsRequest& WithInstanceInterruptionBehavior(InstanceInterruptionBehavior value) {
    SetInstanceInterruptionBehavior(value);
    return *this;
  }
  ///@}
 private:
