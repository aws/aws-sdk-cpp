...
class RegisterInstanceEventNotificationAttributesResponse {
 public:
  ...
  AWS_EC2_API RegisterInstanceEventNotificationAttributesResponse& operator=(
  ...
  template <typename InstanceTagAttributeT = InstanceTagNotificationAttribute>
  RegisterInstanceEventNotificationAttributesResponse& WithInstanceTagAttribute(InstanceTagAttributeT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RegisterInstanceEventNotificationAttributesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
