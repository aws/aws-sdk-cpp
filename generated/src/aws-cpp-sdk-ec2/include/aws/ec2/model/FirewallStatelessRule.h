...
class FirewallStatelessRule {
 public:
  ...
  FirewallStatelessRule& AddDestinationPorts(DestinationPortsT&& value) {
    m_destinationPortsHasBeenSet = true;
    m_destinationPorts.emplace_back(std::forward<DestinationPortsT>(value));
    return *this;
  }
  ///@}
  ...
  inline FirewallStatelessRule& AddProtocols(int value) {
    m_protocolsHasBeenSet = true;
  ...
  inline FirewallStatelessRule& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
