...
class EnableImageBlockPublicAccessResponse {
 public:
  ...
  inline EnableImageBlockPublicAccessResponse& WithImageBlockPublicAccessState(ImageBlockPublicAccessEnabledState value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  EnableImageBlockPublicAccessResponse& WithResponseMetadata(ResponseMetadataT&& value) {
