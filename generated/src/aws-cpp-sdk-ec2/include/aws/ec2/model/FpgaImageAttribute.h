...
class FpgaImageAttribute {
 public:
  ...
  void SetLoadPermissions(LoadPermissionsT&& value) {
    ...
    m_loadPermissions = std::forward<LoadPermissionsT>(value);
  }
  template <typename LoadPermissionsT = Aws::Vector<LoadPermission>>
  FpgaImageAttribute& WithLoadPermissions(LoadPermissionsT&& value) {
    SetLoadPermissions(std::forward<LoadPermissionsT>(value));
    return *this;
  }
  template <typename LoadPermissionsT = LoadPermission>
  FpgaImageAttribute& AddLoadPermissions(LoadPermissionsT&& value) {
    m_loadPermissionsHasBeenSet = true;
    m_loadPermissions.emplace_back(std::forward<LoadPermissionsT>(value));
    return *this;
  }
  ///@}
