...
class CreateVerifiedAccessTrustProviderDeviceOptions {
 public:
  ...
  template <typename TenantIdT = Aws::String>
  CreateVerifiedAccessTrustProviderDeviceOptions& WithTenantId(TenantIdT&& value) {
  ...
  template <typename PublicSigningKeyUrlT = Aws::String>
  CreateVerifiedAccessTrustProviderDeviceOptions& WithPublicSigningKeyUrl(PublicSigningKeyUrlT&& value) {
