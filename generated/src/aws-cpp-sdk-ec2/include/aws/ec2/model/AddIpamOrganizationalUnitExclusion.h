...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AddIpamOrganizationalUnitExclusion">AWS
   * API Reference</a></p>
   */
  class AddIpamOrganizationalUnitExclusion
  {
  public:
    AWS_EC2_API AddIpamOrganizationalUnitExclusion();
    AWS_EC2_API AddIpamOrganizationalUnitExclusion(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_EC2_API AddIpamOrganizationalUnitExclusion& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
    ...
    inline AddIpamOrganizationalUnitExclusion& WithOrganizationsEntityPath(const Aws::String& value) { SetOrganizationsEntityPath(value); return *this;}
    inline AddIpamOrganizationalUnitExclusion& WithOrganizationsEntityPath(Aws::String&& value) { SetOrganizationsEntityPath(std::move(value)); return *this;}
    inline AddIpamOrganizationalUnitExclusion& WithOrganizationsEntityPath(const char* value) { SetOrganizationsEntityPath(value); return *this;}
    ///@}
  private:
