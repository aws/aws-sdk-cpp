...
namespace Model
{
  ...
  public:
    ...
    template<typename OrganizationsEntityPathT = Aws::String>
    AddIpamOrganizationalUnitExclusion& WithOrganizationsEntityPath(OrganizationsEntityPathT&& value) { SetOrganizationsEntityPath(std::forward<OrganizationsEntityPathT>(value)); return *this;}
    ///@}
  private:
