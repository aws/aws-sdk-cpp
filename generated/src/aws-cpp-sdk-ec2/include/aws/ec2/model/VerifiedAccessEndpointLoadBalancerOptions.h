...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API VerifiedAccessEndpointLoadBalancerOptions() = default;
    ...
    inline VerifiedAccessEndpointLoadBalancerOptions& WithProtocol(VerifiedAccessEndpointProtocol value) { SetProtocol(value); return *this;}
    ///@}
    ...
    template<typename LoadBalancerArnT = Aws::String>
    VerifiedAccessEndpointLoadBalancerOptions& WithLoadBalancerArn(LoadBalancerArnT&& value) { SetLoadBalancerArn(std::forward<LoadBalancerArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SubnetIdsT = Aws::Vector<Aws::String>>
    VerifiedAccessEndpointLoadBalancerOptions& WithSubnetIds(SubnetIdsT&& value) { SetSubnetIds(std::forward<SubnetIdsT>(value)); return *this;}
    template<typename SubnetIdsT = Aws::String>
    VerifiedAccessEndpointLoadBalancerOptions& AddSubnetIds(SubnetIdsT&& value) { m_subnetIdsHasBeenSet = true; m_subnetIds.emplace_back(std::forward<SubnetIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename PortRangesT = Aws::Vector<VerifiedAccessEndpointPortRange>>
    VerifiedAccessEndpointLoadBalancerOptions& WithPortRanges(PortRangesT&& value) { SetPortRanges(std::forward<PortRangesT>(value)); return *this;}
    template<typename PortRangesT = VerifiedAccessEndpointPortRange>
    VerifiedAccessEndpointLoadBalancerOptions& AddPortRanges(PortRangesT&& value) { m_portRangesHasBeenSet = true; m_portRanges.emplace_back(std::forward<PortRangesT>(value)); return *this; }
    ///@}
  private:
