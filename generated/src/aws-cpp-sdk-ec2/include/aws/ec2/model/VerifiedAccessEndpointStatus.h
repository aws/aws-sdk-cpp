...
class VerifiedAccessEndpointStatus {
 public:
  ...
  inline void SetCode(VerifiedAccessEndpointStatusCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline VerifiedAccessEndpointStatus& WithCode(VerifiedAccessEndpointStatusCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  VerifiedAccessEndpointStatus& WithMessage(MessageT&& value) {
