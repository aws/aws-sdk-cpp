...
class AssociateRouteServerRequest : public EC2Request {
 ...
 public:
  ...
  template <typename RouteServerIdT = Aws::String>
  AssociateRouteServerRequest& WithRouteServerId(RouteServerIdT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  AssociateRouteServerRequest& WithVpcId(VpcIdT&& value) {
  ...
  inline AssociateRouteServerRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
