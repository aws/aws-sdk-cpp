...
class DeleteTransitGatewayPrefixListReferenceRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayRouteTableIdT = Aws::String>
  DeleteTransitGatewayPrefixListReferenceRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) {
  ...
  template <typename PrefixListIdT = Aws::String>
  DeleteTransitGatewayPrefixListReferenceRequest& WithPrefixListId(PrefixListIdT&& value) {
  ...
  inline DeleteTransitGatewayPrefixListReferenceRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
