...
class CreateSubnetCidrReservationResponse {
 public:
  ...
  void SetSubnetCidrReservation(SubnetCidrReservationT&& value) {
    m_subnetCidrReservationHasBeenSet = true;
    m_subnetCidrReservation = std::forward<SubnetCidrReservationT>(value);
  }
  template <typename SubnetCidrReservationT = SubnetCidrReservation>
  CreateSubnetCidrReservationResponse& WithSubnetCidrReservation(SubnetCidrReservationT&& value) {
    SetSubnetCidrReservation(std::forward<SubnetCidrReservationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateSubnetCidrReservationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
