...
class DescribeHostReservationsResponse {
 public:
  ...
  void SetHostReservationSet(HostReservationSetT&& value) {
    m_hostReservationSetHasBeenSet = true;
    m_hostReservationSet = std::forward<HostReservationSetT>(value);
  }
  template <typename HostReservationSetT = Aws::Vector<HostReservation>>
  DescribeHostReservationsResponse& WithHostReservationSet(HostReservationSetT&& value) {
    SetHostReservationSet(std::forward<HostReservationSetT>(value));
    return *this;
  }
  template <typename HostReservationSetT = HostReservation>
  DescribeHostReservationsResponse& AddHostReservationSet(HostReservationSetT&& value) {
    m_hostReservationSetHasBeenSet = true;
    m_hostReservationSet.emplace_back(std::forward<HostReservationSetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeHostReservationsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeHostReservationsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
