...
class GetCapacityReservationUsageResponse {
 public:
  ...
  inline GetCapacityReservationUsageResponse& WithTotalInstanceCount(int value) {
  ...
  inline GetCapacityReservationUsageResponse& WithAvailableInstanceCount(int value) {
  ...
  inline GetCapacityReservationUsageResponse& WithState(CapacityReservationState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetInstanceUsages(InstanceUsagesT&& value) {
    ...
    m_instanceUsages = std::forward<InstanceUsagesT>(value);
  }
  template <typename InstanceUsagesT = Aws::Vector<InstanceUsage>>
  GetCapacityReservationUsageResponse& WithInstanceUsages(InstanceUsagesT&& value) {
    SetInstanceUsages(std::forward<InstanceUsagesT>(value));
    return *this;
  }
  ...
  GetCapacityReservationUsageResponse& AddInstanceUsages(InstanceUsagesT&& value) {
    m_instanceUsagesHasBeenSet = true;
    m_instanceUsages.emplace_back(std::forward<InstanceUsagesT>(value));
    return *this;
  }
  ///@}
