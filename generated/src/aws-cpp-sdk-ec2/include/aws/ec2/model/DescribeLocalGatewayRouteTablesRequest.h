...
class DescribeLocalGatewayRouteTablesRequest : public EC2Request {
 ...
 public:
  ...
  void SetLocalGatewayRouteTableIds(LocalGatewayRouteTableIdsT&& value) {
    m_localGatewayRouteTableIdsHasBeenSet = true;
    m_localGatewayRouteTableIds = std::forward<LocalGatewayRouteTableIdsT>(value);
  }
  template <typename LocalGatewayRouteTableIdsT = Aws::Vector<Aws::String>>
  DescribeLocalGatewayRouteTablesRequest& WithLocalGatewayRouteTableIds(LocalGatewayRouteTableIdsT&& value) {
    SetLocalGatewayRouteTableIds(std::forward<LocalGatewayRouteTableIdsT>(value));
    return *this;
  }
  template <typename LocalGatewayRouteTableIdsT = Aws::String>
  DescribeLocalGatewayRouteTablesRequest& AddLocalGatewayRouteTableIds(LocalGatewayRouteTableIdsT&& value) {
    m_localGatewayRouteTableIdsHasBeenSet = true;
    m_localGatewayRouteTableIds.emplace_back(std::forward<LocalGatewayRouteTableIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeLocalGatewayRouteTablesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeLocalGatewayRouteTablesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeLocalGatewayRouteTablesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeLocalGatewayRouteTablesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeLocalGatewayRouteTablesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
