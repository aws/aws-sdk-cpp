...
class DescribeCustomerGatewaysRequest : public EC2Request {
 ...
 public:
  ...
  void SetCustomerGatewayIds(CustomerGatewayIdsT&& value) {
    ...
    m_customerGatewayIds = std::forward<CustomerGatewayIdsT>(value);
  }
  template <typename CustomerGatewayIdsT = Aws::Vector<Aws::String>>
  DescribeCustomerGatewaysRequest& WithCustomerGatewayIds(CustomerGatewayIdsT&& value) {
    SetCustomerGatewayIds(std::forward<CustomerGatewayIdsT>(value));
    return *this;
  }
  ...
  DescribeCustomerGatewaysRequest& AddCustomerGatewayIds(CustomerGatewayIdsT&& value) {
    m_customerGatewayIdsHasBeenSet = true;
    m_customerGatewayIds.emplace_back(std::forward<CustomerGatewayIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeCustomerGatewaysRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
