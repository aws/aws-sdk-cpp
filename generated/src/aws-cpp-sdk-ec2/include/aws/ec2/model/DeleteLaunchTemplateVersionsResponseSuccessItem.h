...
class DeleteLaunchTemplateVersionsResponseSuccessItem {
 public:
  ...
  template <typename LaunchTemplateIdT = Aws::String>
  DeleteLaunchTemplateVersionsResponseSuccessItem& WithLaunchTemplateId(LaunchTemplateIdT&& value) {
  ...
  template <typename LaunchTemplateNameT = Aws::String>
  DeleteLaunchTemplateVersionsResponseSuccessItem& WithLaunchTemplateName(LaunchTemplateNameT&& value) {
  ...
  inline DeleteLaunchTemplateVersionsResponseSuccessItem& WithVersionNumber(long long value) {
