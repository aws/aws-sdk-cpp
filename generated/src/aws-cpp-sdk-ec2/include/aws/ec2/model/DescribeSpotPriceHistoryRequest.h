...
class DescribeSpotPriceHistoryRequest : public EC2Request {
 ...
 public:
  ...
  template <typename AvailabilityZoneIdT = Aws::String>
  DescribeSpotPriceHistoryRequest& WithAvailabilityZoneId(AvailabilityZoneIdT&& value) {
  ...
  inline DescribeSpotPriceHistoryRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeSpotPriceHistoryRequest& AddInstanceTypes(InstanceType value) {
    m_instanceTypesHasBeenSet = true;
  ...
  void SetProductDescriptions(ProductDescriptionsT&& value) {
    m_productDescriptionsHasBeenSet = true;
    m_productDescriptions = std::forward<ProductDescriptionsT>(value);
  }
  template <typename ProductDescriptionsT = Aws::Vector<Aws::String>>
  DescribeSpotPriceHistoryRequest& WithProductDescriptions(ProductDescriptionsT&& value) {
    SetProductDescriptions(std::forward<ProductDescriptionsT>(value));
    return *this;
  }
  ...
  DescribeSpotPriceHistoryRequest& AddProductDescriptions(ProductDescriptionsT&& value) {
    m_productDescriptionsHasBeenSet = true;
    m_productDescriptions.emplace_back(std::forward<ProductDescriptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeSpotPriceHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
