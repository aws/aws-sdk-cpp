...
class DnsServersOptionsModifyStructure {
 public:
  ...
  void SetCustomDnsServers(CustomDnsServersT&& value) {
    ...
    m_customDnsServers = std::forward<CustomDnsServersT>(value);
  }
  template <typename CustomDnsServersT = Aws::Vector<Aws::String>>
  DnsServersOptionsModifyStructure& WithCustomDnsServers(CustomDnsServersT&& value) {
    SetCustomDnsServers(std::forward<CustomDnsServersT>(value));
    return *this;
  }
  ...
  DnsServersOptionsModifyStructure& AddCustomDnsServers(CustomDnsServersT&& value) {
    m_customDnsServersHasBeenSet = true;
    m_customDnsServers.emplace_back(std::forward<CustomDnsServersT>(value));
    return *this;
  }
  ///@}
  ...
  inline DnsServersOptionsModifyStructure& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
