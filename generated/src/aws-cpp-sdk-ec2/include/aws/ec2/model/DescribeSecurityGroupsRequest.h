...
class DescribeSecurityGroupsRequest : public EC2Request {
 ...
 public:
  ...
  template <typename GroupIdsT = Aws::Vector<Aws::String>>
  DescribeSecurityGroupsRequest& WithGroupIds(GroupIdsT&& value) {
    SetGroupIds(std::forward<GroupIdsT>(value));
    return *this;
  }
  template <typename GroupIdsT = Aws::String>
  DescribeSecurityGroupsRequest& AddGroupIds(GroupIdsT&& value) {
    m_groupIdsHasBeenSet = true;
  ...
  template <typename GroupNamesT = Aws::Vector<Aws::String>>
  DescribeSecurityGroupsRequest& WithGroupNames(GroupNamesT&& value) {
    SetGroupNames(std::forward<GroupNamesT>(value));
    return *this;
  }
  template <typename GroupNamesT = Aws::String>
  DescribeSecurityGroupsRequest& AddGroupNames(GroupNamesT&& value) {
    m_groupNamesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSecurityGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeSecurityGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeSecurityGroupsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeSecurityGroupsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeSecurityGroupsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
