...
class DescribeFleetInstancesRequest : public EC2Request {
 public:
  AWS_EC2_API DescribeFleetInstancesRequest() = default;
 ...
 public:
  ...
  inline DescribeFleetInstancesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeFleetInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
