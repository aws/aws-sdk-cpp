...
class GetPasswordDataResponse {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  GetPasswordDataResponse& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename TimestampT = Aws::Utils::DateTime>
  GetPasswordDataResponse& WithTimestamp(TimestampT&& value) {
  ...
  template <typename PasswordDataT = Aws::String>
  GetPasswordDataResponse& WithPasswordData(PasswordDataT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetPasswordDataResponse& WithResponseMetadata(ResponseMetadataT&& value) {
