...
class DisassociateTransitGatewayPolicyTableResponse {
 public:
  ...
  AWS_EC2_API DisassociateTransitGatewayPolicyTableResponse& operator=(
  ...
  template <typename AssociationT = TransitGatewayPolicyTableAssociation>
  DisassociateTransitGatewayPolicyTableResponse& WithAssociation(AssociationT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisassociateTransitGatewayPolicyTableResponse& WithResponseMetadata(ResponseMetadataT&& value) {
