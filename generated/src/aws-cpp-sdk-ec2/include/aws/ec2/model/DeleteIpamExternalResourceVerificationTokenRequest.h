...
class DeleteIpamExternalResourceVerificationTokenRequest : public EC2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DeleteIpamExternalResourceVerificationToken"; }
 ...
 public:
  ...
  inline DeleteIpamExternalResourceVerificationTokenRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamExternalResourceVerificationTokenIdT = Aws::String>
  DeleteIpamExternalResourceVerificationTokenRequest& WithIpamExternalResourceVerificationTokenId(
      IpamExternalResourceVerificationTokenIdT&& value) {
