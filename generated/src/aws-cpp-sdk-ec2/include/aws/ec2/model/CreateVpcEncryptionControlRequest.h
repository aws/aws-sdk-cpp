...
/**
 */
class CreateVpcEncryptionControlRequest : public EC2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "CreateVpcEncryptionControl"; }
 ...
 public:
  ...
  inline CreateVpcEncryptionControlRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The ID of the VPC for which to create the encryption control
   * configuration.</p>
   */
