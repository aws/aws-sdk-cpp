...
class GetActiveVpnTunnelStatusResponse {
 public:
  ...
  void SetActiveVpnTunnelStatus(ActiveVpnTunnelStatusT&& value) {
    m_activeVpnTunnelStatusHasBeenSet = true;
    m_activeVpnTunnelStatus = std::forward<ActiveVpnTunnelStatusT>(value);
  }
  template <typename ActiveVpnTunnelStatusT = ActiveVpnTunnelStatus>
  GetActiveVpnTunnelStatusResponse& WithActiveVpnTunnelStatus(ActiveVpnTunnelStatusT&& value) {
    SetActiveVpnTunnelStatus(std::forward<ActiveVpnTunnelStatusT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetActiveVpnTunnelStatusResponse& WithResponseMetadata(ResponseMetadataT&& value) {
