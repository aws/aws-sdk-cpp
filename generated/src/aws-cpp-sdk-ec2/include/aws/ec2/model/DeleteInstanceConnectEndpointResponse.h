...
class DeleteInstanceConnectEndpointResponse {
 public:
  ...
  void SetInstanceConnectEndpoint(InstanceConnectEndpointT&& value) {
    m_instanceConnectEndpointHasBeenSet = true;
    m_instanceConnectEndpoint = std::forward<InstanceConnectEndpointT>(value);
  }
  template <typename InstanceConnectEndpointT = Ec2InstanceConnectEndpoint>
  DeleteInstanceConnectEndpointResponse& WithInstanceConnectEndpoint(InstanceConnectEndpointT&& value) {
    SetInstanceConnectEndpoint(std::forward<InstanceConnectEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteInstanceConnectEndpointResponse& WithResponseMetadata(ResponseMetadataT&& value) {
