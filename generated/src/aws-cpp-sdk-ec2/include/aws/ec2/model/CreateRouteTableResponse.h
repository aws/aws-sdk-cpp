...
class CreateRouteTableResponse {
 public:
  ...
  template <typename RouteTableT = RouteTable>
  CreateRouteTableResponse& WithRouteTable(RouteTableT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateRouteTableResponse& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateRouteTableResponse& WithResponseMetadata(ResponseMetadataT&& value) {
