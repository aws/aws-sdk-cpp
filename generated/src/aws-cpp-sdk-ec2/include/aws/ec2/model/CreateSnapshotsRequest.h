...
class CreateSnapshotsRequest : public EC2Request {
 ...
 public:
  ...
  void SetInstanceSpecification(InstanceSpecificationT&& value) {
    m_instanceSpecificationHasBeenSet = true;
    m_instanceSpecification = std::forward<InstanceSpecificationT>(value);
  }
  template <typename InstanceSpecificationT = InstanceSpecification>
  CreateSnapshotsRequest& WithInstanceSpecification(InstanceSpecificationT&& value) {
    SetInstanceSpecification(std::forward<InstanceSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateSnapshotsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCopyTagsFromSource(CopyTagsFromSource value) {
    m_copyTagsFromSourceHasBeenSet = true;
    m_copyTagsFromSource = value;
  }
  inline CreateSnapshotsRequest& WithCopyTagsFromSource(CopyTagsFromSource value) {
    SetCopyTagsFromSource(value);
    return *this;
  }
  ///@}
  ...
  inline CreateSnapshotsRequest& WithLocation(SnapshotLocationEnum value) {
    SetLocation(value);
    return *this;
  }
  ///@}
