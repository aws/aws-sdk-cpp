...
class PriceSchedule {
 public:
  ...
  inline PriceSchedule& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
  ...
  inline PriceSchedule& WithCurrencyCode(CurrencyCodeValues value) {
  ...
  inline PriceSchedule& WithPrice(double value) {
    SetPrice(value);
    return *this;
  }
  ///@}
  ...
  inline PriceSchedule& WithTerm(long long value) {
    SetTerm(value);
    return *this;
  }
  ///@}
