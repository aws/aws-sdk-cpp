...
class DescribeClientVpnRoutesResponse {
 public:
  AWS_EC2_API DescribeClientVpnRoutesResponse() = default;
  ...
  template <typename RoutesT = Aws::Vector<ClientVpnRoute>>
  void SetRoutes(RoutesT&& value) {
    m_routesHasBeenSet = true;
    m_routes = std::forward<RoutesT>(value);
  }
  template <typename RoutesT = Aws::Vector<ClientVpnRoute>>
  DescribeClientVpnRoutesResponse& WithRoutes(RoutesT&& value) {
    SetRoutes(std::forward<RoutesT>(value));
    return *this;
  }
  template <typename RoutesT = ClientVpnRoute>
  DescribeClientVpnRoutesResponse& AddRoutes(RoutesT&& value) {
    m_routesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeClientVpnRoutesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeClientVpnRoutesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
