...
class DescribeImagesResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeImagesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ImagesT = Aws::Vector<Image>>
  DescribeImagesResponse& WithImages(ImagesT&& value) {
    SetImages(std::forward<ImagesT>(value));
    return *this;
  }
  template <typename ImagesT = Image>
  DescribeImagesResponse& AddImages(ImagesT&& value) {
    m_imagesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeImagesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
