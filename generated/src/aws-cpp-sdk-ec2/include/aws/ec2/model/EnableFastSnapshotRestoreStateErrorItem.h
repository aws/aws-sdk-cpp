...
class EnableFastSnapshotRestoreStateErrorItem {
 public:
  ...
  template <typename AvailabilityZoneT = Aws::String>
  EnableFastSnapshotRestoreStateErrorItem& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename AvailabilityZoneIdT = Aws::String>
  EnableFastSnapshotRestoreStateErrorItem& WithAvailabilityZoneId(AvailabilityZoneIdT&& value) {
  ...
  template <typename ErrorT = EnableFastSnapshotRestoreStateError>
  EnableFastSnapshotRestoreStateErrorItem& WithError(ErrorT&& value) {
