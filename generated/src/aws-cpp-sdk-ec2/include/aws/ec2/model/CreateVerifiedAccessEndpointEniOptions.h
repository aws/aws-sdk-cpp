...
class CreateVerifiedAccessEndpointEniOptions {
 public:
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  CreateVerifiedAccessEndpointEniOptions& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
  ...
  inline CreateVerifiedAccessEndpointEniOptions& WithProtocol(VerifiedAccessEndpointProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline CreateVerifiedAccessEndpointEniOptions& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename PortRangesT = Aws::Vector<CreateVerifiedAccessEndpointPortRange>>
  CreateVerifiedAccessEndpointEniOptions& WithPortRanges(PortRangesT&& value) {
    SetPortRanges(std::forward<PortRangesT>(value));
    return *this;
  }
  template <typename PortRangesT = CreateVerifiedAccessEndpointPortRange>
  CreateVerifiedAccessEndpointEniOptions& AddPortRanges(PortRangesT&& value) {
    m_portRangesHasBeenSet = true;
