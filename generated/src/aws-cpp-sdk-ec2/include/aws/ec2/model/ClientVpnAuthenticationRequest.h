...
class ClientVpnAuthenticationRequest {
 public:
  ...
  inline void SetType(ClientVpnAuthenticationType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ClientVpnAuthenticationRequest& WithType(ClientVpnAuthenticationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetActiveDirectory(ActiveDirectoryT&& value) {
    ...
    m_activeDirectory = std::forward<ActiveDirectoryT>(value);
  }
  template <typename ActiveDirectoryT = DirectoryServiceAuthenticationRequest>
  ClientVpnAuthenticationRequest& WithActiveDirectory(ActiveDirectoryT&& value) {
    SetActiveDirectory(std::forward<ActiveDirectoryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFederatedAuthentication(FederatedAuthenticationT&& value) {
    ...
    m_federatedAuthentication = std::forward<FederatedAuthenticationT>(value);
  }
  template <typename FederatedAuthenticationT = FederatedAuthenticationRequest>
  ClientVpnAuthenticationRequest& WithFederatedAuthentication(FederatedAuthenticationT&& value) {
    SetFederatedAuthentication(std::forward<FederatedAuthenticationT>(value));
    return *this;
  }
  ///@}
 private:
