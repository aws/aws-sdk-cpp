...
class DescribeSnapshotTierStatusResponse {
 public:
  ...
  void SetSnapshotTierStatuses(SnapshotTierStatusesT&& value) {
    m_snapshotTierStatusesHasBeenSet = true;
    m_snapshotTierStatuses = std::forward<SnapshotTierStatusesT>(value);
  }
  template <typename SnapshotTierStatusesT = Aws::Vector<SnapshotTierStatus>>
  DescribeSnapshotTierStatusResponse& WithSnapshotTierStatuses(SnapshotTierStatusesT&& value) {
    SetSnapshotTierStatuses(std::forward<SnapshotTierStatusesT>(value));
    return *this;
  }
  template <typename SnapshotTierStatusesT = SnapshotTierStatus>
  DescribeSnapshotTierStatusResponse& AddSnapshotTierStatuses(SnapshotTierStatusesT&& value) {
    m_snapshotTierStatusesHasBeenSet = true;
    m_snapshotTierStatuses.emplace_back(std::forward<SnapshotTierStatusesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSnapshotTierStatusResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeSnapshotTierStatusResponse& WithResponseMetadata(ResponseMetadataT&& value) {
