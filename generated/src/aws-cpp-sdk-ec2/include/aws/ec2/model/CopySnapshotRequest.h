...
class CopySnapshotRequest : public EC2Request {
 ...
 public:
  ...
  inline CopySnapshotRequest& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline CopySnapshotRequest& WithCompletionDurationMinutes(int value) {
  ...
  inline CopySnapshotRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
