...
class DescribeImagesRequest : public EC2Request {
 ...
 public:
  ...
  void SetExecutableUsers(ExecutableUsersT&& value) {
    m_executableUsersHasBeenSet = true;
    m_executableUsers = std::forward<ExecutableUsersT>(value);
  }
  template <typename ExecutableUsersT = Aws::Vector<Aws::String>>
  DescribeImagesRequest& WithExecutableUsers(ExecutableUsersT&& value) {
    SetExecutableUsers(std::forward<ExecutableUsersT>(value));
    return *this;
  }
  template <typename ExecutableUsersT = Aws::String>
  DescribeImagesRequest& AddExecutableUsers(ExecutableUsersT&& value) {
    m_executableUsersHasBeenSet = true;
    m_executableUsers.emplace_back(std::forward<ExecutableUsersT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeImagesRequest& WithIncludeDeprecated(bool value) {
  ...
  inline void SetIncludeDisabled(bool value) {
    m_includeDisabledHasBeenSet = true;
    m_includeDisabled = value;
  }
  inline DescribeImagesRequest& WithIncludeDisabled(bool value) {
  ...
  inline DescribeImagesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
   ...
   * watermark was originally attached.</p> </li> <li> <p>
   * <code>image-watermark.source-image-region</code> - The Region where the
   * watermark was originally attached.</p> </li> <li> <p>
   ...
   * (<code>marketplace</code>).</p> </li> <li> <p>
   * <code>public-ssm-parameter-name</code> - The name of a public Systems Manager
   * parameter associated with the AMI. The parameter must be in a trusted Amazon Web
   * Services namespace under <code>aws/service/</code>. Returns all AMIs that have
   * ever been associated with the parameter, including previous versions.</p> </li>
