...
class DescribeImageAttributeResponse {
 public:
  ...
  void SetBootMode(BootModeT&& value) {
    ...
    m_bootMode = std::forward<BootModeT>(value);
  }
  template <typename BootModeT = AttributeValue>
  DescribeImageAttributeResponse& WithBootMode(BootModeT&& value) {
    SetBootMode(std::forward<BootModeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTpmSupport(TpmSupportT&& value) {
    ...
    m_tpmSupport = std::forward<TpmSupportT>(value);
  }
  template <typename TpmSupportT = AttributeValue>
  DescribeImageAttributeResponse& WithTpmSupport(TpmSupportT&& value) {
    SetTpmSupport(std::forward<TpmSupportT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastLaunchedTime(LastLaunchedTimeT&& value) {
    ...
    m_lastLaunchedTime = std::forward<LastLaunchedTimeT>(value);
  }
  template <typename LastLaunchedTimeT = AttributeValue>
  DescribeImageAttributeResponse& WithLastLaunchedTime(LastLaunchedTimeT&& value) {
    SetLastLaunchedTime(std::forward<LastLaunchedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeregistrationProtection(DeregistrationProtectionT&& value) {
    ...
    m_deregistrationProtection = std::forward<DeregistrationProtectionT>(value);
  }
  template <typename DeregistrationProtectionT = AttributeValue>
  DescribeImageAttributeResponse& WithDeregistrationProtection(DeregistrationProtectionT&& value) {
    SetDeregistrationProtection(std::forward<DeregistrationProtectionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLaunchPermissions(LaunchPermissionsT&& value) {
    ...
    m_launchPermissions = std::forward<LaunchPermissionsT>(value);
  }
  template <typename LaunchPermissionsT = Aws::Vector<LaunchPermission>>
  DescribeImageAttributeResponse& WithLaunchPermissions(LaunchPermissionsT&& value) {
    SetLaunchPermissions(std::forward<LaunchPermissionsT>(value));
    return *this;
  }
  ...
  DescribeImageAttributeResponse& AddLaunchPermissions(LaunchPermissionsT&& value) {
    m_launchPermissionsHasBeenSet = true;
    m_launchPermissions.emplace_back(std::forward<LaunchPermissionsT>(value));
    return *this;
  }
  ///@}
