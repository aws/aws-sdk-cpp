...
class DescribeInstanceConnectEndpointsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeInstanceConnectEndpointsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeInstanceConnectEndpointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstanceConnectEndpointsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeInstanceConnectEndpointsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeInstanceConnectEndpointsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  void SetInstanceConnectEndpointIds(InstanceConnectEndpointIdsT&& value) {
    m_instanceConnectEndpointIdsHasBeenSet = true;
    m_instanceConnectEndpointIds = std::forward<InstanceConnectEndpointIdsT>(value);
  }
  template <typename InstanceConnectEndpointIdsT = Aws::Vector<Aws::String>>
  DescribeInstanceConnectEndpointsRequest& WithInstanceConnectEndpointIds(InstanceConnectEndpointIdsT&& value) {
    SetInstanceConnectEndpointIds(std::forward<InstanceConnectEndpointIdsT>(value));
    return *this;
  }
  template <typename InstanceConnectEndpointIdsT = Aws::String>
  DescribeInstanceConnectEndpointsRequest& AddInstanceConnectEndpointIds(InstanceConnectEndpointIdsT&& value) {
    m_instanceConnectEndpointIdsHasBeenSet = true;
    m_instanceConnectEndpointIds.emplace_back(std::forward<InstanceConnectEndpointIdsT>(value));
    return *this;
  }
  ///@}
 private:
