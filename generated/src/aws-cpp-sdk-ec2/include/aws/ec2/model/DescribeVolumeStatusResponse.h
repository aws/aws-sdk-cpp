...
class DescribeVolumeStatusResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVolumeStatusResponse& WithNextToken(NextTokenT&& value) {
  ...
  void SetVolumeStatuses(VolumeStatusesT&& value) {
    m_volumeStatusesHasBeenSet = true;
    m_volumeStatuses = std::forward<VolumeStatusesT>(value);
  }
  template <typename VolumeStatusesT = Aws::Vector<VolumeStatusItem>>
  DescribeVolumeStatusResponse& WithVolumeStatuses(VolumeStatusesT&& value) {
    SetVolumeStatuses(std::forward<VolumeStatusesT>(value));
    return *this;
  }
  template <typename VolumeStatusesT = VolumeStatusItem>
  DescribeVolumeStatusResponse& AddVolumeStatuses(VolumeStatusesT&& value) {
    m_volumeStatusesHasBeenSet = true;
    m_volumeStatuses.emplace_back(std::forward<VolumeStatusesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVolumeStatusResponse& WithResponseMetadata(ResponseMetadataT&& value) {
