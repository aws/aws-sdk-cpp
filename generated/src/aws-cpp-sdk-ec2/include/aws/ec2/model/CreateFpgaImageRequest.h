...
class CreateFpgaImageRequest : public EC2Request {
 ...
 public:
  ...
  inline CreateFpgaImageRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetInputStorageLocation(InputStorageLocationT&& value) {
    m_inputStorageLocationHasBeenSet = true;
    m_inputStorageLocation = std::forward<InputStorageLocationT>(value);
  }
  template <typename InputStorageLocationT = StorageLocation>
  CreateFpgaImageRequest& WithInputStorageLocation(InputStorageLocationT&& value) {
    SetInputStorageLocation(std::forward<InputStorageLocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLogsStorageLocation(LogsStorageLocationT&& value) {
    m_logsStorageLocationHasBeenSet = true;
    m_logsStorageLocation = std::forward<LogsStorageLocationT>(value);
  }
  template <typename LogsStorageLocationT = StorageLocation>
  CreateFpgaImageRequest& WithLogsStorageLocation(LogsStorageLocationT&& value) {
    SetLogsStorageLocation(std::forward<LogsStorageLocationT>(value));
    return *this;
  }
  ///@}
