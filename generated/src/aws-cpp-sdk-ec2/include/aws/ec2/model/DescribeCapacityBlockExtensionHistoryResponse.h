...
class DescribeCapacityBlockExtensionHistoryResponse {
 public:
  ...
  AWS_EC2_API DescribeCapacityBlockExtensionHistoryResponse& operator=(
  ...
  void SetCapacityBlockExtensions(CapacityBlockExtensionsT&& value) {
    m_capacityBlockExtensionsHasBeenSet = true;
    m_capacityBlockExtensions = std::forward<CapacityBlockExtensionsT>(value);
  }
  template <typename CapacityBlockExtensionsT = Aws::Vector<CapacityBlockExtension>>
  DescribeCapacityBlockExtensionHistoryResponse& WithCapacityBlockExtensions(CapacityBlockExtensionsT&& value) {
    SetCapacityBlockExtensions(std::forward<CapacityBlockExtensionsT>(value));
    return *this;
  }
  template <typename CapacityBlockExtensionsT = CapacityBlockExtension>
  DescribeCapacityBlockExtensionHistoryResponse& AddCapacityBlockExtensions(CapacityBlockExtensionsT&& value) {
    m_capacityBlockExtensionsHasBeenSet = true;
    m_capacityBlockExtensions.emplace_back(std::forward<CapacityBlockExtensionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeCapacityBlockExtensionHistoryResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeCapacityBlockExtensionHistoryResponse& WithResponseMetadata(ResponseMetadataT&& value) {
