...
class DescribeSpotFleetInstancesRequest : public EC2Request {
 public:
  AWS_EC2_API DescribeSpotFleetInstancesRequest() = default;
 ...
 public:
  ...
  inline DescribeSpotFleetInstancesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename SpotFleetRequestIdT = Aws::String>
  DescribeSpotFleetInstancesRequest& WithSpotFleetRequestId(SpotFleetRequestIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSpotFleetInstancesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeSpotFleetInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
