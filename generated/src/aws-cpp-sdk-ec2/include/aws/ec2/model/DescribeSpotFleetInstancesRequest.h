...
namespace Model
{
  ...
  public:
    ...
    template<typename SpotFleetRequestIdT = Aws::String>
    DescribeSpotFleetInstancesRequest& WithSpotFleetRequestId(SpotFleetRequestIdT&& value) { SetSpotFleetRequestId(std::forward<SpotFleetRequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeSpotFleetInstancesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
