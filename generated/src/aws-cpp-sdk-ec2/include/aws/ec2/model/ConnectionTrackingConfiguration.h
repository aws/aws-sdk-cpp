...
class ConnectionTrackingConfiguration {
 public:
  AWS_EC2_API ConnectionTrackingConfiguration() = default;
  ...
  inline ConnectionTrackingConfiguration& WithTcpEstablishedTimeout(int value) {
  ...
  inline ConnectionTrackingConfiguration& WithUdpStreamTimeout(int value) {
  ...
  inline ConnectionTrackingConfiguration& WithUdpTimeout(int value) {
    SetUdpTimeout(value);
    return *this;
  }
  ///@}
