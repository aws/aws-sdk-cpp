...
class InstanceEventWindowTimeRangeRequest {
 public:
  ...
  inline InstanceEventWindowTimeRangeRequest& WithStartWeekDay(WeekDay value) {
  ...
  inline InstanceEventWindowTimeRangeRequest& WithStartHour(int value) {
    SetStartHour(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceEventWindowTimeRangeRequest& WithEndWeekDay(WeekDay value) {
    SetEndWeekDay(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceEventWindowTimeRangeRequest& WithEndHour(int value) {
    SetEndHour(value);
    return *this;
  }
  ///@}
