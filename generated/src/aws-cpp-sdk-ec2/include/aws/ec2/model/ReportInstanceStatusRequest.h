...
class ReportInstanceStatusRequest : public EC2Request {
 ...
 public:
  ...
  inline ReportInstanceStatusRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ReportStatusType value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ReportInstanceStatusRequest& WithStatus(ReportStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ReportInstanceStatusRequest& AddReasonCodes(ReportInstanceReasonCodes value) {
    m_reasonCodesHasBeenSet = true;
