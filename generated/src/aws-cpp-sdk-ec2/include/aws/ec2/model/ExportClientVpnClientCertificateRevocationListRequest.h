...
class ExportClientVpnClientCertificateRevocationListRequest : public EC2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ExportClientVpnClientCertificateRevocationList"; }
 ...
 public:
  ...
  template <typename ClientVpnEndpointIdT = Aws::String>
  ExportClientVpnClientCertificateRevocationListRequest& WithClientVpnEndpointId(ClientVpnEndpointIdT&& value) {
  ...
  inline ExportClientVpnClientCertificateRevocationListRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
