...
class ModifyVpcEndpointServicePermissionsResponse {
 public:
  ...
  AWS_EC2_API ModifyVpcEndpointServicePermissionsResponse& operator=(
  ...
  void SetAddedPrincipals(AddedPrincipalsT&& value) {
    m_addedPrincipalsHasBeenSet = true;
    m_addedPrincipals = std::forward<AddedPrincipalsT>(value);
  }
  template <typename AddedPrincipalsT = Aws::Vector<AddedPrincipal>>
  ModifyVpcEndpointServicePermissionsResponse& WithAddedPrincipals(AddedPrincipalsT&& value) {
    SetAddedPrincipals(std::forward<AddedPrincipalsT>(value));
    return *this;
  }
  ...
  ModifyVpcEndpointServicePermissionsResponse& AddAddedPrincipals(AddedPrincipalsT&& value) {
    m_addedPrincipalsHasBeenSet = true;
    m_addedPrincipals.emplace_back(std::forward<AddedPrincipalsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModifyVpcEndpointServicePermissionsResponse& WithReturnValue(bool value) {
