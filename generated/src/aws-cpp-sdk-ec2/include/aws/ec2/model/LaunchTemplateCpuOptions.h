...
class LaunchTemplateCpuOptions {
 public:
  ...
  inline LaunchTemplateCpuOptions& WithCoreCount(int value) {
    SetCoreCount(value);
    return *this;
  }
  ///@}
  ...
  inline LaunchTemplateCpuOptions& WithThreadsPerCore(int value) {
  ...
  inline void SetAmdSevSnp(AmdSevSnpSpecification value) {
    m_amdSevSnpHasBeenSet = true;
    m_amdSevSnp = value;
  }
  inline LaunchTemplateCpuOptions& WithAmdSevSnp(AmdSevSnpSpecification value) {
    SetAmdSevSnp(value);
    return *this;
  }
  ///@}
