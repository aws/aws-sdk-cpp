...
class LaunchTemplateCapacityReservationSpecificationResponse {
 public:
  ...
  inline LaunchTemplateCapacityReservationSpecificationResponse& WithCapacityReservationPreference(CapacityReservationPreference value) {
  ...
  template <typename CapacityReservationTargetT = CapacityReservationTargetResponse>
  LaunchTemplateCapacityReservationSpecificationResponse& WithCapacityReservationTarget(CapacityReservationTargetT&& value) {
