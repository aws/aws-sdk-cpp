...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API EnableImageDeprecationResponse() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    EnableImageDeprecationResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
