...
class VpcBlockPublicAccessExclusion {
 public:
  ...
  inline VpcBlockPublicAccessExclusion& WithInternetGatewayExclusionMode(InternetGatewayExclusionMode value) {
  ...
  inline void SetState(VpcBlockPublicAccessExclusionState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline VpcBlockPublicAccessExclusion& WithState(VpcBlockPublicAccessExclusionState value) {
    SetState(value);
    return *this;
  }
  ///@}
