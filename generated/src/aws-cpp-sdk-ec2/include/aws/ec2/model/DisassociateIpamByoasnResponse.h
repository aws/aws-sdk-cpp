...
class DisassociateIpamByoasnResponse {
 public:
  AWS_EC2_API DisassociateIpamByoasnResponse() = default;
  ...
  void SetAsnAssociation(AsnAssociationT&& value) {
    m_asnAssociationHasBeenSet = true;
    m_asnAssociation = std::forward<AsnAssociationT>(value);
  }
  template <typename AsnAssociationT = AsnAssociation>
  DisassociateIpamByoasnResponse& WithAsnAssociation(AsnAssociationT&& value) {
    SetAsnAssociation(std::forward<AsnAssociationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisassociateIpamByoasnResponse& WithResponseMetadata(ResponseMetadataT&& value) {
