...
class CancelSpotFleetRequestsRequest : public EC2Request {
 ...
 public:
  ...
  inline CancelSpotFleetRequestsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTerminateInstances(bool value) {
    m_terminateInstancesHasBeenSet = true;
    m_terminateInstances = value;
  }
  inline CancelSpotFleetRequestsRequest& WithTerminateInstances(bool value) {
    SetTerminateInstances(value);
    return *this;
  }
  ///@}
 private:
