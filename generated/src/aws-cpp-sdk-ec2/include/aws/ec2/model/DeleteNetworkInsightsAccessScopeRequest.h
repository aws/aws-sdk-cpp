...
class DeleteNetworkInsightsAccessScopeRequest : public EC2Request {
 ...
 public:
  ...
  inline DeleteNetworkInsightsAccessScopeRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename NetworkInsightsAccessScopeIdT = Aws::String>
  DeleteNetworkInsightsAccessScopeRequest& WithNetworkInsightsAccessScopeId(NetworkInsightsAccessScopeIdT&& value) {
