...
class CreateLocalGatewayVirtualInterfaceGroupRequest : public EC2Request {
 ...
 public:
  ...
  template <typename LocalGatewayIdT = Aws::String>
  CreateLocalGatewayVirtualInterfaceGroupRequest& WithLocalGatewayId(LocalGatewayIdT&& value) {
  ...
  inline CreateLocalGatewayVirtualInterfaceGroupRequest& WithLocalBgpAsn(int value) {
  ...
  inline CreateLocalGatewayVirtualInterfaceGroupRequest& WithLocalBgpAsnExtended(long long value) {
  ...
  template <typename TagSpecificationsT = Aws::Vector<TagSpecification>>
  CreateLocalGatewayVirtualInterfaceGroupRequest& WithTagSpecifications(TagSpecificationsT&& value) {
    SetTagSpecifications(std::forward<TagSpecificationsT>(value));
    return *this;
  }
  template <typename TagSpecificationsT = TagSpecification>
  CreateLocalGatewayVirtualInterfaceGroupRequest& AddTagSpecifications(TagSpecificationsT&& value) {
    m_tagSpecificationsHasBeenSet = true;
  ...
  inline CreateLocalGatewayVirtualInterfaceGroupRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
