...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API CancelImageLaunchPermissionResponse() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CancelImageLaunchPermissionResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
