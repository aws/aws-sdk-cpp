...
namespace Model
{
  ...
  public:
     ...
     * error.</p>
     */
    inline CancelImageLaunchPermissionResponse& WithReturn(bool value) { SetReturn(value); return *this;}
    ...
    inline CancelImageLaunchPermissionResponse& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}

    
    inline CancelImageLaunchPermissionResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
