...
class CancelSpotInstanceRequestsResponse {
 public:
   ...
   */
  inline const Aws::Vector<CancelledSpotInstanceRequest>& GetCancelledSpotInstanceRequests() const {
    return m_cancelledSpotInstanceRequests;
  }
  template <typename CancelledSpotInstanceRequestsT = Aws::Vector<CancelledSpotInstanceRequest>>
  void SetCancelledSpotInstanceRequests(CancelledSpotInstanceRequestsT&& value) {
    m_cancelledSpotInstanceRequestsHasBeenSet = true;
    m_cancelledSpotInstanceRequests = std::forward<CancelledSpotInstanceRequestsT>(value);
  }
  template <typename CancelledSpotInstanceRequestsT = Aws::Vector<CancelledSpotInstanceRequest>>
  CancelSpotInstanceRequestsResponse& WithCancelledSpotInstanceRequests(CancelledSpotInstanceRequestsT&& value) {
    SetCancelledSpotInstanceRequests(std::forward<CancelledSpotInstanceRequestsT>(value));
    return *this;
  }
  template <typename CancelledSpotInstanceRequestsT = CancelledSpotInstanceRequest>
  CancelSpotInstanceRequestsResponse& AddCancelledSpotInstanceRequests(CancelledSpotInstanceRequestsT&& value) {
    m_cancelledSpotInstanceRequestsHasBeenSet = true;
    m_cancelledSpotInstanceRequests.emplace_back(std::forward<CancelledSpotInstanceRequestsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CancelSpotInstanceRequestsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
