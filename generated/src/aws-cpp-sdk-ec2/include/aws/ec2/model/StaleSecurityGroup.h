...
class StaleSecurityGroup {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  StaleSecurityGroup& WithDescription(DescriptionT&& value) {
  ...
  template <typename GroupIdT = Aws::String>
  StaleSecurityGroup& WithGroupId(GroupIdT&& value) {
  ...
  template <typename GroupNameT = Aws::String>
  StaleSecurityGroup& WithGroupName(GroupNameT&& value) {
  ...
  void SetStaleIpPermissions(StaleIpPermissionsT&& value) {
    m_staleIpPermissionsHasBeenSet = true;
    m_staleIpPermissions = std::forward<StaleIpPermissionsT>(value);
  }
  template <typename StaleIpPermissionsT = Aws::Vector<StaleIpPermission>>
  StaleSecurityGroup& WithStaleIpPermissions(StaleIpPermissionsT&& value) {
    SetStaleIpPermissions(std::forward<StaleIpPermissionsT>(value));
    return *this;
  }
  template <typename StaleIpPermissionsT = StaleIpPermission>
  StaleSecurityGroup& AddStaleIpPermissions(StaleIpPermissionsT&& value) {
    m_staleIpPermissionsHasBeenSet = true;
    m_staleIpPermissions.emplace_back(std::forward<StaleIpPermissionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStaleIpPermissionsEgress(StaleIpPermissionsEgressT&& value) {
    m_staleIpPermissionsEgressHasBeenSet = true;
    m_staleIpPermissionsEgress = std::forward<StaleIpPermissionsEgressT>(value);
  }
  template <typename StaleIpPermissionsEgressT = Aws::Vector<StaleIpPermission>>
  StaleSecurityGroup& WithStaleIpPermissionsEgress(StaleIpPermissionsEgressT&& value) {
    SetStaleIpPermissionsEgress(std::forward<StaleIpPermissionsEgressT>(value));
    return *this;
  }
  template <typename StaleIpPermissionsEgressT = StaleIpPermission>
  StaleSecurityGroup& AddStaleIpPermissionsEgress(StaleIpPermissionsEgressT&& value) {
    m_staleIpPermissionsEgressHasBeenSet = true;
    m_staleIpPermissionsEgress.emplace_back(std::forward<StaleIpPermissionsEgressT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename VpcIdT = Aws::String>
  StaleSecurityGroup& WithVpcId(VpcIdT&& value) {
