...
class DescribeInternetGatewaysRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeInternetGatewaysRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeInternetGatewaysRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetInternetGatewayIds(InternetGatewayIdsT&& value) {
    m_internetGatewayIdsHasBeenSet = true;
    m_internetGatewayIds = std::forward<InternetGatewayIdsT>(value);
  }
  template <typename InternetGatewayIdsT = Aws::Vector<Aws::String>>
  DescribeInternetGatewaysRequest& WithInternetGatewayIds(InternetGatewayIdsT&& value) {
    SetInternetGatewayIds(std::forward<InternetGatewayIdsT>(value));
    return *this;
  }
  ...
  DescribeInternetGatewaysRequest& AddInternetGatewayIds(InternetGatewayIdsT&& value) {
    m_internetGatewayIdsHasBeenSet = true;
    m_internetGatewayIds.emplace_back(std::forward<InternetGatewayIdsT>(value));
    return *this;
  }
  ///@}
