...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API IpamResourceTag() = default;
    ...
    template<typename KeyT = Aws::String>
    IpamResourceTag& WithKey(KeyT&& value) { SetKey(std::forward<KeyT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    IpamResourceTag& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
