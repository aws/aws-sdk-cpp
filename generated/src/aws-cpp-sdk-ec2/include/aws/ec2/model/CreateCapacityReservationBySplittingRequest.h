...
class CreateCapacityReservationBySplittingRequest : public EC2Request {
 ...
 public:
  ...
  inline CreateCapacityReservationBySplittingRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  CreateCapacityReservationBySplittingRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename SourceCapacityReservationIdT = Aws::String>
  CreateCapacityReservationBySplittingRequest& WithSourceCapacityReservationId(SourceCapacityReservationIdT&& value) {
  ...
  inline CreateCapacityReservationBySplittingRequest& WithInstanceCount(int value) {
  ...
  template <typename TagSpecificationsT = Aws::Vector<TagSpecification>>
  CreateCapacityReservationBySplittingRequest& WithTagSpecifications(TagSpecificationsT&& value) {
    SetTagSpecifications(std::forward<TagSpecificationsT>(value));
    return *this;
  }
  template <typename TagSpecificationsT = TagSpecification>
  CreateCapacityReservationBySplittingRequest& AddTagSpecifications(TagSpecificationsT&& value) {
    m_tagSpecificationsHasBeenSet = true;
