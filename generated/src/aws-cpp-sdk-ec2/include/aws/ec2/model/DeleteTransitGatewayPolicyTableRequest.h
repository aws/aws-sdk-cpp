...
class DeleteTransitGatewayPolicyTableRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayPolicyTableIdT = Aws::String>
  DeleteTransitGatewayPolicyTableRequest& WithTransitGatewayPolicyTableId(TransitGatewayPolicyTableIdT&& value) {
  ...
  inline DeleteTransitGatewayPolicyTableRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
