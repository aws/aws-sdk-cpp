...
class DeleteVpcEndpointConnectionNotificationsResponse {
 public:
  ...
  AWS_EC2_API DeleteVpcEndpointConnectionNotificationsResponse& operator=(
  ...
  template <typename UnsuccessfulT = Aws::Vector<UnsuccessfulItem>>
  DeleteVpcEndpointConnectionNotificationsResponse& WithUnsuccessful(UnsuccessfulT&& value) {
    SetUnsuccessful(std::forward<UnsuccessfulT>(value));
    return *this;
  }
  template <typename UnsuccessfulT = UnsuccessfulItem>
  DeleteVpcEndpointConnectionNotificationsResponse& AddUnsuccessful(UnsuccessfulT&& value) {
    m_unsuccessfulHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteVpcEndpointConnectionNotificationsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
