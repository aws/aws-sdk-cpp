...
class ReplaceImageCriteriaInAllowedImagesSettingsResponse {
 public:
  ...
  AWS_EC2_API ReplaceImageCriteriaInAllowedImagesSettingsResponse& operator=(
  ...
  inline ReplaceImageCriteriaInAllowedImagesSettingsResponse& WithReturnValue(bool value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ReplaceImageCriteriaInAllowedImagesSettingsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
