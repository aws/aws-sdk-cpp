...
class ClientVpnAuthorizationRuleStatus {
 public:
  ...
  inline void SetCode(ClientVpnAuthorizationRuleStatusCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline ClientVpnAuthorizationRuleStatus& WithCode(ClientVpnAuthorizationRuleStatusCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  ClientVpnAuthorizationRuleStatus& WithMessage(MessageT&& value) {
