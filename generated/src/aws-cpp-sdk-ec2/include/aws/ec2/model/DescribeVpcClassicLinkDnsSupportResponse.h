...
class DescribeVpcClassicLinkDnsSupportResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVpcClassicLinkDnsSupportResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VpcsT = Aws::Vector<ClassicLinkDnsSupport>>
  DescribeVpcClassicLinkDnsSupportResponse& WithVpcs(VpcsT&& value) {
    SetVpcs(std::forward<VpcsT>(value));
    return *this;
  }
  template <typename VpcsT = ClassicLinkDnsSupport>
  DescribeVpcClassicLinkDnsSupportResponse& AddVpcs(VpcsT&& value) {
    m_vpcsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVpcClassicLinkDnsSupportResponse& WithResponseMetadata(ResponseMetadataT&& value) {
