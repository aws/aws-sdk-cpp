...
class GetImageBlockPublicAccessStateResponse {
 public:
  ...
  void SetImageBlockPublicAccessState(ImageBlockPublicAccessStateT&& value) {
    m_imageBlockPublicAccessStateHasBeenSet = true;
    m_imageBlockPublicAccessState = std::forward<ImageBlockPublicAccessStateT>(value);
  }
  template <typename ImageBlockPublicAccessStateT = Aws::String>
  GetImageBlockPublicAccessStateResponse& WithImageBlockPublicAccessState(ImageBlockPublicAccessStateT&& value) {
    SetImageBlockPublicAccessState(std::forward<ImageBlockPublicAccessStateT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetImageBlockPublicAccessStateResponse& WithManagedBy(ManagedBy value) {
    SetManagedBy(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetImageBlockPublicAccessStateResponse& WithResponseMetadata(ResponseMetadataT&& value) {
