...
class EbsOptimizedInfo {
 public:
  ...
  inline EbsOptimizedInfo& WithBaselineBandwidthInMbps(int value) {
  ...
  inline EbsOptimizedInfo& WithBaselineThroughputInMBps(double value) {
  ...
  inline EbsOptimizedInfo& WithBaselineIops(int value) {
  ...
  inline EbsOptimizedInfo& WithMaximumBandwidthInMbps(int value) {
  ...
  inline EbsOptimizedInfo& WithMaximumThroughputInMBps(double value) {
  ...
  inline EbsOptimizedInfo& WithMaximumIops(int value) {
