...
class InstanceTagNotificationAttribute {
 public:
  ...
  template <typename InstanceTagKeysT = Aws::Vector<Aws::String>>
  InstanceTagNotificationAttribute& WithInstanceTagKeys(InstanceTagKeysT&& value) {
    SetInstanceTagKeys(std::forward<InstanceTagKeysT>(value));
    return *this;
  }
  template <typename InstanceTagKeysT = Aws::String>
  InstanceTagNotificationAttribute& AddInstanceTagKeys(InstanceTagKeysT&& value) {
    m_instanceTagKeysHasBeenSet = true;
  ...
  inline InstanceTagNotificationAttribute& WithIncludeAllTagsOfInstance(bool value) {
