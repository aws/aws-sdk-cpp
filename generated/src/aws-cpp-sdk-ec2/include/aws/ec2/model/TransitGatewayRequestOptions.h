...
class TransitGatewayRequestOptions {
 public:
  ...
  inline TransitGatewayRequestOptions& WithAmazonSideAsn(long long value) {
  ...
  inline TransitGatewayRequestOptions& WithAutoAcceptSharedAttachments(AutoAcceptSharedAttachmentsValue value) {
  ...
  inline TransitGatewayRequestOptions& WithDefaultRouteTableAssociation(DefaultRouteTableAssociationValue value) {
  ...
  inline TransitGatewayRequestOptions& WithDefaultRouteTablePropagation(DefaultRouteTablePropagationValue value) {
  ...
  inline TransitGatewayRequestOptions& WithVpnEcmpSupport(VpnEcmpSupportValue value) {
  ...
  inline TransitGatewayRequestOptions& WithDnsSupport(DnsSupportValue value) {
    SetDnsSupport(value);
    return *this;
  }
  ///@}
  ...
  inline TransitGatewayRequestOptions& WithSecurityGroupReferencingSupport(SecurityGroupReferencingSupportValue value) {
  ...
  inline TransitGatewayRequestOptions& WithMulticastSupport(MulticastSupportValue value) {
