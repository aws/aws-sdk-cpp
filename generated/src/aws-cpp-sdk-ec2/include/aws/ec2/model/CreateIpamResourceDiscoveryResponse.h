...
class CreateIpamResourceDiscoveryResponse {
 public:
  ...
  template <typename IpamResourceDiscoveryT = IpamResourceDiscovery>
  CreateIpamResourceDiscoveryResponse& WithIpamResourceDiscovery(IpamResourceDiscoveryT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateIpamResourceDiscoveryResponse& WithResponseMetadata(ResponseMetadataT&& value) {
