...
class DeleteTransitGatewayPeeringAttachmentResponse {
 public:
  ...
  AWS_EC2_API DeleteTransitGatewayPeeringAttachmentResponse& operator=(
  ...
  template <typename TransitGatewayPeeringAttachmentT = TransitGatewayPeeringAttachment>
  DeleteTransitGatewayPeeringAttachmentResponse& WithTransitGatewayPeeringAttachment(TransitGatewayPeeringAttachmentT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteTransitGatewayPeeringAttachmentResponse& WithResponseMetadata(ResponseMetadataT&& value) {
