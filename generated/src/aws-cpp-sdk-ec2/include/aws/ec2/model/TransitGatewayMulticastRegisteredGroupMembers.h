...
class TransitGatewayMulticastRegisteredGroupMembers {
 public:
  ...
  template <typename TransitGatewayMulticastDomainIdT = Aws::String>
  TransitGatewayMulticastRegisteredGroupMembers& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) {
  ...
  void SetRegisteredNetworkInterfaceIds(RegisteredNetworkInterfaceIdsT&& value) {
    m_registeredNetworkInterfaceIdsHasBeenSet = true;
    m_registeredNetworkInterfaceIds = std::forward<RegisteredNetworkInterfaceIdsT>(value);
  }
  template <typename RegisteredNetworkInterfaceIdsT = Aws::Vector<Aws::String>>
  TransitGatewayMulticastRegisteredGroupMembers& WithRegisteredNetworkInterfaceIds(RegisteredNetworkInterfaceIdsT&& value) {
    SetRegisteredNetworkInterfaceIds(std::forward<RegisteredNetworkInterfaceIdsT>(value));
    return *this;
  }
  template <typename RegisteredNetworkInterfaceIdsT = Aws::String>
  TransitGatewayMulticastRegisteredGroupMembers& AddRegisteredNetworkInterfaceIds(RegisteredNetworkInterfaceIdsT&& value) {
    m_registeredNetworkInterfaceIdsHasBeenSet = true;
    m_registeredNetworkInterfaceIds.emplace_back(std::forward<RegisteredNetworkInterfaceIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename GroupIpAddressT = Aws::String>
  TransitGatewayMulticastRegisteredGroupMembers& WithGroupIpAddress(GroupIpAddressT&& value) {
