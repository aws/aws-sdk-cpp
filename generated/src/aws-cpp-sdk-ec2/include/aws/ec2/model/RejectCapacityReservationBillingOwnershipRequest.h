...
class RejectCapacityReservationBillingOwnershipRequest : public EC2Request {
 ...
 public:
  ...
  inline RejectCapacityReservationBillingOwnershipRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename CapacityReservationIdT = Aws::String>
  RejectCapacityReservationBillingOwnershipRequest& WithCapacityReservationId(CapacityReservationIdT&& value) {
