...
class TargetCapacitySpecification {
 public:
  ...
  inline TargetCapacitySpecification& WithTotalTargetCapacity(int value) {
  ...
  inline void SetOnDemandTargetCapacity(int value) {
    m_onDemandTargetCapacityHasBeenSet = true;
    m_onDemandTargetCapacity = value;
  }
  inline TargetCapacitySpecification& WithOnDemandTargetCapacity(int value) {
    SetOnDemandTargetCapacity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpotTargetCapacity(int value) {
    m_spotTargetCapacityHasBeenSet = true;
    m_spotTargetCapacity = value;
  }
  inline TargetCapacitySpecification& WithSpotTargetCapacity(int value) {
    SetSpotTargetCapacity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultTargetCapacityType(DefaultTargetCapacityType value) {
    m_defaultTargetCapacityTypeHasBeenSet = true;
    m_defaultTargetCapacityType = value;
  }
  inline TargetCapacitySpecification& WithDefaultTargetCapacityType(DefaultTargetCapacityType value) {
    SetDefaultTargetCapacityType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetCapacityUnitType(TargetCapacityUnitType value) {
    m_targetCapacityUnitTypeHasBeenSet = true;
    m_targetCapacityUnitType = value;
  }
  inline TargetCapacitySpecification& WithTargetCapacityUnitType(TargetCapacityUnitType value) {
    SetTargetCapacityUnitType(value);
    return *this;
  }
  ///@}
 private:
