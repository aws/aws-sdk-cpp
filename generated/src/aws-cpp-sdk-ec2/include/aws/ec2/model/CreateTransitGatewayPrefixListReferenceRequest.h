...
class CreateTransitGatewayPrefixListReferenceRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayRouteTableIdT = Aws::String>
  CreateTransitGatewayPrefixListReferenceRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) {
  ...
  template <typename PrefixListIdT = Aws::String>
  CreateTransitGatewayPrefixListReferenceRequest& WithPrefixListId(PrefixListIdT&& value) {
  ...
  template <typename TransitGatewayAttachmentIdT = Aws::String>
  CreateTransitGatewayPrefixListReferenceRequest& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) {
  ...
  inline CreateTransitGatewayPrefixListReferenceRequest& WithBlackhole(bool value) {
    SetBlackhole(value);
    return *this;
  }
  ///@}
  ...
  inline CreateTransitGatewayPrefixListReferenceRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
