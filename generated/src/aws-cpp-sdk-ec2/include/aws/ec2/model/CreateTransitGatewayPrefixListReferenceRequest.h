...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API CreateTransitGatewayPrefixListReferenceRequest() = default;
  ...
  public:
    ...
    template<typename TransitGatewayRouteTableIdT = Aws::String>
    CreateTransitGatewayPrefixListReferenceRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) { SetTransitGatewayRouteTableId(std::forward<TransitGatewayRouteTableIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PrefixListIdT = Aws::String>
    CreateTransitGatewayPrefixListReferenceRequest& WithPrefixListId(PrefixListIdT&& value) { SetPrefixListId(std::forward<PrefixListIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TransitGatewayAttachmentIdT = Aws::String>
    CreateTransitGatewayPrefixListReferenceRequest& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) { SetTransitGatewayAttachmentId(std::forward<TransitGatewayAttachmentIdT>(value)); return *this;}
    ///@}
