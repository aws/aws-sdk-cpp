...
class DescribeIpamsResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeIpamsResponse& WithNextToken(NextTokenT&& value) {
  ...
  void SetIpams(IpamsT&& value) {
    m_ipamsHasBeenSet = true;
    m_ipams = std::forward<IpamsT>(value);
  }
  template <typename IpamsT = Aws::Vector<Ipam>>
  DescribeIpamsResponse& WithIpams(IpamsT&& value) {
    SetIpams(std::forward<IpamsT>(value));
    return *this;
  }
  template <typename IpamsT = Ipam>
  DescribeIpamsResponse& AddIpams(IpamsT&& value) {
    m_ipamsHasBeenSet = true;
    m_ipams.emplace_back(std::forward<IpamsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeIpamsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
