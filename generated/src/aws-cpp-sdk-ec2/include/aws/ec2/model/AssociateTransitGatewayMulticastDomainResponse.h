...
class AssociateTransitGatewayMulticastDomainResponse {
 public:
  AWS_EC2_API AssociateTransitGatewayMulticastDomainResponse() = default;
  ...
  AWS_EC2_API AssociateTransitGatewayMulticastDomainResponse& operator=(
  ...
  template <typename AssociationsT = TransitGatewayMulticastDomainAssociations>
  AssociateTransitGatewayMulticastDomainResponse& WithAssociations(AssociationsT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AssociateTransitGatewayMulticastDomainResponse& WithResponseMetadata(ResponseMetadataT&& value) {
