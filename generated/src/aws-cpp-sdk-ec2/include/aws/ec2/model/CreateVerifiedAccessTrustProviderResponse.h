...
class CreateVerifiedAccessTrustProviderResponse {
 public:
  ...
  template <typename VerifiedAccessTrustProviderT = VerifiedAccessTrustProvider>
  CreateVerifiedAccessTrustProviderResponse& WithVerifiedAccessTrustProvider(VerifiedAccessTrustProviderT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateVerifiedAccessTrustProviderResponse& WithResponseMetadata(ResponseMetadataT&& value) {
