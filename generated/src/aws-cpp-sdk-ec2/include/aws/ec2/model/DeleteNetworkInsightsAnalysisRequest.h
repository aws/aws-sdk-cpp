...
class DeleteNetworkInsightsAnalysisRequest : public EC2Request {
 ...
 public:
  ...
  inline DeleteNetworkInsightsAnalysisRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename NetworkInsightsAnalysisIdT = Aws::String>
  DeleteNetworkInsightsAnalysisRequest& WithNetworkInsightsAnalysisId(NetworkInsightsAnalysisIdT&& value) {
