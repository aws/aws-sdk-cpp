...
namespace Model
{
  ...
  public:
    ...
    template<typename IamInstanceProfileAssociationT = IamInstanceProfileAssociation>
    DisassociateIamInstanceProfileResponse& WithIamInstanceProfileAssociation(IamInstanceProfileAssociationT&& value) { SetIamInstanceProfileAssociation(std::forward<IamInstanceProfileAssociationT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DisassociateIamInstanceProfileResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
