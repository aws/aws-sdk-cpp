...
class GetIpamPoolCidrsResponse {
 public:
  ...
  void SetIpamPoolCidrs(IpamPoolCidrsT&& value) {
    m_ipamPoolCidrsHasBeenSet = true;
    m_ipamPoolCidrs = std::forward<IpamPoolCidrsT>(value);
  }
  template <typename IpamPoolCidrsT = Aws::Vector<IpamPoolCidr>>
  GetIpamPoolCidrsResponse& WithIpamPoolCidrs(IpamPoolCidrsT&& value) {
    SetIpamPoolCidrs(std::forward<IpamPoolCidrsT>(value));
    return *this;
  }
  template <typename IpamPoolCidrsT = IpamPoolCidr>
  GetIpamPoolCidrsResponse& AddIpamPoolCidrs(IpamPoolCidrsT&& value) {
    m_ipamPoolCidrsHasBeenSet = true;
    m_ipamPoolCidrs.emplace_back(std::forward<IpamPoolCidrsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetIpamPoolCidrsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetIpamPoolCidrsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
