...
class SpotFleetTagSpecification {
 public:
  AWS_EC2_API SpotFleetTagSpecification() = default;
  ...
  inline SpotFleetTagSpecification& WithResourceType(ResourceType value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  SpotFleetTagSpecification& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  SpotFleetTagSpecification& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
