...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DeleteVpcBlockPublicAccessExclusionResponse() = default;
    ...
    template<typename VpcBlockPublicAccessExclusionT = VpcBlockPublicAccessExclusion>
    DeleteVpcBlockPublicAccessExclusionResponse& WithVpcBlockPublicAccessExclusion(VpcBlockPublicAccessExclusionT&& value) { SetVpcBlockPublicAccessExclusion(std::forward<VpcBlockPublicAccessExclusionT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteVpcBlockPublicAccessExclusionResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
