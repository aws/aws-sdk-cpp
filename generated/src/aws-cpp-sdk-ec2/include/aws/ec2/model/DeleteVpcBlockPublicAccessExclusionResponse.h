...
class DeleteVpcBlockPublicAccessExclusionResponse {
 public:
  ...
  AWS_EC2_API DeleteVpcBlockPublicAccessExclusionResponse& operator=(
  ...
  template <typename VpcBlockPublicAccessExclusionT = VpcBlockPublicAccessExclusion>
  DeleteVpcBlockPublicAccessExclusionResponse& WithVpcBlockPublicAccessExclusion(VpcBlockPublicAccessExclusionT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteVpcBlockPublicAccessExclusionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
