...
class DescribeFpgaImageAttributeRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeFpgaImageAttributeRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAttribute(FpgaImageAttributeName value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline DescribeFpgaImageAttributeRequest& WithAttribute(FpgaImageAttributeName value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
