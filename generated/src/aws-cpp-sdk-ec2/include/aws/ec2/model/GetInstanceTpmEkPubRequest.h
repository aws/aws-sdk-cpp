...
class GetInstanceTpmEkPubRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetKeyType(EkPubKeyType value) {
    m_keyTypeHasBeenSet = true;
    m_keyType = value;
  }
  inline GetInstanceTpmEkPubRequest& WithKeyType(EkPubKeyType value) {
    SetKeyType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetKeyFormat(EkPubKeyFormat value) {
    m_keyFormatHasBeenSet = true;
    m_keyFormat = value;
  }
  inline GetInstanceTpmEkPubRequest& WithKeyFormat(EkPubKeyFormat value) {
    SetKeyFormat(value);
    return *this;
  }
  ///@}
  ...
  inline GetInstanceTpmEkPubRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
