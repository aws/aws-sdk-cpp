...
class NetworkCardInfo {
 public:
  ...
  inline NetworkCardInfo& WithNetworkCardIndex(int value) {
  ...
  inline void SetMaximumNetworkInterfaces(int value) {
    m_maximumNetworkInterfacesHasBeenSet = true;
    m_maximumNetworkInterfaces = value;
  }
  inline NetworkCardInfo& WithMaximumNetworkInterfaces(int value) {
    SetMaximumNetworkInterfaces(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBaselineBandwidthInGbps(double value) {
    m_baselineBandwidthInGbpsHasBeenSet = true;
    m_baselineBandwidthInGbps = value;
  }
  inline NetworkCardInfo& WithBaselineBandwidthInGbps(double value) {
    SetBaselineBandwidthInGbps(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPeakBandwidthInGbps(double value) {
    m_peakBandwidthInGbpsHasBeenSet = true;
    m_peakBandwidthInGbps = value;
  }
  inline NetworkCardInfo& WithPeakBandwidthInGbps(double value) {
    SetPeakBandwidthInGbps(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultEnaQueueCountPerInterface(int value) {
    m_defaultEnaQueueCountPerInterfaceHasBeenSet = true;
    m_defaultEnaQueueCountPerInterface = value;
  }
  inline NetworkCardInfo& WithDefaultEnaQueueCountPerInterface(int value) {
    SetDefaultEnaQueueCountPerInterface(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumEnaQueueCount(int value) {
    m_maximumEnaQueueCountHasBeenSet = true;
    m_maximumEnaQueueCount = value;
  }
  inline NetworkCardInfo& WithMaximumEnaQueueCount(int value) {
    SetMaximumEnaQueueCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumEnaQueueCountPerInterface(int value) {
    m_maximumEnaQueueCountPerInterfaceHasBeenSet = true;
    m_maximumEnaQueueCountPerInterface = value;
  }
  inline NetworkCardInfo& WithMaximumEnaQueueCountPerInterface(int value) {
    SetMaximumEnaQueueCountPerInterface(value);
    return *this;
  }
  ///@}
 private:
