...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API CreateLocalGatewayRouteResponse() = default;
    ...
    template<typename RouteT = LocalGatewayRoute>
    CreateLocalGatewayRouteResponse& WithRoute(RouteT&& value) { SetRoute(std::forward<RouteT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateLocalGatewayRouteResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
