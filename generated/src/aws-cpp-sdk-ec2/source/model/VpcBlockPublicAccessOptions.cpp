...
VpcBlockPublicAccessOptions::VpcBlockPublicAccessOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
VpcBlockPublicAccessOptions& VpcBlockPublicAccessOptions::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = VpcBlockPublicAccessStateMapper::GetVpcBlockPublicAccessStateForName(
    ...
    if (!internetGatewayBlockModeNode.IsNull()) {
      m_internetGatewayBlockMode = InternetGatewayBlockModeMapper::GetInternetGatewayBlockModeForName(
    ...
    if (!exclusionsAllowedNode.IsNull()) {
      m_exclusionsAllowed = VpcBlockPublicAccessExclusionsAllowedMapper::GetVpcBlockPublicAccessExclusionsAllowedForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(exclusionsAllowedNode.GetText()).c_str()));
...
void VpcBlockPublicAccessOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(VpcBlockPublicAccessStateMapper::GetNameForVpcBlockPublicAccessState(m_state)) << "&";
  }
  ...
  if (m_exclusionsAllowedHasBeenSet) {
    oStream << location << index << locationValue << ".ExclusionsAllowed="
            << StringUtils::URLEncode(
                   VpcBlockPublicAccessExclusionsAllowedMapper::GetNameForVpcBlockPublicAccessExclusionsAllowed(m_exclusionsAllowed))
            << "&";
  }
}
...
void VpcBlockPublicAccessOptions::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_exclusionsAllowedHasBeenSet) {
    oStream << location << ".ExclusionsAllowed="
            << StringUtils::URLEncode(
                   VpcBlockPublicAccessExclusionsAllowedMapper::GetNameForVpcBlockPublicAccessExclusionsAllowed(m_exclusionsAllowed))
            << "&";
  }
