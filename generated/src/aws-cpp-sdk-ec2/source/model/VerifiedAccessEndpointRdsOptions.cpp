...
VerifiedAccessEndpointRdsOptions::VerifiedAccessEndpointRdsOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VerifiedAccessEndpointRdsOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
