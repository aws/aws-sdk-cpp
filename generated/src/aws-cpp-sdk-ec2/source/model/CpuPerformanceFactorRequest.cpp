...
CpuPerformanceFactorRequest::CpuPerformanceFactorRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void CpuPerformanceFactorRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
