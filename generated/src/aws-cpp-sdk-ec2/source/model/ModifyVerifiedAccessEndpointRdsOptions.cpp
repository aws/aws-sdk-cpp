...
ModifyVerifiedAccessEndpointRdsOptions::ModifyVerifiedAccessEndpointRdsOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ModifyVerifiedAccessEndpointRdsOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
