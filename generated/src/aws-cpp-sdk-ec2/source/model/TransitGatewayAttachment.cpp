...
TransitGatewayAttachment::TransitGatewayAttachment(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TransitGatewayAttachment::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
