...
DiskImageVolumeDescription::DiskImageVolumeDescription(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DiskImageVolumeDescription::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
