...
NetworkBandwidthGbpsRequest::NetworkBandwidthGbpsRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void NetworkBandwidthGbpsRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
