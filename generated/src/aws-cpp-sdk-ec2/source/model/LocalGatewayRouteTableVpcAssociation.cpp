...
LocalGatewayRouteTableVpcAssociation::LocalGatewayRouteTableVpcAssociation(const XmlNode& xmlNode) { *this = xmlNode; }
...
LocalGatewayRouteTableVpcAssociation& LocalGatewayRouteTableVpcAssociation::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!localGatewayRouteTableVpcAssociationIdNode.IsNull()) {
      m_localGatewayRouteTableVpcAssociationId =
          Aws::Utils::Xml::DecodeEscapedXmlText(localGatewayRouteTableVpcAssociationIdNode.GetText());
...
void LocalGatewayRouteTableVpcAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                          const char* locationValue) const {
  if (m_localGatewayRouteTableVpcAssociationIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".LocalGatewayRouteTableVpcAssociationId=" << StringUtils::URLEncode(m_localGatewayRouteTableVpcAssociationId.c_str())
            << "&";
  }
