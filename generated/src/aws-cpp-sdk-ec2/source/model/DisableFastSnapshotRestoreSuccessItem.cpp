...
DisableFastSnapshotRestoreSuccessItem::DisableFastSnapshotRestoreSuccessItem(const XmlNode& xmlNode) { *this = xmlNode; }

DisableFastSnapshotRestoreSuccessItem& DisableFastSnapshotRestoreSuccessItem::operator=(const XmlNode& xmlNode) {
...
void DisableFastSnapshotRestoreSuccessItem::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void DisableFastSnapshotRestoreSuccessItem::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_snapshotIdHasBeenSet) {
