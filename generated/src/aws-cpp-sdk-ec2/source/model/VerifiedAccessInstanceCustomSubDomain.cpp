...
VerifiedAccessInstanceCustomSubDomain::VerifiedAccessInstanceCustomSubDomain(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VerifiedAccessInstanceCustomSubDomain::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
