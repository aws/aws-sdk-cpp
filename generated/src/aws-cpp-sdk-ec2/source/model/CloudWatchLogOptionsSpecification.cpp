...
CloudWatchLogOptionsSpecification::CloudWatchLogOptionsSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
void CloudWatchLogOptionsSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
