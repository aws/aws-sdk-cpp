...
LaunchTemplateEnaSrdUdpSpecification::LaunchTemplateEnaSrdUdpSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LaunchTemplateEnaSrdUdpSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
