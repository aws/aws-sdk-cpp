...
ClientConnectResponseOptions::ClientConnectResponseOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ClientConnectResponseOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
