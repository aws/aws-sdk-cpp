...
FleetLaunchTemplateConfigRequest::FleetLaunchTemplateConfigRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void FleetLaunchTemplateConfigRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
