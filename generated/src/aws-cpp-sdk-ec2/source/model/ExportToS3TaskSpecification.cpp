...
ExportToS3TaskSpecification::ExportToS3TaskSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ExportToS3TaskSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
