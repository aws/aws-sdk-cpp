...
InstanceIpv6AddressRequest::InstanceIpv6AddressRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InstanceIpv6AddressRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
