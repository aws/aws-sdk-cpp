...
ScheduledInstancesPlacement::ScheduledInstancesPlacement(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ScheduledInstancesPlacement::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
