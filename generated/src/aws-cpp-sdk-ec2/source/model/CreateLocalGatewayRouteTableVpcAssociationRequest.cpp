...
Aws::String CreateLocalGatewayRouteTableVpcAssociationRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=CreateLocalGatewayRouteTableVpcAssociation&";
...
void CreateLocalGatewayRouteTableVpcAssociationRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
