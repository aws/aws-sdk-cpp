...
DeleteImageUsageReportResponse::DeleteImageUsageReportResponse(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}
...
DeleteImageUsageReportResponse& DeleteImageUsageReportResponse::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  if (!rootNode.IsNull() && (rootNode.GetName() != "DeleteImageUsageReportResponse"))
  {
    resultNode = rootNode.FirstChild("DeleteImageUsageReportResponse");
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DeleteImageUsageReportResponse", "x-amzn-request-id: " << m_responseMetadata.GetRequestId() );
  }
  return *this;
}
