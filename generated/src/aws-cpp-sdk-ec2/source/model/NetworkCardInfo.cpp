...
NetworkCardInfo::NetworkCardInfo(const XmlNode& xmlNode) { *this = xmlNode; }
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!baselineBandwidthInGbpsNode.IsNull()) {
      m_baselineBandwidthInGbps = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(baselineBandwidthInGbpsNode.GetText()).c_str()).c_str());
    ...
    if (!peakBandwidthInGbpsNode.IsNull()) {
      m_peakBandwidthInGbps = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(peakBandwidthInGbpsNode.GetText()).c_str()).c_str());
    ...
    if (!defaultEnaQueueCountPerInterfaceNode.IsNull()) {
      m_defaultEnaQueueCountPerInterface = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(defaultEnaQueueCountPerInterfaceNode.GetText()).c_str()).c_str());
    ...
    if (!maximumEnaQueueCountNode.IsNull()) {
      m_maximumEnaQueueCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maximumEnaQueueCountNode.GetText()).c_str()).c_str());
    ...
    if (!maximumEnaQueueCountPerInterfaceNode.IsNull()) {
      m_maximumEnaQueueCountPerInterface = StringUtils::ConvertToInt32(
