...
BlockDeviceMappingResponse::BlockDeviceMappingResponse() : 
...
BlockDeviceMappingResponse::BlockDeviceMappingResponse(const XmlNode& xmlNode)
  : BlockDeviceMappingResponse()
{
  *this = xmlNode;
}

BlockDeviceMappingResponse& BlockDeviceMappingResponse::operator =(const XmlNode& xmlNode)
{
...
void BlockDeviceMappingResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void BlockDeviceMappingResponse::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_deviceNameHasBeenSet)
  {
