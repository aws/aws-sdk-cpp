...
BlockDeviceMappingResponse::BlockDeviceMappingResponse(const XmlNode& xmlNode) { *this = xmlNode; }
...
void BlockDeviceMappingResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
