...
ImportInstanceTaskDetails::ImportInstanceTaskDetails(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ImportInstanceTaskDetails::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
