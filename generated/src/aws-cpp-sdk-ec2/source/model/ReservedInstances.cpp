...
ReservedInstances::ReservedInstances(const XmlNode& xmlNode) { *this = xmlNode; }
...
ReservedInstances& ReservedInstances::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = ReservedInstanceStateMapper::GetReservedInstanceStateForName(
...
void ReservedInstances::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(ReservedInstanceStateMapper::GetNameForReservedInstanceState(m_state)) << "&";
  }
}
