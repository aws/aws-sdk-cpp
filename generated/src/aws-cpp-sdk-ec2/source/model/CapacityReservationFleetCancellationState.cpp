...
CapacityReservationFleetCancellationState::CapacityReservationFleetCancellationState(const XmlNode& xmlNode) { *this = xmlNode; }
...
CapacityReservationFleetCancellationState& CapacityReservationFleetCancellationState::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!currentFleetStateNode.IsNull()) {
      m_currentFleetState = CapacityReservationFleetStateMapper::GetCapacityReservationFleetStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(currentFleetStateNode.GetText()).c_str()));
    ...
    if (!previousFleetStateNode.IsNull()) {
      m_previousFleetState = CapacityReservationFleetStateMapper::GetCapacityReservationFleetStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(previousFleetStateNode.GetText()).c_str()));
...
void CapacityReservationFleetCancellationState::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                               const char* locationValue) const {
  if (m_currentFleetStateHasBeenSet) {
    oStream << location << index << locationValue << ".CurrentFleetState="
            << StringUtils::URLEncode(CapacityReservationFleetStateMapper::GetNameForCapacityReservationFleetState(m_currentFleetState))
            << "&";
  }

  if (m_previousFleetStateHasBeenSet) {
    oStream << location << index << locationValue << ".PreviousFleetState="
            << StringUtils::URLEncode(CapacityReservationFleetStateMapper::GetNameForCapacityReservationFleetState(m_previousFleetState))
            << "&";
  }
...
void CapacityReservationFleetCancellationState::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_currentFleetStateHasBeenSet) {
    oStream << location << ".CurrentFleetState="
            << StringUtils::URLEncode(CapacityReservationFleetStateMapper::GetNameForCapacityReservationFleetState(m_currentFleetState))
            << "&";
  }
  if (m_previousFleetStateHasBeenSet) {
    oStream << location << ".PreviousFleetState="
            << StringUtils::URLEncode(CapacityReservationFleetStateMapper::GetNameForCapacityReservationFleetState(m_previousFleetState))
            << "&";
  }
  if (m_capacityReservationFleetIdHasBeenSet) {
