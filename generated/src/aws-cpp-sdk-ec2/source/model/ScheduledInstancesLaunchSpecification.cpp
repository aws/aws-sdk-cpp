...
ScheduledInstancesLaunchSpecification::ScheduledInstancesLaunchSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ScheduledInstancesLaunchSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_securityGroupIdsHasBeenSet) {
    ...
    for (auto& item : m_securityGroupIds) {
      oStream << location << index << locationValue << ".SecurityGroupId." << securityGroupIdsIdx++ << "="
