...
Aws::String DisableIpamPolicyRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=DisableIpamPolicy&";
...
void DisableIpamPolicyRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
