...
CapacityReservationGroup::CapacityReservationGroup(const XmlNode& xmlNode) { *this = xmlNode; }
...
void CapacityReservationGroup::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
