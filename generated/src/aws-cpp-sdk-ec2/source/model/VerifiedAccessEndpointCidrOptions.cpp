...
VerifiedAccessEndpointCidrOptions::VerifiedAccessEndpointCidrOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VerifiedAccessEndpointCidrOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
