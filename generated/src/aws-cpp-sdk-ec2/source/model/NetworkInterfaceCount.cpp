...
NetworkInterfaceCount::NetworkInterfaceCount(const XmlNode& xmlNode) { *this = xmlNode; }

NetworkInterfaceCount& NetworkInterfaceCount::operator=(const XmlNode& xmlNode) {
...
void NetworkInterfaceCount::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  if (m_minHasBeenSet) {
...
void NetworkInterfaceCount::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_minHasBeenSet) {
