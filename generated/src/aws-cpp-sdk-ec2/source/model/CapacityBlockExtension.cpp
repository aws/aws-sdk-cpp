...
CapacityBlockExtension::CapacityBlockExtension(const XmlNode& xmlNode) { *this = xmlNode; }
...
CapacityBlockExtension& CapacityBlockExtension::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!capacityBlockExtensionStatusNode.IsNull()) {
      m_capacityBlockExtensionStatus = CapacityBlockExtensionStatusMapper::GetCapacityBlockExtensionStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(capacityBlockExtensionStatusNode.GetText()).c_str()));
    ...
    if (!capacityBlockExtensionPurchaseDateNode.IsNull()) {
      m_capacityBlockExtensionPurchaseDate = DateTime(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(capacityBlockExtensionPurchaseDateNode.GetText()).c_str()).c_str(),
...
void CapacityBlockExtension::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_capacityBlockExtensionStatusHasBeenSet) {
    oStream << location << index << locationValue << ".CapacityBlockExtensionStatus="
            << StringUtils::URLEncode(
                   CapacityBlockExtensionStatusMapper::GetNameForCapacityBlockExtensionStatus(m_capacityBlockExtensionStatus))
            << "&";
  }

  if (m_capacityBlockExtensionPurchaseDateHasBeenSet) {
    oStream << location << index << locationValue << ".CapacityBlockExtensionPurchaseDate="
            << StringUtils::URLEncode(m_capacityBlockExtensionPurchaseDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
...
void CapacityBlockExtension::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_capacityBlockExtensionStatusHasBeenSet) {
    oStream << location << ".CapacityBlockExtensionStatus="
            << StringUtils::URLEncode(
                   CapacityBlockExtensionStatusMapper::GetNameForCapacityBlockExtensionStatus(m_capacityBlockExtensionStatus))
            << "&";
  }
  if (m_capacityBlockExtensionPurchaseDateHasBeenSet) {
    oStream << location << ".CapacityBlockExtensionPurchaseDate="
            << StringUtils::URLEncode(m_capacityBlockExtensionPurchaseDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_capacityBlockExtensionStartDateHasBeenSet) {
