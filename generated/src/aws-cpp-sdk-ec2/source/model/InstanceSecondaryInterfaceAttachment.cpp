...
InstanceSecondaryInterfaceAttachment::InstanceSecondaryInterfaceAttachment(const XmlNode& xmlNode) { *this = xmlNode; }

InstanceSecondaryInterfaceAttachment& InstanceSecondaryInterfaceAttachment::operator=(const XmlNode& xmlNode) {
...
void InstanceSecondaryInterfaceAttachment::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void InstanceSecondaryInterfaceAttachment::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_attachTimeHasBeenSet) {
