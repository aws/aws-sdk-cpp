...
TransitGatewayConnectOptions::TransitGatewayConnectOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TransitGatewayConnectOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
