...
InstanceEventWindowTimeRange::InstanceEventWindowTimeRange(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InstanceEventWindowTimeRange::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
