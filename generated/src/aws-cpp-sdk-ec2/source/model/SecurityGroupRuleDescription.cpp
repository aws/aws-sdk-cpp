...
SecurityGroupRuleDescription::SecurityGroupRuleDescription(const XmlNode& xmlNode) { *this = xmlNode; }
...
void SecurityGroupRuleDescription::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
