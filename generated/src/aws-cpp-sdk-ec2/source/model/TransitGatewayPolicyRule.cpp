...
TransitGatewayPolicyRule::TransitGatewayPolicyRule(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TransitGatewayPolicyRule::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
