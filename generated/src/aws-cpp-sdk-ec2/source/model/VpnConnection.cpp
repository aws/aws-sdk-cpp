...
VpnConnection::VpnConnection(const XmlNode& xmlNode) { *this = xmlNode; }
...
VpnConnection& VpnConnection::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!gatewayAssociationStateNode.IsNull()) {
      m_gatewayAssociationState = GatewayAssociationStateMapper::GetGatewayAssociationStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(gatewayAssociationStateNode.GetText()).c_str()));
    ...
    if (!typeNode.IsNull()) {
      m_type =
          GatewayTypeMapper::GetGatewayTypeForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(typeNode.GetText()).c_str()));
...
void VpnConnection::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_coreNetworkAttachmentArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".CoreNetworkAttachmentArn=" << StringUtils::URLEncode(m_coreNetworkAttachmentArn.c_str()) << "&";
  }

  if (m_gatewayAssociationStateHasBeenSet) {
    oStream << location << index << locationValue << ".GatewayAssociationState="
            << StringUtils::URLEncode(GatewayAssociationStateMapper::GetNameForGatewayAssociationState(m_gatewayAssociationState)) << "&";
  }
  ...
  if (m_customerGatewayConfigurationHasBeenSet) {
    oStream << location << index << locationValue
            << ".CustomerGatewayConfiguration=" << StringUtils::URLEncode(m_customerGatewayConfiguration.c_str()) << "&";
  }
...
void VpnConnection::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_gatewayAssociationStateHasBeenSet) {
    oStream << location << ".GatewayAssociationState="
            << StringUtils::URLEncode(GatewayAssociationStateMapper::GetNameForGatewayAssociationState(m_gatewayAssociationState)) << "&";
  }
  if (m_optionsHasBeenSet) {
