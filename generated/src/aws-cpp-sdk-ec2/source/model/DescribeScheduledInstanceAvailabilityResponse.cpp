...
DescribeScheduledInstanceAvailabilityResponse& DescribeScheduledInstanceAvailabilityResponse::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!scheduledInstanceAvailabilitySetNode.IsNull()) {
      ...
      m_scheduledInstanceAvailabilitySetHasBeenSet = !scheduledInstanceAvailabilitySetMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DescribeScheduledInstanceAvailabilityResponse",
