...
ModifyVerifiedAccessNativeApplicationOidcOptions& ModifyVerifiedAccessNativeApplicationOidcOptions::operator =(const XmlNode& xmlNode)
{
...
void ModifyVerifiedAccessNativeApplicationOidcOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void ModifyVerifiedAccessNativeApplicationOidcOptions::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_publicSigningKeyEndpointHasBeenSet)
  {
