...
LaunchTemplateAndOverridesResponse::LaunchTemplateAndOverridesResponse(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LaunchTemplateAndOverridesResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
