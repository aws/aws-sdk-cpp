...
CapacityBlockExtensionOffering::CapacityBlockExtensionOffering(const XmlNode& xmlNode) { *this = xmlNode; }
...
CapacityBlockExtensionOffering& CapacityBlockExtensionOffering::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!capacityBlockExtensionStartDateNode.IsNull()) {
      m_capacityBlockExtensionStartDate =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(capacityBlockExtensionStartDateNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!capacityBlockExtensionEndDateNode.IsNull()) {
      m_capacityBlockExtensionEndDate =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(capacityBlockExtensionEndDateNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!capacityBlockExtensionDurationHoursNode.IsNull()) {
      m_capacityBlockExtensionDurationHours = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(capacityBlockExtensionDurationHoursNode.GetText()).c_str()).c_str());
    ...
    if (!tenancyNode.IsNull()) {
      m_tenancy = CapacityReservationTenancyMapper::GetCapacityReservationTenancyForName(
...
void CapacityBlockExtensionOffering::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                    const char* locationValue) const {
  if (m_capacityBlockExtensionOfferingIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".CapacityBlockExtensionOfferingId=" << StringUtils::URLEncode(m_capacityBlockExtensionOfferingId.c_str()) << "&";
  }
  ...
  if (m_capacityBlockExtensionStartDateHasBeenSet) {
    oStream << location << index << locationValue << ".CapacityBlockExtensionStartDate="
            << StringUtils::URLEncode(m_capacityBlockExtensionStartDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_capacityBlockExtensionEndDateHasBeenSet) {
    oStream << location << index << locationValue << ".CapacityBlockExtensionEndDate="
            << StringUtils::URLEncode(m_capacityBlockExtensionEndDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
...
void CapacityBlockExtensionOffering::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_capacityBlockExtensionStartDateHasBeenSet) {
    oStream << location << ".CapacityBlockExtensionStartDate="
            << StringUtils::URLEncode(m_capacityBlockExtensionStartDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_capacityBlockExtensionEndDateHasBeenSet) {
    oStream << location << ".CapacityBlockExtensionEndDate="
            << StringUtils::URLEncode(m_capacityBlockExtensionEndDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_capacityBlockExtensionDurationHoursHasBeenSet) {
