...
PathFilter::PathFilter(const XmlNode& xmlNode) { *this = xmlNode; }

PathFilter& PathFilter::operator=(const XmlNode& xmlNode) {
...
void PathFilter::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
...
void PathFilter::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_sourceAddressHasBeenSet) {
