...
InstanceNetworkInterface::InstanceNetworkInterface(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InstanceNetworkInterface::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
