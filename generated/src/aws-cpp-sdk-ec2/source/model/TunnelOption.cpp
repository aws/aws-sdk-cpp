...
TunnelOption::TunnelOption(const XmlNode& xmlNode) { *this = xmlNode; }
...
TunnelOption& TunnelOption::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!phase1LifetimeSecondsNode.IsNull()) {
      m_phase1LifetimeSeconds = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(phase1LifetimeSecondsNode.GetText()).c_str()).c_str());
    ...
    if (!phase2LifetimeSecondsNode.IsNull()) {
      m_phase2LifetimeSeconds = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(phase2LifetimeSecondsNode.GetText()).c_str()).c_str());
    ...
    if (!rekeyMarginTimeSecondsNode.IsNull()) {
      m_rekeyMarginTimeSeconds = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(rekeyMarginTimeSecondsNode.GetText()).c_str()).c_str());
    ...
    if (!rekeyFuzzPercentageNode.IsNull()) {
      m_rekeyFuzzPercentage = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(rekeyFuzzPercentageNode.GetText()).c_str()).c_str());
    ...
    if (!replayWindowSizeNode.IsNull()) {
      m_replayWindowSize = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(replayWindowSizeNode.GetText()).c_str()).c_str());
    ...
    if (!dpdTimeoutSecondsNode.IsNull()) {
      m_dpdTimeoutSeconds = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(dpdTimeoutSecondsNode.GetText()).c_str()).c_str());
    ...
    if (!enableTunnelLifecycleControlNode.IsNull()) {
      m_enableTunnelLifecycleControl = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(enableTunnelLifecycleControlNode.GetText()).c_str()).c_str());
...
void TunnelOption::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_phase1EncryptionAlgorithmsHasBeenSet) {
    ...
    for (auto& item : m_phase1EncryptionAlgorithms) {
      ...
      phase1EncryptionAlgorithmsSs << location << index << locationValue << ".Phase1EncryptionAlgorithmSet."
                                   << phase1EncryptionAlgorithmsIdx++;
  ...
  if (m_phase2EncryptionAlgorithmsHasBeenSet) {
    ...
    for (auto& item : m_phase2EncryptionAlgorithms) {
      ...
      phase2EncryptionAlgorithmsSs << location << index << locationValue << ".Phase2EncryptionAlgorithmSet."
                                   << phase2EncryptionAlgorithmsIdx++;
  ...
  if (m_phase1IntegrityAlgorithmsHasBeenSet) {
    ...
    for (auto& item : m_phase1IntegrityAlgorithms) {
      ...
      phase1IntegrityAlgorithmsSs << location << index << locationValue << ".Phase1IntegrityAlgorithmSet."
                                  << phase1IntegrityAlgorithmsIdx++;
  ...
  if (m_phase2IntegrityAlgorithmsHasBeenSet) {
    ...
    for (auto& item : m_phase2IntegrityAlgorithms) {
      ...
      phase2IntegrityAlgorithmsSs << location << index << locationValue << ".Phase2IntegrityAlgorithmSet."
                                  << phase2IntegrityAlgorithmsIdx++;
