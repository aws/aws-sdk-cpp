...
RequestSpotLaunchSpecification::RequestSpotLaunchSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
void RequestSpotLaunchSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_securityGroupsHasBeenSet) {
    ...
    for (auto& item : m_securityGroups) {
      oStream << location << index << locationValue << ".SecurityGroup." << securityGroupsIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
