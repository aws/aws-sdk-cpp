...
LaunchTemplateSpecification::LaunchTemplateSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LaunchTemplateSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
