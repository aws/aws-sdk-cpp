...
Aws::String RequestSpotInstancesRequest::SerializePayload() const {
  ...
  if (m_instanceInterruptionBehaviorHasBeenSet) {
    ss << "InstanceInterruptionBehavior="
       << StringUtils::URLEncode(InstanceInterruptionBehaviorMapper::GetNameForInstanceInterruptionBehavior(m_instanceInterruptionBehavior))
       << "&";
  }
...
void RequestSpotInstancesRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
