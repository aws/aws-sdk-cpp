...
TransitGatewayPolicyTable::TransitGatewayPolicyTable(const XmlNode& xmlNode) { *this = xmlNode; }
...
TransitGatewayPolicyTable& TransitGatewayPolicyTable::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = TransitGatewayPolicyTableStateMapper::GetTransitGatewayPolicyTableStateForName(
...
void TransitGatewayPolicyTable::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(TransitGatewayPolicyTableStateMapper::GetNameForTransitGatewayPolicyTableState(m_state))
            << "&";
  }
