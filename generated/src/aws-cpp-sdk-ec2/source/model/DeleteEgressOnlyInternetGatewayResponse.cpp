...
DeleteEgressOnlyInternetGatewayResponse& DeleteEgressOnlyInternetGatewayResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!returnCodeNode.IsNull()) {
      m_returnCode =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(returnCodeNode.GetText()).c_str()).c_str());
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DeleteEgressOnlyInternetGatewayResponse",
