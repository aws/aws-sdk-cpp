...
Aws::String ModifyTransitGatewayPolicyTableEntryRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=ModifyTransitGatewayPolicyTableEntry&";
...
void ModifyTransitGatewayPolicyTableEntryRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
