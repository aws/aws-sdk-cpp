...
Image::Image(const XmlNode& xmlNode) { *this = xmlNode; }
...
Image& Image::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!enaSupportNode.IsNull()) {
      m_enaSupport =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(enaSupportNode.GetText()).c_str()).c_str());
      m_enaSupportHasBeenSet = true;
    }
    XmlNode hypervisorNode = resultNode.FirstChild("hypervisor");
    if (!hypervisorNode.IsNull()) {
      m_hypervisor = HypervisorTypeMapper::GetHypervisorTypeForName(
    ...
    if (!rootDeviceTypeNode.IsNull()) {
      m_rootDeviceType = DeviceTypeMapper::GetDeviceTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(rootDeviceTypeNode.GetText()).c_str()));
    ...
    if (!virtualizationTypeNode.IsNull()) {
      m_virtualizationType = VirtualizationTypeMapper::GetVirtualizationTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(virtualizationTypeNode.GetText()).c_str()));
      m_virtualizationTypeHasBeenSet = true;
    }
    XmlNode bootModeNode = resultNode.FirstChild("bootMode");
    if (!bootModeNode.IsNull()) {
      m_bootMode = BootModeValuesMapper::GetBootModeValuesForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(bootModeNode.GetText()).c_str()));
      m_bootModeHasBeenSet = true;
    }
    XmlNode tpmSupportNode = resultNode.FirstChild("tpmSupport");
    if (!tpmSupportNode.IsNull()) {
      m_tpmSupport = TpmSupportValuesMapper::GetTpmSupportValuesForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(tpmSupportNode.GetText()).c_str()));
    ...
    if (!imdsSupportNode.IsNull()) {
      m_imdsSupport = ImdsSupportValuesMapper::GetImdsSupportValuesForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(imdsSupportNode.GetText()).c_str()));
    ...
    if (!architectureNode.IsNull()) {
      m_architecture = ArchitectureValuesMapper::GetArchitectureValuesForName(
    ...
    if (!imageTypeNode.IsNull()) {
      m_imageType = ImageTypeValuesMapper::GetImageTypeValuesForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(imageTypeNode.GetText()).c_str()));
    ...
    if (!platformNode.IsNull()) {
      m_platform = PlatformValuesMapper::GetPlatformValuesForName(
...
void Image::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_hypervisorHasBeenSet) {
    oStream << location << index << locationValue
            << ".Hypervisor=" << StringUtils::URLEncode(HypervisorTypeMapper::GetNameForHypervisorType(m_hypervisor)) << "&";
  }
  ...
  if (m_rootDeviceTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".RootDeviceType=" << StringUtils::URLEncode(DeviceTypeMapper::GetNameForDeviceType(m_rootDeviceType)) << "&";
  }
  ...
  if (m_virtualizationTypeHasBeenSet) {
    oStream << location << index << locationValue << ".VirtualizationType="
            << StringUtils::URLEncode(VirtualizationTypeMapper::GetNameForVirtualizationType(m_virtualizationType)) << "&";
  }

  if (m_bootModeHasBeenSet) {
    oStream << location << index << locationValue
            << ".BootMode=" << StringUtils::URLEncode(BootModeValuesMapper::GetNameForBootModeValues(m_bootMode)) << "&";
  }

  if (m_tpmSupportHasBeenSet) {
    oStream << location << index << locationValue
            << ".TpmSupport=" << StringUtils::URLEncode(TpmSupportValuesMapper::GetNameForTpmSupportValues(m_tpmSupport)) << "&";
  }
  ...
  if (m_imdsSupportHasBeenSet) {
    oStream << location << index << locationValue
            << ".ImdsSupport=" << StringUtils::URLEncode(ImdsSupportValuesMapper::GetNameForImdsSupportValues(m_imdsSupport)) << "&";
  }
  ...
  if (m_deregistrationProtectionHasBeenSet) {
    oStream << location << index << locationValue
            << ".DeregistrationProtection=" << StringUtils::URLEncode(m_deregistrationProtection.c_str()) << "&";
  }
  ...
  if (m_architectureHasBeenSet) {
    oStream << location << index << locationValue
            << ".Architecture=" << StringUtils::URLEncode(ArchitectureValuesMapper::GetNameForArchitectureValues(m_architecture)) << "&";
  }

  if (m_imageTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".ImageType=" << StringUtils::URLEncode(ImageTypeValuesMapper::GetNameForImageTypeValues(m_imageType)) << "&";
  }
...
void Image::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_virtualizationTypeHasBeenSet) {
    oStream << location << ".VirtualizationType="
            << StringUtils::URLEncode(VirtualizationTypeMapper::GetNameForVirtualizationType(m_virtualizationType)) << "&";
  }
  if (m_bootModeHasBeenSet) {
