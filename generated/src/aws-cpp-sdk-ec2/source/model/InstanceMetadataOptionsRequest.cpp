...
InstanceMetadataOptionsRequest::InstanceMetadataOptionsRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InstanceMetadataOptionsRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
