...
LocalGatewayRouteTable::LocalGatewayRouteTable(const XmlNode& xmlNode) { *this = xmlNode; }
...
LocalGatewayRouteTable& LocalGatewayRouteTable::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!modeNode.IsNull()) {
      m_mode = LocalGatewayRouteTableModeMapper::GetLocalGatewayRouteTableModeForName(
...
void LocalGatewayRouteTable::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_modeHasBeenSet) {
    oStream << location << index << locationValue
            << ".Mode=" << StringUtils::URLEncode(LocalGatewayRouteTableModeMapper::GetNameForLocalGatewayRouteTableMode(m_mode)) << "&";
  }
