...
AcceleratorTotalMemoryMiBRequest::AcceleratorTotalMemoryMiBRequest(const XmlNode& xmlNode) { *this = xmlNode; }

AcceleratorTotalMemoryMiBRequest& AcceleratorTotalMemoryMiBRequest::operator=(const XmlNode& xmlNode) {
...
void AcceleratorTotalMemoryMiBRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void AcceleratorTotalMemoryMiBRequest::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_minHasBeenSet) {
