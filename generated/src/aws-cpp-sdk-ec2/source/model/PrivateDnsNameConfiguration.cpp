...
PrivateDnsNameConfiguration::PrivateDnsNameConfiguration(const XmlNode& xmlNode) { *this = xmlNode; }
...
PrivateDnsNameConfiguration& PrivateDnsNameConfiguration::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state =
          DnsNameStateMapper::GetDnsNameStateForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(stateNode.GetText()).c_str()));
...
void PrivateDnsNameConfiguration::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                 const char* locationValue) const {
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(DnsNameStateMapper::GetNameForDnsNameState(m_state)) << "&";
  }
