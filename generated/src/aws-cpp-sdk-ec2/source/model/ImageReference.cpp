...
ImageReference::ImageReference(const XmlNode& xmlNode) { *this = xmlNode; }
...
ImageReference& ImageReference::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!resourceTypeNode.IsNull()) {
      m_resourceType = ImageReferenceResourceTypeMapper::GetImageReferenceResourceTypeForName(
...
void ImageReference::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_resourceTypeHasBeenSet) {
    oStream << location << index << locationValue << ".ResourceType="
            << StringUtils::URLEncode(ImageReferenceResourceTypeMapper::GetNameForImageReferenceResourceType(m_resourceType)) << "&";
  }
