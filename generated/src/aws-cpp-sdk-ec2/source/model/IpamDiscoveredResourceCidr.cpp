...
IpamDiscoveredResourceCidr::IpamDiscoveredResourceCidr(const XmlNode& xmlNode) { *this = xmlNode; }
...
IpamDiscoveredResourceCidr& IpamDiscoveredResourceCidr::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!ipSourceNode.IsNull()) {
      m_ipSource = IpamResourceCidrIpSourceMapper::GetIpamResourceCidrIpSourceForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(ipSourceNode.GetText()).c_str()));
    ...
    if (!ipUsageNode.IsNull()) {
      m_ipUsage =
          StringUtils::ConvertToDouble(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(ipUsageNode.GetText()).c_str()).c_str());
    ...
    if (!networkInterfaceAttachmentStatusNode.IsNull()) {
      m_networkInterfaceAttachmentStatus = IpamNetworkInterfaceAttachmentStatusMapper::GetIpamNetworkInterfaceAttachmentStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(networkInterfaceAttachmentStatusNode.GetText()).c_str()));
...
void IpamDiscoveredResourceCidr::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_ipSourceHasBeenSet) {
    oStream << location << index << locationValue
            << ".IpSource=" << StringUtils::URLEncode(IpamResourceCidrIpSourceMapper::GetNameForIpamResourceCidrIpSource(m_ipSource))
            << "&";
  }
  ...
  if (m_networkInterfaceAttachmentStatusHasBeenSet) {
    oStream << location << index << locationValue << ".NetworkInterfaceAttachmentStatus="
            << StringUtils::URLEncode(IpamNetworkInterfaceAttachmentStatusMapper::GetNameForIpamNetworkInterfaceAttachmentStatus(
                   m_networkInterfaceAttachmentStatus))
            << "&";
  }
...
void IpamDiscoveredResourceCidr::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_networkInterfaceAttachmentStatusHasBeenSet) {
    oStream << location << ".NetworkInterfaceAttachmentStatus="
            << StringUtils::URLEncode(IpamNetworkInterfaceAttachmentStatusMapper::GetNameForIpamNetworkInterfaceAttachmentStatus(
                   m_networkInterfaceAttachmentStatus))
            << "&";
  }
