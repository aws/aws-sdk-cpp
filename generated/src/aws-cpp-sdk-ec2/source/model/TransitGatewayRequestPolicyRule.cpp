...
TransitGatewayRequestPolicyRule::TransitGatewayRequestPolicyRule(const XmlNode& xmlNode) { *this = xmlNode; }

TransitGatewayRequestPolicyRule& TransitGatewayRequestPolicyRule::operator=(const XmlNode& xmlNode) {
...
void TransitGatewayRequestPolicyRule::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void TransitGatewayRequestPolicyRule::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_sourceCidrBlockHasBeenSet) {
