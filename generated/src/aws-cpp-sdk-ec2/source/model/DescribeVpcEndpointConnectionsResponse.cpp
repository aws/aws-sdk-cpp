...
DescribeVpcEndpointConnectionsResponse& DescribeVpcEndpointConnectionsResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!vpcEndpointConnectionsNode.IsNull()) {
      ...
      m_vpcEndpointConnectionsHasBeenSet = !vpcEndpointConnectionsMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DescribeVpcEndpointConnectionsResponse",
