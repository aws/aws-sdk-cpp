...
TransitGatewayPeeringAttachment::TransitGatewayPeeringAttachment(const XmlNode& xmlNode) { *this = xmlNode; }
...
TransitGatewayPeeringAttachment& TransitGatewayPeeringAttachment::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = TransitGatewayAttachmentStateMapper::GetTransitGatewayAttachmentStateForName(
...
void TransitGatewayPeeringAttachment::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_accepterTransitGatewayAttachmentIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".AccepterTransitGatewayAttachmentId=" << StringUtils::URLEncode(m_accepterTransitGatewayAttachmentId.c_str()) << "&";
  }
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(TransitGatewayAttachmentStateMapper::GetNameForTransitGatewayAttachmentState(m_state))
            << "&";
  }
