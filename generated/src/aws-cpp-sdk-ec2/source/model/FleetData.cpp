...
FleetData::FleetData(const XmlNode& xmlNode) { *this = xmlNode; }
...
FleetData& FleetData::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!activityStatusNode.IsNull()) {
      m_activityStatus = FleetActivityStatusMapper::GetFleetActivityStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(activityStatusNode.GetText()).c_str()));
    ...
    if (!fleetStateNode.IsNull()) {
      m_fleetState = FleetStateCodeMapper::GetFleetStateCodeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(fleetStateNode.GetText()).c_str()));
    ...
    if (!excessCapacityTerminationPolicyNode.IsNull()) {
      m_excessCapacityTerminationPolicy = FleetExcessCapacityTerminationPolicyMapper::GetFleetExcessCapacityTerminationPolicyForName(
    ...
    if (!fulfilledOnDemandCapacityNode.IsNull()) {
      m_fulfilledOnDemandCapacity = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(fulfilledOnDemandCapacityNode.GetText()).c_str()).c_str());
...
void FleetData::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  if (m_activityStatusHasBeenSet) {
    oStream << location << index << locationValue
            << ".ActivityStatus=" << StringUtils::URLEncode(FleetActivityStatusMapper::GetNameForFleetActivityStatus(m_activityStatus))
            << "&";
  }
  ...
  if (m_fleetStateHasBeenSet) {
    oStream << location << index << locationValue
            << ".FleetState=" << StringUtils::URLEncode(FleetStateCodeMapper::GetNameForFleetStateCode(m_fleetState)) << "&";
  }
  ...
  if (m_excessCapacityTerminationPolicyHasBeenSet) {
    oStream << location << index << locationValue << ".ExcessCapacityTerminationPolicy="
            << StringUtils::URLEncode(FleetExcessCapacityTerminationPolicyMapper::GetNameForFleetExcessCapacityTerminationPolicy(
                   m_excessCapacityTerminationPolicy))
            << "&";
  }
