...
DestinationOptionsRequest::DestinationOptionsRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DestinationOptionsRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
