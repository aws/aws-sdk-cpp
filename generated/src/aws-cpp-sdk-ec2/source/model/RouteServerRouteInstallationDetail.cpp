...
RouteServerRouteInstallationDetail::RouteServerRouteInstallationDetail(const XmlNode& xmlNode) { *this = xmlNode; }
...
RouteServerRouteInstallationDetail& RouteServerRouteInstallationDetail::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!routeInstallationStatusNode.IsNull()) {
      m_routeInstallationStatus = RouteServerRouteInstallationStatusMapper::GetRouteServerRouteInstallationStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(routeInstallationStatusNode.GetText()).c_str()));
...
void RouteServerRouteInstallationDetail::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_routeInstallationStatusHasBeenSet) {
    oStream << location << index << locationValue << ".RouteInstallationStatus="
            << StringUtils::URLEncode(
                   RouteServerRouteInstallationStatusMapper::GetNameForRouteServerRouteInstallationStatus(m_routeInstallationStatus))
            << "&";
  }

  if (m_routeInstallationStatusReasonHasBeenSet) {
    oStream << location << index << locationValue
            << ".RouteInstallationStatusReason=" << StringUtils::URLEncode(m_routeInstallationStatusReason.c_str()) << "&";
  }
}
...
void RouteServerRouteInstallationDetail::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_routeInstallationStatusHasBeenSet) {
    oStream << location << ".RouteInstallationStatus="
            << StringUtils::URLEncode(
                   RouteServerRouteInstallationStatusMapper::GetNameForRouteServerRouteInstallationStatus(m_routeInstallationStatus))
            << "&";
  }
