...
ElasticInferenceAccelerator::ElasticInferenceAccelerator(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ElasticInferenceAccelerator::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
