...
IpamResourceDiscoveryAssociation::IpamResourceDiscoveryAssociation(const XmlNode& xmlNode) { *this = xmlNode; }
...
IpamResourceDiscoveryAssociation& IpamResourceDiscoveryAssociation::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!resourceDiscoveryStatusNode.IsNull()) {
      m_resourceDiscoveryStatus = IpamAssociatedResourceDiscoveryStatusMapper::GetIpamAssociatedResourceDiscoveryStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(resourceDiscoveryStatusNode.GetText()).c_str()));
      m_resourceDiscoveryStatusHasBeenSet = true;
    }
    XmlNode stateNode = resultNode.FirstChild("state");
    if (!stateNode.IsNull()) {
      m_state = IpamResourceDiscoveryAssociationStateMapper::GetIpamResourceDiscoveryAssociationStateForName(
...
void IpamResourceDiscoveryAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_ipamResourceDiscoveryAssociationIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".IpamResourceDiscoveryAssociationId=" << StringUtils::URLEncode(m_ipamResourceDiscoveryAssociationId.c_str()) << "&";
  }

  if (m_ipamResourceDiscoveryAssociationArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".IpamResourceDiscoveryAssociationArn=" << StringUtils::URLEncode(m_ipamResourceDiscoveryAssociationArn.c_str()) << "&";
  }
  ...
  if (m_resourceDiscoveryStatusHasBeenSet) {
    oStream << location << index << locationValue << ".ResourceDiscoveryStatus="
            << StringUtils::URLEncode(
                   IpamAssociatedResourceDiscoveryStatusMapper::GetNameForIpamAssociatedResourceDiscoveryStatus(m_resourceDiscoveryStatus))
            << "&";
  }

  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue << ".State="
            << StringUtils::URLEncode(IpamResourceDiscoveryAssociationStateMapper::GetNameForIpamResourceDiscoveryAssociationState(m_state))
            << "&";
  }
...
void IpamResourceDiscoveryAssociation::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_resourceDiscoveryStatusHasBeenSet) {
    oStream << location << ".ResourceDiscoveryStatus="
            << StringUtils::URLEncode(
                   IpamAssociatedResourceDiscoveryStatusMapper::GetNameForIpamAssociatedResourceDiscoveryStatus(m_resourceDiscoveryStatus))
            << "&";
  }
