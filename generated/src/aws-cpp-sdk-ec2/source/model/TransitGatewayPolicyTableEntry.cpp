...
TransitGatewayPolicyTableEntry::TransitGatewayPolicyTableEntry(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TransitGatewayPolicyTableEntry::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
