...
EgressOnlyInternetGateway::EgressOnlyInternetGateway(const XmlNode& xmlNode) { *this = xmlNode; }
...
void EgressOnlyInternetGateway::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
