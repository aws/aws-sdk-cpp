...
CapacityReservationCommitmentInfo::CapacityReservationCommitmentInfo(const XmlNode& xmlNode) { *this = xmlNode; }
...
void CapacityReservationCommitmentInfo::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
