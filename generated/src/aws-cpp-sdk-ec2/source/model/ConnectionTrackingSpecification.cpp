...
ConnectionTrackingSpecification::ConnectionTrackingSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ConnectionTrackingSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
