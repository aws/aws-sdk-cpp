...
Ipv6PrefixSpecificationRequest::Ipv6PrefixSpecificationRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void Ipv6PrefixSpecificationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
