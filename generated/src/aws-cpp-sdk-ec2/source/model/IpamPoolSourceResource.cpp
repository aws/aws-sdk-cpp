...
IpamPoolSourceResource::IpamPoolSourceResource(const XmlNode& xmlNode) { *this = xmlNode; }

IpamPoolSourceResource& IpamPoolSourceResource::operator=(const XmlNode& xmlNode) {
...
void IpamPoolSourceResource::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
...
void IpamPoolSourceResource::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_resourceIdHasBeenSet) {
