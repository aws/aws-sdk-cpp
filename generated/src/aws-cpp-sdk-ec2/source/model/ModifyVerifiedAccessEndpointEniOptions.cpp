...
ModifyVerifiedAccessEndpointEniOptions::ModifyVerifiedAccessEndpointEniOptions(const XmlNode& xmlNode) { *this = xmlNode; }

ModifyVerifiedAccessEndpointEniOptions& ModifyVerifiedAccessEndpointEniOptions::operator=(const XmlNode& xmlNode) {
...
void ModifyVerifiedAccessEndpointEniOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
