...
FailedQueuedPurchaseDeletion::FailedQueuedPurchaseDeletion(const XmlNode& xmlNode) { *this = xmlNode; }
...
void FailedQueuedPurchaseDeletion::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
