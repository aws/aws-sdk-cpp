...
Host::Host(const XmlNode& xmlNode) { *this = xmlNode; }
...
Host& Host::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!autoPlacementNode.IsNull()) {
      m_autoPlacement = AutoPlacementMapper::GetAutoPlacementForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(autoPlacementNode.GetText()).c_str()));
    ...
    if (!stateNode.IsNull()) {
      m_state = AllocationStateMapper::GetAllocationStateForName(
    ...
    if (!allocationTimeNode.IsNull()) {
      m_allocationTime = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(allocationTimeNode.GetText()).c_str()).c_str(),
                                  Aws::Utils::DateFormat::ISO_8601);
      m_allocationTimeHasBeenSet = true;
    }
    XmlNode releaseTimeNode = resultNode.FirstChild("releaseTime");
    if (!releaseTimeNode.IsNull()) {
      m_releaseTime = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(releaseTimeNode.GetText()).c_str()).c_str(),
                               Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!hostRecoveryNode.IsNull()) {
      m_hostRecovery = HostRecoveryMapper::GetHostRecoveryForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(hostRecoveryNode.GetText()).c_str()));
    ...
    if (!allowsMultipleInstanceTypesNode.IsNull()) {
      m_allowsMultipleInstanceTypes = AllowsMultipleInstanceTypesMapper::GetAllowsMultipleInstanceTypesForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(allowsMultipleInstanceTypesNode.GetText()).c_str()));
    ...
    if (!memberOfServiceLinkedResourceGroupNode.IsNull()) {
      m_memberOfServiceLinkedResourceGroup = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(memberOfServiceLinkedResourceGroupNode.GetText()).c_str()).c_str());
    ...
    if (!hostMaintenanceNode.IsNull()) {
      m_hostMaintenance = HostMaintenanceMapper::GetHostMaintenanceForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(hostMaintenanceNode.GetText()).c_str()));
...
void Host::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  if (m_autoPlacementHasBeenSet) {
    oStream << location << index << locationValue
            << ".AutoPlacement=" << StringUtils::URLEncode(AutoPlacementMapper::GetNameForAutoPlacement(m_autoPlacement)) << "&";
  }
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(AllocationStateMapper::GetNameForAllocationState(m_state)) << "&";
  }

  if (m_allocationTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".AllocationTime=" << StringUtils::URLEncode(m_allocationTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_releaseTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".ReleaseTime=" << StringUtils::URLEncode(m_releaseTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  ...
  if (m_hostRecoveryHasBeenSet) {
    oStream << location << index << locationValue
            << ".HostRecovery=" << StringUtils::URLEncode(HostRecoveryMapper::GetNameForHostRecovery(m_hostRecovery)) << "&";
  }

  if (m_allowsMultipleInstanceTypesHasBeenSet) {
    oStream << location << index << locationValue << ".AllowsMultipleInstanceTypes="
            << StringUtils::URLEncode(
                   AllowsMultipleInstanceTypesMapper::GetNameForAllowsMultipleInstanceTypes(m_allowsMultipleInstanceTypes))
            << "&";
  }
  ...
  if (m_memberOfServiceLinkedResourceGroupHasBeenSet) {
    oStream << location << index << locationValue << ".MemberOfServiceLinkedResourceGroup=" << std::boolalpha
            << m_memberOfServiceLinkedResourceGroup << "&";
  }
  ...
  if (m_hostMaintenanceHasBeenSet) {
    oStream << location << index << locationValue
            << ".HostMaintenance=" << StringUtils::URLEncode(HostMaintenanceMapper::GetNameForHostMaintenance(m_hostMaintenance)) << "&";
  }
...
void Host::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_allowsMultipleInstanceTypesHasBeenSet) {
    oStream << location << ".AllowsMultipleInstanceTypes="
            << StringUtils::URLEncode(
                   AllowsMultipleInstanceTypesMapper::GetNameForAllowsMultipleInstanceTypes(m_allowsMultipleInstanceTypes))
            << "&";
  }
