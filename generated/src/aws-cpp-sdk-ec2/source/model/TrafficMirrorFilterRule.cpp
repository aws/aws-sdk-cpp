...
TrafficMirrorFilterRule::TrafficMirrorFilterRule(const XmlNode& xmlNode) { *this = xmlNode; }
...
TrafficMirrorFilterRule& TrafficMirrorFilterRule::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!trafficDirectionNode.IsNull()) {
      m_trafficDirection = TrafficDirectionMapper::GetTrafficDirectionForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(trafficDirectionNode.GetText()).c_str()));
    ...
    if (!ruleActionNode.IsNull()) {
      m_ruleAction = TrafficMirrorRuleActionMapper::GetTrafficMirrorRuleActionForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(ruleActionNode.GetText()).c_str()));
      m_ruleActionHasBeenSet = true;
    }
    XmlNode protocolNode = resultNode.FirstChild("protocol");
    if (!protocolNode.IsNull()) {
      m_protocol =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(protocolNode.GetText()).c_str()).c_str());
...
void TrafficMirrorFilterRule::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  if (m_trafficMirrorFilterRuleIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".TrafficMirrorFilterRuleId=" << StringUtils::URLEncode(m_trafficMirrorFilterRuleId.c_str()) << "&";
  }
  ...
  if (m_trafficDirectionHasBeenSet) {
    oStream << location << index << locationValue
            << ".TrafficDirection=" << StringUtils::URLEncode(TrafficDirectionMapper::GetNameForTrafficDirection(m_trafficDirection))
            << "&";
  }
  ...
  if (m_ruleActionHasBeenSet) {
    oStream << location << index << locationValue
            << ".RuleAction=" << StringUtils::URLEncode(TrafficMirrorRuleActionMapper::GetNameForTrafficMirrorRuleAction(m_ruleAction))
            << "&";
  }
