...
Ipv6PrefixSpecificationResponse::Ipv6PrefixSpecificationResponse(const XmlNode& xmlNode) { *this = xmlNode; }

Ipv6PrefixSpecificationResponse& Ipv6PrefixSpecificationResponse::operator=(const XmlNode& xmlNode) {
...
void Ipv6PrefixSpecificationResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void Ipv6PrefixSpecificationResponse::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_ipv6PrefixHasBeenSet) {
