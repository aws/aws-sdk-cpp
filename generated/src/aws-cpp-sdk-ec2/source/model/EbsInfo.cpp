...
EbsInfo::EbsInfo(const XmlNode& xmlNode) { *this = xmlNode; }
...
EbsInfo& EbsInfo::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!ebsOptimizedSupportNode.IsNull()) {
      m_ebsOptimizedSupport = EbsOptimizedSupportMapper::GetEbsOptimizedSupportForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(ebsOptimizedSupportNode.GetText()).c_str()));
    ...
    if (!encryptionSupportNode.IsNull()) {
      m_encryptionSupport = EbsEncryptionSupportMapper::GetEbsEncryptionSupportForName(
    ...
    if (!nvmeSupportNode.IsNull()) {
      m_nvmeSupport = EbsNvmeSupportMapper::GetEbsNvmeSupportForName(
    ...
    if (!maximumEbsAttachmentsNode.IsNull()) {
      m_maximumEbsAttachments = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maximumEbsAttachmentsNode.GetText()).c_str()).c_str());
    ...
    if (!attachmentLimitTypeNode.IsNull()) {
      m_attachmentLimitType = AttachmentLimitTypeMapper::GetAttachmentLimitTypeForName(
...
void EbsInfo::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  if (m_ebsOptimizedSupportHasBeenSet) {
    oStream << location << index << locationValue << ".EbsOptimizedSupport="
            << StringUtils::URLEncode(EbsOptimizedSupportMapper::GetNameForEbsOptimizedSupport(m_ebsOptimizedSupport)) << "&";
  }

  if (m_encryptionSupportHasBeenSet) {
    oStream << location << index << locationValue << ".EncryptionSupport="
            << StringUtils::URLEncode(EbsEncryptionSupportMapper::GetNameForEbsEncryptionSupport(m_encryptionSupport)) << "&";
  }
  ...
  if (m_nvmeSupportHasBeenSet) {
    oStream << location << index << locationValue
            << ".NvmeSupport=" << StringUtils::URLEncode(EbsNvmeSupportMapper::GetNameForEbsNvmeSupport(m_nvmeSupport)) << "&";
  }
...
void EbsInfo::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_ebsOptimizedSupportHasBeenSet) {
    oStream << location << ".EbsOptimizedSupport="
            << StringUtils::URLEncode(EbsOptimizedSupportMapper::GetNameForEbsOptimizedSupport(m_ebsOptimizedSupport)) << "&";
  }
  if (m_encryptionSupportHasBeenSet) {
