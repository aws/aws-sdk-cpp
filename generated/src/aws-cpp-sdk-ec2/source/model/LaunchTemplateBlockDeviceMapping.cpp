...
LaunchTemplateBlockDeviceMapping::LaunchTemplateBlockDeviceMapping(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LaunchTemplateBlockDeviceMapping::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
