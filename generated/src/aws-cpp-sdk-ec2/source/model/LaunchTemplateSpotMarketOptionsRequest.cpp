...
LaunchTemplateSpotMarketOptionsRequest::LaunchTemplateSpotMarketOptionsRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LaunchTemplateSpotMarketOptionsRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
