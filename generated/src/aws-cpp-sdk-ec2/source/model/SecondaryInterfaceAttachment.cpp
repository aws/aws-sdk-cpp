...
SecondaryInterfaceAttachment::SecondaryInterfaceAttachment(const XmlNode& xmlNode) { *this = xmlNode; }

SecondaryInterfaceAttachment& SecondaryInterfaceAttachment::operator=(const XmlNode& xmlNode) {
...
void SecondaryInterfaceAttachment::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void SecondaryInterfaceAttachment::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_attachmentIdHasBeenSet) {
