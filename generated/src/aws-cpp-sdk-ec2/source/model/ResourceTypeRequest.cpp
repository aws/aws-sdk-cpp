...
ResourceTypeRequest::ResourceTypeRequest(const XmlNode& xmlNode) { *this = xmlNode; }

ResourceTypeRequest& ResourceTypeRequest::operator=(const XmlNode& xmlNode) {
...
void ResourceTypeRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
...
void ResourceTypeRequest::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_resourceTypeHasBeenSet) {
