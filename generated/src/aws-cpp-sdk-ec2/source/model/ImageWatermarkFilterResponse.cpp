...
ImageWatermarkFilterResponse::ImageWatermarkFilterResponse(const XmlNode& xmlNode) { *this = xmlNode; }

ImageWatermarkFilterResponse& ImageWatermarkFilterResponse::operator=(const XmlNode& xmlNode) {
...
void ImageWatermarkFilterResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void ImageWatermarkFilterResponse::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_watermarkKeyHasBeenSet) {
