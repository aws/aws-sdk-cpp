...
ConnectionLogOptions::ConnectionLogOptions(const XmlNode& xmlNode) { *this = xmlNode; }

ConnectionLogOptions& ConnectionLogOptions::operator=(const XmlNode& xmlNode) {
...
void ConnectionLogOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
