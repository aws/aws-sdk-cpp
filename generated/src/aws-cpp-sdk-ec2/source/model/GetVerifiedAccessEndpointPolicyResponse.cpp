...
GetVerifiedAccessEndpointPolicyResponse& GetVerifiedAccessEndpointPolicyResponse::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::GetVerifiedAccessEndpointPolicyResponse",
