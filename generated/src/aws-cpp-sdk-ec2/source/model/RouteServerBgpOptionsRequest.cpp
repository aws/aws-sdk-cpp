...
RouteServerBgpOptionsRequest::RouteServerBgpOptionsRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void RouteServerBgpOptionsRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
