...
VpcEncryptionControlExclusions::VpcEncryptionControlExclusions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VpcEncryptionControlExclusions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
