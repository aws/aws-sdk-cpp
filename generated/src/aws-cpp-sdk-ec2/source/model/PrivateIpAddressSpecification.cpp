...
PrivateIpAddressSpecification::PrivateIpAddressSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
void PrivateIpAddressSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
