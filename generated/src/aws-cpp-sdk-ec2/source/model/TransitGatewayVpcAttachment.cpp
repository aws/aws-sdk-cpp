...
TransitGatewayVpcAttachment::TransitGatewayVpcAttachment(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TransitGatewayVpcAttachment::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
