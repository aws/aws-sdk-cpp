...
ModifyVpnTunnelOptionsSpecification::ModifyVpnTunnelOptionsSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ModifyVpnTunnelOptionsSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
