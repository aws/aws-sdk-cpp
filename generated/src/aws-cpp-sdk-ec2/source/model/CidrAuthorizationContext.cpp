...
CidrAuthorizationContext::CidrAuthorizationContext(const XmlNode& xmlNode) { *this = xmlNode; }
...
void CidrAuthorizationContext::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
