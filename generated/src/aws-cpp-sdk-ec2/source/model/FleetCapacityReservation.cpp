...
FleetCapacityReservation::FleetCapacityReservation(const XmlNode& xmlNode) { *this = xmlNode; }
...
void FleetCapacityReservation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
