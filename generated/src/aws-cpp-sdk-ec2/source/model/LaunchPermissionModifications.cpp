...
LaunchPermissionModifications::LaunchPermissionModifications(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LaunchPermissionModifications::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
