...
Aws::String GetIpamDiscoveredRoutesRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=GetIpamDiscoveredRoutes&";
...
void GetIpamDiscoveredRoutesRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
