...
LaunchTemplateLicenseConfiguration::LaunchTemplateLicenseConfiguration(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LaunchTemplateLicenseConfiguration::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
