...
Aws::String GetIpamPolicyAllocationRulesRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=GetIpamPolicyAllocationRules&";
...
void GetIpamPolicyAllocationRulesRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
