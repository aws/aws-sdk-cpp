...
Instance& Instance::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!instanceLifecycleNode.IsNull()) {
      m_instanceLifecycle = InstanceLifecycleTypeMapper::GetInstanceLifecycleTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(instanceLifecycleNode.GetText()).c_str()));
    ...
    if (!usageOperationUpdateTimeNode.IsNull()) {
      m_usageOperationUpdateTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(usageOperationUpdateTimeNode.GetText()).c_str()).c_str(),
    ...
    if (!currentInstanceBootModeNode.IsNull()) {
      m_currentInstanceBootMode = InstanceBootModeValuesMapper::GetInstanceBootModeValuesForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(currentInstanceBootModeNode.GetText()).c_str()));
    ...
    if (!amiLaunchIndexNode.IsNull()) {
      m_amiLaunchIndex = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(amiLaunchIndexNode.GetText()).c_str()).c_str());
...
void Instance::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_instanceLifecycleHasBeenSet) {
    oStream << location << index << locationValue << ".InstanceLifecycle="
            << StringUtils::URLEncode(InstanceLifecycleTypeMapper::GetNameForInstanceLifecycleType(m_instanceLifecycle)) << "&";
  }
  ...
  if (m_elasticInferenceAcceleratorAssociationsHasBeenSet) {
    ...
    for (auto& item : m_elasticInferenceAcceleratorAssociations) {
      ...
      elasticInferenceAcceleratorAssociationsSs << location << index << locationValue << ".ElasticInferenceAcceleratorAssociationSet."
                                                << elasticInferenceAcceleratorAssociationsIdx++;
  ...
  if (m_usageOperationUpdateTimeHasBeenSet) {
    oStream << location << index << locationValue << ".UsageOperationUpdateTime="
            << StringUtils::URLEncode(m_usageOperationUpdateTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  ...
  if (m_currentInstanceBootModeHasBeenSet) {
    oStream << location << index << locationValue << ".CurrentInstanceBootMode="
            << StringUtils::URLEncode(InstanceBootModeValuesMapper::GetNameForInstanceBootModeValues(m_currentInstanceBootMode)) << "&";
  }
...
void Instance::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_instanceLifecycleHasBeenSet) {
    oStream << location << ".InstanceLifecycle="
            << StringUtils::URLEncode(InstanceLifecycleTypeMapper::GetNameForInstanceLifecycleType(m_instanceLifecycle)) << "&";
  }
  if (m_elasticGpuAssociationsHasBeenSet) {
    unsigned elasticGpuAssociationsIdx = 1;
  ...
  if (m_elasticInferenceAcceleratorAssociationsHasBeenSet) {
    ...
    for (auto& item : m_elasticInferenceAcceleratorAssociations) {
      Aws::StringStream elasticInferenceAcceleratorAssociationsSs;
      elasticInferenceAcceleratorAssociationsSs << location << ".ElasticInferenceAcceleratorAssociationSet."
                                                << elasticInferenceAcceleratorAssociationsIdx++;
      item.OutputToStream(oStream, elasticInferenceAcceleratorAssociationsSs.str().c_str());
    }
  }
  ...
  if (m_usageOperationUpdateTimeHasBeenSet) {
    oStream << location << ".UsageOperationUpdateTime="
            << StringUtils::URLEncode(m_usageOperationUpdateTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_privateDnsNameOptionsHasBeenSet) {
  ...
  if (m_currentInstanceBootModeHasBeenSet) {
    oStream << location << ".CurrentInstanceBootMode="
            << StringUtils::URLEncode(InstanceBootModeValuesMapper::GetNameForInstanceBootModeValues(m_currentInstanceBootMode)) << "&";
  }
  if (m_networkPerformanceOptionsHasBeenSet) {
