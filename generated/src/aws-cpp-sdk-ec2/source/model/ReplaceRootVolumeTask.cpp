...
ReplaceRootVolumeTask::ReplaceRootVolumeTask(const XmlNode& xmlNode) { *this = xmlNode; }
...
ReplaceRootVolumeTask& ReplaceRootVolumeTask::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!taskStateNode.IsNull()) {
      m_taskState = ReplaceRootVolumeTaskStateMapper::GetReplaceRootVolumeTaskStateForName(
    ...
    if (!deleteReplacedRootVolumeNode.IsNull()) {
      m_deleteReplacedRootVolume = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(deleteReplacedRootVolumeNode.GetText()).c_str()).c_str());
...
void ReplaceRootVolumeTask::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  if (m_replaceRootVolumeTaskIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".ReplaceRootVolumeTaskId=" << StringUtils::URLEncode(m_replaceRootVolumeTaskId.c_str()) << "&";
  }
  ...
  if (m_taskStateHasBeenSet) {
    oStream << location << index << locationValue
            << ".TaskState=" << StringUtils::URLEncode(ReplaceRootVolumeTaskStateMapper::GetNameForReplaceRootVolumeTaskState(m_taskState))
            << "&";
  }
