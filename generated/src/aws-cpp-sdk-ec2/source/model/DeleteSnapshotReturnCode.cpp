...
DeleteSnapshotReturnCode::DeleteSnapshotReturnCode(const XmlNode& xmlNode) { *this = xmlNode; }
...
DeleteSnapshotReturnCode& DeleteSnapshotReturnCode::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!returnCodeNode.IsNull()) {
      m_returnCode = SnapshotReturnCodesMapper::GetSnapshotReturnCodesForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(returnCodeNode.GetText()).c_str()));
...
void DeleteSnapshotReturnCode::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_returnCodeHasBeenSet) {
    oStream << location << index << locationValue
            << ".ReturnCode=" << StringUtils::URLEncode(SnapshotReturnCodesMapper::GetNameForSnapshotReturnCodes(m_returnCode)) << "&";
  }
}
