...
DescribeTrunkInterfaceAssociationsResponse& DescribeTrunkInterfaceAssociationsResponse::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!interfaceAssociationsNode.IsNull()) {
      ...
      m_interfaceAssociationsHasBeenSet = !interfaceAssociationsMember.IsNull();
      ...
      m_interfaceAssociationsHasBeenSet = true;
    }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DescribeTrunkInterfaceAssociationsResponse",
