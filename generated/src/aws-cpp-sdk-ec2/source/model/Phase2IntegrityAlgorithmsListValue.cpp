...
Phase2IntegrityAlgorithmsListValue::Phase2IntegrityAlgorithmsListValue(const XmlNode& xmlNode) { *this = xmlNode; }
...
void Phase2IntegrityAlgorithmsListValue::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
