...
FleetLaunchTemplateOverridesRequest::FleetLaunchTemplateOverridesRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void FleetLaunchTemplateOverridesRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
