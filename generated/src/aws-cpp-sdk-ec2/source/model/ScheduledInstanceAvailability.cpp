...
ScheduledInstanceAvailability::ScheduledInstanceAvailability(const XmlNode& xmlNode) { *this = xmlNode; }
...
ScheduledInstanceAvailability& ScheduledInstanceAvailability::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!availableInstanceCountNode.IsNull()) {
      m_availableInstanceCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(availableInstanceCountNode.GetText()).c_str()).c_str());
    ...
    if (!firstSlotStartTimeNode.IsNull()) {
      m_firstSlotStartTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(firstSlotStartTimeNode.GetText()).c_str()).c_str(),
    ...
    if (!maxTermDurationInDaysNode.IsNull()) {
      m_maxTermDurationInDays = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maxTermDurationInDaysNode.GetText()).c_str()).c_str());
    ...
    if (!minTermDurationInDaysNode.IsNull()) {
      m_minTermDurationInDays = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(minTermDurationInDaysNode.GetText()).c_str()).c_str());
...
void ScheduledInstanceAvailability::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_firstSlotStartTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".FirstSlotStartTime=" << StringUtils::URLEncode(m_firstSlotStartTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }
