...
PrivateDnsNameOptionsResponse::PrivateDnsNameOptionsResponse(const XmlNode& xmlNode) { *this = xmlNode; }
...
void PrivateDnsNameOptionsResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
