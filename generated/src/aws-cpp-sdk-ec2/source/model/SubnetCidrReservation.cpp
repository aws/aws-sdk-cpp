...
SubnetCidrReservation::SubnetCidrReservation(const XmlNode& xmlNode) { *this = xmlNode; }
...
SubnetCidrReservation& SubnetCidrReservation::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!reservationTypeNode.IsNull()) {
      m_reservationType = SubnetCidrReservationTypeMapper::GetSubnetCidrReservationTypeForName(
...
void SubnetCidrReservation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  if (m_subnetCidrReservationIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".SubnetCidrReservationId=" << StringUtils::URLEncode(m_subnetCidrReservationId.c_str()) << "&";
  }
  ...
  if (m_reservationTypeHasBeenSet) {
    oStream << location << index << locationValue << ".ReservationType="
            << StringUtils::URLEncode(SubnetCidrReservationTypeMapper::GetNameForSubnetCidrReservationType(m_reservationType)) << "&";
  }
