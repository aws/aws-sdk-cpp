...
CapacityReservationTargetResponse::CapacityReservationTargetResponse(const XmlNode& xmlNode) { *this = xmlNode; }
...
void CapacityReservationTargetResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_capacityReservationResourceGroupArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".CapacityReservationResourceGroupArn=" << StringUtils::URLEncode(m_capacityReservationResourceGroupArn.c_str()) << "&";
  }
}
