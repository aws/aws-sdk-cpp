...
PrivateDnsNameOptionsOnLaunch::PrivateDnsNameOptionsOnLaunch(const XmlNode& xmlNode) { *this = xmlNode; }
...
void PrivateDnsNameOptionsOnLaunch::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
