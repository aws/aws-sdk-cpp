...
ReservedInstancesConfiguration::ReservedInstancesConfiguration(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ReservedInstancesConfiguration::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
