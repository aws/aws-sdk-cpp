...
RouteServerEndpoint::RouteServerEndpoint(const XmlNode& xmlNode) { *this = xmlNode; }
...
RouteServerEndpoint& RouteServerEndpoint::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = RouteServerEndpointStateMapper::GetRouteServerEndpointStateForName(
...
void RouteServerEndpoint::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(RouteServerEndpointStateMapper::GetNameForRouteServerEndpointState(m_state)) << "&";
  }
