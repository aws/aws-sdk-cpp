...
LaunchTemplateTagSpecification::LaunchTemplateTagSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LaunchTemplateTagSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
