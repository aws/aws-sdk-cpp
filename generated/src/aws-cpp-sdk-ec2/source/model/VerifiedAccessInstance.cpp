...
VerifiedAccessInstance::VerifiedAccessInstance(const XmlNode& xmlNode) { *this = xmlNode; }
...
VerifiedAccessInstance& VerifiedAccessInstance::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!fipsEnabledNode.IsNull()) {
      m_fipsEnabled =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(fipsEnabledNode.GetText()).c_str()).c_str());
...
void VerifiedAccessInstance::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_verifiedAccessTrustProvidersHasBeenSet) {
    ...
    for (auto& item : m_verifiedAccessTrustProviders) {
      ...
      verifiedAccessTrustProvidersSs << location << index << locationValue << ".VerifiedAccessTrustProviderSet."
                                     << verifiedAccessTrustProvidersIdx++;
