...
CapacityManagerCondition::CapacityManagerCondition(const XmlNode& xmlNode)
{
  *this = xmlNode;
}
...
void CapacityManagerCondition::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
