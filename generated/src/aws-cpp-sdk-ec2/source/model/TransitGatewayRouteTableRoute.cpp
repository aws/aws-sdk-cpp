...
TransitGatewayRouteTableRoute::TransitGatewayRouteTableRoute(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TransitGatewayRouteTableRoute::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
