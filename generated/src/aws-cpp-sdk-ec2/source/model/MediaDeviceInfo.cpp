...
MediaDeviceInfo::MediaDeviceInfo(const XmlNode& xmlNode) { *this = xmlNode; }

MediaDeviceInfo& MediaDeviceInfo::operator=(const XmlNode& xmlNode) {
...
void MediaDeviceInfo::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
...
void MediaDeviceInfo::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_countHasBeenSet) {
