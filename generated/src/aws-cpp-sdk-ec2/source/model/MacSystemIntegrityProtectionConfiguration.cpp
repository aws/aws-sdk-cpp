...
MacSystemIntegrityProtectionConfiguration::MacSystemIntegrityProtectionConfiguration(const XmlNode& xmlNode)
{
  *this = xmlNode;
}
...
MacSystemIntegrityProtectionConfiguration& MacSystemIntegrityProtectionConfiguration::operator =(const XmlNode& xmlNode)
{
  ...
  if(!resultNode.IsNull())
  {
    ...
    {
      m_status = MacSystemIntegrityProtectionSettingStatusMapper::GetMacSystemIntegrityProtectionSettingStatusForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(statusNode.GetText()).c_str()));
...
void MacSystemIntegrityProtectionConfiguration::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
  ...
  {
      oStream << location << index << locationValue << ".Status=" << StringUtils::URLEncode(MacSystemIntegrityProtectionSettingStatusMapper::GetNameForMacSystemIntegrityProtectionSettingStatus(m_status)) << "&";
  }
...
void MacSystemIntegrityProtectionConfiguration::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  ...
  if(m_statusHasBeenSet)
  {
      oStream << location << ".Status=" << StringUtils::URLEncode(MacSystemIntegrityProtectionSettingStatusMapper::GetNameForMacSystemIntegrityProtectionSettingStatus(m_status)) << "&";
  }
}
