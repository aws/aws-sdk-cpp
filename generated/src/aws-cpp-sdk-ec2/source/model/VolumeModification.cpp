...
VolumeModification::VolumeModification(const XmlNode& xmlNode) { *this = xmlNode; }
...
VolumeModification& VolumeModification::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!modificationStateNode.IsNull()) {
      m_modificationState = VolumeModificationStateMapper::GetVolumeModificationStateForName(
    ...
    if (!targetSizeNode.IsNull()) {
      m_targetSize =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(targetSizeNode.GetText()).c_str()).c_str());
      m_targetSizeHasBeenSet = true;
    }
    XmlNode targetIopsNode = resultNode.FirstChild("targetIops");
    if (!targetIopsNode.IsNull()) {
      m_targetIops =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(targetIopsNode.GetText()).c_str()).c_str());
    ...
    if (!targetVolumeTypeNode.IsNull()) {
      m_targetVolumeType = VolumeTypeMapper::GetVolumeTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(targetVolumeTypeNode.GetText()).c_str()));
    ...
    if (!targetThroughputNode.IsNull()) {
      m_targetThroughput = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(targetThroughputNode.GetText()).c_str()).c_str());
    ...
    if (!targetMultiAttachEnabledNode.IsNull()) {
      m_targetMultiAttachEnabled = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(targetMultiAttachEnabledNode.GetText()).c_str()).c_str());
    ...
    if (!originalSizeNode.IsNull()) {
      m_originalSize =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(originalSizeNode.GetText()).c_str()).c_str());
      m_originalSizeHasBeenSet = true;
    }
    XmlNode originalIopsNode = resultNode.FirstChild("originalIops");
    if (!originalIopsNode.IsNull()) {
      m_originalIops =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(originalIopsNode.GetText()).c_str()).c_str());
    ...
    if (!originalVolumeTypeNode.IsNull()) {
      m_originalVolumeType = VolumeTypeMapper::GetVolumeTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(originalVolumeTypeNode.GetText()).c_str()));
    ...
    if (!originalThroughputNode.IsNull()) {
      m_originalThroughput = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(originalThroughputNode.GetText()).c_str()).c_str());
    ...
    if (!originalMultiAttachEnabledNode.IsNull()) {
      m_originalMultiAttachEnabled = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(originalMultiAttachEnabledNode.GetText()).c_str()).c_str());
      m_originalMultiAttachEnabledHasBeenSet = true;
    }
    XmlNode progressNode = resultNode.FirstChild("progress");
    if (!progressNode.IsNull()) {
      m_progress =
          StringUtils::ConvertToInt64(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(progressNode.GetText()).c_str()).c_str());
...
void VolumeModification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_modificationStateHasBeenSet) {
    oStream << location << index << locationValue << ".ModificationState="
            << StringUtils::URLEncode(VolumeModificationStateMapper::GetNameForVolumeModificationState(m_modificationState)) << "&";
  }
  ...
  if (m_targetVolumeTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".TargetVolumeType=" << StringUtils::URLEncode(VolumeTypeMapper::GetNameForVolumeType(m_targetVolumeType)) << "&";
  }
  ...
  if (m_originalVolumeTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".OriginalVolumeType=" << StringUtils::URLEncode(VolumeTypeMapper::GetNameForVolumeType(m_originalVolumeType)) << "&";
  }
