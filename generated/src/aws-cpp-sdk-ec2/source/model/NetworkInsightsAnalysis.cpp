...
NetworkInsightsAnalysis::NetworkInsightsAnalysis(const XmlNode& xmlNode) { *this = xmlNode; }
...
NetworkInsightsAnalysis& NetworkInsightsAnalysis::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!networkPathFoundNode.IsNull()) {
      m_networkPathFound = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(networkPathFoundNode.GetText()).c_str()).c_str());
...
void NetworkInsightsAnalysis::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  if (m_networkInsightsAnalysisIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".NetworkInsightsAnalysisId=" << StringUtils::URLEncode(m_networkInsightsAnalysisId.c_str()) << "&";
  }

  if (m_networkInsightsAnalysisArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".NetworkInsightsAnalysisArn=" << StringUtils::URLEncode(m_networkInsightsAnalysisArn.c_str()) << "&";
  }
  ...
  if (m_additionalAccountsHasBeenSet) {
    ...
    for (auto& item : m_additionalAccounts) {
      oStream << location << index << locationValue << ".AdditionalAccountSet." << additionalAccountsIdx++ << "="
  ...
  if (m_filterInArnsHasBeenSet) {
    ...
    for (auto& item : m_filterInArns) {
      oStream << location << index << locationValue << ".FilterInArnSet." << filterInArnsIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
  ...
  if (m_filterOutArnsHasBeenSet) {
    ...
    for (auto& item : m_filterOutArns) {
      oStream << location << index << locationValue << ".FilterOutArnSet." << filterOutArnsIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
  ...
  if (m_suggestedAccountsHasBeenSet) {
    ...
    for (auto& item : m_suggestedAccounts) {
      oStream << location << index << locationValue << ".SuggestedAccountSet." << suggestedAccountsIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
