...
PerformanceFactorReference::PerformanceFactorReference(const XmlNode& xmlNode) { *this = xmlNode; }
...
void PerformanceFactorReference::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
