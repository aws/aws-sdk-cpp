...
TrafficMirrorTarget::TrafficMirrorTarget(const XmlNode& xmlNode) { *this = xmlNode; }
...
TrafficMirrorTarget& TrafficMirrorTarget::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!typeNode.IsNull()) {
      m_type = TrafficMirrorTargetTypeMapper::GetTrafficMirrorTargetTypeForName(
...
void TrafficMirrorTarget::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_typeHasBeenSet) {
    oStream << location << index << locationValue
            << ".Type=" << StringUtils::URLEncode(TrafficMirrorTargetTypeMapper::GetNameForTrafficMirrorTargetType(m_type)) << "&";
  }
  ...
  if (m_gatewayLoadBalancerEndpointIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".GatewayLoadBalancerEndpointId=" << StringUtils::URLEncode(m_gatewayLoadBalancerEndpointId.c_str()) << "&";
  }
}
