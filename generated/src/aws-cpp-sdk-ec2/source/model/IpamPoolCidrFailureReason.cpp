...
IpamPoolCidrFailureReason::IpamPoolCidrFailureReason(const XmlNode& xmlNode) { *this = xmlNode; }
...
IpamPoolCidrFailureReason& IpamPoolCidrFailureReason::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!codeNode.IsNull()) {
      m_code = IpamPoolCidrFailureCodeMapper::GetIpamPoolCidrFailureCodeForName(
...
void IpamPoolCidrFailureReason::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                               const char* locationValue) const {
  if (m_codeHasBeenSet) {
    oStream << location << index << locationValue
            << ".Code=" << StringUtils::URLEncode(IpamPoolCidrFailureCodeMapper::GetNameForIpamPoolCidrFailureCode(m_code)) << "&";
  }
