...
VerifiedAccessEndpointTarget::VerifiedAccessEndpointTarget(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VerifiedAccessEndpointTarget::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_verifiedAccessEndpointTargetIpAddressHasBeenSet) {
    oStream << location << index << locationValue
            << ".VerifiedAccessEndpointTargetIpAddress=" << StringUtils::URLEncode(m_verifiedAccessEndpointTargetIpAddress.c_str()) << "&";
  }

  if (m_verifiedAccessEndpointTargetDnsHasBeenSet) {
    oStream << location << index << locationValue
            << ".VerifiedAccessEndpointTargetDns=" << StringUtils::URLEncode(m_verifiedAccessEndpointTargetDns.c_str()) << "&";
  }
}
