...
InstanceNetworkPerformanceOptions::InstanceNetworkPerformanceOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InstanceNetworkPerformanceOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
