...
TransitGatewayRouteTableAssociation::TransitGatewayRouteTableAssociation(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TransitGatewayRouteTableAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
