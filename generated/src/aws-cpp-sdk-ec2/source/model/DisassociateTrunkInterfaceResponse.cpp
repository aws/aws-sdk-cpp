...
DisassociateTrunkInterfaceResponse& DisassociateTrunkInterfaceResponse::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  const XmlDocument& xmlDocument = result.GetPayload();
  XmlNode rootNode = xmlDocument.GetRootElement();
  XmlNode resultNode = rootNode;
  if (!rootNode.IsNull() && (rootNode.GetName() != "DisassociateTrunkInterfaceResponse"))
  {
    resultNode = rootNode.FirstChild("DisassociateTrunkInterfaceResponse");
  }
