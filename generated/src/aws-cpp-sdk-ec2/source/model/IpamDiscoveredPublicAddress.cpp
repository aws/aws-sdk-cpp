...
IpamDiscoveredPublicAddress::IpamDiscoveredPublicAddress(const XmlNode& xmlNode) { *this = xmlNode; }
...
IpamDiscoveredPublicAddress& IpamDiscoveredPublicAddress::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!associationStatusNode.IsNull()) {
      m_associationStatus = IpamPublicAddressAssociationStatusMapper::GetIpamPublicAddressAssociationStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(associationStatusNode.GetText()).c_str()));
      m_associationStatusHasBeenSet = true;
    }
    XmlNode addressTypeNode = resultNode.FirstChild("addressType");
    if (!addressTypeNode.IsNull()) {
      m_addressType = IpamPublicAddressTypeMapper::GetIpamPublicAddressTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(addressTypeNode.GetText()).c_str()));
      m_addressTypeHasBeenSet = true;
    }
    XmlNode serviceNode = resultNode.FirstChild("service");
    if (!serviceNode.IsNull()) {
      m_service = IpamPublicAddressAwsServiceMapper::GetIpamPublicAddressAwsServiceForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(serviceNode.GetText()).c_str()));
...
void IpamDiscoveredPublicAddress::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_associationStatusHasBeenSet) {
    oStream << location << index << locationValue << ".AssociationStatus="
            << StringUtils::URLEncode(
                   IpamPublicAddressAssociationStatusMapper::GetNameForIpamPublicAddressAssociationStatus(m_associationStatus))
            << "&";
  }

  if (m_addressTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".AddressType=" << StringUtils::URLEncode(IpamPublicAddressTypeMapper::GetNameForIpamPublicAddressType(m_addressType))
            << "&";
  }

  if (m_serviceHasBeenSet) {
    oStream << location << index << locationValue
            << ".Service=" << StringUtils::URLEncode(IpamPublicAddressAwsServiceMapper::GetNameForIpamPublicAddressAwsService(m_service))
            << "&";
  }
  ...
  if (m_networkInterfaceDescriptionHasBeenSet) {
    oStream << location << index << locationValue
            << ".NetworkInterfaceDescription=" << StringUtils::URLEncode(m_networkInterfaceDescription.c_str()) << "&";
  }
...
void IpamDiscoveredPublicAddress::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_associationStatusHasBeenSet) {
    oStream << location << ".AssociationStatus="
            << StringUtils::URLEncode(
                   IpamPublicAddressAssociationStatusMapper::GetNameForIpamPublicAddressAssociationStatus(m_associationStatus))
            << "&";
  }
