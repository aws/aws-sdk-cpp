...
SnapshotTierStatus::SnapshotTierStatus(const XmlNode& xmlNode) { *this = xmlNode; }
...
SnapshotTierStatus& SnapshotTierStatus::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!statusNode.IsNull()) {
      m_status = SnapshotStateMapper::GetSnapshotStateForName(
    ...
    if (!lastTieringStartTimeNode.IsNull()) {
      m_lastTieringStartTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(lastTieringStartTimeNode.GetText()).c_str()).c_str(),
    ...
    if (!lastTieringProgressNode.IsNull()) {
      m_lastTieringProgress = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(lastTieringProgressNode.GetText()).c_str()).c_str());
    ...
    if (!lastTieringOperationStatusNode.IsNull()) {
      m_lastTieringOperationStatus = TieringOperationStatusMapper::GetTieringOperationStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(lastTieringOperationStatusNode.GetText()).c_str()));
    ...
    if (!archivalCompleteTimeNode.IsNull()) {
      m_archivalCompleteTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(archivalCompleteTimeNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
...
void SnapshotTierStatus::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_statusHasBeenSet) {
    oStream << location << index << locationValue
            << ".Status=" << StringUtils::URLEncode(SnapshotStateMapper::GetNameForSnapshotState(m_status)) << "&";
  }
  ...
  if (m_lastTieringStartTimeHasBeenSet) {
    oStream << location << index << locationValue << ".LastTieringStartTime="
            << StringUtils::URLEncode(m_lastTieringStartTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  ...
  if (m_lastTieringOperationStatusHasBeenSet) {
    oStream << location << index << locationValue << ".LastTieringOperationStatus="
            << StringUtils::URLEncode(TieringOperationStatusMapper::GetNameForTieringOperationStatus(m_lastTieringOperationStatus)) << "&";
  }

  if (m_lastTieringOperationStatusDetailHasBeenSet) {
    oStream << location << index << locationValue
            << ".LastTieringOperationStatusDetail=" << StringUtils::URLEncode(m_lastTieringOperationStatusDetail.c_str()) << "&";
  }

  if (m_archivalCompleteTimeHasBeenSet) {
    oStream << location << index << locationValue << ".ArchivalCompleteTime="
            << StringUtils::URLEncode(m_archivalCompleteTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
...
void SnapshotTierStatus::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_lastTieringStartTimeHasBeenSet) {
    oStream << location << ".LastTieringStartTime="
            << StringUtils::URLEncode(m_lastTieringStartTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_lastTieringProgressHasBeenSet) {
  ...
  if (m_lastTieringOperationStatusHasBeenSet) {
    oStream << location << ".LastTieringOperationStatus="
            << StringUtils::URLEncode(TieringOperationStatusMapper::GetNameForTieringOperationStatus(m_lastTieringOperationStatus)) << "&";
  }
  if (m_lastTieringOperationStatusDetailHasBeenSet) {
  ...
  if (m_archivalCompleteTimeHasBeenSet) {
    oStream << location << ".ArchivalCompleteTime="
            << StringUtils::URLEncode(m_archivalCompleteTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_restoreExpiryTimeHasBeenSet) {
    oStream << location
