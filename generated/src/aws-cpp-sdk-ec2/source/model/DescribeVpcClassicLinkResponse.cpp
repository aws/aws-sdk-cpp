...
DescribeVpcClassicLinkResponse::DescribeVpcClassicLinkResponse(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeVpcClassicLinkResponse& DescribeVpcClassicLinkResponse::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull() && (rootNode.GetName() != "DescribeVpcClassicLinkResponse")) {
