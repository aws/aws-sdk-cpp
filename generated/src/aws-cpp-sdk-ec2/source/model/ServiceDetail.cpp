...
ServiceDetail::ServiceDetail(const XmlNode& xmlNode) { *this = xmlNode; }
...
ServiceDetail& ServiceDetail::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!vpcEndpointPolicySupportedNode.IsNull()) {
      m_vpcEndpointPolicySupported = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(vpcEndpointPolicySupportedNode.GetText()).c_str()).c_str());
    ...
    if (!privateDnsNameVerificationStateNode.IsNull()) {
      m_privateDnsNameVerificationState = DnsNameStateMapper::GetDnsNameStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(privateDnsNameVerificationStateNode.GetText()).c_str()));
...
void ServiceDetail::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_privateDnsNameVerificationStateHasBeenSet) {
    oStream << location << index << locationValue << ".PrivateDnsNameVerificationState="
            << StringUtils::URLEncode(DnsNameStateMapper::GetNameForDnsNameState(m_privateDnsNameVerificationState)) << "&";
  }
...
void ServiceDetail::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_privateDnsNameVerificationStateHasBeenSet) {
    oStream << location << ".PrivateDnsNameVerificationState="
            << StringUtils::URLEncode(DnsNameStateMapper::GetNameForDnsNameState(m_privateDnsNameVerificationState)) << "&";
  }
  if (m_supportedIpAddressTypesHasBeenSet) {
    unsigned supportedIpAddressTypesIdx = 1;
