...
PriceScheduleSpecification::PriceScheduleSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
PriceScheduleSpecification& PriceScheduleSpecification::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!currencyCodeNode.IsNull()) {
      m_currencyCode = CurrencyCodeValuesMapper::GetCurrencyCodeValuesForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(currencyCodeNode.GetText()).c_str()));
...
void PriceScheduleSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_currencyCodeHasBeenSet) {
    oStream << location << index << locationValue
            << ".CurrencyCode=" << StringUtils::URLEncode(CurrencyCodeValuesMapper::GetNameForCurrencyCodeValues(m_currencyCode)) << "&";
  }
}
