...
CapacityManagerDimension::CapacityManagerDimension(const XmlNode& xmlNode)
{
  *this = xmlNode;
}
...
CapacityManagerDimension& CapacityManagerDimension::operator =(const XmlNode& xmlNode)
{
  ...
  if(!resultNode.IsNull())
  {
    ...
    {
      m_reservationType = ReservationTypeMapper::GetReservationTypeForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(reservationTypeNode.GetText()).c_str()));
    ...
    {
      m_reservationCreateTimestamp = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(reservationCreateTimestampNode.GetText()).c_str()).c_str(), Aws::Utils::DateFormat::ISO_8601);
    ...
    {
      m_reservationStartTimestamp = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(reservationStartTimestampNode.GetText()).c_str()).c_str(), Aws::Utils::DateFormat::ISO_8601);
    ...
    {
      m_reservationEndTimestamp = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(reservationEndTimestampNode.GetText()).c_str()).c_str(), Aws::Utils::DateFormat::ISO_8601);
    ...
    {
      m_reservationEndDateType = ReservationEndDateTypeMapper::GetReservationEndDateTypeForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(reservationEndDateTypeNode.GetText()).c_str()));
      m_reservationEndDateTypeHasBeenSet = true;
    }
    XmlNode tenancyNode = resultNode.FirstChild("tenancy");
    if(!tenancyNode.IsNull())
    {
      m_tenancy = CapacityTenancyMapper::GetCapacityTenancyForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(tenancyNode.GetText()).c_str()));
      m_tenancyHasBeenSet = true;
    }
    XmlNode reservationStateNode = resultNode.FirstChild("reservationState");
    if(!reservationStateNode.IsNull())
    {
      m_reservationState = ReservationStateMapper::GetReservationStateForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(reservationStateNode.GetText()).c_str()));
...
void CapacityManagerDimension::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
  ...
  {
      oStream << location << index << locationValue << ".ReservationType=" << StringUtils::URLEncode(ReservationTypeMapper::GetNameForReservationType(m_reservationType)) << "&";
  }

  if(m_reservationCreateTimestampHasBeenSet)
  {
      oStream << location << index << locationValue << ".ReservationCreateTimestamp=" << StringUtils::URLEncode(m_reservationCreateTimestamp.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if(m_reservationStartTimestampHasBeenSet)
  {
      oStream << location << index << locationValue << ".ReservationStartTimestamp=" << StringUtils::URLEncode(m_reservationStartTimestamp.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if(m_reservationEndTimestampHasBeenSet)
  {
      oStream << location << index << locationValue << ".ReservationEndTimestamp=" << StringUtils::URLEncode(m_reservationEndTimestamp.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if(m_reservationEndDateTypeHasBeenSet)
  {
      oStream << location << index << locationValue << ".ReservationEndDateType=" << StringUtils::URLEncode(ReservationEndDateTypeMapper::GetNameForReservationEndDateType(m_reservationEndDateType)) << "&";
  }

  if(m_tenancyHasBeenSet)
  {
      oStream << location << index << locationValue << ".Tenancy=" << StringUtils::URLEncode(CapacityTenancyMapper::GetNameForCapacityTenancy(m_tenancy)) << "&";
  }

  if(m_reservationStateHasBeenSet)
  {
      oStream << location << index << locationValue << ".ReservationState=" << StringUtils::URLEncode(ReservationStateMapper::GetNameForReservationState(m_reservationState)) << "&";
  }

  if(m_reservationInstanceMatchCriteriaHasBeenSet)
  {
      oStream << location << index << locationValue << ".ReservationInstanceMatchCriteria=" << StringUtils::URLEncode(m_reservationInstanceMatchCriteria.c_str()) << "&";
  }

  if(m_reservationUnusedFinancialOwnerHasBeenSet)
  {
      oStream << location << index << locationValue << ".ReservationUnusedFinancialOwner=" << StringUtils::URLEncode(m_reservationUnusedFinancialOwner.c_str()) << "&";
  }
...
void CapacityManagerDimension::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  ...
  if(m_reservationTypeHasBeenSet)
  {
      oStream << location << ".ReservationType=" << StringUtils::URLEncode(ReservationTypeMapper::GetNameForReservationType(m_reservationType)) << "&";
  }
  if(m_reservationCreateTimestampHasBeenSet)
  {
      oStream << location << ".ReservationCreateTimestamp=" << StringUtils::URLEncode(m_reservationCreateTimestamp.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if(m_reservationStartTimestampHasBeenSet)
  {
      oStream << location << ".ReservationStartTimestamp=" << StringUtils::URLEncode(m_reservationStartTimestamp.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if(m_reservationEndTimestampHasBeenSet)
  {
      oStream << location << ".ReservationEndTimestamp=" << StringUtils::URLEncode(m_reservationEndTimestamp.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if(m_reservationEndDateTypeHasBeenSet)
  {
      oStream << location << ".ReservationEndDateType=" << StringUtils::URLEncode(ReservationEndDateTypeMapper::GetNameForReservationEndDateType(m_reservationEndDateType)) << "&";
  }
  if(m_tenancyHasBeenSet)
  {
  ...
  if(m_reservationStateHasBeenSet)
  {
      oStream << location << ".ReservationState=" << StringUtils::URLEncode(ReservationStateMapper::GetNameForReservationState(m_reservationState)) << "&";
  }
  if(m_reservationInstanceMatchCriteriaHasBeenSet)
  {
