...
LaunchTemplateInstanceMetadataOptions::LaunchTemplateInstanceMetadataOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
LaunchTemplateInstanceMetadataOptions& LaunchTemplateInstanceMetadataOptions::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = LaunchTemplateInstanceMetadataOptionsStateMapper::GetLaunchTemplateInstanceMetadataOptionsStateForName(
...
void LaunchTemplateInstanceMetadataOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                           const char* locationValue) const {
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue << ".State="
            << StringUtils::URLEncode(
                   LaunchTemplateInstanceMetadataOptionsStateMapper::GetNameForLaunchTemplateInstanceMetadataOptionsState(m_state))
            << "&";
  }
