...
DescribeSecurityGroupVpcAssociationsResponse::DescribeSecurityGroupVpcAssociationsResponse(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  *this = result;
}

DescribeSecurityGroupVpcAssociationsResponse& DescribeSecurityGroupVpcAssociationsResponse::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DescribeSecurityGroupVpcAssociationsResponse",
