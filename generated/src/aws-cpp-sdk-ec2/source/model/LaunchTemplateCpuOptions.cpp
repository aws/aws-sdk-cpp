...
LaunchTemplateCpuOptions::LaunchTemplateCpuOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LaunchTemplateCpuOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
