...
VpcIpv6CidrBlockAssociation::VpcIpv6CidrBlockAssociation(const XmlNode& xmlNode) { *this = xmlNode; }
...
VpcIpv6CidrBlockAssociation& VpcIpv6CidrBlockAssociation::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!ipv6AddressAttributeNode.IsNull()) {
      m_ipv6AddressAttribute = Ipv6AddressAttributeMapper::GetIpv6AddressAttributeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(ipv6AddressAttributeNode.GetText()).c_str()));
      m_ipv6AddressAttributeHasBeenSet = true;
    }
    XmlNode ipSourceNode = resultNode.FirstChild("ipSource");
    if (!ipSourceNode.IsNull()) {
      m_ipSource =
          IpSourceMapper::GetIpSourceForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(ipSourceNode.GetText()).c_str()));
...
void VpcIpv6CidrBlockAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_ipv6AddressAttributeHasBeenSet) {
    oStream << location << index << locationValue << ".Ipv6AddressAttribute="
            << StringUtils::URLEncode(Ipv6AddressAttributeMapper::GetNameForIpv6AddressAttribute(m_ipv6AddressAttribute)) << "&";
  }
...
void VpcIpv6CidrBlockAssociation::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_ipv6AddressAttributeHasBeenSet) {
    oStream << location << ".Ipv6AddressAttribute="
            << StringUtils::URLEncode(Ipv6AddressAttributeMapper::GetNameForIpv6AddressAttribute(m_ipv6AddressAttribute)) << "&";
  }
  if (m_ipSourceHasBeenSet) {
