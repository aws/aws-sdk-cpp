...
TargetConfigurationRequest::TargetConfigurationRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TargetConfigurationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
