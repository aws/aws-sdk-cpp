...
AddIpamOrganizationalUnitExclusion::AddIpamOrganizationalUnitExclusion(const XmlNode& xmlNode) { *this = xmlNode; }
...
void AddIpamOrganizationalUnitExclusion::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                        const char* locationValue) const {
  if (m_organizationsEntityPathHasBeenSet) {
    oStream << location << index << locationValue
            << ".OrganizationsEntityPath=" << StringUtils::URLEncode(m_organizationsEntityPath.c_str()) << "&";
  }
}
