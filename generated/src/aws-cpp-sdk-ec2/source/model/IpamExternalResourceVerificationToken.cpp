...
IpamExternalResourceVerificationToken::IpamExternalResourceVerificationToken(const XmlNode& xmlNode) { *this = xmlNode; }
...
IpamExternalResourceVerificationToken& IpamExternalResourceVerificationToken::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!ipamExternalResourceVerificationTokenIdNode.IsNull()) {
      m_ipamExternalResourceVerificationTokenId =
          Aws::Utils::Xml::DecodeEscapedXmlText(ipamExternalResourceVerificationTokenIdNode.GetText());
    ...
    if (!ipamExternalResourceVerificationTokenArnNode.IsNull()) {
      m_ipamExternalResourceVerificationTokenArn =
          Aws::Utils::Xml::DecodeEscapedXmlText(ipamExternalResourceVerificationTokenArnNode.GetText());
    ...
    if (!notAfterNode.IsNull()) {
      m_notAfter = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(notAfterNode.GetText()).c_str()).c_str(),
    ...
    if (!statusNode.IsNull()) {
      m_status =
          TokenStateMapper::GetTokenStateForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(statusNode.GetText()).c_str()));
    ...
    if (!stateNode.IsNull()) {
      m_state = IpamExternalResourceVerificationTokenStateMapper::GetIpamExternalResourceVerificationTokenStateForName(
...
void IpamExternalResourceVerificationToken::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                           const char* locationValue) const {
  if (m_ipamExternalResourceVerificationTokenIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".IpamExternalResourceVerificationTokenId=" << StringUtils::URLEncode(m_ipamExternalResourceVerificationTokenId.c_str())
            << "&";
  }

  if (m_ipamExternalResourceVerificationTokenArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".IpamExternalResourceVerificationTokenArn=" << StringUtils::URLEncode(m_ipamExternalResourceVerificationTokenArn.c_str())
            << "&";
  }
  ...
  if (m_notAfterHasBeenSet) {
    oStream << location << index << locationValue
            << ".NotAfter=" << StringUtils::URLEncode(m_notAfter.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue << ".State="
            << StringUtils::URLEncode(
                   IpamExternalResourceVerificationTokenStateMapper::GetNameForIpamExternalResourceVerificationTokenState(m_state))
            << "&";
  }
}
