...
Phase2DHGroupNumbersListValue::Phase2DHGroupNumbersListValue(const XmlNode& xmlNode) { *this = xmlNode; }
...
void Phase2DHGroupNumbersListValue::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
