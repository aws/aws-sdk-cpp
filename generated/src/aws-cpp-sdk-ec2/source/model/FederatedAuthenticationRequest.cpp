...
FederatedAuthenticationRequest::FederatedAuthenticationRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void FederatedAuthenticationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
