...
AttributeSummary::AttributeSummary(const XmlNode& xmlNode) { *this = xmlNode; }
...
AttributeSummary& AttributeSummary::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!numberOfMatchedAccountsNode.IsNull()) {
      m_numberOfMatchedAccounts = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(numberOfMatchedAccountsNode.GetText()).c_str()).c_str());
    ...
    if (!numberOfUnmatchedAccountsNode.IsNull()) {
      m_numberOfUnmatchedAccounts = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(numberOfUnmatchedAccountsNode.GetText()).c_str()).c_str());
