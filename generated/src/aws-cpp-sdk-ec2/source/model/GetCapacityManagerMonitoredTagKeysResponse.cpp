...
GetCapacityManagerMonitoredTagKeysResponse::GetCapacityManagerMonitoredTagKeysResponse(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  *this = result;
}

GetCapacityManagerMonitoredTagKeysResponse& GetCapacityManagerMonitoredTagKeysResponse::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  m_HttpResponseCode = result.GetResponseCode();
  const XmlDocument& xmlDocument = result.GetPayload();
  XmlNode rootNode = xmlDocument.GetRootElement();
  XmlNode resultNode = rootNode;
  if (!rootNode.IsNull() && (rootNode.GetName() != "GetCapacityManagerMonitoredTagKeysResponse")) {
    resultNode = rootNode.FirstChild("GetCapacityManagerMonitoredTagKeysResponse");
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::GetCapacityManagerMonitoredTagKeysResponse",
