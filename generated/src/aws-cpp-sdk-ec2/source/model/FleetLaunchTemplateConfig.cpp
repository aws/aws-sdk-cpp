...
FleetLaunchTemplateConfig::FleetLaunchTemplateConfig(const XmlNode& xmlNode) { *this = xmlNode; }
...
void FleetLaunchTemplateConfig::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
