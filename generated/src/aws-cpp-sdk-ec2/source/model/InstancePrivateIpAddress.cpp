...
InstancePrivateIpAddress::InstancePrivateIpAddress(const XmlNode& xmlNode) { *this = xmlNode; }

InstancePrivateIpAddress& InstancePrivateIpAddress::operator=(const XmlNode& xmlNode) {
...
void InstancePrivateIpAddress::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
