...
ClientVpnConnection::ClientVpnConnection(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ClientVpnConnection::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_connectionEstablishedTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".ConnectionEstablishedTime=" << StringUtils::URLEncode(m_connectionEstablishedTime.c_str()) << "&";
  }
  ...
  if (m_postureComplianceStatusesHasBeenSet) {
    ...
    for (auto& item : m_postureComplianceStatuses) {
      oStream << location << index << locationValue << ".PostureComplianceStatusSet." << postureComplianceStatusesIdx++ << "="
