...
VerifiedAccessLogS3Destination::VerifiedAccessLogS3Destination(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VerifiedAccessLogS3Destination::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
