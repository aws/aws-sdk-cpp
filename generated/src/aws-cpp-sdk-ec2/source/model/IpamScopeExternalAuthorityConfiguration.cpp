...
IpamScopeExternalAuthorityConfiguration::IpamScopeExternalAuthorityConfiguration(const XmlNode& xmlNode) { *this = xmlNode; }

IpamScopeExternalAuthorityConfiguration& IpamScopeExternalAuthorityConfiguration::operator=(const XmlNode& xmlNode) {
...
void IpamScopeExternalAuthorityConfiguration::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void IpamScopeExternalAuthorityConfiguration::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_typeHasBeenSet) {
    oStream << location
            << ".Type=" << StringUtils::URLEncode(IpamScopeExternalAuthorityTypeMapper::GetNameForIpamScopeExternalAuthorityType(m_type))
            << "&";
