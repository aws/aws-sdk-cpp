...
TransitGatewayPolicyTableAssociation::TransitGatewayPolicyTableAssociation(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TransitGatewayPolicyTableAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
