...
ScheduledInstancesMonitoring::ScheduledInstancesMonitoring(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ScheduledInstancesMonitoring::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
