...
CancelSpotFleetRequestsSuccessItem::CancelSpotFleetRequestsSuccessItem(const XmlNode& xmlNode) { *this = xmlNode; }
...
CancelSpotFleetRequestsSuccessItem& CancelSpotFleetRequestsSuccessItem::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!currentSpotFleetRequestStateNode.IsNull()) {
      m_currentSpotFleetRequestState = BatchStateMapper::GetBatchStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(currentSpotFleetRequestStateNode.GetText()).c_str()));
    ...
    if (!previousSpotFleetRequestStateNode.IsNull()) {
      m_previousSpotFleetRequestState = BatchStateMapper::GetBatchStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(previousSpotFleetRequestStateNode.GetText()).c_str()));
...
void CancelSpotFleetRequestsSuccessItem::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                        const char* locationValue) const {
  if (m_currentSpotFleetRequestStateHasBeenSet) {
    oStream << location << index << locationValue << ".CurrentSpotFleetRequestState="
            << StringUtils::URLEncode(BatchStateMapper::GetNameForBatchState(m_currentSpotFleetRequestState)) << "&";
  }

  if (m_previousSpotFleetRequestStateHasBeenSet) {
    oStream << location << index << locationValue << ".PreviousSpotFleetRequestState="
            << StringUtils::URLEncode(BatchStateMapper::GetNameForBatchState(m_previousSpotFleetRequestState)) << "&";
  }
...
void CancelSpotFleetRequestsSuccessItem::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_currentSpotFleetRequestStateHasBeenSet) {
    oStream << location << ".CurrentSpotFleetRequestState="
            << StringUtils::URLEncode(BatchStateMapper::GetNameForBatchState(m_currentSpotFleetRequestState)) << "&";
  }
  if (m_previousSpotFleetRequestStateHasBeenSet) {
    oStream << location << ".PreviousSpotFleetRequestState="
            << StringUtils::URLEncode(BatchStateMapper::GetNameForBatchState(m_previousSpotFleetRequestState)) << "&";
  }
  if (m_spotFleetRequestIdHasBeenSet) {
