...
AddressTransfer::AddressTransfer(const XmlNode& xmlNode) { *this = xmlNode; }
...
AddressTransfer& AddressTransfer::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!transferOfferExpirationTimestampNode.IsNull()) {
      m_transferOfferExpirationTimestamp =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(transferOfferExpirationTimestampNode.GetText()).c_str()).c_str(),
    ...
    if (!transferOfferAcceptedTimestampNode.IsNull()) {
      m_transferOfferAcceptedTimestamp =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(transferOfferAcceptedTimestampNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!addressTransferStatusNode.IsNull()) {
      m_addressTransferStatus = AddressTransferStatusMapper::GetAddressTransferStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(addressTransferStatusNode.GetText()).c_str()));
...
void AddressTransfer::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_transferOfferExpirationTimestampHasBeenSet) {
    oStream << location << index << locationValue << ".TransferOfferExpirationTimestamp="
            << StringUtils::URLEncode(m_transferOfferExpirationTimestamp.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_transferOfferAcceptedTimestampHasBeenSet) {
    oStream << location << index << locationValue << ".TransferOfferAcceptedTimestamp="
            << StringUtils::URLEncode(m_transferOfferAcceptedTimestamp.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_addressTransferStatusHasBeenSet) {
    oStream << location << index << locationValue << ".AddressTransferStatus="
            << StringUtils::URLEncode(AddressTransferStatusMapper::GetNameForAddressTransferStatus(m_addressTransferStatus)) << "&";
  }
}
...
void AddressTransfer::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_transferOfferExpirationTimestampHasBeenSet) {
    oStream << location << ".TransferOfferExpirationTimestamp="
            << StringUtils::URLEncode(m_transferOfferExpirationTimestamp.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_transferOfferAcceptedTimestampHasBeenSet) {
    oStream << location << ".TransferOfferAcceptedTimestamp="
            << StringUtils::URLEncode(m_transferOfferAcceptedTimestamp.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_addressTransferStatusHasBeenSet) {
    oStream << location << ".AddressTransferStatus="
            << StringUtils::URLEncode(AddressTransferStatusMapper::GetNameForAddressTransferStatus(m_addressTransferStatus)) << "&";
  }
}
