...
IpamPublicAddressSecurityGroup::IpamPublicAddressSecurityGroup(const XmlNode& xmlNode) { *this = xmlNode; }

IpamPublicAddressSecurityGroup& IpamPublicAddressSecurityGroup::operator=(const XmlNode& xmlNode) {
...
void IpamPublicAddressSecurityGroup::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void IpamPublicAddressSecurityGroup::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_groupNameHasBeenSet) {
