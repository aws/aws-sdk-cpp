...
ApplicationStatusSummary::ApplicationStatusSummary(const XmlNode& xmlNode) { *this = xmlNode; }

ApplicationStatusSummary& ApplicationStatusSummary::operator=(const XmlNode& xmlNode) {
...
void ApplicationStatusSummary::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void ApplicationStatusSummary::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_statusHasBeenSet) {
