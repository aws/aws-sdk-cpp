...
GetCapacityManagerAttributesResponse& GetCapacityManagerAttributesResponse::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  if(!resultNode.IsNull())
  {
    ...
    {
      m_dataExportCount = StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(dataExportCountNode.GetText()).c_str()).c_str());
    ...
    {
      m_ingestionStatus = IngestionStatusMapper::GetIngestionStatusForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(ingestionStatusNode.GetText()).c_str()));
    ...
    {
      m_earliestDatapointTimestamp = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(earliestDatapointTimestampNode.GetText()).c_str()).c_str(), Aws::Utils::DateFormat::ISO_8601);
    ...
    {
      m_latestDatapointTimestamp = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(latestDatapointTimestampNode.GetText()).c_str()).c_str(), Aws::Utils::DateFormat::ISO_8601);
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::GetCapacityManagerAttributesResponse", "x-amzn-request-id: " << m_responseMetadata.GetRequestId() );
  }
  return *this;
}
