...
NativeApplicationOidcOptions::NativeApplicationOidcOptions(const XmlNode& xmlNode) { *this = xmlNode; }

NativeApplicationOidcOptions& NativeApplicationOidcOptions::operator=(const XmlNode& xmlNode) {
...
void NativeApplicationOidcOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void NativeApplicationOidcOptions::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_publicSigningKeyEndpointHasBeenSet) {
