...
Aws::String DisassociateApplicationStatusCheckRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=DisassociateApplicationStatusCheck&";
...
void DisassociateApplicationStatusCheckRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
