...
ScheduledInstancesBlockDeviceMapping::ScheduledInstancesBlockDeviceMapping(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ScheduledInstancesBlockDeviceMapping::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
