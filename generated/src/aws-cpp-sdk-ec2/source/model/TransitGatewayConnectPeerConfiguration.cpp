...
TransitGatewayConnectPeerConfiguration::TransitGatewayConnectPeerConfiguration(const XmlNode& xmlNode) { *this = xmlNode; }
...
TransitGatewayConnectPeerConfiguration& TransitGatewayConnectPeerConfiguration::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!protocolNode.IsNull()) {
      m_protocol = ProtocolValueMapper::GetProtocolValueForName(
...
void TransitGatewayConnectPeerConfiguration::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_insideCidrBlocksHasBeenSet) {
    ...
    for (auto& item : m_insideCidrBlocks) {
      oStream << location << index << locationValue << ".InsideCidrBlocks." << insideCidrBlocksIdx++ << "="
  ...
  if (m_protocolHasBeenSet) {
    oStream << location << index << locationValue
            << ".Protocol=" << StringUtils::URLEncode(ProtocolValueMapper::GetNameForProtocolValue(m_protocol)) << "&";
  }
