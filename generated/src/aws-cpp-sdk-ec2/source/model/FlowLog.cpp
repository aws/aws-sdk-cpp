...
FlowLog::FlowLog(const XmlNode& xmlNode) { *this = xmlNode; }
...
FlowLog& FlowLog::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!trafficTypeNode.IsNull()) {
      m_trafficType = TrafficTypeMapper::GetTrafficTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(trafficTypeNode.GetText()).c_str()));
    ...
    if (!logDestinationTypeNode.IsNull()) {
      m_logDestinationType = LogDestinationTypeMapper::GetLogDestinationTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(logDestinationTypeNode.GetText()).c_str()));
    ...
    if (!maxAggregationIntervalNode.IsNull()) {
      m_maxAggregationInterval = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maxAggregationIntervalNode.GetText()).c_str()).c_str());
...
void FlowLog::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_deliverLogsErrorMessageHasBeenSet) {
    oStream << location << index << locationValue
            << ".DeliverLogsErrorMessage=" << StringUtils::URLEncode(m_deliverLogsErrorMessage.c_str()) << "&";
  }

  if (m_deliverLogsPermissionArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".DeliverLogsPermissionArn=" << StringUtils::URLEncode(m_deliverLogsPermissionArn.c_str()) << "&";
  }

  if (m_deliverCrossAccountRoleHasBeenSet) {
    oStream << location << index << locationValue
            << ".DeliverCrossAccountRole=" << StringUtils::URLEncode(m_deliverCrossAccountRole.c_str()) << "&";
  }
  ...
  if (m_trafficTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".TrafficType=" << StringUtils::URLEncode(TrafficTypeMapper::GetNameForTrafficType(m_trafficType)) << "&";
  }

  if (m_logDestinationTypeHasBeenSet) {
    oStream << location << index << locationValue << ".LogDestinationType="
            << StringUtils::URLEncode(LogDestinationTypeMapper::GetNameForLogDestinationType(m_logDestinationType)) << "&";
  }
...
void FlowLog::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_logDestinationTypeHasBeenSet) {
    oStream << location << ".LogDestinationType="
            << StringUtils::URLEncode(LogDestinationTypeMapper::GetNameForLogDestinationType(m_logDestinationType)) << "&";
  }
  if (m_logDestinationHasBeenSet) {
