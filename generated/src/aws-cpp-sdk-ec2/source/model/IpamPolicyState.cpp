...
namespace EC2 {
namespace Model {
namespace IpamPolicyStateMapper {
...
IpamPolicyState GetIpamPolicyStateForName(const Aws::String& name) {
  int hashCode = HashingUtils::HashString(name.c_str());
  if (hashCode == create_in_progress_HASH) {
    return IpamPolicyState::create_in_progress;
  } else if (hashCode == create_complete_HASH) {
    return IpamPolicyState::create_complete;
  } else if (hashCode == create_failed_HASH) {
    return IpamPolicyState::create_failed;
  } else if (hashCode == modify_in_progress_HASH) {
    return IpamPolicyState::modify_in_progress;
  } else if (hashCode == modify_complete_HASH) {
    return IpamPolicyState::modify_complete;
  } else if (hashCode == modify_failed_HASH) {
    return IpamPolicyState::modify_failed;
  } else if (hashCode == delete_in_progress_HASH) {
    return IpamPolicyState::delete_in_progress;
  } else if (hashCode == delete_complete_HASH) {
    return IpamPolicyState::delete_complete;
  } else if (hashCode == delete_failed_HASH) {
    return IpamPolicyState::delete_failed;
  } else if (hashCode == isolate_in_progress_HASH) {
    return IpamPolicyState::isolate_in_progress;
  } else if (hashCode == isolate_complete_HASH) {
    return IpamPolicyState::isolate_complete;
  } else if (hashCode == restore_in_progress_HASH) {
    return IpamPolicyState::restore_in_progress;
  }
  EnumParseOverflowContainer* overflowContainer = Aws::GetEnumOverflowContainer();
  if (overflowContainer) {
    overflowContainer->StoreOverflow(hashCode, name);
    return static_cast<IpamPolicyState>(hashCode);
  }

  return IpamPolicyState::NOT_SET;
}

Aws::String GetNameForIpamPolicyState(IpamPolicyState enumValue) {
  switch (enumValue) {
    case IpamPolicyState::NOT_SET:
      return {};
    case IpamPolicyState::create_in_progress:
      return "create-in-progress";
    case IpamPolicyState::create_complete:
      return "create-complete";
    case IpamPolicyState::create_failed:
      return "create-failed";
    case IpamPolicyState::modify_in_progress:
      return "modify-in-progress";
    case IpamPolicyState::modify_complete:
      return "modify-complete";
    case IpamPolicyState::modify_failed:
      return "modify-failed";
    case IpamPolicyState::delete_in_progress:
      return "delete-in-progress";
    case IpamPolicyState::delete_complete:
      return "delete-complete";
    case IpamPolicyState::delete_failed:
      return "delete-failed";
    case IpamPolicyState::isolate_in_progress:
      return "isolate-in-progress";
    case IpamPolicyState::isolate_complete:
      return "isolate-complete";
    case IpamPolicyState::restore_in_progress:
