...
DescribeNetworkInsightsAnalysesResponse& DescribeNetworkInsightsAnalysesResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!networkInsightsAnalysesNode.IsNull()) {
      ...
      m_networkInsightsAnalysesHasBeenSet = !networkInsightsAnalysesMember.IsNull();
      ...
      m_networkInsightsAnalysesHasBeenSet = true;
    }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DescribeNetworkInsightsAnalysesResponse",
