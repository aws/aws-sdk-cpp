...
RevokedSecurityGroupRule::RevokedSecurityGroupRule(const XmlNode& xmlNode) { *this = xmlNode; }
...
void RevokedSecurityGroupRule::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
