...
DescribeLocalGatewayVirtualInterfacesResponse& DescribeLocalGatewayVirtualInterfacesResponse::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!localGatewayVirtualInterfacesNode.IsNull()) {
      ...
      m_localGatewayVirtualInterfacesHasBeenSet = !localGatewayVirtualInterfacesMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DescribeLocalGatewayVirtualInterfacesResponse",
