...
Aws::String GetIpamPoolAllocationsRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=GetIpamPoolAllocations&";
...
void GetIpamPoolAllocationsRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
