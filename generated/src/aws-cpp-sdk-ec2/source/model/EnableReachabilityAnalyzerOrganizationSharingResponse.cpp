...
EnableReachabilityAnalyzerOrganizationSharingResponse& EnableReachabilityAnalyzerOrganizationSharingResponse::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::EnableReachabilityAnalyzerOrganizationSharingResponse", "x-amzn-request-id: " << m_responseMetadata.GetRequestId() );
  }
  return *this;
}
