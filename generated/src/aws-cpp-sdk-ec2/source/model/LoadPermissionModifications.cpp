...
LoadPermissionModifications::LoadPermissionModifications(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LoadPermissionModifications::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
