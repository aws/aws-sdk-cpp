...
PrivateDnsNameOptionsRequest::PrivateDnsNameOptionsRequest(const XmlNode& xmlNode) { *this = xmlNode; }

PrivateDnsNameOptionsRequest& PrivateDnsNameOptionsRequest::operator=(const XmlNode& xmlNode) {
...
void PrivateDnsNameOptionsRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void PrivateDnsNameOptionsRequest::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_hostnameTypeHasBeenSet) {
