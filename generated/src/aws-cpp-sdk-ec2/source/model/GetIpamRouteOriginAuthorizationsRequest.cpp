...
Aws::String GetIpamRouteOriginAuthorizationsRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=GetIpamRouteOriginAuthorizations&";
...
void GetIpamRouteOriginAuthorizationsRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
