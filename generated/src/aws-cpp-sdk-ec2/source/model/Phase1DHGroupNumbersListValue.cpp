...
Phase1DHGroupNumbersListValue::Phase1DHGroupNumbersListValue(const XmlNode& xmlNode) { *this = xmlNode; }
...
void Phase1DHGroupNumbersListValue::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
