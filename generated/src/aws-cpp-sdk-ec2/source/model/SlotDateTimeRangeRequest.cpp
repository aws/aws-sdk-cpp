...
SlotDateTimeRangeRequest::SlotDateTimeRangeRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void SlotDateTimeRangeRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
