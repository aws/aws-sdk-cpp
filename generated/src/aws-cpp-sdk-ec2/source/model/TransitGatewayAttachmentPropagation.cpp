...
TransitGatewayAttachmentPropagation::TransitGatewayAttachmentPropagation(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TransitGatewayAttachmentPropagation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
