...
ConnectionTrackingSpecificationResponse::ConnectionTrackingSpecificationResponse() : 
...
ConnectionTrackingSpecificationResponse::ConnectionTrackingSpecificationResponse(const XmlNode& xmlNode) : 
    m_tcpEstablishedTimeout(0),
    m_tcpEstablishedTimeoutHasBeenSet(false),
    m_udpStreamTimeout(0),
    m_udpStreamTimeoutHasBeenSet(false),
...
ConnectionTrackingSpecificationResponse& ConnectionTrackingSpecificationResponse::operator =(const XmlNode& xmlNode)
{
...
void ConnectionTrackingSpecificationResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void ConnectionTrackingSpecificationResponse::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_tcpEstablishedTimeoutHasBeenSet)
  {
