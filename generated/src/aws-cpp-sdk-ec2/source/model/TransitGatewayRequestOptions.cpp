...
TransitGatewayRequestOptions::TransitGatewayRequestOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
TransitGatewayRequestOptions& TransitGatewayRequestOptions::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!multicastSupportNode.IsNull()) {
      m_multicastSupport = MulticastSupportValueMapper::GetMulticastSupportValueForName(
...
void TransitGatewayRequestOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_transitGatewayCidrBlocksHasBeenSet) {
    ...
    for (auto& item : m_transitGatewayCidrBlocks) {
      oStream << location << index << locationValue << ".TransitGatewayCidrBlocks." << transitGatewayCidrBlocksIdx++ << "="
