...
TransitGatewayMulticastDomain::TransitGatewayMulticastDomain(const XmlNode& xmlNode) { *this = xmlNode; }
...
TransitGatewayMulticastDomain& TransitGatewayMulticastDomain::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = TransitGatewayMulticastDomainStateMapper::GetTransitGatewayMulticastDomainStateForName(
...
void TransitGatewayMulticastDomain::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_transitGatewayMulticastDomainArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".TransitGatewayMulticastDomainArn=" << StringUtils::URLEncode(m_transitGatewayMulticastDomainArn.c_str()) << "&";
  }
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue << ".State="
            << StringUtils::URLEncode(TransitGatewayMulticastDomainStateMapper::GetNameForTransitGatewayMulticastDomainState(m_state))
            << "&";
  }
