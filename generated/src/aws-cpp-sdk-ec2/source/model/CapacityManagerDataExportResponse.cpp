...
CapacityManagerDataExportResponse::CapacityManagerDataExportResponse(const XmlNode& xmlNode) { *this = xmlNode; }
...
CapacityManagerDataExportResponse& CapacityManagerDataExportResponse::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!scheduleNode.IsNull()) {
      m_schedule =
          ScheduleMapper::GetScheduleForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(scheduleNode.GetText()).c_str()));
      m_scheduleHasBeenSet = true;
    }
    XmlNode outputFormatNode = resultNode.FirstChild("outputFormat");
    if (!outputFormatNode.IsNull()) {
      m_outputFormat = OutputFormatMapper::GetOutputFormatForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(outputFormatNode.GetText()).c_str()));
    ...
    if (!latestDeliveryStatusNode.IsNull()) {
      m_latestDeliveryStatus = CapacityManagerDataExportStatusMapper::GetCapacityManagerDataExportStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(latestDeliveryStatusNode.GetText()).c_str()));
    ...
    if (!latestDeliveryTimeNode.IsNull()) {
      m_latestDeliveryTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(latestDeliveryTimeNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
...
void CapacityManagerDataExportResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                       const char* locationValue) const {
  if (m_capacityManagerDataExportIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".CapacityManagerDataExportId=" << StringUtils::URLEncode(m_capacityManagerDataExportId.c_str()) << "&";
  }
  ...
  if (m_outputFormatHasBeenSet) {
    oStream << location << index << locationValue
            << ".OutputFormat=" << StringUtils::URLEncode(OutputFormatMapper::GetNameForOutputFormat(m_outputFormat)) << "&";
  }
  ...
  if (m_latestDeliveryStatusHasBeenSet) {
    oStream << location << index << locationValue << ".LatestDeliveryStatus="
            << StringUtils::URLEncode(
                   CapacityManagerDataExportStatusMapper::GetNameForCapacityManagerDataExportStatus(m_latestDeliveryStatus))
            << "&";
  }

  if (m_latestDeliveryStatusMessageHasBeenSet) {
    oStream << location << index << locationValue
            << ".LatestDeliveryStatusMessage=" << StringUtils::URLEncode(m_latestDeliveryStatusMessage.c_str()) << "&";
  }

  if (m_latestDeliveryS3LocationUriHasBeenSet) {
    oStream << location << index << locationValue
            << ".LatestDeliveryS3LocationUri=" << StringUtils::URLEncode(m_latestDeliveryS3LocationUri.c_str()) << "&";
  }

  if (m_latestDeliveryTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".LatestDeliveryTime=" << StringUtils::URLEncode(m_latestDeliveryTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }
...
void CapacityManagerDataExportResponse::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_latestDeliveryStatusHasBeenSet) {
    oStream << location << ".LatestDeliveryStatus="
            << StringUtils::URLEncode(
                   CapacityManagerDataExportStatusMapper::GetNameForCapacityManagerDataExportStatus(m_latestDeliveryStatus))
            << "&";
  }
