...
TerminateConnectionStatus::TerminateConnectionStatus(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TerminateConnectionStatus::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
