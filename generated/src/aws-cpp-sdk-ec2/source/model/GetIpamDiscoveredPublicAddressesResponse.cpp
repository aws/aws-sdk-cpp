...
GetIpamDiscoveredPublicAddressesResponse& GetIpamDiscoveredPublicAddressesResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!oldestSampleTimeNode.IsNull()) {
      m_oldestSampleTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(oldestSampleTimeNode.GetText()).c_str()).c_str(),
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::GetIpamDiscoveredPublicAddressesResponse",
