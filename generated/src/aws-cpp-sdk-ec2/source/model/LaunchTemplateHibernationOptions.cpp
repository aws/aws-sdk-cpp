...
LaunchTemplateHibernationOptions::LaunchTemplateHibernationOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LaunchTemplateHibernationOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
