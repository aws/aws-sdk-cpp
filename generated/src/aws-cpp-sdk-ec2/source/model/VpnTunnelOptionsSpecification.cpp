...
VpnTunnelOptionsSpecification::VpnTunnelOptionsSpecification(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VpnTunnelOptionsSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_phase1EncryptionAlgorithmsHasBeenSet) {
    ...
    for (auto& item : m_phase1EncryptionAlgorithms) {
      ...
      phase1EncryptionAlgorithmsSs << location << index << locationValue << ".Phase1EncryptionAlgorithm."
  ...
  if (m_phase2EncryptionAlgorithmsHasBeenSet) {
    ...
    for (auto& item : m_phase2EncryptionAlgorithms) {
      ...
      phase2EncryptionAlgorithmsSs << location << index << locationValue << ".Phase2EncryptionAlgorithm."
