...
VpcBlockPublicAccessExclusion::VpcBlockPublicAccessExclusion(const XmlNode& xmlNode) { *this = xmlNode; }
...
VpcBlockPublicAccessExclusion& VpcBlockPublicAccessExclusion::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!internetGatewayExclusionModeNode.IsNull()) {
      m_internetGatewayExclusionMode = InternetGatewayExclusionModeMapper::GetInternetGatewayExclusionModeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(internetGatewayExclusionModeNode.GetText()).c_str()));
    ...
    if (!stateNode.IsNull()) {
      m_state = VpcBlockPublicAccessExclusionStateMapper::GetVpcBlockPublicAccessExclusionStateForName(
    ...
    if (!deletionTimestampNode.IsNull()) {
      m_deletionTimestamp =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(deletionTimestampNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
...
void VpcBlockPublicAccessExclusion::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_internetGatewayExclusionModeHasBeenSet) {
    oStream << location << index << locationValue << ".InternetGatewayExclusionMode="
            << StringUtils::URLEncode(
                   InternetGatewayExclusionModeMapper::GetNameForInternetGatewayExclusionMode(m_internetGatewayExclusionMode))
            << "&";
  }
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue << ".State="
            << StringUtils::URLEncode(VpcBlockPublicAccessExclusionStateMapper::GetNameForVpcBlockPublicAccessExclusionState(m_state))
            << "&";
  }
  ...
  if (m_deletionTimestampHasBeenSet) {
    oStream << location << index << locationValue
            << ".DeletionTimestamp=" << StringUtils::URLEncode(m_deletionTimestamp.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }
...
void VpcBlockPublicAccessExclusion::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_internetGatewayExclusionModeHasBeenSet) {
    oStream << location << ".InternetGatewayExclusionMode="
            << StringUtils::URLEncode(
                   InternetGatewayExclusionModeMapper::GetNameForInternetGatewayExclusionMode(m_internetGatewayExclusionMode))
            << "&";
  }
