...
#include <aws/ec2/model/ModifyIpamRoutingPolicyRegistrationRequest.h>

using namespace Aws::EC2::Model;
using namespace Aws::Utils;

Aws::String ModifyIpamRoutingPolicyRegistrationRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=ModifyIpamRoutingPolicyRegistration&";
...
void ModifyIpamRoutingPolicyRegistrationRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
