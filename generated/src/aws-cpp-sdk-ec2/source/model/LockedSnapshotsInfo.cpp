...
LockedSnapshotsInfo::LockedSnapshotsInfo(const XmlNode& xmlNode) { *this = xmlNode; }
...
LockedSnapshotsInfo& LockedSnapshotsInfo::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!lockStateNode.IsNull()) {
      m_lockState =
          LockStateMapper::GetLockStateForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(lockStateNode.GetText()).c_str()));
      m_lockStateHasBeenSet = true;
    }
    XmlNode lockDurationNode = resultNode.FirstChild("lockDuration");
    if (!lockDurationNode.IsNull()) {
      m_lockDuration =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(lockDurationNode.GetText()).c_str()).c_str());
      m_lockDurationHasBeenSet = true;
    }
    XmlNode coolOffPeriodNode = resultNode.FirstChild("coolOffPeriod");
    if (!coolOffPeriodNode.IsNull()) {
      m_coolOffPeriod = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(coolOffPeriodNode.GetText()).c_str()).c_str());
    ...
    if (!coolOffPeriodExpiresOnNode.IsNull()) {
      m_coolOffPeriodExpiresOn =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(coolOffPeriodExpiresOnNode.GetText()).c_str()).c_str(),
    ...
    if (!lockCreatedOnNode.IsNull()) {
      m_lockCreatedOn = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(lockCreatedOnNode.GetText()).c_str()).c_str(),
                                 Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!lockDurationStartTimeNode.IsNull()) {
      m_lockDurationStartTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(lockDurationStartTimeNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!lockExpiresOnNode.IsNull()) {
      m_lockExpiresOn = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(lockExpiresOnNode.GetText()).c_str()).c_str(),
                                 Aws::Utils::DateFormat::ISO_8601);
...
void LockedSnapshotsInfo::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_lockStateHasBeenSet) {
    oStream << location << index << locationValue
            << ".LockState=" << StringUtils::URLEncode(LockStateMapper::GetNameForLockState(m_lockState)) << "&";
  }
  ...
  if (m_coolOffPeriodExpiresOnHasBeenSet) {
    oStream << location << index << locationValue << ".CoolOffPeriodExpiresOn="
            << StringUtils::URLEncode(m_coolOffPeriodExpiresOn.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_lockCreatedOnHasBeenSet) {
    oStream << location << index << locationValue
            << ".LockCreatedOn=" << StringUtils::URLEncode(m_lockCreatedOn.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_lockDurationStartTimeHasBeenSet) {
    oStream << location << index << locationValue << ".LockDurationStartTime="
            << StringUtils::URLEncode(m_lockDurationStartTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_lockExpiresOnHasBeenSet) {
    oStream << location << index << locationValue
            << ".LockExpiresOn=" << StringUtils::URLEncode(m_lockExpiresOn.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
}
...
void LockedSnapshotsInfo::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_coolOffPeriodExpiresOnHasBeenSet) {
    oStream << location << ".CoolOffPeriodExpiresOn="
            << StringUtils::URLEncode(m_coolOffPeriodExpiresOn.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_lockCreatedOnHasBeenSet) {
    oStream << location
  ...
  if (m_lockDurationStartTimeHasBeenSet) {
    oStream << location << ".LockDurationStartTime="
            << StringUtils::URLEncode(m_lockDurationStartTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_lockExpiresOnHasBeenSet) {
    oStream << location
