...
TransitGatewayAssociation::TransitGatewayAssociation(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TransitGatewayAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
