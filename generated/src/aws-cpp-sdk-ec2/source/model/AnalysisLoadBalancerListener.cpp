...
AnalysisLoadBalancerListener::AnalysisLoadBalancerListener(const XmlNode& xmlNode) { *this = xmlNode; }
...
void AnalysisLoadBalancerListener::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
