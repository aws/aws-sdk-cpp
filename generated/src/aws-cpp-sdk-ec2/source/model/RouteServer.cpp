...
RouteServer::RouteServer(const XmlNode& xmlNode) { *this = xmlNode; }
...
RouteServer& RouteServer::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = RouteServerStateMapper::GetRouteServerStateForName(
    ...
    if (!persistRoutesStateNode.IsNull()) {
      m_persistRoutesState = RouteServerPersistRoutesStateMapper::GetRouteServerPersistRoutesStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(persistRoutesStateNode.GetText()).c_str()));
    ...
    if (!persistRoutesDurationNode.IsNull()) {
      m_persistRoutesDuration = StringUtils::ConvertToInt64(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(persistRoutesDurationNode.GetText()).c_str()).c_str());
    ...
    if (!snsNotificationsEnabledNode.IsNull()) {
      m_snsNotificationsEnabled = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(snsNotificationsEnabledNode.GetText()).c_str()).c_str());
...
void RouteServer::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(RouteServerStateMapper::GetNameForRouteServerState(m_state)) << "&";
  }
  ...
  if (m_persistRoutesStateHasBeenSet) {
    oStream << location << index << locationValue << ".PersistRoutesState="
            << StringUtils::URLEncode(RouteServerPersistRoutesStateMapper::GetNameForRouteServerPersistRoutesState(m_persistRoutesState))
            << "&";
  }
...
void RouteServer::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_persistRoutesStateHasBeenSet) {
    oStream << location << ".PersistRoutesState="
            << StringUtils::URLEncode(RouteServerPersistRoutesStateMapper::GetNameForRouteServerPersistRoutesState(m_persistRoutesState))
            << "&";
  }
  if (m_persistRoutesDurationHasBeenSet) {
