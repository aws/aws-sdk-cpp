...
Aws::String DescribeApplicationStatusCheckAssociationsRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=DescribeApplicationStatusCheckAssociations&";
...
void DescribeApplicationStatusCheckAssociationsRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
