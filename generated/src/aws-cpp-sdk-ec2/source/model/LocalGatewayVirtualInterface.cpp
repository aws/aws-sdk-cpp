...
LocalGatewayVirtualInterface::LocalGatewayVirtualInterface(const XmlNode& xmlNode) { *this = xmlNode; }
...
LocalGatewayVirtualInterface& LocalGatewayVirtualInterface::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!localBgpAsnNode.IsNull()) {
      m_localBgpAsn =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(localBgpAsnNode.GetText()).c_str()).c_str());
      m_localBgpAsnHasBeenSet = true;
    }
    XmlNode peerBgpAsnNode = resultNode.FirstChild("peerBgpAsn");
    if (!peerBgpAsnNode.IsNull()) {
      m_peerBgpAsn =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(peerBgpAsnNode.GetText()).c_str()).c_str());
    ...
    if (!peerBgpAsnExtendedNode.IsNull()) {
      m_peerBgpAsnExtended = StringUtils::ConvertToInt64(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(peerBgpAsnExtendedNode.GetText()).c_str()).c_str());
    ...
    if (!configurationStateNode.IsNull()) {
      m_configurationState = LocalGatewayVirtualInterfaceConfigurationStateMapper::GetLocalGatewayVirtualInterfaceConfigurationStateForName(
...
void LocalGatewayVirtualInterface::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                  const char* locationValue) const {
  if (m_localGatewayVirtualInterfaceIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".LocalGatewayVirtualInterfaceId=" << StringUtils::URLEncode(m_localGatewayVirtualInterfaceId.c_str()) << "&";
  }
  ...
  if (m_localGatewayVirtualInterfaceArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".LocalGatewayVirtualInterfaceArn=" << StringUtils::URLEncode(m_localGatewayVirtualInterfaceArn.c_str()) << "&";
  }
  ...
  if (m_configurationStateHasBeenSet) {
    oStream << location << index << locationValue << ".ConfigurationState="
            << StringUtils::URLEncode(
                   LocalGatewayVirtualInterfaceConfigurationStateMapper::GetNameForLocalGatewayVirtualInterfaceConfigurationState(
