...
Subnet& Subnet::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!enableLniAtDeviceIndexNode.IsNull()) {
      m_enableLniAtDeviceIndex = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(enableLniAtDeviceIndexNode.GetText()).c_str()).c_str());
    ...
    if (!mapCustomerOwnedIpOnLaunchNode.IsNull()) {
      m_mapCustomerOwnedIpOnLaunch = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(mapCustomerOwnedIpOnLaunchNode.GetText()).c_str()).c_str());
    ...
    if (!assignIpv6AddressOnCreationNode.IsNull()) {
      m_assignIpv6AddressOnCreation = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(assignIpv6AddressOnCreationNode.GetText()).c_str()).c_str());
    ...
    if (!enableDns64Node.IsNull()) {
      m_enableDns64 =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(enableDns64Node.GetText()).c_str()).c_str());
      m_enableDns64HasBeenSet = true;
    }
    XmlNode ipv6NativeNode = resultNode.FirstChild("ipv6Native");
    if (!ipv6NativeNode.IsNull()) {
      m_ipv6Native =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(ipv6NativeNode.GetText()).c_str()).c_str());
    ...
    if (!stateNode.IsNull()) {
      m_state =
          SubnetStateMapper::GetSubnetStateForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(stateNode.GetText()).c_str()));
    ...
    if (!availableIpAddressCountNode.IsNull()) {
      m_availableIpAddressCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(availableIpAddressCountNode.GetText()).c_str()).c_str());
    ...
    if (!defaultForAzNode.IsNull()) {
      m_defaultForAz =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(defaultForAzNode.GetText()).c_str()).c_str());
    ...
    if (!mapPublicIpOnLaunchNode.IsNull()) {
      m_mapPublicIpOnLaunch = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(mapPublicIpOnLaunchNode.GetText()).c_str()).c_str());
