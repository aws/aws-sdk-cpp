...
DetachVerifiedAccessTrustProviderResponse& DetachVerifiedAccessTrustProviderResponse::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DetachVerifiedAccessTrustProviderResponse",
