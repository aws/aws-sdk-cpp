...
NetworkInsightsAccessScopeAnalysis::NetworkInsightsAccessScopeAnalysis(const XmlNode& xmlNode) { *this = xmlNode; }
...
NetworkInsightsAccessScopeAnalysis& NetworkInsightsAccessScopeAnalysis::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!statusNode.IsNull()) {
      m_status = AnalysisStatusMapper::GetAnalysisStatusForName(
    ...
    if (!findingsFoundNode.IsNull()) {
      m_findingsFound = FindingsFoundMapper::GetFindingsFoundForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(findingsFoundNode.GetText()).c_str()));
    ...
    if (!analyzedEniCountNode.IsNull()) {
      m_analyzedEniCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(analyzedEniCountNode.GetText()).c_str()).c_str());
...
void NetworkInsightsAccessScopeAnalysis::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                        const char* locationValue) const {
  if (m_networkInsightsAccessScopeAnalysisIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".NetworkInsightsAccessScopeAnalysisId=" << StringUtils::URLEncode(m_networkInsightsAccessScopeAnalysisId.c_str()) << "&";
  }

  if (m_networkInsightsAccessScopeAnalysisArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".NetworkInsightsAccessScopeAnalysisArn=" << StringUtils::URLEncode(m_networkInsightsAccessScopeAnalysisArn.c_str()) << "&";
  }
  ...
  if (m_statusHasBeenSet) {
    oStream << location << index << locationValue
            << ".Status=" << StringUtils::URLEncode(AnalysisStatusMapper::GetNameForAnalysisStatus(m_status)) << "&";
  }
  ...
  if (m_findingsFoundHasBeenSet) {
    oStream << location << index << locationValue
            << ".FindingsFound=" << StringUtils::URLEncode(FindingsFoundMapper::GetNameForFindingsFound(m_findingsFound)) << "&";
  }
