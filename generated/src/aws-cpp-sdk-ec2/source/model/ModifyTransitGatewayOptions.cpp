...
ModifyTransitGatewayOptions::ModifyTransitGatewayOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
ModifyTransitGatewayOptions& ModifyTransitGatewayOptions::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!addTransitGatewayCidrBlocksNode.IsNull()) {
      ...
      m_addTransitGatewayCidrBlocksHasBeenSet = !addTransitGatewayCidrBlocksMember.IsNull();
    ...
    if (!removeTransitGatewayCidrBlocksNode.IsNull()) {
      ...
      m_removeTransitGatewayCidrBlocksHasBeenSet = !removeTransitGatewayCidrBlocksMember.IsNull();
    ...
    if (!vpnEcmpSupportNode.IsNull()) {
      m_vpnEcmpSupport = VpnEcmpSupportValueMapper::GetVpnEcmpSupportValueForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(vpnEcmpSupportNode.GetText()).c_str()));
      m_vpnEcmpSupportHasBeenSet = true;
    }
    XmlNode dnsSupportNode = resultNode.FirstChild("DnsSupport");
    if (!dnsSupportNode.IsNull()) {
      m_dnsSupport = DnsSupportValueMapper::GetDnsSupportValueForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(dnsSupportNode.GetText()).c_str()));
    ...
    if (!securityGroupReferencingSupportNode.IsNull()) {
      m_securityGroupReferencingSupport = SecurityGroupReferencingSupportValueMapper::GetSecurityGroupReferencingSupportValueForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(securityGroupReferencingSupportNode.GetText()).c_str()));
    ...
    if (!autoAcceptSharedAttachmentsNode.IsNull()) {
      m_autoAcceptSharedAttachments = AutoAcceptSharedAttachmentsValueMapper::GetAutoAcceptSharedAttachmentsValueForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(autoAcceptSharedAttachmentsNode.GetText()).c_str()));
    ...
    if (!defaultRouteTableAssociationNode.IsNull()) {
      m_defaultRouteTableAssociation = DefaultRouteTableAssociationValueMapper::GetDefaultRouteTableAssociationValueForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(defaultRouteTableAssociationNode.GetText()).c_str()));
    ...
    if (!defaultRouteTablePropagationNode.IsNull()) {
      m_defaultRouteTablePropagation = DefaultRouteTablePropagationValueMapper::GetDefaultRouteTablePropagationValueForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(defaultRouteTablePropagationNode.GetText()).c_str()));
    ...
    if (!amazonSideAsnNode.IsNull()) {
      m_amazonSideAsn = StringUtils::ConvertToInt64(
...
void ModifyTransitGatewayOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_addTransitGatewayCidrBlocksHasBeenSet) {
    ...
    for (auto& item : m_addTransitGatewayCidrBlocks) {
      oStream << location << index << locationValue << ".AddTransitGatewayCidrBlocks." << addTransitGatewayCidrBlocksIdx++ << "="
  ...
  if (m_removeTransitGatewayCidrBlocksHasBeenSet) {
    ...
    for (auto& item : m_removeTransitGatewayCidrBlocks) {
      oStream << location << index << locationValue << ".RemoveTransitGatewayCidrBlocks." << removeTransitGatewayCidrBlocksIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
  ...
  if (m_vpnEcmpSupportHasBeenSet) {
    oStream << location << index << locationValue
            << ".VpnEcmpSupport=" << StringUtils::URLEncode(VpnEcmpSupportValueMapper::GetNameForVpnEcmpSupportValue(m_vpnEcmpSupport))
            << "&";
  }

  if (m_dnsSupportHasBeenSet) {
    oStream << location << index << locationValue
            << ".DnsSupport=" << StringUtils::URLEncode(DnsSupportValueMapper::GetNameForDnsSupportValue(m_dnsSupport)) << "&";
  }

  if (m_securityGroupReferencingSupportHasBeenSet) {
    oStream << location << index << locationValue << ".SecurityGroupReferencingSupport="
            << StringUtils::URLEncode(SecurityGroupReferencingSupportValueMapper::GetNameForSecurityGroupReferencingSupportValue(
                   m_securityGroupReferencingSupport))
            << "&";
  }

  if (m_autoAcceptSharedAttachmentsHasBeenSet) {
    oStream << location << index << locationValue << ".AutoAcceptSharedAttachments="
            << StringUtils::URLEncode(
                   AutoAcceptSharedAttachmentsValueMapper::GetNameForAutoAcceptSharedAttachmentsValue(m_autoAcceptSharedAttachments))
            << "&";
  }

  if (m_defaultRouteTableAssociationHasBeenSet) {
    oStream << location << index << locationValue << ".DefaultRouteTableAssociation="
            << StringUtils::URLEncode(
                   DefaultRouteTableAssociationValueMapper::GetNameForDefaultRouteTableAssociationValue(m_defaultRouteTableAssociation))
            << "&";
  }

  if (m_associationDefaultRouteTableIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".AssociationDefaultRouteTableId=" << StringUtils::URLEncode(m_associationDefaultRouteTableId.c_str()) << "&";
  }

  if (m_defaultRouteTablePropagationHasBeenSet) {
    oStream << location << index << locationValue << ".DefaultRouteTablePropagation="
            << StringUtils::URLEncode(
                   DefaultRouteTablePropagationValueMapper::GetNameForDefaultRouteTablePropagationValue(m_defaultRouteTablePropagation))
            << "&";
  }

  if (m_propagationDefaultRouteTableIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".PropagationDefaultRouteTableId=" << StringUtils::URLEncode(m_propagationDefaultRouteTableId.c_str()) << "&";
  }
...
void ModifyTransitGatewayOptions::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_addTransitGatewayCidrBlocksHasBeenSet) {
    unsigned addTransitGatewayCidrBlocksIdx = 1;
    for (auto& item : m_addTransitGatewayCidrBlocks) {
      oStream << location << ".AddTransitGatewayCidrBlocks." << addTransitGatewayCidrBlocksIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
  if (m_removeTransitGatewayCidrBlocksHasBeenSet) {
    unsigned removeTransitGatewayCidrBlocksIdx = 1;
    for (auto& item : m_removeTransitGatewayCidrBlocks) {
      oStream << location << ".RemoveTransitGatewayCidrBlocks." << removeTransitGatewayCidrBlocksIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
  if (m_vpnEcmpSupportHasBeenSet) {
  ...
  if (m_securityGroupReferencingSupportHasBeenSet) {
    oStream << location << ".SecurityGroupReferencingSupport="
            << StringUtils::URLEncode(SecurityGroupReferencingSupportValueMapper::GetNameForSecurityGroupReferencingSupportValue(
                   m_securityGroupReferencingSupport))
            << "&";
  }
  if (m_autoAcceptSharedAttachmentsHasBeenSet) {
    oStream << location << ".AutoAcceptSharedAttachments="
            << StringUtils::URLEncode(
                   AutoAcceptSharedAttachmentsValueMapper::GetNameForAutoAcceptSharedAttachmentsValue(m_autoAcceptSharedAttachments))
            << "&";
  }
  if (m_defaultRouteTableAssociationHasBeenSet) {
    oStream << location << ".DefaultRouteTableAssociation="
            << StringUtils::URLEncode(
                   DefaultRouteTableAssociationValueMapper::GetNameForDefaultRouteTableAssociationValue(m_defaultRouteTableAssociation))
            << "&";
  }
  ...
  if (m_defaultRouteTablePropagationHasBeenSet) {
    oStream << location << ".DefaultRouteTablePropagation="
            << StringUtils::URLEncode(
                   DefaultRouteTablePropagationValueMapper::GetNameForDefaultRouteTablePropagationValue(m_defaultRouteTablePropagation))
            << "&";
  }
