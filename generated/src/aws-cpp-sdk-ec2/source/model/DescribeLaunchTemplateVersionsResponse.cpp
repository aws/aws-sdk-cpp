...
DescribeLaunchTemplateVersionsResponse& DescribeLaunchTemplateVersionsResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!launchTemplateVersionsNode.IsNull()) {
      ...
      m_launchTemplateVersionsHasBeenSet = !launchTemplateVersionsMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DescribeLaunchTemplateVersionsResponse",
