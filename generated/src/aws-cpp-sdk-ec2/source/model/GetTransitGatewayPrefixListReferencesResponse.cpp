...
GetTransitGatewayPrefixListReferencesResponse& GetTransitGatewayPrefixListReferencesResponse::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!transitGatewayPrefixListReferencesNode.IsNull()) {
      ...
      m_transitGatewayPrefixListReferencesHasBeenSet = !transitGatewayPrefixListReferencesMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::GetTransitGatewayPrefixListReferencesResponse",
