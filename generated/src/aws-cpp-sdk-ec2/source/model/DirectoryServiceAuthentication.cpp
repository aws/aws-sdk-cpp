...
DirectoryServiceAuthentication::DirectoryServiceAuthentication(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DirectoryServiceAuthentication::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
