...
PeeringConnectionOptions::PeeringConnectionOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void PeeringConnectionOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
