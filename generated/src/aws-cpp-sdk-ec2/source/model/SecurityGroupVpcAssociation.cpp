...
SecurityGroupVpcAssociation::SecurityGroupVpcAssociation(const XmlNode& xmlNode) { *this = xmlNode; }
...
void SecurityGroupVpcAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue << ".State="
            << StringUtils::URLEncode(SecurityGroupVpcAssociationStateMapper::GetNameForSecurityGroupVpcAssociationState(m_state)) << "&";
  }
