...
ClientRouteEnforcementOptions::ClientRouteEnforcementOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ClientRouteEnforcementOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
