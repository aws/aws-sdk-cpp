...
ClientRouteEnforcementOptions::ClientRouteEnforcementOptions(const XmlNode& xmlNode)
{
  *this = xmlNode;
}

ClientRouteEnforcementOptions& ClientRouteEnforcementOptions::operator =(const XmlNode& xmlNode)
{
...
void ClientRouteEnforcementOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void ClientRouteEnforcementOptions::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_enforcedHasBeenSet)
  {
