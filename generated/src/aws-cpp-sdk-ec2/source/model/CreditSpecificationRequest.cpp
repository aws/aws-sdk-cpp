...
CreditSpecificationRequest::CreditSpecificationRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void CreditSpecificationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
