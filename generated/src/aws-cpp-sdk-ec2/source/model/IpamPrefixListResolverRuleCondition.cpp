...
IpamPrefixListResolverRuleCondition::IpamPrefixListResolverRuleCondition(const XmlNode& xmlNode) { *this = xmlNode; }

IpamPrefixListResolverRuleCondition& IpamPrefixListResolverRuleCondition::operator=(const XmlNode& xmlNode) {
...
void IpamPrefixListResolverRuleCondition::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void IpamPrefixListResolverRuleCondition::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_operationHasBeenSet) {
