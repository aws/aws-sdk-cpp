...
InternetGatewayAttachment::InternetGatewayAttachment(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InternetGatewayAttachment::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
