...
NetworkInterface& NetworkInterface::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!interfaceTypeNode.IsNull()) {
      m_interfaceType = NetworkInterfaceTypeMapper::GetNetworkInterfaceTypeForName(
    ...
    if (!requesterManagedNode.IsNull()) {
      m_requesterManaged = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(requesterManagedNode.GetText()).c_str()).c_str());
    ...
    if (!statusNode.IsNull()) {
      m_status = NetworkInterfaceStatusMapper::GetNetworkInterfaceStatusForName(
    ...
    if (!denyAllIgwTrafficNode.IsNull()) {
      m_denyAllIgwTraffic = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(denyAllIgwTrafficNode.GetText()).c_str()).c_str());
...
void NetworkInterface::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_interfaceTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".InterfaceType=" << StringUtils::URLEncode(NetworkInterfaceTypeMapper::GetNameForNetworkInterfaceType(m_interfaceType))
            << "&";
  }
  ...
  if (m_statusHasBeenSet) {
    oStream << location << index << locationValue
            << ".Status=" << StringUtils::URLEncode(NetworkInterfaceStatusMapper::GetNameForNetworkInterfaceStatus(m_status)) << "&";
  }
  ...
  if (m_associatedSubnetsHasBeenSet) {
    ...
    for (auto& item : m_associatedSubnets) {
      oStream << location << index << locationValue << ".AssociatedSubnetSet." << associatedSubnetsIdx++ << "="
