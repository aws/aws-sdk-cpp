...
GetTransitGatewayPolicyTableEntriesResponse& GetTransitGatewayPolicyTableEntriesResponse::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!transitGatewayPolicyTableEntriesNode.IsNull()) {
      ...
      m_transitGatewayPolicyTableEntriesHasBeenSet = !transitGatewayPolicyTableEntriesMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::GetTransitGatewayPolicyTableEntriesResponse",
