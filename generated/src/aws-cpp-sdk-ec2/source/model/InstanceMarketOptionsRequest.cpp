...
InstanceMarketOptionsRequest::InstanceMarketOptionsRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InstanceMarketOptionsRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
