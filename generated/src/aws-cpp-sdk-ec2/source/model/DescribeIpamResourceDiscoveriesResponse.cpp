...
DescribeIpamResourceDiscoveriesResponse& DescribeIpamResourceDiscoveriesResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!ipamResourceDiscoveriesNode.IsNull()) {
      ...
      m_ipamResourceDiscoveriesHasBeenSet = !ipamResourceDiscoveriesMember.IsNull();
      ...
      m_ipamResourceDiscoveriesHasBeenSet = true;
    }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DescribeIpamResourceDiscoveriesResponse",
