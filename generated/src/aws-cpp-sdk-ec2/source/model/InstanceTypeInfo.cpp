...
InstanceTypeInfo::InstanceTypeInfo(const XmlNode& xmlNode) { *this = xmlNode; }
...
InstanceTypeInfo& InstanceTypeInfo::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!currentGenerationNode.IsNull()) {
      m_currentGeneration = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(currentGenerationNode.GetText()).c_str()).c_str());
    ...
    if (!freeTierEligibleNode.IsNull()) {
      m_freeTierEligible = StringUtils::ConvertToBool(
    ...
    if (!supportedUsageClassesNode.IsNull()) {
      ...
      while (!supportedUsageClassesMember.IsNull()) {
        m_supportedUsageClasses.push_back(
            UsageClassTypeMapper::GetUsageClassTypeForName(StringUtils::Trim(supportedUsageClassesMember.GetText().c_str())));
    ...
    if (!supportedRootDeviceTypesNode.IsNull()) {
      ...
      while (!supportedRootDeviceTypesMember.IsNull()) {
        m_supportedRootDeviceTypes.push_back(
            RootDeviceTypeMapper::GetRootDeviceTypeForName(StringUtils::Trim(supportedRootDeviceTypesMember.GetText().c_str())));
    ...
    if (!supportedVirtualizationTypesNode.IsNull()) {
      ...
      while (!supportedVirtualizationTypesMember.IsNull()) {
        m_supportedVirtualizationTypes.push_back(VirtualizationTypeMapper::GetVirtualizationTypeForName(
            StringUtils::Trim(supportedVirtualizationTypesMember.GetText().c_str())));
    ...
    if (!bareMetalNode.IsNull()) {
      m_bareMetal =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(bareMetalNode.GetText()).c_str()).c_str());
      m_bareMetalHasBeenSet = true;
    }
    XmlNode hypervisorNode = resultNode.FirstChild("hypervisor");
    if (!hypervisorNode.IsNull()) {
      m_hypervisor = InstanceTypeHypervisorMapper::GetInstanceTypeHypervisorForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(hypervisorNode.GetText()).c_str()));
    ...
    if (!instanceStorageSupportedNode.IsNull()) {
      m_instanceStorageSupported = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(instanceStorageSupportedNode.GetText()).c_str()).c_str());
    ...
    if (!hibernationSupportedNode.IsNull()) {
      m_hibernationSupported = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(hibernationSupportedNode.GetText()).c_str()).c_str());
    ...
    if (!burstablePerformanceSupportedNode.IsNull()) {
      m_burstablePerformanceSupported = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(burstablePerformanceSupportedNode.GetText()).c_str()).c_str());
    ...
    if (!dedicatedHostsSupportedNode.IsNull()) {
      m_dedicatedHostsSupported = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(dedicatedHostsSupportedNode.GetText()).c_str()).c_str());
    ...
    if (!autoRecoverySupportedNode.IsNull()) {
      m_autoRecoverySupported = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(autoRecoverySupportedNode.GetText()).c_str()).c_str());
    ...
    if (!supportedBootModesNode.IsNull()) {
      ...
      while (!supportedBootModesMember.IsNull()) {
        m_supportedBootModes.push_back(
            BootModeTypeMapper::GetBootModeTypeForName(StringUtils::Trim(supportedBootModesMember.GetText().c_str())));
    ...
    if (!nitroEnclavesSupportNode.IsNull()) {
      m_nitroEnclavesSupport = NitroEnclavesSupportMapper::GetNitroEnclavesSupportForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(nitroEnclavesSupportNode.GetText()).c_str()));
    ...
    if (!nitroTpmSupportNode.IsNull()) {
      m_nitroTpmSupport = NitroTpmSupportMapper::GetNitroTpmSupportForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(nitroTpmSupportNode.GetText()).c_str()));
    ...
    if (!phcSupportNode.IsNull()) {
      m_phcSupport = PhcSupportMapper::GetPhcSupportForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(phcSupportNode.GetText()).c_str()));
    ...
    if (!rebootMigrationSupportNode.IsNull()) {
      m_rebootMigrationSupport = RebootMigrationSupportMapper::GetRebootMigrationSupportForName(
...
void InstanceTypeInfo::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_supportedUsageClassesHasBeenSet) {
    ...
    for (auto& item : m_supportedUsageClasses) {
      oStream << location << index << locationValue << ".SupportedUsageClasses." << supportedUsageClassesIdx++ << "="
              << StringUtils::URLEncode(UsageClassTypeMapper::GetNameForUsageClassType(item)) << "&";
    }
  }
  ...
  if (m_supportedRootDeviceTypesHasBeenSet) {
    ...
    for (auto& item : m_supportedRootDeviceTypes) {
      oStream << location << index << locationValue << ".SupportedRootDeviceTypes." << supportedRootDeviceTypesIdx++ << "="
              << StringUtils::URLEncode(RootDeviceTypeMapper::GetNameForRootDeviceType(item)) << "&";
    }
  }
  ...
  if (m_supportedVirtualizationTypesHasBeenSet) {
    ...
    for (auto& item : m_supportedVirtualizationTypes) {
      oStream << location << index << locationValue << ".SupportedVirtualizationTypes." << supportedVirtualizationTypesIdx++ << "="
  ...
  if (m_hypervisorHasBeenSet) {
    oStream << location << index << locationValue
            << ".Hypervisor=" << StringUtils::URLEncode(InstanceTypeHypervisorMapper::GetNameForInstanceTypeHypervisor(m_hypervisor))
            << "&";
  }
  ...
  if (m_supportedBootModesHasBeenSet) {
    ...
    for (auto& item : m_supportedBootModes) {
      oStream << location << index << locationValue << ".SupportedBootModes." << supportedBootModesIdx++ << "="
              << StringUtils::URLEncode(BootModeTypeMapper::GetNameForBootModeType(item)) << "&";
    }
  }

  if (m_nitroEnclavesSupportHasBeenSet) {
    oStream << location << index << locationValue << ".NitroEnclavesSupport="
            << StringUtils::URLEncode(NitroEnclavesSupportMapper::GetNameForNitroEnclavesSupport(m_nitroEnclavesSupport)) << "&";
  }

  if (m_nitroTpmSupportHasBeenSet) {
    oStream << location << index << locationValue
            << ".NitroTpmSupport=" << StringUtils::URLEncode(NitroTpmSupportMapper::GetNameForNitroTpmSupport(m_nitroTpmSupport)) << "&";
  }
  ...
  if (m_phcSupportHasBeenSet) {
    oStream << location << index << locationValue
            << ".PhcSupport=" << StringUtils::URLEncode(PhcSupportMapper::GetNameForPhcSupport(m_phcSupport)) << "&";
  }
...
void InstanceTypeInfo::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_supportedUsageClassesHasBeenSet) {
    unsigned supportedUsageClassesIdx = 1;
    for (auto& item : m_supportedUsageClasses) {
      oStream << location << ".SupportedUsageClasses." << supportedUsageClassesIdx++ << "="
              << StringUtils::URLEncode(UsageClassTypeMapper::GetNameForUsageClassType(item)) << "&";
    }
  }
  if (m_supportedRootDeviceTypesHasBeenSet) {
    unsigned supportedRootDeviceTypesIdx = 1;
    for (auto& item : m_supportedRootDeviceTypes) {
      oStream << location << ".SupportedRootDeviceTypes." << supportedRootDeviceTypesIdx++ << "="
              << StringUtils::URLEncode(RootDeviceTypeMapper::GetNameForRootDeviceType(item)) << "&";
    }
  }
  if (m_supportedVirtualizationTypesHasBeenSet) {
    unsigned supportedVirtualizationTypesIdx = 1;
    for (auto& item : m_supportedVirtualizationTypes) {
      oStream << location << ".SupportedVirtualizationTypes." << supportedVirtualizationTypesIdx++ << "="
              << StringUtils::URLEncode(VirtualizationTypeMapper::GetNameForVirtualizationType(item)) << "&";
    }
  }
  if (m_bareMetalHasBeenSet) {
  ...
  if (m_supportedBootModesHasBeenSet) {
    unsigned supportedBootModesIdx = 1;
    for (auto& item : m_supportedBootModes) {
      oStream << location << ".SupportedBootModes." << supportedBootModesIdx++ << "="
              << StringUtils::URLEncode(BootModeTypeMapper::GetNameForBootModeType(item)) << "&";
    }
  }
  if (m_nitroEnclavesSupportHasBeenSet) {
    oStream << location << ".NitroEnclavesSupport="
            << StringUtils::URLEncode(NitroEnclavesSupportMapper::GetNameForNitroEnclavesSupport(m_nitroEnclavesSupport)) << "&";
  }
  if (m_nitroTpmSupportHasBeenSet) {
    oStream << location
