...
Aws::String RejectTransitGatewayMulticastDomainAssociationsRequest::SerializePayload() const
{
  Aws::StringStream ss;
  ss << "Action=RejectTransitGatewayMulticastDomainAssociations&";
...
void  RejectTransitGatewayMulticastDomainAssociationsRequest::DumpBodyToUrl(Aws::Http::URI& uri ) const
{
