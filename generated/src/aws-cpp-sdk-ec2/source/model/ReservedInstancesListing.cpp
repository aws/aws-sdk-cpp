...
ReservedInstancesListing::ReservedInstancesListing(const XmlNode& xmlNode) { *this = xmlNode; }
...
ReservedInstancesListing& ReservedInstancesListing::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!statusNode.IsNull()) {
      m_status = ListingStatusMapper::GetListingStatusForName(
...
void ReservedInstancesListing::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_reservedInstancesListingIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".ReservedInstancesListingId=" << StringUtils::URLEncode(m_reservedInstancesListingId.c_str()) << "&";
  }

  if (m_statusHasBeenSet) {
    oStream << location << index << locationValue
            << ".Status=" << StringUtils::URLEncode(ListingStatusMapper::GetNameForListingStatus(m_status)) << "&";
  }
