...
ReservedInstanceLimitPrice::ReservedInstanceLimitPrice(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ReservedInstanceLimitPrice::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
