...
InstanceCreditSpecificationRequest::InstanceCreditSpecificationRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InstanceCreditSpecificationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
