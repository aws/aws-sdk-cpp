...
Snapshot::Snapshot(const XmlNode& xmlNode) { *this = xmlNode; }
...
Snapshot& Snapshot::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!storageTierNode.IsNull()) {
      m_storageTier = StorageTierMapper::GetStorageTierForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(storageTierNode.GetText()).c_str()));
    ...
    if (!restoreExpiryTimeNode.IsNull()) {
      m_restoreExpiryTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(restoreExpiryTimeNode.GetText()).c_str()).c_str(),
    ...
    if (!transferTypeNode.IsNull()) {
      m_transferType = TransferTypeMapper::GetTransferTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(transferTypeNode.GetText()).c_str()));
    ...
    if (!completionDurationMinutesNode.IsNull()) {
      m_completionDurationMinutes = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(completionDurationMinutesNode.GetText()).c_str()).c_str());
    ...
    if (!completionTimeNode.IsNull()) {
      m_completionTime = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(completionTimeNode.GetText()).c_str()).c_str(),
                                  Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!stateNode.IsNull()) {
      m_state = SnapshotStateMapper::GetSnapshotStateForName(
...
void Snapshot::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_storageTierHasBeenSet) {
    oStream << location << index << locationValue
            << ".StorageTier=" << StringUtils::URLEncode(StorageTierMapper::GetNameForStorageTier(m_storageTier)) << "&";
  }

  if (m_restoreExpiryTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".RestoreExpiryTime=" << StringUtils::URLEncode(m_restoreExpiryTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }
  ...
  if (m_transferTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".TransferType=" << StringUtils::URLEncode(TransferTypeMapper::GetNameForTransferType(m_transferType)) << "&";
  }
  ...
  if (m_completionTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".CompletionTime=" << StringUtils::URLEncode(m_completionTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(SnapshotStateMapper::GetNameForSnapshotState(m_state)) << "&";
  }
