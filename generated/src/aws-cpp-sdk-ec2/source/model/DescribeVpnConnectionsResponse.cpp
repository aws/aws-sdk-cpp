...
DescribeVpnConnectionsResponse::DescribeVpnConnectionsResponse(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeVpnConnectionsResponse& DescribeVpnConnectionsResponse::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!vpnConnectionsNode.IsNull()) {
      ...
      m_vpnConnectionsHasBeenSet = !vpnConnectionsMember.IsNull();
      ...
      m_vpnConnectionsHasBeenSet = true;
    }
  }
