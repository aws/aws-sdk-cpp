...
AthenaIntegration::AthenaIntegration(const XmlNode& xmlNode) { *this = xmlNode; }
...
AthenaIntegration& AthenaIntegration::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!partitionLoadFrequencyNode.IsNull()) {
      m_partitionLoadFrequency = PartitionLoadFrequencyMapper::GetPartitionLoadFrequencyForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(partitionLoadFrequencyNode.GetText()).c_str()));
    ...
    if (!partitionStartDateNode.IsNull()) {
      m_partitionStartDate =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(partitionStartDateNode.GetText()).c_str()).c_str(),
    ...
    if (!partitionEndDateNode.IsNull()) {
      m_partitionEndDate =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(partitionEndDateNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
...
void AthenaIntegration::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  if (m_integrationResultS3DestinationArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".IntegrationResultS3DestinationArn=" << StringUtils::URLEncode(m_integrationResultS3DestinationArn.c_str()) << "&";
  }

  if (m_partitionLoadFrequencyHasBeenSet) {
    oStream << location << index << locationValue << ".PartitionLoadFrequency="
            << StringUtils::URLEncode(PartitionLoadFrequencyMapper::GetNameForPartitionLoadFrequency(m_partitionLoadFrequency)) << "&";
  }

  if (m_partitionStartDateHasBeenSet) {
    oStream << location << index << locationValue
            << ".PartitionStartDate=" << StringUtils::URLEncode(m_partitionStartDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }

  if (m_partitionEndDateHasBeenSet) {
    oStream << location << index << locationValue
            << ".PartitionEndDate=" << StringUtils::URLEncode(m_partitionEndDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }
}
...
void AthenaIntegration::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_partitionLoadFrequencyHasBeenSet) {
    oStream << location << ".PartitionLoadFrequency="
            << StringUtils::URLEncode(PartitionLoadFrequencyMapper::GetNameForPartitionLoadFrequency(m_partitionLoadFrequency)) << "&";
  }
  if (m_partitionStartDateHasBeenSet) {
    oStream << location
