...
EnableFastSnapshotRestoreStateErrorItem::EnableFastSnapshotRestoreStateErrorItem(const XmlNode& xmlNode) { *this = xmlNode; }

EnableFastSnapshotRestoreStateErrorItem& EnableFastSnapshotRestoreStateErrorItem::operator=(const XmlNode& xmlNode) {
...
void EnableFastSnapshotRestoreStateErrorItem::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
