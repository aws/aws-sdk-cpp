...
DeleteVpcEndpointsResponse::DeleteVpcEndpointsResponse(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }

DeleteVpcEndpointsResponse& DeleteVpcEndpointsResponse::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  const XmlDocument& xmlDocument = result.GetPayload();
  XmlNode rootNode = xmlDocument.GetRootElement();
  XmlNode resultNode = rootNode;
  if (!rootNode.IsNull() && (rootNode.GetName() != "DeleteVpcEndpointsResponse")) {
    resultNode = rootNode.FirstChild("DeleteVpcEndpointsResponse");
  }
