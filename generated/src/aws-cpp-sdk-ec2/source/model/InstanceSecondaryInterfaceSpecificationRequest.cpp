...
InstanceSecondaryInterfaceSpecificationRequest::InstanceSecondaryInterfaceSpecificationRequest(const XmlNode& xmlNode) { *this = xmlNode; }

InstanceSecondaryInterfaceSpecificationRequest& InstanceSecondaryInterfaceSpecificationRequest::operator=(const XmlNode& xmlNode) {
...
void InstanceSecondaryInterfaceSpecificationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void InstanceSecondaryInterfaceSpecificationRequest::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_deleteOnTerminationHasBeenSet) {
