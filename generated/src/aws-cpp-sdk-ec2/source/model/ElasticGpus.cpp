...
ElasticGpus::ElasticGpus(const XmlNode& xmlNode) { *this = xmlNode; }
...
ElasticGpus& ElasticGpus::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!elasticGpuStateNode.IsNull()) {
      m_elasticGpuState = ElasticGpuStateMapper::GetElasticGpuStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(elasticGpuStateNode.GetText()).c_str()));
...
void ElasticGpus::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_elasticGpuStateHasBeenSet) {
    oStream << location << index << locationValue
            << ".ElasticGpuState=" << StringUtils::URLEncode(ElasticGpuStateMapper::GetNameForElasticGpuState(m_elasticGpuState)) << "&";
  }
