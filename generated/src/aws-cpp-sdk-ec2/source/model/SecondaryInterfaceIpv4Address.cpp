...
SecondaryInterfaceIpv4Address::SecondaryInterfaceIpv4Address(const XmlNode& xmlNode) { *this = xmlNode; }

SecondaryInterfaceIpv4Address& SecondaryInterfaceIpv4Address::operator=(const XmlNode& xmlNode) {
...
void SecondaryInterfaceIpv4Address::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void SecondaryInterfaceIpv4Address::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_privateIpAddressHasBeenSet) {
