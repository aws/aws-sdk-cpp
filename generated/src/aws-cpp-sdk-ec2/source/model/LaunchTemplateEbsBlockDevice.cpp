...
LaunchTemplateEbsBlockDevice::LaunchTemplateEbsBlockDevice(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LaunchTemplateEbsBlockDevice::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
