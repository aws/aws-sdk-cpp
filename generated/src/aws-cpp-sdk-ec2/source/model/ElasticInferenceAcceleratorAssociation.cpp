...
ElasticInferenceAcceleratorAssociation::ElasticInferenceAcceleratorAssociation(const XmlNode& xmlNode) { *this = xmlNode; }
...
ElasticInferenceAcceleratorAssociation& ElasticInferenceAcceleratorAssociation::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!elasticInferenceAcceleratorAssociationIdNode.IsNull()) {
      m_elasticInferenceAcceleratorAssociationId =
          Aws::Utils::Xml::DecodeEscapedXmlText(elasticInferenceAcceleratorAssociationIdNode.GetText());
    ...
    if (!elasticInferenceAcceleratorAssociationStateNode.IsNull()) {
      m_elasticInferenceAcceleratorAssociationState =
          Aws::Utils::Xml::DecodeEscapedXmlText(elasticInferenceAcceleratorAssociationStateNode.GetText());
    ...
    if (!elasticInferenceAcceleratorAssociationTimeNode.IsNull()) {
      m_elasticInferenceAcceleratorAssociationTime = DateTime(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(elasticInferenceAcceleratorAssociationTimeNode.GetText()).c_str())
              .c_str(),
...
void ElasticInferenceAcceleratorAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                            const char* locationValue) const {
  if (m_elasticInferenceAcceleratorArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".ElasticInferenceAcceleratorArn=" << StringUtils::URLEncode(m_elasticInferenceAcceleratorArn.c_str()) << "&";
  }

  if (m_elasticInferenceAcceleratorAssociationIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".ElasticInferenceAcceleratorAssociationId=" << StringUtils::URLEncode(m_elasticInferenceAcceleratorAssociationId.c_str())
            << "&";
  }

  if (m_elasticInferenceAcceleratorAssociationStateHasBeenSet) {
    oStream << location << index << locationValue << ".ElasticInferenceAcceleratorAssociationState="
            << StringUtils::URLEncode(m_elasticInferenceAcceleratorAssociationState.c_str()) << "&";
  }

  if (m_elasticInferenceAcceleratorAssociationTimeHasBeenSet) {
    oStream << location << index << locationValue << ".ElasticInferenceAcceleratorAssociationTime="
            << StringUtils::URLEncode(m_elasticInferenceAcceleratorAssociationTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }
}
...
void ElasticInferenceAcceleratorAssociation::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_elasticInferenceAcceleratorAssociationStateHasBeenSet) {
    oStream << location << ".ElasticInferenceAcceleratorAssociationState="
            << StringUtils::URLEncode(m_elasticInferenceAcceleratorAssociationState.c_str()) << "&";
  }
  if (m_elasticInferenceAcceleratorAssociationTimeHasBeenSet) {
    oStream << location << ".ElasticInferenceAcceleratorAssociationTime="
            << StringUtils::URLEncode(m_elasticInferenceAcceleratorAssociationTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }
}
