...
ModifyIpamResourceCidrResponse::ModifyIpamResourceCidrResponse(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
ModifyIpamResourceCidrResponse& ModifyIpamResourceCidrResponse::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!ipamResourceCidrNode.IsNull()) {
      ...
      m_ipamResourceCidrHasBeenSet = true;
    }
  }
