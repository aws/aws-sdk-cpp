...
PublicIpv4Pool::PublicIpv4Pool(const XmlNode& xmlNode) { *this = xmlNode; }
...
PublicIpv4Pool& PublicIpv4Pool::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!totalAddressCountNode.IsNull()) {
      m_totalAddressCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(totalAddressCountNode.GetText()).c_str()).c_str());
    ...
    if (!totalAvailableAddressCountNode.IsNull()) {
      m_totalAvailableAddressCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(totalAvailableAddressCountNode.GetText()).c_str()).c_str());
