...
EnableAllowedImagesSettingsResponse& EnableAllowedImagesSettingsResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!allowedImagesSettingsStateNode.IsNull()) {
      m_allowedImagesSettingsState = AllowedImagesSettingsEnabledStateMapper::GetAllowedImagesSettingsEnabledStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(allowedImagesSettingsStateNode.GetText()).c_str()));
