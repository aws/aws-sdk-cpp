...
Aws::String DeleteTransitGatewayPolicyTableEntryRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=DeleteTransitGatewayPolicyTableEntry&";
...
void DeleteTransitGatewayPolicyTableEntryRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
