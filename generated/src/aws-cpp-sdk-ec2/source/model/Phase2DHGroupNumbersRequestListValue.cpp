...
Phase2DHGroupNumbersRequestListValue::Phase2DHGroupNumbersRequestListValue(const XmlNode& xmlNode) { *this = xmlNode; }
...
void Phase2DHGroupNumbersRequestListValue::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
