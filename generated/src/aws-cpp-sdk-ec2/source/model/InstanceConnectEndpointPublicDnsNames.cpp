...
InstanceConnectEndpointPublicDnsNames::InstanceConnectEndpointPublicDnsNames(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InstanceConnectEndpointPublicDnsNames::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
