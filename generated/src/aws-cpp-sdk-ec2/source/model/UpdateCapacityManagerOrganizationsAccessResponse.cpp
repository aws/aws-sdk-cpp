...
UpdateCapacityManagerOrganizationsAccessResponse::UpdateCapacityManagerOrganizationsAccessResponse(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

UpdateCapacityManagerOrganizationsAccessResponse& UpdateCapacityManagerOrganizationsAccessResponse::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::UpdateCapacityManagerOrganizationsAccessResponse", "x-amzn-request-id: " << m_responseMetadata.GetRequestId() );
  }
  return *this;
}
