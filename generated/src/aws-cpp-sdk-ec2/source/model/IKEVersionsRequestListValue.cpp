...
IKEVersionsRequestListValue::IKEVersionsRequestListValue(const XmlNode& xmlNode) { *this = xmlNode; }
...
void IKEVersionsRequestListValue::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
