...
SecondaryNetworkIpv4CidrBlockAssociation::SecondaryNetworkIpv4CidrBlockAssociation(const XmlNode& xmlNode) { *this = xmlNode; }

SecondaryNetworkIpv4CidrBlockAssociation& SecondaryNetworkIpv4CidrBlockAssociation::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = SecondaryNetworkCidrBlockAssociationStateMapper::GetSecondaryNetworkCidrBlockAssociationStateForName(
...
void SecondaryNetworkIpv4CidrBlockAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue << ".State="
            << StringUtils::URLEncode(
                   SecondaryNetworkCidrBlockAssociationStateMapper::GetNameForSecondaryNetworkCidrBlockAssociationState(m_state))
            << "&";
  }
...
void SecondaryNetworkIpv4CidrBlockAssociation::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_associationIdHasBeenSet) {
