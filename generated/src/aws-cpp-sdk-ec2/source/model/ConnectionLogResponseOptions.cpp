...
ConnectionLogResponseOptions::ConnectionLogResponseOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ConnectionLogResponseOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
