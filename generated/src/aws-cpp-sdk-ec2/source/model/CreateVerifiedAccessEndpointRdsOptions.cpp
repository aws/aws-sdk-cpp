...
CreateVerifiedAccessEndpointRdsOptions::CreateVerifiedAccessEndpointRdsOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void CreateVerifiedAccessEndpointRdsOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
