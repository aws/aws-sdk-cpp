...
FleetSpotMaintenanceStrategies::FleetSpotMaintenanceStrategies(const XmlNode& xmlNode) { *this = xmlNode; }
...
void FleetSpotMaintenanceStrategies::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
