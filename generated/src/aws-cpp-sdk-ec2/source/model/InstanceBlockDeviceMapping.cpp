...
InstanceBlockDeviceMapping::InstanceBlockDeviceMapping(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InstanceBlockDeviceMapping::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
