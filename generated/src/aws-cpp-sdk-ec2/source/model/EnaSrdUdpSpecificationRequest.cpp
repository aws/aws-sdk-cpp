...
EnaSrdUdpSpecificationRequest::EnaSrdUdpSpecificationRequest() : 
    m_enaSrdUdpEnabled(false),
    m_enaSrdUdpEnabledHasBeenSet(false)
{
}

EnaSrdUdpSpecificationRequest::EnaSrdUdpSpecificationRequest(const XmlNode& xmlNode) : 
    m_enaSrdUdpEnabled(false),
    m_enaSrdUdpEnabledHasBeenSet(false)
{
  *this = xmlNode;
...
EnaSrdUdpSpecificationRequest& EnaSrdUdpSpecificationRequest::operator =(const XmlNode& xmlNode)
{
...
void EnaSrdUdpSpecificationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void EnaSrdUdpSpecificationRequest::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_enaSrdUdpEnabledHasBeenSet)
  {
