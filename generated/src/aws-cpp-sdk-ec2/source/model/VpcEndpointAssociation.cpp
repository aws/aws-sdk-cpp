...
VpcEndpointAssociation::VpcEndpointAssociation(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VpcEndpointAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_associatedResourceAccessibilityHasBeenSet) {
    oStream << location << index << locationValue
            << ".AssociatedResourceAccessibility=" << StringUtils::URLEncode(m_associatedResourceAccessibility.c_str()) << "&";
  }
  ...
  if (m_resourceConfigurationGroupArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".ResourceConfigurationGroupArn=" << StringUtils::URLEncode(m_resourceConfigurationGroupArn.c_str()) << "&";
  }
