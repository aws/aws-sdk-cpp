...
EbsCardInfo::EbsCardInfo(const XmlNode& xmlNode) { *this = xmlNode; }

EbsCardInfo& EbsCardInfo::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!baselineBandwidthInMbpsNode.IsNull()) {
      m_baselineBandwidthInMbps = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(baselineBandwidthInMbpsNode.GetText()).c_str()).c_str());
    ...
    if (!baselineThroughputInMBpsNode.IsNull()) {
      m_baselineThroughputInMBps = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(baselineThroughputInMBpsNode.GetText()).c_str()).c_str());
    ...
    if (!baselineIopsNode.IsNull()) {
      m_baselineIops =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(baselineIopsNode.GetText()).c_str()).c_str());
    ...
    if (!maximumBandwidthInMbpsNode.IsNull()) {
      m_maximumBandwidthInMbps = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maximumBandwidthInMbpsNode.GetText()).c_str()).c_str());
    ...
    if (!maximumThroughputInMBpsNode.IsNull()) {
      m_maximumThroughputInMBps = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maximumThroughputInMBpsNode.GetText()).c_str()).c_str());
    ...
    if (!maximumIopsNode.IsNull()) {
      m_maximumIops =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maximumIopsNode.GetText()).c_str()).c_str());
...
void EbsCardInfo::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
...
void EbsCardInfo::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_ebsCardIndexHasBeenSet) {
