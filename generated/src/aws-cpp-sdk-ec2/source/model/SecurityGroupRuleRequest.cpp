...
SecurityGroupRuleRequest::SecurityGroupRuleRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void SecurityGroupRuleRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
