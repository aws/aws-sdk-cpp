...
ServiceConfiguration::ServiceConfiguration(const XmlNode& xmlNode) { *this = xmlNode; }
...
ServiceConfiguration& ServiceConfiguration::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!serviceStateNode.IsNull()) {
      m_serviceState = ServiceStateMapper::GetServiceStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(serviceStateNode.GetText()).c_str()));
    ...
    if (!acceptanceRequiredNode.IsNull()) {
      m_acceptanceRequired = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(acceptanceRequiredNode.GetText()).c_str()).c_str());
    ...
    if (!managesVpcEndpointsNode.IsNull()) {
      m_managesVpcEndpoints = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(managesVpcEndpointsNode.GetText()).c_str()).c_str());
    ...
    if (!supportedIpAddressTypesNode.IsNull()) {
      ...
      while (!supportedIpAddressTypesMember.IsNull()) {
        m_supportedIpAddressTypes.push_back(ServiceConnectivityTypeMapper::GetServiceConnectivityTypeForName(
            StringUtils::Trim(supportedIpAddressTypesMember.GetText().c_str())));
    ...
    if (!payerResponsibilityNode.IsNull()) {
      m_payerResponsibility = PayerResponsibilityMapper::GetPayerResponsibilityForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(payerResponsibilityNode.GetText()).c_str()));
    ...
    if (!remoteAccessEnabledNode.IsNull()) {
      m_remoteAccessEnabled = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(remoteAccessEnabledNode.GetText()).c_str()).c_str());
...
void ServiceConfiguration::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_serviceStateHasBeenSet) {
    oStream << location << index << locationValue
            << ".ServiceState=" << StringUtils::URLEncode(ServiceStateMapper::GetNameForServiceState(m_serviceState)) << "&";
  }
  ...
  if (m_networkLoadBalancerArnsHasBeenSet) {
    ...
    for (auto& item : m_networkLoadBalancerArns) {
      oStream << location << index << locationValue << ".NetworkLoadBalancerArnSet." << networkLoadBalancerArnsIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
  ...
  if (m_gatewayLoadBalancerArnsHasBeenSet) {
    ...
    for (auto& item : m_gatewayLoadBalancerArns) {
      oStream << location << index << locationValue << ".GatewayLoadBalancerArnSet." << gatewayLoadBalancerArnsIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
  ...
  if (m_supportedIpAddressTypesHasBeenSet) {
    ...
    for (auto& item : m_supportedIpAddressTypes) {
      oStream << location << index << locationValue << ".SupportedIpAddressTypeSet." << supportedIpAddressTypesIdx++ << "="
              << StringUtils::URLEncode(ServiceConnectivityTypeMapper::GetNameForServiceConnectivityType(item)) << "&";
    }
  }
  ...
  if (m_baseEndpointDnsNamesHasBeenSet) {
    ...
    for (auto& item : m_baseEndpointDnsNames) {
      oStream << location << index << locationValue << ".BaseEndpointDnsNameSet." << baseEndpointDnsNamesIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
  ...
  if (m_payerResponsibilityHasBeenSet) {
    oStream << location << index << locationValue << ".PayerResponsibility="
            << StringUtils::URLEncode(PayerResponsibilityMapper::GetNameForPayerResponsibility(m_payerResponsibility)) << "&";
  }
...
void ServiceConfiguration::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_supportedIpAddressTypesHasBeenSet) {
    unsigned supportedIpAddressTypesIdx = 1;
    for (auto& item : m_supportedIpAddressTypes) {
      oStream << location << ".SupportedIpAddressTypeSet." << supportedIpAddressTypesIdx++ << "="
              << StringUtils::URLEncode(ServiceConnectivityTypeMapper::GetNameForServiceConnectivityType(item)) << "&";
    }
  }
  if (m_baseEndpointDnsNamesHasBeenSet) {
  ...
  if (m_payerResponsibilityHasBeenSet) {
    oStream << location << ".PayerResponsibility="
            << StringUtils::URLEncode(PayerResponsibilityMapper::GetNameForPayerResponsibility(m_payerResponsibility)) << "&";
  }
  if (m_tagsHasBeenSet) {
    unsigned tagsIdx = 1;
