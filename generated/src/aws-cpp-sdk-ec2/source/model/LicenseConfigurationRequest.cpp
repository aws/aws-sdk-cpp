...
LicenseConfigurationRequest::LicenseConfigurationRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LicenseConfigurationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
