...
LaunchTemplateInstanceMarketOptions::LaunchTemplateInstanceMarketOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LaunchTemplateInstanceMarketOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
