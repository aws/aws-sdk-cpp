...
ModifyPublicIpDnsNameOptionsResponse& ModifyPublicIpDnsNameOptionsResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!successfulNode.IsNull()) {
      m_successful =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(successfulNode.GetText()).c_str()).c_str());
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::ModifyPublicIpDnsNameOptionsResponse",
