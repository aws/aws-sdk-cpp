...
Ipv4PrefixSpecificationRequest::Ipv4PrefixSpecificationRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void Ipv4PrefixSpecificationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
