...
Aws::String CreateNetworkInterfaceRequest::SerializePayload() const {
  ...
  if (m_interfaceTypeHasBeenSet) {
    ss << "InterfaceType="
       << StringUtils::URLEncode(NetworkInterfaceCreationTypeMapper::GetNameForNetworkInterfaceCreationType(m_interfaceType)) << "&";
  }
...
void CreateNetworkInterfaceRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
