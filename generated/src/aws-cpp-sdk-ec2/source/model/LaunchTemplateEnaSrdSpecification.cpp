...
LaunchTemplateEnaSrdSpecification::LaunchTemplateEnaSrdSpecification(const XmlNode& xmlNode) { *this = xmlNode; }

LaunchTemplateEnaSrdSpecification& LaunchTemplateEnaSrdSpecification::operator=(const XmlNode& xmlNode) {
...
void LaunchTemplateEnaSrdSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void LaunchTemplateEnaSrdSpecification::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_enaSrdEnabledHasBeenSet) {
