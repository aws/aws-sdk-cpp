...
RouteServerRoute::RouteServerRoute(const XmlNode& xmlNode) { *this = xmlNode; }
...
RouteServerRoute& RouteServerRoute::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!routeStatusNode.IsNull()) {
      m_routeStatus = RouteServerRouteStatusMapper::GetRouteServerRouteStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(routeStatusNode.GetText()).c_str()));
...
void RouteServerRoute::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_routeStatusHasBeenSet) {
    oStream << location << index << locationValue
            << ".RouteStatus=" << StringUtils::URLEncode(RouteServerRouteStatusMapper::GetNameForRouteServerRouteStatus(m_routeStatus))
            << "&";
  }
