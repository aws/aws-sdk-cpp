...
VolumeAttachment::VolumeAttachment(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VolumeAttachment::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(VolumeAttachmentStateMapper::GetNameForVolumeAttachmentState(m_state)) << "&";
  }
