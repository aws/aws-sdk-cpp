...
IamInstanceProfileAssociation::IamInstanceProfileAssociation(const XmlNode& xmlNode) { *this = xmlNode; }
...
IamInstanceProfileAssociation& IamInstanceProfileAssociation::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = IamInstanceProfileAssociationStateMapper::GetIamInstanceProfileAssociationStateForName(
...
void IamInstanceProfileAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue << ".State="
            << StringUtils::URLEncode(IamInstanceProfileAssociationStateMapper::GetNameForIamInstanceProfileAssociationState(m_state))
            << "&";
  }
