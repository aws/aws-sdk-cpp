...
InstanceEventWindowAssociationRequest::InstanceEventWindowAssociationRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void InstanceEventWindowAssociationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
