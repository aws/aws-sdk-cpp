...
ConnectionTrackingConfiguration::ConnectionTrackingConfiguration(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ConnectionTrackingConfiguration::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
