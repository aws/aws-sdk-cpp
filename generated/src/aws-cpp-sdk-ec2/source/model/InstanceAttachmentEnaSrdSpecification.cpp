...
InstanceAttachmentEnaSrdSpecification::InstanceAttachmentEnaSrdSpecification(const XmlNode& xmlNode) { *this = xmlNode; }

InstanceAttachmentEnaSrdSpecification& InstanceAttachmentEnaSrdSpecification::operator=(const XmlNode& xmlNode) {
...
void InstanceAttachmentEnaSrdSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void InstanceAttachmentEnaSrdSpecification::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_enaSrdEnabledHasBeenSet) {
