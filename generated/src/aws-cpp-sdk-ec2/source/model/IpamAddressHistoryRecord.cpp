...
IpamAddressHistoryRecord::IpamAddressHistoryRecord(const XmlNode& xmlNode) { *this = xmlNode; }
...
IpamAddressHistoryRecord& IpamAddressHistoryRecord::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!resourceTypeNode.IsNull()) {
      m_resourceType = IpamAddressHistoryResourceTypeMapper::GetIpamAddressHistoryResourceTypeForName(
    ...
    if (!resourceComplianceStatusNode.IsNull()) {
      m_resourceComplianceStatus = IpamComplianceStatusMapper::GetIpamComplianceStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(resourceComplianceStatusNode.GetText()).c_str()));
    ...
    if (!resourceOverlapStatusNode.IsNull()) {
      m_resourceOverlapStatus = IpamOverlapStatusMapper::GetIpamOverlapStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(resourceOverlapStatusNode.GetText()).c_str()));
    ...
    if (!sampledStartTimeNode.IsNull()) {
      m_sampledStartTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(sampledStartTimeNode.GetText()).c_str()).c_str(),
    ...
    if (!sampledEndTimeNode.IsNull()) {
      m_sampledEndTime = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(sampledEndTimeNode.GetText()).c_str()).c_str(),
                                  Aws::Utils::DateFormat::ISO_8601);
...
void IpamAddressHistoryRecord::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_resourceTypeHasBeenSet) {
    oStream << location << index << locationValue << ".ResourceType="
            << StringUtils::URLEncode(IpamAddressHistoryResourceTypeMapper::GetNameForIpamAddressHistoryResourceType(m_resourceType))
            << "&";
  }
  ...
  if (m_resourceComplianceStatusHasBeenSet) {
    oStream << location << index << locationValue << ".ResourceComplianceStatus="
            << StringUtils::URLEncode(IpamComplianceStatusMapper::GetNameForIpamComplianceStatus(m_resourceComplianceStatus)) << "&";
  }

  if (m_resourceOverlapStatusHasBeenSet) {
    oStream << location << index << locationValue << ".ResourceOverlapStatus="
            << StringUtils::URLEncode(IpamOverlapStatusMapper::GetNameForIpamOverlapStatus(m_resourceOverlapStatus)) << "&";
  }
  ...
  if (m_sampledStartTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".SampledStartTime=" << StringUtils::URLEncode(m_sampledStartTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }

  if (m_sampledEndTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".SampledEndTime=" << StringUtils::URLEncode(m_sampledEndTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
}
...
void IpamAddressHistoryRecord::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_resourceComplianceStatusHasBeenSet) {
    oStream << location << ".ResourceComplianceStatus="
            << StringUtils::URLEncode(IpamComplianceStatusMapper::GetNameForIpamComplianceStatus(m_resourceComplianceStatus)) << "&";
  }
  if (m_resourceOverlapStatusHasBeenSet) {
    oStream << location << ".ResourceOverlapStatus="
            << StringUtils::URLEncode(IpamOverlapStatusMapper::GetNameForIpamOverlapStatus(m_resourceOverlapStatus)) << "&";
  }
  if (m_vpcIdHasBeenSet) {
