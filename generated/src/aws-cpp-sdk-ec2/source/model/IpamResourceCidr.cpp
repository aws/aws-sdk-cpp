...
IpamResourceCidr::IpamResourceCidr(const XmlNode& xmlNode) { *this = xmlNode; }
...
IpamResourceCidr& IpamResourceCidr::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!complianceStatusNode.IsNull()) {
      m_complianceStatus = IpamComplianceStatusMapper::GetIpamComplianceStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(complianceStatusNode.GetText()).c_str()));
    ...
    if (!managementStateNode.IsNull()) {
      m_managementState = IpamManagementStateMapper::GetIpamManagementStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(managementStateNode.GetText()).c_str()));
      m_managementStateHasBeenSet = true;
    }
    XmlNode overlapStatusNode = resultNode.FirstChild("overlapStatus");
    if (!overlapStatusNode.IsNull()) {
      m_overlapStatus = IpamOverlapStatusMapper::GetIpamOverlapStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(overlapStatusNode.GetText()).c_str()));
...
void IpamResourceCidr::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_complianceStatusHasBeenSet) {
    oStream << location << index << locationValue << ".ComplianceStatus="
            << StringUtils::URLEncode(IpamComplianceStatusMapper::GetNameForIpamComplianceStatus(m_complianceStatus)) << "&";
  }

  if (m_managementStateHasBeenSet) {
    oStream << location << index << locationValue
            << ".ManagementState=" << StringUtils::URLEncode(IpamManagementStateMapper::GetNameForIpamManagementState(m_managementState))
            << "&";
  }

  if (m_overlapStatusHasBeenSet) {
    oStream << location << index << locationValue
            << ".OverlapStatus=" << StringUtils::URLEncode(IpamOverlapStatusMapper::GetNameForIpamOverlapStatus(m_overlapStatus)) << "&";
  }
...
void IpamResourceCidr::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_complianceStatusHasBeenSet) {
    oStream << location << ".ComplianceStatus="
            << StringUtils::URLEncode(IpamComplianceStatusMapper::GetNameForIpamComplianceStatus(m_complianceStatus)) << "&";
  }
  if (m_managementStateHasBeenSet) {
    oStream << location
