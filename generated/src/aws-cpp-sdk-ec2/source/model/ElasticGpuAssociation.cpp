...
ElasticGpuAssociation::ElasticGpuAssociation(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ElasticGpuAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_elasticGpuAssociationIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".ElasticGpuAssociationId=" << StringUtils::URLEncode(m_elasticGpuAssociationId.c_str()) << "&";
  }

  if (m_elasticGpuAssociationStateHasBeenSet) {
    oStream << location << index << locationValue
            << ".ElasticGpuAssociationState=" << StringUtils::URLEncode(m_elasticGpuAssociationState.c_str()) << "&";
  }

  if (m_elasticGpuAssociationTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".ElasticGpuAssociationTime=" << StringUtils::URLEncode(m_elasticGpuAssociationTime.c_str()) << "&";
  }
}
