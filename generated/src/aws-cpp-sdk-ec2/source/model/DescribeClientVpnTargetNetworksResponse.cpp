...
DescribeClientVpnTargetNetworksResponse& DescribeClientVpnTargetNetworksResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!clientVpnTargetNetworksNode.IsNull()) {
      ...
      m_clientVpnTargetNetworksHasBeenSet = !clientVpnTargetNetworksMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DescribeClientVpnTargetNetworksResponse",
