...
IpamDiscoveredAccount::IpamDiscoveredAccount(const XmlNode& xmlNode) { *this = xmlNode; }
...
IpamDiscoveredAccount& IpamDiscoveredAccount::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!lastAttemptedDiscoveryTimeNode.IsNull()) {
      m_lastAttemptedDiscoveryTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(lastAttemptedDiscoveryTimeNode.GetText()).c_str()).c_str(),
    ...
    if (!lastSuccessfulDiscoveryTimeNode.IsNull()) {
      m_lastSuccessfulDiscoveryTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(lastSuccessfulDiscoveryTimeNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
...
void IpamDiscoveredAccount::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_lastAttemptedDiscoveryTimeHasBeenSet) {
    oStream << location << index << locationValue << ".LastAttemptedDiscoveryTime="
            << StringUtils::URLEncode(m_lastAttemptedDiscoveryTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_lastSuccessfulDiscoveryTimeHasBeenSet) {
    oStream << location << index << locationValue << ".LastSuccessfulDiscoveryTime="
            << StringUtils::URLEncode(m_lastSuccessfulDiscoveryTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
...
void IpamDiscoveredAccount::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_lastAttemptedDiscoveryTimeHasBeenSet) {
    oStream << location << ".LastAttemptedDiscoveryTime="
            << StringUtils::URLEncode(m_lastAttemptedDiscoveryTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_lastSuccessfulDiscoveryTimeHasBeenSet) {
    oStream << location << ".LastSuccessfulDiscoveryTime="
            << StringUtils::URLEncode(m_lastSuccessfulDiscoveryTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_organizationalUnitIdHasBeenSet) {
