...
VolumeStatusAttachmentStatus::VolumeStatusAttachmentStatus(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VolumeStatusAttachmentStatus::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
