...
TransitGatewayPropagation::TransitGatewayPropagation(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TransitGatewayPropagation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
