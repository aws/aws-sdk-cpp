...
DisableImageBlockPublicAccessResponse& DisableImageBlockPublicAccessResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!imageBlockPublicAccessStateNode.IsNull()) {
      m_imageBlockPublicAccessState = ImageBlockPublicAccessDisabledStateMapper::GetImageBlockPublicAccessDisabledStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(imageBlockPublicAccessStateNode.GetText()).c_str()));
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DisableImageBlockPublicAccessResponse",
