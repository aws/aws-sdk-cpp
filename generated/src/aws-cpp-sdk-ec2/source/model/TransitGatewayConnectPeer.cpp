...
TransitGatewayConnectPeer::TransitGatewayConnectPeer(const XmlNode& xmlNode) { *this = xmlNode; }
...
TransitGatewayConnectPeer& TransitGatewayConnectPeer::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = TransitGatewayConnectPeerStateMapper::GetTransitGatewayConnectPeerStateForName(
...
void TransitGatewayConnectPeer::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_transitGatewayConnectPeerIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".TransitGatewayConnectPeerId=" << StringUtils::URLEncode(m_transitGatewayConnectPeerId.c_str()) << "&";
  }

  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(TransitGatewayConnectPeerStateMapper::GetNameForTransitGatewayConnectPeerState(m_state))
            << "&";
  }
