...
DescribeSpotDatafeedSubscriptionResponse& DescribeSpotDatafeedSubscriptionResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!spotDatafeedSubscriptionNode.IsNull()) {
      ...
      m_spotDatafeedSubscriptionHasBeenSet = true;
    }
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DescribeSpotDatafeedSubscriptionResponse",
