...
Address::Address(const XmlNode& xmlNode) { *this = xmlNode; }
...
Address& Address::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!serviceManagedNode.IsNull()) {
      m_serviceManaged = ServiceManagedMapper::GetServiceManagedForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(serviceManagedNode.GetText()).c_str()));
...
void Address::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_networkInterfaceOwnerIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".NetworkInterfaceOwnerId=" << StringUtils::URLEncode(m_networkInterfaceOwnerId.c_str()) << "&";
  }
  ...
  if (m_serviceManagedHasBeenSet) {
    oStream << location << index << locationValue
            << ".ServiceManaged=" << StringUtils::URLEncode(ServiceManagedMapper::GetNameForServiceManaged(m_serviceManaged)) << "&";
  }
