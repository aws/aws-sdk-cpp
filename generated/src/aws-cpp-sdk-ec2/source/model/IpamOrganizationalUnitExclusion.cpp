...
IpamOrganizationalUnitExclusion::IpamOrganizationalUnitExclusion() : 
    m_organizationsEntityPathHasBeenSet(false)
{
}

IpamOrganizationalUnitExclusion::IpamOrganizationalUnitExclusion(const XmlNode& xmlNode)
  : IpamOrganizationalUnitExclusion()
{
  *this = xmlNode;
}

IpamOrganizationalUnitExclusion& IpamOrganizationalUnitExclusion::operator =(const XmlNode& xmlNode)
{
...
void IpamOrganizationalUnitExclusion::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void IpamOrganizationalUnitExclusion::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_organizationsEntityPathHasBeenSet)
  {
