...
AccessScopeAnalysisFinding::AccessScopeAnalysisFinding(const XmlNode& xmlNode) { *this = xmlNode; }
...
void AccessScopeAnalysisFinding::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
