...
SpotMaintenanceStrategies::SpotMaintenanceStrategies(const XmlNode& xmlNode) { *this = xmlNode; }
...
void SpotMaintenanceStrategies::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
