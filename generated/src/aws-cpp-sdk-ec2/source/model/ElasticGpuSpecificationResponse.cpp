...
ElasticGpuSpecificationResponse::ElasticGpuSpecificationResponse(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ElasticGpuSpecificationResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
