...
BaselinePerformanceFactorsRequest::BaselinePerformanceFactorsRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void BaselinePerformanceFactorsRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
