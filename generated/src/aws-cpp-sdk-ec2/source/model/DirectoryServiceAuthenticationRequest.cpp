...
DirectoryServiceAuthenticationRequest::DirectoryServiceAuthenticationRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DirectoryServiceAuthenticationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
