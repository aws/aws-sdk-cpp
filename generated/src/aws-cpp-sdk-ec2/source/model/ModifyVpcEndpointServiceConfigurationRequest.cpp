...
Aws::String ModifyVpcEndpointServiceConfigurationRequest::SerializePayload() const {
  ...
  if (m_addNetworkLoadBalancerArnsHasBeenSet) {
    ...
    for (auto& item : m_addNetworkLoadBalancerArns) {
      ss << "AddNetworkLoadBalancerArn." << addNetworkLoadBalancerArnsCount << "=" << StringUtils::URLEncode(item.c_str()) << "&";
  ...
  if (m_removeNetworkLoadBalancerArnsHasBeenSet) {
    ...
    for (auto& item : m_removeNetworkLoadBalancerArns) {
      ss << "RemoveNetworkLoadBalancerArn." << removeNetworkLoadBalancerArnsCount << "=" << StringUtils::URLEncode(item.c_str()) << "&";
  ...
  if (m_addGatewayLoadBalancerArnsHasBeenSet) {
    ...
    for (auto& item : m_addGatewayLoadBalancerArns) {
      ss << "AddGatewayLoadBalancerArn." << addGatewayLoadBalancerArnsCount << "=" << StringUtils::URLEncode(item.c_str()) << "&";
  ...
  if (m_removeGatewayLoadBalancerArnsHasBeenSet) {
    ...
    for (auto& item : m_removeGatewayLoadBalancerArns) {
      ss << "RemoveGatewayLoadBalancerArn." << removeGatewayLoadBalancerArnsCount << "=" << StringUtils::URLEncode(item.c_str()) << "&";
  ...
  if (m_addSupportedIpAddressTypesHasBeenSet) {
    ...
    for (auto& item : m_addSupportedIpAddressTypes) {
      ss << "AddSupportedIpAddressType." << addSupportedIpAddressTypesCount << "=" << StringUtils::URLEncode(item.c_str()) << "&";
  ...
  if (m_removeSupportedIpAddressTypesHasBeenSet) {
    ...
    for (auto& item : m_removeSupportedIpAddressTypes) {
      ss << "RemoveSupportedIpAddressType." << removeSupportedIpAddressTypesCount << "=" << StringUtils::URLEncode(item.c_str()) << "&";
  ...
  if (m_addSupportedRegionsHasBeenSet) {
    ...
    for (auto& item : m_addSupportedRegions) {
      ss << "AddSupportedRegion." << addSupportedRegionsCount << "=" << StringUtils::URLEncode(item.c_str()) << "&";
  ...
  if (m_removeSupportedRegionsHasBeenSet) {
    ...
    for (auto& item : m_removeSupportedRegions) {
      ss << "RemoveSupportedRegion." << removeSupportedRegionsCount << "=" << StringUtils::URLEncode(item.c_str()) << "&";
...
void ModifyVpcEndpointServiceConfigurationRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
