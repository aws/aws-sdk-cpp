...
FleetBlockDeviceMappingRequest::FleetBlockDeviceMappingRequest(const XmlNode& xmlNode) { *this = xmlNode; }

FleetBlockDeviceMappingRequest& FleetBlockDeviceMappingRequest::operator=(const XmlNode& xmlNode) {
...
void FleetBlockDeviceMappingRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void FleetBlockDeviceMappingRequest::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_deviceNameHasBeenSet) {
