...
VpcEndpoint& VpcEndpoint::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!vpcEndpointTypeNode.IsNull()) {
      m_vpcEndpointType = VpcEndpointTypeMapper::GetVpcEndpointTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(vpcEndpointTypeNode.GetText()).c_str()));
    ...
    if (!privateDnsEnabledNode.IsNull()) {
      m_privateDnsEnabled = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(privateDnsEnabledNode.GetText()).c_str()).c_str());
...
void VpcEndpoint::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_vpcEndpointTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".VpcEndpointType=" << StringUtils::URLEncode(VpcEndpointTypeMapper::GetNameForVpcEndpointType(m_vpcEndpointType)) << "&";
  }
  ...
  if (m_routeTableIdsHasBeenSet) {
    ...
    for (auto& item : m_routeTableIds) {
      oStream << location << index << locationValue << ".RouteTableIdSet." << routeTableIdsIdx++ << "="
  ...
  if (m_resourceConfigurationArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".ResourceConfigurationArn=" << StringUtils::URLEncode(m_resourceConfigurationArn.c_str()) << "&";
  }
