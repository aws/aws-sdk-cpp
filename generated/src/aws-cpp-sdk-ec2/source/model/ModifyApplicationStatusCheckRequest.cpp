...
Aws::String ModifyApplicationStatusCheckRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=ModifyApplicationStatusCheck&";
...
void ModifyApplicationStatusCheckRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
