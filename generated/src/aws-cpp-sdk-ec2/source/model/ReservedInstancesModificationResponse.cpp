...
ReservedInstancesModificationResponse::ReservedInstancesModificationResponse(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ReservedInstancesModificationResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
