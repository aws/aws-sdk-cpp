...
GetIpamPoolCidrsResponse::GetIpamPoolCidrsResponse(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
GetIpamPoolCidrsResponse& GetIpamPoolCidrsResponse::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!ipamPoolCidrsNode.IsNull()) {
      ...
      m_ipamPoolCidrsHasBeenSet = !ipamPoolCidrsMember.IsNull();
      ...
      m_ipamPoolCidrsHasBeenSet = true;
    }
