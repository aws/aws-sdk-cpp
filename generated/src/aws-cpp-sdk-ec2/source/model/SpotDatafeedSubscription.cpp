...
SpotDatafeedSubscription::SpotDatafeedSubscription(const XmlNode& xmlNode) { *this = xmlNode; }
...
SpotDatafeedSubscription& SpotDatafeedSubscription::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!stateNode.IsNull()) {
      m_state = DatafeedSubscriptionStateMapper::GetDatafeedSubscriptionStateForName(
...
void SpotDatafeedSubscription::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(DatafeedSubscriptionStateMapper::GetNameForDatafeedSubscriptionState(m_state)) << "&";
  }
}
