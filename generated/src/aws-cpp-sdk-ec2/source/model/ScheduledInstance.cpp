...
ScheduledInstance::ScheduledInstance(const XmlNode& xmlNode) { *this = xmlNode; }
...
ScheduledInstance& ScheduledInstance::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!nextSlotStartTimeNode.IsNull()) {
      m_nextSlotStartTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(nextSlotStartTimeNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!previousSlotEndTimeNode.IsNull()) {
      m_previousSlotEndTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(previousSlotEndTimeNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!slotDurationInHoursNode.IsNull()) {
      m_slotDurationInHours = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(slotDurationInHoursNode.GetText()).c_str()).c_str());
      m_slotDurationInHoursHasBeenSet = true;
    }
    XmlNode termEndDateNode = resultNode.FirstChild("termEndDate");
    if (!termEndDateNode.IsNull()) {
      m_termEndDate = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(termEndDateNode.GetText()).c_str()).c_str(),
                               Aws::Utils::DateFormat::ISO_8601);
      m_termEndDateHasBeenSet = true;
    }
    XmlNode termStartDateNode = resultNode.FirstChild("termStartDate");
    if (!termStartDateNode.IsNull()) {
      m_termStartDate = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(termStartDateNode.GetText()).c_str()).c_str(),
                                 Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!totalScheduledInstanceHoursNode.IsNull()) {
      m_totalScheduledInstanceHours = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(totalScheduledInstanceHoursNode.GetText()).c_str()).c_str());
...
void ScheduledInstance::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_nextSlotStartTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".NextSlotStartTime=" << StringUtils::URLEncode(m_nextSlotStartTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }
  ...
  if (m_previousSlotEndTimeHasBeenSet) {
    oStream << location << index << locationValue << ".PreviousSlotEndTime="
            << StringUtils::URLEncode(m_previousSlotEndTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  ...
  if (m_termEndDateHasBeenSet) {
    oStream << location << index << locationValue
            << ".TermEndDate=" << StringUtils::URLEncode(m_termEndDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_termStartDateHasBeenSet) {
    oStream << location << index << locationValue
            << ".TermStartDate=" << StringUtils::URLEncode(m_termStartDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
...
void ScheduledInstance::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_previousSlotEndTimeHasBeenSet) {
    oStream << location << ".PreviousSlotEndTime="
            << StringUtils::URLEncode(m_previousSlotEndTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_recurrenceHasBeenSet) {
  ...
  if (m_termEndDateHasBeenSet) {
    oStream << location << ".TermEndDate=" << StringUtils::URLEncode(m_termEndDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }
  if (m_termStartDateHasBeenSet) {
    oStream << location
