...
TransitGatewayRouteTableAnnouncement::TransitGatewayRouteTableAnnouncement(const XmlNode& xmlNode) { *this = xmlNode; }
...
TransitGatewayRouteTableAnnouncement& TransitGatewayRouteTableAnnouncement::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!announcementDirectionNode.IsNull()) {
      m_announcementDirection =
          TransitGatewayRouteTableAnnouncementDirectionMapper::GetTransitGatewayRouteTableAnnouncementDirectionForName(
              StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(announcementDirectionNode.GetText()).c_str()));
    ...
    if (!stateNode.IsNull()) {
      m_state = TransitGatewayRouteTableAnnouncementStateMapper::GetTransitGatewayRouteTableAnnouncementStateForName(
...
void TransitGatewayRouteTableAnnouncement::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_announcementDirectionHasBeenSet) {
    oStream << location << index << locationValue << ".AnnouncementDirection="
            << StringUtils::URLEncode(
                   TransitGatewayRouteTableAnnouncementDirectionMapper::GetNameForTransitGatewayRouteTableAnnouncementDirection(
                       m_announcementDirection))
            << "&";
  }
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue << ".State="
            << StringUtils::URLEncode(
                   TransitGatewayRouteTableAnnouncementStateMapper::GetNameForTransitGatewayRouteTableAnnouncementState(m_state))
            << "&";
  }
...
void TransitGatewayRouteTableAnnouncement::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_announcementDirectionHasBeenSet) {
    oStream << location << ".AnnouncementDirection="
            << StringUtils::URLEncode(
                   TransitGatewayRouteTableAnnouncementDirectionMapper::GetNameForTransitGatewayRouteTableAnnouncementDirection(
                       m_announcementDirection))
            << "&";
