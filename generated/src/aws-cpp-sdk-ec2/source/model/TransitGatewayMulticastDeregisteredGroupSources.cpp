...
TransitGatewayMulticastDeregisteredGroupSources& TransitGatewayMulticastDeregisteredGroupSources::operator=(const XmlNode& xmlNode) {
...
void TransitGatewayMulticastDeregisteredGroupSources::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_deregisteredNetworkInterfaceIdsHasBeenSet) {
    ...
    for (auto& item : m_deregisteredNetworkInterfaceIds) {
      oStream << location << index << locationValue << ".DeregisteredNetworkInterfaceIds." << deregisteredNetworkInterfaceIdsIdx++ << "="
...
void TransitGatewayMulticastDeregisteredGroupSources::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_transitGatewayMulticastDomainIdHasBeenSet) {
  ...
  if (m_deregisteredNetworkInterfaceIdsHasBeenSet) {
    unsigned deregisteredNetworkInterfaceIdsIdx = 1;
    for (auto& item : m_deregisteredNetworkInterfaceIds) {
      oStream << location << ".DeregisteredNetworkInterfaceIds." << deregisteredNetworkInterfaceIdsIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
  if (m_groupIpAddressHasBeenSet) {
