...
RemoveIpamOrganizationalUnitExclusion::RemoveIpamOrganizationalUnitExclusion(const XmlNode& xmlNode) { *this = xmlNode; }
...
void RemoveIpamOrganizationalUnitExclusion::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
