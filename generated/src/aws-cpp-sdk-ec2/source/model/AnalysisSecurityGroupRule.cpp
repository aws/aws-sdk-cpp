...
AnalysisSecurityGroupRule::AnalysisSecurityGroupRule(const XmlNode& xmlNode) { *this = xmlNode; }
...
void AnalysisSecurityGroupRule::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
