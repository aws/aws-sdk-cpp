...
VerifiedAccessSseSpecificationResponse::VerifiedAccessSseSpecificationResponse(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VerifiedAccessSseSpecificationResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
