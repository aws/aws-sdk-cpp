...
CreateVolumePermissionModifications::CreateVolumePermissionModifications(const XmlNode& xmlNode) { *this = xmlNode; }
...
void CreateVolumePermissionModifications::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
