...
ThroughResourcesStatement::ThroughResourcesStatement(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ThroughResourcesStatement::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
