...
CapacityReservation::CapacityReservation(const XmlNode& xmlNode) { *this = xmlNode; }
...
CapacityReservation& CapacityReservation::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!instancePlatformNode.IsNull()) {
      m_instancePlatform = CapacityReservationInstancePlatformMapper::GetCapacityReservationInstancePlatformForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(instancePlatformNode.GetText()).c_str()));
    ...
    if (!totalInstanceCountNode.IsNull()) {
      m_totalInstanceCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(totalInstanceCountNode.GetText()).c_str()).c_str());
    ...
    if (!ephemeralStorageNode.IsNull()) {
      m_ephemeralStorage = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(ephemeralStorageNode.GetText()).c_str()).c_str());
      m_ephemeralStorageHasBeenSet = true;
    }
    XmlNode stateNode = resultNode.FirstChild("state");
    if (!stateNode.IsNull()) {
      m_state = CapacityReservationStateMapper::GetCapacityReservationStateForName(
    ...
    if (!endDateTypeNode.IsNull()) {
      m_endDateType = EndDateTypeMapper::GetEndDateTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(endDateTypeNode.GetText()).c_str()));
    ...
    if (!instanceMatchCriteriaNode.IsNull()) {
      m_instanceMatchCriteria = InstanceMatchCriteriaMapper::GetInstanceMatchCriteriaForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(instanceMatchCriteriaNode.GetText()).c_str()));
    ...
    if (!reservationTypeNode.IsNull()) {
      m_reservationType = CapacityReservationTypeMapper::GetCapacityReservationTypeForName(
    ...
    if (!deliveryPreferenceNode.IsNull()) {
      m_deliveryPreference = CapacityReservationDeliveryPreferenceMapper::GetCapacityReservationDeliveryPreferenceForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(deliveryPreferenceNode.GetText()).c_str()));
...
void CapacityReservation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_instancePlatformHasBeenSet) {
    oStream << location << index << locationValue << ".InstancePlatform="
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(CapacityReservationStateMapper::GetNameForCapacityReservationState(m_state)) << "&";
  }
  ...
  if (m_endDateTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".EndDateType=" << StringUtils::URLEncode(EndDateTypeMapper::GetNameForEndDateType(m_endDateType)) << "&";
  }

  if (m_instanceMatchCriteriaHasBeenSet) {
    oStream << location << index << locationValue << ".InstanceMatchCriteria="
  ...
  if (m_reservationTypeHasBeenSet) {
    oStream << location << index << locationValue << ".ReservationType="
            << StringUtils::URLEncode(CapacityReservationTypeMapper::GetNameForCapacityReservationType(m_reservationType)) << "&";
  }
  ...
  if (m_deliveryPreferenceHasBeenSet) {
    oStream << location << index << locationValue << ".DeliveryPreference="
            << StringUtils::URLEncode(
                   CapacityReservationDeliveryPreferenceMapper::GetNameForCapacityReservationDeliveryPreference(m_deliveryPreference))
            << "&";
  }
...
void CapacityReservation::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_instancePlatformHasBeenSet) {
    oStream << location << ".InstancePlatform="
            << StringUtils::URLEncode(
                   CapacityReservationInstancePlatformMapper::GetNameForCapacityReservationInstancePlatform(m_instancePlatform))
            << "&";
  }
  ...
  if (m_instanceMatchCriteriaHasBeenSet) {
    oStream << location << ".InstanceMatchCriteria="
            << StringUtils::URLEncode(InstanceMatchCriteriaMapper::GetNameForInstanceMatchCriteria(m_instanceMatchCriteria)) << "&";
  }
  if (m_createDateHasBeenSet) {
  ...
  if (m_reservationTypeHasBeenSet) {
    oStream << location << ".ReservationType="
            << StringUtils::URLEncode(CapacityReservationTypeMapper::GetNameForCapacityReservationType(m_reservationType)) << "&";
  }
  if (m_unusedReservationBillingOwnerIdHasBeenSet) {
  ...
  if (m_deliveryPreferenceHasBeenSet) {
    oStream << location << ".DeliveryPreference="
            << StringUtils::URLEncode(
                   CapacityReservationDeliveryPreferenceMapper::GetNameForCapacityReservationDeliveryPreference(m_deliveryPreference))
            << "&";
  }
