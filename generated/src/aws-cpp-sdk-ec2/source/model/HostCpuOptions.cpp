...
HostCpuOptions::HostCpuOptions(const XmlNode& xmlNode) { *this = xmlNode; }

HostCpuOptions& HostCpuOptions::operator=(const XmlNode& xmlNode) {
...
void HostCpuOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
...
void HostCpuOptions::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_amdSevSnpHasBeenSet) {
