...
TransitGatewayPolicyRuleMetaData::TransitGatewayPolicyRuleMetaData(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TransitGatewayPolicyRuleMetaData::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
