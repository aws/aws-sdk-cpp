...
ImageUsageResourceTypeOptionRequest::ImageUsageResourceTypeOptionRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ImageUsageResourceTypeOptionRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
