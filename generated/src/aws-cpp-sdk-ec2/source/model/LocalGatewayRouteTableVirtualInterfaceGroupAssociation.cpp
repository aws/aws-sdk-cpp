...
LocalGatewayRouteTableVirtualInterfaceGroupAssociation& LocalGatewayRouteTableVirtualInterfaceGroupAssociation::operator=(
    const XmlNode& xmlNode) {
  XmlNode resultNode = xmlNode;

  if (!resultNode.IsNull()) {
    XmlNode localGatewayRouteTableVirtualInterfaceGroupAssociationIdNode =
        resultNode.FirstChild("localGatewayRouteTableVirtualInterfaceGroupAssociationId");
    if (!localGatewayRouteTableVirtualInterfaceGroupAssociationIdNode.IsNull()) {
      m_localGatewayRouteTableVirtualInterfaceGroupAssociationId =
          Aws::Utils::Xml::DecodeEscapedXmlText(localGatewayRouteTableVirtualInterfaceGroupAssociationIdNode.GetText());
...
void LocalGatewayRouteTableVirtualInterfaceGroupAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                                            const char* locationValue) const {
  if (m_localGatewayRouteTableVirtualInterfaceGroupAssociationIdHasBeenSet) {
    oStream << location << index << locationValue << ".LocalGatewayRouteTableVirtualInterfaceGroupAssociationId="
...
void LocalGatewayRouteTableVirtualInterfaceGroupAssociation::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_localGatewayRouteTableVirtualInterfaceGroupAssociationIdHasBeenSet) {
    oStream << location << ".LocalGatewayRouteTableVirtualInterfaceGroupAssociationId="
            << StringUtils::URLEncode(m_localGatewayRouteTableVirtualInterfaceGroupAssociationId.c_str()) << "&";
  }
  if (m_localGatewayVirtualInterfaceGroupIdHasBeenSet) {
