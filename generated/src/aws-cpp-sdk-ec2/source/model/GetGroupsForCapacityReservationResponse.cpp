...
GetGroupsForCapacityReservationResponse& GetGroupsForCapacityReservationResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!capacityReservationGroupsNode.IsNull()) {
      ...
      m_capacityReservationGroupsHasBeenSet = !capacityReservationGroupsMember.IsNull();
      ...
      m_capacityReservationGroupsHasBeenSet = true;
    }
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::GetGroupsForCapacityReservationResponse",
