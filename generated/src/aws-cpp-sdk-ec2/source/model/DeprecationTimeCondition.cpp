...
DeprecationTimeCondition::DeprecationTimeCondition(const XmlNode& xmlNode)
{
  *this = xmlNode;
}

DeprecationTimeCondition& DeprecationTimeCondition::operator =(const XmlNode& xmlNode)
{
...
void DeprecationTimeCondition::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void DeprecationTimeCondition::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_maximumDaysSinceDeprecatedHasBeenSet)
  {
