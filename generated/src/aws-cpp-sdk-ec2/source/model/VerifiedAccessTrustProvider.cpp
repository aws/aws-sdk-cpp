...
VerifiedAccessTrustProvider::VerifiedAccessTrustProvider(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VerifiedAccessTrustProvider::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
