...
ClientVpnEndpoint::ClientVpnEndpoint(const XmlNode& xmlNode) { *this = xmlNode; }
...
ClientVpnEndpoint& ClientVpnEndpoint::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!splitTunnelNode.IsNull()) {
      m_splitTunnel =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(splitTunnelNode.GetText()).c_str()).c_str());
      m_splitTunnelHasBeenSet = true;
    }
    XmlNode vpnProtocolNode = resultNode.FirstChild("vpnProtocol");
    if (!vpnProtocolNode.IsNull()) {
      m_vpnProtocol = VpnProtocolMapper::GetVpnProtocolForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(vpnProtocolNode.GetText()).c_str()));
    ...
    if (!transportProtocolNode.IsNull()) {
      m_transportProtocol = TransportProtocolMapper::GetTransportProtocolForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(transportProtocolNode.GetText()).c_str()));
      m_transportProtocolHasBeenSet = true;
    }
    XmlNode vpnPortNode = resultNode.FirstChild("vpnPort");
    if (!vpnPortNode.IsNull()) {
      m_vpnPort =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(vpnPortNode.GetText()).c_str()).c_str());
    ...
    if (!sessionTimeoutHoursNode.IsNull()) {
      m_sessionTimeoutHours = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(sessionTimeoutHoursNode.GetText()).c_str()).c_str());
    ...
    if (!disconnectOnSessionTimeoutNode.IsNull()) {
      m_disconnectOnSessionTimeout = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(disconnectOnSessionTimeoutNode.GetText()).c_str()).c_str());
    ...
    if (!endpointIpAddressTypeNode.IsNull()) {
      m_endpointIpAddressType = EndpointIpAddressTypeMapper::GetEndpointIpAddressTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(endpointIpAddressTypeNode.GetText()).c_str()));
    ...
    if (!trafficIpAddressTypeNode.IsNull()) {
      m_trafficIpAddressType = TrafficIpAddressTypeMapper::GetTrafficIpAddressTypeForName(
...
void ClientVpnEndpoint::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_vpnProtocolHasBeenSet) {
    oStream << location << index << locationValue
            << ".VpnProtocol=" << StringUtils::URLEncode(VpnProtocolMapper::GetNameForVpnProtocol(m_vpnProtocol)) << "&";
  }

  if (m_transportProtocolHasBeenSet) {
    oStream << location << index << locationValue
            << ".TransportProtocol=" << StringUtils::URLEncode(TransportProtocolMapper::GetNameForTransportProtocol(m_transportProtocol))
            << "&";
  }
  ...
  if (m_endpointIpAddressTypeHasBeenSet) {
    oStream << location << index << locationValue << ".EndpointIpAddressType="
            << StringUtils::URLEncode(EndpointIpAddressTypeMapper::GetNameForEndpointIpAddressType(m_endpointIpAddressType)) << "&";
  }
...
void ClientVpnEndpoint::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_endpointIpAddressTypeHasBeenSet) {
    oStream << location << ".EndpointIpAddressType="
            << StringUtils::URLEncode(EndpointIpAddressTypeMapper::GetNameForEndpointIpAddressType(m_endpointIpAddressType)) << "&";
  }
  if (m_trafficIpAddressTypeHasBeenSet) {
