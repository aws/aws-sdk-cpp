...
BaselinePerformanceFactors::BaselinePerformanceFactors(const XmlNode& xmlNode) { *this = xmlNode; }
...
void BaselinePerformanceFactors::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
