...
EnableImageBlockPublicAccessResponse& EnableImageBlockPublicAccessResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!imageBlockPublicAccessStateNode.IsNull()) {
      m_imageBlockPublicAccessState = ImageBlockPublicAccessEnabledStateMapper::GetImageBlockPublicAccessEnabledStateForName(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::EnableImageBlockPublicAccessResponse",
