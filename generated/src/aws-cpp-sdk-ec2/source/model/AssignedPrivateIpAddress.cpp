...
AssignedPrivateIpAddress::AssignedPrivateIpAddress(const XmlNode& xmlNode) { *this = xmlNode; }
...
void AssignedPrivateIpAddress::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
