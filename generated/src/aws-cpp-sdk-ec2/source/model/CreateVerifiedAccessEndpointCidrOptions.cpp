...
CreateVerifiedAccessEndpointCidrOptions::CreateVerifiedAccessEndpointCidrOptions(const XmlNode& xmlNode) { *this = xmlNode; }
...
CreateVerifiedAccessEndpointCidrOptions& CreateVerifiedAccessEndpointCidrOptions::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!protocolNode.IsNull()) {
      m_protocol = VerifiedAccessEndpointProtocolMapper::GetVerifiedAccessEndpointProtocolForName(
...
void CreateVerifiedAccessEndpointCidrOptions::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                             const char* locationValue) const {
  if (m_protocolHasBeenSet) {
    oStream << location << index << locationValue << ".Protocol="
            << StringUtils::URLEncode(VerifiedAccessEndpointProtocolMapper::GetNameForVerifiedAccessEndpointProtocol(m_protocol)) << "&";
  }
