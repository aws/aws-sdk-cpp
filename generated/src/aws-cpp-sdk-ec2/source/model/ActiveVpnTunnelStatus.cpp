...
ActiveVpnTunnelStatus::ActiveVpnTunnelStatus(const XmlNode& xmlNode) { *this = xmlNode; }
...
ActiveVpnTunnelStatus& ActiveVpnTunnelStatus::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!phase1DHGroupNode.IsNull()) {
      m_phase1DHGroup = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(phase1DHGroupNode.GetText()).c_str()).c_str());
      m_phase1DHGroupHasBeenSet = true;
    }
    XmlNode phase2DHGroupNode = resultNode.FirstChild("phase2DHGroup");
    if (!phase2DHGroupNode.IsNull()) {
      m_phase2DHGroup = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(phase2DHGroupNode.GetText()).c_str()).c_str());
    ...
    if (!provisioningStatusNode.IsNull()) {
      m_provisioningStatus = VpnTunnelProvisioningStatusMapper::GetVpnTunnelProvisioningStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(provisioningStatusNode.GetText()).c_str()));
...
void ActiveVpnTunnelStatus::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  if (m_phase1EncryptionAlgorithmHasBeenSet) {
    oStream << location << index << locationValue
            << ".Phase1EncryptionAlgorithm=" << StringUtils::URLEncode(m_phase1EncryptionAlgorithm.c_str()) << "&";
  }

  if (m_phase2EncryptionAlgorithmHasBeenSet) {
    oStream << location << index << locationValue
            << ".Phase2EncryptionAlgorithm=" << StringUtils::URLEncode(m_phase2EncryptionAlgorithm.c_str()) << "&";
  }

  if (m_phase1IntegrityAlgorithmHasBeenSet) {
    oStream << location << index << locationValue
            << ".Phase1IntegrityAlgorithm=" << StringUtils::URLEncode(m_phase1IntegrityAlgorithm.c_str()) << "&";
  }

  if (m_phase2IntegrityAlgorithmHasBeenSet) {
    oStream << location << index << locationValue
            << ".Phase2IntegrityAlgorithm=" << StringUtils::URLEncode(m_phase2IntegrityAlgorithm.c_str()) << "&";
  }
  ...
  if (m_provisioningStatusHasBeenSet) {
    oStream << location << index << locationValue << ".ProvisioningStatus="
            << StringUtils::URLEncode(VpnTunnelProvisioningStatusMapper::GetNameForVpnTunnelProvisioningStatus(m_provisioningStatus))
            << "&";
  }

  if (m_provisioningStatusReasonHasBeenSet) {
    oStream << location << index << locationValue
            << ".ProvisioningStatusReason=" << StringUtils::URLEncode(m_provisioningStatusReason.c_str()) << "&";
  }
}
...
void ActiveVpnTunnelStatus::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_provisioningStatusHasBeenSet) {
    oStream << location << ".ProvisioningStatus="
            << StringUtils::URLEncode(VpnTunnelProvisioningStatusMapper::GetNameForVpnTunnelProvisioningStatus(m_provisioningStatus))
            << "&";
  }
  if (m_provisioningStatusReasonHasBeenSet) {
