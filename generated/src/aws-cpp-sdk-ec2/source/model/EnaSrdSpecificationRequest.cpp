...
EnaSrdSpecificationRequest::EnaSrdSpecificationRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void EnaSrdSpecificationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
