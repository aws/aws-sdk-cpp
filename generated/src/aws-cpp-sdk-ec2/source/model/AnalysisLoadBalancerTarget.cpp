...
AnalysisLoadBalancerTarget::AnalysisLoadBalancerTarget(const XmlNode& xmlNode) { *this = xmlNode; }
...
void AnalysisLoadBalancerTarget::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
