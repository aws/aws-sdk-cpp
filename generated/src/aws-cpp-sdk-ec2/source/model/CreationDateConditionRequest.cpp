...
CreationDateConditionRequest::CreationDateConditionRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void CreationDateConditionRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
