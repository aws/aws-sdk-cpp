...
VerifiedAccessEndpointPortRange::VerifiedAccessEndpointPortRange(const XmlNode& xmlNode) { *this = xmlNode; }
...
void VerifiedAccessEndpointPortRange::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
