...
CreateTrafficMirrorFilterRuleResponse& CreateTrafficMirrorFilterRuleResponse::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!trafficMirrorFilterRuleNode.IsNull()) {
      ...
      m_trafficMirrorFilterRuleHasBeenSet = true;
    }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::CreateTrafficMirrorFilterRuleResponse",
