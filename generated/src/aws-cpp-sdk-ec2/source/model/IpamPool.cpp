...
IpamPool::IpamPool(const XmlNode& xmlNode) { *this = xmlNode; }
...
IpamPool& IpamPool::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!poolDepthNode.IsNull()) {
      m_poolDepth =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(poolDepthNode.GetText()).c_str()).c_str());
      m_poolDepthHasBeenSet = true;
    }
    XmlNode stateNode = resultNode.FirstChild("state");
    if (!stateNode.IsNull()) {
      m_state = IpamPoolStateMapper::GetIpamPoolStateForName(
    ...
    if (!autoImportNode.IsNull()) {
      m_autoImport =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(autoImportNode.GetText()).c_str()).c_str());
    ...
    if (!publiclyAdvertisableNode.IsNull()) {
      m_publiclyAdvertisable = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(publiclyAdvertisableNode.GetText()).c_str()).c_str());
    ...
    if (!allocationMinNetmaskLengthNode.IsNull()) {
      m_allocationMinNetmaskLength = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(allocationMinNetmaskLengthNode.GetText()).c_str()).c_str());
    ...
    if (!allocationMaxNetmaskLengthNode.IsNull()) {
      m_allocationMaxNetmaskLength = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(allocationMaxNetmaskLengthNode.GetText()).c_str()).c_str());
    ...
    if (!allocationDefaultNetmaskLengthNode.IsNull()) {
      m_allocationDefaultNetmaskLength = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(allocationDefaultNetmaskLengthNode.GetText()).c_str()).c_str());
    ...
    if (!awsServiceNode.IsNull()) {
      m_awsService = IpamPoolAwsServiceMapper::GetIpamPoolAwsServiceForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(awsServiceNode.GetText()).c_str()));
      m_awsServiceHasBeenSet = true;
    }
    XmlNode publicIpSourceNode = resultNode.FirstChild("publicIpSource");
    if (!publicIpSourceNode.IsNull()) {
      m_publicIpSource = IpamPoolPublicIpSourceMapper::GetIpamPoolPublicIpSourceForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(publicIpSourceNode.GetText()).c_str()));
...
void IpamPool::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_stateHasBeenSet) {
    oStream << location << index << locationValue
            << ".State=" << StringUtils::URLEncode(IpamPoolStateMapper::GetNameForIpamPoolState(m_state)) << "&";
  }
  ...
  if (m_awsServiceHasBeenSet) {
    oStream << location << index << locationValue
            << ".AwsService=" << StringUtils::URLEncode(IpamPoolAwsServiceMapper::GetNameForIpamPoolAwsService(m_awsService)) << "&";
  }

  if (m_publicIpSourceHasBeenSet) {
    oStream << location << index << locationValue << ".PublicIpSource="
            << StringUtils::URLEncode(IpamPoolPublicIpSourceMapper::GetNameForIpamPoolPublicIpSource(m_publicIpSource)) << "&";
  }
...
void IpamPool::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_publicIpSourceHasBeenSet) {
    oStream << location << ".PublicIpSource="
            << StringUtils::URLEncode(IpamPoolPublicIpSourceMapper::GetNameForIpamPoolPublicIpSource(m_publicIpSource)) << "&";
  }
  if (m_sourceResourceHasBeenSet) {
