...
SpotFleetRequestConfigData::SpotFleetRequestConfigData(const XmlNode& xmlNode) { *this = xmlNode; }
...
SpotFleetRequestConfigData& SpotFleetRequestConfigData::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!onDemandAllocationStrategyNode.IsNull()) {
      m_onDemandAllocationStrategy = OnDemandAllocationStrategyMapper::GetOnDemandAllocationStrategyForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(onDemandAllocationStrategyNode.GetText()).c_str()));
    ...
    if (!excessCapacityTerminationPolicyNode.IsNull()) {
      m_excessCapacityTerminationPolicy = ExcessCapacityTerminationPolicyMapper::GetExcessCapacityTerminationPolicyForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(excessCapacityTerminationPolicyNode.GetText()).c_str()));
    ...
    if (!fulfilledCapacityNode.IsNull()) {
      m_fulfilledCapacity = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(fulfilledCapacityNode.GetText()).c_str()).c_str());
    ...
    if (!onDemandFulfilledCapacityNode.IsNull()) {
      m_onDemandFulfilledCapacity = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(onDemandFulfilledCapacityNode.GetText()).c_str()).c_str());
    ...
    if (!targetCapacityNode.IsNull()) {
      m_targetCapacity = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(targetCapacityNode.GetText()).c_str()).c_str());
    ...
    if (!terminateInstancesWithExpirationNode.IsNull()) {
      m_terminateInstancesWithExpiration = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(terminateInstancesWithExpirationNode.GetText()).c_str()).c_str());
    ...
    if (!validFromNode.IsNull()) {
      m_validFrom = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(validFromNode.GetText()).c_str()).c_str(),
    ...
    if (!replaceUnhealthyInstancesNode.IsNull()) {
      m_replaceUnhealthyInstances = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(replaceUnhealthyInstancesNode.GetText()).c_str()).c_str());
...
void SpotFleetRequestConfigData::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                const char* locationValue) const {
  if (m_allocationStrategyHasBeenSet) {
    oStream << location << index << locationValue << ".AllocationStrategy="
            << StringUtils::URLEncode(AllocationStrategyMapper::GetNameForAllocationStrategy(m_allocationStrategy)) << "&";
  }

  if (m_onDemandAllocationStrategyHasBeenSet) {
    oStream << location << index << locationValue << ".OnDemandAllocationStrategy="
            << StringUtils::URLEncode(OnDemandAllocationStrategyMapper::GetNameForOnDemandAllocationStrategy(m_onDemandAllocationStrategy))
            << "&";
  }
  ...
  if (m_excessCapacityTerminationPolicyHasBeenSet) {
    oStream << location << index << locationValue << ".ExcessCapacityTerminationPolicy="
            << StringUtils::URLEncode(
                   ExcessCapacityTerminationPolicyMapper::GetNameForExcessCapacityTerminationPolicy(m_excessCapacityTerminationPolicy))
            << "&";
  }
  ...
  if (m_terminateInstancesWithExpirationHasBeenSet) {
    oStream << location << index << locationValue << ".TerminateInstancesWithExpiration=" << std::boolalpha
            << m_terminateInstancesWithExpiration << "&";
  }
  ...
  if (m_validFromHasBeenSet) {
    oStream << location << index << locationValue
            << ".ValidFrom=" << StringUtils::URLEncode(m_validFrom.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
...
void SpotFleetRequestConfigData::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_onDemandAllocationStrategyHasBeenSet) {
    oStream << location << ".OnDemandAllocationStrategy="
            << StringUtils::URLEncode(OnDemandAllocationStrategyMapper::GetNameForOnDemandAllocationStrategy(m_onDemandAllocationStrategy))
            << "&";
  }
  if (m_spotMaintenanceStrategiesHasBeenSet) {
  ...
  if (m_excessCapacityTerminationPolicyHasBeenSet) {
    oStream << location << ".ExcessCapacityTerminationPolicy="
            << StringUtils::URLEncode(
                   ExcessCapacityTerminationPolicyMapper::GetNameForExcessCapacityTerminationPolicy(m_excessCapacityTerminationPolicy))
            << "&";
  }
