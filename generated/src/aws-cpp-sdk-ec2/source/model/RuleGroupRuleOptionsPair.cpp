...
RuleGroupRuleOptionsPair::RuleGroupRuleOptionsPair(const XmlNode& xmlNode) { *this = xmlNode; }
...
void RuleGroupRuleOptionsPair::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
