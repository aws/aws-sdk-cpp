...
Ipv4PrefixSpecificationResponse::Ipv4PrefixSpecificationResponse(const XmlNode& xmlNode) { *this = xmlNode; }

Ipv4PrefixSpecificationResponse& Ipv4PrefixSpecificationResponse::operator=(const XmlNode& xmlNode) {
...
void Ipv4PrefixSpecificationResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void Ipv4PrefixSpecificationResponse::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_ipv4PrefixHasBeenSet) {
