...
UpdateCapacityManagerOrganizationsAccessOutcome EC2Client::UpdateCapacityManagerOrganizationsAccess(const UpdateCapacityManagerOrganizationsAccessRequest& request) const
{
  AWS_OPERATION_GUARD(UpdateCapacityManagerOrganizationsAccess);
  AWS_OPERATION_CHECK_PTR(m_endpointProvider, UpdateCapacityManagerOrganizationsAccess, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE);
  ...
  return TracingUtils::MakeCallWithTiming<UpdateCapacityManagerOrganizationsAccessOutcome>(
    [&]()-> UpdateCapacityManagerOrganizationsAccessOutcome {
      ...
      AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, UpdateCapacityManagerOrganizationsAccess, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE, endpointResolutionOutcome.GetError().GetMessage());
      return UpdateCapacityManagerOrganizationsAccessOutcome(MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_POST));
    },
