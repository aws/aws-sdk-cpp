...
namespace EC2
{
const size_t EC2EndpointRules::RulesBlobStrLen = 4313;
const size_t EC2EndpointRules::RulesBlobSize = 4314;
...
'e','c','2','.','{','R','e','g','i','o','n','}','.','a','m','a','z','o','n','a','w','s','.','c','o',
...
's',':','/','/','e','c','2','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
