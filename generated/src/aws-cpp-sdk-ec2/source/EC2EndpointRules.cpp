...
namespace EC2
{
const size_t EC2EndpointRules::RulesBlobStrLen = 4107;
const size_t EC2EndpointRules::RulesBlobSize = 4108;
...
'h','t','t','p','s',':','/','/','e','c','2','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
':','"','h','t','t','p','s',':','/','/','e','c','2','.','u','s','-','g','o','v','-','w','e','s','t',
...
const char* EC2EndpointRules::GetRulesBlob()
{
