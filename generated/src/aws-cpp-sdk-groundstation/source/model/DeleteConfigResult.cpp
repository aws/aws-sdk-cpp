...
DeleteConfigResult::DeleteConfigResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteConfigResult& DeleteConfigResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
