...
UplinkAwsGroundStationAgentEndpointDetails::UplinkAwsGroundStationAgentEndpointDetails(JsonView jsonValue) { *this = jsonValue; }

UplinkAwsGroundStationAgentEndpointDetails& UplinkAwsGroundStationAgentEndpointDetails::operator=(JsonView jsonValue) {
...
JsonValue UplinkAwsGroundStationAgentEndpointDetails::Jsonize() const {
  JsonValue payload;
