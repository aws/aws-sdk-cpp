...
class AWS_GROUNDSTATION_API GroundStationClient : public Aws::Client::AWSJsonClient,
                                                  ...
                                                  public GroundStationWaiter<GroundStationClient> {
 public:
   ...
   */
  GroundStationClient(const Aws::GroundStation::GroundStationClientConfiguration& clientConfiguration =
  ...
  GroundStationClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<GroundStationEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::GroundStation::GroundStationClientConfiguration& clientConfiguration =
                          Aws::GroundStation::GroundStationClientConfiguration());
  ...
  /**
   * An Async wrapper for CancelContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelContactRequestT = Model::CancelContactRequest>
  void CancelContactAsync(const CancelContactRequestT& request, const CancelContactResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CreateConfig that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateConfigRequestT = Model::CreateConfigRequest>
  void CreateConfigAsync(const CreateConfigRequestT& request, const CreateConfigResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDataflowEndpointGroupOutcome CreateDataflowEndpointGroup(
      const Model::CreateDataflowEndpointGroupRequest& request) const;

  /**
   * A Callable wrapper for CreateDataflowEndpointGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateDataflowEndpointGroupRequestT = Model::CreateDataflowEndpointGroupRequest>
  Model::CreateDataflowEndpointGroupOutcomeCallable CreateDataflowEndpointGroupCallable(
      const CreateDataflowEndpointGroupRequestT& request) const {
    return SubmitCallable(&GroundStationClient::CreateDataflowEndpointGroup, request);
  }

  /**
   * An Async wrapper for CreateDataflowEndpointGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDataflowEndpointGroupRequestT = Model::CreateDataflowEndpointGroupRequest>
  void CreateDataflowEndpointGroupAsync(const CreateDataflowEndpointGroupRequestT& request,
  ...
  /**
   * An Async wrapper for CreateEphemeris that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateEphemerisRequestT = Model::CreateEphemerisRequest>
  void CreateEphemerisAsync(const CreateEphemerisRequestT& request, const CreateEphemerisResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateMissionProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMissionProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMissionProfileRequestT = Model::CreateMissionProfileRequest>
  void CreateMissionProfileAsync(const CreateMissionProfileRequestT& request, const CreateMissionProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteConfig that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteConfigRequestT = Model::DeleteConfigRequest>
  void DeleteConfigAsync(const DeleteConfigRequestT& request, const DeleteConfigResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDataflowEndpointGroupOutcome DeleteDataflowEndpointGroup(
      const Model::DeleteDataflowEndpointGroupRequest& request) const;

  /**
   * A Callable wrapper for DeleteDataflowEndpointGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteDataflowEndpointGroupRequestT = Model::DeleteDataflowEndpointGroupRequest>
  Model::DeleteDataflowEndpointGroupOutcomeCallable DeleteDataflowEndpointGroupCallable(
      const DeleteDataflowEndpointGroupRequestT& request) const {
    return SubmitCallable(&GroundStationClient::DeleteDataflowEndpointGroup, request);
  }

  /**
   * An Async wrapper for DeleteDataflowEndpointGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDataflowEndpointGroupRequestT = Model::DeleteDataflowEndpointGroupRequest>
  void DeleteDataflowEndpointGroupAsync(const DeleteDataflowEndpointGroupRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteEphemeris that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteEphemerisRequestT = Model::DeleteEphemerisRequest>
  void DeleteEphemerisAsync(const DeleteEphemerisRequestT& request, const DeleteEphemerisResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMissionProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMissionProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMissionProfileRequestT = Model::DeleteMissionProfileRequest>
  void DeleteMissionProfileAsync(const DeleteMissionProfileRequestT& request, const DeleteMissionProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeEphemeris that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEphemeris that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeEphemerisRequestT = Model::DescribeEphemerisRequest>
  void DescribeEphemerisAsync(const DescribeEphemerisRequestT& request, const DescribeEphemerisResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAgentConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAgentConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAgentConfigurationRequestT = Model::GetAgentConfigurationRequest>
  ...
  /**
   * An Async wrapper for GetConfig that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetConfigRequestT = Model::GetConfigRequest>
  void GetConfigAsync(const GetConfigRequestT& request, const GetConfigResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDataflowEndpointGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDataflowEndpointGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDataflowEndpointGroupRequestT = Model::GetDataflowEndpointGroupRequest>
  void GetDataflowEndpointGroupAsync(const GetDataflowEndpointGroupRequestT& request,
  ...
  /**
   * An Async wrapper for GetMinuteUsage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMinuteUsageRequestT = Model::GetMinuteUsageRequest>
  void GetMinuteUsageAsync(const GetMinuteUsageRequestT& request, const GetMinuteUsageResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMissionProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMissionProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMissionProfileRequestT = Model::GetMissionProfileRequest>
  void GetMissionProfileAsync(const GetMissionProfileRequestT& request, const GetMissionProfileResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSatellite that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSatelliteRequestT = Model::GetSatelliteRequest>
  void GetSatelliteAsync(const GetSatelliteRequestT& request, const GetSatelliteResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListConfigs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListConfigsRequestT = Model::ListConfigsRequest>
  void ListConfigsAsync(const ListConfigsResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDataflowEndpointGroupsOutcome ListDataflowEndpointGroups(
      const Model::ListDataflowEndpointGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDataflowEndpointGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDataflowEndpointGroupsRequestT = Model::ListDataflowEndpointGroupsRequest>
  Model::ListDataflowEndpointGroupsOutcomeCallable ListDataflowEndpointGroupsCallable(
      const ListDataflowEndpointGroupsRequestT& request = {}) const {
    return SubmitCallable(&GroundStationClient::ListDataflowEndpointGroups, request);
  }

  /**
   * An Async wrapper for ListDataflowEndpointGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataflowEndpointGroupsRequestT = Model::ListDataflowEndpointGroupsRequest>
  void ListDataflowEndpointGroupsAsync(const ListDataflowEndpointGroupsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListDataflowEndpointGroupsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListEphemerides that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListEphemeridesRequestT = Model::ListEphemeridesRequest>
  ...
  /**
   * A Callable wrapper for ListGroundStations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGroundStations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListGroundStationsRequestT = Model::ListGroundStationsRequest>
  void ListGroundStationsAsync(const ListGroundStationsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListGroundStationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMissionProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMissionProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListMissionProfilesRequestT = Model::ListMissionProfilesRequest>
  void ListMissionProfilesAsync(const ListMissionProfilesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListMissionProfilesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListSatellites that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSatellitesRequestT = Model::ListSatellitesRequest>
  void ListSatellitesAsync(const ListSatellitesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListSatellitesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for RegisterAgent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RegisterAgentRequestT = Model::RegisterAgentRequest>
  void RegisterAgentAsync(const RegisterAgentRequestT& request, const RegisterAgentResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ReserveContact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ReserveContactRequestT = Model::ReserveContactRequest>
  void ReserveContactAsync(const ReserveContactRequestT& request, const ReserveContactResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateConfig that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateConfigRequestT = Model::UpdateConfigRequest>
  ...
  /**
   * An Async wrapper for UpdateEphemeris that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateEphemerisRequestT = Model::UpdateEphemerisRequest>
  void UpdateEphemerisAsync(const UpdateEphemerisRequestT& request, const UpdateEphemerisResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateMissionProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMissionProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMissionProfileRequestT = Model::UpdateMissionProfileRequest>
  void UpdateMissionProfileAsync(const UpdateMissionProfileRequestT& request, const UpdateMissionProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
