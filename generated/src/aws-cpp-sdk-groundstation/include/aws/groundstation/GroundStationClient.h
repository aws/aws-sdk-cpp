...
namespace GroundStation
{
   ...
   */
  class AWS_GROUNDSTATION_API GroundStationClient : Aws::Client::ClientWithAsyncTemplateMethods<GroundStationClient>,
    smithy::client::AwsSmithyClientT<Aws::GroundStation::SERVICE_NAME,
