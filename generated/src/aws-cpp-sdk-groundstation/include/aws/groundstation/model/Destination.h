...
class Destination {
 public:
  ...
  inline Destination& WithConfigType(ConfigCapabilityType value) {
    SetConfigType(value);
    return *this;
  }
  ///@}
  ...
  void SetDataflowDestinationRegion(DataflowDestinationRegionT&& value) {
    ...
    m_dataflowDestinationRegion = std::forward<DataflowDestinationRegionT>(value);
  }
  template <typename DataflowDestinationRegionT = Aws::String>
  Destination& WithDataflowDestinationRegion(DataflowDestinationRegionT&& value) {
    SetDataflowDestinationRegion(std::forward<DataflowDestinationRegionT>(value));
    return *this;
  }
  ///@}
 private:
