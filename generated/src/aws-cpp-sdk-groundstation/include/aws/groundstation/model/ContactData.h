...
class ContactData {
 public:
  ...
  inline ContactData& WithContactStatus(ContactStatus value) {
  ...
  void SetVisibilityEndTime(VisibilityEndTimeT&& value) {
    ...
    m_visibilityEndTime = std::forward<VisibilityEndTimeT>(value);
  }
  template <typename VisibilityEndTimeT = Aws::Utils::DateTime>
  ContactData& WithVisibilityEndTime(VisibilityEndTimeT&& value) {
    SetVisibilityEndTime(std::forward<VisibilityEndTimeT>(value));
    return *this;
  }
  ///@}
