...
namespace Model {
/**
 * <p>Output for the <code>ListGroundStations</code> operation.</p><p><h3>See
 * Also:</h3>   <a
...
class ListGroundStationsResult {
 public:
  ...
  void SetGroundStationList(GroundStationListT&& value) {
    m_groundStationListHasBeenSet = true;
    m_groundStationList = std::forward<GroundStationListT>(value);
  }
  template <typename GroundStationListT = Aws::Vector<GroundStationData>>
  ListGroundStationsResult& WithGroundStationList(GroundStationListT&& value) {
    SetGroundStationList(std::forward<GroundStationListT>(value));
    return *this;
  }
  template <typename GroundStationListT = GroundStationData>
  ListGroundStationsResult& AddGroundStationList(GroundStationListT&& value) {
    m_groundStationListHasBeenSet = true;
    m_groundStationList.emplace_back(std::forward<GroundStationListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListGroundStationsResult& WithRequestId(RequestIdT&& value) {
