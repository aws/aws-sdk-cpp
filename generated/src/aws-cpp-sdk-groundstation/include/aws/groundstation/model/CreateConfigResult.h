...
namespace Model
{
  ...
  public:
    ...
    template<typename ConfigArnT = Aws::String>
    CreateConfigResult& WithConfigArn(ConfigArnT&& value) { SetConfigArn(std::forward<ConfigArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfigIdT = Aws::String>
    CreateConfigResult& WithConfigId(ConfigIdT&& value) { SetConfigId(std::forward<ConfigIdT>(value)); return *this;}
    ///@}
    ...
    inline CreateConfigResult& WithConfigType(ConfigCapabilityType value) { SetConfigType(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateConfigResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
