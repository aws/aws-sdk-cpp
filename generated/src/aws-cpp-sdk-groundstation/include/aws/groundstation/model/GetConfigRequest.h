...
namespace Model
{
  ...
  public:
    ...
    template<typename ConfigIdT = Aws::String>
    GetConfigRequest& WithConfigId(ConfigIdT&& value) { SetConfigId(std::forward<ConfigIdT>(value)); return *this;}
    ///@}
    ...
    inline GetConfigRequest& WithConfigType(ConfigCapabilityType value) { SetConfigType(value); return *this;}
    ///@}
  private:
