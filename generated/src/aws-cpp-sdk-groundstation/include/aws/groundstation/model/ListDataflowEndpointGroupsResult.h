...
namespace Model {
/**
 * <p>Output for the <code>ListDataflowEndpointGroups</code> operation.
...
class ListDataflowEndpointGroupsResult {
 public:
  ...
  void SetDataflowEndpointGroupList(DataflowEndpointGroupListT&& value) {
    m_dataflowEndpointGroupListHasBeenSet = true;
    m_dataflowEndpointGroupList = std::forward<DataflowEndpointGroupListT>(value);
  }
  template <typename DataflowEndpointGroupListT = Aws::Vector<DataflowEndpointListItem>>
  ListDataflowEndpointGroupsResult& WithDataflowEndpointGroupList(DataflowEndpointGroupListT&& value) {
    SetDataflowEndpointGroupList(std::forward<DataflowEndpointGroupListT>(value));
    return *this;
  }
  template <typename DataflowEndpointGroupListT = DataflowEndpointListItem>
  ListDataflowEndpointGroupsResult& AddDataflowEndpointGroupList(DataflowEndpointGroupListT&& value) {
    m_dataflowEndpointGroupListHasBeenSet = true;
    m_dataflowEndpointGroupList.emplace_back(std::forward<DataflowEndpointGroupListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListDataflowEndpointGroupsResult& WithRequestId(RequestIdT&& value) {
