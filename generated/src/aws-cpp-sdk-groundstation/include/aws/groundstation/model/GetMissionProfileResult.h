...
class GetMissionProfileResult {
 public:
  ...
  inline GetMissionProfileResult& WithContactPostPassDurationSeconds(int value) {
  ...
  inline GetMissionProfileResult& WithContactPrePassDurationSeconds(int value) {
  ...
  inline GetMissionProfileResult& WithMinimumViableContactDurationSeconds(int value) {
