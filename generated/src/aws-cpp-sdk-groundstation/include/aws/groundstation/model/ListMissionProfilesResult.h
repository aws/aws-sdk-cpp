...
namespace Model {
/**
 * <p>Output for the <code>ListMissionProfiles</code> operation. </p><p><h3>See
 * Also:</h3>   <a
...
class ListMissionProfilesResult {
 public:
  ...
  void SetMissionProfileList(MissionProfileListT&& value) {
    m_missionProfileListHasBeenSet = true;
    m_missionProfileList = std::forward<MissionProfileListT>(value);
  }
  template <typename MissionProfileListT = Aws::Vector<MissionProfileListItem>>
  ListMissionProfilesResult& WithMissionProfileList(MissionProfileListT&& value) {
    SetMissionProfileList(std::forward<MissionProfileListT>(value));
    return *this;
  }
  template <typename MissionProfileListT = MissionProfileListItem>
  ListMissionProfilesResult& AddMissionProfileList(MissionProfileListT&& value) {
    m_missionProfileListHasBeenSet = true;
    m_missionProfileList.emplace_back(std::forward<MissionProfileListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListMissionProfilesResult& WithRequestId(RequestIdT&& value) {
