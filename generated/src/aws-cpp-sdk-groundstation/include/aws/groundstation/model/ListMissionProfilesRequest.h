...
/**
 * <p>Input for the <code>ListMissionProfiles</code> operation. </p><p><h3>See
 * Also:</h3>   <a
...
class ListMissionProfilesRequest : public GroundStationRequest {
 public:
  AWS_GROUNDSTATION_API ListMissionProfilesRequest() = default;
  ...
  inline ListMissionProfilesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMissionProfilesRequest& WithNextToken(NextTokenT&& value) {
