...
class ConfigDetails {
 public:
  ...
  void SetAntennaDemodDecodeDetails(AntennaDemodDecodeDetailsT&& value) {
    ...
    m_antennaDemodDecodeDetails = std::forward<AntennaDemodDecodeDetailsT>(value);
  }
  template <typename AntennaDemodDecodeDetailsT = AntennaDemodDecodeDetails>
  ...
  void SetS3RecordingDetails(S3RecordingDetailsT&& value) {
    ...
    m_s3RecordingDetails = std::forward<S3RecordingDetailsT>(value);
  }
  template <typename S3RecordingDetailsT = S3RecordingDetails>
  ConfigDetails& WithS3RecordingDetails(S3RecordingDetailsT&& value) {
    SetS3RecordingDetails(std::forward<S3RecordingDetailsT>(value));
    return *this;
  }
  ///@}
 private:
