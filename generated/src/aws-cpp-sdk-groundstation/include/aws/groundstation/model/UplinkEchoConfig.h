 ...
 * is used in a contact.</p><p><h3>See Also:</h3>   <a
...
class UplinkEchoConfig {
 public:
  ...
  void SetAntennaUplinkConfigArn(AntennaUplinkConfigArnT&& value) {
    m_antennaUplinkConfigArnHasBeenSet = true;
    m_antennaUplinkConfigArn = std::forward<AntennaUplinkConfigArnT>(value);
  }
  template <typename AntennaUplinkConfigArnT = Aws::String>
  UplinkEchoConfig& WithAntennaUplinkConfigArn(AntennaUplinkConfigArnT&& value) {
    SetAntennaUplinkConfigArn(std::forward<AntennaUplinkConfigArnT>(value));
    return *this;
  }
  ///@}
 private:
