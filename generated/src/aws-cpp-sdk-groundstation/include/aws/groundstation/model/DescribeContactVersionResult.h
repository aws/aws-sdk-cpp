...
namespace Model {
class DescribeContactVersionResult {
 public:
  ...
  inline DescribeContactVersionResult& WithContactStatus(ContactStatus value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  DescribeContactVersionResult& WithTags(TagsT&& value) {
  ...
  ///@{
  /**
   * <p>Tracking configuration overrides applied to this contact version. For the
