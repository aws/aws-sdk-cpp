...
/**
 * <p>Input for the <code>ListSatellites</code> operation.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/groundstation-2019-05-23/ListSatellitesRequest">AWS
 * API Reference</a></p>
 */
class ListSatellitesRequest : public GroundStationRequest {
 public:
  ...
  inline ListSatellitesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
