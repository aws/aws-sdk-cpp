...
class KmsKey {
 public:
  ...
  void SetKmsAliasArn(KmsAliasArnT&& value) {
    m_kmsAliasArnHasBeenSet = true;
    m_kmsAliasArn = std::forward<KmsAliasArnT>(value);
  }
  template <typename KmsAliasArnT = Aws::String>
  KmsKey& WithKmsAliasArn(KmsAliasArnT&& value) {
    SetKmsAliasArn(std::forward<KmsAliasArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKmsAliasName(KmsAliasNameT&& value) {
    m_kmsAliasNameHasBeenSet = true;
    m_kmsAliasName = std::forward<KmsAliasNameT>(value);
  }
  template <typename KmsAliasNameT = Aws::String>
  KmsKey& WithKmsAliasName(KmsAliasNameT&& value) {
    SetKmsAliasName(std::forward<KmsAliasNameT>(value));
    return *this;
  }
  ///@}
