...
namespace Model
{
  ...
  {
  public:
    AWS_GROUNDSTATION_API GetMissionProfileRequest() = default;
    ...
    template<typename MissionProfileIdT = Aws::String>
    GetMissionProfileRequest& WithMissionProfileId(MissionProfileIdT&& value) { SetMissionProfileId(std::forward<MissionProfileIdT>(value)); return *this;}
    ///@}
  private:
