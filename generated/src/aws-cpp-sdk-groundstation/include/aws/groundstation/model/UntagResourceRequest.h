...
/**
 * <p>Input for the <code>UntagResource</code> operation.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/groundstation-2019-05-23/UntagResourceRequest">AWS
 * API Reference</a></p>
 */
class UntagResourceRequest : public GroundStationRequest {
 public:
  AWS_GROUNDSTATION_API UntagResourceRequest() = default;
