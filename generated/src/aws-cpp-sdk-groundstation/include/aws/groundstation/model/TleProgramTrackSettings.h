...
/**
 * <p>Program track settings for <a>TLEEphemeris</a>.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/groundstation-2019-05-23/TleProgramTrackSettings">AWS
 * API Reference</a></p>
 */
class TleProgramTrackSettings {
 public:
  AWS_GROUNDSTATION_API TleProgramTrackSettings() = default;
  AWS_GROUNDSTATION_API TleProgramTrackSettings(Aws::Utils::Json::JsonView jsonValue);
  AWS_GROUNDSTATION_API TleProgramTrackSettings& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename EphemerisIdT = Aws::String>
  TleProgramTrackSettings& WithEphemerisId(EphemerisIdT&& value) {
