...
class AgentDetails {
 public:
  ...
  void SetReservedCpuCores(ReservedCpuCoresT&& value) {
    ...
    m_reservedCpuCores = std::forward<ReservedCpuCoresT>(value);
  }
  template <typename ReservedCpuCoresT = Aws::Vector<int>>
  AgentDetails& WithReservedCpuCores(ReservedCpuCoresT&& value) {
    SetReservedCpuCores(std::forward<ReservedCpuCoresT>(value));
    return *this;
  }
  inline AgentDetails& AddReservedCpuCores(int value) {
    m_reservedCpuCoresHasBeenSet = true;
    m_reservedCpuCores.push_back(value);
    return *this;
  }
  ///@}
 private:
