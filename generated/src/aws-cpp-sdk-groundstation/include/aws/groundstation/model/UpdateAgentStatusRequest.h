...
class UpdateAgentStatusRequest : public GroundStationRequest {
 public:
  ...
  void SetAggregateStatus(AggregateStatusT&& value) {
    m_aggregateStatusHasBeenSet = true;
    m_aggregateStatus = std::forward<AggregateStatusT>(value);
  }
  template <typename AggregateStatusT = AggregateStatus>
  UpdateAgentStatusRequest& WithAggregateStatus(AggregateStatusT&& value) {
    SetAggregateStatus(std::forward<AggregateStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComponentStatuses(ComponentStatusesT&& value) {
    m_componentStatusesHasBeenSet = true;
    m_componentStatuses = std::forward<ComponentStatusesT>(value);
  }
  template <typename ComponentStatusesT = Aws::Vector<ComponentStatusData>>
  UpdateAgentStatusRequest& WithComponentStatuses(ComponentStatusesT&& value) {
    SetComponentStatuses(std::forward<ComponentStatusesT>(value));
    return *this;
  }
  ...
  UpdateAgentStatusRequest& AddComponentStatuses(ComponentStatusesT&& value) {
    m_componentStatusesHasBeenSet = true;
    m_componentStatuses.emplace_back(std::forward<ComponentStatusesT>(value));
    return *this;
  }
  ///@}
 private:
