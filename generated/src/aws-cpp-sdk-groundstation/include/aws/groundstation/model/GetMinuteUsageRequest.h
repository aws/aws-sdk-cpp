...
/**
 * <p>Input for the <code>GetMinuteUsage</code> operation.</p><p><h3>See Also:</h3>
 * <a
...
class GetMinuteUsageRequest : public GroundStationRequest {
 public:
  ...
  inline GetMinuteUsageRequest& WithMonth(int value) {
    SetMonth(value);
    return *this;
  }
  ///@}
  ...
  inline GetMinuteUsageRequest& WithYear(int value) {
    SetYear(value);
    return *this;
  }
  ///@}
