...
/**
 * <p>Input for the <code>ListDataflowEndpointGroups</code> operation.
 * </p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/groundstation-2019-05-23/ListDataflowEndpointGroupsRequest">AWS
 * API Reference</a></p>
 */
class ListDataflowEndpointGroupsRequest : public GroundStationRequest {
 public:
  AWS_GROUNDSTATION_API ListDataflowEndpointGroupsRequest() = default;
  ...
  inline ListDataflowEndpointGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataflowEndpointGroupsRequest& WithNextToken(NextTokenT&& value) {
