...
class DataflowEndpointConfig {
 public:
  ...
  void SetDataflowEndpointName(DataflowEndpointNameT&& value) {
    ...
    m_dataflowEndpointName = std::forward<DataflowEndpointNameT>(value);
  }
  template <typename DataflowEndpointNameT = Aws::String>
  DataflowEndpointConfig& WithDataflowEndpointName(DataflowEndpointNameT&& value) {
    SetDataflowEndpointName(std::forward<DataflowEndpointNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataflowEndpointRegion(DataflowEndpointRegionT&& value) {
    ...
    m_dataflowEndpointRegion = std::forward<DataflowEndpointRegionT>(value);
  }
  template <typename DataflowEndpointRegionT = Aws::String>
  DataflowEndpointConfig& WithDataflowEndpointRegion(DataflowEndpointRegionT&& value) {
    SetDataflowEndpointRegion(std::forward<DataflowEndpointRegionT>(value));
    return *this;
  }
  ///@}
 private:
