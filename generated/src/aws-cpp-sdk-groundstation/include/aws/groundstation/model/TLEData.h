...
class TLEData {
 public:
  ...
  void SetTleLine1(TleLine1T&& value) {
    ...
    m_tleLine1 = std::forward<TleLine1T>(value);
  }
  template <typename TleLine1T = Aws::String>
  TLEData& WithTleLine1(TleLine1T&& value) {
    SetTleLine1(std::forward<TleLine1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetTleLine2(TleLine2T&& value) {
    ...
    m_tleLine2 = std::forward<TleLine2T>(value);
  }
  template <typename TleLine2T = Aws::String>
  TLEData& WithTleLine2(TleLine2T&& value) {
    SetTleLine2(std::forward<TleLine2T>(value));
    return *this;
  }
  ///@}
