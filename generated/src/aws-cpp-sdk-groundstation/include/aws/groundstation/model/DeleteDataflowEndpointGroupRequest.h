...
/**
 * <p>Input for the <code>DeleteDataflowEndpointGroup</code> operation.
...
class DeleteDataflowEndpointGroupRequest : public GroundStationRequest {
 public:
  ...
  template <typename DataflowEndpointGroupIdT = Aws::String>
  DeleteDataflowEndpointGroupRequest& WithDataflowEndpointGroupId(DataflowEndpointGroupIdT&& value) {
