...
/**
 */
class ListAntennasRequest : public GroundStationRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ListAntennas"; }
  ...
  inline ListAntennasRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>Next token returned in the request of a previous <code>ListAntennas</code>
