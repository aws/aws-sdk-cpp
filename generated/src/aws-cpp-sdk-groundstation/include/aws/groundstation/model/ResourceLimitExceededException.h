...
namespace Model
{
  ...
  {
  public:
    AWS_GROUNDSTATION_API ResourceLimitExceededException() = default;
    ...
    template<typename ParameterNameT = Aws::String>
    ResourceLimitExceededException& WithParameterName(ParameterNameT&& value) { SetParameterName(std::forward<ParameterNameT>(value)); return *this;}
    ///@}
  private:
