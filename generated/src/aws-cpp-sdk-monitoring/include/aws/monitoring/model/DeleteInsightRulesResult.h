...
class DeleteInsightRulesResult {
 public:
  AWS_CLOUDWATCH_API DeleteInsightRulesResult() = default;
  AWS_CLOUDWATCH_API DeleteInsightRulesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_CLOUDWATCH_API DeleteInsightRulesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename FailuresT = Aws::Vector<PartialFailure>>
  DeleteInsightRulesResult& WithFailures(FailuresT&& value) {
    SetFailures(std::forward<FailuresT>(value));
    return *this;
  }
  template <typename FailuresT = PartialFailure>
  DeleteInsightRulesResult& AddFailures(FailuresT&& value) {
    m_failuresHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteInsightRulesResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteInsightRulesResult& WithResponseMetadata(ResponseMetadataT&& value) {
