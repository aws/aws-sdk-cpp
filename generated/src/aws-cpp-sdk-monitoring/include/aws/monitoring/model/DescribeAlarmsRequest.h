...
class DescribeAlarmsRequest : public CloudWatchRequest {
 ...
 public:
  ...
  void SetAlarmNamePrefix(AlarmNamePrefixT&& value) {
    m_alarmNamePrefixHasBeenSet = true;
    m_alarmNamePrefix = std::forward<AlarmNamePrefixT>(value);
  }
  template <typename AlarmNamePrefixT = Aws::String>
  DescribeAlarmsRequest& WithAlarmNamePrefix(AlarmNamePrefixT&& value) {
    SetAlarmNamePrefix(std::forward<AlarmNamePrefixT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAlarmTypes(AlarmTypesT&& value) {
    ...
    m_alarmTypes = std::forward<AlarmTypesT>(value);
  }
  template <typename AlarmTypesT = Aws::Vector<AlarmType>>
  DescribeAlarmsRequest& WithAlarmTypes(AlarmTypesT&& value) {
    SetAlarmTypes(std::forward<AlarmTypesT>(value));
    return *this;
  }
  inline DescribeAlarmsRequest& AddAlarmTypes(AlarmType value) {
    m_alarmTypesHasBeenSet = true;
    m_alarmTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetChildrenOfAlarmName(ChildrenOfAlarmNameT&& value) {
    m_childrenOfAlarmNameHasBeenSet = true;
    m_childrenOfAlarmName = std::forward<ChildrenOfAlarmNameT>(value);
  }
  template <typename ChildrenOfAlarmNameT = Aws::String>
  DescribeAlarmsRequest& WithChildrenOfAlarmName(ChildrenOfAlarmNameT&& value) {
    SetChildrenOfAlarmName(std::forward<ChildrenOfAlarmNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetParentsOfAlarmName(ParentsOfAlarmNameT&& value) {
    m_parentsOfAlarmNameHasBeenSet = true;
    m_parentsOfAlarmName = std::forward<ParentsOfAlarmNameT>(value);
  }
  template <typename ParentsOfAlarmNameT = Aws::String>
  DescribeAlarmsRequest& WithParentsOfAlarmName(ParentsOfAlarmNameT&& value) {
    SetParentsOfAlarmName(std::forward<ParentsOfAlarmNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeAlarmsRequest& WithStateValue(StateValue value) {
    SetStateValue(value);
    return *this;
  }
  ///@}
  ...
  void SetActionPrefix(ActionPrefixT&& value) {
    m_actionPrefixHasBeenSet = true;
    m_actionPrefix = std::forward<ActionPrefixT>(value);
  }
  template <typename ActionPrefixT = Aws::String>
  DescribeAlarmsRequest& WithActionPrefix(ActionPrefixT&& value) {
    SetActionPrefix(std::forward<ActionPrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeAlarmsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
