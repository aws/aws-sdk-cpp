...
class PutAlarmMuteRuleRequest : public CloudWatchRequest {
 public:
  ...
  ///@{
  /**
   * <p>The date and time after which the mute rule takes effect, specified as a
   * timestamp in ISO 8601 format (for example, <code>2026-04-15T08:00:00Z</code>).
   * If not specified, the mute rule takes effect immediately upon creation and the
   * mutes are applied as per the schedule expression.</p>
   */
   ...
   * <code>2026-12-31T23:59:59Z</code>). After this time, the rule status becomes
   * EXPIRED and will no longer mute the targeted alarms.</p>
   */
