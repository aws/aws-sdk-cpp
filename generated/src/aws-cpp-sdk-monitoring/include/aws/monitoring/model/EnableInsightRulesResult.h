...
class EnableInsightRulesResult {
 public:
  ...
  AWS_CLOUDWATCH_API EnableInsightRulesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_CLOUDWATCH_API EnableInsightRulesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename FailuresT = Aws::Vector<PartialFailure>>
  EnableInsightRulesResult& WithFailures(FailuresT&& value) {
    SetFailures(std::forward<FailuresT>(value));
    return *this;
  }
  template <typename FailuresT = PartialFailure>
  EnableInsightRulesResult& AddFailures(FailuresT&& value) {
    m_failuresHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  EnableInsightRulesResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  EnableInsightRulesResult& WithResponseMetadata(ResponseMetadataT&& value) {
