...
class DescribeAlarmsForMetricRequest : public CloudWatchRequest {
 public:
  ...
  template <typename MetricNameT = Aws::String>
  DescribeAlarmsForMetricRequest& WithMetricName(MetricNameT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  DescribeAlarmsForMetricRequest& WithNamespace(NamespaceT&& value) {
  ...
  inline DescribeAlarmsForMetricRequest& WithStatistic(Statistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  template <typename ExtendedStatisticT = Aws::String>
  DescribeAlarmsForMetricRequest& WithExtendedStatistic(ExtendedStatisticT&& value) {
  ...
  template <typename DimensionsT = Aws::Vector<Dimension>>
  DescribeAlarmsForMetricRequest& WithDimensions(DimensionsT&& value) {
    SetDimensions(std::forward<DimensionsT>(value));
    return *this;
  }
  template <typename DimensionsT = Dimension>
  DescribeAlarmsForMetricRequest& AddDimensions(DimensionsT&& value) {
    m_dimensionsHasBeenSet = true;
  ...
  inline DescribeAlarmsForMetricRequest& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeAlarmsForMetricRequest& WithUnit(StandardUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
