...
class ListDashboardsRequest : public CloudWatchRequest {
 ...
 public:
  ...
  void SetDashboardNamePrefix(DashboardNamePrefixT&& value) {
    m_dashboardNamePrefixHasBeenSet = true;
    m_dashboardNamePrefix = std::forward<DashboardNamePrefixT>(value);
  }
  template <typename DashboardNamePrefixT = Aws::String>
  ListDashboardsRequest& WithDashboardNamePrefix(DashboardNamePrefixT&& value) {
    SetDashboardNamePrefix(std::forward<DashboardNamePrefixT>(value));
    return *this;
  }
  ///@}
