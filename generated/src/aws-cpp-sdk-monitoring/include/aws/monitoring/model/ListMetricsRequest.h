...
class ListMetricsRequest : public CloudWatchRequest {
 ...
 public:
  ...
  inline void SetRecentlyActive(RecentlyActive value) {
    m_recentlyActiveHasBeenSet = true;
    m_recentlyActive = value;
  }
  inline ListMetricsRequest& WithRecentlyActive(RecentlyActive value) {
  ...
  inline ListMetricsRequest& WithIncludeLinkedAccounts(bool value) {
