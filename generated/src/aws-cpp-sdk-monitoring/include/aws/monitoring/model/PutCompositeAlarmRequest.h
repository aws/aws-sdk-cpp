...
class PutCompositeAlarmRequest : public CloudWatchRequest {
 ...
 public:
  ...
  inline PutCompositeAlarmRequest& WithActionsEnabled(bool value) {
  ...
  inline PutCompositeAlarmRequest& WithActionsSuppressorWaitPeriod(int value) {
  ...
  inline PutCompositeAlarmRequest& WithActionsSuppressorExtensionPeriod(int value) {
