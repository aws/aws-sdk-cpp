...
class PutMetricStreamRequest : public CloudWatchRequest {
 ...
 public:
  ...
  template <typename NameT = Aws::String>
  PutMetricStreamRequest& WithName(NameT&& value) {
  ...
  template <typename IncludeFiltersT = Aws::Vector<MetricStreamFilter>>
  PutMetricStreamRequest& WithIncludeFilters(IncludeFiltersT&& value) {
    SetIncludeFilters(std::forward<IncludeFiltersT>(value));
    return *this;
  }
  template <typename IncludeFiltersT = MetricStreamFilter>
  PutMetricStreamRequest& AddIncludeFilters(IncludeFiltersT&& value) {
    m_includeFiltersHasBeenSet = true;
  ...
  template <typename ExcludeFiltersT = Aws::Vector<MetricStreamFilter>>
  PutMetricStreamRequest& WithExcludeFilters(ExcludeFiltersT&& value) {
    SetExcludeFilters(std::forward<ExcludeFiltersT>(value));
    return *this;
  }
  template <typename ExcludeFiltersT = MetricStreamFilter>
  PutMetricStreamRequest& AddExcludeFilters(ExcludeFiltersT&& value) {
    m_excludeFiltersHasBeenSet = true;
  ...
  template <typename FirehoseArnT = Aws::String>
  PutMetricStreamRequest& WithFirehoseArn(FirehoseArnT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  PutMetricStreamRequest& WithRoleArn(RoleArnT&& value) {
  ...
  inline PutMetricStreamRequest& WithOutputFormat(MetricStreamOutputFormat value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  PutMetricStreamRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  PutMetricStreamRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename StatisticsConfigurationsT = Aws::Vector<MetricStreamStatisticsConfiguration>>
  PutMetricStreamRequest& WithStatisticsConfigurations(StatisticsConfigurationsT&& value) {
  ...
  PutMetricStreamRequest& AddStatisticsConfigurations(StatisticsConfigurationsT&& value) {
    m_statisticsConfigurationsHasBeenSet = true;
  ...
  inline PutMetricStreamRequest& WithIncludeLinkedAccountsMetrics(bool value) {
