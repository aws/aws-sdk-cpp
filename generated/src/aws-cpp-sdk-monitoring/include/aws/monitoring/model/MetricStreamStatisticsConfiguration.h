...
class MetricStreamStatisticsConfiguration {
 public:
  ...
  void SetAdditionalStatistics(AdditionalStatisticsT&& value) {
    ...
    m_additionalStatistics = std::forward<AdditionalStatisticsT>(value);
  }
  template <typename AdditionalStatisticsT = Aws::Vector<Aws::String>>
  MetricStreamStatisticsConfiguration& WithAdditionalStatistics(AdditionalStatisticsT&& value) {
    SetAdditionalStatistics(std::forward<AdditionalStatisticsT>(value));
    return *this;
  }
  ...
  MetricStreamStatisticsConfiguration& AddAdditionalStatistics(AdditionalStatisticsT&& value) {
    m_additionalStatisticsHasBeenSet = true;
    m_additionalStatistics.emplace_back(std::forward<AdditionalStatisticsT>(value));
    return *this;
  }
  ///@}
 private:
