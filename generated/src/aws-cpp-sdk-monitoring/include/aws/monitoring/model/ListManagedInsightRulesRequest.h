...
class ListManagedInsightRulesRequest : public CloudWatchRequest {
 public:
  AWS_CLOUDWATCH_API ListManagedInsightRulesRequest() = default;
 ...
 public:
  ...
  template <typename ResourceARNT = Aws::String>
  ListManagedInsightRulesRequest& WithResourceARN(ResourceARNT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListManagedInsightRulesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListManagedInsightRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
