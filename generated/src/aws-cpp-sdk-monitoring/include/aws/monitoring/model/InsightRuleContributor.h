...
class InsightRuleContributor {
 public:
  ...
  inline void SetApproximateAggregateValue(double value) {
    m_approximateAggregateValueHasBeenSet = true;
    m_approximateAggregateValue = value;
  }
  inline InsightRuleContributor& WithApproximateAggregateValue(double value) {
    SetApproximateAggregateValue(value);
    return *this;
  }
  ///@}
