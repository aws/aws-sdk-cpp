...
class GetMetricDataRequest : public CloudWatchRequest {
 ...
 public:
  ...
  inline void SetScanBy(ScanBy value) {
    m_scanByHasBeenSet = true;
    m_scanBy = value;
  }
  inline GetMetricDataRequest& WithScanBy(ScanBy value) {
    SetScanBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxDatapoints(int value) {
    m_maxDatapointsHasBeenSet = true;
    m_maxDatapoints = value;
  }
  inline GetMetricDataRequest& WithMaxDatapoints(int value) {
  ...
  void SetLabelOptions(LabelOptionsT&& value) {
    ...
    m_labelOptions = std::forward<LabelOptionsT>(value);
  }
  template <typename LabelOptionsT = LabelOptions>
  GetMetricDataRequest& WithLabelOptions(LabelOptionsT&& value) {
    SetLabelOptions(std::forward<LabelOptionsT>(value));
    return *this;
  }
  ///@}
 private:
