...
namespace Model
{
  ...
  public:
    ...
    template<typename AlarmNamesT = Aws::Vector<Aws::String>>
    EnableAlarmActionsRequest& WithAlarmNames(AlarmNamesT&& value) { SetAlarmNames(std::forward<AlarmNamesT>(value)); return *this;}
    template<typename AlarmNamesT = Aws::String>
    EnableAlarmActionsRequest& AddAlarmNames(AlarmNamesT&& value) { m_alarmNamesHasBeenSet = true; m_alarmNames.emplace_back(std::forward<AlarmNamesT>(value)); return *this; }
    ///@}
  private:
