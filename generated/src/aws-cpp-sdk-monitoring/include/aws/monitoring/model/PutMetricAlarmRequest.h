...
class PutMetricAlarmRequest : public CloudWatchRequest {
 public:
  ...
  inline PutMetricAlarmRequest& WithActionsEnabled(bool value) {
  ...
  inline PutMetricAlarmRequest& WithStatistic(Statistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  void SetExtendedStatistic(ExtendedStatisticT&& value) {
    ...
    m_extendedStatistic = std::forward<ExtendedStatisticT>(value);
  }
  template <typename ExtendedStatisticT = Aws::String>
  PutMetricAlarmRequest& WithExtendedStatistic(ExtendedStatisticT&& value) {
    SetExtendedStatistic(std::forward<ExtendedStatisticT>(value));
    return *this;
  }
  ///@}
  ...
  inline PutMetricAlarmRequest& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline PutMetricAlarmRequest& WithUnit(StandardUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline PutMetricAlarmRequest& WithEvaluationPeriods(int value) {
  ...
  inline PutMetricAlarmRequest& WithDatapointsToAlarm(int value) {
  ...
  inline PutMetricAlarmRequest& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline PutMetricAlarmRequest& WithComparisonOperator(ComparisonOperator value) {
  ...
  void SetEvaluateLowSampleCountPercentile(EvaluateLowSampleCountPercentileT&& value) {
    ...
    m_evaluateLowSampleCountPercentile = std::forward<EvaluateLowSampleCountPercentileT>(value);
  }
  template <typename EvaluateLowSampleCountPercentileT = Aws::String>
  PutMetricAlarmRequest& WithEvaluateLowSampleCountPercentile(EvaluateLowSampleCountPercentileT&& value) {
    SetEvaluateLowSampleCountPercentile(std::forward<EvaluateLowSampleCountPercentileT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThresholdMetricId(ThresholdMetricIdT&& value) {
    ...
    m_thresholdMetricId = std::forward<ThresholdMetricIdT>(value);
  }
  template <typename ThresholdMetricIdT = Aws::String>
  PutMetricAlarmRequest& WithThresholdMetricId(ThresholdMetricIdT&& value) {
    SetThresholdMetricId(std::forward<ThresholdMetricIdT>(value));
    return *this;
  }
  ///@}
 private:
