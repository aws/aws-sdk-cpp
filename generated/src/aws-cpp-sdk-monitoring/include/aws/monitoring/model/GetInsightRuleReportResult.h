...
class GetInsightRuleReportResult {
 public:
  ...
  void SetKeyLabels(KeyLabelsT&& value) {
    m_keyLabelsHasBeenSet = true;
    m_keyLabels = std::forward<KeyLabelsT>(value);
  }
  template <typename KeyLabelsT = Aws::Vector<Aws::String>>
  GetInsightRuleReportResult& WithKeyLabels(KeyLabelsT&& value) {
    SetKeyLabels(std::forward<KeyLabelsT>(value));
    return *this;
  }
  template <typename KeyLabelsT = Aws::String>
  GetInsightRuleReportResult& AddKeyLabels(KeyLabelsT&& value) {
    m_keyLabelsHasBeenSet = true;
    m_keyLabels.emplace_back(std::forward<KeyLabelsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAggregationStatistic(AggregationStatisticT&& value) {
    m_aggregationStatisticHasBeenSet = true;
    m_aggregationStatistic = std::forward<AggregationStatisticT>(value);
  }
  template <typename AggregationStatisticT = Aws::String>
  GetInsightRuleReportResult& WithAggregationStatistic(AggregationStatisticT&& value) {
    SetAggregationStatistic(std::forward<AggregationStatisticT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAggregateValue(double value) {
    m_aggregateValueHasBeenSet = true;
    m_aggregateValue = value;
  }
  inline GetInsightRuleReportResult& WithAggregateValue(double value) {
  ...
  inline void SetApproximateUniqueCount(long long value) {
    m_approximateUniqueCountHasBeenSet = true;
    m_approximateUniqueCount = value;
  }
  inline GetInsightRuleReportResult& WithApproximateUniqueCount(long long value) {
    SetApproximateUniqueCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename ContributorsT = Aws::Vector<InsightRuleContributor>>
  GetInsightRuleReportResult& WithContributors(ContributorsT&& value) {
    SetContributors(std::forward<ContributorsT>(value));
    return *this;
  }
  template <typename ContributorsT = InsightRuleContributor>
  GetInsightRuleReportResult& AddContributors(ContributorsT&& value) {
    m_contributorsHasBeenSet = true;
  ...
  template <typename MetricDatapointsT = Aws::Vector<InsightRuleMetricDatapoint>>
  GetInsightRuleReportResult& WithMetricDatapoints(MetricDatapointsT&& value) {
    SetMetricDatapoints(std::forward<MetricDatapointsT>(value));
    return *this;
  }
  template <typename MetricDatapointsT = InsightRuleMetricDatapoint>
  GetInsightRuleReportResult& AddMetricDatapoints(MetricDatapointsT&& value) {
    m_metricDatapointsHasBeenSet = true;
