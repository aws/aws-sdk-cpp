...
namespace Model
{
  ...
  public:
    ...
    template<typename RuleNamesT = Aws::Vector<Aws::String>>
    DeleteInsightRulesRequest& WithRuleNames(RuleNamesT&& value) { SetRuleNames(std::forward<RuleNamesT>(value)); return *this;}
    template<typename RuleNamesT = Aws::String>
    DeleteInsightRulesRequest& AddRuleNames(RuleNamesT&& value) { m_ruleNamesHasBeenSet = true; m_ruleNames.emplace_back(std::forward<RuleNamesT>(value)); return *this; }
    ///@}
  private:
