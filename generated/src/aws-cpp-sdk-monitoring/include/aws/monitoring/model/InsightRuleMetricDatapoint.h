...
class InsightRuleMetricDatapoint {
 public:
  ...
  inline void SetUniqueContributors(double value) {
    m_uniqueContributorsHasBeenSet = true;
    m_uniqueContributors = value;
  }
  inline InsightRuleMetricDatapoint& WithUniqueContributors(double value) {
    SetUniqueContributors(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxContributorValue(double value) {
    m_maxContributorValueHasBeenSet = true;
    m_maxContributorValue = value;
  }
  inline InsightRuleMetricDatapoint& WithMaxContributorValue(double value) {
    SetMaxContributorValue(value);
    return *this;
  }
  ///@}
  ...
  inline InsightRuleMetricDatapoint& WithSampleCount(double value) {
  ...
  inline InsightRuleMetricDatapoint& WithAverage(double value) {
    SetAverage(value);
    return *this;
  }
  ///@}
  ...
  inline InsightRuleMetricDatapoint& WithSum(double value) {
    SetSum(value);
    return *this;
  }
  ///@}
  ...
  inline InsightRuleMetricDatapoint& WithMinimum(double value) {
    SetMinimum(value);
    return *this;
  }
  ///@}
  ...
  inline InsightRuleMetricDatapoint& WithMaximum(double value) {
    SetMaximum(value);
    return *this;
  }
  ///@}
