...
class DescribeAlarmHistoryRequest : public CloudWatchRequest {
 ...
 public:
  ...
  template <typename AlarmContributorIdT = Aws::String>
  DescribeAlarmHistoryRequest& WithAlarmContributorId(AlarmContributorIdT&& value) {
  ...
  inline DescribeAlarmHistoryRequest& AddAlarmTypes(AlarmType value) {
    m_alarmTypesHasBeenSet = true;
  ...
  inline DescribeAlarmHistoryRequest& WithHistoryItemType(HistoryItemType value) {
  ...
  inline DescribeAlarmHistoryRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeAlarmHistoryRequest& WithScanBy(ScanBy value) {
    SetScanBy(value);
    return *this;
  }
  ///@}
