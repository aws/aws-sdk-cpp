...
class GetMetricStatisticsRequest : public CloudWatchRequest {
 ...
 public:
  ...
  inline GetMetricStatisticsRequest& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline GetMetricStatisticsRequest& AddStatistics(Statistic value) {
    m_statisticsHasBeenSet = true;
  ...
  GetMetricStatisticsRequest& AddExtendedStatistics(ExtendedStatisticsT&& value) {
    m_extendedStatisticsHasBeenSet = true;
    m_extendedStatistics.emplace_back(std::forward<ExtendedStatisticsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetMetricStatisticsRequest& WithUnit(StandardUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
