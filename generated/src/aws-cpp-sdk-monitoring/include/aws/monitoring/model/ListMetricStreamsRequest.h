...
class ListMetricStreamsRequest : public CloudWatchRequest {
 public:
  AWS_CLOUDWATCH_API ListMetricStreamsRequest() = default;
 ...
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListMetricStreamsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMetricStreamsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
