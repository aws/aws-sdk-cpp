...
class DescribeInsightRulesRequest : public CloudWatchRequest {
 public:
  AWS_CLOUDWATCH_API DescribeInsightRulesRequest() = default;
 ...
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInsightRulesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeInsightRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
