...
class GetMetricWidgetImageRequest : public CloudWatchRequest {
 public:
  ...
  void SetMetricWidget(MetricWidgetT&& value) {
    m_metricWidgetHasBeenSet = true;
    m_metricWidget = std::forward<MetricWidgetT>(value);
  }
  template <typename MetricWidgetT = Aws::String>
  GetMetricWidgetImageRequest& WithMetricWidget(MetricWidgetT&& value) {
    SetMetricWidget(std::forward<MetricWidgetT>(value));
    return *this;
  }
  ///@}
