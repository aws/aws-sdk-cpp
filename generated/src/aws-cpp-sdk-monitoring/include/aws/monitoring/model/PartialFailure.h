...
class PartialFailure {
 public:
  ...
  void SetFailureResource(FailureResourceT&& value) {
    ...
    m_failureResource = std::forward<FailureResourceT>(value);
  }
  template <typename FailureResourceT = Aws::String>
  PartialFailure& WithFailureResource(FailureResourceT&& value) {
    SetFailureResource(std::forward<FailureResourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExceptionType(ExceptionTypeT&& value) {
    ...
    m_exceptionType = std::forward<ExceptionTypeT>(value);
  }
  template <typename ExceptionTypeT = Aws::String>
  PartialFailure& WithExceptionType(ExceptionTypeT&& value) {
    SetExceptionType(std::forward<ExceptionTypeT>(value));
    return *this;
  }
  ///@}
