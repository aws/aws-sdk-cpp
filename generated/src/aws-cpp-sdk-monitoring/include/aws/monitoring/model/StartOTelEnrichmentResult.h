...
namespace Model {
class StartOTelEnrichmentResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  StartOTelEnrichmentResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  StartOTelEnrichmentResult& WithResponseMetadata(ResponseMetadataT&& value) {
