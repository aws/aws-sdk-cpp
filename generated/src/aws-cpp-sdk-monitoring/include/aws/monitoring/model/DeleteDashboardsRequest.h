...
class DeleteDashboardsRequest : public CloudWatchRequest {
 public:
  ...
  void SetDashboardNames(DashboardNamesT&& value) {
    m_dashboardNamesHasBeenSet = true;
    m_dashboardNames = std::forward<DashboardNamesT>(value);
  }
  template <typename DashboardNamesT = Aws::Vector<Aws::String>>
  DeleteDashboardsRequest& WithDashboardNames(DashboardNamesT&& value) {
    SetDashboardNames(std::forward<DashboardNamesT>(value));
    return *this;
  }
  template <typename DashboardNamesT = Aws::String>
  DeleteDashboardsRequest& AddDashboardNames(DashboardNamesT&& value) {
    m_dashboardNamesHasBeenSet = true;
    m_dashboardNames.emplace_back(std::forward<DashboardNamesT>(value));
    return *this;
  }
  ///@}
 private:
