...
class DescribeAnomalyDetectorsRequest : public CloudWatchRequest {
 ...
 public:
  ...
  inline DescribeAnomalyDetectorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetAnomalyDetectorTypes(AnomalyDetectorTypesT&& value) {
    m_anomalyDetectorTypesHasBeenSet = true;
    m_anomalyDetectorTypes = std::forward<AnomalyDetectorTypesT>(value);
  }
  template <typename AnomalyDetectorTypesT = Aws::Vector<AnomalyDetectorType>>
  DescribeAnomalyDetectorsRequest& WithAnomalyDetectorTypes(AnomalyDetectorTypesT&& value) {
    SetAnomalyDetectorTypes(std::forward<AnomalyDetectorTypesT>(value));
    return *this;
  }
  inline DescribeAnomalyDetectorsRequest& AddAnomalyDetectorTypes(AnomalyDetectorType value) {
    m_anomalyDetectorTypesHasBeenSet = true;
    m_anomalyDetectorTypes.push_back(value);
    return *this;
  }
  ///@}
 private:
