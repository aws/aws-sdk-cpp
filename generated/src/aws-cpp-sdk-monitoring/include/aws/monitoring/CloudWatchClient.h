...
class AWS_CLOUDWATCH_API CloudWatchClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  CloudWatchClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<CloudWatchEndpointProviderBase> endpointProvider = nullptr,
      const Aws::CloudWatch::CloudWatchClientConfiguration& clientConfiguration = Aws::CloudWatch::CloudWatchClientConfiguration());
  ...
  /**
   * An Async wrapper for DeleteAlarms that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAlarmsRequestT = Model::DeleteAlarmsRequest>
  void DeleteAlarmsAsync(const DeleteAlarmsRequestT& request, const DeleteAlarmsResponseReceivedHandler& handler,
   ...
   */
  template <typename DeleteAnomalyDetectorRequestT = Model::DeleteAnomalyDetectorRequest>
  void DeleteAnomalyDetectorAsync(const DeleteAnomalyDetectorResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DeleteAnomalyDetectorRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteDashboards that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDashboards that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDashboardsRequestT = Model::DeleteDashboardsRequest>
  void DeleteDashboardsAsync(const DeleteDashboardsRequestT& request, const DeleteDashboardsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteInsightRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteInsightRules that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteInsightRulesRequestT = Model::DeleteInsightRulesRequest>
  void DeleteInsightRulesAsync(const DeleteInsightRulesRequestT& request, const DeleteInsightRulesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMetricStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMetricStream that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteMetricStreamRequestT = Model::DeleteMetricStreamRequest>
  ...
  /**
   * A Callable wrapper for DescribeAlarmContributors that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeAlarmContributorsRequestT = Model::DescribeAlarmContributorsRequest>
  Model::DescribeAlarmContributorsOutcomeCallable DescribeAlarmContributorsCallable(
      const DescribeAlarmContributorsRequestT& request) const {
    return SubmitCallable(&CloudWatchClient::DescribeAlarmContributors, request);
  }

  /**
   * An Async wrapper for DescribeAlarmContributors that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAlarmContributorsRequestT = Model::DescribeAlarmContributorsRequest>
  void DescribeAlarmContributorsAsync(const DescribeAlarmContributorsRequestT& request,
                                      const DescribeAlarmContributorsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAlarmHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAlarmHistory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAlarmHistoryRequestT = Model::DescribeAlarmHistoryRequest>
  void DescribeAlarmHistoryAsync(const DescribeAlarmHistoryResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeAlarmHistoryRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeAlarms that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeAlarmsRequestT = Model::DescribeAlarmsRequest>
  void DescribeAlarmsAsync(const DescribeAlarmsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const DescribeAlarmsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeAlarmsForMetric that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAlarmsForMetric that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAlarmsForMetricRequestT = Model::DescribeAlarmsForMetricRequest>
  void DescribeAlarmsForMetricAsync(const DescribeAlarmsForMetricRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeAnomalyDetectors that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeAnomalyDetectorsRequestT = Model::DescribeAnomalyDetectorsRequest>
  Model::DescribeAnomalyDetectorsOutcomeCallable DescribeAnomalyDetectorsCallable(
      const DescribeAnomalyDetectorsRequestT& request = {}) const {
    return SubmitCallable(&CloudWatchClient::DescribeAnomalyDetectors, request);
  }

  /**
   * An Async wrapper for DescribeAnomalyDetectors that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAnomalyDetectorsRequestT = Model::DescribeAnomalyDetectorsRequest>
  void DescribeAnomalyDetectorsAsync(const DescribeAnomalyDetectorsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeAnomalyDetectorsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeInsightRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeInsightRules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInsightRulesRequestT = Model::DescribeInsightRulesRequest>
  void DescribeInsightRulesAsync(const DescribeInsightRulesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeInsightRulesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DisableAlarmActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisableAlarmActions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisableAlarmActionsRequestT = Model::DisableAlarmActionsRequest>
  void DisableAlarmActionsAsync(const DisableAlarmActionsRequestT& request, const DisableAlarmActionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisableInsightRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisableInsightRules that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisableInsightRulesRequestT = Model::DisableInsightRulesRequest>
  void DisableInsightRulesAsync(const DisableInsightRulesRequestT& request, const DisableInsightRulesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for EnableAlarmActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableAlarmActions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename EnableAlarmActionsRequestT = Model::EnableAlarmActionsRequest>
  void EnableAlarmActionsAsync(const EnableAlarmActionsRequestT& request, const EnableAlarmActionsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for EnableInsightRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableInsightRules that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename EnableInsightRulesRequestT = Model::EnableInsightRulesRequest>
  void EnableInsightRulesAsync(const EnableInsightRulesRequestT& request, const EnableInsightRulesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetInsightRuleReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInsightRuleReport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetInsightRuleReportRequestT = Model::GetInsightRuleReportRequest>
  void GetInsightRuleReportAsync(const GetInsightRuleReportRequestT& request, const GetInsightRuleReportResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMetricStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMetricStatistics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMetricStatisticsRequestT = Model::GetMetricStatisticsRequest>
  void GetMetricStatisticsAsync(const GetMetricStatisticsRequestT& request, const GetMetricStatisticsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMetricStream that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMetricStreamRequestT = Model::GetMetricStreamRequest>
  void GetMetricStreamAsync(const GetMetricStreamRequestT& request, const GetMetricStreamResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMetricWidgetImage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMetricWidgetImage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMetricWidgetImageRequestT = Model::GetMetricWidgetImageRequest>
  void GetMetricWidgetImageAsync(const GetMetricWidgetImageRequestT& request, const GetMetricWidgetImageResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListManagedInsightRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListManagedInsightRules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListManagedInsightRulesRequestT = Model::ListManagedInsightRulesRequest>
  void ListManagedInsightRulesAsync(const ListManagedInsightRulesRequestT& request,
                                    const ListManagedInsightRulesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMetricStreams that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMetricStreams that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListMetricStreamsRequestT = Model::ListMetricStreamsRequest>
  void ListMetricStreamsAsync(const ListMetricStreamsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListMetricStreamsRequestT& request = {}) const {
   ...
   */
  template <typename PutAnomalyDetectorRequestT = Model::PutAnomalyDetectorRequest>
  void PutAnomalyDetectorAsync(const PutAnomalyDetectorResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const PutAnomalyDetectorRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PutCompositeAlarm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutCompositeAlarm that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutCompositeAlarmRequestT = Model::PutCompositeAlarmRequest>
  void PutCompositeAlarmAsync(const PutCompositeAlarmRequestT& request, const PutCompositeAlarmResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutDashboard that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutDashboardRequestT = Model::PutDashboardRequest>
  void PutDashboardAsync(const PutDashboardRequestT& request, const PutDashboardResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutInsightRule that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutInsightRuleRequestT = Model::PutInsightRuleRequest>
  ...
  /**
   * A Callable wrapper for PutManagedInsightRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutManagedInsightRules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutManagedInsightRulesRequestT = Model::PutManagedInsightRulesRequest>
  void PutManagedInsightRulesAsync(const PutManagedInsightRulesRequestT& request,
                                   const PutManagedInsightRulesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutMetricAlarm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutMetricAlarmRequestT = Model::PutMetricAlarmRequest>
  void PutMetricAlarmAsync(const PutMetricAlarmRequestT& request, const PutMetricAlarmResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutMetricData that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutMetricDataRequestT = Model::PutMetricDataRequest>
  void PutMetricDataAsync(const PutMetricDataRequestT& request, const PutMetricDataResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutMetricStream that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutMetricStreamRequestT = Model::PutMetricStreamRequest>
  void PutMetricStreamAsync(const PutMetricStreamRequestT& request, const PutMetricStreamResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SetAlarmState that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SetAlarmStateRequestT = Model::SetAlarmStateRequest>
  void SetAlarmStateAsync(const SetAlarmStateRequestT& request, const SetAlarmStateResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMetricStreams that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMetricStreams that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartMetricStreamsRequestT = Model::StartMetricStreamsRequest>
  void StartMetricStreamsAsync(const StartMetricStreamsRequestT& request, const StartMetricStreamsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopMetricStreams that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopMetricStreams that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopMetricStreamsRequestT = Model::StopMetricStreamsRequest>
