...
{
const size_t CloudWatchEndpointRules::RulesBlobStrLen = 3970;
const size_t CloudWatchEndpointRules::RulesBlobSize = 3971;
...
':','"','h','t','t','p','s',':','/','/','m','o','n','i','t','o','r','i','n','g','-','f','i','p','s',
...
'm','o','n','i','t','o','r','i','n','g','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
