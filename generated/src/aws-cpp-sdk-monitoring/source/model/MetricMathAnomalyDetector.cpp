...
MetricMathAnomalyDetector::MetricMathAnomalyDetector(const XmlNode& xmlNode) { *this = xmlNode; }
...
void MetricMathAnomalyDetector::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
