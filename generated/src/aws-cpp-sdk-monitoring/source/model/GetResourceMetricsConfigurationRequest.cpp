...
Aws::String GetResourceMetricsConfigurationRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection GetResourceMetricsConfigurationRequest::GetRequestSpecificHeaders() const {
