...
Aws::String UpdateOTelEnrichmentRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection UpdateOTelEnrichmentRequest::GetRequestSpecificHeaders() const {
