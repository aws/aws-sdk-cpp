...
AssociateDatasetKmsKeyResult::AssociateDatasetKmsKeyResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

AssociateDatasetKmsKeyResult& AssociateDatasetKmsKeyResult::operator=(
