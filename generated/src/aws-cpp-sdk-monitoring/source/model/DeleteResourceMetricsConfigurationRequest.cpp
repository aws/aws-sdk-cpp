...
Aws::String DeleteResourceMetricsConfigurationRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection DeleteResourceMetricsConfigurationRequest::GetRequestSpecificHeaders() const {
