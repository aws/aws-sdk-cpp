...
GetOTelEnrichmentResult::GetOTelEnrichmentResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) { *this = result; }

GetOTelEnrichmentResult& GetOTelEnrichmentResult::operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "Status") {
                ...
                if (val.has_value()) {
                  m_status = OTelEnrichmentStatusMapper::GetOTelEnrichmentStatusForName(
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_includeFilters.push_back(OTelEnrichmentMetricSelector(decoder));
                      }
                    }
                ...
                if (peekType_0.has_value() &&
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_excludeFilters.push_back(OTelEnrichmentMetricSelector(decoder));
                      }
                    }
                  } else  // IndefArrayStart
                  {
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("GetOTelEnrichmentResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
