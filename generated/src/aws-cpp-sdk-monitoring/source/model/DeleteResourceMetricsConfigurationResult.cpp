...
DeleteResourceMetricsConfigurationResult::DeleteResourceMetricsConfigurationResult(
    const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

DeleteResourceMetricsConfigurationResult& DeleteResourceMetricsConfigurationResult::operator=(
    const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
