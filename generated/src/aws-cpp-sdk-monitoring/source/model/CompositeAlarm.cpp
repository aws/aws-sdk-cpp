...
CompositeAlarm::CompositeAlarm(const XmlNode& xmlNode) { *this = xmlNode; }
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!actionsSuppressedByNode.IsNull()) {
      m_actionsSuppressedBy = ActionsSuppressedByMapper::GetActionsSuppressedByForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(actionsSuppressedByNode.GetText()).c_str()));
    ...
    if (!actionsSuppressorWaitPeriodNode.IsNull()) {
      m_actionsSuppressorWaitPeriod = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(actionsSuppressorWaitPeriodNode.GetText()).c_str()).c_str());
    ...
    if (!actionsSuppressorExtensionPeriodNode.IsNull()) {
      m_actionsSuppressorExtensionPeriod = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(actionsSuppressorExtensionPeriodNode.GetText()).c_str()).c_str());
...
void CompositeAlarm::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_actionsSuppressedByHasBeenSet) {
    oStream << location << index << locationValue << ".ActionsSuppressedBy="
            << StringUtils::URLEncode(ActionsSuppressedByMapper::GetNameForActionsSuppressedBy(m_actionsSuppressedBy)) << "&";
  }

  if (m_actionsSuppressedReasonHasBeenSet) {
    oStream << location << index << locationValue
            << ".ActionsSuppressedReason=" << StringUtils::URLEncode(m_actionsSuppressedReason.c_str()) << "&";
  }
...
void CompositeAlarm::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_actionsSuppressedByHasBeenSet) {
    oStream << location << ".ActionsSuppressedBy="
            << StringUtils::URLEncode(ActionsSuppressedByMapper::GetNameForActionsSuppressedBy(m_actionsSuppressedBy)) << "&";
  }
  if (m_actionsSuppressedReasonHasBeenSet) {
