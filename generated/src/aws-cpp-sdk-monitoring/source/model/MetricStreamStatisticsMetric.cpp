...
MetricStreamStatisticsMetric::MetricStreamStatisticsMetric(const XmlNode& xmlNode) { *this = xmlNode; }
...
void MetricStreamStatisticsMetric::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
