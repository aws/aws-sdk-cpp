...
DashboardValidationMessage::DashboardValidationMessage(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DashboardValidationMessage::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
