...
ResourceNotFoundException::ResourceNotFoundException(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ResourceNotFoundException::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
