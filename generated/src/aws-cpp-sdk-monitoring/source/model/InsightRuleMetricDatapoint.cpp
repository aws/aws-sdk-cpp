...
InsightRuleMetricDatapoint::InsightRuleMetricDatapoint(const XmlNode& xmlNode) { *this = xmlNode; }
...
InsightRuleMetricDatapoint& InsightRuleMetricDatapoint::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!uniqueContributorsNode.IsNull()) {
      m_uniqueContributors = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(uniqueContributorsNode.GetText()).c_str()).c_str());
    ...
    if (!maxContributorValueNode.IsNull()) {
      m_maxContributorValue = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maxContributorValueNode.GetText()).c_str()).c_str());
...
void InsightRuleMetricDatapoint::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
