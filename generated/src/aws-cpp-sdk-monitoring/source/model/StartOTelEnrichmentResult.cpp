...
StartOTelEnrichmentResult::StartOTelEnrichmentResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

StartOTelEnrichmentResult& StartOTelEnrichmentResult::operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("StartOTelEnrichmentResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
