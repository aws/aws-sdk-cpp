...
UpdateOTelEnrichmentResult::UpdateOTelEnrichmentResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

UpdateOTelEnrichmentResult& UpdateOTelEnrichmentResult::operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "IncludeFilters") {
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("UpdateOTelEnrichmentResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
