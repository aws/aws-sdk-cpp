...
Aws::String AssociateDatasetKmsKeyRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection AssociateDatasetKmsKeyRequest::GetRequestSpecificHeaders() const {
