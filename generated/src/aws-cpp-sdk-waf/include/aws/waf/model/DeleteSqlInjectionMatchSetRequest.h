...
class DeleteSqlInjectionMatchSetRequest : public WAFRequest {
 public:
  ...
  template <typename SqlInjectionMatchSetIdT = Aws::String>
  DeleteSqlInjectionMatchSetRequest& WithSqlInjectionMatchSetId(SqlInjectionMatchSetIdT&& value) {
  ...
  template <typename ChangeTokenT = Aws::String>
  DeleteSqlInjectionMatchSetRequest& WithChangeToken(ChangeTokenT&& value) {
