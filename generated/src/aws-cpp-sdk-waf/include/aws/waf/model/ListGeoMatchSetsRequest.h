...
/**
 */
class ListGeoMatchSetsRequest : public WAFRequest {
 public:
  AWS_WAF_API ListGeoMatchSetsRequest() = default;
  ...
  template <typename NextMarkerT = Aws::String>
  ListGeoMatchSetsRequest& WithNextMarker(NextMarkerT&& value) {
  ...
  inline ListGeoMatchSetsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
