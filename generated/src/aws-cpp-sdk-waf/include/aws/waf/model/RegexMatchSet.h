...
class RegexMatchSet {
 public:
  ...
  void SetRegexMatchTuples(RegexMatchTuplesT&& value) {
    ...
    m_regexMatchTuples = std::forward<RegexMatchTuplesT>(value);
  }
  template <typename RegexMatchTuplesT = Aws::Vector<RegexMatchTuple>>
  RegexMatchSet& WithRegexMatchTuples(RegexMatchTuplesT&& value) {
    SetRegexMatchTuples(std::forward<RegexMatchTuplesT>(value));
    return *this;
  }
  template <typename RegexMatchTuplesT = RegexMatchTuple>
  RegexMatchSet& AddRegexMatchTuples(RegexMatchTuplesT&& value) {
    m_regexMatchTuplesHasBeenSet = true;
    m_regexMatchTuples.emplace_back(std::forward<RegexMatchTuplesT>(value));
    return *this;
  }
  ///@}
 private:
