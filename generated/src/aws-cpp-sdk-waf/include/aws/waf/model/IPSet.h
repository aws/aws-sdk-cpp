...
class IPSet {
 public:
  ...
  void SetIPSetDescriptors(IPSetDescriptorsT&& value) {
    ...
    m_iPSetDescriptors = std::forward<IPSetDescriptorsT>(value);
  }
  template <typename IPSetDescriptorsT = Aws::Vector<IPSetDescriptor>>
  IPSet& WithIPSetDescriptors(IPSetDescriptorsT&& value) {
    SetIPSetDescriptors(std::forward<IPSetDescriptorsT>(value));
    return *this;
  }
  template <typename IPSetDescriptorsT = IPSetDescriptor>
  IPSet& AddIPSetDescriptors(IPSetDescriptorsT&& value) {
    m_iPSetDescriptorsHasBeenSet = true;
    m_iPSetDescriptors.emplace_back(std::forward<IPSetDescriptorsT>(value));
    return *this;
  }
  ///@}
 private:
