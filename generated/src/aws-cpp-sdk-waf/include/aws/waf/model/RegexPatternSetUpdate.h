...
class RegexPatternSetUpdate {
 public:
  ...
  inline RegexPatternSetUpdate& WithAction(ChangeAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetRegexPatternString(RegexPatternStringT&& value) {
    ...
    m_regexPatternString = std::forward<RegexPatternStringT>(value);
  }
  template <typename RegexPatternStringT = Aws::String>
  RegexPatternSetUpdate& WithRegexPatternString(RegexPatternStringT&& value) {
    SetRegexPatternString(std::forward<RegexPatternStringT>(value));
    return *this;
  }
  ///@}
 private:
