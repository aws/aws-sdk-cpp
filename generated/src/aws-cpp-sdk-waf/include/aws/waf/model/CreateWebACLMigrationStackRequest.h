...
class CreateWebACLMigrationStackRequest : public WAFRequest {
 public:
  ...
  template <typename WebACLIdT = Aws::String>
  CreateWebACLMigrationStackRequest& WithWebACLId(WebACLIdT&& value) {
  ...
  template <typename S3BucketNameT = Aws::String>
  CreateWebACLMigrationStackRequest& WithS3BucketName(S3BucketNameT&& value) {
  ...
  inline void SetIgnoreUnsupportedType(bool value) {
    m_ignoreUnsupportedTypeHasBeenSet = true;
    m_ignoreUnsupportedType = value;
  }
  inline CreateWebACLMigrationStackRequest& WithIgnoreUnsupportedType(bool value) {
    SetIgnoreUnsupportedType(value);
    return *this;
  }
  ///@}
 private:
