...
class SizeConstraint {
 public:
  ...
  inline SizeConstraint& WithTextTransformation(TextTransformation value) {
  ...
  inline SizeConstraint& WithComparisonOperator(ComparisonOperator value) {
  ...
  inline SizeConstraint& WithSize(long long value) {
    SetSize(value);
    return *this;
  }
  ///@}
