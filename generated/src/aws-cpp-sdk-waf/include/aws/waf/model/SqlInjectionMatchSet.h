...
class SqlInjectionMatchSet {
 public:
  ...
  void SetSqlInjectionMatchSetId(SqlInjectionMatchSetIdT&& value) {
    ...
    m_sqlInjectionMatchSetId = std::forward<SqlInjectionMatchSetIdT>(value);
  }
  template <typename SqlInjectionMatchSetIdT = Aws::String>
  SqlInjectionMatchSet& WithSqlInjectionMatchSetId(SqlInjectionMatchSetIdT&& value) {
    SetSqlInjectionMatchSetId(std::forward<SqlInjectionMatchSetIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSqlInjectionMatchTuples(SqlInjectionMatchTuplesT&& value) {
    ...
    m_sqlInjectionMatchTuples = std::forward<SqlInjectionMatchTuplesT>(value);
  }
  template <typename SqlInjectionMatchTuplesT = Aws::Vector<SqlInjectionMatchTuple>>
  SqlInjectionMatchSet& WithSqlInjectionMatchTuples(SqlInjectionMatchTuplesT&& value) {
    SetSqlInjectionMatchTuples(std::forward<SqlInjectionMatchTuplesT>(value));
    return *this;
  }
  ...
  SqlInjectionMatchSet& AddSqlInjectionMatchTuples(SqlInjectionMatchTuplesT&& value) {
    m_sqlInjectionMatchTuplesHasBeenSet = true;
    m_sqlInjectionMatchTuples.emplace_back(std::forward<SqlInjectionMatchTuplesT>(value));
    return *this;
  }
  ///@}
 private:
