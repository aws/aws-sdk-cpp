...
namespace Model
{
  ...
  {
  public:
    AWS_WAF_API ListRateBasedRulesRequest() = default;
    ...
    template<typename NextMarkerT = Aws::String>
    ListRateBasedRulesRequest& WithNextMarker(NextMarkerT&& value) { SetNextMarker(std::forward<NextMarkerT>(value)); return *this;}
    ///@}
