...
namespace Model
{
  ...
  /**
   */
  class ListRegexPatternSetsRequest : public WAFRequest
  {
  public:
    AWS_WAF_API ListRegexPatternSetsRequest() = default;
    ...
    template<typename NextMarkerT = Aws::String>
    ListRegexPatternSetsRequest& WithNextMarker(NextMarkerT&& value) { SetNextMarker(std::forward<NextMarkerT>(value)); return *this;}
    ///@}
