...
class GeoMatchConstraint {
 public:
  ...
  inline void SetType(GeoMatchConstraintType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline GeoMatchConstraint& WithType(GeoMatchConstraintType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetValue(GeoMatchConstraintValue value) {
    m_valueHasBeenSet = true;
    m_value = value;
  }
  inline GeoMatchConstraint& WithValue(GeoMatchConstraintValue value) {
    SetValue(value);
    return *this;
  }
  ///@}
