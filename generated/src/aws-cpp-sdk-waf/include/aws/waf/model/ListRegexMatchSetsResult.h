...
class ListRegexMatchSetsResult {
 public:
  AWS_WAF_API ListRegexMatchSetsResult() = default;
  ...
  template <typename NextMarkerT = Aws::String>
  ListRegexMatchSetsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetRegexMatchSets(RegexMatchSetsT&& value) {
    m_regexMatchSetsHasBeenSet = true;
    m_regexMatchSets = std::forward<RegexMatchSetsT>(value);
  }
  template <typename RegexMatchSetsT = Aws::Vector<RegexMatchSetSummary>>
  ListRegexMatchSetsResult& WithRegexMatchSets(RegexMatchSetsT&& value) {
    SetRegexMatchSets(std::forward<RegexMatchSetsT>(value));
    return *this;
  }
  template <typename RegexMatchSetsT = RegexMatchSetSummary>
  ListRegexMatchSetsResult& AddRegexMatchSets(RegexMatchSetsT&& value) {
    m_regexMatchSetsHasBeenSet = true;
    m_regexMatchSets.emplace_back(std::forward<RegexMatchSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListRegexMatchSetsResult& WithRequestId(RequestIdT&& value) {
