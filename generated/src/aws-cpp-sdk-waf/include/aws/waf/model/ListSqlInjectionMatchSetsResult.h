...
class ListSqlInjectionMatchSetsResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListSqlInjectionMatchSetsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetSqlInjectionMatchSets(SqlInjectionMatchSetsT&& value) {
    m_sqlInjectionMatchSetsHasBeenSet = true;
    m_sqlInjectionMatchSets = std::forward<SqlInjectionMatchSetsT>(value);
  }
  template <typename SqlInjectionMatchSetsT = Aws::Vector<SqlInjectionMatchSetSummary>>
  ListSqlInjectionMatchSetsResult& WithSqlInjectionMatchSets(SqlInjectionMatchSetsT&& value) {
    SetSqlInjectionMatchSets(std::forward<SqlInjectionMatchSetsT>(value));
    return *this;
  }
  template <typename SqlInjectionMatchSetsT = SqlInjectionMatchSetSummary>
  ListSqlInjectionMatchSetsResult& AddSqlInjectionMatchSets(SqlInjectionMatchSetsT&& value) {
    m_sqlInjectionMatchSetsHasBeenSet = true;
    m_sqlInjectionMatchSets.emplace_back(std::forward<SqlInjectionMatchSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListSqlInjectionMatchSetsResult& WithRequestId(RequestIdT&& value) {
