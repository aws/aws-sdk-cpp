...
class ListXssMatchSetsResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListXssMatchSetsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetXssMatchSets(XssMatchSetsT&& value) {
    m_xssMatchSetsHasBeenSet = true;
    m_xssMatchSets = std::forward<XssMatchSetsT>(value);
  }
  template <typename XssMatchSetsT = Aws::Vector<XssMatchSetSummary>>
  ListXssMatchSetsResult& WithXssMatchSets(XssMatchSetsT&& value) {
    SetXssMatchSets(std::forward<XssMatchSetsT>(value));
    return *this;
  }
  template <typename XssMatchSetsT = XssMatchSetSummary>
  ListXssMatchSetsResult& AddXssMatchSets(XssMatchSetsT&& value) {
    m_xssMatchSetsHasBeenSet = true;
    m_xssMatchSets.emplace_back(std::forward<XssMatchSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListXssMatchSetsResult& WithRequestId(RequestIdT&& value) {
