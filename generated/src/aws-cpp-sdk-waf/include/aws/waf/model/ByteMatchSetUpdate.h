...
class ByteMatchSetUpdate {
 public:
  ...
  inline ByteMatchSetUpdate& WithAction(ChangeAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetByteMatchTuple(ByteMatchTupleT&& value) {
    ...
    m_byteMatchTuple = std::forward<ByteMatchTupleT>(value);
  }
  template <typename ByteMatchTupleT = ByteMatchTuple>
  ByteMatchSetUpdate& WithByteMatchTuple(ByteMatchTupleT&& value) {
    SetByteMatchTuple(std::forward<ByteMatchTupleT>(value));
    return *this;
  }
  ///@}
 private:
