...
class ListGeoMatchSetsResult {
 public:
  AWS_WAF_API ListGeoMatchSetsResult() = default;
  AWS_WAF_API ListGeoMatchSetsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_WAF_API ListGeoMatchSetsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename NextMarkerT = Aws::String>
  ListGeoMatchSetsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetGeoMatchSets(GeoMatchSetsT&& value) {
    m_geoMatchSetsHasBeenSet = true;
    m_geoMatchSets = std::forward<GeoMatchSetsT>(value);
  }
  template <typename GeoMatchSetsT = Aws::Vector<GeoMatchSetSummary>>
  ListGeoMatchSetsResult& WithGeoMatchSets(GeoMatchSetsT&& value) {
    SetGeoMatchSets(std::forward<GeoMatchSetsT>(value));
    return *this;
  }
  template <typename GeoMatchSetsT = GeoMatchSetSummary>
  ListGeoMatchSetsResult& AddGeoMatchSets(GeoMatchSetsT&& value) {
    m_geoMatchSetsHasBeenSet = true;
    m_geoMatchSets.emplace_back(std::forward<GeoMatchSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListGeoMatchSetsResult& WithRequestId(RequestIdT&& value) {
