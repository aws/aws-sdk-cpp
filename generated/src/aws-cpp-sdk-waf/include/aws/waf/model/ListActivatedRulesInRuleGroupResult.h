...
class ListActivatedRulesInRuleGroupResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListActivatedRulesInRuleGroupResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetActivatedRules(ActivatedRulesT&& value) {
    m_activatedRulesHasBeenSet = true;
    m_activatedRules = std::forward<ActivatedRulesT>(value);
  }
  template <typename ActivatedRulesT = Aws::Vector<ActivatedRule>>
  ListActivatedRulesInRuleGroupResult& WithActivatedRules(ActivatedRulesT&& value) {
    SetActivatedRules(std::forward<ActivatedRulesT>(value));
    return *this;
  }
  template <typename ActivatedRulesT = ActivatedRule>
  ListActivatedRulesInRuleGroupResult& AddActivatedRules(ActivatedRulesT&& value) {
    m_activatedRulesHasBeenSet = true;
    m_activatedRules.emplace_back(std::forward<ActivatedRulesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListActivatedRulesInRuleGroupResult& WithRequestId(RequestIdT&& value) {
