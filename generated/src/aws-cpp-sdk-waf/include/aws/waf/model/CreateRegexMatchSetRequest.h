...
namespace Model
{
  ...
  /**
   */
  class CreateRegexMatchSetRequest : public WAFRequest
  {
  public:
    AWS_WAF_API CreateRegexMatchSetRequest() = default;
    ...
    template<typename NameT = Aws::String>
    CreateRegexMatchSetRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ChangeTokenT = Aws::String>
    CreateRegexMatchSetRequest& WithChangeToken(ChangeTokenT&& value) { SetChangeToken(std::forward<ChangeTokenT>(value)); return *this;}
    ///@}
  private:
