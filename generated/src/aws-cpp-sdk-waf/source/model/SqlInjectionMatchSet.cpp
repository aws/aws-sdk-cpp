...
SqlInjectionMatchSet::SqlInjectionMatchSet(JsonView jsonValue) { *this = jsonValue; }
...
SqlInjectionMatchSet& SqlInjectionMatchSet::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SqlInjectionMatchTuples")) {
    ...
    for (unsigned sqlInjectionMatchTuplesIndex = 0; sqlInjectionMatchTuplesIndex < sqlInjectionMatchTuplesJsonList.GetLength();
         ++sqlInjectionMatchTuplesIndex) {
...
JsonValue SqlInjectionMatchSet::Jsonize() const {
  ...
  if (m_sqlInjectionMatchTuplesHasBeenSet) {
    ...
    for (unsigned sqlInjectionMatchTuplesIndex = 0; sqlInjectionMatchTuplesIndex < sqlInjectionMatchTuplesJsonList.GetLength();
         ++sqlInjectionMatchTuplesIndex) {
      sqlInjectionMatchTuplesJsonList[sqlInjectionMatchTuplesIndex].AsObject(
          m_sqlInjectionMatchTuples[sqlInjectionMatchTuplesIndex].Jsonize());
    }
