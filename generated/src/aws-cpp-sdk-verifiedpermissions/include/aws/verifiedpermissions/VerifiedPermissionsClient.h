...
class AWS_VERIFIEDPERMISSIONS_API VerifiedPermissionsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  VerifiedPermissionsClient(const Aws::VerifiedPermissions::VerifiedPermissionsClientConfiguration& clientConfiguration =
  ...
  VerifiedPermissionsClient(const Aws::Auth::AWSCredentials& credentials,
                            std::shared_ptr<VerifiedPermissionsEndpointProviderBase> endpointProvider = nullptr,
                            const Aws::VerifiedPermissions::VerifiedPermissionsClientConfiguration& clientConfiguration =
                                Aws::VerifiedPermissions::VerifiedPermissionsClientConfiguration());
  ...
  /**
   * An Async wrapper for BatchGetPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchGetPolicyRequestT = Model::BatchGetPolicyRequest>
  void BatchGetPolicyAsync(const BatchGetPolicyRequestT& request, const BatchGetPolicyResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for BatchIsAuthorized that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchIsAuthorized that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchIsAuthorizedRequestT = Model::BatchIsAuthorizedRequest>
  void BatchIsAuthorizedAsync(const BatchIsAuthorizedRequestT& request, const BatchIsAuthorizedResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchIsAuthorizedWithTokenOutcome BatchIsAuthorizedWithToken(
      const Model::BatchIsAuthorizedWithTokenRequest& request) const;

  /**
   * A Callable wrapper for BatchIsAuthorizedWithToken that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchIsAuthorizedWithTokenRequestT = Model::BatchIsAuthorizedWithTokenRequest>
  Model::BatchIsAuthorizedWithTokenOutcomeCallable BatchIsAuthorizedWithTokenCallable(
      const BatchIsAuthorizedWithTokenRequestT& request) const {
    return SubmitCallable(&VerifiedPermissionsClient::BatchIsAuthorizedWithToken, request);
  }

  /**
   * An Async wrapper for BatchIsAuthorizedWithToken that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchIsAuthorizedWithTokenRequestT = Model::BatchIsAuthorizedWithTokenRequest>
  void BatchIsAuthorizedWithTokenAsync(const BatchIsAuthorizedWithTokenRequestT& request,
                                       const BatchIsAuthorizedWithTokenResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePolicyStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePolicyStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreatePolicyStoreRequestT = Model::CreatePolicyStoreRequest>
  void CreatePolicyStoreAsync(const CreatePolicyStoreRequestT& request, const CreatePolicyStoreResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePolicyTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePolicyTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePolicyTemplateRequestT = Model::CreatePolicyTemplateRequest>
  void CreatePolicyTemplateAsync(const CreatePolicyTemplateRequestT& request, const CreatePolicyTemplateResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePolicyStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePolicyStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeletePolicyStoreRequestT = Model::DeletePolicyStoreRequest>
  void DeletePolicyStoreAsync(const DeletePolicyStoreRequestT& request, const DeletePolicyStoreResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePolicyTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePolicyTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePolicyTemplateRequestT = Model::DeletePolicyTemplateRequest>
  void DeletePolicyTemplateAsync(const DeletePolicyTemplateRequestT& request, const DeletePolicyTemplateResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetPolicyStore that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetPolicyStoreRequestT = Model::GetPolicyStoreRequest>
  ...
  /**
   * A Callable wrapper for GetPolicyTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPolicyTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPolicyTemplateRequestT = Model::GetPolicyTemplateRequest>
  void GetPolicyTemplateAsync(const GetPolicyTemplateRequestT& request, const GetPolicyTemplateResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for IsAuthorized that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename IsAuthorizedRequestT = Model::IsAuthorizedRequest>
  void IsAuthorizedAsync(const IsAuthorizedRequestT& request, const IsAuthorizedResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for IsAuthorizedWithToken that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for IsAuthorizedWithToken that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename IsAuthorizedWithTokenRequestT = Model::IsAuthorizedWithTokenRequest>
  void IsAuthorizedWithTokenAsync(const IsAuthorizedWithTokenRequestT& request, const IsAuthorizedWithTokenResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListIdentitySourcesRequestT = Model::ListIdentitySourcesRequest>
  void ListIdentitySourcesAsync(const ListIdentitySourcesRequestT& request, const ListIdentitySourcesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPolicyStores that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPolicyStores that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPolicyStoresRequestT = Model::ListPolicyStoresRequest>
  void ListPolicyStoresAsync(const ListPolicyStoresResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListPolicyStoresRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPolicyTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPolicyTemplates that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPolicyTemplatesRequestT = Model::ListPolicyTemplatesRequest>
  void ListPolicyTemplatesAsync(const ListPolicyTemplatesRequestT& request, const ListPolicyTemplatesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutSchema that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutSchemaRequestT = Model::PutSchemaRequest>
  void PutSchemaAsync(const PutSchemaRequestT& request, const PutSchemaResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateIdentitySource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateIdentitySource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateIdentitySourceRequestT = Model::UpdateIdentitySourceRequest>
  void UpdateIdentitySourceAsync(const UpdateIdentitySourceRequestT& request, const UpdateIdentitySourceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePolicyStore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePolicyStore that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdatePolicyStoreRequestT = Model::UpdatePolicyStoreRequest>
  void UpdatePolicyStoreAsync(const UpdatePolicyStoreRequestT& request, const UpdatePolicyStoreResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePolicyTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePolicyTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePolicyTemplateRequestT = Model::UpdatePolicyTemplateRequest>
  void UpdatePolicyTemplateAsync(const UpdatePolicyTemplateRequestT& request, const UpdatePolicyTemplateResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
