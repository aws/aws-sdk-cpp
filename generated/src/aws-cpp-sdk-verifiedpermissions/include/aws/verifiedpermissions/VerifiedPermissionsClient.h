...
namespace VerifiedPermissions
{
   ...
   * </li> </ul>
   */
  class AWS_VERIFIEDPERMISSIONS_API VerifiedPermissionsClient : Aws::Client::ClientWithAsyncTemplateMethods<VerifiedPermissionsClient>,
    smithy::client::AwsSmithyClientT<Aws::VerifiedPermissions::SERVICE_NAME,
