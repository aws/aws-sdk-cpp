...
class BatchGetPolicyResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<BatchGetPolicyOutputItem>>
  BatchGetPolicyResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = BatchGetPolicyOutputItem>
  BatchGetPolicyResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<BatchGetPolicyErrorItem>>
  BatchGetPolicyResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchGetPolicyErrorItem>
  BatchGetPolicyResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetPolicyResult& WithRequestId(RequestIdT&& value) {
