...
class UpdateOpenIdConnectConfiguration {
 public:
  ...
  void SetEntityIdPrefix(EntityIdPrefixT&& value) {
    ...
    m_entityIdPrefix = std::forward<EntityIdPrefixT>(value);
  }
  template <typename EntityIdPrefixT = Aws::String>
  UpdateOpenIdConnectConfiguration& WithEntityIdPrefix(EntityIdPrefixT&& value) {
    SetEntityIdPrefix(std::forward<EntityIdPrefixT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTokenSelection(TokenSelectionT&& value) {
    ...
    m_tokenSelection = std::forward<TokenSelectionT>(value);
  }
  template <typename TokenSelectionT = UpdateOpenIdConnectTokenSelection>
  UpdateOpenIdConnectConfiguration& WithTokenSelection(TokenSelectionT&& value) {
    SetTokenSelection(std::forward<TokenSelectionT>(value));
    return *this;
  }
  ///@}
 private:
