...
namespace Model
{
  ...
  /**
   * <p>The request failed because it exceeded a throttling quota.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/ThrottlingException">AWS
   * API Reference</a></p>
   */
