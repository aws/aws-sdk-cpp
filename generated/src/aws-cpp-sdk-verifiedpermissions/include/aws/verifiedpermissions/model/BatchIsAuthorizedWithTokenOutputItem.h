...
class BatchIsAuthorizedWithTokenOutputItem {
 public:
  ...
  template <typename RequestT = BatchIsAuthorizedWithTokenInputItem>
  BatchIsAuthorizedWithTokenOutputItem& WithRequest(RequestT&& value) {
  ...
  inline BatchIsAuthorizedWithTokenOutputItem& WithDecision(Decision value) {
    SetDecision(value);
    return *this;
  }
  ///@}
  ...
  template <typename DeterminingPoliciesT = Aws::Vector<DeterminingPolicyItem>>
  BatchIsAuthorizedWithTokenOutputItem& WithDeterminingPolicies(DeterminingPoliciesT&& value) {
  ...
  BatchIsAuthorizedWithTokenOutputItem& AddDeterminingPolicies(DeterminingPoliciesT&& value) {
    m_determiningPoliciesHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<EvaluationErrorItem>>
  BatchIsAuthorizedWithTokenOutputItem& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = EvaluationErrorItem>
  BatchIsAuthorizedWithTokenOutputItem& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
