...
class DeletePolicyTemplateRequest : public VerifiedPermissionsRequest {
 public:
  ...
  template <typename PolicyStoreIdT = Aws::String>
  DeletePolicyTemplateRequest& WithPolicyStoreId(PolicyStoreIdT&& value) {
  ...
  ///@{
  /**
   * <p>Specifies the ID of the policy template that you want to delete.</p> <p>You
  ...
  template <typename PolicyTemplateIdT = Aws::String>
  DeletePolicyTemplateRequest& WithPolicyTemplateId(PolicyTemplateIdT&& value) {
