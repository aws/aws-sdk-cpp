...
class ConfigurationItem {
 public:
  ...
  template <typename CognitoUserPoolConfigurationT = CognitoUserPoolConfigurationItem>
  ConfigurationItem& WithCognitoUserPoolConfiguration(CognitoUserPoolConfigurationT&& value) {
  ...
  template <typename OpenIdConnectConfigurationT = OpenIdConnectConfigurationItem>
  ConfigurationItem& WithOpenIdConnectConfiguration(OpenIdConnectConfigurationT&& value) {
