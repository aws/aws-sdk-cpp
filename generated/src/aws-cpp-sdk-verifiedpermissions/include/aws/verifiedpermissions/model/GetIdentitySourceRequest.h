...
class GetIdentitySourceRequest : public VerifiedPermissionsRequest {
 public:
   ...
   * want information about.</p> <p>To specify a policy store, use its ID or alias
   * name. When using an alias name, prefix it with <code>policy-store-alias/</code>.
   * For example:</p> <ul> <li> <p>ID: <code>PSEXAMPLEabcdefg111111</code> </p> </li>
