...
class BatchIsAuthorizedWithTokenInputItem {
 public:
  ...
  template <typename ActionT = ActionIdentifier>
  BatchIsAuthorizedWithTokenInputItem& WithAction(ActionT&& value) {
  ...
  template <typename ResourceT = EntityIdentifier>
  BatchIsAuthorizedWithTokenInputItem& WithResource(ResourceT&& value) {
  ...
  template <typename ContextT = ContextDefinition>
  BatchIsAuthorizedWithTokenInputItem& WithContext(ContextT&& value) {
