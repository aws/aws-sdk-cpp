...
class TemplateLinkedPolicyDefinitionItem {
 public:
  ...
  template <typename PolicyTemplateIdT = Aws::String>
  TemplateLinkedPolicyDefinitionItem& WithPolicyTemplateId(PolicyTemplateIdT&& value) {
  ...
  template <typename PrincipalT = EntityIdentifier>
  TemplateLinkedPolicyDefinitionItem& WithPrincipal(PrincipalT&& value) {
  ...
  template <typename ResourceT = EntityIdentifier>
  TemplateLinkedPolicyDefinitionItem& WithResource(ResourceT&& value) {
