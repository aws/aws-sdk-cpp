...
class OpenIdConnectAccessTokenConfiguration {
 public:
  ...
  template <typename PrincipalIdClaimT = Aws::String>
  OpenIdConnectAccessTokenConfiguration& WithPrincipalIdClaim(PrincipalIdClaimT&& value) {
  ...
  template <typename AudiencesT = Aws::Vector<Aws::String>>
  OpenIdConnectAccessTokenConfiguration& WithAudiences(AudiencesT&& value) {
    SetAudiences(std::forward<AudiencesT>(value));
    return *this;
  }
  template <typename AudiencesT = Aws::String>
  OpenIdConnectAccessTokenConfiguration& AddAudiences(AudiencesT&& value) {
    m_audiencesHasBeenSet = true;
