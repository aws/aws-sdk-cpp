...
class CreateIdentitySourceResult {
 public:
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  CreateIdentitySourceResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename IdentitySourceIdT = Aws::String>
  CreateIdentitySourceResult& WithIdentitySourceId(IdentitySourceIdT&& value) {
  ...
  template <typename LastUpdatedDateT = Aws::Utils::DateTime>
  CreateIdentitySourceResult& WithLastUpdatedDate(LastUpdatedDateT&& value) {
  ...
  template <typename PolicyStoreIdT = Aws::String>
  CreateIdentitySourceResult& WithPolicyStoreId(PolicyStoreIdT&& value) {
