...
class IsAuthorizedWithTokenResult {
 public:
  ...
  AWS_VERIFIEDPERMISSIONS_API IsAuthorizedWithTokenResult& operator=(
  ...
  inline void SetDecision(Decision value) {
    m_decisionHasBeenSet = true;
    m_decision = value;
  }
  inline IsAuthorizedWithTokenResult& WithDecision(Decision value) {
    SetDecision(value);
    return *this;
  }
  ///@}
  ...
  void SetDeterminingPolicies(DeterminingPoliciesT&& value) {
    m_determiningPoliciesHasBeenSet = true;
    m_determiningPolicies = std::forward<DeterminingPoliciesT>(value);
  }
  template <typename DeterminingPoliciesT = Aws::Vector<DeterminingPolicyItem>>
  IsAuthorizedWithTokenResult& WithDeterminingPolicies(DeterminingPoliciesT&& value) {
    SetDeterminingPolicies(std::forward<DeterminingPoliciesT>(value));
    return *this;
  }
  template <typename DeterminingPoliciesT = DeterminingPolicyItem>
  IsAuthorizedWithTokenResult& AddDeterminingPolicies(DeterminingPoliciesT&& value) {
    m_determiningPoliciesHasBeenSet = true;
    m_determiningPolicies.emplace_back(std::forward<DeterminingPoliciesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorsT = Aws::Vector<EvaluationErrorItem>>
  IsAuthorizedWithTokenResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = EvaluationErrorItem>
  IsAuthorizedWithTokenResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename PrincipalT = EntityIdentifier>
  IsAuthorizedWithTokenResult& WithPrincipal(PrincipalT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  IsAuthorizedWithTokenResult& WithRequestId(RequestIdT&& value) {
