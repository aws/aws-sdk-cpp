...
class ListPolicyStoresResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPolicyStoresResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetPolicyStores(PolicyStoresT&& value) {
    m_policyStoresHasBeenSet = true;
    m_policyStores = std::forward<PolicyStoresT>(value);
  }
  template <typename PolicyStoresT = Aws::Vector<PolicyStoreItem>>
  ListPolicyStoresResult& WithPolicyStores(PolicyStoresT&& value) {
    SetPolicyStores(std::forward<PolicyStoresT>(value));
    return *this;
  }
  template <typename PolicyStoresT = PolicyStoreItem>
  ListPolicyStoresResult& AddPolicyStores(PolicyStoresT&& value) {
    m_policyStoresHasBeenSet = true;
    m_policyStores.emplace_back(std::forward<PolicyStoresT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListPolicyStoresResult& WithRequestId(RequestIdT&& value) {
