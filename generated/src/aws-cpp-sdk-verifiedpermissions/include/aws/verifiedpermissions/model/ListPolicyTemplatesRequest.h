...
class ListPolicyTemplatesRequest : public VerifiedPermissionsRequest {
 public:
  AWS_VERIFIEDPERMISSIONS_API ListPolicyTemplatesRequest() = default;
   ...
   * want to list.</p> <p>To specify a policy store, use its ID or alias name. When
  ...
  template <typename PolicyStoreIdT = Aws::String>
  ListPolicyTemplatesRequest& WithPolicyStoreId(PolicyStoreIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPolicyTemplatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPolicyTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
