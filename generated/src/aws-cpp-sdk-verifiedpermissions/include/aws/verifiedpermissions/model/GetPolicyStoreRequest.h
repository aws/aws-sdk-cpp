...
class GetPolicyStoreRequest : public VerifiedPermissionsRequest {
 public:
  ...
  ///@{
  /**
   * <p>Specifies the policy store that you want information about.</p> <p>To specify
   * a policy store, use its ID or alias name. When using an alias name, prefix it
   * with <code>policy-store-alias/</code>. For example:</p> <ul> <li> <p>ID:
  ...
  inline void SetTags(bool value) {
    m_tagsHasBeenSet = true;
    m_tags = value;
  }
  inline GetPolicyStoreRequest& WithTags(bool value) {
    SetTags(value);
    return *this;
  }
  ///@}
