...
class UpdateOpenIdConnectIdentityTokenConfiguration {
 public:
  ...
  template <typename PrincipalIdClaimT = Aws::String>
  UpdateOpenIdConnectIdentityTokenConfiguration& WithPrincipalIdClaim(PrincipalIdClaimT&& value) {
  ...
  void SetClientIds(ClientIdsT&& value) {
    ...
    m_clientIds = std::forward<ClientIdsT>(value);
  }
  template <typename ClientIdsT = Aws::Vector<Aws::String>>
  UpdateOpenIdConnectIdentityTokenConfiguration& WithClientIds(ClientIdsT&& value) {
    SetClientIds(std::forward<ClientIdsT>(value));
    return *this;
  }
  template <typename ClientIdsT = Aws::String>
  UpdateOpenIdConnectIdentityTokenConfiguration& AddClientIds(ClientIdsT&& value) {
    m_clientIdsHasBeenSet = true;
    m_clientIds.emplace_back(std::forward<ClientIdsT>(value));
    return *this;
  }
  ///@}
 private:
