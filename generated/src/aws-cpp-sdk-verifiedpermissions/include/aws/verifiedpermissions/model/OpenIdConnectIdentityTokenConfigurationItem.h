 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/OpenIdConnectIdentityTokenConfigurationItem">AWS
 * API Reference</a></p>
 */
class OpenIdConnectIdentityTokenConfigurationItem {
 public:
  ...
  template <typename PrincipalIdClaimT = Aws::String>
  OpenIdConnectIdentityTokenConfigurationItem& WithPrincipalIdClaim(PrincipalIdClaimT&& value) {
  ...
  template <typename ClientIdsT = Aws::Vector<Aws::String>>
  OpenIdConnectIdentityTokenConfigurationItem& WithClientIds(ClientIdsT&& value) {
    SetClientIds(std::forward<ClientIdsT>(value));
    return *this;
  }
  template <typename ClientIdsT = Aws::String>
  OpenIdConnectIdentityTokenConfigurationItem& AddClientIds(ClientIdsT&& value) {
    m_clientIdsHasBeenSet = true;
