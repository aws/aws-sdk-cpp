...
class UpdateOpenIdConnectAccessTokenConfiguration {
 public:
  ...
  template <typename PrincipalIdClaimT = Aws::String>
  UpdateOpenIdConnectAccessTokenConfiguration& WithPrincipalIdClaim(PrincipalIdClaimT&& value) {
  ...
  template <typename AudiencesT = Aws::Vector<Aws::String>>
  UpdateOpenIdConnectAccessTokenConfiguration& WithAudiences(AudiencesT&& value) {
    SetAudiences(std::forward<AudiencesT>(value));
    return *this;
  }
  template <typename AudiencesT = Aws::String>
  UpdateOpenIdConnectAccessTokenConfiguration& AddAudiences(AudiencesT&& value) {
    m_audiencesHasBeenSet = true;
