...
namespace Model
{
  ...
  {
  public:
    AWS_VERIFIEDPERMISSIONS_API OpenIdConnectGroupConfigurationItem() = default;
    ...
    template<typename GroupClaimT = Aws::String>
    OpenIdConnectGroupConfigurationItem& WithGroupClaim(GroupClaimT&& value) { SetGroupClaim(std::forward<GroupClaimT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupEntityTypeT = Aws::String>
    OpenIdConnectGroupConfigurationItem& WithGroupEntityType(GroupEntityTypeT&& value) { SetGroupEntityType(std::forward<GroupEntityTypeT>(value)); return *this;}
    ///@}
  private:
