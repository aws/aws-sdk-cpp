...
class OpenIdConnectGroupConfigurationDetail {
 public:
  ...
  template <typename GroupClaimT = Aws::String>
  OpenIdConnectGroupConfigurationDetail& WithGroupClaim(GroupClaimT&& value) {
  ...
  template <typename GroupEntityTypeT = Aws::String>
  OpenIdConnectGroupConfigurationDetail& WithGroupEntityType(GroupEntityTypeT&& value) {
