...
class ListPolicyTemplatesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPolicyTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetPolicyTemplates(PolicyTemplatesT&& value) {
    m_policyTemplatesHasBeenSet = true;
    m_policyTemplates = std::forward<PolicyTemplatesT>(value);
  }
  template <typename PolicyTemplatesT = Aws::Vector<PolicyTemplateItem>>
  ListPolicyTemplatesResult& WithPolicyTemplates(PolicyTemplatesT&& value) {
    SetPolicyTemplates(std::forward<PolicyTemplatesT>(value));
    return *this;
  }
  template <typename PolicyTemplatesT = PolicyTemplateItem>
  ListPolicyTemplatesResult& AddPolicyTemplates(PolicyTemplatesT&& value) {
    m_policyTemplatesHasBeenSet = true;
    m_policyTemplates.emplace_back(std::forward<PolicyTemplatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListPolicyTemplatesResult& WithRequestId(RequestIdT&& value) {
