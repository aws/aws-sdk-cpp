...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/IdentitySourceItemDetails">AWS
   * API Reference</a></p>
   */
  class IdentitySourceItemDetails
  {
  public:
    AWS_VERIFIEDPERMISSIONS_API IdentitySourceItemDetails();
    AWS_VERIFIEDPERMISSIONS_API IdentitySourceItemDetails(Aws::Utils::Json::JsonView jsonValue);
     ...
     * pool that are enabled for this identity source.</p>
     */
    inline IdentitySourceItemDetails& WithClientIds(const Aws::Vector<Aws::String>& value) { SetClientIds(value); return *this;}

    /**
     * <p>The application client IDs associated with the specified Amazon Cognito user
     * pool that are enabled for this identity source.</p>
     */
    inline IdentitySourceItemDetails& WithClientIds(Aws::Vector<Aws::String>&& value) { SetClientIds(std::move(value)); return *this;}
    ...
    /**
     * <p>The Amazon Cognito user pool whose identities are accessible to this Verified
     * Permissions policy store.</p>
     */
     ...
     * <code>cognito</code>.</p>
     */
    inline IdentitySourceItemDetails& WithOpenIdIssuer(OpenIdIssuer&& value) { SetOpenIdIssuer(std::move(value)); return *this;}
