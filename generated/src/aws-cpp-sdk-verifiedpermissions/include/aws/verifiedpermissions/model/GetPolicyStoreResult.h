...
class GetPolicyStoreResult {
 public:
  ...
  void SetValidationSettings(ValidationSettingsT&& value) {
    ...
    m_validationSettings = std::forward<ValidationSettingsT>(value);
  }
  template <typename ValidationSettingsT = ValidationSettings>
  GetPolicyStoreResult& WithValidationSettings(ValidationSettingsT&& value) {
    SetValidationSettings(std::forward<ValidationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetPolicyStoreResult& WithDeletionProtection(DeletionProtection value) {
  ...
  inline void SetCedarVersion(CedarVersion value) {
    m_cedarVersionHasBeenSet = true;
    m_cedarVersion = value;
  }
  inline GetPolicyStoreResult& WithCedarVersion(CedarVersion value) {
    SetCedarVersion(value);
    return *this;
  }
  ///@}
