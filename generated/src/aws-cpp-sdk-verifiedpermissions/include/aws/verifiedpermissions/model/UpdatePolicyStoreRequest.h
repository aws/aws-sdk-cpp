...
class UpdatePolicyStoreRequest : public VerifiedPermissionsRequest {
 public:
  ...
  ///@{
  /**
   * <p>Specifies the ID of the policy store that you want to update</p> <p>To
  ...
  template <typename PolicyStoreIdT = Aws::String>
  UpdatePolicyStoreRequest& WithPolicyStoreId(PolicyStoreIdT&& value) {
  ...
  template <typename ValidationSettingsT = ValidationSettings>
  UpdatePolicyStoreRequest& WithValidationSettings(ValidationSettingsT&& value) {
  ...
  inline UpdatePolicyStoreRequest& WithDeletionProtection(DeletionProtection value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdatePolicyStoreRequest& WithDescription(DescriptionT&& value) {
