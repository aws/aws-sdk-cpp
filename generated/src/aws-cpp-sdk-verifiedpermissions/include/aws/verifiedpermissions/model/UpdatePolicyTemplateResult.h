...
class UpdatePolicyTemplateResult {
 public:
  ...
  template <typename PolicyStoreIdT = Aws::String>
  UpdatePolicyTemplateResult& WithPolicyStoreId(PolicyStoreIdT&& value) {
  ...
  template <typename PolicyTemplateIdT = Aws::String>
  UpdatePolicyTemplateResult& WithPolicyTemplateId(PolicyTemplateIdT&& value) {
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  UpdatePolicyTemplateResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename LastUpdatedDateT = Aws::Utils::DateTime>
  UpdatePolicyTemplateResult& WithLastUpdatedDate(LastUpdatedDateT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePolicyTemplateResult& WithRequestId(RequestIdT&& value) {
