...
class UpdateIdentitySourceRequest : public VerifiedPermissionsRequest {
 public:
  ...
  void SetUpdateConfiguration(UpdateConfigurationT&& value) {
    m_updateConfigurationHasBeenSet = true;
    m_updateConfiguration = std::forward<UpdateConfigurationT>(value);
  }
  template <typename UpdateConfigurationT = UpdateConfiguration>
  UpdateIdentitySourceRequest& WithUpdateConfiguration(UpdateConfigurationT&& value) {
    SetUpdateConfiguration(std::forward<UpdateConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrincipalEntityType(PrincipalEntityTypeT&& value) {
    ...
    m_principalEntityType = std::forward<PrincipalEntityTypeT>(value);
  }
  template <typename PrincipalEntityTypeT = Aws::String>
  UpdateIdentitySourceRequest& WithPrincipalEntityType(PrincipalEntityTypeT&& value) {
    SetPrincipalEntityType(std::forward<PrincipalEntityTypeT>(value));
    return *this;
  }
  ///@}
 private:
