...
class OpenIdConnectIdentityTokenConfigurationDetail {
 public:
  ...
  template <typename PrincipalIdClaimT = Aws::String>
  OpenIdConnectIdentityTokenConfigurationDetail& WithPrincipalIdClaim(PrincipalIdClaimT&& value) {
  ...
  template <typename ClientIdsT = Aws::Vector<Aws::String>>
  OpenIdConnectIdentityTokenConfigurationDetail& WithClientIds(ClientIdsT&& value) {
    SetClientIds(std::forward<ClientIdsT>(value));
    return *this;
  }
  template <typename ClientIdsT = Aws::String>
  OpenIdConnectIdentityTokenConfigurationDetail& AddClientIds(ClientIdsT&& value) {
    m_clientIdsHasBeenSet = true;
