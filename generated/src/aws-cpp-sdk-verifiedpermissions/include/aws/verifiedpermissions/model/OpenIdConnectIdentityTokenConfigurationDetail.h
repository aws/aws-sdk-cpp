...
namespace Model
{
  ...
  {
  public:
    AWS_VERIFIEDPERMISSIONS_API OpenIdConnectIdentityTokenConfigurationDetail();
    ...
    inline OpenIdConnectIdentityTokenConfigurationDetail& WithPrincipalIdClaim(const Aws::String& value) { SetPrincipalIdClaim(value); return *this;}
    inline OpenIdConnectIdentityTokenConfigurationDetail& WithPrincipalIdClaim(Aws::String&& value) { SetPrincipalIdClaim(std::move(value)); return *this;}
    inline OpenIdConnectIdentityTokenConfigurationDetail& WithPrincipalIdClaim(const char* value) { SetPrincipalIdClaim(value); return *this;}
    ///@}
    ...
    inline OpenIdConnectIdentityTokenConfigurationDetail& WithClientIds(const Aws::Vector<Aws::String>& value) { SetClientIds(value); return *this;}
    inline OpenIdConnectIdentityTokenConfigurationDetail& WithClientIds(Aws::Vector<Aws::String>&& value) { SetClientIds(std::move(value)); return *this;}
    inline OpenIdConnectIdentityTokenConfigurationDetail& AddClientIds(const Aws::String& value) { m_clientIdsHasBeenSet = true; m_clientIds.push_back(value); return *this; }
    inline OpenIdConnectIdentityTokenConfigurationDetail& AddClientIds(Aws::String&& value) { m_clientIdsHasBeenSet = true; m_clientIds.push_back(std::move(value)); return *this; }
    inline OpenIdConnectIdentityTokenConfigurationDetail& AddClientIds(const char* value) { m_clientIdsHasBeenSet = true; m_clientIds.push_back(value); return *this; }
    ///@}
  private:
