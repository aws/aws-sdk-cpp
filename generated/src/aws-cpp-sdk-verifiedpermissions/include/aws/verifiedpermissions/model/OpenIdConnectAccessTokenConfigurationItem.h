...
namespace Model
{
  ...
  {
  public:
    AWS_VERIFIEDPERMISSIONS_API OpenIdConnectAccessTokenConfigurationItem() = default;
    ...
    template<typename PrincipalIdClaimT = Aws::String>
    OpenIdConnectAccessTokenConfigurationItem& WithPrincipalIdClaim(PrincipalIdClaimT&& value) { SetPrincipalIdClaim(std::forward<PrincipalIdClaimT>(value)); return *this;}
    ///@}
    ...
    template<typename AudiencesT = Aws::Vector<Aws::String>>
    OpenIdConnectAccessTokenConfigurationItem& WithAudiences(AudiencesT&& value) { SetAudiences(std::forward<AudiencesT>(value)); return *this;}
    template<typename AudiencesT = Aws::String>
    OpenIdConnectAccessTokenConfigurationItem& AddAudiences(AudiencesT&& value) { m_audiencesHasBeenSet = true; m_audiences.emplace_back(std::forward<AudiencesT>(value)); return *this; }
    ///@}
  private:
