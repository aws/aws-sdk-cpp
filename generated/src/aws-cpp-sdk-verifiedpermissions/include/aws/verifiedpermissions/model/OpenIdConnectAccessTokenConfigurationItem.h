...
class OpenIdConnectAccessTokenConfigurationItem {
 public:
  ...
  void SetPrincipalIdClaim(PrincipalIdClaimT&& value) {
    m_principalIdClaimHasBeenSet = true;
    m_principalIdClaim = std::forward<PrincipalIdClaimT>(value);
  }
  template <typename PrincipalIdClaimT = Aws::String>
  OpenIdConnectAccessTokenConfigurationItem& WithPrincipalIdClaim(PrincipalIdClaimT&& value) {
    SetPrincipalIdClaim(std::forward<PrincipalIdClaimT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AudiencesT = Aws::Vector<Aws::String>>
  OpenIdConnectAccessTokenConfigurationItem& WithAudiences(AudiencesT&& value) {
    SetAudiences(std::forward<AudiencesT>(value));
    return *this;
  }
  template <typename AudiencesT = Aws::String>
  OpenIdConnectAccessTokenConfigurationItem& AddAudiences(AudiencesT&& value) {
    m_audiencesHasBeenSet = true;
