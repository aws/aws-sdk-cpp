...
class PolicyFilter {
 public:
  ...
  template <typename PrincipalT = EntityReference>
  PolicyFilter& WithPrincipal(PrincipalT&& value) {
  ...
  template <typename ResourceT = EntityReference>
  PolicyFilter& WithResource(ResourceT&& value) {
  ...
  inline PolicyFilter& WithPolicyType(PolicyType value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
  ...
  template <typename PolicyTemplateIdT = Aws::String>
  PolicyFilter& WithPolicyTemplateId(PolicyTemplateIdT&& value) {
