...
class PutSchemaRequest : public VerifiedPermissionsRequest {
 public:
  ...
  ///@{
  /**
   * <p>Specifies the ID of the policy store in which to place the schema.</p> <p>To
  ...
  template <typename PolicyStoreIdT = Aws::String>
  PutSchemaRequest& WithPolicyStoreId(PolicyStoreIdT&& value) {
  ...
  template <typename DefinitionT = SchemaDefinition>
  PutSchemaRequest& WithDefinition(DefinitionT&& value) {
