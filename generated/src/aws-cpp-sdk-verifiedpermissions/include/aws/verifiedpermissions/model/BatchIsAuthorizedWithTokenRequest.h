...
class BatchIsAuthorizedWithTokenRequest : public VerifiedPermissionsRequest {
 public:
  ...
  template <typename PolicyStoreIdT = Aws::String>
  BatchIsAuthorizedWithTokenRequest& WithPolicyStoreId(PolicyStoreIdT&& value) {
  ...
  template <typename IdentityTokenT = Aws::String>
  BatchIsAuthorizedWithTokenRequest& WithIdentityToken(IdentityTokenT&& value) {
  ...
  template <typename AccessTokenT = Aws::String>
  BatchIsAuthorizedWithTokenRequest& WithAccessToken(AccessTokenT&& value) {
  ...
  template <typename EntitiesT = EntitiesDefinition>
  BatchIsAuthorizedWithTokenRequest& WithEntities(EntitiesT&& value) {
  ...
  template <typename RequestsT = Aws::Vector<BatchIsAuthorizedWithTokenInputItem>>
  BatchIsAuthorizedWithTokenRequest& WithRequests(RequestsT&& value) {
    SetRequests(std::forward<RequestsT>(value));
    return *this;
  }
  template <typename RequestsT = BatchIsAuthorizedWithTokenInputItem>
  BatchIsAuthorizedWithTokenRequest& AddRequests(RequestsT&& value) {
    m_requestsHasBeenSet = true;
