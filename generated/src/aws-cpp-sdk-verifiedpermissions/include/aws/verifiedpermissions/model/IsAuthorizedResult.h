...
class IsAuthorizedResult {
 public:
  ...
  inline IsAuthorizedResult& WithDecision(Decision value) {
    SetDecision(value);
    return *this;
  }
  ///@}
  ...
  template <typename DeterminingPoliciesT = Aws::Vector<DeterminingPolicyItem>>
  IsAuthorizedResult& WithDeterminingPolicies(DeterminingPoliciesT&& value) {
  ...
  IsAuthorizedResult& AddDeterminingPolicies(DeterminingPoliciesT&& value) {
    m_determiningPoliciesHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<EvaluationErrorItem>>
  IsAuthorizedResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = EvaluationErrorItem>
  IsAuthorizedResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  IsAuthorizedResult& WithRequestId(RequestIdT&& value) {
