...
namespace Model
{
  ...
  /**
   */
  class GetSchemaRequest : public VerifiedPermissionsRequest
  {
  public:
    AWS_VERIFIEDPERMISSIONS_API GetSchemaRequest();
     ...
     * <p>Specifies the ID of the policy store that contains the schema.</p>
     */
    inline GetSchemaRequest& WithPolicyStoreId(const Aws::String& value) { SetPolicyStoreId(value); return *this;}

    /**
     * <p>Specifies the ID of the policy store that contains the schema.</p>
     */
    inline GetSchemaRequest& WithPolicyStoreId(Aws::String&& value) { SetPolicyStoreId(std::move(value)); return *this;}

    /**
     * <p>Specifies the ID of the policy store that contains the schema.</p>
     */
    inline GetSchemaRequest& WithPolicyStoreId(const char* value) { SetPolicyStoreId(value); return *this;}
