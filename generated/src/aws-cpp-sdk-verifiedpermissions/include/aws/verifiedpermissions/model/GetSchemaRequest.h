...
class GetSchemaRequest : public VerifiedPermissionsRequest {
 public:
  AWS_VERIFIEDPERMISSIONS_API GetSchemaRequest() = default;
  ...
  ///@{
  /**
   * <p>Specifies the ID of the policy store that contains the schema.</p> <p>To
  ...
  template <typename PolicyStoreIdT = Aws::String>
  GetSchemaRequest& WithPolicyStoreId(PolicyStoreIdT&& value) {
