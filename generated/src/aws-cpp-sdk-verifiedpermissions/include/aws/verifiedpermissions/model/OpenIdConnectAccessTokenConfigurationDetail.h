...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/OpenIdConnectAccessTokenConfigurationDetail">AWS
   * API Reference</a></p>
   */
  class OpenIdConnectAccessTokenConfigurationDetail
  {
  public:
    AWS_VERIFIEDPERMISSIONS_API OpenIdConnectAccessTokenConfigurationDetail();
    AWS_VERIFIEDPERMISSIONS_API OpenIdConnectAccessTokenConfigurationDetail(Aws::Utils::Json::JsonView jsonValue);
    AWS_VERIFIEDPERMISSIONS_API OpenIdConnectAccessTokenConfigurationDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline OpenIdConnectAccessTokenConfigurationDetail& WithPrincipalIdClaim(const Aws::String& value) { SetPrincipalIdClaim(value); return *this;}
    inline OpenIdConnectAccessTokenConfigurationDetail& WithPrincipalIdClaim(Aws::String&& value) { SetPrincipalIdClaim(std::move(value)); return *this;}
    inline OpenIdConnectAccessTokenConfigurationDetail& WithPrincipalIdClaim(const char* value) { SetPrincipalIdClaim(value); return *this;}
    ///@}
    ...
    inline OpenIdConnectAccessTokenConfigurationDetail& WithAudiences(const Aws::Vector<Aws::String>& value) { SetAudiences(value); return *this;}
    inline OpenIdConnectAccessTokenConfigurationDetail& WithAudiences(Aws::Vector<Aws::String>&& value) { SetAudiences(std::move(value)); return *this;}
    inline OpenIdConnectAccessTokenConfigurationDetail& AddAudiences(const Aws::String& value) { m_audiencesHasBeenSet = true; m_audiences.push_back(value); return *this; }
    inline OpenIdConnectAccessTokenConfigurationDetail& AddAudiences(Aws::String&& value) { m_audiencesHasBeenSet = true; m_audiences.push_back(std::move(value)); return *this; }
    inline OpenIdConnectAccessTokenConfigurationDetail& AddAudiences(const char* value) { m_audiencesHasBeenSet = true; m_audiences.push_back(value); return *this; }
    ///@}
  private:
