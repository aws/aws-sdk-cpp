...
namespace Model
{
  ...
  {
  public:
    AWS_VERIFIEDPERMISSIONS_API OpenIdConnectAccessTokenConfigurationDetail() = default;
    ...
    template<typename PrincipalIdClaimT = Aws::String>
    OpenIdConnectAccessTokenConfigurationDetail& WithPrincipalIdClaim(PrincipalIdClaimT&& value) { SetPrincipalIdClaim(std::forward<PrincipalIdClaimT>(value)); return *this;}
    ///@}
    ...
    template<typename AudiencesT = Aws::Vector<Aws::String>>
    OpenIdConnectAccessTokenConfigurationDetail& WithAudiences(AudiencesT&& value) { SetAudiences(std::forward<AudiencesT>(value)); return *this;}
    template<typename AudiencesT = Aws::String>
    OpenIdConnectAccessTokenConfigurationDetail& AddAudiences(AudiencesT&& value) { m_audiencesHasBeenSet = true; m_audiences.emplace_back(std::forward<AudiencesT>(value)); return *this; }
    ///@}
  private:
