...
class OpenIdConnectAccessTokenConfigurationDetail {
 public:
  ...
  template <typename PrincipalIdClaimT = Aws::String>
  OpenIdConnectAccessTokenConfigurationDetail& WithPrincipalIdClaim(PrincipalIdClaimT&& value) {
  ...
  template <typename AudiencesT = Aws::Vector<Aws::String>>
  OpenIdConnectAccessTokenConfigurationDetail& WithAudiences(AudiencesT&& value) {
    SetAudiences(std::forward<AudiencesT>(value));
    return *this;
  }
  template <typename AudiencesT = Aws::String>
  OpenIdConnectAccessTokenConfigurationDetail& AddAudiences(AudiencesT&& value) {
    m_audiencesHasBeenSet = true;
