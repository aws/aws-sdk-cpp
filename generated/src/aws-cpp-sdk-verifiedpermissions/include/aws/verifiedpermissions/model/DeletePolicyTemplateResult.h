...
namespace Model
{
  ...
  {
  public:
    AWS_VERIFIEDPERMISSIONS_API DeletePolicyTemplateResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeletePolicyTemplateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
