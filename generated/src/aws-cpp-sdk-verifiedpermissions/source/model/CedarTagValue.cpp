...
CedarTagValue::CedarTagValue(JsonView jsonValue) { *this = jsonValue; }

CedarTagValue& CedarTagValue::operator=(JsonView jsonValue) {
...
JsonValue CedarTagValue::Jsonize() const {
  JsonValue payload;
