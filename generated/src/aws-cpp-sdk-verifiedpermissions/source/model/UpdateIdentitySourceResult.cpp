...
UpdateIdentitySourceResult::UpdateIdentitySourceResult()
{
}

UpdateIdentitySourceResult::UpdateIdentitySourceResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
