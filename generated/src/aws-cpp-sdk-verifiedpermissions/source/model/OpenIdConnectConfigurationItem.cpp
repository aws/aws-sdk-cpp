...
OpenIdConnectConfigurationItem::OpenIdConnectConfigurationItem(JsonView jsonValue) { *this = jsonValue; }

OpenIdConnectConfigurationItem& OpenIdConnectConfigurationItem::operator=(JsonView jsonValue) {
...
JsonValue OpenIdConnectConfigurationItem::Jsonize() const {
  JsonValue payload;
