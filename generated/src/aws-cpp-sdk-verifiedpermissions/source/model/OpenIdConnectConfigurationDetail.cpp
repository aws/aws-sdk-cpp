...
OpenIdConnectConfigurationDetail::OpenIdConnectConfigurationDetail() : 
...
OpenIdConnectConfigurationDetail::OpenIdConnectConfigurationDetail(JsonView jsonValue)
  : OpenIdConnectConfigurationDetail()
{
  *this = jsonValue;
}

OpenIdConnectConfigurationDetail& OpenIdConnectConfigurationDetail::operator =(JsonView jsonValue)
{
...
JsonValue OpenIdConnectConfigurationDetail::Jsonize() const
{
  JsonValue payload;
