...
KmsEncryptionSettings::KmsEncryptionSettings(JsonView jsonValue) { *this = jsonValue; }

KmsEncryptionSettings& KmsEncryptionSettings::operator=(JsonView jsonValue) {
...
JsonValue KmsEncryptionSettings::Jsonize() const {
  JsonValue payload;
