...
CreatePolicyStoreAliasResult::CreatePolicyStoreAliasResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreatePolicyStoreAliasResult& CreatePolicyStoreAliasResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
