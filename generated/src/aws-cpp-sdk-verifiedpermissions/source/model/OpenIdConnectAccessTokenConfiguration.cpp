...
OpenIdConnectAccessTokenConfiguration::OpenIdConnectAccessTokenConfiguration(JsonView jsonValue) { *this = jsonValue; }

OpenIdConnectAccessTokenConfiguration& OpenIdConnectAccessTokenConfiguration::operator=(JsonView jsonValue) {
...
JsonValue OpenIdConnectAccessTokenConfiguration::Jsonize() const {
  JsonValue payload;
