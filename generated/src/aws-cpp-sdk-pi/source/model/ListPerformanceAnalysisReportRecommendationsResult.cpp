...
ListPerformanceAnalysisReportRecommendationsResult::ListPerformanceAnalysisReportRecommendationsResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ListPerformanceAnalysisReportRecommendationsResult& ListPerformanceAnalysisReportRecommendationsResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
