...
namespace Model
{
  ...
  public:
     ...
     * </li> <li> <p> <code>db.blocking_sql</code> - The SQL queries blocking the most
     * DB load.</p> </li> <li> <p> <code>db.blocking_session</code> - The sessions
     * blocking the most DB load.</p> </li> <li> <p> <code>db.blocking_object</code> -
     * The object resources acquired by other sessions that are blocking the most DB
     * load.</p> </li> <li> <p> <code>db.host</code> - The host name of the connected
     * client (all engines).</p> </li> <li> <p> <code>db.plans</code> - The execution
     * plans for the query (only Aurora PostgreSQL).</p> </li> <li> <p>
     * <code>db.query</code> - The query that is currently running (only Amazon
     * DocumentDB).</p> </li> <li> <p> <code>db.query_tokenized</code> - The digest
     * query (only Amazon DocumentDB).</p> </li> <li> <p> <code>db.session_type</code>
     * - The type of the current session (only Aurora PostgreSQL and RDS
     * PostgreSQL).</p> </li> <li> <p> <code>db.sql</code> - The text of the SQL
     * statement that is currently running (all engines except Amazon DocumentDB).</p>
     * </li> <li> <p> <code>db.sql_tokenized</code> - The SQL digest (all engines
     * except Amazon DocumentDB).</p> </li> <li> <p> <code>db.user</code> - The user
     * logged in to the database (all engines except Amazon DocumentDB).</p> </li> <li>
     * <p> <code>db.wait_event</code> - The event for which the database backend is
    ...
    template<typename GroupT = Aws::String>
    DimensionGroup& WithGroup(GroupT&& value) { SetGroup(std::forward<GroupT>(value)); return *this;}
    ///@}
     ...
     * DocumentDB</p> </li> </ul> </li> <li> <p> <code>db.blocking_sql.id</code> - The
     * ID for each of the SQL queries blocking the most DB load.</p> </li> <li> <p>
     * <code>db.blocking_sql.sql</code> - The SQL text for each of the SQL queries
     * blocking the most DB load.</p> </li> <li> <p>
     * <code>db.blocking_session.id</code> - The ID for each of the sessions blocking
     * the most DB load.</p> </li> <li> <p> <code>db.blocking_object.id</code> - The ID
     * for each of the object resources acquired by other sessions that are blocking
     * the most DB load.</p> </li> <li> <p> <code>db.blocking_object.type</code> - The
     * object type for each of the object resources acquired by other sessions that are
     * blocking the most DB load.</p> </li> <li> <p>
     * <code>db.blocking_object.value</code> - The value for each of the object
     * resources acquired by other sessions that are blocking the most DB load.</p>
     * </li> <li> <p> <code>db.host.id</code> - The host ID of the connected client
     * (all engines).</p> </li> <li> <p> <code>db.host.name</code> - The host name of
     * the connected client (all engines).</p> </li> <li> <p> <code>db.name</code> -
     * The name of the database to which the client is connected. Valid values are as
     * follows:</p> <ul> <li> <p>Aurora PostgreSQL</p> </li> <li> <p>Amazon RDS
     * PostgreSQL</p> </li> <li> <p>Aurora MySQL</p> </li> <li> <p>Amazon RDS MySQL</p>
     * </li> <li> <p>Amazon RDS MariaDB</p> </li> <li> <p>Amazon DocumentDB</p> </li>
     * </ul> </li> <li> <p> <code>db.query.id</code> - The query ID generated by
     ...
     * Amazon DocumentDB).</p> </li> <li> <p> <code>db.query.statement</code> - The
     * text of the query that is being run (only Amazon DocumentDB).</p> </li> <li> <p>
     * <code>db.query.tokenized_id</code> </p> </li> <li> <p>
     ...
     * DocumentDB)</p> </li> <li> <p> <code>db.sql.tokenized_id</code> - The hash of
     * the SQL digest generated by Performance Insights (all engines except Amazon
     * DocumentDB). The <code>db.sql.tokenized_id</code> dimension fetches the value of
     * the <code>db.sql_tokenized.id</code> dimension. Amazon RDS returns
     * <code>db.sql.tokenized_id</code> from the <code>db.sql</code> dimension group.
     * </p> </li> <li> <p> <code>db.sql_tokenized.id</code> - The hash of the SQL
     * digest generated by Performance Insights (all engines except Amazon DocumentDB).
     * In the console, <code>db.sql_tokenized.id</code> is called the Support ID
     * because Amazon Web Services Support can look at this data to help you
     * troubleshoot database issues.</p> </li> <li> <p>
     * <code>db.sql_tokenized.db_id</code> - Either the native database ID used to
     * refer to the SQL statement, or a synthetic ID such as <code>pi-2372568224</code>
     * that Performance Insights generates if the native database ID isn't available
     * (all engines except Amazon DocumentDB).</p> </li> <li> <p>
     * <code>db.sql_tokenized.statement</code> - The text of the SQL digest, as in
     * <code>SELECT * FROM employees WHERE employee_id = ?</code> (all engines except
     * Amazon DocumentDB)</p> </li> <li> <p> <code>db.user.id</code> - The ID of the
     * user logged in to the database (all engines except Amazon DocumentDB).</p> </li>
     * <li> <p> <code>db.user.name</code> - The name of the user logged in to the
    ...
    template<typename DimensionsT = Aws::Vector<Aws::String>>
    DimensionGroup& WithDimensions(DimensionsT&& value) { SetDimensions(std::forward<DimensionsT>(value)); return *this;}
    template<typename DimensionsT = Aws::String>
    DimensionGroup& AddDimensions(DimensionsT&& value) { m_dimensionsHasBeenSet = true; m_dimensions.emplace_back(std::forward<DimensionsT>(value)); return *this; }
    ///@}
