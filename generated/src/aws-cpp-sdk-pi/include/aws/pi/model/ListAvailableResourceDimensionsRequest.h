...
class ListAvailableResourceDimensionsRequest : public PIRequest {
 public:
  ...
  inline ListAvailableResourceDimensionsRequest& WithServiceType(ServiceType value) {
  ...
  template <typename IdentifierT = Aws::String>
  ListAvailableResourceDimensionsRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename MetricsT = Aws::Vector<Aws::String>>
  ListAvailableResourceDimensionsRequest& WithMetrics(MetricsT&& value) {
    SetMetrics(std::forward<MetricsT>(value));
    return *this;
  }
  template <typename MetricsT = Aws::String>
  ListAvailableResourceDimensionsRequest& AddMetrics(MetricsT&& value) {
    m_metricsHasBeenSet = true;
  ...
  inline ListAvailableResourceDimensionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAvailableResourceDimensionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetAuthorizedActions(AuthorizedActionsT&& value) {
    m_authorizedActionsHasBeenSet = true;
    m_authorizedActions = std::forward<AuthorizedActionsT>(value);
  }
  template <typename AuthorizedActionsT = Aws::Vector<FineGrainedAction>>
  ListAvailableResourceDimensionsRequest& WithAuthorizedActions(AuthorizedActionsT&& value) {
    SetAuthorizedActions(std::forward<AuthorizedActionsT>(value));
    return *this;
  }
  inline ListAvailableResourceDimensionsRequest& AddAuthorizedActions(FineGrainedAction value) {
    m_authorizedActionsHasBeenSet = true;
    m_authorizedActions.push_back(value);
    return *this;
  }
  ///@}
 private:
