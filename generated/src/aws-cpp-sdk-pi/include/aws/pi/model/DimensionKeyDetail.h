...
class DimensionKeyDetail {
 public:
  ...
  template <typename ValueT = Aws::String>
  DimensionKeyDetail& WithValue(ValueT&& value) {
  ...
  template <typename DimensionT = Aws::String>
  DimensionKeyDetail& WithDimension(DimensionT&& value) {
  ...
  inline void SetStatus(DetailStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DimensionKeyDetail& WithStatus(DetailStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
