...
class GetDimensionKeyDetailsResult {
 public:
  ...
  template <typename DimensionsT = Aws::Vector<DimensionKeyDetail>>
  GetDimensionKeyDetailsResult& WithDimensions(DimensionsT&& value) {
    SetDimensions(std::forward<DimensionsT>(value));
    return *this;
  }
  template <typename DimensionsT = DimensionKeyDetail>
  GetDimensionKeyDetailsResult& AddDimensions(DimensionsT&& value) {
    m_dimensionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetDimensionKeyDetailsResult& WithRequestId(RequestIdT&& value) {
