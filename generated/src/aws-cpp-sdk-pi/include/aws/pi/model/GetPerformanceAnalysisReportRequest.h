...
class GetPerformanceAnalysisReportRequest : public PIRequest {
 public:
  ...
  inline GetPerformanceAnalysisReportRequest& WithServiceType(ServiceType value) {
  ...
  template <typename IdentifierT = Aws::String>
  GetPerformanceAnalysisReportRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename AnalysisReportIdT = Aws::String>
  GetPerformanceAnalysisReportRequest& WithAnalysisReportId(AnalysisReportIdT&& value) {
  ...
  inline void SetTextFormat(TextFormat value) {
    m_textFormatHasBeenSet = true;
    m_textFormat = value;
  }
  inline GetPerformanceAnalysisReportRequest& WithTextFormat(TextFormat value) {
    SetTextFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAcceptLanguage(AcceptLanguage value) {
    m_acceptLanguageHasBeenSet = true;
    m_acceptLanguage = value;
  }
  inline GetPerformanceAnalysisReportRequest& WithAcceptLanguage(AcceptLanguage value) {
