...
class DimensionKeyDescription {
 public:
  ...
  inline DimensionKeyDescription& WithTotal(double value) {
    SetTotal(value);
    return *this;
  }
  ///@}
  ...
  void SetAdditionalMetrics(AdditionalMetricsT&& value) {
    ...
    m_additionalMetrics = std::forward<AdditionalMetricsT>(value);
  }
  template <typename AdditionalMetricsT = Aws::Map<Aws::String, double>>
  DimensionKeyDescription& WithAdditionalMetrics(AdditionalMetricsT&& value) {
    SetAdditionalMetrics(std::forward<AdditionalMetricsT>(value));
    return *this;
  }
  inline DimensionKeyDescription& AddAdditionalMetrics(Aws::String key, double value) {
    m_additionalMetricsHasBeenSet = true;
    m_additionalMetrics.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  inline DimensionKeyDescription& AddPartitions(double value) {
    m_partitionsHasBeenSet = true;
    m_partitions.push_back(value);
    return *this;
  }
  ///@}
 private:
