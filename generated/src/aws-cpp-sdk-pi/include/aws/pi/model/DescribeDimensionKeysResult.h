...
class DescribeDimensionKeysResult {
 public:
  ...
  void SetAlignedStartTime(AlignedStartTimeT&& value) {
    ...
    m_alignedStartTime = std::forward<AlignedStartTimeT>(value);
  }
  template <typename AlignedStartTimeT = Aws::Utils::DateTime>
  DescribeDimensionKeysResult& WithAlignedStartTime(AlignedStartTimeT&& value) {
    SetAlignedStartTime(std::forward<AlignedStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAlignedEndTime(AlignedEndTimeT&& value) {
    ...
    m_alignedEndTime = std::forward<AlignedEndTimeT>(value);
  }
  template <typename AlignedEndTimeT = Aws::Utils::DateTime>
  DescribeDimensionKeysResult& WithAlignedEndTime(AlignedEndTimeT&& value) {
    SetAlignedEndTime(std::forward<AlignedEndTimeT>(value));
    return *this;
  }
  ///@}
