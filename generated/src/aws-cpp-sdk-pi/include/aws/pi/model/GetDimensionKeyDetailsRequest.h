...
class GetDimensionKeyDetailsRequest : public PIRequest {
 public:
  ...
  inline GetDimensionKeyDetailsRequest& WithServiceType(ServiceType value) {
  ...
  void SetRequestedDimensions(RequestedDimensionsT&& value) {
    m_requestedDimensionsHasBeenSet = true;
    m_requestedDimensions = std::forward<RequestedDimensionsT>(value);
  }
  template <typename RequestedDimensionsT = Aws::Vector<Aws::String>>
  GetDimensionKeyDetailsRequest& WithRequestedDimensions(RequestedDimensionsT&& value) {
    SetRequestedDimensions(std::forward<RequestedDimensionsT>(value));
    return *this;
  }
  ...
  GetDimensionKeyDetailsRequest& AddRequestedDimensions(RequestedDimensionsT&& value) {
    m_requestedDimensionsHasBeenSet = true;
    m_requestedDimensions.emplace_back(std::forward<RequestedDimensionsT>(value));
    return *this;
  }
  ///@}
 private:
