...
class Insight {
 public:
  ...
  void SetInsightType(InsightTypeT&& value) {
    ...
    m_insightType = std::forward<InsightTypeT>(value);
  }
  template <typename InsightTypeT = Aws::String>
  Insight& WithInsightType(InsightTypeT&& value) {
    SetInsightType(std::forward<InsightTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetContext(ContextType value) {
    m_contextHasBeenSet = true;
    m_context = value;
  }
  inline Insight& WithContext(ContextType value) {
    SetContext(value);
    return *this;
  }
  ///@}
  ...
  inline Insight& WithSeverity(Severity value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportingInsights(SupportingInsightsT&& value) {
    ...
    m_supportingInsights = std::forward<SupportingInsightsT>(value);
  }
  template <typename SupportingInsightsT = Aws::Vector<Insight>>
  Insight& WithSupportingInsights(SupportingInsightsT&& value) {
    SetSupportingInsights(std::forward<SupportingInsightsT>(value));
    return *this;
  }
  template <typename SupportingInsightsT = Insight>
  Insight& AddSupportingInsights(SupportingInsightsT&& value) {
    m_supportingInsightsHasBeenSet = true;
    m_supportingInsights.emplace_back(std::forward<SupportingInsightsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInsightData(InsightDataT&& value) {
    ...
    m_insightData = std::forward<InsightDataT>(value);
  }
  template <typename InsightDataT = Aws::Vector<Data>>
  Insight& WithInsightData(InsightDataT&& value) {
    SetInsightData(std::forward<InsightDataT>(value));
    return *this;
  }
  template <typename InsightDataT = Data>
  Insight& AddInsightData(InsightDataT&& value) {
    m_insightDataHasBeenSet = true;
    m_insightData.emplace_back(std::forward<InsightDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBaselineData(BaselineDataT&& value) {
    ...
    m_baselineData = std::forward<BaselineDataT>(value);
  }
  template <typename BaselineDataT = Aws::Vector<Data>>
  Insight& WithBaselineData(BaselineDataT&& value) {
    SetBaselineData(std::forward<BaselineDataT>(value));
    return *this;
  }
  template <typename BaselineDataT = Data>
  Insight& AddBaselineData(BaselineDataT&& value) {
    m_baselineDataHasBeenSet = true;
    m_baselineData.emplace_back(std::forward<BaselineDataT>(value));
    return *this;
  }
  ///@}
 private:
