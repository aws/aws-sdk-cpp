...
class ListAvailableResourceMetricsRequest : public PIRequest {
 public:
  ...
  inline ListAvailableResourceMetricsRequest& WithServiceType(ServiceType value) {
  ...
  template <typename IdentifierT = Aws::String>
  ListAvailableResourceMetricsRequest& WithIdentifier(IdentifierT&& value) {
  ...
  void SetMetricTypes(MetricTypesT&& value) {
    m_metricTypesHasBeenSet = true;
    m_metricTypes = std::forward<MetricTypesT>(value);
  }
  template <typename MetricTypesT = Aws::Vector<Aws::String>>
  ListAvailableResourceMetricsRequest& WithMetricTypes(MetricTypesT&& value) {
    SetMetricTypes(std::forward<MetricTypesT>(value));
    return *this;
  }
  template <typename MetricTypesT = Aws::String>
  ListAvailableResourceMetricsRequest& AddMetricTypes(MetricTypesT&& value) {
    m_metricTypesHasBeenSet = true;
    m_metricTypes.emplace_back(std::forward<MetricTypesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAvailableResourceMetricsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAvailableResourceMetricsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
