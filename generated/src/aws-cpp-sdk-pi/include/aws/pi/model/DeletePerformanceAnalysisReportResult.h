...
namespace Model
{
  ...
  {
  public:
    AWS_PI_API DeletePerformanceAnalysisReportResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeletePerformanceAnalysisReportResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
