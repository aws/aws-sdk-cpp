...
class DescribeDimensionKeysRequest : public PIRequest {
 public:
  ...
  inline DescribeDimensionKeysRequest& WithServiceType(ServiceType value) {
  ...
  inline DescribeDimensionKeysRequest& WithPeriodInSeconds(int value) {
  ...
  DescribeDimensionKeysRequest& AddAdditionalMetrics(AdditionalMetricsT&& value) {
    m_additionalMetricsHasBeenSet = true;
    m_additionalMetrics.emplace_back(std::forward<AdditionalMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPartitionBy(PartitionByT&& value) {
    m_partitionByHasBeenSet = true;
    m_partitionBy = std::forward<PartitionByT>(value);
  }
  template <typename PartitionByT = DimensionGroup>
  DescribeDimensionKeysRequest& WithPartitionBy(PartitionByT&& value) {
    SetPartitionBy(std::forward<PartitionByT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeDimensionKeysRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
