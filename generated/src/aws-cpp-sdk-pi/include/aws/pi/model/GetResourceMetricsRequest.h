...
class GetResourceMetricsRequest : public PIRequest {
 public:
  ...
  inline GetResourceMetricsRequest& WithServiceType(ServiceType value) {
  ...
  void SetMetricQueries(MetricQueriesT&& value) {
    m_metricQueriesHasBeenSet = true;
    m_metricQueries = std::forward<MetricQueriesT>(value);
  }
  template <typename MetricQueriesT = Aws::Vector<MetricQuery>>
  GetResourceMetricsRequest& WithMetricQueries(MetricQueriesT&& value) {
    SetMetricQueries(std::forward<MetricQueriesT>(value));
    return *this;
  }
  template <typename MetricQueriesT = MetricQuery>
  GetResourceMetricsRequest& AddMetricQueries(MetricQueriesT&& value) {
    m_metricQueriesHasBeenSet = true;
    m_metricQueries.emplace_back(std::forward<MetricQueriesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPeriodInSeconds(int value) {
    m_periodInSecondsHasBeenSet = true;
    m_periodInSeconds = value;
  }
  inline GetResourceMetricsRequest& WithPeriodInSeconds(int value) {
    SetPeriodInSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline GetResourceMetricsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPeriodAlignment(PeriodAlignment value) {
    m_periodAlignmentHasBeenSet = true;
    m_periodAlignment = value;
  }
  inline GetResourceMetricsRequest& WithPeriodAlignment(PeriodAlignment value) {
    SetPeriodAlignment(value);
    return *this;
  }
  ///@}
 private:
