...
class ListAvailableResourceDimensionsResult {
 public:
  ...
  template <typename MetricDimensionsT = Aws::Vector<MetricDimensionGroups>>
  ListAvailableResourceDimensionsResult& WithMetricDimensions(MetricDimensionsT&& value) {
    SetMetricDimensions(std::forward<MetricDimensionsT>(value));
    return *this;
  }
  template <typename MetricDimensionsT = MetricDimensionGroups>
  ListAvailableResourceDimensionsResult& AddMetricDimensions(MetricDimensionsT&& value) {
    m_metricDimensionsHasBeenSet = true;
    m_metricDimensions.emplace_back(std::forward<MetricDimensionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAvailableResourceDimensionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAvailableResourceDimensionsResult& WithRequestId(RequestIdT&& value) {
