...
class GetPerformanceAnalysisReportResult {
 public:
  ...
  void SetAnalysisReport(AnalysisReportT&& value) {
    m_analysisReportHasBeenSet = true;
    m_analysisReport = std::forward<AnalysisReportT>(value);
  }
  template <typename AnalysisReportT = AnalysisReport>
  GetPerformanceAnalysisReportResult& WithAnalysisReport(AnalysisReportT&& value) {
    SetAnalysisReport(std::forward<AnalysisReportT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetPerformanceAnalysisReportResult& WithRequestId(RequestIdT&& value) {
