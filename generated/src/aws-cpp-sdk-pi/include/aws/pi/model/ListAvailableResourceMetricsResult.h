...
class ListAvailableResourceMetricsResult {
 public:
  ...
  template <typename MetricsT = Aws::Vector<ResponseResourceMetric>>
  ListAvailableResourceMetricsResult& WithMetrics(MetricsT&& value) {
    SetMetrics(std::forward<MetricsT>(value));
    return *this;
  }
  template <typename MetricsT = ResponseResourceMetric>
  ListAvailableResourceMetricsResult& AddMetrics(MetricsT&& value) {
    m_metricsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAvailableResourceMetricsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAvailableResourceMetricsResult& WithRequestId(RequestIdT&& value) {
