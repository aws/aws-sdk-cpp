...
class ListPerformanceAnalysisReportsRequest : public PIRequest {
 public:
  ...
  inline ListPerformanceAnalysisReportsRequest& WithServiceType(ServiceType value) {
  ...
  template <typename IdentifierT = Aws::String>
  ListPerformanceAnalysisReportsRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPerformanceAnalysisReportsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPerformanceAnalysisReportsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetListTags(bool value) {
    m_listTagsHasBeenSet = true;
    m_listTags = value;
  }
  inline ListPerformanceAnalysisReportsRequest& WithListTags(bool value) {
    SetListTags(value);
    return *this;
  }
  ///@}
