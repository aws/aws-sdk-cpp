 ...
 */
using PIEndpointProviderBase = EndpointProviderBase<PIClientConfiguration, PIBuiltInParameters, PIClientContextParameters>;

using PIDefaultEpProviderBase = DefaultEndpointProvider<PIClientConfiguration, PIBuiltInParameters, PIClientContextParameters>;
