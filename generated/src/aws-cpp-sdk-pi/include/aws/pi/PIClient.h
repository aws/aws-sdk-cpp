...
class AWS_PI_API PIClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  PIClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<PIEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePerformanceAnalysisReportOutcome CreatePerformanceAnalysisReport(
      const Model::CreatePerformanceAnalysisReportRequest& request) const;

  /**
   * A Callable wrapper for CreatePerformanceAnalysisReport that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePerformanceAnalysisReportRequestT = Model::CreatePerformanceAnalysisReportRequest>
  Model::CreatePerformanceAnalysisReportOutcomeCallable CreatePerformanceAnalysisReportCallable(
      const CreatePerformanceAnalysisReportRequestT& request) const {
    return SubmitCallable(&PIClient::CreatePerformanceAnalysisReport, request);
  }

  /**
   * An Async wrapper for CreatePerformanceAnalysisReport that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreatePerformanceAnalysisReportRequestT = Model::CreatePerformanceAnalysisReportRequest>
  void CreatePerformanceAnalysisReportAsync(const CreatePerformanceAnalysisReportRequestT& request,
                                            const CreatePerformanceAnalysisReportResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeletePerformanceAnalysisReportOutcome DeletePerformanceAnalysisReport(
      const Model::DeletePerformanceAnalysisReportRequest& request) const;

  /**
   * A Callable wrapper for DeletePerformanceAnalysisReport that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeletePerformanceAnalysisReportRequestT = Model::DeletePerformanceAnalysisReportRequest>
  Model::DeletePerformanceAnalysisReportOutcomeCallable DeletePerformanceAnalysisReportCallable(
      const DeletePerformanceAnalysisReportRequestT& request) const {
    return SubmitCallable(&PIClient::DeletePerformanceAnalysisReport, request);
  }

  /**
   * An Async wrapper for DeletePerformanceAnalysisReport that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeletePerformanceAnalysisReportRequestT = Model::DeletePerformanceAnalysisReportRequest>
  void DeletePerformanceAnalysisReportAsync(const DeletePerformanceAnalysisReportRequestT& request,
                                            const DeletePerformanceAnalysisReportResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDimensionKeys that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDimensionKeys that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDimensionKeysRequestT = Model::DescribeDimensionKeysRequest>
  void DescribeDimensionKeysAsync(const DescribeDimensionKeysRequestT& request, const DescribeDimensionKeysResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDimensionKeyDetails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDimensionKeyDetails that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDimensionKeyDetailsRequestT = Model::GetDimensionKeyDetailsRequest>
  void GetDimensionKeyDetailsAsync(const GetDimensionKeyDetailsRequestT& request,
                                   const GetDimensionKeyDetailsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetPerformanceAnalysisReportOutcome GetPerformanceAnalysisReport(
      const Model::GetPerformanceAnalysisReportRequest& request) const;

  /**
   * A Callable wrapper for GetPerformanceAnalysisReport that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetPerformanceAnalysisReportRequestT = Model::GetPerformanceAnalysisReportRequest>
  Model::GetPerformanceAnalysisReportOutcomeCallable GetPerformanceAnalysisReportCallable(
      const GetPerformanceAnalysisReportRequestT& request) const {
    return SubmitCallable(&PIClient::GetPerformanceAnalysisReport, request);
  }

  /**
   * An Async wrapper for GetPerformanceAnalysisReport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPerformanceAnalysisReportRequestT = Model::GetPerformanceAnalysisReportRequest>
  void GetPerformanceAnalysisReportAsync(const GetPerformanceAnalysisReportRequestT& request,
                                         const GetPerformanceAnalysisReportResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResourceMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourceMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetResourceMetadataRequestT = Model::GetResourceMetadataRequest>
  void GetResourceMetadataAsync(const GetResourceMetadataRequestT& request, const GetResourceMetadataResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResourceMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourceMetrics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetResourceMetricsRequestT = Model::GetResourceMetricsRequest>
  void GetResourceMetricsAsync(const GetResourceMetricsRequestT& request, const GetResourceMetricsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAvailableResourceDimensionsOutcome ListAvailableResourceDimensions(
      const Model::ListAvailableResourceDimensionsRequest& request) const;

  /**
   * A Callable wrapper for ListAvailableResourceDimensions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAvailableResourceDimensionsRequestT = Model::ListAvailableResourceDimensionsRequest>
  Model::ListAvailableResourceDimensionsOutcomeCallable ListAvailableResourceDimensionsCallable(
      const ListAvailableResourceDimensionsRequestT& request) const {
    return SubmitCallable(&PIClient::ListAvailableResourceDimensions, request);
  }

  /**
   * An Async wrapper for ListAvailableResourceDimensions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAvailableResourceDimensionsRequestT = Model::ListAvailableResourceDimensionsRequest>
  void ListAvailableResourceDimensionsAsync(const ListAvailableResourceDimensionsRequestT& request,
                                            const ListAvailableResourceDimensionsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAvailableResourceMetricsOutcome ListAvailableResourceMetrics(
      const Model::ListAvailableResourceMetricsRequest& request) const;

  /**
   * A Callable wrapper for ListAvailableResourceMetrics that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAvailableResourceMetricsRequestT = Model::ListAvailableResourceMetricsRequest>
  Model::ListAvailableResourceMetricsOutcomeCallable ListAvailableResourceMetricsCallable(
      const ListAvailableResourceMetricsRequestT& request) const {
    return SubmitCallable(&PIClient::ListAvailableResourceMetrics, request);
  }

  /**
   * An Async wrapper for ListAvailableResourceMetrics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAvailableResourceMetricsRequestT = Model::ListAvailableResourceMetricsRequest>
  void ListAvailableResourceMetricsAsync(const ListAvailableResourceMetricsRequestT& request,
                                         const ListAvailableResourceMetricsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPerformanceAnalysisReportsOutcome ListPerformanceAnalysisReports(
      const Model::ListPerformanceAnalysisReportsRequest& request) const;

  /**
   * A Callable wrapper for ListPerformanceAnalysisReports that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPerformanceAnalysisReportsRequestT = Model::ListPerformanceAnalysisReportsRequest>
  Model::ListPerformanceAnalysisReportsOutcomeCallable ListPerformanceAnalysisReportsCallable(
      const ListPerformanceAnalysisReportsRequestT& request) const {
    return SubmitCallable(&PIClient::ListPerformanceAnalysisReports, request);
  }

  /**
   * An Async wrapper for ListPerformanceAnalysisReports that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListPerformanceAnalysisReportsRequestT = Model::ListPerformanceAnalysisReportsRequest>
  void ListPerformanceAnalysisReportsAsync(const ListPerformanceAnalysisReportsRequestT& request,
                                           const ListPerformanceAnalysisReportsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
