...
/**
 * <p>The specified resource was not found. You can only access or modify a
 * resource that already exists.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mwaa-serverless-2024-07-26/ResourceNotFoundException">AWS
 * API Reference</a></p>
 */
class ResourceNotFoundException {
 public:
  AWS_MWAASERVERLESS_API ResourceNotFoundException() = default;
  AWS_MWAASERVERLESS_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
  AWS_MWAASERVERLESS_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
