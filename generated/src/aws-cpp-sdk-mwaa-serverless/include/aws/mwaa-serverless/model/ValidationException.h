...
/**
 * <p>The specified request parameters are invalid, missing, or inconsistent with
 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/mwaa-serverless-2024-07-26/ValidationException">AWS
 * API Reference</a></p>
 */
class ValidationException {
 public:
  AWS_MWAASERVERLESS_API ValidationException() = default;
  AWS_MWAASERVERLESS_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
  AWS_MWAASERVERLESS_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
