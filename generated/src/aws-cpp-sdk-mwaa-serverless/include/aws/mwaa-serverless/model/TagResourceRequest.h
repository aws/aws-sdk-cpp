...
/**
 */
class TagResourceRequest : public MWAAServerlessRequest {
 public:
  AWS_MWAASERVERLESS_API TagResourceRequest() = default;
  ...
  ///@{
  /**
   * <p>A map of tags to add to the resource. Each tag consists of a key-value
   * pair.</p>
   */
