...
/**
 */
class DeleteWorkflowRequest : public MWAAServerlessRequest {
 public:
  AWS_MWAASERVERLESS_API DeleteWorkflowRequest() = default;
  ...
  template <typename WorkflowArnT = Aws::String>
  DeleteWorkflowRequest& WithWorkflowArn(WorkflowArnT&& value) {
  ...
  ///@{
  /**
   * <p>Optional. The specific version of the workflow to delete. If not specified,
   * all versions of the workflow are deleted.</p>
   */
  ...
  template <typename WorkflowVersionT = Aws::String>
  DeleteWorkflowRequest& WithWorkflowVersion(WorkflowVersionT&& value) {
