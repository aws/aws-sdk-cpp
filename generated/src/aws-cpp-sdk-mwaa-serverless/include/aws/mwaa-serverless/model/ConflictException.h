...
/**
 * <p>You cannot create a resource that already exists, or the resource is in a
 * state that prevents the requested operation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mwaa-serverless-2024-07-26/ConflictException">AWS
 * API Reference</a></p>
 */
class ConflictException {
 public:
  AWS_MWAASERVERLESS_API ConflictException() = default;
  AWS_MWAASERVERLESS_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
  AWS_MWAASERVERLESS_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
