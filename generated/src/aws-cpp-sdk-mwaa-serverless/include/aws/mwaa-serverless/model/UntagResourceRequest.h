...
/**
 */
class UntagResourceRequest : public MWAAServerlessRequest {
 public:
  AWS_MWAASERVERLESS_API UntagResourceRequest() = default;
  ...
  ///@{
  /**
   * <p>A list of tag keys to remove from the resource. Only the keys are required;
