...
/**
 * <p>Describes a validation exception for a specific field.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/uxc-2024-07-01/ValidationExceptionField">AWS
 * API Reference</a></p>
 */
