...
GetAccountCustomizationsResult::GetAccountCustomizationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetAccountCustomizationsResult& GetAccountCustomizationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
