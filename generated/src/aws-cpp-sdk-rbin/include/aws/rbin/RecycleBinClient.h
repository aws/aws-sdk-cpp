...
namespace RecycleBin
{
   ...
   */
  class AWS_RECYCLEBIN_API RecycleBinClient : Aws::Client::ClientWithAsyncTemplateMethods<RecycleBinClient>,
    smithy::client::AwsSmithyClientT<Aws::RecycleBin::SERVICE_NAME,
