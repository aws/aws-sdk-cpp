...
class CreateRuleResult {
 public:
  ...
  inline CreateRuleResult& WithResourceType(ResourceType value) {
  ...
  inline CreateRuleResult& WithStatus(RuleStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateRuleResult& WithLockState(LockState value) {
    SetLockState(value);
    return *this;
  }
  ///@}
