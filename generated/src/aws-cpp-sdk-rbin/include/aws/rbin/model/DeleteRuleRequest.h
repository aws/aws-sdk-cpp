...
namespace Model
{
  ...
  {
  public:
    AWS_RECYCLEBIN_API DeleteRuleRequest() = default;
    ...
    template<typename IdentifierT = Aws::String>
    DeleteRuleRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
  private:
