...
class GetRuleResult {
 public:
  ...
  inline GetRuleResult& WithResourceType(ResourceType value) {
  ...
  inline GetRuleResult& WithStatus(RuleStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetRuleResult& WithLockState(LockState value) {
    SetLockState(value);
    return *this;
  }
  ///@}
