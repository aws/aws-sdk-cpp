...
class ResourceTag {
 public:
  ...
  void SetResourceTagKey(ResourceTagKeyT&& value) {
    m_resourceTagKeyHasBeenSet = true;
    m_resourceTagKey = std::forward<ResourceTagKeyT>(value);
  }
  template <typename ResourceTagKeyT = Aws::String>
  ResourceTag& WithResourceTagKey(ResourceTagKeyT&& value) {
    SetResourceTagKey(std::forward<ResourceTagKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResourceTagValue(ResourceTagValueT&& value) {
    m_resourceTagValueHasBeenSet = true;
    m_resourceTagValue = std::forward<ResourceTagValueT>(value);
  }
  template <typename ResourceTagValueT = Aws::String>
  ResourceTag& WithResourceTagValue(ResourceTagValueT&& value) {
    SetResourceTagValue(std::forward<ResourceTagValueT>(value));
    return *this;
  }
  ///@}
 private:
