...
class UnlockDelay {
 public:
  ...
  inline void SetUnlockDelayValue(int value) {
    m_unlockDelayValueHasBeenSet = true;
    m_unlockDelayValue = value;
  }
  inline UnlockDelay& WithUnlockDelayValue(int value) {
    SetUnlockDelayValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnlockDelayUnit(UnlockDelayUnit value) {
    m_unlockDelayUnitHasBeenSet = true;
    m_unlockDelayUnit = value;
  }
  inline UnlockDelay& WithUnlockDelayUnit(UnlockDelayUnit value) {
    SetUnlockDelayUnit(value);
    return *this;
  }
  ///@}
 private:
