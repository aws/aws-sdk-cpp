...
class UnlockRuleResult {
 public:
  ...
  inline UnlockRuleResult& WithResourceType(ResourceType value) {
  ...
  inline UnlockRuleResult& WithStatus(RuleStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLockConfiguration(LockConfigurationT&& value) {
    ...
    m_lockConfiguration = std::forward<LockConfigurationT>(value);
  }
  template <typename LockConfigurationT = LockConfiguration>
  UnlockRuleResult& WithLockConfiguration(LockConfigurationT&& value) {
    SetLockConfiguration(std::forward<LockConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline UnlockRuleResult& WithLockState(LockState value) {
    SetLockState(value);
    return *this;
  }
  ///@}
