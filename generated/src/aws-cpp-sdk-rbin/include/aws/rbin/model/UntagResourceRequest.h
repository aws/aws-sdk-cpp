...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public RecycleBinRequest
  {
  public:
    AWS_RECYCLEBIN_API UntagResourceRequest() = default;
    ...
    AWS_RECYCLEBIN_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;
