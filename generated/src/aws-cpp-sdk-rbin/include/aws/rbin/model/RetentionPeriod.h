...
class RetentionPeriod {
 public:
  ...
  inline void SetRetentionPeriodValue(int value) {
    m_retentionPeriodValueHasBeenSet = true;
    m_retentionPeriodValue = value;
  }
  inline RetentionPeriod& WithRetentionPeriodValue(int value) {
    SetRetentionPeriodValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRetentionPeriodUnit(RetentionPeriodUnit value) {
    m_retentionPeriodUnitHasBeenSet = true;
    m_retentionPeriodUnit = value;
  }
  inline RetentionPeriod& WithRetentionPeriodUnit(RetentionPeriodUnit value) {
    SetRetentionPeriodUnit(value);
    return *this;
  }
  ///@}
 private:
