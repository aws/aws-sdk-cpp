...
class LockRuleResult {
 public:
  ...
  inline LockRuleResult& WithResourceType(ResourceType value) {
  ...
  inline LockRuleResult& WithStatus(RuleStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline LockRuleResult& WithLockState(LockState value) {
    SetLockState(value);
    return *this;
  }
  ///@}
