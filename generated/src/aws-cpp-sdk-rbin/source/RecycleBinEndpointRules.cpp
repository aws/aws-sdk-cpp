...
{
const size_t RecycleBinEndpointRules::RulesBlobStrLen = 3445;
const size_t RecycleBinEndpointRules::RulesBlobSize = 3446;
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','b','i',
'n','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
'r','b','i','n','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
'e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r',
't','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t',
'y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* RecycleBinEndpointRules::GetRulesBlob()
{
