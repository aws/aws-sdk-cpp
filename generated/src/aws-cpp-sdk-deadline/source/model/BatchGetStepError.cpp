...
BatchGetStepError::BatchGetStepError(JsonView jsonValue) { *this = jsonValue; }

BatchGetStepError& BatchGetStepError::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("code")) {
    m_code = BatchGetStepErrorCodeMapper::GetBatchGetStepErrorCodeForName(jsonValue.GetString("code"));
...
JsonValue BatchGetStepError::Jsonize() const {
  JsonValue payload;
  ...
  if (m_codeHasBeenSet) {
    payload.WithString("code", BatchGetStepErrorCodeMapper::GetNameForBatchGetStepErrorCode(m_code));
  }
