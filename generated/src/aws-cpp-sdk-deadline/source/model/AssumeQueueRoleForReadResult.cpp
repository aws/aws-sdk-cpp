...
AssumeQueueRoleForReadResult::AssumeQueueRoleForReadResult()
{
}

AssumeQueueRoleForReadResult::AssumeQueueRoleForReadResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
