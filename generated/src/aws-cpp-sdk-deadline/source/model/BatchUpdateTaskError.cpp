...
BatchUpdateTaskError::BatchUpdateTaskError(JsonView jsonValue) { *this = jsonValue; }

BatchUpdateTaskError& BatchUpdateTaskError::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("code")) {
    m_code = BatchUpdateTaskErrorCodeMapper::GetBatchUpdateTaskErrorCodeForName(jsonValue.GetString("code"));
...
JsonValue BatchUpdateTaskError::Jsonize() const {
  JsonValue payload;
  ...
  if (m_codeHasBeenSet) {
    payload.WithString("code", BatchUpdateTaskErrorCodeMapper::GetNameForBatchUpdateTaskErrorCode(m_code));
  }
