...
BatchGetSessionResult::BatchGetSessionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchGetSessionResult& BatchGetSessionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
