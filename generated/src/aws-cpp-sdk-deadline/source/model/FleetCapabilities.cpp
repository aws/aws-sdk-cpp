...
FleetCapabilities::FleetCapabilities(JsonView jsonValue) { *this = jsonValue; }

FleetCapabilities& FleetCapabilities::operator=(JsonView jsonValue) {
...
JsonValue FleetCapabilities::Jsonize() const {
  JsonValue payload;
