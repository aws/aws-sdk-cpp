...
BatchGetStepItem::BatchGetStepItem(JsonView jsonValue) { *this = jsonValue; }

BatchGetStepItem& BatchGetStepItem::operator=(JsonView jsonValue) {
...
JsonValue BatchGetStepItem::Jsonize() const {
  JsonValue payload;
  ...
  if (m_requiredCapabilitiesHasBeenSet) {
    payload.WithObject("requiredCapabilities", m_requiredCapabilities.Jsonize());
  }
