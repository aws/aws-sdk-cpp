...
BatchGetStepResult::BatchGetStepResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchGetStepResult& BatchGetStepResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
