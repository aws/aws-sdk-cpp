...
BatchGetTaskItem::BatchGetTaskItem(JsonView jsonValue) { *this = jsonValue; }

BatchGetTaskItem& BatchGetTaskItem::operator=(JsonView jsonValue) {
...
JsonValue BatchGetTaskItem::Jsonize() const {
  JsonValue payload;
