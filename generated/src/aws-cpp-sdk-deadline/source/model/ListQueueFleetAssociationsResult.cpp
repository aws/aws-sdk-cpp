...
ListQueueFleetAssociationsResult::ListQueueFleetAssociationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListQueueFleetAssociationsResult& ListQueueFleetAssociationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("queueFleetAssociations")) {
    ...
    for (unsigned queueFleetAssociationsIndex = 0; queueFleetAssociationsIndex < queueFleetAssociationsJsonList.GetLength();
         ++queueFleetAssociationsIndex) {
      m_queueFleetAssociations.push_back(queueFleetAssociationsJsonList[queueFleetAssociationsIndex].AsObject());
    }
    m_queueFleetAssociationsHasBeenSet = true;
  }
