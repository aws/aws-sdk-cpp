...
BatchGetWorkerItem::BatchGetWorkerItem(JsonView jsonValue) { *this = jsonValue; }

BatchGetWorkerItem& BatchGetWorkerItem::operator=(JsonView jsonValue) {
...
JsonValue BatchGetWorkerItem::Jsonize() const {
  JsonValue payload;
