...
StringFilterExpression::StringFilterExpression(JsonView jsonValue) { *this = jsonValue; }

StringFilterExpression& StringFilterExpression::operator=(JsonView jsonValue) {
...
JsonValue StringFilterExpression::Jsonize() const {
  JsonValue payload;
