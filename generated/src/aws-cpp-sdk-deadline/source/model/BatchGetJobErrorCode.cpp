...
BatchGetJobErrorCode GetBatchGetJobErrorCodeForName(const Aws::String& name) {
  int hashCode = HashingUtils::HashString(name.c_str());
  if (hashCode == InternalServerErrorException_HASH) {
    return BatchGetJobErrorCode::InternalServerErrorException;
  } else if (hashCode == ResourceNotFoundException_HASH) {
    return BatchGetJobErrorCode::ResourceNotFoundException;
  } else if (hashCode == ValidationException_HASH) {
    return BatchGetJobErrorCode::ValidationException;
  } else if (hashCode == AccessDeniedException_HASH) {
    return BatchGetJobErrorCode::AccessDeniedException;
  } else if (hashCode == ThrottlingException_HASH) {
    return BatchGetJobErrorCode::ThrottlingException;
  }
  EnumParseOverflowContainer* overflowContainer = Aws::GetEnumOverflowContainer();
  if (overflowContainer) {
    overflowContainer->StoreOverflow(hashCode, name);
    return static_cast<BatchGetJobErrorCode>(hashCode);
  }

  return BatchGetJobErrorCode::NOT_SET;
}

Aws::String GetNameForBatchGetJobErrorCode(BatchGetJobErrorCode enumValue) {
  switch (enumValue) {
    case BatchGetJobErrorCode::NOT_SET:
      return {};
    case BatchGetJobErrorCode::InternalServerErrorException:
      return "InternalServerErrorException";
    case BatchGetJobErrorCode::ResourceNotFoundException:
      return "ResourceNotFoundException";
    case BatchGetJobErrorCode::ValidationException:
      return "ValidationException";
    case BatchGetJobErrorCode::AccessDeniedException:
      return "AccessDeniedException";
    case BatchGetJobErrorCode::ThrottlingException:
