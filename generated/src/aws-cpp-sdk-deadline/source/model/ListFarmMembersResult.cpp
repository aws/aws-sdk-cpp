...
ListFarmMembersResult::ListFarmMembersResult()
{
}

ListFarmMembersResult::ListFarmMembersResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListFarmMembersResult& ListFarmMembersResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
