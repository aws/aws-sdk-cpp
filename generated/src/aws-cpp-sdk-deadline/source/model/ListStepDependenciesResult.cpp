...
ListStepDependenciesResult::ListStepDependenciesResult()
{
}

ListStepDependenciesResult::ListStepDependenciesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
