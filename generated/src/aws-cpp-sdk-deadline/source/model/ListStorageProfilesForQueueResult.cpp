...
ListStorageProfilesForQueueResult::ListStorageProfilesForQueueResult()
{
}

ListStorageProfilesForQueueResult::ListStorageProfilesForQueueResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
