...
Aws::String CreateQueueRequest::SerializePayload() const {
  ...
  if (m_requiredFileSystemLocationNamesHasBeenSet) {
    ...
    for (unsigned requiredFileSystemLocationNamesIndex = 0;
      ...
      requiredFileSystemLocationNamesJsonList[requiredFileSystemLocationNamesIndex].AsString(
          m_requiredFileSystemLocationNames[requiredFileSystemLocationNamesIndex]);
    }
