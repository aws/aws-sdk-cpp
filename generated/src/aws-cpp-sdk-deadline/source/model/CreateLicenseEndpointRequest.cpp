...
Aws::String CreateLicenseEndpointRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection CreateLicenseEndpointRequest::GetRequestSpecificHeaders() const
{
