...
ListMeteredProductsResult::ListMeteredProductsResult()
{
}

ListMeteredProductsResult::ListMeteredProductsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListMeteredProductsResult& ListMeteredProductsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
