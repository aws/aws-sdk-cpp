...
BatchGetJobResult::BatchGetJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchGetJobResult& BatchGetJobResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
