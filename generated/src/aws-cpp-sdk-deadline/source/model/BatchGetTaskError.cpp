...
BatchGetTaskError::BatchGetTaskError(JsonView jsonValue) { *this = jsonValue; }

BatchGetTaskError& BatchGetTaskError::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("code")) {
    m_code = BatchGetTaskErrorCodeMapper::GetBatchGetTaskErrorCodeForName(jsonValue.GetString("code"));
...
JsonValue BatchGetTaskError::Jsonize() const {
  JsonValue payload;
  ...
  if (m_codeHasBeenSet) {
    payload.WithString("code", BatchGetTaskErrorCodeMapper::GetNameForBatchGetTaskErrorCode(m_code));
  }
