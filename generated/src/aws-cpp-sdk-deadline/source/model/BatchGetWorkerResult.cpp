...
BatchGetWorkerResult::BatchGetWorkerResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchGetWorkerResult& BatchGetWorkerResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
