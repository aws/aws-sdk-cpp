...
ListFleetMembersResult::ListFleetMembersResult()
{
}

ListFleetMembersResult::ListFleetMembersResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListFleetMembersResult& ListFleetMembersResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
