...
ListFarmsResult::ListFarmsResult()
{
}

ListFarmsResult::ListFarmsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
...
ListFarmsResult& ListFarmsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  ...
  if(jsonValue.ValueExists("farms"))
  {
    ...
    for(unsigned farmsIndex = 0; farmsIndex < farmsJsonList.GetLength(); ++farmsIndex)
    {
