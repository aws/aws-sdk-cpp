...
ListStepConsumersResult::ListStepConsumersResult()
{
}

ListStepConsumersResult::ListStepConsumersResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListStepConsumersResult& ListStepConsumersResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
