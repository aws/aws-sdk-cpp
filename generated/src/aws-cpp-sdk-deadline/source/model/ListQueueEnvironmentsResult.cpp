...
ListQueueEnvironmentsResult::ListQueueEnvironmentsResult()
{
}

ListQueueEnvironmentsResult::ListQueueEnvironmentsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListQueueEnvironmentsResult& ListQueueEnvironmentsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
