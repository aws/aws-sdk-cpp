 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/GetLicenseEndpointResponse">AWS
 * API Reference</a></p>
 */
class GetLicenseEndpointResult {
 public:
  ...
  inline GetLicenseEndpointResult& WithStatus(LicenseEndpointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
