...
class EnvironmentDetailsIdentifiers {
 public:
  AWS_DEADLINE_API EnvironmentDetailsIdentifiers() = default;
  ...
  template <typename JobIdT = Aws::String>
  EnvironmentDetailsIdentifiers& WithJobId(JobIdT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  EnvironmentDetailsIdentifiers& WithEnvironmentId(EnvironmentIdT&& value) {
