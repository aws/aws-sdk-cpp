...
class CreateQueueEnvironmentRequest : public DeadlineRequest {
 public:
  ...
  inline CreateQueueEnvironmentRequest& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTemplateType(EnvironmentTemplateType value) {
    m_templateTypeHasBeenSet = true;
    m_templateType = value;
  }
  inline CreateQueueEnvironmentRequest& WithTemplateType(EnvironmentTemplateType value) {
