...
class DisassociateMemberFromQueueRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API DisassociateMemberFromQueueRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  DisassociateMemberFromQueueRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  DisassociateMemberFromQueueRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename PrincipalIdT = Aws::String>
  DisassociateMemberFromQueueRequest& WithPrincipalId(PrincipalIdT&& value) {
