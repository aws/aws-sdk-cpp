...
class GetStepRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API GetStepRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  GetStepRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  GetStepRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  GetStepRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename StepIdT = Aws::String>
  GetStepRequest& WithStepId(StepIdT&& value) {
