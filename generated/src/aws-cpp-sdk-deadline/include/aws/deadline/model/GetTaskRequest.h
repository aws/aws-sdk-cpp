...
class GetTaskRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API GetTaskRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  GetTaskRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  GetTaskRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  GetTaskRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename StepIdT = Aws::String>
  GetTaskRequest& WithStepId(StepIdT&& value) {
  ...
  template <typename TaskIdT = Aws::String>
  GetTaskRequest& WithTaskId(TaskIdT&& value) {
