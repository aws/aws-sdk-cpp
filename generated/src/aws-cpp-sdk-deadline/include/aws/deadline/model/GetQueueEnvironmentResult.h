...
namespace Model
{
  ...
  public:
    ...
    template<typename QueueEnvironmentIdT = Aws::String>
    GetQueueEnvironmentResult& WithQueueEnvironmentId(QueueEnvironmentIdT&& value) { SetQueueEnvironmentId(std::forward<QueueEnvironmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    GetQueueEnvironmentResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline GetQueueEnvironmentResult& WithTemplateType(EnvironmentTemplateType value) { SetTemplateType(value); return *this;}
    ///@}
    ...
    template<typename TemplateT = Aws::String>
    GetQueueEnvironmentResult& WithTemplate(TemplateT&& value) { SetTemplate(std::forward<TemplateT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetQueueEnvironmentResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedByT = Aws::String>
    GetQueueEnvironmentResult& WithCreatedBy(CreatedByT&& value) { SetCreatedBy(std::forward<CreatedByT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdatedAtT = Aws::Utils::DateTime>
    GetQueueEnvironmentResult& WithUpdatedAt(UpdatedAtT&& value) { SetUpdatedAt(std::forward<UpdatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdatedByT = Aws::String>
    GetQueueEnvironmentResult& WithUpdatedBy(UpdatedByT&& value) { SetUpdatedBy(std::forward<UpdatedByT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetQueueEnvironmentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
