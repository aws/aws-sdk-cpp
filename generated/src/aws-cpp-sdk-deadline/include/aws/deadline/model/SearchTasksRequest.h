 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/SearchTasksRequest">AWS
 * API Reference</a></p>
 */
class SearchTasksRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  SearchTasksRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename FilterExpressionsT = SearchGroupedFilterExpressions>
  SearchTasksRequest& WithFilterExpressions(FilterExpressionsT&& value) {
  ...
  template <typename SortExpressionsT = Aws::Vector<SearchSortExpression>>
  SearchTasksRequest& WithSortExpressions(SortExpressionsT&& value) {
    SetSortExpressions(std::forward<SortExpressionsT>(value));
    return *this;
  }
  template <typename SortExpressionsT = SearchSortExpression>
  SearchTasksRequest& AddSortExpressions(SortExpressionsT&& value) {
    m_sortExpressionsHasBeenSet = true;
  ...
  inline SearchTasksRequest& WithItemOffset(int value) {
    SetItemOffset(value);
    return *this;
  }
  ///@}
  ...
  inline SearchTasksRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename QueueIdsT = Aws::Vector<Aws::String>>
  SearchTasksRequest& WithQueueIds(QueueIdsT&& value) {
    SetQueueIds(std::forward<QueueIdsT>(value));
    return *this;
  }
  template <typename QueueIdsT = Aws::String>
  SearchTasksRequest& AddQueueIds(QueueIdsT&& value) {
    m_queueIdsHasBeenSet = true;
  ...
  template <typename JobIdT = Aws::String>
  SearchTasksRequest& WithJobId(JobIdT&& value) {
