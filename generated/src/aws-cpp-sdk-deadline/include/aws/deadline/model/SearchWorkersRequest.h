...
class SearchWorkersRequest : public DeadlineRequest {
 public:
  ...
  template <typename FilterExpressionsT = SearchGroupedFilterExpressions>
  SearchWorkersRequest& WithFilterExpressions(FilterExpressionsT&& value) {
  ...
  template <typename SortExpressionsT = Aws::Vector<SearchSortExpression>>
  SearchWorkersRequest& WithSortExpressions(SortExpressionsT&& value) {
    SetSortExpressions(std::forward<SortExpressionsT>(value));
    return *this;
  }
  template <typename SortExpressionsT = SearchSortExpression>
  SearchWorkersRequest& AddSortExpressions(SortExpressionsT&& value) {
    m_sortExpressionsHasBeenSet = true;
  ...
  inline SearchWorkersRequest& WithItemOffset(int value) {
    SetItemOffset(value);
    return *this;
  }
  ///@}
  ...
  inline SearchWorkersRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
