 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListLicenseEndpointsResponse">AWS
 * API Reference</a></p>
 */
class ListLicenseEndpointsResult {
 public:
  ...
  void SetLicenseEndpoints(LicenseEndpointsT&& value) {
    m_licenseEndpointsHasBeenSet = true;
    m_licenseEndpoints = std::forward<LicenseEndpointsT>(value);
  }
  template <typename LicenseEndpointsT = Aws::Vector<LicenseEndpointSummary>>
  ListLicenseEndpointsResult& WithLicenseEndpoints(LicenseEndpointsT&& value) {
    SetLicenseEndpoints(std::forward<LicenseEndpointsT>(value));
    return *this;
  }
  ...
  ListLicenseEndpointsResult& AddLicenseEndpoints(LicenseEndpointsT&& value) {
    m_licenseEndpointsHasBeenSet = true;
    m_licenseEndpoints.emplace_back(std::forward<LicenseEndpointsT>(value));
    return *this;
  }
  ///@}
