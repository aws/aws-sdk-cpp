...
class UpdateTaskRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API UpdateTaskRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  UpdateTaskRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  UpdateTaskRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  UpdateTaskRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename StepIdT = Aws::String>
  UpdateTaskRequest& WithStepId(StepIdT&& value) {
  ...
  template <typename TaskIdT = Aws::String>
  UpdateTaskRequest& WithTaskId(TaskIdT&& value) {
