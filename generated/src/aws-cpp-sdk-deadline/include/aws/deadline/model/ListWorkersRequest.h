 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListWorkersRequest">AWS
 * API Reference</a></p>
 */
class ListWorkersRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  ListWorkersRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename FleetIdT = Aws::String>
  ListWorkersRequest& WithFleetId(FleetIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWorkersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
