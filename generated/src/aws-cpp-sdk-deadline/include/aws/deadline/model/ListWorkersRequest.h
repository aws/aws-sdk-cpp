...
namespace Model
{
  ...
  /**
   */
  class ListWorkersRequest : public DeadlineRequest
  {
  public:
    AWS_DEADLINE_API ListWorkersRequest() = default;
    ...
    template<typename FarmIdT = Aws::String>
    ListWorkersRequest& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename FleetIdT = Aws::String>
    ListWorkersRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListWorkersRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
