...
struct ListLimitsPaginationTraits {
  using RequestType = Model::ListLimitsRequest;
  using ResultType = Model::ListLimitsResult;
  using OutcomeType = Model::ListLimitsOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListLimits(request); }
