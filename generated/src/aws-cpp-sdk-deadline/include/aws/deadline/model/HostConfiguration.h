...
class HostConfiguration {
 public:
  ...
  void SetScriptBody(ScriptBodyT&& value) {
    ...
    m_scriptBody = std::forward<ScriptBodyT>(value);
  }
  template <typename ScriptBodyT = Aws::String>
  HostConfiguration& WithScriptBody(ScriptBodyT&& value) {
    SetScriptBody(std::forward<ScriptBodyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetScriptTimeoutSeconds(int value) {
    m_scriptTimeoutSecondsHasBeenSet = true;
    m_scriptTimeoutSeconds = value;
  }
  inline HostConfiguration& WithScriptTimeoutSeconds(int value) {
    SetScriptTimeoutSeconds(value);
    return *this;
  }
  ///@}
 private:
