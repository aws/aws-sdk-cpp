...
namespace Model
{
  ...
  public:
    ...
    template<typename FarmIdT = Aws::String>
    ListFleetsRequest& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PrincipalIdT = Aws::String>
    ListFleetsRequest& WithPrincipalId(PrincipalIdT&& value) { SetPrincipalId(std::forward<PrincipalIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DisplayNameT = Aws::String>
    ListFleetsRequest& WithDisplayName(DisplayNameT&& value) { SetDisplayName(std::forward<DisplayNameT>(value)); return *this;}
    ///@}
    ...
    inline ListFleetsRequest& WithStatus(FleetStatus value) { SetStatus(value); return *this;}
    ///@}
