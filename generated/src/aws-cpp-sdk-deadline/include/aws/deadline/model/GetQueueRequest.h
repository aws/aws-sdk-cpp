...
namespace Model
{
  ...
  /**
   */
  class GetQueueRequest : public DeadlineRequest
  {
  public:
    AWS_DEADLINE_API GetQueueRequest() = default;
    ...
    template<typename FarmIdT = Aws::String>
    GetQueueRequest& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename QueueIdT = Aws::String>
    GetQueueRequest& WithQueueId(QueueIdT&& value) { SetQueueId(std::forward<QueueIdT>(value)); return *this;}
    ///@}
  private:
