...
class ListJobParameterDefinitionsRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  ListJobParameterDefinitionsRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListJobParameterDefinitionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListJobParameterDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
