 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/AssumeQueueRoleForReadResponse">AWS
 * API Reference</a></p>
 */
class AssumeQueueRoleForReadResult {
 public:
  AWS_DEADLINE_API AssumeQueueRoleForReadResult() = default;
  ...
  template <typename CredentialsT = AwsCredentials>
  AssumeQueueRoleForReadResult& WithCredentials(CredentialsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssumeQueueRoleForReadResult& WithRequestId(RequestIdT&& value) {
