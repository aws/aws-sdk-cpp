...
class ListQueueFleetAssociationsRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API ListQueueFleetAssociationsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListQueueFleetAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListQueueFleetAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
