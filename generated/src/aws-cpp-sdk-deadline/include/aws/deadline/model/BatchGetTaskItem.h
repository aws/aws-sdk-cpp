...
/**
 * <p>The details of a task returned in a batch get operation.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/BatchGetTaskItem">AWS
 * API Reference</a></p>
 */
class BatchGetTaskItem {
 public:
  ...
  inline BatchGetTaskItem& WithRunStatus(TaskRunStatus value) {
    SetRunStatus(value);
    return *this;
  }
  ///@}
  ...
  inline BatchGetTaskItem& WithTargetRunStatus(TaskTargetRunStatus value) {
  ...
  inline BatchGetTaskItem& WithFailureRetryCount(int value) {
