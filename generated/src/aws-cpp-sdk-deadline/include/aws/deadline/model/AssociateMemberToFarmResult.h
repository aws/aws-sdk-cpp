...
namespace Model
{
  ...
  {
  public:
    AWS_DEADLINE_API AssociateMemberToFarmResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AssociateMemberToFarmResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
