...
/**
 * <p>The details of a step returned in a batch get operation.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/BatchGetStepItem">AWS
 * API Reference</a></p>
 */
class BatchGetStepItem {
 public:
  ...
  inline BatchGetStepItem& WithLifecycleStatus(StepLifecycleStatus value) {
  ...
  inline BatchGetStepItem& WithTaskRunStatus(TaskRunStatus value) {
  ...
  inline BatchGetStepItem& AddTaskRunStatusCounts(TaskRunStatus key, int value) {
    m_taskRunStatusCountsHasBeenSet = true;
  ...
  inline BatchGetStepItem& WithTaskFailureRetryCount(int value) {
  ...
  inline BatchGetStepItem& WithTargetTaskRunStatus(StepTargetTaskRunStatus value) {
