...
class ListSessionActionsRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API ListSessionActionsRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  ListSessionActionsRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  ListSessionActionsRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  ListSessionActionsRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSessionActionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSessionActionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
