...
class ManifestProperties {
 public:
  ...
  void SetFileSystemLocationName(FileSystemLocationNameT&& value) {
    ...
    m_fileSystemLocationName = std::forward<FileSystemLocationNameT>(value);
  }
  template <typename FileSystemLocationNameT = Aws::String>
  ManifestProperties& WithFileSystemLocationName(FileSystemLocationNameT&& value) {
    SetFileSystemLocationName(std::forward<FileSystemLocationNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRootPath(RootPathT&& value) {
    ...
    m_rootPath = std::forward<RootPathT>(value);
  }
  template <typename RootPathT = Aws::String>
  ManifestProperties& WithRootPath(RootPathT&& value) {
    SetRootPath(std::forward<RootPathT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRootPathFormat(PathFormat value) {
    m_rootPathFormatHasBeenSet = true;
    m_rootPathFormat = value;
  }
  inline ManifestProperties& WithRootPathFormat(PathFormat value) {
    SetRootPathFormat(value);
    return *this;
  }
  ///@}
  ...
  void SetOutputRelativeDirectories(OutputRelativeDirectoriesT&& value) {
    ...
    m_outputRelativeDirectories = std::forward<OutputRelativeDirectoriesT>(value);
  }
  template <typename OutputRelativeDirectoriesT = Aws::Vector<Aws::String>>
  ManifestProperties& WithOutputRelativeDirectories(OutputRelativeDirectoriesT&& value) {
    SetOutputRelativeDirectories(std::forward<OutputRelativeDirectoriesT>(value));
    return *this;
  }
  ...
  ManifestProperties& AddOutputRelativeDirectories(OutputRelativeDirectoriesT&& value) {
    m_outputRelativeDirectoriesHasBeenSet = true;
    m_outputRelativeDirectories.emplace_back(std::forward<OutputRelativeDirectoriesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInputManifestPath(InputManifestPathT&& value) {
    ...
    m_inputManifestPath = std::forward<InputManifestPathT>(value);
  }
  template <typename InputManifestPathT = Aws::String>
  ManifestProperties& WithInputManifestPath(InputManifestPathT&& value) {
    SetInputManifestPath(std::forward<InputManifestPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInputManifestHash(InputManifestHashT&& value) {
    ...
    m_inputManifestHash = std::forward<InputManifestHashT>(value);
  }
  template <typename InputManifestHashT = Aws::String>
  ManifestProperties& WithInputManifestHash(InputManifestHashT&& value) {
    SetInputManifestHash(std::forward<InputManifestHashT>(value));
    return *this;
  }
  ///@}
 private:
