...
class GetQueueLimitAssociationRequest : public DeadlineRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetQueueLimitAssociation"; }
  ...
  template <typename FarmIdT = Aws::String>
  GetQueueLimitAssociationRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  GetQueueLimitAssociationRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename LimitIdT = Aws::String>
  GetQueueLimitAssociationRequest& WithLimitId(LimitIdT&& value) {
