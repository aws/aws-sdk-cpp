...
class QueueSummary {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  QueueSummary& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  QueueSummary& WithQueueId(QueueIdT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  QueueSummary& WithDisplayName(DisplayNameT&& value) {
  ...
  inline QueueSummary& WithStatus(QueueStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline QueueSummary& WithDefaultBudgetAction(DefaultQueueBudgetAction value) {
  ...
  inline QueueSummary& WithBlockedReason(QueueBlockedReason value) {
  ...
  template <typename CreatedByT = Aws::String>
  QueueSummary& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  QueueSummary& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename UpdatedByT = Aws::String>
  QueueSummary& WithUpdatedBy(UpdatedByT&& value) {
