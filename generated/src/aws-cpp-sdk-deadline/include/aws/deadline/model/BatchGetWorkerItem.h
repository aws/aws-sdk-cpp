...
/**
 * <p>The details of a worker returned in a batch get operation.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/BatchGetWorkerItem">AWS
 * API Reference</a></p>
 */
class BatchGetWorkerItem {
 public:
  ...
  inline BatchGetWorkerItem& WithStatus(WorkerStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
