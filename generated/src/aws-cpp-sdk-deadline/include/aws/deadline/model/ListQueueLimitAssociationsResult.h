 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListQueueLimitAssociationsResponse">AWS
 * API Reference</a></p>
 */
class ListQueueLimitAssociationsResult {
 public:
  ...
  void SetQueueLimitAssociations(QueueLimitAssociationsT&& value) {
    m_queueLimitAssociationsHasBeenSet = true;
    m_queueLimitAssociations = std::forward<QueueLimitAssociationsT>(value);
  }
  template <typename QueueLimitAssociationsT = Aws::Vector<QueueLimitAssociationSummary>>
  ListQueueLimitAssociationsResult& WithQueueLimitAssociations(QueueLimitAssociationsT&& value) {
    SetQueueLimitAssociations(std::forward<QueueLimitAssociationsT>(value));
    return *this;
  }
  template <typename QueueLimitAssociationsT = QueueLimitAssociationSummary>
  ListQueueLimitAssociationsResult& AddQueueLimitAssociations(QueueLimitAssociationsT&& value) {
    m_queueLimitAssociationsHasBeenSet = true;
    m_queueLimitAssociations.emplace_back(std::forward<QueueLimitAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListQueueLimitAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListQueueLimitAssociationsResult& WithRequestId(RequestIdT&& value) {
