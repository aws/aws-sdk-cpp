...
class AssumeFleetRoleForWorkerRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API AssumeFleetRoleForWorkerRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  AssumeFleetRoleForWorkerRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename FleetIdT = Aws::String>
  AssumeFleetRoleForWorkerRequest& WithFleetId(FleetIdT&& value) {
  ...
  template <typename WorkerIdT = Aws::String>
  AssumeFleetRoleForWorkerRequest& WithWorkerId(WorkerIdT&& value) {
