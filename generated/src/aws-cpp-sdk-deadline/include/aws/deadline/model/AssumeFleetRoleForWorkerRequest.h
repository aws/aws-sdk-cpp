...
namespace Model
{
  ...
  public:
    ...
    template<typename FarmIdT = Aws::String>
    AssumeFleetRoleForWorkerRequest& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename FleetIdT = Aws::String>
    AssumeFleetRoleForWorkerRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkerIdT = Aws::String>
    AssumeFleetRoleForWorkerRequest& WithWorkerId(WorkerIdT&& value) { SetWorkerId(std::forward<WorkerIdT>(value)); return *this;}
    ///@}
  private:
