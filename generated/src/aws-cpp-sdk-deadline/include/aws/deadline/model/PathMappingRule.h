...
class PathMappingRule {
 public:
  ...
  inline void SetSourcePathFormat(PathFormat value) {
    m_sourcePathFormatHasBeenSet = true;
    m_sourcePathFormat = value;
  }
  inline PathMappingRule& WithSourcePathFormat(PathFormat value) {
    SetSourcePathFormat(value);
    return *this;
  }
  ///@}
