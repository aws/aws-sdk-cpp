...
class SearchTermFilterExpression {
 public:
  ...
  void SetSearchTerm(SearchTermT&& value) {
    ...
    m_searchTerm = std::forward<SearchTermT>(value);
  }
  template <typename SearchTermT = Aws::String>
  SearchTermFilterExpression& WithSearchTerm(SearchTermT&& value) {
    SetSearchTerm(std::forward<SearchTermT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMatchType(SearchTermMatchingType value) {
    m_matchTypeHasBeenSet = true;
    m_matchType = value;
  }
  inline SearchTermFilterExpression& WithMatchType(SearchTermMatchingType value) {
    SetMatchType(value);
    return *this;
  }
  ///@}
