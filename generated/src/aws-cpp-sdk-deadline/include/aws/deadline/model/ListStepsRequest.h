 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListStepsRequest">AWS
 * API Reference</a></p>
 */
class ListStepsRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  ListStepsRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  ListStepsRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  ListStepsRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStepsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStepsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
