 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListStepDependenciesResponse">AWS
 * API Reference</a></p>
 */
class ListStepDependenciesResult {
 public:
  ...
  template <typename DependenciesT = Aws::Vector<StepDependency>>
  ListStepDependenciesResult& WithDependencies(DependenciesT&& value) {
    SetDependencies(std::forward<DependenciesT>(value));
    return *this;
  }
  template <typename DependenciesT = StepDependency>
  ListStepDependenciesResult& AddDependencies(DependenciesT&& value) {
    m_dependenciesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListStepDependenciesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStepDependenciesResult& WithRequestId(RequestIdT&& value) {
