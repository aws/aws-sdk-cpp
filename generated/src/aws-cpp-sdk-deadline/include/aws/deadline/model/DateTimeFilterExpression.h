...
class DateTimeFilterExpression {
 public:
  ...
  template <typename NameT = Aws::String>
  DateTimeFilterExpression& WithName(NameT&& value) {
  ...
  inline DateTimeFilterExpression& WithOperator(ComparisonOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename DateTimeT = Aws::Utils::DateTime>
  DateTimeFilterExpression& WithDateTime(DateTimeT&& value) {
