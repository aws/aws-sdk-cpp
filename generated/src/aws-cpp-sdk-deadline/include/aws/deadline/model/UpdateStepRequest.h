...
class UpdateStepRequest : public DeadlineRequest {
 public:
  ...
  inline UpdateStepRequest& WithTargetTaskRunStatus(StepTargetTaskRunStatus value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateStepRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename FarmIdT = Aws::String>
  UpdateStepRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  UpdateStepRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  UpdateStepRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename StepIdT = Aws::String>
  UpdateStepRequest& WithStepId(StepIdT&& value) {
