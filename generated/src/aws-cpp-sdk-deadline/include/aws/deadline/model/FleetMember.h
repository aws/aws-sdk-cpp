...
class FleetMember {
 public:
  AWS_DEADLINE_API FleetMember() = default;
  ...
  template <typename FarmIdT = Aws::String>
  FleetMember& WithFarmId(FarmIdT&& value) {
  ...
  template <typename FleetIdT = Aws::String>
  FleetMember& WithFleetId(FleetIdT&& value) {
  ...
  template <typename PrincipalIdT = Aws::String>
  FleetMember& WithPrincipalId(PrincipalIdT&& value) {
  ...
  inline FleetMember& WithPrincipalType(PrincipalType value) {
  ...
  template <typename IdentityStoreIdT = Aws::String>
  FleetMember& WithIdentityStoreId(IdentityStoreIdT&& value) {
  ...
  inline FleetMember& WithMembershipLevel(MembershipLevel value) {
