...
namespace Model
{
  ...
  {
  public:
    AWS_DEADLINE_API GetJobRequest() = default;
    ...
    template<typename FarmIdT = Aws::String>
    GetJobRequest& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename QueueIdT = Aws::String>
    GetJobRequest& WithQueueId(QueueIdT&& value) { SetQueueId(std::forward<QueueIdT>(value)); return *this;}
    ///@}
