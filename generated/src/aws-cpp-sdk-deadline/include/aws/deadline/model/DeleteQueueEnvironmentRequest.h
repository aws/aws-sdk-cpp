...
class DeleteQueueEnvironmentRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  DeleteQueueEnvironmentRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  DeleteQueueEnvironmentRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename QueueEnvironmentIdT = Aws::String>
  DeleteQueueEnvironmentRequest& WithQueueEnvironmentId(QueueEnvironmentIdT&& value) {
