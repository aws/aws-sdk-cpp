...
class ServiceManagedEc2AutoScalingConfiguration {
 public:
  AWS_DEADLINE_API ServiceManagedEc2AutoScalingConfiguration() = default;
  AWS_DEADLINE_API ServiceManagedEc2AutoScalingConfiguration(Aws::Utils::Json::JsonView jsonValue);
  AWS_DEADLINE_API ServiceManagedEc2AutoScalingConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline ServiceManagedEc2AutoScalingConfiguration& WithStandbyWorkerCount(int value) {
  ...
  inline ServiceManagedEc2AutoScalingConfiguration& WithWorkerIdleDurationSeconds(int value) {
  ...
  inline ServiceManagedEc2AutoScalingConfiguration& WithScaleOutWorkersPerMinute(int value) {
