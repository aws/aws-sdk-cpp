...
/**
 */
class ListStepDependenciesRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API ListStepDependenciesRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListStepDependencies"; }
  ...
  template <typename FarmIdT = Aws::String>
  ListStepDependenciesRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  ListStepDependenciesRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  ListStepDependenciesRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename StepIdT = Aws::String>
  ListStepDependenciesRequest& WithStepId(StepIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStepDependenciesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStepDependenciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
