...
class TaskRunSessionActionDefinitionSummary {
 public:
  ...
  template <typename TaskIdT = Aws::String>
  TaskRunSessionActionDefinitionSummary& WithTaskId(TaskIdT&& value) {
  ...
  template <typename StepIdT = Aws::String>
  TaskRunSessionActionDefinitionSummary& WithStepId(StepIdT&& value) {
  ...
  template <typename ParametersT = Aws::Map<Aws::String, TaskParameterValue>>
  TaskRunSessionActionDefinitionSummary& WithParameters(ParametersT&& value) {
