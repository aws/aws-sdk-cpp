...
class DisassociateMemberFromFleetRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API DisassociateMemberFromFleetRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  DisassociateMemberFromFleetRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename FleetIdT = Aws::String>
  DisassociateMemberFromFleetRequest& WithFleetId(FleetIdT&& value) {
  ...
  template <typename PrincipalIdT = Aws::String>
  DisassociateMemberFromFleetRequest& WithPrincipalId(PrincipalIdT&& value) {
