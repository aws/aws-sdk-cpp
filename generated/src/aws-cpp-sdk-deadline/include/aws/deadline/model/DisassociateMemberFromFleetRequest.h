...
namespace Model
{
  ...
  public:
    ...
    template<typename FarmIdT = Aws::String>
    DisassociateMemberFromFleetRequest& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename FleetIdT = Aws::String>
    DisassociateMemberFromFleetRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PrincipalIdT = Aws::String>
    DisassociateMemberFromFleetRequest& WithPrincipalId(PrincipalIdT&& value) { SetPrincipalId(std::forward<PrincipalIdT>(value)); return *this;}
    ///@}
  private:
