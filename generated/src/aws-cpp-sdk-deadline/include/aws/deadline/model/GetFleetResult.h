...
class GetFleetResult {
 public:
  ...
  template <typename FleetIdT = Aws::String>
  GetFleetResult& WithFleetId(FleetIdT&& value) {
  ...
  template <typename FarmIdT = Aws::String>
  GetFleetResult& WithFarmId(FarmIdT&& value) {
  ...
  inline GetFleetResult& WithStatus(FleetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  GetFleetResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  inline GetFleetResult& WithAutoScalingStatus(AutoScalingStatus value) {
  ...
  inline GetFleetResult& WithTargetWorkerCount(int value) {
  ...
  inline GetFleetResult& WithWorkerCount(int value) {
  ...
  inline GetFleetResult& WithMinWorkerCount(int value) {
  ...
  inline GetFleetResult& WithMaxWorkerCount(int value) {
  ...
  template <typename ConfigurationT = FleetConfiguration>
  GetFleetResult& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetFleetResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  GetFleetResult& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetFleetResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename UpdatedByT = Aws::String>
  GetFleetResult& WithUpdatedBy(UpdatedByT&& value) {
