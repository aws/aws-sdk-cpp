...
class UpdateStorageProfileRequest : public DeadlineRequest {
 public:
  ...
  inline void SetOsFamily(StorageProfileOperatingSystemFamily value) {
    m_osFamilyHasBeenSet = true;
    m_osFamily = value;
  }
  inline UpdateStorageProfileRequest& WithOsFamily(StorageProfileOperatingSystemFamily value) {
    SetOsFamily(value);
    return *this;
  }
  ///@}
  ...
  void SetFileSystemLocationsToAdd(FileSystemLocationsToAddT&& value) {
    m_fileSystemLocationsToAddHasBeenSet = true;
    m_fileSystemLocationsToAdd = std::forward<FileSystemLocationsToAddT>(value);
  }
  template <typename FileSystemLocationsToAddT = Aws::Vector<FileSystemLocation>>
  UpdateStorageProfileRequest& WithFileSystemLocationsToAdd(FileSystemLocationsToAddT&& value) {
    SetFileSystemLocationsToAdd(std::forward<FileSystemLocationsToAddT>(value));
    return *this;
  }
  ...
  UpdateStorageProfileRequest& AddFileSystemLocationsToAdd(FileSystemLocationsToAddT&& value) {
    m_fileSystemLocationsToAddHasBeenSet = true;
    m_fileSystemLocationsToAdd.emplace_back(std::forward<FileSystemLocationsToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFileSystemLocationsToRemove(FileSystemLocationsToRemoveT&& value) {
    m_fileSystemLocationsToRemoveHasBeenSet = true;
    m_fileSystemLocationsToRemove = std::forward<FileSystemLocationsToRemoveT>(value);
  }
  template <typename FileSystemLocationsToRemoveT = Aws::Vector<FileSystemLocation>>
  UpdateStorageProfileRequest& WithFileSystemLocationsToRemove(FileSystemLocationsToRemoveT&& value) {
    SetFileSystemLocationsToRemove(std::forward<FileSystemLocationsToRemoveT>(value));
    return *this;
  }
  ...
  UpdateStorageProfileRequest& AddFileSystemLocationsToRemove(FileSystemLocationsToRemoveT&& value) {
    m_fileSystemLocationsToRemoveHasBeenSet = true;
    m_fileSystemLocationsToRemove.emplace_back(std::forward<FileSystemLocationsToRemoveT>(value));
    return *this;
  }
  ///@}
 private:
