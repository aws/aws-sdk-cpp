...
namespace Model
{
  ...
  {
  public:
    AWS_DEADLINE_API QueueMember() = default;
    ...
    template<typename FarmIdT = Aws::String>
    QueueMember& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename QueueIdT = Aws::String>
    QueueMember& WithQueueId(QueueIdT&& value) { SetQueueId(std::forward<QueueIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PrincipalIdT = Aws::String>
    QueueMember& WithPrincipalId(PrincipalIdT&& value) { SetPrincipalId(std::forward<PrincipalIdT>(value)); return *this;}
    ///@}
    ...
    inline QueueMember& WithPrincipalType(PrincipalType value) { SetPrincipalType(value); return *this;}
    ///@}
    ...
    template<typename IdentityStoreIdT = Aws::String>
    QueueMember& WithIdentityStoreId(IdentityStoreIdT&& value) { SetIdentityStoreId(std::forward<IdentityStoreIdT>(value)); return *this;}
    ///@}
    ...
    inline QueueMember& WithMembershipLevel(MembershipLevel value) { SetMembershipLevel(value); return *this;}
    ///@}
  private:
