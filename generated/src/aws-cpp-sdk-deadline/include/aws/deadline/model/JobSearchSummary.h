...
class JobSearchSummary {
 public:
  ...
  inline JobSearchSummary& WithLifecycleStatus(JobLifecycleStatus value) {
  ...
  inline JobSearchSummary& WithTaskRunStatus(TaskRunStatus value) {
  ...
  inline JobSearchSummary& WithTargetTaskRunStatus(JobTargetTaskRunStatus value) {
  ...
  inline JobSearchSummary& WithTaskFailureRetryCount(int value) {
  ...
  inline JobSearchSummary& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline JobSearchSummary& WithMaxFailedTasksCount(int value) {
  ...
  inline JobSearchSummary& WithMaxRetriesPerTask(int value) {
  ...
  JobSearchSummary& AddJobParameters(JobParametersKeyT&& key, JobParametersValueT&& value) {
    m_jobParametersHasBeenSet = true;
    m_jobParameters.emplace(std::forward<JobParametersKeyT>(key), std::forward<JobParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline JobSearchSummary& WithMaxWorkerCount(int value) {
