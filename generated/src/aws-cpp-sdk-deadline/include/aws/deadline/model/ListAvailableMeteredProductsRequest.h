...
namespace Model
{
  ...
  {
  public:
    AWS_DEADLINE_API ListAvailableMeteredProductsRequest();
     ...
     * beginning.</p>
     */
    inline ListAvailableMeteredProductsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
