...
class TaskSearchSummary {
 public:
  ...
  inline TaskSearchSummary& WithRunStatus(TaskRunStatus value) {
    SetRunStatus(value);
    return *this;
  }
  ///@}
  ...
  inline TaskSearchSummary& WithTargetRunStatus(TaskTargetRunStatus value) {
  ...
  inline TaskSearchSummary& WithFailureRetryCount(int value) {
