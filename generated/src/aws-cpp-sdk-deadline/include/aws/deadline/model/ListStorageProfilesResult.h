 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListStorageProfilesResponse">AWS
 * API Reference</a></p>
 */
class ListStorageProfilesResult {
 public:
  ...
  template <typename StorageProfilesT = Aws::Vector<StorageProfileSummary>>
  ListStorageProfilesResult& WithStorageProfiles(StorageProfilesT&& value) {
    SetStorageProfiles(std::forward<StorageProfilesT>(value));
    return *this;
  }
  template <typename StorageProfilesT = StorageProfileSummary>
  ListStorageProfilesResult& AddStorageProfiles(StorageProfilesT&& value) {
    m_storageProfilesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListStorageProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStorageProfilesResult& WithRequestId(RequestIdT&& value) {
