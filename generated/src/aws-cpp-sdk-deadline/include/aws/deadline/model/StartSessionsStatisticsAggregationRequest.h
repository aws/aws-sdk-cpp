...
class StartSessionsStatisticsAggregationRequest : public DeadlineRequest {
 public:
  ...
  inline StartSessionsStatisticsAggregationRequest& WithPeriod(Period value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline StartSessionsStatisticsAggregationRequest& AddGroupBy(UsageGroupByField value) {
    m_groupByHasBeenSet = true;
  ...
  inline StartSessionsStatisticsAggregationRequest& AddStatistics(UsageStatistic value) {
    m_statisticsHasBeenSet = true;
