 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/GetQueueFleetAssociationRequest">AWS
 * API Reference</a></p>
 */
class GetQueueFleetAssociationRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  GetQueueFleetAssociationRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  GetQueueFleetAssociationRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename FleetIdT = Aws::String>
  GetQueueFleetAssociationRequest& WithFleetId(FleetIdT&& value) {
