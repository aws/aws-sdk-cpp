 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListJobMembersRequest">AWS
 * API Reference</a></p>
 */
class ListJobMembersRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  ListJobMembersRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  ListJobMembersRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  ListJobMembersRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListJobMembersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListJobMembersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
