...
class UpdateWorkerRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  UpdateWorkerRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename FleetIdT = Aws::String>
  UpdateWorkerRequest& WithFleetId(FleetIdT&& value) {
  ...
  template <typename WorkerIdT = Aws::String>
  UpdateWorkerRequest& WithWorkerId(WorkerIdT&& value) {
  ...
  inline void SetStatus(UpdatedWorkerStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateWorkerRequest& WithStatus(UpdatedWorkerStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CapabilitiesT = WorkerCapabilities>
  UpdateWorkerRequest& WithCapabilities(CapabilitiesT&& value) {
  ...
  template <typename HostPropertiesT = HostPropertiesRequest>
  UpdateWorkerRequest& WithHostProperties(HostPropertiesT&& value) {
