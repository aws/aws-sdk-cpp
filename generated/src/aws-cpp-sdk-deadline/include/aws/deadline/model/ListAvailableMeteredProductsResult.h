 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListAvailableMeteredProductsResponse">AWS
 * API Reference</a></p>
 */
class ListAvailableMeteredProductsResult {
 public:
  ...
  void SetMeteredProducts(MeteredProductsT&& value) {
    m_meteredProductsHasBeenSet = true;
    m_meteredProducts = std::forward<MeteredProductsT>(value);
  }
  template <typename MeteredProductsT = Aws::Vector<MeteredProductSummary>>
  ListAvailableMeteredProductsResult& WithMeteredProducts(MeteredProductsT&& value) {
    SetMeteredProducts(std::forward<MeteredProductsT>(value));
    return *this;
  }
  template <typename MeteredProductsT = MeteredProductSummary>
  ListAvailableMeteredProductsResult& AddMeteredProducts(MeteredProductsT&& value) {
    m_meteredProductsHasBeenSet = true;
    m_meteredProducts.emplace_back(std::forward<MeteredProductsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAvailableMeteredProductsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAvailableMeteredProductsResult& WithRequestId(RequestIdT&& value) {
