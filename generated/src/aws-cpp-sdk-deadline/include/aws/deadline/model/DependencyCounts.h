...
class DependencyCounts {
 public:
  ...
  inline void SetDependenciesResolved(int value) {
    m_dependenciesResolvedHasBeenSet = true;
    m_dependenciesResolved = value;
  }
  inline DependencyCounts& WithDependenciesResolved(int value) {
    SetDependenciesResolved(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDependenciesUnresolved(int value) {
    m_dependenciesUnresolvedHasBeenSet = true;
    m_dependenciesUnresolved = value;
  }
  inline DependencyCounts& WithDependenciesUnresolved(int value) {
    SetDependenciesUnresolved(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConsumersResolved(int value) {
    m_consumersResolvedHasBeenSet = true;
    m_consumersResolved = value;
  }
  inline DependencyCounts& WithConsumersResolved(int value) {
    SetConsumersResolved(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConsumersUnresolved(int value) {
    m_consumersUnresolvedHasBeenSet = true;
    m_consumersUnresolved = value;
  }
  inline DependencyCounts& WithConsumersUnresolved(int value) {
    SetConsumersUnresolved(value);
    return *this;
  }
  ///@}
 private:
