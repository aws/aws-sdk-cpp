...
class GetStorageProfileForQueueRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  GetStorageProfileForQueueRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  GetStorageProfileForQueueRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename StorageProfileIdT = Aws::String>
  GetStorageProfileForQueueRequest& WithStorageProfileId(StorageProfileIdT&& value) {
