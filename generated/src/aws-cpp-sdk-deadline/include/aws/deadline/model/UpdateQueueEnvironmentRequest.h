...
class UpdateQueueEnvironmentRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  UpdateQueueEnvironmentRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  UpdateQueueEnvironmentRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename QueueEnvironmentIdT = Aws::String>
  UpdateQueueEnvironmentRequest& WithQueueEnvironmentId(QueueEnvironmentIdT&& value) {
  ...
  inline UpdateQueueEnvironmentRequest& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateQueueEnvironmentRequest& WithTemplateType(EnvironmentTemplateType value) {
  ...
  template <typename TemplateT = Aws::String>
  UpdateQueueEnvironmentRequest& WithTemplate(TemplateT&& value) {
