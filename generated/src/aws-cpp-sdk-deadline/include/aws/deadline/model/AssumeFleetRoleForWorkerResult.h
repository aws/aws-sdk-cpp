 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/AssumeFleetRoleForWorkerResponse">AWS
 * API Reference</a></p>
 */
class AssumeFleetRoleForWorkerResult {
 public:
  ...
  template <typename CredentialsT = AwsCredentials>
  AssumeFleetRoleForWorkerResult& WithCredentials(CredentialsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssumeFleetRoleForWorkerResult& WithRequestId(RequestIdT&& value) {
