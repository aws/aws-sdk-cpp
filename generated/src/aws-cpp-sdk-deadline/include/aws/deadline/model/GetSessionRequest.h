...
class GetSessionRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API GetSessionRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  GetSessionRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  GetSessionRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  GetSessionRequest& WithJobId(JobIdT&& value) {
