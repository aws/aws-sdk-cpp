...
namespace Model
{
  ...
  {
  public:
    AWS_DEADLINE_API DeleteQueueRequest() = default;
    ...
    template<typename FarmIdT = Aws::String>
    DeleteQueueRequest& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename QueueIdT = Aws::String>
    DeleteQueueRequest& WithQueueId(QueueIdT&& value) { SetQueueId(std::forward<QueueIdT>(value)); return *this;}
    ///@}
  private:
