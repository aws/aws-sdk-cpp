 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListSessionsForWorkerRequest">AWS
 * API Reference</a></p>
 */
class ListSessionsForWorkerRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API ListSessionsForWorkerRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  ListSessionsForWorkerRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename FleetIdT = Aws::String>
  ListSessionsForWorkerRequest& WithFleetId(FleetIdT&& value) {
  ...
  template <typename WorkerIdT = Aws::String>
  ListSessionsForWorkerRequest& WithWorkerId(WorkerIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSessionsForWorkerRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSessionsForWorkerRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
