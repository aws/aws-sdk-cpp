...
class FleetSummary {
 public:
  ...
  inline FleetSummary& WithStatus(FleetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline FleetSummary& WithAutoScalingStatus(AutoScalingStatus value) {
  ...
  inline void SetTargetWorkerCount(int value) {
    m_targetWorkerCountHasBeenSet = true;
    m_targetWorkerCount = value;
  }
  inline FleetSummary& WithTargetWorkerCount(int value) {
    SetTargetWorkerCount(value);
    return *this;
  }
  ///@}
  ...
  inline FleetSummary& WithWorkerCount(int value) {
  ...
  inline FleetSummary& WithMinWorkerCount(int value) {
  ...
  inline FleetSummary& WithMaxWorkerCount(int value) {
