...
class EnvironmentDetailsError {
 public:
  ...
  template <typename JobIdT = Aws::String>
  EnvironmentDetailsError& WithJobId(JobIdT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  EnvironmentDetailsError& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  inline EnvironmentDetailsError& WithCode(JobEntityErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  EnvironmentDetailsError& WithMessage(MessageT&& value) {
