...
class CustomerManagedWorkerCapabilities {
 public:
  ...
  inline CustomerManagedWorkerCapabilities& AddAcceleratorTypes(AcceleratorType value) {
    m_acceleratorTypesHasBeenSet = true;
  ...
  inline void SetOsFamily(CustomerManagedFleetOperatingSystemFamily value) {
    m_osFamilyHasBeenSet = true;
    m_osFamily = value;
  }
  inline CustomerManagedWorkerCapabilities& WithOsFamily(CustomerManagedFleetOperatingSystemFamily value) {
    SetOsFamily(value);
    return *this;
  }
  ///@}
  ...
  inline CustomerManagedWorkerCapabilities& WithCpuArchitectureType(CpuArchitectureType value) {
