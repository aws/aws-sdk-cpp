...
class AssociateMemberToFarmRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API AssociateMemberToFarmRequest() = default;
  ...
  inline AssociateMemberToFarmRequest& WithPrincipalType(PrincipalType value) {
  ...
  template <typename IdentityStoreIdT = Aws::String>
  AssociateMemberToFarmRequest& WithIdentityStoreId(IdentityStoreIdT&& value) {
  ...
  inline AssociateMemberToFarmRequest& WithMembershipLevel(MembershipLevel value) {
  ...
  template <typename IdentityCenterRegionT = Aws::String>
  AssociateMemberToFarmRequest& WithIdentityCenterRegion(IdentityCenterRegionT&& value) {
