...
class BudgetActionToRemove {
 public:
  ...
  inline void SetType(BudgetActionType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline BudgetActionToRemove& WithType(BudgetActionType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline BudgetActionToRemove& WithThresholdPercentage(double value) {
