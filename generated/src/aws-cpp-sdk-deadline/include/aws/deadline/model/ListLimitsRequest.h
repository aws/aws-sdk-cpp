...
namespace Model
{
  ...
  public:
    ...
    template<typename FarmIdT = Aws::String>
    ListLimitsRequest& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListLimitsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
