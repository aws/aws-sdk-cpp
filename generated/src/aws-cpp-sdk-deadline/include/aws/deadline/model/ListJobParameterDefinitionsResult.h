...
class ListJobParameterDefinitionsResult {
 public:
  ...
  void SetJobParameterDefinitions(JobParameterDefinitionsT&& value) {
    m_jobParameterDefinitionsHasBeenSet = true;
    m_jobParameterDefinitions = std::forward<JobParameterDefinitionsT>(value);
  }
  template <typename JobParameterDefinitionsT = Aws::Vector<Aws::Utils::Document>>
  ListJobParameterDefinitionsResult& WithJobParameterDefinitions(JobParameterDefinitionsT&& value) {
    SetJobParameterDefinitions(std::forward<JobParameterDefinitionsT>(value));
    return *this;
  }
  template <typename JobParameterDefinitionsT = Aws::Utils::Document>
  ListJobParameterDefinitionsResult& AddJobParameterDefinitions(JobParameterDefinitionsT&& value) {
    m_jobParameterDefinitionsHasBeenSet = true;
    m_jobParameterDefinitions.emplace_back(std::forward<JobParameterDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListJobParameterDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListJobParameterDefinitionsResult& WithRequestId(RequestIdT&& value) {
