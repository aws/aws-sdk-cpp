 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/UpdateQueueFleetAssociationRequest">AWS
 * API Reference</a></p>
 */
class UpdateQueueFleetAssociationRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API UpdateQueueFleetAssociationRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  UpdateQueueFleetAssociationRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  UpdateQueueFleetAssociationRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename FleetIdT = Aws::String>
  UpdateQueueFleetAssociationRequest& WithFleetId(FleetIdT&& value) {
   ...
   */
  inline UpdateQueueFleetAssociationStatus GetStatus() const { return m_status; }
  inline bool StatusHasBeenSet() const { return m_statusHasBeenSet; }
  inline void SetStatus(UpdateQueueFleetAssociationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateQueueFleetAssociationRequest& WithStatus(UpdateQueueFleetAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
 private:
  ...
  UpdateQueueFleetAssociationStatus m_status{UpdateQueueFleetAssociationStatus::NOT_SET};
