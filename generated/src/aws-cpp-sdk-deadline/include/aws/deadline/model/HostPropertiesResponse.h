...
class HostPropertiesResponse {
 public:
  ...
  void SetEc2InstanceArn(Ec2InstanceArnT&& value) {
    ...
    m_ec2InstanceArn = std::forward<Ec2InstanceArnT>(value);
  }
  template <typename Ec2InstanceArnT = Aws::String>
  HostPropertiesResponse& WithEc2InstanceArn(Ec2InstanceArnT&& value) {
    SetEc2InstanceArn(std::forward<Ec2InstanceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEc2InstanceType(Ec2InstanceTypeT&& value) {
    ...
    m_ec2InstanceType = std::forward<Ec2InstanceTypeT>(value);
  }
  template <typename Ec2InstanceTypeT = Aws::String>
  HostPropertiesResponse& WithEc2InstanceType(Ec2InstanceTypeT&& value) {
    SetEc2InstanceType(std::forward<Ec2InstanceTypeT>(value));
    return *this;
  }
  ///@}
 private:
