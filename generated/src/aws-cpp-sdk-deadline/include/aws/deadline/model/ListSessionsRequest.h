 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListSessionsRequest">AWS
 * API Reference</a></p>
 */
class ListSessionsRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  ListSessionsRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  ListSessionsRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  ListSessionsRequest& WithJobId(JobIdT&& value) {
