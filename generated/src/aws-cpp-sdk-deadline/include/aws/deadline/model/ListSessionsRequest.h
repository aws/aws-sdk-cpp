...
namespace Model
{
  ...
  /**
   */
  class ListSessionsRequest : public DeadlineRequest
  {
  public:
    AWS_DEADLINE_API ListSessionsRequest() = default;
    ...
    template<typename FarmIdT = Aws::String>
    ListSessionsRequest& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename QueueIdT = Aws::String>
    ListSessionsRequest& WithQueueId(QueueIdT&& value) { SetQueueId(std::forward<QueueIdT>(value)); return *this;}
    ///@}
    ...
    template<typename JobIdT = Aws::String>
    ListSessionsRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
