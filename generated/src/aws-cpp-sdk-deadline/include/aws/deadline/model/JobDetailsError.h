...
class JobDetailsError {
 public:
  ...
  template <typename JobIdT = Aws::String>
  JobDetailsError& WithJobId(JobIdT&& value) {
  ...
  inline void SetCode(JobEntityErrorCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline JobDetailsError& WithCode(JobEntityErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  JobDetailsError& WithMessage(MessageT&& value) {
