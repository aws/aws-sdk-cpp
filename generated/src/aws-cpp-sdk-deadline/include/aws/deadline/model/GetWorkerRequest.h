...
namespace Model
{
  ...
  {
  public:
    AWS_DEADLINE_API GetWorkerRequest() = default;
    ...
    template<typename FarmIdT = Aws::String>
    GetWorkerRequest& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename FleetIdT = Aws::String>
    GetWorkerRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkerIdT = Aws::String>
    GetWorkerRequest& WithWorkerId(WorkerIdT&& value) { SetWorkerId(std::forward<WorkerIdT>(value)); return *this;}
    ///@}
  private:
