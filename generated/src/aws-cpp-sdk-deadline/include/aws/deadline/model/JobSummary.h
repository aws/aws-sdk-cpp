...
class JobSummary {
 public:
  ...
  inline JobSummary& WithLifecycleStatus(JobLifecycleStatus value) {
  ...
  inline JobSummary& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline JobSummary& WithTaskRunStatus(TaskRunStatus value) {
  ...
  inline JobSummary& WithTargetTaskRunStatus(JobTargetTaskRunStatus value) {
  ...
  inline JobSummary& WithTaskFailureRetryCount(int value) {
  ...
  inline JobSummary& WithMaxFailedTasksCount(int value) {
  ...
  inline JobSummary& WithMaxRetriesPerTask(int value) {
  ...
  inline JobSummary& WithMaxWorkerCount(int value) {
