 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListVolumesRequest">AWS
 * API Reference</a></p>
 */
class ListVolumesRequest : public DeadlineRequest {
 public:
  ...
  inline ListVolumesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
