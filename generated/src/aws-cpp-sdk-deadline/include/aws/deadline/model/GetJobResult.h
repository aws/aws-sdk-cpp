 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/GetJobResponse">AWS
 * API Reference</a></p>
 */
class GetJobResult {
 public:
  ...
  inline GetJobResult& WithLifecycleStatus(JobLifecycleStatus value) {
  ...
  inline GetJobResult& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline GetJobResult& WithTaskRunStatus(TaskRunStatus value) {
  ...
  inline GetJobResult& WithTargetTaskRunStatus(JobTargetTaskRunStatus value) {
  ...
  inline GetJobResult& WithTaskFailureRetryCount(int value) {
  ...
  inline GetJobResult& WithMaxFailedTasksCount(int value) {
  ...
  inline GetJobResult& WithMaxRetriesPerTask(int value) {
  ...
  inline GetJobResult& WithMaxWorkerCount(int value) {
