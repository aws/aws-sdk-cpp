...
class SearchGroupedFilterExpressions {
 public:
  ...
  template <typename FiltersT = Aws::Vector<SearchFilterExpression>>
  SearchGroupedFilterExpressions& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = SearchFilterExpression>
  SearchGroupedFilterExpressions& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline void SetOperator(LogicalOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline SearchGroupedFilterExpressions& WithOperator(LogicalOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
