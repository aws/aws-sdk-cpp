...
namespace Model
{
  ...
  {
  public:
    AWS_DEADLINE_API UpdateQueueEnvironmentResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateQueueEnvironmentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
