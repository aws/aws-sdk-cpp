 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListStorageProfilesForQueueResponse">AWS
 * API Reference</a></p>
 */
class ListStorageProfilesForQueueResult {
 public:
  ...
  void SetStorageProfiles(StorageProfilesT&& value) {
    m_storageProfilesHasBeenSet = true;
    m_storageProfiles = std::forward<StorageProfilesT>(value);
  }
  template <typename StorageProfilesT = Aws::Vector<StorageProfileSummary>>
  ListStorageProfilesForQueueResult& WithStorageProfiles(StorageProfilesT&& value) {
    SetStorageProfiles(std::forward<StorageProfilesT>(value));
    return *this;
  }
  template <typename StorageProfilesT = StorageProfileSummary>
  ListStorageProfilesForQueueResult& AddStorageProfiles(StorageProfilesT&& value) {
    m_storageProfilesHasBeenSet = true;
    m_storageProfiles.emplace_back(std::forward<StorageProfilesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListStorageProfilesForQueueResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStorageProfilesForQueueResult& WithRequestId(RequestIdT&& value) {
