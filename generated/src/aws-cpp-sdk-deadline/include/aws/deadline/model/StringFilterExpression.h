...
class StringFilterExpression {
 public:
  ...
  template <typename NameT = Aws::String>
  StringFilterExpression& WithName(NameT&& value) {
  ...
  inline StringFilterExpression& WithOperator(ComparisonOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  StringFilterExpression& WithValue(ValueT&& value) {
