...
class UpdateQueueLimitAssociationRequest : public DeadlineRequest {
 public:
  ...
  inline void SetStatus(UpdateQueueLimitAssociationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateQueueLimitAssociationRequest& WithStatus(UpdateQueueLimitAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
