...
namespace Model
{
  ...
  {
  public:
    AWS_DEADLINE_API ListMeteredProductsResult();
     ...
     * <p>The metered products to list.</p>
     */
    inline ListMeteredProductsResult& WithMeteredProducts(const Aws::Vector<MeteredProductSummary>& value) { SetMeteredProducts(value); return *this;}

    /**
     * <p>The metered products to list.</p>
     */
    inline ListMeteredProductsResult& WithMeteredProducts(Aws::Vector<MeteredProductSummary>&& value) { SetMeteredProducts(std::move(value)); return *this;}
     ...
     * receive an HTTP 400 <code>ValidationException</code> error.</p>
     */
    inline ListMeteredProductsResult& WithNextToken(const char* value) { SetNextToken(value); return *this;}
    ...
    inline ListMeteredProductsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListMeteredProductsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListMeteredProductsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
