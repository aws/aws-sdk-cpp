 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListMeteredProductsResponse">AWS
 * API Reference</a></p>
 */
class ListMeteredProductsResult {
 public:
  ...
  template <typename MeteredProductsT = Aws::Vector<MeteredProductSummary>>
  ListMeteredProductsResult& WithMeteredProducts(MeteredProductsT&& value) {
    SetMeteredProducts(std::forward<MeteredProductsT>(value));
    return *this;
  }
  template <typename MeteredProductsT = MeteredProductSummary>
  ListMeteredProductsResult& AddMeteredProducts(MeteredProductsT&& value) {
    m_meteredProductsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListMeteredProductsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMeteredProductsResult& WithRequestId(RequestIdT&& value) {
