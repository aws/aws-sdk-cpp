 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListFarmsResponse">AWS
 * API Reference</a></p>
 */
class ListFarmsResult {
 public:
  ...
  void SetFarms(FarmsT&& value) {
    m_farmsHasBeenSet = true;
    m_farms = std::forward<FarmsT>(value);
  }
  template <typename FarmsT = Aws::Vector<FarmSummary>>
  ListFarmsResult& WithFarms(FarmsT&& value) {
    SetFarms(std::forward<FarmsT>(value));
    return *this;
  }
  template <typename FarmsT = FarmSummary>
  ListFarmsResult& AddFarms(FarmsT&& value) {
    m_farmsHasBeenSet = true;
    m_farms.emplace_back(std::forward<FarmsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFarmsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFarmsResult& WithRequestId(RequestIdT&& value) {
