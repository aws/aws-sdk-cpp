...
class GetQueueEnvironmentRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  GetQueueEnvironmentRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  GetQueueEnvironmentRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename QueueEnvironmentIdT = Aws::String>
  GetQueueEnvironmentRequest& WithQueueEnvironmentId(QueueEnvironmentIdT&& value) {
