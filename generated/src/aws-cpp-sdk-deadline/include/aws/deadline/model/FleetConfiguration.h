...
class FleetConfiguration {
 public:
  ...
  void SetCustomerManaged(CustomerManagedT&& value) {
    ...
    m_customerManaged = std::forward<CustomerManagedT>(value);
  }
  template <typename CustomerManagedT = CustomerManagedFleetConfiguration>
  FleetConfiguration& WithCustomerManaged(CustomerManagedT&& value) {
    SetCustomerManaged(std::forward<CustomerManagedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceManagedEc2(ServiceManagedEc2T&& value) {
    ...
    m_serviceManagedEc2 = std::forward<ServiceManagedEc2T>(value);
  }
  template <typename ServiceManagedEc2T = ServiceManagedEc2FleetConfiguration>
  FleetConfiguration& WithServiceManagedEc2(ServiceManagedEc2T&& value) {
    SetServiceManagedEc2(std::forward<ServiceManagedEc2T>(value));
    return *this;
  }
  ///@}
 private:
