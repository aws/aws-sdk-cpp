 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListMonitorsRequest">AWS
 * API Reference</a></p>
 */
class ListMonitorsRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API ListMonitorsRequest() = default;
