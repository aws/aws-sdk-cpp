 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListMeteredProductsRequest">AWS
 * API Reference</a></p>
 */
class ListMeteredProductsRequest : public DeadlineRequest {
 public:
  ...
  template <typename LicenseEndpointIdT = Aws::String>
  ListMeteredProductsRequest& WithLicenseEndpointId(LicenseEndpointIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListMeteredProductsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMeteredProductsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
