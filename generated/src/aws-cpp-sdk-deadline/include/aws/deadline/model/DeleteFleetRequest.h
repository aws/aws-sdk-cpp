...
class DeleteFleetRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API DeleteFleetRequest() = default;
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteFleetRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename FarmIdT = Aws::String>
  DeleteFleetRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename FleetIdT = Aws::String>
  DeleteFleetRequest& WithFleetId(FleetIdT&& value) {
