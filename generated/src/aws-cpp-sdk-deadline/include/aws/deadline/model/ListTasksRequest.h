 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListTasksRequest">AWS
 * API Reference</a></p>
 */
class ListTasksRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API ListTasksRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  ListTasksRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  ListTasksRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  ListTasksRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename StepIdT = Aws::String>
  ListTasksRequest& WithStepId(StepIdT&& value) {
