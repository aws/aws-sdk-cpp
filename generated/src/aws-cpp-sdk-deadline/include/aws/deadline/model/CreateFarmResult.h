 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/CreateFarmResponse">AWS
 * API Reference</a></p>
 */
class CreateFarmResult {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  CreateFarmResult& WithFarmId(FarmIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateFarmResult& WithRequestId(RequestIdT&& value) {
