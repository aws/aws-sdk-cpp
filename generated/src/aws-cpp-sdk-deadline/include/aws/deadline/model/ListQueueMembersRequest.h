 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListQueueMembersRequest">AWS
 * API Reference</a></p>
 */
class ListQueueMembersRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  ListQueueMembersRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  ListQueueMembersRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListQueueMembersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListQueueMembersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
