...
namespace Model
{
  ...
  {
  public:
    AWS_DEADLINE_API ListQueueMembersRequest() = default;
    ...
    template<typename FarmIdT = Aws::String>
    ListQueueMembersRequest& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename QueueIdT = Aws::String>
    ListQueueMembersRequest& WithQueueId(QueueIdT&& value) { SetQueueId(std::forward<QueueIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListQueueMembersRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
