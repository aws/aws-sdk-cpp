 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListQueueFleetAssociationsResponse">AWS
 * API Reference</a></p>
 */
class ListQueueFleetAssociationsResult {
 public:
  ...
  void SetQueueFleetAssociations(QueueFleetAssociationsT&& value) {
    m_queueFleetAssociationsHasBeenSet = true;
    m_queueFleetAssociations = std::forward<QueueFleetAssociationsT>(value);
  }
  template <typename QueueFleetAssociationsT = Aws::Vector<QueueFleetAssociationSummary>>
  ListQueueFleetAssociationsResult& WithQueueFleetAssociations(QueueFleetAssociationsT&& value) {
    SetQueueFleetAssociations(std::forward<QueueFleetAssociationsT>(value));
    return *this;
  }
  template <typename QueueFleetAssociationsT = QueueFleetAssociationSummary>
  ListQueueFleetAssociationsResult& AddQueueFleetAssociations(QueueFleetAssociationsT&& value) {
    m_queueFleetAssociationsHasBeenSet = true;
    m_queueFleetAssociations.emplace_back(std::forward<QueueFleetAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListQueueFleetAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListQueueFleetAssociationsResult& WithRequestId(RequestIdT&& value) {
