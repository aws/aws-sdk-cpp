...
class ParameterFilterExpression {
 public:
  ...
  template <typename NameT = Aws::String>
  ParameterFilterExpression& WithName(NameT&& value) {
  ...
  inline ParameterFilterExpression& WithOperator(ComparisonOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  ParameterFilterExpression& WithValue(ValueT&& value) {
