...
namespace Model
{
  ...
  {
  public:
    AWS_DEADLINE_API ListFleetMembersResult();
     ...
     * <p>The members on the list.</p>
     */
    inline void SetMembers(const Aws::Vector<FleetMember>& value) { m_members = value; }

    /**
     * <p>The members on the list.</p>
     */
    inline void SetMembers(Aws::Vector<FleetMember>&& value) { m_members = std::move(value); }

    /**
     * <p>The members on the list.</p>
     */
    inline ListFleetMembersResult& WithMembers(const Aws::Vector<FleetMember>& value) { SetMembers(value); return *this;}

    /**
     * <p>The members on the list.</p>
     */
    inline ListFleetMembersResult& WithMembers(Aws::Vector<FleetMember>&& value) { SetMembers(std::move(value)); return *this;}
     ...
     * receive an HTTP 400 <code>ValidationException</code> error.</p>
     */
    inline ListFleetMembersResult& WithNextToken(const char* value) { SetNextToken(value); return *this;}
    ...
    inline ListFleetMembersResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListFleetMembersResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListFleetMembersResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
