 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListFleetMembersResponse">AWS
 * API Reference</a></p>
 */
class ListFleetMembersResult {
 public:
  ...
  template <typename MembersT = Aws::Vector<FleetMember>>
  ListFleetMembersResult& WithMembers(MembersT&& value) {
    SetMembers(std::forward<MembersT>(value));
    return *this;
  }
  template <typename MembersT = FleetMember>
  ListFleetMembersResult& AddMembers(MembersT&& value) {
    m_membersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListFleetMembersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFleetMembersResult& WithRequestId(RequestIdT&& value) {
