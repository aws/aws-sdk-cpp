...
namespace Model
{
  ...
  {
  public:
    AWS_DEADLINE_API ListFleetMembersRequest() = default;
    ...
    template<typename FarmIdT = Aws::String>
    ListFleetMembersRequest& WithFarmId(FarmIdT&& value) { SetFarmId(std::forward<FarmIdT>(value)); return *this;}
    ///@}
    ...
    template<typename FleetIdT = Aws::String>
    ListFleetMembersRequest& WithFleetId(FleetIdT&& value) { SetFleetId(std::forward<FleetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListFleetMembersRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
