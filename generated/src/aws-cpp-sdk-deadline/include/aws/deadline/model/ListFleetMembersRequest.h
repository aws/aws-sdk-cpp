 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListFleetMembersRequest">AWS
 * API Reference</a></p>
 */
class ListFleetMembersRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  ListFleetMembersRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename FleetIdT = Aws::String>
  ListFleetMembersRequest& WithFleetId(FleetIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListFleetMembersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFleetMembersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
