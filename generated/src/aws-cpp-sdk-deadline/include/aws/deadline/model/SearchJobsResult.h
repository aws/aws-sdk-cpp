 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/SearchJobsResponse">AWS
 * API Reference</a></p>
 */
class SearchJobsResult {
 public:
  ...
  inline SearchJobsResult& WithNextItemOffset(int value) {
  ...
  inline SearchJobsResult& WithTotalResults(int value) {
