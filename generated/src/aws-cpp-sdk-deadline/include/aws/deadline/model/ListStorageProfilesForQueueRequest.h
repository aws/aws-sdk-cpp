 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListStorageProfilesForQueueRequest">AWS
 * API Reference</a></p>
 */
class ListStorageProfilesForQueueRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API ListStorageProfilesForQueueRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  ListStorageProfilesForQueueRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  ListStorageProfilesForQueueRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStorageProfilesForQueueRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStorageProfilesForQueueRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
