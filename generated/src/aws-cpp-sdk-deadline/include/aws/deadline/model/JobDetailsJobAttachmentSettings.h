...
/**
 * <p>The job attachment settings returned to workers for a job. These are the
 * Amazon S3 bucket name and the Amazon S3 prefix.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/JobDetailsJobAttachmentSettings">AWS
 * API Reference</a></p>
 */
