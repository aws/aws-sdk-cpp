...
class UpdateWorkerScheduleResult {
 public:
  ...
  void SetAssignedSessions(AssignedSessionsT&& value) {
    m_assignedSessionsHasBeenSet = true;
    m_assignedSessions = std::forward<AssignedSessionsT>(value);
  }
  template <typename AssignedSessionsT = Aws::Map<Aws::String, AssignedSession>>
  UpdateWorkerScheduleResult& WithAssignedSessions(AssignedSessionsT&& value) {
    SetAssignedSessions(std::forward<AssignedSessionsT>(value));
    return *this;
  }
  ...
  UpdateWorkerScheduleResult& AddAssignedSessions(AssignedSessionsKeyT&& key, AssignedSessionsValueT&& value) {
    m_assignedSessionsHasBeenSet = true;
    m_assignedSessions.emplace(std::forward<AssignedSessionsKeyT>(key), std::forward<AssignedSessionsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCancelSessionActions(CancelSessionActionsT&& value) {
    ...
    m_cancelSessionActions = std::forward<CancelSessionActionsT>(value);
  }
  template <typename CancelSessionActionsT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  UpdateWorkerScheduleResult& WithCancelSessionActions(CancelSessionActionsT&& value) {
    SetCancelSessionActions(std::forward<CancelSessionActionsT>(value));
    return *this;
  }
  ...
  UpdateWorkerScheduleResult& AddCancelSessionActions(CancelSessionActionsKeyT&& key, CancelSessionActionsValueT&& value) {
    m_cancelSessionActionsHasBeenSet = true;
    m_cancelSessionActions.emplace(std::forward<CancelSessionActionsKeyT>(key), std::forward<CancelSessionActionsValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDesiredWorkerStatus(DesiredWorkerStatus value) {
    m_desiredWorkerStatusHasBeenSet = true;
    m_desiredWorkerStatus = value;
  }
  inline UpdateWorkerScheduleResult& WithDesiredWorkerStatus(DesiredWorkerStatus value) {
    SetDesiredWorkerStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUpdateIntervalSeconds(int value) {
    m_updateIntervalSecondsHasBeenSet = true;
    m_updateIntervalSeconds = value;
  }
  inline UpdateWorkerScheduleResult& WithUpdateIntervalSeconds(int value) {
    SetUpdateIntervalSeconds(value);
    return *this;
  }
  ///@}
