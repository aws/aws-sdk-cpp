...
class ListStepConsumersRequest : public DeadlineRequest {
 public:
  ...
  template <typename FarmIdT = Aws::String>
  ListStepConsumersRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  ListStepConsumersRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  ListStepConsumersRequest& WithJobId(JobIdT&& value) {
  ...
  template <typename StepIdT = Aws::String>
  ListStepConsumersRequest& WithStepId(StepIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStepConsumersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStepConsumersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
