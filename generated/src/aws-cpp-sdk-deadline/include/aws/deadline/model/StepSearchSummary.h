...
class StepSearchSummary {
 public:
  ...
  inline StepSearchSummary& WithLifecycleStatus(StepLifecycleStatus value) {
  ...
  inline StepSearchSummary& WithTaskRunStatus(TaskRunStatus value) {
  ...
  inline StepSearchSummary& WithTargetTaskRunStatus(StepTargetTaskRunStatus value) {
  ...
  inline StepSearchSummary& WithTaskFailureRetryCount(int value) {
