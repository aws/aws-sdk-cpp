 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListQueueEnvironmentsResponse">AWS
 * API Reference</a></p>
 */
class ListQueueEnvironmentsResult {
 public:
  ...
  template <typename EnvironmentsT = Aws::Vector<QueueEnvironmentSummary>>
  ListQueueEnvironmentsResult& WithEnvironments(EnvironmentsT&& value) {
    SetEnvironments(std::forward<EnvironmentsT>(value));
    return *this;
  }
  template <typename EnvironmentsT = QueueEnvironmentSummary>
  ListQueueEnvironmentsResult& AddEnvironments(EnvironmentsT&& value) {
    m_environmentsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListQueueEnvironmentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListQueueEnvironmentsResult& WithRequestId(RequestIdT&& value) {
