...
class FarmMember {
 public:
  AWS_DEADLINE_API FarmMember() = default;
  ...
  template <typename FarmIdT = Aws::String>
  FarmMember& WithFarmId(FarmIdT&& value) {
  ...
  template <typename PrincipalIdT = Aws::String>
  FarmMember& WithPrincipalId(PrincipalIdT&& value) {
  ...
  inline FarmMember& WithPrincipalType(PrincipalType value) {
  ...
  template <typename IdentityStoreIdT = Aws::String>
  FarmMember& WithIdentityStoreId(IdentityStoreIdT&& value) {
  ...
  inline FarmMember& WithMembershipLevel(MembershipLevel value) {
