...
class DeleteQueueFleetAssociationRequest : public DeadlineRequest {
 public:
  AWS_DEADLINE_API DeleteQueueFleetAssociationRequest() = default;
  ...
  template <typename FarmIdT = Aws::String>
  DeleteQueueFleetAssociationRequest& WithFarmId(FarmIdT&& value) {
  ...
  template <typename QueueIdT = Aws::String>
  DeleteQueueFleetAssociationRequest& WithQueueId(QueueIdT&& value) {
  ...
  template <typename FleetIdT = Aws::String>
  DeleteQueueFleetAssociationRequest& WithFleetId(FleetIdT&& value) {
