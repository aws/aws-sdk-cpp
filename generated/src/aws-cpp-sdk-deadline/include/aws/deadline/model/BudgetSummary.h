...
class BudgetSummary {
 public:
  ...
  template <typename BudgetIdT = Aws::String>
  BudgetSummary& WithBudgetId(BudgetIdT&& value) {
  ...
  template <typename UsageTrackingResourceT = UsageTrackingResource>
  BudgetSummary& WithUsageTrackingResource(UsageTrackingResourceT&& value) {
  ...
  inline BudgetSummary& WithStatus(BudgetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DisplayNameT = Aws::String>
  BudgetSummary& WithDisplayName(DisplayNameT&& value) {
  ...
  inline BudgetSummary& WithApproximateDollarLimit(double value) {
  ...
  template <typename UsagesT = ConsumedUsages>
  BudgetSummary& WithUsages(UsagesT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  BudgetSummary& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  BudgetSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedByT = Aws::String>
  BudgetSummary& WithUpdatedBy(UpdatedByT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  BudgetSummary& WithUpdatedAt(UpdatedAtT&& value) {
