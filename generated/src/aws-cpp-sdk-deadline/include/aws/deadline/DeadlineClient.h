...
class AWS_DEADLINE_API DeadlineClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  DeadlineClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<DeadlineEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AssociateMemberToFarm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateMemberToFarm that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateMemberToFarmRequestT = Model::AssociateMemberToFarmRequest>
  void AssociateMemberToFarmAsync(const AssociateMemberToFarmRequestT& request, const AssociateMemberToFarmResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AssociateMemberToFleet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateMemberToFleet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateMemberToFleetRequestT = Model::AssociateMemberToFleetRequest>
  void AssociateMemberToFleetAsync(const AssociateMemberToFleetRequestT& request,
                                   const AssociateMemberToFleetResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateMemberToJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateMemberToJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateMemberToJobRequestT = Model::AssociateMemberToJobRequest>
  void AssociateMemberToJobAsync(const AssociateMemberToJobRequestT& request, const AssociateMemberToJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateMemberToQueue that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateMemberToQueue that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateMemberToQueueRequestT = Model::AssociateMemberToQueueRequest>
  void AssociateMemberToQueueAsync(const AssociateMemberToQueueRequestT& request,
                                   const AssociateMemberToQueueResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssumeFleetRoleForRead that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssumeFleetRoleForRead that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssumeFleetRoleForReadRequestT = Model::AssumeFleetRoleForReadRequest>
  void AssumeFleetRoleForReadAsync(const AssumeFleetRoleForReadRequestT& request,
                                   const AssumeFleetRoleForReadResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssumeFleetRoleForWorker that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssumeFleetRoleForWorker that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssumeFleetRoleForWorkerRequestT = Model::AssumeFleetRoleForWorkerRequest>
  void AssumeFleetRoleForWorkerAsync(const AssumeFleetRoleForWorkerRequestT& request,
                                     const AssumeFleetRoleForWorkerResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssumeQueueRoleForRead that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssumeQueueRoleForRead that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssumeQueueRoleForReadRequestT = Model::AssumeQueueRoleForReadRequest>
  void AssumeQueueRoleForReadAsync(const AssumeQueueRoleForReadRequestT& request,
                                   const AssumeQueueRoleForReadResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssumeQueueRoleForUser that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssumeQueueRoleForUser that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssumeQueueRoleForUserRequestT = Model::AssumeQueueRoleForUserRequest>
  void AssumeQueueRoleForUserAsync(const AssumeQueueRoleForUserRequestT& request,
                                   const AssumeQueueRoleForUserResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssumeQueueRoleForWorker that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssumeQueueRoleForWorker that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssumeQueueRoleForWorkerRequestT = Model::AssumeQueueRoleForWorkerRequest>
  void AssumeQueueRoleForWorkerAsync(const AssumeQueueRoleForWorkerRequestT& request,
                                     const AssumeQueueRoleForWorkerResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetJobEntity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetJobEntity that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchGetJobEntityRequestT = Model::BatchGetJobEntityRequest>
  ...
  /**
   * An Async wrapper for CopyJobTemplate that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CopyJobTemplateRequestT = Model::CopyJobTemplateRequest>
  void CopyJobTemplateAsync(const CopyJobTemplateRequestT& request, const CopyJobTemplateResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateFarm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateFarmRequestT = Model::CreateFarmRequest>
  void CreateFarmAsync(const CreateFarmRequestT& request, const CreateFarmResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateLicenseEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateLicenseEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateLicenseEndpointRequestT = Model::CreateLicenseEndpointRequest>
  void CreateLicenseEndpointAsync(const CreateLicenseEndpointRequestT& request, const CreateLicenseEndpointResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateLimit that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateLimitRequestT = Model::CreateLimitRequest>
  void CreateLimitAsync(const CreateLimitRequestT& request, const CreateLimitResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateQueueEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateQueueEnvironment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateQueueEnvironmentRequestT = Model::CreateQueueEnvironmentRequest>
  void CreateQueueEnvironmentAsync(const CreateQueueEnvironmentRequestT& request,
                                   const CreateQueueEnvironmentResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateQueueFleetAssociationOutcome CreateQueueFleetAssociation(
      const Model::CreateQueueFleetAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateQueueFleetAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateQueueFleetAssociationRequestT = Model::CreateQueueFleetAssociationRequest>
  Model::CreateQueueFleetAssociationOutcomeCallable CreateQueueFleetAssociationCallable(
      const CreateQueueFleetAssociationRequestT& request) const {
    return SubmitCallable(&DeadlineClient::CreateQueueFleetAssociation, request);
  }

  /**
   * An Async wrapper for CreateQueueFleetAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateQueueFleetAssociationRequestT = Model::CreateQueueFleetAssociationRequest>
  void CreateQueueFleetAssociationAsync(const CreateQueueFleetAssociationRequestT& request,
                                        const CreateQueueFleetAssociationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateQueueLimitAssociationOutcome CreateQueueLimitAssociation(
      const Model::CreateQueueLimitAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateQueueLimitAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateQueueLimitAssociationRequestT = Model::CreateQueueLimitAssociationRequest>
  Model::CreateQueueLimitAssociationOutcomeCallable CreateQueueLimitAssociationCallable(
      const CreateQueueLimitAssociationRequestT& request) const {
    return SubmitCallable(&DeadlineClient::CreateQueueLimitAssociation, request);
  }

  /**
   * An Async wrapper for CreateQueueLimitAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateQueueLimitAssociationRequestT = Model::CreateQueueLimitAssociationRequest>
  void CreateQueueLimitAssociationAsync(const CreateQueueLimitAssociationRequestT& request,
                                        const CreateQueueLimitAssociationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateStorageProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateStorageProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateStorageProfileRequestT = Model::CreateStorageProfileRequest>
  void CreateStorageProfileAsync(const CreateStorageProfileRequestT& request, const CreateStorageProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateWorker that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateWorkerRequestT = Model::CreateWorkerRequest>
  void CreateWorkerAsync(const CreateWorkerRequestT& request, const CreateWorkerResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteFarm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFarmRequestT = Model::DeleteFarmRequest>
  void DeleteFarmAsync(const DeleteFarmRequestT& request, const DeleteFarmResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteLicenseEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteLicenseEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteLicenseEndpointRequestT = Model::DeleteLicenseEndpointRequest>
  void DeleteLicenseEndpointAsync(const DeleteLicenseEndpointRequestT& request, const DeleteLicenseEndpointResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteLimit that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteLimitRequestT = Model::DeleteLimitRequest>
  void DeleteLimitAsync(const DeleteLimitRequestT& request, const DeleteLimitResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMeteredProduct that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMeteredProduct that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMeteredProductRequestT = Model::DeleteMeteredProductRequest>
  void DeleteMeteredProductAsync(const DeleteMeteredProductRequestT& request, const DeleteMeteredProductResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteQueueEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteQueueEnvironment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteQueueEnvironmentRequestT = Model::DeleteQueueEnvironmentRequest>
  void DeleteQueueEnvironmentAsync(const DeleteQueueEnvironmentRequestT& request,
                                   const DeleteQueueEnvironmentResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteQueueFleetAssociationOutcome DeleteQueueFleetAssociation(
      const Model::DeleteQueueFleetAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteQueueFleetAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteQueueFleetAssociationRequestT = Model::DeleteQueueFleetAssociationRequest>
  Model::DeleteQueueFleetAssociationOutcomeCallable DeleteQueueFleetAssociationCallable(
      const DeleteQueueFleetAssociationRequestT& request) const {
    return SubmitCallable(&DeadlineClient::DeleteQueueFleetAssociation, request);
  }

  /**
   * An Async wrapper for DeleteQueueFleetAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteQueueFleetAssociationRequestT = Model::DeleteQueueFleetAssociationRequest>
  void DeleteQueueFleetAssociationAsync(const DeleteQueueFleetAssociationRequestT& request,
                                        const DeleteQueueFleetAssociationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DeleteQueueLimitAssociationOutcome DeleteQueueLimitAssociation(
      const Model::DeleteQueueLimitAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteQueueLimitAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteQueueLimitAssociationRequestT = Model::DeleteQueueLimitAssociationRequest>
  Model::DeleteQueueLimitAssociationOutcomeCallable DeleteQueueLimitAssociationCallable(
      const DeleteQueueLimitAssociationRequestT& request) const {
    return SubmitCallable(&DeadlineClient::DeleteQueueLimitAssociation, request);
  }

  /**
   * An Async wrapper for DeleteQueueLimitAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteQueueLimitAssociationRequestT = Model::DeleteQueueLimitAssociationRequest>
  void DeleteQueueLimitAssociationAsync(const DeleteQueueLimitAssociationRequestT& request,
                                        const DeleteQueueLimitAssociationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteStorageProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteStorageProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteStorageProfileRequestT = Model::DeleteStorageProfileRequest>
  void DeleteStorageProfileAsync(const DeleteStorageProfileRequestT& request, const DeleteStorageProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteWorker that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteWorkerRequestT = Model::DeleteWorkerRequest>
  void DeleteWorkerAsync(const DeleteWorkerRequestT& request, const DeleteWorkerResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateMemberFromFarmOutcome DisassociateMemberFromFarm(
      const Model::DisassociateMemberFromFarmRequest& request) const;

  /**
   * A Callable wrapper for DisassociateMemberFromFarm that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateMemberFromFarmRequestT = Model::DisassociateMemberFromFarmRequest>
  Model::DisassociateMemberFromFarmOutcomeCallable DisassociateMemberFromFarmCallable(
      const DisassociateMemberFromFarmRequestT& request) const {
    return SubmitCallable(&DeadlineClient::DisassociateMemberFromFarm, request);
  }

  /**
   * An Async wrapper for DisassociateMemberFromFarm that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateMemberFromFarmRequestT = Model::DisassociateMemberFromFarmRequest>
  void DisassociateMemberFromFarmAsync(const DisassociateMemberFromFarmRequestT& request,
                                       const DisassociateMemberFromFarmResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DisassociateMemberFromFleetOutcome DisassociateMemberFromFleet(
      const Model::DisassociateMemberFromFleetRequest& request) const;

  /**
   * A Callable wrapper for DisassociateMemberFromFleet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateMemberFromFleetRequestT = Model::DisassociateMemberFromFleetRequest>
  Model::DisassociateMemberFromFleetOutcomeCallable DisassociateMemberFromFleetCallable(
      const DisassociateMemberFromFleetRequestT& request) const {
    return SubmitCallable(&DeadlineClient::DisassociateMemberFromFleet, request);
  }

  /**
   * An Async wrapper for DisassociateMemberFromFleet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateMemberFromFleetRequestT = Model::DisassociateMemberFromFleetRequest>
  void DisassociateMemberFromFleetAsync(const DisassociateMemberFromFleetRequestT& request,
                                        const DisassociateMemberFromFleetResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateMemberFromJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DisassociateMemberFromJobRequestT = Model::DisassociateMemberFromJobRequest>
  Model::DisassociateMemberFromJobOutcomeCallable DisassociateMemberFromJobCallable(
      const DisassociateMemberFromJobRequestT& request) const {
    return SubmitCallable(&DeadlineClient::DisassociateMemberFromJob, request);
  }

  /**
   * An Async wrapper for DisassociateMemberFromJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateMemberFromJobRequestT = Model::DisassociateMemberFromJobRequest>
  void DisassociateMemberFromJobAsync(const DisassociateMemberFromJobRequestT& request,
                                      const DisassociateMemberFromJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateMemberFromQueueOutcome DisassociateMemberFromQueue(
      const Model::DisassociateMemberFromQueueRequest& request) const;

  /**
   * A Callable wrapper for DisassociateMemberFromQueue that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateMemberFromQueueRequestT = Model::DisassociateMemberFromQueueRequest>
  Model::DisassociateMemberFromQueueOutcomeCallable DisassociateMemberFromQueueCallable(
      const DisassociateMemberFromQueueRequestT& request) const {
    return SubmitCallable(&DeadlineClient::DisassociateMemberFromQueue, request);
  }

  /**
   * An Async wrapper for DisassociateMemberFromQueue that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateMemberFromQueueRequestT = Model::DisassociateMemberFromQueueRequest>
  void DisassociateMemberFromQueueAsync(const DisassociateMemberFromQueueRequestT& request,
                                        const DisassociateMemberFromQueueResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBudget that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBudgetRequestT = Model::GetBudgetRequest>
  void GetBudgetAsync(const GetBudgetRequestT& request, const GetBudgetResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetFarm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFarmRequestT = Model::GetFarmRequest>
  void GetFarmAsync(const GetFarmRequestT& request, const GetFarmResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLicenseEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLicenseEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetLicenseEndpointRequestT = Model::GetLicenseEndpointRequest>
  void GetLicenseEndpointAsync(const GetLicenseEndpointRequestT& request, const GetLicenseEndpointResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetLimit that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLimitRequestT = Model::GetLimitRequest>
  void GetLimitAsync(const GetLimitRequestT& request, const GetLimitResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetQueueEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetQueueEnvironment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetQueueEnvironmentRequestT = Model::GetQueueEnvironmentRequest>
  void GetQueueEnvironmentAsync(const GetQueueEnvironmentRequestT& request, const GetQueueEnvironmentResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetQueueFleetAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetQueueFleetAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetQueueFleetAssociationRequestT = Model::GetQueueFleetAssociationRequest>
  void GetQueueFleetAssociationAsync(const GetQueueFleetAssociationRequestT& request,
                                     const GetQueueFleetAssociationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetQueueLimitAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetQueueLimitAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetQueueLimitAssociationRequestT = Model::GetQueueLimitAssociationRequest>
  void GetQueueLimitAssociationAsync(const GetQueueLimitAssociationRequestT& request,
                                     const GetQueueLimitAssociationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSessionAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSessionAction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSessionActionRequestT = Model::GetSessionActionRequest>
  void GetSessionActionAsync(const GetSessionActionRequestT& request, const GetSessionActionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSessionsStatisticsAggregationOutcome GetSessionsStatisticsAggregation(
      const Model::GetSessionsStatisticsAggregationRequest& request) const;

  /**
   * A Callable wrapper for GetSessionsStatisticsAggregation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetSessionsStatisticsAggregationRequestT = Model::GetSessionsStatisticsAggregationRequest>
  Model::GetSessionsStatisticsAggregationOutcomeCallable GetSessionsStatisticsAggregationCallable(
      const GetSessionsStatisticsAggregationRequestT& request) const {
    return SubmitCallable(&DeadlineClient::GetSessionsStatisticsAggregation, request);
  }

  /**
   * An Async wrapper for GetSessionsStatisticsAggregation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetSessionsStatisticsAggregationRequestT = Model::GetSessionsStatisticsAggregationRequest>
  void GetSessionsStatisticsAggregationAsync(const GetSessionsStatisticsAggregationRequestT& request,
                                             const GetSessionsStatisticsAggregationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetStep that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetStepRequestT = Model::GetStepRequest>
  void GetStepAsync(const GetStepRequestT& request, const GetStepResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetStorageProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetStorageProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetStorageProfileRequestT = Model::GetStorageProfileRequest>
  void GetStorageProfileAsync(const GetStorageProfileRequestT& request, const GetStorageProfileResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetStorageProfileForQueue that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetStorageProfileForQueueRequestT = Model::GetStorageProfileForQueueRequest>
  Model::GetStorageProfileForQueueOutcomeCallable GetStorageProfileForQueueCallable(
      const GetStorageProfileForQueueRequestT& request) const {
    return SubmitCallable(&DeadlineClient::GetStorageProfileForQueue, request);
  }

  /**
   * An Async wrapper for GetStorageProfileForQueue that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetStorageProfileForQueueRequestT = Model::GetStorageProfileForQueueRequest>
  void GetStorageProfileForQueueAsync(const GetStorageProfileForQueueRequestT& request,
                                      const GetStorageProfileForQueueResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTaskRequestT = Model::GetTaskRequest>
  ...
  /**
   * An Async wrapper for GetWorker that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetWorkerRequestT = Model::GetWorkerRequest>
  void GetWorkerAsync(const GetWorkerRequestT& request, const GetWorkerResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAvailableMeteredProductsOutcome ListAvailableMeteredProducts(
      const Model::ListAvailableMeteredProductsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListAvailableMeteredProducts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAvailableMeteredProductsRequestT = Model::ListAvailableMeteredProductsRequest>
  Model::ListAvailableMeteredProductsOutcomeCallable ListAvailableMeteredProductsCallable(
      const ListAvailableMeteredProductsRequestT& request = {}) const {
    return SubmitCallable(&DeadlineClient::ListAvailableMeteredProducts, request);
  }

  /**
   * An Async wrapper for ListAvailableMeteredProducts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAvailableMeteredProductsRequestT = Model::ListAvailableMeteredProductsRequest>
  void ListAvailableMeteredProductsAsync(const ListAvailableMeteredProductsResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for ListBudgets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListBudgetsRequestT = Model::ListBudgetsRequest>
  void ListBudgetsAsync(const ListBudgetsRequestT& request, const ListBudgetsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListFarmMembers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFarmMembersRequestT = Model::ListFarmMembersRequest>
  void ListFarmMembersAsync(const ListFarmMembersRequestT& request, const ListFarmMembersResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListFarms that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFarmsRequestT = Model::ListFarmsRequest>
  void ListFarmsAsync(const ListFarmsResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const ListFarmsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListFleetMembers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFleetMembers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListFleetMembersRequestT = Model::ListFleetMembersRequest>
  void ListFleetMembersAsync(const ListFleetMembersRequestT& request, const ListFleetMembersResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListFleetsRequestT = Model::ListFleetsRequest>
  void ListFleetsAsync(const ListFleetsRequestT& request, const ListFleetsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListJobMembers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListJobMembersRequestT = Model::ListJobMembersRequest>
  void ListJobMembersAsync(const ListJobMembersRequestT& request, const ListJobMembersResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListJobParameterDefinitionsOutcome ListJobParameterDefinitions(
      const Model::ListJobParameterDefinitionsRequest& request) const;

  /**
   * A Callable wrapper for ListJobParameterDefinitions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListJobParameterDefinitionsRequestT = Model::ListJobParameterDefinitionsRequest>
  Model::ListJobParameterDefinitionsOutcomeCallable ListJobParameterDefinitionsCallable(
      const ListJobParameterDefinitionsRequestT& request) const {
    return SubmitCallable(&DeadlineClient::ListJobParameterDefinitions, request);
  }

  /**
   * An Async wrapper for ListJobParameterDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListJobParameterDefinitionsRequestT = Model::ListJobParameterDefinitionsRequest>
  void ListJobParameterDefinitionsAsync(const ListJobParameterDefinitionsRequestT& request,
                                        const ListJobParameterDefinitionsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListLicenseEndpoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLicenseEndpoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListLicenseEndpointsRequestT = Model::ListLicenseEndpointsRequest>
  void ListLicenseEndpointsAsync(const ListLicenseEndpointsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListLicenseEndpointsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListLimits that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLimitsRequestT = Model::ListLimitsRequest>
  void ListLimitsAsync(const ListLimitsRequestT& request, const ListLimitsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMeteredProducts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMeteredProducts that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListMeteredProductsRequestT = Model::ListMeteredProductsRequest>
  void ListMeteredProductsAsync(const ListMeteredProductsRequestT& request, const ListMeteredProductsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListQueueEnvironments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListQueueEnvironments that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListQueueEnvironmentsRequestT = Model::ListQueueEnvironmentsRequest>
  void ListQueueEnvironmentsAsync(const ListQueueEnvironmentsRequestT& request, const ListQueueEnvironmentsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListQueueFleetAssociationsOutcome ListQueueFleetAssociations(
      const Model::ListQueueFleetAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListQueueFleetAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListQueueFleetAssociationsRequestT = Model::ListQueueFleetAssociationsRequest>
  Model::ListQueueFleetAssociationsOutcomeCallable ListQueueFleetAssociationsCallable(
      const ListQueueFleetAssociationsRequestT& request) const {
    return SubmitCallable(&DeadlineClient::ListQueueFleetAssociations, request);
  }

  /**
   * An Async wrapper for ListQueueFleetAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListQueueFleetAssociationsRequestT = Model::ListQueueFleetAssociationsRequest>
  void ListQueueFleetAssociationsAsync(const ListQueueFleetAssociationsRequestT& request,
                                       const ListQueueFleetAssociationsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListQueueLimitAssociationsOutcome ListQueueLimitAssociations(
      const Model::ListQueueLimitAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListQueueLimitAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListQueueLimitAssociationsRequestT = Model::ListQueueLimitAssociationsRequest>
  Model::ListQueueLimitAssociationsOutcomeCallable ListQueueLimitAssociationsCallable(
      const ListQueueLimitAssociationsRequestT& request) const {
    return SubmitCallable(&DeadlineClient::ListQueueLimitAssociations, request);
  }

  /**
   * An Async wrapper for ListQueueLimitAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListQueueLimitAssociationsRequestT = Model::ListQueueLimitAssociationsRequest>
  void ListQueueLimitAssociationsAsync(const ListQueueLimitAssociationsRequestT& request,
                                       const ListQueueLimitAssociationsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListQueueMembers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListQueueMembers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListQueueMembersRequestT = Model::ListQueueMembersRequest>
  void ListQueueMembersAsync(const ListQueueMembersRequestT& request, const ListQueueMembersResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSessionActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSessionActions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSessionActionsRequestT = Model::ListSessionActionsRequest>
  void ListSessionActionsAsync(const ListSessionActionsRequestT& request, const ListSessionActionsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSessionsForWorker that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSessionsForWorker that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSessionsForWorkerRequestT = Model::ListSessionsForWorkerRequest>
  void ListSessionsForWorkerAsync(const ListSessionsForWorkerRequestT& request, const ListSessionsForWorkerResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListStepConsumers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStepConsumers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListStepConsumersRequestT = Model::ListStepConsumersRequest>
  void ListStepConsumersAsync(const ListStepConsumersRequestT& request, const ListStepConsumersResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListStepDependencies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStepDependencies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStepDependenciesRequestT = Model::ListStepDependenciesRequest>
  void ListStepDependenciesAsync(const ListStepDependenciesRequestT& request, const ListStepDependenciesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListSteps that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListStepsRequestT = Model::ListStepsRequest>
  void ListStepsAsync(const ListStepsRequestT& request, const ListStepsResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListStorageProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStorageProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListStorageProfilesRequestT = Model::ListStorageProfilesRequest>
  void ListStorageProfilesAsync(const ListStorageProfilesRequestT& request, const ListStorageProfilesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListStorageProfilesForQueueOutcome ListStorageProfilesForQueue(
      const Model::ListStorageProfilesForQueueRequest& request) const;

  /**
   * A Callable wrapper for ListStorageProfilesForQueue that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListStorageProfilesForQueueRequestT = Model::ListStorageProfilesForQueueRequest>
  Model::ListStorageProfilesForQueueOutcomeCallable ListStorageProfilesForQueueCallable(
      const ListStorageProfilesForQueueRequestT& request) const {
    return SubmitCallable(&DeadlineClient::ListStorageProfilesForQueue, request);
  }

  /**
   * An Async wrapper for ListStorageProfilesForQueue that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStorageProfilesForQueueRequestT = Model::ListStorageProfilesForQueueRequest>
  void ListStorageProfilesForQueueAsync(const ListStorageProfilesForQueueRequestT& request,
                                        const ListStorageProfilesForQueueResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListWorkers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListWorkersRequestT = Model::ListWorkersRequest>
  void ListWorkersAsync(const ListWorkersRequestT& request, const ListWorkersResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutMeteredProduct that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutMeteredProduct that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutMeteredProductRequestT = Model::PutMeteredProductRequest>
  void PutMeteredProductAsync(const PutMeteredProductRequestT& request, const PutMeteredProductResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchSteps that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchStepsRequestT = Model::SearchStepsRequest>
  void SearchStepsAsync(const SearchStepsRequestT& request, const SearchStepsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchTasks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchTasksRequestT = Model::SearchTasksRequest>
  void SearchTasksAsync(const SearchTasksRequestT& request, const SearchTasksResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchWorkers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchWorkersRequestT = Model::SearchWorkersRequest>
  void SearchWorkersAsync(const SearchWorkersRequestT& request, const SearchWorkersResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartSessionsStatisticsAggregationOutcome StartSessionsStatisticsAggregation(
      const Model::StartSessionsStatisticsAggregationRequest& request) const;

  /**
   * A Callable wrapper for StartSessionsStatisticsAggregation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StartSessionsStatisticsAggregationRequestT = Model::StartSessionsStatisticsAggregationRequest>
  Model::StartSessionsStatisticsAggregationOutcomeCallable StartSessionsStatisticsAggregationCallable(
      const StartSessionsStatisticsAggregationRequestT& request) const {
    return SubmitCallable(&DeadlineClient::StartSessionsStatisticsAggregation, request);
  }

  /**
   * An Async wrapper for StartSessionsStatisticsAggregation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartSessionsStatisticsAggregationRequestT = Model::StartSessionsStatisticsAggregationRequest>
  void StartSessionsStatisticsAggregationAsync(const StartSessionsStatisticsAggregationRequestT& request,
                                               const StartSessionsStatisticsAggregationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateFarm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateFarmRequestT = Model::UpdateFarmRequest>
  void UpdateFarmAsync(const UpdateFarmRequestT& request, const UpdateFarmResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateLimit that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateLimitRequestT = Model::UpdateLimitRequest>
  void UpdateLimitAsync(const UpdateLimitRequestT& request, const UpdateLimitResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateQueueEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateQueueEnvironment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateQueueEnvironmentRequestT = Model::UpdateQueueEnvironmentRequest>
  void UpdateQueueEnvironmentAsync(const UpdateQueueEnvironmentRequestT& request,
                                   const UpdateQueueEnvironmentResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateQueueFleetAssociationOutcome UpdateQueueFleetAssociation(
      const Model::UpdateQueueFleetAssociationRequest& request) const;

  /**
   * A Callable wrapper for UpdateQueueFleetAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateQueueFleetAssociationRequestT = Model::UpdateQueueFleetAssociationRequest>
  Model::UpdateQueueFleetAssociationOutcomeCallable UpdateQueueFleetAssociationCallable(
      const UpdateQueueFleetAssociationRequestT& request) const {
    return SubmitCallable(&DeadlineClient::UpdateQueueFleetAssociation, request);
  }

  /**
   * An Async wrapper for UpdateQueueFleetAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateQueueFleetAssociationRequestT = Model::UpdateQueueFleetAssociationRequest>
  void UpdateQueueFleetAssociationAsync(const UpdateQueueFleetAssociationRequestT& request,
                                        const UpdateQueueFleetAssociationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateQueueLimitAssociationOutcome UpdateQueueLimitAssociation(
      const Model::UpdateQueueLimitAssociationRequest& request) const;

  /**
   * A Callable wrapper for UpdateQueueLimitAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateQueueLimitAssociationRequestT = Model::UpdateQueueLimitAssociationRequest>
  Model::UpdateQueueLimitAssociationOutcomeCallable UpdateQueueLimitAssociationCallable(
      const UpdateQueueLimitAssociationRequestT& request) const {
    return SubmitCallable(&DeadlineClient::UpdateQueueLimitAssociation, request);
  }

  /**
   * An Async wrapper for UpdateQueueLimitAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateQueueLimitAssociationRequestT = Model::UpdateQueueLimitAssociationRequest>
  void UpdateQueueLimitAssociationAsync(const UpdateQueueLimitAssociationRequestT& request,
                                        const UpdateQueueLimitAssociationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateStep that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateStepRequestT = Model::UpdateStepRequest>
  void UpdateStepAsync(const UpdateStepRequestT& request, const UpdateStepResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateStorageProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateStorageProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateStorageProfileRequestT = Model::UpdateStorageProfileRequest>
  void UpdateStorageProfileAsync(const UpdateStorageProfileRequestT& request, const UpdateStorageProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateWorker that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateWorkerRequestT = Model::UpdateWorkerRequest>
  void UpdateWorkerAsync(const UpdateWorkerRequestT& request, const UpdateWorkerResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateWorkerSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateWorkerSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateWorkerScheduleRequestT = Model::UpdateWorkerScheduleRequest>
  void UpdateWorkerScheduleAsync(const UpdateWorkerScheduleRequestT& request, const UpdateWorkerScheduleResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
