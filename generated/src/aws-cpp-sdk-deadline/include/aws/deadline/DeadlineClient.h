...
namespace deadline
{
   ...
   */
  class AWS_DEADLINE_API DeadlineClient : Aws::Client::ClientWithAsyncTemplateMethods<DeadlineClient>,
    smithy::client::AwsSmithyClientT<Aws::deadline::SERVICE_NAME,
    ...
    public:
      ...
      typedef DeadlineEndpointProvider EndpointProviderType;
        ...
        */
         ...
         * worker know which instances types to exclude.</p><p><h3>See Also:</h3>   <a
