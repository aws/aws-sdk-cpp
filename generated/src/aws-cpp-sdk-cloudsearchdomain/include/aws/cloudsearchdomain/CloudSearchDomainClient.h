...
class AWS_CLOUDSEARCHDOMAIN_API CloudSearchDomainClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CloudSearchDomainClient(const Aws::CloudSearchDomain::CloudSearchDomainClientConfiguration& clientConfiguration =
  ...
  CloudSearchDomainClient(const Aws::Auth::AWSCredentials& credentials,
                          std::shared_ptr<CloudSearchDomainEndpointProviderBase> endpointProvider = nullptr,
                          const Aws::CloudSearchDomain::CloudSearchDomainClientConfiguration& clientConfiguration =
                              Aws::CloudSearchDomain::CloudSearchDomainClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  CloudSearchDomainClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * An Async wrapper for UploadDocuments that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UploadDocumentsRequestT = Model::UploadDocumentsRequest>
  void UploadDocumentsAsync(const UploadDocumentsRequestT& request, const UploadDocumentsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
