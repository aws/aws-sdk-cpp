...
namespace CloudSearchDomain
{
   ...
   */
  class AWS_CLOUDSEARCHDOMAIN_API CloudSearchDomainClient : Aws::Client::ClientWithAsyncTemplateMethods<CloudSearchDomainClient>,
    smithy::client::AwsSmithyClientT<Aws::CloudSearchDomain::SERVICE_NAME,
