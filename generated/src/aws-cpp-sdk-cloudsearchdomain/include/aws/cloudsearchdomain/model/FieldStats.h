...
class FieldStats {
 public:
  ...
  inline FieldStats& WithCount(long long value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMissing(long long value) {
    m_missingHasBeenSet = true;
    m_missing = value;
  }
  inline FieldStats& WithMissing(long long value) {
    SetMissing(value);
    return *this;
  }
  ///@}
  ...
  inline FieldStats& WithSum(double value) {
    SetSum(value);
    return *this;
  }
  ///@}
  ...
  inline FieldStats& WithSumOfSquares(double value) {
  ...
  void SetMean(MeanT&& value) {
    ...
    m_mean = std::forward<MeanT>(value);
  }
  template <typename MeanT = Aws::String>
  FieldStats& WithMean(MeanT&& value) {
    SetMean(std::forward<MeanT>(value));
    return *this;
  }
  ///@}
  ...
  inline FieldStats& WithStddev(double value) {
    SetStddev(value);
    return *this;
  }
  ///@}
