...
class Hits {
 public:
  ...
  inline void SetFound(long long value) {
    m_foundHasBeenSet = true;
    m_found = value;
  }
  inline Hits& WithFound(long long value) {
    SetFound(value);
    return *this;
  }
  ///@}
  ...
  inline Hits& WithStart(long long value) {
    SetStart(value);
    return *this;
  }
  ///@}
  ...
  void SetHit(HitT&& value) {
    ...
    m_hit = std::forward<HitT>(value);
  }
  template <typename HitT = Aws::Vector<Hit>>
  Hits& WithHit(HitT&& value) {
    SetHit(std::forward<HitT>(value));
    return *this;
  }
  template <typename HitT = Hit>
  Hits& AddHit(HitT&& value) {
    m_hitHasBeenSet = true;
    m_hit.emplace_back(std::forward<HitT>(value));
    return *this;
  }
  ///@}
 private:
