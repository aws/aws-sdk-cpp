...
class SearchRequest : public CloudSearchDomainRequest {
 public:
  ...
  void SetCursor(CursorT&& value) {
    ...
    m_cursor = std::forward<CursorT>(value);
  }
  template <typename CursorT = Aws::String>
  SearchRequest& WithCursor(CursorT&& value) {
    SetCursor(std::forward<CursorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExpr(ExprT&& value) {
    ...
    m_expr = std::forward<ExprT>(value);
  }
  template <typename ExprT = Aws::String>
  SearchRequest& WithExpr(ExprT&& value) {
    SetExpr(std::forward<ExprT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFilterQuery(FilterQueryT&& value) {
    ...
    m_filterQuery = std::forward<FilterQueryT>(value);
  }
  template <typename FilterQueryT = Aws::String>
  SearchRequest& WithFilterQuery(FilterQueryT&& value) {
    SetFilterQuery(std::forward<FilterQueryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHighlight(HighlightT&& value) {
    ...
    m_highlight = std::forward<HighlightT>(value);
  }
  template <typename HighlightT = Aws::String>
  SearchRequest& WithHighlight(HighlightT&& value) {
    SetHighlight(std::forward<HighlightT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPartial(bool value) {
    m_partialHasBeenSet = true;
    m_partial = value;
  }
  inline SearchRequest& WithPartial(bool value) {
    SetPartial(value);
    return *this;
  }
  ///@}
  ...
  void SetQueryOptions(QueryOptionsT&& value) {
    m_queryOptionsHasBeenSet = true;
    m_queryOptions = std::forward<QueryOptionsT>(value);
  }
  template <typename QueryOptionsT = Aws::String>
  SearchRequest& WithQueryOptions(QueryOptionsT&& value) {
    SetQueryOptions(std::forward<QueryOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetQueryParser(QueryParser value) {
    m_queryParserHasBeenSet = true;
    m_queryParser = value;
  }
  inline SearchRequest& WithQueryParser(QueryParser value) {
    SetQueryParser(value);
    return *this;
  }
  ///@}
  ...
  inline SearchRequest& WithSize(long long value) {
    SetSize(value);
    return *this;
  }
  ///@}
  ...
  inline SearchRequest& WithStart(long long value) {
    SetStart(value);
    return *this;
  }
  ///@}
