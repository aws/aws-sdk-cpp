...
class PutActionInteractionsRequest : public PersonalizeEventsRequest {
 public:
  ...
  void SetActionInteractions(ActionInteractionsT&& value) {
    m_actionInteractionsHasBeenSet = true;
    m_actionInteractions = std::forward<ActionInteractionsT>(value);
  }
  template <typename ActionInteractionsT = Aws::Vector<ActionInteraction>>
  PutActionInteractionsRequest& WithActionInteractions(ActionInteractionsT&& value) {
    SetActionInteractions(std::forward<ActionInteractionsT>(value));
    return *this;
  }
  ...
  PutActionInteractionsRequest& AddActionInteractions(ActionInteractionsT&& value) {
    m_actionInteractionsHasBeenSet = true;
    m_actionInteractions.emplace_back(std::forward<ActionInteractionsT>(value));
    return *this;
  }
  ///@}
 private:
