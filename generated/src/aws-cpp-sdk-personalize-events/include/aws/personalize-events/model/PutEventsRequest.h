...
class PutEventsRequest : public PersonalizeEventsRequest {
 public:
  ...
  void SetTrackingId(TrackingIdT&& value) {
    ...
    m_trackingId = std::forward<TrackingIdT>(value);
  }
  template <typename TrackingIdT = Aws::String>
  PutEventsRequest& WithTrackingId(TrackingIdT&& value) {
    SetTrackingId(std::forward<TrackingIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventList(EventListT&& value) {
    ...
    m_eventList = std::forward<EventListT>(value);
  }
  template <typename EventListT = Aws::Vector<Event>>
  PutEventsRequest& WithEventList(EventListT&& value) {
    SetEventList(std::forward<EventListT>(value));
    return *this;
  }
  template <typename EventListT = Event>
  PutEventsRequest& AddEventList(EventListT&& value) {
    m_eventListHasBeenSet = true;
    m_eventList.emplace_back(std::forward<EventListT>(value));
    return *this;
  }
  ///@}
 private:
