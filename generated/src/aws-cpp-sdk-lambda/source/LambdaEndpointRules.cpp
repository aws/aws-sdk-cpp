...
namespace Lambda
{
const size_t LambdaEndpointRules::RulesBlobStrLen = 3724;
const size_t LambdaEndpointRules::RulesBlobSize = 3725;
...
'l','"',':','"','h','t','t','p','s',':','/','/','l','a','m','b','d','a','.','{','R','e','g','i','o',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','l','a','m','b','d','a','.','{','R','e',
