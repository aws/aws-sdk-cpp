...
ListFunctionEventInvokeConfigsResult& ListFunctionEventInvokeConfigsResult::operator=(
  ...
  if (jsonValue.ValueExists("FunctionEventInvokeConfigs")) {
    ...
    for (unsigned functionEventInvokeConfigsIndex = 0; functionEventInvokeConfigsIndex < functionEventInvokeConfigsJsonList.GetLength();
         ++functionEventInvokeConfigsIndex) {
