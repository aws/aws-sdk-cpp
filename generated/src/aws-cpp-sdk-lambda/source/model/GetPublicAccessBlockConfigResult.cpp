...
GetPublicAccessBlockConfigResult::GetPublicAccessBlockConfigResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetPublicAccessBlockConfigResult& GetPublicAccessBlockConfigResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
