...
PutPublicAccessBlockConfigResult::PutPublicAccessBlockConfigResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

PutPublicAccessBlockConfigResult& PutPublicAccessBlockConfigResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
