...
ListProvisionedConcurrencyConfigsResult& ListProvisionedConcurrencyConfigsResult::operator=(
  ...
  if (jsonValue.ValueExists("ProvisionedConcurrencyConfigs")) {
    ...
    for (unsigned provisionedConcurrencyConfigsIndex = 0;
         provisionedConcurrencyConfigsIndex < provisionedConcurrencyConfigsJsonList.GetLength(); ++provisionedConcurrencyConfigsIndex) {
