...
class PutProvisionedConcurrencyConfigResult {
 public:
  ...
  inline PutProvisionedConcurrencyConfigResult& WithRequestedProvisionedConcurrentExecutions(int value) {
  ...
  inline PutProvisionedConcurrencyConfigResult& WithStatus(ProvisionedConcurrencyStatusEnum value) {
    SetStatus(value);
    return *this;
  }
  ///@}
