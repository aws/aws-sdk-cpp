...
class PutFunctionEventInvokeConfigResult {
 public:
  ...
  template <typename LastModifiedT = Aws::Utils::DateTime>
  PutFunctionEventInvokeConfigResult& WithLastModified(LastModifiedT&& value) {
  ...
  template <typename FunctionArnT = Aws::String>
  PutFunctionEventInvokeConfigResult& WithFunctionArn(FunctionArnT&& value) {
  ...
  inline PutFunctionEventInvokeConfigResult& WithMaximumRetryAttempts(int value) {
  ...
  inline PutFunctionEventInvokeConfigResult& WithMaximumEventAgeInSeconds(int value) {
  ...
  template <typename DestinationConfigT = DestinationConfig>
  PutFunctionEventInvokeConfigResult& WithDestinationConfig(DestinationConfigT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutFunctionEventInvokeConfigResult& WithRequestId(RequestIdT&& value) {
