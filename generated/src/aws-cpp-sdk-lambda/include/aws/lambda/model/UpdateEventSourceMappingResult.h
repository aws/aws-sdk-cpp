...
namespace Model
{
  ...
  public:
    ...
    template<typename UUIDT = Aws::String>
    UpdateEventSourceMappingResult& WithUUID(UUIDT&& value) { SetUUID(std::forward<UUIDT>(value)); return *this;}
    ///@}
    ...
    inline UpdateEventSourceMappingResult& WithStartingPosition(EventSourcePosition value) { SetStartingPosition(value); return *this;}
    ///@}
    ...
    template<typename StartingPositionTimestampT = Aws::Utils::DateTime>
    UpdateEventSourceMappingResult& WithStartingPositionTimestamp(StartingPositionTimestampT&& value) { SetStartingPositionTimestamp(std::forward<StartingPositionTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename EventSourceArnT = Aws::String>
    UpdateEventSourceMappingResult& WithEventSourceArn(EventSourceArnT&& value) { SetEventSourceArn(std::forward<EventSourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename FilterCriteriaT = FilterCriteria>
    UpdateEventSourceMappingResult& WithFilterCriteria(FilterCriteriaT&& value) { SetFilterCriteria(std::forward<FilterCriteriaT>(value)); return *this;}
    ///@}
    ...
    template<typename FunctionArnT = Aws::String>
    UpdateEventSourceMappingResult& WithFunctionArn(FunctionArnT&& value) { SetFunctionArn(std::forward<FunctionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedT = Aws::Utils::DateTime>
    UpdateEventSourceMappingResult& WithLastModified(LastModifiedT&& value) { SetLastModified(std::forward<LastModifiedT>(value)); return *this;}
    ///@}
    ...
    template<typename LastProcessingResultT = Aws::String>
    UpdateEventSourceMappingResult& WithLastProcessingResult(LastProcessingResultT&& value) { SetLastProcessingResult(std::forward<LastProcessingResultT>(value)); return *this;}
    ///@}
    ...
    template<typename StateT = Aws::String>
    UpdateEventSourceMappingResult& WithState(StateT&& value) { SetState(std::forward<StateT>(value)); return *this;}
    ///@}
    ...
    template<typename StateTransitionReasonT = Aws::String>
    UpdateEventSourceMappingResult& WithStateTransitionReason(StateTransitionReasonT&& value) { SetStateTransitionReason(std::forward<StateTransitionReasonT>(value)); return *this;}
    ///@}
    ...
    template<typename DestinationConfigT = DestinationConfig>
    UpdateEventSourceMappingResult& WithDestinationConfig(DestinationConfigT&& value) { SetDestinationConfig(std::forward<DestinationConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename TopicsT = Aws::Vector<Aws::String>>
    UpdateEventSourceMappingResult& WithTopics(TopicsT&& value) { SetTopics(std::forward<TopicsT>(value)); return *this;}
    template<typename TopicsT = Aws::String>
    UpdateEventSourceMappingResult& AddTopics(TopicsT&& value) { m_topicsHasBeenSet = true; m_topics.emplace_back(std::forward<TopicsT>(value)); return *this; }
    ///@}
    ...
    template<typename QueuesT = Aws::Vector<Aws::String>>
    UpdateEventSourceMappingResult& WithQueues(QueuesT&& value) { SetQueues(std::forward<QueuesT>(value)); return *this;}
    template<typename QueuesT = Aws::String>
    UpdateEventSourceMappingResult& AddQueues(QueuesT&& value) { m_queuesHasBeenSet = true; m_queues.emplace_back(std::forward<QueuesT>(value)); return *this; }
    ///@}
    ...
    template<typename SourceAccessConfigurationsT = Aws::Vector<SourceAccessConfiguration>>
    UpdateEventSourceMappingResult& WithSourceAccessConfigurations(SourceAccessConfigurationsT&& value) { SetSourceAccessConfigurations(std::forward<SourceAccessConfigurationsT>(value)); return *this;}
    template<typename SourceAccessConfigurationsT = SourceAccessConfiguration>
    UpdateEventSourceMappingResult& AddSourceAccessConfigurations(SourceAccessConfigurationsT&& value) { m_sourceAccessConfigurationsHasBeenSet = true; m_sourceAccessConfigurations.emplace_back(std::forward<SourceAccessConfigurationsT>(value)); return *this; }
    ///@}
    ...
    template<typename SelfManagedEventSourceT = SelfManagedEventSource>
    UpdateEventSourceMappingResult& WithSelfManagedEventSource(SelfManagedEventSourceT&& value) { SetSelfManagedEventSource(std::forward<SelfManagedEventSourceT>(value)); return *this;}
    ///@}
    ...
    template<typename FunctionResponseTypesT = Aws::Vector<FunctionResponseType>>
    UpdateEventSourceMappingResult& WithFunctionResponseTypes(FunctionResponseTypesT&& value) { SetFunctionResponseTypes(std::forward<FunctionResponseTypesT>(value)); return *this;}
    inline UpdateEventSourceMappingResult& AddFunctionResponseTypes(FunctionResponseType value) { m_functionResponseTypesHasBeenSet = true; m_functionResponseTypes.push_back(value); return *this; }
    ///@}
    ...
    template<typename AmazonManagedKafkaEventSourceConfigT = AmazonManagedKafkaEventSourceConfig>
    UpdateEventSourceMappingResult& WithAmazonManagedKafkaEventSourceConfig(AmazonManagedKafkaEventSourceConfigT&& value) { SetAmazonManagedKafkaEventSourceConfig(std::forward<AmazonManagedKafkaEventSourceConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename SelfManagedKafkaEventSourceConfigT = SelfManagedKafkaEventSourceConfig>
    UpdateEventSourceMappingResult& WithSelfManagedKafkaEventSourceConfig(SelfManagedKafkaEventSourceConfigT&& value) { SetSelfManagedKafkaEventSourceConfig(std::forward<SelfManagedKafkaEventSourceConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename ScalingConfigT = ScalingConfig>
    UpdateEventSourceMappingResult& WithScalingConfig(ScalingConfigT&& value) { SetScalingConfig(std::forward<ScalingConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename DocumentDBEventSourceConfigT = DocumentDBEventSourceConfig>
    UpdateEventSourceMappingResult& WithDocumentDBEventSourceConfig(DocumentDBEventSourceConfigT&& value) { SetDocumentDBEventSourceConfig(std::forward<DocumentDBEventSourceConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename KMSKeyArnT = Aws::String>
    UpdateEventSourceMappingResult& WithKMSKeyArn(KMSKeyArnT&& value) { SetKMSKeyArn(std::forward<KMSKeyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename FilterCriteriaErrorT = FilterCriteriaError>
    UpdateEventSourceMappingResult& WithFilterCriteriaError(FilterCriteriaErrorT&& value) { SetFilterCriteriaError(std::forward<FilterCriteriaErrorT>(value)); return *this;}
    ///@}
    ...
    template<typename EventSourceMappingArnT = Aws::String>
    UpdateEventSourceMappingResult& WithEventSourceMappingArn(EventSourceMappingArnT&& value) { SetEventSourceMappingArn(std::forward<EventSourceMappingArnT>(value)); return *this;}
    ///@}
    ...
    template<typename MetricsConfigT = EventSourceMappingMetricsConfig>
    UpdateEventSourceMappingResult& WithMetricsConfig(MetricsConfigT&& value) { SetMetricsConfig(std::forward<MetricsConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename ProvisionedPollerConfigT = ProvisionedPollerConfig>
    UpdateEventSourceMappingResult& WithProvisionedPollerConfig(ProvisionedPollerConfigT&& value) { SetProvisionedPollerConfig(std::forward<ProvisionedPollerConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateEventSourceMappingResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
