...
class UpdateEventSourceMappingResult {
 public:
  ...
  inline UpdateEventSourceMappingResult& WithStartingPosition(EventSourcePosition value) {
  ...
  inline UpdateEventSourceMappingResult& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateEventSourceMappingResult& WithMaximumBatchingWindowInSeconds(int value) {
  ...
  inline UpdateEventSourceMappingResult& WithParallelizationFactor(int value) {
  ...
  inline UpdateEventSourceMappingResult& WithMaximumRecordAgeInSeconds(int value) {
  ...
  inline UpdateEventSourceMappingResult& WithBisectBatchOnFunctionError(bool value) {
  ...
  inline UpdateEventSourceMappingResult& WithMaximumRetryAttempts(int value) {
  ...
  inline UpdateEventSourceMappingResult& WithTumblingWindowInSeconds(int value) {
  ...
  inline UpdateEventSourceMappingResult& AddFunctionResponseTypes(FunctionResponseType value) {
    m_functionResponseTypesHasBeenSet = true;
