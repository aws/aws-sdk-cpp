...
namespace Model
{
  ...
  /**
   * <p>Lambda prevented your policy from being created because it would grant public
   * access to your function. If you intended to create a public policy, use the
   * <a>PutPublicAccessBlockConfig</a> API action to configure your function's
   * public-access settings to allow public policies.</p><p><h3>See Also:</h3>   <a
