...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API DeleteFunctionCodeSigningConfigRequest() = default;
    ...
    template<typename FunctionNameT = Aws::String>
    DeleteFunctionCodeSigningConfigRequest& WithFunctionName(FunctionNameT&& value) { SetFunctionName(std::forward<FunctionNameT>(value)); return *this;}
    ///@}
  private:
