...
namespace Model
{
  ...
  public:
    ...
    template<typename TypeT = Aws::String>
    CodeStorageExceededException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    CodeStorageExceededException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
