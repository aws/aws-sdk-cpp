...
class CreateCapacityProviderResult {
 public:
  AWS_LAMBDA_API CreateCapacityProviderResult() = default;
  AWS_LAMBDA_API CreateCapacityProviderResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_LAMBDA_API CreateCapacityProviderResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename CapacityProviderT = CapacityProvider>
  CreateCapacityProviderResult& WithCapacityProvider(CapacityProviderT&& value) {
