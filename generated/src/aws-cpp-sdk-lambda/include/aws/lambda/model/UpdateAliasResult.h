...
class UpdateAliasResult {
 public:
  ...
  template <typename AliasArnT = Aws::String>
  UpdateAliasResult& WithAliasArn(AliasArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateAliasResult& WithName(NameT&& value) {
  ...
  template <typename FunctionVersionT = Aws::String>
  UpdateAliasResult& WithFunctionVersion(FunctionVersionT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateAliasResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename RoutingConfigT = AliasRoutingConfiguration>
  UpdateAliasResult& WithRoutingConfig(RoutingConfigT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  UpdateAliasResult& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAliasResult& WithRequestId(RequestIdT&& value) {
