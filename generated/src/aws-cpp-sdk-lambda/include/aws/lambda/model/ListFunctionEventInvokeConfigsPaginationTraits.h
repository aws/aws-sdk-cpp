...
struct ListFunctionEventInvokeConfigsPaginationTraits {
  using RequestType = Model::ListFunctionEventInvokeConfigsRequest;
  using ResultType = Model::ListFunctionEventInvokeConfigsResult;
  using OutcomeType = Model::ListFunctionEventInvokeConfigsOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListFunctionEventInvokeConfigs(request); }
