...
class ListFunctionsRequest : public LambdaRequest {
 public:
  ...
  void SetMasterRegion(MasterRegionT&& value) {
    ...
    m_masterRegion = std::forward<MasterRegionT>(value);
  }
  template <typename MasterRegionT = Aws::String>
  ListFunctionsRequest& WithMasterRegion(MasterRegionT&& value) {
    SetMasterRegion(std::forward<MasterRegionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFunctionVersion(FunctionVersion value) {
    m_functionVersionHasBeenSet = true;
    m_functionVersion = value;
  }
  inline ListFunctionsRequest& WithFunctionVersion(FunctionVersion value) {
    SetFunctionVersion(value);
    return *this;
  }
  ///@}
  ...
  inline ListFunctionsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
