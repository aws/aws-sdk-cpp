...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API GetPolicyRequest() = default;
    ...
    template<typename FunctionNameT = Aws::String>
    GetPolicyRequest& WithFunctionName(FunctionNameT&& value) { SetFunctionName(std::forward<FunctionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename QualifierT = Aws::String>
    GetPolicyRequest& WithQualifier(QualifierT&& value) { SetQualifier(std::forward<QualifierT>(value)); return *this;}
    ///@}
  private:
