...
class ListFunctionUrlConfigsResult {
 public:
  ...
  void SetFunctionUrlConfigs(FunctionUrlConfigsT&& value) {
    m_functionUrlConfigsHasBeenSet = true;
    m_functionUrlConfigs = std::forward<FunctionUrlConfigsT>(value);
  }
  template <typename FunctionUrlConfigsT = Aws::Vector<FunctionUrlConfig>>
  ListFunctionUrlConfigsResult& WithFunctionUrlConfigs(FunctionUrlConfigsT&& value) {
    SetFunctionUrlConfigs(std::forward<FunctionUrlConfigsT>(value));
    return *this;
  }
  template <typename FunctionUrlConfigsT = FunctionUrlConfig>
  ListFunctionUrlConfigsResult& AddFunctionUrlConfigs(FunctionUrlConfigsT&& value) {
    m_functionUrlConfigsHasBeenSet = true;
    m_functionUrlConfigs.emplace_back(std::forward<FunctionUrlConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextMarkerT = Aws::String>
  ListFunctionUrlConfigsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFunctionUrlConfigsResult& WithRequestId(RequestIdT&& value) {
