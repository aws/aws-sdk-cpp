...
class ListVersionsByFunctionRequest : public LambdaRequest {
 public:
  ...
  template <typename FunctionNameT = Aws::String>
  ListVersionsByFunctionRequest& WithFunctionName(FunctionNameT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListVersionsByFunctionRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListVersionsByFunctionRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
