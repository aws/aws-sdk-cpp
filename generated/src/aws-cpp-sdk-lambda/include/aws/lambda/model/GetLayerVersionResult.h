...
namespace Model
{
  ...
  public:
    ...
    template<typename ContentT = LayerVersionContentOutput>
    GetLayerVersionResult& WithContent(ContentT&& value) { SetContent(std::forward<ContentT>(value)); return *this;}
    ///@}
    ...
    template<typename LayerArnT = Aws::String>
    GetLayerVersionResult& WithLayerArn(LayerArnT&& value) { SetLayerArn(std::forward<LayerArnT>(value)); return *this;}
    ///@}
    ...
    template<typename LayerVersionArnT = Aws::String>
    GetLayerVersionResult& WithLayerVersionArn(LayerVersionArnT&& value) { SetLayerVersionArn(std::forward<LayerVersionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    GetLayerVersionResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedDateT = Aws::String>
    GetLayerVersionResult& WithCreatedDate(CreatedDateT&& value) { SetCreatedDate(std::forward<CreatedDateT>(value)); return *this;}
    ///@}
    ...
    template<typename CompatibleRuntimesT = Aws::Vector<Runtime>>
    GetLayerVersionResult& WithCompatibleRuntimes(CompatibleRuntimesT&& value) { SetCompatibleRuntimes(std::forward<CompatibleRuntimesT>(value)); return *this;}
    inline GetLayerVersionResult& AddCompatibleRuntimes(Runtime value) { m_compatibleRuntimesHasBeenSet = true; m_compatibleRuntimes.push_back(value); return *this; }
    ///@}
    ...
    template<typename LicenseInfoT = Aws::String>
    GetLayerVersionResult& WithLicenseInfo(LicenseInfoT&& value) { SetLicenseInfo(std::forward<LicenseInfoT>(value)); return *this;}
    ///@}
    ...
    template<typename CompatibleArchitecturesT = Aws::Vector<Architecture>>
    GetLayerVersionResult& WithCompatibleArchitectures(CompatibleArchitecturesT&& value) { SetCompatibleArchitectures(std::forward<CompatibleArchitecturesT>(value)); return *this;}
    inline GetLayerVersionResult& AddCompatibleArchitectures(Architecture value) { m_compatibleArchitecturesHasBeenSet = true; m_compatibleArchitectures.push_back(value); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetLayerVersionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
