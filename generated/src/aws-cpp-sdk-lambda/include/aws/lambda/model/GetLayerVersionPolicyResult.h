...
class GetLayerVersionPolicyResult {
 public:
  ...
  template <typename PolicyT = Aws::String>
  GetLayerVersionPolicyResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  GetLayerVersionPolicyResult& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetLayerVersionPolicyResult& WithRequestId(RequestIdT&& value) {
