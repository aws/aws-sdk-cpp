...
class CreateFunctionResult {
 public:
  ...
  inline CreateFunctionResult& WithRuntime(Runtime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFunctionResult& WithCodeSize(long long value) {
    SetCodeSize(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFunctionResult& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFunctionResult& WithMemorySize(int value) {
    SetMemorySize(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFunctionResult& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFunctionResult& WithStateReasonCode(StateReasonCode value) {
  ...
  inline CreateFunctionResult& WithLastUpdateStatus(LastUpdateStatus value) {
  ...
  inline CreateFunctionResult& WithLastUpdateStatusReasonCode(LastUpdateStatusReasonCode value) {
  ...
  inline CreateFunctionResult& WithPackageType(PackageType value) {
  ...
  inline CreateFunctionResult& AddArchitectures(Architecture value) {
    m_architecturesHasBeenSet = true;
