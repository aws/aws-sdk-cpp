...
namespace Model
{
  ...
  public:
    ...
    template<typename FunctionNameT = Aws::String>
    CreateFunctionResult& WithFunctionName(FunctionNameT&& value) { SetFunctionName(std::forward<FunctionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename FunctionArnT = Aws::String>
    CreateFunctionResult& WithFunctionArn(FunctionArnT&& value) { SetFunctionArn(std::forward<FunctionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleT = Aws::String>
    CreateFunctionResult& WithRole(RoleT&& value) { SetRole(std::forward<RoleT>(value)); return *this;}
    ///@}
    ...
    template<typename HandlerT = Aws::String>
    CreateFunctionResult& WithHandler(HandlerT&& value) { SetHandler(std::forward<HandlerT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    CreateFunctionResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedT = Aws::String>
    CreateFunctionResult& WithLastModified(LastModifiedT&& value) { SetLastModified(std::forward<LastModifiedT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeSha256T = Aws::String>
    CreateFunctionResult& WithCodeSha256(CodeSha256T&& value) { SetCodeSha256(std::forward<CodeSha256T>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    CreateFunctionResult& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcConfigT = VpcConfigResponse>
    CreateFunctionResult& WithVpcConfig(VpcConfigT&& value) { SetVpcConfig(std::forward<VpcConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename DeadLetterConfigT = DeadLetterConfig>
    CreateFunctionResult& WithDeadLetterConfig(DeadLetterConfigT&& value) { SetDeadLetterConfig(std::forward<DeadLetterConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentT = EnvironmentResponse>
    CreateFunctionResult& WithEnvironment(EnvironmentT&& value) { SetEnvironment(std::forward<EnvironmentT>(value)); return *this;}
    ///@}
    ...
    template<typename KMSKeyArnT = Aws::String>
    CreateFunctionResult& WithKMSKeyArn(KMSKeyArnT&& value) { SetKMSKeyArn(std::forward<KMSKeyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename TracingConfigT = TracingConfigResponse>
    CreateFunctionResult& WithTracingConfig(TracingConfigT&& value) { SetTracingConfig(std::forward<TracingConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename MasterArnT = Aws::String>
    CreateFunctionResult& WithMasterArn(MasterArnT&& value) { SetMasterArn(std::forward<MasterArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RevisionIdT = Aws::String>
    CreateFunctionResult& WithRevisionId(RevisionIdT&& value) { SetRevisionId(std::forward<RevisionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LayersT = Aws::Vector<Layer>>
    CreateFunctionResult& WithLayers(LayersT&& value) { SetLayers(std::forward<LayersT>(value)); return *this;}
    template<typename LayersT = Layer>
    CreateFunctionResult& AddLayers(LayersT&& value) { m_layersHasBeenSet = true; m_layers.emplace_back(std::forward<LayersT>(value)); return *this; }
    ///@}
    ...
    inline CreateFunctionResult& WithState(State value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename StateReasonT = Aws::String>
    CreateFunctionResult& WithStateReason(StateReasonT&& value) { SetStateReason(std::forward<StateReasonT>(value)); return *this;}
    ///@}
    ...
    inline CreateFunctionResult& WithStateReasonCode(StateReasonCode value) { SetStateReasonCode(value); return *this;}
    ///@}
    ...
    inline CreateFunctionResult& WithLastUpdateStatus(LastUpdateStatus value) { SetLastUpdateStatus(value); return *this;}
    ///@}
    ...
    template<typename LastUpdateStatusReasonT = Aws::String>
    CreateFunctionResult& WithLastUpdateStatusReason(LastUpdateStatusReasonT&& value) { SetLastUpdateStatusReason(std::forward<LastUpdateStatusReasonT>(value)); return *this;}
    ///@}
    ...
    inline CreateFunctionResult& WithLastUpdateStatusReasonCode(LastUpdateStatusReasonCode value) { SetLastUpdateStatusReasonCode(value); return *this;}
    ///@}
    ...
    template<typename FileSystemConfigsT = Aws::Vector<FileSystemConfig>>
    CreateFunctionResult& WithFileSystemConfigs(FileSystemConfigsT&& value) { SetFileSystemConfigs(std::forward<FileSystemConfigsT>(value)); return *this;}
    template<typename FileSystemConfigsT = FileSystemConfig>
    CreateFunctionResult& AddFileSystemConfigs(FileSystemConfigsT&& value) { m_fileSystemConfigsHasBeenSet = true; m_fileSystemConfigs.emplace_back(std::forward<FileSystemConfigsT>(value)); return *this; }
    ///@}
    ...
    inline CreateFunctionResult& WithPackageType(PackageType value) { SetPackageType(value); return *this;}
    ///@}
    ...
    template<typename ImageConfigResponseT = ImageConfigResponse>
    CreateFunctionResult& WithImageConfigResponse(ImageConfigResponseT&& value) { SetImageConfigResponse(std::forward<ImageConfigResponseT>(value)); return *this;}
    ///@}
    ...
    template<typename SigningProfileVersionArnT = Aws::String>
    CreateFunctionResult& WithSigningProfileVersionArn(SigningProfileVersionArnT&& value) { SetSigningProfileVersionArn(std::forward<SigningProfileVersionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SigningJobArnT = Aws::String>
    CreateFunctionResult& WithSigningJobArn(SigningJobArnT&& value) { SetSigningJobArn(std::forward<SigningJobArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ArchitecturesT = Aws::Vector<Architecture>>
    CreateFunctionResult& WithArchitectures(ArchitecturesT&& value) { SetArchitectures(std::forward<ArchitecturesT>(value)); return *this;}
    inline CreateFunctionResult& AddArchitectures(Architecture value) { m_architecturesHasBeenSet = true; m_architectures.push_back(value); return *this; }
    ///@}
    ...
    template<typename EphemeralStorageT = EphemeralStorage>
    CreateFunctionResult& WithEphemeralStorage(EphemeralStorageT&& value) { SetEphemeralStorage(std::forward<EphemeralStorageT>(value)); return *this;}
    ///@}
    ...
    template<typename SnapStartT = SnapStartResponse>
    CreateFunctionResult& WithSnapStart(SnapStartT&& value) { SetSnapStart(std::forward<SnapStartT>(value)); return *this;}
    ///@}
    ...
    template<typename RuntimeVersionConfigT = RuntimeVersionConfig>
    CreateFunctionResult& WithRuntimeVersionConfig(RuntimeVersionConfigT&& value) { SetRuntimeVersionConfig(std::forward<RuntimeVersionConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename LoggingConfigT = LoggingConfig>
    CreateFunctionResult& WithLoggingConfig(LoggingConfigT&& value) { SetLoggingConfig(std::forward<LoggingConfigT>(value)); return *this;}
    ///@}
