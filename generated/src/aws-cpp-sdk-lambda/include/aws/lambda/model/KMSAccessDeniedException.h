...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API KMSAccessDeniedException() = default;
    ...
    template<typename TypeT = Aws::String>
    KMSAccessDeniedException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    KMSAccessDeniedException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
