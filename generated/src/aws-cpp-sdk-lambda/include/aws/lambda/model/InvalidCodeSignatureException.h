...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API InvalidCodeSignatureException() = default;
    ...
    template<typename TypeT = Aws::String>
    InvalidCodeSignatureException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    InvalidCodeSignatureException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
