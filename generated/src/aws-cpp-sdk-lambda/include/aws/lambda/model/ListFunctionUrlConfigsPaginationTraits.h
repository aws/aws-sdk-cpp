...
struct ListFunctionUrlConfigsPaginationTraits {
  using RequestType = Model::ListFunctionUrlConfigsRequest;
  using ResultType = Model::ListFunctionUrlConfigsResult;
  using OutcomeType = Model::ListFunctionUrlConfigsOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListFunctionUrlConfigs(request); }
