...
namespace Model
{
  ...
  public:
    ...
    template<typename TypeT = Aws::String>
    EFSMountFailureException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    EFSMountFailureException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
