...
class UpdateFunctionCodeResult {
 public:
  ...
  inline UpdateFunctionCodeResult& WithRuntime(Runtime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFunctionCodeResult& WithCodeSize(long long value) {
    SetCodeSize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFunctionCodeResult& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFunctionCodeResult& WithMemorySize(int value) {
    SetMemorySize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFunctionCodeResult& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFunctionCodeResult& WithStateReasonCode(StateReasonCode value) {
  ...
  inline UpdateFunctionCodeResult& WithLastUpdateStatus(LastUpdateStatus value) {
  ...
  inline UpdateFunctionCodeResult& WithLastUpdateStatusReasonCode(LastUpdateStatusReasonCode value) {
  ...
  inline UpdateFunctionCodeResult& WithPackageType(PackageType value) {
  ...
  inline UpdateFunctionCodeResult& AddArchitectures(Architecture value) {
    m_architecturesHasBeenSet = true;
