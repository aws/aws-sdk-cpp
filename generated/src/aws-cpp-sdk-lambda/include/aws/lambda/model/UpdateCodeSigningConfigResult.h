...
class UpdateCodeSigningConfigResult {
 public:
  AWS_LAMBDA_API UpdateCodeSigningConfigResult() = default;
  ...
  template <typename CodeSigningConfigT = CodeSigningConfig>
  UpdateCodeSigningConfigResult& WithCodeSigningConfig(CodeSigningConfigT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateCodeSigningConfigResult& WithRequestId(RequestIdT&& value) {
