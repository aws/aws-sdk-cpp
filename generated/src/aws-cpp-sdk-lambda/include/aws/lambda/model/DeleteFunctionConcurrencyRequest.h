...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API DeleteFunctionConcurrencyRequest() = default;
    ...
    template<typename FunctionNameT = Aws::String>
    DeleteFunctionConcurrencyRequest& WithFunctionName(FunctionNameT&& value) { SetFunctionName(std::forward<FunctionNameT>(value)); return *this;}
    ///@}
  private:
