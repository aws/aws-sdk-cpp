...
class GetFunctionCodeSigningConfigResult {
 public:
  ...
  template <typename CodeSigningConfigArnT = Aws::String>
  GetFunctionCodeSigningConfigResult& WithCodeSigningConfigArn(CodeSigningConfigArnT&& value) {
  ...
  template <typename FunctionNameT = Aws::String>
  GetFunctionCodeSigningConfigResult& WithFunctionName(FunctionNameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFunctionCodeSigningConfigResult& WithRequestId(RequestIdT&& value) {
