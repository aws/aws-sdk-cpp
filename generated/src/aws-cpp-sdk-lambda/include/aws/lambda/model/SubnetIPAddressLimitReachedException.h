...
class SubnetIPAddressLimitReachedException {
 public:
  AWS_LAMBDA_API SubnetIPAddressLimitReachedException() = default;
  ...
  template <typename TypeT = Aws::String>
  SubnetIPAddressLimitReachedException& WithType(TypeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  SubnetIPAddressLimitReachedException& WithMessage(MessageT&& value) {
