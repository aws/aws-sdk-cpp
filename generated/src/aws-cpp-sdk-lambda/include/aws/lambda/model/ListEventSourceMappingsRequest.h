...
class ListEventSourceMappingsRequest : public LambdaRequest {
 public:
  ...
  template <typename EventSourceArnT = Aws::String>
  ListEventSourceMappingsRequest& WithEventSourceArn(EventSourceArnT&& value) {
  ...
  template <typename FunctionNameT = Aws::String>
  ListEventSourceMappingsRequest& WithFunctionName(FunctionNameT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListEventSourceMappingsRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListEventSourceMappingsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
