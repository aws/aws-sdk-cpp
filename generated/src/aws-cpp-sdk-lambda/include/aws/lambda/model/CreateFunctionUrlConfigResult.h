...
class CreateFunctionUrlConfigResult {
 public:
  ...
  void SetFunctionUrl(FunctionUrlT&& value) {
    ...
    m_functionUrl = std::forward<FunctionUrlT>(value);
  }
  template <typename FunctionUrlT = Aws::String>
  CreateFunctionUrlConfigResult& WithFunctionUrl(FunctionUrlT&& value) {
    SetFunctionUrl(std::forward<FunctionUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAuthType(FunctionUrlAuthType value) {
    m_authTypeHasBeenSet = true;
    m_authType = value;
  }
  inline CreateFunctionUrlConfigResult& WithAuthType(FunctionUrlAuthType value) {
    SetAuthType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInvokeMode(InvokeMode value) {
    m_invokeModeHasBeenSet = true;
    m_invokeMode = value;
  }
  inline CreateFunctionUrlConfigResult& WithInvokeMode(InvokeMode value) {
    SetInvokeMode(value);
    return *this;
  }
  ///@}
