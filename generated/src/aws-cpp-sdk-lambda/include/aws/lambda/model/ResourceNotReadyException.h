...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API ResourceNotReadyException() = default;
    ...
    template<typename TypeT = Aws::String>
    ResourceNotReadyException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    ResourceNotReadyException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
