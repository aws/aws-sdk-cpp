...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API DeleteCodeSigningConfigResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteCodeSigningConfigResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
