...
class InvokeRequest : public StreamingLambdaRequest {
 public:
  ...
  template <typename FunctionNameT = Aws::String>
  InvokeRequest& WithFunctionName(FunctionNameT&& value) {
  ...
  inline InvokeRequest& WithInvocationType(InvocationType value) {
  ...
  inline InvokeRequest& WithLogType(LogType value) {
    SetLogType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientContextT = Aws::String>
  InvokeRequest& WithClientContext(ClientContextT&& value) {
  ...
  ///@{
  /**
   * <p>A unique name for the durable execution. If you invoke a durable function
   ...
   * Lambda returns a <code>DurableExecutionAlreadyStartedException</code> error.</p>
   * <p>If not specified, Lambda generates a unique identifier automatically. For
   * more information, see <a
   * href="https://docs.aws.amazon.com/lambda/latest/dg/durable-execution-idempotency.html#durable-idempotency-execution-names">Execution
   * names</a>.</p>
   */
  ...
  template <typename QualifierT = Aws::String>
  InvokeRequest& WithQualifier(QualifierT&& value) {
  ...
  template <typename TenantIdT = Aws::String>
  InvokeRequest& WithTenantId(TenantIdT&& value) {
