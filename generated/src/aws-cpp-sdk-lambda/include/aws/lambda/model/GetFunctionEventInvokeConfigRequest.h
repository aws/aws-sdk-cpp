...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API GetFunctionEventInvokeConfigRequest() = default;
    ...
    template<typename FunctionNameT = Aws::String>
    GetFunctionEventInvokeConfigRequest& WithFunctionName(FunctionNameT&& value) { SetFunctionName(std::forward<FunctionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename QualifierT = Aws::String>
    GetFunctionEventInvokeConfigRequest& WithQualifier(QualifierT&& value) { SetQualifier(std::forward<QualifierT>(value)); return *this;}
    ///@}
  private:
