...
class GetProvisionedConcurrencyConfigResult {
 public:
  ...
  inline GetProvisionedConcurrencyConfigResult& WithRequestedProvisionedConcurrentExecutions(int value) {
  ...
  inline GetProvisionedConcurrencyConfigResult& WithAvailableProvisionedConcurrentExecutions(int value) {
  ...
  inline GetProvisionedConcurrencyConfigResult& WithAllocatedProvisionedConcurrentExecutions(int value) {
  ...
  inline GetProvisionedConcurrencyConfigResult& WithStatus(ProvisionedConcurrencyStatusEnum value) {
    SetStatus(value);
    return *this;
  }
  ///@}
