...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API ENILimitReachedException() = default;
    ...
    template<typename TypeT = Aws::String>
    ENILimitReachedException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    ENILimitReachedException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
