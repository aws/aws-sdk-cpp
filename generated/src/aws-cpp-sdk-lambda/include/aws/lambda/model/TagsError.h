...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API TagsError() = default;
    ...
    template<typename ErrorCodeT = Aws::String>
    TagsError& WithErrorCode(ErrorCodeT&& value) { SetErrorCode(std::forward<ErrorCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    TagsError& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
