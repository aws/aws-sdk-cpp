...
class CreateEventSourceMappingResult {
 public:
  ...
  inline void SetStartingPosition(EventSourcePosition value) {
    m_startingPositionHasBeenSet = true;
    m_startingPosition = value;
  }
  inline CreateEventSourceMappingResult& WithStartingPosition(EventSourcePosition value) {
  ...
  void SetStartingPositionTimestamp(StartingPositionTimestampT&& value) {
    ...
    m_startingPositionTimestamp = std::forward<StartingPositionTimestampT>(value);
  }
  template <typename StartingPositionTimestampT = Aws::Utils::DateTime>
  CreateEventSourceMappingResult& WithStartingPositionTimestamp(StartingPositionTimestampT&& value) {
    SetStartingPositionTimestamp(std::forward<StartingPositionTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateEventSourceMappingResult& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline CreateEventSourceMappingResult& WithMaximumBatchingWindowInSeconds(int value) {
  ...
  inline CreateEventSourceMappingResult& WithParallelizationFactor(int value) {
  ...
  void SetLastProcessingResult(LastProcessingResultT&& value) {
    ...
    m_lastProcessingResult = std::forward<LastProcessingResultT>(value);
  }
  template <typename LastProcessingResultT = Aws::String>
  CreateEventSourceMappingResult& WithLastProcessingResult(LastProcessingResultT&& value) {
    SetLastProcessingResult(std::forward<LastProcessingResultT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceAccessConfigurations(SourceAccessConfigurationsT&& value) {
    ...
    m_sourceAccessConfigurations = std::forward<SourceAccessConfigurationsT>(value);
  }
  template <typename SourceAccessConfigurationsT = Aws::Vector<SourceAccessConfiguration>>
  CreateEventSourceMappingResult& WithSourceAccessConfigurations(SourceAccessConfigurationsT&& value) {
    SetSourceAccessConfigurations(std::forward<SourceAccessConfigurationsT>(value));
    return *this;
  }
  ...
  CreateEventSourceMappingResult& AddSourceAccessConfigurations(SourceAccessConfigurationsT&& value) {
    m_sourceAccessConfigurationsHasBeenSet = true;
    m_sourceAccessConfigurations.emplace_back(std::forward<SourceAccessConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelfManagedEventSource(SelfManagedEventSourceT&& value) {
    ...
    m_selfManagedEventSource = std::forward<SelfManagedEventSourceT>(value);
  }
  template <typename SelfManagedEventSourceT = SelfManagedEventSource>
  CreateEventSourceMappingResult& WithSelfManagedEventSource(SelfManagedEventSourceT&& value) {
    SetSelfManagedEventSource(std::forward<SelfManagedEventSourceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumRecordAgeInSeconds(int value) {
    m_maximumRecordAgeInSecondsHasBeenSet = true;
    m_maximumRecordAgeInSeconds = value;
  }
  inline CreateEventSourceMappingResult& WithMaximumRecordAgeInSeconds(int value) {
    SetMaximumRecordAgeInSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBisectBatchOnFunctionError(bool value) {
    m_bisectBatchOnFunctionErrorHasBeenSet = true;
    m_bisectBatchOnFunctionError = value;
  }
  inline CreateEventSourceMappingResult& WithBisectBatchOnFunctionError(bool value) {
    SetBisectBatchOnFunctionError(value);
    return *this;
  }
  ///@}
  ...
  inline CreateEventSourceMappingResult& WithMaximumRetryAttempts(int value) {
  ...
  inline CreateEventSourceMappingResult& WithTumblingWindowInSeconds(int value) {
  ...
  void SetFunctionResponseTypes(FunctionResponseTypesT&& value) {
    ...
    m_functionResponseTypes = std::forward<FunctionResponseTypesT>(value);
  }
  template <typename FunctionResponseTypesT = Aws::Vector<FunctionResponseType>>
  CreateEventSourceMappingResult& WithFunctionResponseTypes(FunctionResponseTypesT&& value) {
    SetFunctionResponseTypes(std::forward<FunctionResponseTypesT>(value));
    return *this;
  }
  inline CreateEventSourceMappingResult& AddFunctionResponseTypes(FunctionResponseType value) {
    m_functionResponseTypesHasBeenSet = true;
   ...
   */
  inline const AmazonManagedKafkaEventSourceConfig& GetAmazonManagedKafkaEventSourceConfig() const {
    return m_amazonManagedKafkaEventSourceConfig;
  }
  ...
  void SetAmazonManagedKafkaEventSourceConfig(AmazonManagedKafkaEventSourceConfigT&& value) {
    ...
    m_amazonManagedKafkaEventSourceConfig = std::forward<AmazonManagedKafkaEventSourceConfigT>(value);
  }
  template <typename AmazonManagedKafkaEventSourceConfigT = AmazonManagedKafkaEventSourceConfig>
  CreateEventSourceMappingResult& WithAmazonManagedKafkaEventSourceConfig(AmazonManagedKafkaEventSourceConfigT&& value) {
    SetAmazonManagedKafkaEventSourceConfig(std::forward<AmazonManagedKafkaEventSourceConfigT>(value));
    return *this;
  }
  ///@}
   ...
   * source.</p>
   */
  inline const SelfManagedKafkaEventSourceConfig& GetSelfManagedKafkaEventSourceConfig() const {
    return m_selfManagedKafkaEventSourceConfig;
  }
  ...
  void SetSelfManagedKafkaEventSourceConfig(SelfManagedKafkaEventSourceConfigT&& value) {
    ...
    m_selfManagedKafkaEventSourceConfig = std::forward<SelfManagedKafkaEventSourceConfigT>(value);
  }
  template <typename SelfManagedKafkaEventSourceConfigT = SelfManagedKafkaEventSourceConfig>
  CreateEventSourceMappingResult& WithSelfManagedKafkaEventSourceConfig(SelfManagedKafkaEventSourceConfigT&& value) {
    SetSelfManagedKafkaEventSourceConfig(std::forward<SelfManagedKafkaEventSourceConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDocumentDBEventSourceConfig(DocumentDBEventSourceConfigT&& value) {
    ...
    m_documentDBEventSourceConfig = std::forward<DocumentDBEventSourceConfigT>(value);
  }
  template <typename DocumentDBEventSourceConfigT = DocumentDBEventSourceConfig>
  CreateEventSourceMappingResult& WithDocumentDBEventSourceConfig(DocumentDBEventSourceConfigT&& value) {
    SetDocumentDBEventSourceConfig(std::forward<DocumentDBEventSourceConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFilterCriteriaError(FilterCriteriaErrorT&& value) {
    ...
    m_filterCriteriaError = std::forward<FilterCriteriaErrorT>(value);
  }
  template <typename FilterCriteriaErrorT = FilterCriteriaError>
  CreateEventSourceMappingResult& WithFilterCriteriaError(FilterCriteriaErrorT&& value) {
    SetFilterCriteriaError(std::forward<FilterCriteriaErrorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventSourceMappingArn(EventSourceMappingArnT&& value) {
    ...
    m_eventSourceMappingArn = std::forward<EventSourceMappingArnT>(value);
  }
  template <typename EventSourceMappingArnT = Aws::String>
  CreateEventSourceMappingResult& WithEventSourceMappingArn(EventSourceMappingArnT&& value) {
    SetEventSourceMappingArn(std::forward<EventSourceMappingArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LoggingConfigT = EventSourceMappingLoggingConfig>
  CreateEventSourceMappingResult& WithLoggingConfig(LoggingConfigT&& value) {
  ...
  void SetProvisionedPollerConfig(ProvisionedPollerConfigT&& value) {
    ...
    m_provisionedPollerConfig = std::forward<ProvisionedPollerConfigT>(value);
  }
  template <typename ProvisionedPollerConfigT = ProvisionedPollerConfig>
  CreateEventSourceMappingResult& WithProvisionedPollerConfig(ProvisionedPollerConfigT&& value) {
    SetProvisionedPollerConfig(std::forward<ProvisionedPollerConfigT>(value));
    return *this;
  }
  ///@}
