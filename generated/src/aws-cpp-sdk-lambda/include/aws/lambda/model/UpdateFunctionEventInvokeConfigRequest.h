...
class UpdateFunctionEventInvokeConfigRequest : public LambdaRequest {
 public:
  ...
  inline UpdateFunctionEventInvokeConfigRequest& WithMaximumRetryAttempts(int value) {
  ...
  inline UpdateFunctionEventInvokeConfigRequest& WithMaximumEventAgeInSeconds(int value) {
