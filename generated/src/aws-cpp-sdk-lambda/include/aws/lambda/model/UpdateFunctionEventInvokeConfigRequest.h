...
namespace Model
{
  ...
  public:
    ...
    template<typename FunctionNameT = Aws::String>
    UpdateFunctionEventInvokeConfigRequest& WithFunctionName(FunctionNameT&& value) { SetFunctionName(std::forward<FunctionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename QualifierT = Aws::String>
    UpdateFunctionEventInvokeConfigRequest& WithQualifier(QualifierT&& value) { SetQualifier(std::forward<QualifierT>(value)); return *this;}
    ///@}
    ...
    template<typename DestinationConfigT = DestinationConfig>
    UpdateFunctionEventInvokeConfigRequest& WithDestinationConfig(DestinationConfigT&& value) { SetDestinationConfig(std::forward<DestinationConfigT>(value)); return *this;}
    ///@}
  private:
