...
class AddPermissionRequest : public LambdaRequest {
 public:
  ...
  void SetEventSourceToken(EventSourceTokenT&& value) {
    m_eventSourceTokenHasBeenSet = true;
    m_eventSourceToken = std::forward<EventSourceTokenT>(value);
  }
  template <typename EventSourceTokenT = Aws::String>
  AddPermissionRequest& WithEventSourceToken(EventSourceTokenT&& value) {
    SetEventSourceToken(std::forward<EventSourceTokenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrincipalOrgID(PrincipalOrgIDT&& value) {
    m_principalOrgIDHasBeenSet = true;
    m_principalOrgID = std::forward<PrincipalOrgIDT>(value);
  }
  template <typename PrincipalOrgIDT = Aws::String>
  AddPermissionRequest& WithPrincipalOrgID(PrincipalOrgIDT&& value) {
    SetPrincipalOrgID(std::forward<PrincipalOrgIDT>(value));
    return *this;
  }
  ///@}
   ...
   * calls. When set to <code>true</code>, this prevents the principal from invoking
   * the function by any means other than the function URL. For more information, see
   * <a href="https://docs.aws.amazon.com/lambda/latest/dg/urls-auth.html">Control
   * access to Lambda function URLs</a>.</p>
   */
