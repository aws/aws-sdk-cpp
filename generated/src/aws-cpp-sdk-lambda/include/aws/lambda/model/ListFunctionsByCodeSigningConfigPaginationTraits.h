...
struct ListFunctionsByCodeSigningConfigPaginationTraits {
  using RequestType = Model::ListFunctionsByCodeSigningConfigRequest;
  using ResultType = Model::ListFunctionsByCodeSigningConfigResult;
  using OutcomeType = Model::ListFunctionsByCodeSigningConfigOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListFunctionsByCodeSigningConfig(request); }
