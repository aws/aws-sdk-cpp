...
class EventSourceMappingConfiguration {
 public:
  ...
  inline EventSourceMappingConfiguration& WithStartingPosition(EventSourcePosition value) {
  ...
  inline EventSourceMappingConfiguration& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline EventSourceMappingConfiguration& WithMaximumBatchingWindowInSeconds(int value) {
  ...
  inline EventSourceMappingConfiguration& WithParallelizationFactor(int value) {
  ...
  inline EventSourceMappingConfiguration& WithMaximumRecordAgeInSeconds(int value) {
  ...
  inline EventSourceMappingConfiguration& WithBisectBatchOnFunctionError(bool value) {
  ...
  inline EventSourceMappingConfiguration& WithMaximumRetryAttempts(int value) {
  ...
  inline EventSourceMappingConfiguration& WithTumblingWindowInSeconds(int value) {
  ...
  inline EventSourceMappingConfiguration& AddFunctionResponseTypes(FunctionResponseType value) {
    m_functionResponseTypesHasBeenSet = true;
