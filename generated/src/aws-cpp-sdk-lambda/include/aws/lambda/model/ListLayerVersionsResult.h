...
class ListLayerVersionsResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListLayerVersionsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetLayerVersions(LayerVersionsT&& value) {
    m_layerVersionsHasBeenSet = true;
    m_layerVersions = std::forward<LayerVersionsT>(value);
  }
  template <typename LayerVersionsT = Aws::Vector<LayerVersionsListItem>>
  ListLayerVersionsResult& WithLayerVersions(LayerVersionsT&& value) {
    SetLayerVersions(std::forward<LayerVersionsT>(value));
    return *this;
  }
  template <typename LayerVersionsT = LayerVersionsListItem>
  ListLayerVersionsResult& AddLayerVersions(LayerVersionsT&& value) {
    m_layerVersionsHasBeenSet = true;
    m_layerVersions.emplace_back(std::forward<LayerVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListLayerVersionsResult& WithRequestId(RequestIdT&& value) {
