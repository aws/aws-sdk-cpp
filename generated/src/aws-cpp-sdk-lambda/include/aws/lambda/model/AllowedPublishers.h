...
class AllowedPublishers {
 public:
  ...
  void SetSigningProfileVersionArns(SigningProfileVersionArnsT&& value) {
    m_signingProfileVersionArnsHasBeenSet = true;
    m_signingProfileVersionArns = std::forward<SigningProfileVersionArnsT>(value);
  }
  template <typename SigningProfileVersionArnsT = Aws::Vector<Aws::String>>
  AllowedPublishers& WithSigningProfileVersionArns(SigningProfileVersionArnsT&& value) {
    SetSigningProfileVersionArns(std::forward<SigningProfileVersionArnsT>(value));
    return *this;
  }
  template <typename SigningProfileVersionArnsT = Aws::String>
  AllowedPublishers& AddSigningProfileVersionArns(SigningProfileVersionArnsT&& value) {
    m_signingProfileVersionArnsHasBeenSet = true;
    m_signingProfileVersionArns.emplace_back(std::forward<SigningProfileVersionArnsT>(value));
    return *this;
  }
  ///@}
 private:
