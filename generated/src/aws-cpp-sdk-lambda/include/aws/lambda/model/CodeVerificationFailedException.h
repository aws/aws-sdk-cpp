...
class CodeVerificationFailedException {
 public:
  AWS_LAMBDA_API CodeVerificationFailedException() = default;
  ...
  template <typename TypeT = Aws::String>
  CodeVerificationFailedException& WithType(TypeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  CodeVerificationFailedException& WithMessage(MessageT&& value) {
