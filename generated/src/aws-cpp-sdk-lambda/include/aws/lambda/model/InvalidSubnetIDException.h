...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API InvalidSubnetIDException() = default;
    ...
    template<typename TypeT = Aws::String>
    InvalidSubnetIDException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    InvalidSubnetIDException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
