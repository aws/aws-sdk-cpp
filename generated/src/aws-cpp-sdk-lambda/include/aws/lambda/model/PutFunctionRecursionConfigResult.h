...
class PutFunctionRecursionConfigResult {
 public:
  ...
  inline void SetRecursiveLoop(RecursiveLoop value) {
    m_recursiveLoopHasBeenSet = true;
    m_recursiveLoop = value;
  }
  inline PutFunctionRecursionConfigResult& WithRecursiveLoop(RecursiveLoop value) {
    SetRecursiveLoop(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutFunctionRecursionConfigResult& WithRequestId(RequestIdT&& value) {
