...
class UpdateFunctionConfigurationRequest : public LambdaRequest {
 public:
  ...
  inline UpdateFunctionConfigurationRequest& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFunctionConfigurationRequest& WithMemorySize(int value) {
    SetMemorySize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFunctionConfigurationRequest& WithRuntime(Runtime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
