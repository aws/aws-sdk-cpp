...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API GetFunctionCodeSigningConfigRequest() = default;
    ...
    template<typename FunctionNameT = Aws::String>
    GetFunctionCodeSigningConfigRequest& WithFunctionName(FunctionNameT&& value) { SetFunctionName(std::forward<FunctionNameT>(value)); return *this;}
    ///@}
  private:
