...
class AliasConfiguration {
 public:
  ...
  template <typename AliasArnT = Aws::String>
  AliasConfiguration& WithAliasArn(AliasArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  AliasConfiguration& WithName(NameT&& value) {
  ...
  template <typename FunctionVersionT = Aws::String>
  AliasConfiguration& WithFunctionVersion(FunctionVersionT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AliasConfiguration& WithDescription(DescriptionT&& value) {
  ...
  template <typename RoutingConfigT = AliasRoutingConfiguration>
  AliasConfiguration& WithRoutingConfig(RoutingConfigT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  AliasConfiguration& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AliasConfiguration& WithRequestId(RequestIdT&& value) {
