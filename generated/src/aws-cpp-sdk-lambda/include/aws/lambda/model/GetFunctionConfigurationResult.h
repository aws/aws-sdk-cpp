...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API GetFunctionConfigurationResult() = default;
    ...
    template<typename FunctionNameT = Aws::String>
    GetFunctionConfigurationResult& WithFunctionName(FunctionNameT&& value) { SetFunctionName(std::forward<FunctionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename FunctionArnT = Aws::String>
    GetFunctionConfigurationResult& WithFunctionArn(FunctionArnT&& value) { SetFunctionArn(std::forward<FunctionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleT = Aws::String>
    GetFunctionConfigurationResult& WithRole(RoleT&& value) { SetRole(std::forward<RoleT>(value)); return *this;}
    ///@}
    ...
    template<typename HandlerT = Aws::String>
    GetFunctionConfigurationResult& WithHandler(HandlerT&& value) { SetHandler(std::forward<HandlerT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    GetFunctionConfigurationResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedT = Aws::String>
    GetFunctionConfigurationResult& WithLastModified(LastModifiedT&& value) { SetLastModified(std::forward<LastModifiedT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeSha256T = Aws::String>
    GetFunctionConfigurationResult& WithCodeSha256(CodeSha256T&& value) { SetCodeSha256(std::forward<CodeSha256T>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    GetFunctionConfigurationResult& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcConfigT = VpcConfigResponse>
    GetFunctionConfigurationResult& WithVpcConfig(VpcConfigT&& value) { SetVpcConfig(std::forward<VpcConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename DeadLetterConfigT = DeadLetterConfig>
    GetFunctionConfigurationResult& WithDeadLetterConfig(DeadLetterConfigT&& value) { SetDeadLetterConfig(std::forward<DeadLetterConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentT = EnvironmentResponse>
    GetFunctionConfigurationResult& WithEnvironment(EnvironmentT&& value) { SetEnvironment(std::forward<EnvironmentT>(value)); return *this;}
    ///@}
    ...
    template<typename KMSKeyArnT = Aws::String>
    GetFunctionConfigurationResult& WithKMSKeyArn(KMSKeyArnT&& value) { SetKMSKeyArn(std::forward<KMSKeyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename TracingConfigT = TracingConfigResponse>
    GetFunctionConfigurationResult& WithTracingConfig(TracingConfigT&& value) { SetTracingConfig(std::forward<TracingConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename MasterArnT = Aws::String>
    GetFunctionConfigurationResult& WithMasterArn(MasterArnT&& value) { SetMasterArn(std::forward<MasterArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RevisionIdT = Aws::String>
    GetFunctionConfigurationResult& WithRevisionId(RevisionIdT&& value) { SetRevisionId(std::forward<RevisionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LayersT = Aws::Vector<Layer>>
    GetFunctionConfigurationResult& WithLayers(LayersT&& value) { SetLayers(std::forward<LayersT>(value)); return *this;}
    template<typename LayersT = Layer>
    GetFunctionConfigurationResult& AddLayers(LayersT&& value) { m_layersHasBeenSet = true; m_layers.emplace_back(std::forward<LayersT>(value)); return *this; }
    ///@}
    ...
    inline GetFunctionConfigurationResult& WithState(State value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename StateReasonT = Aws::String>
    GetFunctionConfigurationResult& WithStateReason(StateReasonT&& value) { SetStateReason(std::forward<StateReasonT>(value)); return *this;}
    ///@}
    ...
    inline GetFunctionConfigurationResult& WithStateReasonCode(StateReasonCode value) { SetStateReasonCode(value); return *this;}
    ///@}
    ...
    inline GetFunctionConfigurationResult& WithLastUpdateStatus(LastUpdateStatus value) { SetLastUpdateStatus(value); return *this;}
    ///@}
    ...
    template<typename LastUpdateStatusReasonT = Aws::String>
    GetFunctionConfigurationResult& WithLastUpdateStatusReason(LastUpdateStatusReasonT&& value) { SetLastUpdateStatusReason(std::forward<LastUpdateStatusReasonT>(value)); return *this;}
    ///@}
    ...
    inline GetFunctionConfigurationResult& WithLastUpdateStatusReasonCode(LastUpdateStatusReasonCode value) { SetLastUpdateStatusReasonCode(value); return *this;}
    ///@}
    ...
    template<typename FileSystemConfigsT = Aws::Vector<FileSystemConfig>>
    GetFunctionConfigurationResult& WithFileSystemConfigs(FileSystemConfigsT&& value) { SetFileSystemConfigs(std::forward<FileSystemConfigsT>(value)); return *this;}
    template<typename FileSystemConfigsT = FileSystemConfig>
    GetFunctionConfigurationResult& AddFileSystemConfigs(FileSystemConfigsT&& value) { m_fileSystemConfigsHasBeenSet = true; m_fileSystemConfigs.emplace_back(std::forward<FileSystemConfigsT>(value)); return *this; }
    ///@}
    ...
    inline GetFunctionConfigurationResult& WithPackageType(PackageType value) { SetPackageType(value); return *this;}
    ///@}
    ...
    template<typename ImageConfigResponseT = ImageConfigResponse>
    GetFunctionConfigurationResult& WithImageConfigResponse(ImageConfigResponseT&& value) { SetImageConfigResponse(std::forward<ImageConfigResponseT>(value)); return *this;}
    ///@}
    ...
    template<typename SigningProfileVersionArnT = Aws::String>
    GetFunctionConfigurationResult& WithSigningProfileVersionArn(SigningProfileVersionArnT&& value) { SetSigningProfileVersionArn(std::forward<SigningProfileVersionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SigningJobArnT = Aws::String>
    GetFunctionConfigurationResult& WithSigningJobArn(SigningJobArnT&& value) { SetSigningJobArn(std::forward<SigningJobArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ArchitecturesT = Aws::Vector<Architecture>>
    GetFunctionConfigurationResult& WithArchitectures(ArchitecturesT&& value) { SetArchitectures(std::forward<ArchitecturesT>(value)); return *this;}
    inline GetFunctionConfigurationResult& AddArchitectures(Architecture value) { m_architecturesHasBeenSet = true; m_architectures.push_back(value); return *this; }
    ///@}
    ...
    template<typename EphemeralStorageT = EphemeralStorage>
    GetFunctionConfigurationResult& WithEphemeralStorage(EphemeralStorageT&& value) { SetEphemeralStorage(std::forward<EphemeralStorageT>(value)); return *this;}
    ///@}
    ...
    template<typename SnapStartT = SnapStartResponse>
    GetFunctionConfigurationResult& WithSnapStart(SnapStartT&& value) { SetSnapStart(std::forward<SnapStartT>(value)); return *this;}
    ///@}
    ...
    template<typename RuntimeVersionConfigT = RuntimeVersionConfig>
    GetFunctionConfigurationResult& WithRuntimeVersionConfig(RuntimeVersionConfigT&& value) { SetRuntimeVersionConfig(std::forward<RuntimeVersionConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename LoggingConfigT = LoggingConfig>
    GetFunctionConfigurationResult& WithLoggingConfig(LoggingConfigT&& value) { SetLoggingConfig(std::forward<LoggingConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetFunctionConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
