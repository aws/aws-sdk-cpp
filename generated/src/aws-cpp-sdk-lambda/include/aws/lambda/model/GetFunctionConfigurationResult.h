...
class GetFunctionConfigurationResult {
 public:
  ...
  template <typename FunctionNameT = Aws::String>
  GetFunctionConfigurationResult& WithFunctionName(FunctionNameT&& value) {
  ...
  template <typename FunctionArnT = Aws::String>
  GetFunctionConfigurationResult& WithFunctionArn(FunctionArnT&& value) {
  ...
  inline GetFunctionConfigurationResult& WithRuntime(Runtime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  template <typename RoleT = Aws::String>
  GetFunctionConfigurationResult& WithRole(RoleT&& value) {
  ...
  template <typename HandlerT = Aws::String>
  GetFunctionConfigurationResult& WithHandler(HandlerT&& value) {
  ...
  inline GetFunctionConfigurationResult& WithCodeSize(long long value) {
    SetCodeSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  GetFunctionConfigurationResult& WithDescription(DescriptionT&& value) {
  ...
  inline GetFunctionConfigurationResult& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline GetFunctionConfigurationResult& WithMemorySize(int value) {
    SetMemorySize(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastModifiedT = Aws::String>
  GetFunctionConfigurationResult& WithLastModified(LastModifiedT&& value) {
  ...
  template <typename CodeSha256T = Aws::String>
  GetFunctionConfigurationResult& WithCodeSha256(CodeSha256T&& value) {
  ...
  template <typename VersionT = Aws::String>
  GetFunctionConfigurationResult& WithVersion(VersionT&& value) {
  ...
  template <typename VpcConfigT = VpcConfigResponse>
  GetFunctionConfigurationResult& WithVpcConfig(VpcConfigT&& value) {
  ...
  template <typename DeadLetterConfigT = DeadLetterConfig>
  GetFunctionConfigurationResult& WithDeadLetterConfig(DeadLetterConfigT&& value) {
  ...
  template <typename EnvironmentT = EnvironmentResponse>
  GetFunctionConfigurationResult& WithEnvironment(EnvironmentT&& value) {
  ...
  template <typename KMSKeyArnT = Aws::String>
  GetFunctionConfigurationResult& WithKMSKeyArn(KMSKeyArnT&& value) {
  ...
  template <typename TracingConfigT = TracingConfigResponse>
  GetFunctionConfigurationResult& WithTracingConfig(TracingConfigT&& value) {
  ...
  template <typename MasterArnT = Aws::String>
  GetFunctionConfigurationResult& WithMasterArn(MasterArnT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  GetFunctionConfigurationResult& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename LayersT = Aws::Vector<Layer>>
  GetFunctionConfigurationResult& WithLayers(LayersT&& value) {
    SetLayers(std::forward<LayersT>(value));
    return *this;
  }
  template <typename LayersT = Layer>
  GetFunctionConfigurationResult& AddLayers(LayersT&& value) {
    m_layersHasBeenSet = true;
  ...
  inline GetFunctionConfigurationResult& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename StateReasonT = Aws::String>
  GetFunctionConfigurationResult& WithStateReason(StateReasonT&& value) {
  ...
  inline GetFunctionConfigurationResult& WithStateReasonCode(StateReasonCode value) {
  ...
  inline GetFunctionConfigurationResult& WithLastUpdateStatus(LastUpdateStatus value) {
  ...
  template <typename LastUpdateStatusReasonT = Aws::String>
  GetFunctionConfigurationResult& WithLastUpdateStatusReason(LastUpdateStatusReasonT&& value) {
  ...
  inline GetFunctionConfigurationResult& WithLastUpdateStatusReasonCode(LastUpdateStatusReasonCode value) {
  ...
  template <typename FileSystemConfigsT = Aws::Vector<FileSystemConfig>>
  GetFunctionConfigurationResult& WithFileSystemConfigs(FileSystemConfigsT&& value) {
    SetFileSystemConfigs(std::forward<FileSystemConfigsT>(value));
    return *this;
  }
  template <typename FileSystemConfigsT = FileSystemConfig>
  GetFunctionConfigurationResult& AddFileSystemConfigs(FileSystemConfigsT&& value) {
    m_fileSystemConfigsHasBeenSet = true;
  ...
  template <typename SigningProfileVersionArnT = Aws::String>
  GetFunctionConfigurationResult& WithSigningProfileVersionArn(SigningProfileVersionArnT&& value) {
  ...
  template <typename ArchitecturesT = Aws::Vector<Architecture>>
  GetFunctionConfigurationResult& WithArchitectures(ArchitecturesT&& value) {
    SetArchitectures(std::forward<ArchitecturesT>(value));
    return *this;
  }
  inline GetFunctionConfigurationResult& AddArchitectures(Architecture value) {
    m_architecturesHasBeenSet = true;
  ...
  template <typename EphemeralStorageT = EphemeralStorage>
  GetFunctionConfigurationResult& WithEphemeralStorage(EphemeralStorageT&& value) {
  ...
  template <typename SnapStartT = SnapStartResponse>
  GetFunctionConfigurationResult& WithSnapStart(SnapStartT&& value) {
  ...
  template <typename RuntimeVersionConfigT = RuntimeVersionConfig>
  GetFunctionConfigurationResult& WithRuntimeVersionConfig(RuntimeVersionConfigT&& value) {
  ...
  template <typename LoggingConfigT = LoggingConfig>
  GetFunctionConfigurationResult& WithLoggingConfig(LoggingConfigT&& value) {
  ...
  template <typename CapacityProviderConfigT = CapacityProviderConfig>
  GetFunctionConfigurationResult& WithCapacityProviderConfig(CapacityProviderConfigT&& value) {
  ...
  template <typename ConfigSha256T = Aws::String>
  GetFunctionConfigurationResult& WithConfigSha256(ConfigSha256T&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetFunctionConfigurationResult& WithRequestId(RequestIdT&& value) {
