...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API EC2AccessDeniedException() = default;
    ...
    template<typename TypeT = Aws::String>
    EC2AccessDeniedException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    EC2AccessDeniedException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
