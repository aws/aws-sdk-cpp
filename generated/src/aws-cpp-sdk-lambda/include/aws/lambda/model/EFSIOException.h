...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API EFSIOException() = default;
    ...
    template<typename TypeT = Aws::String>
    EFSIOException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    EFSIOException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
