...
class ListFunctionEventInvokeConfigsRequest : public LambdaRequest {
 public:
  ...
  template <typename FunctionNameT = Aws::String>
  ListFunctionEventInvokeConfigsRequest& WithFunctionName(FunctionNameT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListFunctionEventInvokeConfigsRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListFunctionEventInvokeConfigsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
