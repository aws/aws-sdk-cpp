...
class UpdateAliasRequest : public LambdaRequest {
 public:
  ...
  template <typename FunctionNameT = Aws::String>
  UpdateAliasRequest& WithFunctionName(FunctionNameT&& value) {
  ...
  template <typename FunctionVersionT = Aws::String>
  UpdateAliasRequest& WithFunctionVersion(FunctionVersionT&& value) {
  ...
  template <typename RoutingConfigT = AliasRoutingConfiguration>
  UpdateAliasRequest& WithRoutingConfig(RoutingConfigT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  UpdateAliasRequest& WithRevisionId(RevisionIdT&& value) {
