...
class GetEventSourceMappingResult {
 public:
  ...
  inline GetEventSourceMappingResult& WithStartingPosition(EventSourcePosition value) {
  ...
  inline GetEventSourceMappingResult& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline GetEventSourceMappingResult& WithMaximumBatchingWindowInSeconds(int value) {
  ...
  inline GetEventSourceMappingResult& WithParallelizationFactor(int value) {
  ...
  inline GetEventSourceMappingResult& WithMaximumRecordAgeInSeconds(int value) {
  ...
  inline GetEventSourceMappingResult& WithBisectBatchOnFunctionError(bool value) {
  ...
  inline GetEventSourceMappingResult& WithMaximumRetryAttempts(int value) {
  ...
  inline GetEventSourceMappingResult& WithTumblingWindowInSeconds(int value) {
  ...
  inline GetEventSourceMappingResult& AddFunctionResponseTypes(FunctionResponseType value) {
    m_functionResponseTypesHasBeenSet = true;
  ...
  template <typename LoggingConfigT = EventSourceMappingLoggingConfig>
  GetEventSourceMappingResult& WithLoggingConfig(LoggingConfigT&& value) {
