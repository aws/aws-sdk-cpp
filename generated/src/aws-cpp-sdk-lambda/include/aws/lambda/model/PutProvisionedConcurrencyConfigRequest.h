...
class PutProvisionedConcurrencyConfigRequest : public LambdaRequest {
 public:
  AWS_LAMBDA_API PutProvisionedConcurrencyConfigRequest() = default;
  ...
  template <typename FunctionNameT = Aws::String>
  PutProvisionedConcurrencyConfigRequest& WithFunctionName(FunctionNameT&& value) {
  ...
  template <typename QualifierT = Aws::String>
  PutProvisionedConcurrencyConfigRequest& WithQualifier(QualifierT&& value) {
  ...
  inline void SetProvisionedConcurrentExecutions(int value) {
    m_provisionedConcurrentExecutionsHasBeenSet = true;
    m_provisionedConcurrentExecutions = value;
  }
  inline PutProvisionedConcurrencyConfigRequest& WithProvisionedConcurrentExecutions(int value) {
    SetProvisionedConcurrentExecutions(value);
    return *this;
  }
  ///@}
 private:
  ...
  int m_provisionedConcurrentExecutions{0};
