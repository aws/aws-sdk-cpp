...
class UpdateFunctionEventInvokeConfigResult {
 public:
  ...
  template <typename LastModifiedT = Aws::Utils::DateTime>
  UpdateFunctionEventInvokeConfigResult& WithLastModified(LastModifiedT&& value) {
  ...
  template <typename FunctionArnT = Aws::String>
  UpdateFunctionEventInvokeConfigResult& WithFunctionArn(FunctionArnT&& value) {
  ...
  inline UpdateFunctionEventInvokeConfigResult& WithMaximumRetryAttempts(int value) {
  ...
  inline UpdateFunctionEventInvokeConfigResult& WithMaximumEventAgeInSeconds(int value) {
  ...
  template <typename DestinationConfigT = DestinationConfig>
  UpdateFunctionEventInvokeConfigResult& WithDestinationConfig(DestinationConfigT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFunctionEventInvokeConfigResult& WithRequestId(RequestIdT&& value) {
