...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API UpdateFunctionEventInvokeConfigResult() = default;
    ...
    template<typename LastModifiedT = Aws::Utils::DateTime>
    UpdateFunctionEventInvokeConfigResult& WithLastModified(LastModifiedT&& value) { SetLastModified(std::forward<LastModifiedT>(value)); return *this;}
    ///@}
    ...
    template<typename FunctionArnT = Aws::String>
    UpdateFunctionEventInvokeConfigResult& WithFunctionArn(FunctionArnT&& value) { SetFunctionArn(std::forward<FunctionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DestinationConfigT = DestinationConfig>
    UpdateFunctionEventInvokeConfigResult& WithDestinationConfig(DestinationConfigT&& value) { SetDestinationConfig(std::forward<DestinationConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateFunctionEventInvokeConfigResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
