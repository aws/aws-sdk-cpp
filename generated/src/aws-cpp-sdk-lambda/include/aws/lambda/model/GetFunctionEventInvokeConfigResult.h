...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API GetFunctionEventInvokeConfigResult() = default;
    ...
    template<typename LastModifiedT = Aws::Utils::DateTime>
    GetFunctionEventInvokeConfigResult& WithLastModified(LastModifiedT&& value) { SetLastModified(std::forward<LastModifiedT>(value)); return *this;}
    ///@}
    ...
    template<typename FunctionArnT = Aws::String>
    GetFunctionEventInvokeConfigResult& WithFunctionArn(FunctionArnT&& value) { SetFunctionArn(std::forward<FunctionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DestinationConfigT = DestinationConfig>
    GetFunctionEventInvokeConfigResult& WithDestinationConfig(DestinationConfigT&& value) { SetDestinationConfig(std::forward<DestinationConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetFunctionEventInvokeConfigResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
