...
class GetFunctionEventInvokeConfigResult {
 public:
  ...
  inline GetFunctionEventInvokeConfigResult& WithMaximumRetryAttempts(int value) {
  ...
  inline GetFunctionEventInvokeConfigResult& WithMaximumEventAgeInSeconds(int value) {
