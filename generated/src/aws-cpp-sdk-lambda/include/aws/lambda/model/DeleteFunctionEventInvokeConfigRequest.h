...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API DeleteFunctionEventInvokeConfigRequest() = default;
    ...
    template<typename FunctionNameT = Aws::String>
    DeleteFunctionEventInvokeConfigRequest& WithFunctionName(FunctionNameT&& value) { SetFunctionName(std::forward<FunctionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename QualifierT = Aws::String>
    DeleteFunctionEventInvokeConfigRequest& WithQualifier(QualifierT&& value) { SetQualifier(std::forward<QualifierT>(value)); return *this;}
    ///@}
  private:
