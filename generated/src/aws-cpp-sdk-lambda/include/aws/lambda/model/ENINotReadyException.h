 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/lambda-2015-03-31/ENINotReadyException">AWS
 * API Reference</a></p>
 */
class ENINotReadyException {
 public:
  AWS_LAMBDA_API ENINotReadyException() = default;
  AWS_LAMBDA_API ENINotReadyException(Aws::Utils::Json::JsonView jsonValue);
  AWS_LAMBDA_API ENINotReadyException& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename TypeT = Aws::String>
  ENINotReadyException& WithType(TypeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  ENINotReadyException& WithMessage(MessageT&& value) {
