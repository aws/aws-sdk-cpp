...
class UpdateCapacityProviderResult {
 public:
  AWS_LAMBDA_API UpdateCapacityProviderResult() = default;
  AWS_LAMBDA_API UpdateCapacityProviderResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_LAMBDA_API UpdateCapacityProviderResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
