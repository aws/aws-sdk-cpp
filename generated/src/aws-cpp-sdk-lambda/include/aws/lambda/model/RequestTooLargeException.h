...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API RequestTooLargeException() = default;
    ...
    template<typename TypeT = Aws::String>
    RequestTooLargeException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    RequestTooLargeException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
