...
class ListEventSourceMappingsResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListEventSourceMappingsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetEventSourceMappings(EventSourceMappingsT&& value) {
    m_eventSourceMappingsHasBeenSet = true;
    m_eventSourceMappings = std::forward<EventSourceMappingsT>(value);
  }
  template <typename EventSourceMappingsT = Aws::Vector<EventSourceMappingConfiguration>>
  ListEventSourceMappingsResult& WithEventSourceMappings(EventSourceMappingsT&& value) {
    SetEventSourceMappings(std::forward<EventSourceMappingsT>(value));
    return *this;
  }
  template <typename EventSourceMappingsT = EventSourceMappingConfiguration>
  ListEventSourceMappingsResult& AddEventSourceMappings(EventSourceMappingsT&& value) {
    m_eventSourceMappingsHasBeenSet = true;
    m_eventSourceMappings.emplace_back(std::forward<EventSourceMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListEventSourceMappingsResult& WithRequestId(RequestIdT&& value) {
