...
class GetLayerVersionRequest : public LambdaRequest {
 public:
  AWS_LAMBDA_API GetLayerVersionRequest() = default;
  ...
  template <typename LayerNameT = Aws::String>
  GetLayerVersionRequest& WithLayerName(LayerNameT&& value) {
  ...
  inline GetLayerVersionRequest& WithVersionNumber(long long value) {
