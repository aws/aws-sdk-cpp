...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API CodeSigningConfigNotFoundException() = default;
    ...
    template<typename TypeT = Aws::String>
    CodeSigningConfigNotFoundException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    CodeSigningConfigNotFoundException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
