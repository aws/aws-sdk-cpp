...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API FilterCriteriaError() = default;
    ...
    template<typename ErrorCodeT = Aws::String>
    FilterCriteriaError& WithErrorCode(ErrorCodeT&& value) { SetErrorCode(std::forward<ErrorCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    FilterCriteriaError& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
