...
class PublishLayerVersionResult {
 public:
  ...
  inline PublishLayerVersionResult& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  inline PublishLayerVersionResult& AddCompatibleRuntimes(Runtime value) {
    m_compatibleRuntimesHasBeenSet = true;
  ...
  inline PublishLayerVersionResult& AddCompatibleArchitectures(Architecture value) {
    m_compatibleArchitecturesHasBeenSet = true;
