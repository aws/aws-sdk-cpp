...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API InvalidSecurityGroupIDException() = default;
    ...
    template<typename TypeT = Aws::String>
    InvalidSecurityGroupIDException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    InvalidSecurityGroupIDException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
