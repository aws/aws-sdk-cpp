...
class ListFunctionsByCodeSigningConfigResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListFunctionsByCodeSigningConfigResult& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename FunctionArnsT = Aws::Vector<Aws::String>>
  ListFunctionsByCodeSigningConfigResult& WithFunctionArns(FunctionArnsT&& value) {
    SetFunctionArns(std::forward<FunctionArnsT>(value));
    return *this;
  }
  template <typename FunctionArnsT = Aws::String>
  ListFunctionsByCodeSigningConfigResult& AddFunctionArns(FunctionArnsT&& value) {
    m_functionArnsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListFunctionsByCodeSigningConfigResult& WithRequestId(RequestIdT&& value) {
