...
class ListFunctionUrlConfigsRequest : public LambdaRequest {
 public:
  AWS_LAMBDA_API ListFunctionUrlConfigsRequest() = default;
  ...
  template <typename FunctionNameT = Aws::String>
  ListFunctionUrlConfigsRequest& WithFunctionName(FunctionNameT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListFunctionUrlConfigsRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListFunctionUrlConfigsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
