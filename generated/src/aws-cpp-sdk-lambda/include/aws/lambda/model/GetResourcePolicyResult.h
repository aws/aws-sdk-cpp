...
class GetResourcePolicyResult {
 public:
  AWS_LAMBDA_API GetResourcePolicyResult() = default;
  ...
  ///@{
  /**
   * <p>The revision ID of the policy. Pass this value as the <code>RevisionId</code>
   * in a <a>PutResourcePolicy</a> or <a>DeleteResourcePolicy</a> request. Doing so
   * ensures the operation acts on the expected version of the policy.</p>
   */
