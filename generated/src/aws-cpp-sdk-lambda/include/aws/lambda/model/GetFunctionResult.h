...
class GetFunctionResult {
 public:
  ...
  void SetTagsError(TagsErrorT&& value) {
    ...
    m_tagsError = std::forward<TagsErrorT>(value);
  }
  template <typename TagsErrorT = TagsError>
  GetFunctionResult& WithTagsError(TagsErrorT&& value) {
    SetTagsError(std::forward<TagsErrorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConcurrency(ConcurrencyT&& value) {
    ...
    m_concurrency = std::forward<ConcurrencyT>(value);
  }
  template <typename ConcurrencyT = Concurrency>
  GetFunctionResult& WithConcurrency(ConcurrencyT&& value) {
    SetConcurrency(std::forward<ConcurrencyT>(value));
    return *this;
  }
  ///@}
