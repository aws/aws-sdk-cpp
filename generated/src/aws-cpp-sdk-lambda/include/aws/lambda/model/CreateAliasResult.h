...
class CreateAliasResult {
 public:
  ...
  template <typename AliasArnT = Aws::String>
  CreateAliasResult& WithAliasArn(AliasArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateAliasResult& WithName(NameT&& value) {
  ...
  template <typename FunctionVersionT = Aws::String>
  CreateAliasResult& WithFunctionVersion(FunctionVersionT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateAliasResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename RoutingConfigT = AliasRoutingConfiguration>
  CreateAliasResult& WithRoutingConfig(RoutingConfigT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  CreateAliasResult& WithRevisionId(RevisionIdT&& value) {
