...
class PutFunctionCodeSigningConfigRequest : public LambdaRequest {
 public:
  ...
  template <typename CodeSigningConfigArnT = Aws::String>
  PutFunctionCodeSigningConfigRequest& WithCodeSigningConfigArn(CodeSigningConfigArnT&& value) {
  ...
  template <typename FunctionNameT = Aws::String>
  PutFunctionCodeSigningConfigRequest& WithFunctionName(FunctionNameT&& value) {
