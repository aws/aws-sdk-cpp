...
class ListFunctionsByCodeSigningConfigRequest : public LambdaRequest {
 public:
  ...
  template <typename CodeSigningConfigArnT = Aws::String>
  ListFunctionsByCodeSigningConfigRequest& WithCodeSigningConfigArn(CodeSigningConfigArnT&& value) {
  ...
  template <typename MarkerT = Aws::String>
  ListFunctionsByCodeSigningConfigRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListFunctionsByCodeSigningConfigRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
