...
class GetAliasResult {
 public:
  ...
  template <typename AliasArnT = Aws::String>
  GetAliasResult& WithAliasArn(AliasArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetAliasResult& WithName(NameT&& value) {
  ...
  template <typename FunctionVersionT = Aws::String>
  GetAliasResult& WithFunctionVersion(FunctionVersionT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetAliasResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename RoutingConfigT = AliasRoutingConfiguration>
  GetAliasResult& WithRoutingConfig(RoutingConfigT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  GetAliasResult& WithRevisionId(RevisionIdT&& value) {
