...
class InvokeWithResponseStreamResponseEvent {
 public:
  ...
  void SetPayloadChunk(PayloadChunkT&& value) {
    m_payloadChunkHasBeenSet = true;
    m_payloadChunk = std::forward<PayloadChunkT>(value);
  }
  template <typename PayloadChunkT = InvokeResponseStreamUpdate>
  InvokeWithResponseStreamResponseEvent& WithPayloadChunk(PayloadChunkT&& value) {
    SetPayloadChunk(std::forward<PayloadChunkT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvokeComplete(InvokeCompleteT&& value) {
    m_invokeCompleteHasBeenSet = true;
    m_invokeComplete = std::forward<InvokeCompleteT>(value);
  }
  template <typename InvokeCompleteT = InvokeWithResponseStreamCompleteEvent>
  InvokeWithResponseStreamResponseEvent& WithInvokeComplete(InvokeCompleteT&& value) {
    SetInvokeComplete(std::forward<InvokeCompleteT>(value));
    return *this;
  }
  ///@}
 private:
