...
struct GetDurableExecutionStatePaginationTraits {
  using RequestType = Model::GetDurableExecutionStateRequest;
  using ResultType = Model::GetDurableExecutionStateResult;
  using OutcomeType = Model::GetDurableExecutionStateOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->GetDurableExecutionState(request); }
