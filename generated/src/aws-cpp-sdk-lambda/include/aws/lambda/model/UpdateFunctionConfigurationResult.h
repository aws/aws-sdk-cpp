...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API UpdateFunctionConfigurationResult() = default;
    ...
    template<typename FunctionNameT = Aws::String>
    UpdateFunctionConfigurationResult& WithFunctionName(FunctionNameT&& value) { SetFunctionName(std::forward<FunctionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename FunctionArnT = Aws::String>
    UpdateFunctionConfigurationResult& WithFunctionArn(FunctionArnT&& value) { SetFunctionArn(std::forward<FunctionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleT = Aws::String>
    UpdateFunctionConfigurationResult& WithRole(RoleT&& value) { SetRole(std::forward<RoleT>(value)); return *this;}
    ///@}
    ...
    template<typename HandlerT = Aws::String>
    UpdateFunctionConfigurationResult& WithHandler(HandlerT&& value) { SetHandler(std::forward<HandlerT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateFunctionConfigurationResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedT = Aws::String>
    UpdateFunctionConfigurationResult& WithLastModified(LastModifiedT&& value) { SetLastModified(std::forward<LastModifiedT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeSha256T = Aws::String>
    UpdateFunctionConfigurationResult& WithCodeSha256(CodeSha256T&& value) { SetCodeSha256(std::forward<CodeSha256T>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    UpdateFunctionConfigurationResult& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcConfigT = VpcConfigResponse>
    UpdateFunctionConfigurationResult& WithVpcConfig(VpcConfigT&& value) { SetVpcConfig(std::forward<VpcConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename DeadLetterConfigT = DeadLetterConfig>
    UpdateFunctionConfigurationResult& WithDeadLetterConfig(DeadLetterConfigT&& value) { SetDeadLetterConfig(std::forward<DeadLetterConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentT = EnvironmentResponse>
    UpdateFunctionConfigurationResult& WithEnvironment(EnvironmentT&& value) { SetEnvironment(std::forward<EnvironmentT>(value)); return *this;}
    ///@}
    ...
    template<typename KMSKeyArnT = Aws::String>
    UpdateFunctionConfigurationResult& WithKMSKeyArn(KMSKeyArnT&& value) { SetKMSKeyArn(std::forward<KMSKeyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename TracingConfigT = TracingConfigResponse>
    UpdateFunctionConfigurationResult& WithTracingConfig(TracingConfigT&& value) { SetTracingConfig(std::forward<TracingConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename MasterArnT = Aws::String>
    UpdateFunctionConfigurationResult& WithMasterArn(MasterArnT&& value) { SetMasterArn(std::forward<MasterArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RevisionIdT = Aws::String>
    UpdateFunctionConfigurationResult& WithRevisionId(RevisionIdT&& value) { SetRevisionId(std::forward<RevisionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LayersT = Aws::Vector<Layer>>
    UpdateFunctionConfigurationResult& WithLayers(LayersT&& value) { SetLayers(std::forward<LayersT>(value)); return *this;}
    template<typename LayersT = Layer>
    UpdateFunctionConfigurationResult& AddLayers(LayersT&& value) { m_layersHasBeenSet = true; m_layers.emplace_back(std::forward<LayersT>(value)); return *this; }
    ///@}
    ...
    inline UpdateFunctionConfigurationResult& WithState(State value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename StateReasonT = Aws::String>
    UpdateFunctionConfigurationResult& WithStateReason(StateReasonT&& value) { SetStateReason(std::forward<StateReasonT>(value)); return *this;}
    ///@}
    ...
    inline UpdateFunctionConfigurationResult& WithStateReasonCode(StateReasonCode value) { SetStateReasonCode(value); return *this;}
    ///@}
    ...
    inline UpdateFunctionConfigurationResult& WithLastUpdateStatus(LastUpdateStatus value) { SetLastUpdateStatus(value); return *this;}
    ///@}
    ...
    template<typename LastUpdateStatusReasonT = Aws::String>
    UpdateFunctionConfigurationResult& WithLastUpdateStatusReason(LastUpdateStatusReasonT&& value) { SetLastUpdateStatusReason(std::forward<LastUpdateStatusReasonT>(value)); return *this;}
    ///@}
    ...
    inline UpdateFunctionConfigurationResult& WithLastUpdateStatusReasonCode(LastUpdateStatusReasonCode value) { SetLastUpdateStatusReasonCode(value); return *this;}
    ///@}
    ...
    template<typename FileSystemConfigsT = Aws::Vector<FileSystemConfig>>
    UpdateFunctionConfigurationResult& WithFileSystemConfigs(FileSystemConfigsT&& value) { SetFileSystemConfigs(std::forward<FileSystemConfigsT>(value)); return *this;}
    template<typename FileSystemConfigsT = FileSystemConfig>
    UpdateFunctionConfigurationResult& AddFileSystemConfigs(FileSystemConfigsT&& value) { m_fileSystemConfigsHasBeenSet = true; m_fileSystemConfigs.emplace_back(std::forward<FileSystemConfigsT>(value)); return *this; }
    ///@}
    ...
    inline UpdateFunctionConfigurationResult& WithPackageType(PackageType value) { SetPackageType(value); return *this;}
    ///@}
    ...
    template<typename ImageConfigResponseT = ImageConfigResponse>
    UpdateFunctionConfigurationResult& WithImageConfigResponse(ImageConfigResponseT&& value) { SetImageConfigResponse(std::forward<ImageConfigResponseT>(value)); return *this;}
    ///@}
    ...
    template<typename SigningProfileVersionArnT = Aws::String>
    UpdateFunctionConfigurationResult& WithSigningProfileVersionArn(SigningProfileVersionArnT&& value) { SetSigningProfileVersionArn(std::forward<SigningProfileVersionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SigningJobArnT = Aws::String>
    UpdateFunctionConfigurationResult& WithSigningJobArn(SigningJobArnT&& value) { SetSigningJobArn(std::forward<SigningJobArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ArchitecturesT = Aws::Vector<Architecture>>
    UpdateFunctionConfigurationResult& WithArchitectures(ArchitecturesT&& value) { SetArchitectures(std::forward<ArchitecturesT>(value)); return *this;}
    inline UpdateFunctionConfigurationResult& AddArchitectures(Architecture value) { m_architecturesHasBeenSet = true; m_architectures.push_back(value); return *this; }
    ///@}
    ...
    template<typename EphemeralStorageT = EphemeralStorage>
    UpdateFunctionConfigurationResult& WithEphemeralStorage(EphemeralStorageT&& value) { SetEphemeralStorage(std::forward<EphemeralStorageT>(value)); return *this;}
    ///@}
    ...
    template<typename SnapStartT = SnapStartResponse>
    UpdateFunctionConfigurationResult& WithSnapStart(SnapStartT&& value) { SetSnapStart(std::forward<SnapStartT>(value)); return *this;}
    ///@}
    ...
    template<typename RuntimeVersionConfigT = RuntimeVersionConfig>
    UpdateFunctionConfigurationResult& WithRuntimeVersionConfig(RuntimeVersionConfigT&& value) { SetRuntimeVersionConfig(std::forward<RuntimeVersionConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename LoggingConfigT = LoggingConfig>
    UpdateFunctionConfigurationResult& WithLoggingConfig(LoggingConfigT&& value) { SetLoggingConfig(std::forward<LoggingConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateFunctionConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
