...
class UpdateFunctionConfigurationResult {
 public:
  ...
  template <typename FunctionNameT = Aws::String>
  UpdateFunctionConfigurationResult& WithFunctionName(FunctionNameT&& value) {
  ...
  template <typename FunctionArnT = Aws::String>
  UpdateFunctionConfigurationResult& WithFunctionArn(FunctionArnT&& value) {
  ...
  inline UpdateFunctionConfigurationResult& WithRuntime(Runtime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  template <typename RoleT = Aws::String>
  UpdateFunctionConfigurationResult& WithRole(RoleT&& value) {
  ...
  template <typename HandlerT = Aws::String>
  UpdateFunctionConfigurationResult& WithHandler(HandlerT&& value) {
  ...
  inline UpdateFunctionConfigurationResult& WithCodeSize(long long value) {
    SetCodeSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  UpdateFunctionConfigurationResult& WithDescription(DescriptionT&& value) {
  ...
  inline UpdateFunctionConfigurationResult& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFunctionConfigurationResult& WithMemorySize(int value) {
    SetMemorySize(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastModifiedT = Aws::String>
  UpdateFunctionConfigurationResult& WithLastModified(LastModifiedT&& value) {
  ...
  template <typename CodeSha256T = Aws::String>
  UpdateFunctionConfigurationResult& WithCodeSha256(CodeSha256T&& value) {
  ...
  template <typename VersionT = Aws::String>
  UpdateFunctionConfigurationResult& WithVersion(VersionT&& value) {
  ...
  template <typename VpcConfigT = VpcConfigResponse>
  UpdateFunctionConfigurationResult& WithVpcConfig(VpcConfigT&& value) {
  ...
  template <typename DeadLetterConfigT = DeadLetterConfig>
  UpdateFunctionConfigurationResult& WithDeadLetterConfig(DeadLetterConfigT&& value) {
  ...
  template <typename EnvironmentT = EnvironmentResponse>
  UpdateFunctionConfigurationResult& WithEnvironment(EnvironmentT&& value) {
  ...
  template <typename KMSKeyArnT = Aws::String>
  UpdateFunctionConfigurationResult& WithKMSKeyArn(KMSKeyArnT&& value) {
  ...
  template <typename TracingConfigT = TracingConfigResponse>
  UpdateFunctionConfigurationResult& WithTracingConfig(TracingConfigT&& value) {
  ...
  template <typename MasterArnT = Aws::String>
  UpdateFunctionConfigurationResult& WithMasterArn(MasterArnT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  UpdateFunctionConfigurationResult& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename LayersT = Aws::Vector<Layer>>
  UpdateFunctionConfigurationResult& WithLayers(LayersT&& value) {
    SetLayers(std::forward<LayersT>(value));
    return *this;
  }
  template <typename LayersT = Layer>
  UpdateFunctionConfigurationResult& AddLayers(LayersT&& value) {
    m_layersHasBeenSet = true;
  ...
  inline UpdateFunctionConfigurationResult& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename StateReasonT = Aws::String>
  UpdateFunctionConfigurationResult& WithStateReason(StateReasonT&& value) {
  ...
  inline UpdateFunctionConfigurationResult& WithStateReasonCode(StateReasonCode value) {
  ...
  inline UpdateFunctionConfigurationResult& WithLastUpdateStatus(LastUpdateStatus value) {
  ...
  template <typename LastUpdateStatusReasonT = Aws::String>
  UpdateFunctionConfigurationResult& WithLastUpdateStatusReason(LastUpdateStatusReasonT&& value) {
  ...
  inline UpdateFunctionConfigurationResult& WithLastUpdateStatusReasonCode(LastUpdateStatusReasonCode value) {
  ...
  template <typename FileSystemConfigsT = Aws::Vector<FileSystemConfig>>
  UpdateFunctionConfigurationResult& WithFileSystemConfigs(FileSystemConfigsT&& value) {
    SetFileSystemConfigs(std::forward<FileSystemConfigsT>(value));
    return *this;
  }
  template <typename FileSystemConfigsT = FileSystemConfig>
  UpdateFunctionConfigurationResult& AddFileSystemConfigs(FileSystemConfigsT&& value) {
    m_fileSystemConfigsHasBeenSet = true;
  ...
  inline UpdateFunctionConfigurationResult& WithPackageType(PackageType value) {
  ...
  template <typename ImageConfigResponseT = ImageConfigResponse>
  UpdateFunctionConfigurationResult& WithImageConfigResponse(ImageConfigResponseT&& value) {
  ...
  template <typename SigningProfileVersionArnT = Aws::String>
  UpdateFunctionConfigurationResult& WithSigningProfileVersionArn(SigningProfileVersionArnT&& value) {
  ...
  template <typename SigningJobArnT = Aws::String>
  UpdateFunctionConfigurationResult& WithSigningJobArn(SigningJobArnT&& value) {
  ...
  template <typename ArchitecturesT = Aws::Vector<Architecture>>
  UpdateFunctionConfigurationResult& WithArchitectures(ArchitecturesT&& value) {
    SetArchitectures(std::forward<ArchitecturesT>(value));
    return *this;
  }
  inline UpdateFunctionConfigurationResult& AddArchitectures(Architecture value) {
    m_architecturesHasBeenSet = true;
  ...
  template <typename EphemeralStorageT = EphemeralStorage>
  UpdateFunctionConfigurationResult& WithEphemeralStorage(EphemeralStorageT&& value) {
  ...
  template <typename SnapStartT = SnapStartResponse>
  UpdateFunctionConfigurationResult& WithSnapStart(SnapStartT&& value) {
  ...
  template <typename RuntimeVersionConfigT = RuntimeVersionConfig>
  UpdateFunctionConfigurationResult& WithRuntimeVersionConfig(RuntimeVersionConfigT&& value) {
  ...
  template <typename LoggingConfigT = LoggingConfig>
  UpdateFunctionConfigurationResult& WithLoggingConfig(LoggingConfigT&& value) {
  ...
  template <typename CapacityProviderConfigT = CapacityProviderConfig>
  UpdateFunctionConfigurationResult& WithCapacityProviderConfig(CapacityProviderConfigT&& value) {
  ...
  template <typename ConfigSha256T = Aws::String>
  UpdateFunctionConfigurationResult& WithConfigSha256(ConfigSha256T&& value) {
  ...
  template <typename DurableConfigT = DurableConfig>
  UpdateFunctionConfigurationResult& WithDurableConfig(DurableConfigT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFunctionConfigurationResult& WithRequestId(RequestIdT&& value) {
