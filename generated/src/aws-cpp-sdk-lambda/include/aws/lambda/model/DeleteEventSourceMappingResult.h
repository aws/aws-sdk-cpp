...
class DeleteEventSourceMappingResult {
 public:
  ...
  inline DeleteEventSourceMappingResult& WithStartingPosition(EventSourcePosition value) {
  ...
  inline DeleteEventSourceMappingResult& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteEventSourceMappingResult& WithMaximumBatchingWindowInSeconds(int value) {
  ...
  inline DeleteEventSourceMappingResult& WithParallelizationFactor(int value) {
  ...
  inline DeleteEventSourceMappingResult& WithMaximumRecordAgeInSeconds(int value) {
  ...
  inline DeleteEventSourceMappingResult& WithBisectBatchOnFunctionError(bool value) {
  ...
  inline DeleteEventSourceMappingResult& WithMaximumRetryAttempts(int value) {
  ...
  inline DeleteEventSourceMappingResult& WithTumblingWindowInSeconds(int value) {
  ...
  inline DeleteEventSourceMappingResult& AddFunctionResponseTypes(FunctionResponseType value) {
    m_functionResponseTypesHasBeenSet = true;
  ...
  template <typename LoggingConfigT = EventSourceMappingLoggingConfig>
  DeleteEventSourceMappingResult& WithLoggingConfig(LoggingConfigT&& value) {
