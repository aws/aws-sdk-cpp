...
namespace Model
{
  ...
  public:
    ...
    template<typename UUIDT = Aws::String>
    DeleteEventSourceMappingResult& WithUUID(UUIDT&& value) { SetUUID(std::forward<UUIDT>(value)); return *this;}
    ///@}
    ...
    inline DeleteEventSourceMappingResult& WithStartingPosition(EventSourcePosition value) { SetStartingPosition(value); return *this;}
    ///@}
    ...
    template<typename StartingPositionTimestampT = Aws::Utils::DateTime>
    DeleteEventSourceMappingResult& WithStartingPositionTimestamp(StartingPositionTimestampT&& value) { SetStartingPositionTimestamp(std::forward<StartingPositionTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename EventSourceArnT = Aws::String>
    DeleteEventSourceMappingResult& WithEventSourceArn(EventSourceArnT&& value) { SetEventSourceArn(std::forward<EventSourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename FilterCriteriaT = FilterCriteria>
    DeleteEventSourceMappingResult& WithFilterCriteria(FilterCriteriaT&& value) { SetFilterCriteria(std::forward<FilterCriteriaT>(value)); return *this;}
    ///@}
    ...
    template<typename FunctionArnT = Aws::String>
    DeleteEventSourceMappingResult& WithFunctionArn(FunctionArnT&& value) { SetFunctionArn(std::forward<FunctionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedT = Aws::Utils::DateTime>
    DeleteEventSourceMappingResult& WithLastModified(LastModifiedT&& value) { SetLastModified(std::forward<LastModifiedT>(value)); return *this;}
    ///@}
    ...
    template<typename LastProcessingResultT = Aws::String>
    DeleteEventSourceMappingResult& WithLastProcessingResult(LastProcessingResultT&& value) { SetLastProcessingResult(std::forward<LastProcessingResultT>(value)); return *this;}
    ///@}
    ...
    template<typename StateT = Aws::String>
    DeleteEventSourceMappingResult& WithState(StateT&& value) { SetState(std::forward<StateT>(value)); return *this;}
    ///@}
    ...
    template<typename StateTransitionReasonT = Aws::String>
    DeleteEventSourceMappingResult& WithStateTransitionReason(StateTransitionReasonT&& value) { SetStateTransitionReason(std::forward<StateTransitionReasonT>(value)); return *this;}
    ///@}
    ...
    template<typename DestinationConfigT = DestinationConfig>
    DeleteEventSourceMappingResult& WithDestinationConfig(DestinationConfigT&& value) { SetDestinationConfig(std::forward<DestinationConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename TopicsT = Aws::Vector<Aws::String>>
    DeleteEventSourceMappingResult& WithTopics(TopicsT&& value) { SetTopics(std::forward<TopicsT>(value)); return *this;}
    template<typename TopicsT = Aws::String>
    DeleteEventSourceMappingResult& AddTopics(TopicsT&& value) { m_topicsHasBeenSet = true; m_topics.emplace_back(std::forward<TopicsT>(value)); return *this; }
    ///@}
    ...
    template<typename QueuesT = Aws::Vector<Aws::String>>
    DeleteEventSourceMappingResult& WithQueues(QueuesT&& value) { SetQueues(std::forward<QueuesT>(value)); return *this;}
    template<typename QueuesT = Aws::String>
    DeleteEventSourceMappingResult& AddQueues(QueuesT&& value) { m_queuesHasBeenSet = true; m_queues.emplace_back(std::forward<QueuesT>(value)); return *this; }
    ///@}
    ...
    template<typename SourceAccessConfigurationsT = Aws::Vector<SourceAccessConfiguration>>
    DeleteEventSourceMappingResult& WithSourceAccessConfigurations(SourceAccessConfigurationsT&& value) { SetSourceAccessConfigurations(std::forward<SourceAccessConfigurationsT>(value)); return *this;}
    template<typename SourceAccessConfigurationsT = SourceAccessConfiguration>
    DeleteEventSourceMappingResult& AddSourceAccessConfigurations(SourceAccessConfigurationsT&& value) { m_sourceAccessConfigurationsHasBeenSet = true; m_sourceAccessConfigurations.emplace_back(std::forward<SourceAccessConfigurationsT>(value)); return *this; }
    ///@}
    ...
    template<typename SelfManagedEventSourceT = SelfManagedEventSource>
    DeleteEventSourceMappingResult& WithSelfManagedEventSource(SelfManagedEventSourceT&& value) { SetSelfManagedEventSource(std::forward<SelfManagedEventSourceT>(value)); return *this;}
    ///@}
    ...
    template<typename FunctionResponseTypesT = Aws::Vector<FunctionResponseType>>
    DeleteEventSourceMappingResult& WithFunctionResponseTypes(FunctionResponseTypesT&& value) { SetFunctionResponseTypes(std::forward<FunctionResponseTypesT>(value)); return *this;}
    inline DeleteEventSourceMappingResult& AddFunctionResponseTypes(FunctionResponseType value) { m_functionResponseTypesHasBeenSet = true; m_functionResponseTypes.push_back(value); return *this; }
    ///@}
    ...
    template<typename AmazonManagedKafkaEventSourceConfigT = AmazonManagedKafkaEventSourceConfig>
    DeleteEventSourceMappingResult& WithAmazonManagedKafkaEventSourceConfig(AmazonManagedKafkaEventSourceConfigT&& value) { SetAmazonManagedKafkaEventSourceConfig(std::forward<AmazonManagedKafkaEventSourceConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename SelfManagedKafkaEventSourceConfigT = SelfManagedKafkaEventSourceConfig>
    DeleteEventSourceMappingResult& WithSelfManagedKafkaEventSourceConfig(SelfManagedKafkaEventSourceConfigT&& value) { SetSelfManagedKafkaEventSourceConfig(std::forward<SelfManagedKafkaEventSourceConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename ScalingConfigT = ScalingConfig>
    DeleteEventSourceMappingResult& WithScalingConfig(ScalingConfigT&& value) { SetScalingConfig(std::forward<ScalingConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename DocumentDBEventSourceConfigT = DocumentDBEventSourceConfig>
    DeleteEventSourceMappingResult& WithDocumentDBEventSourceConfig(DocumentDBEventSourceConfigT&& value) { SetDocumentDBEventSourceConfig(std::forward<DocumentDBEventSourceConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename KMSKeyArnT = Aws::String>
    DeleteEventSourceMappingResult& WithKMSKeyArn(KMSKeyArnT&& value) { SetKMSKeyArn(std::forward<KMSKeyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename FilterCriteriaErrorT = FilterCriteriaError>
    DeleteEventSourceMappingResult& WithFilterCriteriaError(FilterCriteriaErrorT&& value) { SetFilterCriteriaError(std::forward<FilterCriteriaErrorT>(value)); return *this;}
    ///@}
    ...
    template<typename EventSourceMappingArnT = Aws::String>
    DeleteEventSourceMappingResult& WithEventSourceMappingArn(EventSourceMappingArnT&& value) { SetEventSourceMappingArn(std::forward<EventSourceMappingArnT>(value)); return *this;}
    ///@}
    ...
    template<typename MetricsConfigT = EventSourceMappingMetricsConfig>
    DeleteEventSourceMappingResult& WithMetricsConfig(MetricsConfigT&& value) { SetMetricsConfig(std::forward<MetricsConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename ProvisionedPollerConfigT = ProvisionedPollerConfig>
    DeleteEventSourceMappingResult& WithProvisionedPollerConfig(ProvisionedPollerConfigT&& value) { SetProvisionedPollerConfig(std::forward<ProvisionedPollerConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteEventSourceMappingResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
