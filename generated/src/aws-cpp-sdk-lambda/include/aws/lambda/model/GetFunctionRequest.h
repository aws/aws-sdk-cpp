...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API GetFunctionRequest() = default;
    ...
    template<typename FunctionNameT = Aws::String>
    GetFunctionRequest& WithFunctionName(FunctionNameT&& value) { SetFunctionName(std::forward<FunctionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename QualifierT = Aws::String>
    GetFunctionRequest& WithQualifier(QualifierT&& value) { SetQualifier(std::forward<QualifierT>(value)); return *this;}
    ///@}
  private:
