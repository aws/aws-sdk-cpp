...
namespace Model
{
  ...
  public:
    ...
    template<typename FunctionNameT = Aws::String>
    UpdateFunctionUrlConfigRequest& WithFunctionName(FunctionNameT&& value) { SetFunctionName(std::forward<FunctionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename QualifierT = Aws::String>
    UpdateFunctionUrlConfigRequest& WithQualifier(QualifierT&& value) { SetQualifier(std::forward<QualifierT>(value)); return *this;}
    ///@}
    ...
    inline UpdateFunctionUrlConfigRequest& WithAuthType(FunctionUrlAuthType value) { SetAuthType(value); return *this;}
    ///@}
    ...
    template<typename CorsT = Cors>
    UpdateFunctionUrlConfigRequest& WithCors(CorsT&& value) { SetCors(std::forward<CorsT>(value)); return *this;}
    ///@}
    ...
    inline UpdateFunctionUrlConfigRequest& WithInvokeMode(InvokeMode value) { SetInvokeMode(value); return *this;}
    ///@}
  private:
