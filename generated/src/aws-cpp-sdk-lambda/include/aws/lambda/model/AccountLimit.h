...
class AccountLimit {
 public:
  ...
  inline AccountLimit& WithTotalCodeSize(long long value) {
  ...
  inline void SetCodeSizeUnzipped(long long value) {
    m_codeSizeUnzippedHasBeenSet = true;
    m_codeSizeUnzipped = value;
  }
  inline AccountLimit& WithCodeSizeUnzipped(long long value) {
    SetCodeSizeUnzipped(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCodeSizeZipped(long long value) {
    m_codeSizeZippedHasBeenSet = true;
    m_codeSizeZipped = value;
  }
  inline AccountLimit& WithCodeSizeZipped(long long value) {
    SetCodeSizeZipped(value);
    return *this;
  }
  ///@}
  ...
  inline AccountLimit& WithConcurrentExecutions(int value) {
  ...
  inline void SetUnreservedConcurrentExecutions(int value) {
    m_unreservedConcurrentExecutionsHasBeenSet = true;
    m_unreservedConcurrentExecutions = value;
  }
  inline AccountLimit& WithUnreservedConcurrentExecutions(int value) {
    SetUnreservedConcurrentExecutions(value);
    return *this;
  }
  ///@}
 private:
