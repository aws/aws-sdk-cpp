...
class CreateFunctionRequest : public LambdaRequest {
 public:
  ...
  inline CreateFunctionRequest& WithRuntime(Runtime value) {
    SetRuntime(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFunctionRequest& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFunctionRequest& WithMemorySize(int value) {
    SetMemorySize(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFunctionRequest& WithPublish(bool value) {
    SetPublish(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFunctionRequest& WithPackageType(PackageType value) {
  ...
  inline CreateFunctionRequest& AddArchitectures(Architecture value) {
    m_architecturesHasBeenSet = true;
