...
class GetCapacityProviderResult {
 public:
  AWS_LAMBDA_API GetCapacityProviderResult() = default;
  AWS_LAMBDA_API GetCapacityProviderResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_LAMBDA_API GetCapacityProviderResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);

  ///@{
  /**
   * <p>Information about the capacity provider, including its configuration and
   * current state.</p>
   */
  ...
  template <typename CapacityProviderT = CapacityProvider>
  GetCapacityProviderResult& WithCapacityProvider(CapacityProviderT&& value) {
