...
namespace Model
{
  ...
  {
  public:
    AWS_LAMBDA_API ProvisionedConcurrencyConfigNotFoundException() = default;
    ...
    template<typename TypeT = Aws::String>
    ProvisionedConcurrencyConfigNotFoundException& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    ProvisionedConcurrencyConfigNotFoundException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
