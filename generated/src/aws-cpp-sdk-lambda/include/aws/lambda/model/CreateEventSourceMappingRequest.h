...
class CreateEventSourceMappingRequest : public LambdaRequest {
 public:
  ...
  inline CreateEventSourceMappingRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline CreateEventSourceMappingRequest& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline CreateEventSourceMappingRequest& WithMaximumBatchingWindowInSeconds(int value) {
  ...
  inline CreateEventSourceMappingRequest& WithParallelizationFactor(int value) {
  ...
  inline CreateEventSourceMappingRequest& WithStartingPosition(EventSourcePosition value) {
  ...
  inline CreateEventSourceMappingRequest& WithMaximumRecordAgeInSeconds(int value) {
   ...
   * function returns an error, split the batch in two and retry.</p>
   */
  ...
  inline CreateEventSourceMappingRequest& WithBisectBatchOnFunctionError(bool value) {
  ...
  inline CreateEventSourceMappingRequest& WithMaximumRetryAttempts(int value) {
  ...
  inline CreateEventSourceMappingRequest& WithTumblingWindowInSeconds(int value) {
  ...
  inline CreateEventSourceMappingRequest& AddFunctionResponseTypes(FunctionResponseType value) {
    m_functionResponseTypesHasBeenSet = true;
