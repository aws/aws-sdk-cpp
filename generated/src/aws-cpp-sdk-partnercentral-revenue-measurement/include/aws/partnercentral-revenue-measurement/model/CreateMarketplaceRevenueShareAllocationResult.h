...
namespace Model {
class CreateMarketplaceRevenueShareAllocationResult {
 public:
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API CreateMarketplaceRevenueShareAllocationResult() = default;
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API CreateMarketplaceRevenueShareAllocationResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API CreateMarketplaceRevenueShareAllocationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename MarketplaceRevenueShareAllocationIdT = Aws::String>
  CreateMarketplaceRevenueShareAllocationResult& WithMarketplaceRevenueShareAllocationId(MarketplaceRevenueShareAllocationIdT&& value) {
  ...
  template <typename ProductIdT = Aws::String>
  CreateMarketplaceRevenueShareAllocationResult& WithProductId(ProductIdT&& value) {
  ...
  template <typename ProductNameT = Aws::String>
  CreateMarketplaceRevenueShareAllocationResult& WithProductName(ProductNameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateMarketplaceRevenueShareAllocationResult& WithArn(ArnT&& value) {
  ...
  template <typename EffectiveFromT = Aws::String>
  CreateMarketplaceRevenueShareAllocationResult& WithEffectiveFrom(EffectiveFromT&& value) {
  ...
  template <typename EffectiveUntilT = Aws::String>
  CreateMarketplaceRevenueShareAllocationResult& WithEffectiveUntil(EffectiveUntilT&& value) {
  ...
  template <typename RevenueSharePercentT = Aws::String>
  CreateMarketplaceRevenueShareAllocationResult& WithRevenueSharePercent(RevenueSharePercentT&& value) {
  ...
  inline CreateMarketplaceRevenueShareAllocationResult& WithStatus(AllocationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  CreateMarketplaceRevenueShareAllocationResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::Utils::DateTime>
  CreateMarketplaceRevenueShareAllocationResult& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename LatestMarketplaceRevenueShareRevisionT = Aws::String>
  CreateMarketplaceRevenueShareAllocationResult& WithLatestMarketplaceRevenueShareRevision(LatestMarketplaceRevenueShareRevisionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateMarketplaceRevenueShareAllocationResult& WithRequestId(RequestIdT&& value) {
