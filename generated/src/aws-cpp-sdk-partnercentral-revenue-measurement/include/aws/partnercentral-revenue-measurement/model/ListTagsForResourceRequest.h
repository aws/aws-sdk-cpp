...
/**
 */
class ListTagsForResourceRequest : public PartnerCentralRevenueMeasurementRequest {
 public:
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API ListTagsForResourceRequest() = default;
