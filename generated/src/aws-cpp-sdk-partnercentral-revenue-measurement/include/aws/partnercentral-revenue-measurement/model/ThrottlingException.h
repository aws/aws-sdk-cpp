...
/**
 * <p>The request was throttled due to too many requests. Retry your
 * request.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/partnercentral-revenue-measurement-2022-07-26/ThrottlingException">AWS
 * API Reference</a></p>
 */
class ThrottlingException {
 public:
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API ThrottlingException() = default;
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API ThrottlingException(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API ThrottlingException& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
