...
namespace Model {
class GetMarketplaceRevenueShareAllocationResult {
 public:
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API GetMarketplaceRevenueShareAllocationResult() = default;
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API GetMarketplaceRevenueShareAllocationResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API GetMarketplaceRevenueShareAllocationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename MarketplaceRevenueShareAllocationIdT = Aws::String>
  GetMarketplaceRevenueShareAllocationResult& WithMarketplaceRevenueShareAllocationId(MarketplaceRevenueShareAllocationIdT&& value) {
  ...
  template <typename ProductIdT = Aws::String>
  GetMarketplaceRevenueShareAllocationResult& WithProductId(ProductIdT&& value) {
  ...
  template <typename ProductNameT = Aws::String>
  GetMarketplaceRevenueShareAllocationResult& WithProductName(ProductNameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  GetMarketplaceRevenueShareAllocationResult& WithArn(ArnT&& value) {
  ...
  template <typename EffectiveFromT = Aws::String>
  GetMarketplaceRevenueShareAllocationResult& WithEffectiveFrom(EffectiveFromT&& value) {
  ...
  template <typename EffectiveUntilT = Aws::String>
  GetMarketplaceRevenueShareAllocationResult& WithEffectiveUntil(EffectiveUntilT&& value) {
  ...
  template <typename RevenueSharePercentT = Aws::String>
  GetMarketplaceRevenueShareAllocationResult& WithRevenueSharePercent(RevenueSharePercentT&& value) {
  ...
  inline GetMarketplaceRevenueShareAllocationResult& WithStatus(AllocationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedDateT = Aws::Utils::DateTime>
  GetMarketplaceRevenueShareAllocationResult& WithCreatedDate(CreatedDateT&& value) {
  ...
  template <typename LastModifiedDateT = Aws::Utils::DateTime>
  GetMarketplaceRevenueShareAllocationResult& WithLastModifiedDate(LastModifiedDateT&& value) {
  ...
  template <typename LatestMarketplaceRevenueShareRevisionT = Aws::String>
  GetMarketplaceRevenueShareAllocationResult& WithLatestMarketplaceRevenueShareRevision(LatestMarketplaceRevenueShareRevisionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetMarketplaceRevenueShareAllocationResult& WithRequestId(RequestIdT&& value) {
