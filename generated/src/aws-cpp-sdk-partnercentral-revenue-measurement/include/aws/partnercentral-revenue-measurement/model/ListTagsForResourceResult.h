...
class ListTagsForResourceResult {
 public:
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API ListTagsForResourceResult() = default;
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API ListTagsForResourceResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_PARTNERCENTRALREVENUEMEASUREMENT_API ListTagsForResourceResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
