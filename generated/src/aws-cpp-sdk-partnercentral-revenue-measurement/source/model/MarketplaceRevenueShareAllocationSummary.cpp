...
MarketplaceRevenueShareAllocationSummary::MarketplaceRevenueShareAllocationSummary(
    const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  *this = decoder;
}

MarketplaceRevenueShareAllocationSummary& MarketplaceRevenueShareAllocationSummary::operator=(
    const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  if (decoder != nullptr) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("MarketplaceRevenueShareAllocationSummary", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void MarketplaceRevenueShareAllocationSummary::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
  ...
  if (m_productNameHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("ProductName"));
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(m_productName.c_str()));
  }
