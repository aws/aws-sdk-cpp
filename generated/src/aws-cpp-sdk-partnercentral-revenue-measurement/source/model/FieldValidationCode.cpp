...
static const int INVALID_NUMBER_FORMAT_HASH = HashingUtils::HashString("INVALID_NUMBER_FORMAT");
static const int INVALID_STRING_LENGTH_HASH = HashingUtils::HashString("INVALID_STRING_LENGTH");
...
FieldValidationCode GetFieldValidationCodeForName(const Aws::String& name) {
  ...
  } else if (hashCode == INVALID_NUMBER_FORMAT_HASH) {
    return FieldValidationCode::INVALID_NUMBER_FORMAT;
  } else if (hashCode == INVALID_STRING_LENGTH_HASH) {
    return FieldValidationCode::INVALID_STRING_LENGTH;
  }
...
Aws::String GetNameForFieldValidationCode(FieldValidationCode enumValue) {
  switch (enumValue) {
    ...
    case FieldValidationCode::INVALID_NUMBER_FORMAT:
      return "INVALID_NUMBER_FORMAT";
    case FieldValidationCode::INVALID_STRING_LENGTH:
