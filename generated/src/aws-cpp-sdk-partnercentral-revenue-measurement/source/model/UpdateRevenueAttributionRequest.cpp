...
Aws::String UpdateRevenueAttributionRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection UpdateRevenueAttributionRequest::GetRequestSpecificHeaders() const {
