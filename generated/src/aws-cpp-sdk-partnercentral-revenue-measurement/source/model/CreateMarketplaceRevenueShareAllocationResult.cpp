...
CreateMarketplaceRevenueShareAllocationResult::CreateMarketplaceRevenueShareAllocationResult(
    const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

CreateMarketplaceRevenueShareAllocationResult& CreateMarketplaceRevenueShareAllocationResult::operator=(
    const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "MarketplaceRevenueShareAllocationId") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_marketplaceRevenueShareAllocationId = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
                    ...
                    m_marketplaceRevenueShareAllocationId = ss.str();
                  }
                }
                m_marketplaceRevenueShareAllocationIdHasBeenSet = true;
              }

              else if (initialKeyStr == "ProductId") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
              ...
              else if (initialKeyStr == "LatestMarketplaceRevenueShareRevision") {
                auto peekType = decoder->PeekType();
                if (peekType.has_value()) {
                  if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                    auto val = decoder->PopNextTextVal();
                    if (val.has_value()) {
                      m_latestMarketplaceRevenueShareRevision =
                          Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                    }
                  } else {
                    decoder->ConsumeNextSingleElement();
                    ...
                    m_latestMarketplaceRevenueShareRevision = ss.str();
                  }
                }
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("CreateMarketplaceRevenueShareAllocationResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
            ...
            if (initialKeyStr == "MarketplaceRevenueShareAllocationId") {
              ...
              if (peekType.has_value()) {
                if (peekType.value() == Aws::Crt::Cbor::CborType::Text) {
                  auto val = decoder->PopNextTextVal();
                  if (val.has_value()) {
                    m_latestMarketplaceRevenueShareRevision = Aws::String(reinterpret_cast<const char*>(val.value().ptr), val.value().len);
                  }
                } else {
                  decoder->ConsumeNextSingleElement();
                  Aws::StringStream ss;
