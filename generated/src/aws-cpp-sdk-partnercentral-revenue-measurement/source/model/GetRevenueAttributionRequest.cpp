...
Aws::String GetRevenueAttributionRequest::SerializePayload() const {
  ...
  if (m_revisionHasBeenSet) {
    ...
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(m_revision.c_str()));
  }
  const auto str = Aws::String(reinterpret_cast<char*>(encoder.GetEncodedData().ptr), encoder.GetEncodedData().len);
  return str;
}

Aws::Http::HeaderValueCollection GetRevenueAttributionRequest::GetRequestSpecificHeaders() const {
