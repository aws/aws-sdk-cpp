...
Aws::String GetRevenueAttributionAllocationsTaskRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection GetRevenueAttributionAllocationsTaskRequest::GetRequestSpecificHeaders() const {
