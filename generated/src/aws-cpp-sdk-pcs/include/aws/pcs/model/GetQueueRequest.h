...
namespace Model
{
  ...
  public:
    ...
    template<typename ClusterIdentifierT = Aws::String>
    GetQueueRequest& WithClusterIdentifier(ClusterIdentifierT&& value) { SetClusterIdentifier(std::forward<ClusterIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename QueueIdentifierT = Aws::String>
    GetQueueRequest& WithQueueIdentifier(QueueIdentifierT&& value) { SetQueueIdentifier(std::forward<QueueIdentifierT>(value)); return *this;}
    ///@}
  private:
