...
/**
 * <p>The lifecycle actions to configure on a compute node group when you create
 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/pcs-2023-02-10/NodeLifecycleActionsRequest">AWS
 * API Reference</a></p>
 */
class NodeLifecycleActionsRequest {
 public:
  ...
  inline NodeLifecycleActionsRequest& WithScriptCachingPolicy(ScriptCachingPolicy value) {
