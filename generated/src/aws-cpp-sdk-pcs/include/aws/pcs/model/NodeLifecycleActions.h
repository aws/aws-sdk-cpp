...
/**
 * <p>The lifecycle actions configured on a compute node group. Lifecycle actions
 * define scripts that PCS runs on compute nodes at specific stages of their
 * lifecycle.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/pcs-2023-02-10/NodeLifecycleActions">AWS
 * API Reference</a></p>
 */
class NodeLifecycleActions {
 public:
  ...
  inline NodeLifecycleActions& WithScriptCachingPolicy(ScriptCachingPolicy value) {
