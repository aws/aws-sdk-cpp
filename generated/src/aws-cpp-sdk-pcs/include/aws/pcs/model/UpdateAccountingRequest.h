...
namespace Model
{
   ...
   * accounting.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pcs-2023-02-10/UpdateAccountingRequest">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline UpdateAccountingRequest& WithDefaultPurgeTimeInDays(int value) { SetDefaultPurgeTimeInDays(value); return *this;}
    ///@}
    ...
    inline UpdateAccountingRequest& WithMode(AccountingMode value) { SetMode(value); return *this;}
    ///@}
  private:
