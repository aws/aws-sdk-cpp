...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pcs-2023-02-10/UpdateQueueSlurmConfigurationRequest">AWS
   * API Reference</a></p>
   */
  class UpdateQueueSlurmConfigurationRequest
  {
  public:
    AWS_PCS_API UpdateQueueSlurmConfigurationRequest() = default;
    AWS_PCS_API UpdateQueueSlurmConfigurationRequest(Aws::Utils::Json::JsonView jsonValue);
    AWS_PCS_API UpdateQueueSlurmConfigurationRequest& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename SlurmCustomSettingsT = Aws::Vector<SlurmCustomSetting>>
    UpdateQueueSlurmConfigurationRequest& WithSlurmCustomSettings(SlurmCustomSettingsT&& value) { SetSlurmCustomSettings(std::forward<SlurmCustomSettingsT>(value)); return *this;}
    template<typename SlurmCustomSettingsT = SlurmCustomSetting>
    UpdateQueueSlurmConfigurationRequest& AddSlurmCustomSettings(SlurmCustomSettingsT&& value) { m_slurmCustomSettingsHasBeenSet = true; m_slurmCustomSettings.emplace_back(std::forward<SlurmCustomSettingsT>(value)); return *this; }
    ///@}
  private:
