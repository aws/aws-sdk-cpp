...
class UpdateQueueSlurmConfigurationRequest {
 public:
  ...
  template <typename SlurmCustomSettingsT = Aws::Vector<SlurmCustomSetting>>
  UpdateQueueSlurmConfigurationRequest& WithSlurmCustomSettings(SlurmCustomSettingsT&& value) {
    SetSlurmCustomSettings(std::forward<SlurmCustomSettingsT>(value));
    return *this;
  }
  template <typename SlurmCustomSettingsT = SlurmCustomSetting>
  UpdateQueueSlurmConfigurationRequest& AddSlurmCustomSettings(SlurmCustomSettingsT&& value) {
    m_slurmCustomSettingsHasBeenSet = true;
