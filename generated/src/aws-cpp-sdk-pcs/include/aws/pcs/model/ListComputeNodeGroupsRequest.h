...
class ListComputeNodeGroupsRequest : public PCSRequest {
 public:
  AWS_PCS_API ListComputeNodeGroupsRequest() = default;
  ...
  template <typename ClusterIdentifierT = Aws::String>
  ListComputeNodeGroupsRequest& WithClusterIdentifier(ClusterIdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListComputeNodeGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListComputeNodeGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
