...
namespace Model
{
  ...
  /**
   * <p>The requested resource can't be found. The cluster, node group, or queue
   * you're attempting to get, update, list, or delete doesn't exist.</p> <p>
   * <u>Examples</u> </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pcs-2023-02-10/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_PCS_API ResourceNotFoundException() = default;
    AWS_PCS_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_PCS_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
