...
class UpdateClusterResult {
 public:
  AWS_PCS_API UpdateClusterResult() = default;
  AWS_PCS_API UpdateClusterResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PCS_API UpdateClusterResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
