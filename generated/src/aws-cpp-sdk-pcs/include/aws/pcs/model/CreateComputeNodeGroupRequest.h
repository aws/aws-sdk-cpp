...
class CreateComputeNodeGroupRequest : public PCSRequest {
 public:
  ...
  inline CreateComputeNodeGroupRequest& WithPurchaseOption(PurchaseOption value) {
