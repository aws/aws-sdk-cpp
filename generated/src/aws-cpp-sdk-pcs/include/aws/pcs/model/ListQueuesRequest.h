...
namespace Model
{
  ...
  /**
   */
  class ListQueuesRequest : public PCSRequest
  {
  public:
    ...
    template<typename ClusterIdentifierT = Aws::String>
    ListQueuesRequest& WithClusterIdentifier(ClusterIdentifierT&& value) { SetClusterIdentifier(std::forward<ClusterIdentifierT>(value)); return *this;}
    ///@}
