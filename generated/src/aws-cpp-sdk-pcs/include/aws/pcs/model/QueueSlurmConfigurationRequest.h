...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pcs-2023-02-10/QueueSlurmConfigurationRequest">AWS
   * API Reference</a></p>
   */
  class QueueSlurmConfigurationRequest
  {
  public:
    AWS_PCS_API QueueSlurmConfigurationRequest() = default;
    AWS_PCS_API QueueSlurmConfigurationRequest(Aws::Utils::Json::JsonView jsonValue);
    AWS_PCS_API QueueSlurmConfigurationRequest& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename SlurmCustomSettingsT = Aws::Vector<SlurmCustomSetting>>
    QueueSlurmConfigurationRequest& WithSlurmCustomSettings(SlurmCustomSettingsT&& value) { SetSlurmCustomSettings(std::forward<SlurmCustomSettingsT>(value)); return *this;}
    template<typename SlurmCustomSettingsT = SlurmCustomSetting>
    QueueSlurmConfigurationRequest& AddSlurmCustomSettings(SlurmCustomSettingsT&& value) { m_slurmCustomSettingsHasBeenSet = true; m_slurmCustomSettings.emplace_back(std::forward<SlurmCustomSettingsT>(value)); return *this; }
    ///@}
  private:
