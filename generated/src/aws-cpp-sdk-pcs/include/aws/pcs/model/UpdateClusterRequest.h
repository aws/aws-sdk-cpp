...
namespace Model
{
  ...
  public:
    ...
    template<typename ClusterIdentifierT = Aws::String>
    UpdateClusterRequest& WithClusterIdentifier(ClusterIdentifierT&& value) { SetClusterIdentifier(std::forward<ClusterIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename SlurmConfigurationT = UpdateClusterSlurmConfigurationRequest>
    UpdateClusterRequest& WithSlurmConfiguration(SlurmConfigurationT&& value) { SetSlurmConfiguration(std::forward<SlurmConfigurationT>(value)); return *this;}
    ///@}
  private:
