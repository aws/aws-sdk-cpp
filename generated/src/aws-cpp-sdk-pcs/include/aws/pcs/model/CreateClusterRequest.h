...
class CreateClusterRequest : public PCSRequest {
 public:
  ...
  inline void SetSize(Size value) {
    m_sizeHasBeenSet = true;
    m_size = value;
  }
  inline CreateClusterRequest& WithSize(Size value) {
    SetSize(value);
    return *this;
  }
  ///@}
  ...
  void SetNetworking(NetworkingT&& value) {
    ...
    m_networking = std::forward<NetworkingT>(value);
  }
  template <typename NetworkingT = NetworkingRequest>
  CreateClusterRequest& WithNetworking(NetworkingT&& value) {
    SetNetworking(std::forward<NetworkingT>(value));
    return *this;
  }
  ///@}
