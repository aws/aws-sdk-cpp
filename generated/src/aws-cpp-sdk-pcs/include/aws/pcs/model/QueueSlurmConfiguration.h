...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pcs-2023-02-10/QueueSlurmConfiguration">AWS
   * API Reference</a></p>
   */
  class QueueSlurmConfiguration
  {
  public:
    AWS_PCS_API QueueSlurmConfiguration() = default;
    AWS_PCS_API QueueSlurmConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AWS_PCS_API QueueSlurmConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename SlurmCustomSettingsT = Aws::Vector<SlurmCustomSetting>>
    QueueSlurmConfiguration& WithSlurmCustomSettings(SlurmCustomSettingsT&& value) { SetSlurmCustomSettings(std::forward<SlurmCustomSettingsT>(value)); return *this;}
    template<typename SlurmCustomSettingsT = SlurmCustomSetting>
    QueueSlurmConfiguration& AddSlurmCustomSettings(SlurmCustomSettingsT&& value) { m_slurmCustomSettingsHasBeenSet = true; m_slurmCustomSettings.emplace_back(std::forward<SlurmCustomSettingsT>(value)); return *this; }
    ///@}
  private:
