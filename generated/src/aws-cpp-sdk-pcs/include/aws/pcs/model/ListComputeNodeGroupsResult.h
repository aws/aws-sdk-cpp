...
class ListComputeNodeGroupsResult {
 public:
  ...
  void SetComputeNodeGroups(ComputeNodeGroupsT&& value) {
    m_computeNodeGroupsHasBeenSet = true;
    m_computeNodeGroups = std::forward<ComputeNodeGroupsT>(value);
  }
  template <typename ComputeNodeGroupsT = Aws::Vector<ComputeNodeGroupSummary>>
  ListComputeNodeGroupsResult& WithComputeNodeGroups(ComputeNodeGroupsT&& value) {
    SetComputeNodeGroups(std::forward<ComputeNodeGroupsT>(value));
    return *this;
  }
  template <typename ComputeNodeGroupsT = ComputeNodeGroupSummary>
  ListComputeNodeGroupsResult& AddComputeNodeGroups(ComputeNodeGroupsT&& value) {
    m_computeNodeGroupsHasBeenSet = true;
    m_computeNodeGroups.emplace_back(std::forward<ComputeNodeGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListComputeNodeGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListComputeNodeGroupsResult& WithRequestId(RequestIdT&& value) {
