...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public PCSRequest
  {
  public:
    AWS_PCS_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>1 or more tag keys to remove from the resource. Specify only tag keys and not
     * tag values.</p>
     */
