...
namespace Model
{
  ...
  /**
   * <p>The request isn't valid.</p> <p> <u>Examples</u> </p> <ul> <li> <p>Your
   * request contains malformed JSON or unsupported characters.</p> </li> <li> <p>The
   * scheduler version isn't supported.</p> </li> <li> <p>There are networking
   * related errors, such as network validation failure.</p> </li> <li> <p>AMI type
   * is <code>CUSTOM</code> and the launch template doesn't define the AMI ID, or the
   * AMI type is AL2 and the launch template defines the AMI.</p> </li>
   * </ul><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pcs-2023-02-10/ValidationException">AWS
   * API Reference</a></p>
   */
  class ValidationException
  {
  public:
    AWS_PCS_API ValidationException();
