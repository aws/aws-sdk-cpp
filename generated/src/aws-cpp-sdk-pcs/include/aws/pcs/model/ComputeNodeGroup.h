...
class ComputeNodeGroup {
 public:
  ...
  inline void SetStatus(ComputeNodeGroupStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ComputeNodeGroup& WithStatus(ComputeNodeGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ComputeNodeGroup& WithPurchaseOption(PurchaseOption value) {
