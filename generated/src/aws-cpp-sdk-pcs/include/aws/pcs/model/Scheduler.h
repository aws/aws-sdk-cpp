...
class Scheduler {
 public:
  ...
  inline void SetType(SchedulerType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Scheduler& WithType(SchedulerType value) {
    SetType(value);
    return *this;
  }
  ///@}
   ...
   * the scheduler version on a cluster</a> and <a
   ...
   * <code>23.11 | 24.05 | 24.11 | 25.05 | 25.11 | 26.05</code> </p>
   */
