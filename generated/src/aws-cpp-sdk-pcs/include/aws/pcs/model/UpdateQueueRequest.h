...
namespace Model
{
  ...
  public:
     ...
     */
    inline const UpdateQueueSlurmConfigurationRequest& GetSlurmConfiguration() const { return m_slurmConfiguration; }
    inline bool SlurmConfigurationHasBeenSet() const { return m_slurmConfigurationHasBeenSet; }
    template<typename SlurmConfigurationT = UpdateQueueSlurmConfigurationRequest>
    ...
    template<typename SlurmConfigurationT = UpdateQueueSlurmConfigurationRequest>
    UpdateQueueRequest& WithSlurmConfiguration(SlurmConfigurationT&& value) { SetSlurmConfiguration(std::forward<SlurmConfigurationT>(value)); return *this;}
    ///@}
