...
class AWS_PCS_API PCSClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  PCSClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<PCSEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CreateComputeNodeGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateComputeNodeGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateComputeNodeGroupRequestT = Model::CreateComputeNodeGroupRequest>
  void CreateComputeNodeGroupAsync(const CreateComputeNodeGroupRequestT& request,
                                   const CreateComputeNodeGroupResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteComputeNodeGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteComputeNodeGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteComputeNodeGroupRequestT = Model::DeleteComputeNodeGroupRequest>
  void DeleteComputeNodeGroupAsync(const DeleteComputeNodeGroupRequestT& request,
                                   const DeleteComputeNodeGroupResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetComputeNodeGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetComputeNodeGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetComputeNodeGroupRequestT = Model::GetComputeNodeGroupRequest>
  void GetComputeNodeGroupAsync(const GetComputeNodeGroupRequestT& request, const GetComputeNodeGroupResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetQueue that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetQueueRequestT = Model::GetQueueRequest>
  void GetQueueAsync(const GetQueueRequestT& request, const GetQueueResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListComputeNodeGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListComputeNodeGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListComputeNodeGroupsRequestT = Model::ListComputeNodeGroupsRequest>
  void ListComputeNodeGroupsAsync(const ListComputeNodeGroupsRequestT& request, const ListComputeNodeGroupsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterComputeNodeGroupInstanceOutcome RegisterComputeNodeGroupInstance(
      const Model::RegisterComputeNodeGroupInstanceRequest& request) const;

  /**
   * A Callable wrapper for RegisterComputeNodeGroupInstance that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename RegisterComputeNodeGroupInstanceRequestT = Model::RegisterComputeNodeGroupInstanceRequest>
  Model::RegisterComputeNodeGroupInstanceOutcomeCallable RegisterComputeNodeGroupInstanceCallable(
      const RegisterComputeNodeGroupInstanceRequestT& request) const {
    return SubmitCallable(&PCSClient::RegisterComputeNodeGroupInstance, request);
  }

  /**
   * An Async wrapper for RegisterComputeNodeGroupInstance that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RegisterComputeNodeGroupInstanceRequestT = Model::RegisterComputeNodeGroupInstanceRequest>
  void RegisterComputeNodeGroupInstanceAsync(const RegisterComputeNodeGroupInstanceRequestT& request,
                                             const RegisterComputeNodeGroupInstanceResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateComputeNodeGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateComputeNodeGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateComputeNodeGroupRequestT = Model::UpdateComputeNodeGroupRequest>
  void UpdateComputeNodeGroupAsync(const UpdateComputeNodeGroupRequestT& request,
                                   const UpdateComputeNodeGroupResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateQueue that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateQueueRequestT = Model::UpdateQueueRequest>
  void UpdateQueueAsync(const UpdateQueueRequestT& request, const UpdateQueueResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
