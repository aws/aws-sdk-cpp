...
SlurmRestRequest::SlurmRestRequest(JsonView jsonValue) { *this = jsonValue; }

SlurmRestRequest& SlurmRestRequest::operator=(JsonView jsonValue) {
...
JsonValue SlurmRestRequest::Jsonize() const {
  JsonValue payload;
