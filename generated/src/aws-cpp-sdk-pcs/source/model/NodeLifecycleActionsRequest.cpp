...
NodeLifecycleActionsRequest::NodeLifecycleActionsRequest(JsonView jsonValue) { *this = jsonValue; }

NodeLifecycleActionsRequest& NodeLifecycleActionsRequest::operator=(JsonView jsonValue) {
...
JsonValue NodeLifecycleActionsRequest::Jsonize() const {
  JsonValue payload;
