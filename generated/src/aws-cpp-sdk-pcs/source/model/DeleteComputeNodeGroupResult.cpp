...
DeleteComputeNodeGroupResult::DeleteComputeNodeGroupResult()
{
}

DeleteComputeNodeGroupResult::DeleteComputeNodeGroupResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
