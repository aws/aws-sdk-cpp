...
NodeLifecycleActions::NodeLifecycleActions(JsonView jsonValue) { *this = jsonValue; }

NodeLifecycleActions& NodeLifecycleActions::operator=(JsonView jsonValue) {
...
JsonValue NodeLifecycleActions::Jsonize() const {
  JsonValue payload;
