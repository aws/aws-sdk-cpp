...
GetComputeNodeGroupResult::GetComputeNodeGroupResult()
{
}

GetComputeNodeGroupResult::GetComputeNodeGroupResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
