...
UpdateNetworkConnectorResult::UpdateNetworkConnectorResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateNetworkConnectorResult& UpdateNetworkConnectorResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
