 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/lambda-core-2026-04-30/ResourceConflictException">AWS
 * API Reference</a></p>
 */
class ResourceConflictException {
 public:
  AWS_LAMBDACORE_API ResourceConflictException() = default;
  AWS_LAMBDACORE_API ResourceConflictException(Aws::Utils::Json::JsonView jsonValue);
  AWS_LAMBDACORE_API ResourceConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
