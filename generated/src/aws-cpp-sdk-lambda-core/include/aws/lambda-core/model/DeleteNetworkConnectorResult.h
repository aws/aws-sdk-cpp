...
namespace Model {
class DeleteNetworkConnectorResult {
 public:
  AWS_LAMBDACORE_API DeleteNetworkConnectorResult() = default;
  AWS_LAMBDACORE_API DeleteNetworkConnectorResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_LAMBDACORE_API DeleteNetworkConnectorResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ArnT = Aws::String>
  DeleteNetworkConnectorResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteNetworkConnectorResult& WithName(NameT&& value) {
  ...
  template <typename IdT = Aws::String>
  DeleteNetworkConnectorResult& WithId(IdT&& value) {
  ...
  template <typename ConfigurationT = NetworkConnectorConfiguration>
  DeleteNetworkConnectorResult& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename OperatorRoleT = Aws::String>
  DeleteNetworkConnectorResult& WithOperatorRole(OperatorRoleT&& value) {
  ...
  ///@{
  /**
   * <p>The current state of the network connector. The State field is typically
   * <code>DELETING</code> after this call.</p>
   */
  ...
  inline DeleteNetworkConnectorResult& WithState(NetworkConnectorState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteNetworkConnectorResult& WithRequestId(RequestIdT&& value) {
