...
class KeyspacesRow {
 public:
  ...
  void SetValueCells(ValueCellsT&& value) {
    ...
    m_valueCells = std::forward<ValueCellsT>(value);
  }
  template <typename ValueCellsT = Aws::Map<Aws::String, KeyspacesCell>>
  KeyspacesRow& WithValueCells(ValueCellsT&& value) {
    SetValueCells(std::forward<ValueCellsT>(value));
    return *this;
  }
  ...
  KeyspacesRow& AddValueCells(ValueCellsKeyT&& key, ValueCellsValueT&& value) {
    m_valueCellsHasBeenSet = true;
    m_valueCells.emplace(std::forward<ValueCellsKeyT>(key), std::forward<ValueCellsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStaticCells(StaticCellsT&& value) {
    ...
    m_staticCells = std::forward<StaticCellsT>(value);
  }
  template <typename StaticCellsT = Aws::Map<Aws::String, KeyspacesCell>>
  KeyspacesRow& WithStaticCells(StaticCellsT&& value) {
    SetStaticCells(std::forward<StaticCellsT>(value));
    return *this;
  }
  ...
  KeyspacesRow& AddStaticCells(StaticCellsKeyT&& key, StaticCellsValueT&& value) {
    m_staticCellsHasBeenSet = true;
    m_staticCells.emplace(std::forward<StaticCellsKeyT>(key), std::forward<StaticCellsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRowMetadata(RowMetadataT&& value) {
    ...
    m_rowMetadata = std::forward<RowMetadataT>(value);
  }
  template <typename RowMetadataT = KeyspacesMetadata>
  KeyspacesRow& WithRowMetadata(RowMetadataT&& value) {
    SetRowMetadata(std::forward<RowMetadataT>(value));
    return *this;
  }
  ///@}
 private:
