...
class KeyspacesCellValue {
 public:
  ...
  void SetAsciiT(AsciiTT&& value) {
    ...
    m_asciiT = std::forward<AsciiTT>(value);
  }
  template <typename AsciiTT = Aws::String>
  KeyspacesCellValue& WithAsciiT(AsciiTT&& value) {
    SetAsciiT(std::forward<AsciiTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBigintT(BigintTT&& value) {
    ...
    m_bigintT = std::forward<BigintTT>(value);
  }
  template <typename BigintTT = Aws::String>
  KeyspacesCellValue& WithBigintT(BigintTT&& value) {
    SetBigintT(std::forward<BigintTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBlobT(BlobTT&& value) {
    ...
    m_blobT = std::forward<BlobTT>(value);
  }
  template <typename BlobTT = Aws::Utils::ByteBuffer>
  KeyspacesCellValue& WithBlobT(BlobTT&& value) {
    SetBlobT(std::forward<BlobTT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBoolT(bool value) {
    m_boolTHasBeenSet = true;
    m_boolT = value;
  }
  inline KeyspacesCellValue& WithBoolT(bool value) {
    SetBoolT(value);
    return *this;
  }
  ///@}
  ...
  void SetCounterT(CounterTT&& value) {
    ...
    m_counterT = std::forward<CounterTT>(value);
  }
  template <typename CounterTT = Aws::String>
  KeyspacesCellValue& WithCounterT(CounterTT&& value) {
    SetCounterT(std::forward<CounterTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateT(DateTT&& value) {
    ...
    m_dateT = std::forward<DateTT>(value);
  }
  template <typename DateTT = Aws::String>
  KeyspacesCellValue& WithDateT(DateTT&& value) {
    SetDateT(std::forward<DateTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDecimalT(DecimalTT&& value) {
    ...
    m_decimalT = std::forward<DecimalTT>(value);
  }
  template <typename DecimalTT = Aws::String>
  KeyspacesCellValue& WithDecimalT(DecimalTT&& value) {
    SetDecimalT(std::forward<DecimalTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDoubleT(DoubleTT&& value) {
    ...
    m_doubleT = std::forward<DoubleTT>(value);
  }
  template <typename DoubleTT = Aws::String>
  KeyspacesCellValue& WithDoubleT(DoubleTT&& value) {
    SetDoubleT(std::forward<DoubleTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFloatT(FloatTT&& value) {
    ...
    m_floatT = std::forward<FloatTT>(value);
  }
  template <typename FloatTT = Aws::String>
  KeyspacesCellValue& WithFloatT(FloatTT&& value) {
    SetFloatT(std::forward<FloatTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInetT(InetTT&& value) {
    ...
    m_inetT = std::forward<InetTT>(value);
  }
  template <typename InetTT = Aws::String>
  KeyspacesCellValue& WithInetT(InetTT&& value) {
    SetInetT(std::forward<InetTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntT(IntTT&& value) {
    ...
    m_intT = std::forward<IntTT>(value);
  }
  template <typename IntTT = Aws::String>
  KeyspacesCellValue& WithIntT(IntTT&& value) {
    SetIntT(std::forward<IntTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSmallintT(SmallintTT&& value) {
    ...
    m_smallintT = std::forward<SmallintTT>(value);
  }
  template <typename SmallintTT = Aws::String>
  KeyspacesCellValue& WithSmallintT(SmallintTT&& value) {
    SetSmallintT(std::forward<SmallintTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextT(TextTT&& value) {
    ...
    m_textT = std::forward<TextTT>(value);
  }
  template <typename TextTT = Aws::String>
  KeyspacesCellValue& WithTextT(TextTT&& value) {
    SetTextT(std::forward<TextTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeT(TimeTT&& value) {
    ...
    m_timeT = std::forward<TimeTT>(value);
  }
  template <typename TimeTT = Aws::String>
  KeyspacesCellValue& WithTimeT(TimeTT&& value) {
    SetTimeT(std::forward<TimeTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimestampT(TimestampTT&& value) {
    ...
    m_timestampT = std::forward<TimestampTT>(value);
  }
  template <typename TimestampTT = Aws::String>
  KeyspacesCellValue& WithTimestampT(TimestampTT&& value) {
    SetTimestampT(std::forward<TimestampTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeuuidT(TimeuuidTT&& value) {
    ...
    m_timeuuidT = std::forward<TimeuuidTT>(value);
  }
  template <typename TimeuuidTT = Aws::String>
  KeyspacesCellValue& WithTimeuuidT(TimeuuidTT&& value) {
    SetTimeuuidT(std::forward<TimeuuidTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTinyintT(TinyintTT&& value) {
    ...
    m_tinyintT = std::forward<TinyintTT>(value);
  }
  template <typename TinyintTT = Aws::String>
  KeyspacesCellValue& WithTinyintT(TinyintTT&& value) {
    SetTinyintT(std::forward<TinyintTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUuidT(UuidTT&& value) {
    ...
    m_uuidT = std::forward<UuidTT>(value);
  }
  template <typename UuidTT = Aws::String>
  KeyspacesCellValue& WithUuidT(UuidTT&& value) {
    SetUuidT(std::forward<UuidTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVarcharT(VarcharTT&& value) {
    ...
    m_varcharT = std::forward<VarcharTT>(value);
  }
  template <typename VarcharTT = Aws::String>
  KeyspacesCellValue& WithVarcharT(VarcharTT&& value) {
    SetVarcharT(std::forward<VarcharTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVarintT(VarintTT&& value) {
    ...
    m_varintT = std::forward<VarintTT>(value);
  }
  template <typename VarintTT = Aws::String>
  KeyspacesCellValue& WithVarintT(VarintTT&& value) {
    SetVarintT(std::forward<VarintTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUdtT(UdtTT&& value) {
    ...
    m_udtT = std::forward<UdtTT>(value);
  }
  template <typename UdtTT = Aws::Map<Aws::String, KeyspacesCell>>
  KeyspacesCellValue& WithUdtT(UdtTT&& value) {
    SetUdtT(std::forward<UdtTT>(value));
    return *this;
  }
  ...
  KeyspacesCellValue& AddUdtT(UdtTKeyT&& key, UdtTValueT&& value) {
    m_udtTHasBeenSet = true;
    m_udtT.emplace(std::forward<UdtTKeyT>(key), std::forward<UdtTValueT>(value));
    return *this;
  }
  ///@}
 private:
