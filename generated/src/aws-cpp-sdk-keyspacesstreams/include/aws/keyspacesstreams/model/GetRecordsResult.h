...
class GetRecordsResult {
 public:
  ...
  void SetChangeRecords(ChangeRecordsT&& value) {
    m_changeRecordsHasBeenSet = true;
    m_changeRecords = std::forward<ChangeRecordsT>(value);
  }
  template <typename ChangeRecordsT = Aws::Vector<Record>>
  GetRecordsResult& WithChangeRecords(ChangeRecordsT&& value) {
    SetChangeRecords(std::forward<ChangeRecordsT>(value));
    return *this;
  }
  template <typename ChangeRecordsT = Record>
  GetRecordsResult& AddChangeRecords(ChangeRecordsT&& value) {
    m_changeRecordsHasBeenSet = true;
    m_changeRecords.emplace_back(std::forward<ChangeRecordsT>(value));
    return *this;
  }
  ///@}
