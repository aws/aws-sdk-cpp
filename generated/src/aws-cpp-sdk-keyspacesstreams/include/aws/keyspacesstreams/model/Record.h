...
class Record {
 public:
  ...
  void SetEventVersion(EventVersionT&& value) {
    ...
    m_eventVersion = std::forward<EventVersionT>(value);
  }
  template <typename EventVersionT = Aws::String>
  Record& WithEventVersion(EventVersionT&& value) {
    SetEventVersion(std::forward<EventVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline Record& WithOrigin(OriginType value) {
    SetOrigin(value);
    return *this;
  }
  ///@}
  ...
  Record& AddPartitionKeys(PartitionKeysKeyT&& key, PartitionKeysValueT&& value) {
    m_partitionKeysHasBeenSet = true;
    m_partitionKeys.emplace(std::forward<PartitionKeysKeyT>(key), std::forward<PartitionKeysValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClusteringKeys(ClusteringKeysT&& value) {
    ...
    m_clusteringKeys = std::forward<ClusteringKeysT>(value);
  }
  template <typename ClusteringKeysT = Aws::Map<Aws::String, KeyspacesCellValue>>
  Record& WithClusteringKeys(ClusteringKeysT&& value) {
    SetClusteringKeys(std::forward<ClusteringKeysT>(value));
    return *this;
  }
  ...
  Record& AddClusteringKeys(ClusteringKeysKeyT&& key, ClusteringKeysValueT&& value) {
    m_clusteringKeysHasBeenSet = true;
    m_clusteringKeys.emplace(std::forward<ClusteringKeysKeyT>(key), std::forward<ClusteringKeysValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewImage(NewImageT&& value) {
    ...
    m_newImage = std::forward<NewImageT>(value);
  }
  template <typename NewImageT = KeyspacesRow>
  Record& WithNewImage(NewImageT&& value) {
    SetNewImage(std::forward<NewImageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOldImage(OldImageT&& value) {
    ...
    m_oldImage = std::forward<OldImageT>(value);
  }
  template <typename OldImageT = KeyspacesRow>
  Record& WithOldImage(OldImageT&& value) {
    SetOldImage(std::forward<OldImageT>(value));
    return *this;
  }
  ///@}
