...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','a','s','s','a','n','d','r','a','-','s',
't','r','e','a','m','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'/','/','c','a','s','s','a','n','d','r','a','-','s','t','r','e','a','m','s','.','{','R','e','g','i',
...
const char* KeyspacesStreamsEndpointRules::GetRulesBlob()
{
