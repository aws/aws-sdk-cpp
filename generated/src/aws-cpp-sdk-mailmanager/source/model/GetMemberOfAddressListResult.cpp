...
GetMemberOfAddressListResult::GetMemberOfAddressListResult()
{
}

GetMemberOfAddressListResult::GetMemberOfAddressListResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
