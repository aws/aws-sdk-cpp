...
IngressIpv6Expression::IngressIpv6Expression(JsonView jsonValue) { *this = jsonValue; }

IngressIpv6Expression& IngressIpv6Expression::operator=(JsonView jsonValue) {
...
JsonValue IngressIpv6Expression::Jsonize() const {
  JsonValue payload;
