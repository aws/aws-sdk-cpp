...
IngressIpv4Expression::IngressIpv4Expression(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) { *this = decoder; }

IngressIpv4Expression& IngressIpv4Expression::operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  if (decoder != nullptr) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "Evaluate") {
                m_evaluate = IngressIpToEvaluate(decoder);
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("IngressIpv4Expression", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void IngressIpv4Expression::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
