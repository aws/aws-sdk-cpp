        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "Name") {
              ...
              else if (initialKeyStr == "Conditions") {
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_conditions.push_back(RuleCondition(decoder));
                      }
                    }
                ...
                if (peekType_0.has_value() &&
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_unless.push_back(RuleCondition(decoder));
                      }
                    }
                  } else  // IndefArrayStart
                  {
                ...
                if (peekType_0.has_value() &&
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_actions.push_back(RuleAction(decoder));
                      }
                    }
                  } else  // IndefArrayStart
                  {
...
void Rule::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  ...
  if (m_conditionsHasBeenSet) {
    encoder.WriteText(Aws::Crt::ByteCursorFromCString("Conditions"));
    encoder.WriteArrayStart(m_conditions.size());
    for (const auto& item_0 : m_conditions) {
