...
ListAddressListImportJobsResult::ListAddressListImportJobsResult()
{
}

ListAddressListImportJobsResult::ListAddressListImportJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListAddressListImportJobsResult& ListAddressListImportJobsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
