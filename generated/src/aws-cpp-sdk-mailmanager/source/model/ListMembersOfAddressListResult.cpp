...
ListMembersOfAddressListResult::ListMembersOfAddressListResult()
{
}

ListMembersOfAddressListResult::ListMembersOfAddressListResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListMembersOfAddressListResult& ListMembersOfAddressListResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
