...
class AWS_MAILMANAGER_API MailManagerClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  MailManagerClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<MailManagerEndpointProviderBase> endpointProvider = nullptr,
      const Aws::MailManager::MailManagerClientConfiguration& clientConfiguration = Aws::MailManager::MailManagerClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateAddonInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAddonInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAddonInstanceRequestT = Model::CreateAddonInstanceRequest>
  void CreateAddonInstanceAsync(const CreateAddonInstanceRequestT& request, const CreateAddonInstanceResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateAddonSubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAddonSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAddonSubscriptionRequestT = Model::CreateAddonSubscriptionRequest>
  void CreateAddonSubscriptionAsync(const CreateAddonSubscriptionRequestT& request,
                                    const CreateAddonSubscriptionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAddressList that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAddressList that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAddressListRequestT = Model::CreateAddressListRequest>
  void CreateAddressListAsync(const CreateAddressListRequestT& request, const CreateAddressListResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAddressListImportJobOutcome CreateAddressListImportJob(
      const Model::CreateAddressListImportJobRequest& request) const;

  /**
   * A Callable wrapper for CreateAddressListImportJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAddressListImportJobRequestT = Model::CreateAddressListImportJobRequest>
  Model::CreateAddressListImportJobOutcomeCallable CreateAddressListImportJobCallable(
      const CreateAddressListImportJobRequestT& request) const {
    return SubmitCallable(&MailManagerClient::CreateAddressListImportJob, request);
  }

  /**
   * An Async wrapper for CreateAddressListImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAddressListImportJobRequestT = Model::CreateAddressListImportJobRequest>
  void CreateAddressListImportJobAsync(const CreateAddressListImportJobRequestT& request,
                                       const CreateAddressListImportJobResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateIngressPoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateIngressPoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateIngressPointRequestT = Model::CreateIngressPointRequest>
  void CreateIngressPointAsync(const CreateIngressPointRequestT& request, const CreateIngressPointResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateRelay that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateRelayRequestT = Model::CreateRelayRequest>
  void CreateRelayAsync(const CreateRelayRequestT& request, const CreateRelayResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAddonInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAddonInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAddonInstanceRequestT = Model::DeleteAddonInstanceRequest>
  void DeleteAddonInstanceAsync(const DeleteAddonInstanceRequestT& request, const DeleteAddonInstanceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAddonSubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAddonSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAddonSubscriptionRequestT = Model::DeleteAddonSubscriptionRequest>
  void DeleteAddonSubscriptionAsync(const DeleteAddonSubscriptionRequestT& request,
                                    const DeleteAddonSubscriptionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAddressList that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAddressList that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAddressListRequestT = Model::DeleteAddressListRequest>
  void DeleteAddressListAsync(const DeleteAddressListRequestT& request, const DeleteAddressListResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteIngressPoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteIngressPoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteIngressPointRequestT = Model::DeleteIngressPointRequest>
  void DeleteIngressPointAsync(const DeleteIngressPointRequestT& request, const DeleteIngressPointResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteRelay that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteRelayRequestT = Model::DeleteRelayRequest>
  void DeleteRelayAsync(const DeleteRelayRequestT& request, const DeleteRelayResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterMemberFromAddressListOutcome DeregisterMemberFromAddressList(
      const Model::DeregisterMemberFromAddressListRequest& request) const;

  /**
   * A Callable wrapper for DeregisterMemberFromAddressList that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeregisterMemberFromAddressListRequestT = Model::DeregisterMemberFromAddressListRequest>
  Model::DeregisterMemberFromAddressListOutcomeCallable DeregisterMemberFromAddressListCallable(
      const DeregisterMemberFromAddressListRequestT& request) const {
    return SubmitCallable(&MailManagerClient::DeregisterMemberFromAddressList, request);
  }

  /**
   * An Async wrapper for DeregisterMemberFromAddressList that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeregisterMemberFromAddressListRequestT = Model::DeregisterMemberFromAddressListRequest>
  void DeregisterMemberFromAddressListAsync(const DeregisterMemberFromAddressListRequestT& request,
                                            const DeregisterMemberFromAddressListResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAddonInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAddonInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAddonInstanceRequestT = Model::GetAddonInstanceRequest>
  void GetAddonInstanceAsync(const GetAddonInstanceRequestT& request, const GetAddonInstanceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAddonSubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAddonSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAddonSubscriptionRequestT = Model::GetAddonSubscriptionRequest>
  void GetAddonSubscriptionAsync(const GetAddonSubscriptionRequestT& request, const GetAddonSubscriptionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAddressList that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAddressListRequestT = Model::GetAddressListRequest>
  void GetAddressListAsync(const GetAddressListRequestT& request, const GetAddressListResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAddressListImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAddressListImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAddressListImportJobRequestT = Model::GetAddressListImportJobRequest>
  void GetAddressListImportJobAsync(const GetAddressListImportJobRequestT& request,
                                    const GetAddressListImportJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetArchive that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetArchiveRequestT = Model::GetArchiveRequest>
  void GetArchiveAsync(const GetArchiveRequestT& request, const GetArchiveResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetArchiveExport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetArchiveExport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetArchiveExportRequestT = Model::GetArchiveExportRequest>
  void GetArchiveExportAsync(const GetArchiveExportRequestT& request, const GetArchiveExportResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetArchiveMessage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetArchiveMessage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetArchiveMessageRequestT = Model::GetArchiveMessageRequest>
  void GetArchiveMessageAsync(const GetArchiveMessageRequestT& request, const GetArchiveMessageResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetArchiveMessageContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetArchiveMessageContent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetArchiveMessageContentRequestT = Model::GetArchiveMessageContentRequest>
  void GetArchiveMessageContentAsync(const GetArchiveMessageContentRequestT& request,
                                     const GetArchiveMessageContentResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetArchiveSearch that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetArchiveSearch that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetArchiveSearchRequestT = Model::GetArchiveSearchRequest>
  void GetArchiveSearchAsync(const GetArchiveSearchRequestT& request, const GetArchiveSearchResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetArchiveSearchResults that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetArchiveSearchResults that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetArchiveSearchResultsRequestT = Model::GetArchiveSearchResultsRequest>
  void GetArchiveSearchResultsAsync(const GetArchiveSearchResultsRequestT& request,
                                    const GetArchiveSearchResultsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetIngressPoint that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetIngressPointRequestT = Model::GetIngressPointRequest>
  void GetIngressPointAsync(const GetIngressPointRequestT& request, const GetIngressPointResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMemberOfAddressList that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMemberOfAddressList that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMemberOfAddressListRequestT = Model::GetMemberOfAddressListRequest>
  void GetMemberOfAddressListAsync(const GetMemberOfAddressListRequestT& request,
                                   const GetMemberOfAddressListResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetRelay that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRelayRequestT = Model::GetRelayRequest>
  void GetRelayAsync(const GetRelayRequestT& request, const GetRelayResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetRuleSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRuleSetRequestT = Model::GetRuleSetRequest>
  void GetRuleSetAsync(const GetRuleSetRequestT& request, const GetRuleSetResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAddonInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAddonInstances that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAddonInstancesRequestT = Model::ListAddonInstancesRequest>
  void ListAddonInstancesAsync(const ListAddonInstancesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListAddonInstancesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListAddonSubscriptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAddonSubscriptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAddonSubscriptionsRequestT = Model::ListAddonSubscriptionsRequest>
  void ListAddonSubscriptionsAsync(const ListAddonSubscriptionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListAddonSubscriptionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListAddressListImportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListAddressListImportJobsRequestT = Model::ListAddressListImportJobsRequest>
  Model::ListAddressListImportJobsOutcomeCallable ListAddressListImportJobsCallable(
      const ListAddressListImportJobsRequestT& request) const {
    return SubmitCallable(&MailManagerClient::ListAddressListImportJobs, request);
  }

  /**
   * An Async wrapper for ListAddressListImportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAddressListImportJobsRequestT = Model::ListAddressListImportJobsRequest>
  void ListAddressListImportJobsAsync(const ListAddressListImportJobsRequestT& request,
                                      const ListAddressListImportJobsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAddressLists that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAddressLists that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAddressListsRequestT = Model::ListAddressListsRequest>
  void ListAddressListsAsync(const ListAddressListsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListAddressListsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListArchiveExports that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListArchiveExports that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListArchiveExportsRequestT = Model::ListArchiveExportsRequest>
  void ListArchiveExportsAsync(const ListArchiveExportsRequestT& request, const ListArchiveExportsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListArchiveSearches that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListArchiveSearches that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListArchiveSearchesRequestT = Model::ListArchiveSearchesRequest>
  void ListArchiveSearchesAsync(const ListArchiveSearchesRequestT& request, const ListArchiveSearchesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListIngressPoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListIngressPoints that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListIngressPointsRequestT = Model::ListIngressPointsRequest>
  void ListIngressPointsAsync(const ListIngressPointsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListIngressPointsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMembersOfAddressList that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMembersOfAddressList that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMembersOfAddressListRequestT = Model::ListMembersOfAddressListRequest>
  void ListMembersOfAddressListAsync(const ListMembersOfAddressListRequestT& request,
                                     const ListMembersOfAddressListResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListRelays that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListRelaysRequestT = Model::ListRelaysRequest>
  void ListRelaysAsync(const ListRelaysResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListRelaysRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterMemberToAddressListOutcome RegisterMemberToAddressList(
      const Model::RegisterMemberToAddressListRequest& request) const;

  /**
   * A Callable wrapper for RegisterMemberToAddressList that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RegisterMemberToAddressListRequestT = Model::RegisterMemberToAddressListRequest>
  Model::RegisterMemberToAddressListOutcomeCallable RegisterMemberToAddressListCallable(
      const RegisterMemberToAddressListRequestT& request) const {
    return SubmitCallable(&MailManagerClient::RegisterMemberToAddressList, request);
  }

  /**
   * An Async wrapper for RegisterMemberToAddressList that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterMemberToAddressListRequestT = Model::RegisterMemberToAddressListRequest>
  void RegisterMemberToAddressListAsync(const RegisterMemberToAddressListRequestT& request,
                                        const RegisterMemberToAddressListResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartAddressListImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartAddressListImportJobRequestT = Model::StartAddressListImportJobRequest>
  Model::StartAddressListImportJobOutcomeCallable StartAddressListImportJobCallable(
      const StartAddressListImportJobRequestT& request) const {
    return SubmitCallable(&MailManagerClient::StartAddressListImportJob, request);
  }

  /**
   * An Async wrapper for StartAddressListImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartAddressListImportJobRequestT = Model::StartAddressListImportJobRequest>
  void StartAddressListImportJobAsync(const StartAddressListImportJobRequestT& request,
                                      const StartAddressListImportJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartArchiveExport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartArchiveExport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartArchiveExportRequestT = Model::StartArchiveExportRequest>
  void StartArchiveExportAsync(const StartArchiveExportRequestT& request, const StartArchiveExportResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartArchiveSearch that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartArchiveSearch that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartArchiveSearchRequestT = Model::StartArchiveSearchRequest>
  void StartArchiveSearchAsync(const StartArchiveSearchRequestT& request, const StartArchiveSearchResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopAddressListImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopAddressListImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopAddressListImportJobRequestT = Model::StopAddressListImportJobRequest>
  void StopAddressListImportJobAsync(const StopAddressListImportJobRequestT& request,
                                     const StopAddressListImportJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopArchiveExport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopArchiveExport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopArchiveExportRequestT = Model::StopArchiveExportRequest>
  void StopArchiveExportAsync(const StopArchiveExportRequestT& request, const StopArchiveExportResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopArchiveSearch that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopArchiveSearch that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopArchiveSearchRequestT = Model::StopArchiveSearchRequest>
  void StopArchiveSearchAsync(const StopArchiveSearchRequestT& request, const StopArchiveSearchResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateIngressPoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateIngressPoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateIngressPointRequestT = Model::UpdateIngressPointRequest>
  void UpdateIngressPointAsync(const UpdateIngressPointRequestT& request, const UpdateIngressPointResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateRelay that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateRelayRequestT = Model::UpdateRelayRequest>
  void UpdateRelayAsync(const UpdateRelayRequestT& request, const UpdateRelayResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateTrafficPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTrafficPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateTrafficPolicyRequestT = Model::UpdateTrafficPolicyRequest>
  void UpdateTrafficPolicyAsync(const UpdateTrafficPolicyRequestT& request, const UpdateTrafficPolicyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
