...
class ArchiveStringExpression {
 public:
  ...
  AWS_MAILMANAGER_API ArchiveStringExpression(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API ArchiveStringExpression& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetOperator(ArchiveStringOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline ArchiveStringExpression& WithOperator(ArchiveStringOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
