...
class CreateTrafficPolicyRequest : public MailManagerRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTrafficPolicyRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TrafficPolicyNameT = Aws::String>
  CreateTrafficPolicyRequest& WithTrafficPolicyName(TrafficPolicyNameT&& value) {
  ...
  template <typename PolicyStatementsT = Aws::Vector<PolicyStatement>>
  CreateTrafficPolicyRequest& WithPolicyStatements(PolicyStatementsT&& value) {
    SetPolicyStatements(std::forward<PolicyStatementsT>(value));
    return *this;
  }
  template <typename PolicyStatementsT = PolicyStatement>
  CreateTrafficPolicyRequest& AddPolicyStatements(PolicyStatementsT&& value) {
    m_policyStatementsHasBeenSet = true;
  ...
  inline CreateTrafficPolicyRequest& WithDefaultAction(AcceptAction value) {
  ...
  inline CreateTrafficPolicyRequest& WithMaxMessageSizeBytes(int value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateTrafficPolicyRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateTrafficPolicyRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
