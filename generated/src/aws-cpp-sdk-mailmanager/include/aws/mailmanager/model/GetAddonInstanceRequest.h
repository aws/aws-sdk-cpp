...
namespace Model
{
  ...
  {
  public:
    AWS_MAILMANAGER_API GetAddonInstanceRequest() = default;
    ...
    template<typename AddonInstanceIdT = Aws::String>
    GetAddonInstanceRequest& WithAddonInstanceId(AddonInstanceIdT&& value) { SetAddonInstanceId(std::forward<AddonInstanceIdT>(value)); return *this;}
    ///@}
  private:
