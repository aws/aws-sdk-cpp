...
class GetIngressPointResult {
 public:
  ...
  void SetIngressPointArn(IngressPointArnT&& value) {
    ...
    m_ingressPointArn = std::forward<IngressPointArnT>(value);
  }
  template <typename IngressPointArnT = Aws::String>
  GetIngressPointResult& WithIngressPointArn(IngressPointArnT&& value) {
    SetIngressPointArn(std::forward<IngressPointArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetIngressPointResult& WithStatus(IngressPointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetIngressPointResult& WithType(IngressPointType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetIngressPointAuthConfiguration(IngressPointAuthConfigurationT&& value) {
    ...
    m_ingressPointAuthConfiguration = std::forward<IngressPointAuthConfigurationT>(value);
  }
  template <typename IngressPointAuthConfigurationT = IngressPointAuthConfiguration>
  GetIngressPointResult& WithIngressPointAuthConfiguration(IngressPointAuthConfigurationT&& value) {
    SetIngressPointAuthConfiguration(std::forward<IngressPointAuthConfigurationT>(value));
    return *this;
  }
  ///@}
