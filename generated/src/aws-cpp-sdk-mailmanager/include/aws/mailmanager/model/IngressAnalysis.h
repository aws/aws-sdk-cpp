...
namespace Model
{
  ...
  public:
    ...
    template<typename AnalyzerT = Aws::String>
    IngressAnalysis& WithAnalyzer(AnalyzerT&& value) { SetAnalyzer(std::forward<AnalyzerT>(value)); return *this;}
    ///@}
    ...
    template<typename ResultFieldT = Aws::String>
    IngressAnalysis& WithResultField(ResultFieldT&& value) { SetResultField(std::forward<ResultFieldT>(value)); return *this;}
    ///@}
  private:
