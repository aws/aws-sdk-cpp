...
class PolicyCondition {
 public:
  ...
  AWS_MAILMANAGER_API PolicyCondition(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API PolicyCondition& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetIpExpression(IpExpressionT&& value) {
    ...
    m_ipExpression = std::forward<IpExpressionT>(value);
  }
  template <typename IpExpressionT = IngressIpv4Expression>
  PolicyCondition& WithIpExpression(IpExpressionT&& value) {
    SetIpExpression(std::forward<IpExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIpv6Expression(Ipv6ExpressionT&& value) {
    ...
    m_ipv6Expression = std::forward<Ipv6ExpressionT>(value);
  }
  template <typename Ipv6ExpressionT = IngressIpv6Expression>
  PolicyCondition& WithIpv6Expression(Ipv6ExpressionT&& value) {
    SetIpv6Expression(std::forward<Ipv6ExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTlsExpression(TlsExpressionT&& value) {
    ...
    m_tlsExpression = std::forward<TlsExpressionT>(value);
  }
  template <typename TlsExpressionT = IngressTlsProtocolExpression>
  PolicyCondition& WithTlsExpression(TlsExpressionT&& value) {
    SetTlsExpression(std::forward<TlsExpressionT>(value));
    return *this;
  }
  ///@}
