...
class ArchiveBooleanExpression {
 public:
  ...
  AWS_MAILMANAGER_API ArchiveBooleanExpression(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API ArchiveBooleanExpression& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename EvaluateT = ArchiveBooleanToEvaluate>
  ArchiveBooleanExpression& WithEvaluate(EvaluateT&& value) {
  ...
  inline void SetOperator(ArchiveBooleanOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline ArchiveBooleanExpression& WithOperator(ArchiveBooleanOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
