...
class ExportStatus {
 public:
  ...
  AWS_MAILMANAGER_API ExportStatus(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API ExportStatus& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetState(ExportState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ExportStatus& WithState(ExportState value) {
    SetState(value);
    return *this;
  }
  ///@}
