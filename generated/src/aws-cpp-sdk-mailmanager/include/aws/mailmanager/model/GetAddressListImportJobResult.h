...
class GetAddressListImportJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  GetAddressListImportJobResult& WithJobId(JobIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetAddressListImportJobResult& WithName(NameT&& value) {
  ...
  inline GetAddressListImportJobResult& WithStatus(ImportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename PreSignedUrlT = Aws::String>
  GetAddressListImportJobResult& WithPreSignedUrl(PreSignedUrlT&& value) {
  ...
  template <typename ImportDataFormatT = ImportDataFormat>
  GetAddressListImportJobResult& WithImportDataFormat(ImportDataFormatT&& value) {
  ...
  template <typename AddressListIdT = Aws::String>
  GetAddressListImportJobResult& WithAddressListId(AddressListIdT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  GetAddressListImportJobResult& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename StartTimestampT = Aws::Utils::DateTime>
  GetAddressListImportJobResult& WithStartTimestamp(StartTimestampT&& value) {
  ...
  template <typename CompletedTimestampT = Aws::Utils::DateTime>
  GetAddressListImportJobResult& WithCompletedTimestamp(CompletedTimestampT&& value) {
  ...
  template <typename ErrorT = Aws::String>
  GetAddressListImportJobResult& WithError(ErrorT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAddressListImportJobResult& WithRequestId(RequestIdT&& value) {
