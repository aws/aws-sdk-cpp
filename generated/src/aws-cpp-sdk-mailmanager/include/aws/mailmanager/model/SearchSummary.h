...
class SearchSummary {
 public:
  ...
  AWS_MAILMANAGER_API SearchSummary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API SearchSummary& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename StatusT = SearchStatus>
  SearchSummary& WithStatus(StatusT&& value) {
