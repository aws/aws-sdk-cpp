...
class ListMembersOfAddressListResult {
 public:
  ...
  AWS_MAILMANAGER_API ListMembersOfAddressListResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_MAILMANAGER_API ListMembersOfAddressListResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename AddressesT = Aws::Vector<SavedAddress>>
  ListMembersOfAddressListResult& WithAddresses(AddressesT&& value) {
    SetAddresses(std::forward<AddressesT>(value));
    return *this;
  }
  template <typename AddressesT = SavedAddress>
  ListMembersOfAddressListResult& AddAddresses(AddressesT&& value) {
    m_addressesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListMembersOfAddressListResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMembersOfAddressListResult& WithRequestId(RequestIdT&& value) {
