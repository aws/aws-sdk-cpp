...
class GetArchiveMessageResult {
 public:
  ...
  AWS_MAILMANAGER_API GetArchiveMessageResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_MAILMANAGER_API GetArchiveMessageResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetMessageDownloadLink(MessageDownloadLinkT&& value) {
    ...
    m_messageDownloadLink = std::forward<MessageDownloadLinkT>(value);
  }
  template <typename MessageDownloadLinkT = Aws::String>
  GetArchiveMessageResult& WithMessageDownloadLink(MessageDownloadLinkT&& value) {
    SetMessageDownloadLink(std::forward<MessageDownloadLinkT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEnvelope(EnvelopeT&& value) {
    ...
    m_envelope = std::forward<EnvelopeT>(value);
  }
  template <typename EnvelopeT = Envelope>
  GetArchiveMessageResult& WithEnvelope(EnvelopeT&& value) {
    SetEnvelope(std::forward<EnvelopeT>(value));
    return *this;
  }
  ///@}
