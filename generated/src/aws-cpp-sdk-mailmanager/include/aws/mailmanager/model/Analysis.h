...
class Analysis {
 public:
  ...
  AWS_MAILMANAGER_API Analysis(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API Analysis& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename AnalyzerT = Aws::String>
  Analysis& WithAnalyzer(AnalyzerT&& value) {
  ...
  template <typename ResultFieldT = Aws::String>
  Analysis& WithResultField(ResultFieldT&& value) {
