...
class Archive {
 public:
  ...
  AWS_MAILMANAGER_API Archive(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API Archive& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline Archive& WithArchiveState(ArchiveState value) {
