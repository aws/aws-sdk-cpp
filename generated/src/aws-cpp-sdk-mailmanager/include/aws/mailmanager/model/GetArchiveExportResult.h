...
class GetArchiveExportResult {
 public:
  ...
  void SetFromTimestamp(FromTimestampT&& value) {
    ...
    m_fromTimestamp = std::forward<FromTimestampT>(value);
  }
  template <typename FromTimestampT = Aws::Utils::DateTime>
  GetArchiveExportResult& WithFromTimestamp(FromTimestampT&& value) {
    SetFromTimestamp(std::forward<FromTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetToTimestamp(ToTimestampT&& value) {
    ...
    m_toTimestamp = std::forward<ToTimestampT>(value);
  }
  template <typename ToTimestampT = Aws::Utils::DateTime>
  GetArchiveExportResult& WithToTimestamp(ToTimestampT&& value) {
    SetToTimestamp(std::forward<ToTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExportDestinationConfiguration(ExportDestinationConfigurationT&& value) {
    ...
    m_exportDestinationConfiguration = std::forward<ExportDestinationConfigurationT>(value);
  }
  template <typename ExportDestinationConfigurationT = ExportDestinationConfiguration>
  GetArchiveExportResult& WithExportDestinationConfiguration(ExportDestinationConfigurationT&& value) {
    SetExportDestinationConfiguration(std::forward<ExportDestinationConfigurationT>(value));
    return *this;
  }
  ///@}
