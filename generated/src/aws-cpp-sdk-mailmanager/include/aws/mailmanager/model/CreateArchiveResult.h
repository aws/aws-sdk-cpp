...
class CreateArchiveResult {
 public:
  ...
  AWS_MAILMANAGER_API CreateArchiveResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_MAILMANAGER_API CreateArchiveResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ArchiveIdT = Aws::String>
  CreateArchiveResult& WithArchiveId(ArchiveIdT&& value) {
