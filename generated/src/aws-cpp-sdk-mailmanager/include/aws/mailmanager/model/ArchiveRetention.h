...
class ArchiveRetention {
 public:
  ...
  AWS_MAILMANAGER_API ArchiveRetention(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API ArchiveRetention& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetRetentionPeriod(RetentionPeriod value) {
    m_retentionPeriodHasBeenSet = true;
    m_retentionPeriod = value;
  }
  inline ArchiveRetention& WithRetentionPeriod(RetentionPeriod value) {
