...
class StartArchiveExportResult {
 public:
  ...
  AWS_MAILMANAGER_API StartArchiveExportResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_MAILMANAGER_API StartArchiveExportResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ExportIdT = Aws::String>
  StartArchiveExportResult& WithExportId(ExportIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartArchiveExportResult& WithRequestId(RequestIdT&& value) {
