...
class ListMembersOfAddressListRequest : public MailManagerRequest {
 public:
  ...
  template <typename AddressListIdT = Aws::String>
  ListMembersOfAddressListRequest& WithAddressListId(AddressListIdT&& value) {
  ...
  template <typename FilterT = AddressFilter>
  ListMembersOfAddressListRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListMembersOfAddressListRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMembersOfAddressListRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
