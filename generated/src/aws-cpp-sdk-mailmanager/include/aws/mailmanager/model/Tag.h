 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/mailmanager-2023-10-17/Tag">AWS API
 * Reference</a></p>
 */
class Tag {
 public:
  AWS_MAILMANAGER_API Tag() = default;
  AWS_MAILMANAGER_API Tag(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API Tag& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
