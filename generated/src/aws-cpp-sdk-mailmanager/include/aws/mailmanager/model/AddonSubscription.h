...
class AddonSubscription {
 public:
  ...
  AWS_MAILMANAGER_API AddonSubscription(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API AddonSubscription& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename AddonSubscriptionIdT = Aws::String>
  AddonSubscription& WithAddonSubscriptionId(AddonSubscriptionIdT&& value) {
  ...
  template <typename AddonNameT = Aws::String>
  AddonSubscription& WithAddonName(AddonNameT&& value) {
  ...
  template <typename AddonSubscriptionArnT = Aws::String>
  AddonSubscription& WithAddonSubscriptionArn(AddonSubscriptionArnT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  AddonSubscription& WithCreatedTimestamp(CreatedTimestampT&& value) {
