...
class RuleStringExpression {
 public:
  ...
  AWS_MAILMANAGER_API RuleStringExpression(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API RuleStringExpression& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename EvaluateT = RuleStringToEvaluate>
  RuleStringExpression& WithEvaluate(EvaluateT&& value) {
  ...
  inline void SetOperator(RuleStringOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline RuleStringExpression& WithOperator(RuleStringOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  RuleStringExpression& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  RuleStringExpression& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
