...
class Metadata {
 public:
  ...
  AWS_MAILMANAGER_API Metadata(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API Metadata& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetTlsCipherSuite(TlsCipherSuiteT&& value) {
    ...
    m_tlsCipherSuite = std::forward<TlsCipherSuiteT>(value);
  }
  template <typename TlsCipherSuiteT = Aws::String>
  Metadata& WithTlsCipherSuite(TlsCipherSuiteT&& value) {
    SetTlsCipherSuite(std::forward<TlsCipherSuiteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTlsProtocol(TlsProtocolT&& value) {
    ...
    m_tlsProtocol = std::forward<TlsProtocolT>(value);
  }
  template <typename TlsProtocolT = Aws::String>
  Metadata& WithTlsProtocol(TlsProtocolT&& value) {
    SetTlsProtocol(std::forward<TlsProtocolT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSendingMethod(SendingMethodT&& value) {
    ...
    m_sendingMethod = std::forward<SendingMethodT>(value);
  }
  template <typename SendingMethodT = Aws::String>
  Metadata& WithSendingMethod(SendingMethodT&& value) {
    SetSendingMethod(std::forward<SendingMethodT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSendingPool(SendingPoolT&& value) {
    ...
    m_sendingPool = std::forward<SendingPoolT>(value);
  }
  template <typename SendingPoolT = Aws::String>
  Metadata& WithSendingPool(SendingPoolT&& value) {
    SetSendingPool(std::forward<SendingPoolT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConfigurationSet(ConfigurationSetT&& value) {
    ...
    m_configurationSet = std::forward<ConfigurationSetT>(value);
  }
  template <typename ConfigurationSetT = Aws::String>
  Metadata& WithConfigurationSet(ConfigurationSetT&& value) {
    SetConfigurationSet(std::forward<ConfigurationSetT>(value));
    return *this;
  }
  ///@}
