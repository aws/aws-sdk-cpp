...
class TrafficPolicy {
 public:
  ...
  AWS_MAILMANAGER_API TrafficPolicy(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API TrafficPolicy& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetTrafficPolicyName(TrafficPolicyNameT&& value) {
    ...
    m_trafficPolicyName = std::forward<TrafficPolicyNameT>(value);
  }
  template <typename TrafficPolicyNameT = Aws::String>
  TrafficPolicy& WithTrafficPolicyName(TrafficPolicyNameT&& value) {
    SetTrafficPolicyName(std::forward<TrafficPolicyNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TrafficPolicyIdT = Aws::String>
  TrafficPolicy& WithTrafficPolicyId(TrafficPolicyIdT&& value) {
  ...
  inline void SetDefaultAction(AcceptAction value) {
    m_defaultActionHasBeenSet = true;
    m_defaultAction = value;
  }
  inline TrafficPolicy& WithDefaultAction(AcceptAction value) {
