...
class ListArchiveExportsResult {
 public:
  ...
  AWS_MAILMANAGER_API ListArchiveExportsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_MAILMANAGER_API ListArchiveExportsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ExportsT = Aws::Vector<ExportSummary>>
  ListArchiveExportsResult& WithExports(ExportsT&& value) {
    SetExports(std::forward<ExportsT>(value));
    return *this;
  }
  template <typename ExportsT = ExportSummary>
  ListArchiveExportsResult& AddExports(ExportsT&& value) {
    m_exportsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListArchiveExportsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListArchiveExportsResult& WithRequestId(RequestIdT&& value) {
