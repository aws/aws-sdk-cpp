...
namespace Model
{
  ...
  {
  public:
    AWS_MAILMANAGER_API ListArchiveExportsResult();
    ...
    inline void SetExports(const Aws::Vector<ExportSummary>& value) { m_exports = value; }
    inline void SetExports(Aws::Vector<ExportSummary>&& value) { m_exports = std::move(value); }
    inline ListArchiveExportsResult& WithExports(const Aws::Vector<ExportSummary>& value) { SetExports(value); return *this;}
    inline ListArchiveExportsResult& WithExports(Aws::Vector<ExportSummary>&& value) { SetExports(std::move(value)); return *this;}
    ...
    inline ListArchiveExportsResult& WithNextToken(const char* value) { SetNextToken(value); return *this;}
    ///@}
    ...
    inline ListArchiveExportsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline ListArchiveExportsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline ListArchiveExportsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
