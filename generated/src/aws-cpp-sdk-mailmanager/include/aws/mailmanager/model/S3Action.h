...
class S3Action {
 public:
  ...
  AWS_MAILMANAGER_API S3Action(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API S3Action& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline S3Action& WithActionFailurePolicy(ActionFailurePolicy value) {
