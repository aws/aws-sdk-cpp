...
class IngressIpv6Expression {
 public:
  ...
  AWS_MAILMANAGER_API IngressIpv6Expression(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API IngressIpv6Expression& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename EvaluateT = IngressIpv6ToEvaluate>
  IngressIpv6Expression& WithEvaluate(EvaluateT&& value) {
  ...
  inline IngressIpv6Expression& WithOperator(IngressIpOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  IngressIpv6Expression& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  IngressIpv6Expression& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
