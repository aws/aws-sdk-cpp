...
/**
 */
class ListTrafficPoliciesRequest : public MailManagerRequest {
 public:
  AWS_MAILMANAGER_API ListTrafficPoliciesRequest() = default;
  ...
  inline ListTrafficPoliciesRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTrafficPoliciesRequest& WithNextToken(NextTokenT&& value) {
