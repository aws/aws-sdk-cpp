...
class CreateTrafficPolicyResult {
 public:
  AWS_MAILMANAGER_API CreateTrafficPolicyResult() = default;
  AWS_MAILMANAGER_API CreateTrafficPolicyResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_MAILMANAGER_API CreateTrafficPolicyResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename TrafficPolicyIdT = Aws::String>
  CreateTrafficPolicyResult& WithTrafficPolicyId(TrafficPolicyIdT&& value) {
