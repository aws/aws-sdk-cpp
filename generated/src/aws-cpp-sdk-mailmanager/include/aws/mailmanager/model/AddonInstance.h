...
class AddonInstance {
 public:
  ...
  AWS_MAILMANAGER_API AddonInstance(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API AddonInstance& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetAddonInstanceId(AddonInstanceIdT&& value) {
    m_addonInstanceIdHasBeenSet = true;
    m_addonInstanceId = std::forward<AddonInstanceIdT>(value);
  }
  template <typename AddonInstanceIdT = Aws::String>
  AddonInstance& WithAddonInstanceId(AddonInstanceIdT&& value) {
    SetAddonInstanceId(std::forward<AddonInstanceIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AddonSubscriptionIdT = Aws::String>
  AddonInstance& WithAddonSubscriptionId(AddonSubscriptionIdT&& value) {
  ...
  template <typename AddonNameT = Aws::String>
  AddonInstance& WithAddonName(AddonNameT&& value) {
  ...
  void SetAddonInstanceArn(AddonInstanceArnT&& value) {
    m_addonInstanceArnHasBeenSet = true;
    m_addonInstanceArn = std::forward<AddonInstanceArnT>(value);
  }
  template <typename AddonInstanceArnT = Aws::String>
  AddonInstance& WithAddonInstanceArn(AddonInstanceArnT&& value) {
    SetAddonInstanceArn(std::forward<AddonInstanceArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  AddonInstance& WithCreatedTimestamp(CreatedTimestampT&& value) {
