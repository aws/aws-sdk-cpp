...
class UpdateArchiveResult {
 public:
  AWS_MAILMANAGER_API UpdateArchiveResult() = default;
  AWS_MAILMANAGER_API UpdateArchiveResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_MAILMANAGER_API UpdateArchiveResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
