...
class IngressPointPasswordConfiguration {
 public:
  ...
  AWS_MAILMANAGER_API IngressPointPasswordConfiguration(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API IngressPointPasswordConfiguration& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetSmtpPasswordVersion(SmtpPasswordVersionT&& value) {
    m_smtpPasswordVersionHasBeenSet = true;
    m_smtpPasswordVersion = std::forward<SmtpPasswordVersionT>(value);
  }
  template <typename SmtpPasswordVersionT = Aws::String>
  IngressPointPasswordConfiguration& WithSmtpPasswordVersion(SmtpPasswordVersionT&& value) {
    SetSmtpPasswordVersion(std::forward<SmtpPasswordVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreviousSmtpPasswordVersion(PreviousSmtpPasswordVersionT&& value) {
    m_previousSmtpPasswordVersionHasBeenSet = true;
    m_previousSmtpPasswordVersion = std::forward<PreviousSmtpPasswordVersionT>(value);
  }
  template <typename PreviousSmtpPasswordVersionT = Aws::String>
  IngressPointPasswordConfiguration& WithPreviousSmtpPasswordVersion(PreviousSmtpPasswordVersionT&& value) {
    SetPreviousSmtpPasswordVersion(std::forward<PreviousSmtpPasswordVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreviousSmtpPasswordExpiryTimestamp(PreviousSmtpPasswordExpiryTimestampT&& value) {
    m_previousSmtpPasswordExpiryTimestampHasBeenSet = true;
    m_previousSmtpPasswordExpiryTimestamp = std::forward<PreviousSmtpPasswordExpiryTimestampT>(value);
  }
  template <typename PreviousSmtpPasswordExpiryTimestampT = Aws::Utils::DateTime>
  IngressPointPasswordConfiguration& WithPreviousSmtpPasswordExpiryTimestamp(PreviousSmtpPasswordExpiryTimestampT&& value) {
    SetPreviousSmtpPasswordExpiryTimestamp(std::forward<PreviousSmtpPasswordExpiryTimestampT>(value));
    return *this;
  }
  ///@}
 private:
