...
class IngressBooleanExpression {
 public:
  ...
  AWS_MAILMANAGER_API IngressBooleanExpression(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API IngressBooleanExpression& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename EvaluateT = IngressBooleanToEvaluate>
  IngressBooleanExpression& WithEvaluate(EvaluateT&& value) {
  ...
  inline void SetOperator(IngressBooleanOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline IngressBooleanExpression& WithOperator(IngressBooleanOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
