...
class IngressBooleanToEvaluate {
 public:
  ...
  AWS_MAILMANAGER_API IngressBooleanToEvaluate(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API IngressBooleanToEvaluate& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename AnalysisT = IngressAnalysis>
  IngressBooleanToEvaluate& WithAnalysis(AnalysisT&& value) {
  ...
  template <typename IsInAddressListT = IngressIsInAddressList>
  IngressBooleanToEvaluate& WithIsInAddressList(IsInAddressListT&& value) {
