...
class CreateAddressListResult {
 public:
  ...
  AWS_MAILMANAGER_API CreateAddressListResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_MAILMANAGER_API CreateAddressListResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename AddressListIdT = Aws::String>
  CreateAddressListResult& WithAddressListId(AddressListIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAddressListResult& WithRequestId(RequestIdT&& value) {
