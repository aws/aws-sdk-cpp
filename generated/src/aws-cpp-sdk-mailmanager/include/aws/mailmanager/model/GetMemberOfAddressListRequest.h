...
class GetMemberOfAddressListRequest : public MailManagerRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetMemberOfAddressList"; }
  ...
  template <typename AddressListIdT = Aws::String>
  GetMemberOfAddressListRequest& WithAddressListId(AddressListIdT&& value) {
  ...
  template <typename AddressT = Aws::String>
  GetMemberOfAddressListRequest& WithAddress(AddressT&& value) {
