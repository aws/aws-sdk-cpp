...
class RuleNumberExpression {
 public:
  ...
  AWS_MAILMANAGER_API RuleNumberExpression(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API RuleNumberExpression& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetOperator(RuleNumberOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline RuleNumberExpression& WithOperator(RuleNumberOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  inline RuleNumberExpression& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
