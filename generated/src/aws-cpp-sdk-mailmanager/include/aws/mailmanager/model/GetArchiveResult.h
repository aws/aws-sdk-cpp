...
class GetArchiveResult {
 public:
  ...
  AWS_MAILMANAGER_API GetArchiveResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_MAILMANAGER_API GetArchiveResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  inline void SetArchiveState(ArchiveState value) {
    m_archiveStateHasBeenSet = true;
    m_archiveState = value;
  }
  inline GetArchiveResult& WithArchiveState(ArchiveState value) {
