...
namespace Model
{
  ...
  {
  public:
    AWS_MAILMANAGER_API GetAddressListImportJobRequest() = default;
    ...
    template<typename JobIdT = Aws::String>
    GetAddressListImportJobRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
  private:
