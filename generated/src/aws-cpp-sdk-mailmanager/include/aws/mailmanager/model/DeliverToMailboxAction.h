...
class DeliverToMailboxAction {
 public:
  ...
  AWS_MAILMANAGER_API DeliverToMailboxAction(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API DeliverToMailboxAction& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline DeliverToMailboxAction& WithActionFailurePolicy(ActionFailurePolicy value) {
  ...
  void SetMailboxArn(MailboxArnT&& value) {
    m_mailboxArnHasBeenSet = true;
    m_mailboxArn = std::forward<MailboxArnT>(value);
  }
  template <typename MailboxArnT = Aws::String>
  DeliverToMailboxAction& WithMailboxArn(MailboxArnT&& value) {
    SetMailboxArn(std::forward<MailboxArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RoleArnT = Aws::String>
  DeliverToMailboxAction& WithRoleArn(RoleArnT&& value) {
