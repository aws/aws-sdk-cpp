...
class RuleAction {
 public:
  ...
  void SetDrop(DropT&& value) {
    ...
    m_drop = std::forward<DropT>(value);
  }
  template <typename DropT = DropAction>
  RuleAction& WithDrop(DropT&& value) {
    SetDrop(std::forward<DropT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelay(RelayT&& value) {
    ...
    m_relay = std::forward<RelayT>(value);
  }
  template <typename RelayT = RelayAction>
  RuleAction& WithRelay(RelayT&& value) {
    SetRelay(std::forward<RelayT>(value));
    return *this;
  }
  ///@}
  ...
  void SetArchive(ArchiveT&& value) {
    ...
    m_archive = std::forward<ArchiveT>(value);
  }
  template <typename ArchiveT = ArchiveAction>
  RuleAction& WithArchive(ArchiveT&& value) {
    SetArchive(std::forward<ArchiveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWriteToS3(WriteToS3T&& value) {
    ...
    m_writeToS3 = std::forward<WriteToS3T>(value);
  }
  template <typename WriteToS3T = S3Action>
  RuleAction& WithWriteToS3(WriteToS3T&& value) {
    SetWriteToS3(std::forward<WriteToS3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetSend(SendT&& value) {
    ...
    m_send = std::forward<SendT>(value);
  }
  template <typename SendT = SendAction>
  RuleAction& WithSend(SendT&& value) {
    SetSend(std::forward<SendT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAddHeader(AddHeaderT&& value) {
    ...
    m_addHeader = std::forward<AddHeaderT>(value);
  }
  template <typename AddHeaderT = AddHeaderAction>
  RuleAction& WithAddHeader(AddHeaderT&& value) {
    SetAddHeader(std::forward<AddHeaderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplaceRecipient(ReplaceRecipientT&& value) {
    ...
    m_replaceRecipient = std::forward<ReplaceRecipientT>(value);
  }
  template <typename ReplaceRecipientT = ReplaceRecipientAction>
  RuleAction& WithReplaceRecipient(ReplaceRecipientT&& value) {
    SetReplaceRecipient(std::forward<ReplaceRecipientT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeliverToMailbox(DeliverToMailboxT&& value) {
    ...
    m_deliverToMailbox = std::forward<DeliverToMailboxT>(value);
  }
  template <typename DeliverToMailboxT = DeliverToMailboxAction>
  RuleAction& WithDeliverToMailbox(DeliverToMailboxT&& value) {
    SetDeliverToMailbox(std::forward<DeliverToMailboxT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeliverToQBusiness(DeliverToQBusinessT&& value) {
    ...
    m_deliverToQBusiness = std::forward<DeliverToQBusinessT>(value);
  }
  template <typename DeliverToQBusinessT = DeliverToQBusinessAction>
  RuleAction& WithDeliverToQBusiness(DeliverToQBusinessT&& value) {
    SetDeliverToQBusiness(std::forward<DeliverToQBusinessT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPublishToSns(PublishToSnsT&& value) {
    ...
    m_publishToSns = std::forward<PublishToSnsT>(value);
  }
  template <typename PublishToSnsT = SnsAction>
  RuleAction& WithPublishToSns(PublishToSnsT&& value) {
    SetPublishToSns(std::forward<PublishToSnsT>(value));
    return *this;
  }
  ///@}
 private:
