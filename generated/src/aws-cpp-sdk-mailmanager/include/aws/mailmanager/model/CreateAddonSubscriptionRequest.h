...
class CreateAddonSubscriptionRequest : public MailManagerRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateAddonSubscriptionRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename AddonNameT = Aws::String>
  CreateAddonSubscriptionRequest& WithAddonName(AddonNameT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateAddonSubscriptionRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateAddonSubscriptionRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
