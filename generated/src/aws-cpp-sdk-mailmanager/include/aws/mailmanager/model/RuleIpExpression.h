...
class RuleIpExpression {
 public:
  ...
  AWS_MAILMANAGER_API RuleIpExpression(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API RuleIpExpression& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename EvaluateT = RuleIpToEvaluate>
  RuleIpExpression& WithEvaluate(EvaluateT&& value) {
  ...
  inline void SetOperator(RuleIpOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline RuleIpExpression& WithOperator(RuleIpOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  RuleIpExpression& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  RuleIpExpression& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
