...
/**
 * <p>The address lists and the address list attribute value that is evaluated in a
 * policy statement's conditional expression to either deny or block the incoming
 * email.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mailmanager-2023-10-17/IngressIsInAddressList">AWS
 * API Reference</a></p>
 */
class IngressIsInAddressList {
 public:
  AWS_MAILMANAGER_API IngressIsInAddressList() = default;
  AWS_MAILMANAGER_API IngressIsInAddressList(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API IngressIsInAddressList& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetAttribute(IngressAddressListEmailAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline IngressIsInAddressList& WithAttribute(IngressAddressListEmailAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  template <typename AddressListsT = Aws::Vector<Aws::String>>
  IngressIsInAddressList& WithAddressLists(AddressListsT&& value) {
    SetAddressLists(std::forward<AddressListsT>(value));
    return *this;
  }
  template <typename AddressListsT = Aws::String>
  IngressIsInAddressList& AddAddressLists(AddressListsT&& value) {
    m_addressListsHasBeenSet = true;
