...
class PolicyStatement {
 public:
  ...
  template <typename ConditionsT = Aws::Vector<PolicyCondition>>
  PolicyStatement& WithConditions(ConditionsT&& value) {
    SetConditions(std::forward<ConditionsT>(value));
    return *this;
  }
  template <typename ConditionsT = PolicyCondition>
  PolicyStatement& AddConditions(ConditionsT&& value) {
    m_conditionsHasBeenSet = true;
  ...
  inline void SetAction(AcceptAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline PolicyStatement& WithAction(AcceptAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
