...
class IngressPoint {
 public:
  ...
  AWS_MAILMANAGER_API IngressPoint(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API IngressPoint& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetStatus(IngressPointStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline IngressPoint& WithStatus(IngressPointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(IngressPointType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline IngressPoint& WithType(IngressPointType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetARecord(ARecordT&& value) {
    ...
    m_aRecord = std::forward<ARecordT>(value);
  }
  template <typename ARecordT = Aws::String>
  IngressPoint& WithARecord(ARecordT&& value) {
    SetARecord(std::forward<ARecordT>(value));
    return *this;
  }
  ///@}
 private:
