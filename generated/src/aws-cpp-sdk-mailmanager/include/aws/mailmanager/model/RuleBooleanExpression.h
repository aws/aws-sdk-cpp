...
class RuleBooleanExpression {
 public:
  ...
  AWS_MAILMANAGER_API RuleBooleanExpression(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API RuleBooleanExpression& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename EvaluateT = RuleBooleanToEvaluate>
  RuleBooleanExpression& WithEvaluate(EvaluateT&& value) {
  ...
  inline void SetOperator(RuleBooleanOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline RuleBooleanExpression& WithOperator(RuleBooleanOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
