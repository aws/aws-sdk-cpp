...
class RuleCondition {
 public:
  ...
  void SetNumberExpression(NumberExpressionT&& value) {
    ...
    m_numberExpression = std::forward<NumberExpressionT>(value);
  }
  template <typename NumberExpressionT = RuleNumberExpression>
  RuleCondition& WithNumberExpression(NumberExpressionT&& value) {
    SetNumberExpression(std::forward<NumberExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVerdictExpression(VerdictExpressionT&& value) {
    ...
    m_verdictExpression = std::forward<VerdictExpressionT>(value);
  }
  template <typename VerdictExpressionT = RuleVerdictExpression>
  RuleCondition& WithVerdictExpression(VerdictExpressionT&& value) {
    SetVerdictExpression(std::forward<VerdictExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDmarcExpression(DmarcExpressionT&& value) {
    ...
    m_dmarcExpression = std::forward<DmarcExpressionT>(value);
  }
  template <typename DmarcExpressionT = RuleDmarcExpression>
  RuleCondition& WithDmarcExpression(DmarcExpressionT&& value) {
    SetDmarcExpression(std::forward<DmarcExpressionT>(value));
    return *this;
  }
  ///@}
 private:
