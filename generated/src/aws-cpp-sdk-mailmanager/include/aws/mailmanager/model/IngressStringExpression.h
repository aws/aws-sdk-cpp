...
class IngressStringExpression {
 public:
  ...
  AWS_MAILMANAGER_API IngressStringExpression(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API IngressStringExpression& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetEvaluate(EvaluateT&& value) {
    ...
    m_evaluate = std::forward<EvaluateT>(value);
  }
  template <typename EvaluateT = IngressStringToEvaluate>
  IngressStringExpression& WithEvaluate(EvaluateT&& value) {
    SetEvaluate(std::forward<EvaluateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOperator(IngressStringOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline IngressStringExpression& WithOperator(IngressStringOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  IngressStringExpression& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  IngressStringExpression& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
