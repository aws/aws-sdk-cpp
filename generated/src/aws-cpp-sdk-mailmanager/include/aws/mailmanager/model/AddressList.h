...
class AddressList {
 public:
  ...
  AWS_MAILMANAGER_API AddressList(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API AddressList& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
