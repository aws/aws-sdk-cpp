...
class IngressStringToEvaluate {
 public:
  ...
  AWS_MAILMANAGER_API IngressStringToEvaluate(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API IngressStringToEvaluate& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetAttribute(IngressStringEmailAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline IngressStringToEvaluate& WithAttribute(IngressStringEmailAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
