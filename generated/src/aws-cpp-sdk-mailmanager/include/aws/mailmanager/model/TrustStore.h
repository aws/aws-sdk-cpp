...
class TrustStore {
 public:
  ...
  AWS_MAILMANAGER_API TrustStore(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API TrustStore& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
