...
class RuleBooleanToEvaluate {
 public:
  ...
  inline void SetAttribute(RuleBooleanEmailAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline RuleBooleanToEvaluate& WithAttribute(RuleBooleanEmailAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  void SetIsInAddressList(IsInAddressListT&& value) {
    ...
    m_isInAddressList = std::forward<IsInAddressListT>(value);
  }
  template <typename IsInAddressListT = RuleIsInAddressList>
  RuleBooleanToEvaluate& WithIsInAddressList(IsInAddressListT&& value) {
    SetIsInAddressList(std::forward<IsInAddressListT>(value));
    return *this;
  }
  ///@}
 private:
