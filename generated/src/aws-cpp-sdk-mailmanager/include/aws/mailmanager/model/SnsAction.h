...
class SnsAction {
 public:
  ...
  inline SnsAction& WithActionFailurePolicy(ActionFailurePolicy value) {
  ...
  inline void SetEncoding(SnsNotificationEncoding value) {
    m_encodingHasBeenSet = true;
    m_encoding = value;
  }
  inline SnsAction& WithEncoding(SnsNotificationEncoding value) {
    SetEncoding(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPayloadType(SnsNotificationPayloadType value) {
    m_payloadTypeHasBeenSet = true;
    m_payloadType = value;
  }
  inline SnsAction& WithPayloadType(SnsNotificationPayloadType value) {
