...
class Row {
 public:
  ...
  AWS_MAILMANAGER_API Row(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API Row& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetArchivedMessageId(ArchivedMessageIdT&& value) {
    ...
    m_archivedMessageId = std::forward<ArchivedMessageIdT>(value);
  }
  template <typename ArchivedMessageIdT = Aws::String>
  Row& WithArchivedMessageId(ArchivedMessageIdT&& value) {
    SetArchivedMessageId(std::forward<ArchivedMessageIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReceivedTimestamp(ReceivedTimestampT&& value) {
    ...
    m_receivedTimestamp = std::forward<ReceivedTimestampT>(value);
  }
  template <typename ReceivedTimestampT = Aws::Utils::DateTime>
  Row& WithReceivedTimestamp(ReceivedTimestampT&& value) {
    SetReceivedTimestamp(std::forward<ReceivedTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCc(CcT&& value) {
    m_ccHasBeenSet = true;
    m_cc = std::forward<CcT>(value);
  }
  template <typename CcT = Aws::String>
  Row& WithCc(CcT&& value) {
    SetCc(std::forward<CcT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHasAttachments(bool value) {
    m_hasAttachmentsHasBeenSet = true;
    m_hasAttachments = value;
  }
  inline Row& WithHasAttachments(bool value) {
  ...
  void SetReceivedHeaders(ReceivedHeadersT&& value) {
    ...
    m_receivedHeaders = std::forward<ReceivedHeadersT>(value);
  }
  template <typename ReceivedHeadersT = Aws::Vector<Aws::String>>
  Row& WithReceivedHeaders(ReceivedHeadersT&& value) {
    SetReceivedHeaders(std::forward<ReceivedHeadersT>(value));
    return *this;
  }
  template <typename ReceivedHeadersT = Aws::String>
  Row& AddReceivedHeaders(ReceivedHeadersT&& value) {
    m_receivedHeadersHasBeenSet = true;
    m_receivedHeaders.emplace_back(std::forward<ReceivedHeadersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInReplyTo(InReplyToT&& value) {
    ...
    m_inReplyTo = std::forward<InReplyToT>(value);
  }
  template <typename InReplyToT = Aws::String>
  Row& WithInReplyTo(InReplyToT&& value) {
    SetInReplyTo(std::forward<InReplyToT>(value));
    return *this;
  }
  ///@}
  ...
  void SetXMailer(XMailerT&& value) {
    ...
    m_xMailer = std::forward<XMailerT>(value);
  }
  template <typename XMailerT = Aws::String>
  Row& WithXMailer(XMailerT&& value) {
    SetXMailer(std::forward<XMailerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetXOriginalMailer(XOriginalMailerT&& value) {
    ...
    m_xOriginalMailer = std::forward<XOriginalMailerT>(value);
  }
  template <typename XOriginalMailerT = Aws::String>
  Row& WithXOriginalMailer(XOriginalMailerT&& value) {
    SetXOriginalMailer(std::forward<XOriginalMailerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetXPriority(XPriorityT&& value) {
    ...
    m_xPriority = std::forward<XPriorityT>(value);
  }
  template <typename XPriorityT = Aws::String>
  Row& WithXPriority(XPriorityT&& value) {
    SetXPriority(std::forward<XPriorityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSenderHostname(SenderHostnameT&& value) {
    ...
    m_senderHostname = std::forward<SenderHostnameT>(value);
  }
  template <typename SenderHostnameT = Aws::String>
  Row& WithSenderHostname(SenderHostnameT&& value) {
    SetSenderHostname(std::forward<SenderHostnameT>(value));
    return *this;
  }
  ///@}
