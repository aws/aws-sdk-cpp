...
class StopArchiveExportResult {
 public:
  ...
  AWS_MAILMANAGER_API StopArchiveExportResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_MAILMANAGER_API StopArchiveExportResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename RequestIdT = Aws::String>
  StopArchiveExportResult& WithRequestId(RequestIdT&& value) {
