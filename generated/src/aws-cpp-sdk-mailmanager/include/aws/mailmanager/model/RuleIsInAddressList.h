...
class RuleIsInAddressList {
 public:
  ...
  AWS_MAILMANAGER_API RuleIsInAddressList(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MAILMANAGER_API RuleIsInAddressList& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetAttribute(RuleAddressListEmailAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline RuleIsInAddressList& WithAttribute(RuleAddressListEmailAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  template <typename AddressListsT = Aws::Vector<Aws::String>>
  RuleIsInAddressList& WithAddressLists(AddressListsT&& value) {
    SetAddressLists(std::forward<AddressListsT>(value));
    return *this;
  }
  template <typename AddressListsT = Aws::String>
  RuleIsInAddressList& AddAddressLists(AddressListsT&& value) {
    m_addressListsHasBeenSet = true;
