...
class ListAddressListImportJobsRequest : public MailManagerRequest {
 public:
  ...
  template <typename AddressListIdT = Aws::String>
  ListAddressListImportJobsRequest& WithAddressListId(AddressListIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAddressListImportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAddressListImportJobsRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
