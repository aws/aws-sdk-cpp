...
class ListArchiveSearchesRequest : public MailManagerRequest {
 public:
  ...
  template <typename ArchiveIdT = Aws::String>
  ListArchiveSearchesRequest& WithArchiveId(ArchiveIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListArchiveSearchesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListArchiveSearchesRequest& WithPageSize(int value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
