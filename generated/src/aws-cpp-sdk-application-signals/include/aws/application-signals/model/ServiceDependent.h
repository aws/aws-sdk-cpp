...
class ServiceDependent {
 public:
  ...
  void SetDependentKeyAttributes(DependentKeyAttributesT&& value) {
    ...
    m_dependentKeyAttributes = std::forward<DependentKeyAttributesT>(value);
  }
  template <typename DependentKeyAttributesT = Aws::Map<Aws::String, Aws::String>>
  ServiceDependent& WithDependentKeyAttributes(DependentKeyAttributesT&& value) {
    SetDependentKeyAttributes(std::forward<DependentKeyAttributesT>(value));
    return *this;
  }
  ...
  ServiceDependent& AddDependentKeyAttributes(DependentKeyAttributesKeyT&& key, DependentKeyAttributesValueT&& value) {
    m_dependentKeyAttributesHasBeenSet = true;
    m_dependentKeyAttributes.emplace(std::forward<DependentKeyAttributesKeyT>(key), std::forward<DependentKeyAttributesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDependentOperationName(DependentOperationNameT&& value) {
    ...
    m_dependentOperationName = std::forward<DependentOperationNameT>(value);
  }
  template <typename DependentOperationNameT = Aws::String>
  ServiceDependent& WithDependentOperationName(DependentOperationNameT&& value) {
    SetDependentOperationName(std::forward<DependentOperationNameT>(value));
    return *this;
  }
  ///@}
