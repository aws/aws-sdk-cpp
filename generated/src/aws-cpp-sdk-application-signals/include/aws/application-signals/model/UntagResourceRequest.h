...
/**
 */
class UntagResourceRequest : public ApplicationSignalsRequest {
 public:
  AWS_APPLICATIONSIGNALS_API UntagResourceRequest() = default;
   ...
   * delete tags from.</p> <p>The ARN format of an Application Signals SLO is
