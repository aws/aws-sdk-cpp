...
class ListServiceOperationsResult {
 public:
  ...
  void SetServiceOperations(ServiceOperationsT&& value) {
    ...
    m_serviceOperations = std::forward<ServiceOperationsT>(value);
  }
  template <typename ServiceOperationsT = Aws::Vector<ServiceOperation>>
  ListServiceOperationsResult& WithServiceOperations(ServiceOperationsT&& value) {
    SetServiceOperations(std::forward<ServiceOperationsT>(value));
    return *this;
  }
  ...
  ListServiceOperationsResult& AddServiceOperations(ServiceOperationsT&& value) {
    m_serviceOperationsHasBeenSet = true;
    m_serviceOperations.emplace_back(std::forward<ServiceOperationsT>(value));
    return *this;
  }
  ///@}
