...
class BatchGetServiceLevelObjectiveBudgetReportResult {
 public:
  ...
  AWS_APPLICATIONSIGNALS_API BatchGetServiceLevelObjectiveBudgetReportResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename TimestampT = Aws::Utils::DateTime>
  BatchGetServiceLevelObjectiveBudgetReportResult& WithTimestamp(TimestampT&& value) {
  ...
  template <typename ReportsT = Aws::Vector<ServiceLevelObjectiveBudgetReport>>
  BatchGetServiceLevelObjectiveBudgetReportResult& WithReports(ReportsT&& value) {
    SetReports(std::forward<ReportsT>(value));
    return *this;
  }
  template <typename ReportsT = ServiceLevelObjectiveBudgetReport>
  BatchGetServiceLevelObjectiveBudgetReportResult& AddReports(ReportsT&& value) {
    m_reportsHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<ServiceLevelObjectiveBudgetReportError>>
  BatchGetServiceLevelObjectiveBudgetReportResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = ServiceLevelObjectiveBudgetReportError>
  BatchGetServiceLevelObjectiveBudgetReportResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetServiceLevelObjectiveBudgetReportResult& WithRequestId(RequestIdT&& value) {
