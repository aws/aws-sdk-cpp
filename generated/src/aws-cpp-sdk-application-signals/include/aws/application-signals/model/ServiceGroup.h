...
namespace Model
{
  ...
  public:
    ...
    template<typename GroupNameT = Aws::String>
    ServiceGroup& WithGroupName(GroupNameT&& value) { SetGroupName(std::forward<GroupNameT>(value)); return *this;}
    ///@}
    ...
    void SetGroupValue(GroupValueT&& value) { m_groupValueHasBeenSet = true; m_groupValue = std::forward<GroupValueT>(value); }
    template<typename GroupValueT = Aws::String>
    ServiceGroup& WithGroupValue(GroupValueT&& value) { SetGroupValue(std::forward<GroupValueT>(value)); return *this;}
    ///@}
    ...
    void SetGroupSource(GroupSourceT&& value) { m_groupSourceHasBeenSet = true; m_groupSource = std::forward<GroupSourceT>(value); }
    template<typename GroupSourceT = Aws::String>
    ServiceGroup& WithGroupSource(GroupSourceT&& value) { SetGroupSource(std::forward<GroupSourceT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupIdentifierT = Aws::String>
    ServiceGroup& WithGroupIdentifier(GroupIdentifierT&& value) { SetGroupIdentifier(std::forward<GroupIdentifierT>(value)); return *this;}
    ///@}
  private:
