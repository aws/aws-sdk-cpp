...
namespace Model
{
  ...
  public:
    ...
    void SetSourceNodeId(SourceNodeIdT&& value) { m_sourceNodeIdHasBeenSet = true; m_sourceNodeId = std::forward<SourceNodeIdT>(value); }
    template<typename SourceNodeIdT = Aws::String>
    Edge& WithSourceNodeId(SourceNodeIdT&& value) { SetSourceNodeId(std::forward<SourceNodeIdT>(value)); return *this;}
    ///@}
    ...
    void SetDestinationNodeId(DestinationNodeIdT&& value) { m_destinationNodeIdHasBeenSet = true; m_destinationNodeId = std::forward<DestinationNodeIdT>(value); }
    template<typename DestinationNodeIdT = Aws::String>
    Edge& WithDestinationNodeId(DestinationNodeIdT&& value) { SetDestinationNodeId(std::forward<DestinationNodeIdT>(value)); return *this;}
    ///@}
    ...
    inline Edge& WithDuration(double value) { SetDuration(value); return *this;}
    ///@}
    ...
    inline Edge& WithConnectionType(ConnectionType value) { SetConnectionType(value); return *this;}
    ///@}
  private:
