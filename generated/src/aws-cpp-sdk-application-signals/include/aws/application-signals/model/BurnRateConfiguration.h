...
class BurnRateConfiguration {
 public:
  ...
  inline void SetLookBackWindowMinutes(int value) {
    m_lookBackWindowMinutesHasBeenSet = true;
    m_lookBackWindowMinutes = value;
  }
  inline BurnRateConfiguration& WithLookBackWindowMinutes(int value) {
    SetLookBackWindowMinutes(value);
    return *this;
  }
  ///@}
 private:
