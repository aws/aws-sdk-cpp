...
namespace Model
{
  ...
  public:
    ...
    template<typename ServiceT = ServiceEntity>
    ServiceOperationEntity& WithService(ServiceT&& value) { SetService(std::forward<ServiceT>(value)); return *this;}
    ///@}
    ...
    template<typename OperationT = Aws::String>
    ServiceOperationEntity& WithOperation(OperationT&& value) { SetOperation(std::forward<OperationT>(value)); return *this;}
    ///@}
    ...
    template<typename MetricTypeT = Aws::String>
    ServiceOperationEntity& WithMetricType(MetricTypeT&& value) { SetMetricType(std::forward<MetricTypeT>(value)); return *this;}
    ///@}
  private:
