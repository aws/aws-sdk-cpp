...
class ServiceLevelIndicatorMetricConfig {
 public:
  ...
  inline ServiceLevelIndicatorMetricConfig& WithMetricType(ServiceLevelIndicatorMetricType value) {
    SetMetricType(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetricNameT = Aws::String>
  ServiceLevelIndicatorMetricConfig& WithMetricName(MetricNameT&& value) {
  ...
  inline void SetPeriodSeconds(int value) {
    m_periodSecondsHasBeenSet = true;
    m_periodSeconds = value;
  }
  inline ServiceLevelIndicatorMetricConfig& WithPeriodSeconds(int value) {
    SetPeriodSeconds(value);
    return *this;
  }
  ///@}
