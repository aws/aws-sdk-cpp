...
class Interval {
 public:
  ...
  void SetRollingInterval(RollingIntervalT&& value) {
    ...
    m_rollingInterval = std::forward<RollingIntervalT>(value);
  }
  template <typename RollingIntervalT = RollingInterval>
  Interval& WithRollingInterval(RollingIntervalT&& value) {
    SetRollingInterval(std::forward<RollingIntervalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCalendarInterval(CalendarIntervalT&& value) {
    ...
    m_calendarInterval = std::forward<CalendarIntervalT>(value);
  }
  template <typename CalendarIntervalT = CalendarInterval>
  Interval& WithCalendarInterval(CalendarIntervalT&& value) {
    SetCalendarInterval(std::forward<CalendarIntervalT>(value));
    return *this;
  }
  ///@}
 private:
