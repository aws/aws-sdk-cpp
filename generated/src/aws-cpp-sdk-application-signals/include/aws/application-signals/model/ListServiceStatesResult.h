...
namespace Model
{
  ...
  public:
    ...
    template<typename StartTimeT = Aws::Utils::DateTime>
    ListServiceStatesResult& WithStartTime(StartTimeT&& value) { SetStartTime(std::forward<StartTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename EndTimeT = Aws::Utils::DateTime>
    ListServiceStatesResult& WithEndTime(EndTimeT&& value) { SetEndTime(std::forward<EndTimeT>(value)); return *this;}
    ///@}
    ...
    void SetServiceStates(ServiceStatesT&& value) { m_serviceStatesHasBeenSet = true; m_serviceStates = std::forward<ServiceStatesT>(value); }
    template<typename ServiceStatesT = Aws::Vector<ServiceState>>
    ListServiceStatesResult& WithServiceStates(ServiceStatesT&& value) { SetServiceStates(std::forward<ServiceStatesT>(value)); return *this;}
    template<typename ServiceStatesT = ServiceState>
    ListServiceStatesResult& AddServiceStates(ServiceStatesT&& value) { m_serviceStatesHasBeenSet = true; m_serviceStates.emplace_back(std::forward<ServiceStatesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListServiceStatesResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListServiceStatesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
