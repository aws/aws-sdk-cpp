...
namespace Model
{
  ...
  public:
    ...
    template<typename TypeT = Aws::String>
    AuditTarget& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename DataT = AuditTargetEntity>
    AuditTarget& WithData(DataT&& value) { SetData(std::forward<DataT>(value)); return *this;}
    ///@}
  private:
