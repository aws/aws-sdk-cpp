...
class RequestBasedServiceLevelIndicator {
 public:
  ...
  void SetRequestBasedSliMetric(RequestBasedSliMetricT&& value) {
    ...
    m_requestBasedSliMetric = std::forward<RequestBasedSliMetricT>(value);
  }
  template <typename RequestBasedSliMetricT = RequestBasedServiceLevelIndicatorMetric>
  RequestBasedServiceLevelIndicator& WithRequestBasedSliMetric(RequestBasedSliMetricT&& value) {
    SetRequestBasedSliMetric(std::forward<RequestBasedSliMetricT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMetricThreshold(double value) {
    m_metricThresholdHasBeenSet = true;
    m_metricThreshold = value;
  }
  inline RequestBasedServiceLevelIndicator& WithMetricThreshold(double value) {
    SetMetricThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline void SetComparisonOperator(ServiceLevelIndicatorComparisonOperator value) {
    m_comparisonOperatorHasBeenSet = true;
    m_comparisonOperator = value;
  }
  inline RequestBasedServiceLevelIndicator& WithComparisonOperator(ServiceLevelIndicatorComparisonOperator value) {
