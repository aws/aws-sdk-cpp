...
class PutGroupingConfigurationRequest : public ApplicationSignalsRequest {
 public:
  ...
  template <typename GroupingAttributeDefinitionsT = Aws::Vector<GroupingAttributeDefinition>>
  PutGroupingConfigurationRequest& WithGroupingAttributeDefinitions(GroupingAttributeDefinitionsT&& value) {
  ...
  PutGroupingConfigurationRequest& AddGroupingAttributeDefinitions(GroupingAttributeDefinitionsT&& value) {
    m_groupingAttributeDefinitionsHasBeenSet = true;
