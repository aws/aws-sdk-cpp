...
class ServiceLevelObjectiveBudgetReportError {
 public:
  AWS_APPLICATIONSIGNALS_API ServiceLevelObjectiveBudgetReportError() = default;
  ...
  template <typename NameT = Aws::String>
  ServiceLevelObjectiveBudgetReportError& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ServiceLevelObjectiveBudgetReportError& WithArn(ArnT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  ServiceLevelObjectiveBudgetReportError& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  ServiceLevelObjectiveBudgetReportError& WithErrorMessage(ErrorMessageT&& value) {
