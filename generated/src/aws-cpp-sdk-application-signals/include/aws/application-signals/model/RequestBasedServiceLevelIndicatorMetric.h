...
class RequestBasedServiceLevelIndicatorMetric {
 public:
  ...
  template <typename KeyAttributesT = Aws::Map<Aws::String, Aws::String>>
  RequestBasedServiceLevelIndicatorMetric& WithKeyAttributes(KeyAttributesT&& value) {
  ...
  template <typename OperationNameT = Aws::String>
  RequestBasedServiceLevelIndicatorMetric& WithOperationName(OperationNameT&& value) {
  ...
  inline RequestBasedServiceLevelIndicatorMetric& WithMetricType(ServiceLevelIndicatorMetricType value) {
    SetMetricType(value);
    return *this;
  }
  ///@}
  ...
  void SetTotalRequestCountMetric(TotalRequestCountMetricT&& value) {
    m_totalRequestCountMetricHasBeenSet = true;
    m_totalRequestCountMetric = std::forward<TotalRequestCountMetricT>(value);
  }
  template <typename TotalRequestCountMetricT = Aws::Vector<MetricDataQuery>>
  RequestBasedServiceLevelIndicatorMetric& WithTotalRequestCountMetric(TotalRequestCountMetricT&& value) {
    SetTotalRequestCountMetric(std::forward<TotalRequestCountMetricT>(value));
    return *this;
  }
  template <typename TotalRequestCountMetricT = MetricDataQuery>
  RequestBasedServiceLevelIndicatorMetric& AddTotalRequestCountMetric(TotalRequestCountMetricT&& value) {
    m_totalRequestCountMetricHasBeenSet = true;
    m_totalRequestCountMetric.emplace_back(std::forward<TotalRequestCountMetricT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMonitoredRequestCountMetric(MonitoredRequestCountMetricT&& value) {
    m_monitoredRequestCountMetricHasBeenSet = true;
    m_monitoredRequestCountMetric = std::forward<MonitoredRequestCountMetricT>(value);
  }
  template <typename MonitoredRequestCountMetricT = MonitoredRequestCountMetricDataQueries>
  RequestBasedServiceLevelIndicatorMetric& WithMonitoredRequestCountMetric(MonitoredRequestCountMetricT&& value) {
    SetMonitoredRequestCountMetric(std::forward<MonitoredRequestCountMetricT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DependencyConfigT = DependencyConfig>
  RequestBasedServiceLevelIndicatorMetric& WithDependencyConfig(DependencyConfigT&& value) {
  ...
  template <typename MetricSourceT = MetricSource>
  RequestBasedServiceLevelIndicatorMetric& WithMetricSource(MetricSourceT&& value) {
  ...
  template <typename CompositeSliConfigT = CompositeSliConfig>
  RequestBasedServiceLevelIndicatorMetric& WithCompositeSliConfig(CompositeSliConfigT&& value) {
