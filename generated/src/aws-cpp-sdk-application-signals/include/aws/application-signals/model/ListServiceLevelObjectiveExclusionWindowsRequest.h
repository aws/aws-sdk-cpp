...
class ListServiceLevelObjectiveExclusionWindowsRequest : public ApplicationSignalsRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  ListServiceLevelObjectiveExclusionWindowsRequest& WithId(IdT&& value) {
  ...
  inline ListServiceLevelObjectiveExclusionWindowsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceLevelObjectiveExclusionWindowsRequest& WithNextToken(NextTokenT&& value) {
