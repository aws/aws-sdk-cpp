...
class BatchUpdateExclusionWindowsResult {
 public:
  ...
  AWS_APPLICATIONSIGNALS_API BatchUpdateExclusionWindowsResult& operator=(
  ...
  template <typename SloIdsT = Aws::Vector<Aws::String>>
  BatchUpdateExclusionWindowsResult& WithSloIds(SloIdsT&& value) {
    SetSloIds(std::forward<SloIdsT>(value));
    return *this;
  }
  template <typename SloIdsT = Aws::String>
  BatchUpdateExclusionWindowsResult& AddSloIds(SloIdsT&& value) {
    m_sloIdsHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<BatchUpdateExclusionWindowsError>>
  BatchUpdateExclusionWindowsResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchUpdateExclusionWindowsError>
  BatchUpdateExclusionWindowsResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
