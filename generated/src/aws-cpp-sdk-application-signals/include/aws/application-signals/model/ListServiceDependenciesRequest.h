...
namespace Model
{
  ...
  /**
   */
  class ListServiceDependenciesRequest : public ApplicationSignalsRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListServiceDependencies"; }
    ...
    template<typename StartTimeT = Aws::Utils::DateTime>
    ListServiceDependenciesRequest& WithStartTime(StartTimeT&& value) { SetStartTime(std::forward<StartTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename EndTimeT = Aws::Utils::DateTime>
    ListServiceDependenciesRequest& WithEndTime(EndTimeT&& value) { SetEndTime(std::forward<EndTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename KeyAttributesT = Aws::Map<Aws::String, Aws::String>>
    ListServiceDependenciesRequest& WithKeyAttributes(KeyAttributesT&& value) { SetKeyAttributes(std::forward<KeyAttributesT>(value)); return *this;}
     ...
     * next set of service dependencies.</p>
     */
    ...
    template<typename NextTokenT = Aws::String>
    ListServiceDependenciesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
