...
namespace Model
{
  ...
  {
  public:
    AWS_APPLICATIONSIGNALS_API ListServiceDependenciesRequest();
    ...
    inline ListServiceDependenciesRequest& WithKeyAttributes(const Aws::Map<Aws::String, Aws::String>& value) { SetKeyAttributes(value); return *this;}
    inline ListServiceDependenciesRequest& WithKeyAttributes(Aws::Map<Aws::String, Aws::String>&& value) { SetKeyAttributes(std::move(value)); return *this;}
    ...
    inline ListServiceDependenciesRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
    ///@}
  private:
