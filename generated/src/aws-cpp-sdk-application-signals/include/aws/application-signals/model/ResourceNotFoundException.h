...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/application-signals-2024-04-15/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_APPLICATIONSIGNALS_API ResourceNotFoundException() = default;
    AWS_APPLICATIONSIGNALS_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
