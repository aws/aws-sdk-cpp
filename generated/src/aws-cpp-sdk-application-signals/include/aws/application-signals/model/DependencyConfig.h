...
class DependencyConfig {
 public:
  ...
  void SetDependencyKeyAttributes(DependencyKeyAttributesT&& value) {
    ...
    m_dependencyKeyAttributes = std::forward<DependencyKeyAttributesT>(value);
  }
  template <typename DependencyKeyAttributesT = Aws::Map<Aws::String, Aws::String>>
  DependencyConfig& WithDependencyKeyAttributes(DependencyKeyAttributesT&& value) {
    SetDependencyKeyAttributes(std::forward<DependencyKeyAttributesT>(value));
    return *this;
  }
  ...
  DependencyConfig& AddDependencyKeyAttributes(DependencyKeyAttributesKeyT&& key, DependencyKeyAttributesValueT&& value) {
    m_dependencyKeyAttributesHasBeenSet = true;
    m_dependencyKeyAttributes.emplace(std::forward<DependencyKeyAttributesKeyT>(key), std::forward<DependencyKeyAttributesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDependencyOperationName(DependencyOperationNameT&& value) {
    ...
    m_dependencyOperationName = std::forward<DependencyOperationNameT>(value);
  }
  template <typename DependencyOperationNameT = Aws::String>
  DependencyConfig& WithDependencyOperationName(DependencyOperationNameT&& value) {
    SetDependencyOperationName(std::forward<DependencyOperationNameT>(value));
    return *this;
  }
  ///@}
 private:
