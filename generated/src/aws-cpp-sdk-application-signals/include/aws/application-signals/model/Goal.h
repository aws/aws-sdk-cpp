...
class Goal {
 public:
  ...
  inline void SetAttainmentGoal(double value) {
    m_attainmentGoalHasBeenSet = true;
    m_attainmentGoal = value;
  }
  inline Goal& WithAttainmentGoal(double value) {
    SetAttainmentGoal(value);
    return *this;
  }
  ///@}
  ...
  inline Goal& WithWarningThreshold(double value) {
