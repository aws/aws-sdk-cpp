...
namespace Model
{
  ...
  public:
    ...
    void SetAuditFindings(AuditFindingsT&& value) { m_auditFindingsHasBeenSet = true; m_auditFindings = std::forward<AuditFindingsT>(value); }
    template<typename AuditFindingsT = Aws::Vector<AuditFinding>>
    ListAuditFindingsResult& WithAuditFindings(AuditFindingsT&& value) { SetAuditFindings(std::forward<AuditFindingsT>(value)); return *this;}
    template<typename AuditFindingsT = AuditFinding>
    ListAuditFindingsResult& AddAuditFindings(AuditFindingsT&& value) { m_auditFindingsHasBeenSet = true; m_auditFindings.emplace_back(std::forward<AuditFindingsT>(value)); return *this; }
    ///@}
