...
namespace Model
{
  ...
  {
  public:
    AWS_APPLICATIONSIGNALS_API StartDiscoveryResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StartDiscoveryResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
