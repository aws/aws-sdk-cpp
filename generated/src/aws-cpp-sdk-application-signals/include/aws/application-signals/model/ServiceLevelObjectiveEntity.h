...
namespace Model
{
  ...
  public:
    ...
    void SetSloName(SloNameT&& value) { m_sloNameHasBeenSet = true; m_sloName = std::forward<SloNameT>(value); }
    template<typename SloNameT = Aws::String>
    ServiceLevelObjectiveEntity& WithSloName(SloNameT&& value) { SetSloName(std::forward<SloNameT>(value)); return *this;}
    ///@}
    ...
    void SetSloArn(SloArnT&& value) { m_sloArnHasBeenSet = true; m_sloArn = std::forward<SloArnT>(value); }
    template<typename SloArnT = Aws::String>
    ServiceLevelObjectiveEntity& WithSloArn(SloArnT&& value) { SetSloArn(std::forward<SloArnT>(value)); return *this;}
    ///@}
  private:
