...
class RequestBasedServiceLevelIndicatorConfig {
 public:
   ...
   */
  inline const RequestBasedServiceLevelIndicatorMetricConfig& GetRequestBasedSliMetricConfig() const {
    return m_requestBasedSliMetricConfig;
  }
  ...
  void SetRequestBasedSliMetricConfig(RequestBasedSliMetricConfigT&& value) {
    m_requestBasedSliMetricConfigHasBeenSet = true;
    m_requestBasedSliMetricConfig = std::forward<RequestBasedSliMetricConfigT>(value);
  }
  template <typename RequestBasedSliMetricConfigT = RequestBasedServiceLevelIndicatorMetricConfig>
  RequestBasedServiceLevelIndicatorConfig& WithRequestBasedSliMetricConfig(RequestBasedSliMetricConfigT&& value) {
    SetRequestBasedSliMetricConfig(std::forward<RequestBasedSliMetricConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline RequestBasedServiceLevelIndicatorConfig& WithMetricThreshold(double value) {
  ...
  inline RequestBasedServiceLevelIndicatorConfig& WithComparisonOperator(ServiceLevelIndicatorComparisonOperator value) {
