...
namespace Model
{
  ...
  public:
    ...
    void SetAuditor(AuditorT&& value) { m_auditorHasBeenSet = true; m_auditor = std::forward<AuditorT>(value); }
    template<typename AuditorT = Aws::String>
    AuditorResult& WithAuditor(AuditorT&& value) { SetAuditor(std::forward<AuditorT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    AuditorResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    inline AuditorResult& WithSeverity(Severity value) { SetSeverity(value); return *this;}
    ///@}
  private:
