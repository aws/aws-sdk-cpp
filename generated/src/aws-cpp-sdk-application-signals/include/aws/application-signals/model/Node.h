...
namespace Model
{
  ...
  public:
    ...
    template<typename KeyAttributesT = Aws::Map<Aws::String, Aws::String>>
    Node& WithKeyAttributes(KeyAttributesT&& value) { SetKeyAttributes(std::forward<KeyAttributesT>(value)); return *this;}
    ...
    template<typename OperationT = Aws::String>
    Node& WithOperation(OperationT&& value) { SetOperation(std::forward<OperationT>(value)); return *this;}
    ///@}
    ...
    template<typename TypeT = Aws::String>
    Node& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    inline Node& WithDuration(double value) { SetDuration(value); return *this;}
    ///@}
    ...
    template<typename StatusT = Aws::String>
    Node& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
  private:
