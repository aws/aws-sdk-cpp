...
class ServiceLevelIndicator {
 public:
  ...
  void SetSliMetric(SliMetricT&& value) {
    ...
    m_sliMetric = std::forward<SliMetricT>(value);
  }
  template <typename SliMetricT = ServiceLevelIndicatorMetric>
  ServiceLevelIndicator& WithSliMetric(SliMetricT&& value) {
    SetSliMetric(std::forward<SliMetricT>(value));
    return *this;
  }
  ///@}
  ...
  inline ServiceLevelIndicator& WithMetricThreshold(double value) {
  ...
  inline ServiceLevelIndicator& WithComparisonOperator(ServiceLevelIndicatorComparisonOperator value) {
