...
class RequestBasedServiceLevelIndicatorMetricConfig {
 public:
  ...
  template <typename KeyAttributesT = Aws::Map<Aws::String, Aws::String>>
  RequestBasedServiceLevelIndicatorMetricConfig& WithKeyAttributes(KeyAttributesT&& value) {
  ...
  template <typename OperationNameT = Aws::String>
  RequestBasedServiceLevelIndicatorMetricConfig& WithOperationName(OperationNameT&& value) {
  ...
  inline RequestBasedServiceLevelIndicatorMetricConfig& WithMetricType(ServiceLevelIndicatorMetricType value) {
    SetMetricType(value);
    return *this;
  }
  ///@}
  ...
  template <typename TotalRequestCountMetricT = Aws::Vector<MetricDataQuery>>
  RequestBasedServiceLevelIndicatorMetricConfig& WithTotalRequestCountMetric(TotalRequestCountMetricT&& value) {
  ...
  RequestBasedServiceLevelIndicatorMetricConfig& AddTotalRequestCountMetric(TotalRequestCountMetricT&& value) {
    m_totalRequestCountMetricHasBeenSet = true;
  ...
  template <typename MonitoredRequestCountMetricT = MonitoredRequestCountMetricDataQueries>
  RequestBasedServiceLevelIndicatorMetricConfig& WithMonitoredRequestCountMetric(MonitoredRequestCountMetricT&& value) {
  ...
  template <typename DependencyConfigT = DependencyConfig>
  RequestBasedServiceLevelIndicatorMetricConfig& WithDependencyConfig(DependencyConfigT&& value) {
  ...
  template <typename CompositeSliConfigT = CompositeSliConfig>
  RequestBasedServiceLevelIndicatorMetricConfig& WithCompositeSliConfig(CompositeSliConfigT&& value) {
