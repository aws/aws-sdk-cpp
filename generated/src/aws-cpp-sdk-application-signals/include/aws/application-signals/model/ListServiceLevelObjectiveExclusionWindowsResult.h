...
class ListServiceLevelObjectiveExclusionWindowsResult {
 public:
  ...
  AWS_APPLICATIONSIGNALS_API ListServiceLevelObjectiveExclusionWindowsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetExclusionWindows(ExclusionWindowsT&& value) {
    m_exclusionWindowsHasBeenSet = true;
    m_exclusionWindows = std::forward<ExclusionWindowsT>(value);
  }
  template <typename ExclusionWindowsT = Aws::Vector<ExclusionWindow>>
  ListServiceLevelObjectiveExclusionWindowsResult& WithExclusionWindows(ExclusionWindowsT&& value) {
    SetExclusionWindows(std::forward<ExclusionWindowsT>(value));
    return *this;
  }
  template <typename ExclusionWindowsT = ExclusionWindow>
  ListServiceLevelObjectiveExclusionWindowsResult& AddExclusionWindows(ExclusionWindowsT&& value) {
    m_exclusionWindowsHasBeenSet = true;
    m_exclusionWindows.emplace_back(std::forward<ExclusionWindowsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceLevelObjectiveExclusionWindowsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListServiceLevelObjectiveExclusionWindowsResult& WithRequestId(RequestIdT&& value) {
