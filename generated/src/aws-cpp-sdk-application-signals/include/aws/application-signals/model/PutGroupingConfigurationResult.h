...
class PutGroupingConfigurationResult {
 public:
  ...
  AWS_APPLICATIONSIGNALS_API PutGroupingConfigurationResult& operator=(
  ...
  template <typename GroupingConfigurationT = GroupingConfiguration>
  PutGroupingConfigurationResult& WithGroupingConfiguration(GroupingConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutGroupingConfigurationResult& WithRequestId(RequestIdT&& value) {
