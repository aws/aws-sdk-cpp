...
namespace Model
{
  ...
  public:
    ...
    template<typename TimestampT = Aws::Utils::DateTime>
    ChangeEvent& WithTimestamp(TimestampT&& value) { SetTimestamp(std::forward<TimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename AccountIdT = Aws::String>
    ChangeEvent& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RegionT = Aws::String>
    ChangeEvent& WithRegion(RegionT&& value) { SetRegion(std::forward<RegionT>(value)); return *this;}
    ///@}
    ...
    template<typename EntityT = Aws::Map<Aws::String, Aws::String>>
    ChangeEvent& WithEntity(EntityT&& value) { SetEntity(std::forward<EntityT>(value)); return *this;}
    ...
    ChangeEvent& AddEntity(EntityKeyT&& key, EntityValueT&& value) {
      m_entityHasBeenSet = true; m_entity.emplace(std::forward<EntityKeyT>(key), std::forward<EntityValueT>(value)); return *this;
    }
    ///@}
    ...
    inline void SetChangeEventType(ChangeEventType value) { m_changeEventTypeHasBeenSet = true; m_changeEventType = value; }
    inline ChangeEvent& WithChangeEventType(ChangeEventType value) { SetChangeEventType(value); return *this;}
    ///@}
    ...
    template<typename EventIdT = Aws::String>
    ChangeEvent& WithEventId(EventIdT&& value) { SetEventId(std::forward<EventIdT>(value)); return *this;}
    ///@}
    ...
    template<typename UserNameT = Aws::String>
    ChangeEvent& WithUserName(UserNameT&& value) { SetUserName(std::forward<UserNameT>(value)); return *this;}
    ///@}
    ...
    template<typename EventNameT = Aws::String>
    ChangeEvent& WithEventName(EventNameT&& value) { SetEventName(std::forward<EventNameT>(value)); return *this;}
    ///@}
  private:
