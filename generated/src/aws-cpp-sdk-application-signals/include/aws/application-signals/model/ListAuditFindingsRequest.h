...
namespace Model
{
  ...
  public:
    ...
    void SetAuditors(AuditorsT&& value) { m_auditorsHasBeenSet = true; m_auditors = std::forward<AuditorsT>(value); }
    template<typename AuditorsT = Aws::Vector<Aws::String>>
    ListAuditFindingsRequest& WithAuditors(AuditorsT&& value) { SetAuditors(std::forward<AuditorsT>(value)); return *this;}
    template<typename AuditorsT = Aws::String>
    ListAuditFindingsRequest& AddAuditors(AuditorsT&& value) { m_auditorsHasBeenSet = true; m_auditors.emplace_back(std::forward<AuditorsT>(value)); return *this; }
    ///@}
    ...
    void SetAuditTargets(AuditTargetsT&& value) { m_auditTargetsHasBeenSet = true; m_auditTargets = std::forward<AuditTargetsT>(value); }
    template<typename AuditTargetsT = Aws::Vector<AuditTarget>>
    ListAuditFindingsRequest& WithAuditTargets(AuditTargetsT&& value) { SetAuditTargets(std::forward<AuditTargetsT>(value)); return *this;}
    template<typename AuditTargetsT = AuditTarget>
    ListAuditFindingsRequest& AddAuditTargets(AuditTargetsT&& value) { m_auditTargetsHasBeenSet = true; m_auditTargets.emplace_back(std::forward<AuditTargetsT>(value)); return *this; }
    ///@}
