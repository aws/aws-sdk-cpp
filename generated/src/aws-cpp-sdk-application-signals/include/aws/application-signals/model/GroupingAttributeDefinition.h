...
namespace Model
{
  ...
  public:
    ...
    void SetGroupingName(GroupingNameT&& value) { m_groupingNameHasBeenSet = true; m_groupingName = std::forward<GroupingNameT>(value); }
    template<typename GroupingNameT = Aws::String>
    GroupingAttributeDefinition& WithGroupingName(GroupingNameT&& value) { SetGroupingName(std::forward<GroupingNameT>(value)); return *this;}
    ///@}
    ...
    void SetGroupingSourceKeys(GroupingSourceKeysT&& value) { m_groupingSourceKeysHasBeenSet = true; m_groupingSourceKeys = std::forward<GroupingSourceKeysT>(value); }
    template<typename GroupingSourceKeysT = Aws::Vector<Aws::String>>
    GroupingAttributeDefinition& WithGroupingSourceKeys(GroupingSourceKeysT&& value) { SetGroupingSourceKeys(std::forward<GroupingSourceKeysT>(value)); return *this;}
    template<typename GroupingSourceKeysT = Aws::String>
    GroupingAttributeDefinition& AddGroupingSourceKeys(GroupingSourceKeysT&& value) { m_groupingSourceKeysHasBeenSet = true; m_groupingSourceKeys.emplace_back(std::forward<GroupingSourceKeysT>(value)); return *this; }
    ///@}
    ...
    void SetDefaultGroupingValue(DefaultGroupingValueT&& value) { m_defaultGroupingValueHasBeenSet = true; m_defaultGroupingValue = std::forward<DefaultGroupingValueT>(value); }
    template<typename DefaultGroupingValueT = Aws::String>
    GroupingAttributeDefinition& WithDefaultGroupingValue(DefaultGroupingValueT&& value) { SetDefaultGroupingValue(std::forward<DefaultGroupingValueT>(value)); return *this;}
    ///@}
  private:
