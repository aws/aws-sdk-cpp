...
class AWS_APPLICATIONSIGNALS_API ApplicationSignalsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ApplicationSignalsClient(const Aws::ApplicationSignals::ApplicationSignalsClientConfiguration& clientConfiguration =
  ...
  ApplicationSignalsClient(const Aws::Auth::AWSCredentials& credentials,
                           std::shared_ptr<ApplicationSignalsEndpointProviderBase> endpointProvider = nullptr,
                           const Aws::ApplicationSignals::ApplicationSignalsClientConfiguration& clientConfiguration =
                               Aws::ApplicationSignals::ApplicationSignalsClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetServiceLevelObjectiveBudgetReportOutcome BatchGetServiceLevelObjectiveBudgetReport(
      const Model::BatchGetServiceLevelObjectiveBudgetReportRequest& request) const;

  /**
   * A Callable wrapper for BatchGetServiceLevelObjectiveBudgetReport that returns a future to the operation so that it can be executed in
  ...
  Model::BatchGetServiceLevelObjectiveBudgetReportOutcomeCallable BatchGetServiceLevelObjectiveBudgetReportCallable(
      const BatchGetServiceLevelObjectiveBudgetReportRequestT& request) const {
    return SubmitCallable(&ApplicationSignalsClient::BatchGetServiceLevelObjectiveBudgetReport, request);
  }

  /**
   * An Async wrapper for BatchGetServiceLevelObjectiveBudgetReport that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchGetServiceLevelObjectiveBudgetReportRequestT = Model::BatchGetServiceLevelObjectiveBudgetReportRequest>
  void BatchGetServiceLevelObjectiveBudgetReportAsync(
      const BatchGetServiceLevelObjectiveBudgetReportRequestT& request,
      const BatchGetServiceLevelObjectiveBudgetReportResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchUpdateExclusionWindowsOutcome BatchUpdateExclusionWindows(
      const Model::BatchUpdateExclusionWindowsRequest& request) const;

  /**
   * A Callable wrapper for BatchUpdateExclusionWindows that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchUpdateExclusionWindowsRequestT = Model::BatchUpdateExclusionWindowsRequest>
  Model::BatchUpdateExclusionWindowsOutcomeCallable BatchUpdateExclusionWindowsCallable(
      const BatchUpdateExclusionWindowsRequestT& request) const {
    return SubmitCallable(&ApplicationSignalsClient::BatchUpdateExclusionWindows, request);
  }

  /**
   * An Async wrapper for BatchUpdateExclusionWindows that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchUpdateExclusionWindowsRequestT = Model::BatchUpdateExclusionWindowsRequest>
  void BatchUpdateExclusionWindowsAsync(const BatchUpdateExclusionWindowsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateServiceLevelObjectiveOutcome CreateServiceLevelObjective(
      const Model::CreateServiceLevelObjectiveRequest& request) const;

  /**
   * A Callable wrapper for CreateServiceLevelObjective that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateServiceLevelObjectiveRequestT = Model::CreateServiceLevelObjectiveRequest>
  Model::CreateServiceLevelObjectiveOutcomeCallable CreateServiceLevelObjectiveCallable(
      const CreateServiceLevelObjectiveRequestT& request) const {
    return SubmitCallable(&ApplicationSignalsClient::CreateServiceLevelObjective, request);
  }

  /**
   * An Async wrapper for CreateServiceLevelObjective that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateServiceLevelObjectiveRequestT = Model::CreateServiceLevelObjectiveRequest>
  void CreateServiceLevelObjectiveAsync(const CreateServiceLevelObjectiveRequestT& request,
                                        const CreateServiceLevelObjectiveResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteGroupingConfigurationOutcome DeleteGroupingConfiguration(
      const Model::DeleteGroupingConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteGroupingConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteGroupingConfigurationRequestT = Model::DeleteGroupingConfigurationRequest>
  Model::DeleteGroupingConfigurationOutcomeCallable DeleteGroupingConfigurationCallable(
      const DeleteGroupingConfigurationRequestT& request = {}) const {
    return SubmitCallable(&ApplicationSignalsClient::DeleteGroupingConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteGroupingConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteGroupingConfigurationRequestT = Model::DeleteGroupingConfigurationRequest>
  void DeleteGroupingConfigurationAsync(const DeleteGroupingConfigurationResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteServiceLevelObjectiveOutcome DeleteServiceLevelObjective(
      const Model::DeleteServiceLevelObjectiveRequest& request) const;

  /**
   * A Callable wrapper for DeleteServiceLevelObjective that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteServiceLevelObjectiveRequestT = Model::DeleteServiceLevelObjectiveRequest>
  Model::DeleteServiceLevelObjectiveOutcomeCallable DeleteServiceLevelObjectiveCallable(
      const DeleteServiceLevelObjectiveRequestT& request) const {
    return SubmitCallable(&ApplicationSignalsClient::DeleteServiceLevelObjective, request);
  }

  /**
   * An Async wrapper for DeleteServiceLevelObjective that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteServiceLevelObjectiveRequestT = Model::DeleteServiceLevelObjectiveRequest>
  void DeleteServiceLevelObjectiveAsync(const DeleteServiceLevelObjectiveRequestT& request,
  ...
  /**
   * A Callable wrapper for GetServiceLevelObjective that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetServiceLevelObjective that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetServiceLevelObjectiveRequestT = Model::GetServiceLevelObjectiveRequest>
  void GetServiceLevelObjectiveAsync(const GetServiceLevelObjectiveRequestT& request,
                                     const GetServiceLevelObjectiveResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAuditFindings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAuditFindings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAuditFindingsRequestT = Model::ListAuditFindingsRequest>
  void ListAuditFindingsAsync(const ListAuditFindingsRequestT& request, const ListAuditFindingsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListGroupingAttributeDefinitionsOutcome ListGroupingAttributeDefinitions(
      const Model::ListGroupingAttributeDefinitionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListGroupingAttributeDefinitions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListGroupingAttributeDefinitionsRequestT = Model::ListGroupingAttributeDefinitionsRequest>
  Model::ListGroupingAttributeDefinitionsOutcomeCallable ListGroupingAttributeDefinitionsCallable(
  ...
  /**
   * An Async wrapper for ListGroupingAttributeDefinitions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListGroupingAttributeDefinitionsRequestT = Model::ListGroupingAttributeDefinitionsRequest>
  void ListGroupingAttributeDefinitionsAsync(const ListGroupingAttributeDefinitionsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const ListGroupingAttributeDefinitionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListServiceDependencies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListServiceDependencies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListServiceDependenciesRequestT = Model::ListServiceDependenciesRequest>
  void ListServiceDependenciesAsync(const ListServiceDependenciesRequestT& request,
                                    const ListServiceDependenciesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListServiceDependents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListServiceDependents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListServiceDependentsRequestT = Model::ListServiceDependentsRequest>
  void ListServiceDependentsAsync(const ListServiceDependentsRequestT& request, const ListServiceDependentsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListServiceLevelObjectiveExclusionWindowsOutcome ListServiceLevelObjectiveExclusionWindows(
      const Model::ListServiceLevelObjectiveExclusionWindowsRequest& request) const;

  /**
   * A Callable wrapper for ListServiceLevelObjectiveExclusionWindows that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListServiceLevelObjectiveExclusionWindowsOutcomeCallable ListServiceLevelObjectiveExclusionWindowsCallable(
      const ListServiceLevelObjectiveExclusionWindowsRequestT& request) const {
    return SubmitCallable(&ApplicationSignalsClient::ListServiceLevelObjectiveExclusionWindows, request);
  }

  /**
   * An Async wrapper for ListServiceLevelObjectiveExclusionWindows that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListServiceLevelObjectiveExclusionWindowsRequestT = Model::ListServiceLevelObjectiveExclusionWindowsRequest>
  void ListServiceLevelObjectiveExclusionWindowsAsync(
      const ListServiceLevelObjectiveExclusionWindowsRequestT& request,
      const ListServiceLevelObjectiveExclusionWindowsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListServiceLevelObjectivesOutcome ListServiceLevelObjectives(
      const Model::ListServiceLevelObjectivesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListServiceLevelObjectives that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListServiceLevelObjectivesRequestT = Model::ListServiceLevelObjectivesRequest>
  Model::ListServiceLevelObjectivesOutcomeCallable ListServiceLevelObjectivesCallable(
      const ListServiceLevelObjectivesRequestT& request = {}) const {
    return SubmitCallable(&ApplicationSignalsClient::ListServiceLevelObjectives, request);
  }

  /**
   * An Async wrapper for ListServiceLevelObjectives that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListServiceLevelObjectivesRequestT = Model::ListServiceLevelObjectivesRequest>
  void ListServiceLevelObjectivesAsync(const ListServiceLevelObjectivesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListServiceLevelObjectivesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListServiceOperations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListServiceOperations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListServiceOperationsRequestT = Model::ListServiceOperationsRequest>
  void ListServiceOperationsAsync(const ListServiceOperationsRequestT& request, const ListServiceOperationsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListServiceStates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListServiceStates that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListServiceStatesRequestT = Model::ListServiceStatesRequest>
  void ListServiceStatesAsync(const ListServiceStatesRequestT& request, const ListServiceStatesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListServicesRequestT = Model::ListServicesRequest>
  void ListServicesAsync(const ListServicesRequestT& request, const ListServicesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutGroupingConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutGroupingConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutGroupingConfigurationRequestT = Model::PutGroupingConfigurationRequest>
  void PutGroupingConfigurationAsync(const PutGroupingConfigurationRequestT& request,
  ...
  /**
   * An Async wrapper for StartDiscovery that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartDiscoveryRequestT = Model::StartDiscoveryRequest>
  void StartDiscoveryAsync(const StartDiscoveryResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const StartDiscoveryRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateServiceLevelObjectiveOutcome UpdateServiceLevelObjective(
      const Model::UpdateServiceLevelObjectiveRequest& request) const;

  /**
   * A Callable wrapper for UpdateServiceLevelObjective that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateServiceLevelObjectiveRequestT = Model::UpdateServiceLevelObjectiveRequest>
  Model::UpdateServiceLevelObjectiveOutcomeCallable UpdateServiceLevelObjectiveCallable(
      const UpdateServiceLevelObjectiveRequestT& request) const {
    return SubmitCallable(&ApplicationSignalsClient::UpdateServiceLevelObjective, request);
  }

  /**
   * An Async wrapper for UpdateServiceLevelObjective that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateServiceLevelObjectiveRequestT = Model::UpdateServiceLevelObjectiveRequest>
  void UpdateServiceLevelObjectiveAsync(const UpdateServiceLevelObjectiveRequestT& request,
                                        const UpdateServiceLevelObjectiveResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
