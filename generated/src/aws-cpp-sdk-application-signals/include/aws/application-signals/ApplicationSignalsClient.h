...
namespace ApplicationSignals
{
   ...
   * maps.</p>
   */
  class AWS_APPLICATIONSIGNALS_API ApplicationSignalsClient : smithy::client::AwsSmithyClientT<Aws::ApplicationSignals::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<ApplicationSignalsClient>
  {
    public:
