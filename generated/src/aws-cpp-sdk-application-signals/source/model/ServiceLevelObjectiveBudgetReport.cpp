...
ServiceLevelObjectiveBudgetReport::ServiceLevelObjectiveBudgetReport(JsonView jsonValue) { *this = jsonValue; }
...
ServiceLevelObjectiveBudgetReport& ServiceLevelObjectiveBudgetReport::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("BudgetStatus")) {
    m_budgetStatus =
        ServiceLevelObjectiveBudgetStatusMapper::GetServiceLevelObjectiveBudgetStatusForName(jsonValue.GetString("BudgetStatus"));
...
JsonValue ServiceLevelObjectiveBudgetReport::Jsonize() const {
  ...
  if (m_budgetStatusHasBeenSet) {
    payload.WithString("BudgetStatus",
                       ServiceLevelObjectiveBudgetStatusMapper::GetNameForServiceLevelObjectiveBudgetStatus(m_budgetStatus));
  }
