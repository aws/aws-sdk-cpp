...
UpdateServiceLevelObjectiveResult::UpdateServiceLevelObjectiveResult()
{
}

UpdateServiceLevelObjectiveResult::UpdateServiceLevelObjectiveResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
