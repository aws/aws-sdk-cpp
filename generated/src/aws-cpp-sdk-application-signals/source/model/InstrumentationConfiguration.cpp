...
InstrumentationConfiguration::InstrumentationConfiguration(JsonView jsonValue) { *this = jsonValue; }

InstrumentationConfiguration& InstrumentationConfiguration::operator=(JsonView jsonValue) {
...
JsonValue InstrumentationConfiguration::Jsonize() const {
  JsonValue payload;
