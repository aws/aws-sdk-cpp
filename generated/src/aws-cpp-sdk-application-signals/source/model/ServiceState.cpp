...
ServiceState::ServiceState(JsonView jsonValue)
{
  *this = jsonValue;
}
...
ServiceState& ServiceState::operator =(JsonView jsonValue)
{
  ...
  if(jsonValue.ValueExists("LatestChangeEvents"))
  {
    ...
    for(unsigned latestChangeEventsIndex = 0; latestChangeEventsIndex < latestChangeEventsJsonList.GetLength(); ++latestChangeEventsIndex)
    {
