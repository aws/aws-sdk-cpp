...
DescribeDBClusterParameterGroupsResult& DescribeDBClusterParameterGroupsResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::DocDB::Model::DescribeDBClusterParameterGroupsResult",
