...
DescribeOrderableDBInstanceOptionsResult& DescribeOrderableDBInstanceOptionsResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::DocDB::Model::DescribeOrderableDBInstanceOptionsResult",
