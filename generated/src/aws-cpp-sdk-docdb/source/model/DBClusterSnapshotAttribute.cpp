...
DBClusterSnapshotAttribute::DBClusterSnapshotAttribute(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DBClusterSnapshotAttribute::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
