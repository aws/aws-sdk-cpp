...
class ClusterMasterUserSecret {
 public:
  ...
  template <typename SecretArnT = Aws::String>
  ClusterMasterUserSecret& WithSecretArn(SecretArnT&& value) {
  ...
  void SetSecretStatus(SecretStatusT&& value) {
    m_secretStatusHasBeenSet = true;
    m_secretStatus = std::forward<SecretStatusT>(value);
  }
  template <typename SecretStatusT = Aws::String>
  ClusterMasterUserSecret& WithSecretStatus(SecretStatusT&& value) {
    SetSecretStatus(std::forward<SecretStatusT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename KmsKeyIdT = Aws::String>
  ClusterMasterUserSecret& WithKmsKeyId(KmsKeyIdT&& value) {
