...
namespace Model
{
  ...
  {
  public:
    AWS_DOCDB_API DescribeEngineDefaultClusterParametersResult();
    ...
    AWS_DOCDB_API DescribeEngineDefaultClusterParametersResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
