...
class DescribeEngineDefaultClusterParametersResult {
 public:
  AWS_DOCDB_API DescribeEngineDefaultClusterParametersResult() = default;
  AWS_DOCDB_API DescribeEngineDefaultClusterParametersResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_DOCDB_API DescribeEngineDefaultClusterParametersResult& operator=(
  ...
  template <typename EngineDefaultsT = EngineDefaults>
  DescribeEngineDefaultClusterParametersResult& WithEngineDefaults(EngineDefaultsT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeEngineDefaultClusterParametersResult& WithResponseMetadata(ResponseMetadataT&& value) {
