 ...
 * API Reference</a></p>
 */
class DescribePendingMaintenanceActionsRequest : public DocDBRequest {
 public:
  AWS_DOCDB_API DescribePendingMaintenanceActionsRequest() = default;
 ...
 public:
  ...
  template <typename ResourceIdentifierT = Aws::String>
  DescribePendingMaintenanceActionsRequest& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribePendingMaintenanceActionsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribePendingMaintenanceActionsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribePendingMaintenanceActionsRequest& WithMarker(MarkerT&& value) {
  ...
  inline DescribePendingMaintenanceActionsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
