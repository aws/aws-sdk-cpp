...
class Certificate {
 public:
  ...
  void SetCertificateType(CertificateTypeT&& value) {
    ...
    m_certificateType = std::forward<CertificateTypeT>(value);
  }
  template <typename CertificateTypeT = Aws::String>
  Certificate& WithCertificateType(CertificateTypeT&& value) {
    SetCertificateType(std::forward<CertificateTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetValidTill(ValidTillT&& value) {
    ...
    m_validTill = std::forward<ValidTillT>(value);
  }
  template <typename ValidTillT = Aws::Utils::DateTime>
  Certificate& WithValidTill(ValidTillT&& value) {
    SetValidTill(std::forward<ValidTillT>(value));
    return *this;
  }
  ///@}
