...
class ModifyDBInstanceRequest : public DocDBRequest {
 ...
 public:
  ...
  inline ModifyDBInstanceRequest& WithApplyImmediately(bool value) {
  ...
  inline ModifyDBInstanceRequest& WithAutoMinorVersionUpgrade(bool value) {
  ...
  void SetNewDBInstanceIdentifier(NewDBInstanceIdentifierT&& value) {
    m_newDBInstanceIdentifierHasBeenSet = true;
    m_newDBInstanceIdentifier = std::forward<NewDBInstanceIdentifierT>(value);
  }
  template <typename NewDBInstanceIdentifierT = Aws::String>
  ModifyDBInstanceRequest& WithNewDBInstanceIdentifier(NewDBInstanceIdentifierT&& value) {
    SetNewDBInstanceIdentifier(std::forward<NewDBInstanceIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModifyDBInstanceRequest& WithCopyTagsToSnapshot(bool value) {
  ...
  inline ModifyDBInstanceRequest& WithPromotionTier(int value) {
   ...
   * href="https://docs.aws.amazon.com/documentdb/latest/devguide/performance-insights.html">Using
  ...
  inline ModifyDBInstanceRequest& WithEnablePerformanceInsights(bool value) {
  ...
  inline void SetCertificateRotationRestart(bool value) {
    m_certificateRotationRestartHasBeenSet = true;
    m_certificateRotationRestart = value;
  }
  inline ModifyDBInstanceRequest& WithCertificateRotationRestart(bool value) {
    SetCertificateRotationRestart(value);
    return *this;
  }
  ///@}
 private:
