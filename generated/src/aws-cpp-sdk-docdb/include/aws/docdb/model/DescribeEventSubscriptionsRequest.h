...
namespace Model
{
  ...
  /**
   * <p>Represents the input to <a>DescribeEventSubscriptions</a>.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeEventSubscriptionsMessage">AWS
   * API Reference</a></p>
   */
  class DescribeEventSubscriptionsRequest : public DocDBRequest
  {
  public:
    AWS_DOCDB_API DescribeEventSubscriptionsRequest() = default;
