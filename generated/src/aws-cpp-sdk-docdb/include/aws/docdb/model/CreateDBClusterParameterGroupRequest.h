...
class CreateDBClusterParameterGroupRequest : public DocDBRequest {
 ...
 public:
  ...
  template <typename DBClusterParameterGroupNameT = Aws::String>
  CreateDBClusterParameterGroupRequest& WithDBClusterParameterGroupName(DBClusterParameterGroupNameT&& value) {
  ...
  template <typename DBParameterGroupFamilyT = Aws::String>
  CreateDBClusterParameterGroupRequest& WithDBParameterGroupFamily(DBParameterGroupFamilyT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateDBClusterParameterGroupRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateDBClusterParameterGroupRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateDBClusterParameterGroupRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
