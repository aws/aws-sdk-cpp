...
class DescribeDBClusterSnapshotsResult {
 public:
  ...
  void SetDBClusterSnapshots(DBClusterSnapshotsT&& value) {
    ...
    m_dBClusterSnapshots = std::forward<DBClusterSnapshotsT>(value);
  }
  template <typename DBClusterSnapshotsT = Aws::Vector<DBClusterSnapshot>>
  DescribeDBClusterSnapshotsResult& WithDBClusterSnapshots(DBClusterSnapshotsT&& value) {
    SetDBClusterSnapshots(std::forward<DBClusterSnapshotsT>(value));
    return *this;
  }
  ...
  DescribeDBClusterSnapshotsResult& AddDBClusterSnapshots(DBClusterSnapshotsT&& value) {
    m_dBClusterSnapshotsHasBeenSet = true;
    m_dBClusterSnapshots.emplace_back(std::forward<DBClusterSnapshotsT>(value));
    return *this;
  }
  ///@}
