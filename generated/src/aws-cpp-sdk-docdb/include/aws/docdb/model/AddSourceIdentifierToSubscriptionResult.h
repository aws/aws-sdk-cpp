...
class AddSourceIdentifierToSubscriptionResult {
 public:
  ...
  template <typename EventSubscriptionT = EventSubscription>
  AddSourceIdentifierToSubscriptionResult& WithEventSubscription(EventSubscriptionT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AddSourceIdentifierToSubscriptionResult& WithResponseMetadata(ResponseMetadataT&& value) {
