...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DescribeEngineDefaultClusterParametersRequest : public DocDBRequest
  {
  public:
    AWS_DOCDB_API DescribeEngineDefaultClusterParametersRequest() = default;
  ...
  public:
    ...
    template<typename DBParameterGroupFamilyT = Aws::String>
    DescribeEngineDefaultClusterParametersRequest& WithDBParameterGroupFamily(DBParameterGroupFamilyT&& value) { SetDBParameterGroupFamily(std::forward<DBParameterGroupFamilyT>(value)); return *this;}
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    DescribeEngineDefaultClusterParametersRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    DescribeEngineDefaultClusterParametersRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    DescribeEngineDefaultClusterParametersRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
  private:
