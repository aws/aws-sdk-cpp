...
class DescribeEngineDefaultClusterParametersRequest : public DocDBRequest {
 ...
 public:
  ...
  template <typename DBParameterGroupFamilyT = Aws::String>
  DescribeEngineDefaultClusterParametersRequest& WithDBParameterGroupFamily(DBParameterGroupFamilyT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeEngineDefaultClusterParametersRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeEngineDefaultClusterParametersRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeEngineDefaultClusterParametersRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeEngineDefaultClusterParametersRequest& WithMarker(MarkerT&& value) {
