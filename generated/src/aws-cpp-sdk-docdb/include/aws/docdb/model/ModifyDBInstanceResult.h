...
namespace Model
{
  ...
  {
  public:
    AWS_DOCDB_API ModifyDBInstanceResult() = default;
    ...
    template<typename DBInstanceT = DBInstance>
    ModifyDBInstanceResult& WithDBInstance(DBInstanceT&& value) { SetDBInstance(std::forward<DBInstanceT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyDBInstanceResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
