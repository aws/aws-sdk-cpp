...
class AWS_DOCDB_API DocDBClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  DocDBClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<DocDBEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for DescribeCertificates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCertificates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCertificatesRequestT = Model::DescribeCertificatesRequest>
  void DescribeCertificatesAsync(const DescribeCertificatesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeCertificatesRequestT& request = {}) const {
