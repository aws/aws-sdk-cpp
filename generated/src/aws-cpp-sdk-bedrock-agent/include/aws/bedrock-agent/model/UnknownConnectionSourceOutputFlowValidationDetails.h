...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENT_API UnknownConnectionSourceOutputFlowValidationDetails();
    ...
    inline UnknownConnectionSourceOutputFlowValidationDetails& WithConnection(const Aws::String& value) { SetConnection(value); return *this;}
    inline UnknownConnectionSourceOutputFlowValidationDetails& WithConnection(Aws::String&& value) { SetConnection(std::move(value)); return *this;}
    inline UnknownConnectionSourceOutputFlowValidationDetails& WithConnection(const char* value) { SetConnection(value); return *this;}
    ///@}
  private:
