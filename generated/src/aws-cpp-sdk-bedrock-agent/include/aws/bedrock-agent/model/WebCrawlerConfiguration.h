...
class WebCrawlerConfiguration {
 public:
  ...
  void SetUserAgentHeader(UserAgentHeaderT&& value) {
    m_userAgentHeaderHasBeenSet = true;
    m_userAgentHeader = std::forward<UserAgentHeaderT>(value);
  }
  template <typename UserAgentHeaderT = Aws::String>
  WebCrawlerConfiguration& WithUserAgentHeader(UserAgentHeaderT&& value) {
    SetUserAgentHeader(std::forward<UserAgentHeaderT>(value));
    return *this;
  }
  ///@}
 private:
