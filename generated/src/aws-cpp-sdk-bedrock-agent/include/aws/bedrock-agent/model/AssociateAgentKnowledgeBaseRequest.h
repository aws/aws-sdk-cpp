...
class AssociateAgentKnowledgeBaseRequest : public BedrockAgentRequest {
 public:
  ...
  inline void SetKnowledgeBaseState(KnowledgeBaseState value) {
    m_knowledgeBaseStateHasBeenSet = true;
    m_knowledgeBaseState = value;
  }
  inline AssociateAgentKnowledgeBaseRequest& WithKnowledgeBaseState(KnowledgeBaseState value) {
    SetKnowledgeBaseState(value);
    return *this;
  }
  ///@}
 private:
