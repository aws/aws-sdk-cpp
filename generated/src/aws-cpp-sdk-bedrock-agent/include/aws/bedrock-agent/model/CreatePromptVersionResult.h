...
class CreatePromptVersionResult {
 public:
  ...
  template <typename NameT = Aws::String>
  CreatePromptVersionResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreatePromptVersionResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename CustomerEncryptionKeyArnT = Aws::String>
  CreatePromptVersionResult& WithCustomerEncryptionKeyArn(CustomerEncryptionKeyArnT&& value) {
  ...
  template <typename DefaultVariantT = Aws::String>
  CreatePromptVersionResult& WithDefaultVariant(DefaultVariantT&& value) {
  ...
  template <typename VariantsT = Aws::Vector<PromptVariant>>
  CreatePromptVersionResult& WithVariants(VariantsT&& value) {
    SetVariants(std::forward<VariantsT>(value));
    return *this;
  }
  template <typename VariantsT = PromptVariant>
  CreatePromptVersionResult& AddVariants(VariantsT&& value) {
    m_variantsHasBeenSet = true;
  ...
  template <typename IdT = Aws::String>
  CreatePromptVersionResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreatePromptVersionResult& WithArn(ArnT&& value) {
  ...
  template <typename VersionT = Aws::String>
  CreatePromptVersionResult& WithVersion(VersionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreatePromptVersionResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreatePromptVersionResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePromptVersionResult& WithRequestId(RequestIdT&& value) {
