...
class ListAgentAliasesResult {
 public:
  ...
  void SetAgentAliasSummaries(AgentAliasSummariesT&& value) {
    m_agentAliasSummariesHasBeenSet = true;
    m_agentAliasSummaries = std::forward<AgentAliasSummariesT>(value);
  }
  template <typename AgentAliasSummariesT = Aws::Vector<AgentAliasSummary>>
  ListAgentAliasesResult& WithAgentAliasSummaries(AgentAliasSummariesT&& value) {
    SetAgentAliasSummaries(std::forward<AgentAliasSummariesT>(value));
    return *this;
  }
  template <typename AgentAliasSummariesT = AgentAliasSummary>
  ListAgentAliasesResult& AddAgentAliasSummaries(AgentAliasSummariesT&& value) {
    m_agentAliasSummariesHasBeenSet = true;
    m_agentAliasSummaries.emplace_back(std::forward<AgentAliasSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentAliasesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAgentAliasesResult& WithRequestId(RequestIdT&& value) {
