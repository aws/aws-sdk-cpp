...
class ListAgentKnowledgeBasesResult {
 public:
  ...
  void SetAgentKnowledgeBaseSummaries(AgentKnowledgeBaseSummariesT&& value) {
    m_agentKnowledgeBaseSummariesHasBeenSet = true;
    m_agentKnowledgeBaseSummaries = std::forward<AgentKnowledgeBaseSummariesT>(value);
  }
  template <typename AgentKnowledgeBaseSummariesT = Aws::Vector<AgentKnowledgeBaseSummary>>
  ListAgentKnowledgeBasesResult& WithAgentKnowledgeBaseSummaries(AgentKnowledgeBaseSummariesT&& value) {
    SetAgentKnowledgeBaseSummaries(std::forward<AgentKnowledgeBaseSummariesT>(value));
    return *this;
  }
  template <typename AgentKnowledgeBaseSummariesT = AgentKnowledgeBaseSummary>
  ListAgentKnowledgeBasesResult& AddAgentKnowledgeBaseSummaries(AgentKnowledgeBaseSummariesT&& value) {
    m_agentKnowledgeBaseSummariesHasBeenSet = true;
    m_agentKnowledgeBaseSummaries.emplace_back(std::forward<AgentKnowledgeBaseSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentKnowledgeBasesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAgentKnowledgeBasesResult& WithRequestId(RequestIdT&& value) {
