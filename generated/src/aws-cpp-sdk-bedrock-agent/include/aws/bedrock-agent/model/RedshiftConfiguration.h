...
class RedshiftConfiguration {
 public:
  ...
  void SetQueryEngineConfiguration(QueryEngineConfigurationT&& value) {
    ...
    m_queryEngineConfiguration = std::forward<QueryEngineConfigurationT>(value);
  }
  template <typename QueryEngineConfigurationT = RedshiftQueryEngineConfiguration>
  RedshiftConfiguration& WithQueryEngineConfiguration(QueryEngineConfigurationT&& value) {
    SetQueryEngineConfiguration(std::forward<QueryEngineConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQueryGenerationConfiguration(QueryGenerationConfigurationT&& value) {
    ...
    m_queryGenerationConfiguration = std::forward<QueryGenerationConfigurationT>(value);
  }
  template <typename QueryGenerationConfigurationT = QueryGenerationConfiguration>
  RedshiftConfiguration& WithQueryGenerationConfiguration(QueryGenerationConfigurationT&& value) {
    SetQueryGenerationConfiguration(std::forward<QueryGenerationConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
