...
class DocumentMetadata {
 public:
  ...
  inline void SetType(MetadataSourceType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline DocumentMetadata& WithType(MetadataSourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetInlineAttributes(InlineAttributesT&& value) {
    ...
    m_inlineAttributes = std::forward<InlineAttributesT>(value);
  }
  template <typename InlineAttributesT = Aws::Vector<MetadataAttribute>>
  DocumentMetadata& WithInlineAttributes(InlineAttributesT&& value) {
    SetInlineAttributes(std::forward<InlineAttributesT>(value));
    return *this;
  }
  template <typename InlineAttributesT = MetadataAttribute>
  DocumentMetadata& AddInlineAttributes(InlineAttributesT&& value) {
    m_inlineAttributesHasBeenSet = true;
    m_inlineAttributes.emplace_back(std::forward<InlineAttributesT>(value));
    return *this;
  }
  ///@}
