...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENT_API S3Content();
    ...
    inline S3Content& WithS3Location(const S3Location& value) { SetS3Location(value); return *this;}
    inline S3Content& WithS3Location(S3Location&& value) { SetS3Location(std::move(value)); return *this;}
    ///@}
  private:
