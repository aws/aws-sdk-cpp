...
class CrawlFilterConfiguration {
 public:
  ...
  inline void SetType(CrawlFilterConfigurationType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CrawlFilterConfiguration& WithType(CrawlFilterConfigurationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetPatternObjectFilter(PatternObjectFilterT&& value) {
    m_patternObjectFilterHasBeenSet = true;
    m_patternObjectFilter = std::forward<PatternObjectFilterT>(value);
  }
  template <typename PatternObjectFilterT = PatternObjectFilterConfiguration>
  CrawlFilterConfiguration& WithPatternObjectFilter(PatternObjectFilterT&& value) {
    SetPatternObjectFilter(std::forward<PatternObjectFilterT>(value));
    return *this;
  }
  ///@}
 private:
