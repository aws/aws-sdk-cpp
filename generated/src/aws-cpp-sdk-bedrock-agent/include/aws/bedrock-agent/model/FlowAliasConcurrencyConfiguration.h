...
class FlowAliasConcurrencyConfiguration {
 public:
  ...
  inline void SetType(ConcurrencyType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline FlowAliasConcurrencyConfiguration& WithType(ConcurrencyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline FlowAliasConcurrencyConfiguration& WithMaxConcurrency(int value) {
