...
class ListFlowVersionsRequest : public BedrockAgentRequest {
 public:
  ...
  template <typename FlowIdentifierT = Aws::String>
  ListFlowVersionsRequest& WithFlowIdentifier(FlowIdentifierT&& value) {
  ...
  inline ListFlowVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFlowVersionsRequest& WithNextToken(NextTokenT&& value) {
