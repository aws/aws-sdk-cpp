...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENT_API ListFlowVersionsRequest() = default;
    ...
    template<typename FlowIdentifierT = Aws::String>
    ListFlowVersionsRequest& WithFlowIdentifier(FlowIdentifierT&& value) { SetFlowIdentifier(std::forward<FlowIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListFlowVersionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
