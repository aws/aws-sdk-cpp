...
class MismatchedNodeOutputTypeFlowValidationDetails {
 public:
  ...
  template <typename NodeT = Aws::String>
  MismatchedNodeOutputTypeFlowValidationDetails& WithNode(NodeT&& value) {
  ...
  template <typename OutputT = Aws::String>
  MismatchedNodeOutputTypeFlowValidationDetails& WithOutput(OutputT&& value) {
  ...
  inline MismatchedNodeOutputTypeFlowValidationDetails& WithExpectedType(FlowNodeIODataType value) {
