 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-2023-06-05/MongoDbAtlasFieldMapping">AWS
 * API Reference</a></p>
 */
class MongoDbAtlasFieldMapping {
 public:
  ...
  template <typename VectorFieldT = Aws::String>
  MongoDbAtlasFieldMapping& WithVectorField(VectorFieldT&& value) {
  ...
  template <typename TextFieldT = Aws::String>
  MongoDbAtlasFieldMapping& WithTextField(TextFieldT&& value) {
  ...
  template <typename MetadataFieldT = Aws::String>
  MongoDbAtlasFieldMapping& WithMetadataField(MetadataFieldT&& value) {
