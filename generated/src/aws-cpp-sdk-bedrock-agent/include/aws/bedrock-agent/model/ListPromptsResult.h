...
class ListPromptsResult {
 public:
  ...
  void SetPromptSummaries(PromptSummariesT&& value) {
    m_promptSummariesHasBeenSet = true;
    m_promptSummaries = std::forward<PromptSummariesT>(value);
  }
  template <typename PromptSummariesT = Aws::Vector<PromptSummary>>
  ListPromptsResult& WithPromptSummaries(PromptSummariesT&& value) {
    SetPromptSummaries(std::forward<PromptSummariesT>(value));
    return *this;
  }
  template <typename PromptSummariesT = PromptSummary>
  ListPromptsResult& AddPromptSummaries(PromptSummariesT&& value) {
    m_promptSummariesHasBeenSet = true;
    m_promptSummaries.emplace_back(std::forward<PromptSummariesT>(value));
    return *this;
  }
  ///@}
