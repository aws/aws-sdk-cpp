...
class IngestKnowledgeBaseDocumentsRequest : public BedrockAgentRequest {
 public:
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  IngestKnowledgeBaseDocumentsRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  template <typename DataSourceIdT = Aws::String>
  IngestKnowledgeBaseDocumentsRequest& WithDataSourceId(DataSourceIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  IngestKnowledgeBaseDocumentsRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DocumentsT = Aws::Vector<KnowledgeBaseDocument>>
  IngestKnowledgeBaseDocumentsRequest& WithDocuments(DocumentsT&& value) {
    SetDocuments(std::forward<DocumentsT>(value));
    return *this;
  }
  template <typename DocumentsT = KnowledgeBaseDocument>
  IngestKnowledgeBaseDocumentsRequest& AddDocuments(DocumentsT&& value) {
    m_documentsHasBeenSet = true;
