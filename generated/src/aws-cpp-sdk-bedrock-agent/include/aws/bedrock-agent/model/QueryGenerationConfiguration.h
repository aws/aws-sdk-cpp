...
class QueryGenerationConfiguration {
 public:
  ...
  inline void SetExecutionTimeoutSeconds(int value) {
    m_executionTimeoutSecondsHasBeenSet = true;
    m_executionTimeoutSeconds = value;
  }
  inline QueryGenerationConfiguration& WithExecutionTimeoutSeconds(int value) {
    SetExecutionTimeoutSeconds(value);
    return *this;
  }
  ///@}
  ...
  void SetGenerationContext(GenerationContextT&& value) {
    ...
    m_generationContext = std::forward<GenerationContextT>(value);
  }
  template <typename GenerationContextT = QueryGenerationContext>
  QueryGenerationConfiguration& WithGenerationContext(GenerationContextT&& value) {
    SetGenerationContext(std::forward<GenerationContextT>(value));
    return *this;
  }
  ///@}
 private:
