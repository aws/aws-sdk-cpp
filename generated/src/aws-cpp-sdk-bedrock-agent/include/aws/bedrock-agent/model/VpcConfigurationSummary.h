...
/**
 * <p>A summary of a VPC configuration returned by
 * <code>ListVpcConfigurations</code>.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-2023-06-05/VpcConfigurationSummary">AWS
 * API Reference</a></p>
 */
class VpcConfigurationSummary {
 public:
  AWS_BEDROCKAGENT_API VpcConfigurationSummary() = default;
  AWS_BEDROCKAGENT_API VpcConfigurationSummary(Aws::Utils::Json::JsonView jsonValue);
  AWS_BEDROCKAGENT_API VpcConfigurationSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename VpcConfigurationIdT = Aws::String>
  VpcConfigurationSummary& WithVpcConfigurationId(VpcConfigurationIdT&& value) {
  ...
  inline VpcConfigurationSummary& WithStatus(VpcConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  VpcConfigurationSummary& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  VpcConfigurationSummary& WithVpcId(VpcIdT&& value) {
  ...
  template <typename ResourceTargetT = Aws::String>
  VpcConfigurationSummary& WithResourceTarget(ResourceTargetT&& value) {
  ...
  inline VpcConfigurationSummary& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline VpcConfigurationSummary& WithProtocol(VpcProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline VpcConfigurationSummary& WithResolutionMode(VpcResolutionMode value) {
  ...
  template <typename HostHeaderT = Aws::String>
  VpcConfigurationSummary& WithHostHeader(HostHeaderT&& value) {
  ...
  template <typename TlsServerNameT = Aws::String>
  VpcConfigurationSummary& WithTlsServerName(TlsServerNameT&& value) {
  ...
  template <typename NameT = Aws::String>
  VpcConfigurationSummary& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  VpcConfigurationSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  VpcConfigurationSummary& WithCreatedAt(CreatedAtT&& value) {
