...
class OpenSearchManagedClusterFieldMapping {
 public:
  ...
  void SetVectorField(VectorFieldT&& value) {
    ...
    m_vectorField = std::forward<VectorFieldT>(value);
  }
  template <typename VectorFieldT = Aws::String>
  OpenSearchManagedClusterFieldMapping& WithVectorField(VectorFieldT&& value) {
    SetVectorField(std::forward<VectorFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextField(TextFieldT&& value) {
    ...
    m_textField = std::forward<TextFieldT>(value);
  }
  template <typename TextFieldT = Aws::String>
  OpenSearchManagedClusterFieldMapping& WithTextField(TextFieldT&& value) {
    SetTextField(std::forward<TextFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMetadataField(MetadataFieldT&& value) {
    ...
    m_metadataField = std::forward<MetadataFieldT>(value);
  }
  template <typename MetadataFieldT = Aws::String>
  OpenSearchManagedClusterFieldMapping& WithMetadataField(MetadataFieldT&& value) {
    SetMetadataField(std::forward<MetadataFieldT>(value));
    return *this;
  }
  ///@}
 private:
