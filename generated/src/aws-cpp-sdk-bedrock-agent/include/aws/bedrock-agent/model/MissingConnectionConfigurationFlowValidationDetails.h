...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENT_API MissingConnectionConfigurationFlowValidationDetails() = default;
    ...
    template<typename ConnectionT = Aws::String>
    MissingConnectionConfigurationFlowValidationDetails& WithConnection(ConnectionT&& value) { SetConnection(std::forward<ConnectionT>(value)); return *this;}
    ///@}
  private:
