...
class MismatchedNodeInputTypeFlowValidationDetails {
 public:
  ...
  template <typename NodeT = Aws::String>
  MismatchedNodeInputTypeFlowValidationDetails& WithNode(NodeT&& value) {
  ...
  template <typename InputT = Aws::String>
  MismatchedNodeInputTypeFlowValidationDetails& WithInput(InputT&& value) {
  ...
  inline void SetExpectedType(FlowNodeIODataType value) {
    m_expectedTypeHasBeenSet = true;
    m_expectedType = value;
  }
  inline MismatchedNodeInputTypeFlowValidationDetails& WithExpectedType(FlowNodeIODataType value) {
