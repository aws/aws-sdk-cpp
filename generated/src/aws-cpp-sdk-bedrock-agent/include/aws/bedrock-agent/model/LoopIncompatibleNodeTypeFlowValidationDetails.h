...
class LoopIncompatibleNodeTypeFlowValidationDetails {
 public:
  ...
  template <typename NodeT = Aws::String>
  LoopIncompatibleNodeTypeFlowValidationDetails& WithNode(NodeT&& value) {
  ...
  inline void SetIncompatibleNodeType(IncompatibleLoopNodeType value) {
    m_incompatibleNodeTypeHasBeenSet = true;
    m_incompatibleNodeType = value;
  }
  inline LoopIncompatibleNodeTypeFlowValidationDetails& WithIncompatibleNodeType(IncompatibleLoopNodeType value) {
    SetIncompatibleNodeType(value);
    return *this;
  }
  ///@}
  ...
  void SetIncompatibleNodeName(IncompatibleNodeNameT&& value) {
    m_incompatibleNodeNameHasBeenSet = true;
    m_incompatibleNodeName = std::forward<IncompatibleNodeNameT>(value);
  }
  template <typename IncompatibleNodeNameT = Aws::String>
  LoopIncompatibleNodeTypeFlowValidationDetails& WithIncompatibleNodeName(IncompatibleNodeNameT&& value) {
    SetIncompatibleNodeName(std::forward<IncompatibleNodeNameT>(value));
    return *this;
  }
  ///@}
 private:
