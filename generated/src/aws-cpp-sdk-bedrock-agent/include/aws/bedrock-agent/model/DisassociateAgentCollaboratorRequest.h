...
class DisassociateAgentCollaboratorRequest : public BedrockAgentRequest {
 public:
  ...
  template <typename AgentIdT = Aws::String>
  DisassociateAgentCollaboratorRequest& WithAgentId(AgentIdT&& value) {
  ...
  template <typename AgentVersionT = Aws::String>
  DisassociateAgentCollaboratorRequest& WithAgentVersion(AgentVersionT&& value) {
  ...
  template <typename CollaboratorIdT = Aws::String>
  DisassociateAgentCollaboratorRequest& WithCollaboratorId(CollaboratorIdT&& value) {
