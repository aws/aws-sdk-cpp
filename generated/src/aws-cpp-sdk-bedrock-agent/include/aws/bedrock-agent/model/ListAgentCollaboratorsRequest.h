...
class ListAgentCollaboratorsRequest : public BedrockAgentRequest {
 public:
  ...
  template <typename AgentIdT = Aws::String>
  ListAgentCollaboratorsRequest& WithAgentId(AgentIdT&& value) {
  ...
  template <typename AgentVersionT = Aws::String>
  ListAgentCollaboratorsRequest& WithAgentVersion(AgentVersionT&& value) {
  ...
  inline ListAgentCollaboratorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentCollaboratorsRequest& WithNextToken(NextTokenT&& value) {
