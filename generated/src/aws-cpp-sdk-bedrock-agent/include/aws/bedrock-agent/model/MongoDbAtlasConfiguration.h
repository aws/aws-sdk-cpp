...
class MongoDbAtlasConfiguration {
 public:
  ...
  void SetEndpointServiceName(EndpointServiceNameT&& value) {
    ...
    m_endpointServiceName = std::forward<EndpointServiceNameT>(value);
  }
  template <typename EndpointServiceNameT = Aws::String>
  MongoDbAtlasConfiguration& WithEndpointServiceName(EndpointServiceNameT&& value) {
    SetEndpointServiceName(std::forward<EndpointServiceNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextIndexName(TextIndexNameT&& value) {
    ...
    m_textIndexName = std::forward<TextIndexNameT>(value);
  }
  template <typename TextIndexNameT = Aws::String>
  MongoDbAtlasConfiguration& WithTextIndexName(TextIndexNameT&& value) {
    SetTextIndexName(std::forward<TextIndexNameT>(value));
    return *this;
  }
  ///@}
 private:
