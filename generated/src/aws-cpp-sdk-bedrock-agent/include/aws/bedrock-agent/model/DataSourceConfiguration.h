...
class DataSourceConfiguration {
 public:
  ...
  inline DataSourceConfiguration& WithType(DataSourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>Contains the configuration for a data source that connects a managed
   * knowledge base to a supported data source connector. Specify this object when
   * the data source type is <code>MANAGED_KNOWLEDGE_BASE_CONNECTOR</code>.</p>
   */
  inline const ManagedKnowledgeBaseConnectorConfiguration& GetManagedKnowledgeBaseConnectorConfiguration() const {
    return m_managedKnowledgeBaseConnectorConfiguration;
  }
  inline bool ManagedKnowledgeBaseConnectorConfigurationHasBeenSet() const {
    return m_managedKnowledgeBaseConnectorConfigurationHasBeenSet;
  }
  template <typename ManagedKnowledgeBaseConnectorConfigurationT = ManagedKnowledgeBaseConnectorConfiguration>
  void SetManagedKnowledgeBaseConnectorConfiguration(ManagedKnowledgeBaseConnectorConfigurationT&& value) {
    m_managedKnowledgeBaseConnectorConfigurationHasBeenSet = true;
    m_managedKnowledgeBaseConnectorConfiguration = std::forward<ManagedKnowledgeBaseConnectorConfigurationT>(value);
  }
  template <typename ManagedKnowledgeBaseConnectorConfigurationT = ManagedKnowledgeBaseConnectorConfiguration>
  DataSourceConfiguration& WithManagedKnowledgeBaseConnectorConfiguration(ManagedKnowledgeBaseConnectorConfigurationT&& value) {
    SetManagedKnowledgeBaseConnectorConfiguration(std::forward<ManagedKnowledgeBaseConnectorConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   * href="https://docs.aws.amazon.com/bedrock/latest/APIReference/API_agent_ManagedKnowledgeBaseConnectorConfiguration.html">managedKnowledgeBaseConnectorConfiguration</a>.</p>
   */
   ...
   * authorized to crawl the URLs.</p>  <p>To configure this data source for
   * managed knowledge bases, use <a
  ...
  void SetWebConfiguration(WebConfigurationT&& value) {
    ...
    m_webConfiguration = std::forward<WebConfigurationT>(value);
  }
  template <typename WebConfigurationT = WebDataSourceConfiguration>
  DataSourceConfiguration& WithWebConfiguration(WebConfigurationT&& value) {
    SetWebConfiguration(std::forward<WebConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   * for self-managed knowledge bases.</p>  <p>To configure this data source
   * for managed knowledge bases, use <a
   * href="https://docs.aws.amazon.com/bedrock/latest/APIReference/API_agent_ManagedKnowledgeBaseConnectorConfiguration.html">managedKnowledgeBaseConnectorConfiguration</a>.
  ...
  void SetConfluenceConfiguration(ConfluenceConfigurationT&& value) {
    ...
    m_confluenceConfiguration = std::forward<ConfluenceConfigurationT>(value);
  }
  template <typename ConfluenceConfigurationT = ConfluenceDataSourceConfiguration>
  DataSourceConfiguration& WithConfluenceConfiguration(ConfluenceConfigurationT&& value) {
    SetConfluenceConfiguration(std::forward<ConfluenceConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   * source.</p>  <p>Salesforce data source connector for self-managed
   * knowledge bases is in preview release and is subject to change.</p>
   */
  ...
  void SetSalesforceConfiguration(SalesforceConfigurationT&& value) {
    ...
    m_salesforceConfiguration = std::forward<SalesforceConfigurationT>(value);
  }
  template <typename SalesforceConfigurationT = SalesforceDataSourceConfiguration>
  DataSourceConfiguration& WithSalesforceConfiguration(SalesforceConfigurationT&& value) {
    SetSalesforceConfiguration(std::forward<SalesforceConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSharePointConfiguration(SharePointConfigurationT&& value) {
    ...
    m_sharePointConfiguration = std::forward<SharePointConfigurationT>(value);
  }
  template <typename SharePointConfigurationT = SharePointDataSourceConfiguration>
  DataSourceConfiguration& WithSharePointConfiguration(SharePointConfigurationT&& value) {
    SetSharePointConfiguration(std::forward<SharePointConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
  ...
  ManagedKnowledgeBaseConnectorConfiguration m_managedKnowledgeBaseConnectorConfiguration;
  ...
  bool m_managedKnowledgeBaseConnectorConfigurationHasBeenSet = false;
