...
class RedisEnterpriseCloudFieldMapping {
 public:
  ...
  template <typename VectorFieldT = Aws::String>
  RedisEnterpriseCloudFieldMapping& WithVectorField(VectorFieldT&& value) {
  ...
  template <typename TextFieldT = Aws::String>
  RedisEnterpriseCloudFieldMapping& WithTextField(TextFieldT&& value) {
  ...
  template <typename MetadataFieldT = Aws::String>
  RedisEnterpriseCloudFieldMapping& WithMetadataField(MetadataFieldT&& value) {
