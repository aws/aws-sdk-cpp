...
class CreatePromptResult {
 public:
  AWS_BEDROCKAGENT_API CreatePromptResult() = default;
  ...
  template <typename NameT = Aws::String>
  CreatePromptResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreatePromptResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename CustomerEncryptionKeyArnT = Aws::String>
  CreatePromptResult& WithCustomerEncryptionKeyArn(CustomerEncryptionKeyArnT&& value) {
  ...
  void SetDefaultVariant(DefaultVariantT&& value) {
    ...
    m_defaultVariant = std::forward<DefaultVariantT>(value);
  }
  template <typename DefaultVariantT = Aws::String>
  CreatePromptResult& WithDefaultVariant(DefaultVariantT&& value) {
    SetDefaultVariant(std::forward<DefaultVariantT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename VariantsT = Aws::Vector<PromptVariant>>
  CreatePromptResult& WithVariants(VariantsT&& value) {
    SetVariants(std::forward<VariantsT>(value));
    return *this;
  }
  template <typename VariantsT = PromptVariant>
  CreatePromptResult& AddVariants(VariantsT&& value) {
    m_variantsHasBeenSet = true;
  ...
  template <typename IdT = Aws::String>
  CreatePromptResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreatePromptResult& WithArn(ArnT&& value) {
  ...
  template <typename VersionT = Aws::String>
  CreatePromptResult& WithVersion(VersionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreatePromptResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreatePromptResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePromptResult& WithRequestId(RequestIdT&& value) {
