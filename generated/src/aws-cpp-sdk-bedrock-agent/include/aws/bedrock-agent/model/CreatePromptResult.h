...
namespace Model
{
  ...
  public:
    ...
    template<typename CustomerEncryptionKeyArnT = Aws::String>
    CreatePromptResult& WithCustomerEncryptionKeyArn(CustomerEncryptionKeyArnT&& value) { SetCustomerEncryptionKeyArn(std::forward<CustomerEncryptionKeyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultVariantT = Aws::String>
    CreatePromptResult& WithDefaultVariant(DefaultVariantT&& value) { SetDefaultVariant(std::forward<DefaultVariantT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    CreatePromptResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    CreatePromptResult& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
