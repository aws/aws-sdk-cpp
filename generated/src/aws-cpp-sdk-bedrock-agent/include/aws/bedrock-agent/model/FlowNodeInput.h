...
class FlowNodeInput {
 public:
  ...
  inline void SetType(FlowNodeIODataType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline FlowNodeInput& WithType(FlowNodeIODataType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline FlowNodeInput& WithCategory(FlowNodeInputCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
