...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENT_API UpdateAgentActionGroupResult() = default;
    ...
    template<typename AgentActionGroupT = AgentActionGroup>
    UpdateAgentActionGroupResult& WithAgentActionGroup(AgentActionGroupT&& value) { SetAgentActionGroup(std::forward<AgentActionGroupT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateAgentActionGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
