...
class SupplementalDataStorageLocation {
 public:
  ...
  inline void SetType(SupplementalDataStorageLocationType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline SupplementalDataStorageLocation& WithType(SupplementalDataStorageLocationType value) {
    SetType(value);
    return *this;
  }
  ///@}
