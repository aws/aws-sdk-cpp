...
namespace Model
{
  ...
  public:
    ...
    template<typename IngestionJobT = IngestionJob>
    StopIngestionJobResult& WithIngestionJob(IngestionJobT&& value) { SetIngestionJob(std::forward<IngestionJobT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StopIngestionJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
