...
class AgentAlias {
 public:
  ...
  void SetAgentAliasName(AgentAliasNameT&& value) {
    ...
    m_agentAliasName = std::forward<AgentAliasNameT>(value);
  }
  template <typename AgentAliasNameT = Aws::String>
  AgentAlias& WithAgentAliasName(AgentAliasNameT&& value) {
    SetAgentAliasName(std::forward<AgentAliasNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAgentAliasArn(AgentAliasArnT&& value) {
    ...
    m_agentAliasArn = std::forward<AgentAliasArnT>(value);
  }
  template <typename AgentAliasArnT = Aws::String>
  AgentAlias& WithAgentAliasArn(AgentAliasArnT&& value) {
    SetAgentAliasArn(std::forward<AgentAliasArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAgentAliasHistoryEvents(AgentAliasHistoryEventsT&& value) {
    ...
    m_agentAliasHistoryEvents = std::forward<AgentAliasHistoryEventsT>(value);
  }
  template <typename AgentAliasHistoryEventsT = Aws::Vector<AgentAliasHistoryEvent>>
  AgentAlias& WithAgentAliasHistoryEvents(AgentAliasHistoryEventsT&& value) {
    SetAgentAliasHistoryEvents(std::forward<AgentAliasHistoryEventsT>(value));
    return *this;
  }
  ...
  AgentAlias& AddAgentAliasHistoryEvents(AgentAliasHistoryEventsT&& value) {
    m_agentAliasHistoryEventsHasBeenSet = true;
    m_agentAliasHistoryEvents.emplace_back(std::forward<AgentAliasHistoryEventsT>(value));
    return *this;
  }
  ///@}
  ...
  inline AgentAlias& WithAgentAliasStatus(AgentAliasStatus value) {
  ...
  inline void SetAliasInvocationState(AliasInvocationState value) {
    m_aliasInvocationStateHasBeenSet = true;
    m_aliasInvocationState = value;
  }
  inline AgentAlias& WithAliasInvocationState(AliasInvocationState value) {
    SetAliasInvocationState(value);
    return *this;
  }
  ///@}
 private:
