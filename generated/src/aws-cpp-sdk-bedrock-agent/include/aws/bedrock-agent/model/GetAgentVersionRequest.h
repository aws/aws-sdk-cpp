...
namespace Model
{
  ...
  public:
    ...
    template<typename AgentIdT = Aws::String>
    GetAgentVersionRequest& WithAgentId(AgentIdT&& value) { SetAgentId(std::forward<AgentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AgentVersionT = Aws::String>
    GetAgentVersionRequest& WithAgentVersion(AgentVersionT&& value) { SetAgentVersion(std::forward<AgentVersionT>(value)); return *this;}
    ///@}
  private:
