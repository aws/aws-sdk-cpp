...
class OpenSearchServerlessFieldMapping {
 public:
  AWS_BEDROCKAGENT_API OpenSearchServerlessFieldMapping() = default;
  ...
  template <typename VectorFieldT = Aws::String>
  OpenSearchServerlessFieldMapping& WithVectorField(VectorFieldT&& value) {
  ...
  template <typename TextFieldT = Aws::String>
  OpenSearchServerlessFieldMapping& WithTextField(TextFieldT&& value) {
  ...
  template <typename MetadataFieldT = Aws::String>
  OpenSearchServerlessFieldMapping& WithMetadataField(MetadataFieldT&& value) {
