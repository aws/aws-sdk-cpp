...
class Transformation {
 public:
  ...
  void SetTransformationFunction(TransformationFunctionT&& value) {
    ...
    m_transformationFunction = std::forward<TransformationFunctionT>(value);
  }
  template <typename TransformationFunctionT = TransformationFunction>
  Transformation& WithTransformationFunction(TransformationFunctionT&& value) {
    SetTransformationFunction(std::forward<TransformationFunctionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStepToApply(StepType value) {
    m_stepToApplyHasBeenSet = true;
    m_stepToApply = value;
  }
  inline Transformation& WithStepToApply(StepType value) {
    SetStepToApply(value);
    return *this;
  }
  ///@}
 private:
