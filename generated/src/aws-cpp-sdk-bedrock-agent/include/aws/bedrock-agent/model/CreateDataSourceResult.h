...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENT_API CreateDataSourceResult() = default;
    ...
    template<typename DataSourceT = DataSource>
    CreateDataSourceResult& WithDataSource(DataSourceT&& value) { SetDataSource(std::forward<DataSourceT>(value)); return *this;}
    ///@}
