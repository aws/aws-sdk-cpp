...
class FlowNodeConfiguration {
 public:
  ...
  void SetLex(LexT&& value) {
    ...
    m_lex = std::forward<LexT>(value);
  }
  template <typename LexT = LexFlowNodeConfiguration>
  FlowNodeConfiguration& WithLex(LexT&& value) {
    SetLex(std::forward<LexT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIterator(IteratorT&& value) {
    ...
    m_iterator = std::forward<IteratorT>(value);
  }
  template <typename IteratorT = IteratorFlowNodeConfiguration>
  FlowNodeConfiguration& WithIterator(IteratorT&& value) {
    SetIterator(std::forward<IteratorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCollector(CollectorT&& value) {
    ...
    m_collector = std::forward<CollectorT>(value);
  }
  template <typename CollectorT = CollectorFlowNodeConfiguration>
  FlowNodeConfiguration& WithCollector(CollectorT&& value) {
    SetCollector(std::forward<CollectorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInlineCode(InlineCodeT&& value) {
    ...
    m_inlineCode = std::forward<InlineCodeT>(value);
  }
  template <typename InlineCodeT = InlineCodeFlowNodeConfiguration>
  FlowNodeConfiguration& WithInlineCode(InlineCodeT&& value) {
    SetInlineCode(std::forward<InlineCodeT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const LoopFlowNodeConfiguration& GetLoop() const { return *m_loop; }
  ...
  FlowNodeConfiguration& WithLoop(LoopT&& value) {
    SetLoop(std::forward<LoopT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLoopInput(LoopInputT&& value) {
    ...
    m_loopInput = std::forward<LoopInputT>(value);
  }
  template <typename LoopInputT = LoopInputFlowNodeConfiguration>
  FlowNodeConfiguration& WithLoopInput(LoopInputT&& value) {
    SetLoopInput(std::forward<LoopInputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLoopController(LoopControllerT&& value) {
    ...
    m_loopController = std::forward<LoopControllerT>(value);
  }
  template <typename LoopControllerT = LoopControllerFlowNodeConfiguration>
  FlowNodeConfiguration& WithLoopController(LoopControllerT&& value) {
    SetLoopController(std::forward<LoopControllerT>(value));
    return *this;
  }
  ///@}
 private:
