...
class UpdatePromptResult {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdatePromptResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdatePromptResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename CustomerEncryptionKeyArnT = Aws::String>
  UpdatePromptResult& WithCustomerEncryptionKeyArn(CustomerEncryptionKeyArnT&& value) {
  ...
  template <typename DefaultVariantT = Aws::String>
  UpdatePromptResult& WithDefaultVariant(DefaultVariantT&& value) {
  ...
  template <typename VariantsT = Aws::Vector<PromptVariant>>
  UpdatePromptResult& WithVariants(VariantsT&& value) {
    SetVariants(std::forward<VariantsT>(value));
    return *this;
  }
  template <typename VariantsT = PromptVariant>
  UpdatePromptResult& AddVariants(VariantsT&& value) {
    m_variantsHasBeenSet = true;
  ...
  template <typename IdT = Aws::String>
  UpdatePromptResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdatePromptResult& WithArn(ArnT&& value) {
  ...
  template <typename VersionT = Aws::String>
  UpdatePromptResult& WithVersion(VersionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdatePromptResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdatePromptResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePromptResult& WithRequestId(RequestIdT&& value) {
