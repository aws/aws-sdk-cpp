...
class SessionSummaryConfiguration {
 public:
  ...
  inline void SetMaxRecentSessions(int value) {
    m_maxRecentSessionsHasBeenSet = true;
    m_maxRecentSessions = value;
  }
  inline SessionSummaryConfiguration& WithMaxRecentSessions(int value) {
    SetMaxRecentSessions(value);
    return *this;
  }
  ///@}
 private:
