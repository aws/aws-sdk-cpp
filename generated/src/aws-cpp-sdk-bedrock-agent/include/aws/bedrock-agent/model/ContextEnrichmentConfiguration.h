...
class ContextEnrichmentConfiguration {
 public:
  ...
  inline void SetType(ContextEnrichmentType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ContextEnrichmentConfiguration& WithType(ContextEnrichmentType value) {
    SetType(value);
    return *this;
  }
  ///@}
   ...
   * enrichment.</p>
   */
  inline const BedrockFoundationModelContextEnrichmentConfiguration& GetBedrockFoundationModelConfiguration() const {
