...
class RdsFieldMapping {
 public:
  ...
  void SetPrimaryKeyField(PrimaryKeyFieldT&& value) {
    ...
    m_primaryKeyField = std::forward<PrimaryKeyFieldT>(value);
  }
  template <typename PrimaryKeyFieldT = Aws::String>
  RdsFieldMapping& WithPrimaryKeyField(PrimaryKeyFieldT&& value) {
    SetPrimaryKeyField(std::forward<PrimaryKeyFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomMetadataField(CustomMetadataFieldT&& value) {
    ...
    m_customMetadataField = std::forward<CustomMetadataFieldT>(value);
  }
  template <typename CustomMetadataFieldT = Aws::String>
  RdsFieldMapping& WithCustomMetadataField(CustomMetadataFieldT&& value) {
    SetCustomMetadataField(std::forward<CustomMetadataFieldT>(value));
    return *this;
  }
  ///@}
 private:
