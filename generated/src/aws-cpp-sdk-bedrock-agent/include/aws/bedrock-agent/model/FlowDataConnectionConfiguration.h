...
class FlowDataConnectionConfiguration {
 public:
  ...
  void SetSourceOutput(SourceOutputT&& value) {
    m_sourceOutputHasBeenSet = true;
    m_sourceOutput = std::forward<SourceOutputT>(value);
  }
  template <typename SourceOutputT = Aws::String>
  FlowDataConnectionConfiguration& WithSourceOutput(SourceOutputT&& value) {
    SetSourceOutput(std::forward<SourceOutputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetInput(TargetInputT&& value) {
    m_targetInputHasBeenSet = true;
    m_targetInput = std::forward<TargetInputT>(value);
  }
  template <typename TargetInputT = Aws::String>
  FlowDataConnectionConfiguration& WithTargetInput(TargetInputT&& value) {
    SetTargetInput(std::forward<TargetInputT>(value));
    return *this;
  }
  ///@}
 private:
