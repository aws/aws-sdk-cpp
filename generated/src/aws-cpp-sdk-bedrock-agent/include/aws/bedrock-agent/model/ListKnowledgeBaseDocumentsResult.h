...
class ListKnowledgeBaseDocumentsResult {
 public:
  ...
  template <typename DocumentDetailsT = Aws::Vector<KnowledgeBaseDocumentDetail>>
  ListKnowledgeBaseDocumentsResult& WithDocumentDetails(DocumentDetailsT&& value) {
    SetDocumentDetails(std::forward<DocumentDetailsT>(value));
    return *this;
  }
  template <typename DocumentDetailsT = KnowledgeBaseDocumentDetail>
  ListKnowledgeBaseDocumentsResult& AddDocumentDetails(DocumentDetailsT&& value) {
    m_documentDetailsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListKnowledgeBaseDocumentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListKnowledgeBaseDocumentsResult& WithRequestId(RequestIdT&& value) {
