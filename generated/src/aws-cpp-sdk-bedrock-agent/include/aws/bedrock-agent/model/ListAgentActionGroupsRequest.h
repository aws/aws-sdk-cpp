...
class ListAgentActionGroupsRequest : public BedrockAgentRequest {
 public:
  AWS_BEDROCKAGENT_API ListAgentActionGroupsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListAgentActionGroups"; }
  ...
  template <typename AgentIdT = Aws::String>
  ListAgentActionGroupsRequest& WithAgentId(AgentIdT&& value) {
  ...
  template <typename AgentVersionT = Aws::String>
  ListAgentActionGroupsRequest& WithAgentVersion(AgentVersionT&& value) {
  ...
  inline ListAgentActionGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentActionGroupsRequest& WithNextToken(NextTokenT&& value) {
