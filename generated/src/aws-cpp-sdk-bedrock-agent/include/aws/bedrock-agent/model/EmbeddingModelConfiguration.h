...
class EmbeddingModelConfiguration {
 public:
   ...
   */
  inline const BedrockEmbeddingModelConfiguration& GetBedrockEmbeddingModelConfiguration() const {
    return m_bedrockEmbeddingModelConfiguration;
  }
  ...
  void SetBedrockEmbeddingModelConfiguration(BedrockEmbeddingModelConfigurationT&& value) {
    ...
    m_bedrockEmbeddingModelConfiguration = std::forward<BedrockEmbeddingModelConfigurationT>(value);
  }
  template <typename BedrockEmbeddingModelConfigurationT = BedrockEmbeddingModelConfiguration>
  EmbeddingModelConfiguration& WithBedrockEmbeddingModelConfiguration(BedrockEmbeddingModelConfigurationT&& value) {
    SetBedrockEmbeddingModelConfiguration(std::forward<BedrockEmbeddingModelConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
