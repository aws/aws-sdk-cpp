...
class ListIngestionJobsResult {
 public:
  ...
  void SetIngestionJobSummaries(IngestionJobSummariesT&& value) {
    m_ingestionJobSummariesHasBeenSet = true;
    m_ingestionJobSummaries = std::forward<IngestionJobSummariesT>(value);
  }
  template <typename IngestionJobSummariesT = Aws::Vector<IngestionJobSummary>>
  ListIngestionJobsResult& WithIngestionJobSummaries(IngestionJobSummariesT&& value) {
    SetIngestionJobSummaries(std::forward<IngestionJobSummariesT>(value));
    return *this;
  }
  template <typename IngestionJobSummariesT = IngestionJobSummary>
  ListIngestionJobsResult& AddIngestionJobSummaries(IngestionJobSummariesT&& value) {
    m_ingestionJobSummariesHasBeenSet = true;
    m_ingestionJobSummaries.emplace_back(std::forward<IngestionJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIngestionJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIngestionJobsResult& WithRequestId(RequestIdT&& value) {
