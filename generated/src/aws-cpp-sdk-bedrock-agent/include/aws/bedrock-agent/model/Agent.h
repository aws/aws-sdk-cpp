...
class Agent {
 public:
  ...
  inline Agent& WithOrchestrationType(OrchestrationType value) {
  ...
  inline Agent& WithIdleSessionTTLInSeconds(int value) {
  ...
  inline Agent& WithAgentCollaboration(AgentCollaboration value) {
