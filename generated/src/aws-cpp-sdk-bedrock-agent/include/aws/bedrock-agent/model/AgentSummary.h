...
class AgentSummary {
 public:
  ...
  inline AgentSummary& WithAgentStatus(AgentStatus value) {
  ...
  void SetLatestAgentVersion(LatestAgentVersionT&& value) {
    ...
    m_latestAgentVersion = std::forward<LatestAgentVersionT>(value);
  }
  template <typename LatestAgentVersionT = Aws::String>
  AgentSummary& WithLatestAgentVersion(LatestAgentVersionT&& value) {
    SetLatestAgentVersion(std::forward<LatestAgentVersionT>(value));
    return *this;
  }
  ///@}
