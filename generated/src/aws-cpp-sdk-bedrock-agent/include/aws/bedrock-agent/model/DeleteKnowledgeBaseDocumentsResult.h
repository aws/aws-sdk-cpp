...
class DeleteKnowledgeBaseDocumentsResult {
 public:
  ...
  AWS_BEDROCKAGENT_API DeleteKnowledgeBaseDocumentsResult& operator=(
  ...
  template <typename DocumentDetailsT = Aws::Vector<KnowledgeBaseDocumentDetail>>
  DeleteKnowledgeBaseDocumentsResult& WithDocumentDetails(DocumentDetailsT&& value) {
    SetDocumentDetails(std::forward<DocumentDetailsT>(value));
    return *this;
  }
  template <typename DocumentDetailsT = KnowledgeBaseDocumentDetail>
  DeleteKnowledgeBaseDocumentsResult& AddDocumentDetails(DocumentDetailsT&& value) {
    m_documentDetailsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteKnowledgeBaseDocumentsResult& WithRequestId(RequestIdT&& value) {
