...
/**
 * <p>The configuration information to connect to SharePoint as your data source
...
class SharePointDataSourceConfiguration {
 public:
  ...
  template <typename SourceConfigurationT = SharePointSourceConfiguration>
  SharePointDataSourceConfiguration& WithSourceConfiguration(SourceConfigurationT&& value) {
  ...
  void SetCrawlerConfiguration(CrawlerConfigurationT&& value) {
    ...
    m_crawlerConfiguration = std::forward<CrawlerConfigurationT>(value);
  }
  template <typename CrawlerConfigurationT = SharePointCrawlerConfiguration>
  SharePointDataSourceConfiguration& WithCrawlerConfiguration(CrawlerConfigurationT&& value) {
    SetCrawlerConfiguration(std::forward<CrawlerConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
