...
class ConfluenceSourceConfiguration {
 public:
  ...
  inline void SetHostType(ConfluenceHostType value) {
    m_hostTypeHasBeenSet = true;
    m_hostType = value;
  }
  inline ConfluenceSourceConfiguration& WithHostType(ConfluenceHostType value) {
    SetHostType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAuthType(ConfluenceAuthType value) {
    m_authTypeHasBeenSet = true;
    m_authType = value;
  }
  inline ConfluenceSourceConfiguration& WithAuthType(ConfluenceAuthType value) {
    SetAuthType(value);
    return *this;
  }
  ///@}
