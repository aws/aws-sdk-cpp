...
class GetResourcePolicyResult {
 public:
  AWS_BEDROCKAGENT_API GetResourcePolicyResult() = default;
  AWS_BEDROCKAGENT_API GetResourcePolicyResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BEDROCKAGENT_API GetResourcePolicyResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);

  ///@{
  /**
   * <p>The ARN of the knowledge base that the resource policy is associated
   * with.</p>
   */
