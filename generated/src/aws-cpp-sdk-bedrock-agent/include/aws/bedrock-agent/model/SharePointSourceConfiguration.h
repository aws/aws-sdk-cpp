...
class SharePointSourceConfiguration {
 public:
  ...
  inline void SetHostType(SharePointHostType value) {
    m_hostTypeHasBeenSet = true;
    m_hostType = value;
  }
  inline SharePointSourceConfiguration& WithHostType(SharePointHostType value) {
    SetHostType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAuthType(SharePointAuthType value) {
    m_authTypeHasBeenSet = true;
    m_authType = value;
  }
  inline SharePointSourceConfiguration& WithAuthType(SharePointAuthType value) {
    SetAuthType(value);
    return *this;
  }
  ///@}
