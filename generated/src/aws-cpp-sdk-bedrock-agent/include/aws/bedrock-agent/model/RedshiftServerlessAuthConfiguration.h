...
class RedshiftServerlessAuthConfiguration {
 public:
  ...
  inline void SetType(RedshiftServerlessAuthType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RedshiftServerlessAuthConfiguration& WithType(RedshiftServerlessAuthType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetUsernamePasswordSecretArn(UsernamePasswordSecretArnT&& value) {
    ...
    m_usernamePasswordSecretArn = std::forward<UsernamePasswordSecretArnT>(value);
  }
  template <typename UsernamePasswordSecretArnT = Aws::String>
  RedshiftServerlessAuthConfiguration& WithUsernamePasswordSecretArn(UsernamePasswordSecretArnT&& value) {
    SetUsernamePasswordSecretArn(std::forward<UsernamePasswordSecretArnT>(value));
    return *this;
  }
  ///@}
 private:
