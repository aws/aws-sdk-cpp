...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENT_API UnknownConnectionTargetFlowValidationDetails();
    ...
    inline UnknownConnectionTargetFlowValidationDetails& WithConnection(const Aws::String& value) { SetConnection(value); return *this;}
    inline UnknownConnectionTargetFlowValidationDetails& WithConnection(Aws::String&& value) { SetConnection(std::move(value)); return *this;}
    inline UnknownConnectionTargetFlowValidationDetails& WithConnection(const char* value) { SetConnection(value); return *this;}
    ///@}
  private:
