...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENT_API GetAgentKnowledgeBaseRequest() = default;
    ...
    template<typename AgentIdT = Aws::String>
    GetAgentKnowledgeBaseRequest& WithAgentId(AgentIdT&& value) { SetAgentId(std::forward<AgentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AgentVersionT = Aws::String>
    GetAgentKnowledgeBaseRequest& WithAgentVersion(AgentVersionT&& value) { SetAgentVersion(std::forward<AgentVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename KnowledgeBaseIdT = Aws::String>
    GetAgentKnowledgeBaseRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) { SetKnowledgeBaseId(std::forward<KnowledgeBaseIdT>(value)); return *this;}
    ///@}
  private:
