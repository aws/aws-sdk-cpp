...
class GetAgentKnowledgeBaseRequest : public BedrockAgentRequest {
 public:
  ...
  template <typename AgentIdT = Aws::String>
  GetAgentKnowledgeBaseRequest& WithAgentId(AgentIdT&& value) {
  ...
  template <typename AgentVersionT = Aws::String>
  GetAgentKnowledgeBaseRequest& WithAgentVersion(AgentVersionT&& value) {
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  GetAgentKnowledgeBaseRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
