...
class ListKnowledgeBaseDocumentsRequest : public BedrockAgentRequest {
 public:
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  ListKnowledgeBaseDocumentsRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  template <typename DataSourceIdT = Aws::String>
  ListKnowledgeBaseDocumentsRequest& WithDataSourceId(DataSourceIdT&& value) {
  ...
  inline ListKnowledgeBaseDocumentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListKnowledgeBaseDocumentsRequest& WithNextToken(NextTokenT&& value) {
