...
class RedshiftQueryEngineStorageConfiguration {
 public:
  ...
  inline void SetType(RedshiftQueryEngineStorageType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RedshiftQueryEngineStorageConfiguration& WithType(RedshiftQueryEngineStorageType value) {
    SetType(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const RedshiftQueryEngineAwsDataCatalogStorageConfiguration& GetAwsDataCatalogConfiguration() const {
    return m_awsDataCatalogConfiguration;
  }
  ...
  void SetAwsDataCatalogConfiguration(AwsDataCatalogConfigurationT&& value) {
    ...
    m_awsDataCatalogConfiguration = std::forward<AwsDataCatalogConfigurationT>(value);
  }
  template <typename AwsDataCatalogConfigurationT = RedshiftQueryEngineAwsDataCatalogStorageConfiguration>
  RedshiftQueryEngineStorageConfiguration& WithAwsDataCatalogConfiguration(AwsDataCatalogConfigurationT&& value) {
    SetAwsDataCatalogConfiguration(std::forward<AwsDataCatalogConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedshiftConfiguration(RedshiftConfigurationT&& value) {
    ...
    m_redshiftConfiguration = std::forward<RedshiftConfigurationT>(value);
  }
  template <typename RedshiftConfigurationT = RedshiftQueryEngineRedshiftStorageConfiguration>
  RedshiftQueryEngineStorageConfiguration& WithRedshiftConfiguration(RedshiftConfigurationT&& value) {
    SetRedshiftConfiguration(std::forward<RedshiftConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
