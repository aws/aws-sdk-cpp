...
class CreateAgentAliasResult {
 public:
  ...
  void SetAgentAlias(AgentAliasT&& value) {
    m_agentAliasHasBeenSet = true;
    m_agentAlias = std::forward<AgentAliasT>(value);
  }
  template <typename AgentAliasT = AgentAlias>
  CreateAgentAliasResult& WithAgentAlias(AgentAliasT&& value) {
    SetAgentAlias(std::forward<AgentAliasT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateAgentAliasResult& WithRequestId(RequestIdT&& value) {
