...
class ListAgentKnowledgeBasesRequest : public BedrockAgentRequest {
 public:
  ...
  template <typename AgentIdT = Aws::String>
  ListAgentKnowledgeBasesRequest& WithAgentId(AgentIdT&& value) {
  ...
  template <typename AgentVersionT = Aws::String>
  ListAgentKnowledgeBasesRequest& WithAgentVersion(AgentVersionT&& value) {
  ...
  inline ListAgentKnowledgeBasesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentKnowledgeBasesRequest& WithNextToken(NextTokenT&& value) {
