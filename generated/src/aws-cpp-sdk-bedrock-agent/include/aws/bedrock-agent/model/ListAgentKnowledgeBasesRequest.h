...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENT_API ListAgentKnowledgeBasesRequest() = default;
    ...
    template<typename AgentIdT = Aws::String>
    ListAgentKnowledgeBasesRequest& WithAgentId(AgentIdT&& value) { SetAgentId(std::forward<AgentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AgentVersionT = Aws::String>
    ListAgentKnowledgeBasesRequest& WithAgentVersion(AgentVersionT&& value) { SetAgentVersion(std::forward<AgentVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListAgentKnowledgeBasesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
