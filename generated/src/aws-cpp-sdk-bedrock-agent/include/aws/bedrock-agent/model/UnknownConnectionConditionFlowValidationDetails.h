...
/**
 * <p>Details about an unknown condition for a connection.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-2023-06-05/UnknownConnectionConditionFlowValidationDetails">AWS
 * API Reference</a></p>
 */
class UnknownConnectionConditionFlowValidationDetails {
 public:
  ...
  template <typename ConnectionT = Aws::String>
  UnknownConnectionConditionFlowValidationDetails& WithConnection(ConnectionT&& value) {
