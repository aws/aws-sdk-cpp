...
class ListAgentCollaboratorsResult {
 public:
  ...
  void SetAgentCollaboratorSummaries(AgentCollaboratorSummariesT&& value) {
    m_agentCollaboratorSummariesHasBeenSet = true;
    m_agentCollaboratorSummaries = std::forward<AgentCollaboratorSummariesT>(value);
  }
  template <typename AgentCollaboratorSummariesT = Aws::Vector<AgentCollaboratorSummary>>
  ListAgentCollaboratorsResult& WithAgentCollaboratorSummaries(AgentCollaboratorSummariesT&& value) {
    SetAgentCollaboratorSummaries(std::forward<AgentCollaboratorSummariesT>(value));
    return *this;
  }
  template <typename AgentCollaboratorSummariesT = AgentCollaboratorSummary>
  ListAgentCollaboratorsResult& AddAgentCollaboratorSummaries(AgentCollaboratorSummariesT&& value) {
    m_agentCollaboratorSummariesHasBeenSet = true;
    m_agentCollaboratorSummaries.emplace_back(std::forward<AgentCollaboratorSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAgentCollaboratorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAgentCollaboratorsResult& WithRequestId(RequestIdT&& value) {
