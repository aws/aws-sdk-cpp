...
class ListFlowAliasesResult {
 public:
  ...
  void SetFlowAliasSummaries(FlowAliasSummariesT&& value) {
    m_flowAliasSummariesHasBeenSet = true;
    m_flowAliasSummaries = std::forward<FlowAliasSummariesT>(value);
  }
  template <typename FlowAliasSummariesT = Aws::Vector<FlowAliasSummary>>
  ListFlowAliasesResult& WithFlowAliasSummaries(FlowAliasSummariesT&& value) {
    SetFlowAliasSummaries(std::forward<FlowAliasSummariesT>(value));
    return *this;
  }
  template <typename FlowAliasSummariesT = FlowAliasSummary>
  ListFlowAliasesResult& AddFlowAliasSummaries(FlowAliasSummariesT&& value) {
    m_flowAliasSummariesHasBeenSet = true;
    m_flowAliasSummaries.emplace_back(std::forward<FlowAliasSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFlowAliasesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFlowAliasesResult& WithRequestId(RequestIdT&& value) {
