...
class PromptModelInferenceConfiguration {
 public:
  ...
  inline PromptModelInferenceConfiguration& WithTemperature(double value) {
  ...
  inline PromptModelInferenceConfiguration& WithTopP(double value) {
    SetTopP(value);
    return *this;
  }
  ///@}
  ...
  inline PromptModelInferenceConfiguration& WithMaxTokens(int value) {
    SetMaxTokens(value);
    return *this;
  }
  ///@}
