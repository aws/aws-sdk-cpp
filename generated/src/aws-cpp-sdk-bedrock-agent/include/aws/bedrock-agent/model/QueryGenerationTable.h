...
class QueryGenerationTable {
 public:
  ...
  template <typename NameT = Aws::String>
  QueryGenerationTable& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  QueryGenerationTable& WithDescription(DescriptionT&& value) {
  ...
  inline void SetInclusion(IncludeExclude value) {
    m_inclusionHasBeenSet = true;
    m_inclusion = value;
  }
  inline QueryGenerationTable& WithInclusion(IncludeExclude value) {
    SetInclusion(value);
    return *this;
  }
  ///@}
  ...
  template <typename ColumnsT = Aws::Vector<QueryGenerationColumn>>
  QueryGenerationTable& WithColumns(ColumnsT&& value) {
    SetColumns(std::forward<ColumnsT>(value));
    return *this;
  }
  template <typename ColumnsT = QueryGenerationColumn>
  QueryGenerationTable& AddColumns(ColumnsT&& value) {
    m_columnsHasBeenSet = true;
