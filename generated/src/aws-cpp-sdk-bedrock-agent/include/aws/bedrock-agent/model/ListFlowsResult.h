...
class ListFlowsResult {
 public:
  ...
  void SetFlowSummaries(FlowSummariesT&& value) {
    ...
    m_flowSummaries = std::forward<FlowSummariesT>(value);
  }
  template <typename FlowSummariesT = Aws::Vector<FlowSummary>>
  ListFlowsResult& WithFlowSummaries(FlowSummariesT&& value) {
    SetFlowSummaries(std::forward<FlowSummariesT>(value));
    return *this;
  }
  template <typename FlowSummariesT = FlowSummary>
  ListFlowsResult& AddFlowSummaries(FlowSummariesT&& value) {
    m_flowSummariesHasBeenSet = true;
    m_flowSummaries.emplace_back(std::forward<FlowSummariesT>(value));
    return *this;
  }
  ///@}
