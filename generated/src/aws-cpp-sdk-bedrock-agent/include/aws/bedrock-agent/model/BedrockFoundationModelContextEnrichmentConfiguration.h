...
class BedrockFoundationModelContextEnrichmentConfiguration {
 public:
  ...
  void SetEnrichmentStrategyConfiguration(EnrichmentStrategyConfigurationT&& value) {
    ...
    m_enrichmentStrategyConfiguration = std::forward<EnrichmentStrategyConfigurationT>(value);
  }
  template <typename EnrichmentStrategyConfigurationT = EnrichmentStrategyConfiguration>
  BedrockFoundationModelContextEnrichmentConfiguration& WithEnrichmentStrategyConfiguration(EnrichmentStrategyConfigurationT&& value) {
    SetEnrichmentStrategyConfiguration(std::forward<EnrichmentStrategyConfigurationT>(value));
    return *this;
  }
  ///@}
