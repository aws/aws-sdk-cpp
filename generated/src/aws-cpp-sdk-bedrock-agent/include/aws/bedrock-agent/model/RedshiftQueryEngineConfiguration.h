...
class RedshiftQueryEngineConfiguration {
 public:
  ...
  inline void SetType(RedshiftQueryEngineType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RedshiftQueryEngineConfiguration& WithType(RedshiftQueryEngineType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetServerlessConfiguration(ServerlessConfigurationT&& value) {
    m_serverlessConfigurationHasBeenSet = true;
    m_serverlessConfiguration = std::forward<ServerlessConfigurationT>(value);
  }
  template <typename ServerlessConfigurationT = RedshiftServerlessConfiguration>
  RedshiftQueryEngineConfiguration& WithServerlessConfiguration(ServerlessConfigurationT&& value) {
    SetServerlessConfiguration(std::forward<ServerlessConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProvisionedConfiguration(ProvisionedConfigurationT&& value) {
    m_provisionedConfigurationHasBeenSet = true;
    m_provisionedConfiguration = std::forward<ProvisionedConfigurationT>(value);
  }
  template <typename ProvisionedConfigurationT = RedshiftProvisionedConfiguration>
  RedshiftQueryEngineConfiguration& WithProvisionedConfiguration(ProvisionedConfigurationT&& value) {
    SetProvisionedConfiguration(std::forward<ProvisionedConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
