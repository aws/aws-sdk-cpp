...
class LoopControllerFlowNodeConfiguration {
 public:
  ...
  void SetContinueCondition(ContinueConditionT&& value) {
    ...
    m_continueCondition = std::forward<ContinueConditionT>(value);
  }
  template <typename ContinueConditionT = FlowCondition>
  LoopControllerFlowNodeConfiguration& WithContinueCondition(ContinueConditionT&& value) {
    SetContinueCondition(std::forward<ContinueConditionT>(value));
    return *this;
  }
  ///@}
  ...
  inline LoopControllerFlowNodeConfiguration& WithMaxIterations(int value) {
