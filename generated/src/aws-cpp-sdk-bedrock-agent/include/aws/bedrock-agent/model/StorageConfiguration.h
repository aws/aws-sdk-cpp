...
class StorageConfiguration {
 public:
  ...
  inline void SetType(KnowledgeBaseStorageType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline StorageConfiguration& WithType(KnowledgeBaseStorageType value) {
    SetType(value);
    return *this;
  }
  ///@}
   ...
   * Service.</p>
   */
  inline const OpenSearchServerlessConfiguration& GetOpensearchServerlessConfiguration() const {
    return m_opensearchServerlessConfiguration;
  }
  ...
  void SetOpensearchServerlessConfiguration(OpensearchServerlessConfigurationT&& value) {
    ...
    m_opensearchServerlessConfiguration = std::forward<OpensearchServerlessConfigurationT>(value);
  }
  template <typename OpensearchServerlessConfigurationT = OpenSearchServerlessConfiguration>
  StorageConfiguration& WithOpensearchServerlessConfiguration(OpensearchServerlessConfigurationT&& value) {
    SetOpensearchServerlessConfiguration(std::forward<OpensearchServerlessConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const OpenSearchManagedClusterConfiguration& GetOpensearchManagedClusterConfiguration() const {
    return m_opensearchManagedClusterConfiguration;
  }
  ...
  void SetOpensearchManagedClusterConfiguration(OpensearchManagedClusterConfigurationT&& value) {
    ...
    m_opensearchManagedClusterConfiguration = std::forward<OpensearchManagedClusterConfigurationT>(value);
  }
  template <typename OpensearchManagedClusterConfigurationT = OpenSearchManagedClusterConfiguration>
  StorageConfiguration& WithOpensearchManagedClusterConfiguration(OpensearchManagedClusterConfigurationT&& value) {
    SetOpensearchManagedClusterConfiguration(std::forward<OpensearchManagedClusterConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPineconeConfiguration(PineconeConfigurationT&& value) {
    ...
    m_pineconeConfiguration = std::forward<PineconeConfigurationT>(value);
  }
  template <typename PineconeConfigurationT = PineconeConfiguration>
  StorageConfiguration& WithPineconeConfiguration(PineconeConfigurationT&& value) {
    SetPineconeConfiguration(std::forward<PineconeConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   * Cloud.</p>
   */
  inline const RedisEnterpriseCloudConfiguration& GetRedisEnterpriseCloudConfiguration() const {
    return m_redisEnterpriseCloudConfiguration;
  }
  ...
  void SetRedisEnterpriseCloudConfiguration(RedisEnterpriseCloudConfigurationT&& value) {
    ...
    m_redisEnterpriseCloudConfiguration = std::forward<RedisEnterpriseCloudConfigurationT>(value);
  }
  template <typename RedisEnterpriseCloudConfigurationT = RedisEnterpriseCloudConfiguration>
  StorageConfiguration& WithRedisEnterpriseCloudConfiguration(RedisEnterpriseCloudConfigurationT&& value) {
    SetRedisEnterpriseCloudConfiguration(std::forward<RedisEnterpriseCloudConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRdsConfiguration(RdsConfigurationT&& value) {
    ...
    m_rdsConfiguration = std::forward<RdsConfigurationT>(value);
  }
  template <typename RdsConfigurationT = RdsConfiguration>
  StorageConfiguration& WithRdsConfiguration(RdsConfigurationT&& value) {
    SetRdsConfiguration(std::forward<RdsConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMongoDbAtlasConfiguration(MongoDbAtlasConfigurationT&& value) {
    ...
    m_mongoDbAtlasConfiguration = std::forward<MongoDbAtlasConfigurationT>(value);
  }
  template <typename MongoDbAtlasConfigurationT = MongoDbAtlasConfiguration>
  StorageConfiguration& WithMongoDbAtlasConfiguration(MongoDbAtlasConfigurationT&& value) {
    SetMongoDbAtlasConfiguration(std::forward<MongoDbAtlasConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNeptuneAnalyticsConfiguration(NeptuneAnalyticsConfigurationT&& value) {
    ...
    m_neptuneAnalyticsConfiguration = std::forward<NeptuneAnalyticsConfigurationT>(value);
  }
  template <typename NeptuneAnalyticsConfigurationT = NeptuneAnalyticsConfiguration>
  StorageConfiguration& WithNeptuneAnalyticsConfiguration(NeptuneAnalyticsConfigurationT&& value) {
    SetNeptuneAnalyticsConfiguration(std::forward<NeptuneAnalyticsConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3VectorsConfiguration(S3VectorsConfigurationT&& value) {
    ...
    m_s3VectorsConfiguration = std::forward<S3VectorsConfigurationT>(value);
  }
  template <typename S3VectorsConfigurationT = S3VectorsConfiguration>
  StorageConfiguration& WithS3VectorsConfiguration(S3VectorsConfigurationT&& value) {
    SetS3VectorsConfiguration(std::forward<S3VectorsConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
