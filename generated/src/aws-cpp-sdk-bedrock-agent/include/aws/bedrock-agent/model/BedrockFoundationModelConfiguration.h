...
class BedrockFoundationModelConfiguration {
 public:
  ...
  template <typename ModelArnT = Aws::String>
  BedrockFoundationModelConfiguration& WithModelArn(ModelArnT&& value) {
  ...
  template <typename ParsingPromptT = ParsingPrompt>
  BedrockFoundationModelConfiguration& WithParsingPrompt(ParsingPromptT&& value) {
  ...
  inline BedrockFoundationModelConfiguration& WithParsingModality(ParsingModality value) {
