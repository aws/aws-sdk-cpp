...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENT_API SharePointCrawlerConfiguration();
    ...
    inline SharePointCrawlerConfiguration& WithFilterConfiguration(const CrawlFilterConfiguration& value) { SetFilterConfiguration(value); return *this;}
    inline SharePointCrawlerConfiguration& WithFilterConfiguration(CrawlFilterConfiguration&& value) { SetFilterConfiguration(std::move(value)); return *this;}
    ///@}
  private:
