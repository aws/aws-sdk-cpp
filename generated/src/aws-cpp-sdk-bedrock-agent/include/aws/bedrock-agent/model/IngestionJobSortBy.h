...
class IngestionJobSortBy {
 public:
  ...
  inline void SetAttribute(IngestionJobSortByAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline IngestionJobSortBy& WithAttribute(IngestionJobSortByAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline IngestionJobSortBy& WithOrder(SortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
