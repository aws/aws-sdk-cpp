...
class BedrockDataAutomationConfiguration {
 public:
  ...
  inline void SetParsingModality(ParsingModality value) {
    m_parsingModalityHasBeenSet = true;
    m_parsingModality = value;
  }
  inline BedrockDataAutomationConfiguration& WithParsingModality(ParsingModality value) {
    SetParsingModality(value);
    return *this;
  }
  ///@}
 private:
