...
class AssociateAgentCollaboratorResult {
 public:
  ...
  void SetAgentCollaborator(AgentCollaboratorT&& value) {
    m_agentCollaboratorHasBeenSet = true;
    m_agentCollaborator = std::forward<AgentCollaboratorT>(value);
  }
  template <typename AgentCollaboratorT = AgentCollaborator>
  AssociateAgentCollaboratorResult& WithAgentCollaborator(AgentCollaboratorT&& value) {
    SetAgentCollaborator(std::forward<AgentCollaboratorT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  AssociateAgentCollaboratorResult& WithRequestId(RequestIdT&& value) {
