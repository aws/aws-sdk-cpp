...
namespace Model
{
  ...
  {
  public:
    AWS_BEDROCKAGENT_API ListTagsForResourceResult() = default;
    AWS_BEDROCKAGENT_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_BEDROCKAGENT_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
