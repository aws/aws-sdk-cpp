...
class CreatePromptRequest : public BedrockAgentRequest {
 public:
  ...
  template <typename CustomerEncryptionKeyArnT = Aws::String>
  CreatePromptRequest& WithCustomerEncryptionKeyArn(CustomerEncryptionKeyArnT&& value) {
  ...
  template <typename DefaultVariantT = Aws::String>
  CreatePromptRequest& WithDefaultVariant(DefaultVariantT&& value) {
  ...
  template <typename VariantsT = Aws::Vector<PromptVariant>>
  CreatePromptRequest& WithVariants(VariantsT&& value) {
    SetVariants(std::forward<VariantsT>(value));
    return *this;
  }
  template <typename VariantsT = PromptVariant>
  CreatePromptRequest& AddVariants(VariantsT&& value) {
    m_variantsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreatePromptRequest& WithClientToken(ClientTokenT&& value) {
