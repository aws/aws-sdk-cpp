...
DeleteVpcConfigurationResult::DeleteVpcConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteVpcConfigurationResult& DeleteVpcConfigurationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
