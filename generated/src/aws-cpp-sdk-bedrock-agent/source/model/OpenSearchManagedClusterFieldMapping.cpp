...
OpenSearchManagedClusterFieldMapping::OpenSearchManagedClusterFieldMapping(JsonView jsonValue) { *this = jsonValue; }

OpenSearchManagedClusterFieldMapping& OpenSearchManagedClusterFieldMapping::operator=(JsonView jsonValue) {
...
JsonValue OpenSearchManagedClusterFieldMapping::Jsonize() const {
  JsonValue payload;
