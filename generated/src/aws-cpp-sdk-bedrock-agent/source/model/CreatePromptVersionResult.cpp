...
CreatePromptVersionResult::CreatePromptVersionResult()
{
}

CreatePromptVersionResult::CreatePromptVersionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreatePromptVersionResult& CreatePromptVersionResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
