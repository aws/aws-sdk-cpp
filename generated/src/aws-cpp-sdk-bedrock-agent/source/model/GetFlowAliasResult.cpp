...
GetFlowAliasResult::GetFlowAliasResult()
{
}

GetFlowAliasResult::GetFlowAliasResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetFlowAliasResult& GetFlowAliasResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
