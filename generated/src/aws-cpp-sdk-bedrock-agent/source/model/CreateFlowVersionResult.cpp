...
CreateFlowVersionResult::CreateFlowVersionResult() : 
    m_status(FlowStatus::NOT_SET)
{
}

CreateFlowVersionResult::CreateFlowVersionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
  : CreateFlowVersionResult()
{
  *this = result;
}

CreateFlowVersionResult& CreateFlowVersionResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
