...
AssociateAgentKnowledgeBaseResult::AssociateAgentKnowledgeBaseResult()
{
}

AssociateAgentKnowledgeBaseResult::AssociateAgentKnowledgeBaseResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
