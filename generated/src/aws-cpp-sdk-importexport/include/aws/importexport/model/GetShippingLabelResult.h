...
class GetShippingLabelResult {
 public:
  ...
  void SetShippingLabelURL(ShippingLabelURLT&& value) {
    m_shippingLabelURLHasBeenSet = true;
    m_shippingLabelURL = std::forward<ShippingLabelURLT>(value);
  }
  template <typename ShippingLabelURLT = Aws::String>
  GetShippingLabelResult& WithShippingLabelURL(ShippingLabelURLT&& value) {
    SetShippingLabelURL(std::forward<ShippingLabelURLT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename WarningT = Aws::String>
  GetShippingLabelResult& WithWarning(WarningT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetShippingLabelResult& WithResponseMetadata(ResponseMetadataT&& value) {
