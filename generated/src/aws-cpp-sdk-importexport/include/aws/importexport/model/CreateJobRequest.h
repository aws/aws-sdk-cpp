...
class CreateJobRequest : public ImportExportRequest {
 ...
 public:
  ...
  inline CreateJobRequest& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  void SetManifestAddendum(ManifestAddendumT&& value) {
    m_manifestAddendumHasBeenSet = true;
    m_manifestAddendum = std::forward<ManifestAddendumT>(value);
  }
  template <typename ManifestAddendumT = Aws::String>
  CreateJobRequest& WithManifestAddendum(ManifestAddendumT&& value) {
    SetManifestAddendum(std::forward<ManifestAddendumT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateJobRequest& WithValidateOnly(bool value) {
  ...
  template <typename APIVersionT = Aws::String>
  CreateJobRequest& WithAPIVersion(APIVersionT&& value) {
