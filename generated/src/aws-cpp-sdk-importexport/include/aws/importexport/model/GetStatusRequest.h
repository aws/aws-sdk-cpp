...
namespace Model
{
  ...
  {
  public:
    AWS_IMPORTEXPORT_API GetStatusRequest() = default;
  ...
  public:
    ...
    template<typename JobIdT = Aws::String>
    GetStatusRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
    ...
    template<typename APIVersionT = Aws::String>
    GetStatusRequest& WithAPIVersion(APIVersionT&& value) { SetAPIVersion(std::forward<APIVersionT>(value)); return *this;}
    ///@}
  private:
