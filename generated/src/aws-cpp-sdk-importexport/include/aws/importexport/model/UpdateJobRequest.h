...
class UpdateJobRequest : public ImportExportRequest {
 ...
 public:
  ...
  template <typename ManifestT = Aws::String>
  UpdateJobRequest& WithManifest(ManifestT&& value) {
  ...
  inline UpdateJobRequest& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateJobRequest& WithValidateOnly(bool value) {
  ...
  template <typename APIVersionT = Aws::String>
  UpdateJobRequest& WithAPIVersion(APIVersionT&& value) {
