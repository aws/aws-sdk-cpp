...
class GetShippingLabelRequest : public ImportExportRequest {
 ...
 public:
  ...
  template <typename JobIdsT = Aws::Vector<Aws::String>>
  GetShippingLabelRequest& WithJobIds(JobIdsT&& value) {
    SetJobIds(std::forward<JobIdsT>(value));
    return *this;
  }
  template <typename JobIdsT = Aws::String>
  GetShippingLabelRequest& AddJobIds(JobIdsT&& value) {
    m_jobIdsHasBeenSet = true;
  ...
  template <typename NameT = Aws::String>
  GetShippingLabelRequest& WithName(NameT&& value) {
  ...
  void SetCompany(CompanyT&& value) {
    ...
    m_company = std::forward<CompanyT>(value);
  }
  template <typename CompanyT = Aws::String>
  GetShippingLabelRequest& WithCompany(CompanyT&& value) {
    SetCompany(std::forward<CompanyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PhoneNumberT = Aws::String>
  GetShippingLabelRequest& WithPhoneNumber(PhoneNumberT&& value) {
  ...
  template <typename CountryT = Aws::String>
  GetShippingLabelRequest& WithCountry(CountryT&& value) {
  ...
  void SetStateOrProvince(StateOrProvinceT&& value) {
    ...
    m_stateOrProvince = std::forward<StateOrProvinceT>(value);
  }
  template <typename StateOrProvinceT = Aws::String>
  GetShippingLabelRequest& WithStateOrProvince(StateOrProvinceT&& value) {
    SetStateOrProvince(std::forward<StateOrProvinceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CityT = Aws::String>
  GetShippingLabelRequest& WithCity(CityT&& value) {
  ...
  template <typename PostalCodeT = Aws::String>
  GetShippingLabelRequest& WithPostalCode(PostalCodeT&& value) {
  ...
  void SetStreet1(Street1T&& value) {
    ...
    m_street1 = std::forward<Street1T>(value);
  }
  template <typename Street1T = Aws::String>
  GetShippingLabelRequest& WithStreet1(Street1T&& value) {
    SetStreet1(std::forward<Street1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetStreet2(Street2T&& value) {
    ...
    m_street2 = std::forward<Street2T>(value);
  }
  template <typename Street2T = Aws::String>
  GetShippingLabelRequest& WithStreet2(Street2T&& value) {
    SetStreet2(std::forward<Street2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetStreet3(Street3T&& value) {
    ...
    m_street3 = std::forward<Street3T>(value);
  }
  template <typename Street3T = Aws::String>
  GetShippingLabelRequest& WithStreet3(Street3T&& value) {
    SetStreet3(std::forward<Street3T>(value));
    return *this;
  }
  ///@}
  ...
  template <typename APIVersionT = Aws::String>
  GetShippingLabelRequest& WithAPIVersion(APIVersionT&& value) {
