...
class AWS_IMPORTEXPORT_API ImportExportClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  ImportExportClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<ImportExportEndpointProviderBase> endpointProvider = nullptr,
      const Aws::ImportExport::ImportExportClientConfiguration& clientConfiguration = Aws::ImportExport::ImportExportClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  ImportExportClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * A Callable wrapper for GetShippingLabel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetShippingLabel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetShippingLabelRequestT = Model::GetShippingLabelRequest>
  void GetShippingLabelAsync(const GetShippingLabelRequestT& request, const GetShippingLabelResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetStatus that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetStatusRequestT = Model::GetStatusRequest>
  void GetStatusAsync(const GetStatusRequestT& request, const GetStatusResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual std::shared_ptr<ImportExportEndpointProviderBase>& accessEndpointProvider();
