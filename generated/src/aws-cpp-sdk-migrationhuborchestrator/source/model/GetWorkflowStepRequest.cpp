...
GetWorkflowStepRequest::GetWorkflowStepRequest() : 
...
Aws::String GetWorkflowStepRequest::SerializePayload() const
{
  return {};
}

void GetWorkflowStepRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
