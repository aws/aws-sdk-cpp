...
ListTemplateStepGroupsResult::ListTemplateStepGroupsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListTemplateStepGroupsResult& ListTemplateStepGroupsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("templateStepGroupSummary")) {
    ...
    for (unsigned templateStepGroupSummaryIndex = 0; templateStepGroupSummaryIndex < templateStepGroupSummaryJsonList.GetLength();
         ++templateStepGroupSummaryIndex) {
