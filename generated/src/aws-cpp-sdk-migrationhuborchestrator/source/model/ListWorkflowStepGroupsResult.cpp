...
ListWorkflowStepGroupsResult::ListWorkflowStepGroupsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListWorkflowStepGroupsResult& ListWorkflowStepGroupsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("workflowStepGroupsSummary")) {
    ...
    for (unsigned workflowStepGroupsSummaryIndex = 0; workflowStepGroupsSummaryIndex < workflowStepGroupsSummaryJsonList.GetLength();
         ++workflowStepGroupsSummaryIndex) {
      m_workflowStepGroupsSummary.push_back(workflowStepGroupsSummaryJsonList[workflowStepGroupsSummaryIndex].AsObject());
    }
    m_workflowStepGroupsSummaryHasBeenSet = true;
  }
