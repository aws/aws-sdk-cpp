...
ListWorkflowStepsResult::ListWorkflowStepsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListWorkflowStepsResult& ListWorkflowStepsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("workflowStepsSummary")) {
    ...
    for (unsigned workflowStepsSummaryIndex = 0; workflowStepsSummaryIndex < workflowStepsSummaryJsonList.GetLength();
         ++workflowStepsSummaryIndex) {
