...
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::CreateTemplateRequest&, const Model::CreateTemplateOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateTemplateResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::CreateWorkflowRequest&, const Model::CreateWorkflowOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateWorkflowResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::CreateWorkflowStepRequest&,
                           const Model::CreateWorkflowStepOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateWorkflowStepResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::CreateWorkflowStepGroupRequest&,
                           const Model::CreateWorkflowStepGroupOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateWorkflowStepGroupResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::DeleteTemplateRequest&, const Model::DeleteTemplateOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteTemplateResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::DeleteWorkflowRequest&, const Model::DeleteWorkflowOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteWorkflowResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::DeleteWorkflowStepRequest&,
                           const Model::DeleteWorkflowStepOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteWorkflowStepResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::DeleteWorkflowStepGroupRequest&,
                           const Model::DeleteWorkflowStepGroupOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteWorkflowStepGroupResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::GetTemplateRequest&, const Model::GetTemplateOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetTemplateResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::GetTemplateStepRequest&,
                           const Model::GetTemplateStepOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetTemplateStepResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::GetTemplateStepGroupRequest&,
                           const Model::GetTemplateStepGroupOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetTemplateStepGroupResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::GetWorkflowRequest&, const Model::GetWorkflowOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetWorkflowResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::GetWorkflowStepRequest&,
                           const Model::GetWorkflowStepOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetWorkflowStepResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::GetWorkflowStepGroupRequest&,
                           const Model::GetWorkflowStepGroupOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetWorkflowStepGroupResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::ListPluginsRequest&, const Model::ListPluginsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListPluginsResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::ListTagsForResourceRequest&,
                           const Model::ListTagsForResourceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTagsForResourceResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::ListTemplateStepGroupsRequest&,
                           const Model::ListTemplateStepGroupsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTemplateStepGroupsResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::ListTemplateStepsRequest&,
                           const Model::ListTemplateStepsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTemplateStepsResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::ListTemplatesRequest&, const Model::ListTemplatesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTemplatesResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::ListWorkflowStepGroupsRequest&,
                           const Model::ListWorkflowStepGroupsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListWorkflowStepGroupsResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::ListWorkflowStepsRequest&,
                           const Model::ListWorkflowStepsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListWorkflowStepsResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::ListWorkflowsRequest&, const Model::ListWorkflowsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListWorkflowsResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::RetryWorkflowStepRequest&,
                           const Model::RetryWorkflowStepOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    RetryWorkflowStepResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::StartWorkflowRequest&, const Model::StartWorkflowOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartWorkflowResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::StopWorkflowRequest&, const Model::StopWorkflowOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StopWorkflowResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::TagResourceRequest&, const Model::TagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    TagResourceResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UntagResourceResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::UpdateTemplateRequest&, const Model::UpdateTemplateOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateTemplateResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::UpdateWorkflowRequest&, const Model::UpdateWorkflowOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateWorkflowResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::UpdateWorkflowStepRequest&,
                           const Model::UpdateWorkflowStepOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateWorkflowStepResponseReceivedHandler;
typedef std::function<void(const MigrationHubOrchestratorClient*, const Model::UpdateWorkflowStepGroupRequest&,
                           const Model::UpdateWorkflowStepGroupOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateWorkflowStepGroupResponseReceivedHandler;
