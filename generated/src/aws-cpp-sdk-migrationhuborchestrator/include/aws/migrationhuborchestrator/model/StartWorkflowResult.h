...
class StartWorkflowResult {
 public:
  ...
  template <typename IdT = Aws::String>
  StartWorkflowResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  StartWorkflowResult& WithArn(ArnT&& value) {
  ...
  inline StartWorkflowResult& WithStatus(MigrationWorkflowStatusEnum value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  StartWorkflowResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename LastStartTimeT = Aws::Utils::DateTime>
  StartWorkflowResult& WithLastStartTime(LastStartTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartWorkflowResult& WithRequestId(RequestIdT&& value) {
