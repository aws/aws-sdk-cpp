...
class ListTemplateStepsRequest : public MigrationHubOrchestratorRequest {
 public:
  AWS_MIGRATIONHUBORCHESTRATOR_API ListTemplateStepsRequest() = default;
  ...
  inline ListTemplateStepsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTemplateStepsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  ListTemplateStepsRequest& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename StepGroupIdT = Aws::String>
  ListTemplateStepsRequest& WithStepGroupId(StepGroupIdT&& value) {
