...
class CreateWorkflowRequest : public MigrationHubOrchestratorRequest {
 public:
  ...
  template <typename TemplateIdT = Aws::String>
  CreateWorkflowRequest& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename ApplicationConfigurationIdT = Aws::String>
  CreateWorkflowRequest& WithApplicationConfigurationId(ApplicationConfigurationIdT&& value) {
  ...
  template <typename InputParametersT = Aws::Map<Aws::String, StepInput>>
  CreateWorkflowRequest& WithInputParameters(InputParametersT&& value) {
  ...
  CreateWorkflowRequest& AddInputParameters(InputParametersKeyT&& key, InputParametersValueT&& value) {
    m_inputParametersHasBeenSet = true;
    m_inputParameters.emplace(std::forward<InputParametersKeyT>(key), std::forward<InputParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StepTargetsT = Aws::Vector<Aws::String>>
  CreateWorkflowRequest& WithStepTargets(StepTargetsT&& value) {
    SetStepTargets(std::forward<StepTargetsT>(value));
    return *this;
  }
  template <typename StepTargetsT = Aws::String>
  CreateWorkflowRequest& AddStepTargets(StepTargetsT&& value) {
    m_stepTargetsHasBeenSet = true;
