...
class StopWorkflowResult {
 public:
  ...
  template <typename IdT = Aws::String>
  StopWorkflowResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  StopWorkflowResult& WithArn(ArnT&& value) {
  ...
  inline StopWorkflowResult& WithStatus(MigrationWorkflowStatusEnum value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  StopWorkflowResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename LastStopTimeT = Aws::Utils::DateTime>
  StopWorkflowResult& WithLastStopTime(LastStopTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopWorkflowResult& WithRequestId(RequestIdT&& value) {
