...
class ListWorkflowStepsRequest : public MigrationHubOrchestratorRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkflowStepsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWorkflowStepsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename WorkflowIdT = Aws::String>
  ListWorkflowStepsRequest& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename StepGroupIdT = Aws::String>
  ListWorkflowStepsRequest& WithStepGroupId(StepGroupIdT&& value) {
