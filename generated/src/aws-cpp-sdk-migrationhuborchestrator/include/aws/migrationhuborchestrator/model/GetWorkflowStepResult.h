...
class GetWorkflowStepResult {
 public:
  ...
  template <typename NameT = Aws::String>
  GetWorkflowStepResult& WithName(NameT&& value) {
  ...
  template <typename StepGroupIdT = Aws::String>
  GetWorkflowStepResult& WithStepGroupId(StepGroupIdT&& value) {
  ...
  template <typename WorkflowIdT = Aws::String>
  GetWorkflowStepResult& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename StepIdT = Aws::String>
  GetWorkflowStepResult& WithStepId(StepIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetWorkflowStepResult& WithDescription(DescriptionT&& value) {
  ...
  inline GetWorkflowStepResult& WithStepActionType(StepActionType value) {
  ...
  inline GetWorkflowStepResult& WithOwner(Owner value) {
    SetOwner(value);
    return *this;
  }
  ///@}
  ...
  template <typename WorkflowStepAutomationConfigurationT = WorkflowStepAutomationConfiguration>
  GetWorkflowStepResult& WithWorkflowStepAutomationConfiguration(WorkflowStepAutomationConfigurationT&& value) {
  ...
  template <typename StepTargetT = Aws::Vector<Aws::String>>
  GetWorkflowStepResult& WithStepTarget(StepTargetT&& value) {
    SetStepTarget(std::forward<StepTargetT>(value));
    return *this;
  }
  template <typename StepTargetT = Aws::String>
  GetWorkflowStepResult& AddStepTarget(StepTargetT&& value) {
    m_stepTargetHasBeenSet = true;
  ...
  template <typename OutputsT = Aws::Vector<WorkflowStepOutput>>
  GetWorkflowStepResult& WithOutputs(OutputsT&& value) {
    SetOutputs(std::forward<OutputsT>(value));
    return *this;
  }
  template <typename OutputsT = WorkflowStepOutput>
  GetWorkflowStepResult& AddOutputs(OutputsT&& value) {
    m_outputsHasBeenSet = true;
  ...
  template <typename PreviousT = Aws::Vector<Aws::String>>
  GetWorkflowStepResult& WithPrevious(PreviousT&& value) {
    SetPrevious(std::forward<PreviousT>(value));
    return *this;
  }
  template <typename PreviousT = Aws::String>
  GetWorkflowStepResult& AddPrevious(PreviousT&& value) {
    m_previousHasBeenSet = true;
  ...
  template <typename NextT = Aws::Vector<Aws::String>>
  GetWorkflowStepResult& WithNext(NextT&& value) {
    SetNext(std::forward<NextT>(value));
    return *this;
  }
  template <typename NextT = Aws::String>
  GetWorkflowStepResult& AddNext(NextT&& value) {
    m_nextHasBeenSet = true;
  ...
  inline GetWorkflowStepResult& WithStatus(StepStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  GetWorkflowStepResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename ScriptOutputLocationT = Aws::String>
  GetWorkflowStepResult& WithScriptOutputLocation(ScriptOutputLocationT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetWorkflowStepResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastStartTimeT = Aws::Utils::DateTime>
  GetWorkflowStepResult& WithLastStartTime(LastStartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  GetWorkflowStepResult& WithEndTime(EndTimeT&& value) {
  ...
  inline void SetNoOfSrvCompleted(int value) {
    m_noOfSrvCompletedHasBeenSet = true;
    m_noOfSrvCompleted = value;
  }
  inline GetWorkflowStepResult& WithNoOfSrvCompleted(int value) {
    SetNoOfSrvCompleted(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNoOfSrvFailed(int value) {
    m_noOfSrvFailedHasBeenSet = true;
    m_noOfSrvFailed = value;
  }
  inline GetWorkflowStepResult& WithNoOfSrvFailed(int value) {
    SetNoOfSrvFailed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalNoOfSrv(int value) {
    m_totalNoOfSrvHasBeenSet = true;
    m_totalNoOfSrv = value;
  }
  inline GetWorkflowStepResult& WithTotalNoOfSrv(int value) {
    SetTotalNoOfSrv(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetWorkflowStepResult& WithRequestId(RequestIdT&& value) {
