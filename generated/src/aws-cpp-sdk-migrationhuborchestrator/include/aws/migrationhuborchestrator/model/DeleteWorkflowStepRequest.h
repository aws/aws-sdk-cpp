...
class DeleteWorkflowStepRequest : public MigrationHubOrchestratorRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  DeleteWorkflowStepRequest& WithId(IdT&& value) {
  ...
  template <typename StepGroupIdT = Aws::String>
  DeleteWorkflowStepRequest& WithStepGroupId(StepGroupIdT&& value) {
  ...
  template <typename WorkflowIdT = Aws::String>
  DeleteWorkflowStepRequest& WithWorkflowId(WorkflowIdT&& value) {
