...
namespace Model
{
  ...
  {
  public:
    AWS_MIGRATIONHUBORCHESTRATOR_API DeleteWorkflowStepRequest() = default;
    ...
    template<typename IdT = Aws::String>
    DeleteWorkflowStepRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename StepGroupIdT = Aws::String>
    DeleteWorkflowStepRequest& WithStepGroupId(StepGroupIdT&& value) { SetStepGroupId(std::forward<StepGroupIdT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkflowIdT = Aws::String>
    DeleteWorkflowStepRequest& WithWorkflowId(WorkflowIdT&& value) { SetWorkflowId(std::forward<WorkflowIdT>(value)); return *this;}
    ///@}
  private:
