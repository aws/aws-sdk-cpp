...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public MigrationHubOrchestratorRequest
  {
  public:
    AWS_MIGRATIONHUBORCHESTRATOR_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the resource to which you want to add
     * tags.</p>
     */
