...
class UpdateWorkflowStepGroupRequest : public MigrationHubOrchestratorRequest {
 public:
  ...
  template <typename WorkflowIdT = Aws::String>
  UpdateWorkflowStepGroupRequest& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateWorkflowStepGroupRequest& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateWorkflowStepGroupRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateWorkflowStepGroupRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename NextT = Aws::Vector<Aws::String>>
  UpdateWorkflowStepGroupRequest& WithNext(NextT&& value) {
    SetNext(std::forward<NextT>(value));
    return *this;
  }
  template <typename NextT = Aws::String>
  UpdateWorkflowStepGroupRequest& AddNext(NextT&& value) {
    m_nextHasBeenSet = true;
  ...
  template <typename PreviousT = Aws::Vector<Aws::String>>
  UpdateWorkflowStepGroupRequest& WithPrevious(PreviousT&& value) {
    SetPrevious(std::forward<PreviousT>(value));
    return *this;
  }
  template <typename PreviousT = Aws::String>
  UpdateWorkflowStepGroupRequest& AddPrevious(PreviousT&& value) {
    m_previousHasBeenSet = true;
