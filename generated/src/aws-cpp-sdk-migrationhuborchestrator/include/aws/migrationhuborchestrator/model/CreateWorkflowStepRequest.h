...
class CreateWorkflowStepRequest : public MigrationHubOrchestratorRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateWorkflowStepRequest& WithName(NameT&& value) {
  ...
  template <typename StepGroupIdT = Aws::String>
  CreateWorkflowStepRequest& WithStepGroupId(StepGroupIdT&& value) {
  ...
  template <typename WorkflowIdT = Aws::String>
  CreateWorkflowStepRequest& WithWorkflowId(WorkflowIdT&& value) {
  ...
  inline CreateWorkflowStepRequest& WithStepActionType(StepActionType value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateWorkflowStepRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename WorkflowStepAutomationConfigurationT = WorkflowStepAutomationConfiguration>
  CreateWorkflowStepRequest& WithWorkflowStepAutomationConfiguration(WorkflowStepAutomationConfigurationT&& value) {
  ...
  template <typename StepTargetT = Aws::Vector<Aws::String>>
  CreateWorkflowStepRequest& WithStepTarget(StepTargetT&& value) {
    SetStepTarget(std::forward<StepTargetT>(value));
    return *this;
  }
  template <typename StepTargetT = Aws::String>
  CreateWorkflowStepRequest& AddStepTarget(StepTargetT&& value) {
    m_stepTargetHasBeenSet = true;
  ...
  template <typename OutputsT = Aws::Vector<WorkflowStepOutput>>
  CreateWorkflowStepRequest& WithOutputs(OutputsT&& value) {
    SetOutputs(std::forward<OutputsT>(value));
    return *this;
  }
  template <typename OutputsT = WorkflowStepOutput>
  CreateWorkflowStepRequest& AddOutputs(OutputsT&& value) {
    m_outputsHasBeenSet = true;
  ...
  template <typename PreviousT = Aws::Vector<Aws::String>>
  CreateWorkflowStepRequest& WithPrevious(PreviousT&& value) {
    SetPrevious(std::forward<PreviousT>(value));
    return *this;
  }
  template <typename PreviousT = Aws::String>
  CreateWorkflowStepRequest& AddPrevious(PreviousT&& value) {
    m_previousHasBeenSet = true;
  ...
  template <typename NextT = Aws::Vector<Aws::String>>
  CreateWorkflowStepRequest& WithNext(NextT&& value) {
    SetNext(std::forward<NextT>(value));
    return *this;
  }
  template <typename NextT = Aws::String>
  CreateWorkflowStepRequest& AddNext(NextT&& value) {
    m_nextHasBeenSet = true;
