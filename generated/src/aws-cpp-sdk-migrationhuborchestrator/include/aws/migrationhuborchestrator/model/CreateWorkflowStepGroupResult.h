...
class CreateWorkflowStepGroupResult {
 public:
  ...
  AWS_MIGRATIONHUBORCHESTRATOR_API CreateWorkflowStepGroupResult& operator=(
  ...
  template <typename WorkflowIdT = Aws::String>
  CreateWorkflowStepGroupResult& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateWorkflowStepGroupResult& WithName(NameT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateWorkflowStepGroupResult& WithId(IdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateWorkflowStepGroupResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename ToolsT = Aws::Vector<Tool>>
  CreateWorkflowStepGroupResult& WithTools(ToolsT&& value) {
    SetTools(std::forward<ToolsT>(value));
    return *this;
  }
  template <typename ToolsT = Tool>
  CreateWorkflowStepGroupResult& AddTools(ToolsT&& value) {
    m_toolsHasBeenSet = true;
  ...
  template <typename NextT = Aws::Vector<Aws::String>>
  CreateWorkflowStepGroupResult& WithNext(NextT&& value) {
    SetNext(std::forward<NextT>(value));
    return *this;
  }
  template <typename NextT = Aws::String>
  CreateWorkflowStepGroupResult& AddNext(NextT&& value) {
    m_nextHasBeenSet = true;
  ...
  template <typename PreviousT = Aws::Vector<Aws::String>>
  CreateWorkflowStepGroupResult& WithPrevious(PreviousT&& value) {
    SetPrevious(std::forward<PreviousT>(value));
    return *this;
  }
  template <typename PreviousT = Aws::String>
  CreateWorkflowStepGroupResult& AddPrevious(PreviousT&& value) {
    m_previousHasBeenSet = true;
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  CreateWorkflowStepGroupResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateWorkflowStepGroupResult& WithRequestId(RequestIdT&& value) {
