...
class CreateWorkflowResult {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateWorkflowResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateWorkflowResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  CreateWorkflowResult& WithTemplateId(TemplateIdT&& value) {
  ...
  void SetAdsApplicationConfigurationId(AdsApplicationConfigurationIdT&& value) {
    m_adsApplicationConfigurationIdHasBeenSet = true;
    m_adsApplicationConfigurationId = std::forward<AdsApplicationConfigurationIdT>(value);
  }
  template <typename AdsApplicationConfigurationIdT = Aws::String>
  CreateWorkflowResult& WithAdsApplicationConfigurationId(AdsApplicationConfigurationIdT&& value) {
    SetAdsApplicationConfigurationId(std::forward<AdsApplicationConfigurationIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWorkflowInputs(WorkflowInputsT&& value) {
    m_workflowInputsHasBeenSet = true;
    m_workflowInputs = std::forward<WorkflowInputsT>(value);
  }
  template <typename WorkflowInputsT = Aws::Map<Aws::String, StepInput>>
  CreateWorkflowResult& WithWorkflowInputs(WorkflowInputsT&& value) {
    SetWorkflowInputs(std::forward<WorkflowInputsT>(value));
    return *this;
  }
  ...
  CreateWorkflowResult& AddWorkflowInputs(WorkflowInputsKeyT&& key, WorkflowInputsValueT&& value) {
    m_workflowInputsHasBeenSet = true;
    m_workflowInputs.emplace(std::forward<WorkflowInputsKeyT>(key), std::forward<WorkflowInputsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStepTargets(StepTargetsT&& value) {
    m_stepTargetsHasBeenSet = true;
    m_stepTargets = std::forward<StepTargetsT>(value);
  }
  template <typename StepTargetsT = Aws::Vector<Aws::String>>
  CreateWorkflowResult& WithStepTargets(StepTargetsT&& value) {
    SetStepTargets(std::forward<StepTargetsT>(value));
    return *this;
  }
  template <typename StepTargetsT = Aws::String>
  CreateWorkflowResult& AddStepTargets(StepTargetsT&& value) {
    m_stepTargetsHasBeenSet = true;
    m_stepTargets.emplace_back(std::forward<StepTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateWorkflowResult& WithStatus(MigrationWorkflowStatusEnum value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  CreateWorkflowResult& WithCreationTime(CreationTimeT&& value) {
