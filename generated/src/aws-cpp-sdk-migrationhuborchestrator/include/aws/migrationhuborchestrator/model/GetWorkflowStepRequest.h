...
class GetWorkflowStepRequest : public MigrationHubOrchestratorRequest {
 public:
  ...
  template <typename WorkflowIdT = Aws::String>
  GetWorkflowStepRequest& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename StepGroupIdT = Aws::String>
  GetWorkflowStepRequest& WithStepGroupId(StepGroupIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetWorkflowStepRequest& WithId(IdT&& value) {
