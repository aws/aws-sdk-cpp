...
class UpdateWorkflowStepResult {
 public:
  ...
  AWS_MIGRATIONHUBORCHESTRATOR_API UpdateWorkflowStepResult& operator=(
  ...
  template <typename IdT = Aws::String>
  UpdateWorkflowStepResult& WithId(IdT&& value) {
  ...
  template <typename StepGroupIdT = Aws::String>
  UpdateWorkflowStepResult& WithStepGroupId(StepGroupIdT&& value) {
  ...
  template <typename WorkflowIdT = Aws::String>
  UpdateWorkflowStepResult& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateWorkflowStepResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateWorkflowStepResult& WithRequestId(RequestIdT&& value) {
