...
class WorkflowStepGroupSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  WorkflowStepGroupSummary& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  WorkflowStepGroupSummary& WithName(NameT&& value) {
  ...
  inline WorkflowStepGroupSummary& WithOwner(Owner value) {
    SetOwner(value);
    return *this;
  }
  ///@}
  ...
  inline WorkflowStepGroupSummary& WithStatus(StepGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename PreviousT = Aws::Vector<Aws::String>>
  WorkflowStepGroupSummary& WithPrevious(PreviousT&& value) {
    SetPrevious(std::forward<PreviousT>(value));
    return *this;
  }
  template <typename PreviousT = Aws::String>
  WorkflowStepGroupSummary& AddPrevious(PreviousT&& value) {
    m_previousHasBeenSet = true;
  ...
  template <typename NextT = Aws::Vector<Aws::String>>
  WorkflowStepGroupSummary& WithNext(NextT&& value) {
    SetNext(std::forward<NextT>(value));
    return *this;
  }
  template <typename NextT = Aws::String>
  WorkflowStepGroupSummary& AddNext(NextT&& value) {
    m_nextHasBeenSet = true;
