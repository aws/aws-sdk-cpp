...
class GetTemplateStepGroupResult {
 public:
  ...
  AWS_MIGRATIONHUBORCHESTRATOR_API GetTemplateStepGroupResult& operator=(
  ...
  template <typename TemplateIdT = Aws::String>
  GetTemplateStepGroupResult& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetTemplateStepGroupResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetTemplateStepGroupResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetTemplateStepGroupResult& WithDescription(DescriptionT&& value) {
  ...
  inline GetTemplateStepGroupResult& WithStatus(StepGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetTemplateStepGroupResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  GetTemplateStepGroupResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename ToolsT = Aws::Vector<Tool>>
  GetTemplateStepGroupResult& WithTools(ToolsT&& value) {
    SetTools(std::forward<ToolsT>(value));
    return *this;
  }
  template <typename ToolsT = Tool>
  GetTemplateStepGroupResult& AddTools(ToolsT&& value) {
    m_toolsHasBeenSet = true;
  ...
  template <typename PreviousT = Aws::Vector<Aws::String>>
  GetTemplateStepGroupResult& WithPrevious(PreviousT&& value) {
    SetPrevious(std::forward<PreviousT>(value));
    return *this;
  }
  template <typename PreviousT = Aws::String>
  GetTemplateStepGroupResult& AddPrevious(PreviousT&& value) {
    m_previousHasBeenSet = true;
  ...
  template <typename NextT = Aws::Vector<Aws::String>>
  GetTemplateStepGroupResult& WithNext(NextT&& value) {
    SetNext(std::forward<NextT>(value));
    return *this;
  }
  template <typename NextT = Aws::String>
  GetTemplateStepGroupResult& AddNext(NextT&& value) {
    m_nextHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetTemplateStepGroupResult& WithRequestId(RequestIdT&& value) {
