...
class CreateWorkflowStepGroupRequest : public MigrationHubOrchestratorRequest {
 public:
  AWS_MIGRATIONHUBORCHESTRATOR_API CreateWorkflowStepGroupRequest() = default;
  ...
  template <typename WorkflowIdT = Aws::String>
  CreateWorkflowStepGroupRequest& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateWorkflowStepGroupRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateWorkflowStepGroupRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename NextT = Aws::Vector<Aws::String>>
  CreateWorkflowStepGroupRequest& WithNext(NextT&& value) {
    SetNext(std::forward<NextT>(value));
    return *this;
  }
  template <typename NextT = Aws::String>
  CreateWorkflowStepGroupRequest& AddNext(NextT&& value) {
    m_nextHasBeenSet = true;
  ...
  template <typename PreviousT = Aws::Vector<Aws::String>>
  CreateWorkflowStepGroupRequest& WithPrevious(PreviousT&& value) {
    SetPrevious(std::forward<PreviousT>(value));
    return *this;
  }
  template <typename PreviousT = Aws::String>
  CreateWorkflowStepGroupRequest& AddPrevious(PreviousT&& value) {
    m_previousHasBeenSet = true;
