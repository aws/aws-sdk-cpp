...
class UpdateWorkflowResult {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateWorkflowResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateWorkflowResult& WithArn(ArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateWorkflowResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  UpdateWorkflowResult& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename AdsApplicationConfigurationIdT = Aws::String>
  UpdateWorkflowResult& WithAdsApplicationConfigurationId(AdsApplicationConfigurationIdT&& value) {
  ...
  template <typename WorkflowInputsT = Aws::Map<Aws::String, StepInput>>
  UpdateWorkflowResult& WithWorkflowInputs(WorkflowInputsT&& value) {
  ...
  template <typename StepTargetsT = Aws::Vector<Aws::String>>
  UpdateWorkflowResult& WithStepTargets(StepTargetsT&& value) {
    SetStepTargets(std::forward<StepTargetsT>(value));
    return *this;
  }
  template <typename StepTargetsT = Aws::String>
  UpdateWorkflowResult& AddStepTargets(StepTargetsT&& value) {
    m_stepTargetsHasBeenSet = true;
  ...
  inline UpdateWorkflowResult& WithStatus(MigrationWorkflowStatusEnum value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  UpdateWorkflowResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  UpdateWorkflowResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateWorkflowResult& WithTags(TagsT&& value) {
