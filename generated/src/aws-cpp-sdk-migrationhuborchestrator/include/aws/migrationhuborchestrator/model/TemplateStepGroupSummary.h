...
class TemplateStepGroupSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  TemplateStepGroupSummary& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  TemplateStepGroupSummary& WithName(NameT&& value) {
  ...
  template <typename PreviousT = Aws::Vector<Aws::String>>
  TemplateStepGroupSummary& WithPrevious(PreviousT&& value) {
    SetPrevious(std::forward<PreviousT>(value));
    return *this;
  }
  template <typename PreviousT = Aws::String>
  TemplateStepGroupSummary& AddPrevious(PreviousT&& value) {
    m_previousHasBeenSet = true;
  ...
  template <typename NextT = Aws::Vector<Aws::String>>
  TemplateStepGroupSummary& WithNext(NextT&& value) {
    SetNext(std::forward<NextT>(value));
    return *this;
  }
  template <typename NextT = Aws::String>
  TemplateStepGroupSummary& AddNext(NextT&& value) {
    m_nextHasBeenSet = true;
