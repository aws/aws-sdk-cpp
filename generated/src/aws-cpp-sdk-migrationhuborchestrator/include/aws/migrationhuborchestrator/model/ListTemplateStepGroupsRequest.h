...
class ListTemplateStepGroupsRequest : public MigrationHubOrchestratorRequest {
 public:
  ...
  inline ListTemplateStepGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTemplateStepGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  ListTemplateStepGroupsRequest& WithTemplateId(TemplateIdT&& value) {
