...
class ListTemplateStepGroupsResult {
 public:
  ...
  AWS_MIGRATIONHUBORCHESTRATOR_API ListTemplateStepGroupsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListTemplateStepGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetTemplateStepGroupSummary(TemplateStepGroupSummaryT&& value) {
    m_templateStepGroupSummaryHasBeenSet = true;
    m_templateStepGroupSummary = std::forward<TemplateStepGroupSummaryT>(value);
  }
  template <typename TemplateStepGroupSummaryT = Aws::Vector<TemplateStepGroupSummary>>
  ListTemplateStepGroupsResult& WithTemplateStepGroupSummary(TemplateStepGroupSummaryT&& value) {
    SetTemplateStepGroupSummary(std::forward<TemplateStepGroupSummaryT>(value));
    return *this;
  }
  template <typename TemplateStepGroupSummaryT = TemplateStepGroupSummary>
  ListTemplateStepGroupsResult& AddTemplateStepGroupSummary(TemplateStepGroupSummaryT&& value) {
    m_templateStepGroupSummaryHasBeenSet = true;
    m_templateStepGroupSummary.emplace_back(std::forward<TemplateStepGroupSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListTemplateStepGroupsResult& WithRequestId(RequestIdT&& value) {
