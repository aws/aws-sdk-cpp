...
class ListWorkflowStepsResult {
 public:
  ...
  AWS_MIGRATIONHUBORCHESTRATOR_API ListWorkflowStepsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkflowStepsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetWorkflowStepsSummary(WorkflowStepsSummaryT&& value) {
    m_workflowStepsSummaryHasBeenSet = true;
    m_workflowStepsSummary = std::forward<WorkflowStepsSummaryT>(value);
  }
  template <typename WorkflowStepsSummaryT = Aws::Vector<WorkflowStepSummary>>
  ListWorkflowStepsResult& WithWorkflowStepsSummary(WorkflowStepsSummaryT&& value) {
    SetWorkflowStepsSummary(std::forward<WorkflowStepsSummaryT>(value));
    return *this;
  }
  template <typename WorkflowStepsSummaryT = WorkflowStepSummary>
  ListWorkflowStepsResult& AddWorkflowStepsSummary(WorkflowStepsSummaryT&& value) {
    m_workflowStepsSummaryHasBeenSet = true;
    m_workflowStepsSummary.emplace_back(std::forward<WorkflowStepsSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListWorkflowStepsResult& WithRequestId(RequestIdT&& value) {
