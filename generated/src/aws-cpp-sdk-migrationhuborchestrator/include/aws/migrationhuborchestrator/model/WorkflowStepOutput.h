...
class WorkflowStepOutput {
 public:
  ...
  template <typename NameT = Aws::String>
  WorkflowStepOutput& WithName(NameT&& value) {
  ...
  inline WorkflowStepOutput& WithDataType(DataType value) {
    SetDataType(value);
    return *this;
  }
  ///@}
  ...
  inline WorkflowStepOutput& WithRequired(bool value) {
    SetRequired(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = WorkflowStepOutputUnion>
  WorkflowStepOutput& WithValue(ValueT&& value) {
