...
class StepInput {
 public:
  ...
  inline StepInput& WithIntegerValue(int value) {
  ...
  template <typename StringValueT = Aws::String>
  StepInput& WithStringValue(StringValueT&& value) {
  ...
  void SetListOfStringsValue(ListOfStringsValueT&& value) {
    m_listOfStringsValueHasBeenSet = true;
    m_listOfStringsValue = std::forward<ListOfStringsValueT>(value);
  }
  template <typename ListOfStringsValueT = Aws::Vector<Aws::String>>
  StepInput& WithListOfStringsValue(ListOfStringsValueT&& value) {
    SetListOfStringsValue(std::forward<ListOfStringsValueT>(value));
    return *this;
  }
  template <typename ListOfStringsValueT = Aws::String>
  StepInput& AddListOfStringsValue(ListOfStringsValueT&& value) {
    m_listOfStringsValueHasBeenSet = true;
    m_listOfStringsValue.emplace_back(std::forward<ListOfStringsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMapOfStringValue(MapOfStringValueT&& value) {
    m_mapOfStringValueHasBeenSet = true;
    m_mapOfStringValue = std::forward<MapOfStringValueT>(value);
  }
  template <typename MapOfStringValueT = Aws::Map<Aws::String, Aws::String>>
  StepInput& WithMapOfStringValue(MapOfStringValueT&& value) {
    SetMapOfStringValue(std::forward<MapOfStringValueT>(value));
    return *this;
  }
  ...
  StepInput& AddMapOfStringValue(MapOfStringValueKeyT&& key, MapOfStringValueValueT&& value) {
    m_mapOfStringValueHasBeenSet = true;
    m_mapOfStringValue.emplace(std::forward<MapOfStringValueKeyT>(key), std::forward<MapOfStringValueValueT>(value));
    return *this;
  }
  ///@}
 private:
