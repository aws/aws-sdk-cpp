...
class ListTemplatesResult {
 public:
  ...
  void SetTemplateSummary(TemplateSummaryT&& value) {
    m_templateSummaryHasBeenSet = true;
    m_templateSummary = std::forward<TemplateSummaryT>(value);
  }
  template <typename TemplateSummaryT = Aws::Vector<TemplateSummary>>
  ListTemplatesResult& WithTemplateSummary(TemplateSummaryT&& value) {
    SetTemplateSummary(std::forward<TemplateSummaryT>(value));
    return *this;
  }
  template <typename TemplateSummaryT = TemplateSummary>
  ListTemplatesResult& AddTemplateSummary(TemplateSummaryT&& value) {
    m_templateSummaryHasBeenSet = true;
    m_templateSummary.emplace_back(std::forward<TemplateSummaryT>(value));
    return *this;
  }
  ///@}
