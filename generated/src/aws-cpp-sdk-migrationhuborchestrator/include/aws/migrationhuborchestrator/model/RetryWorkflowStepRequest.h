...
class RetryWorkflowStepRequest : public MigrationHubOrchestratorRequest {
 public:
  ...
  template <typename WorkflowIdT = Aws::String>
  RetryWorkflowStepRequest& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename StepGroupIdT = Aws::String>
  RetryWorkflowStepRequest& WithStepGroupId(StepGroupIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  RetryWorkflowStepRequest& WithId(IdT&& value) {
