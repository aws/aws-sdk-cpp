...
class GetTemplateResult {
 public:
  ...
  template <typename IdT = Aws::String>
  GetTemplateResult& WithId(IdT&& value) {
  ...
  template <typename InputsT = Aws::Vector<TemplateInput>>
  GetTemplateResult& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = TemplateInput>
  GetTemplateResult& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  template <typename ToolsT = Aws::Vector<Tool>>
  GetTemplateResult& WithTools(ToolsT&& value) {
    SetTools(std::forward<ToolsT>(value));
    return *this;
  }
  template <typename ToolsT = Tool>
  GetTemplateResult& AddTools(ToolsT&& value) {
    m_toolsHasBeenSet = true;
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetTemplateResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename OwnerT = Aws::String>
  GetTemplateResult& WithOwner(OwnerT&& value) {
  ...
  template <typename StatusMessageT = Aws::String>
  GetTemplateResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  void SetTemplateClass(TemplateClassT&& value) {
    m_templateClassHasBeenSet = true;
    m_templateClass = std::forward<TemplateClassT>(value);
  }
  template <typename TemplateClassT = Aws::String>
  GetTemplateResult& WithTemplateClass(TemplateClassT&& value) {
    SetTemplateClass(std::forward<TemplateClassT>(value));
    return *this;
  }
  ///@}
