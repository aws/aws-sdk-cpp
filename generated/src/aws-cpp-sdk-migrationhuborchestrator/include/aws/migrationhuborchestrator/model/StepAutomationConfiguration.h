...
class StepAutomationConfiguration {
 public:
  ...
  template <typename ScriptLocationS3BucketT = Aws::String>
  StepAutomationConfiguration& WithScriptLocationS3Bucket(ScriptLocationS3BucketT&& value) {
  ...
  template <typename ScriptLocationS3KeyT = PlatformScriptKey>
  StepAutomationConfiguration& WithScriptLocationS3Key(ScriptLocationS3KeyT&& value) {
  ...
  template <typename CommandT = PlatformCommand>
  StepAutomationConfiguration& WithCommand(CommandT&& value) {
  ...
  inline StepAutomationConfiguration& WithRunEnvironment(RunEnvironment value) {
  ...
  inline StepAutomationConfiguration& WithTargetType(TargetType value) {
    SetTargetType(value);
    return *this;
  }
  ///@}
