...
class ListWorkflowsResult {
 public:
  ...
  void SetMigrationWorkflowSummary(MigrationWorkflowSummaryT&& value) {
    m_migrationWorkflowSummaryHasBeenSet = true;
    m_migrationWorkflowSummary = std::forward<MigrationWorkflowSummaryT>(value);
  }
  template <typename MigrationWorkflowSummaryT = Aws::Vector<MigrationWorkflowSummary>>
  ListWorkflowsResult& WithMigrationWorkflowSummary(MigrationWorkflowSummaryT&& value) {
    SetMigrationWorkflowSummary(std::forward<MigrationWorkflowSummaryT>(value));
    return *this;
  }
  template <typename MigrationWorkflowSummaryT = MigrationWorkflowSummary>
  ListWorkflowsResult& AddMigrationWorkflowSummary(MigrationWorkflowSummaryT&& value) {
    m_migrationWorkflowSummaryHasBeenSet = true;
    m_migrationWorkflowSummary.emplace_back(std::forward<MigrationWorkflowSummaryT>(value));
    return *this;
  }
  ///@}
