...
class ListTemplateStepsResult {
 public:
  ...
  AWS_MIGRATIONHUBORCHESTRATOR_API ListTemplateStepsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListTemplateStepsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetTemplateStepSummaryList(TemplateStepSummaryListT&& value) {
    m_templateStepSummaryListHasBeenSet = true;
    m_templateStepSummaryList = std::forward<TemplateStepSummaryListT>(value);
  }
  template <typename TemplateStepSummaryListT = Aws::Vector<TemplateStepSummary>>
  ListTemplateStepsResult& WithTemplateStepSummaryList(TemplateStepSummaryListT&& value) {
    SetTemplateStepSummaryList(std::forward<TemplateStepSummaryListT>(value));
    return *this;
  }
  template <typename TemplateStepSummaryListT = TemplateStepSummary>
  ListTemplateStepsResult& AddTemplateStepSummaryList(TemplateStepSummaryListT&& value) {
    m_templateStepSummaryListHasBeenSet = true;
    m_templateStepSummaryList.emplace_back(std::forward<TemplateStepSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListTemplateStepsResult& WithRequestId(RequestIdT&& value) {
