...
class GetWorkflowResult {
 public:
  ...
  template <typename TemplateIdT = Aws::String>
  GetWorkflowResult& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename AdsApplicationConfigurationIdT = Aws::String>
  GetWorkflowResult& WithAdsApplicationConfigurationId(AdsApplicationConfigurationIdT&& value) {
  ...
  void SetAdsApplicationName(AdsApplicationNameT&& value) {
    m_adsApplicationNameHasBeenSet = true;
    m_adsApplicationName = std::forward<AdsApplicationNameT>(value);
  }
  template <typename AdsApplicationNameT = Aws::String>
  GetWorkflowResult& WithAdsApplicationName(AdsApplicationNameT&& value) {
    SetAdsApplicationName(std::forward<AdsApplicationNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetWorkflowResult& WithStatus(MigrationWorkflowStatusEnum value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastStartTimeT = Aws::Utils::DateTime>
  GetWorkflowResult& WithLastStartTime(LastStartTimeT&& value) {
  ...
  template <typename LastStopTimeT = Aws::Utils::DateTime>
  GetWorkflowResult& WithLastStopTime(LastStopTimeT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  GetWorkflowResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  GetWorkflowResult& WithEndTime(EndTimeT&& value) {
  ...
  template <typename ToolsT = Aws::Vector<Tool>>
  GetWorkflowResult& WithTools(ToolsT&& value) {
    SetTools(std::forward<ToolsT>(value));
    return *this;
  }
  template <typename ToolsT = Tool>
  GetWorkflowResult& AddTools(ToolsT&& value) {
    m_toolsHasBeenSet = true;
  ...
  inline GetWorkflowResult& WithTotalSteps(int value) {
    SetTotalSteps(value);
    return *this;
  }
  ///@}
  ...
  inline GetWorkflowResult& WithCompletedSteps(int value) {
  ...
  template <typename WorkflowInputsT = Aws::Map<Aws::String, StepInput>>
  GetWorkflowResult& WithWorkflowInputs(WorkflowInputsT&& value) {
  ...
  void SetWorkflowBucket(WorkflowBucketT&& value) {
    m_workflowBucketHasBeenSet = true;
    m_workflowBucket = std::forward<WorkflowBucketT>(value);
  }
  template <typename WorkflowBucketT = Aws::String>
  GetWorkflowResult& WithWorkflowBucket(WorkflowBucketT&& value) {
    SetWorkflowBucket(std::forward<WorkflowBucketT>(value));
    return *this;
  }
  ///@}
