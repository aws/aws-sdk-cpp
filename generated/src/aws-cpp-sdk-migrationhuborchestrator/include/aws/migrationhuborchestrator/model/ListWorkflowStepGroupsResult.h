...
class ListWorkflowStepGroupsResult {
 public:
  ...
  AWS_MIGRATIONHUBORCHESTRATOR_API ListWorkflowStepGroupsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkflowStepGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetWorkflowStepGroupsSummary(WorkflowStepGroupsSummaryT&& value) {
    m_workflowStepGroupsSummaryHasBeenSet = true;
    m_workflowStepGroupsSummary = std::forward<WorkflowStepGroupsSummaryT>(value);
  }
  template <typename WorkflowStepGroupsSummaryT = Aws::Vector<WorkflowStepGroupSummary>>
  ListWorkflowStepGroupsResult& WithWorkflowStepGroupsSummary(WorkflowStepGroupsSummaryT&& value) {
    SetWorkflowStepGroupsSummary(std::forward<WorkflowStepGroupsSummaryT>(value));
    return *this;
  }
  template <typename WorkflowStepGroupsSummaryT = WorkflowStepGroupSummary>
  ListWorkflowStepGroupsResult& AddWorkflowStepGroupsSummary(WorkflowStepGroupsSummaryT&& value) {
    m_workflowStepGroupsSummaryHasBeenSet = true;
    m_workflowStepGroupsSummary.emplace_back(std::forward<WorkflowStepGroupsSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListWorkflowStepGroupsResult& WithRequestId(RequestIdT&& value) {
