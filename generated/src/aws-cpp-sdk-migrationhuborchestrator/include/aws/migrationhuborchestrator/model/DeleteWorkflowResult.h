...
class DeleteWorkflowResult {
 public:
  AWS_MIGRATIONHUBORCHESTRATOR_API DeleteWorkflowResult() = default;
  ...
  template <typename IdT = Aws::String>
  DeleteWorkflowResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeleteWorkflowResult& WithArn(ArnT&& value) {
  ...
  inline DeleteWorkflowResult& WithStatus(MigrationWorkflowStatusEnum value) {
    SetStatus(value);
    return *this;
  }
  ///@}
