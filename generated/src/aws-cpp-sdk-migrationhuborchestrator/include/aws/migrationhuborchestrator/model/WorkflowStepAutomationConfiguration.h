...
class WorkflowStepAutomationConfiguration {
 public:
  ...
  void SetScriptLocationS3Bucket(ScriptLocationS3BucketT&& value) {
    m_scriptLocationS3BucketHasBeenSet = true;
    m_scriptLocationS3Bucket = std::forward<ScriptLocationS3BucketT>(value);
  }
  template <typename ScriptLocationS3BucketT = Aws::String>
  WorkflowStepAutomationConfiguration& WithScriptLocationS3Bucket(ScriptLocationS3BucketT&& value) {
    SetScriptLocationS3Bucket(std::forward<ScriptLocationS3BucketT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScriptLocationS3Key(ScriptLocationS3KeyT&& value) {
    m_scriptLocationS3KeyHasBeenSet = true;
    m_scriptLocationS3Key = std::forward<ScriptLocationS3KeyT>(value);
  }
  template <typename ScriptLocationS3KeyT = PlatformScriptKey>
  WorkflowStepAutomationConfiguration& WithScriptLocationS3Key(ScriptLocationS3KeyT&& value) {
    SetScriptLocationS3Key(std::forward<ScriptLocationS3KeyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CommandT = PlatformCommand>
  WorkflowStepAutomationConfiguration& WithCommand(CommandT&& value) {
  ...
  inline void SetRunEnvironment(RunEnvironment value) {
    m_runEnvironmentHasBeenSet = true;
    m_runEnvironment = value;
  }
  inline WorkflowStepAutomationConfiguration& WithRunEnvironment(RunEnvironment value) {
    SetRunEnvironment(value);
    return *this;
  }
  ///@}
  ...
  inline WorkflowStepAutomationConfiguration& WithTargetType(TargetType value) {
    SetTargetType(value);
    return *this;
  }
  ///@}
