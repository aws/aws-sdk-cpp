...
class UpdateWorkflowRequest : public MigrationHubOrchestratorRequest {
 public:
  ...
  template <typename InputParametersT = Aws::Map<Aws::String, StepInput>>
  UpdateWorkflowRequest& WithInputParameters(InputParametersT&& value) {
  ...
  template <typename StepTargetsT = Aws::Vector<Aws::String>>
  UpdateWorkflowRequest& WithStepTargets(StepTargetsT&& value) {
    SetStepTargets(std::forward<StepTargetsT>(value));
    return *this;
  }
  template <typename StepTargetsT = Aws::String>
  UpdateWorkflowRequest& AddStepTargets(StepTargetsT&& value) {
    m_stepTargetsHasBeenSet = true;
