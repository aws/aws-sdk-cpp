...
class CreateWorkflowStepResult {
 public:
  AWS_MIGRATIONHUBORCHESTRATOR_API CreateWorkflowStepResult() = default;
  ...
  AWS_MIGRATIONHUBORCHESTRATOR_API CreateWorkflowStepResult& operator=(
  ...
  template <typename IdT = Aws::String>
  CreateWorkflowStepResult& WithId(IdT&& value) {
  ...
  template <typename StepGroupIdT = Aws::String>
  CreateWorkflowStepResult& WithStepGroupId(StepGroupIdT&& value) {
  ...
  template <typename WorkflowIdT = Aws::String>
  CreateWorkflowStepResult& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateWorkflowStepResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateWorkflowStepResult& WithRequestId(RequestIdT&& value) {
