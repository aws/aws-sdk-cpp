...
namespace Model
{
  ...
  /**
   */
  class DeleteTemplateRequest : public MigrationHubOrchestratorRequest
  {
  public:
    AWS_MIGRATIONHUBORCHESTRATOR_API DeleteTemplateRequest() = default;
    ...
    template<typename IdT = Aws::String>
    DeleteTemplateRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
