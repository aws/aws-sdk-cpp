...
/**
 */
class ListTagsForResourceRequest : public MarketplaceDeploymentRequest {
 public:
  AWS_MARKETPLACEDEPLOYMENT_API ListTagsForResourceRequest() = default;
   ...
   * resource you want to list tags on.</p>
   */
