...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public MarketplaceDeploymentRequest
  {
  public:
    AWS_MARKETPLACEDEPLOYMENT_API UntagResourceRequest() = default;
    ...
    AWS_MARKETPLACEDEPLOYMENT_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;


    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) associated with the resource you want to
