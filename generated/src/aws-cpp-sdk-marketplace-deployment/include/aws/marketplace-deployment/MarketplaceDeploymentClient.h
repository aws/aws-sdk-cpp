...
namespace MarketplaceDeployment
{
   ...
   * experience.</p>
   */
  class AWS_MARKETPLACEDEPLOYMENT_API MarketplaceDeploymentClient : Aws::Client::ClientWithAsyncTemplateMethods<MarketplaceDeploymentClient>,
    smithy::client::AwsSmithyClientT<Aws::MarketplaceDeployment::SERVICE_NAME,
