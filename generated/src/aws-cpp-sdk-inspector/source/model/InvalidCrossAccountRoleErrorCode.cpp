  ...
  namespace Inspector
  {
    namespace Model
    {
      namespace InvalidCrossAccountRoleErrorCodeMapper
      {
        ...
        static constexpr uint32_t ROLE_DOES_NOT_EXIST_OR_INVALID_TRUST_RELATIONSHIP_HASH = ConstExprHashingUtils::HashString("ROLE_DOES_NOT_EXIST_OR_INVALID_TRUST_RELATIONSHIP");
        static constexpr uint32_t ROLE_DOES_NOT_HAVE_CORRECT_POLICY_HASH = ConstExprHashingUtils::HashString("ROLE_DOES_NOT_HAVE_CORRECT_POLICY");
