...
AssessmentRunNotification::AssessmentRunNotification(JsonView jsonValue) { *this = jsonValue; }
...
AssessmentRunNotification& AssessmentRunNotification::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("snsPublishStatusCode")) {
    m_snsPublishStatusCode = AssessmentRunNotificationSnsStatusCodeMapper::GetAssessmentRunNotificationSnsStatusCodeForName(
        jsonValue.GetString("snsPublishStatusCode"));
...
JsonValue AssessmentRunNotification::Jsonize() const {
  ...
  if (m_snsPublishStatusCodeHasBeenSet) {
    payload.WithString(
        ...
        AssessmentRunNotificationSnsStatusCodeMapper::GetNameForAssessmentRunNotificationSnsStatusCode(m_snsPublishStatusCode));
  }
