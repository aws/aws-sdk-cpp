...
class AWS_INSPECTOR_API InspectorClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  InspectorClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<InspectorEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AddAttributesToFindings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddAttributesToFindings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddAttributesToFindingsRequestT = Model::AddAttributesToFindingsRequest>
  void AddAttributesToFindingsAsync(const AddAttributesToFindingsRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateAssessmentTarget that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAssessmentTarget that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAssessmentTargetRequestT = Model::CreateAssessmentTargetRequest>
  void CreateAssessmentTargetAsync(const CreateAssessmentTargetRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateAssessmentTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAssessmentTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAssessmentTemplateRequestT = Model::CreateAssessmentTemplateRequest>
  void CreateAssessmentTemplateAsync(const CreateAssessmentTemplateRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateExclusionsPreview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateExclusionsPreview that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateExclusionsPreviewRequestT = Model::CreateExclusionsPreviewRequest>
  void CreateExclusionsPreviewAsync(const CreateExclusionsPreviewRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateResourceGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateResourceGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateResourceGroupRequestT = Model::CreateResourceGroupRequest>
  void CreateResourceGroupAsync(const CreateResourceGroupRequestT& request, const CreateResourceGroupResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAssessmentRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAssessmentRun that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAssessmentRunRequestT = Model::DeleteAssessmentRunRequest>
  void DeleteAssessmentRunAsync(const DeleteAssessmentRunRequestT& request, const DeleteAssessmentRunResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAssessmentTarget that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAssessmentTarget that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAssessmentTargetRequestT = Model::DeleteAssessmentTargetRequest>
  void DeleteAssessmentTargetAsync(const DeleteAssessmentTargetRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteAssessmentTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAssessmentTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAssessmentTemplateRequestT = Model::DeleteAssessmentTemplateRequest>
  void DeleteAssessmentTemplateAsync(const DeleteAssessmentTemplateRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeAssessmentRuns that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAssessmentRuns that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAssessmentRunsRequestT = Model::DescribeAssessmentRunsRequest>
  void DescribeAssessmentRunsAsync(const DescribeAssessmentRunsRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeAssessmentTargets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeAssessmentTargetsRequestT = Model::DescribeAssessmentTargetsRequest>
  Model::DescribeAssessmentTargetsOutcomeCallable DescribeAssessmentTargetsCallable(
      const DescribeAssessmentTargetsRequestT& request) const {
    return SubmitCallable(&InspectorClient::DescribeAssessmentTargets, request);
  }

  /**
   * An Async wrapper for DescribeAssessmentTargets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAssessmentTargetsRequestT = Model::DescribeAssessmentTargetsRequest>
  void DescribeAssessmentTargetsAsync(const DescribeAssessmentTargetsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAssessmentTemplatesOutcome DescribeAssessmentTemplates(
      const Model::DescribeAssessmentTemplatesRequest& request) const;

  /**
   * A Callable wrapper for DescribeAssessmentTemplates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAssessmentTemplatesRequestT = Model::DescribeAssessmentTemplatesRequest>
  Model::DescribeAssessmentTemplatesOutcomeCallable DescribeAssessmentTemplatesCallable(
      const DescribeAssessmentTemplatesRequestT& request) const {
    return SubmitCallable(&InspectorClient::DescribeAssessmentTemplates, request);
  }

  /**
   * An Async wrapper for DescribeAssessmentTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAssessmentTemplatesRequestT = Model::DescribeAssessmentTemplatesRequest>
  void DescribeAssessmentTemplatesAsync(const DescribeAssessmentTemplatesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCrossAccountAccessRoleOutcome DescribeCrossAccountAccessRole(
      const Model::DescribeCrossAccountAccessRoleRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeCrossAccountAccessRole that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeCrossAccountAccessRoleRequestT = Model::DescribeCrossAccountAccessRoleRequest>
  Model::DescribeCrossAccountAccessRoleOutcomeCallable DescribeCrossAccountAccessRoleCallable(
      const DescribeCrossAccountAccessRoleRequestT& request = {}) const {
    return SubmitCallable(&InspectorClient::DescribeCrossAccountAccessRole, request);
  }

  /**
   * An Async wrapper for DescribeCrossAccountAccessRole that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeCrossAccountAccessRoleRequestT = Model::DescribeCrossAccountAccessRoleRequest>
  void DescribeCrossAccountAccessRoleAsync(const DescribeCrossAccountAccessRoleResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DescribeExclusions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeExclusions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeExclusionsRequestT = Model::DescribeExclusionsRequest>
  void DescribeExclusionsAsync(const DescribeExclusionsRequestT& request, const DescribeExclusionsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeFindings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFindings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeFindingsRequestT = Model::DescribeFindingsRequest>
  void DescribeFindingsAsync(const DescribeFindingsRequestT& request, const DescribeFindingsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeResourceGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeResourceGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeResourceGroupsRequestT = Model::DescribeResourceGroupsRequest>
  void DescribeResourceGroupsAsync(const DescribeResourceGroupsRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeRulesPackages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRulesPackages that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRulesPackagesRequestT = Model::DescribeRulesPackagesRequest>
  void DescribeRulesPackagesAsync(const DescribeRulesPackagesRequestT& request, const DescribeRulesPackagesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAssessmentReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAssessmentReport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAssessmentReportRequestT = Model::GetAssessmentReportRequest>
  void GetAssessmentReportAsync(const GetAssessmentReportRequestT& request, const GetAssessmentReportResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetExclusionsPreview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetExclusionsPreview that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetExclusionsPreviewRequestT = Model::GetExclusionsPreviewRequest>
  void GetExclusionsPreviewAsync(const GetExclusionsPreviewRequestT& request, const GetExclusionsPreviewResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTelemetryMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTelemetryMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTelemetryMetadataRequestT = Model::GetTelemetryMetadataRequest>
  void GetTelemetryMetadataAsync(const GetTelemetryMetadataRequestT& request, const GetTelemetryMetadataResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAssessmentRunAgents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssessmentRunAgents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAssessmentRunAgentsRequestT = Model::ListAssessmentRunAgentsRequest>
  void ListAssessmentRunAgentsAsync(const ListAssessmentRunAgentsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListAssessmentRuns that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssessmentRuns that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAssessmentRunsRequestT = Model::ListAssessmentRunsRequest>
  void ListAssessmentRunsAsync(const ListAssessmentRunsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListAssessmentRunsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListAssessmentTargets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssessmentTargets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAssessmentTargetsRequestT = Model::ListAssessmentTargetsRequest>
  void ListAssessmentTargetsAsync(const ListAssessmentTargetsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListAssessmentTargetsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListAssessmentTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssessmentTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAssessmentTemplatesRequestT = Model::ListAssessmentTemplatesRequest>
  void ListAssessmentTemplatesAsync(const ListAssessmentTemplatesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListAssessmentTemplatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListEventSubscriptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEventSubscriptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEventSubscriptionsRequestT = Model::ListEventSubscriptionsRequest>
  void ListEventSubscriptionsAsync(const ListEventSubscriptionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListEventSubscriptionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListExclusions that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListExclusionsRequestT = Model::ListExclusionsRequest>
  void ListExclusionsAsync(const ListExclusionsRequestT& request, const ListExclusionsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListRulesPackages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRulesPackages that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListRulesPackagesRequestT = Model::ListRulesPackagesRequest>
  void ListRulesPackagesAsync(const ListRulesPackagesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListRulesPackagesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for PreviewAgents that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PreviewAgentsRequestT = Model::PreviewAgentsRequest>
  void PreviewAgentsAsync(const PreviewAgentsRequestT& request, const PreviewAgentsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterCrossAccountAccessRoleOutcome RegisterCrossAccountAccessRole(
      const Model::RegisterCrossAccountAccessRoleRequest& request) const;

  /**
   * A Callable wrapper for RegisterCrossAccountAccessRole that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RegisterCrossAccountAccessRoleRequestT = Model::RegisterCrossAccountAccessRoleRequest>
  Model::RegisterCrossAccountAccessRoleOutcomeCallable RegisterCrossAccountAccessRoleCallable(
      const RegisterCrossAccountAccessRoleRequestT& request) const {
    return SubmitCallable(&InspectorClient::RegisterCrossAccountAccessRole, request);
  }

  /**
   * An Async wrapper for RegisterCrossAccountAccessRole that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RegisterCrossAccountAccessRoleRequestT = Model::RegisterCrossAccountAccessRoleRequest>
  void RegisterCrossAccountAccessRoleAsync(const RegisterCrossAccountAccessRoleRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveAttributesFromFindingsOutcome RemoveAttributesFromFindings(
      const Model::RemoveAttributesFromFindingsRequest& request) const;

  /**
   * A Callable wrapper for RemoveAttributesFromFindings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RemoveAttributesFromFindingsRequestT = Model::RemoveAttributesFromFindingsRequest>
  Model::RemoveAttributesFromFindingsOutcomeCallable RemoveAttributesFromFindingsCallable(
      const RemoveAttributesFromFindingsRequestT& request) const {
    return SubmitCallable(&InspectorClient::RemoveAttributesFromFindings, request);
  }

  /**
   * An Async wrapper for RemoveAttributesFromFindings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveAttributesFromFindingsRequestT = Model::RemoveAttributesFromFindingsRequest>
  void RemoveAttributesFromFindingsAsync(const RemoveAttributesFromFindingsRequestT& request,
  ...
  /**
   * A Callable wrapper for SetTagsForResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetTagsForResource that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetTagsForResourceRequestT = Model::SetTagsForResourceRequest>
  void SetTagsForResourceAsync(const SetTagsForResourceRequestT& request, const SetTagsForResourceResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartAssessmentRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartAssessmentRun that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartAssessmentRunRequestT = Model::StartAssessmentRunRequest>
  void StartAssessmentRunAsync(const StartAssessmentRunRequestT& request, const StartAssessmentRunResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopAssessmentRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopAssessmentRun that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopAssessmentRunRequestT = Model::StopAssessmentRunRequest>
  void StopAssessmentRunAsync(const StopAssessmentRunRequestT& request, const StopAssessmentRunResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SubscribeToEvent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SubscribeToEvent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SubscribeToEventRequestT = Model::SubscribeToEventRequest>
  void SubscribeToEventAsync(const SubscribeToEventRequestT& request, const SubscribeToEventResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UnsubscribeFromEvent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UnsubscribeFromEvent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UnsubscribeFromEventRequestT = Model::UnsubscribeFromEventRequest>
  void UnsubscribeFromEventAsync(const UnsubscribeFromEventRequestT& request, const UnsubscribeFromEventResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAssessmentTarget that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAssessmentTarget that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAssessmentTargetRequestT = Model::UpdateAssessmentTargetRequest>
  void UpdateAssessmentTargetAsync(const UpdateAssessmentTargetRequestT& request,
