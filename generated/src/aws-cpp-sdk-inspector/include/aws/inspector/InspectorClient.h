...
namespace Inspector
{
   ...
   */
  class AWS_INSPECTOR_API InspectorClient : Aws::Client::ClientWithAsyncTemplateMethods<InspectorClient>,
    smithy::client::AwsSmithyClientT<Aws::Inspector::SERVICE_NAME,
