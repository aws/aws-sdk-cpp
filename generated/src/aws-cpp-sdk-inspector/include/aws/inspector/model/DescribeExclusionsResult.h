...
class DescribeExclusionsResult {
 public:
  ...
  template <typename ExclusionsT = Aws::Map<Aws::String, Exclusion>>
  DescribeExclusionsResult& WithExclusions(ExclusionsT&& value) {
  ...
  DescribeExclusionsResult& AddExclusions(ExclusionsKeyT&& key, ExclusionsValueT&& value) {
    m_exclusionsHasBeenSet = true;
    m_exclusions.emplace(std::forward<ExclusionsKeyT>(key), std::forward<ExclusionsValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FailedItemsT = Aws::Map<Aws::String, FailedItemDetails>>
  DescribeExclusionsResult& WithFailedItems(FailedItemsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeExclusionsResult& WithRequestId(RequestIdT&& value) {
