...
class AssessmentRunFilter {
 public:
  ...
  void SetNamePattern(NamePatternT&& value) {
    m_namePatternHasBeenSet = true;
    m_namePattern = std::forward<NamePatternT>(value);
  }
  template <typename NamePatternT = Aws::String>
  AssessmentRunFilter& WithNamePattern(NamePatternT&& value) {
    SetNamePattern(std::forward<NamePatternT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StatesT = Aws::Vector<AssessmentRunState>>
  AssessmentRunFilter& WithStates(StatesT&& value) {
    SetStates(std::forward<StatesT>(value));
    return *this;
  }
  inline AssessmentRunFilter& AddStates(AssessmentRunState value) {
    m_statesHasBeenSet = true;
  ...
  void SetDurationRange(DurationRangeT&& value) {
    m_durationRangeHasBeenSet = true;
    m_durationRange = std::forward<DurationRangeT>(value);
  }
  template <typename DurationRangeT = DurationRange>
  AssessmentRunFilter& WithDurationRange(DurationRangeT&& value) {
    SetDurationRange(std::forward<DurationRangeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RulesPackageArnsT = Aws::Vector<Aws::String>>
  AssessmentRunFilter& WithRulesPackageArns(RulesPackageArnsT&& value) {
    SetRulesPackageArns(std::forward<RulesPackageArnsT>(value));
    return *this;
  }
  template <typename RulesPackageArnsT = Aws::String>
  AssessmentRunFilter& AddRulesPackageArns(RulesPackageArnsT&& value) {
    m_rulesPackageArnsHasBeenSet = true;
  ...
  void SetStartTimeRange(StartTimeRangeT&& value) {
    ...
    m_startTimeRange = std::forward<StartTimeRangeT>(value);
  }
  template <typename StartTimeRangeT = TimestampRange>
  AssessmentRunFilter& WithStartTimeRange(StartTimeRangeT&& value) {
    SetStartTimeRange(std::forward<StartTimeRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCompletionTimeRange(CompletionTimeRangeT&& value) {
    m_completionTimeRangeHasBeenSet = true;
    m_completionTimeRange = std::forward<CompletionTimeRangeT>(value);
  }
  template <typename CompletionTimeRangeT = TimestampRange>
  AssessmentRunFilter& WithCompletionTimeRange(CompletionTimeRangeT&& value) {
    SetCompletionTimeRange(std::forward<CompletionTimeRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStateChangeTimeRange(StateChangeTimeRangeT&& value) {
    m_stateChangeTimeRangeHasBeenSet = true;
    m_stateChangeTimeRange = std::forward<StateChangeTimeRangeT>(value);
  }
  template <typename StateChangeTimeRangeT = TimestampRange>
  AssessmentRunFilter& WithStateChangeTimeRange(StateChangeTimeRangeT&& value) {
    SetStateChangeTimeRange(std::forward<StateChangeTimeRangeT>(value));
    return *this;
  }
  ///@}
 private:
