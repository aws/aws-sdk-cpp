...
class AccessDeniedException {
 public:
  ...
  inline void SetErrorCode(AccessDeniedErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline AccessDeniedException& WithErrorCode(AccessDeniedErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  inline AccessDeniedException& WithCanRetry(bool value) {
    SetCanRetry(value);
    return *this;
  }
  ///@}
