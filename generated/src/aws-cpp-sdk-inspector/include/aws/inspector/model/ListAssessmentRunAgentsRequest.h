...
class ListAssessmentRunAgentsRequest : public InspectorRequest {
 public:
  ...
  template <typename AssessmentRunArnT = Aws::String>
  ListAssessmentRunAgentsRequest& WithAssessmentRunArn(AssessmentRunArnT&& value) {
  ...
  template <typename FilterT = AgentFilter>
  ListAssessmentRunAgentsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAssessmentRunAgentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssessmentRunAgentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
