...
class DurationRange {
 public:
  ...
  inline void SetMinSeconds(int value) {
    m_minSecondsHasBeenSet = true;
    m_minSeconds = value;
  }
  inline DurationRange& WithMinSeconds(int value) {
    SetMinSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxSeconds(int value) {
    m_maxSecondsHasBeenSet = true;
    m_maxSeconds = value;
  }
  inline DurationRange& WithMaxSeconds(int value) {
    SetMaxSeconds(value);
    return *this;
  }
  ///@}
