...
/**
 */
class ListEventSubscriptionsRequest : public InspectorRequest {
 public:
  AWS_INSPECTOR_API ListEventSubscriptionsRequest() = default;
  ...
  template <typename ResourceArnT = Aws::String>
  ListEventSubscriptionsRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListEventSubscriptionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEventSubscriptionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
