...
class InspectorServiceAttributes {
 public:
  ...
  inline void SetSchemaVersion(int value) {
    m_schemaVersionHasBeenSet = true;
    m_schemaVersion = value;
  }
  inline InspectorServiceAttributes& WithSchemaVersion(int value) {
  ...
  void SetRulesPackageArn(RulesPackageArnT&& value) {
    ...
    m_rulesPackageArn = std::forward<RulesPackageArnT>(value);
  }
  template <typename RulesPackageArnT = Aws::String>
  InspectorServiceAttributes& WithRulesPackageArn(RulesPackageArnT&& value) {
    SetRulesPackageArn(std::forward<RulesPackageArnT>(value));
    return *this;
  }
  ///@}
 private:
