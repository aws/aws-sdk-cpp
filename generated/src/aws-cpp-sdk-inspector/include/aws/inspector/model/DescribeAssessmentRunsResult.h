...
class DescribeAssessmentRunsResult {
 public:
  ...
  void SetAssessmentRuns(AssessmentRunsT&& value) {
    m_assessmentRunsHasBeenSet = true;
    m_assessmentRuns = std::forward<AssessmentRunsT>(value);
  }
  template <typename AssessmentRunsT = Aws::Vector<AssessmentRun>>
  DescribeAssessmentRunsResult& WithAssessmentRuns(AssessmentRunsT&& value) {
    SetAssessmentRuns(std::forward<AssessmentRunsT>(value));
    return *this;
  }
  template <typename AssessmentRunsT = AssessmentRun>
  DescribeAssessmentRunsResult& AddAssessmentRuns(AssessmentRunsT&& value) {
    m_assessmentRunsHasBeenSet = true;
    m_assessmentRuns.emplace_back(std::forward<AssessmentRunsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FailedItemsT = Aws::Map<Aws::String, FailedItemDetails>>
  DescribeAssessmentRunsResult& WithFailedItems(FailedItemsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAssessmentRunsResult& WithRequestId(RequestIdT&& value) {
