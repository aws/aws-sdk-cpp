...
class DescribeCrossAccountAccessRoleResult {
 public:
  ...
  template <typename RoleArnT = Aws::String>
  DescribeCrossAccountAccessRoleResult& WithRoleArn(RoleArnT&& value) {
  ...
  inline DescribeCrossAccountAccessRoleResult& WithValid(bool value) {
    SetValid(value);
    return *this;
  }
  ///@}
  ...
  template <typename RegisteredAtT = Aws::Utils::DateTime>
  DescribeCrossAccountAccessRoleResult& WithRegisteredAt(RegisteredAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCrossAccountAccessRoleResult& WithRequestId(RequestIdT&& value) {
