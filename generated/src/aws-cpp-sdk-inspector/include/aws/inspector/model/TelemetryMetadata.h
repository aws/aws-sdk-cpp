...
class TelemetryMetadata {
 public:
  ...
  void SetMessageType(MessageTypeT&& value) {
    m_messageTypeHasBeenSet = true;
    m_messageType = std::forward<MessageTypeT>(value);
  }
  template <typename MessageTypeT = Aws::String>
  TelemetryMetadata& WithMessageType(MessageTypeT&& value) {
    SetMessageType(std::forward<MessageTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline TelemetryMetadata& WithCount(long long value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDataSize(long long value) {
    m_dataSizeHasBeenSet = true;
    m_dataSize = value;
  }
  inline TelemetryMetadata& WithDataSize(long long value) {
    SetDataSize(value);
    return *this;
  }
  ///@}
