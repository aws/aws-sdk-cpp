...
class PreviewAgentsResult {
 public:
  ...
  void SetAgentPreviews(AgentPreviewsT&& value) {
    m_agentPreviewsHasBeenSet = true;
    m_agentPreviews = std::forward<AgentPreviewsT>(value);
  }
  template <typename AgentPreviewsT = Aws::Vector<AgentPreview>>
  PreviewAgentsResult& WithAgentPreviews(AgentPreviewsT&& value) {
    SetAgentPreviews(std::forward<AgentPreviewsT>(value));
    return *this;
  }
  template <typename AgentPreviewsT = AgentPreview>
  PreviewAgentsResult& AddAgentPreviews(AgentPreviewsT&& value) {
    m_agentPreviewsHasBeenSet = true;
    m_agentPreviews.emplace_back(std::forward<AgentPreviewsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  PreviewAgentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PreviewAgentsResult& WithRequestId(RequestIdT&& value) {
