...
class ListAssessmentTemplatesRequest : public InspectorRequest {
 public:
  ...
  template <typename AssessmentTargetArnsT = Aws::Vector<Aws::String>>
  ListAssessmentTemplatesRequest& WithAssessmentTargetArns(AssessmentTargetArnsT&& value) {
    SetAssessmentTargetArns(std::forward<AssessmentTargetArnsT>(value));
    return *this;
  }
  template <typename AssessmentTargetArnsT = Aws::String>
  ListAssessmentTemplatesRequest& AddAssessmentTargetArns(AssessmentTargetArnsT&& value) {
    m_assessmentTargetArnsHasBeenSet = true;
  ...
  template <typename FilterT = AssessmentTemplateFilter>
  ListAssessmentTemplatesRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAssessmentTemplatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssessmentTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
