...
class GetTelemetryMetadataResult {
 public:
  ...
  template <typename TelemetryMetadataT = Aws::Vector<TelemetryMetadata>>
  GetTelemetryMetadataResult& WithTelemetryMetadata(TelemetryMetadataT&& value) {
    SetTelemetryMetadata(std::forward<TelemetryMetadataT>(value));
    return *this;
  }
  template <typename TelemetryMetadataT = TelemetryMetadata>
  GetTelemetryMetadataResult& AddTelemetryMetadata(TelemetryMetadataT&& value) {
    m_telemetryMetadataHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetTelemetryMetadataResult& WithRequestId(RequestIdT&& value) {
