...
class InvalidCrossAccountRoleException {
 public:
  ...
  template <typename MessageT = Aws::String>
  InvalidCrossAccountRoleException& WithMessage(MessageT&& value) {
  ...
  inline void SetErrorCode(InvalidCrossAccountRoleErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline InvalidCrossAccountRoleException& WithErrorCode(InvalidCrossAccountRoleErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  inline InvalidCrossAccountRoleException& WithCanRetry(bool value) {
    SetCanRetry(value);
    return *this;
  }
  ///@}
