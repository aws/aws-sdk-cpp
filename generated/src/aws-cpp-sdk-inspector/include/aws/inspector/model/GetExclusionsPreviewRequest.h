...
class GetExclusionsPreviewRequest : public InspectorRequest {
 public:
  ...
  void SetPreviewToken(PreviewTokenT&& value) {
    ...
    m_previewToken = std::forward<PreviewTokenT>(value);
  }
  template <typename PreviewTokenT = Aws::String>
  GetExclusionsPreviewRequest& WithPreviewToken(PreviewTokenT&& value) {
    SetPreviewToken(std::forward<PreviewTokenT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetExclusionsPreviewRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline GetExclusionsPreviewRequest& WithLocale(Locale value) {
    SetLocale(value);
    return *this;
  }
  ///@}
