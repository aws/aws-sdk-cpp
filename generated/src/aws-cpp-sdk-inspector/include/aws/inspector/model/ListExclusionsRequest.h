...
class ListExclusionsRequest : public InspectorRequest {
 public:
  ...
  template <typename AssessmentRunArnT = Aws::String>
  ListExclusionsRequest& WithAssessmentRunArn(AssessmentRunArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListExclusionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListExclusionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
