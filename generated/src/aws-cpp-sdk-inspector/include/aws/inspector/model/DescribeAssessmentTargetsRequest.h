...
class DescribeAssessmentTargetsRequest : public InspectorRequest {
 public:
  ...
  template <typename AssessmentTargetArnsT = Aws::Vector<Aws::String>>
  DescribeAssessmentTargetsRequest& WithAssessmentTargetArns(AssessmentTargetArnsT&& value) {
    SetAssessmentTargetArns(std::forward<AssessmentTargetArnsT>(value));
    return *this;
  }
  template <typename AssessmentTargetArnsT = Aws::String>
  DescribeAssessmentTargetsRequest& AddAssessmentTargetArns(AssessmentTargetArnsT&& value) {
    m_assessmentTargetArnsHasBeenSet = true;
