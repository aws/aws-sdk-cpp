...
class AssessmentRunInProgressException {
 public:
  ...
  template <typename MessageT = Aws::String>
  AssessmentRunInProgressException& WithMessage(MessageT&& value) {
  ...
  template <typename AssessmentRunArnsT = Aws::Vector<Aws::String>>
  AssessmentRunInProgressException& WithAssessmentRunArns(AssessmentRunArnsT&& value) {
    SetAssessmentRunArns(std::forward<AssessmentRunArnsT>(value));
    return *this;
  }
  template <typename AssessmentRunArnsT = Aws::String>
  AssessmentRunInProgressException& AddAssessmentRunArns(AssessmentRunArnsT&& value) {
    m_assessmentRunArnsHasBeenSet = true;
  ...
  inline void SetAssessmentRunArnsTruncated(bool value) {
    m_assessmentRunArnsTruncatedHasBeenSet = true;
    m_assessmentRunArnsTruncated = value;
  }
  inline AssessmentRunInProgressException& WithAssessmentRunArnsTruncated(bool value) {
    SetAssessmentRunArnsTruncated(value);
    return *this;
  }
  ///@}
  ...
  inline AssessmentRunInProgressException& WithCanRetry(bool value) {
    SetCanRetry(value);
    return *this;
  }
  ///@}
