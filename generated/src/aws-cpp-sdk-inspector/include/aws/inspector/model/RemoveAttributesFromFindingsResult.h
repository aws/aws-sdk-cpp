...
namespace Model
{
  ...
  {
  public:
    AWS_INSPECTOR_API RemoveAttributesFromFindingsResult() = default;
    ...
    template<typename FailedItemsT = Aws::Map<Aws::String, FailedItemDetails>>
    RemoveAttributesFromFindingsResult& WithFailedItems(FailedItemsT&& value) { SetFailedItems(std::forward<FailedItemsT>(value)); return *this;}
    template<typename FailedItemsKeyT = Aws::String, typename FailedItemsValueT = FailedItemDetails>
    RemoveAttributesFromFindingsResult& AddFailedItems(FailedItemsKeyT&& key, FailedItemsValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    RemoveAttributesFromFindingsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
