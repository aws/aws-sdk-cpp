...
class DescribeAssessmentTemplatesRequest : public InspectorRequest {
 public:
  ...
  template <typename AssessmentTemplateArnsT = Aws::Vector<Aws::String>>
  DescribeAssessmentTemplatesRequest& WithAssessmentTemplateArns(AssessmentTemplateArnsT&& value) {
    SetAssessmentTemplateArns(std::forward<AssessmentTemplateArnsT>(value));
    return *this;
  }
  template <typename AssessmentTemplateArnsT = Aws::String>
  DescribeAssessmentTemplatesRequest& AddAssessmentTemplateArns(AssessmentTemplateArnsT&& value) {
    m_assessmentTemplateArnsHasBeenSet = true;
