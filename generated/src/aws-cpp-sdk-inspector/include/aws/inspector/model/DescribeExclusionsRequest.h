...
class DescribeExclusionsRequest : public InspectorRequest {
 public:
  ...
  template <typename ExclusionArnsT = Aws::Vector<Aws::String>>
  DescribeExclusionsRequest& WithExclusionArns(ExclusionArnsT&& value) {
    SetExclusionArns(std::forward<ExclusionArnsT>(value));
    return *this;
  }
  template <typename ExclusionArnsT = Aws::String>
  DescribeExclusionsRequest& AddExclusionArns(ExclusionArnsT&& value) {
    m_exclusionArnsHasBeenSet = true;
  ...
  inline DescribeExclusionsRequest& WithLocale(Locale value) {
    SetLocale(value);
    return *this;
  }
  ///@}
