...
namespace Model
{
  ...
  public:
    ...
    template<typename MessageT = Aws::String>
    NoSuchEntityException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    inline void SetErrorCode(NoSuchEntityErrorCode value) { m_errorCodeHasBeenSet = true; m_errorCode = value; }
    inline NoSuchEntityException& WithErrorCode(NoSuchEntityErrorCode value) { SetErrorCode(value); return *this;}
    ///@}
