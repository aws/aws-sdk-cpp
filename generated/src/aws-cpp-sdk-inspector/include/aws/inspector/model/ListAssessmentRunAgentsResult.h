...
class ListAssessmentRunAgentsResult {
 public:
  ...
  void SetAssessmentRunAgents(AssessmentRunAgentsT&& value) {
    m_assessmentRunAgentsHasBeenSet = true;
    m_assessmentRunAgents = std::forward<AssessmentRunAgentsT>(value);
  }
  template <typename AssessmentRunAgentsT = Aws::Vector<AssessmentRunAgent>>
  ListAssessmentRunAgentsResult& WithAssessmentRunAgents(AssessmentRunAgentsT&& value) {
    SetAssessmentRunAgents(std::forward<AssessmentRunAgentsT>(value));
    return *this;
  }
  template <typename AssessmentRunAgentsT = AssessmentRunAgent>
  ListAssessmentRunAgentsResult& AddAssessmentRunAgents(AssessmentRunAgentsT&& value) {
    m_assessmentRunAgentsHasBeenSet = true;
    m_assessmentRunAgents.emplace_back(std::forward<AssessmentRunAgentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssessmentRunAgentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssessmentRunAgentsResult& WithRequestId(RequestIdT&& value) {
