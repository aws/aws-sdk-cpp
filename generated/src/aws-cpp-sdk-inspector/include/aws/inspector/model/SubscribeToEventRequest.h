...
namespace Model
{
  ...
  /**
   */
  class SubscribeToEventRequest : public InspectorRequest
  {
  public:
    ...
    template<typename ResourceArnT = Aws::String>
    SubscribeToEventRequest& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
    ...
    inline SubscribeToEventRequest& WithEvent(InspectorEvent value) { SetEvent(value); return *this;}
    ///@}
    ...
    template<typename TopicArnT = Aws::String>
    SubscribeToEventRequest& WithTopicArn(TopicArnT&& value) { SetTopicArn(std::forward<TopicArnT>(value)); return *this;}
    ///@}
  private:
