...
class Finding {
 public:
  ...
  inline Finding& WithSchemaVersion(int value) {
  ...
  inline Finding& WithAssetType(AssetType value) {
    SetAssetType(value);
    return *this;
  }
  ///@}
  ...
  void SetAssetAttributes(AssetAttributesT&& value) {
    ...
    m_assetAttributes = std::forward<AssetAttributesT>(value);
  }
  template <typename AssetAttributesT = AssetAttributes>
  Finding& WithAssetAttributes(AssetAttributesT&& value) {
    SetAssetAttributes(std::forward<AssetAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumericSeverity(double value) {
    m_numericSeverityHasBeenSet = true;
    m_numericSeverity = value;
  }
  inline Finding& WithNumericSeverity(double value) {
    SetNumericSeverity(value);
    return *this;
  }
  ///@}
  ...
  inline Finding& WithConfidence(int value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIndicatorOfCompromise(bool value) {
    m_indicatorOfCompromiseHasBeenSet = true;
    m_indicatorOfCompromise = value;
  }
  inline Finding& WithIndicatorOfCompromise(bool value) {
    SetIndicatorOfCompromise(value);
    return *this;
  }
  ///@}
