...
class DescribeAssessmentTemplatesResult {
 public:
  ...
  void SetAssessmentTemplates(AssessmentTemplatesT&& value) {
    m_assessmentTemplatesHasBeenSet = true;
    m_assessmentTemplates = std::forward<AssessmentTemplatesT>(value);
  }
  template <typename AssessmentTemplatesT = Aws::Vector<AssessmentTemplate>>
  DescribeAssessmentTemplatesResult& WithAssessmentTemplates(AssessmentTemplatesT&& value) {
    SetAssessmentTemplates(std::forward<AssessmentTemplatesT>(value));
    return *this;
  }
  template <typename AssessmentTemplatesT = AssessmentTemplate>
  DescribeAssessmentTemplatesResult& AddAssessmentTemplates(AssessmentTemplatesT&& value) {
    m_assessmentTemplatesHasBeenSet = true;
    m_assessmentTemplates.emplace_back(std::forward<AssessmentTemplatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FailedItemsT = Aws::Map<Aws::String, FailedItemDetails>>
  DescribeAssessmentTemplatesResult& WithFailedItems(FailedItemsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAssessmentTemplatesResult& WithRequestId(RequestIdT&& value) {
