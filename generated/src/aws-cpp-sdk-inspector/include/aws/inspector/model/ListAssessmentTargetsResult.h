...
class ListAssessmentTargetsResult {
 public:
  ...
  void SetAssessmentTargetArns(AssessmentTargetArnsT&& value) {
    m_assessmentTargetArnsHasBeenSet = true;
    m_assessmentTargetArns = std::forward<AssessmentTargetArnsT>(value);
  }
  template <typename AssessmentTargetArnsT = Aws::Vector<Aws::String>>
  ListAssessmentTargetsResult& WithAssessmentTargetArns(AssessmentTargetArnsT&& value) {
    SetAssessmentTargetArns(std::forward<AssessmentTargetArnsT>(value));
    return *this;
  }
  template <typename AssessmentTargetArnsT = Aws::String>
  ListAssessmentTargetsResult& AddAssessmentTargetArns(AssessmentTargetArnsT&& value) {
    m_assessmentTargetArnsHasBeenSet = true;
    m_assessmentTargetArns.emplace_back(std::forward<AssessmentTargetArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssessmentTargetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssessmentTargetsResult& WithRequestId(RequestIdT&& value) {
