...
class PreviewAgentsRequest : public InspectorRequest {
 public:
  ...
  void SetPreviewAgentsArn(PreviewAgentsArnT&& value) {
    m_previewAgentsArnHasBeenSet = true;
    m_previewAgentsArn = std::forward<PreviewAgentsArnT>(value);
  }
  template <typename PreviewAgentsArnT = Aws::String>
  PreviewAgentsRequest& WithPreviewAgentsArn(PreviewAgentsArnT&& value) {
    SetPreviewAgentsArn(std::forward<PreviewAgentsArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  PreviewAgentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline PreviewAgentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
