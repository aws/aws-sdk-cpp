...
class SetTagsForResourceRequest : public InspectorRequest {
 public:
  AWS_INSPECTOR_API SetTagsForResourceRequest() = default;
  ...
  template <typename ResourceArnT = Aws::String>
  SetTagsForResourceRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  SetTagsForResourceRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  SetTagsForResourceRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
