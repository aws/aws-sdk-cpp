...
class GetAssessmentReportResult {
 public:
  ...
  inline GetAssessmentReportResult& WithStatus(ReportStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename UrlT = Aws::String>
  GetAssessmentReportResult& WithUrl(UrlT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAssessmentReportResult& WithRequestId(RequestIdT&& value) {
