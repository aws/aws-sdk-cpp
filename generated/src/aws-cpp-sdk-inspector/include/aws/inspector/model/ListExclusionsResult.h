...
class ListExclusionsResult {
 public:
  ...
  void SetExclusionArns(ExclusionArnsT&& value) {
    m_exclusionArnsHasBeenSet = true;
    m_exclusionArns = std::forward<ExclusionArnsT>(value);
  }
  template <typename ExclusionArnsT = Aws::Vector<Aws::String>>
  ListExclusionsResult& WithExclusionArns(ExclusionArnsT&& value) {
    SetExclusionArns(std::forward<ExclusionArnsT>(value));
    return *this;
  }
  template <typename ExclusionArnsT = Aws::String>
  ListExclusionsResult& AddExclusionArns(ExclusionArnsT&& value) {
    m_exclusionArnsHasBeenSet = true;
    m_exclusionArns.emplace_back(std::forward<ExclusionArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListExclusionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListExclusionsResult& WithRequestId(RequestIdT&& value) {
