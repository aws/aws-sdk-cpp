...
class DescribeAssessmentTargetsResult {
 public:
  ...
  template <typename AssessmentTargetsT = Aws::Vector<AssessmentTarget>>
  DescribeAssessmentTargetsResult& WithAssessmentTargets(AssessmentTargetsT&& value) {
    SetAssessmentTargets(std::forward<AssessmentTargetsT>(value));
    return *this;
  }
  template <typename AssessmentTargetsT = AssessmentTarget>
  DescribeAssessmentTargetsResult& AddAssessmentTargets(AssessmentTargetsT&& value) {
    m_assessmentTargetsHasBeenSet = true;
  ...
  template <typename FailedItemsT = Aws::Map<Aws::String, FailedItemDetails>>
  DescribeAssessmentTargetsResult& WithFailedItems(FailedItemsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAssessmentTargetsResult& WithRequestId(RequestIdT&& value) {
