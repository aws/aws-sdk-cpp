...
class DescribeFindingsResult {
 public:
  ...
  template <typename FindingsT = Aws::Vector<Finding>>
  DescribeFindingsResult& WithFindings(FindingsT&& value) {
    SetFindings(std::forward<FindingsT>(value));
    return *this;
  }
  template <typename FindingsT = Finding>
  DescribeFindingsResult& AddFindings(FindingsT&& value) {
    m_findingsHasBeenSet = true;
  ...
  template <typename FailedItemsT = Aws::Map<Aws::String, FailedItemDetails>>
  DescribeFindingsResult& WithFailedItems(FailedItemsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeFindingsResult& WithRequestId(RequestIdT&& value) {
