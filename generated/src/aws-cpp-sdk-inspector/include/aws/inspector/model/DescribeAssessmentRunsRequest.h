...
class DescribeAssessmentRunsRequest : public InspectorRequest {
 public:
  ...
  void SetAssessmentRunArns(AssessmentRunArnsT&& value) {
    m_assessmentRunArnsHasBeenSet = true;
    m_assessmentRunArns = std::forward<AssessmentRunArnsT>(value);
  }
  template <typename AssessmentRunArnsT = Aws::Vector<Aws::String>>
  DescribeAssessmentRunsRequest& WithAssessmentRunArns(AssessmentRunArnsT&& value) {
    SetAssessmentRunArns(std::forward<AssessmentRunArnsT>(value));
    return *this;
  }
  template <typename AssessmentRunArnsT = Aws::String>
  DescribeAssessmentRunsRequest& AddAssessmentRunArns(AssessmentRunArnsT&& value) {
    m_assessmentRunArnsHasBeenSet = true;
    m_assessmentRunArns.emplace_back(std::forward<AssessmentRunArnsT>(value));
    return *this;
  }
  ///@}
 private:
