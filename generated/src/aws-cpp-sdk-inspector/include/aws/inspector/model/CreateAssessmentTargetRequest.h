...
class CreateAssessmentTargetRequest : public InspectorRequest {
 public:
  ...
  template <typename AssessmentTargetNameT = Aws::String>
  CreateAssessmentTargetRequest& WithAssessmentTargetName(AssessmentTargetNameT&& value) {
  ...
  template <typename ResourceGroupArnT = Aws::String>
  CreateAssessmentTargetRequest& WithResourceGroupArn(ResourceGroupArnT&& value) {
