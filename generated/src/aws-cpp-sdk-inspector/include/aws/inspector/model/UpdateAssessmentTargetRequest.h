...
class UpdateAssessmentTargetRequest : public InspectorRequest {
 public:
  ...
  template <typename AssessmentTargetArnT = Aws::String>
  UpdateAssessmentTargetRequest& WithAssessmentTargetArn(AssessmentTargetArnT&& value) {
  ...
  void SetAssessmentTargetName(AssessmentTargetNameT&& value) {
    m_assessmentTargetNameHasBeenSet = true;
    m_assessmentTargetName = std::forward<AssessmentTargetNameT>(value);
  }
  template <typename AssessmentTargetNameT = Aws::String>
  UpdateAssessmentTargetRequest& WithAssessmentTargetName(AssessmentTargetNameT&& value) {
    SetAssessmentTargetName(std::forward<AssessmentTargetNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceGroupArnT = Aws::String>
  UpdateAssessmentTargetRequest& WithResourceGroupArn(ResourceGroupArnT&& value) {
