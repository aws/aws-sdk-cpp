...
/**
 */
class ListRulesPackagesRequest : public InspectorRequest {
 public:
  AWS_INSPECTOR_API ListRulesPackagesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListRulesPackagesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRulesPackagesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
