...
class ListAssessmentRunsRequest : public InspectorRequest {
 public:
  ...
  template <typename AssessmentTemplateArnsT = Aws::Vector<Aws::String>>
  ListAssessmentRunsRequest& WithAssessmentTemplateArns(AssessmentTemplateArnsT&& value) {
    SetAssessmentTemplateArns(std::forward<AssessmentTemplateArnsT>(value));
    return *this;
  }
  template <typename AssessmentTemplateArnsT = Aws::String>
  ListAssessmentRunsRequest& AddAssessmentTemplateArns(AssessmentTemplateArnsT&& value) {
    m_assessmentTemplateArnsHasBeenSet = true;
  ...
  template <typename FilterT = AssessmentRunFilter>
  ListAssessmentRunsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAssessmentRunsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssessmentRunsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
