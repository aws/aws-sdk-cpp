...
class GetExclusionsPreviewResult {
 public:
  ...
  inline GetExclusionsPreviewResult& WithPreviewStatus(PreviewStatus value) {
  ...
  void SetExclusionPreviews(ExclusionPreviewsT&& value) {
    m_exclusionPreviewsHasBeenSet = true;
    m_exclusionPreviews = std::forward<ExclusionPreviewsT>(value);
  }
  template <typename ExclusionPreviewsT = Aws::Vector<ExclusionPreview>>
  GetExclusionsPreviewResult& WithExclusionPreviews(ExclusionPreviewsT&& value) {
    SetExclusionPreviews(std::forward<ExclusionPreviewsT>(value));
    return *this;
  }
  template <typename ExclusionPreviewsT = ExclusionPreview>
  GetExclusionsPreviewResult& AddExclusionPreviews(ExclusionPreviewsT&& value) {
    m_exclusionPreviewsHasBeenSet = true;
    m_exclusionPreviews.emplace_back(std::forward<ExclusionPreviewsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetExclusionsPreviewResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetExclusionsPreviewResult& WithRequestId(RequestIdT&& value) {
