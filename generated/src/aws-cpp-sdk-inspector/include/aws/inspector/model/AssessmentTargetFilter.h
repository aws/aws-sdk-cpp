...
class AssessmentTargetFilter {
 public:
  ...
  void SetAssessmentTargetNamePattern(AssessmentTargetNamePatternT&& value) {
    m_assessmentTargetNamePatternHasBeenSet = true;
    m_assessmentTargetNamePattern = std::forward<AssessmentTargetNamePatternT>(value);
  }
  template <typename AssessmentTargetNamePatternT = Aws::String>
  AssessmentTargetFilter& WithAssessmentTargetNamePattern(AssessmentTargetNamePatternT&& value) {
    SetAssessmentTargetNamePattern(std::forward<AssessmentTargetNamePatternT>(value));
    return *this;
  }
  ///@}
 private:
