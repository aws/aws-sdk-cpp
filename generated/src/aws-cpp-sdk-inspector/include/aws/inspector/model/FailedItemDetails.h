...
class FailedItemDetails {
 public:
  ...
  inline void SetFailureCode(FailedItemErrorCode value) {
    m_failureCodeHasBeenSet = true;
    m_failureCode = value;
  }
  inline FailedItemDetails& WithFailureCode(FailedItemErrorCode value) {
  ...
  inline void SetRetryable(bool value) {
    m_retryableHasBeenSet = true;
    m_retryable = value;
  }
  inline FailedItemDetails& WithRetryable(bool value) {
    SetRetryable(value);
    return *this;
  }
  ///@}
