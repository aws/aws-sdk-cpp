...
class ListAssessmentTargetsRequest : public InspectorRequest {
 public:
  ...
  template <typename FilterT = AssessmentTargetFilter>
  ListAssessmentTargetsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAssessmentTargetsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssessmentTargetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
