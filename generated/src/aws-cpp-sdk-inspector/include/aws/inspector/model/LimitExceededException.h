...
class LimitExceededException {
 public:
  ...
  inline void SetErrorCode(LimitExceededErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline LimitExceededException& WithErrorCode(LimitExceededErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  inline LimitExceededException& WithCanRetry(bool value) {
    SetCanRetry(value);
    return *this;
  }
  ///@}
