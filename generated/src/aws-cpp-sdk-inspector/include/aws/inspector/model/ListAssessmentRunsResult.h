...
class ListAssessmentRunsResult {
 public:
  ...
  template <typename AssessmentRunArnsT = Aws::Vector<Aws::String>>
  ListAssessmentRunsResult& WithAssessmentRunArns(AssessmentRunArnsT&& value) {
    SetAssessmentRunArns(std::forward<AssessmentRunArnsT>(value));
    return *this;
  }
  template <typename AssessmentRunArnsT = Aws::String>
  ListAssessmentRunsResult& AddAssessmentRunArns(AssessmentRunArnsT&& value) {
    m_assessmentRunArnsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAssessmentRunsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssessmentRunsResult& WithRequestId(RequestIdT&& value) {
