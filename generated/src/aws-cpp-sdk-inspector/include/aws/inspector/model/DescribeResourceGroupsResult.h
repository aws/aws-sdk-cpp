...
class DescribeResourceGroupsResult {
 public:
  ...
  void SetResourceGroups(ResourceGroupsT&& value) {
    m_resourceGroupsHasBeenSet = true;
    m_resourceGroups = std::forward<ResourceGroupsT>(value);
  }
  template <typename ResourceGroupsT = Aws::Vector<ResourceGroup>>
  DescribeResourceGroupsResult& WithResourceGroups(ResourceGroupsT&& value) {
    SetResourceGroups(std::forward<ResourceGroupsT>(value));
    return *this;
  }
  template <typename ResourceGroupsT = ResourceGroup>
  DescribeResourceGroupsResult& AddResourceGroups(ResourceGroupsT&& value) {
    m_resourceGroupsHasBeenSet = true;
    m_resourceGroups.emplace_back(std::forward<ResourceGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FailedItemsT = Aws::Map<Aws::String, FailedItemDetails>>
  DescribeResourceGroupsResult& WithFailedItems(FailedItemsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeResourceGroupsResult& WithRequestId(RequestIdT&& value) {
