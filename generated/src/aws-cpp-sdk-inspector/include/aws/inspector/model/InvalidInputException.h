...
class InvalidInputException {
 public:
  ...
  inline void SetErrorCode(InvalidInputErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline InvalidInputException& WithErrorCode(InvalidInputErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  inline InvalidInputException& WithCanRetry(bool value) {
    SetCanRetry(value);
    return *this;
  }
  ///@}
