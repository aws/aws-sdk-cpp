...
class GetAssessmentReportRequest : public InspectorRequest {
 public:
  ...
  inline void SetReportFileFormat(ReportFileFormat value) {
    m_reportFileFormatHasBeenSet = true;
    m_reportFileFormat = value;
  }
  inline GetAssessmentReportRequest& WithReportFileFormat(ReportFileFormat value) {
    SetReportFileFormat(value);
    return *this;
  }
  ///@}
  ...
  inline GetAssessmentReportRequest& WithReportType(ReportType value) {
    SetReportType(value);
    return *this;
  }
  ///@}
