...
class ListRulesPackagesResult {
 public:
  ...
  template <typename RulesPackageArnsT = Aws::Vector<Aws::String>>
  ListRulesPackagesResult& WithRulesPackageArns(RulesPackageArnsT&& value) {
    SetRulesPackageArns(std::forward<RulesPackageArnsT>(value));
    return *this;
  }
  template <typename RulesPackageArnsT = Aws::String>
  ListRulesPackagesResult& AddRulesPackageArns(RulesPackageArnsT&& value) {
    m_rulesPackageArnsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRulesPackagesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRulesPackagesResult& WithRequestId(RequestIdT&& value) {
