...
namespace Model
{
  ...
  {
  public:
    AWS_INSPECTOR_API ResourceGroupTag() = default;
    ...
    template<typename KeyT = Aws::String>
    ResourceGroupTag& WithKey(KeyT&& value) { SetKey(std::forward<KeyT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    ResourceGroupTag& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
