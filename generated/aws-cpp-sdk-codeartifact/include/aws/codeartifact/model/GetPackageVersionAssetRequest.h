...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API GetPackageVersionAssetRequest : public CodeArtifactRequest
  {
  public:
     ...
     * asset file. The valid values are: </p> <ul> <li> <p> <code>npm</code> </p> </li>
  ...
  private:
    ...
    bool m_packageVersionRevisionHasBeenSet;
  };
