...
namespace Model
{
  ...
  /**
   * <p> The operation did not succeed because the resource requested is not found in
   * the service. </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/codeartifact-2018-09-22/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class AWS_CODEARTIFACT_API ResourceNotFoundException
  {
  public:
