...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEARTIFACT_API DescribePackageVersionRequest : public CodeArtifactRequest
  {
  public:
    ...
    /**
     * <p> A format that specifies the type of the requested package version. The valid
     * values are: </p> <ul> <li> <p> <code>npm</code> </p> </li> <li> <p>
