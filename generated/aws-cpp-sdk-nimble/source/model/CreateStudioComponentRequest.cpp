...
Aws::String CreateStudioComponentRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection CreateStudioComponentRequest::GetRequestSpecificHeaders() const
{
