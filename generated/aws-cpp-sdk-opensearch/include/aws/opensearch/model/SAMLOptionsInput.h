...
namespace Model
{
  ...
  /**
   * <p>The SAML application configuration for the domain.</p><p><h3>See Also:</h3>  
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/opensearch-2021-01-01/SAMLOptionsInput">AWS
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API SAMLOptionsInput
  {
  public:
    SAMLOptionsInput();
    ...
    /**
     * <p>The SAML master username, which is stored in the Amazon OpenSearch Service
