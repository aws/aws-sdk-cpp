...
namespace Model
{
  ...
  /**
   * <p> Container for the request parameters to the <code> <a>DescribePackage</a>
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVICE_API DescribePackagesRequest : public OpenSearchServiceRequest
  {
  public:
