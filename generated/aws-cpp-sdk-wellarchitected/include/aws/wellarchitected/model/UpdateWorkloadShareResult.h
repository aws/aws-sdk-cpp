...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API UpdateWorkloadShareResult
  {
  public:
    UpdateWorkloadShareResult();
    UpdateWorkloadShareResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateWorkloadShareResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
