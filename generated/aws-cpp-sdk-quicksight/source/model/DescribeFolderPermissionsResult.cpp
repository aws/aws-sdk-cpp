...
DescribeFolderPermissionsResult::DescribeFolderPermissionsResult() : 
    m_status(0)
{
}
...
DescribeFolderPermissionsResult& DescribeFolderPermissionsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
