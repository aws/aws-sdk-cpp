...
DisassociateS3ResourcesResult::DisassociateS3ResourcesResult()
{
}

DisassociateS3ResourcesResult::DisassociateS3ResourcesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
