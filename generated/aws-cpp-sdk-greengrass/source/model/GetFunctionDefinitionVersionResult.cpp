...
GetFunctionDefinitionVersionResult::GetFunctionDefinitionVersionResult()
{
}

GetFunctionDefinitionVersionResult::GetFunctionDefinitionVersionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
