...
DescribeImportTasksResult::DescribeImportTasksResult()
{
}

DescribeImportTasksResult::DescribeImportTasksResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
