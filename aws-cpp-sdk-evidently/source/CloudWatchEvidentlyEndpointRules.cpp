...
Aws::String CloudWatchEvidentlyEndpointRules::GetRulesAsString()
{
    return Aws::String(CloudWatchEvidentlyEndpointRules::Rules.begin(), CloudWatchEvidentlyEndpointRules::Rules.end());
}

const Aws::Vector<char> CloudWatchEvidentlyEndpointRules::Rules = {
