...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDWATCHEVIDENTLY_API EvaluationRule
  {
  public:
    EvaluationRule();
    EvaluationRule(Aws::Utils::Json::JsonView jsonValue);
    EvaluationRule& operator=(Aws::Utils::Json::JsonView jsonValue);
