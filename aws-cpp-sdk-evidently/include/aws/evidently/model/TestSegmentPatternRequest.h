...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVIDENTLY_API TestSegmentPatternRequest : public CloudWatchEvidentlyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<TestSegmentPatternRequest> Clone() const
    {
      return Aws::MakeUnique<TestSegmentPatternRequest>(GetServiceRequestName(), *this);
    }
