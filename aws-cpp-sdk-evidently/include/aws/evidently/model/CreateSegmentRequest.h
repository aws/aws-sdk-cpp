...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVIDENTLY_API CreateSegmentRequest : public CloudWatchEvidentlyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSegmentRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSegmentRequest>(GetServiceRequestName(), *this);
    }
