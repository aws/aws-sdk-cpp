...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVIDENTLY_API PutProjectEventsRequest : public CloudWatchEvidentlyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutProjectEventsRequest> Clone() const
    {
      return Aws::MakeUnique<PutProjectEventsRequest>(GetServiceRequestName(), *this);
    }
