...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVIDENTLY_API ListSegmentsRequest : public CloudWatchEvidentlyRequest
  {
  public:
    ListSegmentsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListSegmentsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSegmentsRequest>(GetServiceRequestName(), *this);
    }
