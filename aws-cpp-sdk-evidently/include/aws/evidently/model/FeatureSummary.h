...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDWATCHEVIDENTLY_API FeatureSummary
  {
  public:
    FeatureSummary();
    FeatureSummary(Aws::Utils::Json::JsonView jsonValue);
    FeatureSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
