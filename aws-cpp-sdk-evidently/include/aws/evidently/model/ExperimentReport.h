...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDWATCHEVIDENTLY_API ExperimentReport
  {
  public:
    ExperimentReport();
    ExperimentReport(Aws::Utils::Json::JsonView jsonValue);
    ExperimentReport& operator=(Aws::Utils::Json::JsonView jsonValue);
