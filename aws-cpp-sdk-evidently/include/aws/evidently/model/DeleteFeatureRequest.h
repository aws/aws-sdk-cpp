...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVIDENTLY_API DeleteFeatureRequest : public CloudWatchEvidentlyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFeatureRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFeatureRequest>(GetServiceRequestName(), *this);
    }
