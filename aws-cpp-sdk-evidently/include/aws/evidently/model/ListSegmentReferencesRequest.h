...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVIDENTLY_API ListSegmentReferencesRequest : public CloudWatchEvidentlyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSegmentReferencesRequest> Clone() const
    {
      return Aws::MakeUnique<ListSegmentReferencesRequest>(GetServiceRequestName(), *this);
    }
