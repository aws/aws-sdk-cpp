...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVIDENTLY_API ListExperimentsRequest : public CloudWatchEvidentlyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListExperimentsRequest> Clone() const
    {
      return Aws::MakeUnique<ListExperimentsRequest>(GetServiceRequestName(), *this);
    }
