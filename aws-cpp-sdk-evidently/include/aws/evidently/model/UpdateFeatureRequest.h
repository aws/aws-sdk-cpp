...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVIDENTLY_API UpdateFeatureRequest : public CloudWatchEvidentlyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFeatureRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFeatureRequest>(GetServiceRequestName(), *this);
    }
