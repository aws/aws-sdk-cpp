...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVIDENTLY_API GetFeatureRequest : public CloudWatchEvidentlyRequest
  {
  public:
    GetFeatureRequest();
    ...
    */
    virtual Aws::UniquePtr<GetFeatureRequest> Clone() const
    {
      return Aws::MakeUnique<GetFeatureRequest>(GetServiceRequestName(), *this);
    }
