...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDWATCHEVIDENTLY_API MetricGoalConfig
  {
  public:
    MetricGoalConfig();
    MetricGoalConfig(Aws::Utils::Json::JsonView jsonValue);
    MetricGoalConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
