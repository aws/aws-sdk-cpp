...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVIDENTLY_API DeleteLaunchRequest : public CloudWatchEvidentlyRequest
  {
  public:
    DeleteLaunchRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteLaunchRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLaunchRequest>(GetServiceRequestName(), *this);
    }
