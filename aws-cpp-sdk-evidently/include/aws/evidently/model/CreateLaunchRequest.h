...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVIDENTLY_API CreateLaunchRequest : public CloudWatchEvidentlyRequest
  {
  public:
    CreateLaunchRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateLaunchRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLaunchRequest>(GetServiceRequestName(), *this);
    }
