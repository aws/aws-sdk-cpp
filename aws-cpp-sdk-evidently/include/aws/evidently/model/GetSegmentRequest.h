...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVIDENTLY_API GetSegmentRequest : public CloudWatchEvidentlyRequest
  {
  public:
    GetSegmentRequest();
    ...
    */
    virtual Aws::UniquePtr<GetSegmentRequest> Clone() const
    {
      return Aws::MakeUnique<GetSegmentRequest>(GetServiceRequestName(), *this);
    }
