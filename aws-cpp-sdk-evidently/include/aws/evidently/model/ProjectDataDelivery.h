...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDWATCHEVIDENTLY_API ProjectDataDelivery
  {
  public:
    ProjectDataDelivery();
    ProjectDataDelivery(Aws::Utils::Json::JsonView jsonValue);
    ProjectDataDelivery& operator=(Aws::Utils::Json::JsonView jsonValue);
