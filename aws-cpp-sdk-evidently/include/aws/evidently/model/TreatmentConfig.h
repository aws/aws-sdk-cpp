...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDWATCHEVIDENTLY_API TreatmentConfig
  {
  public:
    TreatmentConfig();
    TreatmentConfig(Aws::Utils::Json::JsonView jsonValue);
    TreatmentConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
