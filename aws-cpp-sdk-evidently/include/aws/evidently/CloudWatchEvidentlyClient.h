...
namespace CloudWatchEvidently
{
  ...
  class AWS_CLOUDWATCHEVIDENTLY_API CloudWatchEvidentlyClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudWatchEvidentlyClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                  std::shared_ptr<Endpoint::CloudWatchEvidentlyEndpointProvider> endpointProvider = Aws::MakeShared<CloudWatchEvidently::Endpoint::CloudWatchEvidentlyEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CloudWatchEvidentlyEndpointProvider> m_endpointProvider;
  };
