...
namespace Model
{
   ...
   * <important> <p>You must specify the US-West-2 (Oregon) Region to create or
   * update accelerators.</p> </important> <p>Global Accelerator provides you with
   * static IP addresses that you associate with your accelerator. These IP addresses
   * are anycast from the AWS edge network and distribute incoming application
   * traffic across multiple endpoint resources in multiple AWS Regions, which
   * increases the availability of your applications. Endpoints can be Elastic IP
   * addresses, Network Load Balancers, and Application Load Balancers that are
   * located in one AWS Region or multiple Regions.</p> <p>Global Accelerator uses
   * the AWS global network to route traffic to the optimal regional endpoint based
   ...
   * from clients is directed to only healthy endpoints.</p> <p>Global Accelerator
   ...
   * <p>AWS Global Accelerator provides you with a set of static IP addresses which
   * are anycast from the AWS edge network and serve as the single fixed entry points
   * for your clients. If you already have Elastic Load Balancing or Elastic IP
   * address resources set up for your applications, you can easily add those to
   * Global Accelerator to allow the resources to be accessed by a Global Accelerator
   * static IP address.</p> </dd> <dt>Accelerator</dt> <dd> <p>An accelerator directs
   ...
   * accelerator includes one or more listeners.</p> </dd> <dt>Network zone</dt> <dd>
   * <p>A network zone services the static IP addresses for your accelerator from a
   ...
   * accelerator, Global Accelerator allocates two IPv4 addresses for it. If one IP
   ...
   * <p>An endpoint is an Elastic IP address, Network Load Balancer, or Application
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * <important> <p>You must specify the US-West-2 (Oregon) Region to create or
         * update accelerators.</p> </important><p><h3>See Also:</h3>   <a
         ...
         * scroll down to <b>Example</b>.</p> <important> <p>You must specify the US-West-2
