...
namespace Model
{
        ...
        typedef Aws::Utils::Outcome<AdvertiseByoipCidrResult, Aws::Client::AWSError<GlobalAcceleratorErrors>> AdvertiseByoipCidrOutcome;
        ...
        typedef Aws::Utils::Outcome<DeprovisionByoipCidrResult, Aws::Client::AWSError<GlobalAcceleratorErrors>> DeprovisionByoipCidrOutcome;
        ...
        typedef Aws::Utils::Outcome<ListByoipCidrsResult, Aws::Client::AWSError<GlobalAcceleratorErrors>> ListByoipCidrsOutcome;
        ...
        typedef Aws::Utils::Outcome<ListTagsForResourceResult, Aws::Client::AWSError<GlobalAcceleratorErrors>> ListTagsForResourceOutcome;
        typedef Aws::Utils::Outcome<ProvisionByoipCidrResult, Aws::Client::AWSError<GlobalAcceleratorErrors>> ProvisionByoipCidrOutcome;
        typedef Aws::Utils::Outcome<TagResourceResult, Aws::Client::AWSError<GlobalAcceleratorErrors>> TagResourceOutcome;
        typedef Aws::Utils::Outcome<UntagResourceResult, Aws::Client::AWSError<GlobalAcceleratorErrors>> UntagResourceOutcome;
        ...
        typedef Aws::Utils::Outcome<WithdrawByoipCidrResult, Aws::Client::AWSError<GlobalAcceleratorErrors>> WithdrawByoipCidrOutcome;
   ...
   * multiple Regions.</p> <p>Global Accelerator uses the AWS global network to route
   ...
   * only healthy endpoints.</p> <p>Global Accelerator includes components that work
   * together to help you improve performance and availability for your
   * applications:</p> <dl> <dt>Static IP address</dt> <dd> <p>By default, AWS Global
   * Accelerator provides you with a set of static IP addresses that are anycast from
   * the AWS edge network and serve as the single fixed entry points for your
   * clients. Or you can configure these entry points to be IPv4 addresses from your
   * own IP address ranges that you bring to Global Accelerator (BYOIP). For more
   * information, see <a
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * CLI example of creating an accelerator, scroll down to <b>Example</b>.</p> <p>If
