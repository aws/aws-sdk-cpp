...
namespace Model
{
   ...
   * href="https://docs.awa.amazon.com/global-accelerator/latest/dg/Welcome.html">AWS
   ...
   * edge network and serve as the single fixed points of contact for your clients.
   * If you already have Elastic Load Balancing or Elastic IP address resources set
   * up for your applications, you can easily add those to Global Accelerator to
   * allow the resources to be accessed by a Global Accelerator static IP
   * address.</p> </dd> <dt>Accelerator</dt> <dd> <p>An accelerator directs traffic
   * to optimal endpoints over the AWS global network to improve availability and
   * performance for your internet applications that have a global audience. Each
   ...
   * options that you choose, such as endpoint weights. You can configure weights for
   * each endpoint, which are numbers that you can use to specify the proportion of
   * traffic to route to each one. This can be useful, for example, to do performance
   * testing within a Region.</p> </dd> </dl>
   */
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
        ...
        /**
         * <p>Create an endpoint group for the specified accelerator. An endpoint group is
         * a collection of endpoints in one AWS Region. To see an AWS CLI example of
         * creating an endpoint group, scroll down to <b>Example</b>.</p><p><h3>See
         * Also:</h3>   <a
         ...
         * disable it.</p><p><h3>See Also:</h3>   <a
