...
namespace Model
{
  ...
  /**
   */
  class AWS_GLOBALACCELERATOR_API ListCustomRoutingPortMappingsRequest : public GlobalAcceleratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCustomRoutingPortMappingsRequest> Clone() const
    {
      return Aws::MakeUnique<ListCustomRoutingPortMappingsRequest>(GetServiceRequestName(), *this);
    }
