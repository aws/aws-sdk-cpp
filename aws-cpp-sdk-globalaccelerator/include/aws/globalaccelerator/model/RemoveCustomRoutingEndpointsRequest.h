...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveCustomRoutingEndpointsRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveCustomRoutingEndpointsRequest>(GetServiceRequestName(), *this);
    }
