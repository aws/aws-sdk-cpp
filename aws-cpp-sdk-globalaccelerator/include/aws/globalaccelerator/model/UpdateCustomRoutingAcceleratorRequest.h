...
namespace Model
{
  ...
  /**
   */
  class AWS_GLOBALACCELERATOR_API UpdateCustomRoutingAcceleratorRequest : public GlobalAcceleratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCustomRoutingAcceleratorRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCustomRoutingAcceleratorRequest>(GetServiceRequestName(), *this);
    }
