...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCustomRoutingListenerRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCustomRoutingListenerRequest>(GetServiceRequestName(), *this);
    }
