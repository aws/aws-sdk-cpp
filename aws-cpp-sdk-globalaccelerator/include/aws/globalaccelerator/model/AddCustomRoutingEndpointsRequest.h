...
namespace Model
{
  ...
  /**
   */
  class AWS_GLOBALACCELERATOR_API AddCustomRoutingEndpointsRequest : public GlobalAcceleratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AddCustomRoutingEndpointsRequest> Clone() const
    {
      return Aws::MakeUnique<AddCustomRoutingEndpointsRequest>(GetServiceRequestName(), *this);
    }
