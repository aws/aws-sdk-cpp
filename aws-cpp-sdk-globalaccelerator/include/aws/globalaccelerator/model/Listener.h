...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The client properties that Global Accelerator uses to select an endpoint so
     * that you can choose to route traffic from users to their original endpoint. The
