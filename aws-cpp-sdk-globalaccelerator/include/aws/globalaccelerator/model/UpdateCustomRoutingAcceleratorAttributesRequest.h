...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCustomRoutingAcceleratorAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCustomRoutingAcceleratorAttributesRequest>(GetServiceRequestName(), *this);
    }
