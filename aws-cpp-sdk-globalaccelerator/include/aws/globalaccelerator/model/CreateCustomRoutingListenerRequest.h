...
namespace Model
{
  ...
  /**
   */
  class AWS_GLOBALACCELERATOR_API CreateCustomRoutingListenerRequest : public GlobalAcceleratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCustomRoutingListenerRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCustomRoutingListenerRequest>(GetServiceRequestName(), *this);
    }
