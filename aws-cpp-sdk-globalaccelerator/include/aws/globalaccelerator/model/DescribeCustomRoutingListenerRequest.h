...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCustomRoutingListenerRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCustomRoutingListenerRequest>(GetServiceRequestName(), *this);
    }
