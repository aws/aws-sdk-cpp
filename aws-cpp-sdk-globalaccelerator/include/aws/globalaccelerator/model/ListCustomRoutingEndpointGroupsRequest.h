...
namespace Model
{
  ...
  /**
   */
  class AWS_GLOBALACCELERATOR_API ListCustomRoutingEndpointGroupsRequest : public GlobalAcceleratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCustomRoutingEndpointGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<ListCustomRoutingEndpointGroupsRequest>(GetServiceRequestName(), *this);
    }
