...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCustomRoutingAcceleratorRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCustomRoutingAcceleratorRequest>(GetServiceRequestName(), *this);
    }
