...
namespace Model
{
  ...
  /**
   */
  class AWS_GLOBALACCELERATOR_API DenyCustomRoutingTrafficRequest : public GlobalAcceleratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DenyCustomRoutingTrafficRequest> Clone() const
    {
      return Aws::MakeUnique<DenyCustomRoutingTrafficRequest>(GetServiceRequestName(), *this);
    }
