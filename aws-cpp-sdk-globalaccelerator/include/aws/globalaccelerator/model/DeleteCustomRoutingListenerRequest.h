...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCustomRoutingListenerRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCustomRoutingListenerRequest>(GetServiceRequestName(), *this);
    }
