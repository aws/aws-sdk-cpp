...
namespace Model
{
  ...
  /**
   */
  class AWS_GLOBALACCELERATOR_API CreateCustomRoutingAcceleratorRequest : public GlobalAcceleratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCustomRoutingAcceleratorRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCustomRoutingAcceleratorRequest>(GetServiceRequestName(), *this);
    }
