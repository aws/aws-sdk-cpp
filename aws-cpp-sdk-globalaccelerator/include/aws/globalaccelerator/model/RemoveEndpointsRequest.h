...
namespace Model
{
  ...
  /**
   */
  class AWS_GLOBALACCELERATOR_API RemoveEndpointsRequest : public GlobalAcceleratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveEndpointsRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveEndpointsRequest>(GetServiceRequestName(), *this);
    }
