...
namespace Model
{
  ...
  public:
     ...
     * endpoint, if you have stateful applications, regardless of the source port and
     * protocol of the user request. This gives you control over whether and how to
     * maintain client affinity to a given endpoint.</p> <p>The default value is
     * <code>NONE</code>.</p>
     */
