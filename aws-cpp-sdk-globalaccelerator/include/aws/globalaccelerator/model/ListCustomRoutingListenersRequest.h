...
namespace Model
{
  ...
  /**
   */
  class AWS_GLOBALACCELERATOR_API ListCustomRoutingListenersRequest : public GlobalAcceleratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCustomRoutingListenersRequest> Clone() const
    {
      return Aws::MakeUnique<ListCustomRoutingListenersRequest>(GetServiceRequestName(), *this);
    }
