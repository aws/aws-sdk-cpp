...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCustomRoutingEndpointGroupRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCustomRoutingEndpointGroupRequest>(GetServiceRequestName(), *this);
    }
