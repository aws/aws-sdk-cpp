...
namespace Model
{
  ...
  /**
   */
  class AWS_GLOBALACCELERATOR_API ListCustomRoutingPortMappingsByDestinationRequest : public GlobalAcceleratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCustomRoutingPortMappingsByDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<ListCustomRoutingPortMappingsByDestinationRequest>(GetServiceRequestName(), *this);
    }
