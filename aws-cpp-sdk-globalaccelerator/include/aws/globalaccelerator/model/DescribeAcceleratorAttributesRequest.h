...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAcceleratorAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAcceleratorAttributesRequest>(GetServiceRequestName(), *this);
    }
