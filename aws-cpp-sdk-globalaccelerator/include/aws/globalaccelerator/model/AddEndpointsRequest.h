...
namespace Model
{
  ...
  /**
   */
  class AWS_GLOBALACCELERATOR_API AddEndpointsRequest : public GlobalAcceleratorRequest
  {
  public:
    AddEndpointsRequest();
    ...
    */
    virtual Aws::UniquePtr<AddEndpointsRequest> Clone() const
    {
      return Aws::MakeUnique<AddEndpointsRequest>(GetServiceRequestName(), *this);
    }
