...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAcceleratorAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAcceleratorAttributesRequest>(GetServiceRequestName(), *this);
    }
