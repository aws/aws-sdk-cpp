...
namespace Model
{
  ...
  /**
   */
  class AWS_GLOBALACCELERATOR_API DescribeCustomRoutingAcceleratorRequest : public GlobalAcceleratorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCustomRoutingAcceleratorRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCustomRoutingAcceleratorRequest>(GetServiceRequestName(), *this);
    }
