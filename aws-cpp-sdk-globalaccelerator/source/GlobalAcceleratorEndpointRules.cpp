...
{
const size_t GlobalAcceleratorEndpointRules::RulesBlobStrLen = 3456;
const size_t GlobalAcceleratorEndpointRules::RulesBlobSize = 3457;

using RulesBlobT = Aws::Array<const char, GlobalAcceleratorEndpointRules::RulesBlobSize>;
...
'a','c','c','e','l','e','r','a','t','o','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}',
...
'i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','l','o','b',
'a','l','a','c','c','e','l','e','r','a','t','o','r','-','f','i','p','s','.','{','R','e','g','i','o',
...
'/','g','l','o','b','a','l','a','c','c','e','l','e','r','a','t','o','r','.','{','R','e','g','i','o',
...
'o','b','a','l','a','c','c','e','l','e','r','a','t','o','r','.','{','R','e','g','i','o','n','}','.',
...
const char* GlobalAcceleratorEndpointRules::GetRulesBlob()
{
