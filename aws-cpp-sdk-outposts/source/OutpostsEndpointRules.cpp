...
Aws::String OutpostsEndpointRules::GetRulesAsString()
{
    return Aws::String(OutpostsEndpointRules::Rules.begin(), OutpostsEndpointRules::Rules.end());
}

const Aws::Vector<char> OutpostsEndpointRules::Rules = {
