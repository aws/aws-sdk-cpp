...
namespace Outposts
{
const size_t OutpostsEndpointRules::RulesBlobStrLen = 3400;
const size_t OutpostsEndpointRules::RulesBlobSize = 3401;

using RulesBlobT = Aws::Array<const char, OutpostsEndpointRules::RulesBlobSize>;
...
't','t','p','s',':','/','/','o','u','t','p','o','s','t','s','-','f','i','p','s','.','{','R','e','g',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','o','u','t','p','o','s','t','s','-','f',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','o','u','t','p','o','s','t','s','.','{','R','e',
...
'/','o','u','t','p','o','s','t','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
const char* OutpostsEndpointRules::GetRulesBlob()
{
