...
namespace Outposts
{
  ...
  class AWS_OUTPOSTS_API OutpostsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        OutpostsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::OutpostsEndpointProvider> endpointProvider = Aws::MakeShared<Outposts::Endpoint::OutpostsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::OutpostsEndpointProvider> m_endpointProvider;
  };
