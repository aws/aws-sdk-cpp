...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSiteRackPhysicalPropertiesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSiteRackPhysicalPropertiesRequest>(GetServiceRequestName(), *this);
    }
