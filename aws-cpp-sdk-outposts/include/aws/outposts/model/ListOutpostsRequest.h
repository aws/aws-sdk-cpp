...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p> A filter for the Availibility Zone (<code>us-east-1a</code>) of the Outpost.
    ...
    /**
     * <p> A filter for the AZ IDs (<code>use1-az1</code>) of the Outpost. </p> <p>
     * Filter values are case sensitive. If you specify multiple values for a filter,
     * the values are joined with an <code>OR</code>, and the request returns all
