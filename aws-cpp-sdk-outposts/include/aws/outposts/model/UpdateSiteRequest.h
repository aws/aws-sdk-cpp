...
namespace Model
{
  ...
  /**
   */
  class AWS_OUTPOSTS_API UpdateSiteRequest : public OutpostsRequest
  {
  public:
    UpdateSiteRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateSiteRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSiteRequest>(GetServiceRequestName(), *this);
    }
