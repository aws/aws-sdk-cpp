...
CustomVocabularyExportSpecification& CustomVocabularyExportSpecification::operator =(JsonView jsonValue)
{
...
JsonValue CustomVocabularyExportSpecification::Jsonize() const
{
  JsonValue payload;
