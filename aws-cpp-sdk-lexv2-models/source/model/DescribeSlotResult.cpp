...
DescribeSlotResult::DescribeSlotResult()
{
}

DescribeSlotResult::DescribeSlotResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeSlotResult& DescribeSlotResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
