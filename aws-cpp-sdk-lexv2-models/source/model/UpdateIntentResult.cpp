...
UpdateIntentResult::UpdateIntentResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
...
UpdateIntentResult& UpdateIntentResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  ...
  {
    Array<JsonView> slotPrioritiesJsonList = jsonValue.GetArray("slotPriorities");
