...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API CreateSlotTypeRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSlotTypeRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSlotTypeRequest>(GetServiceRequestName(), *this);
    }
