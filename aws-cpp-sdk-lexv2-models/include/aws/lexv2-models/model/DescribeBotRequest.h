...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DescribeBotRequest : public LexModelsV2Request
  {
  public:
    DescribeBotRequest();
    ...
    */
    virtual Aws::UniquePtr<DescribeBotRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBotRequest>(GetServiceRequestName(), *this);
    }
