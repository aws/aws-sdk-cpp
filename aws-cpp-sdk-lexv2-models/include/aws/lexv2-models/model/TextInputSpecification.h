...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_LEXMODELSV2_API TextInputSpecification
  {
  public:
    TextInputSpecification();
    TextInputSpecification(Aws::Utils::Json::JsonView jsonValue);
    TextInputSpecification& operator=(Aws::Utils::Json::JsonView jsonValue);
