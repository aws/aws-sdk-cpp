...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DescribeSlotRequest : public LexModelsV2Request
  {
  public:
    DescribeSlotRequest();
    ...
    */
    virtual Aws::UniquePtr<DescribeSlotRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSlotRequest>(GetServiceRequestName(), *this);
    }
