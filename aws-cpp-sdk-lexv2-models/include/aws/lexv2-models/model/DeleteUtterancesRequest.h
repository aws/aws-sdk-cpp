...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DeleteUtterancesRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteUtterancesRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteUtterancesRequest>(GetServiceRequestName(), *this);
    }
