...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API UpdateResourcePolicyRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateResourcePolicyRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateResourcePolicyRequest>(GetServiceRequestName(), *this);
    }
