...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API BatchDeleteCustomVocabularyItemRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDeleteCustomVocabularyItemRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDeleteCustomVocabularyItemRequest>(GetServiceRequestName(), *this);
    }
