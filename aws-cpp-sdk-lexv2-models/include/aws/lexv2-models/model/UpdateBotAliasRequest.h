...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API UpdateBotAliasRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateBotAliasRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateBotAliasRequest>(GetServiceRequestName(), *this);
    }
