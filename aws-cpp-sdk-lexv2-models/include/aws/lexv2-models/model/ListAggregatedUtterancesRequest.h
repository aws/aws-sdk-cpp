...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API ListAggregatedUtterancesRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAggregatedUtterancesRequest> Clone() const
    {
      return Aws::MakeUnique<ListAggregatedUtterancesRequest>(GetServiceRequestName(), *this);
    }
