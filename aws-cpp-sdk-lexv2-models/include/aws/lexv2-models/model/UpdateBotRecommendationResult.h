...
namespace Model
{
  class AWS_LEXMODELSV2_API UpdateBotRecommendationResult
  {
  public:
    UpdateBotRecommendationResult();
    UpdateBotRecommendationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateBotRecommendationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
