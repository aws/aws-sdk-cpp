...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DeleteSlotTypeRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSlotTypeRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSlotTypeRequest>(GetServiceRequestName(), *this);
    }
