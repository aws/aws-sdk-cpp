...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DescribeSlotTypeRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSlotTypeRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSlotTypeRequest>(GetServiceRequestName(), *this);
    }
