...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API BatchUpdateCustomVocabularyItemRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchUpdateCustomVocabularyItemRequest> Clone() const
    {
      return Aws::MakeUnique<BatchUpdateCustomVocabularyItemRequest>(GetServiceRequestName(), *this);
    }
