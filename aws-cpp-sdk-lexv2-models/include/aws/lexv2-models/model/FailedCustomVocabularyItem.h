...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_LEXMODELSV2_API FailedCustomVocabularyItem
  {
  public:
    FailedCustomVocabularyItem();
    FailedCustomVocabularyItem(Aws::Utils::Json::JsonView jsonValue);
    FailedCustomVocabularyItem& operator=(Aws::Utils::Json::JsonView jsonValue);
