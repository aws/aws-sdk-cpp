...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DeleteCustomVocabularyRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCustomVocabularyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCustomVocabularyRequest>(GetServiceRequestName(), *this);
    }
