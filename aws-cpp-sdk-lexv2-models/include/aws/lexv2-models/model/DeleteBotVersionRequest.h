...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DeleteBotVersionRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBotVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBotVersionRequest>(GetServiceRequestName(), *this);
    }
