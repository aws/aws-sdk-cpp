...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DeleteImportRequest : public LexModelsV2Request
  {
  public:
    DeleteImportRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteImportRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteImportRequest>(GetServiceRequestName(), *this);
    }
