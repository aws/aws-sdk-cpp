...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_LEXMODELSV2_API DTMFSpecification
  {
  public:
    DTMFSpecification();
    DTMFSpecification(Aws::Utils::Json::JsonView jsonValue);
    DTMFSpecification& operator=(Aws::Utils::Json::JsonView jsonValue);
