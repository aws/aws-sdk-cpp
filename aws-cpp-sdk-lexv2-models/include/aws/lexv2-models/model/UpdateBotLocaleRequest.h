...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API UpdateBotLocaleRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateBotLocaleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateBotLocaleRequest>(GetServiceRequestName(), *this);
    }
