...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API CreateBotAliasRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateBotAliasRequest> Clone() const
    {
      return Aws::MakeUnique<CreateBotAliasRequest>(GetServiceRequestName(), *this);
    }
