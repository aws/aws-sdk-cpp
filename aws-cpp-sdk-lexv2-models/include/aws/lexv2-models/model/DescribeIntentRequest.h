...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DescribeIntentRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeIntentRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeIntentRequest>(GetServiceRequestName(), *this);
    }
