...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DeleteResourcePolicyStatementRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteResourcePolicyStatementRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteResourcePolicyStatementRequest>(GetServiceRequestName(), *this);
    }
