...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateResourcePolicyStatementRequest> Clone() const
    {
      return Aws::MakeUnique<CreateResourcePolicyStatementRequest>(GetServiceRequestName(), *this);
    }
