...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API ListExportsRequest : public LexModelsV2Request
  {
  public:
    ListExportsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListExportsRequest> Clone() const
    {
      return Aws::MakeUnique<ListExportsRequest>(GetServiceRequestName(), *this);
    }
