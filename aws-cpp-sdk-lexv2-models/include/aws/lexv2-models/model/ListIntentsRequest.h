...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API ListIntentsRequest : public LexModelsV2Request
  {
  public:
    ListIntentsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListIntentsRequest> Clone() const
    {
      return Aws::MakeUnique<ListIntentsRequest>(GetServiceRequestName(), *this);
    }
