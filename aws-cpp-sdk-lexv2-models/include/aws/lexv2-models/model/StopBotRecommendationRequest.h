...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API StopBotRecommendationRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopBotRecommendationRequest> Clone() const
    {
      return Aws::MakeUnique<StopBotRecommendationRequest>(GetServiceRequestName(), *this);
    }
