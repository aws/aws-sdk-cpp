...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API UpdateSlotTypeRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSlotTypeRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSlotTypeRequest>(GetServiceRequestName(), *this);
    }
