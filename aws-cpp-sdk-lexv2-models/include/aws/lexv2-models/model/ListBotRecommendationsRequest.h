...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API ListBotRecommendationsRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBotRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListBotRecommendationsRequest>(GetServiceRequestName(), *this);
    }
