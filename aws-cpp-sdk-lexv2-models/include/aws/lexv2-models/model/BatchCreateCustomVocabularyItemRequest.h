...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API BatchCreateCustomVocabularyItemRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchCreateCustomVocabularyItemRequest> Clone() const
    {
      return Aws::MakeUnique<BatchCreateCustomVocabularyItemRequest>(GetServiceRequestName(), *this);
    }
