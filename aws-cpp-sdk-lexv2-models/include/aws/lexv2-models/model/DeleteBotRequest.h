...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DeleteBotRequest : public LexModelsV2Request
  {
  public:
    DeleteBotRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteBotRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBotRequest>(GetServiceRequestName(), *this);
    }
