...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API ListBotAliasesRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBotAliasesRequest> Clone() const
    {
      return Aws::MakeUnique<ListBotAliasesRequest>(GetServiceRequestName(), *this);
    }
