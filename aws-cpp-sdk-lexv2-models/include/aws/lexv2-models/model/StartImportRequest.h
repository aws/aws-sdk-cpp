...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API StartImportRequest : public LexModelsV2Request
  {
  public:
    StartImportRequest();
    ...
    */
    virtual Aws::UniquePtr<StartImportRequest> Clone() const
    {
      return Aws::MakeUnique<StartImportRequest>(GetServiceRequestName(), *this);
    }
