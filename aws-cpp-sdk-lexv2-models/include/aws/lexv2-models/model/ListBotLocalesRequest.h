...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API ListBotLocalesRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBotLocalesRequest> Clone() const
    {
      return Aws::MakeUnique<ListBotLocalesRequest>(GetServiceRequestName(), *this);
    }
