...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API UpdateBotRecommendationRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateBotRecommendationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateBotRecommendationRequest>(GetServiceRequestName(), *this);
    }
