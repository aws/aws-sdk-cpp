...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_LEXMODELSV2_API BuiltInSlotTypeSortBy
  {
  public:
    BuiltInSlotTypeSortBy();
    BuiltInSlotTypeSortBy(Aws::Utils::Json::JsonView jsonValue);
    BuiltInSlotTypeSortBy& operator=(Aws::Utils::Json::JsonView jsonValue);
