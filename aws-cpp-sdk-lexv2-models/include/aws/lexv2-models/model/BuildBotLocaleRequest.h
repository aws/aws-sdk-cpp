...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API BuildBotLocaleRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BuildBotLocaleRequest> Clone() const
    {
      return Aws::MakeUnique<BuildBotLocaleRequest>(GetServiceRequestName(), *this);
    }
