...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API ListCustomVocabularyItemsRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCustomVocabularyItemsRequest> Clone() const
    {
      return Aws::MakeUnique<ListCustomVocabularyItemsRequest>(GetServiceRequestName(), *this);
    }
