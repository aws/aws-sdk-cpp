...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DescribeBotVersionRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeBotVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBotVersionRequest>(GetServiceRequestName(), *this);
    }
