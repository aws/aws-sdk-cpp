...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DescribeCustomVocabularyMetadataRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCustomVocabularyMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCustomVocabularyMetadataRequest>(GetServiceRequestName(), *this);
    }
