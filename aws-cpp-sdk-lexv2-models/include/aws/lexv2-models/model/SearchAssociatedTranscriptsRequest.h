...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchAssociatedTranscriptsRequest> Clone() const
    {
      return Aws::MakeUnique<SearchAssociatedTranscriptsRequest>(GetServiceRequestName(), *this);
    }
