...
namespace Model
{
  ...
  /**
   */
  class AWS_LEXMODELSV2_API DescribeImportRequest : public LexModelsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeImportRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeImportRequest>(GetServiceRequestName(), *this);
    }
