...
namespace LexModelsV2
{
  ...
  class AWS_LEXMODELSV2_API LexModelsV2Client : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        LexModelsV2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::LexModelsV2EndpointProvider> endpointProvider = Aws::MakeShared<LexModelsV2::Endpoint::LexModelsV2EndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::LexModelsV2EndpointProvider> m_endpointProvider;
  };
