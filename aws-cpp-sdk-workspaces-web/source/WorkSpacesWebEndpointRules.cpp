...
{
const size_t WorkSpacesWebEndpointRules::RulesBlobStrLen = 3485;
const size_t WorkSpacesWebEndpointRules::RulesBlobSize = 3486;

using RulesBlobT = Aws::Array<const char, WorkSpacesWebEndpointRules::RulesBlobSize>;
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','w','o','r','k','s','p','a',
'c','e','s','-','w','e','b','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
't','t','p','s',':','/','/','w','o','r','k','s','p','a','c','e','s','-','w','e','b','-','f','i','p',
...
'"',':','"','h','t','t','p','s',':','/','/','w','o','r','k','s','p','a','c','e','s','-','w','e','b',
...
'p','s',':','/','/','w','o','r','k','s','p','a','c','e','s','-','w','e','b','.','{','R','e','g','i',
...
const char* WorkSpacesWebEndpointRules::GetRulesBlob()
{
