...
Aws::String WorkSpacesWebEndpointRules::GetRulesAsString()
{
    return Aws::String(WorkSpacesWebEndpointRules::Rules.begin(), WorkSpacesWebEndpointRules::Rules.end());
}

const Aws::Vector<char> WorkSpacesWebEndpointRules::Rules = {
