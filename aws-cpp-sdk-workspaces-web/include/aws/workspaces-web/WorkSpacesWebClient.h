...
namespace WorkSpacesWeb
{
  ...
  class AWS_WORKSPACESWEB_API WorkSpacesWebClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        WorkSpacesWebClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::WorkSpacesWebEndpointProvider> endpointProvider = Aws::MakeShared<WorkSpacesWeb::Endpoint::WorkSpacesWebEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::WorkSpacesWebEndpointProvider> m_endpointProvider;
  };
