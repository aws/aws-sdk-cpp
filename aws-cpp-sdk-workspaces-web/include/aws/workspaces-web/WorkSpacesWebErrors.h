...
public:
  ...
  WorkSpacesWebError(const Aws::Client::AWSError<WorkSpacesWebErrors>& rhs) : Aws::Client::AWSError<WorkSpacesWebErrors>(rhs) {}
  WorkSpacesWebError(Aws::Client::AWSError<WorkSpacesWebErrors>&& rhs) : Aws::Client::AWSError<WorkSpacesWebErrors>(rhs) {}
