...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API DeleteIdentityProviderRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteIdentityProviderRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteIdentityProviderRequest>(GetServiceRequestName(), *this);
    }
