...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API DeleteUserAccessLoggingSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteUserAccessLoggingSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteUserAccessLoggingSettingsRequest>(GetServiceRequestName(), *this);
    }
