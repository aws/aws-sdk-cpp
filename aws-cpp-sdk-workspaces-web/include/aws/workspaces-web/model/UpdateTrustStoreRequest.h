...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API UpdateTrustStoreRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTrustStoreRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTrustStoreRequest>(GetServiceRequestName(), *this);
    }
