...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API DeleteNetworkSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteNetworkSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteNetworkSettingsRequest>(GetServiceRequestName(), *this);
    }
