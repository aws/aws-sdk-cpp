...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API DeleteUserSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteUserSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteUserSettingsRequest>(GetServiceRequestName(), *this);
    }
