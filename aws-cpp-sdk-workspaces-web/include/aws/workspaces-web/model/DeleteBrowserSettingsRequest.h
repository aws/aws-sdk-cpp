...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API DeleteBrowserSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBrowserSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBrowserSettingsRequest>(GetServiceRequestName(), *this);
    }
