...
namespace Model
{
  ...
  /**
   * <p>There is an internal server error.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-web-2020-07-08/InternalServerException">AWS
   * API Reference</a></p>
   */
  class InternalServerException
  {
  public:
    AWS_WORKSPACESWEB_API InternalServerException();
    AWS_WORKSPACESWEB_API InternalServerException(Aws::Utils::Json::JsonView jsonValue);
    AWS_WORKSPACESWEB_API InternalServerException& operator=(Aws::Utils::Json::JsonView jsonValue);
