...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API GetTrustStoreCertificateRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTrustStoreCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<GetTrustStoreCertificateRequest>(GetServiceRequestName(), *this);
    }
