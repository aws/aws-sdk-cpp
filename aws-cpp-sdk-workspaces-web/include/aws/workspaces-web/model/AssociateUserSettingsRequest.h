...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API AssociateUserSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateUserSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateUserSettingsRequest>(GetServiceRequestName(), *this);
    }
