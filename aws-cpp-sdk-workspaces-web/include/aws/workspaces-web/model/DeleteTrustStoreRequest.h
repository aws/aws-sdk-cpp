...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API DeleteTrustStoreRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTrustStoreRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTrustStoreRequest>(GetServiceRequestName(), *this);
    }
