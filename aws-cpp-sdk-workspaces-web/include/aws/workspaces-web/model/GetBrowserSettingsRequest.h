...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API GetBrowserSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBrowserSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<GetBrowserSettingsRequest>(GetServiceRequestName(), *this);
    }
