...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API AssociateNetworkSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateNetworkSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateNetworkSettingsRequest>(GetServiceRequestName(), *this);
    }
