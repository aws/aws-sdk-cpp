...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API AssociateBrowserSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateBrowserSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateBrowserSettingsRequest>(GetServiceRequestName(), *this);
    }
