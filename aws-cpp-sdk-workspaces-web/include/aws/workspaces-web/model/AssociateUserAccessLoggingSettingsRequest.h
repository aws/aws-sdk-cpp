...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API AssociateUserAccessLoggingSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateUserAccessLoggingSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateUserAccessLoggingSettingsRequest>(GetServiceRequestName(), *this);
    }
