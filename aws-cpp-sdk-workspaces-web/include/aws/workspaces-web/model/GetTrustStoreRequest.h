...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API GetTrustStoreRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTrustStoreRequest> Clone() const
    {
      return Aws::MakeUnique<GetTrustStoreRequest>(GetServiceRequestName(), *this);
    }
