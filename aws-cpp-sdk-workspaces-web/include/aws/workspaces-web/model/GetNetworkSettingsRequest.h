...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API GetNetworkSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetNetworkSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<GetNetworkSettingsRequest>(GetServiceRequestName(), *this);
    }
