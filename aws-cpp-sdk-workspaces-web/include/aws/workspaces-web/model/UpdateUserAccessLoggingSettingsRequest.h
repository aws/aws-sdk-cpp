...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API UpdateUserAccessLoggingSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateUserAccessLoggingSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateUserAccessLoggingSettingsRequest>(GetServiceRequestName(), *this);
    }
