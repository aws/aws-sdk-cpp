...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API GetIdentityProviderRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetIdentityProviderRequest> Clone() const
    {
      return Aws::MakeUnique<GetIdentityProviderRequest>(GetServiceRequestName(), *this);
    }
