...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API CreateUserAccessLoggingSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateUserAccessLoggingSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<CreateUserAccessLoggingSettingsRequest>(GetServiceRequestName(), *this);
    }
