...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKSPACESWEB_API CreateBrowserSettingsRequest : public WorkSpacesWebRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateBrowserSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<CreateBrowserSettingsRequest>(GetServiceRequestName(), *this);
    }
