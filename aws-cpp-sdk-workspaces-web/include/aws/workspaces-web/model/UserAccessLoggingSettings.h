...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WORKSPACESWEB_API UserAccessLoggingSettings
  {
  public:
    UserAccessLoggingSettings();
    UserAccessLoggingSettings(Aws::Utils::Json::JsonView jsonValue);
    UserAccessLoggingSettings& operator=(Aws::Utils::Json::JsonView jsonValue);
