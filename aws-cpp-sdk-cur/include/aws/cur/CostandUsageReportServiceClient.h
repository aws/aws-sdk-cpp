...
namespace CostandUsageReportService
{
  ...
  class AWS_COSTANDUSAGEREPORTSERVICE_API CostandUsageReportServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CostandUsageReportServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                        std::shared_ptr<Endpoint::CostandUsageReportServiceEndpointProvider> endpointProvider = Aws::MakeShared<CostandUsageReportService::Endpoint::CostandUsageReportServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CostandUsageReportServiceEndpointProvider> m_endpointProvider;
  };
