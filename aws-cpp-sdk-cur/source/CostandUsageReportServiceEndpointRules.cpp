...
Aws::String CostandUsageReportServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(CostandUsageReportServiceEndpointRules::Rules.begin(), CostandUsageReportServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> CostandUsageReportServiceEndpointRules::Rules = {
