...
using ResolveEndpointOutcome = Aws::CostandUsageReportService::Endpoint::CostandUsageReportServiceEndpointProvider::CostandUsageReportServiceResolveEndpointOutcome;
...
CostandUsageReportServiceClient::CostandUsageReportServiceClient(const Client::ClientConfiguration& clientConfiguration,
                                                                 std::shared_ptr<Endpoint::CostandUsageReportServiceEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CostandUsageReportServiceErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CostandUsageReportService::Endpoint::CostandUsageReportServiceEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
