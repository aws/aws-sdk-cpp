...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API ListEmailIdentitiesRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEmailIdentitiesRequest> Clone() const
    {
      return Aws::MakeUnique<ListEmailIdentitiesRequest>(GetServiceRequestName(), *this);
    }
