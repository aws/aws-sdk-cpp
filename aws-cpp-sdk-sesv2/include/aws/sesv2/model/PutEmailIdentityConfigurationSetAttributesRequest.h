...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutEmailIdentityConfigurationSetAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<PutEmailIdentityConfigurationSetAttributesRequest>(GetServiceRequestName(), *this);
    }
