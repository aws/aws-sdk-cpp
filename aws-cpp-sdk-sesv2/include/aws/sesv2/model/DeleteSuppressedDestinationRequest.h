...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSuppressedDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSuppressedDestinationRequest>(GetServiceRequestName(), *this);
    }
