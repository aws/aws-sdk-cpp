...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API GetDedicatedIpPoolRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDedicatedIpPoolRequest> Clone() const
    {
      return Aws::MakeUnique<GetDedicatedIpPoolRequest>(GetServiceRequestName(), *this);
    }
