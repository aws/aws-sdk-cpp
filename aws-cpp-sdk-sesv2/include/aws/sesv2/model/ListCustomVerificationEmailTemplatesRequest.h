...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCustomVerificationEmailTemplatesRequest> Clone() const
    {
      return Aws::MakeUnique<ListCustomVerificationEmailTemplatesRequest>(GetServiceRequestName(), *this);
    }
