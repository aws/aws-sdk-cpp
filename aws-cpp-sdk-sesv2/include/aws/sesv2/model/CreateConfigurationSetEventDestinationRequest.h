...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/sesv2-2019-09-27/CreateConfigurationSetEventDestinationRequest">AWS
   * API Reference</a></p>
   */
  class AWS_SESV2_API CreateConfigurationSetEventDestinationRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateConfigurationSetEventDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateConfigurationSetEventDestinationRequest>(GetServiceRequestName(), *this);
    }
