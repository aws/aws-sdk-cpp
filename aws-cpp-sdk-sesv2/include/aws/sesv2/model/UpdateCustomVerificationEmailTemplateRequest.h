...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCustomVerificationEmailTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCustomVerificationEmailTemplateRequest>(GetServiceRequestName(), *this);
    }
