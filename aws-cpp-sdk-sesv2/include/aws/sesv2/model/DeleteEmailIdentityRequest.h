...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API DeleteEmailIdentityRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEmailIdentityRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEmailIdentityRequest>(GetServiceRequestName(), *this);
    }
