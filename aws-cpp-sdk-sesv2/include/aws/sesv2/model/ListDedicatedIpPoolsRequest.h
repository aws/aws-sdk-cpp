...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/sesv2-2019-09-27/ListDedicatedIpPoolsRequest">AWS
   * API Reference</a></p>
   */
  class AWS_SESV2_API ListDedicatedIpPoolsRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDedicatedIpPoolsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDedicatedIpPoolsRequest>(GetServiceRequestName(), *this);
    }
