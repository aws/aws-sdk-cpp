...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAccountSuppressionAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<PutAccountSuppressionAttributesRequest>(GetServiceRequestName(), *this);
    }
