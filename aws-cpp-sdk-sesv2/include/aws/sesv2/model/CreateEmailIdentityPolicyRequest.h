...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API CreateEmailIdentityPolicyRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateEmailIdentityPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<CreateEmailIdentityPolicyRequest>(GetServiceRequestName(), *this);
    }
