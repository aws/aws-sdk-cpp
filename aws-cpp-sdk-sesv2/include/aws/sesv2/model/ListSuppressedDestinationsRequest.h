...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API ListSuppressedDestinationsRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSuppressedDestinationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSuppressedDestinationsRequest>(GetServiceRequestName(), *this);
    }
