...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API PutConfigurationSetVdmOptionsRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutConfigurationSetVdmOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<PutConfigurationSetVdmOptionsRequest>(GetServiceRequestName(), *this);
    }
