...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API CreateImportJobRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateImportJobRequest> Clone() const
    {
      return Aws::MakeUnique<CreateImportJobRequest>(GetServiceRequestName(), *this);
    }
