...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutEmailIdentityDkimSigningAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<PutEmailIdentityDkimSigningAttributesRequest>(GetServiceRequestName(), *this);
    }
