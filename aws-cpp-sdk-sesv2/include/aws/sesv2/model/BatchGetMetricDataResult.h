...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API BatchGetMetricDataResult
  {
  public:
    BatchGetMetricDataResult();
    BatchGetMetricDataResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    BatchGetMetricDataResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
