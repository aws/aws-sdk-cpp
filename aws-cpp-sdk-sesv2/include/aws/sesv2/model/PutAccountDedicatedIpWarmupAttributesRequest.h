...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API PutAccountDedicatedIpWarmupAttributesRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAccountDedicatedIpWarmupAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<PutAccountDedicatedIpWarmupAttributesRequest>(GetServiceRequestName(), *this);
    }
