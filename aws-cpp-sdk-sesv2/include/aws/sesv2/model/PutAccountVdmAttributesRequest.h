...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API PutAccountVdmAttributesRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAccountVdmAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<PutAccountVdmAttributesRequest>(GetServiceRequestName(), *this);
    }
