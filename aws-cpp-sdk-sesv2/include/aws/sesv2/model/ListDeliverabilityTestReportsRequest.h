...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API ListDeliverabilityTestReportsRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDeliverabilityTestReportsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDeliverabilityTestReportsRequest>(GetServiceRequestName(), *this);
    }
