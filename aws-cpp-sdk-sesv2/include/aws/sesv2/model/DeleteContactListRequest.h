...
namespace Model
{
  ...
  /**
   */
  class AWS_SESV2_API DeleteContactListRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteContactListRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteContactListRequest>(GetServiceRequestName(), *this);
    }
