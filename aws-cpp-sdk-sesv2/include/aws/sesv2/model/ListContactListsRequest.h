...
namespace Model
{
  ...
  /**
   */
  class AWS_SESV2_API ListContactListsRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListContactListsRequest> Clone() const
    {
      return Aws::MakeUnique<ListContactListsRequest>(GetServiceRequestName(), *this);
    }
