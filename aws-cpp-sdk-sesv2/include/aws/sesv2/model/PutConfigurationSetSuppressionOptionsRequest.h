...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutConfigurationSetSuppressionOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<PutConfigurationSetSuppressionOptionsRequest>(GetServiceRequestName(), *this);
    }
