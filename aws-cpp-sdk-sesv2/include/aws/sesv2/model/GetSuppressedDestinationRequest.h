...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API GetSuppressedDestinationRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSuppressedDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<GetSuppressedDestinationRequest>(GetServiceRequestName(), *this);
    }
