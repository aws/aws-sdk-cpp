...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API GetCustomVerificationEmailTemplateRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCustomVerificationEmailTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetCustomVerificationEmailTemplateRequest>(GetServiceRequestName(), *this);
    }
