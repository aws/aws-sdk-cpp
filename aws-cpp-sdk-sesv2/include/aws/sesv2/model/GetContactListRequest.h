...
namespace Model
{
  ...
  /**
   */
  class AWS_SESV2_API GetContactListRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetContactListRequest> Clone() const
    {
      return Aws::MakeUnique<GetContactListRequest>(GetServiceRequestName(), *this);
    }
