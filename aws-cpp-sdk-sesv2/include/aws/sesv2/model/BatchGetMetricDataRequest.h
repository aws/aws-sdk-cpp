...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API BatchGetMetricDataRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetMetricDataRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetMetricDataRequest>(GetServiceRequestName(), *this);
    }
