...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/sesv2-2019-09-27/GetConfigurationSetRequest">AWS
   * API Reference</a></p>
   */
  class AWS_SESV2_API GetConfigurationSetRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetConfigurationSetRequest> Clone() const
    {
      return Aws::MakeUnique<GetConfigurationSetRequest>(GetServiceRequestName(), *this);
    }
