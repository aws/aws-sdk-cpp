...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API UpdateEmailIdentityPolicyRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateEmailIdentityPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateEmailIdentityPolicyRequest>(GetServiceRequestName(), *this);
    }
