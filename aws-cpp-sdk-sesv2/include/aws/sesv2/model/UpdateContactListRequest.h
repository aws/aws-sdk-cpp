...
namespace Model
{
  ...
  /**
   */
  class AWS_SESV2_API UpdateContactListRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateContactListRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateContactListRequest>(GetServiceRequestName(), *this);
    }
