...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API UpdateEmailTemplateRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateEmailTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateEmailTemplateRequest>(GetServiceRequestName(), *this);
    }
