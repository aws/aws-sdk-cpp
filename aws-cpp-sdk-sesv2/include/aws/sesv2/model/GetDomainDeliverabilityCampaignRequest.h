...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDomainDeliverabilityCampaignRequest> Clone() const
    {
      return Aws::MakeUnique<GetDomainDeliverabilityCampaignRequest>(GetServiceRequestName(), *this);
    }
