...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API GetDedicatedIpRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDedicatedIpRequest> Clone() const
    {
      return Aws::MakeUnique<GetDedicatedIpRequest>(GetServiceRequestName(), *this);
    }
