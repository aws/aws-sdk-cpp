...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API PutEmailIdentityDkimAttributesRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutEmailIdentityDkimAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<PutEmailIdentityDkimAttributesRequest>(GetServiceRequestName(), *this);
    }
