...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API GetDeliverabilityDashboardOptionsRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDeliverabilityDashboardOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<GetDeliverabilityDashboardOptionsRequest>(GetServiceRequestName(), *this);
    }
