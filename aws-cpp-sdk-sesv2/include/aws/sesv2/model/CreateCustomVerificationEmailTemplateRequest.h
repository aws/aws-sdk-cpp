...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCustomVerificationEmailTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCustomVerificationEmailTemplateRequest>(GetServiceRequestName(), *this);
    }
