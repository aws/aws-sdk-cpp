...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutEmailIdentityMailFromAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<PutEmailIdentityMailFromAttributesRequest>(GetServiceRequestName(), *this);
    }
