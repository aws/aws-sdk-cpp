...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SESV2_API GetEmailIdentityPoliciesRequest : public SESV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEmailIdentityPoliciesRequest> Clone() const
    {
      return Aws::MakeUnique<GetEmailIdentityPoliciesRequest>(GetServiceRequestName(), *this);
    }
