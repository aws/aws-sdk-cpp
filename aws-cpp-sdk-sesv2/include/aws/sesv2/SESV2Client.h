...
namespace SESV2
{
  ...
  class AWS_SESV2_API SESV2Client : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SESV2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                    std::shared_ptr<Endpoint::SESV2EndpointProvider> endpointProvider = Aws::MakeShared<SESV2::Endpoint::SESV2EndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SESV2EndpointProvider> m_endpointProvider;
  };
