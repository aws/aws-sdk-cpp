...
Aws::String SESV2EndpointRules::GetRulesAsString()
{
    return Aws::String(SESV2EndpointRules::Rules.begin(), SESV2EndpointRules::Rules.end());
}

const Aws::Vector<char> SESV2EndpointRules::Rules = {
