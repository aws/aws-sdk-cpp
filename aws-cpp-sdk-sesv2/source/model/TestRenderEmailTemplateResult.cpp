...
TestRenderEmailTemplateResult::TestRenderEmailTemplateResult()
{
}

TestRenderEmailTemplateResult::TestRenderEmailTemplateResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
