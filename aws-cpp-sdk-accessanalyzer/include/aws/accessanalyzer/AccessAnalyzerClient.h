...
namespace AccessAnalyzer
{
  ...
  class AWS_ACCESSANALYZER_API AccessAnalyzerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AccessAnalyzerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::AccessAnalyzerEndpointProvider> endpointProvider = Aws::MakeShared<AccessAnalyzer::Endpoint::AccessAnalyzerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AccessAnalyzerEndpointProvider> m_endpointProvider;
  };
