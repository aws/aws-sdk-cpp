...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ACCESSANALYZER_API GetAnalyzerRequest : public AccessAnalyzerRequest
  {
  public:
    GetAnalyzerRequest();
    ...
    */
    virtual Aws::UniquePtr<GetAnalyzerRequest> Clone() const
    {
      return Aws::MakeUnique<GetAnalyzerRequest>(GetServiceRequestName(), *this);
    }
