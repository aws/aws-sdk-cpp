...
namespace Model
{
  ...
  /**
   * <p>Service quote met error.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class AWS_ACCESSANALYZER_API ServiceQuotaExceededException
  {
  public:
