...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ACCESSANALYZER_API RdsDbSnapshotConfiguration
  {
  public:
    RdsDbSnapshotConfiguration();
    RdsDbSnapshotConfiguration(Aws::Utils::Json::JsonView jsonValue);
    RdsDbSnapshotConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
