...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ACCESSANALYZER_API EcrRepositoryConfiguration
  {
  public:
    EcrRepositoryConfiguration();
    EcrRepositoryConfiguration(Aws::Utils::Json::JsonView jsonValue);
    EcrRepositoryConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
