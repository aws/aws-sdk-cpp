...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/ListTagsForResourceResponse">AWS
   * API Reference</a></p>
   */
  class AWS_ACCESSANALYZER_API ListTagsForResourceResult
  {
  public:
