...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ACCESSANALYZER_API ListArchiveRulesRequest : public AccessAnalyzerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListArchiveRulesRequest> Clone() const
    {
      return Aws::MakeUnique<ListArchiveRulesRequest>(GetServiceRequestName(), *this);
    }
