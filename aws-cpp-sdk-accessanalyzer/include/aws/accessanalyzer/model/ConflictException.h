...
namespace Model
{
  ...
  {
  public:
    AWS_ACCESSANALYZER_API ConflictException();
    AWS_ACCESSANALYZER_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_ACCESSANALYZER_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
