...
namespace Model
{
  ...
  /**
   */
  class AWS_ACCESSANALYZER_API CancelPolicyGenerationRequest : public AccessAnalyzerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelPolicyGenerationRequest> Clone() const
    {
      return Aws::MakeUnique<CancelPolicyGenerationRequest>(GetServiceRequestName(), *this);
    }
