...
namespace Model
{
  ...
  /**
   */
  class AWS_ACCESSANALYZER_API GetGeneratedPolicyRequest : public AccessAnalyzerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetGeneratedPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetGeneratedPolicyRequest>(GetServiceRequestName(), *this);
    }
