...
namespace Model
{
  ...
  /**
   */
  class AWS_ACCESSANALYZER_API ListAccessPreviewsRequest : public AccessAnalyzerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAccessPreviewsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAccessPreviewsRequest>(GetServiceRequestName(), *this);
    }
