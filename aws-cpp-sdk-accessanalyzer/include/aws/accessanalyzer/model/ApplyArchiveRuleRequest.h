...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ACCESSANALYZER_API ApplyArchiveRuleRequest : public AccessAnalyzerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ApplyArchiveRuleRequest> Clone() const
    {
      return Aws::MakeUnique<ApplyArchiveRuleRequest>(GetServiceRequestName(), *this);
    }
