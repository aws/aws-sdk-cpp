...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ACCESSANALYZER_API GetFindingRequest : public AccessAnalyzerRequest
  {
  public:
    GetFindingRequest();
    ...
    */
    virtual Aws::UniquePtr<GetFindingRequest> Clone() const
    {
      return Aws::MakeUnique<GetFindingRequest>(GetServiceRequestName(), *this);
    }
