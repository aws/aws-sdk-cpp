...
ValidatePolicyResult::ValidatePolicyResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ValidatePolicyResult& ValidatePolicyResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
