...
{
const size_t AccessAnalyzerEndpointRules::RulesBlobStrLen = 3489;
const size_t AccessAnalyzerEndpointRules::RulesBlobSize = 3490;

using RulesBlobT = Aws::Array<const char, AccessAnalyzerEndpointRules::RulesBlobSize>;
...
'a','n','a','l','y','z','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'h','t','t','p','s',':','/','/','a','c','c','e','s','s','-','a','n','a','l','y','z','e','r','-','f',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','a','c','c','e','s','s','-','a','n','a','l','y',
'z','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
...
's','"',':','[',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"',
'h','t','t','p','s',':','/','/','a','c','c','e','s','s','-','a','n','a','l','y','z','e','r','.','{',
...
const char* AccessAnalyzerEndpointRules::GetRulesBlob()
{
