...
Aws::String AccessAnalyzerEndpointRules::GetRulesAsString()
{
    return Aws::String(AccessAnalyzerEndpointRules::Rules.begin(), AccessAnalyzerEndpointRules::Rules.end());
}

const Aws::Vector<char> AccessAnalyzerEndpointRules::Rules = {
