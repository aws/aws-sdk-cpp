...
using ResolveEndpointOutcome = Aws::AccessAnalyzer::Endpoint::AccessAnalyzerEndpointProvider::AccessAnalyzerResolveEndpointOutcome;
...
AccessAnalyzerClient::AccessAnalyzerClient(const Client::ClientConfiguration& clientConfiguration,
                                           std::shared_ptr<Endpoint::AccessAnalyzerEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<AccessAnalyzerErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<AccessAnalyzer::Endpoint::AccessAnalyzerEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
