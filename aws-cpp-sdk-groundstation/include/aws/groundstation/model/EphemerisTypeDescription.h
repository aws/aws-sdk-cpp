...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GROUNDSTATION_API EphemerisTypeDescription
  {
  public:
    EphemerisTypeDescription();
    EphemerisTypeDescription(Aws::Utils::Json::JsonView jsonValue);
    EphemerisTypeDescription& operator=(Aws::Utils::Json::JsonView jsonValue);
