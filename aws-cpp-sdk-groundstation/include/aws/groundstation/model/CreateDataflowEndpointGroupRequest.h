...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDataflowEndpointGroupRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDataflowEndpointGroupRequest>(GetServiceRequestName(), *this);
    }
