...
namespace Model
{
  ...
  /**
   */
  class AWS_GROUNDSTATION_API DescribeEphemerisRequest : public GroundStationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEphemerisRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEphemerisRequest>(GetServiceRequestName(), *this);
    }
