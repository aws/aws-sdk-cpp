...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GROUNDSTATION_API GetDataflowEndpointGroupRequest : public GroundStationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDataflowEndpointGroupRequest> Clone() const
    {
      return Aws::MakeUnique<GetDataflowEndpointGroupRequest>(GetServiceRequestName(), *this);
    }
