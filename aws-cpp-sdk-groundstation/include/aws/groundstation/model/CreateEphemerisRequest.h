...
namespace Model
{
  ...
  /**
   */
  class AWS_GROUNDSTATION_API CreateEphemerisRequest : public GroundStationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateEphemerisRequest> Clone() const
    {
      return Aws::MakeUnique<CreateEphemerisRequest>(GetServiceRequestName(), *this);
    }
