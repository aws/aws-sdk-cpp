...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDataflowEndpointGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDataflowEndpointGroupRequest>(GetServiceRequestName(), *this);
    }
