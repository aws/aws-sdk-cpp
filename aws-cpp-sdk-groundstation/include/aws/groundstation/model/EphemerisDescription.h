...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GROUNDSTATION_API EphemerisDescription
  {
  public:
    EphemerisDescription();
    EphemerisDescription(Aws::Utils::Json::JsonView jsonValue);
    EphemerisDescription& operator=(Aws::Utils::Json::JsonView jsonValue);
