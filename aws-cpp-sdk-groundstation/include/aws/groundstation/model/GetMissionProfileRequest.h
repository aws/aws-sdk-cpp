...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GROUNDSTATION_API GetMissionProfileRequest : public GroundStationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMissionProfileRequest> Clone() const
    {
      return Aws::MakeUnique<GetMissionProfileRequest>(GetServiceRequestName(), *this);
    }
