...
namespace Model
{
  ...
  /**
   */
  class AWS_GROUNDSTATION_API ListEphemeridesRequest : public GroundStationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEphemeridesRequest> Clone() const
    {
      return Aws::MakeUnique<ListEphemeridesRequest>(GetServiceRequestName(), *this);
    }
