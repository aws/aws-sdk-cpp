...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GROUNDSTATION_API DeleteConfigRequest : public GroundStationRequest
  {
  public:
    DeleteConfigRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteConfigRequest>(GetServiceRequestName(), *this);
    }
