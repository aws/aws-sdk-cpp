...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GROUNDSTATION_API ListMissionProfilesRequest : public GroundStationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMissionProfilesRequest> Clone() const
    {
      return Aws::MakeUnique<ListMissionProfilesRequest>(GetServiceRequestName(), *this);
    }
