...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GROUNDSTATION_API GetConfigRequest : public GroundStationRequest
  {
  public:
    GetConfigRequest();
    ...
    */
    virtual Aws::UniquePtr<GetConfigRequest> Clone() const
    {
      return Aws::MakeUnique<GetConfigRequest>(GetServiceRequestName(), *this);
    }
