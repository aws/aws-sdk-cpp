...
namespace Model
{
  ...
  /**
   */
  class AWS_GROUNDSTATION_API UpdateEphemerisRequest : public GroundStationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateEphemerisRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateEphemerisRequest>(GetServiceRequestName(), *this);
    }
