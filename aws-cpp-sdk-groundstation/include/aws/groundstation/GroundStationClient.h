...
namespace GroundStation
{
  ...
  class AWS_GROUNDSTATION_API GroundStationClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        GroundStationClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::GroundStationEndpointProvider> endpointProvider = Aws::MakeShared<GroundStation::Endpoint::GroundStationEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::GroundStationEndpointProvider> m_endpointProvider;
  };
