...
Aws::String GroundStationEndpointRules::GetRulesAsString()
{
    return Aws::String(GroundStationEndpointRules::Rules.begin(), GroundStationEndpointRules::Rules.end());
}

const Aws::Vector<char> GroundStationEndpointRules::Rules = {
...
't','p','s',':','/','/','g','r','o','u','n','d','s','t','a','t','i','o','n','-','f','i','p','s','.',
...
'"','h','t','t','p','s',':','/','/','g','r','o','u','n','d','s','t','a','t','i','o','n','.','{','R',
