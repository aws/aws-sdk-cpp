...
using ResolveEndpointOutcome = Aws::GroundStation::Endpoint::GroundStationEndpointProvider::GroundStationResolveEndpointOutcome;
...
GroundStationClient::GroundStationClient(const Client::ClientConfiguration& clientConfiguration,
                                         std::shared_ptr<Endpoint::GroundStationEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<GroundStationErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<GroundStation::Endpoint::GroundStationEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
