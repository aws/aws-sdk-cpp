...
namespace AmplifyUIBuilder
{
  ...
  class AWS_AMPLIFYUIBUILDER_API AmplifyUIBuilderClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AmplifyUIBuilderClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::AmplifyUIBuilderEndpointProvider> endpointProvider = Aws::MakeShared<AmplifyUIBuilder::Endpoint::AmplifyUIBuilderEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AmplifyUIBuilderEndpointProvider> m_endpointProvider;
  };
