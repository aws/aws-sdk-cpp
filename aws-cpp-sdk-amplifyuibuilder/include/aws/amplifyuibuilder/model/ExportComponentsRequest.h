...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ExportComponentsRequest> Clone() const
    {
      return Aws::MakeUnique<ExportComponentsRequest>(GetServiceRequestName(), *this);
    }
     ...
     * <p>The token to request the next page of results.</p>
     */
    inline ExportComponentsRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}

    /**
     * <p>The token to request the next page of results.</p>
     */
    inline ExportComponentsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}

    /**
     * <p>The token to request the next page of results.</p>
     */
    inline ExportComponentsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
