...
namespace Model
{
  ...
  /**
   */
  class AWS_AMPLIFYUIBUILDER_API CreateFormRequest : public AmplifyUIBuilderRequest
  {
  public:
    CreateFormRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateFormRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFormRequest>(GetServiceRequestName(), *this);
    }
