...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYUIBUILDER_API FormDataTypeConfig
  {
  public:
    FormDataTypeConfig();
    FormDataTypeConfig(Aws::Utils::Json::JsonView jsonValue);
    FormDataTypeConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
