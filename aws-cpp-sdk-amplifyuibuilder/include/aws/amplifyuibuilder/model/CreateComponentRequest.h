...
namespace Model
{
  ...
  /**
   */
  class AWS_AMPLIFYUIBUILDER_API CreateComponentRequest : public AmplifyUIBuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateComponentRequest> Clone() const
    {
      return Aws::MakeUnique<CreateComponentRequest>(GetServiceRequestName(), *this);
    }
