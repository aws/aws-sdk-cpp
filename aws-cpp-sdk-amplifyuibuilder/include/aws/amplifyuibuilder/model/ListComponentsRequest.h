...
namespace Model
{
  ...
  /**
   */
  class ListComponentsRequest : public AmplifyUIBuilderRequest
  {
  public:
    AWS_AMPLIFYUIBUILDER_API ListComponentsRequest();
     ...
     * <p>The unique ID for the Amplify app.</p>
     */
    inline ListComponentsRequest& WithAppId(const Aws::String& value) { SetAppId(value); return *this;}

    /**
     * <p>The unique ID for the Amplify app.</p>
     */
    inline ListComponentsRequest& WithAppId(Aws::String&& value) { SetAppId(std::move(value)); return *this;}

    /**
     * <p>The unique ID for the Amplify app.</p>
     */
    inline ListComponentsRequest& WithAppId(const char* value) { SetAppId(value); return *this;}
