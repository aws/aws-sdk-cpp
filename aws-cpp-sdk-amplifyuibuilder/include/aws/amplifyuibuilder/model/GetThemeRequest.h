...
namespace Model
{
  ...
  /**
   */
  class AWS_AMPLIFYUIBUILDER_API GetThemeRequest : public AmplifyUIBuilderRequest
  {
  public:
    GetThemeRequest();
    ...
    */
    virtual Aws::UniquePtr<GetThemeRequest> Clone() const
    {
      return Aws::MakeUnique<GetThemeRequest>(GetServiceRequestName(), *this);
    }
