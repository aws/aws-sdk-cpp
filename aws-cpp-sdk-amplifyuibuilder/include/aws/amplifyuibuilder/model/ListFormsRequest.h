...
namespace Model
{
  ...
  /**
   */
  class AWS_AMPLIFYUIBUILDER_API ListFormsRequest : public AmplifyUIBuilderRequest
  {
  public:
    ListFormsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListFormsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFormsRequest>(GetServiceRequestName(), *this);
    }
