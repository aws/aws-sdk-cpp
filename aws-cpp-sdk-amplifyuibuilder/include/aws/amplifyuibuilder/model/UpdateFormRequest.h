...
namespace Model
{
  ...
  /**
   */
  class AWS_AMPLIFYUIBUILDER_API UpdateFormRequest : public AmplifyUIBuilderRequest
  {
  public:
    UpdateFormRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateFormRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFormRequest>(GetServiceRequestName(), *this);
    }
