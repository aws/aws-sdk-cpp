...
namespace Model
{
  ...
  /**
   */
  class AWS_AMPLIFYUIBUILDER_API PutMetadataFlagRequest : public AmplifyUIBuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutMetadataFlagRequest> Clone() const
    {
      return Aws::MakeUnique<PutMetadataFlagRequest>(GetServiceRequestName(), *this);
    }
