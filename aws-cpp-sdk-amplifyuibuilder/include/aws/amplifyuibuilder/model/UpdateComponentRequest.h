...
namespace Model
{
  ...
  /**
   */
  class AWS_AMPLIFYUIBUILDER_API UpdateComponentRequest : public AmplifyUIBuilderRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateComponentRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateComponentRequest>(GetServiceRequestName(), *this);
    }
