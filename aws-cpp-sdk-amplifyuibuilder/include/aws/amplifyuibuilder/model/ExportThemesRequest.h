...
namespace Model
{
  ...
  /**
   */
  class AWS_AMPLIFYUIBUILDER_API ExportThemesRequest : public AmplifyUIBuilderRequest
  {
  public:
    ExportThemesRequest();
    ...
    */
    virtual Aws::UniquePtr<ExportThemesRequest> Clone() const
    {
      return Aws::MakeUnique<ExportThemesRequest>(GetServiceRequestName(), *this);
    }
