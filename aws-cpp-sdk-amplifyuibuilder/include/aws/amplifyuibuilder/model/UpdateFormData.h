...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYUIBUILDER_API UpdateFormData
  {
  public:
    UpdateFormData();
    UpdateFormData(Aws::Utils::Json::JsonView jsonValue);
    UpdateFormData& operator=(Aws::Utils::Json::JsonView jsonValue);
