...
namespace Model
{
  ...
  /**
   */
  class AWS_AMPLIFYUIBUILDER_API ExportFormsRequest : public AmplifyUIBuilderRequest
  {
  public:
    ExportFormsRequest();
    ...
    */
    virtual Aws::UniquePtr<ExportFormsRequest> Clone() const
    {
      return Aws::MakeUnique<ExportFormsRequest>(GetServiceRequestName(), *this);
    }
