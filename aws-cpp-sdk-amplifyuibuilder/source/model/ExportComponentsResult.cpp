...
ExportComponentsResult::ExportComponentsResult()
{
}

ExportComponentsResult::ExportComponentsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ExportComponentsResult& ExportComponentsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
