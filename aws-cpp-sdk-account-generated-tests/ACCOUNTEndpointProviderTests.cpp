...
using AccountResolveEndpointOutcome = Aws::Account::Endpoint::AccountEndpointProvider::AccountResolveEndpointOutcome;
...
void ValidateOutcome(const AccountResolveEndpointOutcome& outcome, const AccountEndpointProviderEndpointTestCase::Expect& expect)
{
