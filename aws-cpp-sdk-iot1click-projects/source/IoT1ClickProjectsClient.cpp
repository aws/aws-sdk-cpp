...
using ResolveEndpointOutcome = Aws::IoT1ClickProjects::Endpoint::IoT1ClickProjectsEndpointProvider::IoT1ClickProjectsResolveEndpointOutcome;
...
IoT1ClickProjectsClient::IoT1ClickProjectsClient(const Client::ClientConfiguration& clientConfiguration,
                                                 std::shared_ptr<Endpoint::IoT1ClickProjectsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<IoT1ClickProjectsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<IoT1ClickProjects::Endpoint::IoT1ClickProjectsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
