...
Aws::String IoT1ClickProjectsEndpointRules::GetRulesAsString()
{
    return Aws::String(IoT1ClickProjectsEndpointRules::Rules.begin(), IoT1ClickProjectsEndpointRules::Rules.end());
}

const Aws::Vector<char> IoT1ClickProjectsEndpointRules::Rules = {
