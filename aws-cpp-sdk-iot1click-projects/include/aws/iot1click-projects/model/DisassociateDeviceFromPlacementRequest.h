...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateDeviceFromPlacementRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateDeviceFromPlacementRequest>(GetServiceRequestName(), *this);
    }
