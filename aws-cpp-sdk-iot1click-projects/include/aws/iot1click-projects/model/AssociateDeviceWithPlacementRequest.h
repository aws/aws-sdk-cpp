...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateDeviceWithPlacementRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateDeviceWithPlacementRequest>(GetServiceRequestName(), *this);
    }
