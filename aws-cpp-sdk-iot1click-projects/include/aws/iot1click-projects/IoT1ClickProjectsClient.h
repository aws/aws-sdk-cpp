...
namespace IoT1ClickProjects
{
  ...
  class AWS_IOT1CLICKPROJECTS_API IoT1ClickProjectsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IoT1ClickProjectsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                std::shared_ptr<Endpoint::IoT1ClickProjectsEndpointProvider> endpointProvider = Aws::MakeShared<IoT1ClickProjects::Endpoint::IoT1ClickProjectsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IoT1ClickProjectsEndpointProvider> m_endpointProvider;
  };
