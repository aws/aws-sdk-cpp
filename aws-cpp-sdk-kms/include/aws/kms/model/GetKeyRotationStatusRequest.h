...
namespace Model
{
  ...
  /**
   */
  class AWS_KMS_API GetKeyRotationStatusRequest : public KMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetKeyRotationStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetKeyRotationStatusRequest>(GetServiceRequestName(), *this);
    }
