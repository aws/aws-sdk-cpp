...
namespace Model
{
  ...
  /**
   */
  class AWS_KMS_API DeleteCustomKeyStoreRequest : public KMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCustomKeyStoreRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCustomKeyStoreRequest>(GetServiceRequestName(), *this);
    }
