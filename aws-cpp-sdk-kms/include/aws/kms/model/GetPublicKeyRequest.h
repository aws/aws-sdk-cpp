...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPublicKeyRequest> Clone() const
    {
      return Aws::MakeUnique<GetPublicKeyRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>Identifies the asymmetric KMS key that includes the public key.</p> <p>To
