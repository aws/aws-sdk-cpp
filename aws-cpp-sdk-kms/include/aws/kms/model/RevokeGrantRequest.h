...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>A unique identifier for the customer master key (CMK) associated with the
     * grant. To get the key ID and key ARN for a CMK, use <a>ListKeys</a> or
     * <a>DescribeKey</a>.</p> <p>Specify the key ID or key ARN of the CMK. To specify
     * a CMK in a different AWS account, you must use the key ARN.</p> <p>For
