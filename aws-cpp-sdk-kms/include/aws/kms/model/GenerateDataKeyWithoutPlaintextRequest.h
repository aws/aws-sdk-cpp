...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GenerateDataKeyWithoutPlaintextRequest> Clone() const
    {
      return Aws::MakeUnique<GenerateDataKeyWithoutPlaintextRequest>(GetServiceRequestName(), *this);
    }
