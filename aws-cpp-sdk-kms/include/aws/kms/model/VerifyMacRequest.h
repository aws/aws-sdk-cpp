...
namespace Model
{
  ...
  /**
   */
  class AWS_KMS_API VerifyMacRequest : public KMSRequest
  {
  public:
    VerifyMacRequest();
    ...
    */
    virtual Aws::UniquePtr<VerifyMacRequest> Clone() const
    {
      return Aws::MakeUnique<VerifyMacRequest>(GetServiceRequestName(), *this);
    }
