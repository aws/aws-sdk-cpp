...
namespace Model
{
  ...
  /**
   */
  class AWS_KMS_API UpdateKeyDescriptionRequest : public KMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateKeyDescriptionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateKeyDescriptionRequest>(GetServiceRequestName(), *this);
    }
