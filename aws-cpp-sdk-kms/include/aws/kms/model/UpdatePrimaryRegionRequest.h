...
namespace Model
{
  ...
  /**
   */
  class AWS_KMS_API UpdatePrimaryRegionRequest : public KMSRequest
  {
  public:
    ...
    /**
     * <p>Identifies the current primary key. When the operation completes, this CMK
     * will be a replica key.</p> <p>Specify the key ID or key ARN of a multi-Region
     * primary key.</p> <p>For example:</p> <ul> <li> <p>Key ID:
    ...
    /**
     * <p>The AWS Region of the new primary key. Enter the Region ID, such as
     * <code>us-east-1</code> or <code>ap-southeast-2</code>. There must be an existing
     * replica key in this Region. </p> <p>When the operation completes, the
