...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GenerateDataKeyPairWithoutPlaintextRequest> Clone() const
    {
      return Aws::MakeUnique<GenerateDataKeyPairWithoutPlaintextRequest>(GetServiceRequestName(), *this);
    }
