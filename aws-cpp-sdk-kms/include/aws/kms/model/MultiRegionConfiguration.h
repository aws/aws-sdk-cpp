...
namespace Model
{
  ...
  /**
   * <p>Describes the configuration of this multi-Region CMK. This field appears only
   * when the CMK is a primary or replica of a multi-Region CMK.</p> <p>For more
   * information about any listed CMK, use the <a>DescribeKey</a>
  ...
  public:
    ...
    /**
     * <p>Indicates whether the CMK is a <code>PRIMARY</code> or <code>REPLICA</code>
     * key.</p>
     */
     ...
     * current CMK if it is the primary key.</p>
     */
     ...
     * the current CMK if it is a replica key.</p>
     */
