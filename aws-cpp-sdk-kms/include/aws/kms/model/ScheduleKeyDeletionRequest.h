...
namespace Model
{
  ...
  public:
     ...
     * key with replicas, the waiting period begins when the last of its replica keys
     * is deleted. Otherwise, the waiting period begins immediately.</p> <p>This value
     * is optional. If you include a value, it must be between 7 and 30, inclusive. If
