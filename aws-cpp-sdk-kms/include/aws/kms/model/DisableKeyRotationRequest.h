...
namespace Model
{
  ...
  /**
   */
  class AWS_KMS_API DisableKeyRotationRequest : public KMSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableKeyRotationRequest> Clone() const
    {
      return Aws::MakeUnique<DisableKeyRotationRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DisableKeyRotation"; }
     ...
     * key store</a>.</p> <p>Specify the key ID or key ARN of the KMS key.</p> <p>For
     ...
     * <a>ListKeys</a> or <a>DescribeKey</a>.</p>
     */
    inline DisableKeyRotationRequest& WithKeyId(const char* value) { SetKeyId(value); return *this;}
