...
namespace KMS
{
  ...
  class AWS_KMS_API KMSClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        KMSClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::KMSEndpointProvider> endpointProvider = Aws::MakeShared<KMS::Endpoint::KMSEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::KMSEndpointProvider> m_endpointProvider;
  };
