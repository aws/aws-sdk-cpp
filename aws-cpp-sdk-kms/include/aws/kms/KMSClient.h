...
namespace Model
{
  ...
  typedef Aws::Utils::Event<KMSClient, const Model::CreateAliasRequest&, const Model::CreateAliasOutcome&> CreateAliasOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::CreateGrantRequest&, const Model::CreateGrantOutcome&> CreateGrantOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::CreateKeyRequest&, const Model::CreateKeyOutcome&> CreateKeyOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::DecryptRequest&, const Model::DecryptOutcome&> DecryptOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::DeleteAliasRequest&, const Model::DeleteAliasOutcome&> DeleteAliasOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::DescribeKeyRequest&, const Model::DescribeKeyOutcome&> DescribeKeyOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::DisableKeyRequest&, const Model::DisableKeyOutcome&> DisableKeyOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::DisableKeyRotationRequest&, const Model::DisableKeyRotationOutcome&> DisableKeyRotationOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::EnableKeyRequest&, const Model::EnableKeyOutcome&> EnableKeyOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::EnableKeyRotationRequest&, const Model::EnableKeyRotationOutcome&> EnableKeyRotationOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::EncryptRequest&, const Model::EncryptOutcome&> EncryptOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::GenerateDataKeyRequest&, const Model::GenerateDataKeyOutcome&> GenerateDataKeyOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::GenerateDataKeyWithoutPlaintextRequest&, const Model::GenerateDataKeyWithoutPlaintextOutcome&> GenerateDataKeyWithoutPlaintextOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::GenerateRandomRequest&, const Model::GenerateRandomOutcome&> GenerateRandomOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::GetKeyPolicyRequest&, const Model::GetKeyPolicyOutcome&> GetKeyPolicyOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::GetKeyRotationStatusRequest&, const Model::GetKeyRotationStatusOutcome&> GetKeyRotationStatusOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::ListAliasesRequest&, const Model::ListAliasesOutcome&> ListAliasesOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::ListGrantsRequest&, const Model::ListGrantsOutcome&> ListGrantsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::ListKeyPoliciesRequest&, const Model::ListKeyPoliciesOutcome&> ListKeyPoliciesOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::ListKeysRequest&, const Model::ListKeysOutcome&> ListKeysOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::PutKeyPolicyRequest&, const Model::PutKeyPolicyOutcome&> PutKeyPolicyOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::ReEncryptRequest&, const Model::ReEncryptOutcome&> ReEncryptOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::RetireGrantRequest&, const Model::RetireGrantOutcome&> RetireGrantOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::RevokeGrantRequest&, const Model::RevokeGrantOutcome&> RevokeGrantOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::UpdateAliasRequest&, const Model::UpdateAliasOutcome&> UpdateAliasOutcomeReceivedEvent;
  typedef Aws::Utils::Event<KMSClient, const Model::UpdateKeyDescriptionRequest&, const Model::UpdateKeyDescriptionOutcome&> UpdateKeyDescriptionOutcomeReceivedEvent;
  ...
  */
  class AWS_KMS_API KMSClient : public Aws::Client::AWSJsonClient
  {
     ...
     */
     void CreateAliasAsync(const Model::CreateAliasRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void CreateGrantAsync(const Model::CreateGrantRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void CreateKeyAsync(const Model::CreateKeyRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DecryptAsync(const Model::DecryptRequest& request) const;

     /*
       <p>Deletes the specified alias. To associate an alias with a different key, call <a>UpdateAlias</a>.</p>
     */
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DeleteAliasAsync(const Model::DeleteAliasRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribeKeyAsync(const Model::DescribeKeyRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DisableKeyAsync(const Model::DisableKeyRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DisableKeyRotationAsync(const Model::DisableKeyRotationRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void EnableKeyAsync(const Model::EnableKeyRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void EnableKeyRotationAsync(const Model::EnableKeyRotationRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void EncryptAsync(const Model::EncryptRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GenerateDataKeyAsync(const Model::GenerateDataKeyRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GenerateDataKeyWithoutPlaintextAsync(const Model::GenerateDataKeyWithoutPlaintextRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GenerateRandomAsync(const Model::GenerateRandomRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetKeyPolicyAsync(const Model::GetKeyPolicyRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetKeyRotationStatusAsync(const Model::GetKeyRotationStatusRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListAliasesAsync(const Model::ListAliasesRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListGrantsAsync(const Model::ListGrantsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListKeyPoliciesAsync(const Model::ListKeyPoliciesRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListKeysAsync(const Model::ListKeysRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void PutKeyPolicyAsync(const Model::PutKeyPolicyRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ReEncryptAsync(const Model::ReEncryptRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void RetireGrantAsync(const Model::RetireGrantRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void UpdateAliasAsync(const Model::UpdateAliasRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void UpdateKeyDescriptionAsync(const Model::UpdateKeyDescriptionRequest& request) const;
  ...
  private:
    ...
    /**Async helpers**/
    void CreateAliasAsyncHelper(const Model::CreateAliasRequest& request) const;
    void CreateGrantAsyncHelper(const Model::CreateGrantRequest& request) const;
    void CreateKeyAsyncHelper(const Model::CreateKeyRequest& request) const;
    void DecryptAsyncHelper(const Model::DecryptRequest& request) const;
    void DeleteAliasAsyncHelper(const Model::DeleteAliasRequest& request) const;
    void DescribeKeyAsyncHelper(const Model::DescribeKeyRequest& request) const;
    void DisableKeyAsyncHelper(const Model::DisableKeyRequest& request) const;
    void DisableKeyRotationAsyncHelper(const Model::DisableKeyRotationRequest& request) const;
    void EnableKeyAsyncHelper(const Model::EnableKeyRequest& request) const;
    void EnableKeyRotationAsyncHelper(const Model::EnableKeyRotationRequest& request) const;
    void EncryptAsyncHelper(const Model::EncryptRequest& request) const;
    void GenerateDataKeyAsyncHelper(const Model::GenerateDataKeyRequest& request) const;
    void GenerateDataKeyWithoutPlaintextAsyncHelper(const Model::GenerateDataKeyWithoutPlaintextRequest& request) const;
    void GenerateRandomAsyncHelper(const Model::GenerateRandomRequest& request) const;
    void GetKeyPolicyAsyncHelper(const Model::GetKeyPolicyRequest& request) const;
    void GetKeyRotationStatusAsyncHelper(const Model::GetKeyRotationStatusRequest& request) const;
    void ListAliasesAsyncHelper(const Model::ListAliasesRequest& request) const;
    void ListGrantsAsyncHelper(const Model::ListGrantsRequest& request) const;
    void ListKeyPoliciesAsyncHelper(const Model::ListKeyPoliciesRequest& request) const;
    void ListKeysAsyncHelper(const Model::ListKeysRequest& request) const;
    void PutKeyPolicyAsyncHelper(const Model::PutKeyPolicyRequest& request) const;
    void ReEncryptAsyncHelper(const Model::ReEncryptRequest& request) const;
    void RetireGrantAsyncHelper(const Model::RetireGrantRequest& request) const;
    void RevokeGrantAsyncHelper(const Model::RevokeGrantRequest& request) const;
    void UpdateAliasAsyncHelper(const Model::UpdateAliasRequest& request) const;
    void UpdateKeyDescriptionAsyncHelper(const Model::UpdateKeyDescriptionRequest& request) const;
