...
Aws::String KMSEndpointRules::GetRulesAsString()
{
    return Aws::String(KMSEndpointRules::Rules.begin(), KMSEndpointRules::Rules.end());
}

const Aws::Vector<char> KMSEndpointRules::Rules = {
...
't','t','p','s',':','/','/','k','m','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
':','"','h','t','t','p','s',':','/','/','k','m','s','-','f','i','p','s','.','{','R','e','g','i','o',
...
':','/','/','k','m','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
