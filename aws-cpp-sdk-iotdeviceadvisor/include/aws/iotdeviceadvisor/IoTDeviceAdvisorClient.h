...
namespace IoTDeviceAdvisor
{
  ...
  class AWS_IOTDEVICEADVISOR_API IoTDeviceAdvisorClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IoTDeviceAdvisorClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::IoTDeviceAdvisorEndpointProvider> endpointProvider = Aws::MakeShared<IoTDeviceAdvisor::Endpoint::IoTDeviceAdvisorEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IoTDeviceAdvisorEndpointProvider> m_endpointProvider;
  };
