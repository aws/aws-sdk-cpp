...
namespace Model
{
  class AWS_IOTDEVICEADVISOR_API GetSuiteRunResult
  {
  public:
    GetSuiteRunResult();
    GetSuiteRunResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetSuiteRunResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);


    /**
     * <p>Gets the information about Device Advisor test suite run based on suite
     * definition Id.</p>
     */
    ...
    /**
     * <p>Gets the information about Device Advisor test suite run based on suite run
     * Id.</p>
     */
    ...
    /**
     * <p>Gets the information about Device Advisor test suite run based on test case
     * runs.</p>
     */
    ...
    /**
     * <p>Gets the information about Device Advisor test suite run based on start
     * time.</p>
     */
    ...
    /**
     * <p>Gets the information about Device Advisor test suite run based on end
     * time.</p>
     */
    ...
    /**
     * <p>Gets the information about Device Advisor test suite run based on its
     * status.</p>
     */
