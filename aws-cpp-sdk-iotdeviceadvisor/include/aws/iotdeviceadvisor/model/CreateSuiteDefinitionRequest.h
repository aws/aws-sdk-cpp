...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTDEVICEADVISOR_API CreateSuiteDefinitionRequest : public IoTDeviceAdvisorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSuiteDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSuiteDefinitionRequest>(GetServiceRequestName(), *this);
    }
