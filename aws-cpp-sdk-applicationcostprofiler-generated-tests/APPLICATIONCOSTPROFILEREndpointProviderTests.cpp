...
using ApplicationCostProfilerResolveEndpointOutcome = Aws::ApplicationCostProfiler::Endpoint::ApplicationCostProfilerEndpointProvider::ApplicationCostProfilerResolveEndpointOutcome;
...
void ValidateOutcome(const ApplicationCostProfilerResolveEndpointOutcome& outcome, const ApplicationCostProfilerEndpointProviderEndpointTestCase::Expect& expect)
{
