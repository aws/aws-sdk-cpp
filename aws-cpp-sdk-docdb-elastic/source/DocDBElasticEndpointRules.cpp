...
Aws::String DocDBElasticEndpointRules::GetRulesAsString()
{
    return Aws::String(DocDBElasticEndpointRules::Rules.begin(), DocDBElasticEndpointRules::Rules.end());
}

const Aws::Vector<char> DocDBElasticEndpointRules::Rules = {
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','o','c','d','b','-','e','l','a',
's','t','i','c','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
