...
namespace Panorama
{
  ...
  class AWS_PANORAMA_API PanoramaClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        PanoramaClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::PanoramaEndpointProvider> endpointProvider = Aws::MakeShared<Panorama::Endpoint::PanoramaEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::PanoramaEndpointProvider> m_endpointProvider;
  };
