...
namespace Model
{
  ...
  /**
   */
  class AWS_PANORAMA_API ListApplicationInstancesRequest : public PanoramaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListApplicationInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<ListApplicationInstancesRequest>(GetServiceRequestName(), *this);
    }
