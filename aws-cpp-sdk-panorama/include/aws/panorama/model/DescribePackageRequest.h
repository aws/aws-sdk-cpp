...
namespace Model
{
  ...
  /**
   */
  class AWS_PANORAMA_API DescribePackageRequest : public PanoramaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePackageRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePackageRequest>(GetServiceRequestName(), *this);
    }
