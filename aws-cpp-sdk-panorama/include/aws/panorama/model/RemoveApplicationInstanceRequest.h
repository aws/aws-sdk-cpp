...
namespace Model
{
  ...
  /**
   */
  class AWS_PANORAMA_API RemoveApplicationInstanceRequest : public PanoramaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveApplicationInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveApplicationInstanceRequest>(GetServiceRequestName(), *this);
    }
