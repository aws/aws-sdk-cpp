...
namespace Model
{
  ...
  /**
   */
  class AWS_PANORAMA_API DescribePackageVersionRequest : public PanoramaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePackageVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePackageVersionRequest>(GetServiceRequestName(), *this);
    }
