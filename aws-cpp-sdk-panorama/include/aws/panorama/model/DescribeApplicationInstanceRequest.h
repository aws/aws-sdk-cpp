...
namespace Model
{
  ...
  /**
   */
  class AWS_PANORAMA_API DescribeApplicationInstanceRequest : public PanoramaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeApplicationInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeApplicationInstanceRequest>(GetServiceRequestName(), *this);
    }
