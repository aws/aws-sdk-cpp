...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListApplicationInstanceDependenciesRequest> Clone() const
    {
      return Aws::MakeUnique<ListApplicationInstanceDependenciesRequest>(GetServiceRequestName(), *this);
    }
