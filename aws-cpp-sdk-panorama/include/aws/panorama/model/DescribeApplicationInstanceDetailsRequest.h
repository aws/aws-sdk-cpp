...
namespace Model
{
  ...
  /**
   */
  class AWS_PANORAMA_API DescribeApplicationInstanceDetailsRequest : public PanoramaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeApplicationInstanceDetailsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeApplicationInstanceDetailsRequest>(GetServiceRequestName(), *this);
    }
