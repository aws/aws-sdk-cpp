...
namespace Model
{
  ...
  /**
   */
  class AWS_PANORAMA_API ListApplicationInstanceNodeInstancesRequest : public PanoramaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListApplicationInstanceNodeInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<ListApplicationInstanceNodeInstancesRequest>(GetServiceRequestName(), *this);
    }
