...
namespace Model
{
  ...
  /**
   */
  class AWS_PANORAMA_API SignalApplicationInstanceNodeInstancesRequest : public PanoramaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SignalApplicationInstanceNodeInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<SignalApplicationInstanceNodeInstancesRequest>(GetServiceRequestName(), *this);
    }
