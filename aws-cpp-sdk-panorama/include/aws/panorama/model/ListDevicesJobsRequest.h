...
namespace Model
{
  ...
  /**
   */
  class AWS_PANORAMA_API ListDevicesJobsRequest : public PanoramaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDevicesJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDevicesJobsRequest>(GetServiceRequestName(), *this);
    }
