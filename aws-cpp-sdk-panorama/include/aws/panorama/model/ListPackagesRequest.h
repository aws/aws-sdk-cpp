...
namespace Model
{
  ...
  /**
   */
  class AWS_PANORAMA_API ListPackagesRequest : public PanoramaRequest
  {
  public:
    ListPackagesRequest();
    ...
    */
    virtual Aws::UniquePtr<ListPackagesRequest> Clone() const
    {
      return Aws::MakeUnique<ListPackagesRequest>(GetServiceRequestName(), *this);
    }
