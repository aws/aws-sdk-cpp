...
namespace Panorama
{
const size_t PanoramaEndpointRules::RulesBlobStrLen = 3358;
const size_t PanoramaEndpointRules::RulesBlobSize = 3359;
...
't','t','p','s',':','/','/','p','a','n','o','r','a','m','a','-','f','i','p','s','.','{','R','e','g',
...
'p','a','n','o','r','a','m','a','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
