...
namespace Proton
{
  ...
  class AWS_PROTON_API ProtonClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ProtonClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                     std::shared_ptr<Endpoint::ProtonEndpointProvider> endpointProvider = Aws::MakeShared<Proton::Endpoint::ProtonEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ProtonEndpointProvider> m_endpointProvider;
  };
