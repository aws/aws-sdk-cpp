...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API CancelComponentDeploymentRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelComponentDeploymentRequest> Clone() const
    {
      return Aws::MakeUnique<CancelComponentDeploymentRequest>(GetServiceRequestName(), *this);
    }
