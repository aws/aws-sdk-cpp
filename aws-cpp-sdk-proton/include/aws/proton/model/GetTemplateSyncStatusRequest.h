...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API GetTemplateSyncStatusRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTemplateSyncStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetTemplateSyncStatusRequest>(GetServiceRequestName(), *this);
    }
