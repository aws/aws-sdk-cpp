...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateEnvironmentAccountConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateEnvironmentAccountConnectionRequest>(GetServiceRequestName(), *this);
    }
