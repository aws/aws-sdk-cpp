...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API UpdateServiceRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateServiceRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateServiceRequest>(GetServiceRequestName(), *this);
    }
