...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelServicePipelineDeploymentRequest> Clone() const
    {
      return Aws::MakeUnique<CancelServicePipelineDeploymentRequest>(GetServiceRequestName(), *this);
    }
