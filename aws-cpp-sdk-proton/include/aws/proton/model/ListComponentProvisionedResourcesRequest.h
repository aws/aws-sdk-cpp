...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API ListComponentProvisionedResourcesRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListComponentProvisionedResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListComponentProvisionedResourcesRequest>(GetServiceRequestName(), *this);
    }
