...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEnvironmentTemplateVersionRequest> Clone() const
    {
      return Aws::MakeUnique<GetEnvironmentTemplateVersionRequest>(GetServiceRequestName(), *this);
    }
