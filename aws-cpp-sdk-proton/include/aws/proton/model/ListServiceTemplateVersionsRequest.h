...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API ListServiceTemplateVersionsRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListServiceTemplateVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListServiceTemplateVersionsRequest>(GetServiceRequestName(), *this);
    }
