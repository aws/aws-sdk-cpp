...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API ListServiceInstancesRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListServiceInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<ListServiceInstancesRequest>(GetServiceRequestName(), *this);
    }
