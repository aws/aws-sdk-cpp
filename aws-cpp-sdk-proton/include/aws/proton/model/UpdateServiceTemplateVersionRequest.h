...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateServiceTemplateVersionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateServiceTemplateVersionRequest>(GetServiceRequestName(), *this);
    }
