...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API UpdateServiceInstanceRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateServiceInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateServiceInstanceRequest>(GetServiceRequestName(), *this);
    }
