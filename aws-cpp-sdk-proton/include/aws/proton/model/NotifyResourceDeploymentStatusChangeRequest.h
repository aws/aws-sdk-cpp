...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API NotifyResourceDeploymentStatusChangeRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<NotifyResourceDeploymentStatusChangeRequest> Clone() const
    {
      return Aws::MakeUnique<NotifyResourceDeploymentStatusChangeRequest>(GetServiceRequestName(), *this);
    }
