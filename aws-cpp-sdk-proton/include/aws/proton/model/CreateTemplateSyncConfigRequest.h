...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API CreateTemplateSyncConfigRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTemplateSyncConfigRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTemplateSyncConfigRequest>(GetServiceRequestName(), *this);
    }
