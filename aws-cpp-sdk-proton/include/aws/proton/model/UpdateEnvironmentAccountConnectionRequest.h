...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateEnvironmentAccountConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateEnvironmentAccountConnectionRequest>(GetServiceRequestName(), *this);
    }
