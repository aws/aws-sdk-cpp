...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API DeleteTemplateSyncConfigRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTemplateSyncConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTemplateSyncConfigRequest>(GetServiceRequestName(), *this);
    }
