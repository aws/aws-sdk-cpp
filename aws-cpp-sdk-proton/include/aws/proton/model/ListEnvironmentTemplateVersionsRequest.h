...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEnvironmentTemplateVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListEnvironmentTemplateVersionsRequest>(GetServiceRequestName(), *this);
    }
