...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RejectEnvironmentAccountConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<RejectEnvironmentAccountConnectionRequest>(GetServiceRequestName(), *this);
    }
