...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API GetEnvironmentAccountConnectionRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEnvironmentAccountConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<GetEnvironmentAccountConnectionRequest>(GetServiceRequestName(), *this);
    }
