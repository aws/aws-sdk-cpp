...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API UpdateServicePipelineRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateServicePipelineRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateServicePipelineRequest>(GetServiceRequestName(), *this);
    }
