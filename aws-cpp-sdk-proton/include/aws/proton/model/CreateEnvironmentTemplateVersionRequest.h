...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API CreateEnvironmentTemplateVersionRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateEnvironmentTemplateVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateEnvironmentTemplateVersionRequest>(GetServiceRequestName(), *this);
    }
