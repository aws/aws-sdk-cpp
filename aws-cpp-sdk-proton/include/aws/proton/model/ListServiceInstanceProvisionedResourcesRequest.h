...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API ListServiceInstanceProvisionedResourcesRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListServiceInstanceProvisionedResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListServiceInstanceProvisionedResourcesRequest>(GetServiceRequestName(), *this);
    }
