...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API ListRepositorySyncDefinitionsRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRepositorySyncDefinitionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListRepositorySyncDefinitionsRequest>(GetServiceRequestName(), *this);
    }
