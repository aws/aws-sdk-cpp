...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API CancelEnvironmentDeploymentRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelEnvironmentDeploymentRequest> Clone() const
    {
      return Aws::MakeUnique<CancelEnvironmentDeploymentRequest>(GetServiceRequestName(), *this);
    }
