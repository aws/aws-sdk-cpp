...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API GetServiceInstanceRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetServiceInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<GetServiceInstanceRequest>(GetServiceRequestName(), *this);
    }
