...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API ListEnvironmentOutputsRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEnvironmentOutputsRequest> Clone() const
    {
      return Aws::MakeUnique<ListEnvironmentOutputsRequest>(GetServiceRequestName(), *this);
    }
