...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API UpdateTemplateSyncConfigRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTemplateSyncConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTemplateSyncConfigRequest>(GetServiceRequestName(), *this);
    }
