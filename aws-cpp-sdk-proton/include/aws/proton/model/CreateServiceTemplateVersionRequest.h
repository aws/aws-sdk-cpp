...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateServiceTemplateVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateServiceTemplateVersionRequest>(GetServiceRequestName(), *this);
    }
