...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelServiceInstanceDeploymentRequest> Clone() const
    {
      return Aws::MakeUnique<CancelServiceInstanceDeploymentRequest>(GetServiceRequestName(), *this);
    }
