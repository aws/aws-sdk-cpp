...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEnvironmentTemplateVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEnvironmentTemplateVersionRequest>(GetServiceRequestName(), *this);
    }
