...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteServiceTemplateVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteServiceTemplateVersionRequest>(GetServiceRequestName(), *this);
    }
