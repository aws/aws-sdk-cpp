...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEnvironmentProvisionedResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListEnvironmentProvisionedResourcesRequest>(GetServiceRequestName(), *this);
    }
