...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEnvironmentAccountConnectionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListEnvironmentAccountConnectionsRequest>(GetServiceRequestName(), *this);
    }
