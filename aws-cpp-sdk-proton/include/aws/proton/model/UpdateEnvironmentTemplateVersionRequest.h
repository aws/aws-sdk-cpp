...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API UpdateEnvironmentTemplateVersionRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateEnvironmentTemplateVersionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateEnvironmentTemplateVersionRequest>(GetServiceRequestName(), *this);
    }
