...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API ListServicePipelineOutputsRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListServicePipelineOutputsRequest> Clone() const
    {
      return Aws::MakeUnique<ListServicePipelineOutputsRequest>(GetServiceRequestName(), *this);
    }
