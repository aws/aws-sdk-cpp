...
namespace Model
{
  ...
  /**
   */
  class AWS_PROTON_API ListServicePipelineProvisionedResourcesRequest : public ProtonRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListServicePipelineProvisionedResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListServicePipelineProvisionedResourcesRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListServicePipelineProvisionedResources"; }
     ...
     * previously requested.</p>
     */
    inline ListServicePipelineProvisionedResourcesRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
