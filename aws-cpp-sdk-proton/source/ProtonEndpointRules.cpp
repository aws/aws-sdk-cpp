...
Aws::String ProtonEndpointRules::GetRulesAsString()
{
    return Aws::String(ProtonEndpointRules::Rules.begin(), ProtonEndpointRules::Rules.end());
}

const Aws::Vector<char> ProtonEndpointRules::Rules = {
...
'p','r','o','t','o','n','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
't','t','p','s',':','/','/','p','r','o','t','o','n','.','{','R','e','g','i','o','n','}','.','{','P',
