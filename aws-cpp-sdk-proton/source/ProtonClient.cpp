...
using ResolveEndpointOutcome = Aws::Proton::Endpoint::ProtonEndpointProvider::ProtonResolveEndpointOutcome;
...
ProtonClient::ProtonClient(const Client::ClientConfiguration& clientConfiguration,
                           std::shared_ptr<Endpoint::ProtonEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ProtonErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Proton::Endpoint::ProtonEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
