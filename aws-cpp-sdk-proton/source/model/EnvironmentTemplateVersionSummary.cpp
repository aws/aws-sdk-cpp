...
EnvironmentTemplateVersionSummary::EnvironmentTemplateVersionSummary(JsonView jsonValue) : 
    m_arnHasBeenSet(false),
    m_createdAtHasBeenSet(false),
    m_descriptionHasBeenSet(false),
    m_lastModifiedAtHasBeenSet(false),
...
EnvironmentTemplateVersionSummary& EnvironmentTemplateVersionSummary::operator =(JsonView jsonValue)
{
...
JsonValue EnvironmentTemplateVersionSummary::Jsonize() const
{
  JsonValue payload;
