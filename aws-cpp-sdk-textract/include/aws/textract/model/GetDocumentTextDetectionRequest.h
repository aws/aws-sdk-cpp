...
namespace Model
{
  ...
  /**
   */
  class AWS_TEXTRACT_API GetDocumentTextDetectionRequest : public TextractRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDocumentTextDetectionRequest> Clone() const
    {
      return Aws::MakeUnique<GetDocumentTextDetectionRequest>(GetServiceRequestName(), *this);
    }
