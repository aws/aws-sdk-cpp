...
namespace Model
{
  ...
  /**
   */
  class AWS_TEXTRACT_API GetExpenseAnalysisRequest : public TextractRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetExpenseAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<GetExpenseAnalysisRequest>(GetServiceRequestName(), *this);
    }
     ...
     * only valid for 7 days.</p>
     */
    inline GetExpenseAnalysisRequest& WithJobId(const Aws::String& value) { SetJobId(value); return *this;}
     ...
     * only valid for 7 days.</p>
     */
    inline GetExpenseAnalysisRequest& WithJobId(Aws::String&& value) { SetJobId(std::move(value)); return *this;}
     ...
     * only valid for 7 days.</p>
     */
    inline GetExpenseAnalysisRequest& WithJobId(const char* value) { SetJobId(value); return *this;}
     ...
     * use this pagination token to retrieve the next set of blocks.</p>
     */
    inline GetExpenseAnalysisRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
     ...
     * use this pagination token to retrieve the next set of blocks.</p>
     */
    inline GetExpenseAnalysisRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
     ...
     * use this pagination token to retrieve the next set of blocks.</p>
     */
    inline GetExpenseAnalysisRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
