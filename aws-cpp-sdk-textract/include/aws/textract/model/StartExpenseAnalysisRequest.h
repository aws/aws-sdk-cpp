...
namespace Model
{
  ...
  /**
   */
  class AWS_TEXTRACT_API StartExpenseAnalysisRequest : public TextractRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartExpenseAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<StartExpenseAnalysisRequest>(GetServiceRequestName(), *this);
    }
