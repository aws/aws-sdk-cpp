...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_TEXTRACT_API SignatureDetection
  {
  public:
    SignatureDetection();
    SignatureDetection(Aws::Utils::Json::JsonView jsonValue);
    SignatureDetection& operator=(Aws::Utils::Json::JsonView jsonValue);
