...
namespace Model
{
  ...
  /**
   */
  class AWS_TEXTRACT_API AnalyzeIDRequest : public TextractRequest
  {
  public:
    AnalyzeIDRequest();
    ...
    */
    virtual Aws::UniquePtr<AnalyzeIDRequest> Clone() const
    {
      return Aws::MakeUnique<AnalyzeIDRequest>(GetServiceRequestName(), *this);
    }
