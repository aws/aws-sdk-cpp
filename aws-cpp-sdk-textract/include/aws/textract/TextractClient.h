...
namespace Textract
{
  ...
  class AWS_TEXTRACT_API TextractClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        TextractClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::TextractEndpointProvider> endpointProvider = Aws::MakeShared<Textract::Endpoint::TextractEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::TextractEndpointProvider> m_endpointProvider;
  };
