...
using ResolveEndpointOutcome = Aws::Textract::Endpoint::TextractEndpointProvider::TextractResolveEndpointOutcome;
...
TextractClient::TextractClient(const Client::ClientConfiguration& clientConfiguration,
                               std::shared_ptr<Endpoint::TextractEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<TextractErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Textract::Endpoint::TextractEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
