...
Aws::String TextractEndpointRules::GetRulesAsString()
{
    return Aws::String(TextractEndpointRules::Rules.begin(), TextractEndpointRules::Rules.end());
}

const Aws::Vector<char> TextractEndpointRules::Rules = {
