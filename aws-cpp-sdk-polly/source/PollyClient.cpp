...
{
  AWS_MAKE_CALLABLE_OPERATION(DeleteLexicon, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DeleteLexicon, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DescribeVoices, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DescribeVoices, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(GetLexicon, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(GetLexicon, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(GetSpeechSynthesisTask, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(GetSpeechSynthesisTask, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListLexicons, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListLexicons, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListSpeechSynthesisTasks, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListSpeechSynthesisTasks, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(PutLexicon, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(PutLexicon, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(StartSpeechSynthesisTask, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(StartSpeechSynthesisTask, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(SynthesizeSpeech, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(SynthesizeSpeech, request, handler, context, m_executor.get());
}
