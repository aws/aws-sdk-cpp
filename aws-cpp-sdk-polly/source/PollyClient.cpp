...
using ResolveEndpointOutcome = Aws::Polly::Endpoint::PollyEndpointProvider::PollyResolveEndpointOutcome;
...
PollyClient::PollyClient(const Client::ClientConfiguration& clientConfiguration,
                         std::shared_ptr<Endpoint::PollyEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<PollyErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Polly::Endpoint::PollyEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
