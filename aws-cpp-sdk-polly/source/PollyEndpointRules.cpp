...
Aws::String PollyEndpointRules::GetRulesAsString()
{
    return Aws::String(PollyEndpointRules::Rules.begin(), PollyEndpointRules::Rules.end());
}

const Aws::Vector<char> PollyEndpointRules::Rules = {
...
'o','l','l','y','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
