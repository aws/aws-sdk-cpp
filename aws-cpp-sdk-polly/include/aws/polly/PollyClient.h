...
namespace Polly
{
  ...
  class AWS_POLLY_API PollyClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        PollyClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                    std::shared_ptr<Endpoint::PollyEndpointProvider> endpointProvider = Aws::MakeShared<Polly::Endpoint::PollyEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::PollyEndpointProvider> m_endpointProvider;
  };
