...
GetFolderResult::GetFolderResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetFolderResult& GetFolderResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
