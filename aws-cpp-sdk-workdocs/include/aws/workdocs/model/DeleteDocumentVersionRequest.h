...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKDOCS_API DeleteDocumentVersionRequest : public WorkDocsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDocumentVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDocumentVersionRequest>(GetServiceRequestName(), *this);
    }
