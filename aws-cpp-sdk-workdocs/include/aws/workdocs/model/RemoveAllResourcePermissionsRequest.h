...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveAllResourcePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveAllResourcePermissionsRequest>(GetServiceRequestName(), *this);
    }
