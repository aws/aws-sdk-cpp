...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNotificationSubscriptionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNotificationSubscriptionsRequest>(GetServiceRequestName(), *this);
    }
