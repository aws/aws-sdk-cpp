...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<InitiateDocumentVersionUploadRequest> Clone() const
    {
      return Aws::MakeUnique<InitiateDocumentVersionUploadRequest>(GetServiceRequestName(), *this);
    }
