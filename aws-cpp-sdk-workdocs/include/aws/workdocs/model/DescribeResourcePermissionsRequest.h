...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeResourcePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeResourcePermissionsRequest>(GetServiceRequestName(), *this);
    }
