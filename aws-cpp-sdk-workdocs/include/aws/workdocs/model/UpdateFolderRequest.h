...
namespace Model
{
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "UpdateFolder"; }
    ...
    /**
     * <p>The resource state of the folder. Note that only ACTIVE and RECYCLED are
     * accepted values from the API.</p>
     */
