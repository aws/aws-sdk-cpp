...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteNotificationSubscriptionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteNotificationSubscriptionRequest>(GetServiceRequestName(), *this);
    }
