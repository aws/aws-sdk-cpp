...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateNotificationSubscriptionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateNotificationSubscriptionRequest>(GetServiceRequestName(), *this);
    }
