...
using ProtonResolveEndpointOutcome = Aws::Proton::Endpoint::ProtonEndpointProvider::ProtonResolveEndpointOutcome;
...
void ValidateOutcome(const ProtonResolveEndpointOutcome& outcome, const ProtonEndpointProviderEndpointTestCase::Expect& expect)
{
