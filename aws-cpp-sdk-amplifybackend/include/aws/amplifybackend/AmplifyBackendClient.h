...
namespace AmplifyBackend
{
  ...
  class AWS_AMPLIFYBACKEND_API AmplifyBackendClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AmplifyBackendClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::AmplifyBackendEndpointProvider> endpointProvider = Aws::MakeShared<AmplifyBackend::Endpoint::AmplifyBackendEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AmplifyBackendEndpointProvider> m_endpointProvider;
  };
