...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API GetBackendStorageRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBackendStorageRequest> Clone() const
    {
      return Aws::MakeUnique<GetBackendStorageRequest>(GetServiceRequestName(), *this);
    }
