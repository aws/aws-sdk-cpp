...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API CreateBackendConfigRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateBackendConfigRequest> Clone() const
    {
      return Aws::MakeUnique<CreateBackendConfigRequest>(GetServiceRequestName(), *this);
    }
