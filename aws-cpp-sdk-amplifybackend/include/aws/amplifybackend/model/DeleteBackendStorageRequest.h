...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API DeleteBackendStorageRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBackendStorageRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBackendStorageRequest>(GetServiceRequestName(), *this);
    }
