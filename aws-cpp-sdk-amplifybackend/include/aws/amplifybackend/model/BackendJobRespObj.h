...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API BackendJobRespObj
  {
  public:
    BackendJobRespObj();
    BackendJobRespObj(Aws::Utils::Json::JsonView jsonValue);
    BackendJobRespObj& operator=(Aws::Utils::Json::JsonView jsonValue);
