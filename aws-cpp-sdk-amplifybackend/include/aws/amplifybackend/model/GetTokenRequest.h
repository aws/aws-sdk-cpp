...
namespace Model
{
  ...
  /**
   */
  class AWS_AMPLIFYBACKEND_API GetTokenRequest : public AmplifyBackendRequest
  {
  public:
    GetTokenRequest();
    ...
    */
    virtual Aws::UniquePtr<GetTokenRequest> Clone() const
    {
      return Aws::MakeUnique<GetTokenRequest>(GetServiceRequestName(), *this);
    }
