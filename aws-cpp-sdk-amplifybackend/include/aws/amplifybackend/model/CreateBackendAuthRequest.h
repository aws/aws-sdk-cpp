...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API CreateBackendAuthRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateBackendAuthRequest> Clone() const
    {
      return Aws::MakeUnique<CreateBackendAuthRequest>(GetServiceRequestName(), *this);
    }
