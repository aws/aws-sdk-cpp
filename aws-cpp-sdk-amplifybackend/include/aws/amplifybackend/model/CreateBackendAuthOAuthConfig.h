...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The OAuth grant type which you use to allow app users to authenticate from
     * your Amplify app.</p>
     */
    ...
    /**
     * <p>List of OAuth related flows which use to allow your app users to authenticate
     * from your Amplify app.</p>
     */
