...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API RemoveAllBackendsRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveAllBackendsRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveAllBackendsRequest>(GetServiceRequestName(), *this);
    }
