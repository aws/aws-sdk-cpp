...
namespace Model
{
  ...
  /**
   */
  class AWS_AMPLIFYBACKEND_API RemoveBackendConfigRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveBackendConfigRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveBackendConfigRequest>(GetServiceRequestName(), *this);
    }
