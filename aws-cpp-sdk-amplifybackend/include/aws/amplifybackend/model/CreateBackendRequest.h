...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API CreateBackendRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateBackendRequest> Clone() const
    {
      return Aws::MakeUnique<CreateBackendRequest>(GetServiceRequestName(), *this);
    }
