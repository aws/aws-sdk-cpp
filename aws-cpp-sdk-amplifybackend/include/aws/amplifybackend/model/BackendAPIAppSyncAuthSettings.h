...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The Amazon Cognito user pool ID, if Amazon Cognito is used as an
    ...
    /**
     * <p>The API key description for API_KEY, if it is used as an authentication
    ...
    /**
     * <p>The API key expiration time for API_KEY, if it is used as an authentication
     * mechanism to access your data models.</p>
     */
    ...
    /**
     * <p>The clientID for openID, if openID is used as an authentication setting to
    ...
    /**
     * <p>The openID issuer URL, if openID is used as an authentication setting to
     * access your data models.</p>
     */
    ...
    /**
     * <p>The openID provider name, if openID is used as an authentication mechanism to
     * access your data models.</p>
     */
