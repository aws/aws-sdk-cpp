...
namespace Model
{
  ...
  /**
   */
  class AWS_AMPLIFYBACKEND_API GetBackendJobRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBackendJobRequest> Clone() const
    {
      return Aws::MakeUnique<GetBackendJobRequest>(GetServiceRequestName(), *this);
    }
