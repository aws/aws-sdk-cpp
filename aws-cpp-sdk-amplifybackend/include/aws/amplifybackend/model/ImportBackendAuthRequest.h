...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API ImportBackendAuthRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ImportBackendAuthRequest> Clone() const
    {
      return Aws::MakeUnique<ImportBackendAuthRequest>(GetServiceRequestName(), *this);
    }
