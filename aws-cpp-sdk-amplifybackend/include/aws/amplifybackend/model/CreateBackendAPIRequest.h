...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API CreateBackendAPIRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateBackendAPIRequest> Clone() const
    {
      return Aws::MakeUnique<CreateBackendAPIRequest>(GetServiceRequestName(), *this);
    }
