...
namespace Model
{
  ...
  /**
   * <p>Describes the forgot password policy for authenticating into the Amlify
  ...
  public:
    ...
    /**
     * <p>The configuration for the SMS message sent when an Amplify app user forgets
     * their password.</p>
     */
