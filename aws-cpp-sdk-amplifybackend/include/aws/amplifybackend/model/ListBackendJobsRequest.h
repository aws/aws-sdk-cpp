...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API ListBackendJobsRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBackendJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListBackendJobsRequest>(GetServiceRequestName(), *this);
    }
