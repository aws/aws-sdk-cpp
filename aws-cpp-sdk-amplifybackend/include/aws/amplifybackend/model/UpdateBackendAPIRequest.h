...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API UpdateBackendAPIRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateBackendAPIRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateBackendAPIRequest>(GetServiceRequestName(), *this);
    }
