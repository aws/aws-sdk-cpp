...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API CloneBackendRequest : public AmplifyBackendRequest
  {
  public:
    CloneBackendRequest();
    ...
    */
    virtual Aws::UniquePtr<CloneBackendRequest> Clone() const
    {
      return Aws::MakeUnique<CloneBackendRequest>(GetServiceRequestName(), *this);
    }
