...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_AMPLIFYBACKEND_API UpdateBackendJobRequest : public AmplifyBackendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateBackendJobRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateBackendJobRequest>(GetServiceRequestName(), *this);
    }
