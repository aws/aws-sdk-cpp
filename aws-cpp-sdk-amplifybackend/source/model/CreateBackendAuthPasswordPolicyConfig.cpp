...
CreateBackendAuthPasswordPolicyConfig& CreateBackendAuthPasswordPolicyConfig::operator =(JsonView jsonValue)
{
...
JsonValue CreateBackendAuthPasswordPolicyConfig::Jsonize() const
{
  JsonValue payload;
