...
{
  /**
   * <p>Contains the output of DetachClassicLinkVpc.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DetachClassicLinkVpcResult">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline DetachClassicLinkVpcResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
