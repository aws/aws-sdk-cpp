...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteNetworkInsightsAnalysisRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteNetworkInsightsAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteNetworkInsightsAnalysisRequest>(GetServiceRequestName(), *this);
    }
