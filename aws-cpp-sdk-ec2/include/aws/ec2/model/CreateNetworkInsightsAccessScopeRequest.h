...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateNetworkInsightsAccessScopeRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateNetworkInsightsAccessScopeRequest> Clone() const
    {
      return Aws::MakeUnique<CreateNetworkInsightsAccessScopeRequest>(GetServiceRequestName(), *this);
    }
