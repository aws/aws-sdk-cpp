...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLaunchTemplateVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLaunchTemplateVersionsRequest>(GetServiceRequestName(), *this);
    }
