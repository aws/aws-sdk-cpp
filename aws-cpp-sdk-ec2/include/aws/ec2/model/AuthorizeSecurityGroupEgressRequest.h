...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AuthorizeSecurityGroupEgressRequest> Clone() const
    {
      return Aws::MakeUnique<AuthorizeSecurityGroupEgressRequest>(GetServiceRequestName(), *this);
    }
