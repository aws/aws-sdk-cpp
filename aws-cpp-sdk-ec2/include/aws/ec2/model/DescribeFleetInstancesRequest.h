...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeFleetInstancesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFleetInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFleetInstancesRequest>(GetServiceRequestName(), *this);
    }
