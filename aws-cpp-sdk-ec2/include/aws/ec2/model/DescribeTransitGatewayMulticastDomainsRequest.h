...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeTransitGatewayMulticastDomainsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTransitGatewayMulticastDomainsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTransitGatewayMulticastDomainsRequest>(GetServiceRequestName(), *this);
    }
