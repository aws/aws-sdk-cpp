...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteNetworkInsightsAccessScopeRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteNetworkInsightsAccessScopeRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteNetworkInsightsAccessScopeRequest>(GetServiceRequestName(), *this);
    }
