...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetNetworkInsightsAccessScopeContentRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetNetworkInsightsAccessScopeContentRequest> Clone() const
    {
      return Aws::MakeUnique<GetNetworkInsightsAccessScopeContentRequest>(GetServiceRequestName(), *this);
    }
