...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API AssociateTransitGatewayRouteTableRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateTransitGatewayRouteTableRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateTransitGatewayRouteTableRequest>(GetServiceRequestName(), *this);
    }
