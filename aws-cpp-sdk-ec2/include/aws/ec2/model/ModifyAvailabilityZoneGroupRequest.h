...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyAvailabilityZoneGroupRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyAvailabilityZoneGroupRequest>(GetServiceRequestName(), *this);
    }
