...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteTrafficMirrorFilterRuleRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTrafficMirrorFilterRuleRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTrafficMirrorFilterRuleRequest>(GetServiceRequestName(), *this);
    }
