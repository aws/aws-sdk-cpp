...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeClientVpnEndpointsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeClientVpnEndpointsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeClientVpnEndpointsRequest>(GetServiceRequestName(), *this);
    }
