...
namespace Model
{
   ...
   */
  class AWS_EC2_API CreateSpotDatafeedSubscriptionResponse
  {
  public:
    CreateSpotDatafeedSubscriptionResponse();
    CreateSpotDatafeedSubscriptionResponse(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline CreateSpotDatafeedSubscriptionResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
