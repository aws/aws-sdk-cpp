...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetIpamPoolAllocationsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetIpamPoolAllocationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetIpamPoolAllocationsRequest>(GetServiceRequestName(), *this);
    }
