...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetDefaultCreditSpecificationRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDefaultCreditSpecificationRequest> Clone() const
    {
      return Aws::MakeUnique<GetDefaultCreditSpecificationRequest>(GetServiceRequestName(), *this);
    }
