...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeInstanceTypeOfferingsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInstanceTypeOfferingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInstanceTypeOfferingsRequest>(GetServiceRequestName(), *this);
    }
