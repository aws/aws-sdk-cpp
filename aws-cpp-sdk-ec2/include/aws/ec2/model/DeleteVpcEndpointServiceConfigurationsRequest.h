...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVpcEndpointServiceConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVpcEndpointServiceConfigurationsRequest>(GetServiceRequestName(), *this);
    }
