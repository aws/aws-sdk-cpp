...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyVpcEndpointServiceConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyVpcEndpointServiceConfigurationRequest>(GetServiceRequestName(), *this);
    }
