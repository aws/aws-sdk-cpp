...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNetworkInterfaceAttributeRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNetworkInterfaceAttributeRequest>(GetServiceRequestName(), *this);
    }
