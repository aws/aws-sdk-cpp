...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateTransitGatewayRouteRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTransitGatewayRouteRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTransitGatewayRouteRequest>(GetServiceRequestName(), *this);
    }
