...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchTransitGatewayMulticastGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<SearchTransitGatewayMulticastGroupsRequest>(GetServiceRequestName(), *this);
    }
