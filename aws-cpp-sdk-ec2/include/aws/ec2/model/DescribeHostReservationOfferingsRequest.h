...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeHostReservationOfferingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeHostReservationOfferingsRequest>(GetServiceRequestName(), *this);
    }
