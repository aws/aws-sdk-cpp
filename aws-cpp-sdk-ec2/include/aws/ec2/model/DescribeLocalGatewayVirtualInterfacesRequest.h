...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLocalGatewayVirtualInterfacesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLocalGatewayVirtualInterfacesRequest>(GetServiceRequestName(), *this);
    }
