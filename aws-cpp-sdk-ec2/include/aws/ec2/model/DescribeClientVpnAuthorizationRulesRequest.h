...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeClientVpnAuthorizationRulesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeClientVpnAuthorizationRulesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeClientVpnAuthorizationRulesRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DescribeClientVpnAuthorizationRules"; }
