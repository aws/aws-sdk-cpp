...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeClientVpnTargetNetworksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeClientVpnTargetNetworksRequest>(GetServiceRequestName(), *this);
    }
