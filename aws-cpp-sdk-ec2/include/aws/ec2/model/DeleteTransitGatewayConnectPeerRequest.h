...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTransitGatewayConnectPeerRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTransitGatewayConnectPeerRequest>(GetServiceRequestName(), *this);
    }
