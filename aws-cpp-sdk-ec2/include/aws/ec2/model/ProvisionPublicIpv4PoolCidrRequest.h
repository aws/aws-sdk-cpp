...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ProvisionPublicIpv4PoolCidrRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ProvisionPublicIpv4PoolCidrRequest> Clone() const
    {
      return Aws::MakeUnique<ProvisionPublicIpv4PoolCidrRequest>(GetServiceRequestName(), *this);
    }
