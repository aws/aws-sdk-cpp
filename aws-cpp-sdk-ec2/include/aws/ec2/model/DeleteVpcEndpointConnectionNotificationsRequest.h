...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVpcEndpointConnectionNotificationsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVpcEndpointConnectionNotificationsRequest>(GetServiceRequestName(), *this);
    }
