...
namespace Model
{
  class AWS_EC2_API ProvisionIpamPoolCidrResponse
  {
  public:
    ProvisionIpamPoolCidrResponse();
    ProvisionIpamPoolCidrResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ProvisionIpamPoolCidrResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
