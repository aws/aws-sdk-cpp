...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DisableFastLaunchRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableFastLaunchRequest> Clone() const
    {
      return Aws::MakeUnique<DisableFastLaunchRequest>(GetServiceRequestName(), *this);
    }
