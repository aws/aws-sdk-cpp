...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ExportClientVpnClientCertificateRevocationListRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ExportClientVpnClientCertificateRevocationListRequest> Clone() const
    {
      return Aws::MakeUnique<ExportClientVpnClientCertificateRevocationListRequest>(GetServiceRequestName(), *this);
    }
