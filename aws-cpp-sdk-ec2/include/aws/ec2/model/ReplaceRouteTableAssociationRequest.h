...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ReplaceRouteTableAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<ReplaceRouteTableAssociationRequest>(GetServiceRequestName(), *this);
    }
