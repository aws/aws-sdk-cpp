...
namespace Model
{
   ...
   * to specify the rule:</p> <ul> <li> <p>CidrIpv4</p> </li> <li> <p>CidrIpv6</p>
   * </li> <li> <p>PrefixListId</p> </li> <li> <p>ReferencedGroupId</p> </li> </ul>
   *  <p>When you run the <a
   * href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ModifySecurityGroupRules.html">ModifySecurityGroupRules</a>
   * command, you cannot change the rule type. For example if the rules references
   * <code>CidrIpv4</code>, then you must use <code>CidrIpv4</code> to reference the
