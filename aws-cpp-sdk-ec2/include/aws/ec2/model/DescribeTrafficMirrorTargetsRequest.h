...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTrafficMirrorTargetsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTrafficMirrorTargetsRequest>(GetServiceRequestName(), *this);
    }
