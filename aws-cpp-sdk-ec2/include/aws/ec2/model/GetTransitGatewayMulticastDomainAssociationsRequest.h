...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetTransitGatewayMulticastDomainAssociationsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTransitGatewayMulticastDomainAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetTransitGatewayMulticastDomainAssociationsRequest>(GetServiceRequestName(), *this);
    }
