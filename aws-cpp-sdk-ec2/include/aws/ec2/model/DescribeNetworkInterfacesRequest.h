...
namespace Model
{
  ...
  public:
     ...
     * <p><code>attachment.instance-id</code> - The ID of the instance to which the
     * network interface is attached.</p> </li> <li>
     * <p><code>attachment.instance-owner-id</code> - The owner ID of the instance to
     * which the network interface is attached.</p> </li> <li>
     * <p><code>attachment.device-index</code> - The device index to which the network
     * interface is attached.</p> </li> <li> <p><code>attachment.status</code> - The
     * status of the attachment (<code>attaching</code> | <code>attached</code> |
     * <code>detaching</code> | <code>detached</code>).</p> </li> <li>
     ...
     * <p><code>availability-zone</code> - The Availability Zone of the network
     ...
     * <p><code>group-name</code> - The name of a security group associated with the
     ...
     * AWS account ID of the network interface owner.</p> </li> <li>
     * <p><code>private-ip-address</code> - The private IP address or addresses of the
     * network interface.</p> </li> <li> <p><code>private-dns-name</code> - The private
     * DNS name of the network interface.</p> </li> <li> <p><code>requester-id</code> -
     * The ID of the entity that launched the instance on your behalf (for example, AWS
     * Management Console, Auto Scaling, and so on).</p> </li> <li>
     * <p><code>requester-managed</code> - Indicates whether the network interface is
     ...
     * status is <code>in-use</code>.</p> </li> <li> <p><code>subnet-id</code> - The ID
