...
namespace Model
{
  ...
  public:
     ...
     * <code>addresses.private-ip-address</code> - The private IP addresses associated
     * with the network interface.</p> </li> <li> <p> <code>addresses.primary</code> -
     ...
     * the network interface was associated with the Elastic IP address.</p> </li> <li>
     * <p> <code>addresses.association.owner-id</code> - The owner ID of the addresses
     * associated with the network interface.</p> </li> <li> <p>
     * <code>association.association-id</code> - The association ID returned when the
     * network interface was associated with an IP address.</p> </li> <li> <p>
     * <code>association.allocation-id</code> - The allocation ID returned when you
     * allocated the Elastic IP address for your network interface.</p> </li> <li> <p>
     ...
     * to the network interface.</p> </li> <li> <p>
     * <code>association.public-dns-name</code> - The public DNS name for the network
     * interface.</p> </li> <li> <p> <code>attachment.attachment-id</code> - The ID of
     * the interface attachment.</p> </li> <li> <p> <code>attachment.attach.time</code>
     * - The time that the network interface was attached to an instance.</p> </li>
     * <li> <p> <code>attachment.delete-on-termination</code> - Indicates whether the
     * attachment is deleted when an instance is terminated.</p> </li> <li> <p>
     ...
     * <code>private-ip-address</code> - The private IP address or addresses of the
     * network interface.</p> </li> <li> <p> <code>private-dns-name</code> - The
     * private DNS name of the network interface.</p> </li> <li> <p>
     ...
     * combination of a tag assigned to the resource.</p> </li> <li> <p>
