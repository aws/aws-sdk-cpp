...
namespace Model
{
  ...
  public:
     ...
     * Amazon Web Services account ID of the network interface owner.</p> </li> <li>
     * <p> <code>private-ip-address</code> - The private IPv4 address or addresses of
     * the network interface.</p> </li> <li> <p> <code>private-dns-name</code> - The
     ...
     * being managed by an Amazon Web Service (for example, Amazon Web Services
     * Management Console, Auto Scaling, and so on).</p> </li> <li> <p>
