...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTransitGatewayVpcAttachmentsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTransitGatewayVpcAttachmentsRequest>(GetServiceRequestName(), *this);
    }
