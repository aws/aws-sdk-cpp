...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API RestoreSnapshotFromRecycleBinRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RestoreSnapshotFromRecycleBinRequest> Clone() const
    {
      return Aws::MakeUnique<RestoreSnapshotFromRecycleBinRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "RestoreSnapshotFromRecycleBin"; }
