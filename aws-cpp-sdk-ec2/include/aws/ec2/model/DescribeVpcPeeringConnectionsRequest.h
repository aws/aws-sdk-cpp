...
namespace Model
{
  ...
  public:
     ...
     * <p><code>accepter-vpc-info.cidr-block</code> - The CIDR block of the peer
     * VPC.</p> </li> <li> <p><code>accepter-vpc-info.owner-id</code> - The AWS account
     * ID of the owner of the peer VPC.</p> </li> <li>
     * <p><code>accepter-vpc-info.vpc-id</code> - The ID of the peer VPC.</p> </li>
     * <li> <p><code>expiration-time</code> - The expiration date and time for the VPC
     * peering connection.</p> </li> <li> <p><code>requester-vpc-info.cidr-block</code>
     * - The CIDR block of the requester&apos;s VPC.</p> </li> <li>
     * <p><code>requester-vpc-info.owner-id</code> - The AWS account ID of the owner of
     * the requester VPC.</p> </li> <li> <p><code>requester-vpc-info.vpc-id</code> -
     * The ID of the requester VPC.</p> </li> <li> <p><code>status-code</code> - The
     * status of the VPC peering connection (<code>pending-acceptance</code> |
     * <code>failed</code> | <code>expired</code> | <code>provisioning</code> |
     * <code>active</code> | <code>deleted</code> | <code>rejected</code>).</p> </li>
     ...
     * filter.</p> </li> <li> <p><code>vpc-peering-connection-id</code> - The ID of the
     * VPC peering connection.</p> </li> </ul>
     */
