...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeStaleSecurityGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeStaleSecurityGroupsRequest>(GetServiceRequestName(), *this);
    }
