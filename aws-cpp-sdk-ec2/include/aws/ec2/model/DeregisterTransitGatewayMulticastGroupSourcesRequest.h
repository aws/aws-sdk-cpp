...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterTransitGatewayMulticastGroupSourcesRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterTransitGatewayMulticastGroupSourcesRequest>(GetServiceRequestName(), *this);
    }
