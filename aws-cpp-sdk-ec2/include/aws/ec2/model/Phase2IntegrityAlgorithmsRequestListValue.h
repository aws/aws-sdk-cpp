...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API Phase2IntegrityAlgorithmsRequestListValue
  {
  public:
    Phase2IntegrityAlgorithmsRequestListValue();
    Phase2IntegrityAlgorithmsRequestListValue(const Aws::Utils::Xml::XmlNode& xmlNode);
    Phase2IntegrityAlgorithmsRequestListValue& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
