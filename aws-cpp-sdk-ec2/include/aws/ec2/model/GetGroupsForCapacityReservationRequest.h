...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetGroupsForCapacityReservationRequest> Clone() const
    {
      return Aws::MakeUnique<GetGroupsForCapacityReservationRequest>(GetServiceRequestName(), *this);
    }
