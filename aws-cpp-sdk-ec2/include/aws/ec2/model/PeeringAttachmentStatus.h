...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API PeeringAttachmentStatus
  {
  public:
    PeeringAttachmentStatus();
    PeeringAttachmentStatus(const Aws::Utils::Xml::XmlNode& xmlNode);
    PeeringAttachmentStatus& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
