...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLocalGatewayVirtualInterfaceGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLocalGatewayVirtualInterfaceGroupsRequest>(GetServiceRequestName(), *this);
    }
