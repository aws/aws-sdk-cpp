...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeVpcEndpointConnectionsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVpcEndpointConnectionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVpcEndpointConnectionsRequest>(GetServiceRequestName(), *this);
    }
