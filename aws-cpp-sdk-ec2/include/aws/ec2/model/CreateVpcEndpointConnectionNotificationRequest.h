...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateVpcEndpointConnectionNotificationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateVpcEndpointConnectionNotificationRequest>(GetServiceRequestName(), *this);
    }
