...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeIamInstanceProfileAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeIamInstanceProfileAssociationsRequest>(GetServiceRequestName(), *this);
    }
