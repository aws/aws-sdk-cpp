...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API Phase1DHGroupNumbersRequestListValue
  {
  public:
    Phase1DHGroupNumbersRequestListValue();
    Phase1DHGroupNumbersRequestListValue(const Aws::Utils::Xml::XmlNode& xmlNode);
    Phase1DHGroupNumbersRequestListValue& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
