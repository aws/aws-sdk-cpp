...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API RequestIpamResourceTag
  {
  public:
    RequestIpamResourceTag();
    RequestIpamResourceTag(const Aws::Utils::Xml::XmlNode& xmlNode);
    RequestIpamResourceTag& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
