...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCapacityReservationUsageRequest> Clone() const
    {
      return Aws::MakeUnique<GetCapacityReservationUsageRequest>(GetServiceRequestName(), *this);
    }
