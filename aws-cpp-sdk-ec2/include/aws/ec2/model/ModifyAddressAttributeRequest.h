...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ModifyAddressAttributeRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyAddressAttributeRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyAddressAttributeRequest>(GetServiceRequestName(), *this);
    }
