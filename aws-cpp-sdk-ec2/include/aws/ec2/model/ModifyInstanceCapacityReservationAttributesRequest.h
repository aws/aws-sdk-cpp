...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyInstanceCapacityReservationAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyInstanceCapacityReservationAttributesRequest>(GetServiceRequestName(), *this);
    }
