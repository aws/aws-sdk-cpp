...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelReservedInstancesListingRequest> Clone() const
    {
      return Aws::MakeUnique<CancelReservedInstancesListingRequest>(GetServiceRequestName(), *this);
    }
