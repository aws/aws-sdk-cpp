...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AcceptVpcEndpointConnectionsRequest> Clone() const
    {
      return Aws::MakeUnique<AcceptVpcEndpointConnectionsRequest>(GetServiceRequestName(), *this);
    }
