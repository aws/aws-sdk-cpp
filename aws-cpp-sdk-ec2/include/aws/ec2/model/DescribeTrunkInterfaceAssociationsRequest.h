...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTrunkInterfaceAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTrunkInterfaceAssociationsRequest>(GetServiceRequestName(), *this);
    }
