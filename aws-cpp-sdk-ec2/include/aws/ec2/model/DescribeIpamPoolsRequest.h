...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeIpamPoolsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeIpamPoolsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeIpamPoolsRequest>(GetServiceRequestName(), *this);
    }
