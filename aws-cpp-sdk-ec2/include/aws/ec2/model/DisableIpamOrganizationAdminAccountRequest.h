...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DisableIpamOrganizationAdminAccountRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableIpamOrganizationAdminAccountRequest> Clone() const
    {
      return Aws::MakeUnique<DisableIpamOrganizationAdminAccountRequest>(GetServiceRequestName(), *this);
    }
