...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeStoreImageTasksRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeStoreImageTasksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeStoreImageTasksRequest>(GetServiceRequestName(), *this);
    }
