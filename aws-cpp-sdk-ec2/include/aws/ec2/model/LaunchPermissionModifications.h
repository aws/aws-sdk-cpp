...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The Amazon Web Services account ID to add to the list of launch permissions
     * for the AMI.</p>
     */
    ...
    /**
     * <p>The Amazon Web Services account ID to remove from the list of launch
     * permissions for the AMI.</p>
     */
