...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API FastLaunchSnapshotConfigurationRequest
  {
  public:
    FastLaunchSnapshotConfigurationRequest();
    FastLaunchSnapshotConfigurationRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    FastLaunchSnapshotConfigurationRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
