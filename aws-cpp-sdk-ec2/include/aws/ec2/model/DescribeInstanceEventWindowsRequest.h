...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API DescribeInstanceEventWindowsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInstanceEventWindowsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInstanceEventWindowsRequest>(GetServiceRequestName(), *this);
    }
