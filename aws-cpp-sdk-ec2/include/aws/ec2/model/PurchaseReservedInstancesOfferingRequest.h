...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PurchaseReservedInstancesOfferingRequest> Clone() const
    {
      return Aws::MakeUnique<PurchaseReservedInstancesOfferingRequest>(GetServiceRequestName(), *this);
    }
