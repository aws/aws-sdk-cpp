...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteNetworkInsightsAccessScopeAnalysisRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteNetworkInsightsAccessScopeAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteNetworkInsightsAccessScopeAnalysisRequest>(GetServiceRequestName(), *this);
    }
