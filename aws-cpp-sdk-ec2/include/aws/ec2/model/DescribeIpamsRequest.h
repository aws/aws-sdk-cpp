...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeIpamsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeIpamsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeIpamsRequest>(GetServiceRequestName(), *this);
    }
