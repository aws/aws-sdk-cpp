...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API ImportImageLicenseConfigurationRequest
  {
  public:
    ImportImageLicenseConfigurationRequest();
    ImportImageLicenseConfigurationRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    ImportImageLicenseConfigurationRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
