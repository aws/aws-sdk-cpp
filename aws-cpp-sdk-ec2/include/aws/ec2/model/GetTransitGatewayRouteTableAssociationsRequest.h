...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTransitGatewayRouteTableAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetTransitGatewayRouteTableAssociationsRequest>(GetServiceRequestName(), *this);
    }
