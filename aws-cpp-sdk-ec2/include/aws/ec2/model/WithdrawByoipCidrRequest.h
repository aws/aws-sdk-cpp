...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API WithdrawByoipCidrRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<WithdrawByoipCidrRequest> Clone() const
    {
      return Aws::MakeUnique<WithdrawByoipCidrRequest>(GetServiceRequestName(), *this);
    }
