...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSpotInstanceRequestsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSpotInstanceRequestsRequest>(GetServiceRequestName(), *this);
    }
