...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateSubnetCidrBlockRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateSubnetCidrBlockRequest>(GetServiceRequestName(), *this);
    }
