...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTransitGatewayRouteTableAnnouncementRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTransitGatewayRouteTableAnnouncementRequest>(GetServiceRequestName(), *this);
    }
