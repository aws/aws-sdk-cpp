...
namespace Model
{
  ...
  public:
     ...
     * information, see the description of the event.</p> </li> <li>
     ...
     * <p><code>modify_in_progress</code> - A request to modify the Spot fleet request
     * was accepted and is in progress.</p> </li> <li>
     * <p><code>modify_successful</code> - The Spot fleet request was modified.</p>
     * </li> <li> <p><code>price_update</code> - The bid price for a launch
     * configuration was adjusted because it was too high. This change is
     * permanent.</p> </li> <li> <p><code>submitted</code> - The Spot fleet request is
     * being evaluated and Amazon EC2 is preparing to launch the target number of Spot
     * instances.</p> </li> </ul> <p>The following are the <code>instanceChange</code>
     * events.</p> <ul> <li> <p><code>launched</code> - A bid was fulfilled and a new
     * instance was launched.</p> </li> <li> <p><code>terminated</code> - An instance
     * was terminated by the user.</p> </li> </ul>
     */
