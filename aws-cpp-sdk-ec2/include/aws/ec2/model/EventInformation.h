...
namespace Model
{
  ...
  public:
     ...
     * <li> <p><code>iamFleetRoleInvalid</code> - Spot fleet did not have the required
     * permissions either to launch or terminate an instance.</p> </li> <li>
     * <p><code>spotFleetRequestConfigurationInvalid</code> - The configuration is not
     * valid. For more information, see the description.</p> </li> <li>
     * <p><code>spotInstanceCountLimitExceeded</code> - You've reached the limit on the
     * number of Spot Instances that you can launch.</p> </li> </ul> <p>The following
     * are the <code>fleetRequestChange</code> events.</p> <ul> <li>
     * <p><code>active</code> - The Spot fleet has been validated and Amazon EC2 is
     ...
     * terminated.</p> </li> <li> <p><code>cancelled_running</code> - The Spot fleet is
     * canceled and will not launch additional Spot Instances, but its existing Spot
     * Instances will continue to run until they are interrupted or terminated.</p>
     * </li> <li> <p><code>cancelled_terminating</code> - The Spot fleet is canceled
     * and its Spot Instances are terminating.</p> </li> <li> <p><code>expired</code> -
     ...
     * <code>terminateInstancesWithExpiration</code> set.</p> </li> <li>
     * <p><code>price_update</code> - The bid price for a launch configuration was
     * adjusted because it was too high. This change is permanent.</p> </li> <li>
     * <p><code>submitted</code> - The Spot fleet request is being evaluated and Amazon
     * EC2 is preparing to launch the target number of Spot Instances.</p> </li> </ul>
     * <p>The following are the <code>instanceChange</code> events.</p> <ul> <li>
     * <p><code>launched</code> - A bid was fulfilled and a new instance was
     * launched.</p> </li> <li> <p><code>terminated</code> - An instance was terminated
     * by the user.</p> </li> </ul>
     */
