...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API InstanceIpv6AddressRequest
  {
  public:
    InstanceIpv6AddressRequest();
    InstanceIpv6AddressRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    InstanceIpv6AddressRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
