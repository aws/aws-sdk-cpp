...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API LaunchTemplateEnclaveOptionsRequest
  {
  public:
    LaunchTemplateEnclaveOptionsRequest();
    LaunchTemplateEnclaveOptionsRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    LaunchTemplateEnclaveOptionsRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
