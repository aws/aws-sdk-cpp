...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeTransitGatewayConnectPeersRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTransitGatewayConnectPeersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTransitGatewayConnectPeersRequest>(GetServiceRequestName(), *this);
    }
