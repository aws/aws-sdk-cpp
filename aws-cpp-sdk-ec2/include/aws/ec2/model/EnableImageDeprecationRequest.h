...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API EnableImageDeprecationRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableImageDeprecationRequest> Clone() const
    {
      return Aws::MakeUnique<EnableImageDeprecationRequest>(GetServiceRequestName(), *this);
    }
