...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API LaunchTemplateIamInstanceProfileSpecification
  {
  public:
    LaunchTemplateIamInstanceProfileSpecification();
    LaunchTemplateIamInstanceProfileSpecification(const Aws::Utils::Xml::XmlNode& xmlNode);
    LaunchTemplateIamInstanceProfileSpecification& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
