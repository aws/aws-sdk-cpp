...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API RegisterInstanceEventNotificationAttributesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterInstanceEventNotificationAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterInstanceEventNotificationAttributesRequest>(GetServiceRequestName(), *this);
    }
