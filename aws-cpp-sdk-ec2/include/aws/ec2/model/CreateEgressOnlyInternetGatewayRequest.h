...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateEgressOnlyInternetGatewayRequest> Clone() const
    {
      return Aws::MakeUnique<CreateEgressOnlyInternetGatewayRequest>(GetServiceRequestName(), *this);
    }
