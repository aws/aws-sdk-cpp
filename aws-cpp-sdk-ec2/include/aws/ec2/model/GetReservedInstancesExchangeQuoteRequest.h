...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetReservedInstancesExchangeQuoteRequest> Clone() const
    {
      return Aws::MakeUnique<GetReservedInstancesExchangeQuoteRequest>(GetServiceRequestName(), *this);
    }
