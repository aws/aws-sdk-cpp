...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RejectTransitGatewayMulticastDomainAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<RejectTransitGatewayMulticastDomainAssociationsRequest>(GetServiceRequestName(), *this);
    }
