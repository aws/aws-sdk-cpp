...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ModifyLocalGatewayRouteRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyLocalGatewayRouteRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyLocalGatewayRouteRequest>(GetServiceRequestName(), *this);
    }
