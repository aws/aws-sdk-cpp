...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyTrafficMirrorFilterRuleRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyTrafficMirrorFilterRuleRequest>(GetServiceRequestName(), *this);
    }
