...
namespace Model
{
  class AWS_EC2_API DescribeLocalGatewaysResponse
  {
  public:
    DescribeLocalGatewaysResponse();
    DescribeLocalGatewaysResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DescribeLocalGatewaysResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
