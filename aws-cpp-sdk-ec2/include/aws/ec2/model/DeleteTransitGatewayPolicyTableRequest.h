...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTransitGatewayPolicyTableRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTransitGatewayPolicyTableRequest>(GetServiceRequestName(), *this);
    }
