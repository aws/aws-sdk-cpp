...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLocalGatewayRouteTableVpcAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLocalGatewayRouteTableVpcAssociationRequest>(GetServiceRequestName(), *this);
    }
