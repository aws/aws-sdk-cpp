...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ImportClientVpnClientCertificateRevocationListRequest> Clone() const
    {
      return Aws::MakeUnique<ImportClientVpnClientCertificateRevocationListRequest>(GetServiceRequestName(), *this);
    }
