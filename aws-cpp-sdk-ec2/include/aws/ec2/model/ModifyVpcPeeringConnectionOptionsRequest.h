...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyVpcPeeringConnectionOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyVpcPeeringConnectionOptionsRequest>(GetServiceRequestName(), *this);
    }
