...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DisassociateEnclaveCertificateIamRoleRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateEnclaveCertificateIamRoleRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateEnclaveCertificateIamRoleRequest>(GetServiceRequestName(), *this);
    }
