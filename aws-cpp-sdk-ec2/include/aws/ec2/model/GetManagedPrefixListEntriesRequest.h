...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetManagedPrefixListEntriesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetManagedPrefixListEntriesRequest> Clone() const
    {
      return Aws::MakeUnique<GetManagedPrefixListEntriesRequest>(GetServiceRequestName(), *this);
    }
