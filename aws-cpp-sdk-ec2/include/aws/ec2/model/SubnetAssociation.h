...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API SubnetAssociation
  {
  public:
    SubnetAssociation();
    SubnetAssociation(const Aws::Utils::Xml::XmlNode& xmlNode);
    SubnetAssociation& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
