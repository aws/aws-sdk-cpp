...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateIamInstanceProfileRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateIamInstanceProfileRequest>(GetServiceRequestName(), *this);
    }
