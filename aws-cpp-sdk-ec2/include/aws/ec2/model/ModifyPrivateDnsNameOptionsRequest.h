...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ModifyPrivateDnsNameOptionsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyPrivateDnsNameOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyPrivateDnsNameOptionsRequest>(GetServiceRequestName(), *this);
    }
