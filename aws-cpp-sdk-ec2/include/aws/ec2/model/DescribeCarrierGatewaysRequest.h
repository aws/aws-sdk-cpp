...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeCarrierGatewaysRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCarrierGatewaysRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCarrierGatewaysRequest>(GetServiceRequestName(), *this);
    }
