...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API IpamPoolCidrFailureReason
  {
  public:
    IpamPoolCidrFailureReason();
    IpamPoolCidrFailureReason(const Aws::Utils::Xml::XmlNode& xmlNode);
    IpamPoolCidrFailureReason& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
