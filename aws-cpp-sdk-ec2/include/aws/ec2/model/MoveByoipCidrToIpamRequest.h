...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API MoveByoipCidrToIpamRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<MoveByoipCidrToIpamRequest> Clone() const
    {
      return Aws::MakeUnique<MoveByoipCidrToIpamRequest>(GetServiceRequestName(), *this);
    }
