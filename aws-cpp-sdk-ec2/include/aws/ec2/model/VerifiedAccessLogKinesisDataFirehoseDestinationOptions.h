...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API VerifiedAccessLogKinesisDataFirehoseDestinationOptions
  {
  public:
    VerifiedAccessLogKinesisDataFirehoseDestinationOptions();
    VerifiedAccessLogKinesisDataFirehoseDestinationOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    VerifiedAccessLogKinesisDataFirehoseDestinationOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
