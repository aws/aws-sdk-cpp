...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTrafficMirrorSessionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTrafficMirrorSessionsRequest>(GetServiceRequestName(), *this);
    }
