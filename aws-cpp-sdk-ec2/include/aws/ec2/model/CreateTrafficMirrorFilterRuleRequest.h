...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTrafficMirrorFilterRuleRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTrafficMirrorFilterRuleRequest>(GetServiceRequestName(), *this);
    }
