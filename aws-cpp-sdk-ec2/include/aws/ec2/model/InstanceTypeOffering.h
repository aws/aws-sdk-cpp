...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API InstanceTypeOffering
  {
  public:
    InstanceTypeOffering();
    InstanceTypeOffering(const Aws::Utils::Xml::XmlNode& xmlNode);
    InstanceTypeOffering& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
