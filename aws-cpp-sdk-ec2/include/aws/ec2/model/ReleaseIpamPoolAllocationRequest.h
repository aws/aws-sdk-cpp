...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ReleaseIpamPoolAllocationRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ReleaseIpamPoolAllocationRequest> Clone() const
    {
      return Aws::MakeUnique<ReleaseIpamPoolAllocationRequest>(GetServiceRequestName(), *this);
    }
