...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyNetworkInterfaceAttributeRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyNetworkInterfaceAttributeRequest>(GetServiceRequestName(), *this);
    }
