...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeAddressTransfersRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAddressTransfersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAddressTransfersRequest>(GetServiceRequestName(), *this);
    }
