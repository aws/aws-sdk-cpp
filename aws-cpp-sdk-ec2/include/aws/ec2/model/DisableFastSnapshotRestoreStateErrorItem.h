...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API DisableFastSnapshotRestoreStateErrorItem
  {
  public:
    DisableFastSnapshotRestoreStateErrorItem();
    DisableFastSnapshotRestoreStateErrorItem(const Aws::Utils::Xml::XmlNode& xmlNode);
    DisableFastSnapshotRestoreStateErrorItem& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
