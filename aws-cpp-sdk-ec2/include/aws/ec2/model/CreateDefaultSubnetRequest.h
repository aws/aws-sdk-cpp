...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateDefaultSubnetRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDefaultSubnetRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDefaultSubnetRequest>(GetServiceRequestName(), *this);
    }
