...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<TerminateClientVpnConnectionsRequest> Clone() const
    {
      return Aws::MakeUnique<TerminateClientVpnConnectionsRequest>(GetServiceRequestName(), *this);
    }
