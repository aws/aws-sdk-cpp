...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNetworkInsightsAnalysesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNetworkInsightsAnalysesRequest>(GetServiceRequestName(), *this);
    }
