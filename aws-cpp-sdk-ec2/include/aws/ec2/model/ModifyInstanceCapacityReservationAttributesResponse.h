...
namespace Model
{
  ...
  public:
     ...
     * error.</p>
     */
    inline ModifyInstanceCapacityReservationAttributesResponse& WithReturn(bool value) { SetReturn(value); return *this;}
    ...
    inline ModifyInstanceCapacityReservationAttributesResponse& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}

    
    inline ModifyInstanceCapacityReservationAttributesResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
