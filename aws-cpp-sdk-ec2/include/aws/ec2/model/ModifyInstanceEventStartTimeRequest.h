...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyInstanceEventStartTimeRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyInstanceEventStartTimeRequest>(GetServiceRequestName(), *this);
    }
