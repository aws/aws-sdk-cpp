...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartNetworkInsightsAccessScopeAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<StartNetworkInsightsAccessScopeAnalysisRequest>(GetServiceRequestName(), *this);
    }
