...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API AllocateIpamPoolCidrRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AllocateIpamPoolCidrRequest> Clone() const
    {
      return Aws::MakeUnique<AllocateIpamPoolCidrRequest>(GetServiceRequestName(), *this);
    }
