...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DisassociateInstanceEventWindowRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateInstanceEventWindowRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateInstanceEventWindowRequest>(GetServiceRequestName(), *this);
    }
