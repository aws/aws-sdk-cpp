...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetTransitGatewayPolicyTableAssociationsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTransitGatewayPolicyTableAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetTransitGatewayPolicyTableAssociationsRequest>(GetServiceRequestName(), *this);
    }
