...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableVpcClassicLinkDnsSupportRequest> Clone() const
    {
      return Aws::MakeUnique<DisableVpcClassicLinkDnsSupportRequest>(GetServiceRequestName(), *this);
    }
