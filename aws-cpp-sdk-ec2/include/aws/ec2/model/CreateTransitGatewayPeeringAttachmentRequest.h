...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTransitGatewayPeeringAttachmentRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTransitGatewayPeeringAttachmentRequest>(GetServiceRequestName(), *this);
    }
