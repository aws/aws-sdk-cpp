...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API TransitGatewayRouteTableAssociation
  {
  public:
    TransitGatewayRouteTableAssociation();
    TransitGatewayRouteTableAssociation(const Aws::Utils::Xml::XmlNode& xmlNode);
    TransitGatewayRouteTableAssociation& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
