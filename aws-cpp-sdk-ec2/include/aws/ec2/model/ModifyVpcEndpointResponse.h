...
{
  /**
   * <p>Contains the output of ModifyVpcEndpoint.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ModifyVpcEndpointResult">AWS
   * API Reference</a></p>
   */
  class AWS_EC2_API ModifyVpcEndpointResponse
  {
  public:
    ...
    inline ModifyVpcEndpointResponse& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}

    
    inline ModifyVpcEndpointResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
