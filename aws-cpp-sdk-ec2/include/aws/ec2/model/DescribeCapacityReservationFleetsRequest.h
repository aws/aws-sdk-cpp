...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCapacityReservationFleetsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCapacityReservationFleetsRequest>(GetServiceRequestName(), *this);
    }
