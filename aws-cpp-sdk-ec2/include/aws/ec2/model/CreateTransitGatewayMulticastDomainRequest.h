...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateTransitGatewayMulticastDomainRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTransitGatewayMulticastDomainRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTransitGatewayMulticastDomainRequest>(GetServiceRequestName(), *this);
    }
