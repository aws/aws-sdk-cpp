...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API AssociateEnclaveCertificateIamRoleRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateEnclaveCertificateIamRoleRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateEnclaveCertificateIamRoleRequest>(GetServiceRequestName(), *this);
    }
