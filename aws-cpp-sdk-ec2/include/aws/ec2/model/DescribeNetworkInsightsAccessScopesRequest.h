...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeNetworkInsightsAccessScopesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNetworkInsightsAccessScopesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNetworkInsightsAccessScopesRequest>(GetServiceRequestName(), *this);
    }
