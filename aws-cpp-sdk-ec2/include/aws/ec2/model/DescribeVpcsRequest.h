...
namespace Model
{
  ...
  public:
     ...
     * The ID of the account that owns the VPC.</p> </li> <li> <p> <code>state</code> -
     * The state of the VPC (<code>pending</code> | <code>available</code>).</p> </li>
     ...
     * <code>vpc-id</code> - The ID of the VPC.</p> </li> </ul>
     */
