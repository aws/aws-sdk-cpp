...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>One or more filters.</p> <ul> <li> <p> <code>cidr</code> - The CIDR block of
     * the VPC. The CIDR block you specify must exactly match the VPC's CIDR block for
     * information to be returned for the VPC. Must contain the slash followed by one
     * or two digits (for example, <code>/28</code>).</p> </li> <li> <p>
     * <code>dhcp-options-id</code> - The ID of a set of DHCP options.</p> </li> <li>
     * <p> <code>isDefault</code> - Indicates whether the VPC is the default VPC.</p>
     * </li> <li> <p> <code>state</code> - The state of the VPC (<code>pending</code> |
     * <code>available</code>).</p> </li> <li> <p>
