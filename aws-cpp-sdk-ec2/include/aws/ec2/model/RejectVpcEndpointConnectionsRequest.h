...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RejectVpcEndpointConnectionsRequest> Clone() const
    {
      return Aws::MakeUnique<RejectVpcEndpointConnectionsRequest>(GetServiceRequestName(), *this);
    }
