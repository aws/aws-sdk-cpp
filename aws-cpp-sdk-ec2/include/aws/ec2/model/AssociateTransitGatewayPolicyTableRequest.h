...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateTransitGatewayPolicyTableRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateTransitGatewayPolicyTableRequest>(GetServiceRequestName(), *this);
    }
