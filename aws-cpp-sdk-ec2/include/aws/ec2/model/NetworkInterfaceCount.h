...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API NetworkInterfaceCount
  {
  public:
    NetworkInterfaceCount();
    NetworkInterfaceCount(const Aws::Utils::Xml::XmlNode& xmlNode);
    NetworkInterfaceCount& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
