...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API Phase2IntegrityAlgorithmsListValue
  {
  public:
    Phase2IntegrityAlgorithmsListValue();
    Phase2IntegrityAlgorithmsListValue(const Aws::Utils::Xml::XmlNode& xmlNode);
    Phase2IntegrityAlgorithmsListValue& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
