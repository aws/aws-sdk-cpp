...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeClientVpnConnectionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeClientVpnConnectionsRequest>(GetServiceRequestName(), *this);
    }
