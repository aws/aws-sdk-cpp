...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeFleetHistoryRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFleetHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFleetHistoryRequest>(GetServiceRequestName(), *this);
    }
