...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetIpamAddressHistoryRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetIpamAddressHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<GetIpamAddressHistoryRequest>(GetServiceRequestName(), *this);
    }
