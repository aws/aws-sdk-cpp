...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateTrafficMirrorFilterRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTrafficMirrorFilterRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTrafficMirrorFilterRequest>(GetServiceRequestName(), *this);
    }
