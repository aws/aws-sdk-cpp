...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyInstanceMetadataOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyInstanceMetadataOptionsRequest>(GetServiceRequestName(), *this);
    }
