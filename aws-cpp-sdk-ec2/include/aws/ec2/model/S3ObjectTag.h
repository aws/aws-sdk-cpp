...
namespace Model
{
  ...
  /**
   * <p>The tags to apply to the AMI object that will be stored in the S3 bucket. For
   ...
   * Reference</a></p>
   */
  class AWS_EC2_API S3ObjectTag
  {
  public:
    S3ObjectTag();
    S3ObjectTag(const Aws::Utils::Xml::XmlNode& xmlNode);
    S3ObjectTag& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
