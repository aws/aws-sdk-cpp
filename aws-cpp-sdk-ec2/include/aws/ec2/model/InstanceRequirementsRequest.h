...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API InstanceRequirementsRequest
  {
  public:
    InstanceRequirementsRequest();
    InstanceRequirementsRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    InstanceRequirementsRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
     ...
     * pay for an Spot Instance, expressed as a percentage above the cheapest M, C, or
     * R instance type with your specified attributes. When Amazon EC2 selects instance
