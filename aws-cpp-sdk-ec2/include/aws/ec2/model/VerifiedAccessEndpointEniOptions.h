...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API VerifiedAccessEndpointEniOptions
  {
  public:
    VerifiedAccessEndpointEniOptions();
    VerifiedAccessEndpointEniOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    VerifiedAccessEndpointEniOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
