...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeManagedPrefixListsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeManagedPrefixListsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeManagedPrefixListsRequest>(GetServiceRequestName(), *this);
    }
