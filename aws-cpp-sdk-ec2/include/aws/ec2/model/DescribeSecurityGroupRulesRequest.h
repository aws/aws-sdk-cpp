...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeSecurityGroupRulesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSecurityGroupRulesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSecurityGroupRulesRequest>(GetServiceRequestName(), *this);
    }
