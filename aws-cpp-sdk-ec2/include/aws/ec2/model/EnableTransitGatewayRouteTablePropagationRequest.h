...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableTransitGatewayRouteTablePropagationRequest> Clone() const
    {
      return Aws::MakeUnique<EnableTransitGatewayRouteTablePropagationRequest>(GetServiceRequestName(), *this);
    }
