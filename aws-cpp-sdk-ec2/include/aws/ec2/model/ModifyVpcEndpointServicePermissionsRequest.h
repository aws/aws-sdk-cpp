...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyVpcEndpointServicePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyVpcEndpointServicePermissionsRequest>(GetServiceRequestName(), *this);
    }
