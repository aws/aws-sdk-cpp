...
namespace Model
{
  ...
  public:
     ...
     * route table for the VPC.</p> </li> <li> <p><code>route-table-id</code> - The ID
     * of the route table.</p> </li> <li> <p><code>route.destination-cidr-block</code>
     * - The CIDR range specified in a route in the table.</p> </li> <li>
