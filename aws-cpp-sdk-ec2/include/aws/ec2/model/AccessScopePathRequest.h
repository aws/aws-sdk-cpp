...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API AccessScopePathRequest
  {
  public:
    AccessScopePathRequest();
    AccessScopePathRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    AccessScopePathRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
