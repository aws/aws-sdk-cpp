...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCapacityReservationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCapacityReservationsRequest>(GetServiceRequestName(), *this);
    }
