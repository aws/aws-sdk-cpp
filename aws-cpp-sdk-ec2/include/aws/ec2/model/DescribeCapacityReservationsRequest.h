...
namespace Model
{
  ...
  public:
     ...
     * the Capacity Reservation.</p> </li> <li> <p> <code>availability-zone-id</code> -
     * The Availability Zone ID of the Capacity Reservation.</p> </li> <li> <p>
     ...
     * accounts.</p> </li> <li> <p> <code>dedicated</code> - The Capacity Reservation
     * is created on single-tenant hardware that is dedicated to a single Amazon Web
     * Services account.</p> </li> </ul> </li> <li> <p> <code>outpost-arn</code> - The
     * Amazon Resource Name (ARN) of the Outpost on which the Capacity Reservation was
     * created.</p> </li> <li> <p> <code>state</code> - The current state of the
     * Capacity Reservation. A Capacity Reservation can be in one of the following
     * states:</p> <ul> <li> <p> <code>active</code>- The Capacity Reservation is
     * active and the capacity is available for your use.</p> </li> <li> <p>
     ...
     * available for your use.</p> </li> <li> <p> <code>cancelled</code> - The Capacity
     * Reservation was cancelled. The reserved capacity is no longer available for your
     * use.</p> </li> <li> <p> <code>pending</code> - The Capacity Reservation request
     * was successful but the capacity provisioning is still pending.</p> </li> <li>
     * <p> <code>failed</code> - The Capacity Reservation request has failed. A request
     ...
     * </li> <li> <p> <code>start-date</code> - The date and time at which the Capacity
     * Reservation was started.</p> </li> <li> <p> <code>end-date</code> - The date and
     * time at which the Capacity Reservation expires. When a Capacity Reservation
     ...
     * reaches its end date and time.</p> </li> <li> <p> <code>end-date-type</code> -
     * Indicates the way in which the Capacity Reservation ends. A Capacity Reservation
     * can have one of the following end types:</p> <ul> <li> <p>
     ...
     * </li> <li> <p> <code>instance-match-criteria</code> - Indicates the type of
     * instance launches that the Capacity Reservation accepts. The options
     * include:</p> <ul> <li> <p> <code>open</code> - The Capacity Reservation accepts
