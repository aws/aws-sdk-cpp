...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartVpcEndpointServicePrivateDnsVerificationRequest> Clone() const
    {
      return Aws::MakeUnique<StartVpcEndpointServicePrivateDnsVerificationRequest>(GetServiceRequestName(), *this);
    }
