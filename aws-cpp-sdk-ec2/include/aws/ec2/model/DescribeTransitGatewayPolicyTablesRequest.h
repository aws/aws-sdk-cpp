...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeTransitGatewayPolicyTablesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTransitGatewayPolicyTablesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTransitGatewayPolicyTablesRequest>(GetServiceRequestName(), *this);
    }
