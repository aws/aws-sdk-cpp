...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateClientVpnTargetNetworkRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateClientVpnTargetNetworkRequest>(GetServiceRequestName(), *this);
    }
