...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API CreateVerifiedAccessEndpointEniOptions
  {
  public:
    CreateVerifiedAccessEndpointEniOptions();
    CreateVerifiedAccessEndpointEniOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    CreateVerifiedAccessEndpointEniOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
