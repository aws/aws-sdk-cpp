...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteTransitGatewayRouteTableAnnouncementRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTransitGatewayRouteTableAnnouncementRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTransitGatewayRouteTableAnnouncementRequest>(GetServiceRequestName(), *this);
    }
