...
namespace Model
{
  ...
  public:
     ...
     * error.</p>
     */
    inline ImportClientVpnClientCertificateRevocationListResponse& WithReturn(bool value) { SetReturn(value); return *this;}
    ...
    inline ImportClientVpnClientCertificateRevocationListResponse& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}

    
    inline ImportClientVpnClientCertificateRevocationListResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
