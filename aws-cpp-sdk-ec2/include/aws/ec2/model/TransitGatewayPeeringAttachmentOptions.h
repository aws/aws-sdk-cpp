...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API TransitGatewayPeeringAttachmentOptions
  {
  public:
    TransitGatewayPeeringAttachmentOptions();
    TransitGatewayPeeringAttachmentOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    TransitGatewayPeeringAttachmentOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
