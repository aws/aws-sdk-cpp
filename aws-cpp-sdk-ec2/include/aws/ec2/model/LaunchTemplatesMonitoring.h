...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API LaunchTemplatesMonitoring
  {
  public:
    LaunchTemplatesMonitoring();
    LaunchTemplatesMonitoring(const Aws::Utils::Xml::XmlNode& xmlNode);
    LaunchTemplatesMonitoring& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
