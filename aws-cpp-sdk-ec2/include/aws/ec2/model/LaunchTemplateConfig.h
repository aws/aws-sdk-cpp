...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API LaunchTemplateConfig
  {
  public:
    LaunchTemplateConfig();
    LaunchTemplateConfig(const Aws::Utils::Xml::XmlNode& xmlNode);
    LaunchTemplateConfig& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
