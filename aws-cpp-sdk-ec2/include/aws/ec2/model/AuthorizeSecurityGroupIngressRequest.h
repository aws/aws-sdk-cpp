...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AuthorizeSecurityGroupIngressRequest> Clone() const
    {
      return Aws::MakeUnique<AuthorizeSecurityGroupIngressRequest>(GetServiceRequestName(), *this);
    }
