...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateVpcEndpointServiceConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateVpcEndpointServiceConfigurationRequest>(GetServiceRequestName(), *this);
    }
