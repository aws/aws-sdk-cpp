...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVpcEndpointServicePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVpcEndpointServicePermissionsRequest>(GetServiceRequestName(), *this);
    }
