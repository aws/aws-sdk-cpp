...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateCoipPoolRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCoipPoolRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCoipPoolRequest>(GetServiceRequestName(), *this);
    }
