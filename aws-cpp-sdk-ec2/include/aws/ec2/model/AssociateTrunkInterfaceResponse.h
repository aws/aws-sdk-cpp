...
namespace Model
{
  class AWS_EC2_API AssociateTrunkInterfaceResponse
  {
  public:
    AssociateTrunkInterfaceResponse();
    AssociateTrunkInterfaceResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    AssociateTrunkInterfaceResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
