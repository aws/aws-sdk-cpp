...
namespace Model
{
  class AWS_EC2_API DescribeClientVpnEndpointsResponse
  {
  public:
    DescribeClientVpnEndpointsResponse();
    DescribeClientVpnEndpointsResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DescribeClientVpnEndpointsResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
