...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest>(GetServiceRequestName(), *this);
    }
