...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTransitGatewayAttachmentsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTransitGatewayAttachmentsRequest>(GetServiceRequestName(), *this);
    }
