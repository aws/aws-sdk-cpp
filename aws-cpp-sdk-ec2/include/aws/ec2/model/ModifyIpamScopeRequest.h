...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ModifyIpamScopeRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyIpamScopeRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyIpamScopeRequest>(GetServiceRequestName(), *this);
    }
