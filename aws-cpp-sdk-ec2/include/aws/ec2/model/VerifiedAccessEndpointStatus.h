...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API VerifiedAccessEndpointStatus
  {
  public:
    VerifiedAccessEndpointStatus();
    VerifiedAccessEndpointStatus(const Aws::Utils::Xml::XmlNode& xmlNode);
    VerifiedAccessEndpointStatus& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
