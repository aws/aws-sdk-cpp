...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAssociatedEnclaveCertificateIamRolesRequest> Clone() const
    {
      return Aws::MakeUnique<GetAssociatedEnclaveCertificateIamRolesRequest>(GetServiceRequestName(), *this);
    }
