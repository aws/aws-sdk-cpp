...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DisassociateTransitGatewayPolicyTableRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateTransitGatewayPolicyTableRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateTransitGatewayPolicyTableRequest>(GetServiceRequestName(), *this);
    }
