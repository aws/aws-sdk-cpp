...
namespace Model
{
  ...
  public:
     ...
     * <p><code>customer-gateway-configuration</code> - The configuration information
     * for the customer gateway.</p> </li> <li> <p><code>customer-gateway-id</code> -
     * The ID of a customer gateway associated with the VPN connection.</p> </li> <li>
     * <p><code>state</code> - The state of the VPN connection (<code>pending</code> |
     ...
     * Gateway Protocol (BGP).</p> </li> <li>
     * <p><code>route.destination-cidr-block</code> - The destination CIDR block. This
     * corresponds to the subnet used in a customer data center.</p> </li> <li>
     * <p><code>bgp-asn</code> - The BGP Autonomous System Number (ASN) associated with
     * a BGP device.</p> </li> <li> <p><code>tag</code>:<i>key</i>=<i>value</i> - The
     ...
     * <p><code>type</code> - The type of VPN connection. Currently the only supported
     * type is <code>ipsec.1</code>.</p> </li> <li> <p><code>vpn-connection-id</code> -
     * The ID of the VPN connection.</p> </li> <li> <p><code>vpn-gateway-id</code> -
     * The ID of a virtual private gateway associated with the VPN connection.</p>
     * </li> </ul>
     */
