...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API EnaSrdUdpSpecification
  {
  public:
    EnaSrdUdpSpecification();
    EnaSrdUdpSpecification(const Aws::Utils::Xml::XmlNode& xmlNode);
    EnaSrdUdpSpecification& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
