...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyVpcEndpointConnectionNotificationRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyVpcEndpointConnectionNotificationRequest>(GetServiceRequestName(), *this);
    }
