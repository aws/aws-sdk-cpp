...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterTransitGatewayMulticastGroupSourcesRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterTransitGatewayMulticastGroupSourcesRequest>(GetServiceRequestName(), *this);
    }
