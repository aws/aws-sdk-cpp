...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API EnableAddressTransferRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableAddressTransferRequest> Clone() const
    {
      return Aws::MakeUnique<EnableAddressTransferRequest>(GetServiceRequestName(), *this);
    }
