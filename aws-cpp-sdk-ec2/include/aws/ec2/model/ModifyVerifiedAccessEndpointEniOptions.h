...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API ModifyVerifiedAccessEndpointEniOptions
  {
  public:
    ModifyVerifiedAccessEndpointEniOptions();
    ModifyVerifiedAccessEndpointEniOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    ModifyVerifiedAccessEndpointEniOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
