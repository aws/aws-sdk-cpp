...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest>(GetServiceRequestName(), *this);
    }
