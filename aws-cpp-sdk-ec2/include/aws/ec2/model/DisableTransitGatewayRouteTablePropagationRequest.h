...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableTransitGatewayRouteTablePropagationRequest> Clone() const
    {
      return Aws::MakeUnique<DisableTransitGatewayRouteTablePropagationRequest>(GetServiceRequestName(), *this);
    }
