...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteClientVpnEndpointRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteClientVpnEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteClientVpnEndpointRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteClientVpnEndpoint"; }
