...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DisableAddressTransferRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableAddressTransferRequest> Clone() const
    {
      return Aws::MakeUnique<DisableAddressTransferRequest>(GetServiceRequestName(), *this);
    }
