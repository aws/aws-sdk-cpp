...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNetworkInterfacePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNetworkInterfacePermissionsRequest>(GetServiceRequestName(), *this);
    }
