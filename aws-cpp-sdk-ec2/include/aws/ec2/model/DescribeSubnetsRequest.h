...
namespace Model
{
  ...
  public:
     ...
     * subnet for the Availability Zone (<code>true</code> | <code>false</code>). You
     * can also use <code>defaultForAz</code> as the filter name.</p> </li> <li> <p>
     ...
     * <code>false</code>).</p> </li> <li> <p> <code>outpost-arn</code> - The Amazon
     * Resource Name (ARN) of the Outpost.</p> </li> <li> <p> <code>owner-id</code> -
     * The ID of the Amazon Web Services account that owns the subnet.</p> </li> <li>
     * <p> <code>state</code> - The state of the subnet (<code>pending</code> |
     * <code>available</code>).</p> </li> <li> <p> <code>subnet-arn</code> - The Amazon
     * Resource Name (ARN) of the subnet.</p> </li> <li> <p> <code>subnet-id</code> -
     * The ID of the subnet.</p> </li> <li> <p> <code>tag</code>:&lt;key&gt; - The
     ...
     * </li> <li> <p> <code>vpc-id</code> - The ID of the VPC for the subnet.</p> </li>
     * </ul>
     */
