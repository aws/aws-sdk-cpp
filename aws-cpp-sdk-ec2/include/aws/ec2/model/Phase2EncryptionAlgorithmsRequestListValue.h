...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API Phase2EncryptionAlgorithmsRequestListValue
  {
  public:
    Phase2EncryptionAlgorithmsRequestListValue();
    Phase2EncryptionAlgorithmsRequestListValue(const Aws::Utils::Xml::XmlNode& xmlNode);
    Phase2EncryptionAlgorithmsRequestListValue& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
