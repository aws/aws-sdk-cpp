...
namespace Model
{
  ...
  public:
     ...
     * <p>One or more IPv6 addresses associated with the network interface.</p>
     */
    inline InstanceNetworkInterface& WithIpv6Addresses(Aws::Vector<InstanceIpv6Address>&& value) { SetIpv6Addresses(value); return *this;}
     ...
     * <p>One or more IPv6 addresses associated with the network interface.</p>
     */
    inline InstanceNetworkInterface& AddIpv6Addresses(InstanceIpv6Address&& value) { m_ipv6AddressesHasBeenSet = true; m_ipv6Addresses.push_back(value); return *this; }
