...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEgressOnlyInternetGatewaysRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEgressOnlyInternetGatewaysRequest>(GetServiceRequestName(), *this);
    }
