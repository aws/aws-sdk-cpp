...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteSubnetCidrReservationRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSubnetCidrReservationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSubnetCidrReservationRequest>(GetServiceRequestName(), *this);
    }
