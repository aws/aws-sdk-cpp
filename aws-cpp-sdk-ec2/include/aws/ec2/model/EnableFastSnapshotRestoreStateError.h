...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API EnableFastSnapshotRestoreStateError
  {
  public:
    EnableFastSnapshotRestoreStateError();
    EnableFastSnapshotRestoreStateError(const Aws::Utils::Xml::XmlNode& xmlNode);
    EnableFastSnapshotRestoreStateError& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
