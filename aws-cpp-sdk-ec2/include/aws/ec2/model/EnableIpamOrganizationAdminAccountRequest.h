...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API EnableIpamOrganizationAdminAccountRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableIpamOrganizationAdminAccountRequest> Clone() const
    {
      return Aws::MakeUnique<EnableIpamOrganizationAdminAccountRequest>(GetServiceRequestName(), *this);
    }
