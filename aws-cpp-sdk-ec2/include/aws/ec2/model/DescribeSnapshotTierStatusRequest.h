...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeSnapshotTierStatusRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSnapshotTierStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSnapshotTierStatusRequest>(GetServiceRequestName(), *this);
    }
