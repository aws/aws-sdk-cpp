...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateStoreImageTaskRequest : public EC2Request
  {
  public:
  ...
  public:
    ...
    /**
     * <p>The name of the S3 bucket in which the AMI object will be stored. The bucket
     * must be in the Region in which the request is being made. The AMI object appears
     * in the bucket only after the upload task has completed. </p>
     */
    ...
    /**
     * <p>The tags to apply to the AMI object that will be stored in the S3 bucket.
     * </p>
     */
