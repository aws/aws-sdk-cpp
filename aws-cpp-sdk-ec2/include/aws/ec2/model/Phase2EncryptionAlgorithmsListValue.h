...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API Phase2EncryptionAlgorithmsListValue();
    AWS_EC2_API Phase2EncryptionAlgorithmsListValue(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_EC2_API Phase2EncryptionAlgorithmsListValue& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
