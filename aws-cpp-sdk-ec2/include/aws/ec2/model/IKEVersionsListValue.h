...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API IKEVersionsListValue
  {
  public:
    IKEVersionsListValue();
    IKEVersionsListValue(const Aws::Utils::Xml::XmlNode& xmlNode);
    IKEVersionsListValue& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
