...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterImageRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterImageRequest>(GetServiceRequestName(), *this);
    }
  ...
  public:
     ...
     * <p>The ID of the AMI.</p>
     */
    inline DeregisterImageRequest& WithImageId(Aws::String&& value) { SetImageId(std::move(value)); return *this;}
