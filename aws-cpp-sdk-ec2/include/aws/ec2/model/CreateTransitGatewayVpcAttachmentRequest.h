...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTransitGatewayVpcAttachmentRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTransitGatewayVpcAttachmentRequest>(GetServiceRequestName(), *this);
    }
