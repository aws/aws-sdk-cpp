...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeScheduledInstanceAvailabilityRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeScheduledInstanceAvailabilityRequest>(GetServiceRequestName(), *this);
    }
