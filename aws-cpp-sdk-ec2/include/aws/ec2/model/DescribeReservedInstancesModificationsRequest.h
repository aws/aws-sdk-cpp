...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservedInstancesModificationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservedInstancesModificationsRequest>(GetServiceRequestName(), *this);
    }
