...
namespace Model
{
  class AWS_EC2_API DisableFastSnapshotRestoresResponse
  {
  public:
    DisableFastSnapshotRestoresResponse();
    DisableFastSnapshotRestoresResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DisableFastSnapshotRestoresResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
