...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ModifySecurityGroupRulesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifySecurityGroupRulesRequest> Clone() const
    {
      return Aws::MakeUnique<ModifySecurityGroupRulesRequest>(GetServiceRequestName(), *this);
    }
