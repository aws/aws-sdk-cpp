...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSpotFleetRequestHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSpotFleetRequestHistoryRequest>(GetServiceRequestName(), *this);
    }
