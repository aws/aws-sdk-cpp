...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetVpnConnectionDeviceTypesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetVpnConnectionDeviceTypesRequest> Clone() const
    {
      return Aws::MakeUnique<GetVpnConnectionDeviceTypesRequest>(GetServiceRequestName(), *this);
    }
