...
namespace Model
{
  ...
  /**
   * <p>Contains the parameters for AcceptVpcPeeringConnection.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AcceptVpcPeeringConnectionRequest">AWS
   * API Reference</a></p>
   */
  class AWS_EC2_API AcceptVpcPeeringConnectionRequest : public EC2Request
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "AcceptVpcPeeringConnection"; }
