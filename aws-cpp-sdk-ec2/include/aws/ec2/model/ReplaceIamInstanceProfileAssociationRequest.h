...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ReplaceIamInstanceProfileAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<ReplaceIamInstanceProfileAssociationRequest>(GetServiceRequestName(), *this);
    }
