...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetCoipPoolUsageRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCoipPoolUsageRequest> Clone() const
    {
      return Aws::MakeUnique<GetCoipPoolUsageRequest>(GetServiceRequestName(), *this);
    }
