...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservedInstancesOfferingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservedInstancesOfferingsRequest>(GetServiceRequestName(), *this);
    }
