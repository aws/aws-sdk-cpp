...
{
  /**
   * <p>Contains the output of CreateImage.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CreateImageResult">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline CreateImageResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
