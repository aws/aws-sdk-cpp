...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetTransitGatewayPrefixListReferencesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTransitGatewayPrefixListReferencesRequest> Clone() const
    {
      return Aws::MakeUnique<GetTransitGatewayPrefixListReferencesRequest>(GetServiceRequestName(), *this);
    }
