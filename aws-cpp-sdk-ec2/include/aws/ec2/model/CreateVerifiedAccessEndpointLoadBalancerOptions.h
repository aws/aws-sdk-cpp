...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API CreateVerifiedAccessEndpointLoadBalancerOptions
  {
  public:
    CreateVerifiedAccessEndpointLoadBalancerOptions();
    CreateVerifiedAccessEndpointLoadBalancerOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    CreateVerifiedAccessEndpointLoadBalancerOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
