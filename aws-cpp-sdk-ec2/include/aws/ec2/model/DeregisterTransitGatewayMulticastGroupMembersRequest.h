...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeregisterTransitGatewayMulticastGroupMembersRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterTransitGatewayMulticastGroupMembersRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterTransitGatewayMulticastGroupMembersRequest>(GetServiceRequestName(), *this);
    }
