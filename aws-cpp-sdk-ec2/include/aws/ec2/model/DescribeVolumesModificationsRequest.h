...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVolumesModificationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVolumesModificationsRequest>(GetServiceRequestName(), *this);
    }
