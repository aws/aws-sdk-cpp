...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateCoipCidrRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCoipCidrRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCoipCidrRequest>(GetServiceRequestName(), *this);
    }
