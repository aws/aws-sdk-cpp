...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTrafficMirrorFiltersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTrafficMirrorFiltersRequest>(GetServiceRequestName(), *this);
    }
