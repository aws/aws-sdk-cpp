...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyTransitGatewayPrefixListReferenceRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyTransitGatewayPrefixListReferenceRequest>(GetServiceRequestName(), *this);
    }
