...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyCapacityReservationFleetRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyCapacityReservationFleetRequest>(GetServiceRequestName(), *this);
    }
