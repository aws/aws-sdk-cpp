...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The Amazon Resource Name (ARN) of the AWS Outpost on which to create the
     * local snapshots.</p> <ul> <li> <p>To create snapshots from an instance in a
     * Region, omit this parameter. The snapshots are created in the same Region as the
