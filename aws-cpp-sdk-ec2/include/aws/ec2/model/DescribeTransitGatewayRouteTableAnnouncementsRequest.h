...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTransitGatewayRouteTableAnnouncementsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTransitGatewayRouteTableAnnouncementsRequest>(GetServiceRequestName(), *this);
    }
