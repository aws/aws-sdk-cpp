...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteLocalGatewayRouteTableRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLocalGatewayRouteTableRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLocalGatewayRouteTableRequest>(GetServiceRequestName(), *this);
    }
