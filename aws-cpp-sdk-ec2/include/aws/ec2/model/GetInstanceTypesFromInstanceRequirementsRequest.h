...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetInstanceTypesFromInstanceRequirementsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetInstanceTypesFromInstanceRequirementsRequest> Clone() const
    {
      return Aws::MakeUnique<GetInstanceTypesFromInstanceRequirementsRequest>(GetServiceRequestName(), *this);
    }
