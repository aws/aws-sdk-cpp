...
namespace Model
{
  class AWS_EC2_API GetDefaultCreditSpecificationResponse
  {
  public:
    GetDefaultCreditSpecificationResponse();
    GetDefaultCreditSpecificationResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    GetDefaultCreditSpecificationResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
