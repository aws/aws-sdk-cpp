...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeReplaceRootVolumeTasksRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReplaceRootVolumeTasksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReplaceRootVolumeTasksRequest>(GetServiceRequestName(), *this);
    }
