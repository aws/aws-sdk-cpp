...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteQueuedReservedInstancesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteQueuedReservedInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteQueuedReservedInstancesRequest>(GetServiceRequestName(), *this);
    }
