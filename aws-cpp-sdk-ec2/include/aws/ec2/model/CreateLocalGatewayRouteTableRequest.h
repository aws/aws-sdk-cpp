...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLocalGatewayRouteTableRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLocalGatewayRouteTableRequest>(GetServiceRequestName(), *this);
    }
