...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSecurityGroupRuleDescriptionsEgressRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSecurityGroupRuleDescriptionsEgressRequest>(GetServiceRequestName(), *this);
    }
