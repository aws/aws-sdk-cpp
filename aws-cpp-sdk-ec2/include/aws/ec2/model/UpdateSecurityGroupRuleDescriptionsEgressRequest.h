...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/UpdateSecurityGroupRuleDescriptionsEgressRequest">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "UpdateSecurityGroupRuleDescriptionsEgress"; }
