...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCapacityReservationFleetRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCapacityReservationFleetRequest>(GetServiceRequestName(), *this);
    }
