...
namespace Model
{
  ...
  public:
     ...
     * <code>2010-09-15T17:15:20.000Z</code>.</p> </li> <li>
     * <p><code>block-device-mapping.delete-on-termination</code> - A Boolean that
     ...
     * <li> <p><code>block-device-mapping.status</code> - The status for the EBS volume
     * (<code>attaching</code> | <code>attached</code> | <code>detaching</code> |
     * <code>detached</code>).</p> </li> <li>
     * <p><code>block-device-mapping.volume-id</code> - The volume ID of the EBS
     * volume.</p> </li> <li> <p><code>client-token</code> - The idempotency token you
     * provided when you launched the instance.</p> </li> <li> <p><code>dns-name</code>
     ...
     * <p><code>reason</code> - The reason for the current state of the instance (for
     * example, shows "User Initiated [date]" when you stop or terminate the instance).
     * Similar to the state-reason-code filter.</p> </li> <li>
     * <p><code>requester-id</code> - The ID of the entity that launched the instance
     ...
     * same launch request, you'll also get one reservation ID.</p> </li> <li>
     * <p><code>root-device-name</code> - The name of the root device for the instance
     ...
     * uses (<code>ebs</code> | <code>instance-store</code>).</p> </li> <li>
     * <p><code>source-dest-check</code> - Indicates whether the instance performs
     ...
     * <code>tag</code>:<i>key</i> is the tag's key. </p> </li> <li>
     ...
     * network interface is being managed by AWS.</p> </li> <li>
     ...
     * network address translation (NAT) in your VPC.</p> </li> <li>
     * <p><code>network-interface.group-id</code> - The ID of a security group
     * associated with the network interface.</p> </li> <li>
     * <p><code>network-interface.group-name</code> - The name of a security group
     * associated with the network interface.</p> </li> <li>
     * <p><code>network-interface.attachment.attachment-id</code> - The ID of the
     * interface attachment.</p> </li> <li>
     * <p><code>network-interface.attachment.instance-id</code> - The ID of the
     * instance to which the network interface is attached.</p> </li> <li>
     * <p><code>network-interface.attachment.instance-owner-id</code> - The owner ID of
     * the instance to which the network interface is attached.</p> </li> <li>
     * <p><code>network-interface.addresses.private-ip-address</code> - The private IP
     * address associated with the network interface.</p> </li> <li>
     * <p><code>network-interface.attachment.device-index</code> - The device index to
     * which the network interface is attached.</p> </li> <li>
     * <p><code>network-interface.attachment.status</code> - The status of the
     * attachment (<code>attaching</code> | <code>attached</code> |
     * <code>detaching</code> | <code>detached</code>).</p> </li> <li>
     * <p><code>network-interface.attachment.attach-time</code> - The time that the
     * network interface was attached to an instance.</p> </li> <li>
     * <p><code>network-interface.attachment.delete-on-termination</code> - Specifies
     * whether the attachment is deleted when an instance is terminated.</p> </li> <li>
     * <p><code>network-interface.addresses.primary</code> - Specifies whether the IP
     * address of the network interface is the primary private IP address.</p> </li>
     * <li> <p><code>network-interface.addresses.association.public-ip</code> - The ID
     * of the association of an Elastic IP address with a network interface.</p> </li>
     * <li> <p><code>network-interface.addresses.association.ip-owner-id</code> - The
     * owner ID of the private IP address associated with the network interface.</p>
     * </li> <li> <p><code>association.public-ip</code> - The address of the Elastic IP
     * address bound to the network interface.</p> </li> <li>
     ...
     * the network interface was associated with an IP address.</p> </li> </ul>
     */
