...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateInstanceEventWindowRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateInstanceEventWindowRequest>(GetServiceRequestName(), *this);
    }
