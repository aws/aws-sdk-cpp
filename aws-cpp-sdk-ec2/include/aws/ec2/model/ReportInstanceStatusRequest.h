...
namespace Model
{
  ...
  public:
     ...
     * instance is not accepting my credentials.</p></li>
     * <li><p><code>password-not-available</code>: A password is not available for my
     ...
     * stores.</p></li> <li><p><code>performance-ebs-volume</code>: My instance is
     * experiencing performance problems which I believe are related to an EBS
     * volume.</p></li> <li><p><code>performance-other</code>: My instance is
     * experiencing performance problems.</p></li> <li><p><code>other</code>: [explain
     * using the description parameter]</p></li> </ul>
     */
