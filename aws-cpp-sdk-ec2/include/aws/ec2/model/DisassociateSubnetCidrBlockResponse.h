...
namespace Model
{
  ...
  public:
    ...
    DisassociateSubnetCidrBlockResponse(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DisassociateSubnetCidrBlockResponse& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
