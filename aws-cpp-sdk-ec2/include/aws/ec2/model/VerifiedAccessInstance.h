...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API VerifiedAccessInstance
  {
  public:
    VerifiedAccessInstance();
    VerifiedAccessInstance(const Aws::Utils::Xml::XmlNode& xmlNode);
    VerifiedAccessInstance& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
