...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSecurityGroupRuleDescriptionsIngressRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSecurityGroupRuleDescriptionsIngressRequest>(GetServiceRequestName(), *this);
    }
