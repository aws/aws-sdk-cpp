...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API UpdateSecurityGroupRuleDescriptionsIngressRequest : public EC2Request
  {
  public:
  ...
  public:
    ...
    /**
     * <p>The IP permissions for the security group rule. You can either specify this
     * parameter, or the <code>SecurityGroupRuleDescriptions</code> parameter.</p>
     */
    ...
    /**
     * <p>[VPC only] The description for the ingress security group rules. You can
     * either specify this parameter, or the <code>IpPermissions</code> parameter.</p>
     */
