...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVpcEndpointServiceConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVpcEndpointServiceConfigurationsRequest>(GetServiceRequestName(), *this);
    }
