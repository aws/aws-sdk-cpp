...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API VerifiedAccessGroup
  {
  public:
    VerifiedAccessGroup();
    VerifiedAccessGroup(const Aws::Utils::Xml::XmlNode& xmlNode);
    VerifiedAccessGroup& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
