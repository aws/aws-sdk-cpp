...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNetworkInsightsPathsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNetworkInsightsPathsRequest>(GetServiceRequestName(), *this);
    }
