...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyInstanceCreditSpecificationRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyInstanceCreditSpecificationRequest>(GetServiceRequestName(), *this);
    }
