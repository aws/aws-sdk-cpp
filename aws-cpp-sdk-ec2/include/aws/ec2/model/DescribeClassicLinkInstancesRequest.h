...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeClassicLinkInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeClassicLinkInstancesRequest>(GetServiceRequestName(), *this);
    }
