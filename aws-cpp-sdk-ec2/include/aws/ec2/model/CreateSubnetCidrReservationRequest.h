...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateSubnetCidrReservationRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSubnetCidrReservationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSubnetCidrReservationRequest>(GetServiceRequestName(), *this);
    }
