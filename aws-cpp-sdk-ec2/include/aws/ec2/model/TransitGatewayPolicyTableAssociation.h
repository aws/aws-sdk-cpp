...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API TransitGatewayPolicyTableAssociation
  {
  public:
    TransitGatewayPolicyTableAssociation();
    TransitGatewayPolicyTableAssociation(const Aws::Utils::Xml::XmlNode& xmlNode);
    TransitGatewayPolicyTableAssociation& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
