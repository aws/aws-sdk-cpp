...
namespace Model
{
  ...
  /**
   * <p>Describes fast snapshot restores for a snapshot.</p><p><h3>See Also:</h3>  
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeFastSnapshotRestoreSuccessItem">AWS
   * API Reference</a></p>
   */
  class AWS_EC2_API DescribeFastSnapshotRestoreSuccessItem
  {
  public:
    DescribeFastSnapshotRestoreSuccessItem();
    DescribeFastSnapshotRestoreSuccessItem(const Aws::Utils::Xml::XmlNode& xmlNode);
    DescribeFastSnapshotRestoreSuccessItem& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
    ...
    /**
     * <p>The ID of the account that enabled fast snapshot restores on the
     * snapshot.</p>
     */
     ...
     * state.</p>
     */
    inline DescribeFastSnapshotRestoreSuccessItem& WithDisabledTime(Aws::Utils::DateTime&& value) { SetDisabledTime(std::move(value)); return *this;}
