...
namespace Model
{
  class AWS_EC2_API ModifyLaunchTemplateResponse
  {
  public:
    ModifyLaunchTemplateResponse();
    ModifyLaunchTemplateResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ModifyLaunchTemplateResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
