...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLocalGatewayRouteTableVpcAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLocalGatewayRouteTableVpcAssociationsRequest>(GetServiceRequestName(), *this);
    }
