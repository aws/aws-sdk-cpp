...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DisableFastSnapshotRestoresRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableFastSnapshotRestoresRequest> Clone() const
    {
      return Aws::MakeUnique<DisableFastSnapshotRestoresRequest>(GetServiceRequestName(), *this);
    }
