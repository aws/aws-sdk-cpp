...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteInstanceEventWindowRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteInstanceEventWindowRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteInstanceEventWindowRequest>(GetServiceRequestName(), *this);
    }
