...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateNetworkInterfacePermissionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateNetworkInterfacePermissionRequest>(GetServiceRequestName(), *this);
    }
