...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSpotDatafeedSubscriptionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSpotDatafeedSubscriptionRequest>(GetServiceRequestName(), *this);
    }
