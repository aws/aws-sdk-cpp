...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API VerifiedAccessLogOptions
  {
  public:
    VerifiedAccessLogOptions();
    VerifiedAccessLogOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    VerifiedAccessLogOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
