...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyTrafficMirrorFilterNetworkServicesRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyTrafficMirrorFilterNetworkServicesRequest>(GetServiceRequestName(), *this);
    }
