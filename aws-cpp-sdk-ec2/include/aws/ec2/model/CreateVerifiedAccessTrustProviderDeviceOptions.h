...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API CreateVerifiedAccessTrustProviderDeviceOptions
  {
  public:
    CreateVerifiedAccessTrustProviderDeviceOptions();
    CreateVerifiedAccessTrustProviderDeviceOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    CreateVerifiedAccessTrustProviderDeviceOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
