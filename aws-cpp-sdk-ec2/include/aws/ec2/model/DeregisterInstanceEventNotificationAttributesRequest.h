...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeregisterInstanceEventNotificationAttributesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterInstanceEventNotificationAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterInstanceEventNotificationAttributesRequest>(GetServiceRequestName(), *this);
    }
