...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreatePublicIpv4PoolRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreatePublicIpv4PoolRequest> Clone() const
    {
      return Aws::MakeUnique<CreatePublicIpv4PoolRequest>(GetServiceRequestName(), *this);
    }
