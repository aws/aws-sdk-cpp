...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ResetNetworkInterfaceAttributeRequest> Clone() const
    {
      return Aws::MakeUnique<ResetNetworkInterfaceAttributeRequest>(GetServiceRequestName(), *this);
    }
