...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ApplySecurityGroupsToClientVpnTargetNetworkRequest> Clone() const
    {
      return Aws::MakeUnique<ApplySecurityGroupsToClientVpnTargetNetworkRequest>(GetServiceRequestName(), *this);
    }
