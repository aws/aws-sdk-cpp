...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ReplaceNetworkAclAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<ReplaceNetworkAclAssociationRequest>(GetServiceRequestName(), *this);
    }
