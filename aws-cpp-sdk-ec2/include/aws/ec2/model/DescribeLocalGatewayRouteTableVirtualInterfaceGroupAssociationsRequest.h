...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest>(GetServiceRequestName(), *this);
    }
