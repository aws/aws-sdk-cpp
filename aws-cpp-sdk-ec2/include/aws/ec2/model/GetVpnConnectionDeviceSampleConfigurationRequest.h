...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetVpnConnectionDeviceSampleConfigurationRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetVpnConnectionDeviceSampleConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetVpnConnectionDeviceSampleConfigurationRequest>(GetServiceRequestName(), *this);
    }
