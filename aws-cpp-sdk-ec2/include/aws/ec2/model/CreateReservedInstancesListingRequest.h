...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateReservedInstancesListingRequest> Clone() const
    {
      return Aws::MakeUnique<CreateReservedInstancesListingRequest>(GetServiceRequestName(), *this);
    }
