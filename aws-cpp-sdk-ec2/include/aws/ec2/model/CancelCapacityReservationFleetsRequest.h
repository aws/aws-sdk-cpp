...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CancelCapacityReservationFleetsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelCapacityReservationFleetsRequest> Clone() const
    {
      return Aws::MakeUnique<CancelCapacityReservationFleetsRequest>(GetServiceRequestName(), *this);
    }
