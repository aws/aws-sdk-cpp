...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTransitGatewayConnectRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTransitGatewayConnectRequest>(GetServiceRequestName(), *this);
    }
