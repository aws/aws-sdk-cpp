...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSecurityGroupReferencesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSecurityGroupReferencesRequest>(GetServiceRequestName(), *this);
    }
