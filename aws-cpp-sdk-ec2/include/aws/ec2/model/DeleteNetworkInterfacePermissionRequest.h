...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteNetworkInterfacePermissionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteNetworkInterfacePermissionRequest>(GetServiceRequestName(), *this);
    }
