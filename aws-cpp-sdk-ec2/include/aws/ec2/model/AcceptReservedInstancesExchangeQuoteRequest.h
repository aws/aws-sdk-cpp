...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AcceptReservedInstancesExchangeQuoteRequest> Clone() const
    {
      return Aws::MakeUnique<AcceptReservedInstancesExchangeQuoteRequest>(GetServiceRequestName(), *this);
    }
