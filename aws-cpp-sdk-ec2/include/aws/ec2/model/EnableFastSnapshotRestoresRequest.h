...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API EnableFastSnapshotRestoresRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableFastSnapshotRestoresRequest> Clone() const
    {
      return Aws::MakeUnique<EnableFastSnapshotRestoresRequest>(GetServiceRequestName(), *this);
    }
