...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLocalGatewayRouteTablesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLocalGatewayRouteTablesRequest>(GetServiceRequestName(), *this);
    }
