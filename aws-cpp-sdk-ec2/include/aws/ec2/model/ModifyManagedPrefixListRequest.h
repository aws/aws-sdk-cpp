...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ModifyManagedPrefixListRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyManagedPrefixListRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyManagedPrefixListRequest>(GetServiceRequestName(), *this);
    }
