...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVpcEndpointConnectionNotificationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVpcEndpointConnectionNotificationsRequest>(GetServiceRequestName(), *this);
    }
