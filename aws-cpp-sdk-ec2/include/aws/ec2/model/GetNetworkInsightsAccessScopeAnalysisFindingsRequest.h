...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API GetNetworkInsightsAccessScopeAnalysisFindingsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetNetworkInsightsAccessScopeAnalysisFindingsRequest> Clone() const
    {
      return Aws::MakeUnique<GetNetworkInsightsAccessScopeAnalysisFindingsRequest>(GetServiceRequestName(), *this);
    }
