...
namespace Model
{
  ...
  public:
    ...
    CreateDefaultVpcResponse(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    CreateDefaultVpcResponse& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
