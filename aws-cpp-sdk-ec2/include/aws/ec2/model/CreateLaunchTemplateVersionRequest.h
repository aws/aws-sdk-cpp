...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLaunchTemplateVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLaunchTemplateVersionRequest>(GetServiceRequestName(), *this);
    }
