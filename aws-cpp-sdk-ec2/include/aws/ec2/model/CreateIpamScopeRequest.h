...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateIpamScopeRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateIpamScopeRequest> Clone() const
    {
      return Aws::MakeUnique<CreateIpamScopeRequest>(GetServiceRequestName(), *this);
    }
