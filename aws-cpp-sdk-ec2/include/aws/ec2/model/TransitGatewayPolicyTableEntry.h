...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API TransitGatewayPolicyTableEntry
  {
  public:
    TransitGatewayPolicyTableEntry();
    TransitGatewayPolicyTableEntry(const Aws::Utils::Xml::XmlNode& xmlNode);
    TransitGatewayPolicyTableEntry& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
