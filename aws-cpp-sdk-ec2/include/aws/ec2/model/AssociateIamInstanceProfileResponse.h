...
namespace Model
{
  ...
  public:
    ...
    AssociateIamInstanceProfileResponse(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    AssociateIamInstanceProfileResponse& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
     ...
     * <p>Information about the IAM instance profile association.</p>
     */
    inline AssociateIamInstanceProfileResponse& WithIamInstanceProfileAssociation(IamInstanceProfileAssociation&& value) { SetIamInstanceProfileAssociation(value); return *this;}
    ...
    inline AssociateIamInstanceProfileResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
