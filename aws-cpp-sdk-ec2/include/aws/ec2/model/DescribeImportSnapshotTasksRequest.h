...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeImportSnapshotTasksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeImportSnapshotTasksRequest>(GetServiceRequestName(), *this);
    }
