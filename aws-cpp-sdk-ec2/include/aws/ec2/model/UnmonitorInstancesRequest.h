...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UnmonitorInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<UnmonitorInstancesRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "UnmonitorInstances"; }
