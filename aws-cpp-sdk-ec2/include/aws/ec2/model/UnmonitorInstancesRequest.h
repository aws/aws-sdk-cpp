...
namespace Model
{
  ...
  /**
   * <p>Contains the parameters for UnmonitorInstances.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/UnmonitorInstancesRequest">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "UnmonitorInstances"; }
  ...
  public:
     ...
     * <p>One or more instance IDs.</p>
     */
    inline UnmonitorInstancesRequest& WithInstanceIds(Aws::Vector<Aws::String>&& value) { SetInstanceIds(std::move(value)); return *this;}
     ...
     * <p>One or more instance IDs.</p>
     */
    inline UnmonitorInstancesRequest& AddInstanceIds(Aws::String&& value) { m_instanceIdsHasBeenSet = true; m_instanceIds.push_back(std::move(value)); return *this; }
