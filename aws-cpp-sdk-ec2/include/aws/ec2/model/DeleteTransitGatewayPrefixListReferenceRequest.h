...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteTransitGatewayPrefixListReferenceRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTransitGatewayPrefixListReferenceRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTransitGatewayPrefixListReferenceRequest>(GetServiceRequestName(), *this);
    }
