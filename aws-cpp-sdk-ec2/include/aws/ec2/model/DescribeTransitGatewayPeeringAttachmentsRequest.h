...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeTransitGatewayPeeringAttachmentsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTransitGatewayPeeringAttachmentsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTransitGatewayPeeringAttachmentsRequest>(GetServiceRequestName(), *this);
    }
