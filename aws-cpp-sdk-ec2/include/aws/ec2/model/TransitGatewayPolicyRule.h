...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API TransitGatewayPolicyRule
  {
  public:
    TransitGatewayPolicyRule();
    TransitGatewayPolicyRule(const Aws::Utils::Xml::XmlNode& xmlNode);
    TransitGatewayPolicyRule& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
