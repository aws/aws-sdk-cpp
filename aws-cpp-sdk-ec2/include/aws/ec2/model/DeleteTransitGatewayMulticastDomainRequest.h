...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteTransitGatewayMulticastDomainRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTransitGatewayMulticastDomainRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTransitGatewayMulticastDomainRequest>(GetServiceRequestName(), *this);
    }
