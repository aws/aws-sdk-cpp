...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API RemovePrefixListEntry
  {
  public:
    RemovePrefixListEntry();
    RemovePrefixListEntry(const Aws::Utils::Xml::XmlNode& xmlNode);
    RemovePrefixListEntry& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
