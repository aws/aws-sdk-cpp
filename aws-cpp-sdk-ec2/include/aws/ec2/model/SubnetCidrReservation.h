...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API SubnetCidrReservation
  {
  public:
    SubnetCidrReservation();
    SubnetCidrReservation(const Aws::Utils::Xml::XmlNode& xmlNode);
    SubnetCidrReservation& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
