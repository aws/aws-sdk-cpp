...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyInstanceMaintenanceOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyInstanceMaintenanceOptionsRequest>(GetServiceRequestName(), *this);
    }
