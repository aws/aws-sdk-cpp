...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API InstanceEventWindowTimeRangeRequest
  {
  public:
    InstanceEventWindowTimeRangeRequest();
    InstanceEventWindowTimeRangeRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    InstanceEventWindowTimeRangeRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
