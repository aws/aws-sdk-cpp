...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ResetAddressAttributeRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ResetAddressAttributeRequest> Clone() const
    {
      return Aws::MakeUnique<ResetAddressAttributeRequest>(GetServiceRequestName(), *this);
    }
