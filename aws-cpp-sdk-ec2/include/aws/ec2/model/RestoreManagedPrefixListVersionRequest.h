...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API RestoreManagedPrefixListVersionRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RestoreManagedPrefixListVersionRequest> Clone() const
    {
      return Aws::MakeUnique<RestoreManagedPrefixListVersionRequest>(GetServiceRequestName(), *this);
    }
