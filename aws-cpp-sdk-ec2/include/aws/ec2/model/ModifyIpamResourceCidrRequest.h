...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ModifyIpamResourceCidrRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyIpamResourceCidrRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyIpamResourceCidrRequest>(GetServiceRequestName(), *this);
    }
