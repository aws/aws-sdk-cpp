...
{
  /**
   * <p>Contains the output for ImportInstance.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ImportInstanceResult">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline ImportInstanceResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
