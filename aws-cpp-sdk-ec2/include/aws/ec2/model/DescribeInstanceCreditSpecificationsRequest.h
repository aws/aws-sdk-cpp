...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInstanceCreditSpecificationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInstanceCreditSpecificationsRequest>(GetServiceRequestName(), *this);
    }
