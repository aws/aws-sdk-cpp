...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateTransitGatewayPolicyTableRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTransitGatewayPolicyTableRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTransitGatewayPolicyTableRequest>(GetServiceRequestName(), *this);
    }
