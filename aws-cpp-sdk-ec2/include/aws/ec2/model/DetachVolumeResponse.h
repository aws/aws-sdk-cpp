...
namespace Model
{
  ...
  public:
    ...
    DetachVolumeResponse(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DetachVolumeResponse& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
     ...
     * <p>The time stamp when the attachment initiated.</p>
     */
    inline DetachVolumeResponse& WithAttachTime(Aws::Utils::DateTime&& value) { SetAttachTime(value); return *this;}
    ...
    inline DetachVolumeResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
