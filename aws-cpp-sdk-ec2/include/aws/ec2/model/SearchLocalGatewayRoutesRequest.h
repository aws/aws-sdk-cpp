...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API SearchLocalGatewayRoutesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchLocalGatewayRoutesRequest> Clone() const
    {
      return Aws::MakeUnique<SearchLocalGatewayRoutesRequest>(GetServiceRequestName(), *this);
    }
