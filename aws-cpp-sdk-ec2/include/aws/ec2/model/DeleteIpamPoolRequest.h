...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeleteIpamPoolRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteIpamPoolRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteIpamPoolRequest>(GetServiceRequestName(), *this);
    }
