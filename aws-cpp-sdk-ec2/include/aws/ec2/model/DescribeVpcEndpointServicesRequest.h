...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVpcEndpointServicesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVpcEndpointServicesRequest>(GetServiceRequestName(), *this);
    }
