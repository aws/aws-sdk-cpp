...
namespace Model
{
  ...
  public:
     ...
     * the snapshot.</p> </li> <li> <p> <code>owner-alias</code> - Value from an
     * Amazon-maintained list (<code>amazon</code> | <code>self</code> |
     * <code>all</code> | <code>aws-marketplace</code> | <code>microsoft</code>) of
     * snapshot owners. Not to be confused with the user-configured AWS account alias,
     * which is set from the IAM console.</p> </li> <li> <p> <code>owner-id</code> -
     * The ID of the AWS account that owns the snapshot.</p> </li> <li> <p>
