...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DeprovisionPublicIpv4PoolCidrRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeprovisionPublicIpv4PoolCidrRequest> Clone() const
    {
      return Aws::MakeUnique<DeprovisionPublicIpv4PoolCidrRequest>(GetServiceRequestName(), *this);
    }
