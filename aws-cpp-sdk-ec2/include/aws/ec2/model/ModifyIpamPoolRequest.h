...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ModifyIpamPoolRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyIpamPoolRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyIpamPoolRequest>(GetServiceRequestName(), *this);
    }
