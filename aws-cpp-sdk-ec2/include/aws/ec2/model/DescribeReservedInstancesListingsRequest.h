...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservedInstancesListingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservedInstancesListingsRequest>(GetServiceRequestName(), *this);
    }
