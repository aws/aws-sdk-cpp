...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API VerifiedAccessEndpoint
  {
  public:
    VerifiedAccessEndpoint();
    VerifiedAccessEndpoint(const Aws::Utils::Xml::XmlNode& xmlNode);
    VerifiedAccessEndpoint& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
