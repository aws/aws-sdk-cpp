...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateIamInstanceProfileRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateIamInstanceProfileRequest>(GetServiceRequestName(), *this);
    }
