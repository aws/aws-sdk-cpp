...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DisassociateClientVpnTargetNetworkRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateClientVpnTargetNetworkRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateClientVpnTargetNetworkRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DisassociateClientVpnTargetNetwork"; }
