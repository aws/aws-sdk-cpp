...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ModifyVpnTunnelOptionsRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyVpnTunnelOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyVpnTunnelOptionsRequest>(GetServiceRequestName(), *this);
    }
