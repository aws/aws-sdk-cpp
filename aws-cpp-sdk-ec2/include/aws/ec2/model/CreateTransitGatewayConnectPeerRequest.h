...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateTransitGatewayConnectPeerRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTransitGatewayConnectPeerRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTransitGatewayConnectPeerRequest>(GetServiceRequestName(), *this);
    }
