...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVpcClassicLinkDnsSupportRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVpcClassicLinkDnsSupportRequest>(GetServiceRequestName(), *this);
    }
