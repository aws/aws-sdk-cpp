...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API RestoreSnapshotTierRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RestoreSnapshotTierRequest> Clone() const
    {
      return Aws::MakeUnique<RestoreSnapshotTierRequest>(GetServiceRequestName(), *this);
    }
