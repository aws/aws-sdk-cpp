...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API CreateNetworkInsightsPathRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateNetworkInsightsPathRequest> Clone() const
    {
      return Aws::MakeUnique<CreateNetworkInsightsPathRequest>(GetServiceRequestName(), *this);
    }
