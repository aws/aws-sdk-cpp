...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyVpcEndpointServicePayerResponsibilityRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyVpcEndpointServicePayerResponsibilityRequest>(GetServiceRequestName(), *this);
    }
