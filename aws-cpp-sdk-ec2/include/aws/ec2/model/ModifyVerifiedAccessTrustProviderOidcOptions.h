...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API ModifyVerifiedAccessTrustProviderOidcOptions
  {
  public:
    ModifyVerifiedAccessTrustProviderOidcOptions();
    ModifyVerifiedAccessTrustProviderOidcOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    ModifyVerifiedAccessTrustProviderOidcOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
