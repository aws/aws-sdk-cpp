...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/LicenseConfiguration">AWS
   * API Reference</a></p>
   */
  class AWS_EC2_API LicenseConfiguration
  {
  public:
    LicenseConfiguration();
    LicenseConfiguration(const Aws::Utils::Xml::XmlNode& xmlNode);
    LicenseConfiguration& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
