...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyTransitGatewayVpcAttachmentRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyTransitGatewayVpcAttachmentRequest>(GetServiceRequestName(), *this);
    }
