...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API ModifyVerifiedAccessEndpointLoadBalancerOptions
  {
  public:
    ModifyVerifiedAccessEndpointLoadBalancerOptions();
    ModifyVerifiedAccessEndpointLoadBalancerOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    ModifyVerifiedAccessEndpointLoadBalancerOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
