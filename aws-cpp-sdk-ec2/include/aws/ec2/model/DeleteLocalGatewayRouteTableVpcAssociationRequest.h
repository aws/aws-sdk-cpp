...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLocalGatewayRouteTableVpcAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLocalGatewayRouteTableVpcAssociationRequest>(GetServiceRequestName(), *this);
    }
