...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ModifyIpamRequest : public EC2Request
  {
  public:
    ModifyIpamRequest();
    ...
    */
    virtual Aws::UniquePtr<ModifyIpamRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyIpamRequest>(GetServiceRequestName(), *this);
    }
