...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLaunchTemplateVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLaunchTemplateVersionsRequest>(GetServiceRequestName(), *this);
    }
