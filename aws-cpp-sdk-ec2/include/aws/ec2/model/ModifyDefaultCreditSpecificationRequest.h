...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ModifyDefaultCreditSpecificationRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyDefaultCreditSpecificationRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyDefaultCreditSpecificationRequest>(GetServiceRequestName(), *this);
    }
