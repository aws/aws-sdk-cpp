...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateReplaceRootVolumeTaskRequest> Clone() const
    {
      return Aws::MakeUnique<CreateReplaceRootVolumeTaskRequest>(GetServiceRequestName(), *this);
    }
