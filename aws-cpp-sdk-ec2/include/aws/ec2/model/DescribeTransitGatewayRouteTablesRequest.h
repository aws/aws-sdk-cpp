...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTransitGatewayRouteTablesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTransitGatewayRouteTablesRequest>(GetServiceRequestName(), *this);
    }
