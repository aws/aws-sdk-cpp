...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API VerifiedAccessLogs
  {
  public:
    VerifiedAccessLogs();
    VerifiedAccessLogs(const Aws::Utils::Xml::XmlNode& xmlNode);
    VerifiedAccessLogs& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
