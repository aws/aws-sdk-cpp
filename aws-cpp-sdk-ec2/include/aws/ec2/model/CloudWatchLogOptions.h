...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API CloudWatchLogOptions
  {
  public:
    CloudWatchLogOptions();
    CloudWatchLogOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    CloudWatchLogOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
