...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeFastSnapshotRestoresRequest : public EC2Request
  {
  public:
  ...
  public:
     ...
     * <li> <p> <code>owner-id</code>: The ID of the account that enabled fast snapshot
     * restore on the snapshot.</p> </li> <li> <p> <code>snapshot-id</code>: The ID of
     * the snapshot.</p> </li> <li> <p> <code>state</code>: The state of fast snapshot
     * restores for the snapshot (<code>enabling</code> | <code>optimizing</code> |
     * <code>enabled</code> | <code>disabling</code> | <code>disabled</code>).</p>
     * </li> </ul>
     */
