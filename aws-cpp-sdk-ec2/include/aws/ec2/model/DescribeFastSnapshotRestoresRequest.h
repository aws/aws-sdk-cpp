...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFastSnapshotRestoresRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFastSnapshotRestoresRequest>(GetServiceRequestName(), *this);
    }
