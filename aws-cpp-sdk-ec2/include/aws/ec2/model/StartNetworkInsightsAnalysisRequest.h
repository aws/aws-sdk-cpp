...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API StartNetworkInsightsAnalysisRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartNetworkInsightsAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<StartNetworkInsightsAnalysisRequest>(GetServiceRequestName(), *this);
    }
