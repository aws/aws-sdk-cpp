...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API DescribeNetworkInsightsAccessScopeAnalysesRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNetworkInsightsAccessScopeAnalysesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNetworkInsightsAccessScopeAnalysesRequest>(GetServiceRequestName(), *this);
    }
