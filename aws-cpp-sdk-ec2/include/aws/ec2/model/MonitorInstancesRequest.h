...
namespace Model
{
  ...
  /**
   * <p>Contains the parameters for MonitorInstances.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/MonitorInstancesRequest">AWS
   * API Reference</a></p>
   */
  ...
  public:
     ...
     * <p>One or more instance IDs.</p>
     */
    inline MonitorInstancesRequest& WithInstanceIds(Aws::Vector<Aws::String>&& value) { SetInstanceIds(value); return *this;}
