...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2_API ModifySnapshotTierRequest : public EC2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifySnapshotTierRequest> Clone() const
    {
      return Aws::MakeUnique<ModifySnapshotTierRequest>(GetServiceRequestName(), *this);
    }
