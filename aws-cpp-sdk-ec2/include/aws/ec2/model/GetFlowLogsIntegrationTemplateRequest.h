...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetFlowLogsIntegrationTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetFlowLogsIntegrationTemplateRequest>(GetServiceRequestName(), *this);
    }
