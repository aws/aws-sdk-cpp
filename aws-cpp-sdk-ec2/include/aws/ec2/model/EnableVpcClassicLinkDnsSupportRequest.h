...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableVpcClassicLinkDnsSupportRequest> Clone() const
    {
      return Aws::MakeUnique<EnableVpcClassicLinkDnsSupportRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "EnableVpcClassicLinkDnsSupport"; }
