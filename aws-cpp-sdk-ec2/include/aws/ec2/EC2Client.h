...
namespace EC2
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        EC2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::EC2EndpointProvider> endpointProvider = Aws::MakeShared<EC2::Endpoint::EC2EndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::EC2EndpointProvider> m_endpointProvider;
  };
