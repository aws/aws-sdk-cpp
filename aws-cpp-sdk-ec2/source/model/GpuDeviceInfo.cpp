...
GpuDeviceInfo& GpuDeviceInfo::operator =(const XmlNode& xmlNode)
{
...
void GpuDeviceInfo::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
  if(m_nameHasBeenSet)
  {
...
void GpuDeviceInfo::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_nameHasBeenSet)
  {
