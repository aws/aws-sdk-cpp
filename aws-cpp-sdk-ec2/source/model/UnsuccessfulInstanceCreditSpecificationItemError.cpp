...
UnsuccessfulInstanceCreditSpecificationItemError& UnsuccessfulInstanceCreditSpecificationItemError::operator =(const XmlNode& xmlNode)
{
  ...
  if(!resultNode.IsNull())
  {
    ...
    if(!codeNode.IsNull())
    {
      m_code = UnsuccessfulInstanceCreditSpecificationErrorCodeMapper::GetUnsuccessfulInstanceCreditSpecificationErrorCodeForName(StringUtils::Trim(codeNode.GetText().c_str()).c_str());
