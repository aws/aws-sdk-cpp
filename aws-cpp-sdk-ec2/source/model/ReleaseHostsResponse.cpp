...
ReleaseHostsResponse::ReleaseHostsResponse(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

ReleaseHostsResponse& ReleaseHostsResponse::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
