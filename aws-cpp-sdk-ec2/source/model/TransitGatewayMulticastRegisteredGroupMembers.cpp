...
TransitGatewayMulticastRegisteredGroupMembers& TransitGatewayMulticastRegisteredGroupMembers::operator =(const XmlNode& xmlNode)
{
...
void TransitGatewayMulticastRegisteredGroupMembers::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void TransitGatewayMulticastRegisteredGroupMembers::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_transitGatewayMulticastDomainIdHasBeenSet)
  {
