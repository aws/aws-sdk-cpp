...
SpotFleetTagSpecification& SpotFleetTagSpecification::operator =(const XmlNode& xmlNode)
{
...
void SpotFleetTagSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void SpotFleetTagSpecification::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_resourceTypeHasBeenSet)
  {
