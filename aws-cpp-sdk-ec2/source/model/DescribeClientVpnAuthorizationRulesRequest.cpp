...
Aws::String DescribeClientVpnAuthorizationRulesRequest::SerializePayload() const
{
  Aws::StringStream ss;
  ss << "Action=DescribeClientVpnAuthorizationRules&";
...
void  DescribeClientVpnAuthorizationRulesRequest::DumpBodyToUrl(Aws::Http::URI& uri ) const
{
