...
ClientCertificateRevocationListStatus& ClientCertificateRevocationListStatus::operator =(const XmlNode& xmlNode)
{
...
void ClientCertificateRevocationListStatus::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
  if(m_codeHasBeenSet)
  {
...
void ClientCertificateRevocationListStatus::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_codeHasBeenSet)
  {
