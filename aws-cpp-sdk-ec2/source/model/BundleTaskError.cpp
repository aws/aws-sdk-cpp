...
BundleTaskError& BundleTaskError::operator =(const XmlNode& xmlNode)
{
...
void BundleTaskError::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
  if(m_codeHasBeenSet)
  {
...
void BundleTaskError::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_codeHasBeenSet)
  {
