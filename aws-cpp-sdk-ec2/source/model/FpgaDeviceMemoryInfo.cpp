...
FpgaDeviceMemoryInfo& FpgaDeviceMemoryInfo::operator =(const XmlNode& xmlNode)
{
...
void FpgaDeviceMemoryInfo::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void FpgaDeviceMemoryInfo::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_sizeInMiBHasBeenSet)
  {
