...
UnsuccessfulItemError& UnsuccessfulItemError::operator =(const XmlNode& xmlNode)
{
...
void UnsuccessfulItemError::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
  if(m_codeHasBeenSet)
  {
...
void UnsuccessfulItemError::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_codeHasBeenSet)
  {
