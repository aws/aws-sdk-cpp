...
Aws::String GetTransitGatewayMulticastDomainAssociationsRequest::SerializePayload() const
{
  Aws::StringStream ss;
  ss << "Action=GetTransitGatewayMulticastDomainAssociations&";
...
void  GetTransitGatewayMulticastDomainAssociationsRequest::DumpBodyToUrl(Aws::Http::URI& uri ) const
{
