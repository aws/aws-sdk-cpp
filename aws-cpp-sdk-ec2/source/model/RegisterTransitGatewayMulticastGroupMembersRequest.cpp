...
Aws::String RegisterTransitGatewayMulticastGroupMembersRequest::SerializePayload() const
{
  Aws::StringStream ss;
  ss << "Action=RegisterTransitGatewayMulticastGroupMembers&";
...
void  RegisterTransitGatewayMulticastGroupMembersRequest::DumpBodyToUrl(Aws::Http::URI& uri ) const
{
