...
TransitGatewayPolicyTableAssociation::TransitGatewayPolicyTableAssociation(const XmlNode& xmlNode) : 
    m_transitGatewayPolicyTableIdHasBeenSet(false),
    m_transitGatewayAttachmentIdHasBeenSet(false),
    m_resourceIdHasBeenSet(false),
    m_resourceType(TransitGatewayAttachmentResourceType::NOT_SET),
...
TransitGatewayPolicyTableAssociation& TransitGatewayPolicyTableAssociation::operator =(const XmlNode& xmlNode)
{
...
void TransitGatewayPolicyTableAssociation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void TransitGatewayPolicyTableAssociation::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_transitGatewayPolicyTableIdHasBeenSet)
  {
