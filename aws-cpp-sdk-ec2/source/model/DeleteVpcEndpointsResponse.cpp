...
DeleteVpcEndpointsResponse::DeleteVpcEndpointsResponse(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

DeleteVpcEndpointsResponse& DeleteVpcEndpointsResponse::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
  const XmlDocument& xmlDocument = result.GetPayload();
  XmlNode rootNode = xmlDocument.GetRootElement();
  XmlNode resultNode = rootNode;
  if (rootNode.GetName() != "DeleteVpcEndpointsResponse")
  {
