...
DeleteVpcPeeringConnectionResponse& DeleteVpcPeeringConnectionResponse::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  if (!rootNode.IsNull() && (rootNode.GetName() != "DeleteVpcPeeringConnectionResponse"))
  {
    resultNode = rootNode.FirstChild("DeleteVpcPeeringConnectionResponse");
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DeleteVpcPeeringConnectionResponse", "x-amzn-request-id: " << m_responseMetadata.GetRequestId() );
  }
  return *this;
}
