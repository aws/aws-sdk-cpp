...
PrivateDnsNameOptionsResponse& PrivateDnsNameOptionsResponse::operator =(const XmlNode& xmlNode)
{
...
void PrivateDnsNameOptionsResponse::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
...
void PrivateDnsNameOptionsResponse::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_hostnameTypeHasBeenSet)
  {
