...
AttachNetworkInterfaceResponse::AttachNetworkInterfaceResponse(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

AttachNetworkInterfaceResponse& AttachNetworkInterfaceResponse::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
  const XmlDocument& xmlDocument = result.GetPayload();
  XmlNode rootNode = xmlDocument.GetRootElement();
  XmlNode resultNode = rootNode;
  if (rootNode.GetName() != "AttachNetworkInterfaceResponse")
  {
