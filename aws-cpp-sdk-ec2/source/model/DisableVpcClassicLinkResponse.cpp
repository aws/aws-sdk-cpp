...
DisableVpcClassicLinkResponse& DisableVpcClassicLinkResponse::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  if (!rootNode.IsNull() && (rootNode.GetName() != "DisableVpcClassicLinkResponse"))
  {
    resultNode = rootNode.FirstChild("DisableVpcClassicLinkResponse");
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::EC2::Model::DisableVpcClassicLinkResponse", "x-amzn-request-id: " << m_responseMetadata.GetRequestId() );
  }
  return *this;
}
