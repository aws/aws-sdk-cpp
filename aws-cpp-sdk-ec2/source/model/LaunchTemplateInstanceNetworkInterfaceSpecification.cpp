...
LaunchTemplateInstanceNetworkInterfaceSpecification& LaunchTemplateInstanceNetworkInterfaceSpecification::operator =(const XmlNode& xmlNode)
{
  ...
  if(!resultNode.IsNull())
  {
    ...
    if(!groupsNode.IsNull())
    {
      ...
      while(!groupsMember.IsNull())
      {
        ...
        groupsMember = groupsMember.NextNode("groupId");
      }
...
void LaunchTemplateInstanceNetworkInterfaceSpecification::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
  ...
  if(m_groupsHasBeenSet)
  {
      ...
      {
        oStream << location << index << locationValue << ".GroupSet." << groupsIdx++ << "=" << StringUtils::URLEncode(item.c_str()) << "&";
      }
  }
