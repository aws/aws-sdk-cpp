...
MemoryMiB& MemoryMiB::operator =(const XmlNode& xmlNode)
{
...
void MemoryMiB::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
  if(m_minHasBeenSet)
  {
...
void MemoryMiB::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_minHasBeenSet)
  {
