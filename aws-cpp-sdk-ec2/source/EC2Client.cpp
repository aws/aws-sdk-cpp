...
using ResolveEndpointOutcome = Aws::EC2::Endpoint::EC2EndpointProvider::EC2ResolveEndpointOutcome;
...
EC2Client::EC2Client(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::EC2EndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<EC2ErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<EC2::Endpoint::EC2EndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
