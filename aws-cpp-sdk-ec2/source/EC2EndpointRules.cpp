...
namespace EC2
{
const size_t EC2EndpointRules::RulesBlobStrLen = 3617;
const size_t EC2EndpointRules::RulesBlobSize = 3618;
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','c','2','.','{','R','e','g','i','o',
