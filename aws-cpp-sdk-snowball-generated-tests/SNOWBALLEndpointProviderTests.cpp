...
using SnowballResolveEndpointOutcome = Aws::Snowball::Endpoint::SnowballEndpointProvider::SnowballResolveEndpointOutcome;
...
void ValidateOutcome(const SnowballResolveEndpointOutcome& outcome, const SnowballEndpointProviderEndpointTestCase::Expect& expect)
{
