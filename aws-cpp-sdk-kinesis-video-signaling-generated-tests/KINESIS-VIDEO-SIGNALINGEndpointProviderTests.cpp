...
using KinesisVideoSignalingChannelsResolveEndpointOutcome = Aws::KinesisVideoSignalingChannels::Endpoint::KinesisVideoSignalingChannelsEndpointProvider::KinesisVideoSignalingChannelsResolveEndpointOutcome;
...
static const Aws::Vector<KinesisVideoSignalingChannelsEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const KinesisVideoSignalingChannelsResolveEndpointOutcome& outcome, const KinesisVideoSignalingChannelsEndpointProviderEndpointTestCase::Expect& expect)
{
