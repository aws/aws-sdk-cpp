...
namespace Model
{
  ...
  /**
   */
  class AWS_NEPTUNE_API ModifyDBSubnetGroupRequest : public NeptuneRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyDBSubnetGroupRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyDBSubnetGroupRequest>(GetServiceRequestName(), *this);
    }
