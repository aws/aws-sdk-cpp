...
namespace Model
{
  ...
  /**
   */
  class AWS_NEPTUNE_API DescribeGlobalClustersRequest : public NeptuneRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeGlobalClustersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeGlobalClustersRequest>(GetServiceRequestName(), *this);
    }
