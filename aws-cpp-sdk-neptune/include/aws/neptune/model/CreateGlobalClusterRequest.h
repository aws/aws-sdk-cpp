...
namespace Model
{
  ...
  /**
   */
  class AWS_NEPTUNE_API CreateGlobalClusterRequest : public NeptuneRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateGlobalClusterRequest> Clone() const
    {
      return Aws::MakeUnique<CreateGlobalClusterRequest>(GetServiceRequestName(), *this);
    }
