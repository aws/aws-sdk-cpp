...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveSourceIdentifierFromSubscriptionRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveSourceIdentifierFromSubscriptionRequest>(GetServiceRequestName(), *this);
    }
