...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDBInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDBInstancesRequest>(GetServiceRequestName(), *this);
    }
  ...
  public:
     ...
     * invoke this API from the Amazon CLI and filter so that only Neptune DB instances
