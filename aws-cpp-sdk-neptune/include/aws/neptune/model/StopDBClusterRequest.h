...
namespace Model
{
  ...
  /**
   */
  class AWS_NEPTUNE_API StopDBClusterRequest : public NeptuneRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopDBClusterRequest> Clone() const
    {
      return Aws::MakeUnique<StopDBClusterRequest>(GetServiceRequestName(), *this);
    }
