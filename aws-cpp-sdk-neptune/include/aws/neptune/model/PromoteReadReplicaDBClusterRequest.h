...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PromoteReadReplicaDBClusterRequest> Clone() const
    {
      return Aws::MakeUnique<PromoteReadReplicaDBClusterRequest>(GetServiceRequestName(), *this);
    }
