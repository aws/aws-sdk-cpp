...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDBClusterParametersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDBClusterParametersRequest>(GetServiceRequestName(), *this);
    }
