...
namespace Model
{
  ...
  /**
   */
  class AWS_NEPTUNE_API FailoverGlobalClusterRequest : public NeptuneRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<FailoverGlobalClusterRequest> Clone() const
    {
      return Aws::MakeUnique<FailoverGlobalClusterRequest>(GetServiceRequestName(), *this);
    }
