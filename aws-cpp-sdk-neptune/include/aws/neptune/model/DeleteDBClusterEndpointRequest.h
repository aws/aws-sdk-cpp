...
namespace Model
{
  ...
  /**
   */
  class AWS_NEPTUNE_API DeleteDBClusterEndpointRequest : public NeptuneRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDBClusterEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDBClusterEndpointRequest>(GetServiceRequestName(), *this);
    }
