...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RestoreDBClusterFromSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<RestoreDBClusterFromSnapshotRequest>(GetServiceRequestName(), *this);
    }
