...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyDBClusterSnapshotAttributeRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyDBClusterSnapshotAttributeRequest>(GetServiceRequestName(), *this);
    }
