...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDBClusterParameterGroupRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDBClusterParameterGroupRequest>(GetServiceRequestName(), *this);
    }
