...
namespace Model
{
  ...
  /**
   */
  class AWS_NEPTUNE_API AddRoleToDBClusterRequest : public NeptuneRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AddRoleToDBClusterRequest> Clone() const
    {
      return Aws::MakeUnique<AddRoleToDBClusterRequest>(GetServiceRequestName(), *this);
    }
