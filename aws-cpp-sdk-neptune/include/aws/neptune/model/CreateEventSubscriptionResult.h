...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNE_API CreateEventSubscriptionResult();
    AWS_NEPTUNE_API CreateEventSubscriptionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    AWS_NEPTUNE_API CreateEventSubscriptionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
