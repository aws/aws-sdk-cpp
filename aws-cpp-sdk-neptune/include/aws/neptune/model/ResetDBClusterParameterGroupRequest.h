...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ResetDBClusterParameterGroupRequest> Clone() const
    {
      return Aws::MakeUnique<ResetDBClusterParameterGroupRequest>(GetServiceRequestName(), *this);
    }
