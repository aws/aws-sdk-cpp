...
using ResolveEndpointOutcome = Aws::Neptune::Endpoint::NeptuneEndpointProvider::NeptuneResolveEndpointOutcome;
...
NeptuneClient::NeptuneClient(const Client::ClientConfiguration& clientConfiguration,
                             std::shared_ptr<Endpoint::NeptuneEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<NeptuneErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Neptune::Endpoint::NeptuneEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
