...
class ProtocolTestsGen(object):
    ...
    def __init__(self,
        ...
        self.generated_test_clients_dir = str(pathlib.Path(f"{sdk_root_dir}/{PROTOCOL_TESTS_GENERATED_CLIENTS_DIR}").resolve())
        ...
        self.c2j_client_generator.path_to_endpoint_rules = str(pathlib.Path(f"{sdk_root_dir}/{PROTOCOL_TESTS_BASE_DIR}").resolve())
    ...
    def _collect_test_client_models(self) -> dict:
        ...
        for filename in model_files:
            ...
            service_models[service_model_name] = ServiceModel(service_model_name, filename, PROTOCOL_TESTS_ENDPOINT_RULES, None)
