 ...
 */
@NonNullApi
public class LibrariesForTestInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    @Inject
    public LibrariesForTestInPluginsBlock(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
