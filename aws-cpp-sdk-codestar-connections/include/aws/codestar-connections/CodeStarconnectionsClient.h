...
namespace CodeStarconnections
{
  ...
  class AWS_CODESTARCONNECTIONS_API CodeStarconnectionsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CodeStarconnectionsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                  std::shared_ptr<Endpoint::CodeStarconnectionsEndpointProvider> endpointProvider = Aws::MakeShared<CodeStarconnections::Endpoint::CodeStarconnectionsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CodeStarconnectionsEndpointProvider> m_endpointProvider;
  };
