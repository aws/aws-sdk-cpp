...
namespace Model
{
  ...
  /**
   */
  class AWS_CODESTARCONNECTIONS_API ListHostsRequest : public CodeStarconnectionsRequest
  {
  public:
    ListHostsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListHostsRequest> Clone() const
    {
      return Aws::MakeUnique<ListHostsRequest>(GetServiceRequestName(), *this);
    }
