...
namespace Model
{
  ...
  /**
   */
  class AWS_CODESTARCONNECTIONS_API UpdateHostRequest : public CodeStarconnectionsRequest
  {
  public:
    UpdateHostRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateHostRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateHostRequest>(GetServiceRequestName(), *this);
    }
