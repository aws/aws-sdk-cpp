...
using ResolveEndpointOutcome = Aws::CodeStarconnections::Endpoint::CodeStarconnectionsEndpointProvider::CodeStarconnectionsResolveEndpointOutcome;
...
CodeStarconnectionsClient::CodeStarconnectionsClient(const Client::ClientConfiguration& clientConfiguration,
                                                     std::shared_ptr<Endpoint::CodeStarconnectionsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CodeStarconnectionsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CodeStarconnections::Endpoint::CodeStarconnectionsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
