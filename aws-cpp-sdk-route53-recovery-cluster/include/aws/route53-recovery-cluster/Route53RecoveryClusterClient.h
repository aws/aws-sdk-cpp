...
namespace Model
{
   ...
   * Amazon Route 53 Application Recovery Controller.</p> <p>With Amazon Route 53
   * Application Recovery Controller, you can use routing control with extreme
   * reliability to recover applications by rerouting traffic across Availability
   * Zones or AWS Regions. Routing controls are simple on/off switches hosted on a
   * highly available cluster in Application Recovery Controller. A cluster provides
   * a set of five redundant Regional endpoints against which you can run API calls
   * to get or update the state of routing controls. To implement failover, you set
   * one routing control on and another one off, to reroute traffic from one
   * Availability Zone or Amazon Web Services Region to another. </p> <p> <i>Be aware
   * that you must specify the Regional endpoints for a cluster when you work with
   * API cluster operations to get or update routing control states in Application
   * Recovery Controller.</i> In addition, you must specify the US West (Oregon)
   * Region for Application Recovery Controller API calls. For example, use the
   ...
   * states in Application Recovery Controller. You also must set up the structures
   * to support routing controls: clusters and control panels.</p> <p>For more
   * information about working with routing control in Application Recovery
   * Controller, see the following:</p> <ul> <li> <p>To create clusters, routing
   * controls, and control panels by using the control plane API for routing control,
   * see the <a
   ...
   * Controller</a>.</p> </li> <li> <p>Learn about the components in recovery control
   * configuration, including clusters, routing controls, and control panels. For
   ...
   * Controller Developer Guide.</p> </li> <li> <p>Application Recovery Controller
   * also provides readiness checks that run continually to help make sure that your
   * applications are scaled and ready to handle failover traffic. For more
   * information about the related API actions, see the <a
   ...
   * applications and preparing for recovery readiness with Application Recovery
   * Controller, see the <a
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * create a routing control, you must first create a cluster to host the control in
         * a control panel. For more information, see <a
         ...
         * Recovery Controller Developer Guide. Then you access one of the endpoints for
         * the cluster to get or update the routing control state to redirect traffic. </p>
         * <p> <i>You must specify Regional endpoints when you work with API cluster
         * operations to get or update routing control states in Application Recovery
         * Controller.</i> </p> <p>To see a code example for getting a routing control
         * state, including accessing Regional cluster endpoints in sequence, see <a
         ...
         * Off, traffic does not flow.</p> <p>With Application Recovery Controller, you can
         * add safety rules for routing controls, which are safeguards for routing control
         ...
         * control states in Application Recovery Controller.</i> </p> <p>To see a code
         * example for getting a routing control state, including accessing Regional
         * cluster endpoints in sequence, see <a
         * href="https://docs.aws.amazon.com/r53recovery/latest/dg/service_code_examples_actions.html">API
         * examples</a> in the Amazon Route 53 Application Recovery Controller Developer
         * Guide.</p> <ul> <li> <p> <a
         * href="https://docs.aws.amazon.com/r53recovery/latest/dg/routing-control.update.html">
         ...
         * traffic does not flow.</p> <p>With Application Recovery Controller, you can add
