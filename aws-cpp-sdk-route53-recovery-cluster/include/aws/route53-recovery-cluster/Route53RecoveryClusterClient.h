...
namespace Route53RecoveryCluster
{
  ...
  class AWS_ROUTE53RECOVERYCLUSTER_API Route53RecoveryClusterClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        Route53RecoveryClusterClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                     std::shared_ptr<Endpoint::Route53RecoveryClusterEndpointProvider> endpointProvider = Aws::MakeShared<Route53RecoveryCluster::Endpoint::Route53RecoveryClusterEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::Route53RecoveryClusterEndpointProvider> m_endpointProvider;
  };
