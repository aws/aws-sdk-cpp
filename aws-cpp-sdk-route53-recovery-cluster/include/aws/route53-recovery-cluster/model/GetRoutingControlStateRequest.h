...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RECOVERYCLUSTER_API GetRoutingControlStateRequest : public Route53RecoveryClusterRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRoutingControlStateRequest> Clone() const
    {
      return Aws::MakeUnique<GetRoutingControlStateRequest>(GetServiceRequestName(), *this);
    }
