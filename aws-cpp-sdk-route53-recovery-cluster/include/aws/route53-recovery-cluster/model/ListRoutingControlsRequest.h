...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RECOVERYCLUSTER_API ListRoutingControlsRequest : public Route53RecoveryClusterRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRoutingControlsRequest> Clone() const
    {
      return Aws::MakeUnique<ListRoutingControlsRequest>(GetServiceRequestName(), *this);
    }
