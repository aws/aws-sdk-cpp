...
Aws::String Route53RecoveryClusterEndpointRules::GetRulesAsString()
{
    return Aws::String(Route53RecoveryClusterEndpointRules::Rules.begin(), Route53RecoveryClusterEndpointRules::Rules.end());
}

const Aws::Vector<char> Route53RecoveryClusterEndpointRules::Rules = {
...
'-','r','e','c','o','v','e','r','y','-','c','l','u','s','t','e','r','-','f','i','p','s','.','{','R',
...
'/','/','r','o','u','t','e','5','3','-','r','e','c','o','v','e','r','y','-','c','l','u','s','t','e',
...
'o','v','e','r','y','-','c','l','u','s','t','e','r','.','{','R','e','g','i','o','n','}','.','{','P',
