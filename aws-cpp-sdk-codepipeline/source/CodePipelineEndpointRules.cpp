...
Aws::String CodePipelineEndpointRules::GetRulesAsString()
{
    return Aws::String(CodePipelineEndpointRules::Rules.begin(), CodePipelineEndpointRules::Rules.end());
}

const Aws::Vector<char> CodePipelineEndpointRules::Rules = {
...
't','p','s',':','/','/','c','o','d','e','p','i','p','e','l','i','n','e','-','f','i','p','s','.','{',
...
'c','o','d','e','p','i','p','e','l','i','n','e','.','{','R','e','g','i','o','n','}','.','{','P','a',
