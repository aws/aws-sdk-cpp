...
namespace CodePipeline
{
  ...
  class AWS_CODEPIPELINE_API CodePipelineClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CodePipelineClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::CodePipelineEndpointProvider> endpointProvider = Aws::MakeShared<CodePipeline::Endpoint::CodePipelineEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CodePipelineEndpointProvider> m_endpointProvider;
  };
