...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterWebhookWithThirdPartyRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterWebhookWithThirdPartyRequest>(GetServiceRequestName(), *this);
    }
