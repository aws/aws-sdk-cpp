...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The creator of an action type that has been created with any supported
     * integration model. There are two valid values for the <code>owner</code> field
     * in the action type category: <code>AWS</code> and <code>ThirdParty</code>.</p>
     */
