...
namespace Model
{
  ...
  /**
   */
  class AWS_CODEPIPELINE_API ListWebhooksRequest : public CodePipelineRequest
  {
  public:
    ListWebhooksRequest();
    ...
    */
    virtual Aws::UniquePtr<ListWebhooksRequest> Clone() const
    {
      return Aws::MakeUnique<ListWebhooksRequest>(GetServiceRequestName(), *this);
    }
