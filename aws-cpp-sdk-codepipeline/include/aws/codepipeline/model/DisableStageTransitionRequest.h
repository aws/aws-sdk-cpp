...
namespace Model
{
  ...
  /**
   * <p>Represents the input of a DisableStageTransition action.</p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "DisableStageTransition"; }
