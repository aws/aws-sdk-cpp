...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutThirdPartyJobFailureResultRequest> Clone() const
    {
      return Aws::MakeUnique<PutThirdPartyJobFailureResultRequest>(GetServiceRequestName(), *this);
    }
