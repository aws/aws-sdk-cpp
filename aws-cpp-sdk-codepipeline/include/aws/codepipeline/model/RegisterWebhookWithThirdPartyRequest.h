...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterWebhookWithThirdPartyRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterWebhookWithThirdPartyRequest>(GetServiceRequestName(), *this);
    }
