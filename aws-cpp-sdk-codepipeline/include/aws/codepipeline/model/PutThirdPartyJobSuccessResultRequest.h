...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutThirdPartyJobSuccessResultRequest> Clone() const
    {
      return Aws::MakeUnique<PutThirdPartyJobSuccessResultRequest>(GetServiceRequestName(), *this);
    }
