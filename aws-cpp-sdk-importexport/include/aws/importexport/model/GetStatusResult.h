...
namespace Model
{
  ...
  public:
    ...
    inline GetStatusResult& WithJobId(Aws::String&& value) { SetJobId(value); return *this;}
    ...
    inline void SetLocationCode(Aws::String&& value) { m_locationCode = value; }
    ...
    inline GetStatusResult& WithLocationCode(Aws::String&& value) { SetLocationCode(value); return *this;}
    ...
    inline void SetLocationMessage(Aws::String&& value) { m_locationMessage = value; }
    ...
    inline GetStatusResult& WithLocationMessage(Aws::String&& value) { SetLocationMessage(value); return *this;}
    ...
    inline void SetProgressCode(Aws::String&& value) { m_progressCode = value; }
    ...
    inline GetStatusResult& WithProgressCode(Aws::String&& value) { SetProgressCode(value); return *this;}
    ...
    inline void SetProgressMessage(Aws::String&& value) { m_progressMessage = value; }
    ...
    inline GetStatusResult& WithProgressMessage(Aws::String&& value) { SetProgressMessage(value); return *this;}
    ...
    inline void SetCarrier(Aws::String&& value) { m_carrier = value; }
    ...
    inline GetStatusResult& WithCarrier(Aws::String&& value) { SetCarrier(value); return *this;}
    ...
    inline void SetTrackingNumber(Aws::String&& value) { m_trackingNumber = value; }
    ...
    inline GetStatusResult& WithTrackingNumber(Aws::String&& value) { SetTrackingNumber(value); return *this;}
    ...
    inline void SetLogBucket(Aws::String&& value) { m_logBucket = value; }
    ...
    inline GetStatusResult& WithLogBucket(Aws::String&& value) { SetLogBucket(value); return *this;}
    ...
    inline void SetLogKey(Aws::String&& value) { m_logKey = value; }
    ...
    inline GetStatusResult& WithLogKey(Aws::String&& value) { SetLogKey(value); return *this;}
    ...
    inline GetStatusResult& WithSignature(Aws::String&& value) { SetSignature(value); return *this;}
    ...
    inline GetStatusResult& WithSignatureFileContents(Aws::String&& value) { SetSignatureFileContents(value); return *this;}
    ...
    inline void SetCurrentManifest(Aws::String&& value) { m_currentManifest = value; }
    ...
    inline GetStatusResult& WithCurrentManifest(Aws::String&& value) { SetCurrentManifest(value); return *this;}
    ...
    inline GetStatusResult& WithArtifactList(Aws::Vector<Artifact>&& value) { SetArtifactList(value); return *this;}

    
    inline GetStatusResult& AddArtifactList(const Artifact& value) { m_artifactList.push_back(value); return *this; }

    
    inline GetStatusResult& AddArtifactList(Artifact&& value) { m_artifactList.push_back(value); return *this; }
    ...
    inline GetStatusResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
