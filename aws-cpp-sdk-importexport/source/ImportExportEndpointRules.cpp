...
Aws::String ImportExportEndpointRules::GetRulesAsString()
{
    return Aws::String(ImportExportEndpointRules::Rules.begin(), ImportExportEndpointRules::Rules.end());
}

const Aws::Vector<char> ImportExportEndpointRules::Rules = {
