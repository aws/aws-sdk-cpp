...
using ResolveEndpointOutcome = Aws::LexRuntimeService::Endpoint::LexRuntimeServiceEndpointProvider::LexRuntimeServiceResolveEndpointOutcome;
...
LexRuntimeServiceClient::LexRuntimeServiceClient(const Client::ClientConfiguration& clientConfiguration,
                                                 std::shared_ptr<Endpoint::LexRuntimeServiceEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<LexRuntimeServiceErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<LexRuntimeService::Endpoint::LexRuntimeServiceEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
