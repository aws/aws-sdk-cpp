...
namespace LexRuntimeService
{
  ...
  class AWS_LEXRUNTIMESERVICE_API LexRuntimeServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        LexRuntimeServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                std::shared_ptr<Endpoint::LexRuntimeServiceEndpointProvider> endpointProvider = Aws::MakeShared<LexRuntimeService::Endpoint::LexRuntimeServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::LexRuntimeServiceEndpointProvider> m_endpointProvider;
  };
