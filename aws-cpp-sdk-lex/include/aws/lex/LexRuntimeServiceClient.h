    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * using the machine learning model that it built for the bot. </p> <p> In
         * response, Amazon Lex returns the next message to convey to the user. Consider
         * the following example messages: </p> <ul> <li> <p> For a user input "I would
         * like a pizza," Amazon Lex might return a response with a message eliciting slot
         * data (for example, <code>PizzaSize</code>): "What size pizza would you like?".
         ...
         * "Order the pizza?". </p> </li> <li> <p> After the user replies "Yes" to the
         * confirmation prompt, Amazon Lex might return a conclusion statement: "Thank you,
         * your cheese pizza has been ordered.". </p> </li> </ul> <p> Not all Amazon Lex
         ...
         * about the message in the response that you can use to enhance client behavior,
         * such as displaying the appropriate client user interface. Consider the following
         * examples: </p> <ul> <li> <p> If the message is to elicit slot data, Amazon Lex
         * returns the following context information: </p> <ul> <li> <p>
