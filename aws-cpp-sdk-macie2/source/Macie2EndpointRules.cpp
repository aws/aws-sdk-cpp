...
Aws::String Macie2EndpointRules::GetRulesAsString()
{
    return Aws::String(Macie2EndpointRules::Rules.begin(), Macie2EndpointRules::Rules.end());
}

const Aws::Vector<char> Macie2EndpointRules::Rules = {
