...
using ResolveEndpointOutcome = Aws::Macie2::Endpoint::Macie2EndpointProvider::Macie2ResolveEndpointOutcome;
...
Macie2Client::Macie2Client(const Client::ClientConfiguration& clientConfiguration,
                           std::shared_ptr<Endpoint::Macie2EndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<Macie2ErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Macie2::Endpoint::Macie2EndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
