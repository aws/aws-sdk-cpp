...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API BatchGetCustomDataIdentifiersRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetCustomDataIdentifiersRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetCustomDataIdentifiersRequest>(GetServiceRequestName(), *this);
    }
