...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutClassificationExportConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutClassificationExportConfigurationRequest>(GetServiceRequestName(), *this);
    }
