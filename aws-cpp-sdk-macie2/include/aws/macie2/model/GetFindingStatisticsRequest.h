...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API GetFindingStatisticsRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetFindingStatisticsRequest> Clone() const
    {
      return Aws::MakeUnique<GetFindingStatisticsRequest>(GetServiceRequestName(), *this);
    }
