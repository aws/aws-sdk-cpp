...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API DeleteCustomDataIdentifierRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCustomDataIdentifierRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCustomDataIdentifierRequest>(GetServiceRequestName(), *this);
    }
