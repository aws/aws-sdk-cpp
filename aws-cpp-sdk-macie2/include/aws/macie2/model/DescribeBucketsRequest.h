...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API DescribeBucketsRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeBucketsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBucketsRequest>(GetServiceRequestName(), *this);
    }
