...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API DeleteAllowListRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAllowListRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAllowListRequest>(GetServiceRequestName(), *this);
    }
