...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API CreateAllowListRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAllowListRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAllowListRequest>(GetServiceRequestName(), *this);
    }
