...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API GetSensitiveDataOccurrencesAvailabilityRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSensitiveDataOccurrencesAvailabilityRequest> Clone() const
    {
      return Aws::MakeUnique<GetSensitiveDataOccurrencesAvailabilityRequest>(GetServiceRequestName(), *this);
    }
