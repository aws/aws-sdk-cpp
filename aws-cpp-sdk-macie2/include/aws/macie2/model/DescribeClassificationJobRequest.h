...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API DescribeClassificationJobRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeClassificationJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeClassificationJobRequest>(GetServiceRequestName(), *this);
    }
