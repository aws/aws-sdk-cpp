...
namespace Model
{
  ...
  /**
   * <p>The account-level and bucket-level permissions settings for an S3 bucket, or
   * the bucket that contains an object.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01T00:00:00Z/BucketPermissionConfiguration">AWS
   * API Reference</a></p>
   */
