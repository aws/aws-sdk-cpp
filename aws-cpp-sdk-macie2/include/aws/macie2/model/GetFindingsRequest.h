...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API GetFindingsRequest : public Macie2Request
  {
  public:
    GetFindingsRequest();
    ...
    */
    virtual Aws::UniquePtr<GetFindingsRequest> Clone() const
    {
      return Aws::MakeUnique<GetFindingsRequest>(GetServiceRequestName(), *this);
    }
