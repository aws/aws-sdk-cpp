...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MACIE2_API SuppressDataIdentifier
  {
  public:
    SuppressDataIdentifier();
    SuppressDataIdentifier(Aws::Utils::Json::JsonView jsonValue);
    SuppressDataIdentifier& operator=(Aws::Utils::Json::JsonView jsonValue);
