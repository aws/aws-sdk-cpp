...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API DeleteInvitationsRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteInvitationsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteInvitationsRequest>(GetServiceRequestName(), *this);
    }
