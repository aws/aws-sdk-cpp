...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutFindingsPublicationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutFindingsPublicationConfigurationRequest>(GetServiceRequestName(), *this);
    }
