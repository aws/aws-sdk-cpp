...
namespace Model
{
  ...
  /**
   * <p>Specifies one or more conditions that determine which objects a
   * classification job analyzes.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01T00:00:00Z/JobScopeTerm">AWS
   * API Reference</a></p>
   */
  ...
  public:
     ...
     * values for including or excluding an object from a job.</p>
     */
    ...
    /**
     * <p>A tag-based condition that defines a property, operator, and one or more
     * values for including or excluding an object from a job.</p>
     */
