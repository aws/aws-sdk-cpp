...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API GetUsageTotalsRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetUsageTotalsRequest> Clone() const
    {
      return Aws::MakeUnique<GetUsageTotalsRequest>(GetServiceRequestName(), *this);
    }
