...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01T00:00:00Z/SessionIssuer">AWS
   * API Reference</a></p>
   */
  class AWS_MACIE2_API SessionIssuer
  {
  public:
    SessionIssuer();
    SessionIssuer(Aws::Utils::Json::JsonView jsonValue);
    SessionIssuer& operator=(Aws::Utils::Json::JsonView jsonValue);
    Aws::Utils::Json::JsonValue Jsonize() const;


    /**
     * <p>The account that owns the entity that was used to get the credentials.</p>
     */
    ...
    /**
     * <p>The internal identifier for the entity that was used to get the
     * credentials.</p>
     */
