...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The date and time, in UTC and extended ISO 8601 format, when the job will
     * expire and be cancelled if you don't resume it first. If you don't resume a job
     * within 30 days of pausing it, the job expires and Amazon Macie cancels it.</p>
     */
     ...
     * to notify you of the job's pending expiration and cancellation. This value is
