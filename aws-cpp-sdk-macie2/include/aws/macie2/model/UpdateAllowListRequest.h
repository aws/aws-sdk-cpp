...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API UpdateAllowListRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAllowListRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAllowListRequest>(GetServiceRequestName(), *this);
    }
