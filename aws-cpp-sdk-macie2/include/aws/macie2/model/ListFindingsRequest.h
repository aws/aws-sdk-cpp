...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API ListFindingsRequest : public Macie2Request
  {
  public:
    ListFindingsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListFindingsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFindingsRequest>(GetServiceRequestName(), *this);
    }
