...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API GetCustomDataIdentifierRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCustomDataIdentifierRequest> Clone() const
    {
      return Aws::MakeUnique<GetCustomDataIdentifierRequest>(GetServiceRequestName(), *this);
    }
