...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateFromMasterAccountRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateFromMasterAccountRequest>(GetServiceRequestName(), *this);
    }
