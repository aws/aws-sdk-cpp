...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MACIE2_API SearchResourcesBucketCriteria
  {
  public:
    SearchResourcesBucketCriteria();
    SearchResourcesBucketCriteria(Aws::Utils::Json::JsonView jsonValue);
    SearchResourcesBucketCriteria& operator=(Aws::Utils::Json::JsonView jsonValue);
