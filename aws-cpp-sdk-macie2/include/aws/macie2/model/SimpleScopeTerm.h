...
namespace Model
{
  ...
  public:
     ...
     * <li><p>OBJECT_SIZE - Any operator except CONTAINS</p></li> <li><p>TAG - EQ
     * (equals) or NE (not equals)</p></li></ul>
     */
     ...
     * array can specify only one value.</p> <p>Valid values for each supported
     * property (key) are:</p> <ul><li><p>OBJECT_EXTENSION - A string that represents
     * the file name extension of an object. For example: docx or pdf</p></li>
     * <li><p>OBJECT_KEY - A string that represents the key prefix (folder name or
     * path) of an object. For example: logs or awslogs/eventlogs. This value applies a
     * condition to objects whose keys (names) begin with the specified value.</p></li>
