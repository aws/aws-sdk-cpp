...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01T00:00:00Z/AssumedRole">AWS
   * API Reference</a></p>
   */
  class AWS_MACIE2_API AssumedRole
  {
  public:
    AssumedRole();
    AssumedRole(Aws::Utils::Json::JsonView jsonValue);
    AssumedRole& operator=(Aws::Utils::Json::JsonView jsonValue);
