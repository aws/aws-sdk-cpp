...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API ListClassificationJobsRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListClassificationJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListClassificationJobsRequest>(GetServiceRequestName(), *this);
    }
