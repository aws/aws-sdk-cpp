...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MACIE2_API SensitivityAggregations
  {
  public:
    SensitivityAggregations();
    SensitivityAggregations(Aws::Utils::Json::JsonView jsonValue);
    SensitivityAggregations& operator=(Aws::Utils::Json::JsonView jsonValue);
