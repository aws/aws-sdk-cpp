...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The Amazon Resource Name (ARN) of the Key Management Service (KMS) customer
     * master key (CMK) to use for encryption of the results. This must be the ARN of
     * an existing CMK that's in the same Amazon Web Services Region as the bucket.</p>
     */
