...
namespace Model
{
  ...
  /**
   */
  class AWS_MACIE2_API UpdateMemberSessionRequest : public Macie2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateMemberSessionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateMemberSessionRequest>(GetServiceRequestName(), *this);
    }
