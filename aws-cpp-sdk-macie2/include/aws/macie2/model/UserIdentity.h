...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>If the action was performed using the credentials for another AWS account,
     * the details of that account.</p>
     */
    ...
    /**
     * <p>If the action was performed by an AWS account that belongs to an AWS service,
    ...
    /**
     * <p>If the action was performed using the credentials for an AWS Identity and
     * Access Management (IAM) user, the name and other details about the user.</p>
     */
    ...
    /**
     * <p>If the action was performed using the credentials for your AWS account, the
     * details of your account.</p>
     */
