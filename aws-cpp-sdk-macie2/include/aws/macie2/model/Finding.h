...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01T00:00:00Z/Finding">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    /**
     * <p>The identifier for the AWS account that the finding applies to. This is
     * typically the account that owns the affected resource.</p>
     */
