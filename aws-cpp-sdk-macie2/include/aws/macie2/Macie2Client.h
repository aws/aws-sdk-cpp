...
namespace Macie2
{
  ...
  class AWS_MACIE2_API Macie2Client : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        Macie2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                     std::shared_ptr<Endpoint::Macie2EndpointProvider> endpointProvider = Aws::MakeShared<Macie2::Endpoint::Macie2EndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::Macie2EndpointProvider> m_endpointProvider;
  };
