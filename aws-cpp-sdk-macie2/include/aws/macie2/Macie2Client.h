...
namespace Model
{
        ...
        typedef Aws::Utils::Outcome<CreateFindingsFilterResult, Aws::Client::AWSError<Macie2Errors>> CreateFindingsFilterOutcome;
        typedef Aws::Utils::Outcome<CreateInvitationsResult, Aws::Client::AWSError<Macie2Errors>> CreateInvitationsOutcome;
        typedef Aws::Utils::Outcome<CreateMemberResult, Aws::Client::AWSError<Macie2Errors>> CreateMemberOutcome;
        typedef Aws::Utils::Outcome<CreateSampleFindingsResult, Aws::Client::AWSError<Macie2Errors>> CreateSampleFindingsOutcome;
        typedef Aws::Utils::Outcome<DeclineInvitationsResult, Aws::Client::AWSError<Macie2Errors>> DeclineInvitationsOutcome;
        typedef Aws::Utils::Outcome<DeleteCustomDataIdentifierResult, Aws::Client::AWSError<Macie2Errors>> DeleteCustomDataIdentifierOutcome;
        typedef Aws::Utils::Outcome<DeleteFindingsFilterResult, Aws::Client::AWSError<Macie2Errors>> DeleteFindingsFilterOutcome;
        typedef Aws::Utils::Outcome<DeleteInvitationsResult, Aws::Client::AWSError<Macie2Errors>> DeleteInvitationsOutcome;
        typedef Aws::Utils::Outcome<DeleteMemberResult, Aws::Client::AWSError<Macie2Errors>> DeleteMemberOutcome;
        typedef Aws::Utils::Outcome<DescribeBucketsResult, Aws::Client::AWSError<Macie2Errors>> DescribeBucketsOutcome;
        typedef Aws::Utils::Outcome<DescribeClassificationJobResult, Aws::Client::AWSError<Macie2Errors>> DescribeClassificationJobOutcome;
        typedef Aws::Utils::Outcome<DescribeOrganizationConfigurationResult, Aws::Client::AWSError<Macie2Errors>> DescribeOrganizationConfigurationOutcome;
        typedef Aws::Utils::Outcome<DisableMacieResult, Aws::Client::AWSError<Macie2Errors>> DisableMacieOutcome;
        typedef Aws::Utils::Outcome<DisableOrganizationAdminAccountResult, Aws::Client::AWSError<Macie2Errors>> DisableOrganizationAdminAccountOutcome;
        typedef Aws::Utils::Outcome<DisassociateFromMasterAccountResult, Aws::Client::AWSError<Macie2Errors>> DisassociateFromMasterAccountOutcome;
        typedef Aws::Utils::Outcome<DisassociateMemberResult, Aws::Client::AWSError<Macie2Errors>> DisassociateMemberOutcome;
        typedef Aws::Utils::Outcome<EnableMacieResult, Aws::Client::AWSError<Macie2Errors>> EnableMacieOutcome;
        typedef Aws::Utils::Outcome<EnableOrganizationAdminAccountResult, Aws::Client::AWSError<Macie2Errors>> EnableOrganizationAdminAccountOutcome;
        typedef Aws::Utils::Outcome<GetBucketStatisticsResult, Aws::Client::AWSError<Macie2Errors>> GetBucketStatisticsOutcome;
        typedef Aws::Utils::Outcome<GetClassificationExportConfigurationResult, Aws::Client::AWSError<Macie2Errors>> GetClassificationExportConfigurationOutcome;
        typedef Aws::Utils::Outcome<GetCustomDataIdentifierResult, Aws::Client::AWSError<Macie2Errors>> GetCustomDataIdentifierOutcome;
        typedef Aws::Utils::Outcome<GetFindingStatisticsResult, Aws::Client::AWSError<Macie2Errors>> GetFindingStatisticsOutcome;
        typedef Aws::Utils::Outcome<GetFindingsResult, Aws::Client::AWSError<Macie2Errors>> GetFindingsOutcome;
        typedef Aws::Utils::Outcome<GetFindingsFilterResult, Aws::Client::AWSError<Macie2Errors>> GetFindingsFilterOutcome;
        typedef Aws::Utils::Outcome<GetInvitationsCountResult, Aws::Client::AWSError<Macie2Errors>> GetInvitationsCountOutcome;
        typedef Aws::Utils::Outcome<GetMacieSessionResult, Aws::Client::AWSError<Macie2Errors>> GetMacieSessionOutcome;
        typedef Aws::Utils::Outcome<GetMasterAccountResult, Aws::Client::AWSError<Macie2Errors>> GetMasterAccountOutcome;
        typedef Aws::Utils::Outcome<GetMemberResult, Aws::Client::AWSError<Macie2Errors>> GetMemberOutcome;
        typedef Aws::Utils::Outcome<GetUsageStatisticsResult, Aws::Client::AWSError<Macie2Errors>> GetUsageStatisticsOutcome;
        typedef Aws::Utils::Outcome<GetUsageTotalsResult, Aws::Client::AWSError<Macie2Errors>> GetUsageTotalsOutcome;
        typedef Aws::Utils::Outcome<ListClassificationJobsResult, Aws::Client::AWSError<Macie2Errors>> ListClassificationJobsOutcome;
        typedef Aws::Utils::Outcome<ListCustomDataIdentifiersResult, Aws::Client::AWSError<Macie2Errors>> ListCustomDataIdentifiersOutcome;
        typedef Aws::Utils::Outcome<ListFindingsResult, Aws::Client::AWSError<Macie2Errors>> ListFindingsOutcome;
        typedef Aws::Utils::Outcome<ListFindingsFiltersResult, Aws::Client::AWSError<Macie2Errors>> ListFindingsFiltersOutcome;
        typedef Aws::Utils::Outcome<ListInvitationsResult, Aws::Client::AWSError<Macie2Errors>> ListInvitationsOutcome;
        typedef Aws::Utils::Outcome<ListMembersResult, Aws::Client::AWSError<Macie2Errors>> ListMembersOutcome;
        typedef Aws::Utils::Outcome<ListOrganizationAdminAccountsResult, Aws::Client::AWSError<Macie2Errors>> ListOrganizationAdminAccountsOutcome;
        typedef Aws::Utils::Outcome<ListTagsForResourceResult, Aws::Client::AWSError<Macie2Errors>> ListTagsForResourceOutcome;
        ...
        typedef Aws::Utils::Outcome<UpdateMacieSessionResult, Aws::Client::AWSError<Macie2Errors>> UpdateMacieSessionOutcome;
        typedef Aws::Utils::Outcome<UpdateMemberSessionResult, Aws::Client::AWSError<Macie2Errors>> UpdateMemberSessionOutcome;
