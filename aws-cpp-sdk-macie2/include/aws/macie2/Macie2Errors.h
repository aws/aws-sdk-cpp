...
public:
  ...
  Macie2Error(const Aws::Client::AWSError<Macie2Errors>& rhs) : Aws::Client::AWSError<Macie2Errors>(rhs) {}
  Macie2Error(Aws::Client::AWSError<Macie2Errors>&& rhs) : Aws::Client::AWSError<Macie2Errors>(rhs) {}
