...
using ResolveEndpointOutcome = Aws::Pricing::Endpoint::PricingEndpointProvider::PricingResolveEndpointOutcome;
...
PricingClient::PricingClient(const Client::ClientConfiguration& clientConfiguration,
                             std::shared_ptr<Endpoint::PricingEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<PricingErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Pricing::Endpoint::PricingEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
