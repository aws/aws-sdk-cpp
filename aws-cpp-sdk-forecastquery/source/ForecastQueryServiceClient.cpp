...
using ResolveEndpointOutcome = Aws::ForecastQueryService::Endpoint::ForecastQueryServiceEndpointProvider::ForecastQueryServiceResolveEndpointOutcome;
...
ForecastQueryServiceClient::ForecastQueryServiceClient(const Client::ClientConfiguration& clientConfiguration,
                                                       std::shared_ptr<Endpoint::ForecastQueryServiceEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ForecastQueryServiceErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ForecastQueryService::Endpoint::ForecastQueryServiceEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
