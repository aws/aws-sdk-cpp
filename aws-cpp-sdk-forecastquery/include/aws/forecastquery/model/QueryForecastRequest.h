...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTQUERYSERVICE_API QueryForecastRequest : public ForecastQueryServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<QueryForecastRequest> Clone() const
    {
      return Aws::MakeUnique<QueryForecastRequest>(GetServiceRequestName(), *this);
    }
