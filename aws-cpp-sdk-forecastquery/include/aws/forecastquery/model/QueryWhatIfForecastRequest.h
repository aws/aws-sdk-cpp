...
namespace Model
{
  ...
  /**
   */
  class AWS_FORECASTQUERYSERVICE_API QueryWhatIfForecastRequest : public ForecastQueryServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<QueryWhatIfForecastRequest> Clone() const
    {
      return Aws::MakeUnique<QueryWhatIfForecastRequest>(GetServiceRequestName(), *this);
    }
