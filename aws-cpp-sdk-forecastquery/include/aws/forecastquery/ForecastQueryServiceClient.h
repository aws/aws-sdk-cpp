...
namespace ForecastQueryService
{
  ...
  class AWS_FORECASTQUERYSERVICE_API ForecastQueryServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ForecastQueryServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                   std::shared_ptr<Endpoint::ForecastQueryServiceEndpointProvider> endpointProvider = Aws::MakeShared<ForecastQueryService::Endpoint::ForecastQueryServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ForecastQueryServiceEndpointProvider> m_endpointProvider;
  };
