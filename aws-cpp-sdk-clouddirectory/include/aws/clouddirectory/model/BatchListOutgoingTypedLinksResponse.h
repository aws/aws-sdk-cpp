...
namespace Model
{
  ...
  public:
    ...
    BatchListOutgoingTypedLinksResponse(const Aws::Utils::Json::JsonValue& jsonValue);
    BatchListOutgoingTypedLinksResponse& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
