...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2016-05-10/BatchListPolicyAttachments">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    BatchListPolicyAttachments(const Aws::Utils::Json::JsonValue& jsonValue);
    BatchListPolicyAttachments& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
