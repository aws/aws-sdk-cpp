...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2016-05-10/BatchListIncomingTypedLinks">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    BatchListIncomingTypedLinks(const Aws::Utils::Json::JsonValue& jsonValue);
