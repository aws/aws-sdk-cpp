...
namespace Model
{
  ...
  public:
     ...
     * <p>The attributes attached to the facet.</p>
     */
    inline void SetAttributes(Aws::Vector<FacetAttribute>&& value) { m_attributes = value; }
     ...
     * <p>The attributes attached to the facet.</p>
     */
    inline ListFacetAttributesResult& WithAttributes(Aws::Vector<FacetAttribute>&& value) { SetAttributes(value); return *this;}
     ...
     * <p>The attributes attached to the facet.</p>
     */
    inline ListFacetAttributesResult& AddAttributes(FacetAttribute&& value) { m_attributes.push_back(value); return *this; }
     ...
     * <p>The pagination token.</p>
     */
    inline ListFacetAttributesResult& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
