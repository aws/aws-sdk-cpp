...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTypedLinkFacetInformationRequest> Clone() const
    {
      return Aws::MakeUnique<GetTypedLinkFacetInformationRequest>(GetServiceRequestName(), *this);
    }
