...
namespace Model
{
  ...
  public:
     ...
     * <p>The ARNs of retrieved development schemas.</p>
     */
    inline ListDevelopmentSchemaArnsResult& WithSchemaArns(Aws::Vector<Aws::String>&& value) { SetSchemaArns(value); return *this;}
     ...
     * <p>The ARNs of retrieved development schemas.</p>
     */
    inline ListDevelopmentSchemaArnsResult& AddSchemaArns(Aws::String&& value) { m_schemaArns.push_back(value); return *this; }
     ...
     * <p>The pagination token.</p>
     */
    inline ListDevelopmentSchemaArnsResult& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
