...
namespace Model
{
  ...
  public:
     ...
     * information, see <a>arns</a>.</p>
     */
    inline ListObjectPoliciesRequest& WithDirectoryArn(Aws::String&& value) { SetDirectoryArn(value); return *this;}
     ...
     * <p>Reference that identifies the object for which policies will be listed.</p>
     */
    inline ListObjectPoliciesRequest& WithObjectReference(ObjectReference&& value) { SetObjectReference(value); return *this;}
     ...
     * <p>The pagination token.</p>
     */
    inline ListObjectPoliciesRequest& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
