...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTypedLinkFacetAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<ListTypedLinkFacetAttributesRequest>(GetServiceRequestName(), *this);
    }
