...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2016-05-10/LinkAttributeUpdate">AWS
   * API Reference</a></p>
   */
  ...
  public:
    LinkAttributeUpdate();
    LinkAttributeUpdate(const Aws::Utils::Json::JsonValue& jsonValue);
    LinkAttributeUpdate& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
