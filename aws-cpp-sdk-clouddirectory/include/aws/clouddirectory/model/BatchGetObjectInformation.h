...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2016-05-10/BatchGetObjectInformation">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    BatchGetObjectInformation(const Aws::Utils::Json::JsonValue& jsonValue);
