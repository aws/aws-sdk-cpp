...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2016-05-10/BatchCreateIndexResponse">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    BatchCreateIndexResponse(const Aws::Utils::Json::JsonValue& jsonValue);
