...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2016-05-10/BatchListAttachedIndices">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    BatchListAttachedIndices(const Aws::Utils::Json::JsonValue& jsonValue);
