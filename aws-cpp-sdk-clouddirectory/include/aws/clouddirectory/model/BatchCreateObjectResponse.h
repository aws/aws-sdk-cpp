...
namespace Model
{
  ...
  /**
   * <p>Represents the output of a CreateObject response operation.</p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
    ...
    BatchCreateObjectResponse(const Aws::Utils::Json::JsonValue& jsonValue);
     ...
     * <p>ID associated with the object.</p>
     */
    inline BatchCreateObjectResponse& WithObjectIdentifier(Aws::String&& value) { SetObjectIdentifier(value); return *this;}
