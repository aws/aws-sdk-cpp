...
namespace CloudDirectory
{
  ...
  class AWS_CLOUDDIRECTORY_API CloudDirectoryClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudDirectoryClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::CloudDirectoryEndpointProvider> endpointProvider = Aws::MakeShared<CloudDirectory::Endpoint::CloudDirectoryEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CloudDirectoryEndpointProvider> m_endpointProvider;
  };
