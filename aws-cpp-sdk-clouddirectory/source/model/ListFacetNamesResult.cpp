...
ListFacetNamesResult::ListFacetNamesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListFacetNamesResult& ListFacetNamesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
