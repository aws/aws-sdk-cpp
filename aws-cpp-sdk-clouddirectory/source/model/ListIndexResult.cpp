...
ListIndexResult::ListIndexResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListIndexResult& ListIndexResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
