...
ApplySchemaResult::ApplySchemaResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ApplySchemaResult& ApplySchemaResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
