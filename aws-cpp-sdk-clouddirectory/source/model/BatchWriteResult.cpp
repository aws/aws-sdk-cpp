...
BatchWriteResult::BatchWriteResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

BatchWriteResult& BatchWriteResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
