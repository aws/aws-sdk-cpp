...
using ResolveEndpointOutcome = Aws::CloudDirectory::Endpoint::CloudDirectoryEndpointProvider::CloudDirectoryResolveEndpointOutcome;
...
CloudDirectoryClient::CloudDirectoryClient(const Client::ClientConfiguration& clientConfiguration,
                                           std::shared_ptr<Endpoint::CloudDirectoryEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CloudDirectoryErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CloudDirectory::Endpoint::CloudDirectoryEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
