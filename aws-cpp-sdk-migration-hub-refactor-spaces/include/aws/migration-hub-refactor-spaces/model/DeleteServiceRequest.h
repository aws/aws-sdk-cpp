...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBREFACTORSPACES_API DeleteServiceRequest : public MigrationHubRefactorSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteServiceRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteServiceRequest>(GetServiceRequestName(), *this);
    }
