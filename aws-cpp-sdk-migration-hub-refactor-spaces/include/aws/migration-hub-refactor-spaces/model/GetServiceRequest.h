...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBREFACTORSPACES_API GetServiceRequest : public MigrationHubRefactorSpacesRequest
  {
  public:
    GetServiceRequest();
    ...
    */
    virtual Aws::UniquePtr<GetServiceRequest> Clone() const
    {
      return Aws::MakeUnique<GetServiceRequest>(GetServiceRequestName(), *this);
    }
