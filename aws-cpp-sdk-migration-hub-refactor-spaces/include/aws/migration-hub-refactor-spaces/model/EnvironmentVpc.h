...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MIGRATIONHUBREFACTORSPACES_API EnvironmentVpc
  {
  public:
    EnvironmentVpc();
    EnvironmentVpc(Aws::Utils::Json::JsonView jsonValue);
    EnvironmentVpc& operator=(Aws::Utils::Json::JsonView jsonValue);
