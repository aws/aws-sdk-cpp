...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBREFACTORSPACES_API GetRouteRequest : public MigrationHubRefactorSpacesRequest
  {
  public:
    GetRouteRequest();
    ...
    */
    virtual Aws::UniquePtr<GetRouteRequest> Clone() const
    {
      return Aws::MakeUnique<GetRouteRequest>(GetServiceRequestName(), *this);
    }
