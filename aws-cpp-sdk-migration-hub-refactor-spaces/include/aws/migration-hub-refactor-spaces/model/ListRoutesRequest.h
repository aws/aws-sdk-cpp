...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBREFACTORSPACES_API ListRoutesRequest : public MigrationHubRefactorSpacesRequest
  {
  public:
    ListRoutesRequest();
    ...
    */
    virtual Aws::UniquePtr<ListRoutesRequest> Clone() const
    {
      return Aws::MakeUnique<ListRoutesRequest>(GetServiceRequestName(), *this);
    }
