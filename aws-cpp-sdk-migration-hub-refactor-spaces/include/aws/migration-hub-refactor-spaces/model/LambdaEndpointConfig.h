...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MIGRATIONHUBREFACTORSPACES_API LambdaEndpointConfig
  {
  public:
    LambdaEndpointConfig();
    LambdaEndpointConfig(Aws::Utils::Json::JsonView jsonValue);
    LambdaEndpointConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
