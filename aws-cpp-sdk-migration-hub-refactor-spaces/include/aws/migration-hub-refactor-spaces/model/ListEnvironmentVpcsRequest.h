...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBREFACTORSPACES_API ListEnvironmentVpcsRequest : public MigrationHubRefactorSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEnvironmentVpcsRequest> Clone() const
    {
      return Aws::MakeUnique<ListEnvironmentVpcsRequest>(GetServiceRequestName(), *this);
    }
