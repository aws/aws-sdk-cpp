...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBREFACTORSPACES_API GetEnvironmentRequest : public MigrationHubRefactorSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEnvironmentRequest> Clone() const
    {
      return Aws::MakeUnique<GetEnvironmentRequest>(GetServiceRequestName(), *this);
    }
