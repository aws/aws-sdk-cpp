...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBREFACTORSPACES_API CreateEnvironmentRequest : public MigrationHubRefactorSpacesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateEnvironmentRequest> Clone() const
    {
      return Aws::MakeUnique<CreateEnvironmentRequest>(GetServiceRequestName(), *this);
    }
