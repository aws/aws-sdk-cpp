...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBREFACTORSPACES_API UpdateRouteRequest : public MigrationHubRefactorSpacesRequest
  {
  public:
    UpdateRouteRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateRouteRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRouteRequest>(GetServiceRequestName(), *this);
    }
