...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MIGRATIONHUBREFACTORSPACES_API UrlEndpointSummary
  {
  public:
    UrlEndpointSummary();
    UrlEndpointSummary(Aws::Utils::Json::JsonView jsonValue);
    UrlEndpointSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
