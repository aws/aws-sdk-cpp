...
namespace MigrationHubRefactorSpaces
{
  ...
  class AWS_MIGRATIONHUBREFACTORSPACES_API MigrationHubRefactorSpacesClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MigrationHubRefactorSpacesClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                         std::shared_ptr<Endpoint::MigrationHubRefactorSpacesEndpointProvider> endpointProvider = Aws::MakeShared<MigrationHubRefactorSpaces::Endpoint::MigrationHubRefactorSpacesEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MigrationHubRefactorSpacesEndpointProvider> m_endpointProvider;
  };
