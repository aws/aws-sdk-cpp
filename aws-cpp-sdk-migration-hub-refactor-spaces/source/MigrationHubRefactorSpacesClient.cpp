...
using ResolveEndpointOutcome = Aws::MigrationHubRefactorSpaces::Endpoint::MigrationHubRefactorSpacesEndpointProvider::MigrationHubRefactorSpacesResolveEndpointOutcome;
...
MigrationHubRefactorSpacesClient::MigrationHubRefactorSpacesClient(const Client::ClientConfiguration& clientConfiguration,
                                                                   std::shared_ptr<Endpoint::MigrationHubRefactorSpacesEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<MigrationHubRefactorSpacesErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<MigrationHubRefactorSpaces::Endpoint::MigrationHubRefactorSpacesEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
