...
Aws::String ElasticLoadBalancingEndpointRules::GetRulesAsString()
{
    return Aws::String(ElasticLoadBalancingEndpointRules::Rules.begin(), ElasticLoadBalancingEndpointRules::Rules.end());
}

const Aws::Vector<char> ElasticLoadBalancingEndpointRules::Rules = {
...
'l','o','a','d','b','a','l','a','n','c','i','n','g','-','f','i','p','s','.','{','R','e','g','i','o',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','l','a','s','t','i','c','l','o','a',
'd','b','a','l','a','n','c','i','n','g','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
'i','t','i','o','n','R','e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"',
'p','r','o','p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':',
'{','}','}',',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',',','{','"',
'c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n','t','"',
':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','l','a','s','t','i','c','l',
'o','a','d','b','a','l','a','n','c','i','n','g','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'/','/','e','l','a','s','t','i','c','l','o','a','d','b','a','l','a','n','c','i','n','g','.','{','R',
