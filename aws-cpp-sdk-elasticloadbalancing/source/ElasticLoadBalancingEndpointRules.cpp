...
{
const size_t ElasticLoadBalancingEndpointRules::RulesBlobStrLen = 3764;
const size_t ElasticLoadBalancingEndpointRules::RulesBlobSize = 3765;
...
'c','l','o','a','d','b','a','l','a','n','c','i','n','g','-','f','i','p','s','.','{','R','e','g','i',
...
'u','a','l','s','"',',','"','a','r','g','v','"',':','[','"','a','w','s','-','u','s','-','g','o','v',
'"',',','{','"','f','n','"',':','"','g','e','t','A','t','t','r','"',',','"','a','r','g','v','"',':',
'[','{','"','r','e','f','"',':','"','P','a','r','t','i','t','i','o','n','R','e','s','u','l','t','"',
'}',',','"','n','a','m','e','"',']','}',']','}',']',',','"','e','n','d','p','o','i','n','t','"',':',
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','l','a','s','t','i','c','l','o',
'a','d','b','a','l','a','n','c','i','n','g','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
