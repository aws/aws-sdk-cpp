...
RemoveTagsResult::RemoveTagsResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

RemoveTagsResult& RemoveTagsResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
