...
using ResolveEndpointOutcome = Aws::ElasticLoadBalancing::Endpoint::ElasticLoadBalancingEndpointProvider::ElasticLoadBalancingResolveEndpointOutcome;
...
ElasticLoadBalancingClient::ElasticLoadBalancingClient(const Client::ClientConfiguration& clientConfiguration,
                                                       std::shared_ptr<Endpoint::ElasticLoadBalancingEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ElasticLoadBalancingErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ElasticLoadBalancing::Endpoint::ElasticLoadBalancingEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
