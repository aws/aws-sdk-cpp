...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DetachLoadBalancerFromSubnetsRequest> Clone() const
    {
      return Aws::MakeUnique<DetachLoadBalancerFromSubnetsRequest>(GetServiceRequestName(), *this);
    }
