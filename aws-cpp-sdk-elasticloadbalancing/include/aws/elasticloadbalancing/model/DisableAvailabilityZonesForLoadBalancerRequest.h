...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableAvailabilityZonesForLoadBalancerRequest> Clone() const
    {
      return Aws::MakeUnique<DisableAvailabilityZonesForLoadBalancerRequest>(GetServiceRequestName(), *this);
    }
