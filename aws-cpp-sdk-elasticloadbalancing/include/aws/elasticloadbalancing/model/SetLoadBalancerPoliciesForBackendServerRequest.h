...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SetLoadBalancerPoliciesForBackendServerRequest> Clone() const
    {
      return Aws::MakeUnique<SetLoadBalancerPoliciesForBackendServerRequest>(GetServiceRequestName(), *this);
    }
