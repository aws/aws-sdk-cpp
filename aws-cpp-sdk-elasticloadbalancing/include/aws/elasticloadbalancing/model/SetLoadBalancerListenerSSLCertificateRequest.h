...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SetLoadBalancerListenerSSLCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<SetLoadBalancerListenerSSLCertificateRequest>(GetServiceRequestName(), *this);
    }
