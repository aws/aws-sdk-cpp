...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLBCookieStickinessPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLBCookieStickinessPolicyRequest>(GetServiceRequestName(), *this);
    }
