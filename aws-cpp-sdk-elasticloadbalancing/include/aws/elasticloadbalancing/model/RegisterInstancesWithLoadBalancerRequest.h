...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterInstancesWithLoadBalancerRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterInstancesWithLoadBalancerRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "RegisterInstancesWithLoadBalancer"; }
