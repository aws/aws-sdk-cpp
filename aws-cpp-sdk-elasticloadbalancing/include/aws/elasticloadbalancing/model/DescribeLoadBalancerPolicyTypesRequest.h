...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLoadBalancerPolicyTypesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLoadBalancerPolicyTypesRequest>(GetServiceRequestName(), *this);
    }
