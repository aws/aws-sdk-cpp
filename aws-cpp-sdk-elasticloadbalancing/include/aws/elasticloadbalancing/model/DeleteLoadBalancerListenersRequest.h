...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLoadBalancerListenersRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLoadBalancerListenersRequest>(GetServiceRequestName(), *this);
    }
