...
namespace Model
{
   ...
   */
  class AWS_ELASTICLOADBALANCING_API SetLoadBalancerPoliciesForBackendServerResult
  {
  public:
    ...
    inline SetLoadBalancerPoliciesForBackendServerResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
