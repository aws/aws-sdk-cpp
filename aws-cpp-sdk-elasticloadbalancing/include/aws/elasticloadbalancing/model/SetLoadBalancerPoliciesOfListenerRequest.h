...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SetLoadBalancerPoliciesOfListenerRequest> Clone() const
    {
      return Aws::MakeUnique<SetLoadBalancerPoliciesOfListenerRequest>(GetServiceRequestName(), *this);
    }
