  ...
  public:
    ...
    */
    ...
    /*
     <p>The Availability Zones. These must be in the same region as the load balancer.</p>
    */
    inline EnableAvailabilityZonesForLoadBalancerRequest& AddAvailabilityZones(const Aws::String& value) { m_availabilityZones.push_back(value); return *this; }

    /*
     <p>The Availability Zones. These must be in the same region as the load balancer.</p>
    */
    inline EnableAvailabilityZonesForLoadBalancerRequest& AddAvailabilityZones(const char* value) { m_availabilityZones.push_back(value); return *this; }
