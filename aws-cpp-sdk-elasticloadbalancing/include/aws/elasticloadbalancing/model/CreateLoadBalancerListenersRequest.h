...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLoadBalancerListenersRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLoadBalancerListenersRequest>(GetServiceRequestName(), *this);
    }
