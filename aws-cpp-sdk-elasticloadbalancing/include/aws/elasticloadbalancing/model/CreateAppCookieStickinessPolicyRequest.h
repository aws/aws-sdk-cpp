...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAppCookieStickinessPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAppCookieStickinessPolicyRequest>(GetServiceRequestName(), *this);
    }
