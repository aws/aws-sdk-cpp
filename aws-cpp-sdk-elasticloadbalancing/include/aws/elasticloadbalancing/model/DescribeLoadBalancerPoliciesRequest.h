...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLoadBalancerPoliciesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLoadBalancerPoliciesRequest>(GetServiceRequestName(), *this);
    }
