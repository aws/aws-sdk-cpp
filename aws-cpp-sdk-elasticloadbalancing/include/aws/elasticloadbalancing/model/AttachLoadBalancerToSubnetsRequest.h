  ...
  public:
    ...
    */
    ...
    /*
     <p>The IDs of the subnets to add for the load balancer. You can add only one subnet per Availability Zone.</p>
    */
    inline AttachLoadBalancerToSubnetsRequest& AddSubnets(const Aws::String& value) { m_subnets.push_back(value); return *this; }

    /*
     <p>The IDs of the subnets to add for the load balancer. You can add only one subnet per Availability Zone.</p>
    */
    inline AttachLoadBalancerToSubnetsRequest& AddSubnets(const char* value) { m_subnets.push_back(value); return *this; }
