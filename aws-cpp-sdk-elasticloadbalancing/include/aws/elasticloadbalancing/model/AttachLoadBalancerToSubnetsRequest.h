...
namespace Model
{
  ...
  /**
   * <p>Contains the parameters for AttachLoaBalancerToSubnets.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/elasticloadbalancing-2012-06-01/AttachLoadBalancerToSubnetsInput">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AttachLoadBalancerToSubnetsRequest> Clone() const
    {
      return Aws::MakeUnique<AttachLoadBalancerToSubnetsRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "AttachLoadBalancerToSubnets"; }
