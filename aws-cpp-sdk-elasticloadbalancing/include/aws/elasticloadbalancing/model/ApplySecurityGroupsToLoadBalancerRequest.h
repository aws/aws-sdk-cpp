...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ApplySecurityGroupsToLoadBalancerRequest> Clone() const
    {
      return Aws::MakeUnique<ApplySecurityGroupsToLoadBalancerRequest>(GetServiceRequestName(), *this);
    }
