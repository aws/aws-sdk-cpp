...
namespace ElasticLoadBalancing
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ElasticLoadBalancingClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                   std::shared_ptr<Endpoint::ElasticLoadBalancingEndpointProvider> endpointProvider = Aws::MakeShared<ElasticLoadBalancing::Endpoint::ElasticLoadBalancingEndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::ElasticLoadBalancingEndpointProvider> m_endpointProvider;
  };
