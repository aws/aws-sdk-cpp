...
Aws::String AppRegistryEndpointRules::GetRulesAsString()
{
    return Aws::String(AppRegistryEndpointRules::Rules.begin(), AppRegistryEndpointRules::Rules.end());
}

const Aws::Vector<char> AppRegistryEndpointRules::Rules = {
...
'v','i','c','e','c','a','t','a','l','o','g','-','a','p','p','r','e','g','i','s','t','r','y','.','{',
...
'p','s',':','/','/','s','e','r','v','i','c','e','c','a','t','a','l','o','g','-','a','p','p','r','e',
'g','i','s','t','r','y','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'/','/','s','e','r','v','i','c','e','c','a','t','a','l','o','g','-','a','p','p','r','e','g','i','s',
't','r','y','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
