...
namespace Model
{
  ...
  /**
   */
  class AWS_APPREGISTRY_API DeleteAttributeGroupRequest : public AppRegistryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAttributeGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAttributeGroupRequest>(GetServiceRequestName(), *this);
    }
