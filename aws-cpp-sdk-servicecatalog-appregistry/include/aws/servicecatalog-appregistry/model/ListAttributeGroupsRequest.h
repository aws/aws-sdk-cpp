...
namespace Model
{
  ...
  /**
   */
  class AWS_APPREGISTRY_API ListAttributeGroupsRequest : public AppRegistryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAttributeGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAttributeGroupsRequest>(GetServiceRequestName(), *this);
    }
