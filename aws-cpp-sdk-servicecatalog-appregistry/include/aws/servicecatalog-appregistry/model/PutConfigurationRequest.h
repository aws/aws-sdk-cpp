...
namespace Model
{
  ...
  /**
   */
  class AWS_APPREGISTRY_API PutConfigurationRequest : public AppRegistryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutConfigurationRequest>(GetServiceRequestName(), *this);
    }
