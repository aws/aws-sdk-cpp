...
namespace Model
{
  ...
  /**
   */
  class AWS_APPREGISTRY_API ListAttributeGroupsForApplicationRequest : public AppRegistryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAttributeGroupsForApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<ListAttributeGroupsForApplicationRequest>(GetServiceRequestName(), *this);
    }
