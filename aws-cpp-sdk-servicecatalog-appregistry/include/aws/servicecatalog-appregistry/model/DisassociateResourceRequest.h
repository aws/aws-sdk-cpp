...
namespace Model
{
  ...
  /**
   */
  class AWS_APPREGISTRY_API DisassociateResourceRequest : public AppRegistryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateResourceRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateResourceRequest>(GetServiceRequestName(), *this);
    }
