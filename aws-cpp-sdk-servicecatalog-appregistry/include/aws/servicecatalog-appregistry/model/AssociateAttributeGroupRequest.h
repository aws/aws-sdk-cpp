...
namespace Model
{
  ...
  /**
   */
  class AWS_APPREGISTRY_API AssociateAttributeGroupRequest : public AppRegistryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateAttributeGroupRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateAttributeGroupRequest>(GetServiceRequestName(), *this);
    }
