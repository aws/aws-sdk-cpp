...
namespace Model
{
  ...
  /**
   */
  class AWS_APPREGISTRY_API CreateAttributeGroupRequest : public AppRegistryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAttributeGroupRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAttributeGroupRequest>(GetServiceRequestName(), *this);
    }
