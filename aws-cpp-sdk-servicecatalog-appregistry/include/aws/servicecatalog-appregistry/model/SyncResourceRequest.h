...
namespace Model
{
  ...
  /**
   */
  class AWS_APPREGISTRY_API SyncResourceRequest : public AppRegistryRequest
  {
  public:
    SyncResourceRequest();
    ...
    */
    virtual Aws::UniquePtr<SyncResourceRequest> Clone() const
    {
      return Aws::MakeUnique<SyncResourceRequest>(GetServiceRequestName(), *this);
    }
