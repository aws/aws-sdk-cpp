...
namespace Model
{
  ...
  /**
   */
  class AWS_APPREGISTRY_API GetAssociatedResourceRequest : public AppRegistryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAssociatedResourceRequest> Clone() const
    {
      return Aws::MakeUnique<GetAssociatedResourceRequest>(GetServiceRequestName(), *this);
    }
