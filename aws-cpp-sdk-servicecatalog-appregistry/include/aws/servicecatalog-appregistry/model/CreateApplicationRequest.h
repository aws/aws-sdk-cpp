...
namespace Model
{
  ...
  /**
   */
  class AWS_APPREGISTRY_API CreateApplicationRequest : public AppRegistryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateApplicationRequest>(GetServiceRequestName(), *this);
    }
