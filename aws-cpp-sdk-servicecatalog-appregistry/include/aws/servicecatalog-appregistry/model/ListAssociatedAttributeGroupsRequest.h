...
namespace Model
{
  ...
  /**
   */
  class AWS_APPREGISTRY_API ListAssociatedAttributeGroupsRequest : public AppRegistryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAssociatedAttributeGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAssociatedAttributeGroupsRequest>(GetServiceRequestName(), *this);
    }
