...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API GetEventTypesRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEventTypesRequest> Clone() const
    {
      return Aws::MakeUnique<GetEventTypesRequest>(GetServiceRequestName(), *this);
    }
