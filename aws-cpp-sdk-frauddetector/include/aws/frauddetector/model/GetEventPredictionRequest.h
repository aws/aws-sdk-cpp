...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API GetEventPredictionRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEventPredictionRequest> Clone() const
    {
      return Aws::MakeUnique<GetEventPredictionRequest>(GetServiceRequestName(), *this);
    }
