...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDetectorVersionMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDetectorVersionMetadataRequest>(GetServiceRequestName(), *this);
    }
