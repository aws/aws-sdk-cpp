...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API PutEventTypeRequest : public FraudDetectorRequest
  {
  public:
    PutEventTypeRequest();
    ...
    */
    virtual Aws::UniquePtr<PutEventTypeRequest> Clone() const
    {
      return Aws::MakeUnique<PutEventTypeRequest>(GetServiceRequestName(), *this);
    }
