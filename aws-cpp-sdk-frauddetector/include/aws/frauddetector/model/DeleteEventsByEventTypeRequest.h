...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API DeleteEventsByEventTypeRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEventsByEventTypeRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEventsByEventTypeRequest>(GetServiceRequestName(), *this);
    }
