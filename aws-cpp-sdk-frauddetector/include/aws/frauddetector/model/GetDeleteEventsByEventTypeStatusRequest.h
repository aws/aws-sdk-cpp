...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API GetDeleteEventsByEventTypeStatusRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDeleteEventsByEventTypeStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetDeleteEventsByEventTypeStatusRequest>(GetServiceRequestName(), *this);
    }
