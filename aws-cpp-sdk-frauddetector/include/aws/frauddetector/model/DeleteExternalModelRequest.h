...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API DeleteExternalModelRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteExternalModelRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteExternalModelRequest>(GetServiceRequestName(), *this);
    }
