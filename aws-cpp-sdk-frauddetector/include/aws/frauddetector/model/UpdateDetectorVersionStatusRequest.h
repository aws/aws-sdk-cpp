...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API UpdateDetectorVersionStatusRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDetectorVersionStatusRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDetectorVersionStatusRequest>(GetServiceRequestName(), *this);
    }
