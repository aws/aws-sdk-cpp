...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API UpdateRuleVersionRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRuleVersionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRuleVersionRequest>(GetServiceRequestName(), *this);
    }
