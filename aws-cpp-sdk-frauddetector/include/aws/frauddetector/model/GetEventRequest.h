...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API GetEventRequest : public FraudDetectorRequest
  {
  public:
    GetEventRequest();
    ...
    */
    virtual Aws::UniquePtr<GetEventRequest> Clone() const
    {
      return Aws::MakeUnique<GetEventRequest>(GetServiceRequestName(), *this);
    }
