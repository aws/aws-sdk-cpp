...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API UpdateModelRequest : public FraudDetectorRequest
  {
  public:
    UpdateModelRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateModelRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateModelRequest>(GetServiceRequestName(), *this);
    }
