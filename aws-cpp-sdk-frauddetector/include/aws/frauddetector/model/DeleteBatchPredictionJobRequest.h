...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API DeleteBatchPredictionJobRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBatchPredictionJobRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBatchPredictionJobRequest>(GetServiceRequestName(), *this);
    }
