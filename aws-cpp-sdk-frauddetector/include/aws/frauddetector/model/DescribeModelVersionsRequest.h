...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API DescribeModelVersionsRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeModelVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeModelVersionsRequest>(GetServiceRequestName(), *this);
    }
