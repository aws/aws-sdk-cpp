...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API UpdateRuleMetadataRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRuleMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRuleMetadataRequest>(GetServiceRequestName(), *this);
    }
