...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API GetRulesRequest : public FraudDetectorRequest
  {
  public:
    GetRulesRequest();
    ...
    */
    virtual Aws::UniquePtr<GetRulesRequest> Clone() const
    {
      return Aws::MakeUnique<GetRulesRequest>(GetServiceRequestName(), *this);
    }
