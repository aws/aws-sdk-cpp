...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API CancelBatchImportJobRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelBatchImportJobRequest> Clone() const
    {
      return Aws::MakeUnique<CancelBatchImportJobRequest>(GetServiceRequestName(), *this);
    }
