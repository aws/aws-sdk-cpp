...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API PutLabelRequest : public FraudDetectorRequest
  {
  public:
    PutLabelRequest();
    ...
    */
    virtual Aws::UniquePtr<PutLabelRequest> Clone() const
    {
      return Aws::MakeUnique<PutLabelRequest>(GetServiceRequestName(), *this);
    }
