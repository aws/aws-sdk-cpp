...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API BatchGetVariableRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetVariableRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetVariableRequest>(GetServiceRequestName(), *this);
    }
