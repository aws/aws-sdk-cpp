...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API GetBatchImportJobsRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBatchImportJobsRequest> Clone() const
    {
      return Aws::MakeUnique<GetBatchImportJobsRequest>(GetServiceRequestName(), *this);
    }
