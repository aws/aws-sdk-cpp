...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API PutEntityTypeRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutEntityTypeRequest> Clone() const
    {
      return Aws::MakeUnique<PutEntityTypeRequest>(GetServiceRequestName(), *this);
    }
