...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API DescribeDetectorRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDetectorRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDetectorRequest>(GetServiceRequestName(), *this);
    }
