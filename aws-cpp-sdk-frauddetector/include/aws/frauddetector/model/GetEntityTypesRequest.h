...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API GetEntityTypesRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEntityTypesRequest> Clone() const
    {
      return Aws::MakeUnique<GetEntityTypesRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetEntityTypes"; }
