...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API UpdateModelVersionStatusRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateModelVersionStatusRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateModelVersionStatusRequest>(GetServiceRequestName(), *this);
    }
