...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API ListEventPredictionsRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEventPredictionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListEventPredictionsRequest>(GetServiceRequestName(), *this);
    }
