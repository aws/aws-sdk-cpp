...
namespace Model
{
  ...
  /**
   */
  class AWS_FRAUDDETECTOR_API GetBatchPredictionJobsRequest : public FraudDetectorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBatchPredictionJobsRequest> Clone() const
    {
      return Aws::MakeUnique<GetBatchPredictionJobsRequest>(GetServiceRequestName(), *this);
    }
