...
namespace Model
{
        ...
        typedef Aws::Utils::Outcome<DeleteRuleVersionResult, FraudDetectorError> DeleteRuleVersionOutcome;
        ...
        typedef Aws::Utils::Outcome<PutModelResult, FraudDetectorError> PutModelOutcome;
