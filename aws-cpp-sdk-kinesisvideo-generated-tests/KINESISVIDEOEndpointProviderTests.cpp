...
using KinesisVideoResolveEndpointOutcome = Aws::KinesisVideo::Endpoint::KinesisVideoEndpointProvider::KinesisVideoResolveEndpointOutcome;
...
void ValidateOutcome(const KinesisVideoResolveEndpointOutcome& outcome, const KinesisVideoEndpointProviderEndpointTestCase::Expect& expect)
{
