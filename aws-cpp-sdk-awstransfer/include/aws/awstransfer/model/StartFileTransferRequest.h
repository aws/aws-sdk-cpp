...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSFER_API StartFileTransferRequest : public TransferRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartFileTransferRequest> Clone() const
    {
      return Aws::MakeUnique<StartFileTransferRequest>(GetServiceRequestName(), *this);
    }
