...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_TRANSFER_API DescribedConnector
  {
  public:
    DescribedConnector();
    DescribedConnector(Aws::Utils::Json::JsonView jsonValue);
    DescribedConnector& operator=(Aws::Utils::Json::JsonView jsonValue);
