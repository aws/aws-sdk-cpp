...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSFER_API ImportHostKeyRequest : public TransferRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ImportHostKeyRequest> Clone() const
    {
      return Aws::MakeUnique<ImportHostKeyRequest>(GetServiceRequestName(), *this);
    }
