...
namespace Model
{
  ...
  public:
     ...
     * protocol-enabled server to be listed.</p>
     */
    ...
    /**
     * <p>Specifies the authentication method used to validate a user for a file
     * transfer protocol-enabled server that was specified. This can include Secure
     * Shell (SSH), user name and password combinations, or your own custom
    ...
    /**
     * <p>Specifies the type of VPC endpoint that your file transfer protocol-enabled
     * server is connected to. If your server is connected to a VPC endpoint, your
     * server isn't accessible over the public internet.</p>
     */
     ...
     * file transfer protocol-enabled server to turn on Amazon CloudWatch logging.</p>
     */
     ...
     * protocol-enabled servers that were listed.</p>
     */
