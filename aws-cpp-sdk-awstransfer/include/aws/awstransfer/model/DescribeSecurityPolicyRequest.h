...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSFER_API DescribeSecurityPolicyRequest : public TransferRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSecurityPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSecurityPolicyRequest>(GetServiceRequestName(), *this);
    }
