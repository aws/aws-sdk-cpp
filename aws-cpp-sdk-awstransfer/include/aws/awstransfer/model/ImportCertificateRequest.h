...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSFER_API ImportCertificateRequest : public TransferRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ImportCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<ImportCertificateRequest>(GetServiceRequestName(), *this);
    }
