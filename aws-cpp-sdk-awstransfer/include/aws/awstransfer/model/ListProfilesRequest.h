...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSFER_API ListProfilesRequest : public TransferRequest
  {
  public:
    ListProfilesRequest();
    ...
    */
    virtual Aws::UniquePtr<ListProfilesRequest> Clone() const
    {
      return Aws::MakeUnique<ListProfilesRequest>(GetServiceRequestName(), *this);
    }
