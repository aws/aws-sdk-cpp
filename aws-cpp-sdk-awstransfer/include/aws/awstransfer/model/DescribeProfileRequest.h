...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSFER_API DescribeProfileRequest : public TransferRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeProfileRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeProfileRequest>(GetServiceRequestName(), *this);
    }
