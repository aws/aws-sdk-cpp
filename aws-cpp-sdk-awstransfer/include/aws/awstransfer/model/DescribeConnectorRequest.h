...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSFER_API DescribeConnectorRequest : public TransferRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConnectorRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConnectorRequest>(GetServiceRequestName(), *this);
    }
