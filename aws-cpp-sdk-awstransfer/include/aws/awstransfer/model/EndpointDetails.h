...
namespace Model
{
  ...
  public:
     ...
     * valid in the <code>UpdateServer</code> API.</p>  <p>This property can only
     * be use when <code>EndpointType</code> is set to <code>VPC</code>.</p> 
     */
     ...
     * protocol-enabled server endpoint in your VPC.</p>  <p>This property can
    ...
    /**
     * <p>The ID of the VPC endpoint.</p>  <p>This property can only be used when
     * <code>EndpointType</code> is set to <code>VPC_ENDPOINT</code>.</p> 
     */
     ...
     * endpoint will be hosted.</p>  <p>This property can only be used when
