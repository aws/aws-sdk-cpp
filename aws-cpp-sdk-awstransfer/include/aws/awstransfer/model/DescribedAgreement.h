...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_TRANSFER_API DescribedAgreement
  {
  public:
    DescribedAgreement();
    DescribedAgreement(Aws::Utils::Json::JsonView jsonValue);
    DescribedAgreement& operator=(Aws::Utils::Json::JsonView jsonValue);
