...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSFER_API ListAccessesRequest : public TransferRequest
  {
  public:
    ListAccessesRequest();
    ...
    */
    virtual Aws::UniquePtr<ListAccessesRequest> Clone() const
    {
      return Aws::MakeUnique<ListAccessesRequest>(GetServiceRequestName(), *this);
    }
