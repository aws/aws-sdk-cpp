...
{
  /**
   * <p> <code>UpdateUserResponse</code> returns the user name and file transfer
  ...
  public:
    ...
    /**
     * <p>The unique identifier for a user that is assigned to a file transfer
     * protocol-enabled server instance that was specified in the request.</p>
     */
