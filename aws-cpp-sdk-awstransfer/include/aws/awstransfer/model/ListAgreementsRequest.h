...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSFER_API ListAgreementsRequest : public TransferRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAgreementsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAgreementsRequest>(GetServiceRequestName(), *this);
    }
