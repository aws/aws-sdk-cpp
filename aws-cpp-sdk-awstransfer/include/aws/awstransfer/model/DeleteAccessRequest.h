...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSFER_API DeleteAccessRequest : public TransferRequest
  {
  public:
    DeleteAccessRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteAccessRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAccessRequest>(GetServiceRequestName(), *this);
    }
