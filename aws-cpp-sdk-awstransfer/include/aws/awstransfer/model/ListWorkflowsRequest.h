...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSFER_API ListWorkflowsRequest : public TransferRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWorkflowsRequest> Clone() const
    {
      return Aws::MakeUnique<ListWorkflowsRequest>(GetServiceRequestName(), *this);
    }
