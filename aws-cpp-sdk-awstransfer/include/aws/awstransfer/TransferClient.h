...
namespace Transfer
{
  ...
  class AWS_TRANSFER_API TransferClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        TransferClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::TransferEndpointProvider> endpointProvider = Aws::MakeShared<Transfer::Endpoint::TransferEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::TransferEndpointProvider> m_endpointProvider;
  };
