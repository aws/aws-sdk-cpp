...
Aws::String TransferEndpointRules::GetRulesAsString()
{
    return Aws::String(TransferEndpointRules::Rules.begin(), TransferEndpointRules::Rules.end());
}

const Aws::Vector<char> TransferEndpointRules::Rules = {
...
't','t','p','s',':','/','/','t','r','a','n','s','f','e','r','-','f','i','p','s','.','{','R','e','g',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','t','r','a','n','s','f','e','r','-','f',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','t','r','a','n','s','f','e','r','.','{','R','e',
...
'/','t','r','a','n','s','f','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
