...
namespace Model
{
  ...
  public:
    ...
    DeleteDashboardsResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DeleteDashboardsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
