...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCH_API PutManagedInsightRulesRequest : public CloudWatchRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutManagedInsightRulesRequest> Clone() const
    {
      return Aws::MakeUnique<PutManagedInsightRulesRequest>(GetServiceRequestName(), *this);
    }
