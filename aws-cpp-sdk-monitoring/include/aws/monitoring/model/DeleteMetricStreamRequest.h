...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCH_API DeleteMetricStreamRequest : public CloudWatchRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteMetricStreamRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteMetricStreamRequest>(GetServiceRequestName(), *this);
    }
