...
namespace Model
{
   ...
   * that includes extended statistics in the stream. For more information about
   * extended statistics, see CloudWatch, listed in <a
  ...
  public:
    ...
    /**
     * <p>An array of metric name and namespace pairs that stream the extended
     ...
     * the extended statistics, no matter their dimensions.</p>
     */
    ...
    /**
     * <p>The list of extended statistics that are to be streamed for the metrics
     ...
     * stream is <code>json</code>, the valid values are include the abbreviations for
     * all of the extended statistics listed in <a
     * href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Statistics-definitions.html.html">
