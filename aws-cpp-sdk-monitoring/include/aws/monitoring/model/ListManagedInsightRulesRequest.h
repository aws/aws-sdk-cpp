...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCH_API ListManagedInsightRulesRequest : public CloudWatchRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListManagedInsightRulesRequest> Clone() const
    {
      return Aws::MakeUnique<ListManagedInsightRulesRequest>(GetServiceRequestName(), *this);
    }
