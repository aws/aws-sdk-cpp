...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCH_API ListMetricStreamsRequest : public CloudWatchRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMetricStreamsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMetricStreamsRequest>(GetServiceRequestName(), *this);
    }
