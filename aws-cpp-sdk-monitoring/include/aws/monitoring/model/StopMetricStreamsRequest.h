...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCH_API StopMetricStreamsRequest : public CloudWatchRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopMetricStreamsRequest> Clone() const
    {
      return Aws::MakeUnique<StopMetricStreamsRequest>(GetServiceRequestName(), *this);
    }
