...
namespace CloudWatch
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudWatchClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::CloudWatchEndpointProvider> endpointProvider = Aws::MakeShared<CloudWatch::Endpoint::CloudWatchEndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::CloudWatchEndpointProvider> m_endpointProvider;
  };
