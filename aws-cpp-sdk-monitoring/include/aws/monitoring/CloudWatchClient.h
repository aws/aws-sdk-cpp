    ...
    public:
      typedef Aws::Client::AWSXMLClient BASECLASS;
        ...
        */
         ...
         * returned.</p> <p>For a list of metrics and dimensions supported by AWS services,
         * see the <a
         ...
         * for HTTP POST requests.</p> <p>Although the <code>Value</code> parameter accepts
         * numbers of type <code>Double</code>, Amazon CloudWatch rejects values that are
         * either too small or too large. Values must be in the range of 8.515920e-109 to
