...
namespace Model
{
  ...
  typedef Aws::Utils::Event<CloudWatchClient, const Model::DeleteAlarmsRequest&, const Model::DeleteAlarmsOutcome&> DeleteAlarmsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CloudWatchClient, const Model::DescribeAlarmHistoryRequest&, const Model::DescribeAlarmHistoryOutcome&> DescribeAlarmHistoryOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CloudWatchClient, const Model::DescribeAlarmsRequest&, const Model::DescribeAlarmsOutcome&> DescribeAlarmsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CloudWatchClient, const Model::DescribeAlarmsForMetricRequest&, const Model::DescribeAlarmsForMetricOutcome&> DescribeAlarmsForMetricOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CloudWatchClient, const Model::DisableAlarmActionsRequest&, const Model::DisableAlarmActionsOutcome&> DisableAlarmActionsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CloudWatchClient, const Model::EnableAlarmActionsRequest&, const Model::EnableAlarmActionsOutcome&> EnableAlarmActionsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CloudWatchClient, const Model::GetMetricStatisticsRequest&, const Model::GetMetricStatisticsOutcome&> GetMetricStatisticsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CloudWatchClient, const Model::ListHostInfoRequest&, const Model::ListHostInfoOutcome&> ListHostInfoOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CloudWatchClient, const Model::ListMetricsRequest&, const Model::ListMetricsOutcome&> ListMetricsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CloudWatchClient, const Model::PutMetricAlarmRequest&, const Model::PutMetricAlarmOutcome&> PutMetricAlarmOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CloudWatchClient, const Model::PutMetricDataRequest&, const Model::PutMetricDataOutcome&> PutMetricDataOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CloudWatchClient, const Model::PutMetricDataBatchRequest&, const Model::PutMetricDataBatchOutcome&> PutMetricDataBatchOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CloudWatchClient, const Model::SetAlarmStateRequest&, const Model::SetAlarmStateOutcome&> SetAlarmStateOutcomeReceivedEvent;
  ...
  */
  class AWS_CLOUDWATCH_API CloudWatchClient : public Aws::Client::AWSXMLClient
  {
     ...
     */
     void DeleteAlarmsAsync(const Model::DeleteAlarmsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribeAlarmHistoryAsync(const Model::DescribeAlarmHistoryRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribeAlarmsAsync(const Model::DescribeAlarmsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribeAlarmsForMetricAsync(const Model::DescribeAlarmsForMetricRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DisableAlarmActionsAsync(const Model::DisableAlarmActionsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void EnableAlarmActionsAsync(const Model::EnableAlarmActionsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetMetricStatisticsAsync(const Model::GetMetricStatisticsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListHostInfoAsync(const Model::ListHostInfoRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListMetricsAsync(const Model::ListMetricsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void PutMetricAlarmAsync(const Model::PutMetricAlarmRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void PutMetricDataAsync(const Model::PutMetricDataRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void PutMetricDataBatchAsync(const Model::PutMetricDataBatchRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void SetAlarmStateAsync(const Model::SetAlarmStateRequest& request) const;
  ...
  private:
    ...
    /**Async helpers**/
    void DeleteAlarmsAsyncHelper(const Model::DeleteAlarmsRequest& request) const;
    void DescribeAlarmHistoryAsyncHelper(const Model::DescribeAlarmHistoryRequest& request) const;
    void DescribeAlarmsAsyncHelper(const Model::DescribeAlarmsRequest& request) const;
    void DescribeAlarmsForMetricAsyncHelper(const Model::DescribeAlarmsForMetricRequest& request) const;
    void DisableAlarmActionsAsyncHelper(const Model::DisableAlarmActionsRequest& request) const;
    void EnableAlarmActionsAsyncHelper(const Model::EnableAlarmActionsRequest& request) const;
    void GetMetricStatisticsAsyncHelper(const Model::GetMetricStatisticsRequest& request) const;
    void ListHostInfoAsyncHelper(const Model::ListHostInfoRequest& request) const;
    void ListMetricsAsyncHelper(const Model::ListMetricsRequest& request) const;
    void PutMetricAlarmAsyncHelper(const Model::PutMetricAlarmRequest& request) const;
    void PutMetricDataAsyncHelper(const Model::PutMetricDataRequest& request) const;
    void PutMetricDataBatchAsyncHelper(const Model::PutMetricDataBatchRequest& request) const;
    void SetAlarmStateAsyncHelper(const Model::SetAlarmStateRequest& request) const;
