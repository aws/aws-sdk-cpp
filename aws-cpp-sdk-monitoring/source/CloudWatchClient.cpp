...
using ResolveEndpointOutcome = Aws::CloudWatch::Endpoint::CloudWatchEndpointProvider::CloudWatchResolveEndpointOutcome;
...
CloudWatchClient::CloudWatchClient(const Client::ClientConfiguration& clientConfiguration,
                                   std::shared_ptr<Endpoint::CloudWatchEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CloudWatchErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CloudWatch::Endpoint::CloudWatchEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
