...
GetDashboardResult::GetDashboardResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

GetDashboardResult& GetDashboardResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  if(!resultNode.IsNull())
  {
    ...
    {
      m_dashboardBody = StringUtils::Trim(dashboardBodyNode.GetText().c_str());
    }
