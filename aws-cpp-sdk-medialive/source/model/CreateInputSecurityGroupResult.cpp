...
CreateInputSecurityGroupResult::CreateInputSecurityGroupResult()
{
}

CreateInputSecurityGroupResult::CreateInputSecurityGroupResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
