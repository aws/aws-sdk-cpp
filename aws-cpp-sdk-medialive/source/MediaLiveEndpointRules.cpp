...
Aws::String MediaLiveEndpointRules::GetRulesAsString()
{
    return Aws::String(MediaLiveEndpointRules::Rules.begin(), MediaLiveEndpointRules::Rules.end());
}

const Aws::Vector<char> MediaLiveEndpointRules::Rules = {
