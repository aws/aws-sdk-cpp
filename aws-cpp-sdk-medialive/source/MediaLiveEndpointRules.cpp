...
namespace MediaLive
{
const size_t MediaLiveEndpointRules::RulesBlobStrLen = 3404;
const size_t MediaLiveEndpointRules::RulesBlobSize = 3405;
...
't','t','p','s',':','/','/','m','e','d','i','a','l','i','v','e','-','f','i','p','s','.','{','R','e',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','e','d','i','a','l','i','v','e',
...
's',':','/','/','m','e','d','i','a','l','i','v','e','.','{','R','e','g','i','o','n','}','.','{','P',
...
const char* MediaLiveEndpointRules::GetRulesBlob()
{
