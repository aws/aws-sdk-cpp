...
namespace MediaLive
{
  ...
  class AWS_MEDIALIVE_API MediaLiveClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MediaLiveClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::MediaLiveEndpointProvider> endpointProvider = Aws::MakeShared<MediaLive::Endpoint::MediaLiveEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MediaLiveEndpointProvider> m_endpointProvider;
  };
