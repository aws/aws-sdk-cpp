...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API BatchStopRequest : public MediaLiveRequest
  {
  public:
    BatchStopRequest();
    ...
    */
    virtual Aws::UniquePtr<BatchStopRequest> Clone() const
    {
      return Aws::MakeUnique<BatchStopRequest>(GetServiceRequestName(), *this);
    }
