...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API UpdateMultiplexProgramRequest : public MediaLiveRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateMultiplexProgramRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateMultiplexProgramRequest>(GetServiceRequestName(), *this);
    }
