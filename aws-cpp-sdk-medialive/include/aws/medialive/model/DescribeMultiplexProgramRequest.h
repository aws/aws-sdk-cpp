...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API DescribeMultiplexProgramRequest : public MediaLiveRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMultiplexProgramRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMultiplexProgramRequest>(GetServiceRequestName(), *this);
    }
