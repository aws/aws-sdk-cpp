...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API ListOfferingsRequest : public MediaLiveRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListOfferingsRequest> Clone() const
    {
      return Aws::MakeUnique<ListOfferingsRequest>(GetServiceRequestName(), *this);
    }
