...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API BatchStartRequest : public MediaLiveRequest
  {
  public:
    BatchStartRequest();
    ...
    */
    virtual Aws::UniquePtr<BatchStartRequest> Clone() const
    {
      return Aws::MakeUnique<BatchStartRequest>(GetServiceRequestName(), *this);
    }
