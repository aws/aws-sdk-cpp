...
namespace Model
{
  ...
  /**
   * Placeholder documentation for CancelInputDeviceTransferRequest<p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/CancelInputDeviceTransferRequest">AWS
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API CancelInputDeviceTransferRequest : public MediaLiveRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelInputDeviceTransferRequest> Clone() const
    {
      return Aws::MakeUnique<CancelInputDeviceTransferRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "CancelInputDeviceTransfer"; }
