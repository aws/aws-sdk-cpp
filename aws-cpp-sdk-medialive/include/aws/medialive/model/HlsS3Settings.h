...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIALIVE_API HlsS3Settings();
    AWS_MEDIALIVE_API HlsS3Settings(Aws::Utils::Json::JsonView jsonValue);
    AWS_MEDIALIVE_API HlsS3Settings& operator=(Aws::Utils::Json::JsonView jsonValue);
