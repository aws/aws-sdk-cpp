...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API StartInputDeviceMaintenanceWindowRequest : public MediaLiveRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartInputDeviceMaintenanceWindowRequest> Clone() const
    {
      return Aws::MakeUnique<StartInputDeviceMaintenanceWindowRequest>(GetServiceRequestName(), *this);
    }
