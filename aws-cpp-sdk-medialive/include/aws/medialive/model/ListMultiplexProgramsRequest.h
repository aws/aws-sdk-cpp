...
namespace Model
{
  ...
  /**
   * Placeholder documentation for ListMultiplexProgramsRequest<p><h3>See Also:</h3> 
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/ListMultiplexProgramsRequest">AWS
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API ListMultiplexProgramsRequest : public MediaLiveRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMultiplexProgramsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMultiplexProgramsRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListMultiplexPrograms"; }
