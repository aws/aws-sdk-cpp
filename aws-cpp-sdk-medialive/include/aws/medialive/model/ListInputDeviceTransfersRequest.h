...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API ListInputDeviceTransfersRequest : public MediaLiveRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListInputDeviceTransfersRequest> Clone() const
    {
      return Aws::MakeUnique<ListInputDeviceTransfersRequest>(GetServiceRequestName(), *this);
    }
