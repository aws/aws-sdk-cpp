...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API RebootInputDeviceRequest : public MediaLiveRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RebootInputDeviceRequest> Clone() const
    {
      return Aws::MakeUnique<RebootInputDeviceRequest>(GetServiceRequestName(), *this);
    }
