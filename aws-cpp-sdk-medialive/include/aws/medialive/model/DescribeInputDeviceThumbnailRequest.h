...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInputDeviceThumbnailRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInputDeviceThumbnailRequest>(GetServiceRequestName(), *this);
    }
