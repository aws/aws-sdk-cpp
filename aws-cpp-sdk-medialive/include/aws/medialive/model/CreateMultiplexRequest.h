...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API CreateMultiplexRequest : public MediaLiveRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateMultiplexRequest> Clone() const
    {
      return Aws::MakeUnique<CreateMultiplexRequest>(GetServiceRequestName(), *this);
    }
