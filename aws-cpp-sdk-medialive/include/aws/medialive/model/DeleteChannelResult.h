...
one destination per
     ...
     * Settings for VPC output
     */
    inline DeleteChannelResult& WithVpc(const VpcOutputSettings& value) { SetVpc(value); return *this;}

    /**
     * Settings for VPC output
     */
    inline DeleteChannelResult& WithVpc(VpcOutputSettings&& value) { SetVpc(std::move(value)); return *this;}
