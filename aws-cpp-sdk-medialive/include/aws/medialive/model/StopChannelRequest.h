...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API StopChannelRequest : public MediaLiveRequest
  {
  public:
    StopChannelRequest();
    ...
    */
    virtual Aws::UniquePtr<StopChannelRequest> Clone() const
    {
      return Aws::MakeUnique<StopChannelRequest>(GetServiceRequestName(), *this);
    }
