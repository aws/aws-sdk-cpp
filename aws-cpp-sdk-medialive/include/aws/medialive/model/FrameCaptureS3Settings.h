...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API FrameCaptureS3Settings
  {
  public:
    FrameCaptureS3Settings();
    FrameCaptureS3Settings(Aws::Utils::Json::JsonView jsonValue);
    FrameCaptureS3Settings& operator=(Aws::Utils::Json::JsonView jsonValue);
