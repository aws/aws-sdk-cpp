...
one destination per
     ...
     * Settings for VPC output
     */
    inline StartChannelResult& WithVpc(const VpcOutputSettings& value) { SetVpc(value); return *this;}

    /**
     * Settings for VPC output
     */
    inline StartChannelResult& WithVpc(VpcOutputSettings&& value) { SetVpc(std::move(value)); return *this;}
