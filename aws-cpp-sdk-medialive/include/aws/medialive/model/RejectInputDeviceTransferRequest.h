...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API RejectInputDeviceTransferRequest : public MediaLiveRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RejectInputDeviceTransferRequest> Clone() const
    {
      return Aws::MakeUnique<RejectInputDeviceTransferRequest>(GetServiceRequestName(), *this);
    }
