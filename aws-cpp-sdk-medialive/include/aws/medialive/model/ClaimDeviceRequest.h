...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIALIVE_API ClaimDeviceRequest : public MediaLiveRequest
  {
  public:
    ClaimDeviceRequest();
    ...
    */
    virtual Aws::UniquePtr<ClaimDeviceRequest> Clone() const
    {
      return Aws::MakeUnique<ClaimDeviceRequest>(GetServiceRequestName(), *this);
    }
