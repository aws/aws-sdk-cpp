...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The name of the Amazon S3 bucket where the report will be stored.</p> <p>For
     * more information on S3 bucket requirements, including an example bucket policy,
     * see <a
     * href="http://docs.aws.amazon.com/ARG/latest/userguide/tag-policies-prereqs.html#bucket-policy-org-report">Additional
     * Requirements for Running Organization-Wide Tag Compliance Report</a> in the
     * <i>AWS Resource Groups User Guide.</i> </p>
     */
