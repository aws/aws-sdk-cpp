...
namespace ResourceGroupsTaggingAPI
{
  ...
  class AWS_RESOURCEGROUPSTAGGINGAPI_API ResourceGroupsTaggingAPIClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ResourceGroupsTaggingAPIClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                       std::shared_ptr<Endpoint::ResourceGroupsTaggingAPIEndpointProvider> endpointProvider = Aws::MakeShared<ResourceGroupsTaggingAPI::Endpoint::ResourceGroupsTaggingAPIEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ResourceGroupsTaggingAPIEndpointProvider> m_endpointProvider;
  };
