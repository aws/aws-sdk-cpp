...
Aws::String ResourceGroupsTaggingAPIEndpointRules::GetRulesAsString()
{
    return Aws::String(ResourceGroupsTaggingAPIEndpointRules::Rules.begin(), ResourceGroupsTaggingAPIEndpointRules::Rules.end());
}

const Aws::Vector<char> ResourceGroupsTaggingAPIEndpointRules::Rules = {
...
't','a','g','g','i','n','g','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','t','a','g',
'g','i','n','g','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
...
'"','h','t','t','p','s',':','/','/','t','a','g','g','i','n','g','.','{','R','e','g','i','o','n','}',
