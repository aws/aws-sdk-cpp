...
namespace Model
{
  ...
  public:
     ...
     * specified type, such as <code>INVITE</code>, <code>ENABLE-FULL-CONTROL</code>,
     * or <code>APPROVE-FULL-CONTROL</code>. Alternatively, for the
     * <code>ENABLE-FULL-CONTROL</code> handshake that generates a separate child
     ...
     * that parent request.</p>
     */
    inline void SetFilter(HandshakeFilter&& value) { m_filterHasBeenSet = true; m_filter = value; }
     ...
     * that parent request.</p>
     */
    inline ListHandshakesForAccountRequest& WithFilter(HandshakeFilter&& value) { SetFilter(value); return *this;}
     ...
     * where the output should continue from.</p>
     */
    inline ListHandshakesForAccountRequest& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
