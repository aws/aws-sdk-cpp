...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterDelegatedAdministratorRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterDelegatedAdministratorRequest>(GetServiceRequestName(), *this);
    }
