...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAWSServiceAccessForOrganizationRequest> Clone() const
    {
      return Aws::MakeUnique<ListAWSServiceAccessForOrganizationRequest>(GetServiceRequestName(), *this);
    }
