...
namespace Model
{
  ...
  /**
   */
  class AWS_ORGANIZATIONS_API RegisterDelegatedAdministratorRequest : public OrganizationsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterDelegatedAdministratorRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterDelegatedAdministratorRequest>(GetServiceRequestName(), *this);
    }
