...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCreateAccountStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCreateAccountStatusRequest>(GetServiceRequestName(), *this);
    }
