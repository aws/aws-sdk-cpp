...
namespace Model
{
  ...
  public:
    ...
    UpdateOrganizationalUnitResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateOrganizationalUnitResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
