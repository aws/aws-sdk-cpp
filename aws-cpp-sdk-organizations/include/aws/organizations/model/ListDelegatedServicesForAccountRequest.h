...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDelegatedServicesForAccountRequest> Clone() const
    {
      return Aws::MakeUnique<ListDelegatedServicesForAccountRequest>(GetServiceRequestName(), *this);
    }
