...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListHandshakesForOrganizationRequest> Clone() const
    {
      return Aws::MakeUnique<ListHandshakesForOrganizationRequest>(GetServiceRequestName(), *this);
    }
