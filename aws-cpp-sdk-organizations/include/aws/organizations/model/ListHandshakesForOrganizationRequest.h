...
namespace Model
{
  ...
  public:
     ...
     * Alternatively, you can specify the <code>ENABLE-ALL-FEATURES</code> handshake,
     * which generates a separate child handshake for each member account. When you do,
     * specify the <code>ParentHandshakeId</code> to see only the handshakes that were
