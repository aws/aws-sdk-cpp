...
namespace Model
{
  ...
  public:
     ...
     * that parent request.</p>
     */
    inline ListHandshakesForOrganizationRequest& WithFilter(HandshakeFilter&& value) { SetFilter(value); return *this;}
     ...
     * where the output should continue from.</p>
     */
    inline ListHandshakesForOrganizationRequest& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
