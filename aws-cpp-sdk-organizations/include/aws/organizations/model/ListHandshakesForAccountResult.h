...
namespace Model
{
  ...
  public:
     ...
     * that is associated with the specified account.</p>
     */
    inline ListHandshakesForAccountResult& WithHandshakes(Aws::Vector<Handshake>&& value) { SetHandshakes(value); return *this;}
     ...
     * that is associated with the specified account.</p>
     */
    inline ListHandshakesForAccountResult& AddHandshakes(Handshake&& value) { m_handshakes.push_back(value); return *this; }
     ...
     * element comes back as <code>null</code>.</p>
     */
    inline ListHandshakesForAccountResult& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
