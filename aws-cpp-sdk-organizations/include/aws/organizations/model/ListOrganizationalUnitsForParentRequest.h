...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListOrganizationalUnitsForParentRequest> Clone() const
    {
      return Aws::MakeUnique<ListOrganizationalUnitsForParentRequest>(GetServiceRequestName(), *this);
    }
