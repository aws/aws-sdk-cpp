...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDelegatedAdministratorsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDelegatedAdministratorsRequest>(GetServiceRequestName(), *this);
    }
