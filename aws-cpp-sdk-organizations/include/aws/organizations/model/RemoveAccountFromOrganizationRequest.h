...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveAccountFromOrganizationRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveAccountFromOrganizationRequest>(GetServiceRequestName(), *this);
    }
