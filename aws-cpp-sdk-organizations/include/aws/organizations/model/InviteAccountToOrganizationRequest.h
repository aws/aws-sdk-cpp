...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<InviteAccountToOrganizationRequest> Clone() const
    {
      return Aws::MakeUnique<InviteAccountToOrganizationRequest>(GetServiceRequestName(), *this);
    }
