...
namespace Organizations
{
  ...
  class AWS_ORGANIZATIONS_API OrganizationsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        OrganizationsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::OrganizationsEndpointProvider> endpointProvider = Aws::MakeShared<Organizations::Endpoint::OrganizationsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::OrganizationsEndpointProvider> m_endpointProvider;
  };
