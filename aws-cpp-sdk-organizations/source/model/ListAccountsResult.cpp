...
ListAccountsResult::ListAccountsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListAccountsResult& ListAccountsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
