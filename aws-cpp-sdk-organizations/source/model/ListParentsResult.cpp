...
ListParentsResult::ListParentsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListParentsResult& ListParentsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
