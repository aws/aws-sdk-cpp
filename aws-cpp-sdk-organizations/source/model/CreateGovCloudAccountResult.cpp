...
CreateGovCloudAccountResult::CreateGovCloudAccountResult()
{
}

CreateGovCloudAccountResult::CreateGovCloudAccountResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
