...
Aws::String OrganizationsEndpointRules::GetRulesAsString()
{
    return Aws::String(OrganizationsEndpointRules::Rules.begin(), OrganizationsEndpointRules::Rules.end());
}

const Aws::Vector<char> OrganizationsEndpointRules::Rules = {
