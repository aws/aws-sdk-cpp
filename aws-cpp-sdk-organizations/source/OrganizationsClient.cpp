...
using ResolveEndpointOutcome = Aws::Organizations::Endpoint::OrganizationsEndpointProvider::OrganizationsResolveEndpointOutcome;
...
OrganizationsClient::OrganizationsClient(const Client::ClientConfiguration& clientConfiguration,
                                         std::shared_ptr<Endpoint::OrganizationsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<OrganizationsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Organizations::Endpoint::OrganizationsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
