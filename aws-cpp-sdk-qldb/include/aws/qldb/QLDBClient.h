...
namespace QLDB
{
  ...
  class AWS_QLDB_API QLDBClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        QLDBClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                   std::shared_ptr<Endpoint::QLDBEndpointProvider> endpointProvider = Aws::MakeShared<QLDB::Endpoint::QLDBEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::QLDBEndpointProvider> m_endpointProvider;
  };
