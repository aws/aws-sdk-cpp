...
namespace Model
{
  ...
  /**
   */
  class AWS_QLDB_API ListJournalKinesisStreamsForLedgerRequest : public QLDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListJournalKinesisStreamsForLedgerRequest> Clone() const
    {
      return Aws::MakeUnique<ListJournalKinesisStreamsForLedgerRequest>(GetServiceRequestName(), *this);
    }
