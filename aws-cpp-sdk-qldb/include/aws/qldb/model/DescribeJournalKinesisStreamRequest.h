...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeJournalKinesisStreamRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeJournalKinesisStreamRequest>(GetServiceRequestName(), *this);
    }
