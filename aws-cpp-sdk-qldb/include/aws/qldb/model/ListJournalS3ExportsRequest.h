...
namespace Model
{
  ...
  /**
   */
  class AWS_QLDB_API ListJournalS3ExportsRequest : public QLDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListJournalS3ExportsRequest> Clone() const
    {
      return Aws::MakeUnique<ListJournalS3ExportsRequest>(GetServiceRequestName(), *this);
    }
