...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateLedgerPermissionsModeRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLedgerPermissionsModeRequest>(GetServiceRequestName(), *this);
    }
