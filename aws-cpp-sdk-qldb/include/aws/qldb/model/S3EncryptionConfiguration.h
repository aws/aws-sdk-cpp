...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_QLDB_API S3EncryptionConfiguration
  {
  public:
    S3EncryptionConfiguration();
    S3EncryptionConfiguration(Aws::Utils::Json::JsonView jsonValue);
    S3EncryptionConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    /**
     * <p>The Amazon Resource Name (ARN) of a symmetric customer master key (CMK) in
     * Key Management Service (KMS). Amazon S3 does not support asymmetric CMKs.</p>
