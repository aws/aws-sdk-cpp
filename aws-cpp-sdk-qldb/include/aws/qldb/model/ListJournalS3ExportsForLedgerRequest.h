...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListJournalS3ExportsForLedgerRequest> Clone() const
    {
      return Aws::MakeUnique<ListJournalS3ExportsForLedgerRequest>(GetServiceRequestName(), *this);
    }
