...
ResourcePreconditionNotMetException& ResourcePreconditionNotMetException::operator =(JsonView jsonValue)
{
...
JsonValue ResourcePreconditionNotMetException::Jsonize() const
{
  JsonValue payload;
