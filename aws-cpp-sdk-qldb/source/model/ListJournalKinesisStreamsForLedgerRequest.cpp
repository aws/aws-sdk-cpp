...
Aws::String ListJournalKinesisStreamsForLedgerRequest::SerializePayload() const
{
  return {};
}

void ListJournalKinesisStreamsForLedgerRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
