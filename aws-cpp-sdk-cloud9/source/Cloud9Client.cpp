...
using ResolveEndpointOutcome = Aws::Cloud9::Endpoint::Cloud9EndpointProvider::Cloud9ResolveEndpointOutcome;
...
Cloud9Client::Cloud9Client(const Client::ClientConfiguration& clientConfiguration,
                           std::shared_ptr<Endpoint::Cloud9EndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<Cloud9ErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Cloud9::Endpoint::Cloud9EndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
