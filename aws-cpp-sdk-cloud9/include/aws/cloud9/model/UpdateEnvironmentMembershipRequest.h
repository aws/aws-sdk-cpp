...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateEnvironmentMembershipRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateEnvironmentMembershipRequest>(GetServiceRequestName(), *this);
    }
