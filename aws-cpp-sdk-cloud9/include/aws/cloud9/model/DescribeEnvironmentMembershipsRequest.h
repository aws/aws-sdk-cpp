...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEnvironmentMembershipsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEnvironmentMembershipsRequest>(GetServiceRequestName(), *this);
    }
