...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateEnvironmentMembershipRequest> Clone() const
    {
      return Aws::MakeUnique<CreateEnvironmentMembershipRequest>(GetServiceRequestName(), *this);
    }
