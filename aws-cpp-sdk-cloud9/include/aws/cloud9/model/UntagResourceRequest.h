...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public Cloud9Request
  {
  public:
    AWS_CLOUD9_API UntagResourceRequest();
    ...
    /**
     * <p>The Amazon Resource Name (ARN) of the Cloud9 development environment to
     * remove tags from.</p>
     */
