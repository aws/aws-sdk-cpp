...
namespace Model
{
  ...
  public:
     ...
     * EC2 instance. You can specify the AMI for the instance using an AMI alias or an
     * AWS Systems Manager (SSM) path. The default AMI is used if the parameter isn't
     * explicitly assigned a value in the request. </p> <p> <b>AMI aliases </b> </p>
     * <ul> <li> <p>Amazon Linux 2: <code>amazonlinux-2-x86_64</code> </p> </li> <li>
     * <p>Ubuntu 18.04: <code>ubuntu-18.04-x86_64</code> </p> </li> <li> <p>Amazon
     * Linux (default): <code>amazonlinux-1-x86_64</code> </p> </li> </ul> <p> <b>SSM
