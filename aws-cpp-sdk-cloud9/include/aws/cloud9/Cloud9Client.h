...
namespace Cloud9
{
  ...
  class AWS_CLOUD9_API Cloud9Client : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        Cloud9Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                     std::shared_ptr<Endpoint::Cloud9EndpointProvider> endpointProvider = Aws::MakeShared<Cloud9::Endpoint::Cloud9EndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::Cloud9EndpointProvider> m_endpointProvider;
  };
