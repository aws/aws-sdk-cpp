...
using CloudHSMResolveEndpointOutcome = Aws::CloudHSM::Endpoint::CloudHSMEndpointProvider::CloudHSMResolveEndpointOutcome;
...
void ValidateOutcome(const CloudHSMResolveEndpointOutcome& outcome, const CloudHSMEndpointProviderEndpointTestCase::Expect& expect)
{
