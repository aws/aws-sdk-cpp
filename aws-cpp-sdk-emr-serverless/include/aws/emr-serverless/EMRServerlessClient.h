...
namespace EMRServerless
{
  ...
  class AWS_EMRSERVERLESS_API EMRServerlessClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        EMRServerlessClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::EMRServerlessEndpointProvider> endpointProvider = Aws::MakeShared<EMRServerless::Endpoint::EMRServerlessEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::EMRServerlessEndpointProvider> m_endpointProvider;
  };
