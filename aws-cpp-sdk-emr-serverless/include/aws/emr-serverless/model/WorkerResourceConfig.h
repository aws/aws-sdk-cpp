...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EMRSERVERLESSWEBSERVICE_API WorkerResourceConfig
  {
  public:
    WorkerResourceConfig();
    WorkerResourceConfig(Aws::Utils::Json::JsonView jsonValue);
    WorkerResourceConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
