...
Aws::String EMRServerlessEndpointRules::GetRulesAsString()
{
    return Aws::String(EMRServerlessEndpointRules::Rules.begin(), EMRServerlessEndpointRules::Rules.end());
}

const Aws::Vector<char> EMRServerlessEndpointRules::Rules = {
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','m','r','-','s','e',
'r','v','e','r','l','e','s','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'h','t','t','p','s',':','/','/','e','m','r','-','s','e','r','v','e','r','l','e','s','s','-','f','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','e','m','r','-','s','e','r','v','e','r','l','e','s',
...
't','p','s',':','/','/','e','m','r','-','s','e','r','v','e','r','l','e','s','s','.','{','R','e','g',
