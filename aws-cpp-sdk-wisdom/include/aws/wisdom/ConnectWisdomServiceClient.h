...
namespace ConnectWisdomService
{
  ...
  class AWS_CONNECTWISDOMSERVICE_API ConnectWisdomServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ConnectWisdomServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                   std::shared_ptr<Endpoint::ConnectWisdomServiceEndpointProvider> endpointProvider = Aws::MakeShared<ConnectWisdomService::Endpoint::ConnectWisdomServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ConnectWisdomServiceEndpointProvider> m_endpointProvider;
  };
