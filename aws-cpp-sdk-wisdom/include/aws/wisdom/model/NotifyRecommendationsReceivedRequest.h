...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<NotifyRecommendationsReceivedRequest> Clone() const
    {
      return Aws::MakeUnique<NotifyRecommendationsReceivedRequest>(GetServiceRequestName(), *this);
    }
