...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API CreateContentRequest : public ConnectWisdomServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateContentRequest> Clone() const
    {
      return Aws::MakeUnique<CreateContentRequest>(GetServiceRequestName(), *this);
    }
