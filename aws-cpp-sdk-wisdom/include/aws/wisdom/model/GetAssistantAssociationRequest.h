...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API GetAssistantAssociationRequest : public ConnectWisdomServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAssistantAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<GetAssistantAssociationRequest>(GetServiceRequestName(), *this);
    }
