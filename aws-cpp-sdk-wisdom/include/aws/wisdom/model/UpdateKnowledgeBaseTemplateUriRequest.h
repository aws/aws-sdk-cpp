...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API UpdateKnowledgeBaseTemplateUriRequest : public ConnectWisdomServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateKnowledgeBaseTemplateUriRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateKnowledgeBaseTemplateUriRequest>(GetServiceRequestName(), *this);
    }
