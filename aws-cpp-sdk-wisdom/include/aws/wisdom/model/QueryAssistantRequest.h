...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API QueryAssistantRequest : public ConnectWisdomServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<QueryAssistantRequest> Clone() const
    {
      return Aws::MakeUnique<QueryAssistantRequest>(GetServiceRequestName(), *this);
    }
