...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API CreateAssistantRequest : public ConnectWisdomServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAssistantRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAssistantRequest>(GetServiceRequestName(), *this);
    }
