...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTWISDOMSERVICE_API AssistantSummary
  {
  public:
    AssistantSummary();
    AssistantSummary(Aws::Utils::Json::JsonView jsonValue);
    AssistantSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
