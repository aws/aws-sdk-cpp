...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API ListContentsRequest : public ConnectWisdomServiceRequest
  {
  public:
    ListContentsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListContentsRequest> Clone() const
    {
      return Aws::MakeUnique<ListContentsRequest>(GetServiceRequestName(), *this);
    }
