...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API CreateSessionRequest : public ConnectWisdomServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSessionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSessionRequest>(GetServiceRequestName(), *this);
    }
