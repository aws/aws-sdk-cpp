...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API DeleteKnowledgeBaseRequest : public ConnectWisdomServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteKnowledgeBaseRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteKnowledgeBaseRequest>(GetServiceRequestName(), *this);
    }
