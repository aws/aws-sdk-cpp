...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API DeleteAssistantRequest : public ConnectWisdomServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAssistantRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAssistantRequest>(GetServiceRequestName(), *this);
    }
