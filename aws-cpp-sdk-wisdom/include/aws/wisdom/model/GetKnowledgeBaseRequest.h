...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API GetKnowledgeBaseRequest : public ConnectWisdomServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetKnowledgeBaseRequest> Clone() const
    {
      return Aws::MakeUnique<GetKnowledgeBaseRequest>(GetServiceRequestName(), *this);
    }
