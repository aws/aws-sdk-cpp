...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API GetContentRequest : public ConnectWisdomServiceRequest
  {
  public:
    GetContentRequest();
    ...
    */
    virtual Aws::UniquePtr<GetContentRequest> Clone() const
    {
      return Aws::MakeUnique<GetContentRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetContent"; }
