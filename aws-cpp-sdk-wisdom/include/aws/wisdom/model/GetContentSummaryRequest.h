...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API GetContentSummaryRequest : public ConnectWisdomServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetContentSummaryRequest> Clone() const
    {
      return Aws::MakeUnique<GetContentSummaryRequest>(GetServiceRequestName(), *this);
    }
