...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API GetAssistantRequest : public ConnectWisdomServiceRequest
  {
  public:
    GetAssistantRequest();
    ...
    */
    virtual Aws::UniquePtr<GetAssistantRequest> Clone() const
    {
      return Aws::MakeUnique<GetAssistantRequest>(GetServiceRequestName(), *this);
    }
