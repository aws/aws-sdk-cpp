...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API GetSessionRequest : public ConnectWisdomServiceRequest
  {
  public:
    GetSessionRequest();
    ...
    */
    virtual Aws::UniquePtr<GetSessionRequest> Clone() const
    {
      return Aws::MakeUnique<GetSessionRequest>(GetServiceRequestName(), *this);
    }
