...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API DeleteAssistantAssociationRequest : public ConnectWisdomServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAssistantAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAssistantAssociationRequest>(GetServiceRequestName(), *this);
    }
