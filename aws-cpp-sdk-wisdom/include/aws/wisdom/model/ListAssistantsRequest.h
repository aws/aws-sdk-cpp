...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTWISDOMSERVICE_API ListAssistantsRequest : public ConnectWisdomServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAssistantsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAssistantsRequest>(GetServiceRequestName(), *this);
    }
