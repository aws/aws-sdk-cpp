...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveKnowledgeBaseTemplateUriRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveKnowledgeBaseTemplateUriRequest>(GetServiceRequestName(), *this);
    }
