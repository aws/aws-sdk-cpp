...
Aws::String ConnectWisdomServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(ConnectWisdomServiceEndpointRules::Rules.begin(), ConnectWisdomServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> ConnectWisdomServiceEndpointRules::Rules = {
