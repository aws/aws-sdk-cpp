...
{
const size_t ConnectWisdomServiceEndpointRules::RulesBlobStrLen = 3392;
const size_t ConnectWisdomServiceEndpointRules::RulesBlobSize = 3393;

using RulesBlobT = Aws::Array<const char, ConnectWisdomServiceEndpointRules::RulesBlobSize>;
...
't','t','p','s',':','/','/','w','i','s','d','o','m','-','f','i','p','s','.','{','R','e','g','i','o',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','w','i','s','d','o','m','-','f','i','p','s','.',
...
'"','h','t','t','p','s',':','/','/','w','i','s','d','o','m','.','{','R','e','g','i','o','n','}','.',
...
const char* ConnectWisdomServiceEndpointRules::GetRulesBlob()
{
