...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreatePackagingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreatePackagingConfigurationRequest>(GetServiceRequestName(), *this);
    }
