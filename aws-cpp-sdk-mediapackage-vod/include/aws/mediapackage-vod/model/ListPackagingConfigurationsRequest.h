...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPackagingConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListPackagingConfigurationsRequest>(GetServiceRequestName(), *this);
    }
