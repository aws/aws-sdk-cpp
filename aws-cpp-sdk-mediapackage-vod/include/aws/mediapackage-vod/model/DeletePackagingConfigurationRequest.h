...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeletePackagingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeletePackagingConfigurationRequest>(GetServiceRequestName(), *this);
    }
