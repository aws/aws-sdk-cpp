...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePackagingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePackagingConfigurationRequest>(GetServiceRequestName(), *this);
    }
