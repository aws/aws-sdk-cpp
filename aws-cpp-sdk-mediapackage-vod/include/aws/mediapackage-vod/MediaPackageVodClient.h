...
namespace MediaPackageVod
{
  ...
  class AWS_MEDIAPACKAGEVOD_API MediaPackageVodClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MediaPackageVodClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                              std::shared_ptr<Endpoint::MediaPackageVodEndpointProvider> endpointProvider = Aws::MakeShared<MediaPackageVod::Endpoint::MediaPackageVodEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MediaPackageVodEndpointProvider> m_endpointProvider;
  };
