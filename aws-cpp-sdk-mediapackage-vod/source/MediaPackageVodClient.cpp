...
using ResolveEndpointOutcome = Aws::MediaPackageVod::Endpoint::MediaPackageVodEndpointProvider::MediaPackageVodResolveEndpointOutcome;
...
MediaPackageVodClient::MediaPackageVodClient(const Client::ClientConfiguration& clientConfiguration,
                                             std::shared_ptr<Endpoint::MediaPackageVodEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<MediaPackageVodErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<MediaPackageVod::Endpoint::MediaPackageVodEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
...
void MediaPackageVodClient::init(const Client::ClientConfiguration& config)
{
