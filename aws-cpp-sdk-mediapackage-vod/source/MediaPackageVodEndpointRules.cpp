...
Aws::String MediaPackageVodEndpointRules::GetRulesAsString()
{
    return Aws::String(MediaPackageVodEndpointRules::Rules.begin(), MediaPackageVodEndpointRules::Rules.end());
}

const Aws::Vector<char> MediaPackageVodEndpointRules::Rules = {
