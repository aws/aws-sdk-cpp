...
namespace Backup
{
  ...
  class AWS_BACKUP_API BackupClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        BackupClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                     std::shared_ptr<Endpoint::BackupEndpointProvider> endpointProvider = Aws::MakeShared<Backup::Endpoint::BackupEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::BackupEndpointProvider> m_endpointProvider;
  };
