...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API DescribeReportJobRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReportJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReportJobRequest>(GetServiceRequestName(), *this);
    }
