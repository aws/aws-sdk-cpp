...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRecoveryPointsByResourceRequest> Clone() const
    {
      return Aws::MakeUnique<ListRecoveryPointsByResourceRequest>(GetServiceRequestName(), *this);
    }
