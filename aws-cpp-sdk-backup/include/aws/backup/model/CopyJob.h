...
namespace Model
{
  ...
  public:
     ...
     * for example, arn:aws:backup:us-east-1:123456789012:vault:aBackupVault. </p>
     */
    ...
    /**
     * <p>The date and time a job to create a copy job is completed, in Unix format and
    ...
    /**
     * <p>A detailed message explaining the status of the job that to copy a
     * resource.</p>
     */
