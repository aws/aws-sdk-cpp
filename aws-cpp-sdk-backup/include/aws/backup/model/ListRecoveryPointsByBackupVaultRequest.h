...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRecoveryPointsByBackupVaultRequest> Clone() const
    {
      return Aws::MakeUnique<ListRecoveryPointsByBackupVaultRequest>(GetServiceRequestName(), *this);
    }
