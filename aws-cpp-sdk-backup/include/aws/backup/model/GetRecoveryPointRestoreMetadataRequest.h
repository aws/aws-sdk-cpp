...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRecoveryPointRestoreMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<GetRecoveryPointRestoreMetadataRequest>(GetServiceRequestName(), *this);
    }
