...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API DisassociateRecoveryPointRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateRecoveryPointRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateRecoveryPointRequest>(GetServiceRequestName(), *this);
    }
