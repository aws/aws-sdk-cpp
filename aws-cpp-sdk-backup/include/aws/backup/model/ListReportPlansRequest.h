...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API ListReportPlansRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListReportPlansRequest> Clone() const
    {
      return Aws::MakeUnique<ListReportPlansRequest>(GetServiceRequestName(), *this);
    }
