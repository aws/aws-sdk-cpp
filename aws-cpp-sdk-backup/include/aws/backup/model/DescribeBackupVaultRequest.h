...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API DescribeBackupVaultRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeBackupVaultRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBackupVaultRequest>(GetServiceRequestName(), *this);
    }
