...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRecoveryPointLifecycleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRecoveryPointLifecycleRequest>(GetServiceRequestName(), *this);
    }
