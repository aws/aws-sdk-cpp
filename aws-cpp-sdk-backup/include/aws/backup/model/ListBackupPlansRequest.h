...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API ListBackupPlansRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBackupPlansRequest> Clone() const
    {
      return Aws::MakeUnique<ListBackupPlansRequest>(GetServiceRequestName(), *this);
    }
