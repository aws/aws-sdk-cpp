...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API UpdateFrameworkRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFrameworkRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFrameworkRequest>(GetServiceRequestName(), *this);
    }
