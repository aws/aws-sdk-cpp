...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API DeleteBackupVaultNotificationsRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBackupVaultNotificationsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBackupVaultNotificationsRequest>(GetServiceRequestName(), *this);
    }
