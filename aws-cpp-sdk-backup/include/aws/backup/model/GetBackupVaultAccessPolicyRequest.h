...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API GetBackupVaultAccessPolicyRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBackupVaultAccessPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetBackupVaultAccessPolicyRequest>(GetServiceRequestName(), *this);
    }
