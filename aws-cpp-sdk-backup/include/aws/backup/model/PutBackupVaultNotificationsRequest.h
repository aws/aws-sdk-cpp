...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutBackupVaultNotificationsRequest> Clone() const
    {
      return Aws::MakeUnique<PutBackupVaultNotificationsRequest>(GetServiceRequestName(), *this);
    }
