...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API CreateReportPlanRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateReportPlanRequest> Clone() const
    {
      return Aws::MakeUnique<CreateReportPlanRequest>(GetServiceRequestName(), *this);
    }
