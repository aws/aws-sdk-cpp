...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API DeleteBackupPlanRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBackupPlanRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBackupPlanRequest>(GetServiceRequestName(), *this);
    }
