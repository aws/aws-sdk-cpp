...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API UpdateReportPlanRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateReportPlanRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateReportPlanRequest>(GetServiceRequestName(), *this);
    }
