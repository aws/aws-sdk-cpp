...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API DescribeReportPlanRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReportPlanRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReportPlanRequest>(GetServiceRequestName(), *this);
    }
