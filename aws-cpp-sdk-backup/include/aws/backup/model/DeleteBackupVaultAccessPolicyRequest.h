...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API DeleteBackupVaultAccessPolicyRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBackupVaultAccessPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBackupVaultAccessPolicyRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteBackupVaultAccessPolicy"; }
