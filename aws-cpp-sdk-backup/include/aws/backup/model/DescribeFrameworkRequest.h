...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API DescribeFrameworkRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFrameworkRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFrameworkRequest>(GetServiceRequestName(), *this);
    }
