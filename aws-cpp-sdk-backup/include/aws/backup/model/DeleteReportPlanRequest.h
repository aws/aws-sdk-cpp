...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API DeleteReportPlanRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteReportPlanRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteReportPlanRequest>(GetServiceRequestName(), *this);
    }
