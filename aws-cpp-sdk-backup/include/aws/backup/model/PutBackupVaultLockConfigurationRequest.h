...
namespace Model
{
  ...
  /**
   */
  class AWS_BACKUP_API PutBackupVaultLockConfigurationRequest : public BackupRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutBackupVaultLockConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutBackupVaultLockConfigurationRequest>(GetServiceRequestName(), *this);
    }
