...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBackupVaultLockConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBackupVaultLockConfigurationRequest>(GetServiceRequestName(), *this);
    }
