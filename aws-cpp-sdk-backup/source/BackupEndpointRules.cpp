...
Aws::String BackupEndpointRules::GetRulesAsString()
{
    return Aws::String(BackupEndpointRules::Rules.begin(), BackupEndpointRules::Rules.end());
}

const Aws::Vector<char> BackupEndpointRules::Rules = {
...
'b','a','c','k','u','p','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'u','p','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e','s',
...
't','t','p','s',':','/','/','b','a','c','k','u','p','.','{','R','e','g','i','o','n','}','.','{','P',
