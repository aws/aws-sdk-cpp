...
Aws::String AppConfigDataEndpointRules::GetRulesAsString()
{
    return Aws::String(AppConfigDataEndpointRules::Rules.begin(), AppConfigDataEndpointRules::Rules.end());
}

const Aws::Vector<char> AppConfigDataEndpointRules::Rules = {
...
't','p','s',':','/','/','a','p','p','c','o','n','f','i','g','d','a','t','a','-','f','i','p','s','.',
...
'"','h','t','t','p','s',':','/','/','a','p','p','c','o','n','f','i','g','d','a','t','a','.','{','R',
