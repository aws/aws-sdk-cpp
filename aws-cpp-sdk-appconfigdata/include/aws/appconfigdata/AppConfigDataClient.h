...
namespace AppConfigData
{
  ...
  class AWS_APPCONFIGDATA_API AppConfigDataClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AppConfigDataClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::AppConfigDataEndpointProvider> endpointProvider = Aws::MakeShared<AppConfigData::Endpoint::AppConfigDataEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AppConfigDataEndpointProvider> m_endpointProvider;
  };
