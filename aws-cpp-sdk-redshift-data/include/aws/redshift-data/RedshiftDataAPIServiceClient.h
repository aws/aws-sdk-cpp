...
namespace RedshiftDataAPIService
{
  ...
  class AWS_REDSHIFTDATAAPISERVICE_API RedshiftDataAPIServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        RedshiftDataAPIServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                     std::shared_ptr<Endpoint::RedshiftDataAPIServiceEndpointProvider> endpointProvider = Aws::MakeShared<RedshiftDataAPIService::Endpoint::RedshiftDataAPIServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::RedshiftDataAPIServiceEndpointProvider> m_endpointProvider;
  };
