...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSchemasRequest> Clone() const
    {
      return Aws::MakeUnique<ListSchemasRequest>(GetServiceRequestName(), *this);
    }
     ...
     * temporary credentials.</p>
     */
    inline ListSchemasRequest& WithWorkgroupName(const char* value) { SetWorkgroupName(value); return *this;}
