...
namespace Model
{
  class AWS_REDSHIFTDATAAPISERVICE_API ExecuteStatementResult
  {
  public:
    ...
    /**
     * <p>The identifier of the statement to be run. This value is a universally unique
     * identifier (UUID) generated by Amazon Redshift Data API. </p>
     */
