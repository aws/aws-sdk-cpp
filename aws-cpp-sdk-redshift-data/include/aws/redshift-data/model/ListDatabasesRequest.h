...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFTDATAAPISERVICE_API ListDatabasesRequest : public RedshiftDataAPIServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDatabasesRequest> Clone() const
    {
      return Aws::MakeUnique<ListDatabasesRequest>(GetServiceRequestName(), *this);
    }
