...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFTDATAAPISERVICE_API ListStatementsRequest : public RedshiftDataAPIServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListStatementsRequest> Clone() const
    {
      return Aws::MakeUnique<ListStatementsRequest>(GetServiceRequestName(), *this);
    }
