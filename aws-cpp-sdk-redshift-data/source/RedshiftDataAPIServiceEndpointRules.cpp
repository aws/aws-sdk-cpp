...
Aws::String RedshiftDataAPIServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(RedshiftDataAPIServiceEndpointRules::Rules.begin(), RedshiftDataAPIServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> RedshiftDataAPIServiceEndpointRules::Rules = {
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','e','d','s','h','i','f',
't','-','d','a','t','a','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','e','d','s','h','i','f','t','-',
...
'c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n','t','"',
':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','e','d','s','h','i','f','t',
'-','d','a','t','a','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
...
':','"','h','t','t','p','s',':','/','/','r','e','d','s','h','i','f','t','-','d','a','t','a','.','{',
