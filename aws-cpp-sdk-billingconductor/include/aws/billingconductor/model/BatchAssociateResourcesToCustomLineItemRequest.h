...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API BatchAssociateResourcesToCustomLineItemRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchAssociateResourcesToCustomLineItemRequest> Clone() const
    {
      return Aws::MakeUnique<BatchAssociateResourcesToCustomLineItemRequest>(GetServiceRequestName(), *this);
    }
