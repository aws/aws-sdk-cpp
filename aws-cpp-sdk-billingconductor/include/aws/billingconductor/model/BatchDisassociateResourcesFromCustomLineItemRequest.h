...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDisassociateResourcesFromCustomLineItemRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDisassociateResourcesFromCustomLineItemRequest>(GetServiceRequestName(), *this);
    }
