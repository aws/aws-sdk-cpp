...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API CreateCustomLineItemRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCustomLineItemRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCustomLineItemRequest>(GetServiceRequestName(), *this);
    }
