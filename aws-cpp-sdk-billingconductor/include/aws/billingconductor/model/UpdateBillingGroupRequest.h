...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API UpdateBillingGroupRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateBillingGroupRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateBillingGroupRequest>(GetServiceRequestName(), *this);
    }
