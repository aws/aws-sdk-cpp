...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API ListCustomLineItemVersionsRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCustomLineItemVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListCustomLineItemVersionsRequest>(GetServiceRequestName(), *this);
    }
