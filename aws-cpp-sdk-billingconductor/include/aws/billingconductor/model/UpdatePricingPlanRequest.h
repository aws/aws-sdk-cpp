...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API UpdatePricingPlanRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdatePricingPlanRequest> Clone() const
    {
      return Aws::MakeUnique<UpdatePricingPlanRequest>(GetServiceRequestName(), *this);
    }
