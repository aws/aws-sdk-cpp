...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_BILLINGCONDUCTOR_API ListPricingRulesFilter
  {
  public:
    ListPricingRulesFilter();
    ListPricingRulesFilter(Aws::Utils::Json::JsonView jsonValue);
    ListPricingRulesFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
