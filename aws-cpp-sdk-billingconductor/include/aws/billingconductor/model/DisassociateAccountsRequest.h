...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API DisassociateAccountsRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateAccountsRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateAccountsRequest>(GetServiceRequestName(), *this);
    }
