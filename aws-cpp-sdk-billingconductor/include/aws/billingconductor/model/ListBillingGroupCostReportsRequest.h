...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBillingGroupCostReportsRequest> Clone() const
    {
      return Aws::MakeUnique<ListBillingGroupCostReportsRequest>(GetServiceRequestName(), *this);
    }
