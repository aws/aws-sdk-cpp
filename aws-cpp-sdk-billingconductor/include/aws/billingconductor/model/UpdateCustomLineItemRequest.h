...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API UpdateCustomLineItemRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCustomLineItemRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCustomLineItemRequest>(GetServiceRequestName(), *this);
    }
