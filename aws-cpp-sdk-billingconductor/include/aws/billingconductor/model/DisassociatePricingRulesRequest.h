...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API DisassociatePricingRulesRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociatePricingRulesRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociatePricingRulesRequest>(GetServiceRequestName(), *this);
    }
