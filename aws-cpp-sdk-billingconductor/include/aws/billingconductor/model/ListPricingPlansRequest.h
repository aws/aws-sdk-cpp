...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API ListPricingPlansRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPricingPlansRequest> Clone() const
    {
      return Aws::MakeUnique<ListPricingPlansRequest>(GetServiceRequestName(), *this);
    }
