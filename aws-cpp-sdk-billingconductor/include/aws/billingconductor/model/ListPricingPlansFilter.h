...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_BILLINGCONDUCTOR_API ListPricingPlansFilter
  {
  public:
    ListPricingPlansFilter();
    ListPricingPlansFilter(Aws::Utils::Json::JsonView jsonValue);
    ListPricingPlansFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
