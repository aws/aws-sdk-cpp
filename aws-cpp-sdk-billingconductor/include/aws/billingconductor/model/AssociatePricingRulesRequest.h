...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API AssociatePricingRulesRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociatePricingRulesRequest> Clone() const
    {
      return Aws::MakeUnique<AssociatePricingRulesRequest>(GetServiceRequestName(), *this);
    }
