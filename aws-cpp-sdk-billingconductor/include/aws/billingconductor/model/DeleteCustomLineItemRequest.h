...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API DeleteCustomLineItemRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCustomLineItemRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCustomLineItemRequest>(GetServiceRequestName(), *this);
    }
