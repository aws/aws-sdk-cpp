...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API ListPricingPlansAssociatedWithPricingRuleRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPricingPlansAssociatedWithPricingRuleRequest> Clone() const
    {
      return Aws::MakeUnique<ListPricingPlansAssociatedWithPricingRuleRequest>(GetServiceRequestName(), *this);
    }
