...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_BILLINGCONDUCTOR_API ListCustomLineItemVersionsBillingPeriodRangeFilter
  {
  public:
    ListCustomLineItemVersionsBillingPeriodRangeFilter();
    ListCustomLineItemVersionsBillingPeriodRangeFilter(Aws::Utils::Json::JsonView jsonValue);
    ListCustomLineItemVersionsBillingPeriodRangeFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
