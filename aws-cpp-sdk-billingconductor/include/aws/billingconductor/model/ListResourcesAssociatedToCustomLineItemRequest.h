...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResourcesAssociatedToCustomLineItemRequest> Clone() const
    {
      return Aws::MakeUnique<ListResourcesAssociatedToCustomLineItemRequest>(GetServiceRequestName(), *this);
    }
