...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API ListPricingRulesAssociatedToPricingPlanRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPricingRulesAssociatedToPricingPlanRequest> Clone() const
    {
      return Aws::MakeUnique<ListPricingRulesAssociatedToPricingPlanRequest>(GetServiceRequestName(), *this);
    }
