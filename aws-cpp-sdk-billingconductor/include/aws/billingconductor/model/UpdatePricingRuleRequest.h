...
namespace Model
{
  ...
  /**
   */
  class AWS_BILLINGCONDUCTOR_API UpdatePricingRuleRequest : public BillingConductorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdatePricingRuleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdatePricingRuleRequest>(GetServiceRequestName(), *this);
    }
