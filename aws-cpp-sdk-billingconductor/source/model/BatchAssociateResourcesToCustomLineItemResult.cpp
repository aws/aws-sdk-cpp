...
BatchAssociateResourcesToCustomLineItemResult& BatchAssociateResourcesToCustomLineItemResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  ...
  {
    Array<JsonView> successfullyAssociatedResourcesJsonList = jsonValue.GetArray("SuccessfullyAssociatedResources");
  ...
  {
    Array<JsonView> failedAssociatedResourcesJsonList = jsonValue.GetArray("FailedAssociatedResources");
