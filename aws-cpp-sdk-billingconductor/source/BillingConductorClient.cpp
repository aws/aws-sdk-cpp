...
using ResolveEndpointOutcome = Aws::BillingConductor::Endpoint::BillingConductorEndpointProvider::BillingConductorResolveEndpointOutcome;
...
BillingConductorClient::BillingConductorClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::BillingConductorEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<BillingConductorErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<BillingConductor::Endpoint::BillingConductorEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
