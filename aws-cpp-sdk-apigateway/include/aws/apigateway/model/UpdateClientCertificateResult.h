...
namespace Model
{
  ...
  public:
    ...
    inline UpdateClientCertificateResult& WithCreatedDate(double value) { SetCreatedDate(value); return *this;}
    ...
    inline UpdateClientCertificateResult& WithExpirationDate(double value) { SetExpirationDate(value); return *this;}
