...
namespace Model
{
   ...
   * see <a
   * href="[[AwsDocsUrlPrefix]]/apigateway/api-reference/handling-errors/#api-error-codes">API
   ...
   * "curies": { "href":
   * "[[AwsDocsUrlPrefix]]/apigateway/latest/developerguide/account-apigateway-{rel}.html",
   ...
   * href="[[AwsDocsUrlPrefix]]/apigateway/latest/developerguide/api-gateway-limits.html">API
   * Gateway Limits</a> <a
   * href="[[AwsDocsUrlPrefix]]/apigateway/latest/developerguide/welcome.html">Developer
   * Guide</a>, <a
   * href="[[AwsDocsUrlPrefix]]/cli/latest/reference/apigateway/get-account.html">AWS
