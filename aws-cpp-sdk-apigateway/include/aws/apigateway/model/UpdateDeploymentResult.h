...
namespace Model
{
   ...
   */
  class AWS_APIGATEWAY_API UpdateDeploymentResult
  {
  public:
     ...
     * <p>The identifier for the deployment resource.</p>
     */
    inline UpdateDeploymentResult& WithId(Aws::String&& value) { SetId(value); return *this;}
     ...
     * <p>The description for the deployment resource.</p>
     */
    inline UpdateDeploymentResult& WithDescription(Aws::String&& value) { SetDescription(value); return *this;}
     ...
     * <p>The date and time that the deployment resource was created.</p>
     */
    inline UpdateDeploymentResult& WithCreatedDate(Aws::Utils::DateTime&& value) { SetCreatedDate(value); return *this;}
     ...
     * resource was created.</p>
     */
    inline UpdateDeploymentResult& WithApiSummary(Aws::Map<Aws::String, Aws::Map<Aws::String, MethodSnapshot>>&& value) { SetApiSummary(value); return *this;}

    /**
     * <p>A summary of the <a>RestApi</a> at the date and time that the deployment
     * resource was created.</p>
     */
    inline UpdateDeploymentResult& AddApiSummary(const Aws::String& key, const Aws::Map<Aws::String, MethodSnapshot>& value) { m_apiSummary[key] = value; return *this; }

    /**
     * <p>A summary of the <a>RestApi</a> at the date and time that the deployment
     * resource was created.</p>
     */
    inline UpdateDeploymentResult& AddApiSummary(Aws::String&& key, const Aws::Map<Aws::String, MethodSnapshot>& value) { m_apiSummary[key] = value; return *this; }

    /**
     * <p>A summary of the <a>RestApi</a> at the date and time that the deployment
     * resource was created.</p>
     */
    inline UpdateDeploymentResult& AddApiSummary(const Aws::String& key, Aws::Map<Aws::String, MethodSnapshot>&& value) { m_apiSummary[key] = value; return *this; }

    /**
     * <p>A summary of the <a>RestApi</a> at the date and time that the deployment
     * resource was created.</p>
     */
    inline UpdateDeploymentResult& AddApiSummary(Aws::String&& key, Aws::Map<Aws::String, MethodSnapshot>&& value) { m_apiSummary[key] = value; return *this; }

    /**
     * <p>A summary of the <a>RestApi</a> at the date and time that the deployment
     * resource was created.</p>
     */
    inline UpdateDeploymentResult& AddApiSummary(const char* key, Aws::Map<Aws::String, MethodSnapshot>&& value) { m_apiSummary[key] = value; return *this; }

    /**
     * <p>A summary of the <a>RestApi</a> at the date and time that the deployment
     * resource was created.</p>
     */
    inline UpdateDeploymentResult& AddApiSummary(const char* key, const Aws::Map<Aws::String, MethodSnapshot>& value) { m_apiSummary[key] = value; return *this; }
