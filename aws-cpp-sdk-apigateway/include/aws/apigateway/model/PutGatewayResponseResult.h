...
namespace Model
{
   ...
   * Response Types Supported by Amazon API Gateway</a> <div class="example">
   * <h4>Example: Get a Gateway Response of a given response type</h4>
   * <h5>Request</h5> <p>This example shows how to get a gateway response of the
  ...
  public:
     ...
     * customization by an API developer. </p>
     */
