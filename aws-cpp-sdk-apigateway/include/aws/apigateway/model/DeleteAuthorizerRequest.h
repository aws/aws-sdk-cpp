...
namespace Model
{
  ...
  public:
     ...
     * <p>The <a>RestApi</a> identifier for the <a>Authorizer</a> resource.</p>
     */
    inline DeleteAuthorizerRequest& WithRestApiId(Aws::String&& value) { SetRestApiId(value); return *this;}
     ...
     * <p>The identifier of the <a>Authorizer</a> resource.</p>
     */
    inline DeleteAuthorizerRequest& WithAuthorizerId(Aws::String&& value) { SetAuthorizerId(value); return *this;}
