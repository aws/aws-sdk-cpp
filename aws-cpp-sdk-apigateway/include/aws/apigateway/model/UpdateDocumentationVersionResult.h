...
namespace Model
{
  ...
  public:
     ...
     * <p>The version identifier of the API documentation snapshot.</p>
     */
    inline UpdateDocumentationVersionResult& WithVersion(Aws::String&& value) { SetVersion(value); return *this;}
     ...
     * <p>The date when the API documentation snapshot is created.</p>
     */
    inline UpdateDocumentationVersionResult& WithCreatedDate(Aws::Utils::DateTime&& value) { SetCreatedDate(value); return *this;}
     ...
     * <p>The description of the API documentation snapshot.</p>
     */
    inline UpdateDocumentationVersionResult& WithDescription(Aws::String&& value) { SetDescription(value); return *this;}
