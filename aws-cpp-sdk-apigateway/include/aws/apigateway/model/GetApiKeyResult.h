...
namespace Model
{
  ...
  public:
     ...
     * 8601 format</a>.</p>
     */
    inline GetApiKeyResult& WithCreatedDate(double value) { SetCreatedDate(value); return *this;}
     ...
     * <p>When the API Key was last updated, in ISO 8601 format.</p>
     */
    inline GetApiKeyResult& WithLastUpdatedDate(double value) { SetLastUpdatedDate(value); return *this;}
