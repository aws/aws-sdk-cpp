...
namespace Model
{
  ...
  public:
     ...
     * <p>The <a>RestApi</a> identifier for the <a>Resource</a> resource.</p>
     */
    inline DeleteResourceRequest& WithRestApiId(Aws::String&& value) { SetRestApiId(value); return *this;}
     ...
     * <p>The identifier of the <a>Resource</a> resource.</p>
     */
    inline DeleteResourceRequest& WithResourceId(Aws::String&& value) { SetResourceId(value); return *this;}
