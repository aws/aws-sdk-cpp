...
namespace Model
{
  ...
  public:
    ...
    UpdateDocumentationPartResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateDocumentationPartResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * the <code>DocumentationPart</code> is created.</p>
     */
    inline UpdateDocumentationPartResult& WithId(Aws::String&& value) { SetId(value); return *this;}
     ...
     * entities, unless overridden.</p>
     */
    inline UpdateDocumentationPartResult& WithLocation(DocumentationPartLocation&& value) { SetLocation(value); return *this;}
     ...
     * <code>x-amazon-apigateway-documentation</code>.</p>
     */
    inline UpdateDocumentationPartResult& WithProperties(Aws::String&& value) { SetProperties(value); return *this;}
