...
namespace Model
{
  ...
  public:
     ...
     * <p>The <a>RestApi</a> identifier for the <a>MethodResponse</a> resource.</p>
     */
    inline DeleteMethodResponseRequest& WithRestApiId(Aws::String&& value) { SetRestApiId(value); return *this;}
     ...
     * <p>The <a>Resource</a> identifier for the <a>MethodResponse</a> resource.</p>
     */
    inline DeleteMethodResponseRequest& WithResourceId(Aws::String&& value) { SetResourceId(value); return *this;}
     ...
     * <p>The status code identifier for the <a>MethodResponse</a> resource.</p>
     */
    inline DeleteMethodResponseRequest& WithStatusCode(Aws::String&& value) { SetStatusCode(value); return *this;}
