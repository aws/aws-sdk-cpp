...
namespace Model
{
  ...
  public:
     ...
     * 8601 format</a>.</p>
     */
    inline UpdateStageResult& WithCreatedDate(double value) { SetCreatedDate(value); return *this;}
     ...
     * 8601 format</a>.</p>
     */
    inline UpdateStageResult& WithLastUpdatedDate(double value) { SetLastUpdatedDate(value); return *this;}
