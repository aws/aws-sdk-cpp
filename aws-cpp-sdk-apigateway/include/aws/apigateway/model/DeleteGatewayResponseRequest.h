...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APIGATEWAY_API DeleteGatewayResponseRequest : public APIGatewayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteGatewayResponseRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteGatewayResponseRequest>(GetServiceRequestName(), *this);
    }
