...
namespace Model
{
  ...
  public:
     ...
     * 8601 format</a>.</p>
     */
    inline ApiKey& WithCreatedDate(double value) { SetCreatedDate(value); return *this;}
     ...
     * <p>When the API Key was last updated, in ISO 8601 format.</p>
     */
    inline ApiKey& WithLastUpdatedDate(double value) { SetLastUpdatedDate(value); return *this;}
