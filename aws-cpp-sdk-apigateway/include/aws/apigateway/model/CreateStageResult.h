...
namespace Model
{
  ...
  public:
     ...
     * 8601 format</a>.</p>
     */
    inline CreateStageResult& WithCreatedDate(double value) { SetCreatedDate(value); return *this;}
     ...
     * 8601 format</a>.</p>
     */
    inline CreateStageResult& WithLastUpdatedDate(double value) { SetLastUpdatedDate(value); return *this;}
