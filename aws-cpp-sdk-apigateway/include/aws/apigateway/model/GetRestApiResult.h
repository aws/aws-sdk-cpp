...
namespace Model
{
  ...
  public:
    GetRestApiResult();
    GetRestApiResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetRestApiResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * Amazon API Gateway.</p>
     */
    inline GetRestApiResult& WithId(Aws::String&& value) { SetId(value); return *this;}
     ...
     * <p>The API's name.</p>
     */
    inline GetRestApiResult& WithName(Aws::String&& value) { SetName(value); return *this;}
     ...
     * <p>The API's description.</p>
     */
    inline GetRestApiResult& WithDescription(Aws::String&& value) { SetDescription(value); return *this;}
     ...
     * <p>A version identifier for the API.</p>
     */
    inline GetRestApiResult& WithVersion(Aws::String&& value) { SetVersion(value); return *this;}
     ...
     * the <a>RestApi</a> supports only UTF-8-encoded text payloads.</p>
     */
    inline GetRestApiResult& WithBinaryMediaTypes(Aws::Vector<Aws::String>&& value) { SetBinaryMediaTypes(value); return *this;}
     ...
     * the <a>RestApi</a> supports only UTF-8-encoded text payloads.</p>
     */
    inline GetRestApiResult& AddBinaryMediaTypes(Aws::String&& value) { m_binaryMediaTypes.push_back(value); return *this; }
