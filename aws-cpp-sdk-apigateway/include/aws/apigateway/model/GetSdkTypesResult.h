...
namespace Model
{
  ...
  public:
    ...
    inline GetSdkTypesResult& WithPosition(Aws::String&& value) { SetPosition(value); return *this;}
     ...
     * <a>SdkTypes</a> collection.</p>
     */
    inline void SetItems(Aws::Vector<SdkType>&& value) { m_items = value; }
     ...
     * <a>SdkTypes</a> collection.</p>
     */
    inline GetSdkTypesResult& WithItems(Aws::Vector<SdkType>&& value) { SetItems(value); return *this;}
     ...
     * <a>SdkTypes</a> collection.</p>
     */
    inline GetSdkTypesResult& AddItems(SdkType&& value) { m_items.push_back(value); return *this; }
