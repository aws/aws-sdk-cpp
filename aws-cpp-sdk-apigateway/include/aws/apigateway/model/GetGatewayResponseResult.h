...
namespace Model
{
  ...
  public:
    ...
    GetGatewayResponseResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetGatewayResponseResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
