...
namespace Model
{
  ...
  /**
   * <p>Requests Amazon API Gateway to get information about a <a>Deployment</a>
   * resource.</p>
   */
  ...
  public:
     ...
     * resource to get information about.</p>
     */
    inline GetDeploymentRequest& WithRestApiId(Aws::String&& value) { SetRestApiId(value); return *this;}
