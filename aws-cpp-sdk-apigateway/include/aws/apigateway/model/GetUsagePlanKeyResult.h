...
namespace Model
{
  ...
  public:
    ...
    GetUsagePlanKeyResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetUsagePlanKeyResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
