...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APIGATEWAY_API UpdateDeploymentRequest : public APIGatewayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDeploymentRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDeploymentRequest>(GetServiceRequestName(), *this);
    }
