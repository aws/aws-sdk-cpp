...
namespace Model
{
  ...
  public:
    ...
    GetDocumentationPartResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetDocumentationPartResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * the <code>DocumentationPart</code> is created.</p>
     */
    inline GetDocumentationPartResult& WithId(Aws::String&& value) { SetId(value); return *this;}
     ...
     * entities, unless overridden.</p>
     */
    inline GetDocumentationPartResult& WithLocation(DocumentationPartLocation&& value) { SetLocation(value); return *this;}
     ...
     * <code>x-amazon-apigateway-documentation</code>.</p>
     */
    inline GetDocumentationPartResult& WithProperties(Aws::String&& value) { SetProperties(value); return *this;}
