...
namespace Model
{
  ...
  public:
     ...
     * 8601 format</a>.</p>
     */
    inline UpdateApiKeyResult& WithCreatedDate(double value) { SetCreatedDate(value); return *this;}
     ...
     * <p>When the API Key was last updated, in ISO 8601 format.</p>
     */
    inline UpdateApiKeyResult& WithLastUpdatedDate(double value) { SetLastUpdatedDate(value); return *this;}
