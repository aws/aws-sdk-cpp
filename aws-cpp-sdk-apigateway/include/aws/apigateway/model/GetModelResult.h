...
namespace Model
{
   ...
   * and Mappings</a> </div>
   */
  class AWS_APIGATEWAY_API GetModelResult
  {
  public:
    GetModelResult();
    GetModelResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetModelResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p>The identifier for the model resource.</p>
     */
    inline GetModelResult& WithId(Aws::String&& value) { SetId(value); return *this;}
     ...
     * <p>The name of the model.</p>
     */
    inline GetModelResult& WithName(Aws::String&& value) { SetName(value); return *this;}
     ...
     * <p>The description of the model.</p>
     */
    inline GetModelResult& WithDescription(Aws::String&& value) { SetDescription(value); return *this;}
     ...
     * Gateway to fail.</p>
     */
    inline GetModelResult& WithSchema(Aws::String&& value) { SetSchema(value); return *this;}
     ...
     * <p>The content-type for the model.</p>
     */
    inline GetModelResult& WithContentType(Aws::String&& value) { SetContentType(value); return *this;}
