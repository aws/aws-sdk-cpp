...
namespace Model
{
   ...
   * <a>RestApi</a>.</p> <div class="remarks"> <p>In Swagger, the
   * <a>RequestValidators</a> of an API is defined by the <a
   * href="[[AwsDocsUrlPrefix]]/apigateway/latest/developerguide/api-gateway-swagger-extensions.html#api-gateway-swagger-extensions-request-validators.html">x-amazon-apigateway-request-validators</a>
