...
namespace Model
{
  ...
  public:
    ...
    GetRequestValidatorResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetRequestValidatorResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
