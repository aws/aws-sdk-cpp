...
namespace Model
{
  ...
  public:
     ...
     * Amazon API Gateway.</p>
     */
    inline UpdateRestApiResult& WithId(Aws::String&& value) { SetId(value); return *this;}
     ...
     * <p>The API's name.</p>
     */
    inline UpdateRestApiResult& WithName(Aws::String&& value) { SetName(value); return *this;}
     ...
     * <p>The API's description.</p>
     */
    inline UpdateRestApiResult& WithDescription(Aws::String&& value) { SetDescription(value); return *this;}
     ...
     * <p>The timestamp when the API was created.</p>
     */
    inline UpdateRestApiResult& WithCreatedDate(Aws::Utils::DateTime&& value) { SetCreatedDate(value); return *this;}
     ...
     * <p>A version identifier for the API.</p>
     */
    inline UpdateRestApiResult& WithVersion(Aws::String&& value) { SetVersion(value); return *this;}
     ...
     * during API import.</p>
     */
    inline UpdateRestApiResult& WithWarnings(Aws::Vector<Aws::String>&& value) { SetWarnings(value); return *this;}
     ...
     * during API import.</p>
     */
    inline UpdateRestApiResult& AddWarnings(Aws::String&& value) { m_warnings.push_back(value); return *this; }
     ...
     * the <a>RestApi</a> supports only UTF-8-encoded text payloads.</p>
     */
    inline UpdateRestApiResult& WithBinaryMediaTypes(Aws::Vector<Aws::String>&& value) { SetBinaryMediaTypes(value); return *this;}
     ...
     * the <a>RestApi</a> supports only UTF-8-encoded text payloads.</p>
     */
    inline UpdateRestApiResult& AddBinaryMediaTypes(Aws::String&& value) { m_binaryMediaTypes.push_back(value); return *this; }
