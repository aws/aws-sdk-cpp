...
namespace Model
{
  ...
  public:
    ...
    CreateRequestValidatorResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    CreateRequestValidatorResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
