...
namespace APIGateway
{
  ...
  class AWS_APIGATEWAY_API APIGatewayClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        APIGatewayClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::APIGatewayEndpointProvider> endpointProvider = Aws::MakeShared<APIGateway::Endpoint::APIGatewayEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::APIGatewayEndpointProvider> m_endpointProvider;
  };
