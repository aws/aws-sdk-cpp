...
using ResolveEndpointOutcome = Aws::APIGateway::Endpoint::APIGatewayEndpointProvider::APIGatewayResolveEndpointOutcome;
...
APIGatewayClient::APIGatewayClient(const Client::ClientConfiguration& clientConfiguration,
                                   std::shared_ptr<Endpoint::APIGatewayEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<APIGatewayErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<APIGateway::Endpoint::APIGatewayEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
