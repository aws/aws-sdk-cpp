...
GetApiKeyResult::GetApiKeyResult(const AmazonWebServiceResult<JsonValue>& result) : 
    m_enabled(false)
{
  *this = result;
}

GetApiKeyResult& GetApiKeyResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
