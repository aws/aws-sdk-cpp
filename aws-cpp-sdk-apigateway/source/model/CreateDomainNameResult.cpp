...
CreateDomainNameResult::CreateDomainNameResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateDomainNameResult& CreateDomainNameResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
