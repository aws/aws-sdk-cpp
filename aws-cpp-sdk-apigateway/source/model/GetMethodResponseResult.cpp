...
GetMethodResponseResult::GetMethodResponseResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetMethodResponseResult& GetMethodResponseResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
