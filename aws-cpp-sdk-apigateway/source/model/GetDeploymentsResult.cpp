...
GetDeploymentsResult::GetDeploymentsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetDeploymentsResult& GetDeploymentsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
