...
UpdateUsagePlanResult::UpdateUsagePlanResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateUsagePlanResult& UpdateUsagePlanResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
