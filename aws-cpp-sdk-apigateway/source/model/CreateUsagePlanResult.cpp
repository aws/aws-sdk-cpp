...
CreateUsagePlanResult::CreateUsagePlanResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateUsagePlanResult& CreateUsagePlanResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
