...
CreateResourceResult::CreateResourceResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateResourceResult& CreateResourceResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
