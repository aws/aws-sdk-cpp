...
GetSdkTypeResult::GetSdkTypeResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetSdkTypeResult& GetSdkTypeResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
