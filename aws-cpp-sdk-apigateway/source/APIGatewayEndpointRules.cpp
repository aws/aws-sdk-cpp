...
{
const size_t APIGatewayEndpointRules::RulesBlobStrLen = 3408;
const size_t APIGatewayEndpointRules::RulesBlobSize = 3409;

using RulesBlobT = Aws::Array<const char, APIGatewayEndpointRules::RulesBlobSize>;
...
't','t','p','s',':','/','/','a','p','i','g','a','t','e','w','a','y','-','f','i','p','s','.','{','R',
...
':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','i','g','a','t','e','w',
'a','y','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'"',':','[',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h',
't','t','p','s',':','/','/','a','p','i','g','a','t','e','w','a','y','.','{','R','e','g','i','o','n',
...
const char* APIGatewayEndpointRules::GetRulesBlob()
{
