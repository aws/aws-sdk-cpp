...
Aws::String APIGatewayEndpointRules::GetRulesAsString()
{
    return Aws::String(APIGatewayEndpointRules::Rules.begin(), APIGatewayEndpointRules::Rules.end());
}

const Aws::Vector<char> APIGatewayEndpointRules::Rules = {
