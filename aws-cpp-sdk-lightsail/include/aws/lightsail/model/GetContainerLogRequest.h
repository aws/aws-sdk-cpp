...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API GetContainerLogRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetContainerLogRequest> Clone() const
    {
      return Aws::MakeUnique<GetContainerLogRequest>(GetServiceRequestName(), *this);
    }
