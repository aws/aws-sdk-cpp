...
namespace Model
{
  class AWS_LIGHTSAIL_API DeleteInstanceResult
  {
  public:
    DeleteInstanceResult();
    DeleteInstanceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    DeleteInstanceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * delete instance request.</p>
     */
    inline DeleteInstanceResult& WithOperations(const Aws::Vector<Operation>& value) { SetOperations(value); return *this;}
     ...
     * delete instance request.</p>
     */
    inline DeleteInstanceResult& AddOperations(const Operation& value) { m_operations.push_back(value); return *this; }
