...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateRelationalDatabaseFromSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<CreateRelationalDatabaseFromSnapshotRequest>(GetServiceRequestName(), *this);
    }
