...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API GetDisksRequest : public LightsailRequest
  {
  public:
    GetDisksRequest();
    ...
    */
    virtual Aws::UniquePtr<GetDisksRequest> Clone() const
    {
      return Aws::MakeUnique<GetDisksRequest>(GetServiceRequestName(), *this);
    }
