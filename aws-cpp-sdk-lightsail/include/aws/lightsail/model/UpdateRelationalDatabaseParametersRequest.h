...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRelationalDatabaseParametersRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRelationalDatabaseParametersRequest>(GetServiceRequestName(), *this);
    }
