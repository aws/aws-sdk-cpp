...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API CreateContainerServiceDeploymentRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateContainerServiceDeploymentRequest> Clone() const
    {
      return Aws::MakeUnique<CreateContainerServiceDeploymentRequest>(GetServiceRequestName(), *this);
    }
