...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API CreateBucketAccessKeyRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateBucketAccessKeyRequest> Clone() const
    {
      return Aws::MakeUnique<CreateBucketAccessKeyRequest>(GetServiceRequestName(), *this);
    }
