...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AttachInstancesToLoadBalancerRequest> Clone() const
    {
      return Aws::MakeUnique<AttachInstancesToLoadBalancerRequest>(GetServiceRequestName(), *this);
    }
