...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API DeleteKeyPairRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteKeyPairRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteKeyPairRequest>(GetServiceRequestName(), *this);
    }
