...
namespace Model
{
  class AWS_LIGHTSAIL_API AttachStaticIpResult
  {
  public:
     ...
     * operations.</p>
     */
    inline AttachStaticIpResult& WithOperations(const Aws::Vector<Operation>& value) { SetOperations(value); return *this;}

    /**
     * <p>An array of key-value pairs containing information about your API
     * operations.</p>
     */
    inline AttachStaticIpResult& WithOperations(Aws::Vector<Operation>&& value) { SetOperations(value); return *this;}

    /**
     * <p>An array of key-value pairs containing information about your API
     * operations.</p>
     */
    inline AttachStaticIpResult& AddOperations(const Operation& value) { m_operations.push_back(value); return *this; }

    /**
     * <p>An array of key-value pairs containing information about your API
     * operations.</p>
     */
    inline AttachStaticIpResult& AddOperations(Operation&& value) { m_operations.push_back(value); return *this; }
