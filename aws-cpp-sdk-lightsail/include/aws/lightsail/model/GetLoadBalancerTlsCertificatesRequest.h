...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API GetLoadBalancerTlsCertificatesRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetLoadBalancerTlsCertificatesRequest> Clone() const
    {
      return Aws::MakeUnique<GetLoadBalancerTlsCertificatesRequest>(GetServiceRequestName(), *this);
    }
