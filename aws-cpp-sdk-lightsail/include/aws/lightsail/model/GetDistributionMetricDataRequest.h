...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API GetDistributionMetricDataRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDistributionMetricDataRequest> Clone() const
    {
      return Aws::MakeUnique<GetDistributionMetricDataRequest>(GetServiceRequestName(), *this);
    }
