...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API PutAlarmRequest : public LightsailRequest
  {
  public:
    PutAlarmRequest();
    ...
    */
    virtual Aws::UniquePtr<PutAlarmRequest> Clone() const
    {
      return Aws::MakeUnique<PutAlarmRequest>(GetServiceRequestName(), *this);
    }
