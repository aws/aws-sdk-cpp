...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AttachLoadBalancerTlsCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<AttachLoadBalancerTlsCertificateRequest>(GetServiceRequestName(), *this);
    }
