...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API DeleteContactMethodRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteContactMethodRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteContactMethodRequest>(GetServiceRequestName(), *this);
    }
