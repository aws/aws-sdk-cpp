...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API RegisterContainerImageRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterContainerImageRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterContainerImageRequest>(GetServiceRequestName(), *this);
    }
