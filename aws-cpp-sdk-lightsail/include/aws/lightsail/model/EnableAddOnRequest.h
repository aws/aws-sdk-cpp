...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API EnableAddOnRequest : public LightsailRequest
  {
  public:
    EnableAddOnRequest();
    ...
    */
    virtual Aws::UniquePtr<EnableAddOnRequest> Clone() const
    {
      return Aws::MakeUnique<EnableAddOnRequest>(GetServiceRequestName(), *this);
    }
