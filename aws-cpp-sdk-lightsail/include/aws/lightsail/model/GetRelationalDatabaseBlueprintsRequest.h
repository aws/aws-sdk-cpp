...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API GetRelationalDatabaseBlueprintsRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRelationalDatabaseBlueprintsRequest> Clone() const
    {
      return Aws::MakeUnique<GetRelationalDatabaseBlueprintsRequest>(GetServiceRequestName(), *this);
    }
