...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_LIGHTSAIL_API R53HostedZoneDeletionState
  {
  public:
    R53HostedZoneDeletionState();
    R53HostedZoneDeletionState(Aws::Utils::Json::JsonView jsonValue);
    R53HostedZoneDeletionState& operator=(Aws::Utils::Json::JsonView jsonValue);
