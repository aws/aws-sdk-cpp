...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API GetBucketAccessKeysRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketAccessKeysRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketAccessKeysRequest>(GetServiceRequestName(), *this);
    }
