...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLoadBalancerTlsCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLoadBalancerTlsCertificateRequest>(GetServiceRequestName(), *this);
    }
