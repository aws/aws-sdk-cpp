...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API DetachDiskRequest : public LightsailRequest
  {
  public:
    DetachDiskRequest();
    ...
    */
    virtual Aws::UniquePtr<DetachDiskRequest> Clone() const
    {
      return Aws::MakeUnique<DetachDiskRequest>(GetServiceRequestName(), *this);
    }
