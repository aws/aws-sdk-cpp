...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API GetBucketsRequest : public LightsailRequest
  {
  public:
    GetBucketsRequest();
    ...
    */
    virtual Aws::UniquePtr<GetBucketsRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketsRequest>(GetServiceRequestName(), *this);
    }
