...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDistributionLatestCacheResetRequest> Clone() const
    {
      return Aws::MakeUnique<GetDistributionLatestCacheResetRequest>(GetServiceRequestName(), *this);
    }
