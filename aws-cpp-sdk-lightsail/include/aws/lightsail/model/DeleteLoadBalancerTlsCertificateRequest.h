...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLoadBalancerTlsCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLoadBalancerTlsCertificateRequest>(GetServiceRequestName(), *this);
    }
