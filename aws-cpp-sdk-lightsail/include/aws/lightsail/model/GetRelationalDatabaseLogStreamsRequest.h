...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRelationalDatabaseLogStreamsRequest> Clone() const
    {
      return Aws::MakeUnique<GetRelationalDatabaseLogStreamsRequest>(GetServiceRequestName(), *this);
    }
