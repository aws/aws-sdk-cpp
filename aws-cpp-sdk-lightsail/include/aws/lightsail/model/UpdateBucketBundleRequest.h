...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API UpdateBucketBundleRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateBucketBundleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateBucketBundleRequest>(GetServiceRequestName(), *this);
    }
