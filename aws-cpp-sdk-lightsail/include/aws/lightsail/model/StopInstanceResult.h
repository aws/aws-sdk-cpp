...
namespace Model
{
  class AWS_LIGHTSAIL_API StopInstanceResult
  {
  public:
    StopInstanceResult();
     ...
     * operation.</p>
     */
    inline StopInstanceResult& WithOperations(Aws::Vector<Operation>&& value) { SetOperations(value); return *this;}
     ...
     * operation.</p>
     */
    inline StopInstanceResult& AddOperations(Operation&& value) { m_operations.push_back(value); return *this; }
