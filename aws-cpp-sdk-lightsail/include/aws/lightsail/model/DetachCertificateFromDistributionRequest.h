...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API DetachCertificateFromDistributionRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DetachCertificateFromDistributionRequest> Clone() const
    {
      return Aws::MakeUnique<DetachCertificateFromDistributionRequest>(GetServiceRequestName(), *this);
    }
