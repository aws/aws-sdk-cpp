...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCloudFormationStackRecordsRequest> Clone() const
    {
      return Aws::MakeUnique<GetCloudFormationStackRecordsRequest>(GetServiceRequestName(), *this);
    }
