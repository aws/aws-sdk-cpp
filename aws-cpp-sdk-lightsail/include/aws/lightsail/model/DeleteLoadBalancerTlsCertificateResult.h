...
namespace Model
{
  ...
  public:
     ...
     * <p>An object describing the API operations.</p>
     */
    inline DeleteLoadBalancerTlsCertificateResult& WithOperations(const Aws::Vector<Operation>& value) { SetOperations(value); return *this;}

    /**
     * <p>An object describing the API operations.</p>
     */
    inline DeleteLoadBalancerTlsCertificateResult& WithOperations(Aws::Vector<Operation>&& value) { SetOperations(std::move(value)); return *this;}

    /**
     * <p>An object describing the API operations.</p>
     */
    inline DeleteLoadBalancerTlsCertificateResult& AddOperations(const Operation& value) { m_operations.push_back(value); return *this; }

    /**
     * <p>An object describing the API operations.</p>
     */
    inline DeleteLoadBalancerTlsCertificateResult& AddOperations(Operation&& value) { m_operations.push_back(std::move(value)); return *this; }
