...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API UpdateDistributionBundleRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDistributionBundleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDistributionBundleRequest>(GetServiceRequestName(), *this);
    }
