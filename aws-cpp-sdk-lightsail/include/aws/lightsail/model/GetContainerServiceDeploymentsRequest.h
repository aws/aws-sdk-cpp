...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetContainerServiceDeploymentsRequest> Clone() const
    {
      return Aws::MakeUnique<GetContainerServiceDeploymentsRequest>(GetServiceRequestName(), *this);
    }
