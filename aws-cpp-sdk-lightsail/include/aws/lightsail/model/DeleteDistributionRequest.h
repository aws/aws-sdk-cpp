...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API DeleteDistributionRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDistributionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDistributionRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>The name of the distribution to delete.</p> <p>Use the
