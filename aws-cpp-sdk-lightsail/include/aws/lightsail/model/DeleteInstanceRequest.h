...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API DeleteInstanceRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteInstanceRequest>(GetServiceRequestName(), *this);
    }
