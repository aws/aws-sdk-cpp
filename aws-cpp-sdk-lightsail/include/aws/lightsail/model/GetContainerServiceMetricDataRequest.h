...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API GetContainerServiceMetricDataRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetContainerServiceMetricDataRequest> Clone() const
    {
      return Aws::MakeUnique<GetContainerServiceMetricDataRequest>(GetServiceRequestName(), *this);
    }
