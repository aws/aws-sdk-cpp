...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API DeleteBucketRequest : public LightsailRequest
  {
  public:
    DeleteBucketRequest();
    ...
    /**
     * <p>The name of the bucket to delete.</p> <p>Use the <a>GetBuckets</a> action to
     * get a list of bucket names that you can specify.</p>
     */
     ...
     * has instances that were granted access to it using the
     * <a>SetResourceAccessForBucket</a> action.</p> </li> <li> <p>The bucket has
     * objects.</p> </li> <li> <p>The bucket has access keys.</p> </li> </ul>
     *  <p>Force deleting a bucket might impact other resources that rely on
     * the bucket, such as instances, distributions, or software that use the issued
     * access keys.</p> 
     */
