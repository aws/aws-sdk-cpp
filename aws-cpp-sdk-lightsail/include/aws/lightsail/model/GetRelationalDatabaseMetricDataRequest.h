...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRelationalDatabaseMetricDataRequest> Clone() const
    {
      return Aws::MakeUnique<GetRelationalDatabaseMetricDataRequest>(GetServiceRequestName(), *this);
    }
