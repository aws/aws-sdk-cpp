...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DetachInstancesFromLoadBalancerRequest> Clone() const
    {
      return Aws::MakeUnique<DetachInstancesFromLoadBalancerRequest>(GetServiceRequestName(), *this);
    }
