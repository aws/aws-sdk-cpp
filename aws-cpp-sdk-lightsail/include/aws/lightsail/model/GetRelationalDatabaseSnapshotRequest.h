...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRelationalDatabaseSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<GetRelationalDatabaseSnapshotRequest>(GetServiceRequestName(), *this);
    }
