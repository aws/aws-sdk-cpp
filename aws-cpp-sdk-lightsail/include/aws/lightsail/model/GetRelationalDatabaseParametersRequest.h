...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRelationalDatabaseParametersRequest> Clone() const
    {
      return Aws::MakeUnique<GetRelationalDatabaseParametersRequest>(GetServiceRequestName(), *this);
    }
