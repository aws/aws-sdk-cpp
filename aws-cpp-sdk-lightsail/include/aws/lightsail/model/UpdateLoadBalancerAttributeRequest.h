...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateLoadBalancerAttributeRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLoadBalancerAttributeRequest>(GetServiceRequestName(), *this);
    }
