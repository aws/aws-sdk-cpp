...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRelationalDatabaseLogEventsRequest> Clone() const
    {
      return Aws::MakeUnique<GetRelationalDatabaseLogEventsRequest>(GetServiceRequestName(), *this);
    }
