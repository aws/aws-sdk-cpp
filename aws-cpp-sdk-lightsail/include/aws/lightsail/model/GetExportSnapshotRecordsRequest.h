...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API GetExportSnapshotRecordsRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetExportSnapshotRecordsRequest> Clone() const
    {
      return Aws::MakeUnique<GetExportSnapshotRecordsRequest>(GetServiceRequestName(), *this);
    }
