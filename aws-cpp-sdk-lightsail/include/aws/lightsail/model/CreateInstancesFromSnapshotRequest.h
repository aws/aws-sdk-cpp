...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateInstancesFromSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<CreateInstancesFromSnapshotRequest>(GetServiceRequestName(), *this);
    }
