...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API DeleteBucketAccessKeyRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBucketAccessKeyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBucketAccessKeyRequest>(GetServiceRequestName(), *this);
    }
