...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API DisableAddOnRequest : public LightsailRequest
  {
  public:
    DisableAddOnRequest();
    ...
    */
    virtual Aws::UniquePtr<DisableAddOnRequest> Clone() const
    {
      return Aws::MakeUnique<DisableAddOnRequest>(GetServiceRequestName(), *this);
    }
