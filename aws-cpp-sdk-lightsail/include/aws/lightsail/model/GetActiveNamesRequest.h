...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetActiveNamesRequest> Clone() const
    {
      return Aws::MakeUnique<GetActiveNamesRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetActiveNames"; }
     ...
     * get a page token, perform an initial <code>GetActiveNames</code> request. If
