...
namespace Model
{
  ...
  public:
     ...
     * <p>An object containing information about the API operations.</p>
     */
    inline CreateLoadBalancerTlsCertificateResult& WithOperations(const Aws::Vector<Operation>& value) { SetOperations(value); return *this;}

    /**
     * <p>An object containing information about the API operations.</p>
     */
    inline CreateLoadBalancerTlsCertificateResult& WithOperations(Aws::Vector<Operation>&& value) { SetOperations(std::move(value)); return *this;}

    /**
     * <p>An object containing information about the API operations.</p>
     */
    inline CreateLoadBalancerTlsCertificateResult& AddOperations(const Operation& value) { m_operations.push_back(value); return *this; }

    /**
     * <p>An object containing information about the API operations.</p>
     */
    inline CreateLoadBalancerTlsCertificateResult& AddOperations(Operation&& value) { m_operations.push_back(std::move(value)); return *this; }
