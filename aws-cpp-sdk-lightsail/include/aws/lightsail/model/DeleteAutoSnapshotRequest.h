...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API DeleteAutoSnapshotRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAutoSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAutoSnapshotRequest>(GetServiceRequestName(), *this);
    }
