...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API GetBucketMetricDataRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketMetricDataRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketMetricDataRequest>(GetServiceRequestName(), *this);
    }
