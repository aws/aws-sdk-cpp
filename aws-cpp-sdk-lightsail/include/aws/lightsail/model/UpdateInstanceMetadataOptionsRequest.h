...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API UpdateInstanceMetadataOptionsRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateInstanceMetadataOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateInstanceMetadataOptionsRequest>(GetServiceRequestName(), *this);
    }
