...
namespace Model
{
  ...
  public:
     ...
     * operation.</p>
     */
    inline UpdateDomainEntryResult& WithOperations(const Aws::Vector<Operation>& value) { SetOperations(value); return *this;}

    /**
     * <p>An array of key-value pairs containing information about the request
     * operation.</p>
     */
    inline UpdateDomainEntryResult& WithOperations(Aws::Vector<Operation>&& value) { SetOperations(value); return *this;}

    /**
     * <p>An array of key-value pairs containing information about the request
     * operation.</p>
     */
    inline UpdateDomainEntryResult& AddOperations(const Operation& value) { m_operations.push_back(value); return *this; }

    /**
     * <p>An array of key-value pairs containing information about the request
     * operation.</p>
     */
    inline UpdateDomainEntryResult& AddOperations(Operation&& value) { m_operations.push_back(value); return *this; }
