...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRelationalDatabaseBundlesRequest> Clone() const
    {
      return Aws::MakeUnique<GetRelationalDatabaseBundlesRequest>(GetServiceRequestName(), *this);
    }
