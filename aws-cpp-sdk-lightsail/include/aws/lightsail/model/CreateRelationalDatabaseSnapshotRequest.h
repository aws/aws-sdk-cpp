...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateRelationalDatabaseSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<CreateRelationalDatabaseSnapshotRequest>(GetServiceRequestName(), *this);
    }
