...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API CreateCertificateRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCertificateRequest>(GetServiceRequestName(), *this);
    }
