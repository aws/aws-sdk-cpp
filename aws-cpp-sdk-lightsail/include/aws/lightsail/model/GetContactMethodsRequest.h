...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API GetContactMethodsRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetContactMethodsRequest> Clone() const
    {
      return Aws::MakeUnique<GetContactMethodsRequest>(GetServiceRequestName(), *this);
    }
