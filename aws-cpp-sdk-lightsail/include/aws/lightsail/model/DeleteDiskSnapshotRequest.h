...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API DeleteDiskSnapshotRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDiskSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDiskSnapshotRequest>(GetServiceRequestName(), *this);
    }
