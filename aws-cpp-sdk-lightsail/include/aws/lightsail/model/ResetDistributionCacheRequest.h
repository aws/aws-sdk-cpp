...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API ResetDistributionCacheRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ResetDistributionCacheRequest> Clone() const
    {
      return Aws::MakeUnique<ResetDistributionCacheRequest>(GetServiceRequestName(), *this);
    }
