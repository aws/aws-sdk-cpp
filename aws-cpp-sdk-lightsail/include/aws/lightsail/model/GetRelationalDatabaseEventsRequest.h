...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRelationalDatabaseEventsRequest> Clone() const
    {
      return Aws::MakeUnique<GetRelationalDatabaseEventsRequest>(GetServiceRequestName(), *this);
    }
