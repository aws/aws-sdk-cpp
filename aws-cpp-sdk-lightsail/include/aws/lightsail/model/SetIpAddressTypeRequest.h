...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API SetIpAddressTypeRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SetIpAddressTypeRequest> Clone() const
    {
      return Aws::MakeUnique<SetIpAddressTypeRequest>(GetServiceRequestName(), *this);
    }
