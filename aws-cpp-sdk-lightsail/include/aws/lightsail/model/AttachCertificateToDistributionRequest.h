...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AttachCertificateToDistributionRequest> Clone() const
    {
      return Aws::MakeUnique<AttachCertificateToDistributionRequest>(GetServiceRequestName(), *this);
    }
