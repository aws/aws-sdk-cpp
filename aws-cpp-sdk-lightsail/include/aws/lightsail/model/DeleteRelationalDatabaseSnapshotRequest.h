...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRelationalDatabaseSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRelationalDatabaseSnapshotRequest>(GetServiceRequestName(), *this);
    }
