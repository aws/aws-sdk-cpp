...
namespace Model
{
  ...
  public:
     ...
     * operation.</p>
     */
    inline StartInstanceResult& WithOperations(Aws::Vector<Operation>&& value) { SetOperations(value); return *this;}
     ...
     * operation.</p>
     */
    inline StartInstanceResult& AddOperations(Operation&& value) { m_operations.push_back(value); return *this; }
