...
namespace Model
{
  class AWS_LIGHTSAIL_API CloseInstancePublicPortsResult
  {
  public:
     ...
     * operation.</p>
     */
    inline CloseInstancePublicPortsResult& WithOperation(Operation&& value) { SetOperation(value); return *this;}
