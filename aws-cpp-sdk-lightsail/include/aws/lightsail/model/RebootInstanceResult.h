...
namespace Model
{
  ...
  public:
    ...
    RebootInstanceResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    RebootInstanceResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * operation.</p>
     */
    inline RebootInstanceResult& WithOperations(Aws::Vector<Operation>&& value) { SetOperations(value); return *this;}
     ...
     * operation.</p>
     */
    inline RebootInstanceResult& AddOperations(Operation&& value) { m_operations.push_back(value); return *this; }
