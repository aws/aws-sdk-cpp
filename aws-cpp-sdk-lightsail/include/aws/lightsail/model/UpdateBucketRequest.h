...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API UpdateBucketRequest : public LightsailRequest
  {
  public:
    UpdateBucketRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateBucketRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateBucketRequest>(GetServiceRequestName(), *this);
    }
