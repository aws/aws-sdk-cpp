...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API CreateDistributionRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDistributionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDistributionRequest>(GetServiceRequestName(), *this);
    }
