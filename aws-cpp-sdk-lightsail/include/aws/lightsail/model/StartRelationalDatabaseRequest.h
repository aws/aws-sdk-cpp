...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API StartRelationalDatabaseRequest : public LightsailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartRelationalDatabaseRequest> Clone() const
    {
      return Aws::MakeUnique<StartRelationalDatabaseRequest>(GetServiceRequestName(), *this);
    }
