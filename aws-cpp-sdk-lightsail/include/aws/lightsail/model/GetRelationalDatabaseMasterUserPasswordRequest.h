...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRelationalDatabaseMasterUserPasswordRequest> Clone() const
    {
      return Aws::MakeUnique<GetRelationalDatabaseMasterUserPasswordRequest>(GetServiceRequestName(), *this);
    }
