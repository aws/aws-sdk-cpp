...
namespace Model
{
  ...
  /**
   */
  class AWS_LIGHTSAIL_API CreateBucketRequest : public LightsailRequest
  {
  public:
    CreateBucketRequest();
     ...
     * <p>Use the <a>GetBucketBundles</a> action to get a list of bundle IDs that you
     * can specify.</p> <p>Use the <a>UpdateBucketBundle</a> action to change the
