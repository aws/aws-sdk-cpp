...
namespace Lightsail
{
  ...
  class AWS_LIGHTSAIL_API LightsailClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        LightsailClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::LightsailEndpointProvider> endpointProvider = Aws::MakeShared<Lightsail::Endpoint::LightsailEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::LightsailEndpointProvider> m_endpointProvider;
  };
