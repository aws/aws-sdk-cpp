...
GetInstancesResult::GetInstancesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetInstancesResult& GetInstancesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
