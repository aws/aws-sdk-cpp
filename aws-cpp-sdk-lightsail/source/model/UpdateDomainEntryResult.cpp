...
UpdateDomainEntryResult::UpdateDomainEntryResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateDomainEntryResult& UpdateDomainEntryResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
