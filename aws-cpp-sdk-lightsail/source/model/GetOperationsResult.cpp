...
GetOperationsResult::GetOperationsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetOperationsResult& GetOperationsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
