...
UpdateRelationalDatabaseParametersResult::UpdateRelationalDatabaseParametersResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateRelationalDatabaseParametersResult& UpdateRelationalDatabaseParametersResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
