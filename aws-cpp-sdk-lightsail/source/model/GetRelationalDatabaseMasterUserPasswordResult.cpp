...
GetRelationalDatabaseMasterUserPasswordResult& GetRelationalDatabaseMasterUserPasswordResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
