...
DeleteBucketAccessKeyResult::DeleteBucketAccessKeyResult()
{
}

DeleteBucketAccessKeyResult::DeleteBucketAccessKeyResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
