...
SendContactMethodVerificationResult::SendContactMethodVerificationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

SendContactMethodVerificationResult& SendContactMethodVerificationResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
