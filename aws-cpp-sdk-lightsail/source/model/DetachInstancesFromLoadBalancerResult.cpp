...
DetachInstancesFromLoadBalancerResult::DetachInstancesFromLoadBalancerResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DetachInstancesFromLoadBalancerResult& DetachInstancesFromLoadBalancerResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
