...
using ResolveEndpointOutcome = Aws::Lightsail::Endpoint::LightsailEndpointProvider::LightsailResolveEndpointOutcome;
...
LightsailClient::LightsailClient(const Client::ClientConfiguration& clientConfiguration,
                                 std::shared_ptr<Endpoint::LightsailEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<LightsailErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Lightsail::Endpoint::LightsailEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
