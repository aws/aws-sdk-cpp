...
Aws::String LightsailEndpointRules::GetRulesAsString()
{
    return Aws::String(LightsailEndpointRules::Rules.begin(), LightsailEndpointRules::Rules.end());
}

const Aws::Vector<char> LightsailEndpointRules::Rules = {
...
':','/','/','l','i','g','h','t','s','a','i','l','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'r','u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',',
'"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':',
'/','/','l','i','g','h','t','s','a','i','l','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
