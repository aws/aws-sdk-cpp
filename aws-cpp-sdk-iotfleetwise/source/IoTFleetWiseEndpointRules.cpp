...
Aws::String IoTFleetWiseEndpointRules::GetRulesAsString()
{
    return Aws::String(IoTFleetWiseEndpointRules::Rules.begin(), IoTFleetWiseEndpointRules::Rules.end());
}

const Aws::Vector<char> IoTFleetWiseEndpointRules::Rules = {
...
't','p','s',':','/','/','i','o','t','f','l','e','e','t','w','i','s','e','-','f','i','p','s','.','{',
...
'i','o','t','f','l','e','e','t','w','i','s','e','.','{','R','e','g','i','o','n','}','.','{','P','a',
