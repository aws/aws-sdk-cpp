...
BatchCreateVehicleResult::BatchCreateVehicleResult()
{
}

BatchCreateVehicleResult::BatchCreateVehicleResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

BatchCreateVehicleResult& BatchCreateVehicleResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
