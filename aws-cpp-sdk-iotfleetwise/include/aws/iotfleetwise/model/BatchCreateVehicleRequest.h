...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API BatchCreateVehicleRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchCreateVehicleRequest> Clone() const
    {
      return Aws::MakeUnique<BatchCreateVehicleRequest>(GetServiceRequestName(), *this);
    }
