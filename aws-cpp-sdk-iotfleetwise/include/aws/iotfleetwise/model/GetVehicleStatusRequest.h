...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API GetVehicleStatusRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetVehicleStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetVehicleStatusRequest>(GetServiceRequestName(), *this);
    }
