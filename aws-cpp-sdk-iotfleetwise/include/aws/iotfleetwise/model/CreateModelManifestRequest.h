...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API CreateModelManifestRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateModelManifestRequest> Clone() const
    {
      return Aws::MakeUnique<CreateModelManifestRequest>(GetServiceRequestName(), *this);
    }
