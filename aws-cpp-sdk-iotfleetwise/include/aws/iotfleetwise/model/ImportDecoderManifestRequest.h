...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API ImportDecoderManifestRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ImportDecoderManifestRequest> Clone() const
    {
      return Aws::MakeUnique<ImportDecoderManifestRequest>(GetServiceRequestName(), *this);
    }
