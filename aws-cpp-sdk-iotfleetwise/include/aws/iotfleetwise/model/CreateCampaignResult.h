...
namespace Model
{
  class AWS_IOTFLEETWISE_API CreateCampaignResult
  {
  public:
     ...
     * <p>The name of the created campaign.</p>
     */
    inline CreateCampaignResult& WithName(const Aws::String& value) { SetName(value); return *this;}

    /**
     * <p>The name of the created campaign.</p>
     */
    inline CreateCampaignResult& WithName(Aws::String&& value) { SetName(std::move(value)); return *this;}

    /**
     * <p>The name of the created campaign.</p>
     */
    inline CreateCampaignResult& WithName(const char* value) { SetName(value); return *this;}
