...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_IOTFLEETWISE_API SignalInformation
  {
  public:
    SignalInformation();
    SignalInformation(Aws::Utils::Json::JsonView jsonValue);
    SignalInformation& operator=(Aws::Utils::Json::JsonView jsonValue);
