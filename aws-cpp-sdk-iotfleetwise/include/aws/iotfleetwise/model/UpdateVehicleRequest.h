...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API UpdateVehicleRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateVehicleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateVehicleRequest>(GetServiceRequestName(), *this);
    }
