...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_IOTFLEETWISE_API CreateVehicleError
  {
  public:
    CreateVehicleError();
    CreateVehicleError(Aws::Utils::Json::JsonView jsonValue);
    CreateVehicleError& operator=(Aws::Utils::Json::JsonView jsonValue);
