...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API ListModelManifestNodesRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListModelManifestNodesRequest> Clone() const
    {
      return Aws::MakeUnique<ListModelManifestNodesRequest>(GetServiceRequestName(), *this);
    }
