...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API ListDecoderManifestsRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDecoderManifestsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDecoderManifestsRequest>(GetServiceRequestName(), *this);
    }
