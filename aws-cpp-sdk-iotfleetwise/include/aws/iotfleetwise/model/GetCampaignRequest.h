...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API GetCampaignRequest : public IoTFleetWiseRequest
  {
  public:
    GetCampaignRequest();
    ...
    */
    virtual Aws::UniquePtr<GetCampaignRequest> Clone() const
    {
      return Aws::MakeUnique<GetCampaignRequest>(GetServiceRequestName(), *this);
    }
