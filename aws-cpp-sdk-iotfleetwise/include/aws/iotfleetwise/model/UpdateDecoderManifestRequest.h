...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API UpdateDecoderManifestRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDecoderManifestRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDecoderManifestRequest>(GetServiceRequestName(), *this);
    }
