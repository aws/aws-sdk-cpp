...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API ListModelManifestsRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListModelManifestsRequest> Clone() const
    {
      return Aws::MakeUnique<ListModelManifestsRequest>(GetServiceRequestName(), *this);
    }
