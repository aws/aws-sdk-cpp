...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API BatchUpdateVehicleRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchUpdateVehicleRequest> Clone() const
    {
      return Aws::MakeUnique<BatchUpdateVehicleRequest>(GetServiceRequestName(), *this);
    }
