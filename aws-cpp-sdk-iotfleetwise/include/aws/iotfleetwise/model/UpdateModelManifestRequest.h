...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API UpdateModelManifestRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateModelManifestRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateModelManifestRequest>(GetServiceRequestName(), *this);
    }
