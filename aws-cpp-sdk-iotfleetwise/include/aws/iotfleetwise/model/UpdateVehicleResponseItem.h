...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_IOTFLEETWISE_API UpdateVehicleResponseItem
  {
  public:
    UpdateVehicleResponseItem();
    UpdateVehicleResponseItem(Aws::Utils::Json::JsonView jsonValue);
    UpdateVehicleResponseItem& operator=(Aws::Utils::Json::JsonView jsonValue);
