...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API DisassociateVehicleFleetRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateVehicleFleetRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateVehicleFleetRequest>(GetServiceRequestName(), *this);
    }
