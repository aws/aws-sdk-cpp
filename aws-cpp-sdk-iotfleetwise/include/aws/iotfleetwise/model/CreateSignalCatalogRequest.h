...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API CreateSignalCatalogRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSignalCatalogRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSignalCatalogRequest>(GetServiceRequestName(), *this);
    }
