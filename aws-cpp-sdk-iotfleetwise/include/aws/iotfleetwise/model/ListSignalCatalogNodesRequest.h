...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API ListSignalCatalogNodesRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSignalCatalogNodesRequest> Clone() const
    {
      return Aws::MakeUnique<ListSignalCatalogNodesRequest>(GetServiceRequestName(), *this);
    }
