...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API DeleteVehicleRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVehicleRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVehicleRequest>(GetServiceRequestName(), *this);
    }
