...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API CreateDecoderManifestRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDecoderManifestRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDecoderManifestRequest>(GetServiceRequestName(), *this);
    }
