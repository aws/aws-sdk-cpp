...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API ListVehiclesRequest : public IoTFleetWiseRequest
  {
  public:
    ListVehiclesRequest();
    ...
    */
    virtual Aws::UniquePtr<ListVehiclesRequest> Clone() const
    {
      return Aws::MakeUnique<ListVehiclesRequest>(GetServiceRequestName(), *this);
    }
