...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API UpdateFleetRequest : public IoTFleetWiseRequest
  {
  public:
    UpdateFleetRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateFleetRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFleetRequest>(GetServiceRequestName(), *this);
    }
