...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API ListCampaignsRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCampaignsRequest> Clone() const
    {
      return Aws::MakeUnique<ListCampaignsRequest>(GetServiceRequestName(), *this);
    }
