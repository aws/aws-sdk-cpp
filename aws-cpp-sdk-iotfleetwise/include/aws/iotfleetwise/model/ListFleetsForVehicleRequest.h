...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API ListFleetsForVehicleRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFleetsForVehicleRequest> Clone() const
    {
      return Aws::MakeUnique<ListFleetsForVehicleRequest>(GetServiceRequestName(), *this);
    }
