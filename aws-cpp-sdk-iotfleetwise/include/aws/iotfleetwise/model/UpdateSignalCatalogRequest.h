...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API UpdateSignalCatalogRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSignalCatalogRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSignalCatalogRequest>(GetServiceRequestName(), *this);
    }
