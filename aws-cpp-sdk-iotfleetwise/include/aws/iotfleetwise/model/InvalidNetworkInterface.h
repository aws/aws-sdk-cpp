...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_IOTFLEETWISE_API InvalidNetworkInterface
  {
  public:
    InvalidNetworkInterface();
    InvalidNetworkInterface(Aws::Utils::Json::JsonView jsonValue);
    InvalidNetworkInterface& operator=(Aws::Utils::Json::JsonView jsonValue);
