...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API ImportSignalCatalogRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ImportSignalCatalogRequest> Clone() const
    {
      return Aws::MakeUnique<ImportSignalCatalogRequest>(GetServiceRequestName(), *this);
    }
