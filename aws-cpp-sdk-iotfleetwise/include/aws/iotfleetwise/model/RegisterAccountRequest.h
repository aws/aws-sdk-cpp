...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API RegisterAccountRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterAccountRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterAccountRequest>(GetServiceRequestName(), *this);
    }
