...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTFLEETWISE_API UpdateCampaignRequest : public IoTFleetWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCampaignRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCampaignRequest>(GetServiceRequestName(), *this);
    }
