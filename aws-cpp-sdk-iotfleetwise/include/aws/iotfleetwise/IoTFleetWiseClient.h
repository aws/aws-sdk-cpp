...
namespace IoTFleetWise
{
  ...
  class AWS_IOTFLEETWISE_API IoTFleetWiseClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IoTFleetWiseClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::IoTFleetWiseEndpointProvider> endpointProvider = Aws::MakeShared<IoTFleetWise::Endpoint::IoTFleetWiseEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IoTFleetWiseEndpointProvider> m_endpointProvider;
  };
