...
Aws::String PrometheusServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(PrometheusServiceEndpointRules::Rules.begin(), PrometheusServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> PrometheusServiceEndpointRules::Rules = {
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','s','.','{','R','e','g','i','o','n',
