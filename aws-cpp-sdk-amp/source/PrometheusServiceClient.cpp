...
{
  AWS_MAKE_CALLABLE_OPERATION(CreateAlertManagerDefinition, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(CreateAlertManagerDefinition, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(CreateRuleGroupsNamespace, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(CreateRuleGroupsNamespace, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DeleteAlertManagerDefinition, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DeleteAlertManagerDefinition, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DeleteRuleGroupsNamespace, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DeleteRuleGroupsNamespace, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DescribeAlertManagerDefinition, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DescribeAlertManagerDefinition, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DescribeRuleGroupsNamespace, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DescribeRuleGroupsNamespace, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListRuleGroupsNamespaces, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListRuleGroupsNamespaces, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(PutAlertManagerDefinition, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(PutAlertManagerDefinition, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(PutRuleGroupsNamespace, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(PutRuleGroupsNamespace, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(UpdateWorkspaceAlias, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(UpdateWorkspaceAlias, request, handler, context, m_executor.get());
}
