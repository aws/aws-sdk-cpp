...
using ResolveEndpointOutcome = Aws::PrometheusService::Endpoint::PrometheusServiceEndpointProvider::PrometheusServiceResolveEndpointOutcome;
...
PrometheusServiceClient::PrometheusServiceClient(const Client::ClientConfiguration& clientConfiguration,
                                                 std::shared_ptr<Endpoint::PrometheusServiceEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<PrometheusServiceErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<PrometheusService::Endpoint::PrometheusServiceEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
