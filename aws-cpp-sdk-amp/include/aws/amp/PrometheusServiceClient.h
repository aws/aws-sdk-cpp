...
namespace PrometheusService
{
  ...
  class AWS_PROMETHEUSSERVICE_API PrometheusServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        PrometheusServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                std::shared_ptr<Endpoint::PrometheusServiceEndpointProvider> endpointProvider = Aws::MakeShared<PrometheusService::Endpoint::PrometheusServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::PrometheusServiceEndpointProvider> m_endpointProvider;
  };
