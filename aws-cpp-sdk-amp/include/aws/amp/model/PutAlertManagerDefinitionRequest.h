...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PROMETHEUSSERVICE_API PutAlertManagerDefinitionRequest : public PrometheusServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAlertManagerDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<PutAlertManagerDefinitionRequest>(GetServiceRequestName(), *this);
    }
