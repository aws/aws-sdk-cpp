...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PROMETHEUSSERVICE_API UpdateWorkspaceAliasRequest : public PrometheusServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateWorkspaceAliasRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateWorkspaceAliasRequest>(GetServiceRequestName(), *this);
    }
