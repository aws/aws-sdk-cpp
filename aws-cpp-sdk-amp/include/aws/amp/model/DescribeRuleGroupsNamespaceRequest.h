...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRuleGroupsNamespaceRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRuleGroupsNamespaceRequest>(GetServiceRequestName(), *this);
    }
