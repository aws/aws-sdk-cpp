...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PROMETHEUSSERVICE_API DescribeAlertManagerDefinitionRequest : public PrometheusServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAlertManagerDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAlertManagerDefinitionRequest>(GetServiceRequestName(), *this);
    }
