...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PROMETHEUSSERVICE_API ListWorkspacesRequest : public PrometheusServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWorkspacesRequest> Clone() const
    {
      return Aws::MakeUnique<ListWorkspacesRequest>(GetServiceRequestName(), *this);
    }
