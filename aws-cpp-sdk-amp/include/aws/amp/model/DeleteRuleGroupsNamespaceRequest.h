...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PROMETHEUSSERVICE_API DeleteRuleGroupsNamespaceRequest : public PrometheusServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRuleGroupsNamespaceRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRuleGroupsNamespaceRequest>(GetServiceRequestName(), *this);
    }
