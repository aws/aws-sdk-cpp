...
namespace Model
{
  ...
  /**
   * <p>Represents the input of a CreateAlertManagerDefinition
   * operation.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/amp-2020-08-01/CreateAlertManagerDefinitionRequest">AWS
   * API Reference</a></p>
   */
  class AWS_PROMETHEUSSERVICE_API CreateAlertManagerDefinitionRequest : public PrometheusServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAlertManagerDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAlertManagerDefinitionRequest>(GetServiceRequestName(), *this);
    }
