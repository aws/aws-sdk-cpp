...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PROMETHEUSSERVICE_API ListRuleGroupsNamespacesRequest : public PrometheusServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRuleGroupsNamespacesRequest> Clone() const
    {
      return Aws::MakeUnique<ListRuleGroupsNamespacesRequest>(GetServiceRequestName(), *this);
    }
