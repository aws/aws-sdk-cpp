...
using PIResolveEndpointOutcome = Aws::PI::Endpoint::PIEndpointProvider::PIResolveEndpointOutcome;
...
void ValidateOutcome(const PIResolveEndpointOutcome& outcome, const PIEndpointProviderEndpointTestCase::Expect& expect)
{
