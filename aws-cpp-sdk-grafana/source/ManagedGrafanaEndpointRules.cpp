...
Aws::String ManagedGrafanaEndpointRules::GetRulesAsString()
{
    return Aws::String(ManagedGrafanaEndpointRules::Rules.begin(), ManagedGrafanaEndpointRules::Rules.end());
}

const Aws::Vector<char> ManagedGrafanaEndpointRules::Rules = {
...
'g','r','a','f','a','n','a','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','r','a',
'f','a','n','a','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
...
'"','h','t','t','p','s',':','/','/','g','r','a','f','a','n','a','.','{','R','e','g','i','o','n','}',
