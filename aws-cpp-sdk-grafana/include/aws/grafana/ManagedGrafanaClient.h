...
namespace ManagedGrafana
{
  ...
  class AWS_MANAGEDGRAFANA_API ManagedGrafanaClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ManagedGrafanaClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::ManagedGrafanaEndpointProvider> endpointProvider = Aws::MakeShared<ManagedGrafana::Endpoint::ManagedGrafanaEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ManagedGrafanaEndpointProvider> m_endpointProvider;
  };
