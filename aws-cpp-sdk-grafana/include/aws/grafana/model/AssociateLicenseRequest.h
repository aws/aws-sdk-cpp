...
namespace Model
{
  ...
  /**
   */
  class AWS_MANAGEDGRAFANA_API AssociateLicenseRequest : public ManagedGrafanaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateLicenseRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateLicenseRequest>(GetServiceRequestName(), *this);
    }
