...
namespace Model
{
  ...
  /**
   */
  class AWS_MANAGEDGRAFANA_API DescribeWorkspaceRequest : public ManagedGrafanaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeWorkspaceRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeWorkspaceRequest>(GetServiceRequestName(), *this);
    }
