...
namespace Model
{
  ...
  /**
   */
  class AWS_MANAGEDGRAFANA_API CreateWorkspaceApiKeyRequest : public ManagedGrafanaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWorkspaceApiKeyRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWorkspaceApiKeyRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>Specifies the name of the key to create. Key names must be unique to the
     * workspace.</p>
     */
