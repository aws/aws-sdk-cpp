...
namespace Model
{
  ...
  /**
   */
  class AWS_MANAGEDGRAFANA_API UpdateWorkspaceAuthenticationRequest : public ManagedGrafanaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateWorkspaceAuthenticationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateWorkspaceAuthenticationRequest>(GetServiceRequestName(), *this);
    }
