...
namespace Model
{
  ...
  /**
   */
  class AWS_MANAGEDGRAFANA_API DeleteWorkspaceApiKeyRequest : public ManagedGrafanaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWorkspaceApiKeyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWorkspaceApiKeyRequest>(GetServiceRequestName(), *this);
    }
