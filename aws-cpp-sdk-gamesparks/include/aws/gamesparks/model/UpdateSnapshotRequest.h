...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMESPARKS_API UpdateSnapshotRequest : public GameSparksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSnapshotRequest>(GetServiceRequestName(), *this);
    }
