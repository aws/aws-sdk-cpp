...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMESPARKS_API GetPlayerConnectionStatusRequest : public GameSparksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPlayerConnectionStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetPlayerConnectionStatusRequest>(GetServiceRequestName(), *this);
    }
