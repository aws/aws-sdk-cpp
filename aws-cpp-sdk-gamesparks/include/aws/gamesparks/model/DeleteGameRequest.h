...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMESPARKS_API DeleteGameRequest : public GameSparksRequest
  {
  public:
    DeleteGameRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteGameRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteGameRequest>(GetServiceRequestName(), *this);
    }
