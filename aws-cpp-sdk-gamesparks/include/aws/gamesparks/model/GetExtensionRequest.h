...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMESPARKS_API GetExtensionRequest : public GameSparksRequest
  {
  public:
    GetExtensionRequest();
    ...
    */
    virtual Aws::UniquePtr<GetExtensionRequest> Clone() const
    {
      return Aws::MakeUnique<GetExtensionRequest>(GetServiceRequestName(), *this);
    }
