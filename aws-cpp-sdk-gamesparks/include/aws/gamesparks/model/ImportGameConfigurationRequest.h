...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMESPARKS_API ImportGameConfigurationRequest : public GameSparksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ImportGameConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<ImportGameConfigurationRequest>(GetServiceRequestName(), *this);
    }
