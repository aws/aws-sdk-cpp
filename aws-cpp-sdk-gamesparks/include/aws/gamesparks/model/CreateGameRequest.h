...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMESPARKS_API CreateGameRequest : public GameSparksRequest
  {
  public:
    CreateGameRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateGameRequest> Clone() const
    {
      return Aws::MakeUnique<CreateGameRequest>(GetServiceRequestName(), *this);
    }
