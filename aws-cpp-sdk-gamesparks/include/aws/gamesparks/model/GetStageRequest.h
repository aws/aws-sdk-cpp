...
namespace Model
{
  ...
  /**
   */
  class GetStageRequest : public GameSparksRequest
  {
  public:
    AWS_GAMESPARKS_API GetStageRequest();
     ...
     * <p>The name of the game.</p>
     */
    inline GetStageRequest& WithGameName(const Aws::String& value) { SetGameName(value); return *this;}

    /**
     * <p>The name of the game.</p>
     */
    inline GetStageRequest& WithGameName(Aws::String&& value) { SetGameName(std::move(value)); return *this;}

    /**
     * <p>The name of the game.</p>
     */
    inline GetStageRequest& WithGameName(const char* value) { SetGameName(value); return *this;}
