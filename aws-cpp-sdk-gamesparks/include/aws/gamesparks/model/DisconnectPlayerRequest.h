...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMESPARKS_API DisconnectPlayerRequest : public GameSparksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisconnectPlayerRequest> Clone() const
    {
      return Aws::MakeUnique<DisconnectPlayerRequest>(GetServiceRequestName(), *this);
    }
