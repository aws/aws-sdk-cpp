...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMESPARKS_API GetExtensionVersionRequest : public GameSparksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetExtensionVersionRequest> Clone() const
    {
      return Aws::MakeUnique<GetExtensionVersionRequest>(GetServiceRequestName(), *this);
    }
