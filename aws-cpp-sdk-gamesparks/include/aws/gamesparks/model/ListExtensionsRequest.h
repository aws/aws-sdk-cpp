...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMESPARKS_API ListExtensionsRequest : public GameSparksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListExtensionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListExtensionsRequest>(GetServiceRequestName(), *this);
    }
