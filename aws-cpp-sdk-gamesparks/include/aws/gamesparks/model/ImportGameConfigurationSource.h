...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GAMESPARKS_API ImportGameConfigurationSource
  {
  public:
    ImportGameConfigurationSource();
    ImportGameConfigurationSource(Aws::Utils::Json::JsonView jsonValue);
    ImportGameConfigurationSource& operator=(Aws::Utils::Json::JsonView jsonValue);
