...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMESPARKS_API ListExtensionVersionsRequest : public GameSparksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListExtensionVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListExtensionVersionsRequest>(GetServiceRequestName(), *this);
    }
