...
namespace Model
{
  ...
  /**
   */
  class AWS_GAMESPARKS_API GetGameRequest : public GameSparksRequest
  {
  public:
    GetGameRequest();
    ...
    */
    virtual Aws::UniquePtr<GetGameRequest> Clone() const
    {
      return Aws::MakeUnique<GetGameRequest>(GetServiceRequestName(), *this);
    }
