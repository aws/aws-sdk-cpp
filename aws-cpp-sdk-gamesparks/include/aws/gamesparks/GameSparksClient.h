...
namespace GameSparks
{
  ...
  class AWS_GAMESPARKS_API GameSparksClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        GameSparksClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::GameSparksEndpointProvider> endpointProvider = Aws::MakeShared<GameSparks::Endpoint::GameSparksEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::GameSparksEndpointProvider> m_endpointProvider;
  };
