...
Aws::String GameSparksEndpointRules::GetRulesAsString()
{
    return Aws::String(GameSparksEndpointRules::Rules.begin(), GameSparksEndpointRules::Rules.end());
}

const Aws::Vector<char> GameSparksEndpointRules::Rules = {
