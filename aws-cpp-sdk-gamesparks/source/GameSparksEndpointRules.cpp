...
{
const size_t GameSparksEndpointRules::RulesBlobStrLen = 3470;
const size_t GameSparksEndpointRules::RulesBlobSize = 3471;

using RulesBlobT = Aws::Array<const char, GameSparksEndpointRules::RulesBlobSize>;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','a','m','e','s','p',
'a','r','k','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
's',':','/','/','g','a','m','e','s','p','a','r','k','s','-','f','i','p','s','.','{','R','e','g','i',
...
',','"','r','u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',
']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p',
's',':','/','/','g','a','m','e','s','p','a','r','k','s','.','{','R','e','g','i','o','n','}','.','{',
...
'{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n',
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','a','m','e','s','p',
'a','r','k','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
'e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r',
't','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t',
'y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* GameSparksEndpointRules::GetRulesBlob()
{
