...
namespace MediaStore
{
  ...
  class AWS_MEDIASTORE_API MediaStoreClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MediaStoreClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::MediaStoreEndpointProvider> endpointProvider = Aws::MakeShared<MediaStore::Endpoint::MediaStoreEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MediaStoreEndpointProvider> m_endpointProvider;
  };
