...
Aws::String MediaStoreEndpointRules::GetRulesAsString()
{
    return Aws::String(MediaStoreEndpointRules::Rules.begin(), MediaStoreEndpointRules::Rules.end());
}

const Aws::Vector<char> MediaStoreEndpointRules::Rules = {
...
':','/','/','m','e','d','i','a','s','t','o','r','e','-','f','i','p','s','.','{','R','e','g','i','o',
...
'"','r','u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',
',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',
':','/','/','m','e','d','i','a','s','t','o','r','e','.','{','R','e','g','i','o','n','}','.','{','P',
