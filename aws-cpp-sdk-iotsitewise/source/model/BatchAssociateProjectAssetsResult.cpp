...
BatchAssociateProjectAssetsResult::BatchAssociateProjectAssetsResult()
{
}

BatchAssociateProjectAssetsResult::BatchAssociateProjectAssetsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
