...
Aws::String IoTSiteWiseEndpointRules::GetRulesAsString()
{
    return Aws::String(IoTSiteWiseEndpointRules::Rules.begin(), IoTSiteWiseEndpointRules::Rules.end());
}

const Aws::Vector<char> IoTSiteWiseEndpointRules::Rules = {
...
's',':','/','/','i','o','t','s','i','t','e','w','i','s','e','-','f','i','p','s','.','{','R','e','g',
...
'i','t','e','w','i','s','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
