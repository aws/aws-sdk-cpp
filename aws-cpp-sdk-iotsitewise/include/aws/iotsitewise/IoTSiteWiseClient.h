...
namespace IoTSiteWise
{
  ...
  class AWS_IOTSITEWISE_API IoTSiteWiseClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IoTSiteWiseClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::IoTSiteWiseEndpointProvider> endpointProvider = Aws::MakeShared<IoTSiteWise::Endpoint::IoTSiteWiseEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IoTSiteWiseEndpointProvider> m_endpointProvider;
  };
