...
namespace Model
{
        ...
        typedef Aws::Utils::Outcome<Aws::NoResult, Aws::Client::AWSError<IoTSiteWiseErrors>> AssociateAssetsOutcome;
        typedef Aws::Utils::Outcome<BatchAssociateProjectAssetsResult, Aws::Client::AWSError<IoTSiteWiseErrors>> BatchAssociateProjectAssetsOutcome;
        typedef Aws::Utils::Outcome<BatchDisassociateProjectAssetsResult, Aws::Client::AWSError<IoTSiteWiseErrors>> BatchDisassociateProjectAssetsOutcome;
        typedef Aws::Utils::Outcome<BatchPutAssetPropertyValueResult, Aws::Client::AWSError<IoTSiteWiseErrors>> BatchPutAssetPropertyValueOutcome;
        typedef Aws::Utils::Outcome<CreateAccessPolicyResult, Aws::Client::AWSError<IoTSiteWiseErrors>> CreateAccessPolicyOutcome;
        typedef Aws::Utils::Outcome<CreateAssetResult, Aws::Client::AWSError<IoTSiteWiseErrors>> CreateAssetOutcome;
        typedef Aws::Utils::Outcome<CreateAssetModelResult, Aws::Client::AWSError<IoTSiteWiseErrors>> CreateAssetModelOutcome;
        typedef Aws::Utils::Outcome<CreateDashboardResult, Aws::Client::AWSError<IoTSiteWiseErrors>> CreateDashboardOutcome;
        typedef Aws::Utils::Outcome<CreateGatewayResult, Aws::Client::AWSError<IoTSiteWiseErrors>> CreateGatewayOutcome;
        typedef Aws::Utils::Outcome<CreatePortalResult, Aws::Client::AWSError<IoTSiteWiseErrors>> CreatePortalOutcome;
        typedef Aws::Utils::Outcome<CreateProjectResult, Aws::Client::AWSError<IoTSiteWiseErrors>> CreateProjectOutcome;
        typedef Aws::Utils::Outcome<DeleteAccessPolicyResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DeleteAccessPolicyOutcome;
        typedef Aws::Utils::Outcome<DeleteAssetResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DeleteAssetOutcome;
        typedef Aws::Utils::Outcome<DeleteAssetModelResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DeleteAssetModelOutcome;
        typedef Aws::Utils::Outcome<DeleteDashboardResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DeleteDashboardOutcome;
        typedef Aws::Utils::Outcome<Aws::NoResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DeleteGatewayOutcome;
        typedef Aws::Utils::Outcome<DeletePortalResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DeletePortalOutcome;
        typedef Aws::Utils::Outcome<DeleteProjectResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DeleteProjectOutcome;
        typedef Aws::Utils::Outcome<DescribeAccessPolicyResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DescribeAccessPolicyOutcome;
        typedef Aws::Utils::Outcome<DescribeAssetResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DescribeAssetOutcome;
        typedef Aws::Utils::Outcome<DescribeAssetModelResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DescribeAssetModelOutcome;
        typedef Aws::Utils::Outcome<DescribeAssetPropertyResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DescribeAssetPropertyOutcome;
        typedef Aws::Utils::Outcome<DescribeDashboardResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DescribeDashboardOutcome;
        typedef Aws::Utils::Outcome<DescribeGatewayResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DescribeGatewayOutcome;
        typedef Aws::Utils::Outcome<DescribeGatewayCapabilityConfigurationResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DescribeGatewayCapabilityConfigurationOutcome;
        typedef Aws::Utils::Outcome<DescribeLoggingOptionsResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DescribeLoggingOptionsOutcome;
        typedef Aws::Utils::Outcome<DescribePortalResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DescribePortalOutcome;
        typedef Aws::Utils::Outcome<DescribeProjectResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DescribeProjectOutcome;
        typedef Aws::Utils::Outcome<Aws::NoResult, Aws::Client::AWSError<IoTSiteWiseErrors>> DisassociateAssetsOutcome;
        typedef Aws::Utils::Outcome<GetAssetPropertyAggregatesResult, Aws::Client::AWSError<IoTSiteWiseErrors>> GetAssetPropertyAggregatesOutcome;
        typedef Aws::Utils::Outcome<GetAssetPropertyValueResult, Aws::Client::AWSError<IoTSiteWiseErrors>> GetAssetPropertyValueOutcome;
        typedef Aws::Utils::Outcome<GetAssetPropertyValueHistoryResult, Aws::Client::AWSError<IoTSiteWiseErrors>> GetAssetPropertyValueHistoryOutcome;
        typedef Aws::Utils::Outcome<ListAccessPoliciesResult, Aws::Client::AWSError<IoTSiteWiseErrors>> ListAccessPoliciesOutcome;
        typedef Aws::Utils::Outcome<ListAssetModelsResult, Aws::Client::AWSError<IoTSiteWiseErrors>> ListAssetModelsOutcome;
        typedef Aws::Utils::Outcome<ListAssetsResult, Aws::Client::AWSError<IoTSiteWiseErrors>> ListAssetsOutcome;
        typedef Aws::Utils::Outcome<ListAssociatedAssetsResult, Aws::Client::AWSError<IoTSiteWiseErrors>> ListAssociatedAssetsOutcome;
        typedef Aws::Utils::Outcome<ListDashboardsResult, Aws::Client::AWSError<IoTSiteWiseErrors>> ListDashboardsOutcome;
        typedef Aws::Utils::Outcome<ListGatewaysResult, Aws::Client::AWSError<IoTSiteWiseErrors>> ListGatewaysOutcome;
        typedef Aws::Utils::Outcome<ListPortalsResult, Aws::Client::AWSError<IoTSiteWiseErrors>> ListPortalsOutcome;
        typedef Aws::Utils::Outcome<ListProjectAssetsResult, Aws::Client::AWSError<IoTSiteWiseErrors>> ListProjectAssetsOutcome;
        typedef Aws::Utils::Outcome<ListProjectsResult, Aws::Client::AWSError<IoTSiteWiseErrors>> ListProjectsOutcome;
        typedef Aws::Utils::Outcome<ListTagsForResourceResult, Aws::Client::AWSError<IoTSiteWiseErrors>> ListTagsForResourceOutcome;
        typedef Aws::Utils::Outcome<PutLoggingOptionsResult, Aws::Client::AWSError<IoTSiteWiseErrors>> PutLoggingOptionsOutcome;
        typedef Aws::Utils::Outcome<TagResourceResult, Aws::Client::AWSError<IoTSiteWiseErrors>> TagResourceOutcome;
        typedef Aws::Utils::Outcome<UntagResourceResult, Aws::Client::AWSError<IoTSiteWiseErrors>> UntagResourceOutcome;
        typedef Aws::Utils::Outcome<UpdateAccessPolicyResult, Aws::Client::AWSError<IoTSiteWiseErrors>> UpdateAccessPolicyOutcome;
        typedef Aws::Utils::Outcome<UpdateAssetResult, Aws::Client::AWSError<IoTSiteWiseErrors>> UpdateAssetOutcome;
        typedef Aws::Utils::Outcome<UpdateAssetModelResult, Aws::Client::AWSError<IoTSiteWiseErrors>> UpdateAssetModelOutcome;
        typedef Aws::Utils::Outcome<Aws::NoResult, Aws::Client::AWSError<IoTSiteWiseErrors>> UpdateAssetPropertyOutcome;
        typedef Aws::Utils::Outcome<UpdateDashboardResult, Aws::Client::AWSError<IoTSiteWiseErrors>> UpdateDashboardOutcome;
        typedef Aws::Utils::Outcome<Aws::NoResult, Aws::Client::AWSError<IoTSiteWiseErrors>> UpdateGatewayOutcome;
        typedef Aws::Utils::Outcome<UpdateGatewayCapabilityConfigurationResult, Aws::Client::AWSError<IoTSiteWiseErrors>> UpdateGatewayCapabilityConfigurationOutcome;
        typedef Aws::Utils::Outcome<UpdatePortalResult, Aws::Client::AWSError<IoTSiteWiseErrors>> UpdatePortalOutcome;
        typedef Aws::Utils::Outcome<UpdateProjectResult, Aws::Client::AWSError<IoTSiteWiseErrors>> UpdateProjectOutcome;
