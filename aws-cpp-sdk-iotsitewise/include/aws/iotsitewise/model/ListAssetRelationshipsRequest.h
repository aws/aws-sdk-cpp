...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API ListAssetRelationshipsRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAssetRelationshipsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAssetRelationshipsRequest>(GetServiceRequestName(), *this);
    }
