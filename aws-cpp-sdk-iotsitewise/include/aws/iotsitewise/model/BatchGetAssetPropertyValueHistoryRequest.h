...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetAssetPropertyValueHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetAssetPropertyValueHistoryRequest>(GetServiceRequestName(), *this);
    }
