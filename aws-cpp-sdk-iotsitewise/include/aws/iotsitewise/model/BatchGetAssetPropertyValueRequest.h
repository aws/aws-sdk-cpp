...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API BatchGetAssetPropertyValueRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetAssetPropertyValueRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetAssetPropertyValueRequest>(GetServiceRequestName(), *this);
    }
