...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API DeleteGatewayRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteGatewayRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteGatewayRequest>(GetServiceRequestName(), *this);
    }
