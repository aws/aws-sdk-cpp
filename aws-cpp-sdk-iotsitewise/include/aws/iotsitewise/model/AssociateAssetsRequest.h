...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API AssociateAssetsRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateAssetsRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateAssetsRequest>(GetServiceRequestName(), *this);
    }
