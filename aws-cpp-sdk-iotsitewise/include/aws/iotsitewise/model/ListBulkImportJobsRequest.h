...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API ListBulkImportJobsRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBulkImportJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListBulkImportJobsRequest>(GetServiceRequestName(), *this);
    }
