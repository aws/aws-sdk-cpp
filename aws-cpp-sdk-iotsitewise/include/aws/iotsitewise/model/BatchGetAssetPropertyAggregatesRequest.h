...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetAssetPropertyAggregatesRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetAssetPropertyAggregatesRequest>(GetServiceRequestName(), *this);
    }
