...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API AssociateTimeSeriesToAssetPropertyRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateTimeSeriesToAssetPropertyRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateTimeSeriesToAssetPropertyRequest>(GetServiceRequestName(), *this);
    }
