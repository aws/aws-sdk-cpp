...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API DeleteAccessPolicyRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAccessPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAccessPolicyRequest>(GetServiceRequestName(), *this);
    }
