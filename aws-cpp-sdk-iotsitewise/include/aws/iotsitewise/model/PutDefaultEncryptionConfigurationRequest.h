...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutDefaultEncryptionConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutDefaultEncryptionConfigurationRequest>(GetServiceRequestName(), *this);
    }
