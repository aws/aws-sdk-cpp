...
namespace Model
{
  class AWS_IOTSITEWISE_API CreateAssetResult
  {
  public:
    CreateAssetResult();
    ...
    /**
     * <p>The ID of the asset. This ID uniquely identifies the asset within AWS IoT
     * SiteWise and can be used with other AWS IoT SiteWise APIs.</p>
     */
