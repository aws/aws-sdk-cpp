...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetInterpolatedAssetPropertyValuesRequest> Clone() const
    {
      return Aws::MakeUnique<GetInterpolatedAssetPropertyValuesRequest>(GetServiceRequestName(), *this);
    }
