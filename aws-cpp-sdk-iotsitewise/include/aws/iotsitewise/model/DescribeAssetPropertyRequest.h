...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API DescribeAssetPropertyRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAssetPropertyRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAssetPropertyRequest>(GetServiceRequestName(), *this);
    }
