...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API ListAssetPropertiesRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAssetPropertiesRequest> Clone() const
    {
      return Aws::MakeUnique<ListAssetPropertiesRequest>(GetServiceRequestName(), *this);
    }
