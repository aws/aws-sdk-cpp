...
namespace Model
{
  class AWS_IOTSITEWISE_API DescribeGatewayCapabilityConfigurationResult
  {
  public:
    ...
    DescribeGatewayCapabilityConfigurationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
