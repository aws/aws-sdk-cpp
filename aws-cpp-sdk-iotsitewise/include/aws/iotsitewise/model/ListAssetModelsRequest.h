...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API ListAssetModelsRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAssetModelsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAssetModelsRequest>(GetServiceRequestName(), *this);
    }
