...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API CreateBulkImportJobRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateBulkImportJobRequest> Clone() const
    {
      return Aws::MakeUnique<CreateBulkImportJobRequest>(GetServiceRequestName(), *this);
    }
