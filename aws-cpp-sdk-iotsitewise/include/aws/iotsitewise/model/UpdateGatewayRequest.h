...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API UpdateGatewayRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateGatewayRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateGatewayRequest>(GetServiceRequestName(), *this);
    }
