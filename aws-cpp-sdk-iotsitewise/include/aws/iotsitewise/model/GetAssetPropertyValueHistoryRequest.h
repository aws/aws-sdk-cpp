...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAssetPropertyValueHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<GetAssetPropertyValueHistoryRequest>(GetServiceRequestName(), *this);
    }
