...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_IOTSITEWISE_API AssetPropertySummary
  {
  public:
    AssetPropertySummary();
    AssetPropertySummary(Aws::Utils::Json::JsonView jsonValue);
    AssetPropertySummary& operator=(Aws::Utils::Json::JsonView jsonValue);
