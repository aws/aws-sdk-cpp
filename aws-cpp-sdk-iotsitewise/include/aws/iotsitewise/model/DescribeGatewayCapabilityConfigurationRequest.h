...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeGatewayCapabilityConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeGatewayCapabilityConfigurationRequest>(GetServiceRequestName(), *this);
    }
