...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDisassociateProjectAssetsRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDisassociateProjectAssetsRequest>(GetServiceRequestName(), *this);
    }
