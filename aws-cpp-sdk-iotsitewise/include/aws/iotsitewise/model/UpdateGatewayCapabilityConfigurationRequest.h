...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateGatewayCapabilityConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateGatewayCapabilityConfigurationRequest>(GetServiceRequestName(), *this);
    }
