...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTSITEWISE_API ListTimeSeriesRequest : public IoTSiteWiseRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTimeSeriesRequest> Clone() const
    {
      return Aws::MakeUnique<ListTimeSeriesRequest>(GetServiceRequestName(), *this);
    }
