...
static const char* ALLOCATION_TAG = "AWSBudgetsEndpointProviderTests";
using BudgetsEndpointProvider = Aws::Budgets::Endpoint::BudgetsEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using BudgetsResolveEndpointOutcome = Aws::Budgets::Endpoint::BudgetsEndpointProvider::BudgetsResolveEndpointOutcome;
...
static const Aws::Vector<BudgetsEndpointProviderEndpointTestCase> TEST_CASES = {
  ...
  {"For region aws-cn-global with FIPS disabled and DualStack disabled", // documentation
    ...
    {{/*epUrl*/"https://budgets.amazonaws.com.cn",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "cn-northwest-1"), EpProp("name", "sigv4"), EpProp("signingName", "budgets")}}},
  ...
  {"For region aws-global with FIPS disabled and DualStack disabled", // documentation
    ...
    {{/*epUrl*/"https://budgets.amazonaws.com",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "us-east-1"), EpProp("name", "sigv4"), EpProp("signingName", "budgets")}}},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  /*TEST CASE 2*/
...
void ValidateOutcome(const BudgetsResolveEndpointOutcome& outcome, const BudgetsEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(BudgetsEndpointProviderTests, EndpointProviderTest)
{
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const BudgetsEndpointProviderEndpointTestCase::OperationParamsFromTest>>
