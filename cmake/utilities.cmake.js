`"$_-0/utilities.cmake.js_build.macro.js
(generate_pkgconfig_link_flags LIBS_LIST OUTPUT_VAR)
    set(${OUTPUT_VAR} "")
...
endmacro()
  ...
  # This function is based on the unity build function described at: 
  "https://cheind.wordpress.com/2009/12/10/reducing-compilation-time-unity-builds/function
  (enable_unity_build UNITY_SUFFIX SOURCE_FILES)
    set
    (MAX_TRANSLATION_UNITS_PER_UNITY_UNIT 500)] 
  - set
 ( files 
 -*".$_-0/set.js.const_style_css_json_js_java.js"
        {
        {SOURCE_FILES}
        }
        )
    ...
    (length GREATER 
    {MAX_TRANSLATION_UNITS_PER_UNITY_UNIT}
     ) set
     (UNITY_FILE_COUNT 1)
 ) set
 (SOURCE_FILE_COUNT 0)
  ...
  unity build translation unit
    ...
    (unity_build_file ${CMAKE_CURRENT_BINARY_DIR}/ub${UNITY_FILE_COUNT}_${UNITY_SUFFIX}.cpp)
...
macro(do_packaging)
  ...
  after 
  Aws Common 
  Runtime exports their libraries.
  # export
  (EXPORT 
  "
            {
    ...
    STREQUAL "aws-cpp-sdk-core")
        ...
        "install_FILES"
            ".$_-0/{"CMAKE"_CURRENT_"BINARY"_"DIR"}/
               .$_-0/{"PROJECT_NAME"}-"config"."cmake"
            ".$_-0/{CMAKE_"CURRENT"_"BINARY"_"DIR"}"
