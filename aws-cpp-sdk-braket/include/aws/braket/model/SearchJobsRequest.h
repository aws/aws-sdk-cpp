...
namespace Model
{
  ...
  /**
   */
  class AWS_BRAKET_API SearchJobsRequest : public BraketRequest
  {
  public:
    SearchJobsRequest();
    ...
    */
    virtual Aws::UniquePtr<SearchJobsRequest> Clone() const
    {
      return Aws::MakeUnique<SearchJobsRequest>(GetServiceRequestName(), *this);
    }
