...
namespace Model
{
  ...
  /**
   */
  class AWS_BRAKET_API CancelJobRequest : public BraketRequest
  {
  public:
    CancelJobRequest();
    ...
    */
    virtual Aws::UniquePtr<CancelJobRequest> Clone() const
    {
      return Aws::MakeUnique<CancelJobRequest>(GetServiceRequestName(), *this);
    }
