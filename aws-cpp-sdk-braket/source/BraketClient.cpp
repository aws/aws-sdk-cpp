...
using ResolveEndpointOutcome = Aws::Braket::Endpoint::BraketEndpointProvider::BraketResolveEndpointOutcome;
...
BraketClient::BraketClient(const Client::ClientConfiguration& clientConfiguration,
                           std::shared_ptr<Endpoint::BraketEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<BraketErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Braket::Endpoint::BraketEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
