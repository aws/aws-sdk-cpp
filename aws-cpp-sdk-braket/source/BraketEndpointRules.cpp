...
Aws::String BraketEndpointRules::GetRulesAsString()
{
    return Aws::String(BraketEndpointRules::Rules.begin(), BraketEndpointRules::Rules.end());
}

const Aws::Vector<char> BraketEndpointRules::Rules = {
