...
def ParseArguments():
    ...
    parser = argparse.ArgumentParser(
        description="AWSNativeSDK Run all Integration Tests")
...
def Main():
    ...
    # Visual Studio puts executables into a configuration
    # sub-dir, so append that.
    ...
    dynamoDbTest = (
        ...
        configDir +
        "/aws-cpp-sdk-dynamodb-integration-tests" + exeExtension)
    ...
    sqsTest = (
        ...
        configDir +
        "/aws-cpp-sdk-sqs-integration-tests" + exeExtension)
    ...
    s3Test = (
        ...
        configDir +
        "/aws-cpp-sdk-s3-integration-tests" + exeExtension)
    ...
    lambdaTest = (
        ...
        configDir +
        "/aws-cpp-sdk-lambda-integration-tests" + exeExtension)
    ...
    cognitoTest = (
        ...
        configDir +
        "/aws-cpp-sdk-cognitoidentity-integration-tests" + exeExtension)
    ...
    transferTest = (
        ...
        configDir +
        "/aws-cpp-sdk-transfer-tests" + exeExtension)
    AddExecutableBit(transferTest)
    subprocess.check_call(transferTest)

    # These will cost you lots of money.
    # Don't run them unless you decide you want to test this functionality
    # cloudFrontTests = (
    #     arguments["buildDir"] +
    #     "/aws-cpp-sdk-cloudfront-integration-tests/" +
    #     configDir +
    #     "/aws-cpp-sdk-cloudfront-integration-tests" + exeExtension)
    ...
    #     configDir + "/aws-cpp-sdk-redshift-integration-tests" + exeExtension)
