...
static const char* ALLOCATION_TAG = "AWSGameSparksEndpointProviderTests";
using GameSparksEndpointProvider = Aws::GameSparks::Endpoint::GameSparksEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using GameSparksResolveEndpointOutcome = Aws::GameSparks::Endpoint::GameSparksEndpointProvider::GameSparksResolveEndpointOutcome;
...
class GameSparksEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct GameSparksEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<GameSparksEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
  {"For region us-east-1 with FIPS enabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://gamesparks-fips.us-east-1.api.aws",
       {/*properties*/},
  ...
  {"For region us-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://gamesparks-fips.us-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack enabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://gamesparks.us-east-1.api.aws",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
  ...
  {"For region us-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://gamesparks.us-east-1.amazonaws.com",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
...
void ValidateOutcome(const GameSparksResolveEndpointOutcome& outcome, const GameSparksEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(GameSparksEndpointProviderTests, EndpointProviderTest)
{
    ...
    const GameSparksEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<GameSparksEndpointProvider> endpointProvider = Aws::MakeShared<GameSparksEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize GameSparksEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const GameSparksEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         GameSparksEndpointProviderTests,
