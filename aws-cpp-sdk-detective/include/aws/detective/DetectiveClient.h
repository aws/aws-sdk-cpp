...
namespace Detective
{
  ...
  class AWS_DETECTIVE_API DetectiveClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DetectiveClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::DetectiveEndpointProvider> endpointProvider = Aws::MakeShared<Detective::Endpoint::DetectiveEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DetectiveEndpointProvider> m_endpointProvider;
  };
