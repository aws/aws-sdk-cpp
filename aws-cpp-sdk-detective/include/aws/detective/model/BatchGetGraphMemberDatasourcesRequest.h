...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetGraphMemberDatasourcesRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetGraphMemberDatasourcesRequest>(GetServiceRequestName(), *this);
    }
