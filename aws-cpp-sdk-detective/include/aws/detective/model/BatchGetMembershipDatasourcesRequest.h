...
namespace Model
{
  ...
  /**
   */
  class AWS_DETECTIVE_API BatchGetMembershipDatasourcesRequest : public DetectiveRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetMembershipDatasourcesRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetMembershipDatasourcesRequest>(GetServiceRequestName(), *this);
    }
