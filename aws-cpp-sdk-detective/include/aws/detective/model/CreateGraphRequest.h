...
namespace Model
{
  ...
  /**
   */
  class AWS_DETECTIVE_API CreateGraphRequest : public DetectiveRequest
  {
  public:
    CreateGraphRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateGraphRequest> Clone() const
    {
      return Aws::MakeUnique<CreateGraphRequest>(GetServiceRequestName(), *this);
    }
