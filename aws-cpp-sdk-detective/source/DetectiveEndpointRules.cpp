...
Aws::String DetectiveEndpointRules::GetRulesAsString()
{
    return Aws::String(DetectiveEndpointRules::Rules.begin(), DetectiveEndpointRules::Rules.end());
}

const Aws::Vector<char> DetectiveEndpointRules::Rules = {
