...
namespace Detective
{
const size_t DetectiveEndpointRules::RulesBlobStrLen = 3420;
const size_t DetectiveEndpointRules::RulesBlobSize = 3421;

using RulesBlobT = Aws::Array<const char, DetectiveEndpointRules::RulesBlobSize>;
...
't','t','p','s',':','/','/','a','p','i','.','d','e','t','e','c','t','i','v','e','-','f','i','p','s',
...
'n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','i','.','d',
'e','t','e','c','t','i','v','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p',
'i','.','d','e','t','e','c','t','i','v','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'c','k','"',',','"','t','y','p','e','"',':','"','e','r','r','o','r','"','}',']','}',',','{','"','c',
'o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n','t','"',':',
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','i','.','d','e','t','e','c',
't','i','v','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
'e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r',
't','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t',
'y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* DetectiveEndpointRules::GetRulesBlob()
{
