...
using ResolveEndpointOutcome = Aws::Detective::Endpoint::DetectiveEndpointProvider::DetectiveResolveEndpointOutcome;
...
DetectiveClient::DetectiveClient(const Client::ClientConfiguration& clientConfiguration,
                                 std::shared_ptr<Endpoint::DetectiveEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<DetectiveErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Detective::Endpoint::DetectiveEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
