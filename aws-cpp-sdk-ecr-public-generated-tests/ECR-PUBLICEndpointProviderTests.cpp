...
using ECRPublicResolveEndpointOutcome = Aws::ECRPublic::Endpoint::ECRPublicEndpointProvider::ECRPublicResolveEndpointOutcome;
...
void ValidateOutcome(const ECRPublicResolveEndpointOutcome& outcome, const ECRPublicEndpointProviderEndpointTestCase::Expect& expect)
{
