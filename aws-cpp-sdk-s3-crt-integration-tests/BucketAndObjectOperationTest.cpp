...
namespace
{
    ...
    protected:
        ...
        static void SetUpTestCase()
        {
            ...
            s3ClientConfig.connectionTimeoutMs = 30000;
        ...
        static std::shared_ptr<Aws::StringStream> CreateStreamForUploadPart(size_t sizeInMb, const char* partTag)
        {
        ...
        static bool WaitForObjectWithSSECToPropagate(const Aws::String& bucketName, const char* objectKey, const ByteBuffer& sseKey)
        {
            ...
            while (timeoutCount++ < TIMEOUT_MAX)
            {
                ...
                getObjectRequest.SetBucket(bucketName);
                getObjectRequest.SetKey(objectKey);
                getObjectRequest.WithSSECustomerAlgorithm(Aws::S3Crt::Model::ServerSideEncryptionMapper::GetNameForServerSideEncryption(Aws::S3Crt::Model::ServerSideEncryption::AES256))
        ...
        void DoTestObjectOperationsWithPresignedUrlsWithSSEC(bool withCustomizedHeaders)
        {
            ...
            *objectStream << "Test Object";
            ...
            putRequest->AddContentBody(objectStream);
            putRequest->SetHeaderValue(Aws::S3Crt::SSEHeaders::SERVER_SIDE_ENCRYPTION_CUSTOMER_ALGORITHM,
                    Aws::S3Crt::Model::ServerSideEncryptionMapper::GetNameForServerSideEncryption(Aws::S3Crt::Model::ServerSideEncryption::AES256));
            putRequest->SetHeaderValue(Aws::S3Crt::SSEHeaders::SERVER_SIDE_ENCRYPTION_CUSTOMER_KEY, HashingUtils::Base64Encode(sseKey));
            Aws::String strBuffer(reinterpret_cast<char*>(sseKey.GetUnderlyingData()), sseKey.GetLength());
            putRequest->SetHeaderValue(Aws::S3Crt::SSEHeaders::SERVER_SIDE_ENCRYPTION_CUSTOMER_KEY_MD5, HashingUtils::Base64Encode(HashingUtils::CalculateMD5(strBuffer)));
            if (withCustomizedHeaders)
            {
            ...
            std::shared_ptr<HttpRequest> getRequest = CreateHttpRequest(presignedUrlGet, HttpMethod::HTTP_GET, Aws::Utils::Stream::DefaultResponseStreamFactoryMethod);
            getRequest->SetHeaderValue(Aws::S3Crt::SSEHeaders::SERVER_SIDE_ENCRYPTION_CUSTOMER_ALGORITHM,
                    Aws::S3Crt::Model::ServerSideEncryptionMapper::GetNameForServerSideEncryption(Aws::S3Crt::Model::ServerSideEncryption::AES256));
            getRequest->SetHeaderValue(Aws::S3Crt::SSEHeaders::SERVER_SIDE_ENCRYPTION_CUSTOMER_KEY, HashingUtils::Base64Encode(sseKey));
            getRequest->SetHeaderValue(Aws::S3Crt::SSEHeaders::SERVER_SIDE_ENCRYPTION_CUSTOMER_KEY_MD5, HashingUtils::Base64Encode(HashingUtils::CalculateMD5(strBuffer)));
            ...
            ASSERT_STREQ("Test Object", ss.str().c_str());
            ASSERT_EQ(outcome.GetResult().GetSSECustomerAlgorithm(), Aws::S3Crt::Model::ServerSideEncryptionMapper::GetNameForServerSideEncryption(Aws::S3Crt::Model::ServerSideEncryption::AES256));
    ...
    TEST_F(BucketAndObjectOperationTest, TestObjectOperations)
    {
        ...
        Aws::StringStream ss;
        auto getObjectCallback = [&](const S3CrtClient *client, const GetObjectRequest &request,
                                    GetObjectOutcome outcome, const std::shared_ptr<const AsyncCallerContext> &) {
            ASSERT_TRUE(client);
            ASSERT_TRUE(outcome.IsSuccess());
            ASSERT_EQ(contentLength, outcome.GetResult().GetContentLength());
    ...
    TEST_F(BucketAndObjectOperationTest, TestMultiPartObjectOperations)
    {
        ...
        std::shared_ptr<Aws::IOStream> part1Stream = CreateStreamForUploadPart(5, "1");
        ...
        std::shared_ptr<Aws::IOStream> part2Stream = CreateStreamForUploadPart(5, "2");
        ...
        std::shared_ptr<Aws::IOStream> part3Stream = CreateStreamForUploadPart(5, "3");
    ...
    TEST_F(BucketAndObjectOperationTest, TestThatErrorsParse)
    {
        ...
        ASSERT_EQ(S3CrtErrors::NO_SUCH_KEY, getObjectOutcome.GetError().GetErrorType());
    }
