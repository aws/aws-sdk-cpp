...
using KinesisResolveEndpointOutcome = Aws::Kinesis::Endpoint::KinesisEndpointProvider::KinesisResolveEndpointOutcome;
...
void ValidateOutcome(const KinesisResolveEndpointOutcome& outcome, const KinesisEndpointProviderEndpointTestCase::Expect& expect)
{
