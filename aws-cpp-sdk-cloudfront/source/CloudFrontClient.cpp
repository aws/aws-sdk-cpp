...
using ResolveEndpointOutcome = Aws::CloudFront::Endpoint::CloudFrontEndpointProvider::CloudFrontResolveEndpointOutcome;
...
CloudFrontClient::CloudFrontClient(const Client::ClientConfiguration& clientConfiguration,
                                   std::shared_ptr<Endpoint::CloudFrontEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CloudFrontErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CloudFront::Endpoint::CloudFrontEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
