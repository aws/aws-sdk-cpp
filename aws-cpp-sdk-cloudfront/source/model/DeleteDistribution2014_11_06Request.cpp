...
Aws::String DeleteDistribution2014_11_06Request::SerializePayload() const
{
  return "";
}


Aws::Http::HeaderValueCollection DeleteDistribution2014_11_06Request::GetRequestSpecificHeaders() const
{
