...
KeyGroup& KeyGroup::operator =(const XmlNode& xmlNode)
{
...
void KeyGroup::AddToNode(XmlNode& parentNode) const
{
  Aws::StringStream ss;
  if(m_idHasBeenSet)
  {
  ...
  if(m_keyGroupConfigHasBeenSet)
  {
   XmlNode keyGroupConfigNode = parentNode.CreateChildElement("KeyGroupConfig");
   m_keyGroupConfig.AddToNode(keyGroupConfigNode);
  }
