...
Aws::String DeleteCloudFrontOriginAccessIdentity2014_11_06Request::SerializePayload() const
{
  return "";
}


Aws::Http::HeaderValueCollection DeleteCloudFrontOriginAccessIdentity2014_11_06Request::GetRequestSpecificHeaders() const
{
