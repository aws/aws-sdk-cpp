...
ResponseHeadersPolicyAccessControlAllowHeaders::ResponseHeadersPolicyAccessControlAllowHeaders(const XmlNode& xmlNode) : 
    m_quantity(0),
    m_quantityHasBeenSet(false),
    m_itemsHasBeenSet(false)
{
...
ResponseHeadersPolicyAccessControlAllowHeaders& ResponseHeadersPolicyAccessControlAllowHeaders::operator =(const XmlNode& xmlNode)
{
...
void ResponseHeadersPolicyAccessControlAllowHeaders::AddToNode(XmlNode& parentNode) const
{
  Aws::StringStream ss;
