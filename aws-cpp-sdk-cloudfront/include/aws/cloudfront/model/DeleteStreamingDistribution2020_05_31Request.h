...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteStreamingDistribution2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<DeleteStreamingDistribution2020_05_31Request>(GetServiceRequestName(), *this);
    }
