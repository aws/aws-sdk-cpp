...
namespace Model
{
  class AWS_CLOUDFRONT_API CopyDistribution2020_05_31Result
  {
  public:
    CopyDistribution2020_05_31Result();
    CopyDistribution2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    CopyDistribution2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
