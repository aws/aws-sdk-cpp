...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API CreateFieldLevelEncryptionConfig2020_05_31Request : public CloudFrontRequest
  {
  public:
    CreateFieldLevelEncryptionConfig2020_05_31Request();
    ...
    */
    virtual Aws::UniquePtr<CreateFieldLevelEncryptionConfig2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateFieldLevelEncryptionConfig2020_05_31Request>(GetServiceRequestName(), *this);
    }
