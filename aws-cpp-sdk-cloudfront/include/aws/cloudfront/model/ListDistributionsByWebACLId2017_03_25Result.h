...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2017-03-25/ListDistributionsByWebACLIdResult">AWS
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API ListDistributionsByWebACLId2017_03_25Result
  {
  public:
     ...
     * <p>The <code>DistributionList</code> type. </p>
     */
    inline ListDistributionsByWebACLId2017_03_25Result& WithDistributionList(const DistributionList& value) { SetDistributionList(value); return *this;}
