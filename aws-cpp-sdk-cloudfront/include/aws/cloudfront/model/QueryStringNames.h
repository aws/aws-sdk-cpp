...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API QueryStringNames
  {
  public:
    QueryStringNames();
    QueryStringNames(const Aws::Utils::Xml::XmlNode& xmlNode);
    QueryStringNames& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
