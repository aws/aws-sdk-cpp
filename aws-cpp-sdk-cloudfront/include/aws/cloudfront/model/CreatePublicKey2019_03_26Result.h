...
namespace Model
{
  class AWS_CLOUDFRONT_API CreatePublicKey2019_03_26Result
  {
  public:
    CreatePublicKey2019_03_26Result();
    CreatePublicKey2019_03_26Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    CreatePublicKey2019_03_26Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
     ...
     * <p>Returned when you add a public key.</p>
     */
    inline CreatePublicKey2019_03_26Result& WithPublicKey(const PublicKey& value) { SetPublicKey(value); return *this;}

    /**
     * <p>Returned when you add a public key.</p>
     */
    inline CreatePublicKey2019_03_26Result& WithPublicKey(PublicKey&& value) { SetPublicKey(std::move(value)); return *this;}
     ...
     * <code>E2QWRUHAPOMQZL</code>.</p>
     */
    inline CreatePublicKey2019_03_26Result& WithETag(const Aws::String& value) { SetETag(value); return *this;}

    /**
     * <p>The current version of the public key. For example:
     * <code>E2QWRUHAPOMQZL</code>.</p>
     */
    inline CreatePublicKey2019_03_26Result& WithETag(Aws::String&& value) { SetETag(std::move(value)); return *this;}

    /**
     * <p>The current version of the public key. For example:
     * <code>E2QWRUHAPOMQZL</code>.</p>
     */
    inline CreatePublicKey2019_03_26Result& WithETag(const char* value) { SetETag(value); return *this;}
