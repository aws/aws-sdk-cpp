...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API CreatePublicKey2017_10_30Request : public CloudFrontRequest
  {
  public:
    CreatePublicKey2017_10_30Request();
     ...
     * <p>The request to add a public key to CloudFront.</p>
     */
    inline CreatePublicKey2017_10_30Request& WithPublicKeyConfig(const PublicKeyConfig& value) { SetPublicKeyConfig(value); return *this;}

    /**
     * <p>The request to add a public key to CloudFront.</p>
     */
    inline CreatePublicKey2017_10_30Request& WithPublicKeyConfig(PublicKeyConfig&& value) { SetPublicKeyConfig(std::move(value)); return *this;}
