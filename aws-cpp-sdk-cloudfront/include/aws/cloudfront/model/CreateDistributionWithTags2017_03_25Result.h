...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2017-03-25/CreateDistributionWithTagsResult">AWS
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API CreateDistributionWithTags2017_03_25Result
  {
  public:
     ...
     * <p>The distribution's information. </p>
     */
    inline CreateDistributionWithTags2017_03_25Result& WithDistribution(const Distribution& value) { SetDistribution(value); return *this;}
     ...
     * </p>
     */
    inline CreateDistributionWithTags2017_03_25Result& WithLocation(const Aws::String& value) { SetLocation(value); return *this;}
     ...
     * </p>
     */
    inline CreateDistributionWithTags2017_03_25Result& WithLocation(Aws::String&& value) { SetLocation(std::move(value)); return *this;}
     ...
     * <p>The current version of the distribution created.</p>
     */
    inline CreateDistributionWithTags2017_03_25Result& WithETag(const Aws::String& value) { SetETag(value); return *this;}

    /**
     * <p>The current version of the distribution created.</p>
     */
    inline CreateDistributionWithTags2017_03_25Result& WithETag(Aws::String&& value) { SetETag(std::move(value)); return *this;}
