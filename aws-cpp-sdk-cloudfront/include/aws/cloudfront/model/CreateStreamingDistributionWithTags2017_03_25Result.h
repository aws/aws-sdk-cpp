...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2017-03-25/CreateStreamingDistributionWithTagsResult">AWS
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API CreateStreamingDistributionWithTags2017_03_25Result
  {
  public:
     ...
     * <p>The streaming distribution's information. </p>
     */
    inline CreateStreamingDistributionWithTags2017_03_25Result& WithStreamingDistribution(const StreamingDistribution& value) { SetStreamingDistribution(value); return *this;}
     ...
     * https://cloudfront.amazonaws.com/2010-11-01/streaming-distribution/EGTXBD79H29TRA8</code>.</p>
     */
    inline CreateStreamingDistributionWithTags2017_03_25Result& WithLocation(const Aws::String& value) { SetLocation(value); return *this;}
     ...
     * https://cloudfront.amazonaws.com/2010-11-01/streaming-distribution/EGTXBD79H29TRA8</code>.</p>
     */
    inline CreateStreamingDistributionWithTags2017_03_25Result& WithLocation(Aws::String&& value) { SetLocation(std::move(value)); return *this;}
    ...
    inline CreateStreamingDistributionWithTags2017_03_25Result& WithETag(const Aws::String& value) { SetETag(value); return *this;}

    
    inline CreateStreamingDistributionWithTags2017_03_25Result& WithETag(Aws::String&& value) { SetETag(std::move(value)); return *this;}
