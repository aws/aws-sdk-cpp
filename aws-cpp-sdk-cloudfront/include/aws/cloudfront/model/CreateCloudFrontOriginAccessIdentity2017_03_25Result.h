...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2017-03-25/CreateCloudFrontOriginAccessIdentityResult">AWS
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API CreateCloudFrontOriginAccessIdentity2017_03_25Result
  {
  public:
     ...
     * <p>The origin access identity's information.</p>
     */
    inline CreateCloudFrontOriginAccessIdentity2017_03_25Result& WithCloudFrontOriginAccessIdentity(const CloudFrontOriginAccessIdentity& value) { SetCloudFrontOriginAccessIdentity(value); return *this;}
     ...
     * <code>https://cloudfront.amazonaws.com/2010-11-01/origin-access-identity/cloudfront/E74FTE3AJFJ256A</code>.</p>
     */
    inline CreateCloudFrontOriginAccessIdentity2017_03_25Result& WithLocation(const Aws::String& value) { SetLocation(value); return *this;}
     ...
     * <code>https://cloudfront.amazonaws.com/2010-11-01/origin-access-identity/cloudfront/E74FTE3AJFJ256A</code>.</p>
     */
    inline CreateCloudFrontOriginAccessIdentity2017_03_25Result& WithLocation(Aws::String&& value) { SetLocation(std::move(value)); return *this;}
     ...
     * <p>The current version of the origin access identity created.</p>
     */
    inline CreateCloudFrontOriginAccessIdentity2017_03_25Result& WithETag(const Aws::String& value) { SetETag(value); return *this;}

    /**
     * <p>The current version of the origin access identity created.</p>
     */
    inline CreateCloudFrontOriginAccessIdentity2017_03_25Result& WithETag(Aws::String&& value) { SetETag(std::move(value)); return *this;}
