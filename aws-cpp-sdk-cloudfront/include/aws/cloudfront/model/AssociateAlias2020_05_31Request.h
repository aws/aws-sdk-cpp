...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API AssociateAlias2020_05_31Request : public CloudFrontRequest
  {
  public:
    AssociateAlias2020_05_31Request();
    ...
    */
    virtual Aws::UniquePtr<AssociateAlias2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<AssociateAlias2020_05_31Request>(GetServiceRequestName(), *this);
    }
