...
namespace Model
{
  class AWS_CLOUDFRONT_API CreateOriginAccessControl2020_05_31Result
  {
  public:
    CreateOriginAccessControl2020_05_31Result();
    CreateOriginAccessControl2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    CreateOriginAccessControl2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
