...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API UpdateRealtimeLogConfig2020_05_31Request : public CloudFrontRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRealtimeLogConfig2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<UpdateRealtimeLogConfig2020_05_31Request>(GetServiceRequestName(), *this);
    }
