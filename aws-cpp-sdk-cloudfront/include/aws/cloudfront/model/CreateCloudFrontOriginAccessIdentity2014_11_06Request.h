...
namespace Model
{
  ...
  */
  class AWS_CLOUDFRONT_API CreateCloudFrontOriginAccessIdentity2014_11_06Request : public CloudFrontRequest
  {
  public:
    CreateCloudFrontOriginAccessIdentity2014_11_06Request();
    ...
    */
    ...
    /*
     The origin access identity's configuration information.
    */
    inline CreateCloudFrontOriginAccessIdentity2014_11_06Request&  WithCloudFrontOriginAccessIdentityConfig(const CloudFrontOriginAccessIdentityConfig& value) { SetCloudFrontOriginAccessIdentityConfig(value); return *this;}
