...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API CreateDistribution2020_05_31Request : public CloudFrontRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDistribution2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateDistribution2020_05_31Request>(GetServiceRequestName(), *this);
    }
