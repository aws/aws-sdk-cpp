...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDistribution2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<DeleteDistribution2020_05_31Request>(GetServiceRequestName(), *this);
    }
