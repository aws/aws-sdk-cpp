...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateStreamingDistributionWithTags2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateStreamingDistributionWithTags2020_05_31Request>(GetServiceRequestName(), *this);
    }
