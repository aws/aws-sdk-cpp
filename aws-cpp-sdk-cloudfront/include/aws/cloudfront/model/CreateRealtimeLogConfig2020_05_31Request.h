...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateRealtimeLogConfig2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateRealtimeLogConfig2020_05_31Request>(GetServiceRequestName(), *this);
    }
     ...
     * sending real-time log data.</p>
     */
    inline CreateRealtimeLogConfig2020_05_31Request& WithEndPoints(const Aws::Vector<EndPoint>& value) { SetEndPoints(value); return *this;}

    /**
     * <p>Contains information about the Amazon Kinesis data stream where you are
     * sending real-time log data.</p>
     */
    inline CreateRealtimeLogConfig2020_05_31Request& WithEndPoints(Aws::Vector<EndPoint>&& value) { SetEndPoints(std::move(value)); return *this;}

    /**
     * <p>Contains information about the Amazon Kinesis data stream where you are
     * sending real-time log data.</p>
     */
    inline CreateRealtimeLogConfig2020_05_31Request& AddEndPoints(const EndPoint& value) { m_endPointsHasBeenSet = true; m_endPoints.push_back(value); return *this; }

    /**
     * <p>Contains information about the Amazon Kinesis data stream where you are
     * sending real-time log data.</p>
     */
    inline CreateRealtimeLogConfig2020_05_31Request& AddEndPoints(EndPoint&& value) { m_endPointsHasBeenSet = true; m_endPoints.push_back(std::move(value)); return *this; }
     ...
     * Guide</i>.</p>
     */
    inline CreateRealtimeLogConfig2020_05_31Request& WithFields(const Aws::Vector<Aws::String>& value) { SetFields(value); return *this;}
     ...
     * Guide</i>.</p>
     */
    inline CreateRealtimeLogConfig2020_05_31Request& WithFields(Aws::Vector<Aws::String>&& value) { SetFields(std::move(value)); return *this;}
     ...
     * Guide</i>.</p>
     */
    inline CreateRealtimeLogConfig2020_05_31Request& AddFields(const Aws::String& value) { m_fieldsHasBeenSet = true; m_fields.push_back(value); return *this; }
     ...
     * Guide</i>.</p>
     */
    inline CreateRealtimeLogConfig2020_05_31Request& AddFields(Aws::String&& value) { m_fieldsHasBeenSet = true; m_fields.push_back(std::move(value)); return *this; }
     ...
     * Guide</i>.</p>
     */
    inline CreateRealtimeLogConfig2020_05_31Request& AddFields(const char* value) { m_fieldsHasBeenSet = true; m_fields.push_back(value); return *this; }
     ...
     * <p>A unique name to identify this real-time log configuration.</p>
     */
    inline CreateRealtimeLogConfig2020_05_31Request& WithName(const Aws::String& value) { SetName(value); return *this;}

    /**
     * <p>A unique name to identify this real-time log configuration.</p>
     */
    inline CreateRealtimeLogConfig2020_05_31Request& WithName(Aws::String&& value) { SetName(std::move(value)); return *this;}

    /**
     * <p>A unique name to identify this real-time log configuration.</p>
     */
    inline CreateRealtimeLogConfig2020_05_31Request& WithName(const char* value) { SetName(value); return *this;}
