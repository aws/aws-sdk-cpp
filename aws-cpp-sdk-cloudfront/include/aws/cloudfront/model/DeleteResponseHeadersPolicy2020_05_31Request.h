...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteResponseHeadersPolicy2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<DeleteResponseHeadersPolicy2020_05_31Request>(GetServiceRequestName(), *this);
    }
