...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API ListDistributionsByResponseHeadersPolicyId2020_05_31Request : public CloudFrontRequest
  {
  public:
    ListDistributionsByResponseHeadersPolicyId2020_05_31Request();
    ...
    */
    virtual Aws::UniquePtr<ListDistributionsByResponseHeadersPolicyId2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<ListDistributionsByResponseHeadersPolicyId2020_05_31Request>(GetServiceRequestName(), *this);
    }
