...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDistributions2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<ListDistributions2020_05_31Request>(GetServiceRequestName(), *this);
    }
