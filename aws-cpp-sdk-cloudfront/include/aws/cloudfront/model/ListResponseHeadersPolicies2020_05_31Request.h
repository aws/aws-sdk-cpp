...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API ListResponseHeadersPolicies2020_05_31Request : public CloudFrontRequest
  {
  public:
    ListResponseHeadersPolicies2020_05_31Request();
    ...
    */
    virtual Aws::UniquePtr<ListResponseHeadersPolicies2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<ListResponseHeadersPolicies2020_05_31Request>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListResponseHeadersPolicies"; }
     ...
     * </li> </ul>
     */
    inline ListResponseHeadersPolicies2020_05_31Request& WithType(const ResponseHeadersPolicyType& value) { SetType(value); return *this;}
     ...
     * </li> </ul>
     */
    inline ListResponseHeadersPolicies2020_05_31Request& WithType(ResponseHeadersPolicyType&& value) { SetType(std::move(value)); return *this;}
     ...
     * response.</p>
     */
    inline ListResponseHeadersPolicies2020_05_31Request& WithMaxItems(const Aws::String& value) { SetMaxItems(value); return *this;}

    /**
     * <p>The maximum number of response headers policies that you want to get in the
     * response.</p>
     */
    inline ListResponseHeadersPolicies2020_05_31Request& WithMaxItems(Aws::String&& value) { SetMaxItems(std::move(value)); return *this;}

    /**
     * <p>The maximum number of response headers policies that you want to get in the
     * response.</p>
     */
    inline ListResponseHeadersPolicies2020_05_31Request& WithMaxItems(const char* value) { SetMaxItems(value); return *this;}
