...
namespace Model
{
  class AWS_CLOUDFRONT_API CreateFieldLevelEncryptionProfile2020_05_31Result
  {
  public:
    CreateFieldLevelEncryptionProfile2020_05_31Result();
    CreateFieldLevelEncryptionProfile2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    CreateFieldLevelEncryptionProfile2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
