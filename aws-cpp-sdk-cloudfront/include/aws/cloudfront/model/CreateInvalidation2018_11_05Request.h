...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2018-11-05/CreateInvalidationRequest">AWS
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API CreateInvalidation2018_11_05Request : public CloudFrontRequest
  {
  public:
    CreateInvalidation2018_11_05Request();
     ...
     * <p>The distribution's id.</p>
     */
    inline CreateInvalidation2018_11_05Request& WithDistributionId(const Aws::String& value) { SetDistributionId(value); return *this;}

    /**
     * <p>The distribution's id.</p>
     */
    inline CreateInvalidation2018_11_05Request& WithDistributionId(Aws::String&& value) { SetDistributionId(std::move(value)); return *this;}

    /**
     * <p>The distribution's id.</p>
     */
    inline CreateInvalidation2018_11_05Request& WithDistributionId(const char* value) { SetDistributionId(value); return *this;}
     ...
     * <p>The batch information for the invalidation.</p>
     */
    inline CreateInvalidation2018_11_05Request& WithInvalidationBatch(const InvalidationBatch& value) { SetInvalidationBatch(value); return *this;}

    /**
     * <p>The batch information for the invalidation.</p>
     */
    inline CreateInvalidation2018_11_05Request& WithInvalidationBatch(InvalidationBatch&& value) { SetInvalidationBatch(std::move(value)); return *this;}
