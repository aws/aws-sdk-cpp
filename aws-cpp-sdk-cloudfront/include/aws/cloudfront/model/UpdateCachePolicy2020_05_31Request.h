...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API UpdateCachePolicy2020_05_31Request : public CloudFrontRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCachePolicy2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<UpdateCachePolicy2020_05_31Request>(GetServiceRequestName(), *this);
    }
