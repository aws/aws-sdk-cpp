...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API UpdateDistributionWithStagingConfig2020_05_31Request : public CloudFrontRequest
  {
  public:
    UpdateDistributionWithStagingConfig2020_05_31Request();
