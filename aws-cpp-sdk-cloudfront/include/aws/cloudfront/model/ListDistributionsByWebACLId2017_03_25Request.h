...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2017-03-25/ListDistributionsByWebACLIdRequest">AWS
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API ListDistributionsByWebACLId2017_03_25Request : public CloudFrontRequest
  {
  public:
    ListDistributionsByWebACLId2017_03_25Request();
    
    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() override { return "ListDistributionsByWebACLId"; }
     ...
     * response. (For the first request, omit <code>Marker</code>.) </p>
     */
    inline ListDistributionsByWebACLId2017_03_25Request& WithMarker(const Aws::String& value) { SetMarker(value); return *this;}
     ...
     * response. (For the first request, omit <code>Marker</code>.) </p>
     */
    inline ListDistributionsByWebACLId2017_03_25Request& WithMarker(Aws::String&& value) { SetMarker(std::move(value)); return *this;}
     ...
     * response body. The maximum and default values are both 100.</p>
     */
    inline ListDistributionsByWebACLId2017_03_25Request& WithMaxItems(const Aws::String& value) { SetMaxItems(value); return *this;}

    /**
     * <p>The maximum number of distributions that you want CloudFront to return in the
     * response body. The maximum and default values are both 100.</p>
     */
    inline ListDistributionsByWebACLId2017_03_25Request& WithMaxItems(Aws::String&& value) { SetMaxItems(std::move(value)); return *this;}
     ...
     * the distributions that aren't associated with a web ACL. </p>
     */
    inline ListDistributionsByWebACLId2017_03_25Request& WithWebACLId(const Aws::String& value) { SetWebACLId(value); return *this;}
     ...
     * the distributions that aren't associated with a web ACL. </p>
     */
    inline ListDistributionsByWebACLId2017_03_25Request& WithWebACLId(Aws::String&& value) { SetWebACLId(std::move(value)); return *this;}
