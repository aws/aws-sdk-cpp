...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2019-03-26/FieldPatterns">AWS
   * API Reference</a></p>
   */
  ...
  public:
    FieldPatterns();
    FieldPatterns(const Aws::Utils::Xml::XmlNode& xmlNode);
    FieldPatterns& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
