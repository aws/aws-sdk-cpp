...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateMonitoringSubscription2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateMonitoringSubscription2020_05_31Request>(GetServiceRequestName(), *this);
    }
