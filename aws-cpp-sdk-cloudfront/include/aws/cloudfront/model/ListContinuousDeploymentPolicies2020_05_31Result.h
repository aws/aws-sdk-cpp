...
namespace Model
{
  class AWS_CLOUDFRONT_API ListContinuousDeploymentPolicies2020_05_31Result
  {
  public:
    ListContinuousDeploymentPolicies2020_05_31Result();
    ListContinuousDeploymentPolicies2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ListContinuousDeploymentPolicies2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
