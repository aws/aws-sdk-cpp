...
namespace Model
{
  class AWS_CLOUDFRONT_API CreateRealtimeLogConfig2020_05_31Result
  {
  public:
    CreateRealtimeLogConfig2020_05_31Result();
    CreateRealtimeLogConfig2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    CreateRealtimeLogConfig2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
