...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetFieldLevelEncryption2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<GetFieldLevelEncryption2020_05_31Request>(GetServiceRequestName(), *this);
    }
