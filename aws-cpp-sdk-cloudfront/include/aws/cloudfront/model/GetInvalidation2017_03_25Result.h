...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2017-03-25/GetInvalidationResult">AWS
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API GetInvalidation2017_03_25Result
  {
  public:
     ...
     * Complex Type</a>. </p>
     */
    inline GetInvalidation2017_03_25Result& WithInvalidation(const Invalidation& value) { SetInvalidation(value); return *this;}
