...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateOriginAccessControl2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<UpdateOriginAccessControl2020_05_31Request>(GetServiceRequestName(), *this);
    }
