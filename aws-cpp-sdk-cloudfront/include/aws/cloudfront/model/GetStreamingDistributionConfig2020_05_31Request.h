...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetStreamingDistributionConfig2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<GetStreamingDistributionConfig2020_05_31Request>(GetServiceRequestName(), *this);
    }
