...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetFieldLevelEncryptionProfile2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<GetFieldLevelEncryptionProfile2020_05_31Request>(GetServiceRequestName(), *this);
    }
