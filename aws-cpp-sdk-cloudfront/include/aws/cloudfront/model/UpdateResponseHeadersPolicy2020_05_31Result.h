...
namespace Model
{
  class AWS_CLOUDFRONT_API UpdateResponseHeadersPolicy2020_05_31Result
  {
  public:
    UpdateResponseHeadersPolicy2020_05_31Result();
    UpdateResponseHeadersPolicy2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    UpdateResponseHeadersPolicy2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
