...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateInvalidation2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateInvalidation2020_05_31Request>(GetServiceRequestName(), *this);
    }
