...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2017-03-25/CreateInvalidationResult">AWS
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API CreateInvalidation2017_03_25Result
  {
  public:
     ...
     * including the <code>Invalidation ID</code>.</p>
     */
    inline CreateInvalidation2017_03_25Result& WithLocation(const Aws::String& value) { SetLocation(value); return *this;}

    /**
     * <p>The fully qualified URI of the distribution and invalidation batch request,
     * including the <code>Invalidation ID</code>.</p>
     */
    inline CreateInvalidation2017_03_25Result& WithLocation(Aws::String&& value) { SetLocation(std::move(value)); return *this;}
     ...
     * <p>The invalidation's information.</p>
     */
    inline CreateInvalidation2017_03_25Result& WithInvalidation(const Invalidation& value) { SetInvalidation(value); return *this;}
