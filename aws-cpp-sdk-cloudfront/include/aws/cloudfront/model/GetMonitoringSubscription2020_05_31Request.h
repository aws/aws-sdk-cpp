...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMonitoringSubscription2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<GetMonitoringSubscription2020_05_31Request>(GetServiceRequestName(), *this);
    }
