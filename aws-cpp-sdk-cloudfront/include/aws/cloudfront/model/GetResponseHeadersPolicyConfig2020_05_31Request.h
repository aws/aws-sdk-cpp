...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetResponseHeadersPolicyConfig2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<GetResponseHeadersPolicyConfig2020_05_31Request>(GetServiceRequestName(), *this);
    }
