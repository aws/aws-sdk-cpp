...
namespace Model
{
  ...
  /**
   * The request to list your streaming distributions.<p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2016-01-28/ListStreamingDistributionsRequest">AWS
   * API Reference</a></p>
   */
  ...
  public:
     ...
     * of the last distribution on that page).
     */
    inline ListStreamingDistributions2016_01_28Request& WithMarker(Aws::String&& value) { SetMarker(std::move(value)); return *this;}
     ...
     * The maximum number of streaming distributions you want in the response body.
     */
    inline ListStreamingDistributions2016_01_28Request& WithMaxItems(Aws::String&& value) { SetMaxItems(std::move(value)); return *this;}
