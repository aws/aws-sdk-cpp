...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API CreateFieldLevelEncryptionProfile2018_06_18Request : public CloudFrontRequest
  {
  public:
    CreateFieldLevelEncryptionProfile2018_06_18Request();
     ...
     * <p>The request to create a field-level encryption profile.</p>
     */
    inline CreateFieldLevelEncryptionProfile2018_06_18Request& WithFieldLevelEncryptionProfileConfig(const FieldLevelEncryptionProfileConfig& value) { SetFieldLevelEncryptionProfileConfig(value); return *this;}

    /**
     * <p>The request to create a field-level encryption profile.</p>
     */
    inline CreateFieldLevelEncryptionProfile2018_06_18Request& WithFieldLevelEncryptionProfileConfig(FieldLevelEncryptionProfileConfig&& value) { SetFieldLevelEncryptionProfileConfig(std::move(value)); return *this;}
