...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API ContinuousDeploymentPolicy
  {
  public:
    ContinuousDeploymentPolicy();
    ContinuousDeploymentPolicy(const Aws::Utils::Xml::XmlNode& xmlNode);
    ContinuousDeploymentPolicy& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
