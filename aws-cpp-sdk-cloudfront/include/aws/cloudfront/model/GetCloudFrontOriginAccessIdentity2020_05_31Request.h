...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API GetCloudFrontOriginAccessIdentity2020_05_31Request : public CloudFrontRequest
  {
  public:
    GetCloudFrontOriginAccessIdentity2020_05_31Request();
    ...
    */
    virtual Aws::UniquePtr<GetCloudFrontOriginAccessIdentity2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<GetCloudFrontOriginAccessIdentity2020_05_31Request>(GetServiceRequestName(), *this);
    }
