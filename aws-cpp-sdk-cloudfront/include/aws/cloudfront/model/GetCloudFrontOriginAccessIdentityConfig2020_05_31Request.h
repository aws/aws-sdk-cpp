...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCloudFrontOriginAccessIdentityConfig2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<GetCloudFrontOriginAccessIdentityConfig2020_05_31Request>(GetServiceRequestName(), *this);
    }
