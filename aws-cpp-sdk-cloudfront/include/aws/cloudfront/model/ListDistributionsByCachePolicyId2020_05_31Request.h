...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDistributionsByCachePolicyId2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<ListDistributionsByCachePolicyId2020_05_31Request>(GetServiceRequestName(), *this);
    }
