...
namespace Model
{
  class AWS_CLOUDFRONT_API GetOriginAccessControl2020_05_31Result
  {
  public:
    GetOriginAccessControl2020_05_31Result();
    GetOriginAccessControl2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    GetOriginAccessControl2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
