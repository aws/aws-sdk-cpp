...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API StagingDistributionDnsNames
  {
  public:
    StagingDistributionDnsNames();
    StagingDistributionDnsNames(const Aws::Utils::Xml::XmlNode& xmlNode);
    StagingDistributionDnsNames& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
