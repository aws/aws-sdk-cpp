...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API GetPublicKey2020_05_31Request : public CloudFrontRequest
  {
  public:
    GetPublicKey2020_05_31Request();
    ...
    */
    virtual Aws::UniquePtr<GetPublicKey2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<GetPublicKey2020_05_31Request>(GetServiceRequestName(), *this);
    }
