...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API UpdateCloudFrontOriginAccessIdentity2020_05_31Request : public CloudFrontRequest
  {
  public:
    UpdateCloudFrontOriginAccessIdentity2020_05_31Request();
    ...
    */
    virtual Aws::UniquePtr<UpdateCloudFrontOriginAccessIdentity2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<UpdateCloudFrontOriginAccessIdentity2020_05_31Request>(GetServiceRequestName(), *this);
    }
