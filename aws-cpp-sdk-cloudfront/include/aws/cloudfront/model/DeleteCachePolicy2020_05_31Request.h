...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCachePolicy2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<DeleteCachePolicy2020_05_31Request>(GetServiceRequestName(), *this);
    }
