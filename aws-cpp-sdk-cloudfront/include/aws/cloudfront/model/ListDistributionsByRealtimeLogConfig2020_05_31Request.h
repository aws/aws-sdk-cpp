...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDistributionsByRealtimeLogConfig2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<ListDistributionsByRealtimeLogConfig2020_05_31Request>(GetServiceRequestName(), *this);
    }
