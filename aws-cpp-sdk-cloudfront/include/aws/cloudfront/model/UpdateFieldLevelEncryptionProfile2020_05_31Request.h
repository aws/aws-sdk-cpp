...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFieldLevelEncryptionProfile2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<UpdateFieldLevelEncryptionProfile2020_05_31Request>(GetServiceRequestName(), *this);
    }
