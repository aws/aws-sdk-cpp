...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API SessionStickinessConfig
  {
  public:
    SessionStickinessConfig();
    SessionStickinessConfig(const Aws::Utils::Xml::XmlNode& xmlNode);
    SessionStickinessConfig& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
