...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API CreatePublicKey2018_06_18Request : public CloudFrontRequest
  {
  public:
    CreatePublicKey2018_06_18Request();
     ...
     * <p>The request to add a public key to CloudFront.</p>
     */
    inline CreatePublicKey2018_06_18Request& WithPublicKeyConfig(const PublicKeyConfig& value) { SetPublicKeyConfig(value); return *this;}

    /**
     * <p>The request to add a public key to CloudFront.</p>
     */
    inline CreatePublicKey2018_06_18Request& WithPublicKeyConfig(PublicKeyConfig&& value) { SetPublicKeyConfig(std::move(value)); return *this;}
