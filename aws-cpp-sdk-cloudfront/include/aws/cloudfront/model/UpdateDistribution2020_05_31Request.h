...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDistribution2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<UpdateDistribution2020_05_31Request>(GetServiceRequestName(), *this);
    }
