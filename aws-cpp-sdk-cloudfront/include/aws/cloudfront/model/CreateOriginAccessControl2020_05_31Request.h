...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API CreateOriginAccessControl2020_05_31Request : public CloudFrontRequest
  {
  public:
    CreateOriginAccessControl2020_05_31Request();
    ...
    */
    virtual Aws::UniquePtr<CreateOriginAccessControl2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateOriginAccessControl2020_05_31Request>(GetServiceRequestName(), *this);
    }
