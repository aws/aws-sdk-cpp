...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateStreamingDistribution2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateStreamingDistribution2020_05_31Request>(GetServiceRequestName(), *this);
    }
