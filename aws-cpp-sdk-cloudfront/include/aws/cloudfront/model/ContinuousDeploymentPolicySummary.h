...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API ContinuousDeploymentPolicySummary
  {
  public:
    ContinuousDeploymentPolicySummary();
    ContinuousDeploymentPolicySummary(const Aws::Utils::Xml::XmlNode& xmlNode);
    ContinuousDeploymentPolicySummary& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
