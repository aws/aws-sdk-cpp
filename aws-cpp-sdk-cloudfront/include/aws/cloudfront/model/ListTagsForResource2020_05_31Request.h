...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTagsForResource2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<ListTagsForResource2020_05_31Request>(GetServiceRequestName(), *this);
    }
