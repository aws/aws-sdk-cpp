...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API ListDistributionsByWebACLId2020_05_31Request : public CloudFrontRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDistributionsByWebACLId2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<ListDistributionsByWebACLId2020_05_31Request>(GetServiceRequestName(), *this);
    }
