...
namespace Model
{
  class AWS_CLOUDFRONT_API GetResponseHeadersPolicyConfig2020_05_31Result
  {
  public:
    GetResponseHeadersPolicyConfig2020_05_31Result();
    GetResponseHeadersPolicyConfig2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    GetResponseHeadersPolicyConfig2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
