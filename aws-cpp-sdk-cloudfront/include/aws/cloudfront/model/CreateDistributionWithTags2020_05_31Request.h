...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDistributionWithTags2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateDistributionWithTags2020_05_31Request>(GetServiceRequestName(), *this);
    }
