...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateOriginRequestPolicy2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<UpdateOriginRequestPolicy2020_05_31Request>(GetServiceRequestName(), *this);
    }
