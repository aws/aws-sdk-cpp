...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFieldLevelEncryptionProfile2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<DeleteFieldLevelEncryptionProfile2020_05_31Request>(GetServiceRequestName(), *this);
    }
