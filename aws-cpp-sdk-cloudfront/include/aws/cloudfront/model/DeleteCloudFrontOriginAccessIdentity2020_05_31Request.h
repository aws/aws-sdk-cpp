...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCloudFrontOriginAccessIdentity2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<DeleteCloudFrontOriginAccessIdentity2020_05_31Request>(GetServiceRequestName(), *this);
    }
