...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCloudFrontOriginAccessIdentity2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateCloudFrontOriginAccessIdentity2020_05_31Request>(GetServiceRequestName(), *this);
    }
