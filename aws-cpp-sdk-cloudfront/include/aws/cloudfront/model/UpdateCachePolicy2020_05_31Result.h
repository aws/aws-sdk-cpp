...
namespace Model
{
  class AWS_CLOUDFRONT_API UpdateCachePolicy2020_05_31Result
  {
  public:
    UpdateCachePolicy2020_05_31Result();
    UpdateCachePolicy2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    UpdateCachePolicy2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
