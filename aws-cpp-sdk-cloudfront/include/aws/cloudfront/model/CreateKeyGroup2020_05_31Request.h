...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API CreateKeyGroup2020_05_31Request : public CloudFrontRequest
  {
  public:
    CreateKeyGroup2020_05_31Request();
    ...
    */
    virtual Aws::UniquePtr<CreateKeyGroup2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateKeyGroup2020_05_31Request>(GetServiceRequestName(), *this);
    }
