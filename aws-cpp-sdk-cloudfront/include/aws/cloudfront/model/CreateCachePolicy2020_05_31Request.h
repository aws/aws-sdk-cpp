...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API CreateCachePolicy2020_05_31Request : public CloudFrontRequest
  {
  public:
    CreateCachePolicy2020_05_31Request();
    ...
    */
    virtual Aws::UniquePtr<CreateCachePolicy2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateCachePolicy2020_05_31Request>(GetServiceRequestName(), *this);
    }
