...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API OriginAccessControlConfig
  {
  public:
    OriginAccessControlConfig();
    OriginAccessControlConfig(const Aws::Utils::Xml::XmlNode& xmlNode);
    OriginAccessControlConfig& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
