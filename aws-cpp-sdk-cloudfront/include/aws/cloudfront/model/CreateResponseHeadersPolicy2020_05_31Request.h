...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateResponseHeadersPolicy2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<CreateResponseHeadersPolicy2020_05_31Request>(GetServiceRequestName(), *this);
    }
