...
namespace Model
{
  class AWS_CLOUDFRONT_API ListCachePolicies2020_05_31Result
  {
  public:
    ListCachePolicies2020_05_31Result();
    ListCachePolicies2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ListCachePolicies2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
