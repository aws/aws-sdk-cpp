...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2018-06-18/CreateDistributionRequest">AWS
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API CreateDistribution2018_06_18Request : public CloudFrontRequest
  {
  public:
    CreateDistribution2018_06_18Request();
     ...
     * <p>The distribution's configuration information.</p>
     */
    inline CreateDistribution2018_06_18Request& WithDistributionConfig(const DistributionConfig& value) { SetDistributionConfig(value); return *this;}

    /**
     * <p>The distribution's configuration information.</p>
     */
    inline CreateDistribution2018_06_18Request& WithDistributionConfig(DistributionConfig&& value) { SetDistributionConfig(std::move(value)); return *this;}
