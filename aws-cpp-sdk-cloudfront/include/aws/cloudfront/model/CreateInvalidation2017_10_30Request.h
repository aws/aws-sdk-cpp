...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2017-10-30/CreateInvalidationRequest">AWS
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API CreateInvalidation2017_10_30Request : public CloudFrontRequest
  {
  public:
    CreateInvalidation2017_10_30Request();
     ...
     * <p>The distribution's id.</p>
     */
    inline CreateInvalidation2017_10_30Request& WithDistributionId(const Aws::String& value) { SetDistributionId(value); return *this;}

    /**
     * <p>The distribution's id.</p>
     */
    inline CreateInvalidation2017_10_30Request& WithDistributionId(Aws::String&& value) { SetDistributionId(std::move(value)); return *this;}

    /**
     * <p>The distribution's id.</p>
     */
    inline CreateInvalidation2017_10_30Request& WithDistributionId(const char* value) { SetDistributionId(value); return *this;}
     ...
     * <p>The batch information for the invalidation.</p>
     */
    inline CreateInvalidation2017_10_30Request& WithInvalidationBatch(const InvalidationBatch& value) { SetInvalidationBatch(value); return *this;}

    /**
     * <p>The batch information for the invalidation.</p>
     */
    inline CreateInvalidation2017_10_30Request& WithInvalidationBatch(InvalidationBatch&& value) { SetInvalidationBatch(std::move(value)); return *this;}
