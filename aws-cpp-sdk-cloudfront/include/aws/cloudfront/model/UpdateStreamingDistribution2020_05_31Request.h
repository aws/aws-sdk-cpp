...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API UpdateStreamingDistribution2020_05_31Request : public CloudFrontRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateStreamingDistribution2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<UpdateStreamingDistribution2020_05_31Request>(GetServiceRequestName(), *this);
    }
