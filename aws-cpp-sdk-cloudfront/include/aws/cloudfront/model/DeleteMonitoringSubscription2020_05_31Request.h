...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteMonitoringSubscription2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<DeleteMonitoringSubscription2020_05_31Request>(GetServiceRequestName(), *this);
    }
