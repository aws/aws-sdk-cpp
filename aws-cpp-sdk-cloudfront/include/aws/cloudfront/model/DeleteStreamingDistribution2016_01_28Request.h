...
namespace Model
{
  ...
  public:
     ...
     * The distribution id.
     */
    inline DeleteStreamingDistribution2016_01_28Request& WithId(Aws::String&& value) { SetId(std::move(value)); return *this;}
     ...
     * distribution. For example: E2QWRUHAPOMQZL.
     */
    inline DeleteStreamingDistribution2016_01_28Request& WithIfMatch(Aws::String&& value) { SetIfMatch(std::move(value)); return *this;}
