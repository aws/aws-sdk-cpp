...
namespace Model
{
  class AWS_CLOUDFRONT_API UpdateOriginAccessControl2020_05_31Result
  {
  public:
    UpdateOriginAccessControl2020_05_31Result();
    UpdateOriginAccessControl2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    UpdateOriginAccessControl2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
