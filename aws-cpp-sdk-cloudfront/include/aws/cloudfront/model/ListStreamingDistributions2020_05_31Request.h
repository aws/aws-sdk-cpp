...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListStreamingDistributions2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<ListStreamingDistributions2020_05_31Request>(GetServiceRequestName(), *this);
    }
