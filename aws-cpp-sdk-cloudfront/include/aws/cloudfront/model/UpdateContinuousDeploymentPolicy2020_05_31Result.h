...
namespace Model
{
  class AWS_CLOUDFRONT_API UpdateContinuousDeploymentPolicy2020_05_31Result
  {
  public:
    UpdateContinuousDeploymentPolicy2020_05_31Result();
    UpdateContinuousDeploymentPolicy2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    UpdateContinuousDeploymentPolicy2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
