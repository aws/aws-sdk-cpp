...
namespace Model
{
  ...
  */
  class AWS_CLOUDFRONT_API UpdateDistribution2015_04_17Request : public CloudFrontRequest
  {
  public:
    UpdateDistribution2015_04_17Request();
    ...
    */
    ...
    /*
     The distribution's id.
    */
    inline UpdateDistribution2015_04_17Request& WithId(const char* value) { SetId(value); return *this;}
    ...
    */
    ...
    /*
     The value of the ETag header you received when retrieving the distribution's configuration. For example: E2QWRUHAPOMQZL.
    */
    inline UpdateDistribution2015_04_17Request& WithIfMatch(const char* value) { SetIfMatch(value); return *this;}
