...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The Region for Origin Shield.</p> <p>Specify the Region that has the lowest
     ...
     * <code>us-east-2</code>.</p> <p>When you enable CloudFront Origin Shield, you
     * must specify the Region for Origin Shield. For the list of Regions that you can
     * specify, and for help choosing the best Region for your origin, see <a
