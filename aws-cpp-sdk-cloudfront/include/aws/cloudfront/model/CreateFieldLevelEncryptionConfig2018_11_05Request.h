...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API CreateFieldLevelEncryptionConfig2018_11_05Request : public CloudFrontRequest
  {
  public:
    CreateFieldLevelEncryptionConfig2018_11_05Request();
     ...
     * <p>The request to create a new field-level encryption configuration.</p>
     */
    inline CreateFieldLevelEncryptionConfig2018_11_05Request& WithFieldLevelEncryptionConfig(const FieldLevelEncryptionConfig& value) { SetFieldLevelEncryptionConfig(value); return *this;}

    /**
     * <p>The request to create a new field-level encryption configuration.</p>
     */
    inline CreateFieldLevelEncryptionConfig2018_11_05Request& WithFieldLevelEncryptionConfig(FieldLevelEncryptionConfig&& value) { SetFieldLevelEncryptionConfig(std::move(value)); return *this;}
