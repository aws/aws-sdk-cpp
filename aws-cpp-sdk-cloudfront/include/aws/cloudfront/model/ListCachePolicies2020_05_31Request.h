...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCachePolicies2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<ListCachePolicies2020_05_31Request>(GetServiceRequestName(), *this);
    }
