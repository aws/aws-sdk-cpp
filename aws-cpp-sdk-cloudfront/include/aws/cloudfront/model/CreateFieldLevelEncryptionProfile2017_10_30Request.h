...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API CreateFieldLevelEncryptionProfile2017_10_30Request : public CloudFrontRequest
  {
  public:
    CreateFieldLevelEncryptionProfile2017_10_30Request();
     ...
     * <p>The request to create a field-level encryption profile.</p>
     */
    inline CreateFieldLevelEncryptionProfile2017_10_30Request& WithFieldLevelEncryptionProfileConfig(const FieldLevelEncryptionProfileConfig& value) { SetFieldLevelEncryptionProfileConfig(value); return *this;}

    /**
     * <p>The request to create a field-level encryption profile.</p>
     */
    inline CreateFieldLevelEncryptionProfile2017_10_30Request& WithFieldLevelEncryptionProfileConfig(FieldLevelEncryptionProfileConfig&& value) { SetFieldLevelEncryptionProfileConfig(std::move(value)); return *this;}
