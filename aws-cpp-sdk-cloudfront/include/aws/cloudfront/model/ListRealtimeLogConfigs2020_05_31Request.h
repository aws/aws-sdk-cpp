...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRealtimeLogConfigs2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<ListRealtimeLogConfigs2020_05_31Request>(GetServiceRequestName(), *this);
    }
