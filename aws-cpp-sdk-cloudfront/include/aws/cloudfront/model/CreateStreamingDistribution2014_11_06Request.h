...
namespace Model
{
  ...
  */
  class AWS_CLOUDFRONT_API CreateStreamingDistribution2014_11_06Request : public CloudFrontRequest
  {
  public:
    CreateStreamingDistribution2014_11_06Request();
    ...
    */
    ...
    /*
     The streaming distribution's configuration information.
    */
    inline CreateStreamingDistribution2014_11_06Request&  WithStreamingDistributionConfig(const StreamingDistributionConfig& value) { SetStreamingDistributionConfig(value); return *this;}
