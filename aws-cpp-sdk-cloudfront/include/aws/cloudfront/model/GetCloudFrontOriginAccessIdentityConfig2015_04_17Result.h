...
namespace Model
{
  ...
  */
  class AWS_CLOUDFRONT_API GetCloudFrontOriginAccessIdentityConfig2015_04_17Result
  {
  public:
    GetCloudFrontOriginAccessIdentityConfig2015_04_17Result();
    GetCloudFrontOriginAccessIdentityConfig2015_04_17Result(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    GetCloudFrontOriginAccessIdentityConfig2015_04_17Result& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    */
    ...
    /*
     The current version of the configuration. For example: E2QWRUHAPOMQZL.
    */
    inline GetCloudFrontOriginAccessIdentityConfig2015_04_17Result& WithETag(const char* value) { SetETag(value); return *this;}
