...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2017-03-25/ListInvalidationsRequest">AWS
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API ListInvalidations2017_03_25Request : public CloudFrontRequest
  {
  public:
    ListInvalidations2017_03_25Request();
    
    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() override { return "ListInvalidations"; }
     ...
     * <p>The distribution's ID.</p>
     */
    inline ListInvalidations2017_03_25Request& WithDistributionId(const Aws::String& value) { SetDistributionId(value); return *this;}

    /**
     * <p>The distribution's ID.</p>
     */
    inline ListInvalidations2017_03_25Request& WithDistributionId(Aws::String&& value) { SetDistributionId(std::move(value)); return *this;}
     ...
     * invalidation batch on that page. </p>
     */
    inline ListInvalidations2017_03_25Request& WithMarker(const Aws::String& value) { SetMarker(value); return *this;}
     ...
     * invalidation batch on that page. </p>
     */
    inline ListInvalidations2017_03_25Request& WithMarker(Aws::String&& value) { SetMarker(std::move(value)); return *this;}
     ...
     * body.</p>
     */
    inline ListInvalidations2017_03_25Request& WithMaxItems(const Aws::String& value) { SetMaxItems(value); return *this;}

    /**
     * <p>The maximum number of invalidation batches that you want in the response
     * body.</p>
     */
    inline ListInvalidations2017_03_25Request& WithMaxItems(Aws::String&& value) { SetMaxItems(std::move(value)); return *this;}
