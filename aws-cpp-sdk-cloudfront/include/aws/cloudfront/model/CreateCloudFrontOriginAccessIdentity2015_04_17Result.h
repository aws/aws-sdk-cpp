...
namespace Model
{
  ...
  */
  class AWS_CLOUDFRONT_API CreateCloudFrontOriginAccessIdentity2015_04_17Result
  {
  public:
    CreateCloudFrontOriginAccessIdentity2015_04_17Result();
    CreateCloudFrontOriginAccessIdentity2015_04_17Result(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    CreateCloudFrontOriginAccessIdentity2015_04_17Result& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    */
    ...
    /*
     The fully qualified URI of the new origin access identity just created. For example: https://cloudfront.amazonaws.com/2010-11-01/origin-access-identity/cloudfront/E74FTE3AJFJ256A.
    */
    inline CreateCloudFrontOriginAccessIdentity2015_04_17Result& WithLocation(const char* value) { SetLocation(value); return *this;}
    ...
    */
    ...
    /*
     The current version of the origin access identity created.
    */
    inline CreateCloudFrontOriginAccessIdentity2015_04_17Result& WithETag(const char* value) { SetETag(value); return *this;}
