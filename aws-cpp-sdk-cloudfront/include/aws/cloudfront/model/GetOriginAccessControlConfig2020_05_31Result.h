...
namespace Model
{
  class AWS_CLOUDFRONT_API GetOriginAccessControlConfig2020_05_31Result
  {
  public:
    GetOriginAccessControlConfig2020_05_31Result();
    GetOriginAccessControlConfig2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    GetOriginAccessControlConfig2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
