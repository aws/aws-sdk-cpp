...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2017-03-25/UpdateCloudFrontOriginAccessIdentityRequest">AWS
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API UpdateCloudFrontOriginAccessIdentity2017_03_25Request : public CloudFrontRequest
  {
  public:
    UpdateCloudFrontOriginAccessIdentity2017_03_25Request();
    
    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() override { return "UpdateCloudFrontOriginAccessIdentity"; }
     ...
     * <p>The identity's configuration information.</p>
     */
    inline UpdateCloudFrontOriginAccessIdentity2017_03_25Request& WithCloudFrontOriginAccessIdentityConfig(const CloudFrontOriginAccessIdentityConfig& value) { SetCloudFrontOriginAccessIdentityConfig(value); return *this;}
     ...
     * <p>The identity's id.</p>
     */
    inline UpdateCloudFrontOriginAccessIdentity2017_03_25Request& WithId(const Aws::String& value) { SetId(value); return *this;}

    /**
     * <p>The identity's id.</p>
     */
    inline UpdateCloudFrontOriginAccessIdentity2017_03_25Request& WithId(Aws::String&& value) { SetId(std::move(value)); return *this;}
     ...
     * the identity's configuration. For example: <code>E2QWRUHAPOMQZL</code>.</p>
     */
    inline UpdateCloudFrontOriginAccessIdentity2017_03_25Request& WithIfMatch(const Aws::String& value) { SetIfMatch(value); return *this;}

    /**
     * <p>The value of the <code>ETag</code> header that you received when retrieving
     * the identity's configuration. For example: <code>E2QWRUHAPOMQZL</code>.</p>
     */
    inline UpdateCloudFrontOriginAccessIdentity2017_03_25Request& WithIfMatch(Aws::String&& value) { SetIfMatch(std::move(value)); return *this;}
