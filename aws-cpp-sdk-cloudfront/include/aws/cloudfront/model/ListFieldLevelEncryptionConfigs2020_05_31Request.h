...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFieldLevelEncryptionConfigs2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<ListFieldLevelEncryptionConfigs2020_05_31Request>(GetServiceRequestName(), *this);
    }
