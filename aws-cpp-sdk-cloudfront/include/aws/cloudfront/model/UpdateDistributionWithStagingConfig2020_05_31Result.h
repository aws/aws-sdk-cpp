...
namespace Model
{
  class AWS_CLOUDFRONT_API UpdateDistributionWithStagingConfig2020_05_31Result
  {
  public:
    UpdateDistributionWithStagingConfig2020_05_31Result();
    UpdateDistributionWithStagingConfig2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    UpdateDistributionWithStagingConfig2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
