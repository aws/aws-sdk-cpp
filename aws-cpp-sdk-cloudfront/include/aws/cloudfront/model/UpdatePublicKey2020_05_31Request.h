...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFRONT_API UpdatePublicKey2020_05_31Request : public CloudFrontRequest
  {
  public:
    UpdatePublicKey2020_05_31Request();
    ...
    */
    virtual Aws::UniquePtr<UpdatePublicKey2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<UpdatePublicKey2020_05_31Request>(GetServiceRequestName(), *this);
    }
