...
namespace Model
{
  class AWS_CLOUDFRONT_API GetFieldLevelEncryptionConfig2020_05_31Result
  {
  public:
    GetFieldLevelEncryptionConfig2020_05_31Result();
    GetFieldLevelEncryptionConfig2020_05_31Result(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    GetFieldLevelEncryptionConfig2020_05_31Result& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
