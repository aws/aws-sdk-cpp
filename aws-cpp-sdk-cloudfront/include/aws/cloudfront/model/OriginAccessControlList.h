...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFRONT_API OriginAccessControlList
  {
  public:
    OriginAccessControlList();
    OriginAccessControlList(const Aws::Utils::Xml::XmlNode& xmlNode);
    OriginAccessControlList& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
