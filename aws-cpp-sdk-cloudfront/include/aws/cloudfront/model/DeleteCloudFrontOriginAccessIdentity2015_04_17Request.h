...
namespace Model
{
   ...
   */
  class AWS_CLOUDFRONT_API DeleteCloudFrontOriginAccessIdentity2015_04_17Request : public CloudFrontRequest
  {
  public:
    DeleteCloudFrontOriginAccessIdentity2015_04_17Request();
     ...
     * The origin access identity's id.
     */
    inline DeleteCloudFrontOriginAccessIdentity2015_04_17Request& WithId(const char* value) { SetId(value); return *this;}
     ...
     * For example: E2QWRUHAPOMQZL.
     */
    inline DeleteCloudFrontOriginAccessIdentity2015_04_17Request& WithIfMatch(const char* value) { SetIfMatch(value); return *this;}
