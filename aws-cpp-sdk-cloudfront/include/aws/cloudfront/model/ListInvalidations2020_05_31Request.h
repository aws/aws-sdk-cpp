...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListInvalidations2020_05_31Request> Clone() const
    {
      return Aws::MakeUnique<ListInvalidations2020_05_31Request>(GetServiceRequestName(), *this);
    }
