...
namespace Model
{
  ...
  */
  class AWS_CLOUDFRONT_API CreateInvalidation2014_11_06Request : public CloudFrontRequest
  {
  public:
    CreateInvalidation2014_11_06Request();
    ...
    */
    ...
    /*
     The distribution's id.
    */
    inline CreateInvalidation2014_11_06Request&  WithDistributionId(const Aws::String& value) { SetDistributionId(value); return *this;}

    /*
     The distribution's id.
    */
    inline CreateInvalidation2014_11_06Request& WithDistributionId(const char* value) { SetDistributionId(value); return *this;}
    ...
    */
    ...
    /*
     The batch information for the invalidation.
    */
    inline CreateInvalidation2014_11_06Request&  WithInvalidationBatch(const InvalidationBatch& value) { SetInvalidationBatch(value); return *this;}
