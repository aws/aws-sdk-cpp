...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>This field is <code>true</code> if any of the AWS accounts in the list have
    ...
    /**
     * <p>A list of AWS accounts and the identifiers of active CloudFront key pairs in
