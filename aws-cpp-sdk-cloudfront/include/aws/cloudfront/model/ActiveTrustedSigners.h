...
namespace Model
{
  ...
  /**
   * <p>A list of accounts and the active CloudFront key pairs in each account that
  ...
  public:
    ...
    /**
     * <p>This field is <code>true</code> if any of the accounts in the list have
     * active CloudFront key pairs that CloudFront can use to verify the signatures of
     * signed URLs and signed cookies. If not, this field is <code>false</code>.</p>
     */
    ...
    /**
     * <p>A list of accounts and the identifiers of active CloudFront key pairs in each
