...
namespace CloudFront
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudFrontClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::CloudFrontEndpointProvider> endpointProvider = Aws::MakeShared<CloudFront::Endpoint::CloudFrontEndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::CloudFrontEndpointProvider> m_endpointProvider;
  };
