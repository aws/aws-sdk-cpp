...
Aws::String SsmSapEndpointRules::GetRulesAsString()
{
    return Aws::String(SsmSapEndpointRules::Rules.begin(), SsmSapEndpointRules::Rules.end());
}

const Aws::Vector<char> SsmSapEndpointRules::Rules = {
...
':','"','h','t','t','p','s',':','/','/','s','s','m','-','s','a','p','-','f','i','p','s','.','{','R',
...
'p','s',':','/','/','s','s','m','-','s','a','p','.','{','R','e','g','i','o','n','}','.','{','P','a',
