...
using ResolveEndpointOutcome = Aws::ECRPublic::Endpoint::ECRPublicEndpointProvider::ECRPublicResolveEndpointOutcome;
...
ECRPublicClient::ECRPublicClient(const Client::ClientConfiguration& clientConfiguration,
                                 std::shared_ptr<Endpoint::ECRPublicEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ECRPublicErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ECRPublic::Endpoint::ECRPublicEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
