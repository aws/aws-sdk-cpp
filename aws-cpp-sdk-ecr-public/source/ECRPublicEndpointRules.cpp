...
Aws::String ECRPublicEndpointRules::GetRulesAsString()
{
    return Aws::String(ECRPublicEndpointRules::Rules.begin(), ECRPublicEndpointRules::Rules.end());
}

const Aws::Vector<char> ECRPublicEndpointRules::Rules = {
...
'c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n','t','"',
':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','i','.','e','c','r','-',
'p','u','b','l','i','c','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'r','-','p','u','b','l','i','c','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
