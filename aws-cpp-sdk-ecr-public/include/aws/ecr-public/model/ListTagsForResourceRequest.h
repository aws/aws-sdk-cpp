...
namespace Model
{
  ...
  /**
   */
  class ListTagsForResourceRequest : public ECRPublicRequest
  {
  public:
    AWS_ECRPUBLIC_API ListTagsForResourceRequest();
     ...
     * for. Currently, the supported resource is an Amazon ECR Public repository.</p>
     */
