...
namespace Model
{
  ...
  /**
   */
  class AWS_ECRPUBLIC_API BatchDeleteImageRequest : public ECRPublicRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDeleteImageRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDeleteImageRequest>(GetServiceRequestName(), *this);
    }
