...
namespace Model
{
  ...
  /**
   */
  class AWS_ECRPUBLIC_API DescribeImageTagsRequest : public ECRPublicRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeImageTagsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeImageTagsRequest>(GetServiceRequestName(), *this);
    }
