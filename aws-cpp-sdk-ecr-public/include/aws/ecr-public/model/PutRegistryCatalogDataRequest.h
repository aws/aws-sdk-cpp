...
namespace Model
{
  ...
  /**
   */
  class AWS_ECRPUBLIC_API PutRegistryCatalogDataRequest : public ECRPublicRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutRegistryCatalogDataRequest> Clone() const
    {
      return Aws::MakeUnique<PutRegistryCatalogDataRequest>(GetServiceRequestName(), *this);
    }
