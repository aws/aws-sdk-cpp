...
namespace Model
{
  ...
  /**
   */
  class AWS_ECRPUBLIC_API PutImageRequest : public ECRPublicRequest
  {
  public:
    PutImageRequest();
    ...
    */
    virtual Aws::UniquePtr<PutImageRequest> Clone() const
    {
      return Aws::MakeUnique<PutImageRequest>(GetServiceRequestName(), *this);
    }
