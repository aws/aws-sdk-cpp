...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ECRPUBLIC_API RepositoryCatalogData
  {
  public:
    RepositoryCatalogData();
    RepositoryCatalogData(Aws::Utils::Json::JsonView jsonValue);
    RepositoryCatalogData& operator=(Aws::Utils::Json::JsonView jsonValue);
