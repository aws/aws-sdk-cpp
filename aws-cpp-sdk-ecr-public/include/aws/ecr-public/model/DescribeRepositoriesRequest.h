...
namespace Model
{
  ...
  /**
   */
  class AWS_ECRPUBLIC_API DescribeRepositoriesRequest : public ECRPublicRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRepositoriesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRepositoriesRequest>(GetServiceRequestName(), *this);
    }
