...
namespace Model
{
  ...
  /**
   */
  class AWS_ECRPUBLIC_API DescribeRegistriesRequest : public ECRPublicRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRegistriesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRegistriesRequest>(GetServiceRequestName(), *this);
    }
