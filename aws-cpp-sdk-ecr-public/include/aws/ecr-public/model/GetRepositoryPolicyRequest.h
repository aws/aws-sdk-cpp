...
namespace Model
{
  ...
  /**
   */
  class AWS_ECRPUBLIC_API GetRepositoryPolicyRequest : public ECRPublicRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRepositoryPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetRepositoryPolicyRequest>(GetServiceRequestName(), *this);
    }
