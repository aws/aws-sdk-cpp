...
namespace ECRPublic
{
  ...
  class AWS_ECRPUBLIC_API ECRPublicClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ECRPublicClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::ECRPublicEndpointProvider> endpointProvider = Aws::MakeShared<ECRPublic::Endpoint::ECRPublicEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ECRPublicEndpointProvider> m_endpointProvider;
  };
