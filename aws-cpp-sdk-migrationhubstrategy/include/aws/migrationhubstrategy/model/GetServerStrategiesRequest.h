...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API GetServerStrategiesRequest : public MigrationHubStrategyRecommendationsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetServerStrategiesRequest> Clone() const
    {
      return Aws::MakeUnique<GetServerStrategiesRequest>(GetServiceRequestName(), *this);
    }
