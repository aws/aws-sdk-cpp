...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API ListApplicationComponentsRequest : public MigrationHubStrategyRecommendationsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListApplicationComponentsRequest> Clone() const
    {
      return Aws::MakeUnique<ListApplicationComponentsRequest>(GetServiceRequestName(), *this);
    }
