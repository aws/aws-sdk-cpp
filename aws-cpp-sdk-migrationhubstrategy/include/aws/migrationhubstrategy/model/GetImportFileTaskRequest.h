...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API GetImportFileTaskRequest : public MigrationHubStrategyRecommendationsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetImportFileTaskRequest> Clone() const
    {
      return Aws::MakeUnique<GetImportFileTaskRequest>(GetServiceRequestName(), *this);
    }
