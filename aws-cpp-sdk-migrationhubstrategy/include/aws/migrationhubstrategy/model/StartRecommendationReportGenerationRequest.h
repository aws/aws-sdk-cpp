...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API StartRecommendationReportGenerationRequest : public MigrationHubStrategyRecommendationsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartRecommendationReportGenerationRequest> Clone() const
    {
      return Aws::MakeUnique<StartRecommendationReportGenerationRequest>(GetServiceRequestName(), *this);
    }
