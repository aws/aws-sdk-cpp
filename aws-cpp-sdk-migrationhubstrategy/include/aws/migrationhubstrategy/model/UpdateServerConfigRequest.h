...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API UpdateServerConfigRequest : public MigrationHubStrategyRecommendationsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateServerConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateServerConfigRequest>(GetServiceRequestName(), *this);
    }
