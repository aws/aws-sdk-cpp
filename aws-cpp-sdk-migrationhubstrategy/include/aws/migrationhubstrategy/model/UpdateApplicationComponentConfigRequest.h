...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateApplicationComponentConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateApplicationComponentConfigRequest>(GetServiceRequestName(), *this);
    }
