...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API RecommendationSet
  {
  public:
    RecommendationSet();
    RecommendationSet(Aws::Utils::Json::JsonView jsonValue);
    RecommendationSet& operator=(Aws::Utils::Json::JsonView jsonValue);
