...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API GetServerDetailsRequest : public MigrationHubStrategyRecommendationsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetServerDetailsRequest> Clone() const
    {
      return Aws::MakeUnique<GetServerDetailsRequest>(GetServiceRequestName(), *this);
    }
