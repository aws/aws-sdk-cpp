...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API ListCollectorsRequest : public MigrationHubStrategyRecommendationsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCollectorsRequest> Clone() const
    {
      return Aws::MakeUnique<ListCollectorsRequest>(GetServiceRequestName(), *this);
    }
