...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API GetRecommendationReportDetailsRequest : public MigrationHubStrategyRecommendationsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRecommendationReportDetailsRequest> Clone() const
    {
      return Aws::MakeUnique<GetRecommendationReportDetailsRequest>(GetServiceRequestName(), *this);
    }
