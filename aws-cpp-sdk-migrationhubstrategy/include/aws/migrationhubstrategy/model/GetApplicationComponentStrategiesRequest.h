...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API GetApplicationComponentStrategiesRequest : public MigrationHubStrategyRecommendationsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetApplicationComponentStrategiesRequest> Clone() const
    {
      return Aws::MakeUnique<GetApplicationComponentStrategiesRequest>(GetServiceRequestName(), *this);
    }
