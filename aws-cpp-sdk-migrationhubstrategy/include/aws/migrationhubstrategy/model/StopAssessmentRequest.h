...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API StopAssessmentRequest : public MigrationHubStrategyRecommendationsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopAssessmentRequest> Clone() const
    {
      return Aws::MakeUnique<StopAssessmentRequest>(GetServiceRequestName(), *this);
    }
