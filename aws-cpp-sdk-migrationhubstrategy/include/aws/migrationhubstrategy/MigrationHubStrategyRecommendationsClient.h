...
namespace MigrationHubStrategyRecommendations
{
  ...
  class AWS_MIGRATIONHUBSTRATEGYRECOMMENDATIONS_API MigrationHubStrategyRecommendationsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MigrationHubStrategyRecommendationsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                                  std::shared_ptr<Endpoint::MigrationHubStrategyRecommendationsEndpointProvider> endpointProvider = Aws::MakeShared<MigrationHubStrategyRecommendations::Endpoint::MigrationHubStrategyRecommendationsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MigrationHubStrategyRecommendationsEndpointProvider> m_endpointProvider;
  };
