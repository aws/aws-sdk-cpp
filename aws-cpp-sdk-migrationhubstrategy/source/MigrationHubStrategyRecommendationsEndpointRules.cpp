...
Aws::String MigrationHubStrategyRecommendationsEndpointRules::GetRulesAsString()
{
    return Aws::String(MigrationHubStrategyRecommendationsEndpointRules::Rules.begin(), MigrationHubStrategyRecommendationsEndpointRules::Rules.end());
}

const Aws::Vector<char> MigrationHubStrategyRecommendationsEndpointRules::Rules = {
...
'b','-','s','t','r','a','t','e','g','y','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
'm','i','g','r','a','t','i','o','n','h','u','b','-','s','t','r','a','t','e','g','y','.','{','R','e',
...
'/','m','i','g','r','a','t','i','o','n','h','u','b','-','s','t','r','a','t','e','g','y','.','{','R',
