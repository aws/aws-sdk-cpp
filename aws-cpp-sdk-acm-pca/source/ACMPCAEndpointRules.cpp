...
Aws::String ACMPCAEndpointRules::GetRulesAsString()
{
    return Aws::String(ACMPCAEndpointRules::Rules.begin(), ACMPCAEndpointRules::Rules.end());
}

const Aws::Vector<char> ACMPCAEndpointRules::Rules = {
...
't','t','p','s',':','/','/','a','c','m','-','p','c','a','-','f','i','p','s','.','{','R','e','g','i',
...
'p','s',':','/','/','a','c','m','-','p','c','a','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'/','/','a','c','m','-','p','c','a','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','c','m','-','p','c','a','.','{','R','e',
