...
namespace Model
{
   ...
   * You must first call the <a>CreateCertificateAuthority</a> function. If
   * successful, the function returns an Amazon Resource Name (ARN) for your private
   * CA. Use this ARN as input to the <a>GetCertificateAuthorityCsr</a> function to
   ...
   * <a>IssueCertificate</a> function to issue a certificate. Call the
   * <a>RevokeCertificate</a> function to revoke a certificate. </p> <note>
   ...
   * call the <a>CreateCertificateAuthority</a> function. ACM PCA writes the CRL to
   ...
   * signing when the <b>IssueCertificate</b> or <b>RevokeCertificate</b> function is
   * called. </p>
   */
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * CA. If successful, this function returns the Amazon Resource Name (ARN) of the
         ...
         * <a>IssueCertificate</a> and <a>RevokeCertificate</a> functions use the private
        ...
        /**
         * <p>Deletes the private certificate authority (CA) that you created or started to
         * create by calling the <a>CreateCertificateAuthority</a> function. This action
         * requires that you enter an ARN (Amazon Resource Name) for the private CA that
         * you want to delete. You can find the ARN by calling the
         * <a>ListCertificateAuthorities</a> function. You can delete the CA if you are
         * waiting for it to be created (the <b>Status</b> field of the
         * <a>CertificateAuthority</a> is <code>CREATING</code>) or if the CA has been
         * created but you haven't yet imported the signed certificate (the <b>Status</b>
         * is <code>PENDING_CERTIFICATE</code>) into ACM PCA. If you've already imported
         * the certificate, you cannot delete the CA unless it has been disabled for more
         * than 30 days. To disable a CA, call the <a>UpdateCertificateAuthority</a>
         * function and set the <b>CertificateAuthorityStatus</b> argument to
         ...
         * <b>CREATING:</b> ACM PCA is creating your private certificate authority.</p>
         * </li> <li> <p> <b>PENDING_CERTIFICATE:</b> The certificate is pending. You must
         * use your on-premises root or subordinate CA to sign your private CA CSR and then
         * import it into PCA. </p> </li> <li> <p> <b>ACTIVE:</b> Your private CA is
         * active.</p> </li> <li> <p> <b>DISABLED:</b> Your private CA has been
         * disabled.</p> </li> <li> <p> <b>EXPIRED:</b> Your private CA certificate has
         * expired.</p> </li> <li> <p> <b>FAILED:</b> Your private CA has failed. Your CA
         * can fail for problems such a network outage or backend AWS failure or other
         * errors. A failed CA can never return to the pending state. You must create a new
         * CA. </p> </li> </ul><p><h3>See Also:</h3>   <a
         ...
         * <a>CreateCertificateAuthorityAuditReport</a> function. Audit information is
         * created every time the certificate authority (CA) private key is used. The
         * private key is used when you call the <a>IssueCertificate</a> function or the
         * <a>RevokeCertificate</a> function. </p><p><h3>See Also:</h3>   <a
         ...
         * returned when you call the <a>IssueCertificate</a> function. You must specify
         * both the ARN of your private CA and the ARN of the issued certificate when
         * calling the <b>GetCertificate</b> function. You can retrieve the certificate if
         * it is in the <b>ISSUED</b> state. You can call the
         * <a>CreateCertificateAuthorityAuditReport</a> function to create a report that
         ...
         * <a>CreateCertificateAuthority</a> function. Take the CSR to your on-premises
         ...
         * <a>ImportCertificateAuthorityCertificate</a> function. The CSR is returned as a
         ...
         * this function, you must create the private certificate authority by calling the
         * <a>CreateCertificateAuthority</a> function. You must then generate a certificate
         * signing request (CSR) by calling the <a>GetCertificateAuthorityCsr</a> function.
         * Take the CSR to your on-premises CA and use the root certificate or a
         * subordinate certificate to sign it. Create a certificate chain and copy the
         * signed certificate and the certificate chain to your working directory. </p>
         * <note> <p>Your certificate chain must not include the private CA certificate
         * that you are importing.</p> </note> <note> <p>Your on-premises CA certificate
         * must be the last certificate in your chain. The subordinate certificate, if any,
         ...
         * chain is built. </p> </note> <note> <p>The chain must be PEM-encoded.</p>
         ...
         * This function returns the Amazon Resource Name (ARN) of the certificate. You can
         * retrieve the certificate by calling the <a>GetCertificate</a> function and
         * specifying the ARN. </p> <note> <p>You cannot use the ACM
         * <b>ListCertificateAuthorities</b> function to retrieve the ARNs of the
         ...
         * <a>CreateCertificateAuthority</a> function.</p><p><h3>See Also:</h3>   <a
         ...
         * a key and an optional value. Call the <a>TagCertificateAuthority</a> function to
         * add one or more tags to your CA. Call the <a>UntagCertificateAuthority</a>
         * function to remove tags. </p><p><h3>See Also:</h3>   <a
         ...
         * function. If you enable a certificate revocation list (CRL) when you create or
         ...
         * <a>UntagCertificateAuthority</a> function. Call the <a>ListTags</a> function to
         * see what tags are associated with your CA. </p><p><h3>See Also:</h3>   <a
         ...
         * <a>ListTags</a> function to see what tags are associated with your CA.
         * </p><p><h3>See Also:</h3>   <a
         ...
         * Your private CA must be in the <b> <code>ACTIVE</code> </b> or <b>
         * <code>DISABLED</code> </b> state before you can update it. You can disable a
         * private CA that is in the <b> <code>ACTIVE</code> </b> state or make a CA that
         * is in the <b> <code>DISABLED</code> </b> state active again.</p><p><h3>See
         * Also:</h3>   <a
