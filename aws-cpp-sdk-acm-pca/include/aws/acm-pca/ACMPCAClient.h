...
namespace ACMPCA
{
  ...
  class AWS_ACMPCA_API ACMPCAClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ACMPCAClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                     std::shared_ptr<Endpoint::ACMPCAEndpointProvider> endpointProvider = Aws::MakeShared<ACMPCA::Endpoint::ACMPCAEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ACMPCAEndpointProvider> m_endpointProvider;
  };
