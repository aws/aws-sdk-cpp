...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>By default, ACM Private CA injects an AWS domain into certificates being
     ...
     * domain.</p> <p>Note: The value of the CNAME must not include a protocol prefix
     * such as "http://" or "https://".</p> <p>For more information, see <a
     * href="https://docs.aws.amazon.com/acm-pca/latest/userguide/ocsp-customize.html">Customizing
     * Online Certificate Status Protocol (OCSP) </a> in the <i>AWS Certificate Manager
