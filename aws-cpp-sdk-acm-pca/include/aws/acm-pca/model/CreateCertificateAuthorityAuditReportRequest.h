...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCertificateAuthorityAuditReportRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCertificateAuthorityAuditReportRequest>(GetServiceRequestName(), *this);
    }
