...
namespace Model
{
  ...
  /**
   */
  class AWS_ACMPCA_API DescribeCertificateAuthorityRequest : public ACMPCARequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCertificateAuthorityRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCertificateAuthorityRequest>(GetServiceRequestName(), *this);
    }
