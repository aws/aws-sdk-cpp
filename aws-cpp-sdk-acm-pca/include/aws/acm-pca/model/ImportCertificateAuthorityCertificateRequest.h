...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ImportCertificateAuthorityCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<ImportCertificateAuthorityCertificateRequest>(GetServiceRequestName(), *this);
    }
