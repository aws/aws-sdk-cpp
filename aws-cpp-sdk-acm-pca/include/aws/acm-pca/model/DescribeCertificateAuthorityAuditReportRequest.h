...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCertificateAuthorityAuditReportRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCertificateAuthorityAuditReportRequest>(GetServiceRequestName(), *this);
    }
