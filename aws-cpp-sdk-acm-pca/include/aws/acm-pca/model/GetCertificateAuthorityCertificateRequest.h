...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCertificateAuthorityCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<GetCertificateAuthorityCertificateRequest>(GetServiceRequestName(), *this);
    }
