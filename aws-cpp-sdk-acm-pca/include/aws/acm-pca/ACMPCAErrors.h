...
public:
  ...
  ACMPCAError(const Aws::Client::AWSError<ACMPCAErrors>& rhs) : Aws::Client::AWSError<ACMPCAErrors>(rhs) {}
  ACMPCAError(Aws::Client::AWSError<ACMPCAErrors>&& rhs) : Aws::Client::AWSError<ACMPCAErrors>(rhs) {}
