...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeStackProvisioningParametersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeStackProvisioningParametersRequest>(GetServiceRequestName(), *this);
    }
