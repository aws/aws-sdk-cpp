...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The stack's AWS region, such as "us-east-1". For more information about
     ...
     * to recipes. The string should be in the following escape characters such as
     * '"':</p> <p> <code>"{\"key1\": \"value1\", \"key2\": \"value2\",...}"</code>
