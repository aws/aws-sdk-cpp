...
namespace Model
{
  ...
  /**
   */
  class AWS_OPSWORKS_API DetachElasticLoadBalancerRequest : public OpsWorksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DetachElasticLoadBalancerRequest> Clone() const
    {
      return Aws::MakeUnique<DetachElasticLoadBalancerRequest>(GetServiceRequestName(), *this);
    }
