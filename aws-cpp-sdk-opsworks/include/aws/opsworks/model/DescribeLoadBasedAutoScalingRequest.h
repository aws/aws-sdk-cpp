...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLoadBasedAutoScalingRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLoadBasedAutoScalingRequest>(GetServiceRequestName(), *this);
    }
