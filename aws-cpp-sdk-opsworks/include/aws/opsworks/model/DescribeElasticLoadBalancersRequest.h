...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeElasticLoadBalancersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeElasticLoadBalancersRequest>(GetServiceRequestName(), *this);
    }
