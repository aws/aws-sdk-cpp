...
namespace Model
{
  ...
  /**
   */
  class AWS_OPSWORKS_API StopStackRequest : public OpsWorksRequest
  {
  public:
    StopStackRequest();
    ...
    */
    virtual Aws::UniquePtr<StopStackRequest> Clone() const
    {
      return Aws::MakeUnique<StopStackRequest>(GetServiceRequestName(), *this);
    }
