  ...
  */
  ...
  public:
    ...
    */
    ...
    /*
     <p>This parameter depends on the repository type. </p> <ul> <li>For Amazon S3 bundles, set <code>Username</code> to the appropriate IAM access key ID.</li> <li>For HTTP bundles, Git repositories, and Subversion repositories, set <code>Username</code> to the user name.</li> </ul>
    */
    ...
    */
    ...
    /*
     <p>When included in a request, the parameter depends on the repository type. </p> <ul> <li>For Amazon S3 bundles, set <code>Password</code> to the appropriate IAM secret access key.</li> <li>For HTTP bundles and Subversion repositories, set <code>Password</code> to the password.</li> </ul> <p>For more information on how to safely handle IAM credentials, see <a href="http://docs.aws.amazon.com/general/latest/gr/aws-access-keys-best-practices.html"></a>.</p> <p>In responses, AWS OpsWorks returns <code>*****FILTERED*****</code> instead of the actual value.</p>
    */
    ...
    */
    ...
    /*
     <p>In requests, the repository's SSH key.</p> <p>In responses, AWS OpsWorks returns <code>*****FILTERED*****</code> instead of the actual value.</p>
    */
    ...
    */
    ...
    /*
     <p>The application's version. AWS OpsWorks enables you to easily deploy new versions of an application. One of the simplest approaches is to have branches or revisions in your repository that represent different versions that can potentially be deployed.</p>
    */
