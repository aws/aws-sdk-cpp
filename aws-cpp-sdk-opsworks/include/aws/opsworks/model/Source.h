...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>This parameter depends on the repository type. </p> <ul> <li>For Amazon S3
     * bundles, set <code>Username</code> to the appropriate IAM access key ID.</li>
     * <li>For HTTP bundles, Git repositories, and Subversion repositories, set
     * <code>Username</code> to the user name.</li> </ul>
     */
    ...
    /**
     * <p>When included in a request, the parameter depends on the repository type.
     * </p> <ul> <li>For Amazon S3 bundles, set <code>Password</code> to the
