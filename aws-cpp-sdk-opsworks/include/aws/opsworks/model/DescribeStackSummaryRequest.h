...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeStackSummaryRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeStackSummaryRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DescribeStackSummary"; }
