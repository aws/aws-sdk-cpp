...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTimeBasedAutoScalingRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTimeBasedAutoScalingRequest>(GetServiceRequestName(), *this);
    }
