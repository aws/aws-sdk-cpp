...
namespace OpsWorks
{
  ...
  class AWS_OPSWORKS_API OpsWorksClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        OpsWorksClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::OpsWorksEndpointProvider> endpointProvider = Aws::MakeShared<OpsWorks::Endpoint::OpsWorksEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::OpsWorksEndpointProvider> m_endpointProvider;
  };
