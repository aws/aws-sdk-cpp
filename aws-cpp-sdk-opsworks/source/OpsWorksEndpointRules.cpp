...
Aws::String OpsWorksEndpointRules::GetRulesAsString()
{
    return Aws::String(OpsWorksEndpointRules::Rules.begin(), OpsWorksEndpointRules::Rules.end());
}

const Aws::Vector<char> OpsWorksEndpointRules::Rules = {
...
'p','s','w','o','r','k','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','o','p','s','w','o','r','k','s','.','{','R','e','g',
