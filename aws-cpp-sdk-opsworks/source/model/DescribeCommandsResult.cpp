...
DescribeCommandsResult::DescribeCommandsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeCommandsResult& DescribeCommandsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
