...
DescribeAppsResult::DescribeAppsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeAppsResult& DescribeAppsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
