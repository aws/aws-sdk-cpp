...
using ResolveEndpointOutcome = Aws::OpsWorks::Endpoint::OpsWorksEndpointProvider::OpsWorksResolveEndpointOutcome;
...
OpsWorksClient::OpsWorksClient(const Client::ClientConfiguration& clientConfiguration,
                               std::shared_ptr<Endpoint::OpsWorksEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<OpsWorksErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<OpsWorks::Endpoint::OpsWorksEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
