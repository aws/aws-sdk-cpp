  ...
  namespace S3Control
  {
    ...
    public:
        ...
        */
         ...
         * Service Developer Guide</i>.</p> <p/> <p> <b>Using this action with Amazon S3 on
         ...
         * href="AmazonS3/latest/dev/S3onOutposts.html">Using Amazon S3 on Outposts</a> in
         * the <i>Amazon Simple Storage Service Developer Guide </i>.</p> <p>All Amazon S3
         ...
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API__control_CreateAccessPoint.html#API_control_CreateAccessPoint_Examples">
         * Example</a> section below.</p> <p/> <p>The following actions are related to
         ...
         * </p> </li> <li> <p> <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API__control_ListAccessPoints.html">ListAccessPoints</a>
        ...
        /**
         *  <p>This API operation creates an Amazon S3 on Outposts bucket. To create
         * an S3 bucket, see <a
         ...
         * with Amazon S3 Buckets</a>.</p> <p>S3 on Outposts buckets do not support </p>
         * <ul> <li> <p>ACLs. Instead, configure access point policies to manage access to
         * buckets.</p> </li> <li> <p>Public access. </p> </li> <li> <p>Object Lock</p>
         * </li> <li> <p>Bucket Location constraint</p> </li> </ul> <p>For an example of
         * the request syntax for Amazon S3 on Outposts that uses the S3 on Outposts
         * endpoint hostname prefix and outpost-id in your API request, see the <a
         ...
         * <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API__control_DeleteAccessPointPolicy.html#API_control_DeleteAccessPointPolicy_Examples">
         * Example</a> section below.</p> <p>The following actions are related to
        ...
        /**
         *  <p>This API operation deletes an Amazon S3 on Outposts bucket. To delete
         * an S3 bucket, see <a
         ...
         * require an additional parameter of outpost-id to be passed with the request and
         * an S3 on Outposts endpoint hostname prefix instead of s3-control. For an example
         * of the request syntax for Amazon S3 on Outposts that uses the S3 on Outposts
         * endpoint hostname prefix and the outpost-id derived using the access point ARN,
         * see the <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API__control_DeleteBucket.html#API_control_DeleteBucket_Examples">
         * Example</a> section below.</p> <p class="title"> <b>Related Resources</b> </p>
         * <ul> <li> <p> <a
        ...
        /**
         *  <p>This API action deletes an Amazon S3 on Outposts bucket's lifecycle
         ...
         * href="https://docs.aws.amazon.com/AmazonS3/latest/dev/S3onOutposts.html">Using
         * Amazon S3 on Outposts</a> in <i>Amazon Simple Storage Service Developer
         * Guide</i>.</p> <p>To use this operation, you must have permission to perform the
         * <code>s3outposts:DeleteLifecycleConfiguration</code> action. By default, the
         ...
         * point ARN, see the <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API__control_DeleteBucketLifecycleConfiguration.html#API_control_DeleteBucketLifecycleConfiguration_Examples">
         * Example</a> section below.</p> <p>For more information about object expiration,
         * see <a
        ...
        /**
         *  <p>This API operation deletes an Amazon S3 on Outposts bucket policy. To
         ...
         * implementation of the DELETE operation uses the policy subresource to delete the
         ...
         * identity must have the <code>s3outposts:DeleteBucketPolicy</code> permissions on
         ...
         * more information about bucket policies, see <a href="
        ...
        /**
         *  <p>This API operation deletes an Amazon S3 on Outposts bucket's tags. To
         * delete an S3 bucket tags, see <a
         ...
         * Developer Guide</i>.</p> <p/> <p>Related actions include:</p> <ul> <li> <p> <a
         ...
         * href="https://docs.aws.amazon.com/AmazonS3/latest/dev/batch-ops-basics.html">S3
         * Batch Operations</a> in the <i>Amazon Simple Storage Service Developer
         * Guide</i>.</p> <p/> <p>Related actions include:</p> <ul> <li> <p> <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_CreateJob.html">CreateJob</a>
         * </p> </li> <li> <p> <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_ListJobs.html">ListJobs</a>
         * </p> </li> <li> <p> <a
         ...
         * href="https://docs.aws.amazon.com/AmazonS3/latest/dev/S3onOutposts.html"> Using
         * Amazon S3 on Outposts</a> in the <i>Amazon Simple Storage Service Developer
         * Guide</i>.</p> <p>The following actions are related to <code>GetBucket</code>
         * for Amazon S3 on Outposts:</p> <ul> <li> <p> <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutObject.html">PutObject</a>
         * </p> </li> <li> <p> <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API__control_CreateBucket.html">CreateBucket</a>
         * </p> </li> <li> <p> <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API__control_DeleteBucket.html">DeleteBucket</a>
         * </p> </li> </ul><p><h3>See Also:</h3>   <a
        ...
        /**
         *  <p>This API operation gets an Amazon S3 on Outposts bucket's lifecycle
         ...
         * Object Lifecycle Management</a> in <i>Amazon Simple Storage Service Developer
         * Guide</i>.</p> <p>To use this operation, you must have permission to perform the
        ...
        /**
         *  <p>This API action gets a bucket policy for an Amazon S3 on Outposts
         * bucket. To get a policy for an S3 bucket, see <a
         ...
         * the bucket owner's account in order to use this operation.</p> <p>If you don't
         * have <code>s3outposts:GetBucketPolicy</code> permissions, Amazon S3 returns a
        ...
        /**
         *  <p>This API operation gets an Amazon S3 on Outposts bucket's tags. To get
         ...
         * href="https://docs.aws.amazon.com/AmazonS3/latest/dev/batch-ops-basics.html">S3
         * Batch Operations</a> in the <i>Amazon Simple Storage Service Developer
         * Guide</i>.</p> <p>Related actions include:</p> <p/> <ul> <li> <p> <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_CreateJob.html">CreateJob</a>
         * </p> </li> <li> <p> <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_DescribeJob.html">DescribeJob</a>
         * </p> </li> <li> <p> <a
         ...
         * that uses the S3 on Outposts endpoint hostname prefix and outpost-id in your API
         * request, see the <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API__control_ListRegionalBuckets.html#API_control_ListRegionalBuckets_Examples">
         * Example</a> section below.</p><p><h3>See Also:</h3>   <a
         ...
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API__control_PutAccessPointPolicy.html#API_control_PutAccessPointPolicy_Examples">
         * Example</a> section below.</p> <p>The following actions are related to
        ...
        /**
         *  <p>This API action puts a lifecycle configuration to an Amazon S3 on
         * Outposts bucket. To put a lifecycle configuration to an S3 bucket, see <a
         ...
         * lifecycle configuration. Outposts buckets can only support a lifecycle that
         * deletes objects after a certain period of time. For more information, see <a
         ...
         * on Outposts that uses the S3 on Outposts endpoint hostname prefix and the
         * outpost-id derived using the access point ARN, see the <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API__control_PutBucketLifecycleConfiguration.html#API_control_PutBucketLifecycleConfiguration_Examples">
         * Example</a> section below.</p> <p>The following actions are related to
        ...
        /**
         *  <p>This API action puts a bucket policy to an Amazon S3 on Outposts
         * bucket. To put a policy on an S3 bucket, see <a
         ...
         * you don't have <code>PutBucketPolicy</code> permissions, Amazon S3 returns a
         * <code>403 Access Denied</code> error. If you have the correct permissions, but
         * you're not using an identity that belongs to the bucket owner's account, Amazon
         * S3 returns a <code>405 Method Not Allowed</code> error.</p>  <p> As a
         * security precaution, the root user of the AWS account that owns a bucket can
        ...
        /**
         *  <p>This API action puts tags on an Amazon S3 on Outposts bucket. To put
         * tags on an S3 bucket, see <a
         ...
         * href="https://docs.aws.amazon.com/AmazonS3/latest/dev/batch-ops-managing-jobs.html#batch-ops-job-tags">Controlling
         * access and labeling jobs using tags</a> in the <i>Amazon Simple Storage Service
         * Developer Guide</i>. </p> <p/>  <ul> <li> <p>If you send this request with
         * an empty tag set, Amazon S3 deletes the existing tag set on the Batch Operations
         ...
         * Guide</i>.</p> </li> </ul> </li> </ul>  <p/> <p>To use this operation,
         * you must have permission to perform the <code>s3:PutJobTagging</code>
