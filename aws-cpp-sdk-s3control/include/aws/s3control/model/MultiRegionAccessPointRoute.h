...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_S3CONTROL_API MultiRegionAccessPointRoute
  {
  public:
    MultiRegionAccessPointRoute();
    MultiRegionAccessPointRoute(const Aws::Utils::Xml::XmlNode& xmlNode);
    MultiRegionAccessPointRoute& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
