...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutMultiRegionAccessPointPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutMultiRegionAccessPointPolicyRequest>(GetServiceRequestName(), *this);
    }
