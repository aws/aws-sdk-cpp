...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAccessPointPolicyForObjectLambdaRequest> Clone() const
    {
      return Aws::MakeUnique<PutAccessPointPolicyForObjectLambdaRequest>(GetServiceRequestName(), *this);
    }
