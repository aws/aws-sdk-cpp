...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_S3CONTROL_API StorageLensAwsOrg
  {
  public:
    StorageLensAwsOrg();
    StorageLensAwsOrg(const Aws::Utils::Xml::XmlNode& xmlNode);
    StorageLensAwsOrg& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
