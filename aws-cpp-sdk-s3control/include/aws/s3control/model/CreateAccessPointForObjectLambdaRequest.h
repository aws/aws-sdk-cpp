...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAccessPointForObjectLambdaRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAccessPointForObjectLambdaRequest>(GetServiceRequestName(), *this);
    }
