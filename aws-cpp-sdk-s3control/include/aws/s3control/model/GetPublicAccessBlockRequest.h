...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CONTROL_API GetPublicAccessBlockRequest : public S3ControlRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPublicAccessBlockRequest> Clone() const
    {
      return Aws::MakeUnique<GetPublicAccessBlockRequest>(GetServiceRequestName(), *this);
    }
