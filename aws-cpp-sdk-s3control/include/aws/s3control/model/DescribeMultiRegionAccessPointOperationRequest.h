...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMultiRegionAccessPointOperationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMultiRegionAccessPointOperationRequest>(GetServiceRequestName(), *this);
    }
