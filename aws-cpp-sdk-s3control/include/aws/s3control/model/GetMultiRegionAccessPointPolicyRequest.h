...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMultiRegionAccessPointPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetMultiRegionAccessPointPolicyRequest>(GetServiceRequestName(), *this);
    }
