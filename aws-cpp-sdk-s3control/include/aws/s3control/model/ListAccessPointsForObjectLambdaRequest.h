...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CONTROL_API ListAccessPointsForObjectLambdaRequest : public S3ControlRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAccessPointsForObjectLambdaRequest> Clone() const
    {
      return Aws::MakeUnique<ListAccessPointsForObjectLambdaRequest>(GetServiceRequestName(), *this);
    }
