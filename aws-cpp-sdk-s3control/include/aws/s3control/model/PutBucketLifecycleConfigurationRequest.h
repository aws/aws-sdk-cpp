...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CONTROL_API PutBucketLifecycleConfigurationRequest : public S3ControlRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutBucketLifecycleConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutBucketLifecycleConfigurationRequest>(GetServiceRequestName(), *this);
    }
