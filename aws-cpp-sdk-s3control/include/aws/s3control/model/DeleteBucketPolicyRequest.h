...
namespace Model
{
  ...
  /**
   */
  class DeleteBucketPolicyRequest : public S3ControlRequest
  {
  public:
    AWS_S3CONTROL_API DeleteBucketPolicyRequest();
     ...
     * <p>The account ID of the Outposts bucket.</p>
     */
    inline DeleteBucketPolicyRequest& WithAccountId(const Aws::String& value) { SetAccountId(value); return *this;}

    /**
     * <p>The account ID of the Outposts bucket.</p>
     */
    inline DeleteBucketPolicyRequest& WithAccountId(Aws::String&& value) { SetAccountId(std::move(value)); return *this;}

    /**
     * <p>The account ID of the Outposts bucket.</p>
     */
    inline DeleteBucketPolicyRequest& WithAccountId(const char* value) { SetAccountId(value); return *this;}
