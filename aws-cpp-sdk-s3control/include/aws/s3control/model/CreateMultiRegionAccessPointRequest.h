...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CONTROL_API CreateMultiRegionAccessPointRequest : public S3ControlRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateMultiRegionAccessPointRequest> Clone() const
    {
      return Aws::MakeUnique<CreateMultiRegionAccessPointRequest>(GetServiceRequestName(), *this);
    }
