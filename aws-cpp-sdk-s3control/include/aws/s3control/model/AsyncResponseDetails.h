...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_S3CONTROL_API AsyncResponseDetails
  {
  public:
    AsyncResponseDetails();
    AsyncResponseDetails(const Aws::Utils::Xml::XmlNode& xmlNode);
    AsyncResponseDetails& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
