...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_S3CONTROL_API AdvancedDataProtectionMetrics
  {
  public:
    AdvancedDataProtectionMetrics();
    AdvancedDataProtectionMetrics(const Aws::Utils::Xml::XmlNode& xmlNode);
    AdvancedDataProtectionMetrics& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
