...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListStorageLensConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListStorageLensConfigurationsRequest>(GetServiceRequestName(), *this);
    }
