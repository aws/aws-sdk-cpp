...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMultiRegionAccessPointsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMultiRegionAccessPointsRequest>(GetServiceRequestName(), *this);
    }
