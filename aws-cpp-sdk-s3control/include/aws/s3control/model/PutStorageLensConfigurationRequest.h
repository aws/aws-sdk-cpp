...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutStorageLensConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutStorageLensConfigurationRequest>(GetServiceRequestName(), *this);
    }
