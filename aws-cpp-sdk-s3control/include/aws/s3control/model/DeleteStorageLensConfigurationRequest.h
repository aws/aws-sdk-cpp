...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CONTROL_API DeleteStorageLensConfigurationRequest : public S3ControlRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteStorageLensConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteStorageLensConfigurationRequest>(GetServiceRequestName(), *this);
    }
