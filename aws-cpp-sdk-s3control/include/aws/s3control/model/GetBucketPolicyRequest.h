...
namespace Model
{
  ...
  /**
   */
  class GetBucketPolicyRequest : public S3ControlRequest
  {
  public:
    AWS_S3CONTROL_API GetBucketPolicyRequest();
     ...
     * <p>The Amazon Web Services account ID of the Outposts bucket.</p>
     */
    inline GetBucketPolicyRequest& WithAccountId(const Aws::String& value) { SetAccountId(value); return *this;}

    /**
     * <p>The Amazon Web Services account ID of the Outposts bucket.</p>
     */
    inline GetBucketPolicyRequest& WithAccountId(Aws::String&& value) { SetAccountId(std::move(value)); return *this;}

    /**
     * <p>The Amazon Web Services account ID of the Outposts bucket.</p>
     */
    inline GetBucketPolicyRequest& WithAccountId(const char* value) { SetAccountId(value); return *this;}
