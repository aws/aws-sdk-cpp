...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CONTROL_API GetAccessPointPolicyRequest : public S3ControlRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAccessPointPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetAccessPointPolicyRequest>(GetServiceRequestName(), *this);
    }
