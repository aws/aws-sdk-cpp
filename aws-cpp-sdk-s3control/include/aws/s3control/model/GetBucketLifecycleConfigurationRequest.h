...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CONTROL_API GetBucketLifecycleConfigurationRequest : public S3ControlRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketLifecycleConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketLifecycleConfigurationRequest>(GetServiceRequestName(), *this);
    }
     ...
     * <p>The Amazon Web Services account ID of the Outposts bucket.</p>
     */
    inline GetBucketLifecycleConfigurationRequest& WithAccountId(const Aws::String& value) { SetAccountId(value); return *this;}

    /**
     * <p>The Amazon Web Services account ID of the Outposts bucket.</p>
     */
    inline GetBucketLifecycleConfigurationRequest& WithAccountId(Aws::String&& value) { SetAccountId(std::move(value)); return *this;}

    /**
     * <p>The Amazon Web Services account ID of the Outposts bucket.</p>
     */
    inline GetBucketLifecycleConfigurationRequest& WithAccountId(const char* value) { SetAccountId(value); return *this;}
