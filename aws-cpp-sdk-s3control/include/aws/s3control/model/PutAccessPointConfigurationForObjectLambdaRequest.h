...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CONTROL_API PutAccessPointConfigurationForObjectLambdaRequest : public S3ControlRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAccessPointConfigurationForObjectLambdaRequest> Clone() const
    {
      return Aws::MakeUnique<PutAccessPointConfigurationForObjectLambdaRequest>(GetServiceRequestName(), *this);
    }
