...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CONTROL_API DeleteMultiRegionAccessPointRequest : public S3ControlRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteMultiRegionAccessPointRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteMultiRegionAccessPointRequest>(GetServiceRequestName(), *this);
    }
