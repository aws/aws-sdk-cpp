...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CONTROL_API GetAccessPointPolicyForObjectLambdaRequest : public S3ControlRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAccessPointPolicyForObjectLambdaRequest> Clone() const
    {
      return Aws::MakeUnique<GetAccessPointPolicyForObjectLambdaRequest>(GetServiceRequestName(), *this);
    }
