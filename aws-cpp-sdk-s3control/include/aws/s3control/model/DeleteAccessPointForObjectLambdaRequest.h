...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CONTROL_API DeleteAccessPointForObjectLambdaRequest : public S3ControlRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAccessPointForObjectLambdaRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAccessPointForObjectLambdaRequest>(GetServiceRequestName(), *this);
    }
