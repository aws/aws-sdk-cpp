...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_S3CONTROL_API SSEKMSEncryption
  {
  public:
    SSEKMSEncryption();
    SSEKMSEncryption(const Aws::Utils::Xml::XmlNode& xmlNode);
    SSEKMSEncryption& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
