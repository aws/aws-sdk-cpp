...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMultiRegionAccessPointPolicyStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetMultiRegionAccessPointPolicyStatusRequest>(GetServiceRequestName(), *this);
    }
