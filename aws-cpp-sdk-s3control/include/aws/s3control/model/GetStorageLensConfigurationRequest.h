...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetStorageLensConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetStorageLensConfigurationRequest>(GetServiceRequestName(), *this);
    }
