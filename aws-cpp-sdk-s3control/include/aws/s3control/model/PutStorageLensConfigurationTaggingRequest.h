...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CONTROL_API PutStorageLensConfigurationTaggingRequest : public S3ControlRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutStorageLensConfigurationTaggingRequest> Clone() const
    {
      return Aws::MakeUnique<PutStorageLensConfigurationTaggingRequest>(GetServiceRequestName(), *this);
    }
