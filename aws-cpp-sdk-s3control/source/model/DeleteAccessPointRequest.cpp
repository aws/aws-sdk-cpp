...
Aws::Http::HeaderValueCollection DeleteAccessPointRequest::GetRequestSpecificHeaders() const
{
...
DeleteAccessPointRequest::EndpointParameters DeleteAccessPointRequest::GetEndpointContextParams() const
{
