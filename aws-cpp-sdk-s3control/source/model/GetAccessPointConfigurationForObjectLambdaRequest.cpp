...
Aws::String GetAccessPointConfigurationForObjectLambdaRequest::SerializePayload() const
{
  return {};
}
...
GetAccessPointConfigurationForObjectLambdaRequest::EndpointParameters GetAccessPointConfigurationForObjectLambdaRequest::GetEndpointContextParams() const
{
