...
Aws::String DeleteStorageLensConfigurationRequest::SerializePayload() const
{
  return {};
}


Aws::Http::HeaderValueCollection DeleteStorageLensConfigurationRequest::GetRequestSpecificHeaders() const
{
...
DeleteStorageLensConfigurationRequest::EndpointParameters DeleteStorageLensConfigurationRequest::GetEndpointContextParams() const
{
