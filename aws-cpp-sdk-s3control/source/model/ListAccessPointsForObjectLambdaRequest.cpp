...
Aws::String ListAccessPointsForObjectLambdaRequest::SerializePayload() const
{
  return {};
}

void ListAccessPointsForObjectLambdaRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
...
Aws::Http::HeaderValueCollection ListAccessPointsForObjectLambdaRequest::GetRequestSpecificHeaders() const
{
...
ListAccessPointsForObjectLambdaRequest::EndpointParameters ListAccessPointsForObjectLambdaRequest::GetEndpointContextParams() const
{
