...
AdvancedDataProtectionMetrics& AdvancedDataProtectionMetrics::operator =(const XmlNode& xmlNode)
{
...
void AdvancedDataProtectionMetrics::AddToNode(XmlNode& parentNode) const
{
  Aws::StringStream ss;
