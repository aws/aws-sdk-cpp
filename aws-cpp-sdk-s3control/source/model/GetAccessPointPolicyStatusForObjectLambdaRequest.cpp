...
Aws::String GetAccessPointPolicyStatusForObjectLambdaRequest::SerializePayload() const
{
  return {};
}


Aws::Http::HeaderValueCollection GetAccessPointPolicyStatusForObjectLambdaRequest::GetRequestSpecificHeaders() const
{
...
GetAccessPointPolicyStatusForObjectLambdaRequest::EndpointParameters GetAccessPointPolicyStatusForObjectLambdaRequest::GetEndpointContextParams() const
{
