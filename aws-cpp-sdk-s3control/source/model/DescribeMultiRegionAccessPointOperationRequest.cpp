...
Aws::String DescribeMultiRegionAccessPointOperationRequest::SerializePayload() const
{
  return {};
}


Aws::Http::HeaderValueCollection DescribeMultiRegionAccessPointOperationRequest::GetRequestSpecificHeaders() const
{
...
DescribeMultiRegionAccessPointOperationRequest::EndpointParameters DescribeMultiRegionAccessPointOperationRequest::GetEndpointContextParams() const
{
