...
Aws::String DynamoDBEndpointRules::GetRulesAsString()
{
    return Aws::String(DynamoDBEndpointRules::Rules.begin(), DynamoDBEndpointRules::Rules.end());
}

const Aws::Vector<char> DynamoDBEndpointRules::Rules = {
...
't','t','p','s',':','/','/','d','y','n','a','m','o','d','b','-','f','i','p','s','.','{','R','e','g',
...
't','p','s',':','/','/','d','y','n','a','m','o','d','b','.','{','R','e','g','i','o','n','}','.','{',
