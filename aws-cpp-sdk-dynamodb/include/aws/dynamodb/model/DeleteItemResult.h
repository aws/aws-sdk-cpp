...
namespace Model
{
  ...
  public:
     ...
     * item as it appeared before the <i>DeleteItem</i> operation. This map appears in
     * the response only if <i>ReturnValues</i> was specified as <code>ALL_OLD</code>
     * in the request.</p>
     */
     ...
     * element consists of:</p> <ul> <li><p><i>ItemCollectionKey</i> - The hash key
     * value of the item collection. This is the same as the hash key of the
     * item.</p></li> <li><p><i>SizeEstimateRange</i> - An estimate of item collection
     * size, in gigabytes. This value is a two-element array containing a lower bound
     * and an upper bound for the estimate. The estimate includes the size of all the
     * items in the table, plus the size of all attributes projected into all of the
     * local secondary indexes on that table. Use this estimate to measure whether a
