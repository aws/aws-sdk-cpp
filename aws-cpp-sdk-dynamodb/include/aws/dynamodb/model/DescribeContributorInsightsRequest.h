...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeContributorInsightsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeContributorInsightsRequest>(GetServiceRequestName(), *this);
    }
