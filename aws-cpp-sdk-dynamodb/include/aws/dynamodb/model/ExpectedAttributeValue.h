...
namespace Model
{
   ...
   * comparison evaluates to false.</p> </li> </ul> <p><i>Value</i> and <i>Exists</i>
   * are incompatible with <i>AttributeValueList</i> and <i>ComparisonOperator</i>.
  ...
  public:
     ...
     * following are descriptions of each comparison operator.</p> <ul> <li>
     * <p><code>EQ</code> : Equal. <code>EQ</code> is supported for all datatypes,
