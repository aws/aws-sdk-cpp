...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTableReplicaAutoScalingRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTableReplicaAutoScalingRequest>(GetServiceRequestName(), *this);
    }
