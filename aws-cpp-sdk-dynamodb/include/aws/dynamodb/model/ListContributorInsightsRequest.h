...
namespace Model
{
  ...
  /**
   */
  class AWS_DYNAMODB_API ListContributorInsightsRequest : public DynamoDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListContributorInsightsRequest> Clone() const
    {
      return Aws::MakeUnique<ListContributorInsightsRequest>(GetServiceRequestName(), *this);
    }
