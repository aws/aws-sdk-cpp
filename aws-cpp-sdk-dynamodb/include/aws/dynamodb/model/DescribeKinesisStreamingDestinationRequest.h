...
namespace Model
{
  ...
  /**
   */
  class AWS_DYNAMODB_API DescribeKinesisStreamingDestinationRequest : public DynamoDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeKinesisStreamingDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeKinesisStreamingDestinationRequest>(GetServiceRequestName(), *this);
    }
