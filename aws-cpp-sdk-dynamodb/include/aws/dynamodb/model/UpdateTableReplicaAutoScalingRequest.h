...
namespace Model
{
  ...
  /**
   */
  class AWS_DYNAMODB_API UpdateTableReplicaAutoScalingRequest : public DynamoDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTableReplicaAutoScalingRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTableReplicaAutoScalingRequest>(GetServiceRequestName(), *this);
    }
