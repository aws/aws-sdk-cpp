...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeGlobalTableSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeGlobalTableSettingsRequest>(GetServiceRequestName(), *this);
    }
