...
{
  /**
   * <p>Represents the output of a <i>Scan</i> operation.</p><p><h3>See Also:</h3>  
   * <a
  ...
  public:
    ...
    /**
     * <p>The number of items in the response.</p> <p>If you set <i>ScanFilter</i> in
     * the request, then <i>Count</i> is the number of items returned after the filter
     * was applied, and <i>ScannedCount</i> is the number of matching items before the
     * filter was applied.</p> <p>If you did not use a filter in the request, then
     * <i>Count</i> is the same as <i>ScannedCount</i>.</p>
     */
    ...
    /**
     * <p>The number of items evaluated, before any <i>ScanFilter</i> is applied. A
     * high <i>ScannedCount</i> value with few, or no, <i>Count</i> results indicates
     * an inefficient <i>Scan</i> operation. For more information, see <a
