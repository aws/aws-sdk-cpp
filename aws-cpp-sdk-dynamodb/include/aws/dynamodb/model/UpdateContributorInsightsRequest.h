...
namespace Model
{
  ...
  /**
   */
  class AWS_DYNAMODB_API UpdateContributorInsightsRequest : public DynamoDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateContributorInsightsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateContributorInsightsRequest>(GetServiceRequestName(), *this);
    }
