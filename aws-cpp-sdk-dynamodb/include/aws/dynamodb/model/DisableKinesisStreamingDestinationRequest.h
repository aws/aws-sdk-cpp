...
namespace Model
{
  ...
  /**
   */
  class AWS_DYNAMODB_API DisableKinesisStreamingDestinationRequest : public DynamoDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableKinesisStreamingDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<DisableKinesisStreamingDestinationRequest>(GetServiceRequestName(), *this);
    }
