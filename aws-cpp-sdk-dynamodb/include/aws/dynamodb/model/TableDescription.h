...
namespace Model
{
  ...
  public:
     ...
     * <p><i>AttributeName</i> - The name of the attribute.</p> </li> <li>
     * <p><i>AttributeType</i> - The data type for the attribute.</p> </li> </ul>
     */
     ...
     * attributes are projected into the index.</p> </li> </ul> </li> <li>
     * <p><i>NonKeyAttributes</i> - A list of one or more non-key attribute names that
     * are projected into the secondary index. The total count of attributes provided
     * in <i>NonKeyAttributes</i>, summed across all of the secondary indexes, must not
     ...
     * </li> <li> <p><i>IndexSizeBytes</i> - Represents the total size of the index, in
     * bytes. DynamoDB updates this value approximately every six hours. Recent changes
     * might not be reflected in this value.</p> </li> <li> <p><i>ItemCount</i> -
     ...
     * during a <i>CreateTable</i> operation.)</p> </li> <li> <p><i>IndexName</i> - The
     * name of the global secondary index.</p> </li> <li> <p><i>IndexSizeBytes</i> -
     ...
     * </li> <li> <p><i>DELETING</i> - The index is being deleted.</p> </li> <li>
     * <p><i>ACTIVE</i> - The index is ready for use.</p> </li> </ul> </li> <li>
     * <p><i>ItemCount</i> - The number of items in the global secondary index.
     ...
     * exceed 20. If you project the same attribute into two different indexes, this
     * counts as two distinct attributes when determining the total.</p> </li> </ul>
     * </li> <li> <p><i>ProvisionedThroughput</i> - The provisioned throughput settings
     * for the global secondary index, consisting of read and write capacity units,
     * along with data about increases and decreases. </p> </li> </ul> <p>If the table
     * is in the <code>DELETING</code> state, no information about indexes will be
     * returned.</p>
     */
