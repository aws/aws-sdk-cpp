...
namespace Model
{
  ...
  public:
    ...
    AutoScalingSettingsDescription(const Aws::Utils::Json::JsonValue& jsonValue);
    AutoScalingSettingsDescription& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
