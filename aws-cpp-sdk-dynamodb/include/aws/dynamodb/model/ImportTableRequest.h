...
namespace Model
{
  ...
  /**
   */
  class AWS_DYNAMODB_API ImportTableRequest : public DynamoDBRequest
  {
  public:
    ImportTableRequest();
    ...
    */
    virtual Aws::UniquePtr<ImportTableRequest> Clone() const
    {
      return Aws::MakeUnique<ImportTableRequest>(GetServiceRequestName(), *this);
    }
