...
namespace Model
{
  ...
  typedef Aws::Utils::Event<DynamoDBClient, const Model::BatchGetItemRequest&, const Model::BatchGetItemOutcome&, const Aws::Client::AsyncCallerContext*> BatchGetItemOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::BatchWriteItemRequest&, const Model::BatchWriteItemOutcome&, const Aws::Client::AsyncCallerContext*> BatchWriteItemOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::CreateTableRequest&, const Model::CreateTableOutcome&, const Aws::Client::AsyncCallerContext*> CreateTableOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::DeleteItemRequest&, const Model::DeleteItemOutcome&, const Aws::Client::AsyncCallerContext*> DeleteItemOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::DeleteTableRequest&, const Model::DeleteTableOutcome&, const Aws::Client::AsyncCallerContext*> DeleteTableOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::DescribeTableRequest&, const Model::DescribeTableOutcome&, const Aws::Client::AsyncCallerContext*> DescribeTableOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::GetItemRequest&, const Model::GetItemOutcome&, const Aws::Client::AsyncCallerContext*> GetItemOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::ListTablesRequest&, const Model::ListTablesOutcome&, const Aws::Client::AsyncCallerContext*> ListTablesOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::PutItemRequest&, const Model::PutItemOutcome&, const Aws::Client::AsyncCallerContext*> PutItemOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::QueryRequest&, const Model::QueryOutcome&, const Aws::Client::AsyncCallerContext*> QueryOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::ScanRequest&, const Model::ScanOutcome&, const Aws::Client::AsyncCallerContext*> ScanOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::UpdateItemRequest&, const Model::UpdateItemOutcome&, const Aws::Client::AsyncCallerContext*> UpdateItemOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::UpdateTableRequest&, const Model::UpdateTableOutcome&, const Aws::Client::AsyncCallerContext*> UpdateTableOutcomeReceivedEvent;
  ...
  */
  class AWS_DYNAMODB_API DynamoDBClient : public Aws::Client::AWSJsonClient
  {
     ...
     */
     Model::BatchGetItemOutcome BatchGetItem(const Model::BatchGetItemRequest& request) const;
     ...
     */
     Model::BatchGetItemOutcomeCallable BatchGetItemCallable(const Model::BatchGetItemRequest& request) const;
     ...
     */
     void BatchGetItemAsync(const Model::BatchGetItemRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::BatchWriteItemOutcome BatchWriteItem(const Model::BatchWriteItemRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::BatchWriteItemOutcomeCallable BatchWriteItemCallable(const Model::BatchWriteItemRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void BatchWriteItemAsync(const Model::BatchWriteItemRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::CreateTableOutcome CreateTable(const Model::CreateTableRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::CreateTableOutcomeCallable CreateTableCallable(const Model::CreateTableRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void CreateTableAsync(const Model::CreateTableRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::DeleteItemOutcome DeleteItem(const Model::DeleteItemRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::DeleteItemOutcomeCallable DeleteItemCallable(const Model::DeleteItemRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DeleteItemAsync(const Model::DeleteItemRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::DeleteTableOutcome DeleteTable(const Model::DeleteTableRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::DeleteTableOutcomeCallable DeleteTableCallable(const Model::DeleteTableRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DeleteTableAsync(const Model::DeleteTableRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::DescribeTableOutcome DescribeTable(const Model::DescribeTableRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::DescribeTableOutcomeCallable DescribeTableCallable(const Model::DescribeTableRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribeTableAsync(const Model::DescribeTableRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::GetItemOutcome GetItem(const Model::GetItemRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::GetItemOutcomeCallable GetItemCallable(const Model::GetItemRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetItemAsync(const Model::GetItemRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::ListTablesOutcome ListTables(const Model::ListTablesRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::ListTablesOutcomeCallable ListTablesCallable(const Model::ListTablesRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListTablesAsync(const Model::ListTablesRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::PutItemOutcome PutItem(const Model::PutItemRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::PutItemOutcomeCallable PutItemCallable(const Model::PutItemRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void PutItemAsync(const Model::PutItemRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::QueryOutcome Query(const Model::QueryRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::QueryOutcomeCallable QueryCallable(const Model::QueryRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void QueryAsync(const Model::QueryRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::ScanOutcome Scan(const Model::ScanRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::ScanOutcomeCallable ScanCallable(const Model::ScanRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ScanAsync(const Model::ScanRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::UpdateItemOutcome UpdateItem(const Model::UpdateItemRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::UpdateItemOutcomeCallable UpdateItemCallable(const Model::UpdateItemRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void UpdateItemAsync(const Model::UpdateItemRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;
     ...
     */
     Model::UpdateTableOutcome UpdateTable(const Model::UpdateTableRequest& request) const;
     ...
     /*
       ...
       returns a future to the operation so that it can be executed in parallel to other requests.
     */
     Model::UpdateTableOutcomeCallable UpdateTableCallable(const Model::UpdateTableRequest& request) const;
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void UpdateTableAsync(const Model::UpdateTableRequest& request, const Aws::Client::AsyncCallerContext* context = nullptr) const;

   /**
    * Adds an event handler for BatchGetItemAsync to call upon completion to the handler chain. You need to call this to
    * use BatchGetItemAsync.
    */
    inline void RegisterBatchGetItemOutcomeReceivedHandler(const BatchGetItemOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onBatchGetItemOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for BatchGetItem.
    */
    inline void ClearAllBatchGetItemOutcomeReceivedHandlers()
    {
      m_onBatchGetItemOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for BatchWriteItemAsync to call upon completion to the handler chain. You need to call this to
    * use BatchWriteItemAsync.
    */
    inline void RegisterBatchWriteItemOutcomeReceivedHandler(const BatchWriteItemOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onBatchWriteItemOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for BatchWriteItem.
    */
    inline void ClearAllBatchWriteItemOutcomeReceivedHandlers()
    {
      m_onBatchWriteItemOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for CreateTableAsync to call upon completion to the handler chain. You need to call this to
    * use CreateTableAsync.
    */
    inline void RegisterCreateTableOutcomeReceivedHandler(const CreateTableOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onCreateTableOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for CreateTable.
    */
    inline void ClearAllCreateTableOutcomeReceivedHandlers()
    {
      m_onCreateTableOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for DeleteItemAsync to call upon completion to the handler chain. You need to call this to
    * use DeleteItemAsync.
    */
    inline void RegisterDeleteItemOutcomeReceivedHandler(const DeleteItemOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onDeleteItemOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for DeleteItem.
    */
    inline void ClearAllDeleteItemOutcomeReceivedHandlers()
    {
      m_onDeleteItemOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for DeleteTableAsync to call upon completion to the handler chain. You need to call this to
    * use DeleteTableAsync.
    */
    inline void RegisterDeleteTableOutcomeReceivedHandler(const DeleteTableOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onDeleteTableOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for DeleteTable.
    */
    inline void ClearAllDeleteTableOutcomeReceivedHandlers()
    {
      m_onDeleteTableOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for DescribeTableAsync to call upon completion to the handler chain. You need to call this to
    * use DescribeTableAsync.
    */
    inline void RegisterDescribeTableOutcomeReceivedHandler(const DescribeTableOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onDescribeTableOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for DescribeTable.
    */
    inline void ClearAllDescribeTableOutcomeReceivedHandlers()
    {
      m_onDescribeTableOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for GetItemAsync to call upon completion to the handler chain. You need to call this to
    * use GetItemAsync.
    */
    inline void RegisterGetItemOutcomeReceivedHandler(const GetItemOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onGetItemOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for GetItem.
    */
    inline void ClearAllGetItemOutcomeReceivedHandlers()
    {
      m_onGetItemOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for ListTablesAsync to call upon completion to the handler chain. You need to call this to
    * use ListTablesAsync.
    */
    inline void RegisterListTablesOutcomeReceivedHandler(const ListTablesOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onListTablesOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for ListTables.
    */
    inline void ClearAllListTablesOutcomeReceivedHandlers()
    {
      m_onListTablesOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for PutItemAsync to call upon completion to the handler chain. You need to call this to
    * use PutItemAsync.
    */
    inline void RegisterPutItemOutcomeReceivedHandler(const PutItemOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onPutItemOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for PutItem.
    */
    inline void ClearAllPutItemOutcomeReceivedHandlers()
    {
      m_onPutItemOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for QueryAsync to call upon completion to the handler chain. You need to call this to
    * use QueryAsync.
    */
    inline void RegisterQueryOutcomeReceivedHandler(const QueryOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onQueryOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for Query.
    */
    inline void ClearAllQueryOutcomeReceivedHandlers()
    {
      m_onQueryOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for ScanAsync to call upon completion to the handler chain. You need to call this to
    * use ScanAsync.
    */
    inline void RegisterScanOutcomeReceivedHandler(const ScanOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onScanOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for Scan.
    */
    inline void ClearAllScanOutcomeReceivedHandlers()
    {
      m_onScanOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for UpdateItemAsync to call upon completion to the handler chain. You need to call this to
    * use UpdateItemAsync.
    */
    inline void RegisterUpdateItemOutcomeReceivedHandler(const UpdateItemOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onUpdateItemOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for UpdateItem.
    */
    inline void ClearAllUpdateItemOutcomeReceivedHandlers()
    {
      m_onUpdateItemOutcomeReceived.Clear();
    }

   /**
    * Adds an event handler for UpdateTableAsync to call upon completion to the handler chain. You need to call this to
    * use UpdateTableAsync.
    */
    inline void RegisterUpdateTableOutcomeReceivedHandler(const UpdateTableOutcomeReceivedEvent::EventHandler& handler)
    {
      m_onUpdateTableOutcomeReceived += handler;
    }

    /**
    * Clears all event handlers for UpdateTable.
    */
    inline void ClearAllUpdateTableOutcomeReceivedHandlers()
    {
      m_onUpdateTableOutcomeReceived.Clear();
    }
  ...
  private:
    ...
    /**Async helpers**/
    void BatchGetItemAsyncHelper(const Model::BatchGetItemRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void BatchWriteItemAsyncHelper(const Model::BatchWriteItemRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void CreateTableAsyncHelper(const Model::CreateTableRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void DeleteItemAsyncHelper(const Model::DeleteItemRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void DeleteTableAsyncHelper(const Model::DeleteTableRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void DescribeTableAsyncHelper(const Model::DescribeTableRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void GetItemAsyncHelper(const Model::GetItemRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void ListTablesAsyncHelper(const Model::ListTablesRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void PutItemAsyncHelper(const Model::PutItemRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void QueryAsyncHelper(const Model::QueryRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void ScanAsyncHelper(const Model::ScanRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void UpdateItemAsyncHelper(const Model::UpdateItemRequest& request, const Aws::Client::AsyncCallerContext* context) const;
    void UpdateTableAsyncHelper(const Model::UpdateTableRequest& request, const Aws::Client::AsyncCallerContext* context) const;

    Aws::String m_uri;
    std::shared_ptr<Utils::Threading::Executor> m_executor;

    /** events **/
    BatchGetItemOutcomeReceivedEvent m_onBatchGetItemOutcomeReceived;
    BatchWriteItemOutcomeReceivedEvent m_onBatchWriteItemOutcomeReceived;
    CreateTableOutcomeReceivedEvent m_onCreateTableOutcomeReceived;
    DeleteItemOutcomeReceivedEvent m_onDeleteItemOutcomeReceived;
    DeleteTableOutcomeReceivedEvent m_onDeleteTableOutcomeReceived;
    DescribeTableOutcomeReceivedEvent m_onDescribeTableOutcomeReceived;
    GetItemOutcomeReceivedEvent m_onGetItemOutcomeReceived;
    ListTablesOutcomeReceivedEvent m_onListTablesOutcomeReceived;
    PutItemOutcomeReceivedEvent m_onPutItemOutcomeReceived;
    QueryOutcomeReceivedEvent m_onQueryOutcomeReceived;
    ScanOutcomeReceivedEvent m_onScanOutcomeReceived;
    UpdateItemOutcomeReceivedEvent m_onUpdateItemOutcomeReceived;
    UpdateTableOutcomeReceivedEvent m_onUpdateTableOutcomeReceived;
  };
