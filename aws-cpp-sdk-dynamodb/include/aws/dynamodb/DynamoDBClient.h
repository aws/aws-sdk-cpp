...
namespace DynamoDB
{
  ...
  class AWS_DYNAMODB_API DynamoDBClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DynamoDBClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::DynamoDBEndpointProvider> endpointProvider = Aws::MakeShared<DynamoDB::Endpoint::DynamoDBEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DynamoDBEndpointProvider> m_endpointProvider;
  };
