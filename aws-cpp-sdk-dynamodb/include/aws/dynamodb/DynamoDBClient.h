...
namespace Model
{
  ...
  typedef Aws::Utils::Event<DynamoDBClient, const Model::BatchGetItemRequest&, const Model::BatchGetItemOutcome&> BatchGetItemOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::BatchWriteItemRequest&, const Model::BatchWriteItemOutcome&> BatchWriteItemOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::CreateTableRequest&, const Model::CreateTableOutcome&> CreateTableOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::DeleteItemRequest&, const Model::DeleteItemOutcome&> DeleteItemOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::DeleteTableRequest&, const Model::DeleteTableOutcome&> DeleteTableOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::DescribeTableRequest&, const Model::DescribeTableOutcome&> DescribeTableOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::GetItemRequest&, const Model::GetItemOutcome&> GetItemOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::ListTablesRequest&, const Model::ListTablesOutcome&> ListTablesOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::PutItemRequest&, const Model::PutItemOutcome&> PutItemOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::QueryRequest&, const Model::QueryOutcome&> QueryOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::ScanRequest&, const Model::ScanOutcome&> ScanOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::UpdateItemRequest&, const Model::UpdateItemOutcome&> UpdateItemOutcomeReceivedEvent;
  typedef Aws::Utils::Event<DynamoDBClient, const Model::UpdateTableRequest&, const Model::UpdateTableOutcome&> UpdateTableOutcomeReceivedEvent;
  ...
  */
  class AWS_DYNAMODB_API DynamoDBClient : public Aws::Client::AWSJsonClient
  {
     ...
     */
     void BatchGetItemAsync(const Model::BatchGetItemRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void BatchWriteItemAsync(const Model::BatchWriteItemRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void CreateTableAsync(const Model::CreateTableRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DeleteItemAsync(const Model::DeleteItemRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DeleteTableAsync(const Model::DeleteTableRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribeTableAsync(const Model::DescribeTableRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetItemAsync(const Model::GetItemRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListTablesAsync(const Model::ListTablesRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void PutItemAsync(const Model::PutItemRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void QueryAsync(const Model::QueryRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ScanAsync(const Model::ScanRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void UpdateItemAsync(const Model::UpdateItemRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void UpdateTableAsync(const Model::UpdateTableRequest& request) const;
  ...
  private:
    ...
    /**Async helpers**/
    void BatchGetItemAsyncHelper(const Model::BatchGetItemRequest& request) const;
    void BatchWriteItemAsyncHelper(const Model::BatchWriteItemRequest& request) const;
    void CreateTableAsyncHelper(const Model::CreateTableRequest& request) const;
    void DeleteItemAsyncHelper(const Model::DeleteItemRequest& request) const;
    void DeleteTableAsyncHelper(const Model::DeleteTableRequest& request) const;
    void DescribeTableAsyncHelper(const Model::DescribeTableRequest& request) const;
    void GetItemAsyncHelper(const Model::GetItemRequest& request) const;
    void ListTablesAsyncHelper(const Model::ListTablesRequest& request) const;
    void PutItemAsyncHelper(const Model::PutItemRequest& request) const;
    void QueryAsyncHelper(const Model::QueryRequest& request) const;
    void ScanAsyncHelper(const Model::ScanRequest& request) const;
    void UpdateItemAsyncHelper(const Model::UpdateItemRequest& request) const;
    void UpdateTableAsyncHelper(const Model::UpdateTableRequest& request) const;
