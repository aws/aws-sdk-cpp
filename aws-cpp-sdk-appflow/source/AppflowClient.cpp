...
using ResolveEndpointOutcome = Aws::Appflow::Endpoint::AppflowEndpointProvider::AppflowResolveEndpointOutcome;
...
AppflowClient::AppflowClient(const Client::ClientConfiguration& clientConfiguration,
                             std::shared_ptr<Endpoint::AppflowEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<AppflowErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Appflow::Endpoint::AppflowEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
