...
Aws::String AppflowEndpointRules::GetRulesAsString()
{
    return Aws::String(AppflowEndpointRules::Rules.begin(), AppflowEndpointRules::Rules.end());
}

const Aws::Vector<char> AppflowEndpointRules::Rules = {
