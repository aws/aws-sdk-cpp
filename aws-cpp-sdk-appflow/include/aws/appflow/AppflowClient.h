...
namespace Appflow
{
  ...
  class AWS_APPFLOW_API AppflowClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AppflowClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                      std::shared_ptr<Endpoint::AppflowEndpointProvider> endpointProvider = Aws::MakeShared<Appflow::Endpoint::AppflowEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AppflowEndpointProvider> m_endpointProvider;
  };
