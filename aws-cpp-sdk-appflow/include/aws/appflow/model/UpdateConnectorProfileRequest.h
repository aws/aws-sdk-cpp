...
namespace Model
{
  ...
  /**
   */
  class AWS_APPFLOW_API UpdateConnectorProfileRequest : public AppflowRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateConnectorProfileRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateConnectorProfileRequest>(GetServiceRequestName(), *this);
    }
