...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPFLOW_API RegistrationOutput
  {
  public:
    RegistrationOutput();
    RegistrationOutput(Aws::Utils::Json::JsonView jsonValue);
    RegistrationOutput& operator=(Aws::Utils::Json::JsonView jsonValue);
