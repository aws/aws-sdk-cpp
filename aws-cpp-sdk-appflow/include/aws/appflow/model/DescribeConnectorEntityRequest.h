...
namespace Model
{
  ...
  /**
   */
  class AWS_APPFLOW_API DescribeConnectorEntityRequest : public AppflowRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConnectorEntityRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConnectorEntityRequest>(GetServiceRequestName(), *this);
    }
