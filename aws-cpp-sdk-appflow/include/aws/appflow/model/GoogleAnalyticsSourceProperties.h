...
namespace Model
{
  ...
  /**
   * <p> The properties that are applied when Google Analytics is being used as a
   * source. </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/appflow-2020-08-23/GoogleAnalyticsSourceProperties">AWS
   * API Reference</a></p>
   */
  class AWS_APPFLOW_API GoogleAnalyticsSourceProperties
  {
  public:
    GoogleAnalyticsSourceProperties();
    GoogleAnalyticsSourceProperties(Aws::Utils::Json::JsonView jsonValue);
    GoogleAnalyticsSourceProperties& operator=(Aws::Utils::Json::JsonView jsonValue);
