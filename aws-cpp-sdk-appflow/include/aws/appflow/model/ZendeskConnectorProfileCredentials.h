...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPFLOW_API ZendeskConnectorProfileCredentials
  {
  public:
    ZendeskConnectorProfileCredentials();
    ZendeskConnectorProfileCredentials(Aws::Utils::Json::JsonView jsonValue);
    ZendeskConnectorProfileCredentials& operator=(Aws::Utils::Json::JsonView jsonValue);
