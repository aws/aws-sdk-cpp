...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFlowExecutionRecordsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFlowExecutionRecordsRequest>(GetServiceRequestName(), *this);
    }
