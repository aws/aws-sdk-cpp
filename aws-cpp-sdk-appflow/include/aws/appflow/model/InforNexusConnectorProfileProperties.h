...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPFLOW_API InforNexusConnectorProfileProperties
  {
  public:
    InforNexusConnectorProfileProperties();
    InforNexusConnectorProfileProperties(Aws::Utils::Json::JsonView jsonValue);
    InforNexusConnectorProfileProperties& operator=(Aws::Utils::Json::JsonView jsonValue);
