...
namespace Model
{
  ...
  /**
   */
  class AWS_APPFLOW_API DeleteConnectorProfileRequest : public AppflowRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteConnectorProfileRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteConnectorProfileRequest>(GetServiceRequestName(), *this);
    }
