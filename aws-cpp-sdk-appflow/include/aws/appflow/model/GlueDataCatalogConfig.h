...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPFLOW_API GlueDataCatalogConfig
  {
  public:
    GlueDataCatalogConfig();
    GlueDataCatalogConfig(Aws::Utils::Json::JsonView jsonValue);
    GlueDataCatalogConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
