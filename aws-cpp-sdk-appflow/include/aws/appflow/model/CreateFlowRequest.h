...
namespace Model
{
  ...
  /**
   */
  class AWS_APPFLOW_API CreateFlowRequest : public AppflowRequest
  {
  public:
    CreateFlowRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateFlowRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFlowRequest>(GetServiceRequestName(), *this);
    }
