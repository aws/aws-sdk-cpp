...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPFLOW_API SingularSourceProperties
  {
  public:
    SingularSourceProperties();
    SingularSourceProperties(Aws::Utils::Json::JsonView jsonValue);
    SingularSourceProperties& operator=(Aws::Utils::Json::JsonView jsonValue);
