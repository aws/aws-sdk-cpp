...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPFLOW_API BasicAuthCredentials
  {
  public:
    BasicAuthCredentials();
    BasicAuthCredentials(Aws::Utils::Json::JsonView jsonValue);
    BasicAuthCredentials& operator=(Aws::Utils::Json::JsonView jsonValue);
