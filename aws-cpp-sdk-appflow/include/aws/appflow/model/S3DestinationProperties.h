...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPFLOW_API S3DestinationProperties
  {
  public:
    S3DestinationProperties();
    S3DestinationProperties(Aws::Utils::Json::JsonView jsonValue);
    S3DestinationProperties& operator=(Aws::Utils::Json::JsonView jsonValue);
