...
namespace Model
{
  ...
  /**
   */
  class AWS_APPFLOW_API DeleteFlowRequest : public AppflowRequest
  {
  public:
    DeleteFlowRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteFlowRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFlowRequest>(GetServiceRequestName(), *this);
    }
