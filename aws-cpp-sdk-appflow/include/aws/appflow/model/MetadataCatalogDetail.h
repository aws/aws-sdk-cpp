...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPFLOW_API MetadataCatalogDetail
  {
  public:
    MetadataCatalogDetail();
    MetadataCatalogDetail(Aws::Utils::Json::JsonView jsonValue);
    MetadataCatalogDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
