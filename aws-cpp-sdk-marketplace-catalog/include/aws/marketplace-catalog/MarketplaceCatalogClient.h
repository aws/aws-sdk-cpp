...
namespace MarketplaceCatalog
{
  ...
  class AWS_MARKETPLACECATALOG_API MarketplaceCatalogClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MarketplaceCatalogClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                 std::shared_ptr<Endpoint::MarketplaceCatalogEndpointProvider> endpointProvider = Aws::MakeShared<MarketplaceCatalog::Endpoint::MarketplaceCatalogEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MarketplaceCatalogEndpointProvider> m_endpointProvider;
  };
