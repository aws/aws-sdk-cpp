...
namespace Model
{
  ...
  /**
   */
  class AWS_MARKETPLACECATALOG_API CancelChangeSetRequest : public MarketplaceCatalogRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelChangeSetRequest> Clone() const
    {
      return Aws::MakeUnique<CancelChangeSetRequest>(GetServiceRequestName(), *this);
    }
