...
namespace Model
{
  ...
  /**
   */
  class AWS_MARKETPLACECATALOG_API ListEntitiesRequest : public MarketplaceCatalogRequest
  {
  public:
    ListEntitiesRequest();
    ...
    */
    virtual Aws::UniquePtr<ListEntitiesRequest> Clone() const
    {
      return Aws::MakeUnique<ListEntitiesRequest>(GetServiceRequestName(), *this);
    }
