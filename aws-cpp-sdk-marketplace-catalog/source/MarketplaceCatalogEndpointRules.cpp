...
Aws::String MarketplaceCatalogEndpointRules::GetRulesAsString()
{
    return Aws::String(MarketplaceCatalogEndpointRules::Rules.begin(), MarketplaceCatalogEndpointRules::Rules.end());
}

const Aws::Vector<char> MarketplaceCatalogEndpointRules::Rules = {
...
'e','t','p','l','a','c','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','a','t',
'a','l','o','g','.','m','a','r','k','e','t','p','l','a','c','e','.','{','R','e','g','i','o','n','}',
...
'l','o','g','.','m','a','r','k','e','t','p','l','a','c','e','.','{','R','e','g','i','o','n','}','.',
