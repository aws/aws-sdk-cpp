...
using ResolveEndpointOutcome = Aws::MarketplaceCatalog::Endpoint::MarketplaceCatalogEndpointProvider::MarketplaceCatalogResolveEndpointOutcome;
...
MarketplaceCatalogClient::MarketplaceCatalogClient(const Client::ClientConfiguration& clientConfiguration,
                                                   std::shared_ptr<Endpoint::MarketplaceCatalogEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<MarketplaceCatalogErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<MarketplaceCatalog::Endpoint::MarketplaceCatalogEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
