...
{
const size_t IoTEventsDataEndpointRules::RulesBlobStrLen = 3444;
const size_t IoTEventsDataEndpointRules::RulesBlobSize = 3445;

using RulesBlobT = Aws::Array<const char, IoTEventsDataEndpointRules::RulesBlobSize>;
...
'o','t','e','v','e','n','t','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','a','t','a','.',
'i','o','t','e','v','e','n','t','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','a','t','a','.','i','o','t','e','v','e',
...
const char* IoTEventsDataEndpointRules::GetRulesBlob()
{
