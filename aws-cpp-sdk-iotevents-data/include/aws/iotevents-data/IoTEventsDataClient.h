...
namespace IoTEventsData
{
  ...
  class AWS_IOTEVENTSDATA_API IoTEventsDataClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IoTEventsDataClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::IoTEventsDataEndpointProvider> endpointProvider = Aws::MakeShared<IoTEventsData::Endpoint::IoTEventsDataEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IoTEventsDataEndpointProvider> m_endpointProvider;
  };
