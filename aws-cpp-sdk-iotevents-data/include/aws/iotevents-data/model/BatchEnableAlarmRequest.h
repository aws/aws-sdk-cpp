...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTEVENTSDATA_API BatchEnableAlarmRequest : public IoTEventsDataRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchEnableAlarmRequest> Clone() const
    {
      return Aws::MakeUnique<BatchEnableAlarmRequest>(GetServiceRequestName(), *this);
    }
