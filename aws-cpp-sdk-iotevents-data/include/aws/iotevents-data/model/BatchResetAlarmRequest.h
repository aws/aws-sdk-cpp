...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTEVENTSDATA_API BatchResetAlarmRequest : public IoTEventsDataRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchResetAlarmRequest> Clone() const
    {
      return Aws::MakeUnique<BatchResetAlarmRequest>(GetServiceRequestName(), *this);
    }
