...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTEVENTSDATA_API BatchDisableAlarmRequest : public IoTEventsDataRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDisableAlarmRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDisableAlarmRequest>(GetServiceRequestName(), *this);
    }
