...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTEVENTSDATA_API DescribeAlarmRequest : public IoTEventsDataRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAlarmRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAlarmRequest>(GetServiceRequestName(), *this);
    }
