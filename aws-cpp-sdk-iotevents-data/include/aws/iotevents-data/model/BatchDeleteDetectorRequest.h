...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTEVENTSDATA_API BatchDeleteDetectorRequest : public IoTEventsDataRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDeleteDetectorRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDeleteDetectorRequest>(GetServiceRequestName(), *this);
    }
