...
namespace Model
{
  ...
  /**
   * <p>Information needed to acknowledge the alarm.</p><p><h3>See Also:</h3>   <a
  ...
  public:
     ...
     * <p>The request ID. Each ID must be unique within each batch.</p>
     */
    inline AcknowledgeAlarmActionRequest& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    /**
     * <p>The request ID. Each ID must be unique within each batch.</p>
     */
    inline AcknowledgeAlarmActionRequest& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    /**
     * <p>The request ID. Each ID must be unique within each batch.</p>
     */
    inline AcknowledgeAlarmActionRequest& WithRequestId(const char* value) { SetRequestId(value); return *this;}
     ...
     * <p>The name of the alarm model.</p>
     */
    inline AcknowledgeAlarmActionRequest& WithAlarmModelName(const Aws::String& value) { SetAlarmModelName(value); return *this;}

    /**
     * <p>The name of the alarm model.</p>
     */
    inline AcknowledgeAlarmActionRequest& WithAlarmModelName(Aws::String&& value) { SetAlarmModelName(std::move(value)); return *this;}

    /**
     * <p>The name of the alarm model.</p>
     */
    inline AcknowledgeAlarmActionRequest& WithAlarmModelName(const char* value) { SetAlarmModelName(value); return *this;}
     ...
     * href="https://docs.aws.amazon.com/iotevents/latest/apireference/API_CreateAlarmModel.html#iotevents-CreateAlarmModel-request-key">key</a>.</p>
     */
    inline AcknowledgeAlarmActionRequest& WithKeyValue(const Aws::String& value) { SetKeyValue(value); return *this;}
     ...
     * href="https://docs.aws.amazon.com/iotevents/latest/apireference/API_CreateAlarmModel.html#iotevents-CreateAlarmModel-request-key">key</a>.</p>
     */
    inline AcknowledgeAlarmActionRequest& WithKeyValue(Aws::String&& value) { SetKeyValue(std::move(value)); return *this;}
     ...
     * href="https://docs.aws.amazon.com/iotevents/latest/apireference/API_CreateAlarmModel.html#iotevents-CreateAlarmModel-request-key">key</a>.</p>
     */
    inline AcknowledgeAlarmActionRequest& WithKeyValue(const char* value) { SetKeyValue(value); return *this;}
     ...
     * <p>The note that you can leave when you acknowledge the alarm.</p>
     */
    inline AcknowledgeAlarmActionRequest& WithNote(const Aws::String& value) { SetNote(value); return *this;}

    /**
     * <p>The note that you can leave when you acknowledge the alarm.</p>
     */
    inline AcknowledgeAlarmActionRequest& WithNote(Aws::String&& value) { SetNote(std::move(value)); return *this;}

    /**
     * <p>The note that you can leave when you acknowledge the alarm.</p>
     */
    inline AcknowledgeAlarmActionRequest& WithNote(const char* value) { SetNote(value); return *this;}
