...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_IOTEVENTSDATA_API AcknowledgeActionConfiguration
  {
  public:
    AcknowledgeActionConfiguration();
    AcknowledgeActionConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AcknowledgeActionConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
