...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTEVENTSDATA_API ListAlarmsRequest : public IoTEventsDataRequest
  {
  public:
    ListAlarmsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListAlarmsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAlarmsRequest>(GetServiceRequestName(), *this);
    }
