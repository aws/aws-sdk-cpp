...
namespace PinpointEmail
{
  ...
  class AWS_PINPOINTEMAIL_API PinpointEmailClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        PinpointEmailClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::PinpointEmailEndpointProvider> endpointProvider = Aws::MakeShared<PinpointEmail::Endpoint::PinpointEmailEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::PinpointEmailEndpointProvider> m_endpointProvider;
  };
