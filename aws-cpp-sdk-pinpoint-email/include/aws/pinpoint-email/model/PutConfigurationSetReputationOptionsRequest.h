...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutConfigurationSetReputationOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<PutConfigurationSetReputationOptionsRequest>(GetServiceRequestName(), *this);
    }
