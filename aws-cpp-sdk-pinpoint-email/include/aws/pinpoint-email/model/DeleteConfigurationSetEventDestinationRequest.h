...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PINPOINTEMAIL_API DeleteConfigurationSetEventDestinationRequest : public PinpointEmailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteConfigurationSetEventDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteConfigurationSetEventDestinationRequest>(GetServiceRequestName(), *this);
    }
