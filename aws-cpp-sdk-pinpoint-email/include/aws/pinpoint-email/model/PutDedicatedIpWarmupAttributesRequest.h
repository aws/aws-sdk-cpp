...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutDedicatedIpWarmupAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<PutDedicatedIpWarmupAttributesRequest>(GetServiceRequestName(), *this);
    }
