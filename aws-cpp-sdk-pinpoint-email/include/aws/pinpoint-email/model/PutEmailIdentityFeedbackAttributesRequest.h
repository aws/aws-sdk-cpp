...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutEmailIdentityFeedbackAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<PutEmailIdentityFeedbackAttributesRequest>(GetServiceRequestName(), *this);
    }
