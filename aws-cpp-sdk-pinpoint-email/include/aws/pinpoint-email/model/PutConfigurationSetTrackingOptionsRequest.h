...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutConfigurationSetTrackingOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<PutConfigurationSetTrackingOptionsRequest>(GetServiceRequestName(), *this);
    }
