...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAccountSendingAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<PutAccountSendingAttributesRequest>(GetServiceRequestName(), *this);
    }
