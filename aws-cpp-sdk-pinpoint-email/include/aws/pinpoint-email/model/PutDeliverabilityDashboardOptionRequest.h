...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutDeliverabilityDashboardOptionRequest> Clone() const
    {
      return Aws::MakeUnique<PutDeliverabilityDashboardOptionRequest>(GetServiceRequestName(), *this);
    }
