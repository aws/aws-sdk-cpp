...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutConfigurationSetDeliveryOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<PutConfigurationSetDeliveryOptionsRequest>(GetServiceRequestName(), *this);
    }
