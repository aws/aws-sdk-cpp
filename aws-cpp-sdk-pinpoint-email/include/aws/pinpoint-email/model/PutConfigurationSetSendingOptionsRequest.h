...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutConfigurationSetSendingOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<PutConfigurationSetSendingOptionsRequest>(GetServiceRequestName(), *this);
    }
