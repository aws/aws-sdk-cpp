...
namespace Model
{
  ...
  /**
   * <p>A request to retrieve the status of the Deliverability dashboard for your
   ...
   * charge of USD$1,250.00, in addition to any other fees that you accrue by using
   * Amazon Pinpoint. If you enable the Deliverability dashboard after the first day
   * of a calendar month, AWS prorates the monthly charge based on how many days have
   * elapsed in the current calendar month.</p><p><h3>See Also:</h3>   <a
