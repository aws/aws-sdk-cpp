...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDomainDeliverabilityCampaignsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDomainDeliverabilityCampaignsRequest>(GetServiceRequestName(), *this);
    }
