...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDeliverabilityTestReportRequest> Clone() const
    {
      return Aws::MakeUnique<GetDeliverabilityTestReportRequest>(GetServiceRequestName(), *this);
    }
