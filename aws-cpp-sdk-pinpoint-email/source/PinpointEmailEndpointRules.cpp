...
Aws::String PinpointEmailEndpointRules::GetRulesAsString()
{
    return Aws::String(PinpointEmailEndpointRules::Rules.begin(), PinpointEmailEndpointRules::Rules.end());
}

const Aws::Vector<char> PinpointEmailEndpointRules::Rules = {
...
':','/','/','e','m','a','i','l','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
'i','o','n','R','e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r',
'o','p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}',
'}',',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}'};
