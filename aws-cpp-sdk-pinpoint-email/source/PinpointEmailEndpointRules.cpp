...
{
const size_t PinpointEmailEndpointRules::RulesBlobStrLen = 3450;
const size_t PinpointEmailEndpointRules::RulesBlobSize = 3451;

using RulesBlobT = Aws::Array<const char, PinpointEmailEndpointRules::RulesBlobSize>;
...
'm','a','i','l','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
const char* PinpointEmailEndpointRules::GetRulesBlob()
{
