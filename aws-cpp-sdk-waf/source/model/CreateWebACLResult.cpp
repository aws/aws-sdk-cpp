...
CreateWebACLResult::CreateWebACLResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateWebACLResult& CreateWebACLResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
