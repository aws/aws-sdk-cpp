...
CreateRuleResult::CreateRuleResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateRuleResult& CreateRuleResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
