...
namespace WAF
{
  ...
  class AWS_WAF_API WAFClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        WAFClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::WAFEndpointProvider> endpointProvider = Aws::MakeShared<WAF::Endpoint::WAFEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::WAFEndpointProvider> m_endpointProvider;
  };
