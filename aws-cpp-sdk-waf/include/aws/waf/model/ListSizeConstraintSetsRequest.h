...
namespace Model
{
  ...
  /**
   */
  class AWS_WAF_API ListSizeConstraintSetsRequest : public WAFRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSizeConstraintSetsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSizeConstraintSetsRequest>(GetServiceRequestName(), *this);
    }
