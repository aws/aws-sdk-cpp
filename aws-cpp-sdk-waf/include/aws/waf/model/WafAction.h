...
namespace Model
{
  ...
  public:
     ...
     * in a <code>Rule</code>. Valid settings include the following:</p> <ul>
     * <li><code>ALLOW</code>: AWS WAF allows requests</li> <li><code>BLOCK</code>: AWS
     * WAF blocks requests</li> <li><code>COUNT</code>: AWS WAF increments a counter of
     * the requests that match all of the conditions in the rule. AWS WAF then
