...
namespace Model
{
  ...
  /**
   */
  class AWS_WAF_API CreateGeoMatchSetRequest : public WAFRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateGeoMatchSetRequest> Clone() const
    {
      return Aws::MakeUnique<CreateGeoMatchSetRequest>(GetServiceRequestName(), *this);
    }
