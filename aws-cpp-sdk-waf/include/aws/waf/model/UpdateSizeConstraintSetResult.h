...
namespace Model
{
  class AWS_WAF_API UpdateSizeConstraintSetResult
  {
  public:
    UpdateSizeConstraintSetResult();
    UpdateSizeConstraintSetResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateSizeConstraintSetResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <a>GetChangeTokenStatus</a>.</p>
     */
    inline UpdateSizeConstraintSetResult& WithChangeToken(Aws::String&& value) { SetChangeToken(value); return *this;}
