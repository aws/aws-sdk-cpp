...
namespace Model
{
  ...
  /**
   */
  class AWS_WAF_API CreateRegexMatchSetRequest : public WAFRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateRegexMatchSetRequest> Clone() const
    {
      return Aws::MakeUnique<CreateRegexMatchSetRequest>(GetServiceRequestName(), *this);
    }
