...
namespace Model
{
  ...
  /**
   */
  class AWS_WAF_API UpdateRegexMatchSetRequest : public WAFRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRegexMatchSetRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRegexMatchSetRequest>(GetServiceRequestName(), *this);
    }
