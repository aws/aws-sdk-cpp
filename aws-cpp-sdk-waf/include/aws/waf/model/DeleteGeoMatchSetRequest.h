...
namespace Model
{
  ...
  /**
   */
  class AWS_WAF_API DeleteGeoMatchSetRequest : public WAFRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteGeoMatchSetRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteGeoMatchSetRequest>(GetServiceRequestName(), *this);
    }
