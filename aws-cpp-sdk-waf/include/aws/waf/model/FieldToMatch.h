...
namespace Model
{
  ...
  public:
     ...
     * <li><code>HEADER</code>: A specified request header, for example, the value of
     ...
     * <code>Data</code>.</li> <li><code>METHOD</code>: The HTTP method, which
     * indicated the type of operation that the request is asking the origin to
     ...
     * <code>POST</code>, and <code>PUT</code>.</li> <li><code>QUERY_STRING</code>: A
     * query string, which is the part of a URL that appears after a <code>?</code>
     * character, if any.</li> <li><code>URI</code>: The part of a web request that
     * identifies a resource, for example, <code>/images/daily-ad.jpg</code>.</li>
     * <li><code>BODY</code>: The part of a request that contains any additional data
     * that you want to send to your web server as the HTTP request body, such as data
     * from a form. The request body immediately follows the request headers. Note that
     * only the first <code>8192</code> bytes of the request body are forwarded to AWS
     * WAF for inspection. To allow or block requests based on the length of the body,
     * you can create a size constraint set. For more information, see
     * <a>CreateSizeConstraintSet</a>. </li> </ul>
     */
