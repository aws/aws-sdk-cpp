...
namespace Model
{
  ...
  /**
   */
  class AWS_WAF_API DeleteRuleGroupRequest : public WAFRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRuleGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRuleGroupRequest>(GetServiceRequestName(), *this);
    }
