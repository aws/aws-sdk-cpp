...
namespace Model
{
  ...
  public:
    SizeConstraint();
    SizeConstraint(const Aws::Utils::Json::JsonValue& jsonValue);
     ...
     * before inspecting a request for a match.</p> <p>Note that if you choose
     * <code>BODY</code> for the value of <code>Type</code>, you must choose
     * <code>NONE</code> for <code>TextTransformation</code> because CloudFront
     * forwards only the first 8192 bytes for inspection. </p> <p><b>NONE</b></p>
     * <p>Specify <code>NONE</code> if you don't want to perform any text
     * transformations.</p> <p><b>CMD_LINE</b></p> <p>When you're concerned that
     ...
     * perform the following transformations:</p> <ul> <li>Delete the following
     * characters: \ " ' ^</li> <li>Delete spaces before the following characters: /
     * (</li> <li>Replace the following characters with a space: , ;</li> <li>Replace
     * multiple spaces with one space</li> <li>Convert uppercase letters (A-Z) to
     * lowercase (a-z)</li> </ul> <p><b>COMPRESS_WHITE_SPACE</b></p> <p>Use this option
     * to replace the following characters with a space character (decimal 32):</p>
     * <ul> <li>\f, formfeed, decimal 12</li> <li>\t, tab, decimal 9</li> <li>\n,
     * newline, decimal 10</li> <li>\r, carriage return, decimal 13</li> <li>\v,
     * vertical tab, decimal 11</li> <li>non-breaking space, decimal 160</li> </ul>
     * <p><code>COMPRESS_WHITE_SPACE</code> also replaces multiple spaces with one
     ...
     * <p><b>LE</b>: Used to test if the <code>Size</code> is less than or equal to the
     * size of the <code>FieldToMatch</code></p> <p><b>LT</b>: Used to test if the
     * <code>Size</code> is strictly less than the size of the
