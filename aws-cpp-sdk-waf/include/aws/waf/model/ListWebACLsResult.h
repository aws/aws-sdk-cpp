...
namespace Model
{
  ...
  public:
     ...
     * value in the next request.</p>
     */
    inline ListWebACLsResult& WithNextMarker(Aws::String&& value) { SetNextMarker(value); return *this;}
     ...
     * <p>An array of <a>WebACLSummary</a> objects.</p>
     */
    inline void SetWebACLs(Aws::Vector<WebACLSummary>&& value) { m_webACLs = value; }
     ...
     * <p>An array of <a>WebACLSummary</a> objects.</p>
     */
    inline ListWebACLsResult& WithWebACLs(Aws::Vector<WebACLSummary>&& value) { SetWebACLs(value); return *this;}
     ...
     * <p>An array of <a>WebACLSummary</a> objects.</p>
     */
    inline ListWebACLsResult& AddWebACLs(WebACLSummary&& value) { m_webACLs.push_back(value); return *this; }
