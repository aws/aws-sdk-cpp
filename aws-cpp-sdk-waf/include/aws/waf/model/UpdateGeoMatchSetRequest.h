...
namespace Model
{
  ...
  /**
   */
  class AWS_WAF_API UpdateGeoMatchSetRequest : public WAFRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateGeoMatchSetRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateGeoMatchSetRequest>(GetServiceRequestName(), *this);
    }
