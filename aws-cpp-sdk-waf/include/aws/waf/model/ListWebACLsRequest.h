...
namespace Model
{
  ...
  public:
     ...
     * about another batch of <code>WebACL</code> objects.</p>
     */
    inline ListWebACLsRequest& WithNextMarker(Aws::String&& value) { SetNextMarker(value); return *this;}
     ...
     * <code>WebACL</code> objects.</p>
     */
    inline ListWebACLsRequest& WithLimit(long value) { SetLimit(value); return *this;}
