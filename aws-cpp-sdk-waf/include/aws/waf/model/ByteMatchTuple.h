...
namespace Model
{
  ...
  public:
     ...
     * <code>FieldToMatch</code>:</p> <ul> <li><code>HEADER</code>: The value that you
     * want AWS WAF to search for in the request header that you specified in
     * <a>FieldToMatch</a>, for example, the value of the <code>User-Agent</code> or
     * <code>Referer</code> header.</li> <li><code>METHOD</code>: The HTTP method,
     * which indicates the type of operation specified in the request. CloudFront
     * supports the following methods: <code>DELETE</code>, <code>GET</code>,
     * <code>HEAD</code>, <code>OPTIONS</code>, <code>PATCH</code>, <code>POST</code>,
     * and <code>PUT</code>.</li> <li><code>QUERY_STRING</code>: The value that you
     * want AWS WAF to search for in the query string, which is the part of a URL that
     * appears after a <code>?</code> character.</li> <li><code>URI</code>: The value
     * that you want AWS WAF to search for in the part of a URL that identifies a
     ...
     * <a>CreateSizeConstraintSet</a>. </li> </ul> <p>If <code>TargetString</code>
     ...
     * a word, which means one of the following:</p> <ul> <li><code>TargetString</code>
     * exactly matches the value of the specified part of the web request, such as the
     * value of a header.</li> <li><code>TargetString</code> is at the beginning of the
     * specified part of the web request and is followed by a character other than an
     * alphanumeric character or underscore (_), for example,
     * <code>BadBot;</code>.</li> <li><code>TargetString</code> is at the end of the
     * specified part of the web request and is preceded by a character other than an
     * alphanumeric character or underscore (_), for example,
     * <code>;BadBot</code>.</li> <li><code>TargetString</code> is in the middle of the
     ...
     * <code>-BadBot;</code>.</li> </ul> <p><b>EXACTLY</b></p> <p>The value of the
     * specified part of the web request must exactly match the value of
     * <code>TargetString</code>.</p> <p><b>STARTS_WITH</b></p> <p>The value of
     * <code>TargetString</code> must appear at the beginning of the specified part of
     * the web request.</p> <p><b>ENDS_WITH</b></p> <p>The value of
     * <code>TargetString</code> must appear at the end of the specified part of the
     * web request.</p>
     */
