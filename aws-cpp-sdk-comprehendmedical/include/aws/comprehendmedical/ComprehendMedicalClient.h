...
namespace ComprehendMedical
{
  ...
  class AWS_COMPREHENDMEDICAL_API ComprehendMedicalClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ComprehendMedicalClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                std::shared_ptr<Endpoint::ComprehendMedicalEndpointProvider> endpointProvider = Aws::MakeShared<ComprehendMedical::Endpoint::ComprehendMedicalEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ComprehendMedicalEndpointProvider> m_endpointProvider;
  };
