...
namespace Model
{
        ...
        typedef Aws::Utils::Outcome<DescribeICD10CMInferenceJobResult, Aws::Client::AWSError<ComprehendMedicalErrors>> DescribeICD10CMInferenceJobOutcome;
        ...
        typedef Aws::Utils::Outcome<DescribeRxNormInferenceJobResult, Aws::Client::AWSError<ComprehendMedicalErrors>> DescribeRxNormInferenceJobOutcome;
        ...
        typedef Aws::Utils::Outcome<ListICD10CMInferenceJobsResult, Aws::Client::AWSError<ComprehendMedicalErrors>> ListICD10CMInferenceJobsOutcome;
        ...
        typedef Aws::Utils::Outcome<ListRxNormInferenceJobsResult, Aws::Client::AWSError<ComprehendMedicalErrors>> ListRxNormInferenceJobsOutcome;
        ...
        typedef Aws::Utils::Outcome<StartICD10CMInferenceJobResult, Aws::Client::AWSError<ComprehendMedicalErrors>> StartICD10CMInferenceJobOutcome;
        ...
        typedef Aws::Utils::Outcome<StartRxNormInferenceJobResult, Aws::Client::AWSError<ComprehendMedicalErrors>> StartRxNormInferenceJobOutcome;
        ...
        typedef Aws::Utils::Outcome<StopICD10CMInferenceJobResult, Aws::Client::AWSError<ComprehendMedicalErrors>> StopICD10CMInferenceJobOutcome;
        ...
        typedef Aws::Utils::Outcome<StopRxNormInferenceJobResult, Aws::Client::AWSError<ComprehendMedicalErrors>> StopRxNormInferenceJobOutcome;
