...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEntitiesDetectionV2JobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListEntitiesDetectionV2JobsRequest>(GetServiceRequestName(), *this);
    }
