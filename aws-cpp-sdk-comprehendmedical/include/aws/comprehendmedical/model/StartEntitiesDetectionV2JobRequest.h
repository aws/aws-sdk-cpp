...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartEntitiesDetectionV2JobRequest> Clone() const
    {
      return Aws::MakeUnique<StartEntitiesDetectionV2JobRequest>(GetServiceRequestName(), *this);
    }
