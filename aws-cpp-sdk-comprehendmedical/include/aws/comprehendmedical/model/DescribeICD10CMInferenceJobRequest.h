...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeICD10CMInferenceJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeICD10CMInferenceJobRequest>(GetServiceRequestName(), *this);
    }
