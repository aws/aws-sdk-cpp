...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEntitiesDetectionV2JobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEntitiesDetectionV2JobRequest>(GetServiceRequestName(), *this);
    }
