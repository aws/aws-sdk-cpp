...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPREHENDMEDICAL_API InferSNOMEDCTRequest : public ComprehendMedicalRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<InferSNOMEDCTRequest> Clone() const
    {
      return Aws::MakeUnique<InferSNOMEDCTRequest>(GetServiceRequestName(), *this);
    }
