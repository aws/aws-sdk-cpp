...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPREHENDMEDICAL_API StopSNOMEDCTInferenceJobRequest : public ComprehendMedicalRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopSNOMEDCTInferenceJobRequest> Clone() const
    {
      return Aws::MakeUnique<StopSNOMEDCTInferenceJobRequest>(GetServiceRequestName(), *this);
    }
