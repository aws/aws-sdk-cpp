...
{
const size_t ComprehendMedicalEndpointRules::RulesBlobStrLen = 3498;
const size_t ComprehendMedicalEndpointRules::RulesBlobSize = 3499;

using RulesBlobT = Aws::Array<const char, ComprehendMedicalEndpointRules::RulesBlobSize>;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','o','m','p','r','e',
'h','e','n','d','m','e','d','i','c','a','l','-','f','i','p','s','.','{','R','e','g','i','o','n','}',
...
'"',':','"','h','t','t','p','s',':','/','/','c','o','m','p','r','e','h','e','n','d','m','e','d','i',
'c','a','l','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'e','n','d','m','e','d','i','c','a','l','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','o','m','p','r','e','h','e','n','d',
'm','e','d','i','c','a','l','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
'o','n','R','e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o',
'p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',
',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* ComprehendMedicalEndpointRules::GetRulesBlob()
{
