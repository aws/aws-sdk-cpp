...
ListPHIDetectionJobsResult::ListPHIDetectionJobsResult()
{
}

ListPHIDetectionJobsResult::ListPHIDetectionJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListPHIDetectionJobsResult& ListPHIDetectionJobsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
