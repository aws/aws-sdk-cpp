...
namespace IoTDataPlane
{
  ...
  class AWS_IOTDATAPLANE_API IoTDataPlaneClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IoTDataPlaneClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::IoTDataPlaneEndpointProvider> endpointProvider = Aws::MakeShared<IoTDataPlane::Endpoint::IoTDataPlaneEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IoTDataPlaneEndpointProvider> m_endpointProvider;
  };
