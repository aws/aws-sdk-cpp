...
namespace Model
{
  ...
  public:
    ...
    UpdateThingShadowResult(AmazonWebServiceResult<Utils::Stream::ResponseStream>&& result);
    UpdateThingShadowResult& operator=(AmazonWebServiceResult<Utils::Stream::ResponseStream>&& result);
