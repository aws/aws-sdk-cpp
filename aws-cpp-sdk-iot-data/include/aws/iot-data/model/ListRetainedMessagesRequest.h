...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTDATAPLANE_API ListRetainedMessagesRequest : public IoTDataPlaneRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRetainedMessagesRequest> Clone() const
    {
      return Aws::MakeUnique<ListRetainedMessagesRequest>(GetServiceRequestName(), *this);
    }
