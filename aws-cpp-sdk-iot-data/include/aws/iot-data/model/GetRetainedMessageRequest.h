...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_IOTDATAPLANE_API GetRetainedMessageRequest : public IoTDataPlaneRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRetainedMessageRequest> Clone() const
    {
      return Aws::MakeUnique<GetRetainedMessageRequest>(GetServiceRequestName(), *this);
    }
