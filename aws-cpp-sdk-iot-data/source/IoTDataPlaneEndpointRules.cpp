...
Aws::String IoTDataPlaneEndpointRules::GetRulesAsString()
{
    return Aws::String(IoTDataPlaneEndpointRules::Rules.begin(), IoTDataPlaneEndpointRules::Rules.end());
}

const Aws::Vector<char> IoTDataPlaneEndpointRules::Rules = {
...
'p','s',':','/','/','d','a','t','a','.','i','o','t','-','f','i','p','s','.','u','s','-','e','a','s',
...
':','/','/','d','a','t','a','.','i','o','t','-','f','i','p','s','.','u','s','-','g','o','v','-','e',
