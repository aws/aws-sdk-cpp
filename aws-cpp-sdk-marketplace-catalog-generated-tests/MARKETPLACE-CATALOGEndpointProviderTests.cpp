...
using MarketplaceCatalogResolveEndpointOutcome = Aws::MarketplaceCatalog::Endpoint::MarketplaceCatalogEndpointProvider::MarketplaceCatalogResolveEndpointOutcome;
...
void ValidateOutcome(const MarketplaceCatalogResolveEndpointOutcome& outcome, const MarketplaceCatalogEndpointProviderEndpointTestCase::Expect& expect)
{
