...
(Defaults to OFF) Enables building the performance test executables for S3 and DynamoDB that measure and report operation latencies in JSON format. Requires S3 and DynamoDB clients to be built.
