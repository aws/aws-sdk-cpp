...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateServiceAccessPoliciesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateServiceAccessPoliciesRequest>(GetServiceRequestName(), *this);
    }
