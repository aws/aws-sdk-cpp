...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeServiceAccessPoliciesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeServiceAccessPoliciesRequest>(GetServiceRequestName(), *this);
    }
