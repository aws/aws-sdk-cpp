...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDSEARCH_API LiteralOptions
  {
  public:
    LiteralOptions();
    LiteralOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    LiteralOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
     ...
     * A value to use for the field if the field isn't specified for a document.
     */
    inline LiteralOptions& WithDefaultValue(const Aws::String& value) { SetDefaultValue(value); return *this;}
