...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDSEARCH_API UpdateDomainEndpointOptionsRequest : public CloudSearchRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDomainEndpointOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDomainEndpointOptionsRequest>(GetServiceRequestName(), *this);
    }
