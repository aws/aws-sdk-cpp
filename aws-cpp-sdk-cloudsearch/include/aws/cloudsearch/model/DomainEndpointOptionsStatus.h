...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDSEARCH_API DomainEndpointOptionsStatus
  {
  public:
    DomainEndpointOptionsStatus();
    DomainEndpointOptionsStatus(const Aws::Utils::Xml::XmlNode& xmlNode);
    DomainEndpointOptionsStatus& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
