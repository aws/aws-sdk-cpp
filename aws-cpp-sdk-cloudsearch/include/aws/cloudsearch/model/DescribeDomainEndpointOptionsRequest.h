...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDomainEndpointOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDomainEndpointOptionsRequest>(GetServiceRequestName(), *this);
    }
