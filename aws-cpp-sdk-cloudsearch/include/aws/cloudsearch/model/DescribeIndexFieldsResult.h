...
namespace Model
{
  ...
  public:
    ...
    DescribeIndexFieldsResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DescribeIndexFieldsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
