...
namespace Model
{
   ...
   * <code>date-array</code>. All options are enabled by default.</p>
   */
  class AWS_CLOUDSEARCH_API DateArrayOptions
  {
  public:
    DateArrayOptions();
    DateArrayOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    DateArrayOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
     ...
     * A value to use for the field if the field isn't specified for a document.
     */
    inline DateArrayOptions& WithDefaultValue(Aws::String&& value) { SetDefaultValue(value); return *this;}
     ...
     * <p>A list of source fields to map to the field. </p>
     */
    inline DateArrayOptions& WithSourceFields(Aws::String&& value) { SetSourceFields(value); return *this;}
