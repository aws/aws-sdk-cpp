...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAvailabilityOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAvailabilityOptionsRequest>(GetServiceRequestName(), *this);
    }
