...
using ResolveEndpointOutcome = Aws::CloudSearch::Endpoint::CloudSearchEndpointProvider::CloudSearchResolveEndpointOutcome;
...
CloudSearchClient::CloudSearchClient(const Client::ClientConfiguration& clientConfiguration,
                                     std::shared_ptr<Endpoint::CloudSearchEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CloudSearchErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CloudSearch::Endpoint::CloudSearchEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
