  ...
  Aws::String ForRegion(Region region)
  {
    switch(region)
    {
     case Region::US_EAST_1:
        return "es.us-east-1.amazonaws.com";
     case Region::US_WEST_1:
        return "es.us-west-1.amazonaws.com";
     case Region::US_WEST_2:
        return "es.us-west-2.amazonaws.com";
     case Region::EU_WEST_1:
        return "es.eu-west-1.amazonaws.com";
     case Region::EU_CENTRAL_1:
        return "es.eu-central-1.amazonaws.com";
     case Region::AP_SOUTHEAST_1:
        return "es.ap-southeast-1.amazonaws.com";
     case Region::AP_SOUTHEAST_2:
        return "es.ap-southeast-2.amazonaws.com";
     case Region::AP_NORTHEAST_1:
        return "es.ap-northeast-1.amazonaws.com";
     case Region::AP_NORTHEAST_2:
        return "es.ap-northeast-2.amazonaws.com";
     case Region::SA_EAST_1:
        return "es.sa-east-1.amazonaws.com";
     case Region::AP_SOUTH_1:
        return "es.ap-south-1.amazonaws.com";
     default:
        return "es.us-east-1.amazonaws.com";
    }
  }
