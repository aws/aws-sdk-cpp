...
void DescribeReservedElasticsearchInstancesRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
    if(m_reservedElasticsearchInstanceIdHasBeenSet)
    {
      ss << m_reservedElasticsearchInstanceId;
      uri.AddQueryStringParameter("reservationId", ss.str());
      ss.str("");
    }
