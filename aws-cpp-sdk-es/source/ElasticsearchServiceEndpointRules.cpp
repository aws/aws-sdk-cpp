...
{
const size_t ElasticsearchServiceEndpointRules::RulesBlobStrLen = 3438;
const size_t ElasticsearchServiceEndpointRules::RulesBlobSize = 3439;

using RulesBlobT = Aws::Array<const char, ElasticsearchServiceEndpointRules::RulesBlobSize>;
...
const char* ElasticsearchServiceEndpointRules::GetRulesBlob()
{
