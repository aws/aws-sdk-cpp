...
Aws::String ElasticsearchServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(ElasticsearchServiceEndpointRules::Rules.begin(), ElasticsearchServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> ElasticsearchServiceEndpointRules::Rules = {
