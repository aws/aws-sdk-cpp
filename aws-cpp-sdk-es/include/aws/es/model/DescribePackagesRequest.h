...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICSEARCHSERVICE_API DescribePackagesRequest : public ElasticsearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePackagesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePackagesRequest>(GetServiceRequestName(), *this);
    }
