...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListElasticsearchInstanceTypesRequest> Clone() const
    {
      return Aws::MakeUnique<ListElasticsearchInstanceTypesRequest>(GetServiceRequestName(), *this);
    }
