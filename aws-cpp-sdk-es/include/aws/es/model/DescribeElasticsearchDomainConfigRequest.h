...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeElasticsearchDomainConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeElasticsearchDomainConfigRequest>(GetServiceRequestName(), *this);
    }
