...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservedElasticsearchInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservedElasticsearchInstancesRequest>(GetServiceRequestName(), *this);
    }
