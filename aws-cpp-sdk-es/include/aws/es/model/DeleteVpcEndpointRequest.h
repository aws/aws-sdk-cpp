...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICSEARCHSERVICE_API DeleteVpcEndpointRequest : public ElasticsearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVpcEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVpcEndpointRequest>(GetServiceRequestName(), *this);
    }
