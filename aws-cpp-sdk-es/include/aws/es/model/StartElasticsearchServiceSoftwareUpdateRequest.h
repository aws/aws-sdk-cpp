...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartElasticsearchServiceSoftwareUpdateRequest> Clone() const
    {
      return Aws::MakeUnique<StartElasticsearchServiceSoftwareUpdateRequest>(GetServiceRequestName(), *this);
    }
