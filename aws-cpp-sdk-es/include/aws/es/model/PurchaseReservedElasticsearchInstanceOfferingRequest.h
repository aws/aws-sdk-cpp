...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PurchaseReservedElasticsearchInstanceOfferingRequest> Clone() const
    {
      return Aws::MakeUnique<PurchaseReservedElasticsearchInstanceOfferingRequest>(GetServiceRequestName(), *this);
    }
