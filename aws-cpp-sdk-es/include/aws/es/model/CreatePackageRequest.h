...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICSEARCHSERVICE_API CreatePackageRequest : public ElasticsearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreatePackageRequest> Clone() const
    {
      return Aws::MakeUnique<CreatePackageRequest>(GetServiceRequestName(), *this);
    }
