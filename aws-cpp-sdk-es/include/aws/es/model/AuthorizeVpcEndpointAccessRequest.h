...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICSEARCHSERVICE_API AuthorizeVpcEndpointAccessRequest : public ElasticsearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AuthorizeVpcEndpointAccessRequest> Clone() const
    {
      return Aws::MakeUnique<AuthorizeVpcEndpointAccessRequest>(GetServiceRequestName(), *this);
    }
