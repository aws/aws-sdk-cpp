...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICSEARCHSERVICE_API GetPackageVersionHistoryRequest : public ElasticsearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPackageVersionHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<GetPackageVersionHistoryRequest>(GetServiceRequestName(), *this);
    }
