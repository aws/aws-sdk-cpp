...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICSEARCHSERVICE_API CreateVpcEndpointRequest : public ElasticsearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateVpcEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<CreateVpcEndpointRequest>(GetServiceRequestName(), *this);
    }
