...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservedElasticsearchInstanceOfferingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservedElasticsearchInstanceOfferingsRequest>(GetServiceRequestName(), *this);
    }
