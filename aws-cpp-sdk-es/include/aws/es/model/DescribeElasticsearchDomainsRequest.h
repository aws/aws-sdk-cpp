...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeElasticsearchDomainsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeElasticsearchDomainsRequest>(GetServiceRequestName(), *this);
    }
