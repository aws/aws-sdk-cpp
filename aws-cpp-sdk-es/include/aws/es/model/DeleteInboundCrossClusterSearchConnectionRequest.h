...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICSEARCHSERVICE_API DeleteInboundCrossClusterSearchConnectionRequest : public ElasticsearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteInboundCrossClusterSearchConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteInboundCrossClusterSearchConnectionRequest>(GetServiceRequestName(), *this);
    }
