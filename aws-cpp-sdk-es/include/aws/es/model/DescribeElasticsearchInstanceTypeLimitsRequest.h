...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeElasticsearchInstanceTypeLimitsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeElasticsearchInstanceTypeLimitsRequest>(GetServiceRequestName(), *this);
    }
