...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AcceptInboundCrossClusterSearchConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<AcceptInboundCrossClusterSearchConnectionRequest>(GetServiceRequestName(), *this);
    }
