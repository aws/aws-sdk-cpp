...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeElasticsearchDomainRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeElasticsearchDomainRequest>(GetServiceRequestName(), *this);
    }
     ...
     * <p>The name of the Elasticsearch domain for which you want information.</p>
     */
    inline DescribeElasticsearchDomainRequest& WithDomainName(const Aws::String& value) { SetDomainName(value); return *this;}
