...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateElasticsearchDomainConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateElasticsearchDomainConfigRequest>(GetServiceRequestName(), *this);
    }
