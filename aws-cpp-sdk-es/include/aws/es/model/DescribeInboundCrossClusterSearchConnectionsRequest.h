...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICSEARCHSERVICE_API DescribeInboundCrossClusterSearchConnectionsRequest : public ElasticsearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInboundCrossClusterSearchConnectionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInboundCrossClusterSearchConnectionsRequest>(GetServiceRequestName(), *this);
    }
