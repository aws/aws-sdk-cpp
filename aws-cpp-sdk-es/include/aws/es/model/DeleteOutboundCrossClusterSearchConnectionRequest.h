...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteOutboundCrossClusterSearchConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteOutboundCrossClusterSearchConnectionRequest>(GetServiceRequestName(), *this);
    }
