...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICSEARCHSERVICE_API DescribeOutboundCrossClusterSearchConnectionsRequest : public ElasticsearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOutboundCrossClusterSearchConnectionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOutboundCrossClusterSearchConnectionsRequest>(GetServiceRequestName(), *this);
    }
