...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelElasticsearchServiceSoftwareUpdateRequest> Clone() const
    {
      return Aws::MakeUnique<CancelElasticsearchServiceSoftwareUpdateRequest>(GetServiceRequestName(), *this);
    }
