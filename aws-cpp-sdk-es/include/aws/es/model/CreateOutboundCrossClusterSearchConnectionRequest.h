...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateOutboundCrossClusterSearchConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateOutboundCrossClusterSearchConnectionRequest>(GetServiceRequestName(), *this);
    }
