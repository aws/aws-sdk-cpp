...
namespace Model
{
  ...
  /**
   * <p> Container for request parameters to <code> <a>GetUpgradeHistory</a> </code>
   * operation. </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/es-2015-01-01/GetUpgradeHistoryRequest">AWS
   * API Reference</a></p>
   */
  class AWS_ELASTICSEARCHSERVICE_API GetUpgradeHistoryRequest : public ElasticsearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetUpgradeHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<GetUpgradeHistoryRequest>(GetServiceRequestName(), *this);
    }
