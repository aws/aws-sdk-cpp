...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICSEARCHSERVICE_API AssociatePackageRequest : public ElasticsearchServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociatePackageRequest> Clone() const
    {
      return Aws::MakeUnique<AssociatePackageRequest>(GetServiceRequestName(), *this);
    }
