...
namespace ElasticsearchService
{
  ...
  class AWS_ELASTICSEARCHSERVICE_API ElasticsearchServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ElasticsearchServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                   std::shared_ptr<Endpoint::ElasticsearchServiceEndpointProvider> endpointProvider = Aws::MakeShared<ElasticsearchService::Endpoint::ElasticsearchServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ElasticsearchServiceEndpointProvider> m_endpointProvider;
  };
