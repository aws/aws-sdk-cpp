...
Aws::String SSMEndpointRules::GetRulesAsString()
{
    return Aws::String(SSMEndpointRules::Rules.begin(), SSMEndpointRules::Rules.end());
}

const Aws::Vector<char> SSMEndpointRules::Rules = {
