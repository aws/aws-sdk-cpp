...
namespace SSM
{
const size_t SSMEndpointRules::RulesBlobStrLen = 3617;
const size_t SSMEndpointRules::RulesBlobSize = 3618;

using RulesBlobT = Aws::Array<const char, SSMEndpointRules::RulesBlobSize>;
...
't','t','p','s',':','/','/','s','s','m','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','s','m','.','{','R','e','g','i','o',
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','s',
'm','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u',
'l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r','t','i','e',
's','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y','p','e',
'"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* SSMEndpointRules::GetRulesBlob()
{
