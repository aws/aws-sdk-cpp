...
using ResolveEndpointOutcome = Aws::SSM::Endpoint::SSMEndpointProvider::SSMResolveEndpointOutcome;
...
SSMClient::SSMClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::SSMEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SSMErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<SSM::Endpoint::SSMEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
