...
ListAssociationsResult::ListAssociationsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListAssociationsResult& ListAssociationsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
