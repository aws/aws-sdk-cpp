...
DescribeMaintenanceWindowTasksResult::DescribeMaintenanceWindowTasksResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeMaintenanceWindowTasksResult& DescribeMaintenanceWindowTasksResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
