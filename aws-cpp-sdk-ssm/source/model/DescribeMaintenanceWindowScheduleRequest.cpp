...
Aws::String DescribeMaintenanceWindowScheduleRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection DescribeMaintenanceWindowScheduleRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AmazonSSM.DescribeMaintenanceWindowSchedule"));
  return headers;
