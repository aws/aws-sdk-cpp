...
Aws::String DescribeEffectiveInstanceAssociationsRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection DescribeEffectiveInstanceAssociationsRequest::GetRequestSpecificHeaders() const
{
  ...
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AmazonSSM.DescribeEffectiveInstanceAssociations"));
  return headers;
