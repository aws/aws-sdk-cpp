...
Aws::String DeregisterTaskFromMaintenanceWindowRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection DeregisterTaskFromMaintenanceWindowRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AmazonSSM.DeregisterTaskFromMaintenanceWindow"));
  return headers;
