...
DeleteParametersResult::DeleteParametersResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DeleteParametersResult& DeleteParametersResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
