...
ListCommandsResult::ListCommandsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListCommandsResult& ListCommandsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
