...
GetInventoryResult::GetInventoryResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetInventoryResult& GetInventoryResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
