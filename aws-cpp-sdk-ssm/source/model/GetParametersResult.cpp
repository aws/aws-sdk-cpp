...
GetParametersResult::GetParametersResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetParametersResult& GetParametersResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
