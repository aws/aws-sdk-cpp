...
CreateAssociationResult::CreateAssociationResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateAssociationResult& CreateAssociationResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
