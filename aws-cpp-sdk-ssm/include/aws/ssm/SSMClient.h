...
namespace Model
{
  ...
  /**
   * <p>Simple Systems Manager (SSM) enables you to remotely manage the configuration
   ...
   * for Windows instances.) </p> <p/> <b>Run Command</b> <p>Run Command provides an
   * on-demand experience for executing commands. You can use pre-defined Amazon SSM
   ...
   * CLI</a>.</p> <p>Run Command reports the status of the command execution for each
   * instance targeted by a command. You can also audit the command execution to
   * understand who executed commands, when, and what changes were made. By switching
   * between different SSM documents, you can quickly configure your instances with
   * different types of commands. To get started with Run Command, verify that your
   * environment meets the prerequisites for remotely running commands on EC2
   * instances (<a
   ...
   * </p> <p/> <b>SSM Config</b> <p>SSM Config is a lightweight instance
   ...
   * the following pre-defined documents.</p> <table> <title>Amazon Pre-defined SSM
   * Documents</title> <tgroup cols="3"> <colspec colname="col1" colnum="1"
   * colwidth="1*"/> <colspec colname="col2" colnum="2" colwidth="1*"/> <colspec
   * colname="col3" colnum="3" colwidth="1*"/> <thead> <row> <entry>Name</entry>
   * <entry>Description</entry> <entry>Platform</entry> </row> </thead> <tbody> <row>
   * <entry> <p>AWS-RunShellScript</p> </entry> <entry> <p>Run shell scripts</p>
   * </entry> <entry> <p>Linux</p> </entry> </row> <row> <entry>
   * <p>AWS-UpdateSSMAgent</p> </entry> <entry> <p>Update the Amazon SSM agent</p>
   * </entry> <entry> <p>Linux</p> </entry> </row> <row> <entry>
   * <p>AWS-JoinDirectoryServiceDomain </p> </entry> <entry> <p>Join an AWS Directory
   * </p> </entry> <entry> <p>Windows</p> </entry> </row> <row> <entry>
   * <p>AWS-RunPowerShellScript</p> </entry> <entry> <p>Run PowerShell commands or
   * scripts</p> </entry> <entry> <p>Windows</p> </entry> </row> <row> <entry>
   * <p>AWS-UpdateEC2Config</p> </entry> <entry> <p>Update the EC2Config service </p>
   * </entry> <entry> <p>Windows</p> </entry> </row> <row> <entry>
   * <p>AWS-ConfigureWindowsUpdate</p> </entry> <entry> <p>Configure Windows Update
   * settings</p> </entry> <entry> <p>Windows</p> </entry> </row> <row> <entry>
   * <p>AWS-InstallApplication</p> </entry> <entry> <p>Install, repair, or uninstall
   * software using an MSI package</p> </entry> <entry> <p>Windows</p> </entry>
   * </row> <row> <entry> <p>AWS-InstallPowerShellModule</p> </entry> <entry>
   * <p>Install PowerShell modules </p> </entry> <entry> <p>Windows</p> </entry>
   * </row> <row> <entry> <p>AWS-ConfigureCloudWatch</p> </entry> <entry>
   * <p>Configure Amazon CloudWatch Logs to monitor applications and systems</p>
   * </entry> <entry> <p>Windows</p> </entry> </row> </tbody> </tgroup> </table>
   * <important> <simpara>The commands or scripts specified in SSM documents run with
   * administrative privilege on your instances because the Amazon SSM agent runs as
   * root on Linux and the EC2Config service runs in the Local System account on
   ...
   * administrator access to the instance. Delegate access to SSM and Run Command
   * judiciously. This becomes extremely important if you create your own SSM
   * documents. Amazon Web Services does not provide guidance about how to create
   * secure SSM documents. You create SSM documents and delegate access to Run
   * Command at your own risk. As a security best practice, we recommend that you
   * assign access to "AWS-*" documents, especially the AWS-RunShellScript document
   * on Linux and the AWS-RunPowerShellScript document on Windows, to trusted
   * administrators only. You can create SSM documents for specific tasks and
   * delegate access to non-administrators.</simpara> </important>
   */
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * <a>CreateAssociation</a> to associate it with one or more running instances.</p>
         */
