...
namespace SSM
{
  ...
  class AWS_SSM_API SSMClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SSMClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::SSMEndpointProvider> endpointProvider = Aws::MakeShared<SSM::Endpoint::SSMEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SSMEndpointProvider> m_endpointProvider;
  };
