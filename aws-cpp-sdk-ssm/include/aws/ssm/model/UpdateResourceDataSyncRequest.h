...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API UpdateResourceDataSyncRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateResourceDataSyncRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateResourceDataSyncRequest>(GetServiceRequestName(), *this);
    }
