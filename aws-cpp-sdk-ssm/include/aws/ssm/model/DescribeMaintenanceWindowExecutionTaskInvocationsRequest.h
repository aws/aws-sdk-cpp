...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMaintenanceWindowExecutionTaskInvocationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMaintenanceWindowExecutionTaskInvocationsRequest>(GetServiceRequestName(), *this);
    }
