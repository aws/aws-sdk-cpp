...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInstanceAssociationsStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInstanceAssociationsStatusRequest>(GetServiceRequestName(), *this);
    }
