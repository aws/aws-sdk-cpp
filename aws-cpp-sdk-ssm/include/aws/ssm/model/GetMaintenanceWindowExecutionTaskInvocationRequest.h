...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMaintenanceWindowExecutionTaskInvocationRequest> Clone() const
    {
      return Aws::MakeUnique<GetMaintenanceWindowExecutionTaskInvocationRequest>(GetServiceRequestName(), *this);
    }
