...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API ListResourceDataSyncRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResourceDataSyncRequest> Clone() const
    {
      return Aws::MakeUnique<ListResourceDataSyncRequest>(GetServiceRequestName(), *this);
    }
