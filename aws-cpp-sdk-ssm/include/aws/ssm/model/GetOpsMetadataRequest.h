...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API GetOpsMetadataRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetOpsMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<GetOpsMetadataRequest>(GetServiceRequestName(), *this);
    }
