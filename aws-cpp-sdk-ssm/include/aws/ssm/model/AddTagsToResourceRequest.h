...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The resource ID you want to tag.</p> <p>For the ManagedInstance,
     * MaintenanceWindow, and PatchBaseline values, use the ID of the resource, such as
     * mw-01234361858c9b57b for a Maintenance Window.</p> <p>For the Document and
     * Parameter values, use the name of the resource.</p>
     */
