...
namespace Model
{
  class AWS_SSM_API DescribeInstancePatchStatesResult
  {
  public:
     ...
     * <p>The high-level patch state for the requested instances.</p>
     */
    inline DescribeInstancePatchStatesResult& WithInstancePatchStates(Aws::Vector<InstancePatchState>&& value) { SetInstancePatchStates(value); return *this;}
     ...
     * <p>The high-level patch state for the requested instances.</p>
     */
    inline DescribeInstancePatchStatesResult& AddInstancePatchStates(InstancePatchState&& value) { m_instancePatchStates.push_back(value); return *this; }
     ...
     * additional items to return, the string is empty.</p>
     */
    inline DescribeInstancePatchStatesResult& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
