...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMaintenanceWindowExecutionTasksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMaintenanceWindowExecutionTasksRequest>(GetServiceRequestName(), *this);
    }
