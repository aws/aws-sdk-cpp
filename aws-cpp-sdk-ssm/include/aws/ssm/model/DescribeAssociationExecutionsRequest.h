...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAssociationExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAssociationExecutionsRequest>(GetServiceRequestName(), *this);
    }
