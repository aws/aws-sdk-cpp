...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateMaintenanceWindowTaskRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateMaintenanceWindowTaskRequest>(GetServiceRequestName(), *this);
    }
