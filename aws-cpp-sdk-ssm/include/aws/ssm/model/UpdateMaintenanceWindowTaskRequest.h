...
namespace Model
{
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "UpdateMaintenanceWindowTask"; }
     ...
     * string, between 1 and 255 characters</p> <p>Value: an array of strings, each
     * string is between 1 and 255 characters</p>
     */
