...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelMaintenanceWindowExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<CancelMaintenanceWindowExecutionRequest>(GetServiceRequestName(), *this);
    }
