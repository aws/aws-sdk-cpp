...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMaintenanceWindowExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMaintenanceWindowExecutionsRequest>(GetServiceRequestName(), *this);
    }
