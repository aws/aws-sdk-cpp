...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API GetPatchBaselineRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPatchBaselineRequest> Clone() const
    {
      return Aws::MakeUnique<GetPatchBaselineRequest>(GetServiceRequestName(), *this);
    }
