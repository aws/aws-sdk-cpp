...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterPatchBaselineForPatchGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterPatchBaselineForPatchGroupRequest>(GetServiceRequestName(), *this);
    }
