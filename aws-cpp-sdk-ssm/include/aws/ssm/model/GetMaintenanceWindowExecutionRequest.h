...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMaintenanceWindowExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<GetMaintenanceWindowExecutionRequest>(GetServiceRequestName(), *this);
    }
