...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDocumentDefaultVersionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDocumentDefaultVersionRequest>(GetServiceRequestName(), *this);
    }
