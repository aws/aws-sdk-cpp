...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInstancePatchStatesForPatchGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInstancePatchStatesForPatchGroupRequest>(GetServiceRequestName(), *this);
    }
