...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API UpdateOpsMetadataRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateOpsMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateOpsMetadataRequest>(GetServiceRequestName(), *this);
    }
