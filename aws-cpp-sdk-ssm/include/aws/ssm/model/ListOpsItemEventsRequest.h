...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API ListOpsItemEventsRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListOpsItemEventsRequest> Clone() const
    {
      return Aws::MakeUnique<ListOpsItemEventsRequest>(GetServiceRequestName(), *this);
    }
