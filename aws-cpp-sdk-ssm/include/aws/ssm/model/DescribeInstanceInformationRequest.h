...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInstanceInformationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInstanceInformationRequest>(GetServiceRequestName(), *this);
    }
