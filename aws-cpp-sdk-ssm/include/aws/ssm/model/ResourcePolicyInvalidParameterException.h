...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SSM_API ResourcePolicyInvalidParameterException
  {
  public:
    ResourcePolicyInvalidParameterException();
    ResourcePolicyInvalidParameterException(Aws::Utils::Json::JsonView jsonValue);
    ResourcePolicyInvalidParameterException& operator=(Aws::Utils::Json::JsonView jsonValue);
