...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDeployablePatchSnapshotForInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<GetDeployablePatchSnapshotForInstanceRequest>(GetServiceRequestName(), *this);
    }
