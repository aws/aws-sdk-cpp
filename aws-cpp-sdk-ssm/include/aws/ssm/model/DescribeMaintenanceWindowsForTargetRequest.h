...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API DescribeMaintenanceWindowsForTargetRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMaintenanceWindowsForTargetRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMaintenanceWindowsForTargetRequest>(GetServiceRequestName(), *this);
    }
