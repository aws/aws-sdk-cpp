...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMaintenanceWindowTasksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMaintenanceWindowTasksRequest>(GetServiceRequestName(), *this);
    }
