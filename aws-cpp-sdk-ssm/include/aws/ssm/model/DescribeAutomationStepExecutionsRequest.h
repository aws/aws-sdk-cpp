...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAutomationStepExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAutomationStepExecutionsRequest>(GetServiceRequestName(), *this);
    }
