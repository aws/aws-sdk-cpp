...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMaintenanceWindowScheduleRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMaintenanceWindowScheduleRequest>(GetServiceRequestName(), *this);
    }
