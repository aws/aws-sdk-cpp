...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterTargetWithMaintenanceWindowRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterTargetWithMaintenanceWindowRequest>(GetServiceRequestName(), *this);
    }
