...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteParametersRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteParametersRequest>(GetServiceRequestName(), *this);
    }
     ...
     * at least 30 seconds to create a parameter with the same name.</p>
     */
