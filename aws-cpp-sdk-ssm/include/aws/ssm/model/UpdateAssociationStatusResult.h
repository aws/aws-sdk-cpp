...
namespace Model
{
  class AWS_SSM_API UpdateAssociationStatusResult
  {
  public:
    UpdateAssociationStatusResult();
    UpdateAssociationStatusResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateAssociationStatusResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p>Information about the association.</p>
     */
    inline UpdateAssociationStatusResult& WithAssociationDescription(AssociationDescription&& value) { SetAssociationDescription(value); return *this;}
