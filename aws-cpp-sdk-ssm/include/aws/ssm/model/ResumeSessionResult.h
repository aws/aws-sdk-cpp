...
namespace Model
{
  class AWS_SSM_API ResumeSessionResult
  {
  public:
    ResumeSessionResult();
    ResumeSessionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ResumeSessionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p> <b>region</b> represents the Region identifier for an Region supported by
     * Amazon Web Services Systems Manager, such as <code>us-east-2</code> for the US
     * East (Ohio) Region. For a list of supported <b>region</b> values, see the
