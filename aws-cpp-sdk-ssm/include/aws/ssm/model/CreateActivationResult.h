...
namespace Model
{
  ...
  public:
    ...
    CreateActivationResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    CreateActivationResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * activation ID functions like a user name.</p>
     */
    inline void SetActivationId(Aws::String&& value) { m_activationId = value; }
     ...
     * activation ID functions like a user name.</p>
     */
    inline CreateActivationResult& WithActivationId(Aws::String&& value) { SetActivationId(value); return *this;}
     ...
     * activation code functions like a password to validate the activation ID. </p>
     */
    inline void SetActivationCode(Aws::String&& value) { m_activationCode = value; }
     ...
     * activation code functions like a password to validate the activation ID. </p>
     */
    inline CreateActivationResult& WithActivationCode(Aws::String&& value) { SetActivationCode(value); return *this;}
