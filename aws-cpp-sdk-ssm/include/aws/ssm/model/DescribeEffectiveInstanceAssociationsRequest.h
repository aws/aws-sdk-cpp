...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEffectiveInstanceAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEffectiveInstanceAssociationsRequest>(GetServiceRequestName(), *this);
    }
     ...
     * a previous call.)</p>
     */
    inline DescribeEffectiveInstanceAssociationsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
