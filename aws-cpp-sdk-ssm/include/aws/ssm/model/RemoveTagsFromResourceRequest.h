...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The type of resource from which you want to remove a tag.</p> <note> <p>The
     ...
     * use the name of the resource.</p> <note> <p>The ManagedInstance type for this
