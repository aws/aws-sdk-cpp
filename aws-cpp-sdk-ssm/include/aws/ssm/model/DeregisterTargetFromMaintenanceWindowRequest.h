...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterTargetFromMaintenanceWindowRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterTargetFromMaintenanceWindowRequest>(GetServiceRequestName(), *this);
    }
