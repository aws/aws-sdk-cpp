...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMaintenanceWindowExecutionTaskRequest> Clone() const
    {
      return Aws::MakeUnique<GetMaintenanceWindowExecutionTaskRequest>(GetServiceRequestName(), *this);
    }
