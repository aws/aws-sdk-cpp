...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterTaskWithMaintenanceWindowRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterTaskWithMaintenanceWindowRequest>(GetServiceRequestName(), *this);
    }
