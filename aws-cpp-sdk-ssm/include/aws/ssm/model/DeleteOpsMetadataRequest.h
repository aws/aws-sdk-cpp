...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API DeleteOpsMetadataRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteOpsMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteOpsMetadataRequest>(GetServiceRequestName(), *this);
    }
