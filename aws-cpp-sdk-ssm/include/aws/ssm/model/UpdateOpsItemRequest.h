...
namespace Model
{
  ...
  public:
     ...
     * characters. The value has a maximum size of 20 KB.</p> <p>This custom data is
     * searchable, but with restrictions. For the <code>Searchable operational
     * data</code> feature, all users with access to the OpsItem Overview page (as
     * provided by the <a>DescribeOpsItems</a> API action) can view and search on the
     * specified data. For the <code>Private operational data</code> feature, the data
     * is only viewable by users who have access to the OpsItem (as provided by the
     * <a>GetOpsItem</a> API action).</p>
     */
