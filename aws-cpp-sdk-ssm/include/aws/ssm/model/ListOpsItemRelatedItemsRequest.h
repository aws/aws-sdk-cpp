...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API ListOpsItemRelatedItemsRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListOpsItemRelatedItemsRequest> Clone() const
    {
      return Aws::MakeUnique<ListOpsItemRelatedItemsRequest>(GetServiceRequestName(), *this);
    }
