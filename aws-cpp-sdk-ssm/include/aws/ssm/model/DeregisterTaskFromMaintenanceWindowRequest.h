...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterTaskFromMaintenanceWindowRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterTaskFromMaintenanceWindowRequest>(GetServiceRequestName(), *this);
    }
