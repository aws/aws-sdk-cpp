...
namespace Model
{
   ...
   * tags to Systems Manager documents (SSM documents), managed instances,
   * maintenance windows, parameters, patch baselines, OpsItems, and
   * OpsMetadata.</p><p><h3>See Also:</h3>   <a
