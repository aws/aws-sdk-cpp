...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartChangeRequestExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<StartChangeRequestExecutionRequest>(GetServiceRequestName(), *this);
    }
