...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterDefaultPatchBaselineRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterDefaultPatchBaselineRequest>(GetServiceRequestName(), *this);
    }
