...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEffectivePatchesForPatchBaselineRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEffectivePatchesForPatchBaselineRequest>(GetServiceRequestName(), *this);
    }
