...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInstancePatchStatesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInstancePatchStatesRequest>(GetServiceRequestName(), *this);
    }
