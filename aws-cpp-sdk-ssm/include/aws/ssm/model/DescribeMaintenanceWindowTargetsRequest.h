...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMaintenanceWindowTargetsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMaintenanceWindowTargetsRequest>(GetServiceRequestName(), *this);
    }
