...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API UpdateDocumentMetadataRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDocumentMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDocumentMetadataRequest>(GetServiceRequestName(), *this);
    }
