...
namespace Model
{
  ...
  public:
    ...
    DescribeMaintenanceWindowsResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    DescribeMaintenanceWindowsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p>Information about the Maintenance Windows.</p>
     */
    inline void SetWindowIdentities(Aws::Vector<MaintenanceWindowIdentity>&& value) { m_windowIdentities = value; }
     ...
     * <p>Information about the Maintenance Windows.</p>
     */
    inline DescribeMaintenanceWindowsResult& WithWindowIdentities(Aws::Vector<MaintenanceWindowIdentity>&& value) { SetWindowIdentities(value); return *this;}
     ...
     * <p>Information about the Maintenance Windows.</p>
     */
    inline DescribeMaintenanceWindowsResult& AddWindowIdentities(MaintenanceWindowIdentity&& value) { m_windowIdentities.push_back(value); return *this; }
     ...
     * additional items to return, the string is empty.</p>
     */
    inline DescribeMaintenanceWindowsResult& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
