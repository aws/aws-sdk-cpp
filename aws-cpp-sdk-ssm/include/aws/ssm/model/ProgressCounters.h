...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The total number of steps that successfully completed in all specified
    ...
    /**
     * <p>The total number of steps that the system cancelled in all specified Regions
    ...
    /**
     * <p>The total number of steps that timed out in all specified Regions and
     * accounts for the current Automation execution.</p>
     */
