...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API ListResourceComplianceSummariesRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResourceComplianceSummariesRequest> Clone() const
    {
      return Aws::MakeUnique<ListResourceComplianceSummariesRequest>(GetServiceRequestName(), *this);
    }
