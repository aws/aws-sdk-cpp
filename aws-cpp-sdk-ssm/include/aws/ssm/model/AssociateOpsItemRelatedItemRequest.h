...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API AssociateOpsItemRelatedItemRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateOpsItemRelatedItemRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateOpsItemRelatedItemRequest>(GetServiceRequestName(), *this);
    }
