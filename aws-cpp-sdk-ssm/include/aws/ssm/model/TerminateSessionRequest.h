...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API TerminateSessionRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<TerminateSessionRequest> Clone() const
    {
      return Aws::MakeUnique<TerminateSessionRequest>(GetServiceRequestName(), *this);
    }
