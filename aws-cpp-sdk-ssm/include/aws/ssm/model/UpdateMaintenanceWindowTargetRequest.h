...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateMaintenanceWindowTargetRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateMaintenanceWindowTargetRequest>(GetServiceRequestName(), *this);
    }
