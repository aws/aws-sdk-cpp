...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API UnlabelParameterVersionRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UnlabelParameterVersionRequest> Clone() const
    {
      return Aws::MakeUnique<UnlabelParameterVersionRequest>(GetServiceRequestName(), *this);
    }
