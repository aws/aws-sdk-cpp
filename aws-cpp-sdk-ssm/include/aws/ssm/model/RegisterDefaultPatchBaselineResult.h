...
namespace Model
{
  class AWS_SSM_API RegisterDefaultPatchBaselineResult
  {
  public:
     ...
     * <p>The ID of the default patch baseline.</p>
     */
    inline RegisterDefaultPatchBaselineResult& WithBaselineId(Aws::String&& value) { SetBaselineId(value); return *this;}
