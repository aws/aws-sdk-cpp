...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAutomationExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAutomationExecutionsRequest>(GetServiceRequestName(), *this);
    }
