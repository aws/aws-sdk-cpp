...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPatchBaselineForPatchGroupRequest> Clone() const
    {
      return Aws::MakeUnique<GetPatchBaselineForPatchGroupRequest>(GetServiceRequestName(), *this);
    }
