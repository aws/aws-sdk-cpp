...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateOpsItemRelatedItemRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateOpsItemRelatedItemRequest>(GetServiceRequestName(), *this);
    }
