...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAssociationExecutionTargetsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAssociationExecutionTargetsRequest>(GetServiceRequestName(), *this);
    }
