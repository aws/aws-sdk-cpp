...
namespace Model
{
  ...
  /**
   */
  class AWS_SSM_API ListDocumentMetadataHistoryRequest : public SSMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDocumentMetadataHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<ListDocumentMetadataHistoryRequest>(GetServiceRequestName(), *this);
    }
