...
using SWFResolveEndpointOutcome = Aws::SWF::Endpoint::SWFEndpointProvider::SWFResolveEndpointOutcome;
...
void ValidateOutcome(const SWFResolveEndpointOutcome& outcome, const SWFEndpointProviderEndpointTestCase::Expect& expect)
{
