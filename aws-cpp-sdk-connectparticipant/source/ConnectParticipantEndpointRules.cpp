...
Aws::String ConnectParticipantEndpointRules::GetRulesAsString()
{
    return Aws::String(ConnectParticipantEndpointRules::Rules.begin(), ConnectParticipantEndpointRules::Rules.end());
}

const Aws::Vector<char> ConnectParticipantEndpointRules::Rules = {
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','p','a','r','t','i','c',
'i','p','a','n','t','.','c','o','n','n','e','c','t','-','f','i','p','s','.','{','R','e','g','i','o',
...
'r','t','i','c','i','p','a','n','t','.','c','o','n','n','e','c','t','-','f','i','p','s','.','{','R',
...
'p','s',':','/','/','p','a','r','t','i','c','i','p','a','n','t','.','c','o','n','n','e','c','t','.',
...
's',':','/','/','p','a','r','t','i','c','i','p','a','n','t','.','c','o','n','n','e','c','t','.','{',
'R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u','l','t','#',
