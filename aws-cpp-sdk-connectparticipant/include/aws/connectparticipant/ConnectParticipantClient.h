...
namespace ConnectParticipant
{
  ...
  class AWS_CONNECTPARTICIPANT_API ConnectParticipantClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ConnectParticipantClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                 std::shared_ptr<Endpoint::ConnectParticipantEndpointProvider> endpointProvider = Aws::MakeShared<ConnectParticipant::Endpoint::ConnectParticipantEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ConnectParticipantEndpointProvider> m_endpointProvider;
  };
