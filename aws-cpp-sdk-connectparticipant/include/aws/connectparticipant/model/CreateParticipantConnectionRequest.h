...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateParticipantConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateParticipantConnectionRequest>(GetServiceRequestName(), *this);
    }
