...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTPARTICIPANT_API CompleteAttachmentUploadRequest : public ConnectParticipantRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CompleteAttachmentUploadRequest> Clone() const
    {
      return Aws::MakeUnique<CompleteAttachmentUploadRequest>(GetServiceRequestName(), *this);
    }
