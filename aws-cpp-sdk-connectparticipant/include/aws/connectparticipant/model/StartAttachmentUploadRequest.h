...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTPARTICIPANT_API StartAttachmentUploadRequest : public ConnectParticipantRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartAttachmentUploadRequest> Clone() const
    {
      return Aws::MakeUnique<StartAttachmentUploadRequest>(GetServiceRequestName(), *this);
    }
