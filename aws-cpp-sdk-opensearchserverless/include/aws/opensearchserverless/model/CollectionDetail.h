...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVERLESS_API CollectionDetail
  {
  public:
    CollectionDetail();
    CollectionDetail(Aws::Utils::Json::JsonView jsonValue);
    CollectionDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
