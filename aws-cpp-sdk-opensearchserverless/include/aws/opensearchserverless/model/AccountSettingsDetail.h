...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVERLESS_API AccountSettingsDetail
  {
  public:
    AccountSettingsDetail();
    AccountSettingsDetail(Aws::Utils::Json::JsonView jsonValue);
    AccountSettingsDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
