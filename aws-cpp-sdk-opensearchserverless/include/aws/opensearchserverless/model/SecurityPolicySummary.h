...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVERLESS_API SecurityPolicySummary
  {
  public:
    SecurityPolicySummary();
    SecurityPolicySummary(Aws::Utils::Json::JsonView jsonValue);
    SecurityPolicySummary& operator=(Aws::Utils::Json::JsonView jsonValue);
