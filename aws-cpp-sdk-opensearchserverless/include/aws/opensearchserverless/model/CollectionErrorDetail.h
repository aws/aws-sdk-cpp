...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVERLESS_API CollectionErrorDetail
  {
  public:
    CollectionErrorDetail();
    CollectionErrorDetail(Aws::Utils::Json::JsonView jsonValue);
    CollectionErrorDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
