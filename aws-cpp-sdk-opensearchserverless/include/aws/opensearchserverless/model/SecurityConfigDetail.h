...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVERLESS_API SecurityConfigDetail
  {
  public:
    SecurityConfigDetail();
    SecurityConfigDetail(Aws::Utils::Json::JsonView jsonValue);
    SecurityConfigDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
