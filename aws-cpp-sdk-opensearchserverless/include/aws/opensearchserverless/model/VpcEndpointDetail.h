...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OPENSEARCHSERVERLESS_API VpcEndpointDetail
  {
  public:
    VpcEndpointDetail();
    VpcEndpointDetail(Aws::Utils::Json::JsonView jsonValue);
    VpcEndpointDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
