...
Aws::String MQEndpointRules::GetRulesAsString()
{
    return Aws::String(MQEndpointRules::Rules.begin(), MQEndpointRules::Rules.end());
}

const Aws::Vector<char> MQEndpointRules::Rules = {
