...
namespace MQ
{
  ...
  class AWS_MQ_API MQClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MQClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                 std::shared_ptr<Endpoint::MQEndpointProvider> endpointProvider = Aws::MakeShared<MQ::Endpoint::MQEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MQEndpointProvider> m_endpointProvider;
  };
