...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConfigurationRevisionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConfigurationRevisionRequest>(GetServiceRequestName(), *this);
    }
