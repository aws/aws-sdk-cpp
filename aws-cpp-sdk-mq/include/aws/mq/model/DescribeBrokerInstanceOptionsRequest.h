...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeBrokerInstanceOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeBrokerInstanceOptionsRequest>(GetServiceRequestName(), *this);
    }
