...
using ResolveEndpointOutcome = Aws::NetworkManager::Endpoint::NetworkManagerEndpointProvider::NetworkManagerResolveEndpointOutcome;
...
NetworkManagerClient::NetworkManagerClient(const Client::ClientConfiguration& clientConfiguration,
                                           std::shared_ptr<Endpoint::NetworkManagerEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<NetworkManagerErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<NetworkManager::Endpoint::NetworkManagerEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
