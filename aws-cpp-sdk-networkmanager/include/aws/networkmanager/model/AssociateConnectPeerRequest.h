...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API AssociateConnectPeerRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateConnectPeerRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateConnectPeerRequest>(GetServiceRequestName(), *this);
    }
