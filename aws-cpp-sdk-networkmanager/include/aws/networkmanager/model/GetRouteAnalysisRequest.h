...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetRouteAnalysisRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRouteAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<GetRouteAnalysisRequest>(GetServiceRequestName(), *this);
    }
