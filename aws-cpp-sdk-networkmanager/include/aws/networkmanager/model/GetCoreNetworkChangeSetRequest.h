...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetCoreNetworkChangeSetRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCoreNetworkChangeSetRequest> Clone() const
    {
      return Aws::MakeUnique<GetCoreNetworkChangeSetRequest>(GetServiceRequestName(), *this);
    }
