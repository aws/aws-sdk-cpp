...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetNetworkResourceRelationshipsRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetNetworkResourceRelationshipsRequest> Clone() const
    {
      return Aws::MakeUnique<GetNetworkResourceRelationshipsRequest>(GetServiceRequestName(), *this);
    }
