...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API StartRouteAnalysisRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartRouteAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<StartRouteAnalysisRequest>(GetServiceRequestName(), *this);
    }
