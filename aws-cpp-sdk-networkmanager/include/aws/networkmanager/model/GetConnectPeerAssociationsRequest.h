...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetConnectPeerAssociationsRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetConnectPeerAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetConnectPeerAssociationsRequest>(GetServiceRequestName(), *this);
    }
