...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API CreateTransitGatewayPeeringRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTransitGatewayPeeringRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTransitGatewayPeeringRequest>(GetServiceRequestName(), *this);
    }
