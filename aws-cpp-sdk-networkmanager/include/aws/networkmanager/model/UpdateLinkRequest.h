...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API UpdateLinkRequest : public NetworkManagerRequest
  {
  public:
    UpdateLinkRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateLinkRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLinkRequest>(GetServiceRequestName(), *this);
    }
