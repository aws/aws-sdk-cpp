...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API DeleteGlobalNetworkRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteGlobalNetworkRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteGlobalNetworkRequest>(GetServiceRequestName(), *this);
    }
