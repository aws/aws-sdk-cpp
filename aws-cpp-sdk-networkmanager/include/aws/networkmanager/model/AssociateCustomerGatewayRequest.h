...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API AssociateCustomerGatewayRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateCustomerGatewayRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateCustomerGatewayRequest>(GetServiceRequestName(), *this);
    }
