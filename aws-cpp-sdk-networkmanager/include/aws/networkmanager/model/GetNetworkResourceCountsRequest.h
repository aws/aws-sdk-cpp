...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetNetworkResourceCountsRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetNetworkResourceCountsRequest> Clone() const
    {
      return Aws::MakeUnique<GetNetworkResourceCountsRequest>(GetServiceRequestName(), *this);
    }
