...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API DeleteLinkRequest : public NetworkManagerRequest
  {
  public:
    DeleteLinkRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteLinkRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLinkRequest>(GetServiceRequestName(), *this);
    }
