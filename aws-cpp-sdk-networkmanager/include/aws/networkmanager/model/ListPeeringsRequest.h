...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API ListPeeringsRequest : public NetworkManagerRequest
  {
  public:
    ListPeeringsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListPeeringsRequest> Clone() const
    {
      return Aws::MakeUnique<ListPeeringsRequest>(GetServiceRequestName(), *this);
    }
