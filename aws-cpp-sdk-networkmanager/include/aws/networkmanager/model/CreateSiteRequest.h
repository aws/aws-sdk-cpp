...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API CreateSiteRequest : public NetworkManagerRequest
  {
  public:
    CreateSiteRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateSiteRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSiteRequest>(GetServiceRequestName(), *this);
    }
