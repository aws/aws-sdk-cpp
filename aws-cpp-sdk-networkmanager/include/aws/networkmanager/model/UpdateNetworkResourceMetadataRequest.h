...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API UpdateNetworkResourceMetadataRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateNetworkResourceMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateNetworkResourceMetadataRequest>(GetServiceRequestName(), *this);
    }
