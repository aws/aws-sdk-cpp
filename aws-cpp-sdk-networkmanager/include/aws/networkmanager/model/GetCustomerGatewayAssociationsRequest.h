...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCustomerGatewayAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetCustomerGatewayAssociationsRequest>(GetServiceRequestName(), *this);
    }
