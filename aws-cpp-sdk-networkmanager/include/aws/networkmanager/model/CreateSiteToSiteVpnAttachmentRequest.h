...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API CreateSiteToSiteVpnAttachmentRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSiteToSiteVpnAttachmentRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSiteToSiteVpnAttachmentRequest>(GetServiceRequestName(), *this);
    }
