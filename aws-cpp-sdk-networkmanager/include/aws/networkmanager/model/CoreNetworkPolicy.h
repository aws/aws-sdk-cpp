...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_NETWORKMANAGER_API CoreNetworkPolicy
  {
  public:
    CoreNetworkPolicy();
    CoreNetworkPolicy(Aws::Utils::Json::JsonView jsonValue);
    CoreNetworkPolicy& operator=(Aws::Utils::Json::JsonView jsonValue);
