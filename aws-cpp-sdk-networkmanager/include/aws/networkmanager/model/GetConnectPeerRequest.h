...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetConnectPeerRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetConnectPeerRequest> Clone() const
    {
      return Aws::MakeUnique<GetConnectPeerRequest>(GetServiceRequestName(), *this);
    }
