...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetNetworkResourcesRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetNetworkResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<GetNetworkResourcesRequest>(GetServiceRequestName(), *this);
    }
