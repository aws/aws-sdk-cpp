...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ExecuteCoreNetworkChangeSetRequest> Clone() const
    {
      return Aws::MakeUnique<ExecuteCoreNetworkChangeSetRequest>(GetServiceRequestName(), *this);
    }
