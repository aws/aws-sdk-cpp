...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateCustomerGatewayRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateCustomerGatewayRequest>(GetServiceRequestName(), *this);
    }
