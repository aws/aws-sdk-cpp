...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API DeleteCoreNetworkRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCoreNetworkRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCoreNetworkRequest>(GetServiceRequestName(), *this);
    }
