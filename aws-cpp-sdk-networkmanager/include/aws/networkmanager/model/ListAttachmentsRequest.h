...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API ListAttachmentsRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAttachmentsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAttachmentsRequest>(GetServiceRequestName(), *this);
    }
