...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API DeleteAttachmentRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAttachmentRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAttachmentRequest>(GetServiceRequestName(), *this);
    }
