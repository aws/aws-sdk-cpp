...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCoreNetworkPolicyVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCoreNetworkPolicyVersionRequest>(GetServiceRequestName(), *this);
    }
