...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetTransitGatewayPeeringRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTransitGatewayPeeringRequest> Clone() const
    {
      return Aws::MakeUnique<GetTransitGatewayPeeringRequest>(GetServiceRequestName(), *this);
    }
