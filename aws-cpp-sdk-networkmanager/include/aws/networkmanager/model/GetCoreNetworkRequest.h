...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetCoreNetworkRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCoreNetworkRequest> Clone() const
    {
      return Aws::MakeUnique<GetCoreNetworkRequest>(GetServiceRequestName(), *this);
    }
