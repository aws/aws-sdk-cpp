...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateTransitGatewayConnectPeerRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateTransitGatewayConnectPeerRequest>(GetServiceRequestName(), *this);
    }
