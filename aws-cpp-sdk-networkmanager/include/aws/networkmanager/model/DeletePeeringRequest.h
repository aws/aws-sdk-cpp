...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API DeletePeeringRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeletePeeringRequest> Clone() const
    {
      return Aws::MakeUnique<DeletePeeringRequest>(GetServiceRequestName(), *this);
    }
