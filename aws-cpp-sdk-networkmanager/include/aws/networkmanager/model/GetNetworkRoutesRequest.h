...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetNetworkRoutesRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetNetworkRoutesRequest> Clone() const
    {
      return Aws::MakeUnique<GetNetworkRoutesRequest>(GetServiceRequestName(), *this);
    }
