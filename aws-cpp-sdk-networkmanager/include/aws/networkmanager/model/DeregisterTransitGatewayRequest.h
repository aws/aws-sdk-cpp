...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API DeregisterTransitGatewayRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterTransitGatewayRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterTransitGatewayRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeregisterTransitGateway"; }
