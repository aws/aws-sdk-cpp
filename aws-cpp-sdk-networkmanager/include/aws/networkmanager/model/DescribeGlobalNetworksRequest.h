...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API DescribeGlobalNetworksRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeGlobalNetworksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeGlobalNetworksRequest>(GetServiceRequestName(), *this);
    }
