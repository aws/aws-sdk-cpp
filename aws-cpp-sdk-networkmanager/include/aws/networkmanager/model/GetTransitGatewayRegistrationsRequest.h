...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetTransitGatewayRegistrationsRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTransitGatewayRegistrationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetTransitGatewayRegistrationsRequest>(GetServiceRequestName(), *this);
    }
