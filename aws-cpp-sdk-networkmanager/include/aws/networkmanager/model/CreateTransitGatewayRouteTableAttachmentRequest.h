...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTransitGatewayRouteTableAttachmentRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTransitGatewayRouteTableAttachmentRequest>(GetServiceRequestName(), *this);
    }
