...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API CreateDeviceRequest : public NetworkManagerRequest
  {
  public:
    CreateDeviceRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateDeviceRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDeviceRequest>(GetServiceRequestName(), *this);
    }
