...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API StartOrganizationServiceAccessUpdateRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartOrganizationServiceAccessUpdateRequest> Clone() const
    {
      return Aws::MakeUnique<StartOrganizationServiceAccessUpdateRequest>(GetServiceRequestName(), *this);
    }
