...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTransitGatewayConnectPeerAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetTransitGatewayConnectPeerAssociationsRequest>(GetServiceRequestName(), *this);
    }
