...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API RegisterTransitGatewayRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterTransitGatewayRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterTransitGatewayRequest>(GetServiceRequestName(), *this);
    }
