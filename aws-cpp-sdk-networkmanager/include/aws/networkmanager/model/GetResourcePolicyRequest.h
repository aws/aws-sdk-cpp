...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetResourcePolicyRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetResourcePolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetResourcePolicyRequest>(GetServiceRequestName(), *this);
    }
