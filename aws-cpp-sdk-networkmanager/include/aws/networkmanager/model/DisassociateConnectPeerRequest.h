...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API DisassociateConnectPeerRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateConnectPeerRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateConnectPeerRequest>(GetServiceRequestName(), *this);
    }
