...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateTransitGatewayConnectPeerRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateTransitGatewayConnectPeerRequest>(GetServiceRequestName(), *this);
    }
