...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API GetVpcAttachmentRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetVpcAttachmentRequest> Clone() const
    {
      return Aws::MakeUnique<GetVpcAttachmentRequest>(GetServiceRequestName(), *this);
    }
