...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API ListConnectPeersRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListConnectPeersRequest> Clone() const
    {
      return Aws::MakeUnique<ListConnectPeersRequest>(GetServiceRequestName(), *this);
    }
