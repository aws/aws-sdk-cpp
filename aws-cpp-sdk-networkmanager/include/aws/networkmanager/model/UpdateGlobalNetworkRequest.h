...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKMANAGER_API UpdateGlobalNetworkRequest : public NetworkManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateGlobalNetworkRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateGlobalNetworkRequest>(GetServiceRequestName(), *this);
    }
