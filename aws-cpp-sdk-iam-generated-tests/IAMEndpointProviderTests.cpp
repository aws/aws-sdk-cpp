...
using IAMResolveEndpointOutcome = Aws::IAM::Endpoint::IAMEndpointProvider::IAMResolveEndpointOutcome;
...
void ValidateOutcome(const IAMResolveEndpointOutcome& outcome, const IAMEndpointProviderEndpointTestCase::Expect& expect)
{
