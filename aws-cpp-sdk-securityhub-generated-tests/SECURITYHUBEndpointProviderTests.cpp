...
using SecurityHubResolveEndpointOutcome = Aws::SecurityHub::Endpoint::SecurityHubEndpointProvider::SecurityHubResolveEndpointOutcome;
...
void ValidateOutcome(const SecurityHubResolveEndpointOutcome& outcome, const SecurityHubEndpointProviderEndpointTestCase::Expect& expect)
{
