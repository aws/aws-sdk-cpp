...
namespace Model
{
  ...
  /**
   */
  class AWS_APIGATEWAYV2_API DeleteVpcLinkRequest : public ApiGatewayV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVpcLinkRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVpcLinkRequest>(GetServiceRequestName(), *this);
    }
