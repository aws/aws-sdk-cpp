...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRouteRequestParameterRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRouteRequestParameterRequest>(GetServiceRequestName(), *this);
    }
