...
namespace Model
{
  ...
  /**
   */
  class AWS_APIGATEWAYV2_API DeleteAccessLogSettingsRequest : public ApiGatewayV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAccessLogSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAccessLogSettingsRequest>(GetServiceRequestName(), *this);
    }
