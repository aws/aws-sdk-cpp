...
namespace Model
{
  ...
  /**
   */
  class AWS_APIGATEWAYV2_API GetRoutesRequest : public ApiGatewayV2Request
  {
  public:
    GetRoutesRequest();
    ...
    */
    virtual Aws::UniquePtr<GetRoutesRequest> Clone() const
    {
      return Aws::MakeUnique<GetRoutesRequest>(GetServiceRequestName(), *this);
    }
