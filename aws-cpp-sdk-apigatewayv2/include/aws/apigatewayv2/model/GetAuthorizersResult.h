...
namespace Model
{
 ...
 the collection.</p>
     */
    inline GetAuthorizersResult& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
 ...
 the collection.</p>
     */
    inline GetAuthorizersResult& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
 ...
 the collection.</p>
     */
    inline GetAuthorizersResult& WithNextToken(const char* value) { SetNextToken(value); return *this;}
