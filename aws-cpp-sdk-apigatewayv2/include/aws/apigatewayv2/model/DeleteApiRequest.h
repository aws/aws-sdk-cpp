...
namespace Model
{
  ...
  /**
   */
  class AWS_APIGATEWAYV2_API DeleteApiRequest : public ApiGatewayV2Request
  {
  public:
    DeleteApiRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteApiRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteApiRequest>(GetServiceRequestName(), *this);
    }
