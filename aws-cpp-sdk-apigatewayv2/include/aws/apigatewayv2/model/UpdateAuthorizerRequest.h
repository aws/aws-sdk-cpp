...
namespace Model
{
  ...
  public:
     ...
     * zero, authorization caching is disabled. If it is greater than zero, API Gateway
     * will cache authorizer responses. If this field is not set, the default value is
     * 300. The maximum value is 3600, or 1 hour.</p>
     */
     ...
     * specified request parameters. For example, if an Auth header, a Name query
