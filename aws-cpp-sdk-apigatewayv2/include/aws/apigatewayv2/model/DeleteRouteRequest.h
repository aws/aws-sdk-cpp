...
namespace Model
{
  ...
  /**
   */
  class AWS_APIGATEWAYV2_API DeleteRouteRequest : public ApiGatewayV2Request
  {
  public:
    DeleteRouteRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteRouteRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRouteRequest>(GetServiceRequestName(), *this);
    }
