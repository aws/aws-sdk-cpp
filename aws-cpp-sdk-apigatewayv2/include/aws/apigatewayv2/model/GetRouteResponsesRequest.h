...
namespace Model
{
  ...
  /**
   */
  class AWS_APIGATEWAYV2_API GetRouteResponsesRequest : public ApiGatewayV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRouteResponsesRequest> Clone() const
    {
      return Aws::MakeUnique<GetRouteResponsesRequest>(GetServiceRequestName(), *this);
    }
