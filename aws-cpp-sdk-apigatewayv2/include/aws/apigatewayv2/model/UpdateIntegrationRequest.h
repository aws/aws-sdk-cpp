...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APIGATEWAYV2_API UpdateIntegrationRequest : public ApiGatewayV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateIntegrationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateIntegrationRequest>(GetServiceRequestName(), *this);
    }
