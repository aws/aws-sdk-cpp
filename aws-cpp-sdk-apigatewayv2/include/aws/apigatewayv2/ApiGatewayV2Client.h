...
namespace ApiGatewayV2
{
  ...
  class AWS_APIGATEWAYV2_API ApiGatewayV2Client : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ApiGatewayV2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::ApiGatewayV2EndpointProvider> endpointProvider = Aws::MakeShared<ApiGatewayV2::Endpoint::ApiGatewayV2EndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ApiGatewayV2EndpointProvider> m_endpointProvider;
  };
