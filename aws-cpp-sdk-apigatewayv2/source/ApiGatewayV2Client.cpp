...
using ResolveEndpointOutcome = Aws::ApiGatewayV2::Endpoint::ApiGatewayV2EndpointProvider::ApiGatewayV2ResolveEndpointOutcome;
...
ApiGatewayV2Client::ApiGatewayV2Client(const Client::ClientConfiguration& clientConfiguration,
                                       std::shared_ptr<Endpoint::ApiGatewayV2EndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ApiGatewayV2ErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ApiGatewayV2::Endpoint::ApiGatewayV2EndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
