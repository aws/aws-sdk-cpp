...
namespace Model
{
  ...
  public:
     ...
     * <li><p>DEVICE_LOG: The device log type.</p></li> <li><p>EXERCISER_MONKEY_OUTPUT:
     * For Android, the artifact (log) generated by an Android fuzz test.</p></li>
     * <li><p>INSTRUMENTATION_OUTPUT: The instrumentation type.</p></li>
     * <li><p>MESSAGE_LOG: The message log type.</p></li> <li><p>RESULT_LOG: The result
     * log type.</p></li> <li><p>SCREENSHOT: The screenshot type.</p></li>
     * <li><p>SERVICE_LOG: The service log type.</p></li> <li><p>UNKNOWN: An unknown
     * type.</p></li> </ul>
     */
