...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DEVICEFARM_API GetTestRequest : public DeviceFarmRequest
  {
  public:
    GetTestRequest();
    ...
    */
    virtual Aws::UniquePtr<GetTestRequest> Clone() const
    {
      return Aws::MakeUnique<GetTestRequest>(GetServiceRequestName(), *this);
    }
