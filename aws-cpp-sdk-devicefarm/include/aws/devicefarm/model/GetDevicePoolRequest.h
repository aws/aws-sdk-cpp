...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDevicePoolRequest> Clone() const
    {
      return Aws::MakeUnique<GetDevicePoolRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetDevicePool"; }
