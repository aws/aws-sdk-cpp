...
namespace Model
{
   ...
   */
  class AWS_DEVICEFARM_API ListTestsRequest : public DeviceFarmRequest
  {
  public:
    ListTestsRequest();
     ...
     * <p>The tests' ARNs.</p>
     */
    inline ListTestsRequest& WithArn(Aws::String&& value) { SetArn(value); return *this;}
     ...
     * which can be used to return the next set of items in the list.</p>
     */
    inline ListTestsRequest& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
