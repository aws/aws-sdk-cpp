...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRemoteAccessSessionRequest> Clone() const
    {
      return Aws::MakeUnique<GetRemoteAccessSessionRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetRemoteAccessSession"; }
