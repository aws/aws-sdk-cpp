...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVICEFARM_API CreateTestGridUrlRequest : public DeviceFarmRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTestGridUrlRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTestGridUrlRequest>(GetServiceRequestName(), *this);
    }
