...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVICEFARM_API ListTestGridSessionActionsRequest : public DeviceFarmRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTestGridSessionActionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListTestGridSessionActionsRequest>(GetServiceRequestName(), *this);
    }
