...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVICEFARM_API UpdateTestGridProjectRequest : public DeviceFarmRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTestGridProjectRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTestGridProjectRequest>(GetServiceRequestName(), *this);
    }
