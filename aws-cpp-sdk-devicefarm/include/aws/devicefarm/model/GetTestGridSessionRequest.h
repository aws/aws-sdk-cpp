...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVICEFARM_API GetTestGridSessionRequest : public DeviceFarmRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTestGridSessionRequest> Clone() const
    {
      return Aws::MakeUnique<GetTestGridSessionRequest>(GetServiceRequestName(), *this);
    }
