...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DEVICEFARM_API ListRunsRequest : public DeviceFarmRequest
  {
  public:
    ListRunsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListRunsRequest> Clone() const
    {
      return Aws::MakeUnique<ListRunsRequest>(GetServiceRequestName(), *this);
    }
