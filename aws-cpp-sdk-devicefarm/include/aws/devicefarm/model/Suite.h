...
namespace Model
{
  ...
  public:
     ...
     * <p>When the suite was created.</p>
     */
    inline Suite& WithCreated(double value) { SetCreated(value); return *this;}

    /**
     * <p>The suite's status.</p> <p>Allowed values include:</p> <ul> <li><p>COMPLETED:
    ...
    /**
     * <p>The suite's result.</p> <p>Allowed values include:</p> <ul> <li><p>ERRORED:
     * An error condition.</p></li> <li><p>FAILED: A failed condition.</p></li>
     ...
     * <p>The suite's start time.</p>
     */
    inline Suite& WithStarted(double value) { SetStarted(value); return *this;}
     ...
     * <p>The suite's stop time.</p>
     */
    inline Suite& WithStopped(double value) { SetStopped(value); return *this;}
