...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DEVICEFARM_API GetUploadRequest : public DeviceFarmRequest
  {
  public:
    GetUploadRequest();
    ...
    */
    virtual Aws::UniquePtr<GetUploadRequest> Clone() const
    {
      return Aws::MakeUnique<GetUploadRequest>(GetServiceRequestName(), *this);
    }
