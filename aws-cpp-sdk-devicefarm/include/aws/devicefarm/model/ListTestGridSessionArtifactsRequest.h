...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTestGridSessionArtifactsRequest> Clone() const
    {
      return Aws::MakeUnique<ListTestGridSessionArtifactsRequest>(GetServiceRequestName(), *this);
    }
