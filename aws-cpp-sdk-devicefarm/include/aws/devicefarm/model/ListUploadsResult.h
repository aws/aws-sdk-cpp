...
namespace Model
{
  ...
  public:
     ...
     * <p>Information about the uploads.</p>
     */
    inline void SetUploads(Aws::Vector<Upload>&& value) { m_uploads = value; }
     ...
     * <p>Information about the uploads.</p>
     */
    inline ListUploadsResult& WithUploads(Aws::Vector<Upload>&& value) { SetUploads(value); return *this;}
     ...
     * <p>Information about the uploads.</p>
     */
    inline ListUploadsResult& AddUploads(Upload&& value) { m_uploads.push_back(value); return *this; }
     ...
     * operation to return the next set of items in the list.</p>
     */
    inline ListUploadsResult& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
