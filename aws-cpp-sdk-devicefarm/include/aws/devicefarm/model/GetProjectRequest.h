...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetProjectRequest> Clone() const
    {
      return Aws::MakeUnique<GetProjectRequest>(GetServiceRequestName(), *this);
    }
     ...
     * <p>The project's ARN.</p>
     */
    inline GetProjectRequest& WithArn(Aws::String&& value) { SetArn(std::move(value)); return *this;}
