...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<InstallToRemoteAccessSessionRequest> Clone() const
    {
      return Aws::MakeUnique<InstallToRemoteAccessSessionRequest>(GetServiceRequestName(), *this);
    }
