...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVICEFARM_API CreateTestGridProjectRequest : public DeviceFarmRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTestGridProjectRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTestGridProjectRequest>(GetServiceRequestName(), *this);
    }
