...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVICEFARM_API ListTestGridProjectsRequest : public DeviceFarmRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTestGridProjectsRequest> Clone() const
    {
      return Aws::MakeUnique<ListTestGridProjectsRequest>(GetServiceRequestName(), *this);
    }
