...
ListSamplesResult::ListSamplesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListSamplesResult& ListSamplesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
