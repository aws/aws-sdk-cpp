...
ListArtifactsResult::ListArtifactsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListArtifactsResult& ListArtifactsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
