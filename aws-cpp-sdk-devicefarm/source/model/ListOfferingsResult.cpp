...
ListOfferingsResult::ListOfferingsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListOfferingsResult& ListOfferingsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
