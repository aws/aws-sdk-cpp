...
Aws::String GetVPCEConfigurationRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection GetVPCEConfigurationRequest::GetRequestSpecificHeaders() const
{
  ...
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "DeviceFarm_20150623.GetVPCEConfiguration"));
  return headers;
