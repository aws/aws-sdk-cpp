...
Aws::String ListArtifactsRequest::SerializePayload() const
{
  ...
  if(m_typeHasBeenSet)
  {
   payload.WithString("type", ArtifactCategoryMapper::GetNameForArtifactCategory(m_type));
  }
...
Aws::Http::HeaderValueCollection ListArtifactsRequest::GetRequestSpecificHeaders() const
{
  ...
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "DeviceFarm_20150623.ListArtifacts"));
  return headers;
