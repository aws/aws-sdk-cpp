...
Aws::String DeviceFarmEndpointRules::GetRulesAsString()
{
    return Aws::String(DeviceFarmEndpointRules::Rules.begin(), DeviceFarmEndpointRules::Rules.end());
}

const Aws::Vector<char> DeviceFarmEndpointRules::Rules = {
...
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','e','v','i','c','e','f',
'a','r','m','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
':','/','/','d','e','v','i','c','e','f','a','r','m','-','f','i','p','s','.','{','R','e','g','i','o',
...
'"','r','u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',
',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',
':','/','/','d','e','v','i','c','e','f','a','r','m','.','{','R','e','g','i','o','n','}','.','{','P',
...
'"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n','t',
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','e','v','i','c','e','f',
'a','r','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
