...
Aws::String MigrationHubEndpointRules::GetRulesAsString()
{
    return Aws::String(MigrationHubEndpointRules::Rules.begin(), MigrationHubEndpointRules::Rules.end());
}

const Aws::Vector<char> MigrationHubEndpointRules::Rules = {
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','g','h','.','{','R','e','g','i','o',
