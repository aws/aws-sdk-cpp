...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateCreatedArtifactRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateCreatedArtifactRequest>(GetServiceRequestName(), *this);
    }
