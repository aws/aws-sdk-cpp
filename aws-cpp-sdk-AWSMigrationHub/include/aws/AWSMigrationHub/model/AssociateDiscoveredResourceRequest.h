...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateDiscoveredResourceRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateDiscoveredResourceRequest>(GetServiceRequestName(), *this);
    }
