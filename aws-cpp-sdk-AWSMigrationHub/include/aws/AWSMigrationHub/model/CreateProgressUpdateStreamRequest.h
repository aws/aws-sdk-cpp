...
namespace Model
{
  ...
  /**
   */
  class AWS_MIGRATIONHUB_API CreateProgressUpdateStreamRequest : public MigrationHubRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateProgressUpdateStreamRequest> Clone() const
    {
      return Aws::MakeUnique<CreateProgressUpdateStreamRequest>(GetServiceRequestName(), *this);
    }
