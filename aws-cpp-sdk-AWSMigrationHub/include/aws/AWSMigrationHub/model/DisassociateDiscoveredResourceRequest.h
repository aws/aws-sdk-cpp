...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateDiscoveredResourceRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateDiscoveredResourceRequest>(GetServiceRequestName(), *this);
    }
