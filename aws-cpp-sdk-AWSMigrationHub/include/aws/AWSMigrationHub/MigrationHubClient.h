...
namespace MigrationHub
{
  ...
  class AWS_MIGRATIONHUB_API MigrationHubClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MigrationHubClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::MigrationHubEndpointProvider> endpointProvider = Aws::MakeShared<MigrationHub::Endpoint::MigrationHubEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MigrationHubEndpointProvider> m_endpointProvider;
  };
