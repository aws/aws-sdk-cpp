...
BatchUpdateTableRowsResult::BatchUpdateTableRowsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) : 
    m_workbookCursor(0)
{
  *this = result;
}

BatchUpdateTableRowsResult& BatchUpdateTableRowsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
