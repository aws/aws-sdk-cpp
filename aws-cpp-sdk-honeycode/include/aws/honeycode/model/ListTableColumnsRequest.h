...
namespace Model
{
  ...
  /**
   */
  class AWS_HONEYCODE_API ListTableColumnsRequest : public HoneycodeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTableColumnsRequest> Clone() const
    {
      return Aws::MakeUnique<ListTableColumnsRequest>(GetServiceRequestName(), *this);
    }
