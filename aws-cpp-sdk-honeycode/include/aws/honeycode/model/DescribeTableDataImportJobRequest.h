...
namespace Model
{
  ...
  /**
   */
  class AWS_HONEYCODE_API DescribeTableDataImportJobRequest : public HoneycodeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTableDataImportJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTableDataImportJobRequest>(GetServiceRequestName(), *this);
    }
