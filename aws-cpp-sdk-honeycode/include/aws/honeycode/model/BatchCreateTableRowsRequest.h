...
namespace Model
{
  ...
  /**
   */
  class AWS_HONEYCODE_API BatchCreateTableRowsRequest : public HoneycodeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchCreateTableRowsRequest> Clone() const
    {
      return Aws::MakeUnique<BatchCreateTableRowsRequest>(GetServiceRequestName(), *this);
    }
