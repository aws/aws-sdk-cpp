...
namespace Model
{
  ...
  /**
   */
  class AWS_HONEYCODE_API GetScreenDataRequest : public HoneycodeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetScreenDataRequest> Clone() const
    {
      return Aws::MakeUnique<GetScreenDataRequest>(GetServiceRequestName(), *this);
    }
