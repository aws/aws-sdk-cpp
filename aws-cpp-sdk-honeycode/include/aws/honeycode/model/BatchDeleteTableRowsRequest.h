...
namespace Model
{
  ...
  /**
   */
  class AWS_HONEYCODE_API BatchDeleteTableRowsRequest : public HoneycodeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDeleteTableRowsRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDeleteTableRowsRequest>(GetServiceRequestName(), *this);
    }
