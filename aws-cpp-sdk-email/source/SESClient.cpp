...
using ResolveEndpointOutcome = Aws::SES::Endpoint::SESEndpointProvider::SESResolveEndpointOutcome;
...
SESClient::SESClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::SESEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SESErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<SES::Endpoint::SESEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
