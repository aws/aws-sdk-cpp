  ...
  Aws::String ForRegion(Region region)
  {
    switch(region)
    {
     ...
     case Region::US_WEST_1:
        return "email.us-west-1.amazonaws.com";
     case Region::US_WEST_2:
        return "email.us-west-2.amazonaws.com";
     case Region::EU_WEST_1:
        return "email.eu-west-1.amazonaws.com";
     case Region::EU_CENTRAL_1:
        return "email.eu-central-1.amazonaws.com";
     case Region::AP_SOUTHEAST_1:
        return "email.ap-southeast-1.amazonaws.com";
     ...
     case Region::AP_SOUTH_1:
        return "email.ap-south-1.amazonaws.com";
     default:
        return "email.us-east-1.amazonaws.com";
    }
  }
