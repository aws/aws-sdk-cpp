...
Aws::String SESEndpointRules::GetRulesAsString()
{
    return Aws::String(SESEndpointRules::Rules.begin(), SESEndpointRules::Rules.end());
}

const Aws::Vector<char> SESEndpointRules::Rules = {
