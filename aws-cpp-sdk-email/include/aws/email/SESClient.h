...
namespace SES
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SESClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::SESEndpointProvider> endpointProvider = Aws::MakeShared<SES::Endpoint::SESEndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::SESEndpointProvider> m_endpointProvider;
  };
