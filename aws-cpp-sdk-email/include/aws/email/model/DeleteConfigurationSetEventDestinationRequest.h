...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SES_API DeleteConfigurationSetEventDestinationRequest : public SESRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "DeleteConfigurationSetEventDestination"; }
