...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/ConfigurationSetAlreadyExistsException">AWS
   * API Reference</a></p>
   */
  class AWS_SES_API ConfigurationSetAlreadyExistsException
  {
  public:
     ...
     * <p>Indicates that the configuration set does not exist.</p>
     */
    inline ConfigurationSetAlreadyExistsException& WithConfigurationSetName(const char* value) { SetConfigurationSetName(value); return *this;}
