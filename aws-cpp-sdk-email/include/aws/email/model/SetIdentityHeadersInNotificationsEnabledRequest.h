...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SetIdentityHeadersInNotificationsEnabledRequest> Clone() const
    {
      return Aws::MakeUnique<SetIdentityHeadersInNotificationsEnabledRequest>(GetServiceRequestName(), *this);
    }
