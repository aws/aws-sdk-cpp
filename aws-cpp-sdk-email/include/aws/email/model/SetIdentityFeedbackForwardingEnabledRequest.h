...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SetIdentityFeedbackForwardingEnabledRequest> Clone() const
    {
      return Aws::MakeUnique<SetIdentityFeedbackForwardingEnabledRequest>(GetServiceRequestName(), *this);
    }
