...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateConfigurationSetTrackingOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateConfigurationSetTrackingOptionsRequest>(GetServiceRequestName(), *this);
    }
