...
namespace Model
{
  ...
  /*
    <p>Represents a request instructing the service to apply an authorization policy to an identity.</p>
  */
  ...
  public:
    ...
    /*
     <p>The email address or domain to which the <code>Policy</code> will apply. </p> <p>The identity must be owned by the caller.</p>
    */
    ...
    */
    ...
    /*
     <p>The name of the policy document</p> <p>The policy name cannot exceed 100 characters and can only include alpha-numeric characters, dashes, and underscores.</p>
    */
    ...
    */
    ...
    /*
     <p>The text of the policy.</p> <p>The policy cannot exceed 4KB in size. For more information about the syntax of authorization policies, see the <a href="http://docs.aws.amazon.com/ses/latest/DeveloperGuide/sending-authorization.html">Amazon SES Developer Guide</a>. </p>
    */
