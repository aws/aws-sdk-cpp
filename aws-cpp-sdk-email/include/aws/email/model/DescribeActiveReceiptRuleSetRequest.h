...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeActiveReceiptRuleSetRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeActiveReceiptRuleSetRequest>(GetServiceRequestName(), *this);
    }
