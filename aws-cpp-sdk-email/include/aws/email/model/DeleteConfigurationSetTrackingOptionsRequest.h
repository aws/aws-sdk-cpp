...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteConfigurationSetTrackingOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteConfigurationSetTrackingOptionsRequest>(GetServiceRequestName(), *this);
    }
