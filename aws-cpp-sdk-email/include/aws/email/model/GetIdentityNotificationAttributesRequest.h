...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetIdentityNotificationAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<GetIdentityNotificationAttributesRequest>(GetServiceRequestName(), *this);
    }
