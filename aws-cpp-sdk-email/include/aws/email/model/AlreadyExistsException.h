...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SES_API AlreadyExistsException
  {
  public:
    AlreadyExistsException();
    AlreadyExistsException(const Aws::Utils::Xml::XmlNode& xmlNode);
    AlreadyExistsException& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
