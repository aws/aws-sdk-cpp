...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SetIdentityNotificationTopicRequest> Clone() const
    {
      return Aws::MakeUnique<SetIdentityNotificationTopicRequest>(GetServiceRequestName(), *this);
    }
