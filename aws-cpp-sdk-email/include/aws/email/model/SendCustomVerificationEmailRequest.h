...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SendCustomVerificationEmailRequest> Clone() const
    {
      return Aws::MakeUnique<SendCustomVerificationEmailRequest>(GetServiceRequestName(), *this);
    }
