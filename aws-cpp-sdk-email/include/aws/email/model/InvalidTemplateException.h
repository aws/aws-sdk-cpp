...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SES_API InvalidTemplateException
  {
  public:
    InvalidTemplateException();
    InvalidTemplateException(const Aws::Utils::Xml::XmlNode& xmlNode);
    InvalidTemplateException& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
