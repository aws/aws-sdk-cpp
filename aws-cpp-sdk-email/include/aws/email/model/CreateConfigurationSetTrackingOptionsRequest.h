...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateConfigurationSetTrackingOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<CreateConfigurationSetTrackingOptionsRequest>(GetServiceRequestName(), *this);
    }
