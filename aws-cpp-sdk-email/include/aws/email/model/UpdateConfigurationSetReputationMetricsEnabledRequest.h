...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateConfigurationSetReputationMetricsEnabledRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateConfigurationSetReputationMetricsEnabledRequest>(GetServiceRequestName(), *this);
    }
