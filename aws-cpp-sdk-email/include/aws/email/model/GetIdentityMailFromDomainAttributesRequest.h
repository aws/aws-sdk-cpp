...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetIdentityMailFromDomainAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<GetIdentityMailFromDomainAttributesRequest>(GetServiceRequestName(), *this);
    }
