...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetIdentityVerificationAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<GetIdentityVerificationAttributesRequest>(GetServiceRequestName(), *this);
    }
