...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAccountSendingEnabledRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAccountSendingEnabledRequest>(GetServiceRequestName(), *this);
    }
