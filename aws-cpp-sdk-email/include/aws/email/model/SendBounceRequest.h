...
namespace Model
{
  ...
  */
  ...
  public:
    ...
    /*
     Message id of the message received through SES Inbound that should be bounced. This is required and needs to be received by the same account as the caller of this API.
    */
    ...
    */
    ...
    /*
     The address to use in the bounces From header. This is required and must use a verified identity.
    */
    ...
    */
    ...
    /*
     Human-readable text for the bounce message to explain the failure. If not specified, one will be auto-generated based on the bounced recipients (and BounceTypes, if provided).
    */
    ...
    */
    ...
    /*
     Recipients of the original message that bounced and information about them needed to create their DSNs. This is a required field - you must have at least one BouncedRecipientInfo in the list.
    */
    ...
    */
    ...
    /*
     The ARN for the identity of the address to use in the bounce's From header. This is only necessary if the caller's account doesn't own the identity and is using sending authorization policies to send on behalf of another account's identity.
    */
