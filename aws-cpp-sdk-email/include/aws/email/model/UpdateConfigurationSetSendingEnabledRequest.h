...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateConfigurationSetSendingEnabledRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateConfigurationSetSendingEnabledRequest>(GetServiceRequestName(), *this);
    }
