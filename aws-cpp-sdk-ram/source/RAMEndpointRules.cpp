...
namespace RAM
{
const size_t RAMEndpointRules::RulesBlobStrLen = 4107;
const size_t RAMEndpointRules::RulesBlobSize = 4108;
...
'h','t','t','p','s',':','/','/','r','a','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
':','"','h','t','t','p','s',':','/','/','r','a','m','.','u','s','-','g','o','v','-','w','e','s','t',
