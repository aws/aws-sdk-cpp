...
Aws::String RAMEndpointRules::GetRulesAsString()
{
    return Aws::String(RAMEndpointRules::Rules.begin(), RAMEndpointRules::Rules.end());
}

const Aws::Vector<char> RAMEndpointRules::Rules = {
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','a','m','.','{','R','e','g','i','o',
