...
namespace RAM
{
  ...
  class AWS_RAM_API RAMClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        RAMClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::RAMEndpointProvider> endpointProvider = Aws::MakeShared<RAM::Endpoint::RAMEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::RAMEndpointProvider> m_endpointProvider;
  };
