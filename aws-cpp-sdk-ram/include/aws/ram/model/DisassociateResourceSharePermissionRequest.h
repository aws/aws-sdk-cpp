...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateResourceSharePermissionRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateResourceSharePermissionRequest>(GetServiceRequestName(), *this);
    }
