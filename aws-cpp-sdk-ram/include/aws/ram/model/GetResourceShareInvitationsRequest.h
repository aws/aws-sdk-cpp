...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetResourceShareInvitationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetResourceShareInvitationsRequest>(GetServiceRequestName(), *this);
    }
