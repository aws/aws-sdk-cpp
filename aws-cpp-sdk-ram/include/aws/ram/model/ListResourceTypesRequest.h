...
namespace Model
{
  ...
  /**
   */
  class AWS_RAM_API ListResourceTypesRequest : public RAMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResourceTypesRequest> Clone() const
    {
      return Aws::MakeUnique<ListResourceTypesRequest>(GetServiceRequestName(), *this);
    }
