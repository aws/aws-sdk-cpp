...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RejectResourceShareInvitationRequest> Clone() const
    {
      return Aws::MakeUnique<RejectResourceShareInvitationRequest>(GetServiceRequestName(), *this);
    }
