...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PromoteResourceShareCreatedFromPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PromoteResourceShareCreatedFromPolicyRequest>(GetServiceRequestName(), *this);
    }
