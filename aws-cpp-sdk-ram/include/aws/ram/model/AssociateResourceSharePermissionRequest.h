...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateResourceSharePermissionRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateResourceSharePermissionRequest>(GetServiceRequestName(), *this);
    }
