...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResourceSharePermissionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListResourceSharePermissionsRequest>(GetServiceRequestName(), *this);
    }
