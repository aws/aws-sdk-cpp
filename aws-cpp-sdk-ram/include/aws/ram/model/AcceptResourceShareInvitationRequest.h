...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AcceptResourceShareInvitationRequest> Clone() const
    {
      return Aws::MakeUnique<AcceptResourceShareInvitationRequest>(GetServiceRequestName(), *this);
    }
