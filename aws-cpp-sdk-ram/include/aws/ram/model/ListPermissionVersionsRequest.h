...
namespace Model
{
  ...
  /**
   */
  class AWS_RAM_API ListPermissionVersionsRequest : public RAMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPermissionVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListPermissionVersionsRequest>(GetServiceRequestName(), *this);
    }
