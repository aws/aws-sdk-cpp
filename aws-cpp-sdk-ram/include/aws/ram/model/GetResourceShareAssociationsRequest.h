...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetResourceShareAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetResourceShareAssociationsRequest>(GetServiceRequestName(), *this);
    }
