...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPendingInvitationResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListPendingInvitationResourcesRequest>(GetServiceRequestName(), *this);
    }
