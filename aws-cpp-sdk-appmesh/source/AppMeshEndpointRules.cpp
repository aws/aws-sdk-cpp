...
namespace AppMesh
{
const size_t AppMeshEndpointRules::RulesBlobStrLen = 3458;
const size_t AppMeshEndpointRules::RulesBlobSize = 3459;

using RulesBlobT = Aws::Array<const char, AppMeshEndpointRules::RulesBlobSize>;
...
'/','a','p','p','m','e','s','h','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'p','m','e','s','h','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
...
':','"','h','t','t','p','s',':','/','/','a','p','p','m','e','s','h','.','{','R','e','g','i','o','n',
...
const char* AppMeshEndpointRules::GetRulesBlob()
{
