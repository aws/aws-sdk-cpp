...
Aws::String AppMeshEndpointRules::GetRulesAsString()
{
    return Aws::String(AppMeshEndpointRules::Rules.begin(), AppMeshEndpointRules::Rules.end());
}

const Aws::Vector<char> AppMeshEndpointRules::Rules = {
...
'a','p','p','m','e','s','h','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'm','e','s','h','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
