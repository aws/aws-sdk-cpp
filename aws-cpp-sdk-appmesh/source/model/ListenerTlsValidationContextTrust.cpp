...
ListenerTlsValidationContextTrust& ListenerTlsValidationContextTrust::operator =(JsonView jsonValue)
{
...
JsonValue ListenerTlsValidationContextTrust::Jsonize() const
{
  JsonValue payload;
