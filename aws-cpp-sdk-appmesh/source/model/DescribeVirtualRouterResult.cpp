...
DescribeVirtualRouterResult::DescribeVirtualRouterResult()
{
}

DescribeVirtualRouterResult::DescribeVirtualRouterResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
