...
namespace AppMesh
{
  ...
  class AWS_APPMESH_API AppMeshClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AppMeshClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                      std::shared_ptr<Endpoint::AppMeshEndpointProvider> endpointProvider = Aws::MakeShared<AppMesh::Endpoint::AppMeshEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AppMeshEndpointProvider> m_endpointProvider;
  };
