...
namespace Model
{
  ...
  /**
   * <p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2018-10-01/DescribeRouteInput">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    /**
     * <p>The name of the virtual router with which the route is associated.</p>
     */
