...
namespace Model
{
  ...
  public:
     ...
     * mesh (and any traffic to <code>*.amazonaws.com</code> for AWS API calls). You
     * can set the egress filter type to <code>ALLOW_ALL</code> to allow egress to any
     * endpoint inside or outside of the service mesh.</p>
     */
