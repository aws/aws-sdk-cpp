...
namespace Model
{
  ...
  /**
   */
  class AWS_APPMESH_API CreateGatewayRouteRequest : public AppMeshRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateGatewayRouteRequest> Clone() const
    {
      return Aws::MakeUnique<CreateGatewayRouteRequest>(GetServiceRequestName(), *this);
    }
