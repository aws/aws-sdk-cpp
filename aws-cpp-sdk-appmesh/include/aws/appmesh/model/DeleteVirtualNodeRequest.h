...
namespace Model
{
  ...
  /**
   * <p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2018-10-01/DeleteVirtualNodeInput">AWS
   * API Reference</a></p>
   */
  class AWS_APPMESH_API DeleteVirtualNodeRequest : public AppMeshRequest
  {
  public:
    ...
    /**
     * <p>The name of the service mesh in which to delete the virtual node.</p>
     */
