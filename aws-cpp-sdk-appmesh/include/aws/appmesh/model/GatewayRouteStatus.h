...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPMESH_API GatewayRouteStatus
  {
  public:
    GatewayRouteStatus();
    GatewayRouteStatus(Aws::Utils::Json::JsonView jsonValue);
    GatewayRouteStatus& operator=(Aws::Utils::Json::JsonView jsonValue);
