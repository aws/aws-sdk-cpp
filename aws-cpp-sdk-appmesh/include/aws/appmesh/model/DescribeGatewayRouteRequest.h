...
namespace Model
{
  ...
  /**
   */
  class AWS_APPMESH_API DescribeGatewayRouteRequest : public AppMeshRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeGatewayRouteRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeGatewayRouteRequest>(GetServiceRequestName(), *this);
    }
