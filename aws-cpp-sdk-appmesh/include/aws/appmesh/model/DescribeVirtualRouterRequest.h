...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPMESH_API DescribeVirtualRouterRequest : public AppMeshRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVirtualRouterRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVirtualRouterRequest>(GetServiceRequestName(), *this);
    }
