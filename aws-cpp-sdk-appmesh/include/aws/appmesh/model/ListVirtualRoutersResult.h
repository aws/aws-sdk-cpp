...
namespace Model
{
  /**
   * <p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2018-10-01/ListVirtualRoutersOutput">AWS
   * API Reference</a></p>
   */
  ...
  public:
     ...
     * <code>ListVirtualRouters</code> request exceed
         <code>limit</code>, this
     * value can be used to retrieve the next page of
