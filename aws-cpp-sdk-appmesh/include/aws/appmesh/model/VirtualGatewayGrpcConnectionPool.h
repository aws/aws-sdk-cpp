...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPMESH_API VirtualGatewayGrpcConnectionPool
  {
  public:
    VirtualGatewayGrpcConnectionPool();
    VirtualGatewayGrpcConnectionPool(Aws::Utils::Json::JsonView jsonValue);
    VirtualGatewayGrpcConnectionPool& operator=(Aws::Utils::Json::JsonView jsonValue);
