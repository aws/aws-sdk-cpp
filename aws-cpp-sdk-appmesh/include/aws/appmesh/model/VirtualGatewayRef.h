...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPMESH_API VirtualGatewayRef
  {
  public:
    VirtualGatewayRef();
    VirtualGatewayRef(Aws::Utils::Json::JsonView jsonValue);
    VirtualGatewayRef& operator=(Aws::Utils::Json::JsonView jsonValue);
