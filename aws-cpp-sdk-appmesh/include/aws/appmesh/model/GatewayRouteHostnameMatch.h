...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPMESH_API GatewayRouteHostnameMatch
  {
  public:
    GatewayRouteHostnameMatch();
    GatewayRouteHostnameMatch(Aws::Utils::Json::JsonView jsonValue);
    GatewayRouteHostnameMatch& operator=(Aws::Utils::Json::JsonView jsonValue);
