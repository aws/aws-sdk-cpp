...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2018-10-01/HttpRouteAction">AWS
   * API Reference</a></p>
   */
  ...
  public:
     ...
     * can specify
         one or more targets and their relative weights with which
     * to distribute traffic.</p>
     */
