...
namespace Model
{
  ...
  /**
   */
  class AWS_APPMESH_API UpdateGatewayRouteRequest : public AppMeshRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateGatewayRouteRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateGatewayRouteRequest>(GetServiceRequestName(), *this);
    }
