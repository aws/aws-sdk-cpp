...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The header value sent by the client must match the specified value
     * exactly.</p>
     */
    ...
    /**
     * <p>The header value sent by the client must begin with the specified
     * characters.</p>
     */
    ...
    /**
     * <p>The header value sent by the client must include the specified
     * characters.</p>
     */
    ...
    /**
     * <p>The header value sent by the client must end with the specified
     * characters.</p>
     */
