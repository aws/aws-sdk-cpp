...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API UpdateChannelFlowRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateChannelFlowRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateChannelFlowRequest>(GetServiceRequestName(), *this);
    }
