...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API ListChannelModeratorsRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListChannelModeratorsRequest> Clone() const
    {
      return Aws::MakeUnique<ListChannelModeratorsRequest>(GetServiceRequestName(), *this);
    }
