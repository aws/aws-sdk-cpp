...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API DescribeChannelModeratorRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeChannelModeratorRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeChannelModeratorRequest>(GetServiceRequestName(), *this);
    }
