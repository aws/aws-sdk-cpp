...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API DescribeChannelMembershipForAppInstanceUserRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeChannelMembershipForAppInstanceUserRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeChannelMembershipForAppInstanceUserRequest>(GetServiceRequestName(), *this);
    }
