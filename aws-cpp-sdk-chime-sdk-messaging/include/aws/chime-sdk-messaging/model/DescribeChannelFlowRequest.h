...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API DescribeChannelFlowRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeChannelFlowRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeChannelFlowRequest>(GetServiceRequestName(), *this);
    }
