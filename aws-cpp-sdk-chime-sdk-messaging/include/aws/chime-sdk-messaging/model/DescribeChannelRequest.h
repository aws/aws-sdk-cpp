...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API DescribeChannelRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeChannelRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeChannelRequest>(GetServiceRequestName(), *this);
    }
