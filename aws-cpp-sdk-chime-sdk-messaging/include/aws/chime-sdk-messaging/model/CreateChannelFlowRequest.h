...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API CreateChannelFlowRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateChannelFlowRequest> Clone() const
    {
      return Aws::MakeUnique<CreateChannelFlowRequest>(GetServiceRequestName(), *this);
    }
