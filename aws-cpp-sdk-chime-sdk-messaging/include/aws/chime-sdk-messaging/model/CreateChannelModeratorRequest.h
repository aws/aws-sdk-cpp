...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API CreateChannelModeratorRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateChannelModeratorRequest> Clone() const
    {
      return Aws::MakeUnique<CreateChannelModeratorRequest>(GetServiceRequestName(), *this);
    }
