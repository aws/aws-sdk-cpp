...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API GetChannelMessageStatusRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetChannelMessageStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetChannelMessageStatusRequest>(GetServiceRequestName(), *this);
    }
