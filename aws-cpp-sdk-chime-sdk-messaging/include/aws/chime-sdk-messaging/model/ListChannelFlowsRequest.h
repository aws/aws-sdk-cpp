...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API ListChannelFlowsRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListChannelFlowsRequest> Clone() const
    {
      return Aws::MakeUnique<ListChannelFlowsRequest>(GetServiceRequestName(), *this);
    }
