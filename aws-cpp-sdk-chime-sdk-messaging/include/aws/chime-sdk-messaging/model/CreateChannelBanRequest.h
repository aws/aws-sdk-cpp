...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API CreateChannelBanRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateChannelBanRequest> Clone() const
    {
      return Aws::MakeUnique<CreateChannelBanRequest>(GetServiceRequestName(), *this);
    }
