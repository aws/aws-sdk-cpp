...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API PutChannelMembershipPreferencesRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutChannelMembershipPreferencesRequest> Clone() const
    {
      return Aws::MakeUnique<PutChannelMembershipPreferencesRequest>(GetServiceRequestName(), *this);
    }
