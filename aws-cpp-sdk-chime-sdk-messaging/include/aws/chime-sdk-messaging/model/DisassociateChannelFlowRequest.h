...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API DisassociateChannelFlowRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateChannelFlowRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateChannelFlowRequest>(GetServiceRequestName(), *this);
    }
