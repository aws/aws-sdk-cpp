...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API ListChannelMembershipsRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListChannelMembershipsRequest> Clone() const
    {
      return Aws::MakeUnique<ListChannelMembershipsRequest>(GetServiceRequestName(), *this);
    }
