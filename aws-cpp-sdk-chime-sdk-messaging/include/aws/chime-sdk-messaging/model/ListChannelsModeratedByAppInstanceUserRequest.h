...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API ListChannelsModeratedByAppInstanceUserRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListChannelsModeratedByAppInstanceUserRequest> Clone() const
    {
      return Aws::MakeUnique<ListChannelsModeratedByAppInstanceUserRequest>(GetServiceRequestName(), *this);
    }
