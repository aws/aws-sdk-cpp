...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API DeleteChannelModeratorRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteChannelModeratorRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteChannelModeratorRequest>(GetServiceRequestName(), *this);
    }
