...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKMESSAGING_API ForbiddenException();
    AWS_CHIMESDKMESSAGING_API ForbiddenException(Aws::Utils::Json::JsonView jsonValue);
    AWS_CHIMESDKMESSAGING_API ForbiddenException& operator=(Aws::Utils::Json::JsonView jsonValue);
