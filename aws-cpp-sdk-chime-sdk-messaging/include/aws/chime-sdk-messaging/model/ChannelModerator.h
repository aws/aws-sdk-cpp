...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CHIMESDKMESSAGING_API ChannelModerator
  {
  public:
    ChannelModerator();
    ChannelModerator(Aws::Utils::Json::JsonView jsonValue);
    ChannelModerator& operator=(Aws::Utils::Json::JsonView jsonValue);
