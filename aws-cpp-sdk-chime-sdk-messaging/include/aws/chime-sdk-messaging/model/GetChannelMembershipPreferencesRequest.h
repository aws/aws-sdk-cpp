...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API GetChannelMembershipPreferencesRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetChannelMembershipPreferencesRequest> Clone() const
    {
      return Aws::MakeUnique<GetChannelMembershipPreferencesRequest>(GetServiceRequestName(), *this);
    }
