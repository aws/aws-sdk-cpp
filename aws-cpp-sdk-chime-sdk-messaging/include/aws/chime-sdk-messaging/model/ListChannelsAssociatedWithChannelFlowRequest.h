...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API ListChannelsAssociatedWithChannelFlowRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListChannelsAssociatedWithChannelFlowRequest> Clone() const
    {
      return Aws::MakeUnique<ListChannelsAssociatedWithChannelFlowRequest>(GetServiceRequestName(), *this);
    }
