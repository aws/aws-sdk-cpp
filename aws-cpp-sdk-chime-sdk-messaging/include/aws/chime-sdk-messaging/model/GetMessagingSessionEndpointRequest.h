...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMessagingSessionEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<GetMessagingSessionEndpointRequest>(GetServiceRequestName(), *this);
    }
