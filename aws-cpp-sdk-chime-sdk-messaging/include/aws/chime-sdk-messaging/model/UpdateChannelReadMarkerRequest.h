...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API UpdateChannelReadMarkerRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateChannelReadMarkerRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateChannelReadMarkerRequest>(GetServiceRequestName(), *this);
    }
