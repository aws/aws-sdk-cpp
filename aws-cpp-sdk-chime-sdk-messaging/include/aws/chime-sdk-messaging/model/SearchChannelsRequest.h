...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API SearchChannelsRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchChannelsRequest> Clone() const
    {
      return Aws::MakeUnique<SearchChannelsRequest>(GetServiceRequestName(), *this);
    }
