...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API DeleteChannelFlowRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteChannelFlowRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteChannelFlowRequest>(GetServiceRequestName(), *this);
    }
