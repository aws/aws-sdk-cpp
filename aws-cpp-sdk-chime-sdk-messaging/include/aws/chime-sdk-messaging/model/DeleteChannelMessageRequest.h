...
namespace Model
{
  ...
  /**
   */
  class AWS_CHIMESDKMESSAGING_API DeleteChannelMessageRequest : public ChimeSDKMessagingRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteChannelMessageRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteChannelMessageRequest>(GetServiceRequestName(), *this);
    }
