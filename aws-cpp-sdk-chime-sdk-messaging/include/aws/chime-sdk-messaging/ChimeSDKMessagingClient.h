...
namespace ChimeSDKMessaging
{
  ...
  class AWS_CHIMESDKMESSAGING_API ChimeSDKMessagingClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ChimeSDKMessagingClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                std::shared_ptr<Endpoint::ChimeSDKMessagingEndpointProvider> endpointProvider = Aws::MakeShared<ChimeSDKMessaging::Endpoint::ChimeSDKMessagingEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ChimeSDKMessagingEndpointProvider> m_endpointProvider;
  };
