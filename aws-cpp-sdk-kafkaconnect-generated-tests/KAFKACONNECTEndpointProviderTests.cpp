...
using KafkaConnectResolveEndpointOutcome = Aws::KafkaConnect::Endpoint::KafkaConnectEndpointProvider::KafkaConnectResolveEndpointOutcome;
...
void ValidateOutcome(const KafkaConnectResolveEndpointOutcome& outcome, const KafkaConnectEndpointProviderEndpointTestCase::Expect& expect)
{
