...
namespace Model
{
  ...
  /**
   */
  class GetWorkerRequest : public IoTRoboRunnerRequest
  {
  public:
    AWS_IOTROBORUNNER_API GetWorkerRequest();
    ...
    inline GetWorkerRequest& WithId(const Aws::String& value) { SetId(value); return *this;}

    
    inline GetWorkerRequest& WithId(Aws::String&& value) { SetId(std::move(value)); return *this;}

    
    inline GetWorkerRequest& WithId(const char* value) { SetId(value); return *this;}
