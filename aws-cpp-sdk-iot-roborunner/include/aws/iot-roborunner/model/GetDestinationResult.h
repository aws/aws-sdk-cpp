...
namespace Model
{
  ...
  {
  public:
    AWS_IOTROBORUNNER_API GetDestinationResult();
    AWS_IOTROBORUNNER_API GetDestinationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_IOTROBORUNNER_API GetDestinationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline GetDestinationResult& WithId(const Aws::String& value) { SetId(value); return *this;}

    
    inline GetDestinationResult& WithId(Aws::String&& value) { SetId(std::move(value)); return *this;}

    
    inline GetDestinationResult& WithId(const char* value) { SetId(value); return *this;}
    ...
    inline GetDestinationResult& WithSite(const Aws::String& value) { SetSite(value); return *this;}

    
    inline GetDestinationResult& WithSite(Aws::String&& value) { SetSite(std::move(value)); return *this;}

    
    inline GetDestinationResult& WithSite(const char* value) { SetSite(value); return *this;}
    ...
    inline GetDestinationResult& WithState(const DestinationState& value) { SetState(value); return *this;}

    
    inline GetDestinationResult& WithState(DestinationState&& value) { SetState(std::move(value)); return *this;}
    ...
    inline GetDestinationResult& WithAdditionalFixedProperties(const Aws::String& value) { SetAdditionalFixedProperties(value); return *this;}

    
    inline GetDestinationResult& WithAdditionalFixedProperties(Aws::String&& value) { SetAdditionalFixedProperties(std::move(value)); return *this;}

    
    inline GetDestinationResult& WithAdditionalFixedProperties(const char* value) { SetAdditionalFixedProperties(value); return *this;}
