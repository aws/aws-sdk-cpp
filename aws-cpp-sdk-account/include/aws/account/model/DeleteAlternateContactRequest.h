...
namespace Model
{
  ...
  /**
   */
  class AWS_ACCOUNT_API DeleteAlternateContactRequest : public AccountRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAlternateContactRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAlternateContactRequest>(GetServiceRequestName(), *this);
    }
