...
namespace Model
{
  ...
  /**
   */
  class AWS_ACCOUNT_API PutContactInformationRequest : public AccountRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutContactInformationRequest> Clone() const
    {
      return Aws::MakeUnique<PutContactInformationRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "PutContactInformation"; }
