...
namespace Model
{
  ...
  /**
   */
  class AWS_ACCOUNT_API GetAlternateContactRequest : public AccountRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAlternateContactRequest> Clone() const
    {
      return Aws::MakeUnique<GetAlternateContactRequest>(GetServiceRequestName(), *this);
    }
