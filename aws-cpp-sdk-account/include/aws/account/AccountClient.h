...
namespace Account
{
  ...
  class AWS_ACCOUNT_API AccountClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AccountClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                      std::shared_ptr<Endpoint::AccountEndpointProvider> endpointProvider = Aws::MakeShared<Account::Endpoint::AccountEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AccountEndpointProvider> m_endpointProvider;
  };
