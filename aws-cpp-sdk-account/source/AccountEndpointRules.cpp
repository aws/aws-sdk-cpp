...
Aws::String AccountEndpointRules::GetRulesAsString()
{
    return Aws::String(AccountEndpointRules::Rules.begin(), AccountEndpointRules::Rules.end());
}

const Aws::Vector<char> AccountEndpointRules::Rules = {
...
'a','c','c','o','u','n','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','a','m','a',
'z','o','n','a','w','s','.','c','o','m','"',',','"','p','r','o','p','e','r','t','i','e','s','"',':',
'{','"','a','u','t','h','S','c','h','e','m','e','s','"',':','[','{','"','n','a','m','e','"',':','"',
's','i','g','v','4','"',',','"','s','i','g','n','i','n','g','N','a','m','e','"',':','"','a','c','c',
'o','u','n','t','"',',','"','s','i','g','n','i','n','g','R','e','g','i','o','n','"',':','"','u','s',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','c','c','o','u','n','t','.','{','R',
...
't','t','p','s',':','/','/','a','c','c','o','u','n','t','.','u','s','-','e','a','s','t','-','1','.',
...
'h','t','t','p','s',':','/','/','a','c','c','o','u','n','t','-','f','i','p','s','.','{','R','e','g',
...
'y','p','e','"',':','"','t','r','e','e','"',',','"','r','u','l','e','s','"',':','[','{','"','c','o',
'n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n','t','"',':','{',
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','c','c','o','u','n','t','-','f','i',
