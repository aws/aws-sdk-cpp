...
using ResolveEndpointOutcome = Aws::Account::Endpoint::AccountEndpointProvider::AccountResolveEndpointOutcome;
...
AccountClient::AccountClient(const Client::ClientConfiguration& clientConfiguration,
                             std::shared_ptr<Endpoint::AccountEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<AccountErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Account::Endpoint::AccountEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
