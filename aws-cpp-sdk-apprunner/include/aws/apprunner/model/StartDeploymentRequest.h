...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API StartDeploymentRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartDeploymentRequest> Clone() const
    {
      return Aws::MakeUnique<StartDeploymentRequest>(GetServiceRequestName(), *this);
    }
