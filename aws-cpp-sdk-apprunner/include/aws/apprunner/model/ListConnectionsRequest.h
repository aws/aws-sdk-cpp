...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API ListConnectionsRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListConnectionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListConnectionsRequest>(GetServiceRequestName(), *this);
    }
