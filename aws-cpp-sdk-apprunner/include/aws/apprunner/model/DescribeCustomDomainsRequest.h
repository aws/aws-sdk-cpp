...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API DescribeCustomDomainsRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCustomDomainsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCustomDomainsRequest>(GetServiceRequestName(), *this);
    }
