...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API DeleteAutoScalingConfigurationRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAutoScalingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAutoScalingConfigurationRequest>(GetServiceRequestName(), *this);
    }
