...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPRUNNER_API SourceCodeVersion
  {
  public:
    SourceCodeVersion();
    SourceCodeVersion(Aws::Utils::Json::JsonView jsonValue);
    SourceCodeVersion& operator=(Aws::Utils::Json::JsonView jsonValue);
