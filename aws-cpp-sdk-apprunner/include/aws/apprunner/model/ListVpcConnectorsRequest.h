...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API ListVpcConnectorsRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListVpcConnectorsRequest> Clone() const
    {
      return Aws::MakeUnique<ListVpcConnectorsRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListVpcConnectors"; }
