...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAutoScalingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAutoScalingConfigurationRequest>(GetServiceRequestName(), *this);
    }
