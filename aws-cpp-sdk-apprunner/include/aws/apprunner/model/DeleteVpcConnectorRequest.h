...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API DeleteVpcConnectorRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVpcConnectorRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVpcConnectorRequest>(GetServiceRequestName(), *this);
    }
