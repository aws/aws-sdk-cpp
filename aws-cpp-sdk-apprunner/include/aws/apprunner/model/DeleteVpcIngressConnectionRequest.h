...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API DeleteVpcIngressConnectionRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVpcIngressConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVpcIngressConnectionRequest>(GetServiceRequestName(), *this);
    }
