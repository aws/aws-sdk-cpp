...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API UpdateVpcIngressConnectionRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateVpcIngressConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateVpcIngressConnectionRequest>(GetServiceRequestName(), *this);
    }
