...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListObservabilityConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListObservabilityConfigurationsRequest>(GetServiceRequestName(), *this);
    }
