...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPRUNNER_API VpcIngressConnection
  {
  public:
    VpcIngressConnection();
    VpcIngressConnection(Aws::Utils::Json::JsonView jsonValue);
    VpcIngressConnection& operator=(Aws::Utils::Json::JsonView jsonValue);
