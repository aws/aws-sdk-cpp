...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateObservabilityConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateObservabilityConfigurationRequest>(GetServiceRequestName(), *this);
    }
