...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API CreateVpcIngressConnectionRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateVpcIngressConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateVpcIngressConnectionRequest>(GetServiceRequestName(), *this);
    }
