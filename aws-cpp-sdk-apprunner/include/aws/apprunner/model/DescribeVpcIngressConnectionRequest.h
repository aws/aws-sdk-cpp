...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API DescribeVpcIngressConnectionRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVpcIngressConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVpcIngressConnectionRequest>(GetServiceRequestName(), *this);
    }
