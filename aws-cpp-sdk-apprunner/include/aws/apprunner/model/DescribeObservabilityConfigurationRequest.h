...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API DescribeObservabilityConfigurationRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeObservabilityConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeObservabilityConfigurationRequest>(GetServiceRequestName(), *this);
    }
