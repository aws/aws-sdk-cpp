...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAutoScalingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAutoScalingConfigurationRequest>(GetServiceRequestName(), *this);
    }
