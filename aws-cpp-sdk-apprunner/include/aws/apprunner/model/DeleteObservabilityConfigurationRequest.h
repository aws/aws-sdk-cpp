...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API DeleteObservabilityConfigurationRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteObservabilityConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteObservabilityConfigurationRequest>(GetServiceRequestName(), *this);
    }
