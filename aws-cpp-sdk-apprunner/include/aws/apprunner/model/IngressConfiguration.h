...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPRUNNER_API IngressConfiguration
  {
  public:
    IngressConfiguration();
    IngressConfiguration(Aws::Utils::Json::JsonView jsonValue);
    IngressConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
