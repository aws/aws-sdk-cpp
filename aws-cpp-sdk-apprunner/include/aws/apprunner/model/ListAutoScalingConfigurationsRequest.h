...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAutoScalingConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAutoScalingConfigurationsRequest>(GetServiceRequestName(), *this);
    }
