...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API ResumeServiceRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ResumeServiceRequest> Clone() const
    {
      return Aws::MakeUnique<ResumeServiceRequest>(GetServiceRequestName(), *this);
    }
