...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API DescribeVpcConnectorRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeVpcConnectorRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeVpcConnectorRequest>(GetServiceRequestName(), *this);
    }
