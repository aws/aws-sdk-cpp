...
namespace Model
{
  ...
  /**
   */
  class AWS_APPRUNNER_API AssociateCustomDomainRequest : public AppRunnerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateCustomDomainRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateCustomDomainRequest>(GetServiceRequestName(), *this);
    }
