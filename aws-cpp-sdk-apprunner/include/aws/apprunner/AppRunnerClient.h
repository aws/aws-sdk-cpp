...
namespace AppRunner
{
  ...
  class AWS_APPRUNNER_API AppRunnerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AppRunnerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::AppRunnerEndpointProvider> endpointProvider = Aws::MakeShared<AppRunner::Endpoint::AppRunnerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AppRunnerEndpointProvider> m_endpointProvider;
  };
