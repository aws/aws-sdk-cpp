...
namespace AppRunner
{
const size_t AppRunnerEndpointRules::RulesBlobStrLen = 3465;
const size_t AppRunnerEndpointRules::RulesBlobSize = 3466;

using RulesBlobT = Aws::Array<const char, AppRunnerEndpointRules::RulesBlobSize>;
...
'/','/','a','p','p','r','u','n','n','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}',
...
'e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/',
'/','a','p','p','r','u','n','n','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','r','u','n','n','e','r','.',
...
const char* AppRunnerEndpointRules::GetRulesBlob()
{
