...
Aws::String AppRunnerEndpointRules::GetRulesAsString()
{
    return Aws::String(AppRunnerEndpointRules::Rules.begin(), AppRunnerEndpointRules::Rules.end());
}

const Aws::Vector<char> AppRunnerEndpointRules::Rules = {
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','r','u','n',
'n','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'r','u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',',
'"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':',
'/','/','a','p','p','r','u','n','n','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
