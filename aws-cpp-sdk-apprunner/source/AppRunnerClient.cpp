...
using ResolveEndpointOutcome = Aws::AppRunner::Endpoint::AppRunnerEndpointProvider::AppRunnerResolveEndpointOutcome;
...
AppRunnerClient::AppRunnerClient(const Client::ClientConfiguration& clientConfiguration,
                                 std::shared_ptr<Endpoint::AppRunnerEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<AppRunnerErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<AppRunner::Endpoint::AppRunnerEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
