...
using CloudWatchEventsResolveEndpointOutcome = Aws::CloudWatchEvents::Endpoint::CloudWatchEventsEndpointProvider::CloudWatchEventsResolveEndpointOutcome;
...
void ValidateOutcome(const CloudWatchEventsResolveEndpointOutcome& outcome, const CloudWatchEventsEndpointProviderEndpointTestCase::Expect& expect)
{
