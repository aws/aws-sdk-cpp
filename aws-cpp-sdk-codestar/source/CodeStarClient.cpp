...
using ResolveEndpointOutcome = Aws::CodeStar::Endpoint::CodeStarEndpointProvider::CodeStarResolveEndpointOutcome;
...
CodeStarClient::CodeStarClient(const Client::ClientConfiguration& clientConfiguration,
                               std::shared_ptr<Endpoint::CodeStarEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CodeStarErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CodeStar::Endpoint::CodeStarEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
