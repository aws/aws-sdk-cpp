...
namespace CodeStar
{
const size_t CodeStarEndpointRules::RulesBlobStrLen = 3462;
const size_t CodeStarEndpointRules::RulesBlobSize = 3463;

using RulesBlobT = Aws::Array<const char, CodeStarEndpointRules::RulesBlobSize>;
...
'a','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'/','/','c','o','d','e','s','t','a','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
'c','o','d','e','s','t','a','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','c','o','d','e','s','t','a','r','.','{','R','e',
...
const char* CodeStarEndpointRules::GetRulesBlob()
{
