...
Aws::String CodeStarEndpointRules::GetRulesAsString()
{
    return Aws::String(CodeStarEndpointRules::Rules.begin(), CodeStarEndpointRules::Rules.end());
}

const Aws::Vector<char> CodeStarEndpointRules::Rules = {
