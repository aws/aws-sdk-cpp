...
namespace CodeStar
{
  ...
  class AWS_CODESTAR_API CodeStarClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CodeStarClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::CodeStarEndpointProvider> endpointProvider = Aws::MakeShared<CodeStar::Endpoint::CodeStarEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CodeStarEndpointProvider> m_endpointProvider;
  };
