...
Aws::String PrivateNetworksEndpointRules::GetRulesAsString()
{
    return Aws::String(PrivateNetworksEndpointRules::Rules.begin(), PrivateNetworksEndpointRules::Rules.end());
}

const Aws::Vector<char> PrivateNetworksEndpointRules::Rules = {
