...
using ResolveEndpointOutcome = Aws::PrivateNetworks::Endpoint::PrivateNetworksEndpointProvider::PrivateNetworksResolveEndpointOutcome;
...
PrivateNetworksClient::PrivateNetworksClient(const Client::ClientConfiguration& clientConfiguration,
                                             std::shared_ptr<Endpoint::PrivateNetworksEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<PrivateNetworksErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<PrivateNetworks::Endpoint::PrivateNetworksEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
