...
namespace Model
{
  ...
  /**
   */
  class AWS_PRIVATENETWORKS_API GetNetworkRequest : public PrivateNetworksRequest
  {
  public:
    GetNetworkRequest();
    ...
    */
    virtual Aws::UniquePtr<GetNetworkRequest> Clone() const
    {
      return Aws::MakeUnique<GetNetworkRequest>(GetServiceRequestName(), *this);
    }
