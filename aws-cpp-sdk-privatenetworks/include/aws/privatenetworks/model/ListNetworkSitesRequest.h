...
namespace Model
{
  ...
  /**
   */
  class AWS_PRIVATENETWORKS_API ListNetworkSitesRequest : public PrivateNetworksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListNetworkSitesRequest> Clone() const
    {
      return Aws::MakeUnique<ListNetworkSitesRequest>(GetServiceRequestName(), *this);
    }
