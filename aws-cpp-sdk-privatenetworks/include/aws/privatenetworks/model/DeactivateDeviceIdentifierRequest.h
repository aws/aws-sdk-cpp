...
namespace Model
{
  ...
  /**
   */
  class AWS_PRIVATENETWORKS_API DeactivateDeviceIdentifierRequest : public PrivateNetworksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeactivateDeviceIdentifierRequest> Clone() const
    {
      return Aws::MakeUnique<DeactivateDeviceIdentifierRequest>(GetServiceRequestName(), *this);
    }
