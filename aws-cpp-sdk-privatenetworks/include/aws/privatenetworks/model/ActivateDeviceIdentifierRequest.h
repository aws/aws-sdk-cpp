...
namespace Model
{
  ...
  /**
   */
  class AWS_PRIVATENETWORKS_API ActivateDeviceIdentifierRequest : public PrivateNetworksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ActivateDeviceIdentifierRequest> Clone() const
    {
      return Aws::MakeUnique<ActivateDeviceIdentifierRequest>(GetServiceRequestName(), *this);
    }
