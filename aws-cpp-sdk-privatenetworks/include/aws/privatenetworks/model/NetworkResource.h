...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PRIVATENETWORKS_API NetworkResource
  {
  public:
    NetworkResource();
    NetworkResource(Aws::Utils::Json::JsonView jsonValue);
    NetworkResource& operator=(Aws::Utils::Json::JsonView jsonValue);
