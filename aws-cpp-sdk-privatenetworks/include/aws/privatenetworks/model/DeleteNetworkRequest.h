...
namespace Model
{
  ...
  /**
   */
  class AWS_PRIVATENETWORKS_API DeleteNetworkRequest : public PrivateNetworksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteNetworkRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteNetworkRequest>(GetServiceRequestName(), *this);
    }
