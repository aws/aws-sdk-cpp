...
namespace Model
{
  ...
  /**
   */
  class AWS_PRIVATENETWORKS_API GetNetworkSiteRequest : public PrivateNetworksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetNetworkSiteRequest> Clone() const
    {
      return Aws::MakeUnique<GetNetworkSiteRequest>(GetServiceRequestName(), *this);
    }
