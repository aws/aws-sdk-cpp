...
namespace Model
{
  ...
  /**
   */
  class AWS_PRIVATENETWORKS_API UpdateNetworkSitePlanRequest : public PrivateNetworksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateNetworkSitePlanRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateNetworkSitePlanRequest>(GetServiceRequestName(), *this);
    }
