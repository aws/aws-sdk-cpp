...
namespace Model
{
  ...
  /**
   */
  class AWS_PRIVATENETWORKS_API AcknowledgeOrderReceiptRequest : public PrivateNetworksRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AcknowledgeOrderReceiptRequest> Clone() const
    {
      return Aws::MakeUnique<AcknowledgeOrderReceiptRequest>(GetServiceRequestName(), *this);
    }
