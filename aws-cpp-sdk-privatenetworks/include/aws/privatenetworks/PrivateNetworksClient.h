...
namespace PrivateNetworks
{
  ...
  class AWS_PRIVATENETWORKS_API PrivateNetworksClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        PrivateNetworksClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                              std::shared_ptr<Endpoint::PrivateNetworksEndpointProvider> endpointProvider = Aws::MakeShared<PrivateNetworks::Endpoint::PrivateNetworksEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::PrivateNetworksEndpointProvider> m_endpointProvider;
  };
