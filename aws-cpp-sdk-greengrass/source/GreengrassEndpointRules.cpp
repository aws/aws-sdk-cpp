...
Aws::String GreengrassEndpointRules::GetRulesAsString()
{
    return Aws::String(GreengrassEndpointRules::Rules.begin(), GreengrassEndpointRules::Rules.end());
}

const Aws::Vector<char> GreengrassEndpointRules::Rules = {
