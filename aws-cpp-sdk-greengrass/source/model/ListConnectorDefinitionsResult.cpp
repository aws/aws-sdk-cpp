...
ListConnectorDefinitionsResult::ListConnectorDefinitionsResult()
{
}

ListConnectorDefinitionsResult::ListConnectorDefinitionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListConnectorDefinitionsResult& ListConnectorDefinitionsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
