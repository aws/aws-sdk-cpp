...
ListResourceDefinitionsResult::ListResourceDefinitionsResult()
{
}

ListResourceDefinitionsResult::ListResourceDefinitionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListResourceDefinitionsResult& ListResourceDefinitionsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
