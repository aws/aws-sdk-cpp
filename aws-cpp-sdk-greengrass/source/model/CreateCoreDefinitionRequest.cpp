...
Aws::String CreateCoreDefinitionRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection CreateCoreDefinitionRequest::GetRequestSpecificHeaders() const
{
