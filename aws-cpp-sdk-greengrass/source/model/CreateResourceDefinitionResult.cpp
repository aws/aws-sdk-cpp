...
CreateResourceDefinitionResult::CreateResourceDefinitionResult()
{
}

CreateResourceDefinitionResult::CreateResourceDefinitionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateResourceDefinitionResult& CreateResourceDefinitionResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
