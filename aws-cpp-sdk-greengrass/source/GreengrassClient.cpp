...
using ResolveEndpointOutcome = Aws::Greengrass::Endpoint::GreengrassEndpointProvider::GreengrassResolveEndpointOutcome;
...
GreengrassClient::GreengrassClient(const Client::ClientConfiguration& clientConfiguration,
                                   std::shared_ptr<Endpoint::GreengrassEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<GreengrassErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Greengrass::Endpoint::GreengrassEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
