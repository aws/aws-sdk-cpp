...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLoggerDefinitionVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLoggerDefinitionVersionRequest>(GetServiceRequestName(), *this);
    }
