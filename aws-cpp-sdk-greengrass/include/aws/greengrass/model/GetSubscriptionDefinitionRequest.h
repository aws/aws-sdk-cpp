...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASS_API GetSubscriptionDefinitionRequest : public GreengrassRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSubscriptionDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<GetSubscriptionDefinitionRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetSubscriptionDefinition"; }
