...
namespace Model
{
  ...
  public:
    ...
    GetDeviceDefinitionResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetDeviceDefinitionResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
