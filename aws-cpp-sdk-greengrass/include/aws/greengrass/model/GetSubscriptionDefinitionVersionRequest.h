...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSubscriptionDefinitionVersionRequest> Clone() const
    {
      return Aws::MakeUnique<GetSubscriptionDefinitionVersionRequest>(GetServiceRequestName(), *this);
    }
