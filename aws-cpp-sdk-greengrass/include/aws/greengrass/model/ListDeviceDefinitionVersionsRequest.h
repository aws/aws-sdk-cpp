...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDeviceDefinitionVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDeviceDefinitionVersionsRequest>(GetServiceRequestName(), *this);
    }
