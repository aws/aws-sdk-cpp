...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBulkDeploymentDetailedReportsRequest> Clone() const
    {
      return Aws::MakeUnique<ListBulkDeploymentDetailedReportsRequest>(GetServiceRequestName(), *this);
    }
