...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLoggerDefinitionVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListLoggerDefinitionVersionsRequest>(GetServiceRequestName(), *this);
    }
