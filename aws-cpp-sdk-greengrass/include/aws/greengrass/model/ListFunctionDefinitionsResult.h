...
namespace Model
{
  ...
  public:
    ...
    ListFunctionDefinitionsResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListFunctionDefinitionsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
