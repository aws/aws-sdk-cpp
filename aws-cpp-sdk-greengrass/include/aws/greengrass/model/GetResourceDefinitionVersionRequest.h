...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetResourceDefinitionVersionRequest> Clone() const
    {
      return Aws::MakeUnique<GetResourceDefinitionVersionRequest>(GetServiceRequestName(), *this);
    }
