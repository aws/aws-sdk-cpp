...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFunctionDefinitionVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFunctionDefinitionVersionsRequest>(GetServiceRequestName(), *this);
    }
