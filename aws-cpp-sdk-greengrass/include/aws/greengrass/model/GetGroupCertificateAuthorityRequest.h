...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetGroupCertificateAuthorityRequest> Clone() const
    {
      return Aws::MakeUnique<GetGroupCertificateAuthorityRequest>(GetServiceRequestName(), *this);
    }
