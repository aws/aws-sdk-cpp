...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSubscriptionDefinitionVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSubscriptionDefinitionVersionsRequest>(GetServiceRequestName(), *this);
    }
