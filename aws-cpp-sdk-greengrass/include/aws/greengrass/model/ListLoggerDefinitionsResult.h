...
namespace Model
{
  ...
  public:
    ...
    ListLoggerDefinitionsResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListLoggerDefinitionsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
