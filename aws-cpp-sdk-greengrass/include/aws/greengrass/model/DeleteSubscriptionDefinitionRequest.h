...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSubscriptionDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSubscriptionDefinitionRequest>(GetServiceRequestName(), *this);
    }
