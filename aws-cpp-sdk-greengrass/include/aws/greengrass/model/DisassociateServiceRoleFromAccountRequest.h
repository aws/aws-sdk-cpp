...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateServiceRoleFromAccountRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateServiceRoleFromAccountRequest>(GetServiceRequestName(), *this);
    }
