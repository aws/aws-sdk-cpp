...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateGroupCertificateConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateGroupCertificateConfigurationRequest>(GetServiceRequestName(), *this);
    }
