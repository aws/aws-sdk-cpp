...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASS_API ListFunctionDefinitionsRequest : public GreengrassRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFunctionDefinitionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFunctionDefinitionsRequest>(GetServiceRequestName(), *this);
    }
