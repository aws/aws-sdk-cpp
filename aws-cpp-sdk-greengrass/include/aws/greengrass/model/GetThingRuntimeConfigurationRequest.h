...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetThingRuntimeConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetThingRuntimeConfigurationRequest>(GetServiceRequestName(), *this);
    }
