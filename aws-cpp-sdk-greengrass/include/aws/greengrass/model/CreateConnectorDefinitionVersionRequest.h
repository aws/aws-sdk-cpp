...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateConnectorDefinitionVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateConnectorDefinitionVersionRequest>(GetServiceRequestName(), *this);
    }
