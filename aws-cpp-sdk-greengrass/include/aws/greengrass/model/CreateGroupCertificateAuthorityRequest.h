...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateGroupCertificateAuthorityRequest> Clone() const
    {
      return Aws::MakeUnique<CreateGroupCertificateAuthorityRequest>(GetServiceRequestName(), *this);
    }
