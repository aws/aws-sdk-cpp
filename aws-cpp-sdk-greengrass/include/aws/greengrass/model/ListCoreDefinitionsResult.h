...
namespace Model
{
  ...
  public:
    ...
    ListCoreDefinitionsResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListCoreDefinitionsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
