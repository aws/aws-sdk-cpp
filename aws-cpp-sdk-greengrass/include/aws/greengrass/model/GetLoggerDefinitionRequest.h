...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASS_API GetLoggerDefinitionRequest : public GreengrassRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetLoggerDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<GetLoggerDefinitionRequest>(GetServiceRequestName(), *this);
    }
