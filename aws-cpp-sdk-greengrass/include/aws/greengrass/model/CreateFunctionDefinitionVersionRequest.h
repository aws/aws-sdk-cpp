...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateFunctionDefinitionVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFunctionDefinitionVersionRequest>(GetServiceRequestName(), *this);
    }
