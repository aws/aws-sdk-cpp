...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSubscriptionDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSubscriptionDefinitionRequest>(GetServiceRequestName(), *this);
    }
