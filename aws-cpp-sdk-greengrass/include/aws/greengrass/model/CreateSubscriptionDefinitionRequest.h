...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSubscriptionDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSubscriptionDefinitionRequest>(GetServiceRequestName(), *this);
    }
