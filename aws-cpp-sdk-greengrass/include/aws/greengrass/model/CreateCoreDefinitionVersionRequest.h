...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCoreDefinitionVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCoreDefinitionVersionRequest>(GetServiceRequestName(), *this);
    }
