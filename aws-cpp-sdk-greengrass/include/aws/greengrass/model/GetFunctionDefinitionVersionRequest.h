...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetFunctionDefinitionVersionRequest> Clone() const
    {
      return Aws::MakeUnique<GetFunctionDefinitionVersionRequest>(GetServiceRequestName(), *this);
    }
