...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateResourceDefinitionVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateResourceDefinitionVersionRequest>(GetServiceRequestName(), *this);
    }
