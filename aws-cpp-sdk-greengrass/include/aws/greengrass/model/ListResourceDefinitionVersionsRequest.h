...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResourceDefinitionVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListResourceDefinitionVersionsRequest>(GetServiceRequestName(), *this);
    }
