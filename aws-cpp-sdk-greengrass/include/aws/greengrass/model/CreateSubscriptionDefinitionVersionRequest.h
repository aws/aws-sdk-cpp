...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSubscriptionDefinitionVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSubscriptionDefinitionVersionRequest>(GetServiceRequestName(), *this);
    }
