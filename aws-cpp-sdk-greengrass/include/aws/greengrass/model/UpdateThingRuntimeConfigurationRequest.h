...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASS_API UpdateThingRuntimeConfigurationRequest : public GreengrassRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateThingRuntimeConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateThingRuntimeConfigurationRequest>(GetServiceRequestName(), *this);
    }
