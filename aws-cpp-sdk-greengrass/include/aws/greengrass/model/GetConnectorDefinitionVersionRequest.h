...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetConnectorDefinitionVersionRequest> Clone() const
    {
      return Aws::MakeUnique<GetConnectorDefinitionVersionRequest>(GetServiceRequestName(), *this);
    }
