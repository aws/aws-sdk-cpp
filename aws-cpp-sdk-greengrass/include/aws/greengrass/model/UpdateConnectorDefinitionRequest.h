...
namespace Model
{
  ...
  /**
   */
  class AWS_GREENGRASS_API UpdateConnectorDefinitionRequest : public GreengrassRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateConnectorDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateConnectorDefinitionRequest>(GetServiceRequestName(), *this);
    }
