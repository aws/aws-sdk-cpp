...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDeviceDefinitionVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDeviceDefinitionVersionRequest>(GetServiceRequestName(), *this);
    }
