...
namespace Model
{
  ...
  public:
    ...
    GetAssociatedRoleResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetAssociatedRoleResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
