...
namespace Greengrass
{
  ...
  class AWS_GREENGRASS_API GreengrassClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        GreengrassClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::GreengrassEndpointProvider> endpointProvider = Aws::MakeShared<Greengrass::Endpoint::GreengrassEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::GreengrassEndpointProvider> m_endpointProvider;
  };
