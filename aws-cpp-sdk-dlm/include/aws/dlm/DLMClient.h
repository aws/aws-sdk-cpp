...
namespace DLM
{
  ...
  class AWS_DLM_API DLMClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DLMClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::DLMEndpointProvider> endpointProvider = Aws::MakeShared<DLM::Endpoint::DLMEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DLMEndpointProvider> m_endpointProvider;
  };
