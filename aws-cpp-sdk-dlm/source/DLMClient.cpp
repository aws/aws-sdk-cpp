...
using ResolveEndpointOutcome = Aws::DLM::Endpoint::DLMEndpointProvider::DLMResolveEndpointOutcome;
...
DLMClient::DLMClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::DLMEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<DLMErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<DLM::Endpoint::DLMEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
