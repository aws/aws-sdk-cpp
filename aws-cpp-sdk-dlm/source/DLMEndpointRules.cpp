...
Aws::String DLMEndpointRules::GetRulesAsString()
{
    return Aws::String(DLMEndpointRules::Rules.begin(), DLMEndpointRules::Rules.end());
}

const Aws::Vector<char> DLMEndpointRules::Rules = {
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','l','m','.','{','R','e','g','i','o',
