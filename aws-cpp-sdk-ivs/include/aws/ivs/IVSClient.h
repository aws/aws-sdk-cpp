...
namespace IVS
{
  ...
  class AWS_IVS_API IVSClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IVSClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::IVSEndpointProvider> endpointProvider = Aws::MakeShared<IVS::Endpoint::IVSEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IVSEndpointProvider> m_endpointProvider;
  };
