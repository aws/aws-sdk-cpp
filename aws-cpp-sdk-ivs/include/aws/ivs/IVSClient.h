...
namespace Model
{
   ...
   * Document History</a>.</p> <pre><code> &lt;p&gt; &lt;b&gt;Allowed Header
   * Values&lt;/b&gt; &lt;/p&gt; &lt;ul&gt; &lt;li&gt; &lt;p&gt; &lt;code&gt;
   * &lt;b&gt;Accept:&lt;/b&gt; &lt;/code&gt; application/json&lt;/p&gt; &lt;/li&gt;
   * &lt;li&gt; &lt;p&gt; &lt;code&gt; &lt;b&gt;Accept-Encoding:&lt;/b&gt;
   * &lt;/code&gt; gzip, deflate&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;
   * &lt;code&gt; &lt;b&gt;Content-Type:&lt;/b&gt;
   * &lt;/code&gt;application/json&lt;/p&gt; &lt;/li&gt; &lt;/ul&gt; &lt;p&gt;
   * &lt;b&gt;Resources&lt;/b&gt; &lt;/p&gt; &lt;p&gt;The following resources contain
   * information about your IVS live stream (see &lt;a
   * href=&quot;https://docs.aws.amazon.com/ivs/latest/userguide/getting-started.html&quot;&gt;
   * Getting Started with Amazon IVS&lt;/a&gt;):&lt;/p&gt; &lt;ul&gt; &lt;li&gt;
   * &lt;p&gt;Channel — Stores configuration data related to your live stream. You
   * first create a channel and then use the channel’s stream key to start your live
   * stream. See the Channel endpoints for more information. &lt;/p&gt; &lt;/li&gt;
   * &lt;li&gt; &lt;p&gt;Stream key — An identifier assigned by Amazon IVS when you
   * create a channel, which is then used to authorize streaming. See the StreamKey
   * endpoints for more information. &lt;i&gt; &lt;b&gt;Treat the stream key like a
   * secret, since it allows anyone to stream to the channel.&lt;/b&gt; &lt;/i&gt;
   * &lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;Playback key pair — Video playback
   ...
   * for more information.&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;Recording
   * configuration — Stores configuration related to recording a live stream and
   * where to store the recorded content. Multiple channels can reference the same
   * recording configuration. See the Recording Configuration endpoints for more
   * information.&lt;/p&gt; &lt;/li&gt; &lt;/ul&gt; &lt;p&gt;
   * &lt;b&gt;Tagging&lt;/b&gt; &lt;/p&gt; &lt;p&gt;A &lt;i&gt;tag&lt;/i&gt; is a
   * metadata label that you assign to an Amazon Web Services resource. A tag
   * comprises a &lt;i&gt;key&lt;/i&gt; and a &lt;i&gt;value&lt;/i&gt;, both set by
   * you. For example, you might set a tag as &lt;code&gt;topic:nature&lt;/code&gt;
   * to label a particular video category. See &lt;a
   * href=&quot;https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html&quot;&gt;Tagging
   * Amazon Web Services Resources&lt;/a&gt; for more information, including
   * restrictions that apply to tags.&lt;/p&gt; &lt;p&gt;Tags can help you identify
   * and organize your Amazon Web Services resources. For example, you can use the
   ...
   * Access Tags&lt;/a&gt;). &lt;/p&gt; &lt;p&gt;The Amazon IVS API has these
   * tag-related endpoints: &lt;a&gt;TagResource&lt;/a&gt;,
   * &lt;a&gt;UntagResource&lt;/a&gt;, and &lt;a&gt;ListTagsForResource&lt;/a&gt;.
   * The following resources support tagging: Channels, Stream Keys, Playback Key
   * Pairs, and Recording Configurations.&lt;/p&gt; &lt;p&gt;At most 50 tags can be
   * applied to a resource. &lt;/p&gt; &lt;p&gt; &lt;b&gt;Authentication versus
   * Authorization&lt;/b&gt; &lt;/p&gt; &lt;p&gt;Note the differences between these
   * concepts:&lt;/p&gt; &lt;ul&gt; &lt;li&gt; &lt;p&gt;
   * &lt;i&gt;Authentication&lt;/i&gt; is about verifying identity. You need to be
   * authenticated to sign Amazon IVS API requests.&lt;/p&gt; &lt;/li&gt; &lt;li&gt;
   * &lt;p&gt; &lt;i&gt;Authorization&lt;/i&gt; is about granting permissions. You
   * need to be authorized to view &lt;a
   ...
   * for &quot;playback authorization.&quot;)&lt;/p&gt; &lt;/li&gt; &lt;/ul&gt;
   * &lt;p&gt; &lt;b&gt;Authentication&lt;/b&gt; &lt;/p&gt; &lt;p&gt;All Amazon IVS
   * API requests must be authenticated with a signature. The Amazon Web Services
   ...
   * API directly, it’s your responsibility to sign the requests.&lt;/p&gt;
   * &lt;p&gt;You generate a signature using valid Amazon Web Services credentials
   * that have permission to perform the requested action. For example, you must sign
   * PutMetadata requests with a signature generated from an IAM user account that
   * has the &lt;code&gt;ivs:PutMetadata&lt;/code&gt; permission.&lt;/p&gt;
   ...
   * &lt;b&gt;Channel Endpoints&lt;/b&gt; &lt;/p&gt; &lt;ul&gt; &lt;li&gt; &lt;p&gt;
   * &lt;a&gt;CreateChannel&lt;/a&gt; — Creates a new channel and an associated
   * stream key to start streaming.&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;
   * &lt;a&gt;GetChannel&lt;/a&gt; — Gets the channel configuration for the specified
   * channel ARN (Amazon Resource Name).&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;
   * &lt;a&gt;BatchGetChannel&lt;/a&gt; — Performs &lt;a&gt;GetChannel&lt;/a&gt; on
   * multiple ARNs simultaneously.&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;
   ...
   * stream for the changes to take effect.&lt;/p&gt; &lt;/li&gt; &lt;li&gt;
   * &lt;p&gt; &lt;a&gt;DeleteChannel&lt;/a&gt; — Deletes the specified
   * channel.&lt;/p&gt; &lt;/li&gt; &lt;/ul&gt; &lt;p&gt; &lt;b&gt;StreamKey
   * Endpoints&lt;/b&gt; &lt;/p&gt; &lt;ul&gt; &lt;li&gt; &lt;p&gt;
   * &lt;a&gt;CreateStreamKey&lt;/a&gt; — Creates a stream key, used to initiate a
   * stream, for the specified channel ARN.&lt;/p&gt; &lt;/li&gt; &lt;li&gt;
   * &lt;p&gt; &lt;a&gt;GetStreamKey&lt;/a&gt; — Gets stream key information for the
   * specified ARN.&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;
   * &lt;a&gt;BatchGetStreamKey&lt;/a&gt; — Performs &lt;a&gt;GetStreamKey&lt;/a&gt;
   * on multiple ARNs simultaneously.&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;
   * &lt;a&gt;ListStreamKeys&lt;/a&gt; — Gets summary information about stream keys
   * for the specified channel.&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;
   * &lt;a&gt;DeleteStreamKey&lt;/a&gt; — Deletes the stream key for the specified
   * ARN, so it can no longer be used to stream.&lt;/p&gt; &lt;/li&gt; &lt;/ul&gt;
   * &lt;p&gt; &lt;b&gt;Stream Endpoints&lt;/b&gt; &lt;/p&gt; &lt;ul&gt; &lt;li&gt;
   * &lt;p&gt; &lt;a&gt;GetStream&lt;/a&gt; — Gets information about the active
   * (live) stream on a specified channel.&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;
   ...
   * requests per second per account are allowed.&lt;/p&gt; &lt;/li&gt; &lt;/ul&gt;
   * &lt;p&gt; &lt;b&gt;PlaybackKeyPair Endpoints&lt;/b&gt; &lt;/p&gt; &lt;p&gt;For
   ...
   * key pair and returns its &lt;code&gt;arn&lt;/code&gt; and
   * &lt;code&gt;fingerprint&lt;/code&gt;. The &lt;code&gt;privateKey&lt;/code&gt;
   ...
   * authorization).&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;
   * &lt;a&gt;GetPlaybackKeyPair&lt;/a&gt; — Gets a specified playback authorization
   * key pair and returns the &lt;code&gt;arn&lt;/code&gt; and
   * &lt;code&gt;fingerprint&lt;/code&gt;. The &lt;code&gt;privateKey&lt;/code&gt;
   * held by the caller can be used to generate viewer authorization tokens, to grant
   * viewers access to private channels.&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;
   * &lt;a&gt;ListPlaybackKeyPairs&lt;/a&gt; — Gets summary information about
   * playback key pairs.&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;
   * &lt;a&gt;DeletePlaybackKeyPair&lt;/a&gt; — Deletes a specified authorization key
   * pair. This invalidates future viewer tokens generated using the key pair’s
   * &lt;code&gt;privateKey&lt;/code&gt;.&lt;/p&gt; &lt;/li&gt; &lt;/ul&gt; &lt;p&gt;
   * &lt;b&gt;RecordingConfiguration Endpoints&lt;/b&gt; &lt;/p&gt; &lt;ul&gt;
   * &lt;li&gt; &lt;p&gt; &lt;a&gt;CreateRecordingConfiguration&lt;/a&gt; — Creates a
   * new recording configuration, used to enable recording to Amazon S3.&lt;/p&gt;
   * &lt;/li&gt; &lt;li&gt; &lt;p&gt; &lt;a&gt;GetRecordingConfiguration&lt;/a&gt; —
   * Gets the recording-configuration metadata for the specified ARN.&lt;/p&gt;
   * &lt;/li&gt; &lt;li&gt; &lt;p&gt; &lt;a&gt;ListRecordingConfigurations&lt;/a&gt;
   * — Gets summary information about all recording configurations in your account,
   * in the Amazon Web Services region where the API request is processed.&lt;/p&gt;
   * &lt;/li&gt; &lt;li&gt; &lt;p&gt; &lt;a&gt;DeleteRecordingConfiguration&lt;/a&gt;
   * — Deletes the recording configuration for the specified ARN.&lt;/p&gt;
   * &lt;/li&gt; &lt;/ul&gt; &lt;p&gt; &lt;b&gt;Amazon Web Services Tags
   * Endpoints&lt;/b&gt; &lt;/p&gt; &lt;ul&gt; &lt;li&gt; &lt;p&gt;
   * &lt;a&gt;TagResource&lt;/a&gt; — Adds or updates tags for the Amazon Web
   * Services resource with the specified ARN.&lt;/p&gt; &lt;/li&gt; &lt;li&gt;
   * &lt;p&gt; &lt;a&gt;UntagResource&lt;/a&gt; — Removes tags from the resource with
   * the specified ARN.&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;
   * &lt;a&gt;ListTagsForResource&lt;/a&gt; — Gets information about Amazon Web
   * Services tags for the specified ARN.&lt;/p&gt; &lt;/li&gt; &lt;/ul&gt;
   * </code></pre>
   */
