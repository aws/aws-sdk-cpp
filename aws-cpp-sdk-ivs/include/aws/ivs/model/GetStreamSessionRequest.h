...
namespace Model
{
  ...
  /**
   */
  class AWS_IVS_API GetStreamSessionRequest : public IVSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetStreamSessionRequest> Clone() const
    {
      return Aws::MakeUnique<GetStreamSessionRequest>(GetServiceRequestName(), *this);
    }
