...
namespace Model
{
  ...
  /**
   */
  class AWS_IVS_API ListStreamSessionsRequest : public IVSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListStreamSessionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListStreamSessionsRequest>(GetServiceRequestName(), *this);
    }
