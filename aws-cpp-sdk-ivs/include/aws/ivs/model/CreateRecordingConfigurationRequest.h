...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateRecordingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateRecordingConfigurationRequest>(GetServiceRequestName(), *this);
    }
