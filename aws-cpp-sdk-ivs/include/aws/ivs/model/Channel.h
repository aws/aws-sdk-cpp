...
namespace Model
{
  ...
  public:
     ...
     * STANDARD: The stream is transcoded; resolution (width, in landscape orientation)
     * can be up to 1080p or the input source resolution, whichever is lower; and
     * bitrate can be up to 8.5 Mbps. BASIC: The stream is transfixed; resolution can
     * be up to 480p; and bitrate can be up to 1.5 Mbps. Default STANDARD.</p>
     */
