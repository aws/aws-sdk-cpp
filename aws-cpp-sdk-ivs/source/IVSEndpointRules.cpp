...
Aws::String IVSEndpointRules::GetRulesAsString()
{
    return Aws::String(IVSEndpointRules::Rules.begin(), IVSEndpointRules::Rules.end());
}

const Aws::Vector<char> IVSEndpointRules::Rules = {
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','i','v','s','.','{','R','e','g','i','o',
