...
using ResolveEndpointOutcome = Aws::IVS::Endpoint::IVSEndpointProvider::IVSResolveEndpointOutcome;
...
IVSClient::IVSClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::IVSEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<IVSErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<IVS::Endpoint::IVSEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
