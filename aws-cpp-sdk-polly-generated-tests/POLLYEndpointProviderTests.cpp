...
using PollyResolveEndpointOutcome = Aws::Polly::Endpoint::PollyEndpointProvider::PollyResolveEndpointOutcome;
...
void ValidateOutcome(const PollyResolveEndpointOutcome& outcome, const PollyEndpointProviderEndpointTestCase::Expect& expect)
{
