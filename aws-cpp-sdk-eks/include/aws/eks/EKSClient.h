...
namespace Model
{
   ...
   * containerized applications. </p> <p>Amazon EKS runs three Kubernetes control
   * plane instances across three Availability Zones to ensure high availability.
   * Amazon EKS automatically detects and replaces unhealthy control plane instances,
   * and it provides automated version upgrades and patching for them.</p> <p>Amazon
   * EKS is also integrated with many AWS services to provide scalability and
   * security for your applications, including the following: </p> <ul> <li>
   * <p>Elastic Load Balancing for load distribution</p> </li> <li> <p>IAM for
   * authentication</p> </li> <li> <p>Amazon VPC for isolation</p> </li> </ul>
   * <p>Amazon EKS runs up to date versions of the open-source Kubernetes software,
   ...
   * applications running on any standard Kubernetes environment, whether running in
