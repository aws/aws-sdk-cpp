...
namespace EKS
{
  ...
  class AWS_EKS_API EKSClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        EKSClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::EKSEndpointProvider> endpointProvider = Aws::MakeShared<EKS::Endpoint::EKSEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::EKSEndpointProvider> m_endpointProvider;
  };
