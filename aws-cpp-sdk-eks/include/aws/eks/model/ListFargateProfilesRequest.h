...
namespace Model
{
  ...
  /**
   */
  class AWS_EKS_API ListFargateProfilesRequest : public EKSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFargateProfilesRequest> Clone() const
    {
      return Aws::MakeUnique<ListFargateProfilesRequest>(GetServiceRequestName(), *this);
    }
