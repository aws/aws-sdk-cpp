...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateNodegroupVersionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateNodegroupVersionRequest>(GetServiceRequestName(), *this);
    }
     ...
     * Guide</i>. If you specify <code>launchTemplate</code>, and your launch template
     * uses a custom AMI, then don't specify <code>releaseVersion</code>, or the node
