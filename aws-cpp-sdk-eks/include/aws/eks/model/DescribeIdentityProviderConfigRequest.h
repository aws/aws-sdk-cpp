...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeIdentityProviderConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeIdentityProviderConfigRequest>(GetServiceRequestName(), *this);
    }
