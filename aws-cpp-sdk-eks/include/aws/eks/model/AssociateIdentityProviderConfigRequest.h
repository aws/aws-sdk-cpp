...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateIdentityProviderConfigRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateIdentityProviderConfigRequest>(GetServiceRequestName(), *this);
    }
