...
namespace Model
{
  ...
  /**
   */
  class AWS_EKS_API DeleteFargateProfileRequest : public EKSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFargateProfileRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFargateProfileRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteFargateProfile"; }

    Aws::String SerializePayload() const override;


    /**
     * <p>The name of the Amazon EKS cluster associated with the Fargate profile to
     * delete.</p>
     */
