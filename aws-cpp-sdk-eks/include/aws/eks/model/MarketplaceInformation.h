...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EKS_API MarketplaceInformation
  {
  public:
    MarketplaceInformation();
    MarketplaceInformation(Aws::Utils::Json::JsonView jsonValue);
    MarketplaceInformation& operator=(Aws::Utils::Json::JsonView jsonValue);
