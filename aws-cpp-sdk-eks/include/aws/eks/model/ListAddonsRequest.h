...
namespace Model
{
  ...
  /**
   */
  class AWS_EKS_API ListAddonsRequest : public EKSRequest
  {
  public:
    ListAddonsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListAddonsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAddonsRequest>(GetServiceRequestName(), *this);
    }
