...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EKS_API IdentityProviderConfig
  {
  public:
    IdentityProviderConfig();
    IdentityProviderConfig(Aws::Utils::Json::JsonView jsonValue);
    IdentityProviderConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
