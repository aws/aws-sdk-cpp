...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateIdentityProviderConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateIdentityProviderConfigRequest>(GetServiceRequestName(), *this);
    }
