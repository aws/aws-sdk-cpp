...
namespace Model
{
  ...
  /**
   */
  class AWS_EKS_API AssociateEncryptionConfigRequest : public EKSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateEncryptionConfigRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateEncryptionConfigRequest>(GetServiceRequestName(), *this);
    }
