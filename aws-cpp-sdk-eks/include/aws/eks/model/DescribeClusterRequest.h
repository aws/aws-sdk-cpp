...
namespace Model
{
  ...
  /**
   */
  class AWS_EKS_API DescribeClusterRequest : public EKSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeClusterRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeClusterRequest>(GetServiceRequestName(), *this);
    }
