...
namespace Model
{
  ...
  /**
   */
  class AWS_EKS_API ListIdentityProviderConfigsRequest : public EKSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListIdentityProviderConfigsRequest> Clone() const
    {
      return Aws::MakeUnique<ListIdentityProviderConfigsRequest>(GetServiceRequestName(), *this);
    }
