...
Aws::String EKSEndpointRules::GetRulesAsString()
{
    return Aws::String(EKSEndpointRules::Rules.begin(), EKSEndpointRules::Rules.end());
}

const Aws::Vector<char> EKSEndpointRules::Rules = {
