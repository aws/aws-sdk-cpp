...
using ResolveEndpointOutcome = Aws::EKS::Endpoint::EKSEndpointProvider::EKSResolveEndpointOutcome;
...
EKSClient::EKSClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::EKSEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<EKSErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<EKS::Endpoint::EKSEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
