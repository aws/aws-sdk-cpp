...
Aws::String LicenseManagerLinuxSubscriptionsEndpointRules::GetRulesAsString()
{
    return Aws::String(LicenseManagerLinuxSubscriptionsEndpointRules::Rules.begin(), LicenseManagerLinuxSubscriptionsEndpointRules::Rules.end());
}

const Aws::Vector<char> LicenseManagerLinuxSubscriptionsEndpointRules::Rules = {
