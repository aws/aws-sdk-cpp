...
DescribeJobsResult::DescribeJobsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeJobsResult& DescribeJobsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
