...
DescribeJobQueuesResult::DescribeJobQueuesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeJobQueuesResult& DescribeJobQueuesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
