...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_BATCH_API DescribeSchedulingPoliciesRequest : public BatchRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSchedulingPoliciesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSchedulingPoliciesRequest>(GetServiceRequestName(), *this);
    }
