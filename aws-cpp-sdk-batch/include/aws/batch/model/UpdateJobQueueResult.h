...
namespace Model
{
  ...
  public:
    ...
    UpdateJobQueueResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateJobQueueResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
