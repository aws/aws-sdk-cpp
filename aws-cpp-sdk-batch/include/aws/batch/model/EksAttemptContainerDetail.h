...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_BATCH_API EksAttemptContainerDetail
  {
  public:
    EksAttemptContainerDetail();
    EksAttemptContainerDetail(Aws::Utils::Json::JsonView jsonValue);
    EksAttemptContainerDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
