...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeComputeEnvironmentsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeComputeEnvironmentsRequest>(GetServiceRequestName(), *this);
    }
