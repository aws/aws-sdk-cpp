...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_BATCH_API DeleteSchedulingPolicyRequest : public BatchRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSchedulingPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSchedulingPolicyRequest>(GetServiceRequestName(), *this);
    }
