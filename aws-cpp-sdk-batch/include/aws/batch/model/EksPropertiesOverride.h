...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_BATCH_API EksPropertiesOverride
  {
  public:
    EksPropertiesOverride();
    EksPropertiesOverride(Aws::Utils::Json::JsonView jsonValue);
    EksPropertiesOverride& operator=(Aws::Utils::Json::JsonView jsonValue);
