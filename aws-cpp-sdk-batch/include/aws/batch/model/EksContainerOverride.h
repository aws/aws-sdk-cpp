...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_BATCH_API EksContainerOverride
  {
  public:
    EksContainerOverride();
    EksContainerOverride(Aws::Utils::Json::JsonView jsonValue);
    EksContainerOverride& operator=(Aws::Utils::Json::JsonView jsonValue);
