...
namespace Model
{
  ...
  public:
     ...
     * required but can be specified in several places for multi-node parallel (MNP)
     * jobs; it must be specified for each node at least once.</p>
     */
     ...
     * specified for each node at least once.</p>  <p>If you are trying to
