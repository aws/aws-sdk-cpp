...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_BATCH_API EksPodPropertiesOverride
  {
  public:
    EksPodPropertiesOverride();
    EksPodPropertiesOverride(Aws::Utils::Json::JsonView jsonValue);
    EksPodPropertiesOverride& operator=(Aws::Utils::Json::JsonView jsonValue);
