...
namespace Model
{
   ...
   * policy. Fair share identifiers that are not included have a default weight of
   * <code>1.0</code>.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/ShareAttributes">AWS
   * API Reference</a></p>
   */
  class AWS_BATCH_API ShareAttributes
  {
  public:
    ShareAttributes();
    ShareAttributes(Aws::Utils::Json::JsonView jsonValue);
    ShareAttributes& operator=(Aws::Utils::Json::JsonView jsonValue);
     ...
     * more than 500 fair share identifiers active in a job queue.</p> <p>The string is
     * limited to 255 alphanumeric characters, optionally followed by '*'.</p>
     */
     ...
     * compute resources of jobs using a share identifier with a weight factor of
     * 1.</p> <p>The smallest supported value is 0.0001 and the largest supported value
     * is 999.9999.</p>
     */
