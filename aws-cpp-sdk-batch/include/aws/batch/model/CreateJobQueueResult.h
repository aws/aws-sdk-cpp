...
namespace Model
{
  ...
  public:
     ...
     * <p>The name of the job queue.</p>
     */
    inline CreateJobQueueResult& WithJobQueueName(Aws::String&& value) { SetJobQueueName(value); return *this;}
     ...
     * <p>The Amazon Resource Name (ARN) of the job queue.</p>
     */
    inline CreateJobQueueResult& WithJobQueueArn(Aws::String&& value) { SetJobQueueArn(value); return *this;}
