...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_BATCH_API EksPropertiesDetail
  {
  public:
    EksPropertiesDetail();
    EksPropertiesDetail(Aws::Utils::Json::JsonView jsonValue);
    EksPropertiesDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
