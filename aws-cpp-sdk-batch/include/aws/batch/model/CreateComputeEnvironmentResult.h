...
namespace Model
{
  ...
  public:
    ...
    CreateComputeEnvironmentResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    CreateComputeEnvironmentResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p>The name of the compute environment.</p>
     */
    inline CreateComputeEnvironmentResult& WithComputeEnvironmentName(Aws::String&& value) { SetComputeEnvironmentName(value); return *this;}
     ...
     * <p>The Amazon Resource Name (ARN) of the compute environment. </p>
     */
    inline CreateComputeEnvironmentResult& WithComputeEnvironmentArn(Aws::String&& value) { SetComputeEnvironmentArn(value); return *this;}
