...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_BATCH_API CreateSchedulingPolicyRequest : public BatchRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSchedulingPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSchedulingPolicyRequest>(GetServiceRequestName(), *this);
    }
