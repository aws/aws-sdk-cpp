...
namespace Batch
{
  ...
  class AWS_BATCH_API BatchClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        BatchClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                    std::shared_ptr<Endpoint::BatchEndpointProvider> endpointProvider = Aws::MakeShared<Batch::Endpoint::BatchEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::BatchEndpointProvider> m_endpointProvider;
  };
