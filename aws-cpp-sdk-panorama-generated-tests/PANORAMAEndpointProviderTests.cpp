...
static const char* ALLOCATION_TAG = "AWSPanoramaEndpointProviderTests";
using PanoramaEndpointProvider = Aws::Panorama::Endpoint::PanoramaEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using PanoramaResolveEndpointOutcome = Aws::Panorama::Endpoint::PanoramaEndpointProvider::PanoramaResolveEndpointOutcome;
...
class PanoramaEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct PanoramaEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<PanoramaEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const PanoramaResolveEndpointOutcome& outcome, const PanoramaEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(PanoramaEndpointProviderTests, EndpointProviderTest)
{
    ...
    const PanoramaEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<PanoramaEndpointProvider> endpointProvider = Aws::MakeShared<PanoramaEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize PanoramaEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const PanoramaEndpointProviderEndpointTestCase::OperationParamsFromTest>>
