...
using ResolveEndpointOutcome = Aws::Schemas::Endpoint::SchemasEndpointProvider::SchemasResolveEndpointOutcome;
...
SchemasClient::SchemasClient(const Client::ClientConfiguration& clientConfiguration,
                             std::shared_ptr<Endpoint::SchemasEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SchemasErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Schemas::Endpoint::SchemasEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
