...
namespace Schemas
{
const size_t SchemasEndpointRules::RulesBlobStrLen = 3458;
const size_t SchemasEndpointRules::RulesBlobSize = 3459;

using RulesBlobT = Aws::Array<const char, SchemasEndpointRules::RulesBlobSize>;
...
'/','s','c','h','e','m','a','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'h','e','m','a','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
...
':','"','h','t','t','p','s',':','/','/','s','c','h','e','m','a','s','.','{','R','e','g','i','o','n',
...
const char* SchemasEndpointRules::GetRulesBlob()
{
