...
Aws::String SchemasEndpointRules::GetRulesAsString()
{
    return Aws::String(SchemasEndpointRules::Rules.begin(), SchemasEndpointRules::Rules.end());
}

const Aws::Vector<char> SchemasEndpointRules::Rules = {
...
's','c','h','e','m','a','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','c','h',
'e','m','a','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
