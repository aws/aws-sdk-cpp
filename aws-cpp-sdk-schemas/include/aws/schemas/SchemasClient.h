...
namespace Model
{
        ...
        typedef Aws::Utils::Outcome<CreateDiscovererResult, Aws::Client::AWSError<SchemasErrors>> CreateDiscovererOutcome;
        typedef Aws::Utils::Outcome<CreateRegistryResult, Aws::Client::AWSError<SchemasErrors>> CreateRegistryOutcome;
        ...
        typedef Aws::Utils::Outcome<DescribeDiscovererResult, Aws::Client::AWSError<SchemasErrors>> DescribeDiscovererOutcome;
        typedef Aws::Utils::Outcome<DescribeRegistryResult, Aws::Client::AWSError<SchemasErrors>> DescribeRegistryOutcome;
        ...
        typedef Aws::Utils::Outcome<UpdateSchemaResult, Aws::Client::AWSError<SchemasErrors>> UpdateSchemaOutcome;
