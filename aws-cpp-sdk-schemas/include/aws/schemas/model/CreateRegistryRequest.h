...
namespace Model
{
  ...
  /**
   */
  class AWS_SCHEMAS_API CreateRegistryRequest : public SchemasRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateRegistryRequest> Clone() const
    {
      return Aws::MakeUnique<CreateRegistryRequest>(GetServiceRequestName(), *this);
    }
