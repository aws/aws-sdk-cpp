...
namespace Model
{
  ...
  /**
   */
  class AWS_SCHEMAS_API DeleteDiscovererRequest : public SchemasRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDiscovererRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDiscovererRequest>(GetServiceRequestName(), *this);
    }
