...
namespace Model
{
  ...
  /**
   */
  class AWS_SCHEMAS_API DescribeDiscovererRequest : public SchemasRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDiscovererRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDiscovererRequest>(GetServiceRequestName(), *this);
    }
