...
namespace Model
{
  ...
  /**
   */
  class AWS_SCHEMAS_API StartDiscovererRequest : public SchemasRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartDiscovererRequest> Clone() const
    {
      return Aws::MakeUnique<StartDiscovererRequest>(GetServiceRequestName(), *this);
    }
