...
Aws::String MWAAEndpointRules::GetRulesAsString()
{
    return Aws::String(MWAAEndpointRules::Rules.begin(), MWAAEndpointRules::Rules.end());
}

const Aws::Vector<char> MWAAEndpointRules::Rules = {
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','i','r','f','l','o',
'w','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
'/','a','i','r','f','l','o','w','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
':','"','h','t','t','p','s',':','/','/','a','i','r','f','l','o','w','.','{','R','e','g','i','o','n',
