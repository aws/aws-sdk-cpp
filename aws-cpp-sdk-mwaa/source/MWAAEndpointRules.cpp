...
namespace MWAA
{
const size_t MWAAEndpointRules::RulesBlobStrLen = 3396;
const size_t MWAAEndpointRules::RulesBlobSize = 3397;

using RulesBlobT = Aws::Array<const char, MWAAEndpointRules::RulesBlobSize>;
...
't','t','p','s',':','/','/','a','i','r','f','l','o','w','-','f','i','p','s','.','{','R','e','g','i',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','i','r','f','l','o','w','-','f','i','p',
...
'"',':','"','h','t','t','p','s',':','/','/','a','i','r','f','l','o','w','.','{','R','e','g','i','o',
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','i',
'r','f','l','o','w','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
'R','e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e',
'r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"',
't','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* MWAAEndpointRules::GetRulesBlob()
{
