...
namespace MWAA
{
  ...
  class AWS_MWAA_API MWAAClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MWAAClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                   std::shared_ptr<Endpoint::MWAAEndpointProvider> endpointProvider = Aws::MakeShared<MWAA::Endpoint::MWAAEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MWAAEndpointProvider> m_endpointProvider;
  };
