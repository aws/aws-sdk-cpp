...
namespace Model
{
  ...
  /**
   */
  class AWS_MWAA_API CreateWebLoginTokenRequest : public MWAARequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWebLoginTokenRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWebLoginTokenRequest>(GetServiceRequestName(), *this);
    }
