...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AcceptAdministratorInvitationRequest> Clone() const
    {
      return Aws::MakeUnique<AcceptAdministratorInvitationRequest>(GetServiceRequestName(), *this);
    }
