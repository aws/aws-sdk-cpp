...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdatePublishingDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdatePublishingDestinationRequest>(GetServiceRequestName(), *this);
    }
