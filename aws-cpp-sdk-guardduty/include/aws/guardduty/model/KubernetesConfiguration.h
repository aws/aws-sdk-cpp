...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GUARDDUTY_API KubernetesConfiguration
  {
  public:
    KubernetesConfiguration();
    KubernetesConfiguration(Aws::Utils::Json::JsonView jsonValue);
    KubernetesConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
