...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GUARDDUTY_API ScanResultDetails
  {
  public:
    ScanResultDetails();
    ScanResultDetails(Aws::Utils::Json::JsonView jsonValue);
    ScanResultDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
