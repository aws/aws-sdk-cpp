...
namespace Model
{
  ...
  /**
   */
  class AWS_GUARDDUTY_API CreatePublishingDestinationRequest : public GuardDutyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreatePublishingDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<CreatePublishingDestinationRequest>(GetServiceRequestName(), *this);
    }
