...
namespace Model
{
  ...
  /**
   */
  class AWS_GUARDDUTY_API DeleteDetectorRequest : public GuardDutyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDetectorRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDetectorRequest>(GetServiceRequestName(), *this);
    }
