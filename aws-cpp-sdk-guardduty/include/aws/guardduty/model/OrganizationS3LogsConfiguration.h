...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_GUARDDUTY_API OrganizationS3LogsConfiguration
  {
  public:
    OrganizationS3LogsConfiguration();
    OrganizationS3LogsConfiguration(Aws::Utils::Json::JsonView jsonValue);
    OrganizationS3LogsConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
