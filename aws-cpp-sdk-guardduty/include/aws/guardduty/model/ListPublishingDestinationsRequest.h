...
namespace Model
{
  ...
  /**
   */
  class AWS_GUARDDUTY_API ListPublishingDestinationsRequest : public GuardDutyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPublishingDestinationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListPublishingDestinationsRequest>(GetServiceRequestName(), *this);
    }
