...
namespace Model
{
  ...
  /**
   */
  class AWS_GUARDDUTY_API DescribePublishingDestinationRequest : public GuardDutyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePublishingDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePublishingDestinationRequest>(GetServiceRequestName(), *this);
    }
