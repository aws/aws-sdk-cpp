...
namespace Model
{
  ...
  /**
   */
  class AWS_GUARDDUTY_API DescribeOrganizationConfigurationRequest : public GuardDutyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOrganizationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOrganizationConfigurationRequest>(GetServiceRequestName(), *this);
    }
