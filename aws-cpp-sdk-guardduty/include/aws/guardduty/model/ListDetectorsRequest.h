...
namespace Model
{
  ...
  /**
   */
  class AWS_GUARDDUTY_API ListDetectorsRequest : public GuardDutyRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDetectorsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDetectorsRequest>(GetServiceRequestName(), *this);
    }
