...
namespace GuardDuty
{
  ...
  class AWS_GUARDDUTY_API GuardDutyClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        GuardDutyClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::GuardDutyEndpointProvider> endpointProvider = Aws::MakeShared<GuardDuty::Endpoint::GuardDutyEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::GuardDutyEndpointProvider> m_endpointProvider;
  };
