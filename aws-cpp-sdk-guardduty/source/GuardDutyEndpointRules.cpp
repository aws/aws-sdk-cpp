...
Aws::String GuardDutyEndpointRules::GetRulesAsString()
{
    return Aws::String(GuardDutyEndpointRules::Rules.begin(), GuardDutyEndpointRules::Rules.end());
}

const Aws::Vector<char> GuardDutyEndpointRules::Rules = {
