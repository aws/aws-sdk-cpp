...
using ResolveEndpointOutcome = Aws::GuardDuty::Endpoint::GuardDutyEndpointProvider::GuardDutyResolveEndpointOutcome;
...
GuardDutyClient::GuardDutyClient(const Client::ClientConfiguration& clientConfiguration,
                                 std::shared_ptr<Endpoint::GuardDutyEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<GuardDutyErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<GuardDuty::Endpoint::GuardDutyEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
