...
using SFNResolveEndpointOutcome = Aws::SFN::Endpoint::SFNEndpointProvider::SFNResolveEndpointOutcome;
...
void ValidateOutcome(const SFNResolveEndpointOutcome& outcome, const SFNEndpointProviderEndpointTestCase::Expect& expect)
{
