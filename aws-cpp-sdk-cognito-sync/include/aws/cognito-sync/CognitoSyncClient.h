...
namespace Model
{
  ...
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::BulkPublishRequest&, const Model::BulkPublishOutcome&> BulkPublishOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::DeleteDatasetRequest&, const Model::DeleteDatasetOutcome&> DeleteDatasetOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::DescribeDatasetRequest&, const Model::DescribeDatasetOutcome&> DescribeDatasetOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::DescribeIdentityPoolUsageRequest&, const Model::DescribeIdentityPoolUsageOutcome&> DescribeIdentityPoolUsageOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::DescribeIdentityUsageRequest&, const Model::DescribeIdentityUsageOutcome&> DescribeIdentityUsageOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::GetBulkPublishDetailsRequest&, const Model::GetBulkPublishDetailsOutcome&> GetBulkPublishDetailsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::GetCognitoEventsRequest&, const Model::GetCognitoEventsOutcome&> GetCognitoEventsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::GetIdentityPoolConfigurationRequest&, const Model::GetIdentityPoolConfigurationOutcome&> GetIdentityPoolConfigurationOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::ListDatasetsRequest&, const Model::ListDatasetsOutcome&> ListDatasetsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::ListIdentityPoolUsageRequest&, const Model::ListIdentityPoolUsageOutcome&> ListIdentityPoolUsageOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::ListRecordsRequest&, const Model::ListRecordsOutcome&> ListRecordsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::RegisterDeviceRequest&, const Model::RegisterDeviceOutcome&> RegisterDeviceOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::SetCognitoEventsRequest&, const Model::SetCognitoEventsOutcome&> SetCognitoEventsOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::SetIdentityPoolConfigurationRequest&, const Model::SetIdentityPoolConfigurationOutcome&> SetIdentityPoolConfigurationOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::SubscribeToDatasetRequest&, const Model::SubscribeToDatasetOutcome&> SubscribeToDatasetOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::UnsubscribeFromDatasetRequest&, const Model::UnsubscribeFromDatasetOutcome&> UnsubscribeFromDatasetOutcomeReceivedEvent;
  typedef Aws::Utils::Event<CognitoSyncClient, const Model::UpdateRecordsRequest&, const Model::UpdateRecordsOutcome&> UpdateRecordsOutcomeReceivedEvent;
  ...
  */
  class AWS_COGNITOSYNC_API CognitoSyncClient : public Aws::Client::AWSJsonRestClient
  {
     ...
     */
     void BulkPublishAsync(const Model::BulkPublishRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DeleteDatasetAsync(const Model::DeleteDatasetRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribeDatasetAsync(const Model::DescribeDatasetRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribeIdentityPoolUsageAsync(const Model::DescribeIdentityPoolUsageRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void DescribeIdentityUsageAsync(const Model::DescribeIdentityUsageRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetBulkPublishDetailsAsync(const Model::GetBulkPublishDetailsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetCognitoEventsAsync(const Model::GetCognitoEventsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void GetIdentityPoolConfigurationAsync(const Model::GetIdentityPoolConfigurationRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListDatasetsAsync(const Model::ListDatasetsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListIdentityPoolUsageAsync(const Model::ListIdentityPoolUsageRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void ListRecordsAsync(const Model::ListRecordsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void RegisterDeviceAsync(const Model::RegisterDeviceRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void SetCognitoEventsAsync(const Model::SetCognitoEventsRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void SetIdentityPoolConfigurationAsync(const Model::SetIdentityPoolConfigurationRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void SubscribeToDatasetAsync(const Model::SubscribeToDatasetRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void UnsubscribeFromDatasetAsync(const Model::UnsubscribeFromDatasetRequest& request) const;
     ...
     */
     ...
     /*
      ...
      Queues the request into a thread executor and triggers associated callback when operation has finished.
     */
     void UpdateRecordsAsync(const Model::UpdateRecordsRequest& request) const;
  ...
  private:
    ...
    /**Async helpers**/
    void BulkPublishAsyncHelper(const Model::BulkPublishRequest& request) const;
    void DeleteDatasetAsyncHelper(const Model::DeleteDatasetRequest& request) const;
    void DescribeDatasetAsyncHelper(const Model::DescribeDatasetRequest& request) const;
    void DescribeIdentityPoolUsageAsyncHelper(const Model::DescribeIdentityPoolUsageRequest& request) const;
    void DescribeIdentityUsageAsyncHelper(const Model::DescribeIdentityUsageRequest& request) const;
    void GetBulkPublishDetailsAsyncHelper(const Model::GetBulkPublishDetailsRequest& request) const;
    void GetCognitoEventsAsyncHelper(const Model::GetCognitoEventsRequest& request) const;
    void GetIdentityPoolConfigurationAsyncHelper(const Model::GetIdentityPoolConfigurationRequest& request) const;
    void ListDatasetsAsyncHelper(const Model::ListDatasetsRequest& request) const;
    void ListIdentityPoolUsageAsyncHelper(const Model::ListIdentityPoolUsageRequest& request) const;
    void ListRecordsAsyncHelper(const Model::ListRecordsRequest& request) const;
    void RegisterDeviceAsyncHelper(const Model::RegisterDeviceRequest& request) const;
    void SetCognitoEventsAsyncHelper(const Model::SetCognitoEventsRequest& request) const;
    void SetIdentityPoolConfigurationAsyncHelper(const Model::SetIdentityPoolConfigurationRequest& request) const;
    void SubscribeToDatasetAsyncHelper(const Model::SubscribeToDatasetRequest& request) const;
    void UnsubscribeFromDatasetAsyncHelper(const Model::UnsubscribeFromDatasetRequest& request) const;
    void UpdateRecordsAsyncHelper(const Model::UpdateRecordsRequest& request) const;
