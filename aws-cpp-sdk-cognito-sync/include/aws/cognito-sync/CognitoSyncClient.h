...
namespace CognitoSync
{
  ...
  class AWS_COGNITOSYNC_API CognitoSyncClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CognitoSyncClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::CognitoSyncEndpointProvider> endpointProvider = Aws::MakeShared<CognitoSync::Endpoint::CognitoSyncEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CognitoSyncEndpointProvider> m_endpointProvider;
  };
