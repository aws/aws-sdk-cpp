...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetIdentityPoolConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetIdentityPoolConfigurationRequest>(GetServiceRequestName(), *this);
    }
