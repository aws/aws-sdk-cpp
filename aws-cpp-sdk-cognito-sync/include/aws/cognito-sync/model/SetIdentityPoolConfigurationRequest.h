...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SetIdentityPoolConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<SetIdentityPoolConfigurationRequest>(GetServiceRequestName(), *this);
    }
