...
namespace Model
{
  ...
  public:
    ...
    GetIdentityPoolConfigurationResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetIdentityPoolConfigurationResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
