...
UpdateRecordsResult::UpdateRecordsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateRecordsResult& UpdateRecordsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
