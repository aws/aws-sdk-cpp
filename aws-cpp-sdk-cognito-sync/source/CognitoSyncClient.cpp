...
using ResolveEndpointOutcome = Aws::CognitoSync::Endpoint::CognitoSyncEndpointProvider::CognitoSyncResolveEndpointOutcome;
...
CognitoSyncClient::CognitoSyncClient(const Client::ClientConfiguration& clientConfiguration,
                                     std::shared_ptr<Endpoint::CognitoSyncEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CognitoSyncErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CognitoSync::Endpoint::CognitoSyncEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
