...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API CreateInAppTemplateRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateInAppTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<CreateInAppTemplateRequest>(GetServiceRequestName(), *this);
    }
