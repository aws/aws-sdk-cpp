...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRecommenderConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetRecommenderConfigurationRequest>(GetServiceRequestName(), *this);
    }
