...
namespace Model
{
  ...
  public:
    GetCampaignsResult();
    GetCampaignsResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetCampaignsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
