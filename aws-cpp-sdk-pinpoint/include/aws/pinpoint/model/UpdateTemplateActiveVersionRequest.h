...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API UpdateTemplateActiveVersionRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTemplateActiveVersionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTemplateActiveVersionRequest>(GetServiceRequestName(), *this);
    }
