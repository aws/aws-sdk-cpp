...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API GetVoiceTemplateRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetVoiceTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetVoiceTemplateRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetVoiceTemplate"; }
     ...
     * Template names are case sensitive.</p>
     */
    inline GetVoiceTemplateRequest& WithTemplateName(const Aws::String& value) { SetTemplateName(value); return *this;}
     ...
     * Template names are case sensitive.</p>
     */
    inline GetVoiceTemplateRequest& WithTemplateName(Aws::String&& value) { SetTemplateName(std::move(value)); return *this;}
     ...
     * Template names are case sensitive.</p>
     */
    inline GetVoiceTemplateRequest& WithTemplateName(const char* value) { SetTemplateName(value); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline GetVoiceTemplateRequest& WithVersion(const Aws::String& value) { SetVersion(value); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline GetVoiceTemplateRequest& WithVersion(Aws::String&& value) { SetVersion(std::move(value)); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline GetVoiceTemplateRequest& WithVersion(const char* value) { SetVersion(value); return *this;}
