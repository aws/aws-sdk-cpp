...
namespace Model
{
  class AWS_PINPOINT_API CreateVoiceTemplateResult
  {
  public:
    CreateVoiceTemplateResult();
    CreateVoiceTemplateResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    CreateVoiceTemplateResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
