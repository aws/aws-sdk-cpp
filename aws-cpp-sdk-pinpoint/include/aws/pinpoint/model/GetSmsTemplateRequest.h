...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API GetSmsTemplateRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSmsTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetSmsTemplateRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetSmsTemplate"; }
     ...
     * Template names are case sensitive.</p>
     */
    inline GetSmsTemplateRequest& WithTemplateName(const Aws::String& value) { SetTemplateName(value); return *this;}
     ...
     * Template names are case sensitive.</p>
     */
    inline GetSmsTemplateRequest& WithTemplateName(Aws::String&& value) { SetTemplateName(std::move(value)); return *this;}
     ...
     * Template names are case sensitive.</p>
     */
    inline GetSmsTemplateRequest& WithTemplateName(const char* value) { SetTemplateName(value); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline GetSmsTemplateRequest& WithVersion(const Aws::String& value) { SetVersion(value); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline GetSmsTemplateRequest& WithVersion(Aws::String&& value) { SetVersion(std::move(value)); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline GetSmsTemplateRequest& WithVersion(const char* value) { SetVersion(value); return *this;}
