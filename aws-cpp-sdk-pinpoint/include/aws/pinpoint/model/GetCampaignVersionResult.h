...
namespace Model
{
  ...
  public:
    ...
    GetCampaignVersionResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetCampaignVersionResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
