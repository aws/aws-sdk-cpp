...
namespace Model
{
  class AWS_PINPOINT_API DeleteApnsVoipSandboxChannelResult
  {
  public:
    DeleteApnsVoipSandboxChannelResult();
    DeleteApnsVoipSandboxChannelResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    DeleteApnsVoipSandboxChannelResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
