...
namespace Model
{
  ...
  public:
    UpdateSegmentResult();
    UpdateSegmentResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateSegmentResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
