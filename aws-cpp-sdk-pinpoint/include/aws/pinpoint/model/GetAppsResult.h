...
namespace Model
{
  ...
  public:
    GetAppsResult();
    GetAppsResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetAppsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
