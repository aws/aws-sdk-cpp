...
namespace Model
{
  ...
  public:
    ...
    GetSegmentVersionsResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetSegmentVersionsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
