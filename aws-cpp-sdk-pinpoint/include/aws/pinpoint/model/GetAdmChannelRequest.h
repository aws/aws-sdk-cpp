...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API GetAdmChannelRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAdmChannelRequest> Clone() const
    {
      return Aws::MakeUnique<GetAdmChannelRequest>(GetServiceRequestName(), *this);
    }
