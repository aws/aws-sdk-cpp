...
namespace Model
{
  class AWS_PINPOINT_API GetAdmChannelResult
  {
  public:
    GetAdmChannelResult();
    GetAdmChannelResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetAdmChannelResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
