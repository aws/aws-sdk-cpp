...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API GetCampaignVersionsRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCampaignVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<GetCampaignVersionsRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetCampaignVersions"; }
     ...
     * the <b>Project ID</b> on the Amazon Pinpoint console.</p>
     */
    inline GetCampaignVersionsRequest& WithApplicationId(const Aws::String& value) { SetApplicationId(value); return *this;}

    /**
     * <p>The unique identifier for the application. This identifier is displayed as
     * the <b>Project ID</b> on the Amazon Pinpoint console.</p>
     */
    inline GetCampaignVersionsRequest& WithApplicationId(Aws::String&& value) { SetApplicationId(std::move(value)); return *this;}
     ...
     * <p>The unique identifier for the campaign.</p>
     */
    inline GetCampaignVersionsRequest& WithCampaignId(const Aws::String& value) { SetCampaignId(value); return *this;}

    /**
     * <p>The unique identifier for the campaign.</p>
     */
    inline GetCampaignVersionsRequest& WithCampaignId(Aws::String&& value) { SetCampaignId(std::move(value)); return *this;}
     ...
     * paginated response.</p>
     */
    inline GetCampaignVersionsRequest& WithToken(const Aws::String& value) { SetToken(value); return *this;}

    /**
     * <p>The NextToken string that specifies which page of results to return in a
     * paginated response.</p>
     */
    inline GetCampaignVersionsRequest& WithToken(Aws::String&& value) { SetToken(std::move(value)); return *this;}
