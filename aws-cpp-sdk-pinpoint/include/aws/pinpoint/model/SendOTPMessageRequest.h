...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API SendOTPMessageRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SendOTPMessageRequest> Clone() const
    {
      return Aws::MakeUnique<SendOTPMessageRequest>(GetServiceRequestName(), *this);
    }
