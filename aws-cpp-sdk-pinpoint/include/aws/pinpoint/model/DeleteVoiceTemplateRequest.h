...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API DeleteVoiceTemplateRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVoiceTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVoiceTemplateRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteVoiceTemplate"; }
     ...
     * Template names are case sensitive.</p>
     */
    inline DeleteVoiceTemplateRequest& WithTemplateName(const Aws::String& value) { SetTemplateName(value); return *this;}
     ...
     * Template names are case sensitive.</p>
     */
    inline DeleteVoiceTemplateRequest& WithTemplateName(Aws::String&& value) { SetTemplateName(std::move(value)); return *this;}
     ...
     * Template names are case sensitive.</p>
     */
    inline DeleteVoiceTemplateRequest& WithTemplateName(const char* value) { SetTemplateName(value); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline DeleteVoiceTemplateRequest& WithVersion(const Aws::String& value) { SetVersion(value); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline DeleteVoiceTemplateRequest& WithVersion(Aws::String&& value) { SetVersion(std::move(value)); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline DeleteVoiceTemplateRequest& WithVersion(const char* value) { SetVersion(value); return *this;}
