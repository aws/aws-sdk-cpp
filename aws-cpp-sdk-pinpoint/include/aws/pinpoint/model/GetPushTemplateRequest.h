...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API GetPushTemplateRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPushTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetPushTemplateRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetPushTemplate"; }
     ...
     * Template names are case sensitive.</p>
     */
    inline GetPushTemplateRequest& WithTemplateName(const Aws::String& value) { SetTemplateName(value); return *this;}
     ...
     * Template names are case sensitive.</p>
     */
    inline GetPushTemplateRequest& WithTemplateName(Aws::String&& value) { SetTemplateName(std::move(value)); return *this;}
     ...
     * Template names are case sensitive.</p>
     */
    inline GetPushTemplateRequest& WithTemplateName(const char* value) { SetTemplateName(value); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline GetPushTemplateRequest& WithVersion(const Aws::String& value) { SetVersion(value); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline GetPushTemplateRequest& WithVersion(Aws::String&& value) { SetVersion(std::move(value)); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline GetPushTemplateRequest& WithVersion(const char* value) { SetVersion(value); return *this;}
