...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PINPOINT_API TemplateVersionResponse
  {
  public:
    TemplateVersionResponse();
    TemplateVersionResponse(Aws::Utils::Json::JsonView jsonValue);
    TemplateVersionResponse& operator=(Aws::Utils::Json::JsonView jsonValue);
