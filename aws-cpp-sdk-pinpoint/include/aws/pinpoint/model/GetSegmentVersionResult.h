...
namespace Model
{
  ...
  public:
    ...
    GetSegmentVersionResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetSegmentVersionResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
