...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API DeleteRecommenderConfigurationRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRecommenderConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRecommenderConfigurationRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteRecommenderConfiguration"; }
