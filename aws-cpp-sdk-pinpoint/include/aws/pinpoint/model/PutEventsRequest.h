...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API PutEventsRequest : public PinpointRequest
  {
  public:
    PutEventsRequest();
    ...
    */
    virtual Aws::UniquePtr<PutEventsRequest> Clone() const
    {
      return Aws::MakeUnique<PutEventsRequest>(GetServiceRequestName(), *this);
    }
