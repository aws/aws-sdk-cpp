...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PINPOINT_API MethodNotAllowedException
  {
  public:
    MethodNotAllowedException();
    MethodNotAllowedException(Aws::Utils::Json::JsonView jsonValue);
    MethodNotAllowedException& operator=(Aws::Utils::Json::JsonView jsonValue);
