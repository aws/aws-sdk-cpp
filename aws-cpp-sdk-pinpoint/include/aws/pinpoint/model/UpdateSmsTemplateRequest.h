...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API UpdateSmsTemplateRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSmsTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSmsTemplateRequest>(GetServiceRequestName(), *this);
    }
