...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API UpdateApnsSandboxChannelRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateApnsSandboxChannelRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateApnsSandboxChannelRequest>(GetServiceRequestName(), *this);
    }
