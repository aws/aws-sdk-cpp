...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API ListJourneysRequest : public PinpointRequest
  {
  public:
    ListJourneysRequest();
    ...
    */
    virtual Aws::UniquePtr<ListJourneysRequest> Clone() const
    {
      return Aws::MakeUnique<ListJourneysRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListJourneys"; }
     ...
     * paginated response.</p>
     */
    inline ListJourneysRequest& WithToken(const char* value) { SetToken(value); return *this;}
