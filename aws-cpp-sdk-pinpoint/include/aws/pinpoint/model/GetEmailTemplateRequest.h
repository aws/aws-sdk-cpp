...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API GetEmailTemplateRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEmailTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetEmailTemplateRequest>(GetServiceRequestName(), *this);
    }
     ...
     * all versions of the template.</p></li></ul>
     */
    inline GetEmailTemplateRequest& WithVersion(const Aws::String& value) { SetVersion(value); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline GetEmailTemplateRequest& WithVersion(Aws::String&& value) { SetVersion(std::move(value)); return *this;}
     ...
     * all versions of the template.</p></li></ul>
     */
    inline GetEmailTemplateRequest& WithVersion(const char* value) { SetVersion(value); return *this;}
