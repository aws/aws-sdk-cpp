...
namespace Model
{
  ...
  /**
   * <p>Specifies the tags (keys and values) for an application, campaign, journey,
  ...
  public:
     ...
     * application, campaign, journey, message template, or segment. Each of these
     * resources can have a maximum of 50 tags.</p> <p>Each tag consists of a required
