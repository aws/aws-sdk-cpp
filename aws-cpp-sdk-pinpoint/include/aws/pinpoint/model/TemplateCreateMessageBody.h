...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PINPOINT_API TemplateCreateMessageBody
  {
  public:
    TemplateCreateMessageBody();
    TemplateCreateMessageBody(Aws::Utils::Json::JsonView jsonValue);
    TemplateCreateMessageBody& operator=(Aws::Utils::Json::JsonView jsonValue);
