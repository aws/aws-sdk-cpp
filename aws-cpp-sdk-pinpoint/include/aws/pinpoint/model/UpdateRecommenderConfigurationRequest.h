...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRecommenderConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRecommenderConfigurationRequest>(GetServiceRequestName(), *this);
    }
