...
namespace Model
{
  ...
  public:
    ...
    DeleteSmsChannelResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    DeleteSmsChannelResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
