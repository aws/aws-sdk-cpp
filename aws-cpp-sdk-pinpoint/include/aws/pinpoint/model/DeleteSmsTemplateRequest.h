...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API DeleteSmsTemplateRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSmsTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSmsTemplateRequest>(GetServiceRequestName(), *this);
    }
