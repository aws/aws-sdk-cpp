...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API GetSegmentExportJobsRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSegmentExportJobsRequest> Clone() const
    {
      return Aws::MakeUnique<GetSegmentExportJobsRequest>(GetServiceRequestName(), *this);
    }
