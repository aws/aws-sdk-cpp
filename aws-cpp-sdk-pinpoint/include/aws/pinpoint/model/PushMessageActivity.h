...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PINPOINT_API PushMessageActivity
  {
  public:
    PushMessageActivity();
    PushMessageActivity(Aws::Utils::Json::JsonView jsonValue);
    PushMessageActivity& operator=(Aws::Utils::Json::JsonView jsonValue);
