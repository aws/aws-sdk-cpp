...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateApnsVoipSandboxChannelRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateApnsVoipSandboxChannelRequest>(GetServiceRequestName(), *this);
    }
