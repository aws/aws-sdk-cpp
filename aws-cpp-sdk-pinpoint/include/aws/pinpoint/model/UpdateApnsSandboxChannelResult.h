...
namespace Model
{
  ...
  public:
    ...
    UpdateApnsSandboxChannelResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateApnsSandboxChannelResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
