...
namespace Model
{
  ...
  public:
    ...
    UpdateCampaignResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateCampaignResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
