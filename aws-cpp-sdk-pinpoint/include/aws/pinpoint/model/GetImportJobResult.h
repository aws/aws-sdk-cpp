...
namespace Model
{
  ...
  public:
    GetImportJobResult();
    GetImportJobResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetImportJobResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
