...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINT_API GetRecommenderConfigurationsRequest : public PinpointRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRecommenderConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetRecommenderConfigurationsRequest>(GetServiceRequestName(), *this);
    }
