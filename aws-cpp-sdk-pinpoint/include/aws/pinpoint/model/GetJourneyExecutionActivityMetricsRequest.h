...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetJourneyExecutionActivityMetricsRequest> Clone() const
    {
      return Aws::MakeUnique<GetJourneyExecutionActivityMetricsRequest>(GetServiceRequestName(), *this);
    }
