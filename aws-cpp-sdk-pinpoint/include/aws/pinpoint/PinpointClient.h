...
namespace Pinpoint
{
  ...
  class AWS_PINPOINT_API PinpointClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        PinpointClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::PinpointEndpointProvider> endpointProvider = Aws::MakeShared<Pinpoint::Endpoint::PinpointEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::PinpointEndpointProvider> m_endpointProvider;
  };
