...
GetAppResult::GetAppResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetAppResult& GetAppResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
