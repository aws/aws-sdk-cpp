...
GetEndpointResult::GetEndpointResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetEndpointResult& GetEndpointResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
