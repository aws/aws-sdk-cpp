...
GetSegmentExportJobsResult::GetSegmentExportJobsResult()
{
}

GetSegmentExportJobsResult::GetSegmentExportJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
