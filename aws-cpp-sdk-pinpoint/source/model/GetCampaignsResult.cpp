...
GetCampaignsResult::GetCampaignsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetCampaignsResult& GetCampaignsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
