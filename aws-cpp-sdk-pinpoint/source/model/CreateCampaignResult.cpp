...
CreateCampaignResult::CreateCampaignResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateCampaignResult& CreateCampaignResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
