...
UpdateCampaignResult::UpdateCampaignResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateCampaignResult& UpdateCampaignResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
