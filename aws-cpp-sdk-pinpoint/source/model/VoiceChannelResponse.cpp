...
VoiceChannelResponse::VoiceChannelResponse(JsonView jsonValue) : 
    m_applicationIdHasBeenSet(false),
    m_creationDateHasBeenSet(false),
    m_enabled(false),
    m_enabledHasBeenSet(false),
...
VoiceChannelResponse& VoiceChannelResponse::operator =(JsonView jsonValue)
{
...
JsonValue VoiceChannelResponse::Jsonize() const
{
  JsonValue payload;
