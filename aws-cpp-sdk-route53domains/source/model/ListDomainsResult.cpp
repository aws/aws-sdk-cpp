...
ListDomainsResult::ListDomainsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListDomainsResult& ListDomainsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
