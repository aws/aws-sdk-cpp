...
ListOperationsResult::ListOperationsResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListOperationsResult& ListOperationsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
