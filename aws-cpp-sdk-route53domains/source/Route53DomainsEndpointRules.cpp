...
{
const size_t Route53DomainsEndpointRules::RulesBlobStrLen = 3424;
const size_t Route53DomainsEndpointRules::RulesBlobSize = 3425;
...
't','t','p','s',':','/','/','r','o','u','t','e','5','3','d','o','m','a','i','n','s','-','f','i','p',
...
'3','d','o','m','a','i','n','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
