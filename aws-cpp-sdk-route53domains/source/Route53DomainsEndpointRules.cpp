...
Aws::String Route53DomainsEndpointRules::GetRulesAsString()
{
    return Aws::String(Route53DomainsEndpointRules::Rules.begin(), Route53DomainsEndpointRules::Rules.end());
}

const Aws::Vector<char> Route53DomainsEndpointRules::Rules = {
