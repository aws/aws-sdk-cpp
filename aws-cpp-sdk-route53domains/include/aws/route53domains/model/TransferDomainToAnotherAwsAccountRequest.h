...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<TransferDomainToAnotherAwsAccountRequest> Clone() const
    {
      return Aws::MakeUnique<TransferDomainToAnotherAwsAccountRequest>(GetServiceRequestName(), *this);
    }
