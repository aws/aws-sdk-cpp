...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetContactReachabilityStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetContactReachabilityStatusRequest>(GetServiceRequestName(), *this);
    }
