...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53DOMAINS_API ListPricesRequest : public Route53DomainsRequest
  {
  public:
    ListPricesRequest();
    ...
    */
    virtual Aws::UniquePtr<ListPricesRequest> Clone() const
    {
      return Aws::MakeUnique<ListPricesRequest>(GetServiceRequestName(), *this);
    }
