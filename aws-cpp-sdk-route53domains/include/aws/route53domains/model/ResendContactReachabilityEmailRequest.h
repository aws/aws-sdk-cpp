...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ResendContactReachabilityEmailRequest> Clone() const
    {
      return Aws::MakeUnique<ResendContactReachabilityEmailRequest>(GetServiceRequestName(), *this);
    }
