...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RejectDomainTransferFromAnotherAwsAccountRequest> Clone() const
    {
      return Aws::MakeUnique<RejectDomainTransferFromAnotherAwsAccountRequest>(GetServiceRequestName(), *this);
    }
