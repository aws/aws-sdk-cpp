...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelDomainTransferToAnotherAwsAccountRequest> Clone() const
    {
      return Aws::MakeUnique<CancelDomainTransferToAnotherAwsAccountRequest>(GetServiceRequestName(), *this);
    }
