...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AcceptDomainTransferFromAnotherAwsAccountRequest> Clone() const
    {
      return Aws::MakeUnique<AcceptDomainTransferFromAnotherAwsAccountRequest>(GetServiceRequestName(), *this);
    }
