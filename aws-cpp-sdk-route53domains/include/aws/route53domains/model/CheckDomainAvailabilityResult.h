...
namespace Model
{
  ...
  public:
     ...
     * name is available.</li> <li> <code>AVAILABLE_RESERVED</code> – The domain name
     * is reserved under specific conditions.</li> <li> <code>AVAILABLE_PREORDER</code>
     * – The domain name is available and can be preordered.</li> <li>
     * <code>UNAVAILABLE</code> – The domain name is not available.</li> <li>
     * <code>UNAVAILABLE_PREMIUM</code> – The domain name is not available.</li> <li>
     * <code>UNAVAILABLE_RESTRICTED</code> – The domain name is forbidden.</li> <li>
     * <code>RESERVED</code> – The domain name has been reserved for another person or
     * organization.</li> <li> <code>DONT_KNOW</code> – The TLD registry didn't reply
