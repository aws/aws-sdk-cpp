...
namespace Model
{
  ...
  public:
    ...
    UpdateDomainNameserversResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateDomainNameserversResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
