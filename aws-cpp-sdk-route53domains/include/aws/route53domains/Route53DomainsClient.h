...
namespace Route53Domains
{
  ...
  class AWS_ROUTE53DOMAINS_API Route53DomainsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        Route53DomainsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::Route53DomainsEndpointProvider> endpointProvider = Aws::MakeShared<Route53Domains::Endpoint::Route53DomainsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::Route53DomainsEndpointProvider> m_endpointProvider;
  };
