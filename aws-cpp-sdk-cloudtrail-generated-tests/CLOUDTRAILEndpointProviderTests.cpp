...
using CloudTrailResolveEndpointOutcome = Aws::CloudTrail::Endpoint::CloudTrailEndpointProvider::CloudTrailResolveEndpointOutcome;
...
void ValidateOutcome(const CloudTrailResolveEndpointOutcome& outcome, const CloudTrailEndpointProviderEndpointTestCase::Expect& expect)
{
