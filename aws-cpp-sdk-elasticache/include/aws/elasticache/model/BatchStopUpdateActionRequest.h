...
namespace Model
{
  ...
  /**
   */
  class AWS_ELASTICACHE_API BatchStopUpdateActionRequest : public ElastiCacheRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchStopUpdateActionRequest> Clone() const
    {
      return Aws::MakeUnique<BatchStopUpdateActionRequest>(GetServiceRequestName(), *this);
    }
