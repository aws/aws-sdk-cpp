...
namespace Model
{
  ...
  /**
   */
  class AWS_ELASTICACHE_API DescribeServiceUpdatesRequest : public ElastiCacheRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeServiceUpdatesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeServiceUpdatesRequest>(GetServiceRequestName(), *this);
    }
