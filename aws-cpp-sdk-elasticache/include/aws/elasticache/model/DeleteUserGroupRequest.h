...
namespace Model
{
  ...
  /**
   */
  class AWS_ELASTICACHE_API DeleteUserGroupRequest : public ElastiCacheRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteUserGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteUserGroupRequest>(GetServiceRequestName(), *this);
    }
