...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAllowedNodeTypeModificationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAllowedNodeTypeModificationsRequest>(GetServiceRequestName(), *this);
    }
