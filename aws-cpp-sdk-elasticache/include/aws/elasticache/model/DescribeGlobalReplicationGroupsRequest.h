...
namespace Model
{
  ...
  /**
   */
  class AWS_ELASTICACHE_API DescribeGlobalReplicationGroupsRequest : public ElastiCacheRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeGlobalReplicationGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeGlobalReplicationGroupsRequest>(GetServiceRequestName(), *this);
    }
