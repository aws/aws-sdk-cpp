...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCacheSecurityGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCacheSecurityGroupsRequest>(GetServiceRequestName(), *this);
    }
