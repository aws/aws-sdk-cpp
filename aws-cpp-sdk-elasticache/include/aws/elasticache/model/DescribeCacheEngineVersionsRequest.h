...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCacheEngineVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCacheEngineVersionsRequest>(GetServiceRequestName(), *this);
    }
