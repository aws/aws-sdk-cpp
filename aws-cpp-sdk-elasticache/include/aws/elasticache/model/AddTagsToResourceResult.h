...
namespace Model
{
   ...
   * operations.</p>
   */
  class AWS_ELASTICACHE_API AddTagsToResourceResult
  {
  public:
    AddTagsToResourceResult();
    AddTagsToResourceResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline AddTagsToResourceResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
