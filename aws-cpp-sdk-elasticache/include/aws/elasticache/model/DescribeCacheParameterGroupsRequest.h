...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCacheParameterGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCacheParameterGroupsRequest>(GetServiceRequestName(), *this);
    }
