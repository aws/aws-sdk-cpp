...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateGlobalReplicationGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateGlobalReplicationGroupRequest>(GetServiceRequestName(), *this);
    }
