...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEngineDefaultParametersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEngineDefaultParametersRequest>(GetServiceRequestName(), *this);
    }
