...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservedCacheNodesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservedCacheNodesRequest>(GetServiceRequestName(), *this);
    }
  ...
  public:
     ...
     * version 1.5.16 onward): <code>cache.m6g.large</code>,
