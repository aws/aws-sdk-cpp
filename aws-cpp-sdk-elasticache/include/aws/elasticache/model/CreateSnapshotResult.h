...
namespace Model
{
  ...
  public:
    ...
    inline CreateSnapshotResult& WithSnapshot(Snapshot&& value) { SetSnapshot(value); return *this;}
    ...
    inline CreateSnapshotResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
