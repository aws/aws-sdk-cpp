...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICACHE_API DestinationDetails
  {
  public:
    DestinationDetails();
    DestinationDetails(const Aws::Utils::Xml::XmlNode& xmlNode);
    DestinationDetails& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
