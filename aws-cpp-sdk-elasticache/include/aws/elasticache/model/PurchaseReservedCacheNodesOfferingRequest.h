...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PurchaseReservedCacheNodesOfferingRequest> Clone() const
    {
      return Aws::MakeUnique<PurchaseReservedCacheNodesOfferingRequest>(GetServiceRequestName(), *this);
    }
