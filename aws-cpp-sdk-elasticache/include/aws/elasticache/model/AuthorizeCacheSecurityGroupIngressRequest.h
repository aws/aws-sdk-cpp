...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AuthorizeCacheSecurityGroupIngressRequest> Clone() const
    {
      return Aws::MakeUnique<AuthorizeCacheSecurityGroupIngressRequest>(GetServiceRequestName(), *this);
    }
