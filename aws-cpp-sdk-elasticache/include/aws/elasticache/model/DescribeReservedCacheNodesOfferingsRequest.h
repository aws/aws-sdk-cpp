...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReservedCacheNodesOfferingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReservedCacheNodesOfferingsRequest>(GetServiceRequestName(), *this);
    }
  ...
  public:
     ...
     * <p>General purpose:</p> <ul> <li> <p>Current generation: </p> <p> <b>M6g node
     * types</b> (available only for Redis engine version 5.0.6 onward and for
     * Memcached engine version 1.5.16 onward): <code>cache.m6g.large</code>,
