...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICACHE_API AuthenticationMode
  {
  public:
    AuthenticationMode();
    AuthenticationMode(const Aws::Utils::Xml::XmlNode& xmlNode);
    AuthenticationMode& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
