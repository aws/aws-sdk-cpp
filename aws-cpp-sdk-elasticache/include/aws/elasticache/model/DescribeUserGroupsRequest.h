...
namespace Model
{
  ...
  /**
   */
  class AWS_ELASTICACHE_API DescribeUserGroupsRequest : public ElastiCacheRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeUserGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeUserGroupsRequest>(GetServiceRequestName(), *this);
    }
