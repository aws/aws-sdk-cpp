...
namespace Model
{
  ...
  /**
   */
  class AWS_ELASTICACHE_API CompleteMigrationRequest : public ElastiCacheRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CompleteMigrationRequest> Clone() const
    {
      return Aws::MakeUnique<CompleteMigrationRequest>(GetServiceRequestName(), *this);
    }
