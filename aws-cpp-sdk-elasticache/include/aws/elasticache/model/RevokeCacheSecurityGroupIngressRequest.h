...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RevokeCacheSecurityGroupIngressRequest> Clone() const
    {
      return Aws::MakeUnique<RevokeCacheSecurityGroupIngressRequest>(GetServiceRequestName(), *this);
    }
