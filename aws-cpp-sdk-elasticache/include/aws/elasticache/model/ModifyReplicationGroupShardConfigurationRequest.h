...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyReplicationGroupShardConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyReplicationGroupShardConfigurationRequest>(GetServiceRequestName(), *this);
    }
