...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RebalanceSlotsInGlobalReplicationGroupRequest> Clone() const
    {
      return Aws::MakeUnique<RebalanceSlotsInGlobalReplicationGroupRequest>(GetServiceRequestName(), *this);
    }
