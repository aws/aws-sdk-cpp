...
namespace ElastiCache
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ElastiCacheClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::ElastiCacheEndpointProvider> endpointProvider = Aws::MakeShared<ElastiCache::Endpoint::ElastiCacheEndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::ElastiCacheEndpointProvider> m_endpointProvider;
  };
