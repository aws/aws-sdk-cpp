...
CopySnapshotResult::CopySnapshotResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

CopySnapshotResult& CopySnapshotResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
