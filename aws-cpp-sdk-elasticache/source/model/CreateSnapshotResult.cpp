...
CreateSnapshotResult::CreateSnapshotResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

CreateSnapshotResult& CreateSnapshotResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
