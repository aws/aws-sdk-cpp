...
DeleteSnapshotResult::DeleteSnapshotResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

DeleteSnapshotResult& DeleteSnapshotResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
