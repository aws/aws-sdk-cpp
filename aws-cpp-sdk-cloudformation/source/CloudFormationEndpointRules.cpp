...
Aws::String CloudFormationEndpointRules::GetRulesAsString()
{
    return Aws::String(CloudFormationEndpointRules::Rules.begin(), CloudFormationEndpointRules::Rules.end());
}

const Aws::Vector<char> CloudFormationEndpointRules::Rules = {
...
't','t','p','s',':','/','/','c','l','o','u','d','f','o','r','m','a','t','i','o','n','-','f','i','p',
...
'p','s',':','/','/','c','l','o','u','d','f','o','r','m','a','t','i','o','n','.','{','R','e','g','i',
