...
ListStackSetsResult::ListStackSetsResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

ListStackSetsResult& ListStackSetsResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
