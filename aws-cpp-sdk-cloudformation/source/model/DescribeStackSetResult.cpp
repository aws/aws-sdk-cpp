...
DescribeStackSetResult::DescribeStackSetResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

DescribeStackSetResult& DescribeStackSetResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
