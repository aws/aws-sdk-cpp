...
UpdateStackSetResult::UpdateStackSetResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

UpdateStackSetResult& UpdateStackSetResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
