...
ListStacksResult::ListStacksResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

ListStacksResult& ListStacksResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
