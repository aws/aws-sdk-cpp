...
GetStackPolicyResult::GetStackPolicyResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

GetStackPolicyResult& GetStackPolicyResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
