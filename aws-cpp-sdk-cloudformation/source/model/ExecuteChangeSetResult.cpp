...
ExecuteChangeSetResult::ExecuteChangeSetResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

ExecuteChangeSetResult& ExecuteChangeSetResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
