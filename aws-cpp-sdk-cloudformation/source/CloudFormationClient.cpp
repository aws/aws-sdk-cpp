...
using ResolveEndpointOutcome = Aws::CloudFormation::Endpoint::CloudFormationEndpointProvider::CloudFormationResolveEndpointOutcome;
...
CloudFormationClient::CloudFormationClient(const Client::ClientConfiguration& clientConfiguration,
                                           std::shared_ptr<Endpoint::CloudFormationEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CloudFormationErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CloudFormation::Endpoint::CloudFormationEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
