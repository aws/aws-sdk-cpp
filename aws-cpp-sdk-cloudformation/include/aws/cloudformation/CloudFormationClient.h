...
namespace CloudFormation
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudFormationClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::CloudFormationEndpointProvider> endpointProvider = Aws::MakeShared<CloudFormation::Endpoint::CloudFormationEndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::CloudFormationEndpointProvider> m_endpointProvider;
  };
