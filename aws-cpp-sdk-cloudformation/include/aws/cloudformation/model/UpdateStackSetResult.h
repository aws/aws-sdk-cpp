...
namespace Model
{
  ...
  public:
    ...
    UpdateStackSetResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    UpdateStackSetResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
