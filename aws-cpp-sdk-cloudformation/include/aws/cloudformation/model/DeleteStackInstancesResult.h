...
namespace Model
{
  ...
  public:
    ...
    DeleteStackInstancesResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DeleteStackInstancesResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
