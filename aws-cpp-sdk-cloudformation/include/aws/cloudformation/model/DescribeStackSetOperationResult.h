...
namespace Model
{
  ...
  public:
    ...
    DescribeStackSetOperationResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DescribeStackSetOperationResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
