...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFORMATION_API DescribeTypeRegistrationRequest : public CloudFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTypeRegistrationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTypeRegistrationRequest>(GetServiceRequestName(), *this);
    }
