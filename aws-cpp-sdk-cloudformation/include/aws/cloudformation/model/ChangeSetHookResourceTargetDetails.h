...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFORMATION_API ChangeSetHookResourceTargetDetails
  {
  public:
    ChangeSetHookResourceTargetDetails();
    ChangeSetHookResourceTargetDetails(const Aws::Utils::Xml::XmlNode& xmlNode);
    ChangeSetHookResourceTargetDetails& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
