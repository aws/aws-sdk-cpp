...
namespace Model
{
  ...
  public:
     ...
     * when the extension version is not specified.</p> <p>To set the default version
     * of an extension, use <code> <a>SetTypeDefaultVersion</a> </code>. </p>
     */
    ...
    /**
     * <p>The provisioning behavior of the extension. AWS CloudFormation determines the
     ...
     * does not include all of the following handlers, and therefore cannot actually be
     ...
     * include:</p> <ul> <li> <p> <code>LIVE</code>: The extension is registered and
     * can be used in CloudFormation operations, dependent on its provisioning behavior
     * and visibility scope.</p> </li> <li> <p> <code>DEPRECATED</code>: The extension
     * has been deregistered and can no longer be used in CloudFormation operations.
     * </p> </li> </ul>
     */
