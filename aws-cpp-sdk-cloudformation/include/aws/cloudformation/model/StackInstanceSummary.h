...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFORMATION_API StackInstanceSummary
  {
  public:
    StackInstanceSummary();
    StackInstanceSummary(const Aws::Utils::Xml::XmlNode& xmlNode);
    StackInstanceSummary& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
