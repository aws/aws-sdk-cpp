...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFORMATION_API StackSetOperationStatusDetails
  {
  public:
    StackSetOperationStatusDetails();
    StackSetOperationStatusDetails(const Aws::Utils::Xml::XmlNode& xmlNode);
    StackSetOperationStatusDetails& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
