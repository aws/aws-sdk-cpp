...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTerminationProtectionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTerminationProtectionRequest>(GetServiceRequestName(), *this);
    }
