...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFORMATION_API TestTypeRequest : public CloudFormationRequest
  {
  public:
    TestTypeRequest();
    ...
    */
    virtual Aws::UniquePtr<TestTypeRequest> Clone() const
    {
      return Aws::MakeUnique<TestTypeRequest>(GetServiceRequestName(), *this);
    }
