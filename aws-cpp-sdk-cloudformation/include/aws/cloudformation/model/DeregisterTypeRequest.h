...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFORMATION_API DeregisterTypeRequest : public CloudFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterTypeRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterTypeRequest>(GetServiceRequestName(), *this);
    }
