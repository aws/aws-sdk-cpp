...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFORMATION_API DeactivateTypeRequest : public CloudFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeactivateTypeRequest> Clone() const
    {
      return Aws::MakeUnique<DeactivateTypeRequest>(GetServiceRequestName(), *this);
    }
