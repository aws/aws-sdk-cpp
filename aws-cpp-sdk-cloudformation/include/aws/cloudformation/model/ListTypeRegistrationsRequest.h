...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFORMATION_API ListTypeRegistrationsRequest : public CloudFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTypeRegistrationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListTypeRegistrationsRequest>(GetServiceRequestName(), *this);
    }
