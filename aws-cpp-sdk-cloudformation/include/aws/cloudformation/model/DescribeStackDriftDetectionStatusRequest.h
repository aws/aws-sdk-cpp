...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeStackDriftDetectionStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeStackDriftDetectionStatusRequest>(GetServiceRequestName(), *this);
    }
