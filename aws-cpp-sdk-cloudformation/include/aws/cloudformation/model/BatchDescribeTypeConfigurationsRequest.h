...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDescribeTypeConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDescribeTypeConfigurationsRequest>(GetServiceRequestName(), *this);
    }
