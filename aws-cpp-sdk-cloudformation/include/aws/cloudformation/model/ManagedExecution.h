...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFORMATION_API ManagedExecution
  {
  public:
    ManagedExecution();
    ManagedExecution(const Aws::Utils::Xml::XmlNode& xmlNode);
    ManagedExecution& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
