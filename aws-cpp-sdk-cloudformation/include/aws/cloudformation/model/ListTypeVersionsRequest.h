...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFORMATION_API ListTypeVersionsRequest : public CloudFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTypeVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListTypeVersionsRequest>(GetServiceRequestName(), *this);
    }
