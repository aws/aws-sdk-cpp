...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeStackResourceDriftsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeStackResourceDriftsRequest>(GetServiceRequestName(), *this);
    }
