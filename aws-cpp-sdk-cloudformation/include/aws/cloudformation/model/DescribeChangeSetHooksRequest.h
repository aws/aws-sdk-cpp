...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFORMATION_API DescribeChangeSetHooksRequest : public CloudFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeChangeSetHooksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeChangeSetHooksRequest>(GetServiceRequestName(), *this);
    }
