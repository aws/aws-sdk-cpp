...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListStackSetOperationResultsRequest> Clone() const
    {
      return Aws::MakeUnique<ListStackSetOperationResultsRequest>(GetServiceRequestName(), *this);
    }
