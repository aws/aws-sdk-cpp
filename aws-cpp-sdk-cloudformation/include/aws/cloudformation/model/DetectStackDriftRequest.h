...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFORMATION_API DetectStackDriftRequest : public CloudFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DetectStackDriftRequest> Clone() const
    {
      return Aws::MakeUnique<DetectStackDriftRequest>(GetServiceRequestName(), *this);
    }
