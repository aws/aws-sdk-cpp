...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFORMATION_API RegisterPublisherRequest : public CloudFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterPublisherRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterPublisherRequest>(GetServiceRequestName(), *this);
    }
