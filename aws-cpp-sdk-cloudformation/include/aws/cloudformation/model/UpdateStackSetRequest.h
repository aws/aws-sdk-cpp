...
namespace Model
{
  ...
  public:
     ...
     * either of these capabilities, CloudFormation returns an
     ...
     * stack instances with their existing stack instance status.</p>
     */
     ...
     * properties are specified), or the <code>Parameters</code> property,
