...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDFORMATION_API SetTypeConfigurationRequest : public CloudFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SetTypeConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<SetTypeConfigurationRequest>(GetServiceRequestName(), *this);
    }
