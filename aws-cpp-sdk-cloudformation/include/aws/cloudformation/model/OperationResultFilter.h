...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDFORMATION_API OperationResultFilter
  {
  public:
    OperationResultFilter();
    OperationResultFilter(const Aws::Utils::Xml::XmlNode& xmlNode);
    OperationResultFilter& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
