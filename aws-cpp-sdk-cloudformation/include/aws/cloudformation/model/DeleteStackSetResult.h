...
namespace Model
{
  ...
  public:
    ...
    DeleteStackSetResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DeleteStackSetResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
