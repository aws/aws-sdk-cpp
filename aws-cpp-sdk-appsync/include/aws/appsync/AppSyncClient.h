...
namespace AppSync
{
  ...
  class AWS_APPSYNC_API AppSyncClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AppSyncClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                      std::shared_ptr<Endpoint::AppSyncEndpointProvider> endpointProvider = Aws::MakeShared<AppSync::Endpoint::AppSyncEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AppSyncEndpointProvider> m_endpointProvider;
  };
