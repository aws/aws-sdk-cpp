...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_APPSYNC_API GetApiCacheRequest : public AppSyncRequest
  {
  public:
    GetApiCacheRequest();
    ...
    */
    virtual Aws::UniquePtr<GetApiCacheRequest> Clone() const
    {
      return Aws::MakeUnique<GetApiCacheRequest>(GetServiceRequestName(), *this);
    }
