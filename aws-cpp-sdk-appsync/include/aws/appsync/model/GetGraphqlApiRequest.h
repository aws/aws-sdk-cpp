...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSYNC_API GetGraphqlApiRequest : public AppSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetGraphqlApiRequest> Clone() const
    {
      return Aws::MakeUnique<GetGraphqlApiRequest>(GetServiceRequestName(), *this);
    }
