...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSYNC_API EvaluateMappingTemplateRequest : public AppSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EvaluateMappingTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<EvaluateMappingTemplateRequest>(GetServiceRequestName(), *this);
    }
