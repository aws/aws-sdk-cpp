...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSYNC_API ListFunctionsRequest : public AppSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFunctionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFunctionsRequest>(GetServiceRequestName(), *this);
    }
