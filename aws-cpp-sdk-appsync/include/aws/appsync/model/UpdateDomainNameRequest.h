...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSYNC_API UpdateDomainNameRequest : public AppSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDomainNameRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDomainNameRequest>(GetServiceRequestName(), *this);
    }
