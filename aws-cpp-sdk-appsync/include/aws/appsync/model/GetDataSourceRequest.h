...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSYNC_API GetDataSourceRequest : public AppSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDataSourceRequest> Clone() const
    {
      return Aws::MakeUnique<GetDataSourceRequest>(GetServiceRequestName(), *this);
    }
