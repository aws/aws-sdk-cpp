...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSYNC_API DeleteFunctionRequest : public AppSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFunctionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFunctionRequest>(GetServiceRequestName(), *this);
    }
