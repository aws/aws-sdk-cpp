...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSYNC_API CreateDomainNameRequest : public AppSyncRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDomainNameRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDomainNameRequest>(GetServiceRequestName(), *this);
    }
