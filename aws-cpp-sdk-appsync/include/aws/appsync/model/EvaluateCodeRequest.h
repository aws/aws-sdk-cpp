...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSYNC_API EvaluateCodeRequest : public AppSyncRequest
  {
  public:
    EvaluateCodeRequest();
    ...
    */
    virtual Aws::UniquePtr<EvaluateCodeRequest> Clone() const
    {
      return Aws::MakeUnique<EvaluateCodeRequest>(GetServiceRequestName(), *this);
    }
