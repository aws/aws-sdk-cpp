...
namespace Model
{
  ...
  /**
   */
  class AWS_APPSYNC_API DeleteTypeRequest : public AppSyncRequest
  {
  public:
    DeleteTypeRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteTypeRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTypeRequest>(GetServiceRequestName(), *this);
    }
