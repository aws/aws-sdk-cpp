...
UpdateFunctionResult::UpdateFunctionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateFunctionResult& UpdateFunctionResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
