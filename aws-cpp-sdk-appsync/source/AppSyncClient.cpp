...
using ResolveEndpointOutcome = Aws::AppSync::Endpoint::AppSyncEndpointProvider::AppSyncResolveEndpointOutcome;
...
AppSyncClient::AppSyncClient(const Client::ClientConfiguration& clientConfiguration,
                             std::shared_ptr<Endpoint::AppSyncEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<AppSyncErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<AppSync::Endpoint::AppSyncEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
