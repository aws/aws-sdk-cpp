...
Aws::String AppSyncEndpointRules::GetRulesAsString()
{
    return Aws::String(AppSyncEndpointRules::Rules.begin(), AppSyncEndpointRules::Rules.end());
}

const Aws::Vector<char> AppSyncEndpointRules::Rules = {
...
'/','a','p','p','s','y','n','c','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
