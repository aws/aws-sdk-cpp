...
using WorkMailResolveEndpointOutcome = Aws::WorkMail::Endpoint::WorkMailEndpointProvider::WorkMailResolveEndpointOutcome;
...
void ValidateOutcome(const WorkMailResolveEndpointOutcome& outcome, const WorkMailEndpointProviderEndpointTestCase::Expect& expect)
{
