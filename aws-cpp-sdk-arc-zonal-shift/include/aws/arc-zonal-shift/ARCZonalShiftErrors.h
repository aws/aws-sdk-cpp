...
public:
  ...
  ARCZonalShiftError(const Aws::Client::AWSError<ARCZonalShiftErrors>& rhs) : Aws::Client::AWSError<ARCZonalShiftErrors>(rhs) {}
  ARCZonalShiftError(Aws::Client::AWSError<ARCZonalShiftErrors>&& rhs) : Aws::Client::AWSError<ARCZonalShiftErrors>(rhs) {}
