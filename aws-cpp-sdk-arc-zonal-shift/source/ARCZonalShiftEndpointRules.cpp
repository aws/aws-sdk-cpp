...
Aws::String ARCZonalShiftEndpointRules::GetRulesAsString()
{
    return Aws::String(ARCZonalShiftEndpointRules::Rules.begin(), ARCZonalShiftEndpointRules::Rules.end());
}

const Aws::Vector<char> ARCZonalShiftEndpointRules::Rules = {
