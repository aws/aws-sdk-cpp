...
Aws::String SupportAppEndpointRules::GetRulesAsString()
{
    return Aws::String(SupportAppEndpointRules::Rules.begin(), SupportAppEndpointRules::Rules.end());
}

const Aws::Vector<char> SupportAppEndpointRules::Rules = {
...
'-','a','p','p','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','s','u','p','p','o','r','t','-','a','p','p','.',
