...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSlackChannelConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSlackChannelConfigurationRequest>(GetServiceRequestName(), *this);
    }
