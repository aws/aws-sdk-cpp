...
namespace Model
{
  ...
  /**
   */
  class AWS_SUPPORTAPP_API ListSlackChannelConfigurationsRequest : public SupportAppRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSlackChannelConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSlackChannelConfigurationsRequest>(GetServiceRequestName(), *this);
    }
