...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSlackWorkspaceConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSlackWorkspaceConfigurationsRequest>(GetServiceRequestName(), *this);
    }
