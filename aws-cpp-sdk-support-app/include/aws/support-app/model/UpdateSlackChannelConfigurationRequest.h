...
namespace Model
{
  ...
  /**
   */
  class AWS_SUPPORTAPP_API UpdateSlackChannelConfigurationRequest : public SupportAppRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSlackChannelConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSlackChannelConfigurationRequest>(GetServiceRequestName(), *this);
    }
