...
namespace Model
{
  ...
  /**
   */
  class AWS_SUPPORTAPP_API DeleteSlackChannelConfigurationRequest : public SupportAppRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSlackChannelConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSlackChannelConfigurationRequest>(GetServiceRequestName(), *this);
    }
