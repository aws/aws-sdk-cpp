...
namespace Model
{
  ...
  /**
   */
  class AWS_SUPPORTAPP_API DeleteSlackWorkspaceConfigurationRequest : public SupportAppRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSlackWorkspaceConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSlackWorkspaceConfigurationRequest>(GetServiceRequestName(), *this);
    }
