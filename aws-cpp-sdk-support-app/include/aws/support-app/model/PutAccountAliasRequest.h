...
namespace Model
{
  ...
  /**
   */
  class AWS_SUPPORTAPP_API PutAccountAliasRequest : public SupportAppRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAccountAliasRequest> Clone() const
    {
      return Aws::MakeUnique<PutAccountAliasRequest>(GetServiceRequestName(), *this);
    }
