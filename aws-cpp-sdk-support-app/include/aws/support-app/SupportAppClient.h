...
namespace SupportApp
{
  ...
  class AWS_SUPPORTAPP_API SupportAppClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SupportAppClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::SupportAppEndpointProvider> endpointProvider = Aws::MakeShared<SupportApp::Endpoint::SupportAppEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SupportAppEndpointProvider> m_endpointProvider;
  };
