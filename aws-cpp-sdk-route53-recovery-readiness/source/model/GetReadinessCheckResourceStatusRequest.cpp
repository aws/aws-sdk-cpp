...
Aws::String GetReadinessCheckResourceStatusRequest::SerializePayload() const
{
  return {};
}

void GetReadinessCheckResourceStatusRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
