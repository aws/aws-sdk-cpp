...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCrossAccountAuthorizationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCrossAccountAuthorizationRequest>(GetServiceRequestName(), *this);
    }
