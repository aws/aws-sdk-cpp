...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRecoveryGroupReadinessSummaryRequest> Clone() const
    {
      return Aws::MakeUnique<GetRecoveryGroupReadinessSummaryRequest>(GetServiceRequestName(), *this);
    }
