...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetReadinessCheckResourceStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetReadinessCheckResourceStatusRequest>(GetServiceRequestName(), *this);
    }
