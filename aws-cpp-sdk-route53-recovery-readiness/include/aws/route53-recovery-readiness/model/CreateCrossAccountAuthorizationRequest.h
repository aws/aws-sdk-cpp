...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCrossAccountAuthorizationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCrossAccountAuthorizationRequest>(GetServiceRequestName(), *this);
    }
