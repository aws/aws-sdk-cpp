...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetArchitectureRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetArchitectureRecommendationsRequest>(GetServiceRequestName(), *this);
    }
