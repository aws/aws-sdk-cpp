...
namespace LookoutEquipment
{
  ...
  class AWS_LOOKOUTEQUIPMENT_API LookoutEquipmentClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        LookoutEquipmentClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::LookoutEquipmentEndpointProvider> endpointProvider = Aws::MakeShared<LookoutEquipment::Endpoint::LookoutEquipmentEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::LookoutEquipmentEndpointProvider> m_endpointProvider;
  };
