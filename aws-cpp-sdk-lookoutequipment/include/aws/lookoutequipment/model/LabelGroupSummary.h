...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_LOOKOUTEQUIPMENT_API LabelGroupSummary
  {
  public:
    LabelGroupSummary();
    LabelGroupSummary(Aws::Utils::Json::JsonView jsonValue);
    LabelGroupSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
