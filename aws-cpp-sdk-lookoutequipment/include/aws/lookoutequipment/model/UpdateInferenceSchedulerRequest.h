...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API UpdateInferenceSchedulerRequest : public LookoutEquipmentRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateInferenceSchedulerRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateInferenceSchedulerRequest>(GetServiceRequestName(), *this);
    }
