...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API StartInferenceSchedulerRequest : public LookoutEquipmentRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartInferenceSchedulerRequest> Clone() const
    {
      return Aws::MakeUnique<StartInferenceSchedulerRequest>(GetServiceRequestName(), *this);
    }
