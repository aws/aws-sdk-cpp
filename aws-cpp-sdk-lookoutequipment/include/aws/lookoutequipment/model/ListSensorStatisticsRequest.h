...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API ListSensorStatisticsRequest : public LookoutEquipmentRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSensorStatisticsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSensorStatisticsRequest>(GetServiceRequestName(), *this);
    }
