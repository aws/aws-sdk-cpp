...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API DeleteLabelRequest : public LookoutEquipmentRequest
  {
  public:
    DeleteLabelRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteLabelRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLabelRequest>(GetServiceRequestName(), *this);
    }
