...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API DescribeInferenceSchedulerRequest : public LookoutEquipmentRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInferenceSchedulerRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInferenceSchedulerRequest>(GetServiceRequestName(), *this);
    }
