...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API StartDataIngestionJobRequest : public LookoutEquipmentRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartDataIngestionJobRequest> Clone() const
    {
      return Aws::MakeUnique<StartDataIngestionJobRequest>(GetServiceRequestName(), *this);
    }
