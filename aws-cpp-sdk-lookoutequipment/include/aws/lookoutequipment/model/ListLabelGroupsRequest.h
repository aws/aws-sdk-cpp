...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API ListLabelGroupsRequest : public LookoutEquipmentRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLabelGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<ListLabelGroupsRequest>(GetServiceRequestName(), *this);
    }
