...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API DeleteLabelGroupRequest : public LookoutEquipmentRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLabelGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLabelGroupRequest>(GetServiceRequestName(), *this);
    }
