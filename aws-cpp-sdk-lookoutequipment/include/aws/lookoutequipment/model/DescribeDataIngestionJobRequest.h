...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API DescribeDataIngestionJobRequest : public LookoutEquipmentRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDataIngestionJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDataIngestionJobRequest>(GetServiceRequestName(), *this);
    }
