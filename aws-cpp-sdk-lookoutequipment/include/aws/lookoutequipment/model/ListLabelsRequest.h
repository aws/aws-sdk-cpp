...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API ListLabelsRequest : public LookoutEquipmentRequest
  {
  public:
    ListLabelsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListLabelsRequest> Clone() const
    {
      return Aws::MakeUnique<ListLabelsRequest>(GetServiceRequestName(), *this);
    }
