...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API ListInferenceEventsRequest : public LookoutEquipmentRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListInferenceEventsRequest> Clone() const
    {
      return Aws::MakeUnique<ListInferenceEventsRequest>(GetServiceRequestName(), *this);
    }
