...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API CreateLabelRequest : public LookoutEquipmentRequest
  {
  public:
    CreateLabelRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateLabelRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLabelRequest>(GetServiceRequestName(), *this);
    }
