...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTEQUIPMENT_API DescribeLabelGroupRequest : public LookoutEquipmentRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLabelGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLabelGroupRequest>(GetServiceRequestName(), *this);
    }
