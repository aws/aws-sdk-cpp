...
Aws::String LookoutEquipmentEndpointRules::GetRulesAsString()
{
    return Aws::String(LookoutEquipmentEndpointRules::Rules.begin(), LookoutEquipmentEndpointRules::Rules.end());
}

const Aws::Vector<char> LookoutEquipmentEndpointRules::Rules = {
...
't','e','q','u','i','p','m','e','n','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
':','"','h','t','t','p','s',':','/','/','l','o','o','k','o','u','t','e','q','u','i','p','m','e','n',
...
'u','i','p','m','e','n','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','l','o','o','k','o','u','t','e','q','u','i','p','m',
'e','n','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
