...
using ResolveEndpointOutcome = Aws::LookoutEquipment::Endpoint::LookoutEquipmentEndpointProvider::LookoutEquipmentResolveEndpointOutcome;
...
LookoutEquipmentClient::LookoutEquipmentClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::LookoutEquipmentEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<LookoutEquipmentErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<LookoutEquipment::Endpoint::LookoutEquipmentEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
