...
{
  AWS_MAKE_CALLABLE_OPERATION(CreateInferenceScheduler, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(CreateInferenceScheduler, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(CreateLabel, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(CreateLabel, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(CreateLabelGroup, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(CreateLabelGroup, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DeleteInferenceScheduler, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DeleteInferenceScheduler, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DeleteLabelGroup, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DeleteLabelGroup, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DescribeDataIngestionJob, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DescribeDataIngestionJob, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DescribeInferenceScheduler, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DescribeInferenceScheduler, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DescribeLabel, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DescribeLabel, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(DescribeLabelGroup, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(DescribeLabelGroup, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListDataIngestionJobs, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListDataIngestionJobs, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListInferenceEvents, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListInferenceEvents, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListInferenceExecutions, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListInferenceExecutions, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListInferenceSchedulers, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListInferenceSchedulers, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListLabelGroups, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListLabelGroups, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListLabels, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListLabels, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(ListSensorStatistics, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(ListSensorStatistics, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(StartDataIngestionJob, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(StartDataIngestionJob, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(StartInferenceScheduler, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(StartInferenceScheduler, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(StopInferenceScheduler, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(StopInferenceScheduler, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(UpdateInferenceScheduler, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(UpdateInferenceScheduler, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(UpdateLabelGroup, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(UpdateLabelGroup, request, handler, context, m_executor.get());
}
