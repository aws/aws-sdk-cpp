...
using CloudWatchResolveEndpointOutcome = Aws::CloudWatch::Endpoint::CloudWatchEndpointProvider::CloudWatchResolveEndpointOutcome;
...
void ValidateOutcome(const CloudWatchResolveEndpointOutcome& outcome, const CloudWatchEndpointProviderEndpointTestCase::Expect& expect)
{
