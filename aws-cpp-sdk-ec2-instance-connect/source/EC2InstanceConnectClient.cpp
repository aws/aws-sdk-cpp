...
using ResolveEndpointOutcome = Aws::EC2InstanceConnect::Endpoint::EC2InstanceConnectEndpointProvider::EC2InstanceConnectResolveEndpointOutcome;
...
EC2InstanceConnectClient::EC2InstanceConnectClient(const Client::ClientConfiguration& clientConfiguration,
                                                   std::shared_ptr<Endpoint::EC2InstanceConnectEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<EC2InstanceConnectErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<EC2InstanceConnect::Endpoint::EC2InstanceConnectEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
