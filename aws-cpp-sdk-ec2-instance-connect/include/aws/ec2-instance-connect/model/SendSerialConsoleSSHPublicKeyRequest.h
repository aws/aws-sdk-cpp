...
namespace Model
{
  ...
  /**
   */
  class AWS_EC2INSTANCECONNECT_API SendSerialConsoleSSHPublicKeyRequest : public EC2InstanceConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SendSerialConsoleSSHPublicKeyRequest> Clone() const
    {
      return Aws::MakeUnique<SendSerialConsoleSSHPublicKeyRequest>(GetServiceRequestName(), *this);
    }
