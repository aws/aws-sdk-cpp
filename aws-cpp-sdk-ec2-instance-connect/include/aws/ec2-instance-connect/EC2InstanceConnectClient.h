...
namespace EC2InstanceConnect
{
  ...
  class AWS_EC2INSTANCECONNECT_API EC2InstanceConnectClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        EC2InstanceConnectClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                 std::shared_ptr<Endpoint::EC2InstanceConnectEndpointProvider> endpointProvider = Aws::MakeShared<EC2InstanceConnect::Endpoint::EC2InstanceConnectEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::EC2InstanceConnectEndpointProvider> m_endpointProvider;
  };
