...
namespace Model
{
  ...
  /**
   */
  class AWS_MAINFRAMEMODERNIZATION_API ListEnvironmentsRequest : public MainframeModernizationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEnvironmentsRequest> Clone() const
    {
      return Aws::MakeUnique<ListEnvironmentsRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>A pagination token to control the number of environments displayed in the
     * list.</p>
     */
