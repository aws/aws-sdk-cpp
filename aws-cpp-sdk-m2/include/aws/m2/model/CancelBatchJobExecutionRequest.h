...
namespace Model
{
  ...
  /**
   */
  class AWS_MAINFRAMEMODERNIZATION_API CancelBatchJobExecutionRequest : public MainframeModernizationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelBatchJobExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<CancelBatchJobExecutionRequest>(GetServiceRequestName(), *this);
    }
