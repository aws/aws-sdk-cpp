...
namespace Model
{
  ...
  /**
   */
  class AWS_MAINFRAMEMODERNIZATION_API ListDataSetImportHistoryRequest : public MainframeModernizationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDataSetImportHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<ListDataSetImportHistoryRequest>(GetServiceRequestName(), *this);
    }
