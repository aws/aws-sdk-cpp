...
namespace Model
{
  ...
  /**
   */
  class AWS_MAINFRAMEMODERNIZATION_API ListBatchJobDefinitionsRequest : public MainframeModernizationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBatchJobDefinitionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListBatchJobDefinitionsRequest>(GetServiceRequestName(), *this);
    }
