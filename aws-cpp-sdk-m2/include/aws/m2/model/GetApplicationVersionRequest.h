...
namespace Model
{
  ...
  /**
   */
  class AWS_MAINFRAMEMODERNIZATION_API GetApplicationVersionRequest : public MainframeModernizationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetApplicationVersionRequest> Clone() const
    {
      return Aws::MakeUnique<GetApplicationVersionRequest>(GetServiceRequestName(), *this);
    }
