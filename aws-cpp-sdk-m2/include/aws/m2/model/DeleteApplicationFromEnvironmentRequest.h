...
namespace Model
{
  ...
  /**
   */
  class AWS_MAINFRAMEMODERNIZATION_API DeleteApplicationFromEnvironmentRequest : public MainframeModernizationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteApplicationFromEnvironmentRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteApplicationFromEnvironmentRequest>(GetServiceRequestName(), *this);
    }
