...
namespace Model
{
  ...
  /**
   */
  class AWS_MAINFRAMEMODERNIZATION_API GetBatchJobExecutionRequest : public MainframeModernizationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBatchJobExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<GetBatchJobExecutionRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetBatchJobExecution"; }
