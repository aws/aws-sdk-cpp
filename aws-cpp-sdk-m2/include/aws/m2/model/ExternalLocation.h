...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MAINFRAMEMODERNIZATION_API ExternalLocation
  {
  public:
    ExternalLocation();
    ExternalLocation(Aws::Utils::Json::JsonView jsonValue);
    ExternalLocation& operator=(Aws::Utils::Json::JsonView jsonValue);
