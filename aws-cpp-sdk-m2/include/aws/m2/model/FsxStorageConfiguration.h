...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MAINFRAMEMODERNIZATION_API FsxStorageConfiguration
  {
  public:
    FsxStorageConfiguration();
    FsxStorageConfiguration(Aws::Utils::Json::JsonView jsonValue);
    FsxStorageConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
