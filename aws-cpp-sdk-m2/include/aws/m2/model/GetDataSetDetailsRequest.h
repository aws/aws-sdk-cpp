...
namespace Model
{
  ...
  /**
   */
  class AWS_MAINFRAMEMODERNIZATION_API GetDataSetDetailsRequest : public MainframeModernizationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDataSetDetailsRequest> Clone() const
    {
      return Aws::MakeUnique<GetDataSetDetailsRequest>(GetServiceRequestName(), *this);
    }
