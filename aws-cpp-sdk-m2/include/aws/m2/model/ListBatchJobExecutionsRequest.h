...
namespace Model
{
  ...
  /**
   */
  class AWS_MAINFRAMEMODERNIZATION_API ListBatchJobExecutionsRequest : public MainframeModernizationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBatchJobExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListBatchJobExecutionsRequest>(GetServiceRequestName(), *this);
    }
