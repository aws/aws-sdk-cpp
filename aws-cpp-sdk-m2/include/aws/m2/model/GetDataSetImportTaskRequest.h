...
namespace Model
{
  ...
  /**
   */
  class AWS_MAINFRAMEMODERNIZATION_API GetDataSetImportTaskRequest : public MainframeModernizationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDataSetImportTaskRequest> Clone() const
    {
      return Aws::MakeUnique<GetDataSetImportTaskRequest>(GetServiceRequestName(), *this);
    }
