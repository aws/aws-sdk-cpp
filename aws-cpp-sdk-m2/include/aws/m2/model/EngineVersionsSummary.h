...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MAINFRAMEMODERNIZATION_API EngineVersionsSummary
  {
  public:
    EngineVersionsSummary();
    EngineVersionsSummary(Aws::Utils::Json::JsonView jsonValue);
    EngineVersionsSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
