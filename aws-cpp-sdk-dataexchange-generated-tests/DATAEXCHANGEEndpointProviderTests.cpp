...
using DataExchangeResolveEndpointOutcome = Aws::DataExchange::Endpoint::DataExchangeEndpointProvider::DataExchangeResolveEndpointOutcome;
...
void ValidateOutcome(const DataExchangeResolveEndpointOutcome& outcome, const DataExchangeEndpointProviderEndpointTestCase::Expect& expect)
{
