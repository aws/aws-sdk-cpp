...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API PrivateDnsNameOptionsOnLaunch
  {
  public:
    PrivateDnsNameOptionsOnLaunch();
    PrivateDnsNameOptionsOnLaunch(const Aws::Utils::Xml::XmlNode& xmlNode);
    PrivateDnsNameOptionsOnLaunch& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
