...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API LaunchTemplateInstanceMarketOptions
  {
  public:
    LaunchTemplateInstanceMarketOptions();
    LaunchTemplateInstanceMarketOptions(const Aws::Utils::Xml::XmlNode& xmlNode);
    LaunchTemplateInstanceMarketOptions& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
