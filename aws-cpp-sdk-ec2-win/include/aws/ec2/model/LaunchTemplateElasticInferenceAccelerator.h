...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API LaunchTemplateElasticInferenceAccelerator
  {
  public:
    LaunchTemplateElasticInferenceAccelerator();
    LaunchTemplateElasticInferenceAccelerator(const Aws::Utils::Xml::XmlNode& xmlNode);
    LaunchTemplateElasticInferenceAccelerator& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
