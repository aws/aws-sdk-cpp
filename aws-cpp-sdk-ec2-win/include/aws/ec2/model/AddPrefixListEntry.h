...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API AddPrefixListEntry
  {
  public:
    AddPrefixListEntry();
    AddPrefixListEntry(const Aws::Utils::Xml::XmlNode& xmlNode);
    AddPrefixListEntry& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
