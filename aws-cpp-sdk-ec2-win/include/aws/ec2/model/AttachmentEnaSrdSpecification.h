...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API AttachmentEnaSrdSpecification
  {
  public:
    AttachmentEnaSrdSpecification();
    AttachmentEnaSrdSpecification(const Aws::Utils::Xml::XmlNode& xmlNode);
    AttachmentEnaSrdSpecification& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
