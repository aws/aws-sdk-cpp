...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API NetworkBandwidthGbps
  {
  public:
    NetworkBandwidthGbps();
    NetworkBandwidthGbps(const Aws::Utils::Xml::XmlNode& xmlNode);
    NetworkBandwidthGbps& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
