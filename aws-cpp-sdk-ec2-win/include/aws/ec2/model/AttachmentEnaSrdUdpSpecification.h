...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API AttachmentEnaSrdUdpSpecification
  {
  public:
    AttachmentEnaSrdUdpSpecification();
    AttachmentEnaSrdUdpSpecification(const Aws::Utils::Xml::XmlNode& xmlNode);
    AttachmentEnaSrdUdpSpecification& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
