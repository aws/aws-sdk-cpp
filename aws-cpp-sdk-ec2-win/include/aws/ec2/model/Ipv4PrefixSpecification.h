...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API Ipv4PrefixSpecification
  {
  public:
    Ipv4PrefixSpecification();
    Ipv4PrefixSpecification(const Aws::Utils::Xml::XmlNode& xmlNode);
    Ipv4PrefixSpecification& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
