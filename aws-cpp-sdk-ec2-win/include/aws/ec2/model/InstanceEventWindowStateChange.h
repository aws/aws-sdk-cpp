...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API InstanceEventWindowStateChange
  {
  public:
    InstanceEventWindowStateChange();
    InstanceEventWindowStateChange(const Aws::Utils::Xml::XmlNode& xmlNode);
    InstanceEventWindowStateChange& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
