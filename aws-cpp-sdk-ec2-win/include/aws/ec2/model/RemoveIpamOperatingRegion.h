...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API RemoveIpamOperatingRegion
  {
  public:
    RemoveIpamOperatingRegion();
    RemoveIpamOperatingRegion(const Aws::Utils::Xml::XmlNode& xmlNode);
    RemoveIpamOperatingRegion& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
