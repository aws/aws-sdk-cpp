...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API ThroughResourcesStatementRequest
  {
  public:
    ThroughResourcesStatementRequest();
    ThroughResourcesStatementRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    ThroughResourcesStatementRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
