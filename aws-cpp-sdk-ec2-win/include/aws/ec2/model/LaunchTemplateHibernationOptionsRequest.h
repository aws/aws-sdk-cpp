...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API LaunchTemplateHibernationOptionsRequest
  {
  public:
    LaunchTemplateHibernationOptionsRequest();
    LaunchTemplateHibernationOptionsRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    LaunchTemplateHibernationOptionsRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
