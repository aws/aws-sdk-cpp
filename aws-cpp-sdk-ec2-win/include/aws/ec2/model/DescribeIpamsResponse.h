...
namespace Model
{
  class AWS_EC2_API DescribeIpamsResponse
  {
  public:
    DescribeIpamsResponse();
    DescribeIpamsResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    DescribeIpamsResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
