...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_EC2_API DeregisterInstanceTagAttributeRequest
  {
  public:
    DeregisterInstanceTagAttributeRequest();
    DeregisterInstanceTagAttributeRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
    DeregisterInstanceTagAttributeRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
