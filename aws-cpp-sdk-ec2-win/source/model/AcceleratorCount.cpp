...
AcceleratorCount& AcceleratorCount::operator =(const XmlNode& xmlNode)
{
...
void AcceleratorCount::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const
{
  if(m_minHasBeenSet)
  {
...
void AcceleratorCount::OutputToStream(Aws::OStream& oStream, const char* location) const
{
  if(m_minHasBeenSet)
  {
