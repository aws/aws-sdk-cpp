...
Aws::String DescribeManagedPrefixListsRequest::SerializePayload() const
{
  Aws::StringStream ss;
  ss << "Action=DescribeManagedPrefixLists&";
...
void  DescribeManagedPrefixListsRequest::DumpBodyToUrl(Aws::Http::URI& uri ) const
{
