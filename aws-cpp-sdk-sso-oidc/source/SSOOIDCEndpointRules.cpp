...
Aws::String SSOOIDCEndpointRules::GetRulesAsString()
{
    return Aws::String(SSOOIDCEndpointRules::Rules.begin(), SSOOIDCEndpointRules::Rules.end());
}

const Aws::Vector<char> SSOOIDCEndpointRules::Rules = {
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','o','i','d',
'c','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
'o','i','d','c','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
