...
namespace KinesisAnalytics
{
  ...
  class AWS_KINESISANALYTICS_API KinesisAnalyticsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        KinesisAnalyticsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::KinesisAnalyticsEndpointProvider> endpointProvider = Aws::MakeShared<KinesisAnalytics::Endpoint::KinesisAnalyticsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::KinesisAnalyticsEndpointProvider> m_endpointProvider;
  };
