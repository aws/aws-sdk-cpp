...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteApplicationReferenceDataSourceRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteApplicationReferenceDataSourceRequest>(GetServiceRequestName(), *this);
    }
