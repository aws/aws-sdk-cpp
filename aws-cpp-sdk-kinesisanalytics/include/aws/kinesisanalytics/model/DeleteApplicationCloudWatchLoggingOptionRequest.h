...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteApplicationCloudWatchLoggingOptionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteApplicationCloudWatchLoggingOptionRequest>(GetServiceRequestName(), *this);
    }
