...
namespace Model
{
   ...
   * used to access the AWS Lambda function. </p><p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    InputLambdaProcessor(const Aws::Utils::Json::JsonValue& jsonValue);
    InputLambdaProcessor& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
