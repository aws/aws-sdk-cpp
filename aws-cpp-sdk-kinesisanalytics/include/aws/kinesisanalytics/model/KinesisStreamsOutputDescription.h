...
namespace Model
{
  ...
  public:
    ...
    KinesisStreamsOutputDescription(const Aws::Utils::Json::JsonValue& jsonValue);
    KinesisStreamsOutputDescription& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
     ...
     * <p>Amazon Resource Name (ARN) of the Amazon Kinesis stream.</p>
     */
    inline KinesisStreamsOutputDescription& WithResourceARN(Aws::String&& value) { SetResourceARN(value); return *this;}
     ...
     * stream.</p>
     */
    inline KinesisStreamsOutputDescription& WithRoleARN(Aws::String&& value) { SetRoleARN(value); return *this;}
