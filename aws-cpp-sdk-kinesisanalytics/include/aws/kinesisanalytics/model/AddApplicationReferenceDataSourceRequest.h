...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AddApplicationReferenceDataSourceRequest> Clone() const
    {
      return Aws::MakeUnique<AddApplicationReferenceDataSourceRequest>(GetServiceRequestName(), *this);
    }
