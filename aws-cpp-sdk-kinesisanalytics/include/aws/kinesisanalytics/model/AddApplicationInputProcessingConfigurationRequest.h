...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AddApplicationInputProcessingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<AddApplicationInputProcessingConfigurationRequest>(GetServiceRequestName(), *this);
    }
