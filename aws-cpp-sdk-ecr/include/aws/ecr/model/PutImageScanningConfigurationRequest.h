...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutImageScanningConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutImageScanningConfigurationRequest>(GetServiceRequestName(), *this);
    }
