...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetRepositoryScanningConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetRepositoryScanningConfigurationRequest>(GetServiceRequestName(), *this);
    }
