...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutRegistryScanningConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutRegistryScanningConfigurationRequest>(GetServiceRequestName(), *this);
    }
