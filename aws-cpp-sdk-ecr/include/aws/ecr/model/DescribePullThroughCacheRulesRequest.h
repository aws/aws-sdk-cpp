...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePullThroughCacheRulesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePullThroughCacheRulesRequest>(GetServiceRequestName(), *this);
    }
