...
namespace Model
{
  ...
  /**
   */
  class AWS_ECR_API DeletePullThroughCacheRuleRequest : public ECRRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeletePullThroughCacheRuleRequest> Clone() const
    {
      return Aws::MakeUnique<DeletePullThroughCacheRuleRequest>(GetServiceRequestName(), *this);
    }
