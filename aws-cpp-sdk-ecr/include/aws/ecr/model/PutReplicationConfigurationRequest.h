...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutReplicationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutReplicationConfigurationRequest>(GetServiceRequestName(), *this);
    }
