...
namespace Model
{
  ...
  public:
     ...
     * assumed.</p>
     */
    inline InitiateLayerUploadRequest& WithRegistryId(Aws::String&& value) { SetRegistryId(value); return *this;}
     ...
     * <p>The name of the repository that you intend to upload layers to.</p>
     */
    inline InitiateLayerUploadRequest& WithRepositoryName(Aws::String&& value) { SetRepositoryName(value); return *this;}
