...
namespace Model
{
  ...
  /**
   */
  class AWS_ECR_API DeleteRepositoryPolicyRequest : public ECRRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRepositoryPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRepositoryPolicyRequest>(GetServiceRequestName(), *this);
    }
