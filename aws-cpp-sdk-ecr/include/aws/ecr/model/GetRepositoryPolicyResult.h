...
namespace Model
{
  ...
  public:
    ...
    GetRepositoryPolicyResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    GetRepositoryPolicyResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
