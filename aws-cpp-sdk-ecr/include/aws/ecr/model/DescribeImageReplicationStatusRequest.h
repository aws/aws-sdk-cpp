...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeImageReplicationStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeImageReplicationStatusRequest>(GetServiceRequestName(), *this);
    }
