...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartLifecyclePolicyPreviewRequest> Clone() const
    {
      return Aws::MakeUnique<StartLifecyclePolicyPreviewRequest>(GetServiceRequestName(), *this);
    }
