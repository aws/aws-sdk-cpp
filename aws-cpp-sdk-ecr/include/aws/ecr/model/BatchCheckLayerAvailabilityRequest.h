...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchCheckLayerAvailabilityRequest> Clone() const
    {
      return Aws::MakeUnique<BatchCheckLayerAvailabilityRequest>(GetServiceRequestName(), *this);
    }
