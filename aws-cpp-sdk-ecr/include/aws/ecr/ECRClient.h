...
namespace ECR
{
  ...
  class AWS_ECR_API ECRClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ECRClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::ECREndpointProvider> endpointProvider = Aws::MakeShared<ECR::Endpoint::ECREndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ECREndpointProvider> m_endpointProvider;
  };
