...
Aws::String MemoryDBEndpointRules::GetRulesAsString()
{
    return Aws::String(MemoryDBEndpointRules::Rules.begin(), MemoryDBEndpointRules::Rules.end());
}

const Aws::Vector<char> MemoryDBEndpointRules::Rules = {
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','e','m','o','r','y',
'-','d','b','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
':','/','/','m','e','m','o','r','y','-','d','b','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'r','u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',',
'"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':',
'/','/','m','e','m','o','r','y','-','d','b','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'r','g','v','"',':','[','{','"','r','e','f','"',':','"','R','e','g','i','o','n','"','}',',','"','f',
'i','p','s','"',']','}',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',
':','"','h','t','t','p','s',':','/','/','m','e','m','o','r','y','-','d','b','-','f','i','p','s','.',
'u','s','-','w','e','s','t','-','1','.','a','m','a','z','o','n','a','w','s','.','c','o','m','"',',',
