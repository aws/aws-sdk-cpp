...
namespace MemoryDB
{
  ...
  class AWS_MEMORYDB_API MemoryDBClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MemoryDBClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::MemoryDBEndpointProvider> endpointProvider = Aws::MakeShared<MemoryDB::Endpoint::MemoryDBEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MemoryDBEndpointProvider> m_endpointProvider;
  };
