...
namespace Model
{
  ...
  /**
   */
  class AWS_MEMORYDB_API ListAllowedNodeTypeUpdatesRequest : public MemoryDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAllowedNodeTypeUpdatesRequest> Clone() const
    {
      return Aws::MakeUnique<ListAllowedNodeTypeUpdatesRequest>(GetServiceRequestName(), *this);
    }
