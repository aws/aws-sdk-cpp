...
namespace Model
{
  ...
  /**
   */
  class AWS_MEMORYDB_API DescribeSubnetGroupsRequest : public MemoryDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSubnetGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSubnetGroupsRequest>(GetServiceRequestName(), *this);
    }
