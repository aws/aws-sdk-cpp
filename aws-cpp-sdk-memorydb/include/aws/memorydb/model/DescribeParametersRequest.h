...
namespace Model
{
  ...
  /**
   */
  class AWS_MEMORYDB_API DescribeParametersRequest : public MemoryDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeParametersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeParametersRequest>(GetServiceRequestName(), *this);
    }
