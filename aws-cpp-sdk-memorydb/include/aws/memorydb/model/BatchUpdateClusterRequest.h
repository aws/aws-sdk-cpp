...
namespace Model
{
  ...
  /**
   */
  class AWS_MEMORYDB_API BatchUpdateClusterRequest : public MemoryDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchUpdateClusterRequest> Clone() const
    {
      return Aws::MakeUnique<BatchUpdateClusterRequest>(GetServiceRequestName(), *this);
    }
