...
namespace Model
{
  ...
  /**
   */
  class AWS_MEMORYDB_API CreateSnapshotRequest : public MemoryDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSnapshotRequest>(GetServiceRequestName(), *this);
    }
