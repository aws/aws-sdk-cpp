...
namespace Model
{
  ...
  /**
   */
  class AWS_MEMORYDB_API DescribeEngineVersionsRequest : public MemoryDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEngineVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEngineVersionsRequest>(GetServiceRequestName(), *this);
    }
