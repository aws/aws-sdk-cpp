...
namespace Model
{
  ...
  /**
   */
  class AWS_MEMORYDB_API DeleteSubnetGroupRequest : public MemoryDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSubnetGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSubnetGroupRequest>(GetServiceRequestName(), *this);
    }
