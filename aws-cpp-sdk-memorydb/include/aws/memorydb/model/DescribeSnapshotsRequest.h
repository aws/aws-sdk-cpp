...
namespace Model
{
  ...
  /**
   */
  class AWS_MEMORYDB_API DescribeSnapshotsRequest : public MemoryDBRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSnapshotsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSnapshotsRequest>(GetServiceRequestName(), *this);
    }
