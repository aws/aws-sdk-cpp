...
namespace Model
{
  ...
  /**
   */
  class AWS_MEMORYDB_API CreateACLRequest : public MemoryDBRequest
  {
  public:
    CreateACLRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateACLRequest> Clone() const
    {
      return Aws::MakeUnique<CreateACLRequest>(GetServiceRequestName(), *this);
    }
