...
namespace Model
{
  ...
  /**
   */
  class AWS_MEMORYDB_API DescribeACLsRequest : public MemoryDBRequest
  {
  public:
    DescribeACLsRequest();
    ...
    */
    virtual Aws::UniquePtr<DescribeACLsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeACLsRequest>(GetServiceRequestName(), *this);
    }
