...
using ResolveEndpointOutcome = Aws::AutoScalingPlans::Endpoint::AutoScalingPlansEndpointProvider::AutoScalingPlansResolveEndpointOutcome;
...
AutoScalingPlansClient::AutoScalingPlansClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::AutoScalingPlansEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<AutoScalingPlansErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<AutoScalingPlans::Endpoint::AutoScalingPlansEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
