...
Aws::String AutoScalingPlansEndpointRules::GetRulesAsString()
{
    return Aws::String(AutoScalingPlansEndpointRules::Rules.begin(), AutoScalingPlansEndpointRules::Rules.end());
}

const Aws::Vector<char> AutoScalingPlansEndpointRules::Rules = {
