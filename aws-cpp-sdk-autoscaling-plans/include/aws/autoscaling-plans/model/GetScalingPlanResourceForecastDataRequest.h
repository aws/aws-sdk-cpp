...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetScalingPlanResourceForecastDataRequest> Clone() const
    {
      return Aws::MakeUnique<GetScalingPlanResourceForecastDataRequest>(GetServiceRequestName(), *this);
    }
