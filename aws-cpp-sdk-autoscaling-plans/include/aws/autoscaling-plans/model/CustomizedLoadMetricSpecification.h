...
namespace Model
{
   ...
   * Statistics are calculations used to aggregate data over specified time periods.
   * For more information, see the <a
   * href="http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.html">Amazon
   * CloudWatch User Guide</a>. </p> <p>When you choose a load metric, make sure that
   * the required <code>Sum</code> and <code>Average</code> statistics for your
   * metric are available in CloudWatch and that they provide relevant data for
   * predictive scaling. The <code>Sum</code> statistic must represent the total load
   * on the resource, and the <code>Average</code> statistic must represent the
   ...
   * <p>For information about terminology, see <a
