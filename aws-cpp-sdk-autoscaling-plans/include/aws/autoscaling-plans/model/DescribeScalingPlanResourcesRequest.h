...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeScalingPlanResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeScalingPlanResourcesRequest>(GetServiceRequestName(), *this);
    }
