...
namespace AutoScalingPlans
{
  ...
  class AWS_AUTOSCALINGPLANS_API AutoScalingPlansClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AutoScalingPlansClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::AutoScalingPlansEndpointProvider> endpointProvider = Aws::MakeShared<AutoScalingPlans::Endpoint::AutoScalingPlansEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AutoScalingPlansEndpointProvider> m_endpointProvider;
  };
