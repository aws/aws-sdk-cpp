...
namespace Model
{
  ...
  public:
    ...
    inline AllocatePublicVirtualInterfaceResult& WithVlan(long value) { SetVlan(value); return *this;}
    ...
    inline AllocatePublicVirtualInterfaceResult& WithAsn(long value) { SetAsn(value); return *this;}
