...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTCONNECT_API AssociateHostedConnectionResult();
     ...
     * connection.</p>
     */
    inline AssociateHostedConnectionResult& WithAwsLogicalDeviceId(const Aws::String& value) { SetAwsLogicalDeviceId(value); return *this;}
     ...
     * connection.</p>
     */
    inline AssociateHostedConnectionResult& WithAwsLogicalDeviceId(Aws::String&& value) { SetAwsLogicalDeviceId(std::move(value)); return *this;}
     ...
     * connection.</p>
     */
    inline AssociateHostedConnectionResult& WithAwsLogicalDeviceId(const char* value) { SetAwsLogicalDeviceId(value); return *this;}
     ...
     * <p>The name of the service provider associated with the connection.</p>
     */
    inline AssociateHostedConnectionResult& WithProviderName(const Aws::String& value) { SetProviderName(value); return *this;}

    /**
     * <p>The name of the service provider associated with the connection.</p>
     */
    inline AssociateHostedConnectionResult& WithProviderName(Aws::String&& value) { SetProviderName(std::move(value)); return *this;}
