...
namespace Model
{
  ...
  public:
    ...
    AssociateHostedConnectionResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AssociateHostedConnectionResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p>The AWS account that will own the new connection.</p>
     */
    inline AssociateHostedConnectionResult& WithOwnerAccount(Aws::String&& value) { SetOwnerAccount(value); return *this;}
    ...
    inline AssociateHostedConnectionResult& WithConnectionId(Aws::String&& value) { SetConnectionId(value); return *this;}
    ...
    inline AssociateHostedConnectionResult& WithConnectionName(Aws::String&& value) { SetConnectionName(value); return *this;}
    ...
    inline AssociateHostedConnectionResult& WithConnectionState(ConnectionState&& value) { SetConnectionState(value); return *this;}
    ...
    inline AssociateHostedConnectionResult& WithRegion(Aws::String&& value) { SetRegion(value); return *this;}
    ...
    inline AssociateHostedConnectionResult& WithLocation(Aws::String&& value) { SetLocation(value); return *this;}
     ...
     * or 500Mbps (for hosted connections)</p> <p>Default: None</p>
     */
    inline AssociateHostedConnectionResult& WithBandwidth(Aws::String&& value) { SetBandwidth(value); return *this;}
     ...
     * connection.</p>
     */
    inline AssociateHostedConnectionResult& WithPartnerName(Aws::String&& value) { SetPartnerName(value); return *this;}
     ...
     * connection.</p>
     */
    inline AssociateHostedConnectionResult& WithLoaIssueTime(Aws::Utils::DateTime&& value) { SetLoaIssueTime(value); return *this;}
    ...
    inline AssociateHostedConnectionResult& WithLagId(Aws::String&& value) { SetLagId(value); return *this;}
     ...
     * on.</p>
     */
    inline AssociateHostedConnectionResult& WithAwsDevice(Aws::String&& value) { SetAwsDevice(value); return *this;}
