...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTCONNECT_API DisassociateMacSecKeyRequest : public DirectConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateMacSecKeyRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateMacSecKeyRequest>(GetServiceRequestName(), *this);
    }
