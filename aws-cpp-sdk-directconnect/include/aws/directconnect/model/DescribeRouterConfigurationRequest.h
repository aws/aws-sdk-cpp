...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DIRECTCONNECT_API DescribeRouterConfigurationRequest : public DirectConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRouterConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRouterConfigurationRequest>(GetServiceRequestName(), *this);
    }
