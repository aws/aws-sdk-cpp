...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDirectConnectGatewayAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDirectConnectGatewayAssociationRequest>(GetServiceRequestName(), *this);
    }
