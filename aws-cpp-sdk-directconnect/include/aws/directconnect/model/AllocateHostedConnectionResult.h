...
namespace Model
{
  ...
  public:
     ...
     * <p>The AWS account that will own the new connection.</p>
     */
    inline AllocateHostedConnectionResult& WithOwnerAccount(Aws::String&& value) { SetOwnerAccount(value); return *this;}
    ...
    inline AllocateHostedConnectionResult& WithConnectionId(Aws::String&& value) { SetConnectionId(value); return *this;}
    ...
    inline AllocateHostedConnectionResult& WithConnectionName(Aws::String&& value) { SetConnectionName(value); return *this;}
    ...
    inline AllocateHostedConnectionResult& WithRegion(Aws::String&& value) { SetRegion(value); return *this;}
    ...
    inline AllocateHostedConnectionResult& WithLocation(Aws::String&& value) { SetLocation(value); return *this;}
     ...
     * or 500Mbps (for hosted connections)</p> <p>Default: None</p>
     */
    inline AllocateHostedConnectionResult& WithBandwidth(Aws::String&& value) { SetBandwidth(value); return *this;}
     ...
     * connection.</p>
     */
    inline AllocateHostedConnectionResult& WithPartnerName(Aws::String&& value) { SetPartnerName(value); return *this;}
     ...
     * connection.</p>
     */
    inline AllocateHostedConnectionResult& WithLoaIssueTime(Aws::Utils::DateTime&& value) { SetLoaIssueTime(value); return *this;}
    ...
    inline AllocateHostedConnectionResult& WithLagId(Aws::String&& value) { SetLagId(value); return *this;}
     ...
     * on.</p>
     */
    inline AllocateHostedConnectionResult& WithAwsDevice(Aws::String&& value) { SetAwsDevice(value); return *this;}
