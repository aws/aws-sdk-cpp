...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DIRECTCONNECT_API AssociateConnectionWithLagResult
  {
  public:
    AssociateConnectionWithLagResult();
    AssociateConnectionWithLagResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AssociateConnectionWithLagResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p>The AWS account that will own the new connection.</p>
     */
    inline AssociateConnectionWithLagResult& WithOwnerAccount(Aws::String&& value) { SetOwnerAccount(value); return *this;}
    ...
    inline AssociateConnectionWithLagResult& WithConnectionId(Aws::String&& value) { SetConnectionId(value); return *this;}
    ...
    inline AssociateConnectionWithLagResult& WithConnectionName(Aws::String&& value) { SetConnectionName(value); return *this;}
    ...
    inline AssociateConnectionWithLagResult& WithRegion(Aws::String&& value) { SetRegion(value); return *this;}
    ...
    inline AssociateConnectionWithLagResult& WithLocation(Aws::String&& value) { SetLocation(value); return *this;}
     ...
     * or 500Mbps (for hosted connections)</p> <p>Default: None</p>
     */
    inline AssociateConnectionWithLagResult& WithBandwidth(Aws::String&& value) { SetBandwidth(value); return *this;}
     ...
     * connection.</p>
     */
    inline AssociateConnectionWithLagResult& WithPartnerName(Aws::String&& value) { SetPartnerName(value); return *this;}
     ...
     * connection.</p>
     */
    inline AssociateConnectionWithLagResult& WithLoaIssueTime(Aws::Utils::DateTime&& value) { SetLoaIssueTime(value); return *this;}
    ...
    inline AssociateConnectionWithLagResult& WithLagId(Aws::String&& value) { SetLagId(value); return *this;}
     ...
     * on.</p>
     */
    inline AssociateConnectionWithLagResult& WithAwsDevice(Aws::String&& value) { SetAwsDevice(value); return *this;}
