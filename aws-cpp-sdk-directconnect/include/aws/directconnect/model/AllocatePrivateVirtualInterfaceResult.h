...
namespace Model
{
  ...
  public:
    ...
    inline AllocatePrivateVirtualInterfaceResult& WithVlan(long value) { SetVlan(value); return *this;}
    ...
    inline AllocatePrivateVirtualInterfaceResult& WithAsn(long value) { SetAsn(value); return *this;}
