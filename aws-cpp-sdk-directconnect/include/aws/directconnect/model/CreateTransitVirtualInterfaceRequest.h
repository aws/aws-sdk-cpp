...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTCONNECT_API CreateTransitVirtualInterfaceRequest : public DirectConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTransitVirtualInterfaceRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTransitVirtualInterfaceRequest>(GetServiceRequestName(), *this);
    }
