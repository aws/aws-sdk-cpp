...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDirectConnectGatewayAttachmentsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDirectConnectGatewayAttachmentsRequest>(GetServiceRequestName(), *this);
    }
