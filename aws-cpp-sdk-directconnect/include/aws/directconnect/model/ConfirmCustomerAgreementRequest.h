...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTCONNECT_API ConfirmCustomerAgreementRequest : public DirectConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ConfirmCustomerAgreementRequest> Clone() const
    {
      return Aws::MakeUnique<ConfirmCustomerAgreementRequest>(GetServiceRequestName(), *this);
    }
