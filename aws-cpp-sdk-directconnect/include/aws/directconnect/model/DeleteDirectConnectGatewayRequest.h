...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDirectConnectGatewayRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDirectConnectGatewayRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteDirectConnectGateway"; }
