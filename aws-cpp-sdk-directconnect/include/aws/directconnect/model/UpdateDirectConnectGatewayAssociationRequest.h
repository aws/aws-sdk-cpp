...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDirectConnectGatewayAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDirectConnectGatewayAssociationRequest>(GetServiceRequestName(), *this);
    }
