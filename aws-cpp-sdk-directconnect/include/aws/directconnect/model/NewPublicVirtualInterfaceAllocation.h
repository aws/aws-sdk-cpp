...
namespace Model
{
  ...
  public:
    ...
    inline NewPublicVirtualInterfaceAllocation& WithVlan(long value) { SetVlan(value); return *this;}
    ...
    inline NewPublicVirtualInterfaceAllocation& WithAsn(long value) { SetAsn(value); return *this;}
