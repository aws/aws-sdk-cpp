...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDirectConnectGatewayAssociationProposalRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDirectConnectGatewayAssociationProposalRequest>(GetServiceRequestName(), *this);
    }
