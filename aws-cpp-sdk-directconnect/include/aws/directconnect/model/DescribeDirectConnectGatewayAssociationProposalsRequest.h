...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDirectConnectGatewayAssociationProposalsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDirectConnectGatewayAssociationProposalsRequest>(GetServiceRequestName(), *this);
    }
