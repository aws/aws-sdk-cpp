...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DIRECTCONNECT_API CreateLagResult
  {
  public:
    CreateLagResult();
     ...
     * <p>Available values: 1Gbps, 10Gbps</p>
     */
    inline CreateLagResult& WithConnectionsBandwidth(Aws::String&& value) { SetConnectionsBandwidth(value); return *this;}
    ...
    inline CreateLagResult& WithLagId(Aws::String&& value) { SetLagId(value); return *this;}
     ...
     * <p>The owner of the LAG.</p>
     */
    inline CreateLagResult& WithOwnerAccount(Aws::String&& value) { SetOwnerAccount(value); return *this;}
     ...
     * <p>The name of the LAG.</p>
     */
    inline CreateLagResult& WithLagName(Aws::String&& value) { SetLagName(value); return *this;}
    ...
    inline CreateLagResult& WithLagState(LagState&& value) { SetLagState(value); return *this;}
    ...
    inline CreateLagResult& WithLocation(Aws::String&& value) { SetLocation(value); return *this;}
    ...
    inline CreateLagResult& WithRegion(Aws::String&& value) { SetRegion(value); return *this;}
     ...
     * <p>The AWS Direct Connection endpoint that hosts the LAG.</p>
     */
    inline CreateLagResult& WithAwsDevice(Aws::String&& value) { SetAwsDevice(value); return *this;}
     ...
     * <p>A list of connections bundled by this LAG.</p>
     */
    inline CreateLagResult& WithConnections(Aws::Vector<Connection>&& value) { SetConnections(value); return *this;}
     ...
     * <p>A list of connections bundled by this LAG.</p>
     */
    inline CreateLagResult& AddConnections(Connection&& value) { m_connections.push_back(value); return *this; }
