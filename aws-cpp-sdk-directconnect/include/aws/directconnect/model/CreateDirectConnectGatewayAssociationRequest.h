...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDirectConnectGatewayAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDirectConnectGatewayAssociationRequest>(GetServiceRequestName(), *this);
    }
