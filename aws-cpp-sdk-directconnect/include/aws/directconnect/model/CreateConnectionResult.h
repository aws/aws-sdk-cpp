...
namespace Model
{
  ...
  public:
    ...
    inline CreateConnectionResult& WithLagId(Aws::String&& value) { SetLagId(value); return *this;}
     ...
     * on.</p>
     */
    inline CreateConnectionResult& WithAwsDevice(Aws::String&& value) { SetAwsDevice(value); return *this;}
