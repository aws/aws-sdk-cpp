...
{
  /**
   * <p>The response received when CreateBGPPeer is called.</p><p><h3>See Also:</h3> 
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/directconnect-2012-10-25/CreateBGPPeerResponse">AWS
   * API Reference</a></p>
   */
