...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListVirtualInterfaceTestHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<ListVirtualInterfaceTestHistoryRequest>(GetServiceRequestName(), *this);
    }
