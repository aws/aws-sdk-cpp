...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ConfirmTransitVirtualInterfaceRequest> Clone() const
    {
      return Aws::MakeUnique<ConfirmTransitVirtualInterfaceRequest>(GetServiceRequestName(), *this);
    }
