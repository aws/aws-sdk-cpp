...
namespace Model
{
  ...
  public:
    ...
    inline AllocateConnectionOnInterconnectResult& WithLagId(const Aws::String& value) { SetLagId(value); return *this;}

    
    inline AllocateConnectionOnInterconnectResult& WithLagId(Aws::String&& value) { SetLagId(value); return *this;}

    
    inline AllocateConnectionOnInterconnectResult& WithLagId(const char* value) { SetLagId(value); return *this;}
     ...
     * on.</p>
     */
    inline AllocateConnectionOnInterconnectResult& WithAwsDevice(const Aws::String& value) { SetAwsDevice(value); return *this;}

    /**
     * <p>The Direct Connection endpoint which the physical connection terminates
     * on.</p>
     */
    inline AllocateConnectionOnInterconnectResult& WithAwsDevice(Aws::String&& value) { SetAwsDevice(value); return *this;}

    /**
     * <p>The Direct Connection endpoint which the physical connection terminates
     * on.</p>
     */
    inline AllocateConnectionOnInterconnectResult& WithAwsDevice(const char* value) { SetAwsDevice(value); return *this;}
