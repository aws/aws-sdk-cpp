...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AcceptDirectConnectGatewayAssociationProposalRequest> Clone() const
    {
      return Aws::MakeUnique<AcceptDirectConnectGatewayAssociationProposalRequest>(GetServiceRequestName(), *this);
    }
