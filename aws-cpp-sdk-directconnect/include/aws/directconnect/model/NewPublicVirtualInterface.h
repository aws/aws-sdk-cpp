...
namespace Model
{
  ...
  public:
    ...
    inline NewPublicVirtualInterface& WithVlan(long value) { SetVlan(value); return *this;}
    ...
    inline NewPublicVirtualInterface& WithAsn(long value) { SetAsn(value); return *this;}
