...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDirectConnectGatewayAssociationProposalRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDirectConnectGatewayAssociationProposalRequest>(GetServiceRequestName(), *this);
    }
