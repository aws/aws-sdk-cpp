...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTCONNECT_API UpdateConnectionRequest : public DirectConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateConnectionRequest>(GetServiceRequestName(), *this);
    }
