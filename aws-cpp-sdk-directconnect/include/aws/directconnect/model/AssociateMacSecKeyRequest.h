...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTCONNECT_API AssociateMacSecKeyRequest : public DirectConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateMacSecKeyRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateMacSecKeyRequest>(GetServiceRequestName(), *this);
    }
