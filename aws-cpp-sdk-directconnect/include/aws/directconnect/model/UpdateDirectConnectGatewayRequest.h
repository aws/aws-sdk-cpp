...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTCONNECT_API UpdateDirectConnectGatewayRequest : public DirectConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDirectConnectGatewayRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDirectConnectGatewayRequest>(GetServiceRequestName(), *this);
    }
