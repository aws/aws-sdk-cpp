...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ConfirmPublicVirtualInterfaceRequest> Clone() const
    {
      return Aws::MakeUnique<ConfirmPublicVirtualInterfaceRequest>(GetServiceRequestName(), *this);
    }
