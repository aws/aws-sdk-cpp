...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDirectConnectGatewaysRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDirectConnectGatewaysRequest>(GetServiceRequestName(), *this);
    }
