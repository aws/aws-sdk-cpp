...
{
  /**
   * <p>The response received when DescribeInterconnectLoa is called.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/directconnect-2012-10-25/DescribeInterconnectLoaResponse">AWS
   * API Reference</a></p>
   */
