...
namespace Model
{
  ...
  /**
   * <p>Container for the parameters to the ConfirmConnection
   * operation.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/directconnect-2012-10-25/ConfirmConnectionRequest">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline ConfirmConnectionRequest& WithConnectionId(Aws::String&& value) { SetConnectionId(value); return *this;}
