...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDirectConnectGatewayAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDirectConnectGatewayAssociationsRequest>(GetServiceRequestName(), *this);
    }
