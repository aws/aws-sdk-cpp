...
namespace Model
{
  ...
  public:
    DeleteLagResult();
    DeleteLagResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    DeleteLagResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
