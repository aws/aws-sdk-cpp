...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AllocateTransitVirtualInterfaceRequest> Clone() const
    {
      return Aws::MakeUnique<AllocateTransitVirtualInterfaceRequest>(GetServiceRequestName(), *this);
    }
