...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ConfirmPrivateVirtualInterfaceRequest> Clone() const
    {
      return Aws::MakeUnique<ConfirmPrivateVirtualInterfaceRequest>(GetServiceRequestName(), *this);
    }
