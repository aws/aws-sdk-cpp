...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateConnectionFromLagRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateConnectionFromLagRequest>(GetServiceRequestName(), *this);
    }
