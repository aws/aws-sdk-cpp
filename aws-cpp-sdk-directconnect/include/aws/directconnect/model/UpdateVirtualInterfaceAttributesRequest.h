...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateVirtualInterfaceAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateVirtualInterfaceAttributesRequest>(GetServiceRequestName(), *this);
    }
