...
namespace Model
{
  ...
  /**
   * <p>AWS Direct Connect makes it easy to establish a dedicated network connection
   ...
   * than Internet-based connections.</p> <p>The AWS Direct Connect API Reference
   * provides descriptions, syntax, and usage examples for each of the actions and
   * data types for AWS Direct Connect. Use the following links to get started using
   * the <i>AWS Direct Connect API Reference</i>:</p> <ul> <li><a
   ...
   * Query Parameters</a>: Parameters that all Query actions can use.</li> <li><a
