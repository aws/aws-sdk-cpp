...
namespace DirectConnect
{
  ...
  class AWS_DIRECTCONNECT_API DirectConnectClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DirectConnectClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::DirectConnectEndpointProvider> endpointProvider = Aws::MakeShared<DirectConnect::Endpoint::DirectConnectEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DirectConnectEndpointProvider> m_endpointProvider;
  };
