...
Aws::String DirectConnectEndpointRules::GetRulesAsString()
{
    return Aws::String(DirectConnectEndpointRules::Rules.begin(), DirectConnectEndpointRules::Rules.end());
}

const Aws::Vector<char> DirectConnectEndpointRules::Rules = {
