...
NewTransitVirtualInterfaceAllocation& NewTransitVirtualInterfaceAllocation::operator =(JsonView jsonValue)
{
...
JsonValue NewTransitVirtualInterfaceAllocation::Jsonize() const
{
  JsonValue payload;
