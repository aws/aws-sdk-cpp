...
AssociateConnectionWithLagResult::AssociateConnectionWithLagResult(const AmazonWebServiceResult<JsonValue>& result) : 
    m_connectionState(ConnectionState::NOT_SET),
    m_vlan(0)
{
  *this = result;
...
AssociateConnectionWithLagResult& AssociateConnectionWithLagResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
