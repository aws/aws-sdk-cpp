...
CreateLagResult::CreateLagResult(const AmazonWebServiceResult<JsonValue>& result) : 
    m_numberOfConnections(0),
    m_lagState(LagState::NOT_SET),
    m_minimumLinks(0),
    m_allowsHostedConnections(false)
...
CreateLagResult& CreateLagResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
