...
namespace kendra
{
  ...
  class AWS_KENDRA_API KendraClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        KendraClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                     std::shared_ptr<Endpoint::KendraEndpointProvider> endpointProvider = Aws::MakeShared<kendra::Endpoint::KendraEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::KendraEndpointProvider> m_endpointProvider;
  };
