...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API ListDataSourceSyncJobsRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDataSourceSyncJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDataSourceSyncJobsRequest>(GetServiceRequestName(), *this);
    }
