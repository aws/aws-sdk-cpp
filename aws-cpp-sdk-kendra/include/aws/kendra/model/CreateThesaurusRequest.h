...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API CreateThesaurusRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateThesaurusRequest> Clone() const
    {
      return Aws::MakeUnique<CreateThesaurusRequest>(GetServiceRequestName(), *this);
    }
