...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API UpdateAccessControlConfigurationRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAccessControlConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAccessControlConfigurationRequest>(GetServiceRequestName(), *this);
    }
