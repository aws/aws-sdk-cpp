...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API ListThesauriRequest : public KendraRequest
  {
  public:
    ListThesauriRequest();
    ...
    */
    virtual Aws::UniquePtr<ListThesauriRequest> Clone() const
    {
      return Aws::MakeUnique<ListThesauriRequest>(GetServiceRequestName(), *this);
    }
