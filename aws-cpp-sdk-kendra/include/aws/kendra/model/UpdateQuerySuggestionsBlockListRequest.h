...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateQuerySuggestionsBlockListRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateQuerySuggestionsBlockListRequest>(GetServiceRequestName(), *this);
    }
