...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API UpdateThesaurusRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateThesaurusRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateThesaurusRequest>(GetServiceRequestName(), *this);
    }
