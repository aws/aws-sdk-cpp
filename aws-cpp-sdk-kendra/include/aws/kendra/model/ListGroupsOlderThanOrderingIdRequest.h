...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API ListGroupsOlderThanOrderingIdRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListGroupsOlderThanOrderingIdRequest> Clone() const
    {
      return Aws::MakeUnique<ListGroupsOlderThanOrderingIdRequest>(GetServiceRequestName(), *this);
    }
