...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_KENDRA_API AccessControlConfigurationSummary
  {
  public:
    AccessControlConfigurationSummary();
    AccessControlConfigurationSummary(Aws::Utils::Json::JsonView jsonValue);
    AccessControlConfigurationSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
