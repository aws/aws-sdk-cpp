...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API ListDataSourcesRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDataSourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListDataSourcesRequest>(GetServiceRequestName(), *this);
    }
