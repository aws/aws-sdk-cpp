...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API ClearQuerySuggestionsRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ClearQuerySuggestionsRequest> Clone() const
    {
      return Aws::MakeUnique<ClearQuerySuggestionsRequest>(GetServiceRequestName(), *this);
    }
