...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API ListExperiencesRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListExperiencesRequest> Clone() const
    {
      return Aws::MakeUnique<ListExperiencesRequest>(GetServiceRequestName(), *this);
    }
