...
namespace Model
{
   ...
   * identity source. This applies to users and groups with specific permissions that
   * define their level of access to your Amazon Kendra experience. You can create an
