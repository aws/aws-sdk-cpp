...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API CreateQuerySuggestionsBlockListRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateQuerySuggestionsBlockListRequest> Clone() const
    {
      return Aws::MakeUnique<CreateQuerySuggestionsBlockListRequest>(GetServiceRequestName(), *this);
    }
