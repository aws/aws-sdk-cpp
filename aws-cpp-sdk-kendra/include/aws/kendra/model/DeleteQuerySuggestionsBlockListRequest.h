...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteQuerySuggestionsBlockListRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteQuerySuggestionsBlockListRequest>(GetServiceRequestName(), *this);
    }
