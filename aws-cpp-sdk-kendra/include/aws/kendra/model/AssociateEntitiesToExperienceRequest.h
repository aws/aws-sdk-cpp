...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateEntitiesToExperienceRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateEntitiesToExperienceRequest>(GetServiceRequestName(), *this);
    }
