...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API DisassociatePersonasFromEntitiesRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociatePersonasFromEntitiesRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociatePersonasFromEntitiesRequest>(GetServiceRequestName(), *this);
    }
