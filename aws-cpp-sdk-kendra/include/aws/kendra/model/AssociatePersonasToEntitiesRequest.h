...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API AssociatePersonasToEntitiesRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociatePersonasToEntitiesRequest> Clone() const
    {
      return Aws::MakeUnique<AssociatePersonasToEntitiesRequest>(GetServiceRequestName(), *this);
    }
