...
namespace Model
{
  ...
  /**
   * <p>Defines the mapping between a field in the Confluence data source to an
   ...
   * API Reference</a></p>
   */
  class AWS_KENDRA_API ConfluenceSpaceToIndexFieldMapping
  {
  public:
    ConfluenceSpaceToIndexFieldMapping();
    ConfluenceSpaceToIndexFieldMapping(Aws::Utils::Json::JsonView jsonValue);
    ConfluenceSpaceToIndexFieldMapping& operator=(Aws::Utils::Json::JsonView jsonValue);
