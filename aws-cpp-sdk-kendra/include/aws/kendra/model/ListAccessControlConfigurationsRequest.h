...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAccessControlConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAccessControlConfigurationsRequest>(GetServiceRequestName(), *this);
    }
