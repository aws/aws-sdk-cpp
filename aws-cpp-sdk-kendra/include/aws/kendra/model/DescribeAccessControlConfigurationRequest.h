...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API DescribeAccessControlConfigurationRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAccessControlConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAccessControlConfigurationRequest>(GetServiceRequestName(), *this);
    }
