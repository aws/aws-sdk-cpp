...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeQuerySuggestionsConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeQuerySuggestionsConfigRequest>(GetServiceRequestName(), *this);
    }
