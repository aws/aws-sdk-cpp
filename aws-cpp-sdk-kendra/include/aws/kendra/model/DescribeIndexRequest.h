...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API DescribeIndexRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeIndexRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeIndexRequest>(GetServiceRequestName(), *this);
    }
