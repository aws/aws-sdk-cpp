...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API GetQuerySuggestionsRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetQuerySuggestionsRequest> Clone() const
    {
      return Aws::MakeUnique<GetQuerySuggestionsRequest>(GetServiceRequestName(), *this);
    }
