...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateEntitiesFromExperienceRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateEntitiesFromExperienceRequest>(GetServiceRequestName(), *this);
    }
