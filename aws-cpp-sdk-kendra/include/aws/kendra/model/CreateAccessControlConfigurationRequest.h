...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API CreateAccessControlConfigurationRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAccessControlConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAccessControlConfigurationRequest>(GetServiceRequestName(), *this);
    }
