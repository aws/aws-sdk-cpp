...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateQuerySuggestionsConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateQuerySuggestionsConfigRequest>(GetServiceRequestName(), *this);
    }
