...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAccessControlConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAccessControlConfigurationRequest>(GetServiceRequestName(), *this);
    }
