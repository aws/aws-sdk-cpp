...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API ListQuerySuggestionsBlockListsRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListQuerySuggestionsBlockListsRequest> Clone() const
    {
      return Aws::MakeUnique<ListQuerySuggestionsBlockListsRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListQuerySuggestionsBlockLists"; }
