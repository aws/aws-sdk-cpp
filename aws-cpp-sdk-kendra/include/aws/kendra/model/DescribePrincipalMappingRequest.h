...
namespace Model
{
  ...
  /**
   */
  class AWS_KENDRA_API DescribePrincipalMappingRequest : public KendraRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePrincipalMappingRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePrincipalMappingRequest>(GetServiceRequestName(), *this);
    }
