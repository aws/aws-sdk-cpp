...
using ResolveEndpointOutcome = Aws::kendra::Endpoint::kendraEndpointProvider::KendraResolveEndpointOutcome;
...
KendraClient::KendraClient(const Client::ClientConfiguration& clientConfiguration,
                           std::shared_ptr<Endpoint::KendraEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<KendraErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<kendra::Endpoint::KendraEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
