...
Aws::String SageMakerFeatureStoreRuntimeEndpointRules::GetRulesAsString()
{
    return Aws::String(SageMakerFeatureStoreRuntimeEndpointRules::Rules.begin(), SageMakerFeatureStoreRuntimeEndpointRules::Rules.end());
}

const Aws::Vector<char> SageMakerFeatureStoreRuntimeEndpointRules::Rules = {
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','f','e','a','t','u','r',
'e','s','t','o','r','e','-','r','u','n','t','i','m','e','.','s','a','g','e','m','a','k','e','r','-',
...
'"','h','t','t','p','s',':','/','/','f','e','a','t','u','r','e','s','t','o','r','e','-','r','u','n',
't','i','m','e','.','s','a','g','e','m','a','k','e','r','-','f','i','p','s','.','{','R','e','g','i',
...
'/','/','f','e','a','t','u','r','e','s','t','o','r','e','-','r','u','n','t','i','m','e','.','s','a',
