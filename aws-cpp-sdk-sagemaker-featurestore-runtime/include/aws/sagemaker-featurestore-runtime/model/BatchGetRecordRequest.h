...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKERFEATURESTORERUNTIME_API BatchGetRecordRequest : public SageMakerFeatureStoreRuntimeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetRecordRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetRecordRequest>(GetServiceRequestName(), *this);
    }
