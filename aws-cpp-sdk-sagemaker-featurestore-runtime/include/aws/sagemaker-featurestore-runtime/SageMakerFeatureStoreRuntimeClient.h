...
namespace SageMakerFeatureStoreRuntime
{
  ...
  class AWS_SAGEMAKERFEATURESTORERUNTIME_API SageMakerFeatureStoreRuntimeClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SageMakerFeatureStoreRuntimeClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                           std::shared_ptr<Endpoint::SageMakerFeatureStoreRuntimeEndpointProvider> endpointProvider = Aws::MakeShared<SageMakerFeatureStoreRuntime::Endpoint::SageMakerFeatureStoreRuntimeEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SageMakerFeatureStoreRuntimeEndpointProvider> m_endpointProvider;
  };
