...
namespace Model
{
  ...
  /**
   */
  class AWS_SNS_API PutDataProtectionPolicyRequest : public SNSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutDataProtectionPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutDataProtectionPolicyRequest>(GetServiceRequestName(), *this);
    }
