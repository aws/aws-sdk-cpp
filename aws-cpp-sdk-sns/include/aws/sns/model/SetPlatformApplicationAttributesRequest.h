...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SetPlatformApplicationAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<SetPlatformApplicationAttributesRequest>(GetServiceRequestName(), *this);
    }
