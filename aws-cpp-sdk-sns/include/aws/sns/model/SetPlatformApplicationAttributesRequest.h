...
namespace Model
{
  ...
  public:
     ...
     * the following:</p> <ul> <li><p><code>PlatformCredential</code> -- The credential
     * received from the notification service. For APNS/APNS_SANDBOX,
     * PlatformCredential is private key. For GCM, PlatformCredential is "API key". For
     * ADM, PlatformCredential is "client secret".</p></li>
     ...
     * PlatformPrincipal is "client id".</p></li>
     * <li><p><code>EventEndpointCreated</code> -- Topic ARN to which EndpointCreated
     * event notifications should be sent.</p></li>
     * <li><p><code>EventEndpointDeleted</code> -- Topic ARN to which EndpointDeleted
     * event notifications should be sent.</p></li>
     * <li><p><code>EventEndpointUpdated</code> -- Topic ARN to which EndpointUpdate
     * event notifications should be sent.</p></li>
     * <li><p><code>EventDeliveryFailure</code> -- Topic ARN to which DeliveryFailure
     * event notifications should be sent upon Direct Publish delivery failure
     * (permanent) to one of the application's endpoints.</p></li>
     * <li><p><code>SuccessFeedbackRoleArn</code> -- IAM role ARN used to give Amazon
     * SNS write access to use CloudWatch Logs on your behalf.</p></li>
     * <li><p><code>FailureFeedbackRoleArn</code> -- IAM role ARN used to give Amazon
     * SNS write access to use CloudWatch Logs on your behalf.</p></li>
     * <li><p><code>SuccessFeedbackSampleRate</code> -- Sample rate percentage (0-100)
     * of successfully delivered messages.</p></li> </ul>
     */
