...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPlatformApplicationAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<GetPlatformApplicationAttributesRequest>(GetServiceRequestName(), *this);
    }
