...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEndpointsByPlatformApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<ListEndpointsByPlatformApplicationRequest>(GetServiceRequestName(), *this);
    }
