...
namespace Model
{
  ...
  public:
    ...
    <ul>
      <li>
<code>TopicArn</code> -- the topic's
     * ARN</li>
      <li>
<code>Owner</code> -- the AWS account ID of the topic's
     * owner</li>
      <li>
<code>Policy</code> -- the JSON serialization of the
     * topic's access control policy</li>
      <li>
<code>DisplayName</code> -- the
     * human-readable name used in the "From" field for notifications to email and
     * email-json endpoints</li>
      <li>
<code>SubscriptionsPending</code> -- the
     * number of subscriptions pending confirmation on this topic</li>
     
     * <li>
<code>SubscriptionsConfirmed</code> -- the number of confirmed
     * subscriptions on this topic</li>
      <li>
<code>SubscriptionsDeleted</code> --
...
<code>DeliveryPolicy</code> -- the JSON serialization of the topic's
     * delivery policy</li>
      <li>
<code>EffectiveDeliveryPolicy</code> -- the JSON
