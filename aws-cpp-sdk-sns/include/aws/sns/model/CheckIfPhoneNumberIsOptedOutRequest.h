...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CheckIfPhoneNumberIsOptedOutRequest> Clone() const
    {
      return Aws::MakeUnique<CheckIfPhoneNumberIsOptedOutRequest>(GetServiceRequestName(), *this);
    }
