...
namespace Model
{
  ...
  /**
   */
  class AWS_SNS_API VerifySMSSandboxPhoneNumberRequest : public SNSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<VerifySMSSandboxPhoneNumberRequest> Clone() const
    {
      return Aws::MakeUnique<VerifySMSSandboxPhoneNumberRequest>(GetServiceRequestName(), *this);
    }
