...
namespace Model
{
  ...
  public:
    ...
    <ul>
      <li>
<code>SubscriptionArn</code> -- the
     * subscription's ARN</li>
      <li>
<code>TopicArn</code> -- the topic ARN that
     * the subscription is associated with</li>
      <li>
<code>Owner</code> -- the
     * AWS account ID of the subscription's owner</li>
...
<code>EffectiveDeliveryPolicy</code> -- the JSON
     * serialization of the effective delivery policy that takes 
    into account the
     * topic delivery policy and account system defaults</li>
    </ul>
     */
