...
namespace Model
{
  ...
  public:
    ...
    <ul>
      ...
      <li>
<code>CustomUserData</code> --
     * arbitrary user data to associate with the endpoint. Amazon SNS does not use this
     * data. The data must be in UTF-8 format and less than 2KB.</li>
...
<code>Enabled</code> -- flag that enables/disables delivery to the
     ...
     * indicates to Amazon SNS that the endpoint is invalid. 
        Users can set it
...
<code>Token</code> -- device token, also referred to as a registration id,
     * for an app and mobile device. 
        This is returned from the notification
