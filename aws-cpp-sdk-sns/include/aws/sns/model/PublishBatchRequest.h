...
namespace Model
{
  ...
  /**
   */
  class AWS_SNS_API PublishBatchRequest : public SNSRequest
  {
  public:
    PublishBatchRequest();
    ...
    */
    virtual Aws::UniquePtr<PublishBatchRequest> Clone() const
    {
      return Aws::MakeUnique<PublishBatchRequest>(GetServiceRequestName(), *this);
    }
