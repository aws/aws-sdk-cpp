...
namespace Model
{
  ...
  /**
   */
  class AWS_SNS_API GetDataProtectionPolicyRequest : public SNSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDataProtectionPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetDataProtectionPolicyRequest>(GetServiceRequestName(), *this);
    }
