...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>Attributes include the following:</p> <ul> <li><p><code>CustomUserData</code>
     * -- arbitrary user data to associate with the endpoint. Amazon SNS does not use
     * this data. The data must be in UTF-8 format and less than 2KB.</p></li>
     ...
     * true, typically after updating Token.</p></li> <li><p><code>Token</code> --
     ...
     * device are registered with the notification service.</p></li> </ul>
     */
