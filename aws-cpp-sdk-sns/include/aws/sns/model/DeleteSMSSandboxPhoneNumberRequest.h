...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSMSSandboxPhoneNumberRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSMSSandboxPhoneNumberRequest>(GetServiceRequestName(), *this);
    }
