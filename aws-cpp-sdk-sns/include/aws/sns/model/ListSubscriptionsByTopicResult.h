...
namespace Model
{
  ...
  public:
     ...
     * <p>A list of subscriptions.</p>
     */
    inline ListSubscriptionsByTopicResult& WithSubscriptions(Aws::Vector<Subscription>&& value) { SetSubscriptions(value); return *this;}
     ...
     * <p>A list of subscriptions.</p>
     */
    inline ListSubscriptionsByTopicResult& AddSubscriptions(Subscription&& value) { m_subscriptions.push_back(value); return *this; }
     ...
     * retrieve.</p>
     */
    inline ListSubscriptionsByTopicResult& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
    ...
    inline ListSubscriptionsByTopicResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
