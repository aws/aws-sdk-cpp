...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSMSSandboxPhoneNumberRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSMSSandboxPhoneNumberRequest>(GetServiceRequestName(), *this);
    }
