...
namespace Model
{
  ...
  public:
     ...
     * the message dwell time, and other information.</p>
     * <p><code>DeliveryStatusSuccessSamplingRate</code> – The percentage of successful
     ...
     * successful deliveries, set it to <code>10</code>.</p>
     * <p><code>DefaultSenderID</code> – A string, such as your business brand, that is
     ...
     * values:</p> <ul> <li> <p><code>Promotional</code> – Noncritical messages, such
     * as marketing messages. Amazon SNS optimizes the message delivery to incur the
     * lowest cost.</p> </li> <li> <p><code>Transactional</code> – (Default) Critical
     * messages that support customer transactions, such as one-time passcodes for
     * multi-factor authentication. Amazon SNS optimizes the message delivery to
     * achieve the highest reliability.</p> </li> </ul>
     * <p><code>UsageReportS3Bucket</code> – The name of the Amazon S3 bucket to
     * receive daily SMS usage reports from Amazon SNS. Each day, Amazon SNS will
     * deliver a usage report as a CSV file to the bucket. The report includes the
     * following information for each SMS message that was successfully delivered by
     * your account:</p> <ul> <li> <p>Time that the message was published (in UTC)</p>
     * </li> <li> <p>Message ID</p> </li> <li> <p>Destination phone number</p> </li>
     * <li> <p>Message type</p> </li> <li> <p>Delivery status</p> </li> <li> <p>Message
