...
Aws::String SNSEndpointRules::GetRulesAsString()
{
    return Aws::String(SNSEndpointRules::Rules.begin(), SNSEndpointRules::Rules.end());
}

const Aws::Vector<char> SNSEndpointRules::Rules = {
...
':','"','h','t','t','p','s',':','/','/','s','n','s','.','u','s','-','g','o','v','-','w','e','s','t',
...
'/','s','n','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
