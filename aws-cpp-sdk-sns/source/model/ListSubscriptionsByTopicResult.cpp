...
ListSubscriptionsByTopicResult& ListSubscriptionsByTopicResult::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  if (!rootNode.IsNull() && (rootNode.GetName() != "ListSubscriptionsByTopicResult"))
  {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::SNS::Model::ListSubscriptionsByTopicResult", "x-amzn-request-id: " << m_responseMetadata.GetRequestId() );
  }
  return *this;
}
