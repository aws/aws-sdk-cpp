...
#include <aws/ssmsap/model/ApplicationStatus.h>
...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/ssmsap-2018-05-10/Application">AWS
   * API Reference</a></p>
   */
  class AWS_SSMSAP_API Application
  {
  public:
    Application();
