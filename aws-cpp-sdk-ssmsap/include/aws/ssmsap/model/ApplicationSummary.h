...
#include <aws/ssmsap/model/ApplicationType.h>
...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/ssmsap-2018-05-10/ApplicationSummary">AWS
   * API Reference</a></p>
   */
  class AWS_SSMSAP_API ApplicationSummary
  {
  public:
    ApplicationSummary();
