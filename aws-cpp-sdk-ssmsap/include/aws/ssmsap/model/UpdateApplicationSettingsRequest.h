...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMSAP_API UpdateApplicationSettingsRequest : public SsmSapRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateApplicationSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateApplicationSettingsRequest>(GetServiceRequestName(), *this);
    }
