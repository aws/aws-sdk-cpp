...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMSAP_API RegisterApplicationRequest : public SsmSapRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<RegisterApplicationRequest>(GetServiceRequestName(), *this);
    }
