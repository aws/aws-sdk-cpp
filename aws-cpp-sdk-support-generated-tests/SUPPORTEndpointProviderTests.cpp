...
using SupportResolveEndpointOutcome = Aws::Support::Endpoint::SupportEndpointProvider::SupportResolveEndpointOutcome;
...
void ValidateOutcome(const SupportResolveEndpointOutcome& outcome, const SupportEndpointProviderEndpointTestCase::Expect& expect)
{
