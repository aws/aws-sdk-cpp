...
Aws::String ConnectCasesEndpointRules::GetRulesAsString()
{
    return Aws::String(ConnectCasesEndpointRules::Rules.begin(), ConnectCasesEndpointRules::Rules.end());
}

const Aws::Vector<char> ConnectCasesEndpointRules::Rules = {
