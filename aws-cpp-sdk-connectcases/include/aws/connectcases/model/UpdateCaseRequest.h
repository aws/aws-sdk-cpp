...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API UpdateCaseRequest : public ConnectCasesRequest
  {
  public:
    UpdateCaseRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateCaseRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCaseRequest>(GetServiceRequestName(), *this);
    }
