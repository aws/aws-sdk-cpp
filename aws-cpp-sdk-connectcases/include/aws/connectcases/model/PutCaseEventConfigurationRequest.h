...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API PutCaseEventConfigurationRequest : public ConnectCasesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutCaseEventConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutCaseEventConfigurationRequest>(GetServiceRequestName(), *this);
    }
