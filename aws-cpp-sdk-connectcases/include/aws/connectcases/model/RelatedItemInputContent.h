...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCASES_API RelatedItemInputContent
  {
  public:
    RelatedItemInputContent();
    RelatedItemInputContent(Aws::Utils::Json::JsonView jsonValue);
    RelatedItemInputContent& operator=(Aws::Utils::Json::JsonView jsonValue);
