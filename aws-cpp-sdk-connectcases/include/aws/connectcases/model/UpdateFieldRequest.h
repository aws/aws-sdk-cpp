...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API UpdateFieldRequest : public ConnectCasesRequest
  {
  public:
    UpdateFieldRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateFieldRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFieldRequest>(GetServiceRequestName(), *this);
    }
