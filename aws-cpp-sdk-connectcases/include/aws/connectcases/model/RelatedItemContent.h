...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCASES_API RelatedItemContent
  {
  public:
    RelatedItemContent();
    RelatedItemContent(Aws::Utils::Json::JsonView jsonValue);
    RelatedItemContent& operator=(Aws::Utils::Json::JsonView jsonValue);
