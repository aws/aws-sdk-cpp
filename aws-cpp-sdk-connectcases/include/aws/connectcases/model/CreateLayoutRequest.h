...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API CreateLayoutRequest : public ConnectCasesRequest
  {
  public:
    CreateLayoutRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateLayoutRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLayoutRequest>(GetServiceRequestName(), *this);
    }
