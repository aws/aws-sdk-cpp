...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API GetLayoutRequest : public ConnectCasesRequest
  {
  public:
    GetLayoutRequest();
    ...
    */
    virtual Aws::UniquePtr<GetLayoutRequest> Clone() const
    {
      return Aws::MakeUnique<GetLayoutRequest>(GetServiceRequestName(), *this);
    }
