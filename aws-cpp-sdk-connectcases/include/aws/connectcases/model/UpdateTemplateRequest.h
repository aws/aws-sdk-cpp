...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API UpdateTemplateRequest : public ConnectCasesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTemplateRequest>(GetServiceRequestName(), *this);
    }
