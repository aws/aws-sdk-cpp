...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCASES_API SearchRelatedItemsResponseItem
  {
  public:
    SearchRelatedItemsResponseItem();
    SearchRelatedItemsResponseItem(Aws::Utils::Json::JsonView jsonValue);
    SearchRelatedItemsResponseItem& operator=(Aws::Utils::Json::JsonView jsonValue);
