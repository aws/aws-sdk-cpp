...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API SearchCasesRequest : public ConnectCasesRequest
  {
  public:
    SearchCasesRequest();
    ...
    */
    virtual Aws::UniquePtr<SearchCasesRequest> Clone() const
    {
      return Aws::MakeUnique<SearchCasesRequest>(GetServiceRequestName(), *this);
    }
