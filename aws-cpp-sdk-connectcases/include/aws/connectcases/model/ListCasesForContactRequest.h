...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API ListCasesForContactRequest : public ConnectCasesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCasesForContactRequest> Clone() const
    {
      return Aws::MakeUnique<ListCasesForContactRequest>(GetServiceRequestName(), *this);
    }
