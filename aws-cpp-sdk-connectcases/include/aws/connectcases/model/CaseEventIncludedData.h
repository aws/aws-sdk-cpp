...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCASES_API CaseEventIncludedData
  {
  public:
    CaseEventIncludedData();
    CaseEventIncludedData(Aws::Utils::Json::JsonView jsonValue);
    CaseEventIncludedData& operator=(Aws::Utils::Json::JsonView jsonValue);
