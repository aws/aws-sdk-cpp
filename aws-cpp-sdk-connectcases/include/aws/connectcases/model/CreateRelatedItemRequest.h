...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API CreateRelatedItemRequest : public ConnectCasesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateRelatedItemRequest> Clone() const
    {
      return Aws::MakeUnique<CreateRelatedItemRequest>(GetServiceRequestName(), *this);
    }
