...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API ListFieldOptionsRequest : public ConnectCasesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFieldOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFieldOptionsRequest>(GetServiceRequestName(), *this);
    }
