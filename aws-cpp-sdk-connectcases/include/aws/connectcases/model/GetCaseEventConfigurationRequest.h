...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API GetCaseEventConfigurationRequest : public ConnectCasesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCaseEventConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetCaseEventConfigurationRequest>(GetServiceRequestName(), *this);
    }
