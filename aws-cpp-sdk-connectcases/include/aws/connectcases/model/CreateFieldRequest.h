...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API CreateFieldRequest : public ConnectCasesRequest
  {
  public:
    CreateFieldRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateFieldRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFieldRequest>(GetServiceRequestName(), *this);
    }
