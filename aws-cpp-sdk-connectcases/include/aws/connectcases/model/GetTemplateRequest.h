...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API GetTemplateRequest : public ConnectCasesRequest
  {
  public:
    GetTemplateRequest();
    ...
    */
    virtual Aws::UniquePtr<GetTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetTemplateRequest>(GetServiceRequestName(), *this);
    }
