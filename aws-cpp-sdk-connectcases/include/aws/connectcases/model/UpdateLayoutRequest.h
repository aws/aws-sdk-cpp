...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API UpdateLayoutRequest : public ConnectCasesRequest
  {
  public:
    UpdateLayoutRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateLayoutRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLayoutRequest>(GetServiceRequestName(), *this);
    }
