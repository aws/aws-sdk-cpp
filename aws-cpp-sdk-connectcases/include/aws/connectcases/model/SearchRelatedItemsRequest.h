...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API SearchRelatedItemsRequest : public ConnectCasesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchRelatedItemsRequest> Clone() const
    {
      return Aws::MakeUnique<SearchRelatedItemsRequest>(GetServiceRequestName(), *this);
    }
