...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API GetCaseRequest : public ConnectCasesRequest
  {
  public:
    GetCaseRequest();
    ...
    */
    virtual Aws::UniquePtr<GetCaseRequest> Clone() const
    {
      return Aws::MakeUnique<GetCaseRequest>(GetServiceRequestName(), *this);
    }
