...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCASES_API SearchCasesResponseItem
  {
  public:
    SearchCasesResponseItem();
    SearchCasesResponseItem(Aws::Utils::Json::JsonView jsonValue);
    SearchCasesResponseItem& operator=(Aws::Utils::Json::JsonView jsonValue);
