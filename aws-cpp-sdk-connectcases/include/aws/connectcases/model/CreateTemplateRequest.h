...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API CreateTemplateRequest : public ConnectCasesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTemplateRequest>(GetServiceRequestName(), *this);
    }
