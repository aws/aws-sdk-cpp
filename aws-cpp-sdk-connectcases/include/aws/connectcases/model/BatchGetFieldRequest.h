...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCASES_API BatchGetFieldRequest : public ConnectCasesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetFieldRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetFieldRequest>(GetServiceRequestName(), *this);
    }
