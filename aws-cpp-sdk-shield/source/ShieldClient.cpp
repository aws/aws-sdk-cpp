...
using ResolveEndpointOutcome = Aws::Shield::Endpoint::ShieldEndpointProvider::ShieldResolveEndpointOutcome;
...
ShieldClient::ShieldClient(const Client::ClientConfiguration& clientConfiguration,
                           std::shared_ptr<Endpoint::ShieldEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ShieldErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Shield::Endpoint::ShieldEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
