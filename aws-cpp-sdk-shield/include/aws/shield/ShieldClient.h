...
namespace Shield
{
  ...
  class AWS_SHIELD_API ShieldClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ShieldClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                     std::shared_ptr<Endpoint::ShieldEndpointProvider> endpointProvider = Aws::MakeShared<Shield::Endpoint::ShieldEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ShieldEndpointProvider> m_endpointProvider;
  };
