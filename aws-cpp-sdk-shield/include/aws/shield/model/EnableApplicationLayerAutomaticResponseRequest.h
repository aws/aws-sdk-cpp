...
namespace Model
{
  ...
  /**
   */
  class AWS_SHIELD_API EnableApplicationLayerAutomaticResponseRequest : public ShieldRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableApplicationLayerAutomaticResponseRequest> Clone() const
    {
      return Aws::MakeUnique<EnableApplicationLayerAutomaticResponseRequest>(GetServiceRequestName(), *this);
    }
