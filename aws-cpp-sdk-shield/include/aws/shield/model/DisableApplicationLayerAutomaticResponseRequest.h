...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableApplicationLayerAutomaticResponseRequest> Clone() const
    {
      return Aws::MakeUnique<DisableApplicationLayerAutomaticResponseRequest>(GetServiceRequestName(), *this);
    }
