...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEmergencyContactSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEmergencyContactSettingsRequest>(GetServiceRequestName(), *this);
    }
