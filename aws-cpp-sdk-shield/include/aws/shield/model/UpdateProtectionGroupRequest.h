...
namespace Model
{
  ...
  /**
   */
  class AWS_SHIELD_API UpdateProtectionGroupRequest : public ShieldRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateProtectionGroupRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateProtectionGroupRequest>(GetServiceRequestName(), *this);
    }
