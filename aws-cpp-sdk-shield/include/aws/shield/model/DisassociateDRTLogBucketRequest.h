...
namespace Model
{
  ...
  /**
   */
  class AWS_SHIELD_API DisassociateDRTLogBucketRequest : public ShieldRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateDRTLogBucketRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateDRTLogBucketRequest>(GetServiceRequestName(), *this);
    }
