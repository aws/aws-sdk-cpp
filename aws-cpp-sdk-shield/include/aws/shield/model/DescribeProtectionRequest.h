...
namespace Model
{
  ...
  /**
   */
  class AWS_SHIELD_API DescribeProtectionRequest : public ShieldRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeProtectionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeProtectionRequest>(GetServiceRequestName(), *this);
    }
