...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateEmergencyContactSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateEmergencyContactSettingsRequest>(GetServiceRequestName(), *this);
    }
