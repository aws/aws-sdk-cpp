...
namespace Model
{
  ...
  /**
   */
  class AWS_SHIELD_API DeleteProtectionGroupRequest : public ShieldRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteProtectionGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteProtectionGroupRequest>(GetServiceRequestName(), *this);
    }
