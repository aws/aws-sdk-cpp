...
namespace Model
{
  ...
  /**
   */
  class AWS_SHIELD_API UpdateApplicationLayerAutomaticResponseRequest : public ShieldRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateApplicationLayerAutomaticResponseRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateApplicationLayerAutomaticResponseRequest>(GetServiceRequestName(), *this);
    }
