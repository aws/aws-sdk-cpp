...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResourcesInProtectionGroupRequest> Clone() const
    {
      return Aws::MakeUnique<ListResourcesInProtectionGroupRequest>(GetServiceRequestName(), *this);
    }
