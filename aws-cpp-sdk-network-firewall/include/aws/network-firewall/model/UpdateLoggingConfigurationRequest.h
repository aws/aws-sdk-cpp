...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKFIREWALL_API UpdateLoggingConfigurationRequest : public NetworkFirewallRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateLoggingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLoggingConfigurationRequest>(GetServiceRequestName(), *this);
    }
