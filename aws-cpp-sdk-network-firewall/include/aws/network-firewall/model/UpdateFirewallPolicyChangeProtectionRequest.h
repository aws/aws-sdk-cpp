...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFirewallPolicyChangeProtectionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFirewallPolicyChangeProtectionRequest>(GetServiceRequestName(), *this);
    }
