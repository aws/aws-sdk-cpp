...
namespace Model
{
  class AWS_NETWORKFIREWALL_API DescribeFirewallPolicyResult
  {
  public:
    ...
    DescribeFirewallPolicyResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
