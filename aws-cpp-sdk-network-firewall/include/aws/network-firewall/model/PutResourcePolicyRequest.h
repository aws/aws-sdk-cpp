...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKFIREWALL_API PutResourcePolicyRequest : public NetworkFirewallRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutResourcePolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutResourcePolicyRequest>(GetServiceRequestName(), *this);
    }
