...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKFIREWALL_API DescribeFirewallPolicyRequest : public NetworkFirewallRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFirewallPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFirewallPolicyRequest>(GetServiceRequestName(), *this);
    }
