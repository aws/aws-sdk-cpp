...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFirewallDeleteProtectionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFirewallDeleteProtectionRequest>(GetServiceRequestName(), *this);
    }
