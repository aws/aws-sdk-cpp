...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKFIREWALL_API DescribeRuleGroupRequest : public NetworkFirewallRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRuleGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRuleGroupRequest>(GetServiceRequestName(), *this);
    }
