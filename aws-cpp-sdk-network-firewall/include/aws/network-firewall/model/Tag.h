...
namespace Model
{
  ...
  /**
   * <p>A key:value pair associated with an AWS resource. The key:value pair can be
   ...
   * tags to each AWS resource. </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/network-firewall-2020-11-12/Tag">AWS
   * API Reference</a></p>
   */
  class AWS_NETWORKFIREWALL_API Tag
  {
  public:
    Tag();
