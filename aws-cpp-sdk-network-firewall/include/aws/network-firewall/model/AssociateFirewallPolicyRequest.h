...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKFIREWALL_API AssociateFirewallPolicyRequest : public NetworkFirewallRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateFirewallPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateFirewallPolicyRequest>(GetServiceRequestName(), *this);
    }
