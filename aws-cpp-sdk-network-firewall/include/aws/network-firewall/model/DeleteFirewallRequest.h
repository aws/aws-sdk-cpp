...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKFIREWALL_API DeleteFirewallRequest : public NetworkFirewallRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFirewallRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFirewallRequest>(GetServiceRequestName(), *this);
    }
