...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFirewallRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFirewallRequest>(GetServiceRequestName(), *this);
    }
     ...
     * ARN or the name, and you can specify both. </p>
     */
    inline DescribeFirewallRequest& WithFirewallArn(const char* value) { SetFirewallArn(value); return *this;}
