...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_NETWORKFIREWALL_API RuleGroupMetadata
  {
  public:
    RuleGroupMetadata();
    RuleGroupMetadata(Aws::Utils::Json::JsonView jsonValue);
    RuleGroupMetadata& operator=(Aws::Utils::Json::JsonView jsonValue);
