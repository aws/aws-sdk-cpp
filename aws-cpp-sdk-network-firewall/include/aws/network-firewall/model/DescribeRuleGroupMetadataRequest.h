...
namespace Model
{
  ...
  /**
   */
  class AWS_NETWORKFIREWALL_API DescribeRuleGroupMetadataRequest : public NetworkFirewallRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRuleGroupMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRuleGroupMetadataRequest>(GetServiceRequestName(), *this);
    }
