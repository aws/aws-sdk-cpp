...
using ResolveEndpointOutcome = Aws::NetworkFirewall::Endpoint::NetworkFirewallEndpointProvider::NetworkFirewallResolveEndpointOutcome;
...
NetworkFirewallClient::NetworkFirewallClient(const Client::ClientConfiguration& clientConfiguration,
                                             std::shared_ptr<Endpoint::NetworkFirewallEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<NetworkFirewallErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<NetworkFirewall::Endpoint::NetworkFirewallEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
