...
namespace Model
{
  ...
  /**
   */
  class AWS_LAKEFORMATION_API GetTemporaryGlueTableCredentialsRequest : public LakeFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTemporaryGlueTableCredentialsRequest> Clone() const
    {
      return Aws::MakeUnique<GetTemporaryGlueTableCredentialsRequest>(GetServiceRequestName(), *this);
    }
