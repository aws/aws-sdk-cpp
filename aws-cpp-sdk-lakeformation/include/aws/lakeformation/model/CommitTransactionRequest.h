...
namespace Model
{
  ...
  /**
   */
  class AWS_LAKEFORMATION_API CommitTransactionRequest : public LakeFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CommitTransactionRequest> Clone() const
    {
      return Aws::MakeUnique<CommitTransactionRequest>(GetServiceRequestName(), *this);
    }
