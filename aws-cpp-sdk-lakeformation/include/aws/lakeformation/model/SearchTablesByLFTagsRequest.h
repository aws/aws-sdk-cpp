...
namespace Model
{
  ...
  /**
   */
  class AWS_LAKEFORMATION_API SearchTablesByLFTagsRequest : public LakeFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchTablesByLFTagsRequest> Clone() const
    {
      return Aws::MakeUnique<SearchTablesByLFTagsRequest>(GetServiceRequestName(), *this);
    }
