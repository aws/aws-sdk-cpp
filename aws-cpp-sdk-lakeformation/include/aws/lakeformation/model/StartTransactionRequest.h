...
namespace Model
{
  ...
  /**
   */
  class AWS_LAKEFORMATION_API StartTransactionRequest : public LakeFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartTransactionRequest> Clone() const
    {
      return Aws::MakeUnique<StartTransactionRequest>(GetServiceRequestName(), *this);
    }
