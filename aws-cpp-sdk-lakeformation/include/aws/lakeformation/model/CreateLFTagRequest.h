...
namespace Model
{
  ...
  /**
   */
  class AWS_LAKEFORMATION_API CreateLFTagRequest : public LakeFormationRequest
  {
  public:
    CreateLFTagRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateLFTagRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLFTagRequest>(GetServiceRequestName(), *this);
    }
