...
namespace Model
{
  ...
  /**
   */
  class AWS_LAKEFORMATION_API ListDataCellsFilterRequest : public LakeFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDataCellsFilterRequest> Clone() const
    {
      return Aws::MakeUnique<ListDataCellsFilterRequest>(GetServiceRequestName(), *this);
    }
