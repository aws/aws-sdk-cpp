...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTableStorageOptimizerRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTableStorageOptimizerRequest>(GetServiceRequestName(), *this);
    }
