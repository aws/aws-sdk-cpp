...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEffectivePermissionsForPathRequest> Clone() const
    {
      return Aws::MakeUnique<GetEffectivePermissionsForPathRequest>(GetServiceRequestName(), *this);
    }
