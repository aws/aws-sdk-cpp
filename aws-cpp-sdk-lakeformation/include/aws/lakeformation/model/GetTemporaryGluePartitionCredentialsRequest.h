...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTemporaryGluePartitionCredentialsRequest> Clone() const
    {
      return Aws::MakeUnique<GetTemporaryGluePartitionCredentialsRequest>(GetServiceRequestName(), *this);
    }
