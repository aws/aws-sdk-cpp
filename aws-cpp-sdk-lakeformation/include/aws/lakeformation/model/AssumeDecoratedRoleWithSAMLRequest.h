...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssumeDecoratedRoleWithSAMLRequest> Clone() const
    {
      return Aws::MakeUnique<AssumeDecoratedRoleWithSAMLRequest>(GetServiceRequestName(), *this);
    }
