...
namespace Model
{
  ...
  /**
   */
  class AWS_LAKEFORMATION_API GetWorkUnitResultsRequest : public LakeFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetWorkUnitResultsRequest> Clone() const
    {
      return Aws::MakeUnique<GetWorkUnitResultsRequest>(GetServiceRequestName(), *this);
    }
