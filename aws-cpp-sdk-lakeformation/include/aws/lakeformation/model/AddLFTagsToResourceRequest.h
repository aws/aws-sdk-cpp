...
namespace Model
{
  ...
  /**
   */
  class AWS_LAKEFORMATION_API AddLFTagsToResourceRequest : public LakeFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AddLFTagsToResourceRequest> Clone() const
    {
      return Aws::MakeUnique<AddLFTagsToResourceRequest>(GetServiceRequestName(), *this);
    }
