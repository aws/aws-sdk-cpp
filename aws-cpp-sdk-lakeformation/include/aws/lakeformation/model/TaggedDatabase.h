...
namespace Model
{
  ...
  /**
   * <p>A structure describing a database resource with tags.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/lakeformation-2017-03-31/TaggedDatabase">AWS
   * API Reference</a></p>
   */
  class AWS_LAKEFORMATION_API TaggedDatabase
  {
  public:
    TaggedDatabase();
    TaggedDatabase(Aws::Utils::Json::JsonView jsonValue);
    TaggedDatabase& operator=(Aws::Utils::Json::JsonView jsonValue);
