...
namespace Model
{
  ...
  /**
   */
  class AWS_LAKEFORMATION_API CancelTransactionRequest : public LakeFormationRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelTransactionRequest> Clone() const
    {
      return Aws::MakeUnique<CancelTransactionRequest>(GetServiceRequestName(), *this);
    }
