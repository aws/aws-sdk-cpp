...
namespace Model
{
  ...
  /**
   */
  class AWS_LAKEFORMATION_API ListLFTagsRequest : public LakeFormationRequest
  {
  public:
    ListLFTagsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListLFTagsRequest> Clone() const
    {
      return Aws::MakeUnique<ListLFTagsRequest>(GetServiceRequestName(), *this);
    }
