...
namespace Model
{
  ...
  /**
   */
  class AWS_LAKEFORMATION_API UpdateLFTagRequest : public LakeFormationRequest
  {
  public:
    UpdateLFTagRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateLFTagRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLFTagRequest>(GetServiceRequestName(), *this);
    }
