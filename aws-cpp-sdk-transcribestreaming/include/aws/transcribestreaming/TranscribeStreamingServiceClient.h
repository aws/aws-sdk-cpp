...
namespace TranscribeStreamingService
{
  ...
  class AWS_TRANSCRIBESTREAMINGSERVICE_API TranscribeStreamingServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        TranscribeStreamingServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                         std::shared_ptr<Endpoint::TranscribeStreamingServiceEndpointProvider> endpointProvider = Aws::MakeShared<TranscribeStreamingService::Endpoint::TranscribeStreamingServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::TranscribeStreamingServiceEndpointProvider> m_endpointProvider;
  };
