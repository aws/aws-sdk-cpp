...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_TRANSCRIBESTREAMINGSERVICE_API UtteranceEvent
  {
  public:
    UtteranceEvent();
    UtteranceEvent(Aws::Utils::Json::JsonView jsonValue);
    UtteranceEvent& operator=(Aws::Utils::Json::JsonView jsonValue);
