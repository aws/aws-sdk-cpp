...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartMedicalStreamTranscriptionRequest> Clone() const
    {
      return Aws::MakeUnique<StartMedicalStreamTranscriptionRequest>(GetServiceRequestName(), *this);
    }
