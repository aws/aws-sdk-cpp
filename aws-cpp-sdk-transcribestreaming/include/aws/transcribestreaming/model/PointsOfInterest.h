...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_TRANSCRIBESTREAMINGSERVICE_API PointsOfInterest
  {
  public:
    PointsOfInterest();
    PointsOfInterest(Aws::Utils::Json::JsonView jsonValue);
    PointsOfInterest& operator=(Aws::Utils::Json::JsonView jsonValue);
