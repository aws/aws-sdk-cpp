...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CODECATALYST_API ProjectListFilter
  {
  public:
    ProjectListFilter();
    ProjectListFilter(Aws::Utils::Json::JsonView jsonValue);
    ProjectListFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
