...
StartDevEnvironmentResult::StartDevEnvironmentResult() : 
...
StartDevEnvironmentResult& StartDevEnvironmentResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
