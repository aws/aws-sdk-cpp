...
namespace FinSpaceData
{
  ...
  class AWS_FINSPACEDATA_API FinSpaceDataClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        FinSpaceDataClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::FinSpaceDataEndpointProvider> endpointProvider = Aws::MakeShared<FinSpaceData::Endpoint::FinSpaceDataEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::FinSpaceDataEndpointProvider> m_endpointProvider;
  };
