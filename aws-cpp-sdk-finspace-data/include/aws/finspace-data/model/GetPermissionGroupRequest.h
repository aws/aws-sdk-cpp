...
namespace Model
{
  ...
  /**
   */
  class AWS_FINSPACEDATA_API GetPermissionGroupRequest : public FinSpaceDataRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPermissionGroupRequest> Clone() const
    {
      return Aws::MakeUnique<GetPermissionGroupRequest>(GetServiceRequestName(), *this);
    }
