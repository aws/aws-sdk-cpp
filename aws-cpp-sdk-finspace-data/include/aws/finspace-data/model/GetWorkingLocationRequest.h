...
namespace Model
{
  ...
  /**
   */
  class AWS_FINSPACEDATA_API GetWorkingLocationRequest : public FinSpaceDataRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetWorkingLocationRequest> Clone() const
    {
      return Aws::MakeUnique<GetWorkingLocationRequest>(GetServiceRequestName(), *this);
    }
