...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_FINSPACEDATA_API ChangesetSummary
  {
  public:
    ChangesetSummary();
    ChangesetSummary(Aws::Utils::Json::JsonView jsonValue);
    ChangesetSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
