...
namespace Model
{
  ...
  /**
   */
  class AWS_FINSPACEDATA_API ListPermissionGroupsByUserRequest : public FinSpaceDataRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPermissionGroupsByUserRequest> Clone() const
    {
      return Aws::MakeUnique<ListPermissionGroupsByUserRequest>(GetServiceRequestName(), *this);
    }
