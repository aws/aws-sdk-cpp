...
namespace Model
{
  ...
  /**
   * <p>Error message.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/finspace-2020-07-13/ErrorInfo">AWS
   * API Reference</a></p>
   */
  class AWS_FINSPACEDATA_API ErrorInfo
  {
  public:
    ErrorInfo();
     ...
     * occurred.</p> </li> <li> <p> <code>CANCELLED</code> - A user recoverable error
     * has occurred.</p> </li> </ul>
     */
     ...
     * has occurred.</p> </li> </ul>
     */
    inline ErrorInfo& WithErrorCategory(const ErrorCategory& value) { SetErrorCategory(value); return *this;}
     ...
     * has occurred.</p> </li> </ul>
     */
    inline ErrorInfo& WithErrorCategory(ErrorCategory&& value) { SetErrorCategory(std::move(value)); return *this;}
