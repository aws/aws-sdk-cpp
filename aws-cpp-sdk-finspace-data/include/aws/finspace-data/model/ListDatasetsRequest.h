...
namespace Model
{
  ...
  /**
   * Request for the ListDatasets operation.<p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/finspace-2020-07-13/ListDatasetsRequest">AWS
   * API Reference</a></p>
   */
  class AWS_FINSPACEDATA_API ListDatasetsRequest : public FinSpaceDataRequest
  {
  public:
    ListDatasetsRequest();
