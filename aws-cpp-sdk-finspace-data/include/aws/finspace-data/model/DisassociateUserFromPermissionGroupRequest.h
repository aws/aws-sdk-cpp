...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateUserFromPermissionGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateUserFromPermissionGroupRequest>(GetServiceRequestName(), *this);
    }
