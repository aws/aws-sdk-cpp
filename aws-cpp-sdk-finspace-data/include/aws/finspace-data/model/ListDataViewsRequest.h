...
namespace Model
{
  ...
  /**
   * Request for a list data views.<p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDataViewsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDataViewsRequest>(GetServiceRequestName(), *this);
    }
     ...
     * <p>The unique identifier of the Dataset for which to retrieve Dataviews.</p>
     */
    inline ListDataViewsRequest& WithDatasetId(const Aws::String& value) { SetDatasetId(value); return *this;}

    /**
     * <p>The unique identifier of the Dataset for which to retrieve Dataviews.</p>
     */
    inline ListDataViewsRequest& WithDatasetId(Aws::String&& value) { SetDatasetId(std::move(value)); return *this;}

    /**
     * <p>The unique identifier of the Dataset for which to retrieve Dataviews.</p>
     */
    inline ListDataViewsRequest& WithDatasetId(const char* value) { SetDatasetId(value); return *this;}
     ...
     * <p>The maximum number of results per page.</p>
     */
    inline ListDataViewsRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
