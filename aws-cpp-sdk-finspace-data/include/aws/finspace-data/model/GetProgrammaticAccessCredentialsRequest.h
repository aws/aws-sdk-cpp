...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetProgrammaticAccessCredentialsRequest> Clone() const
    {
      return Aws::MakeUnique<GetProgrammaticAccessCredentialsRequest>(GetServiceRequestName(), *this);
    }
