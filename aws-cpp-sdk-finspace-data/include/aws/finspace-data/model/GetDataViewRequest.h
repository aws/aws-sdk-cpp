...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_FINSPACEDATA_API GetDataViewRequest : public FinSpaceDataRequest
  {
  public:
    GetDataViewRequest();
    ...
    */
    virtual Aws::UniquePtr<GetDataViewRequest> Clone() const
    {
      return Aws::MakeUnique<GetDataViewRequest>(GetServiceRequestName(), *this);
    }
