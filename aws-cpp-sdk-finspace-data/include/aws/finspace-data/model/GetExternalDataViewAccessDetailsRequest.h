...
namespace Model
{
  ...
  /**
   */
  class AWS_FINSPACEDATA_API GetExternalDataViewAccessDetailsRequest : public FinSpaceDataRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetExternalDataViewAccessDetailsRequest> Clone() const
    {
      return Aws::MakeUnique<GetExternalDataViewAccessDetailsRequest>(GetServiceRequestName(), *this);
    }
