...
using ResolveEndpointOutcome = Aws::FinSpaceData::Endpoint::FinSpaceDataEndpointProvider::FinSpaceDataResolveEndpointOutcome;
...
FinSpaceDataClient::FinSpaceDataClient(const Client::ClientConfiguration& clientConfiguration,
                                       std::shared_ptr<Endpoint::FinSpaceDataEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<FinSpaceDataErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<FinSpaceData::Endpoint::FinSpaceDataEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
