...
GetBucketLifecycleResult::GetBucketLifecycleResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

GetBucketLifecycleResult& GetBucketLifecycleResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
