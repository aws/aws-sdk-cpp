...
GetBucketAclResult::GetBucketAclResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

GetBucketAclResult& GetBucketAclResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
