...
PublicAccessBlockConfiguration& PublicAccessBlockConfiguration::operator =(const XmlNode& xmlNode)
{
  ...
  if(!resultNode.IsNull())
  {
    ...
    {
      m_blockPublicAcls = StringUtils::ConvertToBool(StringUtils::Trim(blockPublicAclsNode.GetText().c_str()).c_str());
    ...
    {
      m_ignorePublicAcls = StringUtils::ConvertToBool(StringUtils::Trim(ignorePublicAclsNode.GetText().c_str()).c_str());
    ...
    {
      m_blockPublicPolicy = StringUtils::ConvertToBool(StringUtils::Trim(blockPublicPolicyNode.GetText().c_str()).c_str());
    ...
    {
      m_restrictPublicBuckets = StringUtils::ConvertToBool(StringUtils::Trim(restrictPublicBucketsNode.GetText().c_str()).c_str());
