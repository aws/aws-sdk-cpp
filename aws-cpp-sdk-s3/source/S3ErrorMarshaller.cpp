...
Aws::String S3ErrorMarshaller::ExtractRegion(const Client::AWSError<Client::CoreErrors>& error) const
{
...
Aws::String S3ErrorMarshaller::ExtractEndpoint(const Client::AWSError<Client::CoreErrors>& error) const
{
  const auto& headers = error.GetResponseHeaders();
