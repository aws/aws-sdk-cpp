...
namespace Model
{
  ...
  public:
    ...
    inline AbortMultipartUploadRequest& WithBucket(Aws::String&& value) { SetBucket(value); return *this;}
    ...
    inline AbortMultipartUploadRequest& WithKey(Aws::String&& value) { SetKey(value); return *this;}
