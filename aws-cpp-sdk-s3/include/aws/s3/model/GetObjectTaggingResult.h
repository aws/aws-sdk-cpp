...
namespace Model
{
  ...
  public:
    ...
    inline GetObjectTaggingResult& WithVersionId(Aws::String&& value) { SetVersionId(value); return *this;}
    ...
    inline GetObjectTaggingResult& WithTagSet(Aws::Vector<Tag>&& value) { SetTagSet(value); return *this;}

    
    inline GetObjectTaggingResult& AddTagSet(const Tag& value) { m_tagSet.push_back(value); return *this; }

    
    inline GetObjectTaggingResult& AddTagSet(Tag&& value) { m_tagSet.push_back(value); return *this; }
