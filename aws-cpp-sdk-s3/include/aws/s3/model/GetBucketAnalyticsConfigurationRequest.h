...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketAnalyticsConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketAnalyticsConfigurationRequest>(GetServiceRequestName(), *this);
    }
