...
namespace Model
{
  ...
  public:
     ...
     * The name of the bucket containing the metrics configuration to delete.
     */
    inline DeleteBucketMetricsConfigurationRequest& WithBucket(Aws::String&& value) { SetBucket(value); return *this;}
     ...
     * The ID used to identify the metrics configuration.
     */
    inline DeleteBucketMetricsConfigurationRequest& WithId(Aws::String&& value) { SetId(value); return *this;}
