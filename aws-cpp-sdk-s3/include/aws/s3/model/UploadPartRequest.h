...
namespace Model
{
  ...
  public:
     ...
     * encryption key specified in the initiate multipart upload request.
     */
    inline UploadPartRequest& WithSSECustomerKey(const Aws::Utils::ByteBuffer& value) { SetSSECustomerKey(value); return *this;}
     ...
     * encryption key specified in the initiate multipart upload request.
     */
    inline UploadPartRequest& WithSSECustomerKey(Aws::Utils::ByteBuffer&& value) { SetSSECustomerKey(value); return *this;}
