...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBucketAnalyticsConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListBucketAnalyticsConfigurationsRequest>(GetServiceRequestName(), *this);
    }
