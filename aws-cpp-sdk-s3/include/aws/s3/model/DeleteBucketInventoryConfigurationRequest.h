...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBucketInventoryConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBucketInventoryConfigurationRequest>(GetServiceRequestName(), *this);
    }
