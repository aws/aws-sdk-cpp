...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutBucketAnalyticsConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutBucketAnalyticsConfigurationRequest>(GetServiceRequestName(), *this);
    }
