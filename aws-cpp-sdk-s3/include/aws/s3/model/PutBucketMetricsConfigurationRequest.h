...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutBucketMetricsConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutBucketMetricsConfigurationRequest>(GetServiceRequestName(), *this);
    }
