...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutBucketIntelligentTieringConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutBucketIntelligentTieringConfigurationRequest>(GetServiceRequestName(), *this);
    }
