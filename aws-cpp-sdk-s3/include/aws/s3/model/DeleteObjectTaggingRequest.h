...
namespace Model
{
  ...
  public:
    ...
    inline DeleteObjectTaggingRequest& WithBucket(Aws::String&& value) { SetBucket(value); return *this;}
    ...
    inline DeleteObjectTaggingRequest& WithKey(Aws::String&& value) { SetKey(value); return *this;}
     ...
     * The versionId of the object that the tag-set will be removed from.
     */
    inline DeleteObjectTaggingRequest& WithVersionId(Aws::String&& value) { SetVersionId(value); return *this;}
