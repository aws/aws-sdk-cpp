...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutBucketNotificationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutBucketNotificationConfigurationRequest>(GetServiceRequestName(), *this);
    }
