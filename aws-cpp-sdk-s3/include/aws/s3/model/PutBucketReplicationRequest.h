...
namespace Model
{
  ...
  public:
    ...
    inline PutBucketReplicationRequest& WithBucket(Aws::String&& value) { SetBucket(value); return *this;}
    ...
    inline PutBucketReplicationRequest& WithContentMD5(Aws::String&& value) { SetContentMD5(value); return *this;}
    ...
    inline void SetReplicationConfiguration(ReplicationConfiguration&& value) { m_replicationConfigurationHasBeenSet = true; m_replicationConfiguration = value; }
    ...
    inline PutBucketReplicationRequest& WithReplicationConfiguration(ReplicationConfiguration&& value) { SetReplicationConfiguration(value); return *this;}
