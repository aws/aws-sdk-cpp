...
namespace Model
{
  ...
  public:
    ListObjectsV2Result();
    ListObjectsV2Result(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ListObjectsV2Result& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
