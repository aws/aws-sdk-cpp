...
namespace Model
{
  ...
  public:
     ...
     * The name of the bucket containing the metrics configuration to retrieve.
     */
    inline GetBucketMetricsConfigurationRequest& WithBucket(Aws::String&& value) { SetBucket(value); return *this;}
     ...
     * The ID used to identify the metrics configuration.
     */
    inline GetBucketMetricsConfigurationRequest& WithId(Aws::String&& value) { SetId(value); return *this;}
