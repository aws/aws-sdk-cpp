...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBucketMetricsConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListBucketMetricsConfigurationsRequest>(GetServiceRequestName(), *this);
    }
