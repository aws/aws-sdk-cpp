...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutBucketInventoryConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutBucketInventoryConfigurationRequest>(GetServiceRequestName(), *this);
    }
