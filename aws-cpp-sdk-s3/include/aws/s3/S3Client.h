...
namespace Aws
{
  namespace S3
  {
    ...
    public:
        ...
        */
        S3Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                 std::shared_ptr<Endpoint::S3EndpointProvider> endpointProvider = Aws::MakeShared<S3::Endpoint::S3EndpointProvider>(ALLOCATION_TAG),
    ...
    private:
        ...
        std::shared_ptr<Endpoint::S3EndpointProvider> m_endpointProvider;
