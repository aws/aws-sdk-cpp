...
using CloudDirectoryResolveEndpointOutcome = Aws::CloudDirectory::Endpoint::CloudDirectoryEndpointProvider::CloudDirectoryResolveEndpointOutcome;
...
void ValidateOutcome(const CloudDirectoryResolveEndpointOutcome& outcome, const CloudDirectoryEndpointProviderEndpointTestCase::Expect& expect)
{
