...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>A list of <code class="code">FilteredLogEvent</code> objects representing the
     * matched events from the request.</p>
     */
    ...
    /**
     * <p>A list of <code class="code">SearchedLogStream</code> objects indicating
     * which log streams have been searched in this request and whether each has been
     * searched completely or still has more to be paginated.</p>
     */
