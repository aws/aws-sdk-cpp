...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSubscriptionFiltersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSubscriptionFiltersRequest>(GetServiceRequestName(), *this);
    }
