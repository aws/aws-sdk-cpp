...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDWATCHLOGS_API QueryCompileError
  {
  public:
    QueryCompileError();
    QueryCompileError(Aws::Utils::Json::JsonView jsonValue);
    QueryCompileError& operator=(Aws::Utils::Json::JsonView jsonValue);
