...
namespace Model
{
   ...
   * CloudTrail, or other sources. You can then retrieve the associated log data from
   * CloudWatch Logs using the Amazon CloudWatch console, the CloudWatch Logs
   * commands in the AWS CLI, the CloudWatch Logs API, or the CloudWatch Logs
   * SDK.</p> <p>You can use CloudWatch Logs to:</p> <ul> <li> <p> <b>Monitor Logs
   * from Amazon EC2 Instances in Real-time</b>: You can use CloudWatch Logs to
   ...
   * Logs reports the data to a Amazon CloudWatch metric that you specify.</p> </li>
   * <li> <p> <b>Monitor Amazon CloudTrail Logged Events</b>: You can create alarms
   * in Amazon CloudWatch and receive notifications of particular API activity as
   * captured by CloudTrail and use the notification to perform troubleshooting.</p>
   * </li> <li> <p> <b>Archive Log Data</b>: You can use CloudWatch Logs to store
   ...
   * access the raw log data when you need it.</p> </li> </ul>
   */
    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * task. You can only have one active (<code>RUNNING</code> or
         * <code>PENDING</code>) export task at a time, per account.</p> <p>You can export
         * logs from multiple log groups or multiple time ranges to the same Amazon S3
         * bucket. To separate out log data for each export task, you can specify a prefix
         ...
         * log group:</p> <ul> <li> <p>Log group names can be between 1 and 512 characters
         * long.</p> </li> <li> <p>Allowed characters are a-z, A-Z, 0-9, '_' (underscore),
         * '-' (hyphen), '/' (forward slash), and '.' (period).</p> </li> </ul>
         */
         ...
         * guidelines when naming a log stream:</p> <ul> <li> <p>Log stream names can be
         * between 1 and 512 characters long.</p> </li> <li> <p>The ':' colon character is
         * not allowed.</p> </li> </ul>
         */
        ...
        /**
         * <p>Deletes the log group with the specified name and permanently deletes all the
         * archived log events associated with it.</p>
         */
        ...
        /**
         * <p>Deletes the retention policy of the specified log group. Log events would not
         ...
         * name.</p> <p>By default, this operation returns up to 50 destinations. If there
         * are more destinations to list, the response would contain a
         * <code>nextToken</code> value in the response body. You can also limit the number
         * of destinations returned in the response by specifying the <code>limit</code>
         ...
         * to list, the response would contain a <code>nextToken</code> value in the
         * response body. You can also limit the number of export tasks returned in the
         ...
         * are more log groups to list, the response would contain a <code>nextToken</code>
        ...
        /**
         * <p>Returns all the log streams that are associated with the specified log group.
         * The list returned in the response is ASCII-sorted by log stream name.</p> <p>By
         * default, this operation returns up to 50 log streams. If there are more log
         * streams to list, the response would contain a <code>nextToken</code> value in
         * the response body. You can also limit the number of log streams returned in the
         * response by specifying the <code>limit</code> parameter in the request. This
         * operation has a limit of five transactions per second, after which transactions
         * are throttled.</p>
         */
         ...
         * list returned in the response is ASCII-sorted by filter name.</p> <p>By default,
         * this operation returns up to 50 metric filters. If there are more metric filters
         * to list, the response would contain a <code>nextToken</code> value in the
        ...
        /**
         * <p>Returns all the subscription filters associated with the specified log group.
         * The list returned in the response is ASCII-sorted by filter name.</p> <p>By
         * default, this operation returns up to 50 subscription filters. If there are more
         ...
         * <code>limit</code> parameter in the request.</p>
         */
         ...
         * results on the event <code>timestamp</code>. You can limit the streams searched
         * to an explicit list of <code>logStreamNames</code>.</p> <p>By default, this
         * operation returns as much matching log events as can fit in a response size of
         * 1MB, up to 10,000 log events, or all the events found within a time-bounded scan
         * window. If the response includes a <code>nextToken</code>, then there is more
         * data to search, and the search can be resumed with a new request providing the
         * nextToken. The response will contain a list of <code>searchedLogStreams</code>
         * that contains information about which streams were searched in the request and
         * whether they have been searched completely or require further pagination. The
         * <code>limit</code> parameter in the request can be used to specify the maximum
         * number of events to return in a page.</p>
         */
         ...
         * <code>timestamp</code>.</p> <p>By default, this operation returns as much log
         * events as can fit in a response size of 1MB, up to 10,000 log events. The
         * response will always include a <code>nextForwardToken</code> and a
         * <code>nextBackwardToken</code> in the response body. You can use any of these
         * tokens in subsequent <code>GetLogEvents</code> requests to paginate through
         * events in either forward or backward direction. You can also limit the number of
         * log events returned in the response by specifying the <code>limit</code>
         * parameter in the request.</p>
         */
         ...
         * <code>PutLogEvents</code> requests. Currently, the only supported physical
         * resource is a Amazon Kinesis stream belonging to the same account as the
         * destination.</p> <p>A destination controls what is written to its Amazon Kinesis
         * stream through an access policy. By default, PutDestination does not set any
         * access policy with the destination, which means a cross-account user will not be
         * able to call <code>PutSubscriptionFilter</code> against this destination. To
         * enable that, the destination owner must call <code>PutDestinationPolicy</code>
         * after PutDestination.</p>
         */
         ...
         * does not require a <code>sequenceToken</code>. You can also get the
         * <code>sequenceToken</code> using <a>DescribeLogStreams</a>.</p> <p>The batch of
         ...
         * events in the batch must be in chronological ordered by their
         * <code>timestamp</code>.</p> </li> <li> <p>The maximum number of log events in a
         * batch is 10,000.</p> </li> <li> <p>A batch of log events in a single
         * PutLogEvents request cannot span more than 24 hours. Otherwise, the PutLogEvents
         * operation will fail.</p> </li> </ul>
         */
         ...
         * log events ingested through <code>PutLogEvents</code> requests.</p> <p>The
         * maximum number of metric filters that can be associated with a log group is
         * 100.</p>
         */
         ...
         * log events ingested through <code>PutLogEvents</code> requests and have them
         * delivered to a specific destination. Currently, the supported destinations
         * are:</p> <ul> <li> <p>An Amazon Kinesis stream belonging to the same account as
         * the subscription filter, for same-account delivery.</p> </li> <li> <p> A logical
         * destination (used via an ARN of <code>Destination</code>) belonging to a
         ...
         * delivery.</p> </li> </ul> <p>Currently there can only be one subscription filter
         * associated with a log group.</p>
         */
