...
namespace CloudWatchLogs
{
  ...
  class AWS_CLOUDWATCHLOGS_API CloudWatchLogsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudWatchLogsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::CloudWatchLogsEndpointProvider> endpointProvider = Aws::MakeShared<CloudWatchLogs::Endpoint::CloudWatchLogsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CloudWatchLogsEndpointProvider> m_endpointProvider;
  };
