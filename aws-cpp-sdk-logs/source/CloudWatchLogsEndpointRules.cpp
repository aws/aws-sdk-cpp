...
Aws::String CloudWatchLogsEndpointRules::GetRulesAsString()
{
    return Aws::String(CloudWatchLogsEndpointRules::Rules.begin(), CloudWatchLogsEndpointRules::Rules.end());
}

const Aws::Vector<char> CloudWatchLogsEndpointRules::Rules = {
...
'"',':','"','h','t','t','p','s',':','/','/','l','o','g','s','.','u','s','-','g','o','v','-','w','e',
...
't','p','s',':','/','/','l','o','g','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
