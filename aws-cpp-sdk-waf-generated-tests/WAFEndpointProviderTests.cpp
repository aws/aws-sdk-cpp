...
static const char* ALLOCATION_TAG = "AWSWAFEndpointProviderTests";
using WAFEndpointProvider = Aws::WAF::Endpoint::WAFEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using WAFResolveEndpointOutcome = Aws::WAF::Endpoint::WAFEndpointProvider::WAFResolveEndpointOutcome;
...
class WAFEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct WAFEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<WAFEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
  {"For region aws-global with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://waf.amazonaws.com",
       {/*properties*/{"authSchemes", {EpProp("signingRegion", "us-east-1"), EpProp("name", "sigv4"), EpProp("signingName", "waf")}}},
...
void ValidateOutcome(const WAFResolveEndpointOutcome& outcome, const WAFEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(WAFEndpointProviderTests, EndpointProviderTest)
{
    ...
    const WAFEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<WAFEndpointProvider> endpointProvider = Aws::MakeShared<WAFEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize WAFEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const WAFEndpointProviderEndpointTestCase::OperationParamsFromTest>>
