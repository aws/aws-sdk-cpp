...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVENTS_API UpdateApiDestinationRequest : public CloudWatchEventsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateApiDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateApiDestinationRequest>(GetServiceRequestName(), *this);
    }
