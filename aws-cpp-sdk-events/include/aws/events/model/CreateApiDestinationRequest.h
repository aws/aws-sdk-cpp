...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVENTS_API CreateApiDestinationRequest : public CloudWatchEventsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateApiDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateApiDestinationRequest>(GetServiceRequestName(), *this);
    }
