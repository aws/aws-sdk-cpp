...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVENTS_API UpdateArchiveRequest : public CloudWatchEventsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateArchiveRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateArchiveRequest>(GetServiceRequestName(), *this);
    }
