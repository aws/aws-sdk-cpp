...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVENTS_API ListApiDestinationsRequest : public CloudWatchEventsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListApiDestinationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListApiDestinationsRequest>(GetServiceRequestName(), *this);
    }
