...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHEVENTS_API ListReplaysRequest : public CloudWatchEventsRequest
  {
  public:
    ListReplaysRequest();
    ...
    */
    virtual Aws::UniquePtr<ListReplaysRequest> Clone() const
    {
      return Aws::MakeUnique<ListReplaysRequest>(GetServiceRequestName(), *this);
    }
