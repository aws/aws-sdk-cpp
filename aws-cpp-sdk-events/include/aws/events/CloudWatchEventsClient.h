...
namespace CloudWatchEvents
{
  ...
  class AWS_CLOUDWATCHEVENTS_API CloudWatchEventsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudWatchEventsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::CloudWatchEventsEndpointProvider> endpointProvider = Aws::MakeShared<CloudWatchEvents::Endpoint::CloudWatchEventsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CloudWatchEventsEndpointProvider> m_endpointProvider;
  };
