...
Aws::String CloudWatchEventsEndpointRules::GetRulesAsString()
{
    return Aws::String(CloudWatchEventsEndpointRules::Rules.begin(), CloudWatchEventsEndpointRules::Rules.end());
}

const Aws::Vector<char> CloudWatchEventsEndpointRules::Rules = {
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','e','v','e','n','t','s','.','u','s','-','g','o',
...
'"',',','"','r','u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':',
'[',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t',
'p','s',':','/','/','e','v','e','n','t','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
