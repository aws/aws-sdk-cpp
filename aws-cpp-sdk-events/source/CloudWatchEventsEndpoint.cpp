  ...
  Aws::String ForRegion(Region region)
  {
    switch(region)
    {
     ...
     case Region::US_WEST_1:
        return "events.us-west-1.amazonaws.com";
     case Region::US_WEST_2:
        return "events.us-west-2.amazonaws.com";
     case Region::EU_WEST_1:
        return "events.eu-west-1.amazonaws.com";
     case Region::EU_CENTRAL_1:
        return "events.eu-central-1.amazonaws.com";
     case Region::AP_SOUTHEAST_1:
        return "events.ap-southeast-1.amazonaws.com";
     case Region::AP_SOUTHEAST_2:
        return "events.ap-southeast-2.amazonaws.com";
     case Region::AP_NORTHEAST_1:
        return "events.ap-northeast-1.amazonaws.com";
