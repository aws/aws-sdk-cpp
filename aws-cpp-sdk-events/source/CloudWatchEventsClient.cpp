...
using ResolveEndpointOutcome = Aws::CloudWatchEvents::Endpoint::CloudWatchEventsEndpointProvider::CloudWatchEventsResolveEndpointOutcome;
...
CloudWatchEventsClient::CloudWatchEventsClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::CloudWatchEventsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CloudWatchEventsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CloudWatchEvents::Endpoint::CloudWatchEventsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
