...
using ResolveEndpointOutcome = Aws::TranscribeService::Endpoint::TranscribeServiceEndpointProvider::TranscribeServiceResolveEndpointOutcome;
...
TranscribeServiceClient::TranscribeServiceClient(const Client::ClientConfiguration& clientConfiguration,
                                                 std::shared_ptr<Endpoint::TranscribeServiceEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<TranscribeServiceErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<TranscribeService::Endpoint::TranscribeServiceEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
