...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The date and time the vocabulary was last modified with a text file different
     * from what was previously used.</p>
     */
    ...
    /**
     * <p>The Amazon S3 location where the vocabulary is stored. Use this URI to get
