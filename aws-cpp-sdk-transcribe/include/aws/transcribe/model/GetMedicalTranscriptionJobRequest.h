...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSCRIBESERVICE_API GetMedicalTranscriptionJobRequest : public TranscribeServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMedicalTranscriptionJobRequest> Clone() const
    {
      return Aws::MakeUnique<GetMedicalTranscriptionJobRequest>(GetServiceRequestName(), *this);
    }
