...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetVocabularyRequest> Clone() const
    {
      return Aws::MakeUnique<GetVocabularyRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>The name of the custom vocabulary you want information about. Vocabulary
