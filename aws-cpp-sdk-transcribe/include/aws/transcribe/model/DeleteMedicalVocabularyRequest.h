...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteMedicalVocabularyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteMedicalVocabularyRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>The name of the custom medical vocabulary you want to delete. Vocabulary
