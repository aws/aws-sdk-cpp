...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCallAnalyticsCategoryRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCallAnalyticsCategoryRequest>(GetServiceRequestName(), *this);
    }
