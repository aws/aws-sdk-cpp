...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteMedicalTranscriptionJobRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteMedicalTranscriptionJobRequest>(GetServiceRequestName(), *this);
    }
