...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartMedicalTranscriptionJobRequest> Clone() const
    {
      return Aws::MakeUnique<StartMedicalTranscriptionJobRequest>(GetServiceRequestName(), *this);
    }
