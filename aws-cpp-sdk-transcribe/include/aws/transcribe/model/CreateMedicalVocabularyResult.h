...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The name of the vocabulary. The name must be unique within an AWS account. It
     * is also case-sensitive.</p>
     */
    ...
    /**
     * <p>The language code you chose to describe the entries in your custom
