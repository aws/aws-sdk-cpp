...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetVocabularyFilterRequest> Clone() const
    {
      return Aws::MakeUnique<GetVocabularyFilterRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>The name of the custom vocabulary filter you want information about.
