...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSCRIBESERVICE_API DeleteVocabularyFilterRequest : public TranscribeServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVocabularyFilterRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVocabularyFilterRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>The name of the custom vocabulary filter you want to delete. Vocabulary
