...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateMedicalVocabularyRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateMedicalVocabularyRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>The name of the custom medical vocabulary you want to update. Vocabulary
