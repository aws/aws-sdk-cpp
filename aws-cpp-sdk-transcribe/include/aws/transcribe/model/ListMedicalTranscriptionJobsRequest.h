...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMedicalTranscriptionJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMedicalTranscriptionJobsRequest>(GetServiceRequestName(), *this);
    }
