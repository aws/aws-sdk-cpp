...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCallAnalyticsCategoryRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCallAnalyticsCategoryRequest>(GetServiceRequestName(), *this);
    }
