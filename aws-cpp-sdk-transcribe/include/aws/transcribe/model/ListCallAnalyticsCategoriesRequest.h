...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCallAnalyticsCategoriesRequest> Clone() const
    {
      return Aws::MakeUnique<ListCallAnalyticsCategoriesRequest>(GetServiceRequestName(), *this);
    }
