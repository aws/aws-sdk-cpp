...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSCRIBESERVICE_API GetCallAnalyticsJobRequest : public TranscribeServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCallAnalyticsJobRequest> Clone() const
    {
      return Aws::MakeUnique<GetCallAnalyticsJobRequest>(GetServiceRequestName(), *this);
    }
