...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSCRIBESERVICE_API DeleteCallAnalyticsCategoryRequest : public TranscribeServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCallAnalyticsCategoryRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCallAnalyticsCategoryRequest>(GetServiceRequestName(), *this);
    }
