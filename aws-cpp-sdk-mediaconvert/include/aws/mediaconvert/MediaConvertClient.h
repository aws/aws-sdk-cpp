...
namespace MediaConvert
{
  ...
  class AWS_MEDIACONVERT_API MediaConvertClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MediaConvertClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::MediaConvertEndpointProvider> endpointProvider = Aws::MakeShared<MediaConvert::Endpoint::MediaConvertEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MediaConvertEndpointProvider> m_endpointProvider;
  };
