...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MEDIACONVERT_API HlsRenditionGroupSettings
  {
  public:
    HlsRenditionGroupSettings();
    HlsRenditionGroupSettings(Aws::Utils::Json::JsonView jsonValue);
    HlsRenditionGroupSettings& operator=(Aws::Utils::Json::JsonView jsonValue);
