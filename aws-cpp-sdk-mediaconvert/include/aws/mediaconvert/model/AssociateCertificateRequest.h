...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIACONVERT_API AssociateCertificateRequest : public MediaConvertRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateCertificateRequest>(GetServiceRequestName(), *this);
    }
