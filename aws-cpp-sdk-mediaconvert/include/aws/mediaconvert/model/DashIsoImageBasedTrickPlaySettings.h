...
namespace Model
{
  ...
  public:
     ...
     */
    inline const DashIsoIntervalCadence& GetIntervalCadence() const{ return m_intervalCadence; }
     ...
     * generates thumbnails according to the interval you specify in thumbnailInterval.
     */
    inline void SetIntervalCadence(const DashIsoIntervalCadence& value) { m_intervalCadenceHasBeenSet = true; m_intervalCadence = value; }
     ...
     * generates thumbnails according to the interval you specify in thumbnailInterval.
     */
    inline void SetIntervalCadence(DashIsoIntervalCadence&& value) { m_intervalCadenceHasBeenSet = true; m_intervalCadence = std::move(value); }
     ...
     * generates thumbnails according to the interval you specify in thumbnailInterval.
     */
    inline DashIsoImageBasedTrickPlaySettings& WithIntervalCadence(const DashIsoIntervalCadence& value) { SetIntervalCadence(value); return *this;}
     ...
     * generates thumbnails according to the interval you specify in thumbnailInterval.
     */
    inline DashIsoImageBasedTrickPlaySettings& WithIntervalCadence(DashIsoIntervalCadence&& value) { SetIntervalCadence(std::move(value)); return *this;}
     ...
     * Must be divisible by 2.
     */
    inline DashIsoImageBasedTrickPlaySettings& WithThumbnailHeight(int value) { SetThumbnailHeight(value); return *this;}
     ...
     * MediaConvert uses a 150 frame interval to generate thumbnails.
     */
    inline DashIsoImageBasedTrickPlaySettings& WithThumbnailInterval(double value) { SetThumbnailInterval(value); return *this;}
     ...
     * Must be divisible by 8.
     */
    inline DashIsoImageBasedTrickPlaySettings& WithThumbnailWidth(int value) { SetThumbnailWidth(value); return *this;}
     ...
     * 2048. Must be divisible by 2.
     */
    inline DashIsoImageBasedTrickPlaySettings& WithTileHeight(int value) { SetTileHeight(value); return *this;}
     ...
     * 512.
     */
    inline DashIsoImageBasedTrickPlaySettings& WithTileWidth(int value) { SetTileWidth(value); return *this;}
