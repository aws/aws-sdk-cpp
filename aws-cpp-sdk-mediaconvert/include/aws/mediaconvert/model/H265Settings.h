...
namespace Model
{
  ...
  public:
     ...
     * with some downstream systems and video players. Choose HVC1 to mark your output
     * as HVC1. This makes your output compliant with the following specification: ISO
     * IECJTC1 SC29 N13798 Text ISO/IEC FDIS 14496-15 3rd Edition. For these outputs,
     * the service stores parameter set NAL units in the sample headers but not in the
     * samples directly. The service defaults to marking your output as HEV1. For these
