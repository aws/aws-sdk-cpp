...
Aws::String MediaConvertEndpointRules::GetRulesAsString()
{
    return Aws::String(MediaConvertEndpointRules::Rules.begin(), MediaConvertEndpointRules::Rules.end());
}

const Aws::Vector<char> MediaConvertEndpointRules::Rules = {
...
'p','s',':','/','/','m','e','d','i','a','c','o','n','v','e','r','t','-','f','i','p','s','.','{','R',
...
't','t','p','s',':','/','/','m','e','d','i','a','c','o','n','v','e','r','t','.','{','R','e','g','i',
