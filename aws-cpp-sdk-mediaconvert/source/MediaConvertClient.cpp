...
using ResolveEndpointOutcome = Aws::MediaConvert::Endpoint::MediaConvertEndpointProvider::MediaConvertResolveEndpointOutcome;
...
MediaConvertClient::MediaConvertClient(const Client::ClientConfiguration& clientConfiguration,
                                       std::shared_ptr<Endpoint::MediaConvertEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<MediaConvertErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<MediaConvert::Endpoint::MediaConvertEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
