...
UpdateQueueResult::UpdateQueueResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateQueueResult& UpdateQueueResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
