...
namespace QLDBSession
{
  ...
  class AWS_QLDBSESSION_API QLDBSessionClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        QLDBSessionClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::QLDBSessionEndpointProvider> endpointProvider = Aws::MakeShared<QLDBSession::Endpoint::QLDBSessionEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::QLDBSessionEndpointProvider> m_endpointProvider;
  };
