...
using AlexaForBusinessResolveEndpointOutcome = Aws::AlexaForBusiness::Endpoint::AlexaForBusinessEndpointProvider::AlexaForBusinessResolveEndpointOutcome;
...
void ValidateOutcome(const AlexaForBusinessResolveEndpointOutcome& outcome, const AlexaForBusinessEndpointProviderEndpointTestCase::Expect& expect)
{
