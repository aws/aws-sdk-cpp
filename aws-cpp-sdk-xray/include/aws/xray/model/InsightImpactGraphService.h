...
namespace Model
{
  ...
  public:
     ...
     * <p>AWS Resource - The type of an AWS resource. For example, AWS::EC2::Instance
     * for an application running on Amazon EC2 or AWS::DynamoDB::Table for an Amazon
     * DynamoDB table that the application used. </p> </li> <li> <p>AWS Service - The
     * type of an AWS service. For example, AWS::DynamoDB for downstream calls to
     * Amazon DynamoDB that didn't target a specific table. </p> </li> <li> <p>AWS
     * Service - The type of an AWS service. For example, AWS::DynamoDB for downstream
     * calls to Amazon DynamoDB that didn't target a specific table. </p> </li> <li>
     * <p>remote - A downstream service of indeterminate type.</p> </li> </ul>
     */
