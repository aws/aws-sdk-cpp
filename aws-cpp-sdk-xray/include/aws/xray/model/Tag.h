...
namespace Model
{
  ...
  /**
   * <p>A map that contains tag keys and tag values to attach to an AWS X-Ray group
   ...
   * per resource: 50</p> </li> <li> <p>Tag keys and values are case sensitive.</p>
   * </li> <li> <p>Don't use <code>aws:</code> as a prefix for keys; it's reserved
   * for AWS use. You cannot edit or delete system tags.</p> </li> </ul><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/Tag">AWS API
   * Reference</a></p>
   */
