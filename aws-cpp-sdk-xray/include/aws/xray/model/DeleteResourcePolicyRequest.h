...
namespace Model
{
  ...
  /**
   */
  class AWS_XRAY_API DeleteResourcePolicyRequest : public XRayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteResourcePolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteResourcePolicyRequest>(GetServiceRequestName(), *this);
    }
