...
namespace Model
{
  ...
  /**
   */
  class AWS_XRAY_API GetInsightEventsRequest : public XRayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetInsightEventsRequest> Clone() const
    {
      return Aws::MakeUnique<GetInsightEventsRequest>(GetServiceRequestName(), *this);
    }
