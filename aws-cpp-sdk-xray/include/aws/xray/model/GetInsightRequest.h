...
namespace Model
{
  ...
  /**
   */
  class AWS_XRAY_API GetInsightRequest : public XRayRequest
  {
  public:
    GetInsightRequest();
    ...
    */
    virtual Aws::UniquePtr<GetInsightRequest> Clone() const
    {
      return Aws::MakeUnique<GetInsightRequest>(GetServiceRequestName(), *this);
    }
