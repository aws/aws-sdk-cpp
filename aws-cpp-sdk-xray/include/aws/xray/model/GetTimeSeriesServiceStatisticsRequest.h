...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTimeSeriesServiceStatisticsRequest> Clone() const
    {
      return Aws::MakeUnique<GetTimeSeriesServiceStatisticsRequest>(GetServiceRequestName(), *this);
    }
