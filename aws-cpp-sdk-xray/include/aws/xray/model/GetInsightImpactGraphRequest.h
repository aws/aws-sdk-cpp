...
namespace Model
{
  ...
  /**
   */
  class AWS_XRAY_API GetInsightImpactGraphRequest : public XRayRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetInsightImpactGraphRequest> Clone() const
    {
      return Aws::MakeUnique<GetInsightImpactGraphRequest>(GetServiceRequestName(), *this);
    }
