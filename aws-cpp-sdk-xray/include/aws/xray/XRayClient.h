...
namespace XRay
{
  ...
  class AWS_XRAY_API XRayClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        XRayClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                   std::shared_ptr<Endpoint::XRayEndpointProvider> endpointProvider = Aws::MakeShared<XRay::Endpoint::XRayEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::XRayEndpointProvider> m_endpointProvider;
  };
