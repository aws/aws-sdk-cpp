...
using ResolveEndpointOutcome = Aws::XRay::Endpoint::XRayEndpointProvider::XRayResolveEndpointOutcome;
...
XRayClient::XRayClient(const Client::ClientConfiguration& clientConfiguration,
                       std::shared_ptr<Endpoint::XRayEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<XRayErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<XRay::Endpoint::XRayEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
