...
Aws::String XRayEndpointRules::GetRulesAsString()
{
    return Aws::String(XRayEndpointRules::Rules.begin(), XRayEndpointRules::Rules.end());
}

const Aws::Vector<char> XRayEndpointRules::Rules = {
...
'/','x','r','a','y','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
