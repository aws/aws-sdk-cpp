...
using CloudFrontResolveEndpointOutcome = Aws::CloudFront::Endpoint::CloudFrontEndpointProvider::CloudFrontResolveEndpointOutcome;
...
void ValidateOutcome(const CloudFrontResolveEndpointOutcome& outcome, const CloudFrontEndpointProviderEndpointTestCase::Expect& expect)
{
