...
using GreengrassV2ResolveEndpointOutcome = Aws::GreengrassV2::Endpoint::GreengrassV2EndpointProvider::GreengrassV2ResolveEndpointOutcome;
...
static const Aws::Vector<GreengrassV2EndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const GreengrassV2ResolveEndpointOutcome& outcome, const GreengrassV2EndpointProviderEndpointTestCase::Expect& expect)
{
