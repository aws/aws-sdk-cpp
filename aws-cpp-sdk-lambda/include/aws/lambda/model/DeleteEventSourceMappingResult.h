  ...
  public:
    ...
    */
    ...
    /*
     <p>The UTC time string indicating the last time the event mapping was updated.</p>
    */
    inline DeleteEventSourceMappingResult&  WithLastModified(const Aws::String& value) { SetLastModified(value); return *this;}

    /*
     <p>The UTC time string indicating the last time the event mapping was updated.</p>
    */
    inline DeleteEventSourceMappingResult& WithLastModified(const char* value) { SetLastModified(value); return *this;}
