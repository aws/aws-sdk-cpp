...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFunctionConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFunctionConfigurationRequest>(GetServiceRequestName(), *this);
    }
