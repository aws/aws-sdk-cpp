...
namespace Model
{
  ...
  */
  ...
  public:
    ...
    CreateEventSourceMappingResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    CreateEventSourceMappingResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    */
    ...
    /*
     <p>The UTC time string indicating the last time the event mapping was updated.</p>
    */
    inline CreateEventSourceMappingResult&  WithLastModified(const Aws::String& value) { SetLastModified(value); return *this;}

    /*
     <p>The UTC time string indicating the last time the event mapping was updated.</p>
    */
    inline CreateEventSourceMappingResult& WithLastModified(const char* value) { SetLastModified(value); return *this;}
