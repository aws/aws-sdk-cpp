...
namespace Model
{
  ...
  /**
   */
  class AWS_LAMBDA_API DeleteProvisionedConcurrencyConfigRequest : public LambdaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteProvisionedConcurrencyConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteProvisionedConcurrencyConfigRequest>(GetServiceRequestName(), *this);
    }
