...
namespace Model
{
  ...
  /**
   */
  class AWS_LAMBDA_API UpdateFunctionEventInvokeConfigRequest : public LambdaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFunctionEventInvokeConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFunctionEventInvokeConfigRequest>(GetServiceRequestName(), *this);
    }
