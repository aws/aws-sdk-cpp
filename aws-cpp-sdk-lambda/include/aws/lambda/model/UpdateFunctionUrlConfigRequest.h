...
namespace Model
{
  ...
  /**
   */
  class AWS_LAMBDA_API UpdateFunctionUrlConfigRequest : public LambdaRequest
  {
  public:
    ...
    inline UpdateFunctionUrlConfigRequest& WithAuthorizationType(const AuthorizationType& value) { SetAuthorizationType(value); return *this;}

    
    inline UpdateFunctionUrlConfigRequest& WithAuthorizationType(AuthorizationType&& value) { SetAuthorizationType(std::move(value)); return *this;}
