...
namespace Model
{
  ...
  public:
     ...
     * <p>It is the SHA256 hash of your function deployment package.</p>
     */
    inline GetFunctionConfigurationResult& WithCodeSha256(Aws::String&& value) { SetCodeSha256(value); return *this;}
     ...
     * <p>The version of the Lambda function.</p>
     */
    inline GetFunctionConfigurationResult& WithVersion(Aws::String&& value) { SetVersion(value); return *this;}
     ...
     * Amazon SQS queue or Amazon SNS topic.</p>
     */
    inline GetFunctionConfigurationResult& WithDeadLetterConfig(DeadLetterConfig&& value) { SetDeadLetterConfig(value); return *this;}
