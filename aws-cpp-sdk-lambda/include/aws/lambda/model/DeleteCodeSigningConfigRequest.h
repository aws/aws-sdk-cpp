...
namespace Model
{
  ...
  /**
   */
  class AWS_LAMBDA_API DeleteCodeSigningConfigRequest : public LambdaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCodeSigningConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCodeSigningConfigRequest>(GetServiceRequestName(), *this);
    }
