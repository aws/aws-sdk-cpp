...
namespace Model
{
  ...
  /**
   */
  class AWS_LAMBDA_API PutFunctionCodeSigningConfigRequest : public LambdaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutFunctionCodeSigningConfigRequest> Clone() const
    {
      return Aws::MakeUnique<PutFunctionCodeSigningConfigRequest>(GetServiceRequestName(), *this);
    }
