...
namespace Model
{
   ...
   */
  class AWS_LAMBDA_API GetAliasResult
  {
  public:
    GetAliasResult();
     ...
     * <code>arn:aws:lambda:aws-regions:acct-id:function:helloworld:BETA</code>.</p>
     */
    inline GetAliasResult& WithAliasArn(Aws::String&& value) { SetAliasArn(value); return *this;}
     ...
     * <p>Alias name.</p>
     */
    inline GetAliasResult& WithName(Aws::String&& value) { SetName(value); return *this;}
     ...
     * <p>Function version to which the alias points.</p>
     */
    inline GetAliasResult& WithFunctionVersion(Aws::String&& value) { SetFunctionVersion(value); return *this;}
     ...
     * <p>Alias description.</p>
     */
    inline GetAliasResult& WithDescription(Aws::String&& value) { SetDescription(value); return *this;}
