...
namespace Model
{
  ...
  /**
   */
  class AWS_LAMBDA_API DeleteFunctionEventInvokeConfigRequest : public LambdaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFunctionEventInvokeConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFunctionEventInvokeConfigRequest>(GetServiceRequestName(), *this);
    }
