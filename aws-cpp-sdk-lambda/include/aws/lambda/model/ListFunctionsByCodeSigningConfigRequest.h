...
namespace Model
{
  ...
  /**
   */
  class AWS_LAMBDA_API ListFunctionsByCodeSigningConfigRequest : public LambdaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFunctionsByCodeSigningConfigRequest> Clone() const
    {
      return Aws::MakeUnique<ListFunctionsByCodeSigningConfigRequest>(GetServiceRequestName(), *this);
    }
