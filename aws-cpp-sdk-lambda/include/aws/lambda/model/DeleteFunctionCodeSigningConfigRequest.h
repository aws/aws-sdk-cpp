...
namespace Model
{
  ...
  /**
   */
  class AWS_LAMBDA_API DeleteFunctionCodeSigningConfigRequest : public LambdaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFunctionCodeSigningConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFunctionCodeSigningConfigRequest>(GetServiceRequestName(), *this);
    }
