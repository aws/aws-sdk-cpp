  ...
  */
  ...
  public:
    ...
    */
    ...
    /*
     <p>Specifies Lambda function version to retrieve. If you specify an ARN with version information as the <code>FunctionName</code>, you either don't specify this parameter at all or you must specify the same version that you provided in the <code>FunctionName</code>. To retrieve the default version of a function, do not include version in the function name ARN and do not set this parameter. </p>
    */
    ...
    */
    ...
    /*
     <p>Specifies Lambda function version to retrieve. If you specify an ARN with version information as the <code>FunctionName</code>, you either don't specify this parameter at all or you must specify the same version that you provided in the <code>FunctionName</code>. To retrieve the default version of a function, do not include version in the function name ARN and do not set this parameter. </p>
    */
    inline GetFunctionRequest&  WithVersion(const Aws::String& value) { SetVersion(value); return *this;}

    /*
     <p>Specifies Lambda function version to retrieve. If you specify an ARN with version information as the <code>FunctionName</code>, you either don't specify this parameter at all or you must specify the same version that you provided in the <code>FunctionName</code>. To retrieve the default version of a function, do not include version in the function name ARN and do not set this parameter. </p>
    */
    inline GetFunctionRequest& WithVersion(const char* value) { SetVersion(value); return *this;}
