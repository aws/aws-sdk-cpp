...
namespace Model
{
  ...
  */
  ...
  public:
    ...
    UpdateEventSourceMappingResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    UpdateEventSourceMappingResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    */
    ...
    /*
     <p>The UTC time string indicating the last time the event mapping was updated.</p>
    */
    inline UpdateEventSourceMappingResult&  WithLastModified(const Aws::String& value) { SetLastModified(value); return *this;}

    /*
     <p>The UTC time string indicating the last time the event mapping was updated.</p>
    */
    inline UpdateEventSourceMappingResult& WithLastModified(const char* value) { SetLastModified(value); return *this;}
