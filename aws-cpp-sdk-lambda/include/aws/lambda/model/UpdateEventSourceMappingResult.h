...
namespace Model
{
  ...
  public:
     ...
     * event filtering</a>.</p>
     */
    inline UpdateEventSourceMappingResult& WithFilterCriteria(FilterCriteria&& value) { SetFilterCriteria(std::move(value)); return *this;}
     ...
     * maximum concurrency for Amazon SQS event sources</a>.</p>
     */
    inline UpdateEventSourceMappingResult& WithScalingConfig(const ScalingConfig& value) { SetScalingConfig(value); return *this;}
     ...
     * maximum concurrency for Amazon SQS event sources</a>.</p>
     */
    inline UpdateEventSourceMappingResult& WithScalingConfig(ScalingConfig&& value) { SetScalingConfig(std::move(value)); return *this;}
