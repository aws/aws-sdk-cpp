...
namespace Model
{
  ...
  /**
   */
  class AWS_LAMBDA_API GetFunctionCodeSigningConfigRequest : public LambdaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetFunctionCodeSigningConfigRequest> Clone() const
    {
      return Aws::MakeUnique<GetFunctionCodeSigningConfigRequest>(GetServiceRequestName(), *this);
    }
