...
namespace Model
{
  ...
  /**
   */
  class AWS_LAMBDA_API DeleteLayerVersionRequest : public LambdaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLayerVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLayerVersionRequest>(GetServiceRequestName(), *this);
    }
