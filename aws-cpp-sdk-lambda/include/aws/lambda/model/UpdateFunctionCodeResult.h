...
namespace Model
{
  ...
  public:
     ...
     * <p>It is the SHA256 hash of your function deployment package.</p>
     */
    inline UpdateFunctionCodeResult& WithCodeSha256(Aws::String&& value) { SetCodeSha256(value); return *this;}
     ...
     * <p>The version of the Lambda function.</p>
     */
    inline UpdateFunctionCodeResult& WithVersion(Aws::String&& value) { SetVersion(value); return *this;}
     ...
     * settings.</p>
     */
    inline UpdateFunctionCodeResult& WithEnvironment(EnvironmentResponse&& value) { SetEnvironment(value); return *this;}
     ...
     * service key.</p>
     */
    inline UpdateFunctionCodeResult& WithKMSKeyArn(Aws::String&& value) { SetKMSKeyArn(value); return *this;}
