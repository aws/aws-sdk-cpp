...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveLayerVersionPermissionRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveLayerVersionPermissionRequest>(GetServiceRequestName(), *this);
    }
