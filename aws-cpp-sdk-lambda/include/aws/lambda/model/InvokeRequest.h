...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>By default, the <code>Invoke</code> API assumes "RequestResponse" invocation
     * type. You can optionally request asynchronous execution by specifying "Event" as
     * the <code>InvocationType</code>. You can also use this parameter to request AWS
     * Lambda to not execute the function but do some verification, such as if the
     * caller is authorized to invoke the function and if the inputs are valid. You
     * request this by specifying "DryRun" as the <code>InvocationType</code>. This is
     * useful in a cross-account scenario when you want to verify access to a function
    ...
    /**
     * <p>You can set this optional parameter to "Tail" in the request only if you
     * specify the <code>InvocationType</code> parameter with value "RequestResponse".
     * In this case, AWS Lambda returns the base64-encoded last 4 KB of log data
     * produced by your Lambda function in the <code>x-amz-log-results</code> header.
     * </p>
     */
     ...
     * For an example of a ClientContext JSON, go to <a
