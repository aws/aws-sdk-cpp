...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutFunctionEventInvokeConfigRequest> Clone() const
    {
      return Aws::MakeUnique<PutFunctionEventInvokeConfigRequest>(GetServiceRequestName(), *this);
    }
