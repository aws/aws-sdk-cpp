...
namespace Model
{
  ...
  /**
   */
  class AWS_LAMBDA_API DeleteFunctionUrlConfigRequest : public LambdaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFunctionUrlConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFunctionUrlConfigRequest>(GetServiceRequestName(), *this);
    }
