...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/lambda-2015-03-31/GetFunctionConfigurationRequest">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "GetFunctionConfiguration"; }
