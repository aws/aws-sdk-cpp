...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutProvisionedConcurrencyConfigRequest> Clone() const
    {
      return Aws::MakeUnique<PutProvisionedConcurrencyConfigRequest>(GetServiceRequestName(), *this);
    }
