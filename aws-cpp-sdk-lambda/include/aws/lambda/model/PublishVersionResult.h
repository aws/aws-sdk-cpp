...
namespace Model
{
  ...
  public:
     ...
     * <p>The name of the function.</p>
     */
    inline PublishVersionResult& WithFunctionName(Aws::String&& value) { SetFunctionName(value); return *this;}
     ...
     * <p>The Amazon Resource Name (ARN) assigned to the function.</p>
     */
    inline PublishVersionResult& WithFunctionArn(Aws::String&& value) { SetFunctionArn(value); return *this;}
     ...
     * </p>
     */
    inline PublishVersionResult& WithRole(Aws::String&& value) { SetRole(value); return *this;}
     ...
     * <p>The function Lambda calls to begin executing your function.</p>
     */
    inline PublishVersionResult& WithHandler(Aws::String&& value) { SetHandler(value); return *this;}
     ...
     * <p>The user-provided description.</p>
     */
    inline PublishVersionResult& WithDescription(Aws::String&& value) { SetDescription(value); return *this;}
     ...
     * value based on your expected execution time. The default is 3 seconds. </p>
     */
    inline PublishVersionResult& WithTimeout(long value) { SetTimeout(value); return *this;}
     ...
     * of 64 MB.</p>
     */
    inline PublishVersionResult& WithMemorySize(long value) { SetMemorySize(value); return *this;}
     ...
     * <p>The time stamp of the last time you updated the function.</p>
     */
    inline PublishVersionResult& WithLastModified(Aws::String&& value) { SetLastModified(value); return *this;}
     ...
     * <p>It is the SHA256 hash of your function deployment package.</p>
     */
    inline PublishVersionResult& WithCodeSha256(Aws::String&& value) { SetCodeSha256(value); return *this;}
     ...
     * <p>The version of the Lambda function.</p>
     */
    inline PublishVersionResult& WithVersion(Aws::String&& value) { SetVersion(value); return *this;}
