  ...
  public:
    ...
    */
    ...
    /*
     <p>The default version of the Lambda function.</p>
    */
    inline PublishVersionResult&  WithDefaultVersion(const Aws::String& value) { SetDefaultVersion(value); return *this;}

    /*
     <p>The default version of the Lambda function.</p>
    */
    inline PublishVersionResult& WithDefaultVersion(const char* value) { SetDefaultVersion(value); return *this;}
