    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * href="http://docs.aws.amazon.com/lambda/latest/dg/access-control-resource-based.html">Lambda
         ...
         * href="http://docs.aws.amazon.com/lambda/latest/dg/deployment-package-v2.html">deployment
         * package</a> and an <a
         ...
         * an unpublished version, and can have published versions and aliases. A published
         * version is a snapshot of your function code and configuration that can not be
         * changed. An alias is a named resource that maps to a version, and can be changed
         * to map to a different version. Use the <code>Publish</code> parameter to create
         * version <code>1</code> of your function from its initial configuration.</p>
         * <p>The other parameters let you configure version-specific and function-level
         * settings. You can modify version-specific settings later with
         * <a>UpdateFunctionConfiguration</a>. Function-level settings apply to both the
         * unpublished and published versions of the function and include tags
         * (<a>TagResource</a>) and per-function concurrency limits
         * (<a>PutFunctionConcurrency</a>).</p> <p>If another account or a AWS service
        ...
        /**
         * <p>Deletes an <a
         * href="http://docs.aws.amazon.com/lambda/latest/dg/intro-invocation-modes.html">event
        ...
        /**
         * <p>Returns information about function or function version, with a link to
         * download the deployment package that's valid for 10 minutes. If you specify a
         * function version, only details specific to that version are
        ...
        /**
         * <p>Returns a the version-specific settings of a Lambda function or version. The
        ...
        /**
         * <p>Returns the <a
         * href="http://docs.aws.amazon.com/lambda/latest/dg/access-control-resource-based.html">resource-based
         ...
         * href="http://docs.aws.amazon.com/lambda/latest/dg/monitoring-functions.html">execution
         * log</a> and <a
         * href="http://docs.aws.amazon.com/lambda/latest/dg/dlq.html">trace</a>. To record
         * function errors for asynchronous invocations, configure your function with a <a
         * href="http://docs.aws.amazon.com/lambda/latest/dg/dlq.html">dead letter
         * queue</a>.</p> <p>The status code in the API response does not reflect function
         * errors. Error codes are reserved for errors that prevent your function from
         * executing, such as permissions errors, <a
         * href="http://docs.aws.amazon.com/lambda/latest/dg/limits.html">limit errors</a>,
         * or issues with your function's code and configuration. For example, Lambda
         * returns <code>TooManyRequestsException</code> if executing the function would
         ...
         * functions with a long timeout, your client may be disconnected during
         ...
         * href="http://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">aliases</a>
         ...
         * href="http://docs.aws.amazon.com/lambda/latest/dg/tagging.html">tags</a>. You
        ...
        /**
         * <p>Returns a list of <a
         * href="http://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">versions</a>,
        ...
        /**
         * <p>Creates a <a
         * href="http://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html">version</a>
         ...
         * Lambda does not publish a version if the function's configuration and code
         * hasn't changed since the last version. Use <a>UpdateFunctionCode</a> or
         * <a>UpdateFunctionConfiguration</a> to update the function prior to publishing a
         ...
         * version. Reserving concurrency both guarantees that your function has capacity
         * to process the specified number of events simultaneously, and prevents it from
        ...
        /**
         * <p>Adds <a
         * href="http://docs.aws.amazon.com/lambda/latest/dg/tagging.html">tags</a> to a
        ...
        /**
         * <p>Removes <a
         * href="http://docs.aws.amazon.com/lambda/latest/dg/tagging.html">tags</a> from a
         * function.</p><p><h3>See Also:</h3>   <a
         ...
         * you publish a version. You cannot modify the code of a published version, only
         ...
         * a version. You cannot modify the configuration of a published version, only the
