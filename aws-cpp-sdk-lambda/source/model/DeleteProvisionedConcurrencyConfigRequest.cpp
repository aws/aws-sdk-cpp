...
Aws::String DeleteProvisionedConcurrencyConfigRequest::SerializePayload() const
{
  return {};
}

void DeleteProvisionedConcurrencyConfigRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
