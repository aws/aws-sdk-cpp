...
GetLayerVersionPolicyResult::GetLayerVersionPolicyResult()
{
}

GetLayerVersionPolicyResult::GetLayerVersionPolicyResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
