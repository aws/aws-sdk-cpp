...
namespace Lambda
{
const size_t LambdaEndpointRules::RulesBlobStrLen = 3392;
const size_t LambdaEndpointRules::RulesBlobSize = 3393;

using RulesBlobT = Aws::Array<const char, LambdaEndpointRules::RulesBlobSize>;
...
't','t','p','s',':','/','/','l','a','m','b','d','a','-','f','i','p','s','.','{','R','e','g','i','o',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','l','a','m','b','d','a','-','f','i','p','s','.',
...
'"','h','t','t','p','s',':','/','/','l','a','m','b','d','a','.','{','R','e','g','i','o','n','}','.',
...
'n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','l','a','m','b','d',
'a','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u',
'l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r','t','i','e',
's','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y','p','e',
'"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* LambdaEndpointRules::GetRulesBlob()
{
