...
Aws::String LambdaEndpointRules::GetRulesAsString()
{
    return Aws::String(LambdaEndpointRules::Rules.begin(), LambdaEndpointRules::Rules.end());
}

const Aws::Vector<char> LambdaEndpointRules::Rules = {
