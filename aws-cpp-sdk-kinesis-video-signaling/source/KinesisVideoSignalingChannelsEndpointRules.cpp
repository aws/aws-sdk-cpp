...
{
const size_t KinesisVideoSignalingChannelsEndpointRules::RulesBlobStrLen = 3478;
const size_t KinesisVideoSignalingChannelsEndpointRules::RulesBlobSize = 3479;

using RulesBlobT = Aws::Array<const char, KinesisVideoSignalingChannelsEndpointRules::RulesBlobSize>;
...
const char* KinesisVideoSignalingChannelsEndpointRules::GetRulesBlob()
{
