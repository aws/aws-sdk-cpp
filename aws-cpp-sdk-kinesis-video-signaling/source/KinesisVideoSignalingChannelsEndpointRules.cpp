...
Aws::String KinesisVideoSignalingChannelsEndpointRules::GetRulesAsString()
{
    return Aws::String(KinesisVideoSignalingChannelsEndpointRules::Rules.begin(), KinesisVideoSignalingChannelsEndpointRules::Rules.end());
}

const Aws::Vector<char> KinesisVideoSignalingChannelsEndpointRules::Rules = {
