...
namespace KinesisVideoSignalingChannels
{
  ...
  class AWS_KINESISVIDEOSIGNALINGCHANNELS_API KinesisVideoSignalingChannelsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        KinesisVideoSignalingChannelsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                            std::shared_ptr<Endpoint::KinesisVideoSignalingChannelsEndpointProvider> endpointProvider = Aws::MakeShared<KinesisVideoSignalingChannels::Endpoint::KinesisVideoSignalingChannelsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::KinesisVideoSignalingChannelsEndpointProvider> m_endpointProvider;
  };
