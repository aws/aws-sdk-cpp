...
using NeptuneResolveEndpointOutcome = Aws::Neptune::Endpoint::NeptuneEndpointProvider::NeptuneResolveEndpointOutcome;
...
static const Aws::Vector<NeptuneEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const NeptuneResolveEndpointOutcome& outcome, const NeptuneEndpointProviderEndpointTestCase::Expect& expect)
{
