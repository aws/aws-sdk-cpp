...
using Cloud9ResolveEndpointOutcome = Aws::Cloud9::Endpoint::Cloud9EndpointProvider::Cloud9ResolveEndpointOutcome;
...
void ValidateOutcome(const Cloud9ResolveEndpointOutcome& outcome, const Cloud9EndpointProviderEndpointTestCase::Expect& expect)
{
