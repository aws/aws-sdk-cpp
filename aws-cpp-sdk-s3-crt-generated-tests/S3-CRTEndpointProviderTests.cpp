...
using S3CrtResolveEndpointOutcome = Aws::S3Crt::Endpoint::S3CrtEndpointProvider::S3CrtResolveEndpointOutcome;
...
void ValidateOutcome(const S3CrtResolveEndpointOutcome& outcome, const S3CrtEndpointProviderEndpointTestCase::Expect& expect)
{
