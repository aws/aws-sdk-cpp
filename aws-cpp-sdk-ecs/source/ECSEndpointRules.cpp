...
Aws::String ECSEndpointRules::GetRulesAsString()
{
    return Aws::String(ECSEndpointRules::Rules.begin(), ECSEndpointRules::Rules.end());
}

const Aws::Vector<char> ECSEndpointRules::Rules = {
