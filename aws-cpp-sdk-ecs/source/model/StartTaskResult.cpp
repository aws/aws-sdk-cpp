...
StartTaskResult::StartTaskResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

StartTaskResult& StartTaskResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
