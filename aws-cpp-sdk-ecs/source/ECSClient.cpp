...
using ResolveEndpointOutcome = Aws::ECS::Endpoint::ECSEndpointProvider::ECSResolveEndpointOutcome;
...
ECSClient::ECSClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::ECSEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ECSErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ECS::Endpoint::ECSEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
