    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * count, the deployment configuration, the network configuration, load balancers,
         * service registries, enable ECS managed tags option, propagate tags option, task
