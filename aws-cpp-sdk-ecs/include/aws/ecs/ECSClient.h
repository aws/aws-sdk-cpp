...
namespace ECS
{
  ...
  class AWS_ECS_API ECSClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ECSClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::ECSEndpointProvider> endpointProvider = Aws::MakeShared<ECS::Endpoint::ECSEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ECSEndpointProvider> m_endpointProvider;
  };
