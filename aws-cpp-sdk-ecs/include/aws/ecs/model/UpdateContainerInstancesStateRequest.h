...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateContainerInstancesStateRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateContainerInstancesStateRequest>(GetServiceRequestName(), *this);
    }
