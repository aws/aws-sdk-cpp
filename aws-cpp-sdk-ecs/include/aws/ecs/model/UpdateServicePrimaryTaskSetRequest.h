...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateServicePrimaryTaskSetRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateServicePrimaryTaskSetRequest>(GetServiceRequestName(), *this);
    }
