...
namespace Model
{
  ...
  /**
   */
  class AWS_ECS_API PutClusterCapacityProvidersRequest : public ECSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutClusterCapacityProvidersRequest> Clone() const
    {
      return Aws::MakeUnique<PutClusterCapacityProvidersRequest>(GetServiceRequestName(), *this);
    }
