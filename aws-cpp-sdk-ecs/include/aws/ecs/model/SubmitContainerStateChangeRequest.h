...
namespace Model
{
  ...
  */
  ...
  public:
    ...
    /*
     <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the container.</p>
    */
    ...
    */
    ...
    /*
     <p>The task UUID or full Amazon Resource Name (ARN) of the task that hosts the container.</p>
    */
