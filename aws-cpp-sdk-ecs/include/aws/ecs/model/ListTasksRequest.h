...
namespace Model
{
  ...
  public:
     ...
     * the tasks you want to list. If you do not specify a cluster, the default cluster
     * is assumed..</p>
     */
    ...
    /**
     * <p>The container instance UUID or full Amazon Resource Name (ARN) of the
     * container instance that you want to filter the <code>ListTasks</code> results
     * with. Specifying a <code>containerInstance</code> will limit the results to
    ...
    /**
     * <p>The name of the family that you want to filter the <code>ListTasks</code>
     * results with. Specifying a <code>family</code> will limit the results to tasks
     * that belong to that family.</p>
     */
    ...
    /**
     * <p>The <code>startedBy</code> value that you want to filter the task results
     * with. Specifying a <code>startedBy</code> value will limit the results to tasks
    ...
    /**
     * <p>The name of the service that you want to filter the <code>ListTasks</code>
     * results with. Specifying a <code>serviceName</code> will limit the results to
     * tasks that belong to that service.</p>
     */
    ...
    /**
     * <p>The task status that you want to filter the <code>ListTasks</code> results
     * with. Specifying a <code>desiredStatus</code> of <code>STOPPED</code> will limit
     * the results to tasks that are in the <code>STOPPED</code> status, which can be
