...
namespace Model
{
  ...
  public:
     ...
     * termination protection.</p> <p>When managed termination protection is enabled,
     * Amazon ECS prevents the Amazon EC2 instances in an Auto Scaling group that
     * contain tasks from being terminated during a scale-in action. The Auto Scaling
     * group and each instance in the Auto Scaling group must have instance protection
     * from scale-in actions enabled as well. For more information, see <a
