...
namespace Model
{
  ...
  /**
   */
  class AWS_ECS_API DescribeCapacityProvidersRequest : public ECSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCapacityProvidersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCapacityProvidersRequest>(GetServiceRequestName(), *this);
    }
