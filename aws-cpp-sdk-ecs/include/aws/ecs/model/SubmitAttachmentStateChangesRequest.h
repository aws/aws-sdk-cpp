...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SubmitAttachmentStateChangesRequest> Clone() const
    {
      return Aws::MakeUnique<SubmitAttachmentStateChangesRequest>(GetServiceRequestName(), *this);
    }
