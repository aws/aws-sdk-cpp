...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterContainerInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterContainerInstanceRequest>(GetServiceRequestName(), *this);
    }
