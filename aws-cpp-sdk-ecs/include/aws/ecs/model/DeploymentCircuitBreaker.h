...
namespace Model
{
   ...
   * rolling update (<code>ECS</code>) deployment type that are not behind a Classic
  ...
  public:
    ...
    /**
     * <p>Whether to enable Amazon ECS to roll back the service if a service deployment
