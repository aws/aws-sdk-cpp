...
namespace Model
{
  ...
  /**
   */
  class AWS_ECS_API UpdateCapacityProviderRequest : public ECSRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCapacityProviderRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCapacityProviderRequest>(GetServiceRequestName(), *this);
    }
