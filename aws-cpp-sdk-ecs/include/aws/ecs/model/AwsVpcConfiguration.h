...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The IDs of the subnets associated with the task or service. There is a limit
    ...
    /**
     * <p>The IDs of the security groups associated with the task or service. If you do
