...
namespace Model
{
  ...
  public:
     ...
     * <code>links</code> of another container to connect the containers.</p>
     */
     ...
     * <code><i>repository-url</i>/<i>image</i>:<i>tag</i></code>.</p>
     */
     ...
     * ratio as their allocated amount.</p> <p>For example, if you run a
     * single-container task on a single-core instance type with 512 CPU units
     ...
     * limited to 512 CPU units.</p> <p>The Docker daemon on the container instance
     ...
     * that the Linux kernel will allow is 2; however, the CPU parameter is not
     ...
     * ECS container agent version:</p> <ul> <li> <b>Agent versions less than or equal
     ...
     * which the Linux kernel converts to 2 CPU shares.</li> <li> <b>Agent versions
     * greater than or equal to 1.2.0:</b> Null, zero, and CPU values of 1 are passed
     * to Docker as 2.</li> </ul>
     */
    ...
    /**
     * <p>The number of MiB of memory reserved for the container. If your container
     * attempts to exceed the memory allocated here, the container is killed.</p>
     */
     ...
     * <code>name:alias</code> in Docker links. For more information on linking Docker
     * containers, see <a
     * href="https://docs.docker.com/userguide/dockerlinks/">https://docs.docker.com/userguide/dockerlinks/</a>.</p>
     ...
     * <code>true</code>, the failure of that container will stop the task. If the
     * <code>essential</code> parameter of a container is marked as <code>false</code>,
     * then its failure will not affect the rest of the containers in a task. If this
     ...
     * <code>ENTRYPOINT</code> that is passed to the container. For more information on
     * the Docker <code>ENTRYPOINT</code> parameter, see <a
    ...
    /**
     * <p>The <code>CMD</code> that is passed to the container. For more information on
     * the Docker <code>CMD</code> parameter, see <a
