...
using FMSResolveEndpointOutcome = Aws::FMS::Endpoint::FMSEndpointProvider::FMSResolveEndpointOutcome;
...
void ValidateOutcome(const FMSResolveEndpointOutcome& outcome, const FMSEndpointProviderEndpointTestCase::Expect& expect)
{
