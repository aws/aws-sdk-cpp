...
namespace AlexaForBusiness
{
  ...
  class AWS_ALEXAFORBUSINESS_API AlexaForBusinessClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AlexaForBusinessClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::AlexaForBusinessEndpointProvider> endpointProvider = Aws::MakeShared<AlexaForBusiness::Endpoint::AlexaForBusinessEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AlexaForBusinessEndpointProvider> m_endpointProvider;
  };
