...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateContactWithAddressBookRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateContactWithAddressBookRequest>(GetServiceRequestName(), *this);
    }
