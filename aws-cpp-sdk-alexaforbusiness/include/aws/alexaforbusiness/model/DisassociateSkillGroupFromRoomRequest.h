...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateSkillGroupFromRoomRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateSkillGroupFromRoomRequest>(GetServiceRequestName(), *this);
    }
