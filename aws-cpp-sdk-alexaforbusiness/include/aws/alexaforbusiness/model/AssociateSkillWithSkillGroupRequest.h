...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateSkillWithSkillGroupRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateSkillWithSkillGroupRequest>(GetServiceRequestName(), *this);
    }
