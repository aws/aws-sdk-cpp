...
namespace Model
{
  ...
  /**
   */
  class AWS_ALEXAFORBUSINESS_API GetDeviceRequest : public AlexaForBusinessRequest
  {
  public:
    GetDeviceRequest();
    ...
    */
    virtual Aws::UniquePtr<GetDeviceRequest> Clone() const
    {
      return Aws::MakeUnique<GetDeviceRequest>(GetServiceRequestName(), *this);
    }
