...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBusinessReportSchedulesRequest> Clone() const
    {
      return Aws::MakeUnique<ListBusinessReportSchedulesRequest>(GetServiceRequestName(), *this);
    }
