...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateSkillGroupWithRoomRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateSkillGroupWithRoomRequest>(GetServiceRequestName(), *this);
    }
