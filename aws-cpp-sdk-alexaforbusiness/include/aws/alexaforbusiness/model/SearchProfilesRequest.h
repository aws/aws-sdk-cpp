...
namespace Model
{
  ...
  /**
   */
  class AWS_ALEXAFORBUSINESS_API SearchProfilesRequest : public AlexaForBusinessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchProfilesRequest> Clone() const
    {
      return Aws::MakeUnique<SearchProfilesRequest>(GetServiceRequestName(), *this);
    }
