...
namespace Model
{
  ...
  /**
   * <p>The audio message. There is a 1 MB limit on the audio file input, and the
   * only supported format is MP3. You must convert audio files to an Alexa-friendly
   * format. </p> <p>You might need to use converter software to convert your MP3
   * files to the required codec version (MPEG version 2) and bit rate (48 kbps). One
   * option for this is a command-line tool, FFmpeg. For more information, see <a
   * href="https://www.ffmpeg.org/">FFmpeg</a>. The following command converts the
   * provided &lt;input-file&gt; to an MP3 file that will be played in the
   * announcement:</p> <p> <code>ffmpeg -i &lt;input-file&gt; -ac 2 -codec:a
   * libmp3lame -b:a 48k -ar 16000 &lt;output-file.mp3&gt;</code> </p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
     ...
     * locations comprised of safe character are valid. For more information, see <a
