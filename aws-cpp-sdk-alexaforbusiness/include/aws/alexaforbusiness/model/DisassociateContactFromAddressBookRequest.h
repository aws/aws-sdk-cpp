...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateContactFromAddressBookRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateContactFromAddressBookRequest>(GetServiceRequestName(), *this);
    }
