...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSkillsStoreSkillsByCategoryRequest> Clone() const
    {
      return Aws::MakeUnique<ListSkillsStoreSkillsByCategoryRequest>(GetServiceRequestName(), *this);
    }
