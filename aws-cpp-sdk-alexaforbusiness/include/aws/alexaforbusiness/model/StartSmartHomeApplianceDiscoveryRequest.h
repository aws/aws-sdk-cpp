...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartSmartHomeApplianceDiscoveryRequest> Clone() const
    {
      return Aws::MakeUnique<StartSmartHomeApplianceDiscoveryRequest>(GetServiceRequestName(), *this);
    }
