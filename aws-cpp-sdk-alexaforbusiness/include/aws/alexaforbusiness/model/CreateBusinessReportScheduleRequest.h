...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateBusinessReportScheduleRequest> Clone() const
    {
      return Aws::MakeUnique<CreateBusinessReportScheduleRequest>(GetServiceRequestName(), *this);
    }
