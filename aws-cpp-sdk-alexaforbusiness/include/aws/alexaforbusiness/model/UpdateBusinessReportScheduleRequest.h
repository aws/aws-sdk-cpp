...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateBusinessReportScheduleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateBusinessReportScheduleRequest>(GetServiceRequestName(), *this);
    }
