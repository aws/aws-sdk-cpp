...
namespace Model
{
  ...
  /**
   */
  class AWS_ALEXAFORBUSINESS_API RevokeInvitationRequest : public AlexaForBusinessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RevokeInvitationRequest> Clone() const
    {
      return Aws::MakeUnique<RevokeInvitationRequest>(GetServiceRequestName(), *this);
    }
