...
namespace Model
{
  ...
  /**
   * <p>The attributes of a skill group.</p><p><h3>See Also:</h3>   <a
  ...
  public:
    SkillGroupData();
    SkillGroupData(const Aws::Utils::Json::JsonValue& jsonValue);
    SkillGroupData& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
     ...
     * <p>The description of a skill group.</p>
     */
    inline SkillGroupData& WithDescription(const char* value) { SetDescription(value); return *this;}
