...
namespace Model
{
  ...
  /**
   */
  class AWS_ALEXAFORBUSINESS_API DisassociateSkillFromSkillGroupRequest : public AlexaForBusinessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateSkillFromSkillGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateSkillFromSkillGroupRequest>(GetServiceRequestName(), *this);
    }
