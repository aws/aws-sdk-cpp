...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBusinessReportScheduleRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBusinessReportScheduleRequest>(GetServiceRequestName(), *this);
    }
