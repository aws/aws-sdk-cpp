...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateDeviceWithNetworkProfileRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateDeviceWithNetworkProfileRequest>(GetServiceRequestName(), *this);
    }
