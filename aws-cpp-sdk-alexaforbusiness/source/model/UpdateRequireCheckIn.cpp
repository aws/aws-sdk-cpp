...
UpdateRequireCheckIn::UpdateRequireCheckIn(JsonView jsonValue) : 
    m_releaseAfterMinutes(0),
    m_releaseAfterMinutesHasBeenSet(false),
    m_enabled(false),
    m_enabledHasBeenSet(false)
...
UpdateRequireCheckIn& UpdateRequireCheckIn::operator =(JsonView jsonValue)
{
...
JsonValue UpdateRequireCheckIn::Jsonize() const
{
  JsonValue payload;
