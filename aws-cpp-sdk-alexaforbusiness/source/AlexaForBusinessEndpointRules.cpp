...
Aws::String AlexaForBusinessEndpointRules::GetRulesAsString()
{
    return Aws::String(AlexaForBusinessEndpointRules::Rules.begin(), AlexaForBusinessEndpointRules::Rules.end());
}

const Aws::Vector<char> AlexaForBusinessEndpointRules::Rules = {
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','4','b','.','{','R','e','g','i','o',
