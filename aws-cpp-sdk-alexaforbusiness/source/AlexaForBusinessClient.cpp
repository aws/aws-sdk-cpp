...
using ResolveEndpointOutcome = Aws::AlexaForBusiness::Endpoint::AlexaForBusinessEndpointProvider::AlexaForBusinessResolveEndpointOutcome;
...
AlexaForBusinessClient::AlexaForBusinessClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::AlexaForBusinessEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<AlexaForBusinessErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<AlexaForBusiness::Endpoint::AlexaForBusinessEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
