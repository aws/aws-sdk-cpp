...
Aws::String KinesisVideoEndpointRules::GetRulesAsString()
{
    return Aws::String(KinesisVideoEndpointRules::Rules.begin(), KinesisVideoEndpointRules::Rules.end());
}

const Aws::Vector<char> KinesisVideoEndpointRules::Rules = {
