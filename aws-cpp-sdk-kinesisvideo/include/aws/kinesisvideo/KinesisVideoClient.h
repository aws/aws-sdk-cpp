...
namespace KinesisVideo
{
  ...
  class AWS_KINESISVIDEO_API KinesisVideoClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        KinesisVideoClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::KinesisVideoEndpointProvider> endpointProvider = Aws::MakeShared<KinesisVideo::Endpoint::KinesisVideoEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::KinesisVideoEndpointProvider> m_endpointProvider;
  };
