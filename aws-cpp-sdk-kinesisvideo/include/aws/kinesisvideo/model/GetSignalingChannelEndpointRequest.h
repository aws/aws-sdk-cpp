...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSignalingChannelEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<GetSignalingChannelEndpointRequest>(GetServiceRequestName(), *this);
    }
