...
namespace Model
{
  ...
  /**
   */
  class AWS_KINESISVIDEO_API UpdateImageGenerationConfigurationRequest : public KinesisVideoRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateImageGenerationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateImageGenerationConfigurationRequest>(GetServiceRequestName(), *this);
    }
