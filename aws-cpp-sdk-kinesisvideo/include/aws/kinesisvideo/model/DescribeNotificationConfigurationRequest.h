...
namespace Model
{
  ...
  /**
   */
  class AWS_KINESISVIDEO_API DescribeNotificationConfigurationRequest : public KinesisVideoRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNotificationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNotificationConfigurationRequest>(GetServiceRequestName(), *this);
    }
