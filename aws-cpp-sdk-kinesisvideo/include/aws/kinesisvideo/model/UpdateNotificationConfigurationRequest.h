...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateNotificationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateNotificationConfigurationRequest>(GetServiceRequestName(), *this);
    }
