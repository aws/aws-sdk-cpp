...
CreateMemberResult::CreateMemberResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateMemberResult& CreateMemberResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
