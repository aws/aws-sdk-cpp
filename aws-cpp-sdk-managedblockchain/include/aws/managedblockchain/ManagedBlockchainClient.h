...
namespace ManagedBlockchain
{
  ...
  class AWS_MANAGEDBLOCKCHAIN_API ManagedBlockchainClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ManagedBlockchainClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                std::shared_ptr<Endpoint::ManagedBlockchainEndpointProvider> endpointProvider = Aws::MakeShared<ManagedBlockchain::Endpoint::ManagedBlockchainEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ManagedBlockchainEndpointProvider> m_endpointProvider;
  };
