...
namespace Model
{
  ...
  /**
   */
  class AWS_MANAGEDBLOCKCHAIN_API ListAccessorsRequest : public ManagedBlockchainRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAccessorsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAccessorsRequest>(GetServiceRequestName(), *this);
    }
