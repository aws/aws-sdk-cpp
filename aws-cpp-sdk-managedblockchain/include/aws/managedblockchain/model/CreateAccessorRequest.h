...
namespace Model
{
  ...
  /**
   */
  class AWS_MANAGEDBLOCKCHAIN_API CreateAccessorRequest : public ManagedBlockchainRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAccessorRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAccessorRequest>(GetServiceRequestName(), *this);
    }
