...
namespace Model
{
  ...
  /**
   */
  class AWS_MANAGEDBLOCKCHAIN_API GetMemberRequest : public ManagedBlockchainRequest
  {
  public:
    GetMemberRequest();
    ...
    */
    virtual Aws::UniquePtr<GetMemberRequest> Clone() const
    {
      return Aws::MakeUnique<GetMemberRequest>(GetServiceRequestName(), *this);
    }
