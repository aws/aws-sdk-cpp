...
namespace Model
{
  ...
  /**
   */
  class AWS_MANAGEDBLOCKCHAIN_API DeleteAccessorRequest : public ManagedBlockchainRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAccessorRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAccessorRequest>(GetServiceRequestName(), *this);
    }
