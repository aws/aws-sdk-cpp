...
namespace Model
{
  ...
  /**
   */
  class AWS_MANAGEDBLOCKCHAIN_API GetAccessorRequest : public ManagedBlockchainRequest
  {
  public:
    GetAccessorRequest();
    ...
    */
    virtual Aws::UniquePtr<GetAccessorRequest> Clone() const
    {
      return Aws::MakeUnique<GetAccessorRequest>(GetServiceRequestName(), *this);
    }
