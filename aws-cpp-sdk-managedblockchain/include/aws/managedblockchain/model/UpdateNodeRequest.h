...
namespace Model
{
  ...
  /**
   */
  class AWS_MANAGEDBLOCKCHAIN_API UpdateNodeRequest : public ManagedBlockchainRequest
  {
  public:
    UpdateNodeRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateNodeRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateNodeRequest>(GetServiceRequestName(), *this);
    }
