...
namespace Model
{
  ...
  /**
   */
  class AWS_MANAGEDBLOCKCHAIN_API UpdateMemberRequest : public ManagedBlockchainRequest
  {
  public:
    UpdateMemberRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateMemberRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateMemberRequest>(GetServiceRequestName(), *this);
    }
