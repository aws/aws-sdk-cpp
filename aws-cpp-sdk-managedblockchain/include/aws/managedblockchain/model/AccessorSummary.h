...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MANAGEDBLOCKCHAIN_API AccessorSummary
  {
  public:
    AccessorSummary();
    AccessorSummary(Aws::Utils::Json::JsonView jsonValue);
    AccessorSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
