...
static const char* ALLOCATION_TAG = "AWSIoTEventsDataEndpointProviderTests";
using IoTEventsDataEndpointProvider = Aws::IoTEventsData::Endpoint::IoTEventsDataEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using IoTEventsDataResolveEndpointOutcome = Aws::IoTEventsData::Endpoint::IoTEventsDataEndpointProvider::IoTEventsDataResolveEndpointOutcome;
...
class IoTEventsDataEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct IoTEventsDataEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<IoTEventsDataEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const IoTEventsDataResolveEndpointOutcome& outcome, const IoTEventsDataEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(IoTEventsDataEndpointProviderTests, EndpointProviderTest)
{
    ...
    const IoTEventsDataEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<IoTEventsDataEndpointProvider> endpointProvider = Aws::MakeShared<IoTEventsDataEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize IoTEventsDataEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const IoTEventsDataEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         IoTEventsDataEndpointProviderTests,
