...
using ResolveEndpointOutcome = Aws::Route53Resolver::Endpoint::Route53ResolverEndpointProvider::Route53ResolverResolveEndpointOutcome;
...
Route53ResolverClient::Route53ResolverClient(const Client::ClientConfiguration& clientConfiguration,
                                             std::shared_ptr<Endpoint::Route53ResolverEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<Route53ResolverErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Route53Resolver::Endpoint::Route53ResolverEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
