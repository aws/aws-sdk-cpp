...
Aws::String Route53ResolverEndpointRules::GetRulesAsString()
{
    return Aws::String(Route53ResolverEndpointRules::Rules.begin(), Route53ResolverEndpointRules::Rules.end());
}

const Aws::Vector<char> Route53ResolverEndpointRules::Rules = {
...
'3','r','e','s','o','l','v','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','o','u','t','e','5','3','r','e','s','o',
'l','v','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
