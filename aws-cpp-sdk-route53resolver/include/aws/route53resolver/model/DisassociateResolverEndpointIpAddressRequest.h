...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateResolverEndpointIpAddressRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateResolverEndpointIpAddressRequest>(GetServiceRequestName(), *this);
    }
