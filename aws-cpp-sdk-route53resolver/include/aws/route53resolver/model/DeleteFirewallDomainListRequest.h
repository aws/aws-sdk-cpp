...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API DeleteFirewallDomainListRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFirewallDomainListRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFirewallDomainListRequest>(GetServiceRequestName(), *this);
    }
