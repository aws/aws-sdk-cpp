...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResolverQueryLogConfigAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListResolverQueryLogConfigAssociationsRequest>(GetServiceRequestName(), *this);
    }
