...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API DisassociateFirewallRuleGroupRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateFirewallRuleGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateFirewallRuleGroupRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DisassociateFirewallRuleGroup"; }
