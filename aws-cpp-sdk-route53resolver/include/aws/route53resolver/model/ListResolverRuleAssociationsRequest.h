...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResolverRuleAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListResolverRuleAssociationsRequest>(GetServiceRequestName(), *this);
    }
