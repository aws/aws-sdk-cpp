...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFirewallRuleGroupAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFirewallRuleGroupAssociationRequest>(GetServiceRequestName(), *this);
    }
