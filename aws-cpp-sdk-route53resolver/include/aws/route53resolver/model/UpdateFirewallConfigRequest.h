...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API UpdateFirewallConfigRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFirewallConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFirewallConfigRequest>(GetServiceRequestName(), *this);
    }
