...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API UpdateFirewallDomainsRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFirewallDomainsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFirewallDomainsRequest>(GetServiceRequestName(), *this);
    }
