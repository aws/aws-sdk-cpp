...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API ListResolverConfigsRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResolverConfigsRequest> Clone() const
    {
      return Aws::MakeUnique<ListResolverConfigsRequest>(GetServiceRequestName(), *this);
    }
