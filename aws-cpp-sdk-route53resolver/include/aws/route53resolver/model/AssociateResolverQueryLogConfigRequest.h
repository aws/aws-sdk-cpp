...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API AssociateResolverQueryLogConfigRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateResolverQueryLogConfigRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateResolverQueryLogConfigRequest>(GetServiceRequestName(), *this);
    }
