...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ROUTE53RESOLVER_API FirewallRuleGroup
  {
  public:
    FirewallRuleGroup();
    FirewallRuleGroup(Aws::Utils::Json::JsonView jsonValue);
    FirewallRuleGroup& operator=(Aws::Utils::Json::JsonView jsonValue);
