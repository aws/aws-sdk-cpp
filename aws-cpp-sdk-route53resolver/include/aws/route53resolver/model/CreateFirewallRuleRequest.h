...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API CreateFirewallRuleRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateFirewallRuleRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFirewallRuleRequest>(GetServiceRequestName(), *this);
    }
