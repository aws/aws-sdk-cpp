...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API GetFirewallRuleGroupAssociationRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetFirewallRuleGroupAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<GetFirewallRuleGroupAssociationRequest>(GetServiceRequestName(), *this);
    }
