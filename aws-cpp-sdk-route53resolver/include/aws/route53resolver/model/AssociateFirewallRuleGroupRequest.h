...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API AssociateFirewallRuleGroupRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateFirewallRuleGroupRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateFirewallRuleGroupRequest>(GetServiceRequestName(), *this);
    }
