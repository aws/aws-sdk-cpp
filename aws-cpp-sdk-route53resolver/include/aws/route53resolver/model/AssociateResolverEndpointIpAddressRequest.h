...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateResolverEndpointIpAddressRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateResolverEndpointIpAddressRequest>(GetServiceRequestName(), *this);
    }
