...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateResolverQueryLogConfigRequest> Clone() const
    {
      return Aws::MakeUnique<CreateResolverQueryLogConfigRequest>(GetServiceRequestName(), *this);
    }
