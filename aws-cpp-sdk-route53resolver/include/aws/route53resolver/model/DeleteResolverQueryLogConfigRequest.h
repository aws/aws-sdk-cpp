...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API DeleteResolverQueryLogConfigRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteResolverQueryLogConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteResolverQueryLogConfigRequest>(GetServiceRequestName(), *this);
    }
