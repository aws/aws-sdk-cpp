...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API GetFirewallConfigRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetFirewallConfigRequest> Clone() const
    {
      return Aws::MakeUnique<GetFirewallConfigRequest>(GetServiceRequestName(), *this);
    }
