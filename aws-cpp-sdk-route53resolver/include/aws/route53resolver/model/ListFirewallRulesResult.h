...
namespace Model
{
  class AWS_ROUTE53RESOLVER_API ListFirewallRulesResult
  {
  public:
    ListFirewallRulesResult();
    ListFirewallRulesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListFirewallRulesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
