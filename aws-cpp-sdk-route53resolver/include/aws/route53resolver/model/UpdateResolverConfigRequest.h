...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API UpdateResolverConfigRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateResolverConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateResolverConfigRequest>(GetServiceRequestName(), *this);
    }
