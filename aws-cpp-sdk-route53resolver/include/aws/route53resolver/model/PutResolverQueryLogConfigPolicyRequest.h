...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API PutResolverQueryLogConfigPolicyRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutResolverQueryLogConfigPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutResolverQueryLogConfigPolicyRequest>(GetServiceRequestName(), *this);
    }
