...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API ListFirewallRulesRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFirewallRulesRequest> Clone() const
    {
      return Aws::MakeUnique<ListFirewallRulesRequest>(GetServiceRequestName(), *this);
    }
