...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResolverEndpointIpAddressesRequest> Clone() const
    {
      return Aws::MakeUnique<ListResolverEndpointIpAddressesRequest>(GetServiceRequestName(), *this);
    }
