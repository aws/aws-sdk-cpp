...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API ListResolverQueryLogConfigsRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListResolverQueryLogConfigsRequest> Clone() const
    {
      return Aws::MakeUnique<ListResolverQueryLogConfigsRequest>(GetServiceRequestName(), *this);
    }
