...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API CreateFirewallDomainListRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateFirewallDomainListRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFirewallDomainListRequest>(GetServiceRequestName(), *this);
    }
