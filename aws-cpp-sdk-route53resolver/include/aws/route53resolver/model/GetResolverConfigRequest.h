...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API GetResolverConfigRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetResolverConfigRequest> Clone() const
    {
      return Aws::MakeUnique<GetResolverConfigRequest>(GetServiceRequestName(), *this);
    }
