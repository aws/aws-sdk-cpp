...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API DisassociateResolverQueryLogConfigRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateResolverQueryLogConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateResolverQueryLogConfigRequest>(GetServiceRequestName(), *this);
    }
