...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API ListFirewallRuleGroupAssociationsRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFirewallRuleGroupAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFirewallRuleGroupAssociationsRequest>(GetServiceRequestName(), *this);
    }
