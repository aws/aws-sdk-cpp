...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API GetResolverQueryLogConfigAssociationRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetResolverQueryLogConfigAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<GetResolverQueryLogConfigAssociationRequest>(GetServiceRequestName(), *this);
    }
