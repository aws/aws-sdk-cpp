...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API DeleteFirewallRuleGroupRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFirewallRuleGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFirewallRuleGroupRequest>(GetServiceRequestName(), *this);
    }
