...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API ListFirewallRuleGroupsRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFirewallRuleGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFirewallRuleGroupsRequest>(GetServiceRequestName(), *this);
    }
