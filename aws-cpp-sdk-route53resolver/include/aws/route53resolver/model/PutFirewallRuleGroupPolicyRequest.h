...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API PutFirewallRuleGroupPolicyRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutFirewallRuleGroupPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutFirewallRuleGroupPolicyRequest>(GetServiceRequestName(), *this);
    }
