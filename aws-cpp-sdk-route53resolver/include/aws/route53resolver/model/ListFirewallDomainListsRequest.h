...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53RESOLVER_API ListFirewallDomainListsRequest : public Route53ResolverRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFirewallDomainListsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFirewallDomainListsRequest>(GetServiceRequestName(), *this);
    }
     ...
     * <code>MaxResults</code>, Resolver returns up to 100 objects. </p>
     */
    inline ListFirewallDomainListsRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
     ...
     * prior request in your next request.</p>
     */
    inline ListFirewallDomainListsRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
     ...
     * prior request in your next request.</p>
     */
    inline ListFirewallDomainListsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
     ...
     * prior request in your next request.</p>
     */
    inline ListFirewallDomainListsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
