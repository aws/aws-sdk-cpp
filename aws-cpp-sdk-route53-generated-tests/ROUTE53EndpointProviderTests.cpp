...
using Route53ResolveEndpointOutcome = Aws::Route53::Endpoint::Route53EndpointProvider::Route53ResolveEndpointOutcome;
...
static const Aws::Vector<Route53EndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const Route53ResolveEndpointOutcome& outcome, const Route53EndpointProviderEndpointTestCase::Expect& expect)
{
