...
using TimestreamQueryResolveEndpointOutcome = Aws::TimestreamQuery::Endpoint::TimestreamQueryEndpointProvider::TimestreamQueryResolveEndpointOutcome;
...
static const Aws::Vector<TimestreamQueryEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const TimestreamQueryResolveEndpointOutcome& outcome, const TimestreamQueryEndpointProviderEndpointTestCase::Expect& expect)
{
