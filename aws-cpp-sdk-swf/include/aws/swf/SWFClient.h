...
namespace SWF
{
  ...
  class AWS_SWF_API SWFClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SWFClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::SWFEndpointProvider> endpointProvider = Aws::MakeShared<SWF::Endpoint::SWFEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SWFEndpointProvider> m_endpointProvider;
  };
