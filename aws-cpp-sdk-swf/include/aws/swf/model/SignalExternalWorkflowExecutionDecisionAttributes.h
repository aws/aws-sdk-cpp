...
namespace Model
{
  ...
  */
  ...
  public:
    ...
    /*
     <p><b>Required.</b> The <code>workflowId</code> of the workflow execution to be signaled.</p>
    */
    ...
    */
    ...
    /*
     <p><b>Required.</b> The name of the signal.The target workflow execution will use the signal name and input to process the signal.</p>
    */
    ...
    */
    ...
    /*
     <p><i>Optional.</i> Input data to be provided with the signal. The target workflow execution will use the signal name and input data to process the signal.</p>
    */
    ...
    */
    ...
    /*
     <p><i>Optional.</i> Data attached to the event that can be used by the decider in subsequent decision tasks.</p>
    */
