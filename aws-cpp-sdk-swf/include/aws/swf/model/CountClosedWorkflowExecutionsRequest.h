...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CountClosedWorkflowExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<CountClosedWorkflowExecutionsRequest>(GetServiceRequestName(), *this);
    }
