...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RecordActivityTaskHeartbeatRequest> Clone() const
    {
      return Aws::MakeUnique<RecordActivityTaskHeartbeatRequest>(GetServiceRequestName(), *this);
    }
