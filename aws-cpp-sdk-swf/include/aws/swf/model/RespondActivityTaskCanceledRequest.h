...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RespondActivityTaskCanceledRequest> Clone() const
    {
      return Aws::MakeUnique<RespondActivityTaskCanceledRequest>(GetServiceRequestName(), *this);
    }
