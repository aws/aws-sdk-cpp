...
namespace Model
{
  ...
  */
  ...
  public:
    ...
    WorkflowExecutionContinuedAsNewEventAttributes(const Aws::Utils::Json::JsonValue& jsonValue);
    ...
    */
    ...
    /*
     <p>The total duration allowed for the new workflow execution.</p> <p>The duration is specified in seconds; an integer greater than or equal to 0. The value "NONE" can be used to specify unlimited duration.</p>
    */
    ...
    */
    ...
    /*
     <p>The maximum duration of decision tasks for the new workflow execution.</p> <p>The duration is specified in seconds; an integer greater than or equal to 0. The value "NONE" can be used to specify unlimited duration.</p>
    */
