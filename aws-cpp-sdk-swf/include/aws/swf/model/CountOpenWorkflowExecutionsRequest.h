...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CountOpenWorkflowExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<CountOpenWorkflowExecutionsRequest>(GetServiceRequestName(), *this);
    }
