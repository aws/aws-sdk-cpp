...
namespace Model
{
  ...
  /**
   */
  class AWS_SWF_API RespondActivityTaskFailedRequest : public SWFRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RespondActivityTaskFailedRequest> Clone() const
    {
      return Aws::MakeUnique<RespondActivityTaskFailedRequest>(GetServiceRequestName(), *this);
    }
