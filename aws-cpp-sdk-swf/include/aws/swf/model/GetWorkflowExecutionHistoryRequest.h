...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetWorkflowExecutionHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<GetWorkflowExecutionHistoryRequest>(GetServiceRequestName(), *this);
    }
