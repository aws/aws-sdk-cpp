...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RespondDecisionTaskCompletedRequest> Clone() const
    {
      return Aws::MakeUnique<RespondDecisionTaskCompletedRequest>(GetServiceRequestName(), *this);
    }
