...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListClosedWorkflowExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListClosedWorkflowExecutionsRequest>(GetServiceRequestName(), *this);
    }
