...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RespondActivityTaskCompletedRequest> Clone() const
    {
      return Aws::MakeUnique<RespondActivityTaskCompletedRequest>(GetServiceRequestName(), *this);
    }
