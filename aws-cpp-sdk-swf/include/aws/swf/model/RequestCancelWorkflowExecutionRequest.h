...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RequestCancelWorkflowExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<RequestCancelWorkflowExecutionRequest>(GetServiceRequestName(), *this);
    }
