...
ListActivityTypesResult::ListActivityTypesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListActivityTypesResult& ListActivityTypesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
