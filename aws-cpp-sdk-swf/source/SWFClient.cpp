...
using ResolveEndpointOutcome = Aws::SWF::Endpoint::SWFEndpointProvider::SWFResolveEndpointOutcome;
...
SWFClient::SWFClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::SWFEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SWFErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<SWF::Endpoint::SWFEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
