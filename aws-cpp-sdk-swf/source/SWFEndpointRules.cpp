...
Aws::String SWFEndpointRules::GetRulesAsString()
{
    return Aws::String(SWFEndpointRules::Rules.begin(), SWFEndpointRules::Rules.end());
}

const Aws::Vector<char> SWFEndpointRules::Rules = {
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','w','f','.','{','R','e','g','i','o',
