...
namespace SQS
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SQSClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::SQSEndpointProvider> endpointProvider = Aws::MakeShared<SQS::Endpoint::SQSEndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::SQSEndpointProvider> m_endpointProvider;
  };
