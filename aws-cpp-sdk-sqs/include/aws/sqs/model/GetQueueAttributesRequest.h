...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>A list of attributes for which to retrieve information.</p> <note> <p>Going
     ...
     * attributes gracefully.</p> </note> <p>The following attributes are
     ...
     * time when the queue was last changed in seconds (epoch time).</p> </li> <li> <p>
     * <code>MaximumMessageSize</code> - Returns the limit of how many bytes a message
     * can contain before Amazon SQS rejects it.</p> </li> <li> <p>
     * <code>MessageRetentionPeriod</code> - Returns the number of seconds for which
     * Amazon SQS retains a message.</p> </li> <li> <p> <code>Policy</code> - Returns
     * the policy of the queue.</p> </li> <li> <p> <code>QueueArn</code> - Returns the
     * Amazon resource name (ARN) of the queue.</p> </li> <li> <p>
     * <code>ReceiveMessageWaitTimeSeconds</code> - Returns the number of seconds for
     * which ReceiveMessage call will wait for a message to arrive. </p> </li> <li> <p>
