...
namespace Model
{
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "CreateQueue"; }
  ...
  public:
     ...
     * 0 to 900 seconds (15 minutes). The default is 0 (zero). </p> </li> <li> <p>
     ...
     * (1 minute) to 1,209,600 seconds (14 days). The default is 345,600 (4 days). </p>
     ...
     * You can provide this attribute only during queue creation. You can't change it
     * for an existing queue. When you set this attribute, you must also provide the
