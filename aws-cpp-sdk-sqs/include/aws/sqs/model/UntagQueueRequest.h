...
namespace Model
{
  ...
  /**
   */
  class AWS_SQS_API UntagQueueRequest : public SQSRequest
  {
  public:
    UntagQueueRequest();
    ...
    */
    virtual Aws::UniquePtr<UntagQueueRequest> Clone() const
    {
      return Aws::MakeUnique<UntagQueueRequest>(GetServiceRequestName(), *this);
    }
