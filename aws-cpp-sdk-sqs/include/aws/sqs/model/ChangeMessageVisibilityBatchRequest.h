...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ChangeMessageVisibilityBatchRequest> Clone() const
    {
      return Aws::MakeUnique<ChangeMessageVisibilityBatchRequest>(GetServiceRequestName(), *this);
    }
