...
namespace Model
{
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() override { return "SetQueueAttributes"; }
  ...
  public:
     ...
     * 0 to 900 (15 minutes). The default is 0 (zero). </p> </li> <li> <p>
     ...
     * representing seconds, from 60 (1 minute) to 1,209,600 (14 days). The default is
     ...
     * arrive. Valid values: an integer from 0 to 20 (seconds). The default is 0. </p>
     * </li> <li> <p> <code>RedrivePolicy</code> - The parameters for the dead letter
     * queue functionality of the source queue. For more information about the redrive
     * policy and dead letter queues, see <a
     ...
     * delivered. </p> </li> </ul> </li> </ul> <p>Any other valid special request
