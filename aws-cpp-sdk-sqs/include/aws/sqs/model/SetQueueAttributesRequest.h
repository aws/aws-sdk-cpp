...
namespace Model
{
  ...
  public:
     ...
     * <code>SetQueueAttributes</code> action uses:</p> <p> <ul> <li>
     ...
     * <code>ReceiveMessageWaitTimeSeconds</code> - The time for which a ReceiveMessage
     * call will wait for a message to arrive. An integer from 0 to 20 (seconds). The
     * default for this attribute is 0. </li> <li> <code>VisibilityTimeout</code> - The
     ...
     * see Visibility Timeout in the <i>Amazon SQS Developer Guide</i>.</li> <li>
     * <code>RedrivePolicy</code> - The parameters for dead letter queue functionality
     * of the source queue. For more information about RedrivePolicy and dead letter
     * queues, see Using Amazon SQS Dead Letter Queues in the <i>Amazon SQS Developer
     * Guide</i>.</li> </ul> </p>
     */
