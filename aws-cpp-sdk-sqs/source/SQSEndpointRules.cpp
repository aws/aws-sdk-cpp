...
Aws::String SQSEndpointRules::GetRulesAsString()
{
    return Aws::String(SQSEndpointRules::Rules.begin(), SQSEndpointRules::Rules.end());
}

const Aws::Vector<char> SQSEndpointRules::Rules = {
...
'/','s','q','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
...
'"','h','t','t','p','s',':','/','/','s','q','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
