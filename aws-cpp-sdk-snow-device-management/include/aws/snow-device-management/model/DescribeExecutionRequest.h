...
namespace Model
{
  ...
  /**
   */
  class AWS_SNOWDEVICEMANAGEMENT_API DescribeExecutionRequest : public SnowDeviceManagementRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeExecutionRequest>(GetServiceRequestName(), *this);
    }
