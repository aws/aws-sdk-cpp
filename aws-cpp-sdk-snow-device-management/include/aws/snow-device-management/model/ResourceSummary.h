...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SNOWDEVICEMANAGEMENT_API ResourceSummary
  {
  public:
    ResourceSummary();
    ResourceSummary(Aws::Utils::Json::JsonView jsonValue);
    ResourceSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
