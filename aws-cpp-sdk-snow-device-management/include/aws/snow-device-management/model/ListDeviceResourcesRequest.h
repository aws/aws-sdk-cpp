...
namespace Model
{
  ...
  /**
   */
  class AWS_SNOWDEVICEMANAGEMENT_API ListDeviceResourcesRequest : public SnowDeviceManagementRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDeviceResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListDeviceResourcesRequest>(GetServiceRequestName(), *this);
    }
