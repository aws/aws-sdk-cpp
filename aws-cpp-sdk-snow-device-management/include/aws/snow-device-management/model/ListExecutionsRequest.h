...
namespace Model
{
  ...
  /**
   */
  class AWS_SNOWDEVICEMANAGEMENT_API ListExecutionsRequest : public SnowDeviceManagementRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListExecutionsRequest>(GetServiceRequestName(), *this);
    }
