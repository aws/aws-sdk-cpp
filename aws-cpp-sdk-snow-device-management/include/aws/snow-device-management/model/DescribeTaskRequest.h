...
namespace Model
{
  ...
  /**
   */
  class AWS_SNOWDEVICEMANAGEMENT_API DescribeTaskRequest : public SnowDeviceManagementRequest
  {
  public:
    DescribeTaskRequest();
    ...
    */
    virtual Aws::UniquePtr<DescribeTaskRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTaskRequest>(GetServiceRequestName(), *this);
    }
