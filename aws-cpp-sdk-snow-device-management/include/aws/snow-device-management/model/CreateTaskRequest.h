...
namespace Model
{
  ...
  /**
   */
  class AWS_SNOWDEVICEMANAGEMENT_API CreateTaskRequest : public SnowDeviceManagementRequest
  {
  public:
    CreateTaskRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateTaskRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTaskRequest>(GetServiceRequestName(), *this);
    }
