...
namespace SnowDeviceManagement
{
  ...
  class AWS_SNOWDEVICEMANAGEMENT_API SnowDeviceManagementClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SnowDeviceManagementClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                   std::shared_ptr<Endpoint::SnowDeviceManagementEndpointProvider> endpointProvider = Aws::MakeShared<SnowDeviceManagement::Endpoint::SnowDeviceManagementEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SnowDeviceManagementEndpointProvider> m_endpointProvider;
  };
