...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DIRECTORYSERVICE_API InvalidCertificateException
  {
  public:
    InvalidCertificateException();
    InvalidCertificateException(Aws::Utils::Json::JsonView jsonValue);
    InvalidCertificateException& operator=(Aws::Utils::Json::JsonView jsonValue);
