...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTORYSERVICE_API ListCertificatesRequest : public DirectoryServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCertificatesRequest> Clone() const
    {
      return Aws::MakeUnique<ListCertificatesRequest>(GetServiceRequestName(), *this);
    }
