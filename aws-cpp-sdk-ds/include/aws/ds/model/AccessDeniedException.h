...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API AccessDeniedException();
    AWS_DIRECTORYSERVICE_API AccessDeniedException(Aws::Utils::Json::JsonView jsonValue);
    AWS_DIRECTORYSERVICE_API AccessDeniedException& operator=(Aws::Utils::Json::JsonView jsonValue);
