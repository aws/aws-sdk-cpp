...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTORYSERVICE_API DescribeClientAuthenticationSettingsRequest : public DirectoryServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeClientAuthenticationSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeClientAuthenticationSettingsRequest>(GetServiceRequestName(), *this);
    }
