...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The type of LDAP security the customer wants to enable. The security can be
     * either server or client, but currently only the default <code>Client</code> is
     * supported.</p>
     */
