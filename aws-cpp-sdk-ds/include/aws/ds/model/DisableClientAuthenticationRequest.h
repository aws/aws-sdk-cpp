...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableClientAuthenticationRequest> Clone() const
    {
      return Aws::MakeUnique<DisableClientAuthenticationRequest>(GetServiceRequestName(), *this);
    }
