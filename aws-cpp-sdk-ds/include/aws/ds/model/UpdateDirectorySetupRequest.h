...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTORYSERVICE_API UpdateDirectorySetupRequest : public DirectoryServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDirectorySetupRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDirectorySetupRequest>(GetServiceRequestName(), *this);
    }
