...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DIRECTORYSERVICE_API NoAvailableCertificateException
  {
  public:
    NoAvailableCertificateException();
    NoAvailableCertificateException(Aws::Utils::Json::JsonView jsonValue);
    NoAvailableCertificateException& operator=(Aws::Utils::Json::JsonView jsonValue);
