...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConditionalForwardersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConditionalForwardersRequest>(GetServiceRequestName(), *this);
    }
