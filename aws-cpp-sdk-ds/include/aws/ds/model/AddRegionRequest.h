...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTORYSERVICE_API AddRegionRequest : public DirectoryServiceRequest
  {
  public:
    AddRegionRequest();
    ...
    */
    virtual Aws::UniquePtr<AddRegionRequest> Clone() const
    {
      return Aws::MakeUnique<AddRegionRequest>(GetServiceRequestName(), *this);
    }
