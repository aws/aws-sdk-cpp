...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTORYSERVICE_API DescribeUpdateDirectoryRequest : public DirectoryServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeUpdateDirectoryRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeUpdateDirectoryRequest>(GetServiceRequestName(), *this);
    }
