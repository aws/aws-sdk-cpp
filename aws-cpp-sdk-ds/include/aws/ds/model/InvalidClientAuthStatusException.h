...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DIRECTORYSERVICE_API InvalidClientAuthStatusException
  {
  public:
    InvalidClientAuthStatusException();
    InvalidClientAuthStatusException(Aws::Utils::Json::JsonView jsonValue);
    InvalidClientAuthStatusException& operator=(Aws::Utils::Json::JsonView jsonValue);
