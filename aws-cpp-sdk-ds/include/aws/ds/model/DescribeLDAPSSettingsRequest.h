...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTORYSERVICE_API DescribeLDAPSSettingsRequest : public DirectoryServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLDAPSSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLDAPSSettingsRequest>(GetServiceRequestName(), *this);
    }
