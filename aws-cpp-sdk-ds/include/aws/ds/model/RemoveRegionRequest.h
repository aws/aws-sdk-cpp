...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTORYSERVICE_API RemoveRegionRequest : public DirectoryServiceRequest
  {
  public:
    RemoveRegionRequest();
    ...
    */
    virtual Aws::UniquePtr<RemoveRegionRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveRegionRequest>(GetServiceRequestName(), *this);
    }
