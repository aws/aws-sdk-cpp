...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTORYSERVICE_API DescribeRegionsRequest : public DirectoryServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRegionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRegionsRequest>(GetServiceRequestName(), *this);
    }
