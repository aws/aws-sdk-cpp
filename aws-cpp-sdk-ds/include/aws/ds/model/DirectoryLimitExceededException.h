...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DIRECTORYSERVICE_API DirectoryLimitExceededException
  {
  public:
    DirectoryLimitExceededException();
    DirectoryLimitExceededException(Aws::Utils::Json::JsonView jsonValue);
    DirectoryLimitExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
