...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTORYSERVICE_API DescribeSettingsRequest : public DirectoryServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSettingsRequest>(GetServiceRequestName(), *this);
    }
