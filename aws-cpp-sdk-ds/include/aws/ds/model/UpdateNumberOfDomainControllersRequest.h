...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateNumberOfDomainControllersRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateNumberOfDomainControllersRequest>(GetServiceRequestName(), *this);
    }
