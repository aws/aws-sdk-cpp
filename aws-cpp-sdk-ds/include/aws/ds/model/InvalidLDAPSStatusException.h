...
namespace Model
{
  ...
  {
  public:
    AWS_DIRECTORYSERVICE_API InvalidLDAPSStatusException();
    AWS_DIRECTORYSERVICE_API InvalidLDAPSStatusException(Aws::Utils::Json::JsonView jsonValue);
    AWS_DIRECTORYSERVICE_API InvalidLDAPSStatusException& operator=(Aws::Utils::Json::JsonView jsonValue);
