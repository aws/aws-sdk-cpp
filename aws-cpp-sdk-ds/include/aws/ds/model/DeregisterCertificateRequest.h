...
namespace Model
{
  ...
  /**
   */
  class AWS_DIRECTORYSERVICE_API DeregisterCertificateRequest : public DirectoryServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterCertificateRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterCertificateRequest>(GetServiceRequestName(), *this);
    }
