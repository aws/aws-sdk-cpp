...
namespace DirectoryService
{
  ...
  class AWS_DIRECTORYSERVICE_API DirectoryServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DirectoryServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::DirectoryServiceEndpointProvider> endpointProvider = Aws::MakeShared<DirectoryService::Endpoint::DirectoryServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DirectoryServiceEndpointProvider> m_endpointProvider;
  };
