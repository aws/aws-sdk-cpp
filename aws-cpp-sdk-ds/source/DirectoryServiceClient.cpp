...
using ResolveEndpointOutcome = Aws::DirectoryService::Endpoint::DirectoryServiceEndpointProvider::DirectoryServiceResolveEndpointOutcome;
...
DirectoryServiceClient::DirectoryServiceClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::DirectoryServiceEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<DirectoryServiceErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<DirectoryService::Endpoint::DirectoryServiceEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
