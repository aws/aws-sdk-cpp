...
{
const size_t DirectoryServiceEndpointRules::RulesBlobStrLen = 3438;
const size_t DirectoryServiceEndpointRules::RulesBlobSize = 3439;

using RulesBlobT = Aws::Array<const char, DirectoryServiceEndpointRules::RulesBlobSize>;
...
const char* DirectoryServiceEndpointRules::GetRulesBlob()
{
