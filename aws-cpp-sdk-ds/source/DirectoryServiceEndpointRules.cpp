...
Aws::String DirectoryServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(DirectoryServiceEndpointRules::Rules.begin(), DirectoryServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> DirectoryServiceEndpointRules::Rules = {
