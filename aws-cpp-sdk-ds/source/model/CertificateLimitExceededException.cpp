...
CertificateLimitExceededException& CertificateLimitExceededException::operator =(JsonView jsonValue)
{
...
JsonValue CertificateLimitExceededException::Jsonize() const
{
  JsonValue payload;
