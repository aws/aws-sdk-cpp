  ...
  Aws::String ForRegion(Region region)
  {
    switch(region)
    {
     ...
     case Region::US_WEST_1:
        return "ds.us-west-1.amazonaws.com";
     case Region::US_WEST_2:
        return "ds.us-west-2.amazonaws.com";
     case Region::EU_WEST_1:
        return "ds.eu-west-1.amazonaws.com";
     case Region::EU_CENTRAL_1:
        return "ds.eu-central-1.amazonaws.com";
     case Region::AP_SOUTHEAST_1:
        return "ds.ap-southeast-1.amazonaws.com";
     case Region::AP_SOUTHEAST_2:
        return "ds.ap-southeast-2.amazonaws.com";
     case Region::AP_NORTHEAST_1:
        return "ds.ap-northeast-1.amazonaws.com";
