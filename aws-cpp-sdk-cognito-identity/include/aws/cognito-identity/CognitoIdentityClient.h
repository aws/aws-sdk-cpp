...
namespace CognitoIdentity
{
  ...
  class AWS_COGNITOIDENTITY_API CognitoIdentityClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CognitoIdentityClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                              std::shared_ptr<Endpoint::CognitoIdentityEndpointProvider> endpointProvider = Aws::MakeShared<CognitoIdentity::Endpoint::CognitoIdentityEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CognitoIdentityEndpointProvider> m_endpointProvider;
  };
