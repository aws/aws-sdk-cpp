...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteIdentityPoolRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteIdentityPoolRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteIdentityPool"; }
