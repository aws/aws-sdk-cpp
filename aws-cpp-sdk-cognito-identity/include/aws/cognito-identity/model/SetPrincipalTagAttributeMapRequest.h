...
namespace Model
{
  ...
  /**
   */
  class AWS_COGNITOIDENTITY_API SetPrincipalTagAttributeMapRequest : public CognitoIdentityRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SetPrincipalTagAttributeMapRequest> Clone() const
    {
      return Aws::MakeUnique<SetPrincipalTagAttributeMapRequest>(GetServiceRequestName(), *this);
    }
