...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetOpenIdTokenForDeveloperIdentityRequest> Clone() const
    {
      return Aws::MakeUnique<GetOpenIdTokenForDeveloperIdentityRequest>(GetServiceRequestName(), *this);
    }
