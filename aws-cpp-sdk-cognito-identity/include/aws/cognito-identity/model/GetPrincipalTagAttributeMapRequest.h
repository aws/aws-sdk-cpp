...
namespace Model
{
  ...
  /**
   */
  class AWS_COGNITOIDENTITY_API GetPrincipalTagAttributeMapRequest : public CognitoIdentityRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPrincipalTagAttributeMapRequest> Clone() const
    {
      return Aws::MakeUnique<GetPrincipalTagAttributeMapRequest>(GetServiceRequestName(), *this);
    }
