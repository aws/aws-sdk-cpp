...
ListIdentitiesResult::ListIdentitiesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListIdentitiesResult& ListIdentitiesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
