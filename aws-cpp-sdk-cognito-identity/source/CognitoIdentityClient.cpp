...
using ResolveEndpointOutcome = Aws::CognitoIdentity::Endpoint::CognitoIdentityEndpointProvider::CognitoIdentityResolveEndpointOutcome;
...
CognitoIdentityClient::CognitoIdentityClient(const Client::ClientConfiguration& clientConfiguration,
                                             std::shared_ptr<Endpoint::CognitoIdentityEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CognitoIdentityErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CognitoIdentity::Endpoint::CognitoIdentityEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
