...
namespace ElasticBeanstalk
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ElasticBeanstalkClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::ElasticBeanstalkEndpointProvider> endpointProvider = Aws::MakeShared<ElasticBeanstalk::Endpoint::ElasticBeanstalkEndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::ElasticBeanstalkEndpointProvider> m_endpointProvider;
  };
