...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEnvironmentConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEnvironmentConfigurationRequest>(GetServiceRequestName(), *this);
    }
