...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEnvironmentManagedActionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEnvironmentManagedActionsRequest>(GetServiceRequestName(), *this);
    }
