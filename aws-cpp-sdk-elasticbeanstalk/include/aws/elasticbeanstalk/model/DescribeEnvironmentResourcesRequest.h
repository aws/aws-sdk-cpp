...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEnvironmentResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEnvironmentResourcesRequest>(GetServiceRequestName(), *this);
    }
