...
namespace Model
{
  ...
  /**
   */
  class AWS_ELASTICBEANSTALK_API ListPlatformBranchesRequest : public ElasticBeanstalkRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPlatformBranchesRequest> Clone() const
    {
      return Aws::MakeUnique<ListPlatformBranchesRequest>(GetServiceRequestName(), *this);
    }
