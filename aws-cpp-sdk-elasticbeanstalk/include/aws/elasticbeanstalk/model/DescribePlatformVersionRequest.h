...
namespace Model
{
  ...
  /**
   */
  class AWS_ELASTICBEANSTALK_API DescribePlatformVersionRequest : public ElasticBeanstalkRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePlatformVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePlatformVersionRequest>(GetServiceRequestName(), *this);
    }
