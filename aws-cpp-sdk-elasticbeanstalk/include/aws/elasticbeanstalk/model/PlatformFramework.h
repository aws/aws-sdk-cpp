...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICBEANSTALK_API PlatformFramework
  {
  public:
    PlatformFramework();
    PlatformFramework(const Aws::Utils::Xml::XmlNode& xmlNode);
    PlatformFramework& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
