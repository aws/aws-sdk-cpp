...
namespace Model
{
  ...
  public:
     ...
     * <p> Returns an <a>EnvironmentDescription</a> list. </p>
     */
    inline ComposeEnvironmentsResult& WithEnvironments(Aws::Vector<EnvironmentDescription>&& value) { SetEnvironments(value); return *this;}
     ...
     * <p> Returns an <a>EnvironmentDescription</a> list. </p>
     */
    inline ComposeEnvironmentsResult& AddEnvironments(EnvironmentDescription&& value) { m_environments.push_back(value); return *this; }
    ...
    inline ComposeEnvironmentsResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
