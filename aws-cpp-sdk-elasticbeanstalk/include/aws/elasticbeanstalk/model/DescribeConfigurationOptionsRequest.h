...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConfigurationOptionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConfigurationOptionsRequest>(GetServiceRequestName(), *this);
    }
