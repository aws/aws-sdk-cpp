...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ApplyEnvironmentManagedActionRequest> Clone() const
    {
      return Aws::MakeUnique<ApplyEnvironmentManagedActionRequest>(GetServiceRequestName(), *this);
    }
