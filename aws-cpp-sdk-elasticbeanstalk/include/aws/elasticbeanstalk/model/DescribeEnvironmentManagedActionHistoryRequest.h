...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEnvironmentManagedActionHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEnvironmentManagedActionHistoryRequest>(GetServiceRequestName(), *this);
    }
