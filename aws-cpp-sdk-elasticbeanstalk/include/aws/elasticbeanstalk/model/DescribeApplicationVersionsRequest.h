...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeApplicationVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeApplicationVersionsRequest>(GetServiceRequestName(), *this);
    }
