...
namespace Model
{
  ...
  public:
     ...
     * error. </p> <p> Condition: You must specify either this or an EnvironmentName,
    ...
    /**
     * <p> If this parameter is specified, AWS Elastic Beanstalk updates the
     * description of this environment. </p>
     */
    ...
    /**
     * <p> This specifies the tier to use to update the environment. </p> <p>
     * Condition: At this time, if you change the tier version, name, or type, AWS
     * Elastic Beanstalk returns <code>InvalidParameterValue</code> error. </p>
     */
