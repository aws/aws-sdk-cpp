...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ELASTICBEANSTALK_API AssociateEnvironmentOperationsRoleRequest : public ElasticBeanstalkRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateEnvironmentOperationsRoleRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateEnvironmentOperationsRoleRequest>(GetServiceRequestName(), *this);
    }
