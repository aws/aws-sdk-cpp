...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateApplicationResourceLifecycleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateApplicationResourceLifecycleRequest>(GetServiceRequestName(), *this);
    }
