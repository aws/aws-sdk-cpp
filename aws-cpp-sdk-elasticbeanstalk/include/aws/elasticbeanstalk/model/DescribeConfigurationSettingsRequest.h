...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConfigurationSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConfigurationSettingsRequest>(GetServiceRequestName(), *this);
    }
