...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p> The name of the configuration template to describe. </p> <p> Conditional:
     * You must specify either this parameter or an EnvironmentName, but not both. If
    ...
    /**
     * <p> The name of the environment to describe. </p> <p> Condition: You must
     * specify either this or a TemplateName, but not both. If you specify both, AWS
