...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateEnvironmentOperationsRoleRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateEnvironmentOperationsRoleRequest>(GetServiceRequestName(), *this);
    }
