...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p> The name of the configuration template to validate the settings against.
     * </p> <p> Condition: You cannot specify both this and an environment name. </p>
     */
    ...
    /**
     * <p> The name of the environment to validate the settings against. </p> <p>
     * Condition: You cannot specify both this and a configuration template name. </p>
     */
