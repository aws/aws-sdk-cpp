...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ValidateConfigurationSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<ValidateConfigurationSettingsRequest>(GetServiceRequestName(), *this);
    }
