...
using ResolveEndpointOutcome = Aws::ElasticBeanstalk::Endpoint::ElasticBeanstalkEndpointProvider::ElasticBeanstalkResolveEndpointOutcome;
...
ElasticBeanstalkClient::ElasticBeanstalkClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::ElasticBeanstalkEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ElasticBeanstalkErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ElasticBeanstalk::Endpoint::ElasticBeanstalkEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
