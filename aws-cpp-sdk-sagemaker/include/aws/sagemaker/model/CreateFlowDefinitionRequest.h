...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API CreateFlowDefinitionRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateFlowDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFlowDefinitionRequest>(GetServiceRequestName(), *this);
    }
