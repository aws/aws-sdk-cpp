...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API SendPipelineExecutionStepSuccessRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SendPipelineExecutionStepSuccessRequest> Clone() const
    {
      return Aws::MakeUnique<SendPipelineExecutionStepSuccessRequest>(GetServiceRequestName(), *this);
    }
