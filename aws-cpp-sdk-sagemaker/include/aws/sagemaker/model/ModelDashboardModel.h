...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API ModelDashboardModel
  {
  public:
    ModelDashboardModel();
    ModelDashboardModel(Aws::Utils::Json::JsonView jsonValue);
    ModelDashboardModel& operator=(Aws::Utils::Json::JsonView jsonValue);
