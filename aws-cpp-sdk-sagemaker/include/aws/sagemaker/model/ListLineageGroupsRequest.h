...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListLineageGroupsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLineageGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<ListLineageGroupsRequest>(GetServiceRequestName(), *this);
    }
