...
namespace Model
{
  ...
  /**
   * <p>An entity having characteristics over which a user can search for a
   * hyperparameter tuning job.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/HyperParameterTuningJobSearchEntity">AWS
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API HyperParameterTuningJobSearchEntity
  {
  public:
    HyperParameterTuningJobSearchEntity();
    HyperParameterTuningJobSearchEntity(Aws::Utils::Json::JsonView jsonValue);
    HyperParameterTuningJobSearchEntity& operator=(Aws::Utils::Json::JsonView jsonValue);
