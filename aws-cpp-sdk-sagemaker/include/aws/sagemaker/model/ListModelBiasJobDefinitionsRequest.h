...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListModelBiasJobDefinitionsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListModelBiasJobDefinitionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListModelBiasJobDefinitionsRequest>(GetServiceRequestName(), *this);
    }
