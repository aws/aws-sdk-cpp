...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListUserProfilesRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListUserProfilesRequest> Clone() const
    {
      return Aws::MakeUnique<ListUserProfilesRequest>(GetServiceRequestName(), *this);
    }
