...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTrainingJobsForHyperParameterTuningJobRequest> Clone() const
    {
      return Aws::MakeUnique<ListTrainingJobsForHyperParameterTuningJobRequest>(GetServiceRequestName(), *this);
    }
