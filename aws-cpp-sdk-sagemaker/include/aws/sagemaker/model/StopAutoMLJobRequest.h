...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API StopAutoMLJobRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopAutoMLJobRequest> Clone() const
    {
      return Aws::MakeUnique<StopAutoMLJobRequest>(GetServiceRequestName(), *this);
    }
