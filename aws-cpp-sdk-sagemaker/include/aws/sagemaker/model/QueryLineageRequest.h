...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API QueryLineageRequest : public SageMakerRequest
  {
  public:
    QueryLineageRequest();
    ...
    */
    virtual Aws::UniquePtr<QueryLineageRequest> Clone() const
    {
      return Aws::MakeUnique<QueryLineageRequest>(GetServiceRequestName(), *this);
    }
