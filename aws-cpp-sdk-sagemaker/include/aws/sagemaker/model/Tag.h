...
namespace Model
{
   ...
   * metadata for Amazon SageMaker Amazon Web Services resources.</p> <p>You can add
   * tags to notebook instances, training jobs, hyperparameter tuning jobs, batch
   * transform jobs, models, labeling jobs, work teams, endpoint configurations, and
   * endpoints. For more information on adding tags to Amazon SageMaker resources,
   * see <a>AddTags</a>.</p> <p>For more information on adding metadata to your
