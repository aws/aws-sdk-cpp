...
namespace Model
{
   ...
   * metadata for Amazon SageMaker AWS resources.</p> <p>You can add tags to notebook
   ...
   * more information on adding tags to Amazon SageMaker resources, see
   * <a>AddTags</a>.</p> <p>For more information on adding metadata to your AWS
   * resources with tagging, see <a
   * href="https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html">Tagging
   * AWS resources</a>. For advice on best practices for managing AWS resources with
   * tagging, see <a
