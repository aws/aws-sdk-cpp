...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API InferenceExperimentSummary
  {
  public:
    InferenceExperimentSummary();
    InferenceExperimentSummary(Aws::Utils::Json::JsonView jsonValue);
    InferenceExperimentSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
