...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeImageRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeImageRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeImageRequest>(GetServiceRequestName(), *this);
    }
