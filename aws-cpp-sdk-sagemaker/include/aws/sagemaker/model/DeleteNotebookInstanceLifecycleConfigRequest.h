...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteNotebookInstanceLifecycleConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteNotebookInstanceLifecycleConfigRequest>(GetServiceRequestName(), *this);
    }
