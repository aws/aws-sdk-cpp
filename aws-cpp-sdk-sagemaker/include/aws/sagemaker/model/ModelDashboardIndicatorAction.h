...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API ModelDashboardIndicatorAction
  {
  public:
    ModelDashboardIndicatorAction();
    ModelDashboardIndicatorAction(Aws::Utils::Json::JsonView jsonValue);
    ModelDashboardIndicatorAction& operator=(Aws::Utils::Json::JsonView jsonValue);
