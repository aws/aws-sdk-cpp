...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeContextRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeContextRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeContextRequest>(GetServiceRequestName(), *this);
    }
