...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API UpdateDevicesRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDevicesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDevicesRequest>(GetServiceRequestName(), *this);
    }
