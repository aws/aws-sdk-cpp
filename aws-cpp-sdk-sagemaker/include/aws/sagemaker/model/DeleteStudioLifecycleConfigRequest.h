...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteStudioLifecycleConfigRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteStudioLifecycleConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteStudioLifecycleConfigRequest>(GetServiceRequestName(), *this);
    }
