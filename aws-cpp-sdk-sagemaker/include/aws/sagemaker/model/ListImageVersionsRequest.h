...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListImageVersionsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListImageVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListImageVersionsRequest>(GetServiceRequestName(), *this);
    }
