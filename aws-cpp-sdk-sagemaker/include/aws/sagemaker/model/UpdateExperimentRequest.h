...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API UpdateExperimentRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateExperimentRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateExperimentRequest>(GetServiceRequestName(), *this);
    }
