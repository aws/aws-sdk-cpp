...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API MonitoringAlertSummary
  {
  public:
    MonitoringAlertSummary();
    MonitoringAlertSummary(Aws::Utils::Json::JsonView jsonValue);
    MonitoringAlertSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
