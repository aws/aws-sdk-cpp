...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API ModelDashboardMonitoringSchedule
  {
  public:
    ModelDashboardMonitoringSchedule();
    ModelDashboardMonitoringSchedule(Aws::Utils::Json::JsonView jsonValue);
    ModelDashboardMonitoringSchedule& operator=(Aws::Utils::Json::JsonView jsonValue);
