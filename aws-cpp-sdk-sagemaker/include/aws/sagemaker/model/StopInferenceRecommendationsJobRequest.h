...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StopInferenceRecommendationsJobRequest> Clone() const
    {
      return Aws::MakeUnique<StopInferenceRecommendationsJobRequest>(GetServiceRequestName(), *this);
    }
