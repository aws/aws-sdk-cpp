...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeEdgeDeploymentPlanRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEdgeDeploymentPlanRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEdgeDeploymentPlanRequest>(GetServiceRequestName(), *this);
    }
