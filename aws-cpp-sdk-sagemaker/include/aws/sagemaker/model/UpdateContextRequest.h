...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API UpdateContextRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateContextRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateContextRequest>(GetServiceRequestName(), *this);
    }
