...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteModelPackageGroupRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteModelPackageGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteModelPackageGroupRequest>(GetServiceRequestName(), *this);
    }
