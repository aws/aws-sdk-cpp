...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteDeviceFleetRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDeviceFleetRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDeviceFleetRequest>(GetServiceRequestName(), *this);
    }
