...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListModelExplainabilityJobDefinitionsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListModelExplainabilityJobDefinitionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListModelExplainabilityJobDefinitionsRequest>(GetServiceRequestName(), *this);
    }
