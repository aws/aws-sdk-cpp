...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLabelingJobsForWorkteamRequest> Clone() const
    {
      return Aws::MakeUnique<ListLabelingJobsForWorkteamRequest>(GetServiceRequestName(), *this);
    }
