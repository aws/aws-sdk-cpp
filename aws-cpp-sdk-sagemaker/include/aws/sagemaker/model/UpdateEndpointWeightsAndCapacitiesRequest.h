...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateEndpointWeightsAndCapacitiesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateEndpointWeightsAndCapacitiesRequest>(GetServiceRequestName(), *this);
    }
