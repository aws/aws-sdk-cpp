...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API StartPipelineExecutionRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartPipelineExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<StartPipelineExecutionRequest>(GetServiceRequestName(), *this);
    }
