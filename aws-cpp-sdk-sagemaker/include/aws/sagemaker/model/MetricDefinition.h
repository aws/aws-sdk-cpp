...
namespace Model
{
   ...
   * or <code>stdout</code>. Amazon SageMakerHyperparamter tuning captures all
  ...
  public:
    MetricDefinition();
    MetricDefinition(const Aws::Utils::Json::JsonValue& jsonValue);
    MetricDefinition& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
