...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API CreateInferenceRecommendationsJobRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateInferenceRecommendationsJobRequest> Clone() const
    {
      return Aws::MakeUnique<CreateInferenceRecommendationsJobRequest>(GetServiceRequestName(), *this);
    }
