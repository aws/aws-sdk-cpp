...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListNotebookInstanceLifecycleConfigsRequest> Clone() const
    {
      return Aws::MakeUnique<ListNotebookInstanceLifecycleConfigsRequest>(GetServiceRequestName(), *this);
    }
