...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListStudioLifecycleConfigsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListStudioLifecycleConfigsRequest> Clone() const
    {
      return Aws::MakeUnique<ListStudioLifecycleConfigsRequest>(GetServiceRequestName(), *this);
    }
