...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateStudioLifecycleConfigRequest> Clone() const
    {
      return Aws::MakeUnique<CreateStudioLifecycleConfigRequest>(GetServiceRequestName(), *this);
    }
