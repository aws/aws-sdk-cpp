...
namespace Model
{
   ...
   * Reference</a></p>
   */
  class AWS_SAGEMAKER_API Trial
  {
  public:
    Trial();
    Trial(Aws::Utils::Json::JsonView jsonValue);
    Trial& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  private:
    ...
    bool m_trialComponentSummariesHasBeenSet;
  };
