...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeSubscribedWorkteamRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSubscribedWorkteamRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSubscribedWorkteamRequest>(GetServiceRequestName(), *this);
    }
