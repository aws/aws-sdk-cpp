...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeAppImageConfigRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAppImageConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAppImageConfigRequest>(GetServiceRequestName(), *this);
    }
