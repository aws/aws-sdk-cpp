...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListWorkforcesRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWorkforcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListWorkforcesRequest>(GetServiceRequestName(), *this);
    }
