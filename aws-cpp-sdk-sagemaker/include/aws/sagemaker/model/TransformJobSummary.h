...
namespace Model
{
  ...
  /**
   * <p>Provides a summary information for a transform job. Multiple
   * TransformJobSummary objects are returned as a list after calling
   * <a>ListTransformJobs</a>.</p><p><h3>See Also:</h3>   <a
  ...
  public:
    TransformJobSummary();
    TransformJobSummary(const Aws::Utils::Json::JsonValue& jsonValue);
    TransformJobSummary& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
