...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListHyperParameterTuningJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListHyperParameterTuningJobsRequest>(GetServiceRequestName(), *this);
    }
