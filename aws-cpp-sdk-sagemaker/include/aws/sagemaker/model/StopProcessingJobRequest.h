...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API StopProcessingJobRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopProcessingJobRequest> Clone() const
    {
      return Aws::MakeUnique<StopProcessingJobRequest>(GetServiceRequestName(), *this);
    }
