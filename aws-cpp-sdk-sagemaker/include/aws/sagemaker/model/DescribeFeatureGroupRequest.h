...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeFeatureGroupRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFeatureGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFeatureGroupRequest>(GetServiceRequestName(), *this);
    }
