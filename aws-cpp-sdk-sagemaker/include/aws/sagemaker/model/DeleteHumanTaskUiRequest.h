...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteHumanTaskUiRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteHumanTaskUiRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteHumanTaskUiRequest>(GetServiceRequestName(), *this);
    }
