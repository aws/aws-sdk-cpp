...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListEdgeDeploymentPlansRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEdgeDeploymentPlansRequest> Clone() const
    {
      return Aws::MakeUnique<ListEdgeDeploymentPlansRequest>(GetServiceRequestName(), *this);
    }
