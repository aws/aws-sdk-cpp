...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListInferenceRecommendationsJobsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListInferenceRecommendationsJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListInferenceRecommendationsJobsRequest>(GetServiceRequestName(), *this);
    }
