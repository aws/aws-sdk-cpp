...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API CreateTrialRequest : public SageMakerRequest
  {
  public:
    CreateTrialRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateTrialRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTrialRequest>(GetServiceRequestName(), *this);
    }
