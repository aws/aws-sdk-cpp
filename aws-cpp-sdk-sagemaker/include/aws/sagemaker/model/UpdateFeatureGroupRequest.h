...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API UpdateFeatureGroupRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFeatureGroupRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFeatureGroupRequest>(GetServiceRequestName(), *this);
    }
