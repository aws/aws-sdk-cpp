...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API MonitoringCsvDatasetFormat
  {
  public:
    MonitoringCsvDatasetFormat();
    MonitoringCsvDatasetFormat(Aws::Utils::Json::JsonView jsonValue);
    MonitoringCsvDatasetFormat& operator=(Aws::Utils::Json::JsonView jsonValue);
