...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateNotebookInstanceLifecycleConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateNotebookInstanceLifecycleConfigRequest>(GetServiceRequestName(), *this);
    }
