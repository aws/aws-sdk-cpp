...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<SendPipelineExecutionStepFailureRequest> Clone() const
    {
      return Aws::MakeUnique<SendPipelineExecutionStepFailureRequest>(GetServiceRequestName(), *this);
    }
