...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeMonitoringScheduleRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMonitoringScheduleRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMonitoringScheduleRequest>(GetServiceRequestName(), *this);
    }
