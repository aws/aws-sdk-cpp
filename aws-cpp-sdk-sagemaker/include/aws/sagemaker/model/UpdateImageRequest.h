...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API UpdateImageRequest : public SageMakerRequest
  {
  public:
    UpdateImageRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateImageRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateImageRequest>(GetServiceRequestName(), *this);
    }
