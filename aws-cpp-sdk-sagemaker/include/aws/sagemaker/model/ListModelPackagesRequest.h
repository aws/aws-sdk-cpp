...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListModelPackagesRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListModelPackagesRequest> Clone() const
    {
      return Aws::MakeUnique<ListModelPackagesRequest>(GetServiceRequestName(), *this);
    }
