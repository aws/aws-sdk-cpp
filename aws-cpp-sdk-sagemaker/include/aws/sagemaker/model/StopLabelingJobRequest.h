...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API StopLabelingJobRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopLabelingJobRequest> Clone() const
    {
      return Aws::MakeUnique<StopLabelingJobRequest>(GetServiceRequestName(), *this);
    }
