...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreatePresignedNotebookInstanceUrlRequest> Clone() const
    {
      return Aws::MakeUnique<CreatePresignedNotebookInstanceUrlRequest>(GetServiceRequestName(), *this);
    }
