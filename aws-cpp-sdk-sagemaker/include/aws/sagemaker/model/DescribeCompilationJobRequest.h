...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeCompilationJobRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCompilationJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCompilationJobRequest>(GetServiceRequestName(), *this);
    }
