...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSagemakerServicecatalogPortfolioStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetSagemakerServicecatalogPortfolioStatusRequest>(GetServiceRequestName(), *this);
    }
