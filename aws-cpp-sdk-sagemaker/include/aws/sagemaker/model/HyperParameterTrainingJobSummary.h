...
namespace Model
{
  ...
  public:
    ...
    HyperParameterTrainingJobSummary(const Aws::Utils::Json::JsonValue& jsonValue);
    HyperParameterTrainingJobSummary& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
