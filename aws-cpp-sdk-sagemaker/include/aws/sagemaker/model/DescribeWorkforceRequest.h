...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeWorkforceRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeWorkforceRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeWorkforceRequest>(GetServiceRequestName(), *this);
    }
