...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeFlowDefinitionRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFlowDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFlowDefinitionRequest>(GetServiceRequestName(), *this);
    }
