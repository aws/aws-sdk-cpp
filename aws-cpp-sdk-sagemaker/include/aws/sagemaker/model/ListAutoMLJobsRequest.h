...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListAutoMLJobsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAutoMLJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAutoMLJobsRequest>(GetServiceRequestName(), *this);
    }
