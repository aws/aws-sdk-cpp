...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListDataQualityJobDefinitionsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDataQualityJobDefinitionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDataQualityJobDefinitionsRequest>(GetServiceRequestName(), *this);
    }
