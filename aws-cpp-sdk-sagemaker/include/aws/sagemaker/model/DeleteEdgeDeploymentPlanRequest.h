...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteEdgeDeploymentPlanRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEdgeDeploymentPlanRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEdgeDeploymentPlanRequest>(GetServiceRequestName(), *this);
    }
