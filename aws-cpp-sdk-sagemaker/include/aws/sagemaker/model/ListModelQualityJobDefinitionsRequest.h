...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListModelQualityJobDefinitionsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListModelQualityJobDefinitionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListModelQualityJobDefinitionsRequest>(GetServiceRequestName(), *this);
    }
