...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListActionsRequest : public SageMakerRequest
  {
  public:
    ListActionsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListActionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListActionsRequest>(GetServiceRequestName(), *this);
    }
