...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API AddAssociationRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AddAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<AddAssociationRequest>(GetServiceRequestName(), *this);
    }
