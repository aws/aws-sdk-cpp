...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListModelMetadataRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListModelMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<ListModelMetadataRequest>(GetServiceRequestName(), *this);
    }
