...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API CreateContextRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateContextRequest> Clone() const
    {
      return Aws::MakeUnique<CreateContextRequest>(GetServiceRequestName(), *this);
    }
