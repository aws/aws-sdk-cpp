...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteWorkforceRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWorkforceRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWorkforceRequest>(GetServiceRequestName(), *this);
    }
