...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API StopEdgeDeploymentStageRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopEdgeDeploymentStageRequest> Clone() const
    {
      return Aws::MakeUnique<StopEdgeDeploymentStageRequest>(GetServiceRequestName(), *this);
    }
