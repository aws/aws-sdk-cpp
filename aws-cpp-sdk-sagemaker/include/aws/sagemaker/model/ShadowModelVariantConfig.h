...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API ShadowModelVariantConfig
  {
  public:
    ShadowModelVariantConfig();
    ShadowModelVariantConfig(Aws::Utils::Json::JsonView jsonValue);
    ShadowModelVariantConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
