...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StopHyperParameterTuningJobRequest> Clone() const
    {
      return Aws::MakeUnique<StopHyperParameterTuningJobRequest>(GetServiceRequestName(), *this);
    }
