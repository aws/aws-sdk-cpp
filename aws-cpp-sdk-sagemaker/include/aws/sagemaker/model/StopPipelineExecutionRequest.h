...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API StopPipelineExecutionRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopPipelineExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<StopPipelineExecutionRequest>(GetServiceRequestName(), *this);
    }
