...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteEdgeDeploymentStageRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEdgeDeploymentStageRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEdgeDeploymentStageRequest>(GetServiceRequestName(), *this);
    }
