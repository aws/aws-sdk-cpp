...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteAlgorithmRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAlgorithmRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAlgorithmRequest>(GetServiceRequestName(), *this);
    }
