...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDataQualityJobDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDataQualityJobDefinitionRequest>(GetServiceRequestName(), *this);
    }
