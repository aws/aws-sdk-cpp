...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API StopEdgePackagingJobRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StopEdgePackagingJobRequest> Clone() const
    {
      return Aws::MakeUnique<StopEdgePackagingJobRequest>(GetServiceRequestName(), *this);
    }
