...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteTrialComponentRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTrialComponentRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTrialComponentRequest>(GetServiceRequestName(), *this);
    }
