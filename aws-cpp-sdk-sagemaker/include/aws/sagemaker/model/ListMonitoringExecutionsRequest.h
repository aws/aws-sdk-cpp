...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListMonitoringExecutionsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMonitoringExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMonitoringExecutionsRequest>(GetServiceRequestName(), *this);
    }
