...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API GetDeviceFleetReportRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDeviceFleetReportRequest> Clone() const
    {
      return Aws::MakeUnique<GetDeviceFleetReportRequest>(GetServiceRequestName(), *this);
    }
