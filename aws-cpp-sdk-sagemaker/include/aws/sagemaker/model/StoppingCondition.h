...
namespace Model
{
   ...
   * results of training are not lost. </p> <p>The training algorithms provided by
   * Amazon SageMaker automatically save the intermediate results of a model training
   * job when possible. This attempt to save artifacts is only a best effort case as
   ...
   * model with <code>CreateModel</code>.</p>  <p>The Neural Topic Model (NTM)
  ...
  public:
     ...
     * the job.</p> <p>When <code>RetryStrategy</code> is specified in the job request,
     * <code>MaxRuntimeInSeconds</code> specifies the maximum time for all of the
     * attempts in total, not each individual attempt.</p> <p>The default value is 1
     * day. The maximum value is 28 days.</p>
     */
