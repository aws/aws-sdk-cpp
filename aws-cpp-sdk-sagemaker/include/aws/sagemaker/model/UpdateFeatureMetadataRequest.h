...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API UpdateFeatureMetadataRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFeatureMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFeatureMetadataRequest>(GetServiceRequestName(), *this);
    }
