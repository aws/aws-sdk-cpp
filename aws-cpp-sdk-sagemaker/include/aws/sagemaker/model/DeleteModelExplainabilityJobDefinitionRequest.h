...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteModelExplainabilityJobDefinitionRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteModelExplainabilityJobDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteModelExplainabilityJobDefinitionRequest>(GetServiceRequestName(), *this);
    }
