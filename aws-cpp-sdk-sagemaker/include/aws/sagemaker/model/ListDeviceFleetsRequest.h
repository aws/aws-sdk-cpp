...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListDeviceFleetsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDeviceFleetsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDeviceFleetsRequest>(GetServiceRequestName(), *this);
    }
