...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePipelineDefinitionForExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePipelineDefinitionForExecutionRequest>(GetServiceRequestName(), *this);
    }
