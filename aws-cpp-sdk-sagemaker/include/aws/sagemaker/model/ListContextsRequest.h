...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListContextsRequest : public SageMakerRequest
  {
  public:
    ListContextsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListContextsRequest> Clone() const
    {
      return Aws::MakeUnique<ListContextsRequest>(GetServiceRequestName(), *this);
    }
