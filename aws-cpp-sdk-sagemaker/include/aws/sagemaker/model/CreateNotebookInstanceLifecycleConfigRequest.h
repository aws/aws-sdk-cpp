...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateNotebookInstanceLifecycleConfigRequest> Clone() const
    {
      return Aws::MakeUnique<CreateNotebookInstanceLifecycleConfigRequest>(GetServiceRequestName(), *this);
    }
