...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API PutModelPackageGroupPolicyRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutModelPackageGroupPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<PutModelPackageGroupPolicyRequest>(GetServiceRequestName(), *this);
    }
