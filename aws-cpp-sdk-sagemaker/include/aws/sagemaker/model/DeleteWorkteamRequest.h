...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteWorkteamRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWorkteamRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWorkteamRequest>(GetServiceRequestName(), *this);
    }
