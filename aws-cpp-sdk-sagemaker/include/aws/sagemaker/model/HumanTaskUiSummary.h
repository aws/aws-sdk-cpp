...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API HumanTaskUiSummary
  {
  public:
    HumanTaskUiSummary();
    HumanTaskUiSummary(Aws::Utils::Json::JsonView jsonValue);
    HumanTaskUiSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
