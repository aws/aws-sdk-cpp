...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeFeatureMetadataRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFeatureMetadataRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFeatureMetadataRequest>(GetServiceRequestName(), *this);
    }
