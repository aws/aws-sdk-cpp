...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API ModelDashboardModelCard
  {
  public:
    ModelDashboardModelCard();
    ModelDashboardModelCard(Aws::Utils::Json::JsonView jsonValue);
    ModelDashboardModelCard& operator=(Aws::Utils::Json::JsonView jsonValue);
