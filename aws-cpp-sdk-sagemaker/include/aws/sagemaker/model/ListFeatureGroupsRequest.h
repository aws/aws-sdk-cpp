...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListFeatureGroupsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFeatureGroupsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFeatureGroupsRequest>(GetServiceRequestName(), *this);
    }
