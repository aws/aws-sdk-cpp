...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeCodeRepositoryRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCodeRepositoryRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCodeRepositoryRequest>(GetServiceRequestName(), *this);
    }
