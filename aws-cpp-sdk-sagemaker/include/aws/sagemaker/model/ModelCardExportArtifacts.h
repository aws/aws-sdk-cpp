...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API ModelCardExportArtifacts
  {
  public:
    ModelCardExportArtifacts();
    ModelCardExportArtifacts(Aws::Utils::Json::JsonView jsonValue);
    ModelCardExportArtifacts& operator=(Aws::Utils::Json::JsonView jsonValue);
