...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API UpdateActionRequest : public SageMakerRequest
  {
  public:
    UpdateActionRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateActionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateActionRequest>(GetServiceRequestName(), *this);
    }
