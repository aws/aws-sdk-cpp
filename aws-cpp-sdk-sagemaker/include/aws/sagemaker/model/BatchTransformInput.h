...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API BatchTransformInput
  {
  public:
    BatchTransformInput();
    BatchTransformInput(Aws::Utils::Json::JsonView jsonValue);
    BatchTransformInput& operator=(Aws::Utils::Json::JsonView jsonValue);
