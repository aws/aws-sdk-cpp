...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API GetLineageGroupPolicyRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetLineageGroupPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetLineageGroupPolicyRequest>(GetServiceRequestName(), *this);
    }
