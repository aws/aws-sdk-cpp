...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListPipelineParametersForExecutionRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPipelineParametersForExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<ListPipelineParametersForExecutionRequest>(GetServiceRequestName(), *this);
    }
