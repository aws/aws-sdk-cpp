...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API FeatureDefinition
  {
  public:
    FeatureDefinition();
    FeatureDefinition(Aws::Utils::Json::JsonView jsonValue);
    FeatureDefinition& operator=(Aws::Utils::Json::JsonView jsonValue);
