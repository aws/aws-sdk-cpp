...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API CreateEdgeDeploymentStageRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateEdgeDeploymentStageRequest> Clone() const
    {
      return Aws::MakeUnique<CreateEdgeDeploymentStageRequest>(GetServiceRequestName(), *this);
    }
