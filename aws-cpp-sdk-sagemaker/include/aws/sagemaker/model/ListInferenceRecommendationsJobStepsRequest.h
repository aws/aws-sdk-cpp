...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListInferenceRecommendationsJobStepsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListInferenceRecommendationsJobStepsRequest> Clone() const
    {
      return Aws::MakeUnique<ListInferenceRecommendationsJobStepsRequest>(GetServiceRequestName(), *this);
    }
