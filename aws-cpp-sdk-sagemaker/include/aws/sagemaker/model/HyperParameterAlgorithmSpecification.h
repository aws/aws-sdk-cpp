...
namespace Model
{
  ...
  public:
    ...
    HyperParameterAlgorithmSpecification(const Aws::Utils::Json::JsonValue& jsonValue);
    HyperParameterAlgorithmSpecification& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
    ...
    /**
     * <p>An array of objects that specify the metrics that the algorithm emits.</p>
     */
