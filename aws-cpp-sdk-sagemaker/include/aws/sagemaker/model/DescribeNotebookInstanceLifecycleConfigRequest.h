...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNotebookInstanceLifecycleConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNotebookInstanceLifecycleConfigRequest>(GetServiceRequestName(), *this);
    }
