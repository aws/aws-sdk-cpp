...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribePipelineRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePipelineRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePipelineRequest>(GetServiceRequestName(), *this);
    }
