...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API EndpointPerformance
  {
  public:
    EndpointPerformance();
    EndpointPerformance(Aws::Utils::Json::JsonView jsonValue);
    EndpointPerformance& operator=(Aws::Utils::Json::JsonView jsonValue);
