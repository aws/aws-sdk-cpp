...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API MonitoringAlertActions
  {
  public:
    MonitoringAlertActions();
    MonitoringAlertActions(Aws::Utils::Json::JsonView jsonValue);
    MonitoringAlertActions& operator=(Aws::Utils::Json::JsonView jsonValue);
