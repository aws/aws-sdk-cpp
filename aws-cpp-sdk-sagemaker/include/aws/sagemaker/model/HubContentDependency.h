...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API HubContentDependency
  {
  public:
    HubContentDependency();
    HubContentDependency(Aws::Utils::Json::JsonView jsonValue);
    HubContentDependency& operator=(Aws::Utils::Json::JsonView jsonValue);
