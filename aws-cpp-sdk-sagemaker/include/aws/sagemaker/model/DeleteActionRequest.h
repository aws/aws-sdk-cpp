...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteActionRequest : public SageMakerRequest
  {
  public:
    DeleteActionRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteActionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteActionRequest>(GetServiceRequestName(), *this);
    }
