...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API MonitoringDatasetFormat
  {
  public:
    MonitoringDatasetFormat();
    MonitoringDatasetFormat(Aws::Utils::Json::JsonView jsonValue);
    MonitoringDatasetFormat& operator=(Aws::Utils::Json::JsonView jsonValue);
