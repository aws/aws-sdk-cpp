...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API DefaultSpaceSettings
  {
  public:
    DefaultSpaceSettings();
    DefaultSpaceSettings(Aws::Utils::Json::JsonView jsonValue);
    DefaultSpaceSettings& operator=(Aws::Utils::Json::JsonView jsonValue);
