...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API ModelStepMetadata
  {
  public:
    ModelStepMetadata();
    ModelStepMetadata(Aws::Utils::Json::JsonView jsonValue);
    ModelStepMetadata& operator=(Aws::Utils::Json::JsonView jsonValue);
