...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateHyperParameterTuningJobRequest> Clone() const
    {
      return Aws::MakeUnique<CreateHyperParameterTuningJobRequest>(GetServiceRequestName(), *this);
    }
