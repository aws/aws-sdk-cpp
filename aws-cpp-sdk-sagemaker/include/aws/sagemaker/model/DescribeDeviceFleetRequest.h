...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeDeviceFleetRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDeviceFleetRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDeviceFleetRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DescribeDeviceFleet"; }
