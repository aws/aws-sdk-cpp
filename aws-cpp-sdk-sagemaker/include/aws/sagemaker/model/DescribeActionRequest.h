...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribeActionRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeActionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeActionRequest>(GetServiceRequestName(), *this);
    }
