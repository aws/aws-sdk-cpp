...
namespace Model
{
  ...
  public:
     ...
     * compute instance that hosts the endpoint.</p> <note> <p>Nitro-based instances do
     * not support encryption with AWS KMS. If any of the models that you specify in
     * the <code>ProductionVariants</code> parameter use nitro-based instances, do not
     * specify a value for the <code>KmsKeyId</code> parameter. If you specify a value
     * for <code>KmsKeyId</code> when using any nitro-based instances, the call to
     * <code>CreateEndpointConfig</code> fails.</p> <p>For a list of nitro-based
     * instances, see <a
     * href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html#ec2-nitro-instances">Nitro-based
     * Instances</a> in the <i>Amazon Elastic Compute Cloud User Guide for Linux
     * Instances</i>.</p> <p>For more information about storage volumes on nitro-based
     * instances, see <a
     * href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/nvme-ebs-volumes.html">Amazon
     * EBS and NVMe on Linux Instances</a>.</p> </note>
     */
