...
namespace Model
{
  ...
  public:
     ...
     * compute instance that hosts the endpoint.</p> <note> <p>Certain Nitro-based
     ...
     * a <code>KmsKeyId</code> when using an instance type with local storage. If any
     * of the models that you specify in the <code>ProductionVariants</code> parameter
