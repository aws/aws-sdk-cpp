...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API MonitoringConstraintsResource
  {
  public:
    MonitoringConstraintsResource();
    MonitoringConstraintsResource(Aws::Utils::Json::JsonView jsonValue);
    MonitoringConstraintsResource& operator=(Aws::Utils::Json::JsonView jsonValue);
