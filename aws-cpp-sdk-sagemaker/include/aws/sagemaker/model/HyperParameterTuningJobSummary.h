...
namespace Model
{
  ...
  public:
    ...
    HyperParameterTuningJobSummary(const Aws::Utils::Json::JsonValue& jsonValue);
    HyperParameterTuningJobSummary& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
    ...
    /**
     * <p>The object that specifies the numbers of training jobs, categorized by
     * status, that this tuning job launched.</p>
     */
    ...
    /**
     * <p>The object that specifies the numbers of training jobs, categorized by
     * objective metric status, that this tuning job launched.</p>
     */
     ...
     * training jobs allowed for this tuning job.</p>
     */
