...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API UpdateTrialRequest : public SageMakerRequest
  {
  public:
    UpdateTrialRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateTrialRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTrialRequest>(GetServiceRequestName(), *this);
    }
