...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API UserProfileDetails
  {
  public:
    UserProfileDetails();
    UserProfileDetails(Aws::Utils::Json::JsonView jsonValue);
    UserProfileDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
