...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeregisterDevicesRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeregisterDevicesRequest> Clone() const
    {
      return Aws::MakeUnique<DeregisterDevicesRequest>(GetServiceRequestName(), *this);
    }
