...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListProcessingJobsRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListProcessingJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListProcessingJobsRequest>(GetServiceRequestName(), *this);
    }
