...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteCodeRepositoryRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCodeRepositoryRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCodeRepositoryRequest>(GetServiceRequestName(), *this);
    }
