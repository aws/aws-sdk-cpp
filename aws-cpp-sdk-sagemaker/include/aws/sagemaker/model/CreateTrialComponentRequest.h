...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API CreateTrialComponentRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTrialComponentRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTrialComponentRequest>(GetServiceRequestName(), *this);
    }
