...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_SAGEMAKER_API ClarifyShapConfig
  {
  public:
    ClarifyShapConfig();
    ClarifyShapConfig(Aws::Utils::Json::JsonView jsonValue);
    ClarifyShapConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
