...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateModelExplainabilityJobDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateModelExplainabilityJobDefinitionRequest>(GetServiceRequestName(), *this);
    }
