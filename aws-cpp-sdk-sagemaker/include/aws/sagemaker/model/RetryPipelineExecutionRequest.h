...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API RetryPipelineExecutionRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RetryPipelineExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<RetryPipelineExecutionRequest>(GetServiceRequestName(), *this);
    }
