...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DeleteFeatureGroupRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFeatureGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFeatureGroupRequest>(GetServiceRequestName(), *this);
    }
