...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API DescribePipelineExecutionRequest : public SageMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePipelineExecutionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePipelineExecutionRequest>(GetServiceRequestName(), *this);
    }
