...
namespace Model
{
  ...
  /**
   */
  class AWS_SAGEMAKER_API ListTrialsRequest : public SageMakerRequest
  {
  public:
    ListTrialsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListTrialsRequest> Clone() const
    {
      return Aws::MakeUnique<ListTrialsRequest>(GetServiceRequestName(), *this);
    }
