...
namespace SageMaker
{
  ...
  class AWS_SAGEMAKER_API SageMakerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SageMakerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                        std::shared_ptr<Endpoint::SageMakerEndpointProvider> endpointProvider = Aws::MakeShared<SageMaker::Endpoint::SageMakerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SageMakerEndpointProvider> m_endpointProvider;
  };
