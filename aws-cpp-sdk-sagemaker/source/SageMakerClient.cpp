...
using ResolveEndpointOutcome = Aws::SageMaker::Endpoint::SageMakerEndpointProvider::SageMakerResolveEndpointOutcome;
...
SageMakerClient::SageMakerClient(const Client::ClientConfiguration& clientConfiguration,
                                 std::shared_ptr<Endpoint::SageMakerEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SageMakerErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<SageMaker::Endpoint::SageMakerEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
