...
ListDeviceFleetsRequest::ListDeviceFleetsRequest() : 
    ...
    m_sortBy(ListDeviceFleetsSortBy::NOT_SET),
...
Aws::String ListDeviceFleetsRequest::SerializePayload() const
{
  JsonValue payload;
  ...
  {
   payload.WithString("SortBy", ListDeviceFleetsSortByMapper::GetNameForListDeviceFleetsSortBy(m_sortBy));
  }
...
Aws::Http::HeaderValueCollection ListDeviceFleetsRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "SageMaker.ListDeviceFleets"));
  return headers;
