...
ListTransformJobsRequest::ListTransformJobsRequest() : 
    ...
    m_statusEquals(TransformJobStatus::NOT_SET),
...
Aws::String ListTransformJobsRequest::SerializePayload() const
{
  JsonValue payload;
  ...
  {
   payload.WithString("StatusEquals", TransformJobStatusMapper::GetNameForTransformJobStatus(m_statusEquals));
  }
...
Aws::Http::HeaderValueCollection ListTransformJobsRequest::GetRequestSpecificHeaders() const
{
  ...
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "SageMaker.ListTransformJobs"));
  return headers;
