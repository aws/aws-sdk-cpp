...
CreatePresignedDomainUrlResult::CreatePresignedDomainUrlResult()
{
}

CreatePresignedDomainUrlResult::CreatePresignedDomainUrlResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
