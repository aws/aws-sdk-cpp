...
AssociateTrialComponentResult::AssociateTrialComponentResult()
{
}

AssociateTrialComponentResult::AssociateTrialComponentResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
