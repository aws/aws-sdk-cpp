...
ModelQualityAppSpecification& ModelQualityAppSpecification::operator =(JsonView jsonValue)
{
...
JsonValue ModelQualityAppSpecification::Jsonize() const
{
  JsonValue payload;
  ...
  {
   payload.WithString("ProblemType", MonitoringProblemTypeMapper::GetNameForMonitoringProblemType(m_problemType));
  }
