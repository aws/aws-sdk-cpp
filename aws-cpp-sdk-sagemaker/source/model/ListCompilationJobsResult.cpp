...
ListCompilationJobsResult::ListCompilationJobsResult()
{
}

ListCompilationJobsResult::ListCompilationJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListCompilationJobsResult& ListCompilationJobsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
