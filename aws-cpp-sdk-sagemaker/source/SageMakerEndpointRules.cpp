...
Aws::String SageMakerEndpointRules::GetRulesAsString()
{
    return Aws::String(SageMakerEndpointRules::Rules.begin(), SageMakerEndpointRules::Rules.end());
}

const Aws::Vector<char> SageMakerEndpointRules::Rules = {
...
't','t','p','s',':','/','/','a','p','i','.','s','a','g','e','m','a','k','e','r','-','f','i','p','s',
...
'r','i','n','g','E','q','u','a','l','s','"',',','"','a','r','g','v','"',':','[','"','a','w','s','"',
',','{','"','f','n','"',':','"','g','e','t','A','t','t','r','"',',','"','a','r','g','v','"',':','[',
'{','"','r','e','f','"',':','"','P','a','r','t','i','t','i','o','n','R','e','s','u','l','t','"','}',
',','"','n','a','m','e','"',']','}',']','}',']',',','"','e','n','d','p','o','i','n','t','"',':','{',
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','i','-','f','i','p','s','.','s',
'a','g','e','m','a','k','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/',
'/','a','p','i','.','s','a','g','e','m','a','k','e','r','-','f','i','p','s','.','{','R','e','g','i',
'o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u','l','t','#','d','n','s','S',
'u','f','f','i','x','}','"',',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','}',',','"',
'h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y','p','e','"',':','"','e','n','d','p',
'o','i','n','t','"','}',']','}',']','}',',','{','"','c','o','n','d','i','t','i','o','n','s','"',':',
...
's',':','/','/','a','p','i','.','s','a','g','e','m','a','k','e','r','.','{','R','e','g','i','o','n',
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','i',
'.','s','a','g','e','m','a','k','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
