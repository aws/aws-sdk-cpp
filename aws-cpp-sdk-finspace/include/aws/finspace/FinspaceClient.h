...
namespace finspace
{
  ...
  class AWS_FINSPACE_API FinspaceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        FinspaceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::FinspaceEndpointProvider> endpointProvider = Aws::MakeShared<finspace::Endpoint::FinspaceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::FinspaceEndpointProvider> m_endpointProvider;
  };
