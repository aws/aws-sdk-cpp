...
namespace Model
{
  ...
  /**
   */
  class AWS_FINSPACE_API DeleteEnvironmentRequest : public FinspaceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEnvironmentRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEnvironmentRequest>(GetServiceRequestName(), *this);
    }
