...
Aws::String FinspaceEndpointRules::GetRulesAsString()
{
    return Aws::String(FinspaceEndpointRules::Rules.begin(), FinspaceEndpointRules::Rules.end());
}

const Aws::Vector<char> FinspaceEndpointRules::Rules = {
...
'/','/','f','i','n','s','p','a','c','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
'f','i','n','s','p','a','c','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','f','i','n','s','p','a','c','e','.','{','R','e',
