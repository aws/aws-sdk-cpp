...
using ServiceCatalogResolveEndpointOutcome = Aws::ServiceCatalog::Endpoint::ServiceCatalogEndpointProvider::ServiceCatalogResolveEndpointOutcome;
...
void ValidateOutcome(const ServiceCatalogResolveEndpointOutcome& outcome, const ServiceCatalogEndpointProviderEndpointTestCase::Expect& expect)
{
