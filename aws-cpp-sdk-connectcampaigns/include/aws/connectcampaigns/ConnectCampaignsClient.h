...
namespace ConnectCampaigns
{
  ...
  class AWS_CONNECTCAMPAIGNS_API ConnectCampaignsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ConnectCampaignsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::ConnectCampaignsEndpointProvider> endpointProvider = Aws::MakeShared<ConnectCampaigns::Endpoint::ConnectCampaignsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ConnectCampaignsEndpointProvider> m_endpointProvider;
  };
