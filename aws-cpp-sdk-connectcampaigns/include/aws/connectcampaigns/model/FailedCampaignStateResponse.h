...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCAMPAIGNS_API FailedCampaignStateResponse
  {
  public:
    FailedCampaignStateResponse();
    FailedCampaignStateResponse(Aws::Utils::Json::JsonView jsonValue);
    FailedCampaignStateResponse& operator=(Aws::Utils::Json::JsonView jsonValue);
