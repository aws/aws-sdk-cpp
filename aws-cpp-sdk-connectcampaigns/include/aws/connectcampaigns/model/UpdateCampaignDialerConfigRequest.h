...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCAMPAIGNS_API UpdateCampaignDialerConfigRequest : public ConnectCampaignsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCampaignDialerConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCampaignDialerConfigRequest>(GetServiceRequestName(), *this);
    }
