...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCAMPAIGNS_API PutDialRequestBatchRequest : public ConnectCampaignsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutDialRequestBatchRequest> Clone() const
    {
      return Aws::MakeUnique<PutDialRequestBatchRequest>(GetServiceRequestName(), *this);
    }
