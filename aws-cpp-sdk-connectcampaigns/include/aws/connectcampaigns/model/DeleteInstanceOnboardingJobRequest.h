...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCAMPAIGNS_API DeleteInstanceOnboardingJobRequest : public ConnectCampaignsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteInstanceOnboardingJobRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteInstanceOnboardingJobRequest>(GetServiceRequestName(), *this);
    }
