...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCAMPAIGNS_API ConflictException
  {
  public:
    ConflictException();
    ...
    inline ConflictException& WithXAmzErrorType(const Aws::String& value) { SetXAmzErrorType(value); return *this;}

    
    inline ConflictException& WithXAmzErrorType(Aws::String&& value) { SetXAmzErrorType(std::move(value)); return *this;}

    
    inline ConflictException& WithXAmzErrorType(const char* value) { SetXAmzErrorType(value); return *this;}
