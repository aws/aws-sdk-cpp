...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCAMPAIGNS_API UpdateCampaignNameRequest : public ConnectCampaignsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCampaignNameRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCampaignNameRequest>(GetServiceRequestName(), *this);
    }
