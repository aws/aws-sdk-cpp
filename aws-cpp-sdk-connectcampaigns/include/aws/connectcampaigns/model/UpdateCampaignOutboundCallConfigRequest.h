...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateCampaignOutboundCallConfigRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateCampaignOutboundCallConfigRequest>(GetServiceRequestName(), *this);
    }
