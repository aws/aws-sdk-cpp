...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCAMPAIGNS_API DescribeCampaignRequest : public ConnectCampaignsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCampaignRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCampaignRequest>(GetServiceRequestName(), *this);
    }
