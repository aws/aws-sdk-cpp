...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCAMPAIGNS_API GetInstanceOnboardingJobStatusRequest : public ConnectCampaignsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetInstanceOnboardingJobStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetInstanceOnboardingJobStatusRequest>(GetServiceRequestName(), *this);
    }
