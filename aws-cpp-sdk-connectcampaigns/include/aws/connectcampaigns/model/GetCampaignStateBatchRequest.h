...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCAMPAIGNS_API GetCampaignStateBatchRequest : public ConnectCampaignsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCampaignStateBatchRequest> Clone() const
    {
      return Aws::MakeUnique<GetCampaignStateBatchRequest>(GetServiceRequestName(), *this);
    }
