...
namespace Model
{
  ...
  /**
   * <p>GetConnectInstanceConfigRequest</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/connectcampaigns-2021-01-30/GetConnectInstanceConfigRequest">AWS
   * API Reference</a></p>
   */
  class AWS_CONNECTCAMPAIGNS_API GetConnectInstanceConfigRequest : public ConnectCampaignsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetConnectInstanceConfigRequest> Clone() const
    {
      return Aws::MakeUnique<GetConnectInstanceConfigRequest>(GetServiceRequestName(), *this);
    }
