...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCAMPAIGNS_API DeleteConnectInstanceConfigRequest : public ConnectCampaignsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteConnectInstanceConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteConnectInstanceConfigRequest>(GetServiceRequestName(), *this);
    }
