...
using ResolveEndpointOutcome = Aws::SSO::Endpoint::SSOEndpointProvider::SSOResolveEndpointOutcome;
...
SSOClient::SSOClient(const Client::ClientConfiguration& clientConfiguration,
                     std::shared_ptr<Endpoint::SSOEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<SSOErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<SSO::Endpoint::SSOEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
