...
namespace SSO
{
  ...
  class AWS_SSO_API SSOClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SSOClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::SSOEndpointProvider> endpointProvider = Aws::MakeShared<SSO::Endpoint::SSOEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SSOEndpointProvider> m_endpointProvider;
  };
