...
namespace Model
{
   ...
   * Web Services SSO rename</a>.</p>  <p>This API reference guide describes
   * the Amazon Web Services SSO Portal operations that you can call programatically
   * and includes detailed information on data types and errors.</p>  <p>Amazon
   * Web Services provides SDKs that consist of libraries and sample code for various
