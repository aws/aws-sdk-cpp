...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_KAFKACONNECT_API LogDeliveryDescription
  {
  public:
    LogDeliveryDescription();
    LogDeliveryDescription(Aws::Utils::Json::JsonView jsonValue);
    LogDeliveryDescription& operator=(Aws::Utils::Json::JsonView jsonValue);
