...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_KAFKACONNECT_API KafkaClusterEncryptionInTransit
  {
  public:
    KafkaClusterEncryptionInTransit();
    KafkaClusterEncryptionInTransit(Aws::Utils::Json::JsonView jsonValue);
    KafkaClusterEncryptionInTransit& operator=(Aws::Utils::Json::JsonView jsonValue);
