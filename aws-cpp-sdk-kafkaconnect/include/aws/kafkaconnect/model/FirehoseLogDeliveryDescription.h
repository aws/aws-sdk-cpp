...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_KAFKACONNECT_API FirehoseLogDeliveryDescription
  {
  public:
    FirehoseLogDeliveryDescription();
    FirehoseLogDeliveryDescription(Aws::Utils::Json::JsonView jsonValue);
    FirehoseLogDeliveryDescription& operator=(Aws::Utils::Json::JsonView jsonValue);
