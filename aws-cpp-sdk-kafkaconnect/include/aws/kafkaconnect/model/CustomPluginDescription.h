...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_KAFKACONNECT_API CustomPluginDescription
  {
  public:
    CustomPluginDescription();
    CustomPluginDescription(Aws::Utils::Json::JsonView jsonValue);
    CustomPluginDescription& operator=(Aws::Utils::Json::JsonView jsonValue);
