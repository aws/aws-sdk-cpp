...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_KAFKACONNECT_API WorkerLogDelivery
  {
  public:
    WorkerLogDelivery();
    WorkerLogDelivery(Aws::Utils::Json::JsonView jsonValue);
    WorkerLogDelivery& operator=(Aws::Utils::Json::JsonView jsonValue);
