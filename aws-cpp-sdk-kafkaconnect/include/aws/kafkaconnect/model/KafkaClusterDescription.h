...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_KAFKACONNECT_API KafkaClusterDescription
  {
  public:
    KafkaClusterDescription();
    KafkaClusterDescription(Aws::Utils::Json::JsonView jsonValue);
    KafkaClusterDescription& operator=(Aws::Utils::Json::JsonView jsonValue);
