...
namespace Model
{
  ...
  /**
   */
  class AWS_KAFKACONNECT_API ListWorkerConfigurationsRequest : public KafkaConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWorkerConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListWorkerConfigurationsRequest>(GetServiceRequestName(), *this);
    }
