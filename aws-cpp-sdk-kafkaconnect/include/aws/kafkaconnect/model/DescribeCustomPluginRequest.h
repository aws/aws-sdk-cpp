...
namespace Model
{
  ...
  /**
   */
  class AWS_KAFKACONNECT_API DescribeCustomPluginRequest : public KafkaConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCustomPluginRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCustomPluginRequest>(GetServiceRequestName(), *this);
    }
