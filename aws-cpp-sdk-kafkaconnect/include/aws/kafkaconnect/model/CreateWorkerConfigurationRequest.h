...
namespace Model
{
  ...
  /**
   */
  class AWS_KAFKACONNECT_API CreateWorkerConfigurationRequest : public KafkaConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWorkerConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWorkerConfigurationRequest>(GetServiceRequestName(), *this);
    }
