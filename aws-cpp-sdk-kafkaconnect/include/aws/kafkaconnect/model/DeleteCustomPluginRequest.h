...
namespace Model
{
  ...
  /**
   */
  class AWS_KAFKACONNECT_API DeleteCustomPluginRequest : public KafkaConnectRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCustomPluginRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCustomPluginRequest>(GetServiceRequestName(), *this);
    }
