...
namespace KafkaConnect
{
  ...
  class AWS_KAFKACONNECT_API KafkaConnectClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        KafkaConnectClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::KafkaConnectEndpointProvider> endpointProvider = Aws::MakeShared<KafkaConnect::Endpoint::KafkaConnectEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::KafkaConnectEndpointProvider> m_endpointProvider;
  };
