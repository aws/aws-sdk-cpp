...
{
const size_t KafkaConnectEndpointRules::RulesBlobStrLen = 3478;
const size_t KafkaConnectEndpointRules::RulesBlobSize = 3479;

using RulesBlobT = Aws::Array<const char, KafkaConnectEndpointRules::RulesBlobSize>;
...
't','p','s',':','/','/','k','a','f','k','a','c','o','n','n','e','c','t','-','f','i','p','s','.','{',
...
'h','t','t','p','s',':','/','/','k','a','f','k','a','c','o','n','n','e','c','t','.','{','R','e','g',
...
'k','a','f','k','a','c','o','n','n','e','c','t','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
const char* KafkaConnectEndpointRules::GetRulesBlob()
{
