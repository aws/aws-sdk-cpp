...
Aws::String KafkaConnectEndpointRules::GetRulesAsString()
{
    return Aws::String(KafkaConnectEndpointRules::Rules.begin(), KafkaConnectEndpointRules::Rules.end());
}

const Aws::Vector<char> KafkaConnectEndpointRules::Rules = {
