...
using XRayResolveEndpointOutcome = Aws::XRay::Endpoint::XRayEndpointProvider::XRayResolveEndpointOutcome;
...
void ValidateOutcome(const XRayResolveEndpointOutcome& outcome, const XRayEndpointProviderEndpointTestCase::Expect& expect)
{
