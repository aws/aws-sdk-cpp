...
namespace Model
{
  ...
  public:
     ...
     * the Requester. </p>
     */
    inline ApproveAssignmentRequest& WithAssignmentId(Aws::String&& value) { SetAssignmentId(value); return *this;}
     ...
     * the web site. </p>
     */
    inline ApproveAssignmentRequest& WithRequesterFeedback(Aws::String&& value) { SetRequesterFeedback(value); return *this;}
