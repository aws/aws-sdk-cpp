...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWorkersWithQualificationTypeRequest> Clone() const
    {
      return Aws::MakeUnique<ListWorkersWithQualificationTypeRequest>(GetServiceRequestName(), *this);
    }
