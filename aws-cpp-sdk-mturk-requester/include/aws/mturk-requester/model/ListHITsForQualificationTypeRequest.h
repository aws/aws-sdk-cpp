...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListHITsForQualificationTypeRequest> Clone() const
    {
      return Aws::MakeUnique<ListHITsForQualificationTypeRequest>(GetServiceRequestName(), *this);
    }
