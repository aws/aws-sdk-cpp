...
namespace Model
{
  ...
  public:
    ListHITsResult();
    ListHITsResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListHITsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline ListHITsResult& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
     ...
     * <p> The list of HIT elements returned by the query.</p>
     */
    inline ListHITsResult& WithHITs(Aws::Vector<HIT>&& value) { SetHITs(value); return *this;}
     ...
     * <p> The list of HIT elements returned by the query.</p>
     */
    inline ListHITsResult& AddHITs(HIT&& value) { m_hITs.push_back(value); return *this; }
