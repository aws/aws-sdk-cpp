...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateQualificationWithWorkerRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateQualificationWithWorkerRequest>(GetServiceRequestName(), *this);
    }
