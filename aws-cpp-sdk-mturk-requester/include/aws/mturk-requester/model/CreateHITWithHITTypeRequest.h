...
namespace Model
{
  ...
  public:
     ...
     * <p>The HIT type ID you want to create this HIT with.</p>
     */
    inline CreateHITWithHITTypeRequest& WithHITTypeId(Aws::String&& value) { SetHITTypeId(value); return *this;}
     ...
     * <p>Either a Question parameter or a HITLayoutId parameter must be provided.</p>
     */
    inline CreateHITWithHITTypeRequest& WithQuestion(Aws::String&& value) { SetQuestion(value); return *this;}
     ...
     * grouped. </p>
     */
    inline CreateHITWithHITTypeRequest& WithRequesterAnnotation(Aws::String&& value) { SetRequesterAnnotation(value); return *this;}
     ...
     * </p> </note>
     */
    inline CreateHITWithHITTypeRequest& WithUniqueRequestToken(Aws::String&& value) { SetUniqueRequestToken(value); return *this;}
     ...
     * </p>
     */
    inline CreateHITWithHITTypeRequest& WithAssignmentReviewPolicy(ReviewPolicy&& value) { SetAssignmentReviewPolicy(value); return *this;}
     ...
     * Mechanical Turk to take various actions based on the policy. </p>
     */
    inline CreateHITWithHITTypeRequest& WithHITReviewPolicy(ReviewPolicy&& value) { SetHITReviewPolicy(value); return *this;}
     ...
     * HITLayoutId parameter must be provided. </p>
     */
    inline CreateHITWithHITTypeRequest& WithHITLayoutId(Aws::String&& value) { SetHITLayoutId(value); return *this;}
     ...
     * HITLayout. </p>
     */
    inline CreateHITWithHITTypeRequest& WithHITLayoutParameters(Aws::Vector<HITLayoutParameter>&& value) { SetHITLayoutParameters(value); return *this;}
     ...
     * HITLayout. </p>
     */
    inline CreateHITWithHITTypeRequest& AddHITLayoutParameters(HITLayoutParameter&& value) { m_hITLayoutParametersHasBeenSet = true; m_hITLayoutParameters.push_back(value); return *this; }
