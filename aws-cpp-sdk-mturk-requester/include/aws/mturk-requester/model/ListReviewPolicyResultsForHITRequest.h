...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListReviewPolicyResultsForHITRequest> Clone() const
    {
      return Aws::MakeUnique<ListReviewPolicyResultsForHITRequest>(GetServiceRequestName(), *this);
    }
