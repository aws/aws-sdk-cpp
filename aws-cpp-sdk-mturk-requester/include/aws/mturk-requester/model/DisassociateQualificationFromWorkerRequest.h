...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateQualificationFromWorkerRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateQualificationFromWorkerRequest>(GetServiceRequestName(), *this);
    }
