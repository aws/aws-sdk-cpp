...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAdditionalAssignmentsForHITRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAdditionalAssignmentsForHITRequest>(GetServiceRequestName(), *this);
    }
