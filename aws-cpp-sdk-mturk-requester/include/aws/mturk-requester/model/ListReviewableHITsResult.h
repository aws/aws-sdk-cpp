...
namespace Model
{
  ...
  public:
    ...
    ListReviewableHITsResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListReviewableHITsResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline ListReviewableHITsResult& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
     ...
     * <p> The list of HIT elements returned by the query.</p>
     */
    inline ListReviewableHITsResult& WithHITs(Aws::Vector<HIT>&& value) { SetHITs(value); return *this;}
     ...
     * <p> The list of HIT elements returned by the query.</p>
     */
    inline ListReviewableHITsResult& AddHITs(HIT&& value) { m_hITs.push_back(value); return *this; }
