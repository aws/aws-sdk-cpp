...
namespace MTurk
{
  ...
  class AWS_MTURK_API MTurkClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MTurkClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                    std::shared_ptr<Endpoint::MTurkEndpointProvider> endpointProvider = Aws::MakeShared<MTurk::Endpoint::MTurkEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MTurkEndpointProvider> m_endpointProvider;
  };
