...
using ResolveEndpointOutcome = Aws::MTurk::Endpoint::MTurkEndpointProvider::MTurkResolveEndpointOutcome;
...
MTurkClient::MTurkClient(const Client::ClientConfiguration& clientConfiguration,
                         std::shared_ptr<Endpoint::MTurkEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<MTurkErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<MTurk::Endpoint::MTurkEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
