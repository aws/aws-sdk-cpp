...
ListBonusPaymentsResult::ListBonusPaymentsResult(const AmazonWebServiceResult<JsonValue>& result) : 
    m_numResults(0)
{
  *this = result;
}

ListBonusPaymentsResult& ListBonusPaymentsResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
