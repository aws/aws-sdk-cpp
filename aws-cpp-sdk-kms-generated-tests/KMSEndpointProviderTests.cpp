...
using KMSResolveEndpointOutcome = Aws::KMS::Endpoint::KMSEndpointProvider::KMSResolveEndpointOutcome;
...
void ValidateOutcome(const KMSResolveEndpointOutcome& outcome, const KMSEndpointProviderEndpointTestCase::Expect& expect)
{
