...
namespace HealthLake
{
  ...
  class AWS_HEALTHLAKE_API HealthLakeClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        HealthLakeClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::HealthLakeEndpointProvider> endpointProvider = Aws::MakeShared<HealthLake::Endpoint::HealthLakeEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::HealthLakeEndpointProvider> m_endpointProvider;
  };
