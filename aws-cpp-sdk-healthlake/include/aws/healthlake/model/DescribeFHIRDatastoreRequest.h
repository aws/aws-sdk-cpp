...
namespace Model
{
  ...
  /**
   */
  class AWS_HEALTHLAKE_API DescribeFHIRDatastoreRequest : public HealthLakeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFHIRDatastoreRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFHIRDatastoreRequest>(GetServiceRequestName(), *this);
    }
