...
namespace Model
{
  ...
  /**
   * <p>The filters applied to datastore query.</p><p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    /**
     * <p>A filter that allows the user to set cutoff dates for records. All datastores
     * created before the specified date will be included in the results. </p>
     */
    ...
    /**
     * <p>A filter that allows the user to set cutoff dates for records. All datastores
     * created after the specified date will be included in the results.</p>
     */
