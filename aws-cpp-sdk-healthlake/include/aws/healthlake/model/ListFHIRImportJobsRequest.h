...
namespace Model
{
  ...
  /**
   */
  class AWS_HEALTHLAKE_API ListFHIRImportJobsRequest : public HealthLakeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFHIRImportJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFHIRImportJobsRequest>(GetServiceRequestName(), *this);
    }
