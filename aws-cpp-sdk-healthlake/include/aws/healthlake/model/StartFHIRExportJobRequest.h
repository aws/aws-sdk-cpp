...
namespace Model
{
  ...
  /**
   */
  class AWS_HEALTHLAKE_API StartFHIRExportJobRequest : public HealthLakeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartFHIRExportJobRequest> Clone() const
    {
      return Aws::MakeUnique<StartFHIRExportJobRequest>(GetServiceRequestName(), *this);
    }
