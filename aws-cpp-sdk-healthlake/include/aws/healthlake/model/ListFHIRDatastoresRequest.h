...
namespace Model
{
  ...
  /**
   */
  class AWS_HEALTHLAKE_API ListFHIRDatastoresRequest : public HealthLakeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFHIRDatastoresRequest> Clone() const
    {
      return Aws::MakeUnique<ListFHIRDatastoresRequest>(GetServiceRequestName(), *this);
    }
