...
namespace Model
{
  ...
  /**
   */
  class AWS_HEALTHLAKE_API DescribeFHIRExportJobRequest : public HealthLakeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFHIRExportJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFHIRExportJobRequest>(GetServiceRequestName(), *this);
    }
