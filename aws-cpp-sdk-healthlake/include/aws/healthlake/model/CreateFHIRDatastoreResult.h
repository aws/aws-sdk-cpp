...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The AWS-generated datastore id. This id is in the output from the initial
     * datastore creation call.</p>
     */
    ...
    /**
     * <p>The datastore ARN is generated during the creation of the datastore and can
     * be found in the output from the initial datastore creation call.</p>
     */
    ...
    /**
     * <p>The status of the FHIR datastore. Possible statuses are ‘CREATING’, ‘ACTIVE’,
     * ‘DELETING’, ‘DELETED’.</p>
     */
    ...
    /**
     * <p>The AWS endpoint for the created datastore. For preview, only US-east-1
