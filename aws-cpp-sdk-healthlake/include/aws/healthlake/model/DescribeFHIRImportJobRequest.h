...
namespace Model
{
  ...
  /**
   */
  class AWS_HEALTHLAKE_API DescribeFHIRImportJobRequest : public HealthLakeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFHIRImportJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFHIRImportJobRequest>(GetServiceRequestName(), *this);
    }
