...
Aws::String ServerlessApplicationRepositoryEndpointRules::GetRulesAsString()
{
    return Aws::String(ServerlessApplicationRepositoryEndpointRules::Rules.begin(), ServerlessApplicationRepositoryEndpointRules::Rules.end());
}

const Aws::Vector<char> ServerlessApplicationRepositoryEndpointRules::Rules = {
