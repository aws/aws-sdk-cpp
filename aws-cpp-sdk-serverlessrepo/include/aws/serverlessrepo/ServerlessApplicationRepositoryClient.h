...
namespace ServerlessApplicationRepository
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ServerlessApplicationRepositoryClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                              std::shared_ptr<Endpoint::ServerlessApplicationRepositoryEndpointProvider> endpointProvider = Aws::MakeShared<ServerlessApplicationRepository::Endpoint::ServerlessApplicationRepositoryEndpointProvider>(ALLOCATION_TAG));
 ...
 .</p><p><h3>See Also:</h3>   <a
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ServerlessApplicationRepositoryEndpointProvider> m_endpointProvider;
  };
