...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCloudFormationTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCloudFormationTemplateRequest>(GetServiceRequestName(), *this);
    }
