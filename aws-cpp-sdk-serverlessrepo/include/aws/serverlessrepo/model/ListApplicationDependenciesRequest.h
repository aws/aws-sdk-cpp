...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListApplicationDependenciesRequest> Clone() const
    {
      return Aws::MakeUnique<ListApplicationDependenciesRequest>(GetServiceRequestName(), *this);
    }
