...
using ResolveEndpointOutcome = Aws::Route53::Endpoint::Route53EndpointProvider::Route53ResolveEndpointOutcome;
...
Route53Client::Route53Client(const Client::ClientConfiguration& clientConfiguration,
                             std::shared_ptr<Endpoint::Route53EndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<Route53ErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Route53::Endpoint::Route53EndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
