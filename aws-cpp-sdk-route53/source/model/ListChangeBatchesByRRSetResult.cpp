...
ListChangeBatchesByRRSetResult::ListChangeBatchesByRRSetResult() : 
    m_isTruncated(false)
{
}

ListChangeBatchesByRRSetResult::ListChangeBatchesByRRSetResult(const AmazonWebServiceResult<XmlDocument>& result) : 
    m_isTruncated(false)
{
  *this = result;
}

ListChangeBatchesByRRSetResult& ListChangeBatchesByRRSetResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
