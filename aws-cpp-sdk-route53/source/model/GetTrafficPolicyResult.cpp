...
GetTrafficPolicyResult::GetTrafficPolicyResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

GetTrafficPolicyResult& GetTrafficPolicyResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
