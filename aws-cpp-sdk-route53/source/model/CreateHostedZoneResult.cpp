...
CreateHostedZoneResult::CreateHostedZoneResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

CreateHostedZoneResult& CreateHostedZoneResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
