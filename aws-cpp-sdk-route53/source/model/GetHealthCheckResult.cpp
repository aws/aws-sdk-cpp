...
GetHealthCheckResult::GetHealthCheckResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

GetHealthCheckResult& GetHealthCheckResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
