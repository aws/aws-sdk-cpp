...
CreateHealthCheckResult::CreateHealthCheckResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

CreateHealthCheckResult& CreateHealthCheckResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
