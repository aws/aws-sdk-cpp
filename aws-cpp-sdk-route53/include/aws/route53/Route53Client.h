...
namespace Route53
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        Route53Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                      std::shared_ptr<Endpoint::Route53EndpointProvider> endpointProvider = Aws::MakeShared<Route53::Endpoint::Route53EndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::Route53EndpointProvider> m_endpointProvider;
  };
