...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetReusableDelegationSetLimitRequest> Clone() const
    {
      return Aws::MakeUnique<GetReusableDelegationSetLimitRequest>(GetServiceRequestName(), *this);
    }
