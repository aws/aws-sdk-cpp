...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53_API EnableHostedZoneDNSSECRequest : public Route53Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableHostedZoneDNSSECRequest> Clone() const
    {
      return Aws::MakeUnique<EnableHostedZoneDNSSECRequest>(GetServiceRequestName(), *this);
    }
