...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53_API CreateCidrCollectionRequest : public Route53Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateCidrCollectionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateCidrCollectionRequest>(GetServiceRequestName(), *this);
    }
