...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateTrafficPolicyInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<CreateTrafficPolicyInstanceRequest>(GetServiceRequestName(), *this);
    }
