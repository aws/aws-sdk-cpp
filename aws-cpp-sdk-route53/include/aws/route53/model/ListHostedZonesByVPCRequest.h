...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ROUTE53_API ListHostedZonesByVPCRequest : public Route53Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListHostedZonesByVPCRequest> Clone() const
    {
      return Aws::MakeUnique<ListHostedZonesByVPCRequest>(GetServiceRequestName(), *this);
    }
