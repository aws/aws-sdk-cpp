...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTrafficPolicyInstancesByPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<ListTrafficPolicyInstancesByPolicyRequest>(GetServiceRequestName(), *this);
    }
