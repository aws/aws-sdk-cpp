...
namespace Model
{
  ...
  public:
    ...
    ListTagsForResourcesResult(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ListTagsForResourcesResult& operator=(const AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
