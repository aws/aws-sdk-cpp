...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateVPCAssociationAuthorizationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateVPCAssociationAuthorizationRequest>(GetServiceRequestName(), *this);
    }
