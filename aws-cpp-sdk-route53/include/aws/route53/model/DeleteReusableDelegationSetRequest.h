...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteReusableDelegationSetRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteReusableDelegationSetRequest>(GetServiceRequestName(), *this);
    }
