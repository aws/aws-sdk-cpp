...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateTrafficPolicyInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTrafficPolicyInstanceRequest>(GetServiceRequestName(), *this);
    }
