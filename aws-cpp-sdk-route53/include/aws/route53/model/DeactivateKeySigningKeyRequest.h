...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53_API DeactivateKeySigningKeyRequest : public Route53Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeactivateKeySigningKeyRequest> Clone() const
    {
      return Aws::MakeUnique<DeactivateKeySigningKeyRequest>(GetServiceRequestName(), *this);
    }
