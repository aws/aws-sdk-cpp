...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53_API DisableHostedZoneDNSSECRequest : public Route53Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisableHostedZoneDNSSECRequest> Clone() const
    {
      return Aws::MakeUnique<DisableHostedZoneDNSSECRequest>(GetServiceRequestName(), *this);
    }
