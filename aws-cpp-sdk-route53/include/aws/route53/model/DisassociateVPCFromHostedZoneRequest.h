...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateVPCFromHostedZoneRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateVPCFromHostedZoneRequest>(GetServiceRequestName(), *this);
    }
