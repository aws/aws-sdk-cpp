...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetHealthCheckLastFailureReasonRequest> Clone() const
    {
      return Aws::MakeUnique<GetHealthCheckLastFailureReasonRequest>(GetServiceRequestName(), *this);
    }
