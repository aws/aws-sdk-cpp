...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTrafficPolicyInstancesByHostedZoneRequest> Clone() const
    {
      return Aws::MakeUnique<ListTrafficPolicyInstancesByHostedZoneRequest>(GetServiceRequestName(), *this);
    }
