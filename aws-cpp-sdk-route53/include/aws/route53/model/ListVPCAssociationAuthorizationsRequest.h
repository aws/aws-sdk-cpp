...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListVPCAssociationAuthorizationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListVPCAssociationAuthorizationsRequest>(GetServiceRequestName(), *this);
    }
