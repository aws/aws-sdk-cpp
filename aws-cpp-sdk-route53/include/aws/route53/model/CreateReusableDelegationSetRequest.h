...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateReusableDelegationSetRequest> Clone() const
    {
      return Aws::MakeUnique<CreateReusableDelegationSetRequest>(GetServiceRequestName(), *this);
    }
