...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTrafficPolicyInstanceRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTrafficPolicyInstanceRequest>(GetServiceRequestName(), *this);
    }
