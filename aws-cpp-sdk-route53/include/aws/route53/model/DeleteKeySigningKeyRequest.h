...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53_API DeleteKeySigningKeyRequest : public Route53Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteKeySigningKeyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteKeySigningKeyRequest>(GetServiceRequestName(), *this);
    }
