...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53_API ListCidrCollectionsRequest : public Route53Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCidrCollectionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListCidrCollectionsRequest>(GetServiceRequestName(), *this);
    }
