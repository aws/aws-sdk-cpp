...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53_API DeleteCidrCollectionRequest : public Route53Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteCidrCollectionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteCidrCollectionRequest>(GetServiceRequestName(), *this);
    }
