...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTrafficPolicyInstanceCountRequest> Clone() const
    {
      return Aws::MakeUnique<GetTrafficPolicyInstanceCountRequest>(GetServiceRequestName(), *this);
    }
