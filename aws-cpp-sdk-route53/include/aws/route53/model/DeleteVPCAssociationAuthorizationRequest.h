...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVPCAssociationAuthorizationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVPCAssociationAuthorizationRequest>(GetServiceRequestName(), *this);
    }
