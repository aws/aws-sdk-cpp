...
namespace Model
{
   ...
   * zone that was created with a different account. </p><p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    /**
     * <p>When removing authorization to associate a VPC that was created by one
     * account with a hosted zone that was created with a different account, the ID of
     * the hosted zone.</p>
     */
    ...
    /**
     * <p>When removing authorization to associate a VPC that was created by one
     * account with a hosted zone that was created with a different account, a complex
     * type that includes the ID and region of the VPC.</p>
     */
