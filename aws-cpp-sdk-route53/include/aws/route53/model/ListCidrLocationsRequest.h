...
namespace Model
{
  ...
  /**
   */
  class AWS_ROUTE53_API ListCidrLocationsRequest : public Route53Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCidrLocationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListCidrLocationsRequest>(GetServiceRequestName(), *this);
    }
