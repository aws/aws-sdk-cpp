...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CODEGURUPROFILER_API AddNotificationChannelsRequest : public CodeGuruProfilerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AddNotificationChannelsRequest> Clone() const
    {
      return Aws::MakeUnique<AddNotificationChannelsRequest>(GetServiceRequestName(), *this);
    }
