...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CODEGURUPROFILER_API GetFindingsReportAccountSummaryRequest : public CodeGuruProfilerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetFindingsReportAccountSummaryRequest> Clone() const
    {
      return Aws::MakeUnique<GetFindingsReportAccountSummaryRequest>(GetServiceRequestName(), *this);
    }
