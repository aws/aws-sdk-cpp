...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CODEGURUPROFILER_API GetNotificationConfigurationRequest : public CodeGuruProfilerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetNotificationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetNotificationConfigurationRequest>(GetServiceRequestName(), *this);
    }
