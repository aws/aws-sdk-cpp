...
namespace Model
{
        ...
        typedef Aws::Utils::Outcome<AddNotificationChannelsResult, Aws::Client::AWSError<CodeGuruProfilerErrors>> AddNotificationChannelsOutcome;
        typedef Aws::Utils::Outcome<BatchGetFrameMetricDataResult, Aws::Client::AWSError<CodeGuruProfilerErrors>> BatchGetFrameMetricDataOutcome;
        ...
        typedef Aws::Utils::Outcome<GetFindingsReportAccountSummaryResult, Aws::Client::AWSError<CodeGuruProfilerErrors>> GetFindingsReportAccountSummaryOutcome;
        typedef Aws::Utils::Outcome<GetNotificationConfigurationResult, Aws::Client::AWSError<CodeGuruProfilerErrors>> GetNotificationConfigurationOutcome;
        ...
        typedef Aws::Utils::Outcome<GetRecommendationsResult, Aws::Client::AWSError<CodeGuruProfilerErrors>> GetRecommendationsOutcome;
        typedef Aws::Utils::Outcome<ListFindingsReportsResult, Aws::Client::AWSError<CodeGuruProfilerErrors>> ListFindingsReportsOutcome;
        ...
        typedef Aws::Utils::Outcome<RemoveNotificationChannelResult, Aws::Client::AWSError<CodeGuruProfilerErrors>> RemoveNotificationChannelOutcome;
        typedef Aws::Utils::Outcome<RemovePermissionResult, Aws::Client::AWSError<CodeGuruProfilerErrors>> RemovePermissionOutcome;
        typedef Aws::Utils::Outcome<SubmitFeedbackResult, Aws::Client::AWSError<CodeGuruProfilerErrors>> SubmitFeedbackOutcome;
   ...
   * operations.</p> <pre><code> &lt;p&gt;Amazon CodeGuru Profiler collects runtime
