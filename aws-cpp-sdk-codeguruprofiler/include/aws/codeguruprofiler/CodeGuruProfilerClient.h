...
namespace CodeGuruProfiler
{
  ...
  class AWS_CODEGURUPROFILER_API CodeGuruProfilerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CodeGuruProfilerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::CodeGuruProfilerEndpointProvider> endpointProvider = Aws::MakeShared<CodeGuruProfiler::Endpoint::CodeGuruProfilerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CodeGuruProfilerEndpointProvider> m_endpointProvider;
  };
