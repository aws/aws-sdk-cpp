...
Aws::String CodeGuruProfilerEndpointRules::GetRulesAsString()
{
    return Aws::String(CodeGuruProfilerEndpointRules::Rules.begin(), CodeGuruProfilerEndpointRules::Rules.end());
}

const Aws::Vector<char> CodeGuruProfilerEndpointRules::Rules = {
...
'u','-','p','r','o','f','i','l','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
'n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','o','d','e','g',
'u','r','u','-','p','r','o','f','i','l','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n',
