...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API DeleteEventBusRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEventBusRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEventBusRequest>(GetServiceRequestName(), *this);
    }
