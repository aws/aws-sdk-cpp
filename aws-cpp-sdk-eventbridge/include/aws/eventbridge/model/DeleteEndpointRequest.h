...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API DeleteEndpointRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEndpointRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEndpointRequest>(GetServiceRequestName(), *this);
    }
