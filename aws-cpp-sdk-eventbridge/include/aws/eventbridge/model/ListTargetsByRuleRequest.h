...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API ListTargetsByRuleRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTargetsByRuleRequest> Clone() const
    {
      return Aws::MakeUnique<ListTargetsByRuleRequest>(GetServiceRequestName(), *this);
    }
