...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API ListEventSourcesRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEventSourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListEventSourcesRequest>(GetServiceRequestName(), *this);
    }
