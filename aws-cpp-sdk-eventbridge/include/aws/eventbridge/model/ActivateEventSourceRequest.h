...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API ActivateEventSourceRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ActivateEventSourceRequest> Clone() const
    {
      return Aws::MakeUnique<ActivateEventSourceRequest>(GetServiceRequestName(), *this);
    }
