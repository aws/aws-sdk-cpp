...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API ListArchivesRequest : public EventBridgeRequest
  {
  public:
    ListArchivesRequest();
    ...
    */
    virtual Aws::UniquePtr<ListArchivesRequest> Clone() const
    {
      return Aws::MakeUnique<ListArchivesRequest>(GetServiceRequestName(), *this);
    }
