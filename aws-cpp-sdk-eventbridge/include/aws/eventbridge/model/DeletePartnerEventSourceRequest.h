...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API DeletePartnerEventSourceRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeletePartnerEventSourceRequest> Clone() const
    {
      return Aws::MakeUnique<DeletePartnerEventSourceRequest>(GetServiceRequestName(), *this);
    }
