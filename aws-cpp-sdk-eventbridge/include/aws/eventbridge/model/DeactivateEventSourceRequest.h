...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API DeactivateEventSourceRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeactivateEventSourceRequest> Clone() const
    {
      return Aws::MakeUnique<DeactivateEventSourceRequest>(GetServiceRequestName(), *this);
    }
