...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API DescribePartnerEventSourceRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePartnerEventSourceRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePartnerEventSourceRequest>(GetServiceRequestName(), *this);
    }
