...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API DescribeEventSourceRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEventSourceRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEventSourceRequest>(GetServiceRequestName(), *this);
    }
