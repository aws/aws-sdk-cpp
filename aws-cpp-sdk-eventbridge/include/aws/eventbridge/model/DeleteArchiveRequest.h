...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API DeleteArchiveRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteArchiveRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteArchiveRequest>(GetServiceRequestName(), *this);
    }
