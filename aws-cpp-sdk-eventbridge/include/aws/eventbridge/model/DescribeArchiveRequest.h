...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API DescribeArchiveRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeArchiveRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeArchiveRequest>(GetServiceRequestName(), *this);
    }
