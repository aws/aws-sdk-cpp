...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API ListPartnerEventSourceAccountsRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPartnerEventSourceAccountsRequest> Clone() const
    {
      return Aws::MakeUnique<ListPartnerEventSourceAccountsRequest>(GetServiceRequestName(), *this);
    }
