...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API DeauthorizeConnectionRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeauthorizeConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<DeauthorizeConnectionRequest>(GetServiceRequestName(), *this);
    }
