...
namespace Model
{
  ...
  /**
   */
  class AWS_EVENTBRIDGE_API DescribeEventBusRequest : public EventBridgeRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEventBusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEventBusRequest>(GetServiceRequestName(), *this);
    }
