...
Aws::String EventBridgeEndpointRules::GetRulesAsString()
{
    return Aws::String(EventBridgeEndpointRules::Rules.begin(), EventBridgeEndpointRules::Rules.end());
}

const Aws::Vector<char> EventBridgeEndpointRules::Rules = {
...
'n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','{','E','n','d','p',
'o','i','n','t','I','d','}','.','e','n','d','p','o','i','n','t','.','e','v','e','n','t','s','.','{',
...
'"',':','[','"','*','"',']',',','"','s','i','g','n','i','n','g','N','a','m','e','"',':','"','e','v',
'e','n','t','s','"','}',']','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t',
...
'{','E','n','d','p','o','i','n','t','I','d','}','.','e','n','d','p','o','i','n','t','.','e','v','e',
'n','t','s','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u','l','t','#','d','n','s','S',
'u','f','f','i','x','}','"',',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','"','a','u',
't','h','S','c','h','e','m','e','s','"',':','[','{','"','n','a','m','e','"',':','"','s','i','g','v',
'4','a','"',',','"','s','i','g','n','i','n','g','R','e','g','i','o','n','S','e','t','"',':','[','"',
'*','"',']',',','"','s','i','g','n','i','n','g','N','a','m','e','"',':','"','e','v','e','n','t','s',
'"','}',']','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y','p','e','"',
':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}',',','{','"','c','o','n','d','i','t',
'i','o','n','s','"',':','[',']',',','"','e','r','r','o','r','"',':','"','I','n','v','a','l','i','d',
' ','C','o','n','f','i','g','u','r','a','t','i','o','n',':',' ','F','I','P','S',' ','i','s',' ','n',
'o','t',' ','s','u','p','p','o','r','t','e','d',' ','w','i','t','h',' ','E','v','e','n','t','B','r',
'i','d','g','e',' ','m','u','l','t','i','-','r','e','g','i','o','n',' ','e','n','d','p','o','i','n',
't','s','.','"',',','"','t','y','p','e','"',':','"','e','r','r','o','r','"','}',']','}',']','}',',',
...
's',':','/','/','e','v','e','n','t','s','.','u','s','-','g','o','v','-','w','e','s','t','-','1','.',
...
'i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','v','e','n',
't','s','.','u','s','-','g','o','v','-','e','a','s','t','-','1','.','a','m','a','z','o','n','a','w',
