...
Aws::String IoTTwinMakerEndpointRules::GetRulesAsString()
{
    return Aws::String(IoTTwinMakerEndpointRules::Rules.begin(), IoTTwinMakerEndpointRules::Rules.end());
}

const Aws::Vector<char> IoTTwinMakerEndpointRules::Rules = {
