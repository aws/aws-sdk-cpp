...
namespace IoTTwinMaker
{
  ...
  class AWS_IOTTWINMAKER_API IoTTwinMakerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IoTTwinMakerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::IoTTwinMakerEndpointProvider> endpointProvider = Aws::MakeShared<IoTTwinMaker::Endpoint::IoTTwinMakerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IoTTwinMakerEndpointProvider> m_endpointProvider;
  };
