...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTTWINMAKER_API CreateEntityRequest : public IoTTwinMakerRequest
  {
  public:
    CreateEntityRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateEntityRequest> Clone() const
    {
      return Aws::MakeUnique<CreateEntityRequest>(GetServiceRequestName(), *this);
    }
