...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTTWINMAKER_API DeleteWorkspaceRequest : public IoTTwinMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWorkspaceRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWorkspaceRequest>(GetServiceRequestName(), *this);
    }
