...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTTWINMAKER_API DeleteComponentTypeRequest : public IoTTwinMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteComponentTypeRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteComponentTypeRequest>(GetServiceRequestName(), *this);
    }
