...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTTWINMAKER_API CreateSceneRequest : public IoTTwinMakerRequest
  {
  public:
    CreateSceneRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateSceneRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSceneRequest>(GetServiceRequestName(), *this);
    }
