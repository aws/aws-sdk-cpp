...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTTWINMAKER_API CreateComponentTypeRequest : public IoTTwinMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateComponentTypeRequest> Clone() const
    {
      return Aws::MakeUnique<CreateComponentTypeRequest>(GetServiceRequestName(), *this);
    }
