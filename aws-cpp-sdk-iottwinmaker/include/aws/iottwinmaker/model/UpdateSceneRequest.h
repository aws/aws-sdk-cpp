...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTTWINMAKER_API UpdateSceneRequest : public IoTTwinMakerRequest
  {
  public:
    UpdateSceneRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateSceneRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSceneRequest>(GetServiceRequestName(), *this);
    }
