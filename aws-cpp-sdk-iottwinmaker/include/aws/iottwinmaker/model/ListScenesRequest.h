...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTTWINMAKER_API ListScenesRequest : public IoTTwinMakerRequest
  {
  public:
    ListScenesRequest();
    ...
    */
    virtual Aws::UniquePtr<ListScenesRequest> Clone() const
    {
      return Aws::MakeUnique<ListScenesRequest>(GetServiceRequestName(), *this);
    }
