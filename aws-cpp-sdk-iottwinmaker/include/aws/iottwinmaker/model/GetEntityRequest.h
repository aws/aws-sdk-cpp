...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTTWINMAKER_API GetEntityRequest : public IoTTwinMakerRequest
  {
  public:
    GetEntityRequest();
    ...
    */
    virtual Aws::UniquePtr<GetEntityRequest> Clone() const
    {
      return Aws::MakeUnique<GetEntityRequest>(GetServiceRequestName(), *this);
    }
