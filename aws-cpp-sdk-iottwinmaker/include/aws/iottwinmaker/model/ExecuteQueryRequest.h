...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTTWINMAKER_API ExecuteQueryRequest : public IoTTwinMakerRequest
  {
  public:
    ExecuteQueryRequest();
    ...
    */
    virtual Aws::UniquePtr<ExecuteQueryRequest> Clone() const
    {
      return Aws::MakeUnique<ExecuteQueryRequest>(GetServiceRequestName(), *this);
    }
