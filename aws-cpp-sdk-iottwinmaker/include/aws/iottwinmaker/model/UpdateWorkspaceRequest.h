...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTTWINMAKER_API UpdateWorkspaceRequest : public IoTTwinMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateWorkspaceRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateWorkspaceRequest>(GetServiceRequestName(), *this);
    }
