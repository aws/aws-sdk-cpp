...
namespace Model
{
  ...
  /**
   */
  class AWS_IOTTWINMAKER_API CreateWorkspaceRequest : public IoTTwinMakerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWorkspaceRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWorkspaceRequest>(GetServiceRequestName(), *this);
    }
