...
namespace Model
{
  ...
  {
  public:
    AWS_SIMSPACEWEAVER_API ListTagsForResourceResult();
    AWS_SIMSPACEWEAVER_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_SIMSPACEWEAVER_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
