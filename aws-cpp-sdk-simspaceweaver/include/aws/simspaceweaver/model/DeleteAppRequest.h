...
namespace Model
{
  ...
  /**
   */
  class AWS_SIMSPACEWEAVER_API DeleteAppRequest : public SimSpaceWeaverRequest
  {
  public:
    DeleteAppRequest();
     ...
     * <p>The name of the simulation of the app.</p>
     */
    inline DeleteAppRequest& WithSimulation(const char* value) { SetSimulation(value); return *this;}
