...
namespace Model
{
  ...
  /**
   */
  class AWS_SIMSPACEWEAVER_API DeleteSimulationRequest : public SimSpaceWeaverRequest
  {
  public:
     ...
     * <p>The name of the simulation.</p>
     */
    inline DeleteSimulationRequest& WithSimulation(const Aws::String& value) { SetSimulation(value); return *this;}

    /**
     * <p>The name of the simulation.</p>
     */
    inline DeleteSimulationRequest& WithSimulation(Aws::String&& value) { SetSimulation(std::move(value)); return *this;}

    /**
     * <p>The name of the simulation.</p>
     */
    inline DeleteSimulationRequest& WithSimulation(const char* value) { SetSimulation(value); return *this;}
