...
using GlueResolveEndpointOutcome = Aws::Glue::Endpoint::GlueEndpointProvider::GlueResolveEndpointOutcome;
...
void ValidateOutcome(const GlueResolveEndpointOutcome& outcome, const GlueEndpointProviderEndpointTestCase::Expect& expect)
{
