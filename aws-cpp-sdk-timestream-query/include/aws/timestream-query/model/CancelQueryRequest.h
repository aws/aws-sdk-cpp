...
namespace Model
{
  ...
  /**
   */
  class AWS_TIMESTREAMQUERY_API CancelQueryRequest : public TimestreamQueryRequest
  {
  public:
    CancelQueryRequest();
    ...
    */
    virtual Aws::UniquePtr<CancelQueryRequest> Clone() const
    {
      return Aws::MakeUnique<CancelQueryRequest>(GetServiceRequestName(), *this);
    }
