...
namespace Model
{
  ...
  /**
   */
  class AWS_TIMESTREAMQUERY_API UpdateScheduledQueryRequest : public TimestreamQueryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateScheduledQueryRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateScheduledQueryRequest>(GetServiceRequestName(), *this);
    }
