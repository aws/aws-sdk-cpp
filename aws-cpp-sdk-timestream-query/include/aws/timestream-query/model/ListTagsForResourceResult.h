...
namespace Model
{
  ...
  {
  public:
    AWS_TIMESTREAMQUERY_API ListTagsForResourceResult();
    AWS_TIMESTREAMQUERY_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_TIMESTREAMQUERY_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
