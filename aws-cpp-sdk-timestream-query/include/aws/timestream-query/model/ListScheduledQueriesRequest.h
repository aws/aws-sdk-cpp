...
namespace Model
{
  ...
  /**
   */
  class AWS_TIMESTREAMQUERY_API ListScheduledQueriesRequest : public TimestreamQueryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListScheduledQueriesRequest> Clone() const
    {
      return Aws::MakeUnique<ListScheduledQueriesRequest>(GetServiceRequestName(), *this);
    }
