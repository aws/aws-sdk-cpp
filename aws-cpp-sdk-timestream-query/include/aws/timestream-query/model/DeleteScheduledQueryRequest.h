...
namespace Model
{
  ...
  /**
   */
  class AWS_TIMESTREAMQUERY_API DeleteScheduledQueryRequest : public TimestreamQueryRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteScheduledQueryRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteScheduledQueryRequest>(GetServiceRequestName(), *this);
    }
