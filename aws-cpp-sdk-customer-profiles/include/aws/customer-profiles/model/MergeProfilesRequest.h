...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API MergeProfilesRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<MergeProfilesRequest> Clone() const
    {
      return Aws::MakeUnique<MergeProfilesRequest>(GetServiceRequestName(), *this);
    }
