...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API GetDomainRequest : public CustomerProfilesRequest
  {
  public:
    GetDomainRequest();
    ...
    */
    virtual Aws::UniquePtr<GetDomainRequest> Clone() const
    {
      return Aws::MakeUnique<GetDomainRequest>(GetServiceRequestName(), *this);
    }
