...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API DeleteProfileRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteProfileRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteProfileRequest>(GetServiceRequestName(), *this);
    }
