...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API DeleteProfileObjectRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteProfileObjectRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteProfileObjectRequest>(GetServiceRequestName(), *this);
    }
