...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API GetIdentityResolutionJobRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetIdentityResolutionJobRequest> Clone() const
    {
      return Aws::MakeUnique<GetIdentityResolutionJobRequest>(GetServiceRequestName(), *this);
    }
