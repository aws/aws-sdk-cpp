...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API CreateIntegrationWorkflowRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateIntegrationWorkflowRequest> Clone() const
    {
      return Aws::MakeUnique<CreateIntegrationWorkflowRequest>(GetServiceRequestName(), *this);
    }
