...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API CreateProfileRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateProfileRequest> Clone() const
    {
      return Aws::MakeUnique<CreateProfileRequest>(GetServiceRequestName(), *this);
    }
