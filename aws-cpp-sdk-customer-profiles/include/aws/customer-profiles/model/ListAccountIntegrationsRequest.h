...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API ListAccountIntegrationsRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAccountIntegrationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAccountIntegrationsRequest>(GetServiceRequestName(), *this);
    }
