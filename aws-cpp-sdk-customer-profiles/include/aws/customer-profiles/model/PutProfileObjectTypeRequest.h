...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API PutProfileObjectTypeRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutProfileObjectTypeRequest> Clone() const
    {
      return Aws::MakeUnique<PutProfileObjectTypeRequest>(GetServiceRequestName(), *this);
    }
