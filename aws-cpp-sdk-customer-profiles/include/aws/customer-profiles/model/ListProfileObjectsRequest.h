...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API ListProfileObjectsRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListProfileObjectsRequest> Clone() const
    {
      return Aws::MakeUnique<ListProfileObjectsRequest>(GetServiceRequestName(), *this);
    }
