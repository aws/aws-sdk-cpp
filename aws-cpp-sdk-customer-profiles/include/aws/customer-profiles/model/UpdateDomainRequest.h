...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API UpdateDomainRequest : public CustomerProfilesRequest
  {
  public:
    UpdateDomainRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateDomainRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDomainRequest>(GetServiceRequestName(), *this);
    }
