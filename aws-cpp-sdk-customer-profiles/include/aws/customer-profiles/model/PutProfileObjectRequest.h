...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API PutProfileObjectRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutProfileObjectRequest> Clone() const
    {
      return Aws::MakeUnique<PutProfileObjectRequest>(GetServiceRequestName(), *this);
    }
