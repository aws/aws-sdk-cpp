...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API ListDomainsRequest : public CustomerProfilesRequest
  {
  public:
    ListDomainsRequest();
    ...
    */
    virtual Aws::UniquePtr<ListDomainsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDomainsRequest>(GetServiceRequestName(), *this);
    }
