...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API ListProfileObjectTypeTemplatesRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListProfileObjectTypeTemplatesRequest> Clone() const
    {
      return Aws::MakeUnique<ListProfileObjectTypeTemplatesRequest>(GetServiceRequestName(), *this);
    }
