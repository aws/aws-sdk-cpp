...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API GetProfileObjectTypeTemplateRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetProfileObjectTypeTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetProfileObjectTypeTemplateRequest>(GetServiceRequestName(), *this);
    }
