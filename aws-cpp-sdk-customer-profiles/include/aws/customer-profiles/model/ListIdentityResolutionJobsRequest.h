...
namespace Model
{
  ...
  /**
   */
  class AWS_CUSTOMERPROFILES_API ListIdentityResolutionJobsRequest : public CustomerProfilesRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListIdentityResolutionJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListIdentityResolutionJobsRequest>(GetServiceRequestName(), *this);
    }
