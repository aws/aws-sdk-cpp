...
namespace CustomerProfiles
{
  ...
  class AWS_CUSTOMERPROFILES_API CustomerProfilesClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CustomerProfilesClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::CustomerProfilesEndpointProvider> endpointProvider = Aws::MakeShared<CustomerProfiles::Endpoint::CustomerProfilesEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CustomerProfilesEndpointProvider> m_endpointProvider;
  };
