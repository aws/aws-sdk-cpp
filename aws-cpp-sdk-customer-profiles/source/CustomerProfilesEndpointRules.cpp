...
Aws::String CustomerProfilesEndpointRules::GetRulesAsString()
{
    return Aws::String(CustomerProfilesEndpointRules::Rules.begin(), CustomerProfilesEndpointRules::Rules.end());
}

const Aws::Vector<char> CustomerProfilesEndpointRules::Rules = {
...
'/','p','r','o','f','i','l','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
