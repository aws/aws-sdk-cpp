...
namespace FSx
{
  ...
  class AWS_FSX_API FSxClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        FSxClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::FSxEndpointProvider> endpointProvider = Aws::MakeShared<FSx::Endpoint::FSxEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::FSxEndpointProvider> m_endpointProvider;
  };
