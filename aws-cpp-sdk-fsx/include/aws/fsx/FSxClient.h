    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * for NetApp ONTAP</p> </li> <li> <p>Amazon FSx for Windows File Server</p> </li>
         ...
         * parameters are the same.</p> <p>If a file system with the specified client
         * request token exists and the parameters match, <code>CreateFileSystem</code>
         ...
         * returns <code>IncompatibleParameterError</code>. If a file system with the
         * specified client request token doesn't exist, <code>CreateFileSystem</code> does
         * the following: </p> <ul> <li> <p>Creates a new, empty Amazon FSx file system
         * with an assigned ID, and an initial lifecycle state of
         * <code>CREATING</code>.</p> </li> <li> <p>Returns the description of the file
         * system.</p> </li> </ul> <p>This operation requires a client request token in the
         * request that Amazon FSx uses to ensure idempotent creation. This means that
         * calling the operation multiple times with the same client request token has no
         * effect. By using the idempotent operation, you can retry a
         * <code>CreateFileSystem</code> operation without the risk of creating an extra
