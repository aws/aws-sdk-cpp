...
namespace Model
{
  ...
  /**
   */
  class AWS_FSX_API CreateFileCacheRequest : public FSxRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateFileCacheRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFileCacheRequest>(GetServiceRequestName(), *this);
    }
