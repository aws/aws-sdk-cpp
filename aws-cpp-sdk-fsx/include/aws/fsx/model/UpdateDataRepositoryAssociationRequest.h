...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDataRepositoryAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDataRepositoryAssociationRequest>(GetServiceRequestName(), *this);
    }
