...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDataRepositoryTasksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDataRepositoryTasksRequest>(GetServiceRequestName(), *this);
    }
