...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateStorageVirtualMachineRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateStorageVirtualMachineRequest>(GetServiceRequestName(), *this);
    }
