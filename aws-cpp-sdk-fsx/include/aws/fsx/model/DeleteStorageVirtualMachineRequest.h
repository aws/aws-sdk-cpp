...
namespace Model
{
  ...
  /**
   */
  class AWS_FSX_API DeleteStorageVirtualMachineRequest : public FSxRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteStorageVirtualMachineRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteStorageVirtualMachineRequest>(GetServiceRequestName(), *this);
    }
