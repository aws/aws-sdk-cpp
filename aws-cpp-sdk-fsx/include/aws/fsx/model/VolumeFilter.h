...
namespace Model
{
   ...
   * all applied filter requirements.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/fsx-2018-03-01/VolumeFilter">AWS
   * API Reference</a></p>
   */
  class AWS_FSX_API VolumeFilter
  {
  public:
    VolumeFilter();
    VolumeFilter(Aws::Utils::Json::JsonView jsonValue);
    VolumeFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
