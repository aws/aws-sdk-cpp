...
namespace Model
{
  ...
  /**
   */
  class AWS_FSX_API DeleteDataRepositoryAssociationRequest : public FSxRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDataRepositoryAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDataRepositoryAssociationRequest>(GetServiceRequestName(), *this);
    }
