...
namespace Model
{
  ...
  /**
   */
  class AWS_FSX_API ReleaseFileSystemNfsV3LocksRequest : public FSxRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ReleaseFileSystemNfsV3LocksRequest> Clone() const
    {
      return Aws::MakeUnique<ReleaseFileSystemNfsV3LocksRequest>(GetServiceRequestName(), *this);
    }
