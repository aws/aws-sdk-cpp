...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_FSX_API DisassociateFileSystemAliasesRequest : public FSxRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateFileSystemAliasesRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateFileSystemAliasesRequest>(GetServiceRequestName(), *this);
    }
