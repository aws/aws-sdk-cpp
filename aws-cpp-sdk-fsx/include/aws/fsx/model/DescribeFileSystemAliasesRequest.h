...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_FSX_API DescribeFileSystemAliasesRequest : public FSxRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFileSystemAliasesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFileSystemAliasesRequest>(GetServiceRequestName(), *this);
    }
