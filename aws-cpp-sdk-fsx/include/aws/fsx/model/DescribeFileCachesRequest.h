...
namespace Model
{
  ...
  /**
   */
  class AWS_FSX_API DescribeFileCachesRequest : public FSxRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFileCachesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFileCachesRequest>(GetServiceRequestName(), *this);
    }
