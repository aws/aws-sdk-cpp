...
namespace Model
{
  ...
  /**
   */
  class AWS_FSX_API CreateDataRepositoryAssociationRequest : public FSxRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDataRepositoryAssociationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDataRepositoryAssociationRequest>(GetServiceRequestName(), *this);
    }
