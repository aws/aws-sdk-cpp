...
namespace Model
{
  ...
  /**
   */
  class AWS_FSX_API DeleteFileCacheRequest : public FSxRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFileCacheRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFileCacheRequest>(GetServiceRequestName(), *this);
    }
