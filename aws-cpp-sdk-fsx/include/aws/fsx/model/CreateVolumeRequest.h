...
namespace Model
{
  ...
  /**
   */
  class AWS_FSX_API CreateVolumeRequest : public FSxRequest
  {
  public:
    CreateVolumeRequest();
    ...
    */
    virtual Aws::UniquePtr<CreateVolumeRequest> Clone() const
    {
      return Aws::MakeUnique<CreateVolumeRequest>(GetServiceRequestName(), *this);
    }
