...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_FSX_API CreateFileCacheLustreConfiguration
  {
  public:
    CreateFileCacheLustreConfiguration();
    CreateFileCacheLustreConfiguration(Aws::Utils::Json::JsonView jsonValue);
    CreateFileCacheLustreConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
