...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_FSX_API AssociateFileSystemAliasesRequest : public FSxRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateFileSystemAliasesRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateFileSystemAliasesRequest>(GetServiceRequestName(), *this);
    }
