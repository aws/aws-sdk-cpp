...
namespace Model
{
  ...
  /**
   */
  class AWS_FSX_API DescribeDataRepositoryAssociationsRequest : public FSxRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDataRepositoryAssociationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDataRepositoryAssociationsRequest>(GetServiceRequestName(), *this);
    }
