...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeStorageVirtualMachinesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeStorageVirtualMachinesRequest>(GetServiceRequestName(), *this);
    }
