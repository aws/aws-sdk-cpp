...
namespace Model
{
  ...
  /**
   */
  class AWS_FSX_API UpdateFileCacheRequest : public FSxRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateFileCacheRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateFileCacheRequest>(GetServiceRequestName(), *this);
    }
