...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateStorageVirtualMachineRequest> Clone() const
    {
      return Aws::MakeUnique<CreateStorageVirtualMachineRequest>(GetServiceRequestName(), *this);
    }
