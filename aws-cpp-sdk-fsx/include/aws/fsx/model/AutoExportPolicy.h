...
namespace Model
{
   ...
   * create, modify, or delete files, Amazon FSx automatically exports the defined
   * changes asynchronously once your application finishes modifying the file.</p>
   * <p>This <code>AutoExportPolicy</code> is supported only for file systems with
   * the <code>Persistent_2</code> deployment type.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/fsx-2018-03-01/AutoExportPolicy">AWS
   * API Reference</a></p>
   */
  class AWS_FSX_API AutoExportPolicy
  {
  public:
    AutoExportPolicy();
    AutoExportPolicy(Aws::Utils::Json::JsonView jsonValue);
    AutoExportPolicy& operator=(Aws::Utils::Json::JsonView jsonValue);
    Aws::Utils::Json::JsonValue Jsonize() const;


    /**
     * <p>The <code>AutoExportPolicy</code> can have the following event values:</p>
     * <ul> <li> <p> <code>NEW</code> - Amazon FSx automatically exports new files and
     * directories to the data repository as they are added to the file system.</p>
     * </li> <li> <p> <code>CHANGED</code> - Amazon FSx automatically exports changes
     * to files and directories on the file system to the data repository.</p> </li>
     * <li> <p> <code>DELETED</code> - Files and directories are automatically deleted
     * on the data repository when they are deleted on the file system.</p> </li> </ul>
     * <p>You can define any combination of event types for your
