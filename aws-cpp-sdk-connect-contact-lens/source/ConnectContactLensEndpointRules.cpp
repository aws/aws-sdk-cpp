...
Aws::String ConnectContactLensEndpointRules::GetRulesAsString()
{
    return Aws::String(ConnectContactLensEndpointRules::Rules.begin(), ConnectContactLensEndpointRules::Rules.end());
}

const Aws::Vector<char> ConnectContactLensEndpointRules::Rules = {
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','o','n','t','a','c',
't','-','l','e','n','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
't','p','s',':','/','/','c','o','n','t','a','c','t','-','l','e','n','s','-','f','i','p','s','.','{',
...
'h','t','t','p','s',':','/','/','c','o','n','t','a','c','t','-','l','e','n','s','.','{','R','e','g',
...
'c','o','n','t','a','c','t','-','l','e','n','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
