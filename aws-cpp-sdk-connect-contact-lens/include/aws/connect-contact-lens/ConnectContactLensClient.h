...
namespace ConnectContactLens
{
  ...
  class AWS_CONNECTCONTACTLENS_API ConnectContactLensClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ConnectContactLensClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                 std::shared_ptr<Endpoint::ConnectContactLensEndpointProvider> endpointProvider = Aws::MakeShared<ConnectContactLens::Endpoint::ConnectContactLensEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ConnectContactLensEndpointProvider> m_endpointProvider;
  };
