...
namespace Model
{
  ...
  /**
   */
  class AWS_CONNECTCONTACTLENS_API ListRealtimeContactAnalysisSegmentsRequest : public ConnectContactLensRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRealtimeContactAnalysisSegmentsRequest> Clone() const
    {
      return Aws::MakeUnique<ListRealtimeContactAnalysisSegmentsRequest>(GetServiceRequestName(), *this);
    }
