...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONNECTCONTACTLENS_API CategoryDetails
  {
  public:
    CategoryDetails();
    CategoryDetails(Aws::Utils::Json::JsonView jsonValue);
    CategoryDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
