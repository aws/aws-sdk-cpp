...
Aws::String PipesEndpointRules::GetRulesAsString()
{
    return Aws::String(PipesEndpointRules::Rules.begin(), PipesEndpointRules::Rules.end());
}

const Aws::Vector<char> PipesEndpointRules::Rules = {
...
'h','t','t','p','s',':','/','/','p','i','p','e','s','-','f','i','p','s','.','{','R','e','g','i','o',
