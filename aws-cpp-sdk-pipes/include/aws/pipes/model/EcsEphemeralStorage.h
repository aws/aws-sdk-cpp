...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API EcsEphemeralStorage
  {
  public:
    EcsEphemeralStorage();
    EcsEphemeralStorage(Aws::Utils::Json::JsonView jsonValue);
    EcsEphemeralStorage& operator=(Aws::Utils::Json::JsonView jsonValue);
