...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API PipeSourceSqsQueueParameters
  {
  public:
    PipeSourceSqsQueueParameters();
    PipeSourceSqsQueueParameters(Aws::Utils::Json::JsonView jsonValue);
    PipeSourceSqsQueueParameters& operator=(Aws::Utils::Json::JsonView jsonValue);
