...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API PipeTargetSqsQueueParameters
  {
  public:
    PipeTargetSqsQueueParameters();
    PipeTargetSqsQueueParameters(Aws::Utils::Json::JsonView jsonValue);
    PipeTargetSqsQueueParameters& operator=(Aws::Utils::Json::JsonView jsonValue);
