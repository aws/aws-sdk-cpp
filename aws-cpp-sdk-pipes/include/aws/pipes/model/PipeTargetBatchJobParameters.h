...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API PipeTargetBatchJobParameters
  {
  public:
    PipeTargetBatchJobParameters();
    PipeTargetBatchJobParameters(Aws::Utils::Json::JsonView jsonValue);
    PipeTargetBatchJobParameters& operator=(Aws::Utils::Json::JsonView jsonValue);
