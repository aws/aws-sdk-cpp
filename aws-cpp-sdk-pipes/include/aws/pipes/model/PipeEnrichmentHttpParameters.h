...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API PipeEnrichmentHttpParameters
  {
  public:
    PipeEnrichmentHttpParameters();
    PipeEnrichmentHttpParameters(Aws::Utils::Json::JsonView jsonValue);
    PipeEnrichmentHttpParameters& operator=(Aws::Utils::Json::JsonView jsonValue);
