...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API PipeTargetCloudWatchLogsParameters
  {
  public:
    PipeTargetCloudWatchLogsParameters();
    PipeTargetCloudWatchLogsParameters(Aws::Utils::Json::JsonView jsonValue);
    PipeTargetCloudWatchLogsParameters& operator=(Aws::Utils::Json::JsonView jsonValue);
