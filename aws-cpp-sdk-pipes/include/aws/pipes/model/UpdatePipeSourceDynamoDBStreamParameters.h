...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API UpdatePipeSourceDynamoDBStreamParameters
  {
  public:
    UpdatePipeSourceDynamoDBStreamParameters();
    UpdatePipeSourceDynamoDBStreamParameters(Aws::Utils::Json::JsonView jsonValue);
    UpdatePipeSourceDynamoDBStreamParameters& operator=(Aws::Utils::Json::JsonView jsonValue);
