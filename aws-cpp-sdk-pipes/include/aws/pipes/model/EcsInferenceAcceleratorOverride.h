...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API EcsInferenceAcceleratorOverride
  {
  public:
    EcsInferenceAcceleratorOverride();
    EcsInferenceAcceleratorOverride(Aws::Utils::Json::JsonView jsonValue);
    EcsInferenceAcceleratorOverride& operator=(Aws::Utils::Json::JsonView jsonValue);
