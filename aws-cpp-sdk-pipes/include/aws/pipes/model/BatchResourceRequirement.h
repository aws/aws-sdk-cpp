...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API BatchResourceRequirement
  {
  public:
    BatchResourceRequirement();
    BatchResourceRequirement(Aws::Utils::Json::JsonView jsonValue);
    BatchResourceRequirement& operator=(Aws::Utils::Json::JsonView jsonValue);
