...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API BatchEnvironmentVariable
  {
  public:
    BatchEnvironmentVariable();
    BatchEnvironmentVariable(Aws::Utils::Json::JsonView jsonValue);
    BatchEnvironmentVariable& operator=(Aws::Utils::Json::JsonView jsonValue);
