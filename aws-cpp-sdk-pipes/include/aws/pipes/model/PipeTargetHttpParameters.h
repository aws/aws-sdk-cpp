...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API PipeTargetHttpParameters
  {
  public:
    PipeTargetHttpParameters();
    PipeTargetHttpParameters(Aws::Utils::Json::JsonView jsonValue);
    PipeTargetHttpParameters& operator=(Aws::Utils::Json::JsonView jsonValue);
