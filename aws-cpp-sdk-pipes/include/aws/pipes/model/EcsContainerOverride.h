...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API EcsContainerOverride
  {
  public:
    EcsContainerOverride();
    EcsContainerOverride(Aws::Utils::Json::JsonView jsonValue);
    EcsContainerOverride& operator=(Aws::Utils::Json::JsonView jsonValue);
