...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API EcsEnvironmentFile
  {
  public:
    EcsEnvironmentFile();
    EcsEnvironmentFile(Aws::Utils::Json::JsonView jsonValue);
    EcsEnvironmentFile& operator=(Aws::Utils::Json::JsonView jsonValue);
