...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API BatchContainerOverrides
  {
  public:
    BatchContainerOverrides();
    BatchContainerOverrides(Aws::Utils::Json::JsonView jsonValue);
    BatchContainerOverrides& operator=(Aws::Utils::Json::JsonView jsonValue);
