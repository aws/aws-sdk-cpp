...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API UpdatePipeSourceSelfManagedKafkaParameters
  {
  public:
    UpdatePipeSourceSelfManagedKafkaParameters();
    UpdatePipeSourceSelfManagedKafkaParameters(Aws::Utils::Json::JsonView jsonValue);
    UpdatePipeSourceSelfManagedKafkaParameters& operator=(Aws::Utils::Json::JsonView jsonValue);
