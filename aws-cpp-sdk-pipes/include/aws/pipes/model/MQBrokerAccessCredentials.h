...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API MQBrokerAccessCredentials
  {
  public:
    MQBrokerAccessCredentials();
    MQBrokerAccessCredentials(Aws::Utils::Json::JsonView jsonValue);
    MQBrokerAccessCredentials& operator=(Aws::Utils::Json::JsonView jsonValue);
