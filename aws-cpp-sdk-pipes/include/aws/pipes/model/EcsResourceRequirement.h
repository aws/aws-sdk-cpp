...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PIPES_API EcsResourceRequirement
  {
  public:
    EcsResourceRequirement();
    EcsResourceRequirement(Aws::Utils::Json::JsonView jsonValue);
    EcsResourceRequirement& operator=(Aws::Utils::Json::JsonView jsonValue);
