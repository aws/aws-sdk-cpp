...
namespace MediaTailor
{
  ...
  class AWS_MEDIATAILOR_API MediaTailorClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MediaTailorClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                          std::shared_ptr<Endpoint::MediaTailorEndpointProvider> endpointProvider = Aws::MakeShared<MediaTailor::Endpoint::MediaTailorEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MediaTailorEndpointProvider> m_endpointProvider;
  };
