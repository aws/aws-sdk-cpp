...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIATAILOR_API ListSourceLocationsRequest : public MediaTailorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSourceLocationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSourceLocationsRequest>(GetServiceRequestName(), *this);
    }
     ...
     * allowed. Use the token to fetch the next page of results.</p>
     */
    inline ListSourceLocationsRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}

    /**
     * <p>Pagination token returned by the list request when results exceed the maximum
     * allowed. Use the token to fetch the next page of results.</p>
     */
    inline ListSourceLocationsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}

    /**
     * <p>Pagination token returned by the list request when results exceed the maximum
     * allowed. Use the token to fetch the next page of results.</p>
     */
    inline ListSourceLocationsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
