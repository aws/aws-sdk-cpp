...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeletePlaybackConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeletePlaybackConfigurationRequest>(GetServiceRequestName(), *this);
    }
