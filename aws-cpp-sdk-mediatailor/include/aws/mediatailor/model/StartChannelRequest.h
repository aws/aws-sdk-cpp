...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIATAILOR_API StartChannelRequest : public MediaTailorRequest
  {
  public:
    StartChannelRequest();
    ...
    */
    virtual Aws::UniquePtr<StartChannelRequest> Clone() const
    {
      return Aws::MakeUnique<StartChannelRequest>(GetServiceRequestName(), *this);
    }
