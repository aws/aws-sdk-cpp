...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIATAILOR_API DeleteChannelPolicyRequest : public MediaTailorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteChannelPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteChannelPolicyRequest>(GetServiceRequestName(), *this);
    }
