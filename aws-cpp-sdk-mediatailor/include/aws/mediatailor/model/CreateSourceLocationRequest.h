...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIATAILOR_API CreateSourceLocationRequest : public MediaTailorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateSourceLocationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateSourceLocationRequest>(GetServiceRequestName(), *this);
    }
