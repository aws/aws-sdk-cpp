...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIATAILOR_API GetPlaybackConfigurationRequest : public MediaTailorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPlaybackConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetPlaybackConfigurationRequest>(GetServiceRequestName(), *this);
    }
