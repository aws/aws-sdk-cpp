...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIATAILOR_API ListLiveSourcesRequest : public MediaTailorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLiveSourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListLiveSourcesRequest>(GetServiceRequestName(), *this);
    }
