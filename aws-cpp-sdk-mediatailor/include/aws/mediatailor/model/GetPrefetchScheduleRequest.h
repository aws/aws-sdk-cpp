...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIATAILOR_API GetPrefetchScheduleRequest : public MediaTailorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPrefetchScheduleRequest> Clone() const
    {
      return Aws::MakeUnique<GetPrefetchScheduleRequest>(GetServiceRequestName(), *this);
    }
