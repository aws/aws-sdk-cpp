...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ConfigureLogsForPlaybackConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<ConfigureLogsForPlaybackConfigurationRequest>(GetServiceRequestName(), *this);
    }
