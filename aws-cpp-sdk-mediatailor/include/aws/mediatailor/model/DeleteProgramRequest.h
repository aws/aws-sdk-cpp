...
namespace Model
{
  ...
  /**
   */
  class AWS_MEDIATAILOR_API DeleteProgramRequest : public MediaTailorRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteProgramRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteProgramRequest>(GetServiceRequestName(), *this);
    }
