...
using ResolveEndpointOutcome = Aws::MediaTailor::Endpoint::MediaTailorEndpointProvider::MediaTailorResolveEndpointOutcome;
...
MediaTailorClient::MediaTailorClient(const Client::ClientConfiguration& clientConfiguration,
                                     std::shared_ptr<Endpoint::MediaTailorEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<MediaTailorErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<MediaTailor::Endpoint::MediaTailorEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
