...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MGN_API LifeCycleLastTestInitiated
  {
  public:
    LifeCycleLastTestInitiated();
    LifeCycleLastTestInitiated(Aws::Utils::Json::JsonView jsonValue);
    LifeCycleLastTestInitiated& operator=(Aws::Utils::Json::JsonView jsonValue);
