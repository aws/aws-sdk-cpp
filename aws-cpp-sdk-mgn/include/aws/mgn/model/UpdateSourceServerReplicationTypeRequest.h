...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSourceServerReplicationTypeRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSourceServerReplicationTypeRequest>(GetServiceRequestName(), *this);
    }
