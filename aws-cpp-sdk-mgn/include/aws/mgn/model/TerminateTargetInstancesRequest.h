...
namespace Model
{
  ...
  /**
   */
  class AWS_MGN_API TerminateTargetInstancesRequest : public MgnRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<TerminateTargetInstancesRequest> Clone() const
    {
      return Aws::MakeUnique<TerminateTargetInstancesRequest>(GetServiceRequestName(), *this);
    }
