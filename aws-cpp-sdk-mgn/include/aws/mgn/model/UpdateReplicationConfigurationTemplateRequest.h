...
namespace Model
{
  ...
  /**
   */
  class AWS_MGN_API UpdateReplicationConfigurationTemplateRequest : public MgnRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateReplicationConfigurationTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateReplicationConfigurationTemplateRequest>(GetServiceRequestName(), *this);
    }
