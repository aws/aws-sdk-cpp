...
namespace Model
{
  ...
  /**
   */
  class AWS_MGN_API StartCutoverRequest : public MgnRequest
  {
  public:
    StartCutoverRequest();
    ...
    */
    virtual Aws::UniquePtr<StartCutoverRequest> Clone() const
    {
      return Aws::MakeUnique<StartCutoverRequest>(GetServiceRequestName(), *this);
    }
