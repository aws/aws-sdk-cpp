...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLaunchConfigurationTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLaunchConfigurationTemplateRequest>(GetServiceRequestName(), *this);
    }
