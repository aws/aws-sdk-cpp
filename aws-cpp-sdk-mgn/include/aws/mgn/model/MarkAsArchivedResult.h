...
namespace Model
{
  ...
  public:
     ...
     * <p>Source server Tags.</p>
     */
    inline MarkAsArchivedResult& WithTags(const Aws::Map<Aws::String, Aws::String>& value) { SetTags(value); return *this;}

    /**
     * <p>Source server Tags.</p>
     */
    inline MarkAsArchivedResult& WithTags(Aws::Map<Aws::String, Aws::String>&& value) { SetTags(std::move(value)); return *this;}
