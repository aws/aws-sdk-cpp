...
namespace Model
{
  ...
  /**
   */
  class AWS_MGN_API StartReplicationRequest : public MgnRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartReplicationRequest> Clone() const
    {
      return Aws::MakeUnique<StartReplicationRequest>(GetServiceRequestName(), *this);
    }
