...
namespace Model
{
  ...
  /**
   */
  class AWS_MGN_API MarkAsArchivedRequest : public MgnRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<MarkAsArchivedRequest> Clone() const
    {
      return Aws::MakeUnique<MarkAsArchivedRequest>(GetServiceRequestName(), *this);
    }
