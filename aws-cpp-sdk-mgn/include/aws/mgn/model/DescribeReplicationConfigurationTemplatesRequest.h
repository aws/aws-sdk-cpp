...
namespace Model
{
  ...
  /**
   */
  class AWS_MGN_API DescribeReplicationConfigurationTemplatesRequest : public MgnRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReplicationConfigurationTemplatesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReplicationConfigurationTemplatesRequest>(GetServiceRequestName(), *this);
    }
