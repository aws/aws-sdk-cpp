...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateLaunchConfigurationTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLaunchConfigurationTemplateRequest>(GetServiceRequestName(), *this);
    }
