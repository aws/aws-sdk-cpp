...
namespace Model
{
  ...
  /**
   */
  class AWS_MGN_API DeleteVcenterClientRequest : public MgnRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteVcenterClientRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteVcenterClientRequest>(GetServiceRequestName(), *this);
    }
