...
namespace Model
{
  ...
  /**
   */
  class AWS_MGN_API StartTestRequest : public MgnRequest
  {
  public:
    StartTestRequest();
    ...
    */
    virtual Aws::UniquePtr<StartTestRequest> Clone() const
    {
      return Aws::MakeUnique<StartTestRequest>(GetServiceRequestName(), *this);
    }
