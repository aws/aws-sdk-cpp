...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLaunchConfigurationTemplatesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLaunchConfigurationTemplatesRequest>(GetServiceRequestName(), *this);
    }
