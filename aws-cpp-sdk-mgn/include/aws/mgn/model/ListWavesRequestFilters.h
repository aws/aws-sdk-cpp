...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_MGN_API ListWavesRequestFilters
  {
  public:
    ListWavesRequestFilters();
    ListWavesRequestFilters(Aws::Utils::Json::JsonView jsonValue);
    ListWavesRequestFilters& operator=(Aws::Utils::Json::JsonView jsonValue);
