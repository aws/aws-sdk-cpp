...
namespace Model
{
  ...
  /**
   */
  class AWS_MGN_API DeleteLaunchConfigurationTemplateRequest : public MgnRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLaunchConfigurationTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLaunchConfigurationTemplateRequest>(GetServiceRequestName(), *this);
    }
