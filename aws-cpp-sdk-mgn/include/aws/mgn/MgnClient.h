...
namespace mgn
{
  ...
  class AWS_MGN_API MgnClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MgnClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::MgnEndpointProvider> endpointProvider = Aws::MakeShared<mgn::Endpoint::MgnEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MgnEndpointProvider> m_endpointProvider;
  };
