...
Aws::String MgnEndpointRules::GetRulesAsString()
{
    return Aws::String(MgnEndpointRules::Rules.begin(), MgnEndpointRules::Rules.end());
}

const Aws::Vector<char> MgnEndpointRules::Rules = {
