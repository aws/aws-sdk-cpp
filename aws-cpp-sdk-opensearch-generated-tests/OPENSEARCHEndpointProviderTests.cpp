...
static const char* ALLOCATION_TAG = "AWSOpenSearchServiceEndpointProviderTests";
using OpenSearchServiceEndpointProvider = Aws::OpenSearchService::Endpoint::OpenSearchServiceEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using OpenSearchServiceResolveEndpointOutcome = Aws::OpenSearchService::Endpoint::OpenSearchServiceEndpointProvider::OpenSearchServiceResolveEndpointOutcome;
...
class OpenSearchServiceEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct OpenSearchServiceEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<OpenSearchServiceEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const OpenSearchServiceResolveEndpointOutcome& outcome, const OpenSearchServiceEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(OpenSearchServiceEndpointProviderTests, EndpointProviderTest)
{
    ...
    const OpenSearchServiceEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<OpenSearchServiceEndpointProvider> endpointProvider = Aws::MakeShared<OpenSearchServiceEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize OpenSearchServiceEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const OpenSearchServiceEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         OpenSearchServiceEndpointProviderTests,
