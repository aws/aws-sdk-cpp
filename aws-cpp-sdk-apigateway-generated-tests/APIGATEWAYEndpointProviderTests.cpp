...
static const char* ALLOCATION_TAG = "AWSAPIGatewayEndpointProviderTests";
using APIGatewayEndpointProvider = Aws::APIGateway::Endpoint::APIGatewayEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using APIGatewayResolveEndpointOutcome = Aws::APIGateway::Endpoint::APIGatewayEndpointProvider::APIGatewayResolveEndpointOutcome;
...
class APIGatewayEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct APIGatewayEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<APIGatewayEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const APIGatewayResolveEndpointOutcome& outcome, const APIGatewayEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(APIGatewayEndpointProviderTests, EndpointProviderTest)
{
    ...
    const APIGatewayEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<APIGatewayEndpointProvider> endpointProvider = Aws::MakeShared<APIGatewayEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize APIGatewayEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const APIGatewayEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         APIGatewayEndpointProviderTests,
