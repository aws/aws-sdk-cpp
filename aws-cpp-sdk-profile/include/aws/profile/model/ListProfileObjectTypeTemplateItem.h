...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListProfileObjectTypeTemplateItem">AWS
   * API Reference</a></p>
   */
  class AWS_PROFILE_API ListProfileObjectTypeTemplateItem
  {
  public:
