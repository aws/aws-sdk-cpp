...
#include <aws/profile/model/StandardIdentifier.h>
...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ObjectTypeKey">AWS
   * API Reference</a></p>
   */
  class AWS_PROFILE_API ObjectTypeKey
  {
  public:
    ObjectTypeKey();
