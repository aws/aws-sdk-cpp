...
#include <aws/profile/model/DeleteProfileResult.h>
...
#include <aws/profile/model/ListProfileObjectTypeTemplatesResult.h>
...
namespace Model
{
        ...
        typedef Aws::Utils::Outcome<AddProfileKeyResult, ProfileError> AddProfileKeyOutcome;
        typedef Aws::Utils::Outcome<CreateDomainResult, ProfileError> CreateDomainOutcome;
        typedef Aws::Utils::Outcome<CreateProfileResult, ProfileError> CreateProfileOutcome;
        typedef Aws::Utils::Outcome<DeleteDomainResult, ProfileError> DeleteDomainOutcome;
        typedef Aws::Utils::Outcome<DeleteIntegrationResult, ProfileError> DeleteIntegrationOutcome;
        typedef Aws::Utils::Outcome<DeleteProfileResult, ProfileError> DeleteProfileOutcome;
        typedef Aws::Utils::Outcome<DeleteProfileKeyResult, ProfileError> DeleteProfileKeyOutcome;
        typedef Aws::Utils::Outcome<DeleteProfileObjectResult, ProfileError> DeleteProfileObjectOutcome;
        typedef Aws::Utils::Outcome<DeleteProfileObjectTypeResult, ProfileError> DeleteProfileObjectTypeOutcome;
        typedef Aws::Utils::Outcome<GetDomainResult, ProfileError> GetDomainOutcome;
        typedef Aws::Utils::Outcome<GetIntegrationResult, ProfileError> GetIntegrationOutcome;
        typedef Aws::Utils::Outcome<GetProfileObjectTypeResult, ProfileError> GetProfileObjectTypeOutcome;
        typedef Aws::Utils::Outcome<GetProfileObjectTypeTemplateResult, ProfileError> GetProfileObjectTypeTemplateOutcome;
        typedef Aws::Utils::Outcome<ListAccountIntegrationsResult, ProfileError> ListAccountIntegrationsOutcome;
        typedef Aws::Utils::Outcome<ListDomainsResult, ProfileError> ListDomainsOutcome;
        typedef Aws::Utils::Outcome<ListIntegrationsResult, ProfileError> ListIntegrationsOutcome;
        typedef Aws::Utils::Outcome<ListProfileObjectTypeTemplatesResult, ProfileError> ListProfileObjectTypeTemplatesOutcome;
        typedef Aws::Utils::Outcome<ListProfileObjectTypesResult, ProfileError> ListProfileObjectTypesOutcome;
        typedef Aws::Utils::Outcome<ListProfileObjectsResult, ProfileError> ListProfileObjectsOutcome;
        typedef Aws::Utils::Outcome<ListTagsForResourceResult, ProfileError> ListTagsForResourceOutcome;
        typedef Aws::Utils::Outcome<PutIntegrationResult, ProfileError> PutIntegrationOutcome;
        typedef Aws::Utils::Outcome<PutProfileObjectResult, ProfileError> PutProfileObjectOutcome;
        typedef Aws::Utils::Outcome<PutProfileObjectTypeResult, ProfileError> PutProfileObjectTypeOutcome;
        typedef Aws::Utils::Outcome<SearchProfilesResult, ProfileError> SearchProfilesOutcome;
        typedef Aws::Utils::Outcome<TagResourceResult, ProfileError> TagResourceOutcome;
        typedef Aws::Utils::Outcome<UntagResourceResult, ProfileError> UntagResourceOutcome;
        typedef Aws::Utils::Outcome<UpdateDomainResult, ProfileError> UpdateDomainOutcome;
        typedef Aws::Utils::Outcome<UpdateProfileResult, ProfileError> UpdateProfileOutcome;
  ...
  class ProfileClient;
    ...
    typedef std::function<void(const ProfileClient*, const Model::AddProfileKeyRequest&, const Model::AddProfileKeyOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > AddProfileKeyResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::CreateDomainRequest&, const Model::CreateDomainOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > CreateDomainResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::CreateProfileRequest&, const Model::CreateProfileOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > CreateProfileResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::DeleteDomainRequest&, const Model::DeleteDomainOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DeleteDomainResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::DeleteIntegrationRequest&, const Model::DeleteIntegrationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DeleteIntegrationResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::DeleteProfileRequest&, const Model::DeleteProfileOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DeleteProfileResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::DeleteProfileKeyRequest&, const Model::DeleteProfileKeyOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DeleteProfileKeyResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::DeleteProfileObjectRequest&, const Model::DeleteProfileObjectOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DeleteProfileObjectResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::DeleteProfileObjectTypeRequest&, const Model::DeleteProfileObjectTypeOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > DeleteProfileObjectTypeResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::GetDomainRequest&, const Model::GetDomainOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > GetDomainResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::GetIntegrationRequest&, const Model::GetIntegrationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > GetIntegrationResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::GetProfileObjectTypeRequest&, const Model::GetProfileObjectTypeOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > GetProfileObjectTypeResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::GetProfileObjectTypeTemplateRequest&, const Model::GetProfileObjectTypeTemplateOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > GetProfileObjectTypeTemplateResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::ListAccountIntegrationsRequest&, const Model::ListAccountIntegrationsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ListAccountIntegrationsResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::ListDomainsRequest&, const Model::ListDomainsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ListDomainsResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::ListIntegrationsRequest&, const Model::ListIntegrationsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ListIntegrationsResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::ListProfileObjectTypeTemplatesRequest&, const Model::ListProfileObjectTypeTemplatesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ListProfileObjectTypeTemplatesResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::ListProfileObjectTypesRequest&, const Model::ListProfileObjectTypesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ListProfileObjectTypesResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::ListProfileObjectsRequest&, const Model::ListProfileObjectsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ListProfileObjectsResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::ListTagsForResourceRequest&, const Model::ListTagsForResourceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ListTagsForResourceResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::PutIntegrationRequest&, const Model::PutIntegrationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > PutIntegrationResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::PutProfileObjectRequest&, const Model::PutProfileObjectOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > PutProfileObjectResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::PutProfileObjectTypeRequest&, const Model::PutProfileObjectTypeOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > PutProfileObjectTypeResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::SearchProfilesRequest&, const Model::SearchProfilesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > SearchProfilesResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::TagResourceRequest&, const Model::TagResourceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > TagResourceResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > UntagResourceResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::UpdateDomainRequest&, const Model::UpdateDomainOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > UpdateDomainResponseReceivedHandler;
    typedef std::function<void(const ProfileClient*, const Model::UpdateProfileRequest&, const Model::UpdateProfileOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > UpdateProfileResponseReceivedHandler;
   ...
   */
  class AWS_PROFILE_API ProfileClient : public Aws::Client::AWSJsonClient
  {
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
        ProfileClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration());

       /**
        * Initializes client to use SimpleAWSCredentialsProvider, with default http client factory, and optional client config. If client config
        * is not specified, it will be initialized to default values.
        */
        ProfileClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration());

       /**
        * Initializes client to use specified credentials provider with specified client config. If http client factory is not supplied,
        * the default http client factory will be used
        */
        ProfileClient(const std::shared_ptr<Aws::Auth::AWSCredentialsProvider>& credentialsProvider,
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/AddProfileKey">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/CreateDomain">AWS
         * API Reference</a></p>
         */
         ...
         * Also:</h3>   <a
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/CreateProfile">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/DeleteDomain">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/DeleteIntegration">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/DeleteProfile">AWS
         * API Reference</a></p>
         */
         ...
         * <a
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/DeleteProfileKey">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/DeleteProfileObject">AWS
         * API Reference</a></p>
         */
         ...
         * Also:</h3>   <a
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/DeleteProfileObjectType">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/GetDomain">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/GetIntegration">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/GetProfileObjectType">AWS
         * API Reference</a></p>
         */
         ...
         * <a
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/GetProfileObjectTypeTemplate">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListAccountIntegrations">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListDomains">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListIntegrations">AWS
         * API Reference</a></p>
         */
         ...
         * Also:</h3>   <a
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListProfileObjectTypeTemplates">AWS
         * API Reference</a></p>
         */
         ...
         * Also:</h3>   <a
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListProfileObjectTypes">AWS
         * API Reference</a></p>
         */
         ...
         * ProfileObjectType.</p><p><h3>See Also:</h3>   <a
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListProfileObjects">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/ListTagsForResource">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/PutIntegration">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/PutProfileObject">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/PutProfileObjectType">AWS
         * API Reference</a></p>
         */
         ...
         * Also:</h3>   <a
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/SearchProfiles">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/TagResource">AWS
         * API Reference</a></p>
         */
         ...
         * resource. In Connect Customer Profiles, domains, profile object types, and
         * integrations can be tagged.</p><p><h3>See Also:</h3>   <a
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/UntagResource">AWS
         * API Reference</a></p>
         */
         ...
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/UpdateDomain">AWS
         * API Reference</a></p>
         */
         ...
         * Also:</h3>   <a
         * href="http://docs.aws.amazon.com/goto/WebAPI/profile-2020-08-15/UpdateProfile">AWS
         * API Reference</a></p>
         */
