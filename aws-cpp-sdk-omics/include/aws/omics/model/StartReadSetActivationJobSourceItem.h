...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OMICS_API StartReadSetActivationJobSourceItem
  {
  public:
    StartReadSetActivationJobSourceItem();
    StartReadSetActivationJobSourceItem(Aws::Utils::Json::JsonView jsonValue);
    StartReadSetActivationJobSourceItem& operator=(Aws::Utils::Json::JsonView jsonValue);
