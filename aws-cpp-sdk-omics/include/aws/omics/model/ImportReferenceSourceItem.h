...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OMICS_API ImportReferenceSourceItem
  {
  public:
    ImportReferenceSourceItem();
    ImportReferenceSourceItem(Aws::Utils::Json::JsonView jsonValue);
    ImportReferenceSourceItem& operator=(Aws::Utils::Json::JsonView jsonValue);
