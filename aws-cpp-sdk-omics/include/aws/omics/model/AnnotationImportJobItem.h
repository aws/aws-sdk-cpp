...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OMICS_API AnnotationImportJobItem
  {
  public:
    AnnotationImportJobItem();
    AnnotationImportJobItem(Aws::Utils::Json::JsonView jsonValue);
    AnnotationImportJobItem& operator=(Aws::Utils::Json::JsonView jsonValue);
