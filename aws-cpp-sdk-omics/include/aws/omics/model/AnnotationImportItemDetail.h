...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OMICS_API AnnotationImportItemDetail
  {
  public:
    AnnotationImportItemDetail();
    AnnotationImportItemDetail(Aws::Utils::Json::JsonView jsonValue);
    AnnotationImportItemDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
