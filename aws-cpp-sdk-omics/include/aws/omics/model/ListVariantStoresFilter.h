...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OMICS_API ListVariantStoresFilter
  {
  public:
    ListVariantStoresFilter();
    ListVariantStoresFilter(Aws::Utils::Json::JsonView jsonValue);
    ListVariantStoresFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
