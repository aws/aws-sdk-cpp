...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OMICS_API VariantImportItemDetail
  {
  public:
    VariantImportItemDetail();
    VariantImportItemDetail(Aws::Utils::Json::JsonView jsonValue);
    VariantImportItemDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
