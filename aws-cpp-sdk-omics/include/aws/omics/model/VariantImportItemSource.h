...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OMICS_API VariantImportItemSource
  {
  public:
    VariantImportItemSource();
    VariantImportItemSource(Aws::Utils::Json::JsonView jsonValue);
    VariantImportItemSource& operator=(Aws::Utils::Json::JsonView jsonValue);
