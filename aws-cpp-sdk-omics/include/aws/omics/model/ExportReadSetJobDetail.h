...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OMICS_API ExportReadSetJobDetail
  {
  public:
    ExportReadSetJobDetail();
    ExportReadSetJobDetail(Aws::Utils::Json::JsonView jsonValue);
    ExportReadSetJobDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
