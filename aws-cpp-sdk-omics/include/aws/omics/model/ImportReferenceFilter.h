...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OMICS_API ImportReferenceFilter
  {
  public:
    ImportReferenceFilter();
    ImportReferenceFilter(Aws::Utils::Json::JsonView jsonValue);
    ImportReferenceFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
