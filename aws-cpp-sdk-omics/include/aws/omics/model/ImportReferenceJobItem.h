...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OMICS_API ImportReferenceJobItem
  {
  public:
    ImportReferenceJobItem();
    ImportReferenceJobItem(Aws::Utils::Json::JsonView jsonValue);
    ImportReferenceJobItem& operator=(Aws::Utils::Json::JsonView jsonValue);
