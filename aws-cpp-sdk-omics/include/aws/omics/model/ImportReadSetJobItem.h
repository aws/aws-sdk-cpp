...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_OMICS_API ImportReadSetJobItem
  {
  public:
    ImportReadSetJobItem();
    ImportReadSetJobItem(Aws::Utils::Json::JsonView jsonValue);
    ImportReadSetJobItem& operator=(Aws::Utils::Json::JsonView jsonValue);
