...
Aws::String OmicsEndpointRules::GetRulesAsString()
{
    return Aws::String(OmicsEndpointRules::Rules.begin(), OmicsEndpointRules::Rules.end());
}

const Aws::Vector<char> OmicsEndpointRules::Rules = {
...
'h','t','t','p','s',':','/','/','o','m','i','c','s','-','f','i','p','s','.','{','R','e','g','i','o',
