...
using ResolveEndpointOutcome = Aws::ElasticLoadBalancingv2::Endpoint::ElasticLoadBalancingv2EndpointProvider::ElasticLoadBalancingv2ResolveEndpointOutcome;
...
ElasticLoadBalancingv2Client::ElasticLoadBalancingv2Client(const Client::ClientConfiguration& clientConfiguration,
                                                           std::shared_ptr<Endpoint::ElasticLoadBalancingv2EndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ElasticLoadBalancingv2ErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ElasticLoadBalancingv2::Endpoint::ElasticLoadBalancingv2EndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
