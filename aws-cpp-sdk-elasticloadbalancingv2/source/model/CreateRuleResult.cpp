...
CreateRuleResult::CreateRuleResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

CreateRuleResult& CreateRuleResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
  const XmlDocument& xmlDocument = result.GetPayload();
  XmlNode rootNode = xmlDocument.GetRootElement();
  XmlNode resultNode = rootNode;
  if (rootNode.GetName() != "CreateRuleResult")
  {
