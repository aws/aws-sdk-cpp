...
Aws::String DescribeProvisionedCapacityRequest::SerializePayload() const
{
  Aws::StringStream ss;
  ss << "Action=DescribeProvisionedCapacity&";
...
void  DescribeProvisionedCapacityRequest::DumpBodyToUrl(Aws::Http::URI& uri ) const
{
