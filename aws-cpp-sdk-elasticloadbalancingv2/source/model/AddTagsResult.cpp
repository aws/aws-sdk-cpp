...
AddTagsResult::AddTagsResult(const AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}

AddTagsResult& AddTagsResult::operator =(const AmazonWebServiceResult<XmlDocument>& result)
{
