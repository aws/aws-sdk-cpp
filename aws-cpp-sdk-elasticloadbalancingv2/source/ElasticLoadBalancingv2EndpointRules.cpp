...
Aws::String ElasticLoadBalancingv2EndpointRules::GetRulesAsString()
{
    return Aws::String(ElasticLoadBalancingv2EndpointRules::Rules.begin(), ElasticLoadBalancingv2EndpointRules::Rules.end());
}

const Aws::Vector<char> ElasticLoadBalancingv2EndpointRules::Rules = {
