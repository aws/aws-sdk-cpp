...
namespace ElasticLoadBalancingv2
{
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ElasticLoadBalancingv2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                     std::shared_ptr<Endpoint::ElasticLoadBalancingv2EndpointProvider> endpointProvider = Aws::MakeShared<ElasticLoadBalancingv2::Endpoint::ElasticLoadBalancingv2EndpointProvider>(ALLOCATION_TAG));
  ...
  private:
        ...
        std::shared_ptr<Endpoint::ElasticLoadBalancingv2EndpointProvider> m_endpointProvider;
  };
