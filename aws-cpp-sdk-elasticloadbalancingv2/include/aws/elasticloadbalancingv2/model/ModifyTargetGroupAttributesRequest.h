...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyTargetGroupAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyTargetGroupAttributesRequest>(GetServiceRequestName(), *this);
    }
