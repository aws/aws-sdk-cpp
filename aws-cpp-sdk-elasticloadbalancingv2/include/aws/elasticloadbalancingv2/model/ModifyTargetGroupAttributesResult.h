...
{
  /**
   * <p>Contains the output of ModifyTargetGroupAttributes.</p><p><h3>See Also:</h3> 
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/elasticloadbalancingv2-2015-12-01/ModifyTargetGroupAttributesOutput">AWS
   * API Reference</a></p>
   */
  class AWS_ELASTICLOADBALANCINGV2_API ModifyTargetGroupAttributesResult
  {
  public:
     ...
     * <p>Information about the attributes.</p>
     */
    inline void SetAttributes(Aws::Vector<TargetGroupAttribute>&& value) { m_attributes = value; }
     ...
     * <p>Information about the attributes.</p>
     */
    inline ModifyTargetGroupAttributesResult& WithAttributes(Aws::Vector<TargetGroupAttribute>&& value) { SetAttributes(value); return *this;}
     ...
     * <p>Information about the attributes.</p>
     */
    inline ModifyTargetGroupAttributesResult& AddAttributes(TargetGroupAttribute&& value) { m_attributes.push_back(value); return *this; }
    ...
    inline ModifyTargetGroupAttributesResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
