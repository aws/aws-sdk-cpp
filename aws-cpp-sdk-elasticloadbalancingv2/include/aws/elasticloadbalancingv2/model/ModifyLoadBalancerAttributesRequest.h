...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyLoadBalancerAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyLoadBalancerAttributesRequest>(GetServiceRequestName(), *this);
    }
