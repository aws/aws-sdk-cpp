...
{
  /**
   * <p>Contains the output of SetRulePriorities.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/elasticloadbalancingv2-2015-12-01/SetRulePrioritiesOutput">AWS
   * API Reference</a></p>
   */
  ...
  public:
     ...
     * <p>Information about the rules.</p>
     */
    inline SetRulePrioritiesResult& WithRules(Aws::Vector<Rule>&& value) { SetRules(value); return *this;}
     ...
     * <p>Information about the rules.</p>
     */
    inline SetRulePrioritiesResult& AddRules(Rule&& value) { m_rules.push_back(value); return *this; }
    ...
    inline SetRulePrioritiesResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(value); return *this;}
