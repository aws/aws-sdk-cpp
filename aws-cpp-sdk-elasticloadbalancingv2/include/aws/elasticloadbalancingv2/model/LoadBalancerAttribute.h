...
namespace Model
{
  ...
  public:
     ...
     * <code>access_logs.s3.enabled</code> - [Application Load Balancers] Indicates
     * whether access logs stored in Amazon S3 are enabled. The value is
     * <code>true</code> or <code>false</code>.</p> </li> <li> <p>
     * <code>access_logs.s3.bucket</code> - [Application Load Balancers] The name of
     * the S3 bucket for the access logs. This attribute is required if access logs in
     * Amazon S3 are enabled. The bucket must exist in the same region as the load
     * balancer and have a bucket policy that grants Elastic Load Balancing permission
     * to write to the bucket.</p> </li> <li> <p> <code>access_logs.s3.prefix</code> -
     * [Application Load Balancers] The prefix for the location in the S3 bucket. If
     * you don't specify a prefix, the access logs are stored in the root of the
     * bucket.</p> </li> <li> <p> <code>deletion_protection.enabled</code> - Indicates
