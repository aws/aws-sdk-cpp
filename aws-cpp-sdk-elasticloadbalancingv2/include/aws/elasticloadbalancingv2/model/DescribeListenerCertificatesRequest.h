...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeListenerCertificatesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeListenerCertificatesRequest>(GetServiceRequestName(), *this);
    }
