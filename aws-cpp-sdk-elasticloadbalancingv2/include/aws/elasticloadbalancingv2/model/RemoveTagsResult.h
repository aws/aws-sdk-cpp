...
namespace Model
{
  class AWS_ELASTICLOADBALANCINGV2_API RemoveTagsResult
  {
  public:
    RemoveTagsResult();
    ...
    inline RemoveTagsResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
