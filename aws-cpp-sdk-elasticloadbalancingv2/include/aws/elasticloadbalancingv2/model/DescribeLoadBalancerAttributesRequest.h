...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeLoadBalancerAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeLoadBalancerAttributesRequest>(GetServiceRequestName(), *this);
    }
