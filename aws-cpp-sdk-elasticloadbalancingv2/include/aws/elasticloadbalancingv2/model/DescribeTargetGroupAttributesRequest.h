...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeTargetGroupAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeTargetGroupAttributesRequest>(GetServiceRequestName(), *this);
    }
