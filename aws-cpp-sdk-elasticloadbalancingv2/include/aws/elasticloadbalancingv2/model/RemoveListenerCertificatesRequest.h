...
namespace Model
{
  ...
  /**
   */
  class AWS_ELASTICLOADBALANCINGV2_API RemoveListenerCertificatesRequest : public ElasticLoadBalancingv2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveListenerCertificatesRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveListenerCertificatesRequest>(GetServiceRequestName(), *this);
    }
