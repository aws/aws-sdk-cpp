...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetBucketIntelligentTieringConfigurationRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketIntelligentTieringConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketIntelligentTieringConfigurationRequest>(GetServiceRequestName(), *this);
    }
