...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetObjectRetentionRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetObjectRetentionRequest> Clone() const
    {
      return Aws::MakeUnique<GetObjectRetentionRequest>(GetServiceRequestName(), *this);
    }
