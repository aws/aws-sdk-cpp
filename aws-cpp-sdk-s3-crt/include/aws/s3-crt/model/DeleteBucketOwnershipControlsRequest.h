...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API DeleteBucketOwnershipControlsRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBucketOwnershipControlsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBucketOwnershipControlsRequest>(GetServiceRequestName(), *this);
    }
