...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetObjectLegalHoldRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetObjectLegalHoldRequest> Clone() const
    {
      return Aws::MakeUnique<GetObjectLegalHoldRequest>(GetServiceRequestName(), *this);
    }
