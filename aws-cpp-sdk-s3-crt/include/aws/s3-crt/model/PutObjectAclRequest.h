...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API PutObjectAclRequest : public S3CrtRequest
  {
  public:
    PutObjectAclRequest();
    ...
    */
    virtual Aws::UniquePtr<PutObjectAclRequest> Clone() const
    {
      return Aws::MakeUnique<PutObjectAclRequest>(GetServiceRequestName(), *this);
    }
