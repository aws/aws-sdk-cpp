...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API ListObjectVersionsRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListObjectVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListObjectVersionsRequest>(GetServiceRequestName(), *this);
    }
