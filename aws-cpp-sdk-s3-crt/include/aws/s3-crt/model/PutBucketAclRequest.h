...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API PutBucketAclRequest : public S3CrtRequest
  {
  public:
    PutBucketAclRequest();
    ...
    */
    virtual Aws::UniquePtr<PutBucketAclRequest> Clone() const
    {
      return Aws::MakeUnique<PutBucketAclRequest>(GetServiceRequestName(), *this);
    }
