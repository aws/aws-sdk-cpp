...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API PutBucketTaggingRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutBucketTaggingRequest> Clone() const
    {
      return Aws::MakeUnique<PutBucketTaggingRequest>(GetServiceRequestName(), *this);
    }
