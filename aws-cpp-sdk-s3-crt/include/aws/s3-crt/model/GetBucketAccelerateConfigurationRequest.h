...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketAccelerateConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketAccelerateConfigurationRequest>(GetServiceRequestName(), *this);
    }
