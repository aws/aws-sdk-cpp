...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API ListMultipartUploadsRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMultipartUploadsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMultipartUploadsRequest>(GetServiceRequestName(), *this);
    }
