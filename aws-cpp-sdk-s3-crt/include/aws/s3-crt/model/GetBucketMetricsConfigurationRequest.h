...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetBucketMetricsConfigurationRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketMetricsConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketMetricsConfigurationRequest>(GetServiceRequestName(), *this);
    }
