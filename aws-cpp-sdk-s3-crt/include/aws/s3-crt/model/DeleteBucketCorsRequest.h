...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API DeleteBucketCorsRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBucketCorsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBucketCorsRequest>(GetServiceRequestName(), *this);
    }
