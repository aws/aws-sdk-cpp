...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetBucketLocationRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketLocationRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketLocationRequest>(GetServiceRequestName(), *this);
    }
