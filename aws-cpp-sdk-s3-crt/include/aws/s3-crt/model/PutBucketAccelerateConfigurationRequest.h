...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API PutBucketAccelerateConfigurationRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutBucketAccelerateConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutBucketAccelerateConfigurationRequest>(GetServiceRequestName(), *this);
    }
