...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API DeleteBucketWebsiteRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBucketWebsiteRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBucketWebsiteRequest>(GetServiceRequestName(), *this);
    }
