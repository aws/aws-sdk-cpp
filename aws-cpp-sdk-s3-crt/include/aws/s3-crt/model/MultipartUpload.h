...
namespace Model
{
  ...
  {
  public:
    AWS_S3CRT_API MultipartUpload();
    AWS_S3CRT_API MultipartUpload(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_S3CRT_API MultipartUpload& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
