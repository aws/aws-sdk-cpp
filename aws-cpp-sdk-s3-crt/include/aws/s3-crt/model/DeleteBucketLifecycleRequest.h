...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API DeleteBucketLifecycleRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBucketLifecycleRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBucketLifecycleRequest>(GetServiceRequestName(), *this);
    }
