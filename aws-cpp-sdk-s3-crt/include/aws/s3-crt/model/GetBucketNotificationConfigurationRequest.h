...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetBucketNotificationConfigurationRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketNotificationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketNotificationConfigurationRequest>(GetServiceRequestName(), *this);
    }
