...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetBucketLoggingRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketLoggingRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketLoggingRequest>(GetServiceRequestName(), *this);
    }
