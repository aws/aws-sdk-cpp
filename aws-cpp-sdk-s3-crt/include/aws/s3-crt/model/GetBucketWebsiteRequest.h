...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetBucketWebsiteRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketWebsiteRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketWebsiteRequest>(GetServiceRequestName(), *this);
    }
