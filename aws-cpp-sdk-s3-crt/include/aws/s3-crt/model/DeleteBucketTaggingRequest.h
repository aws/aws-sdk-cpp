...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API DeleteBucketTaggingRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBucketTaggingRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBucketTaggingRequest>(GetServiceRequestName(), *this);
    }
