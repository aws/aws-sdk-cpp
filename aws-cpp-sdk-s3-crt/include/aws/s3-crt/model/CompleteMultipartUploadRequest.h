...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API CompleteMultipartUploadRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CompleteMultipartUploadRequest> Clone() const
    {
      return Aws::MakeUnique<CompleteMultipartUploadRequest>(GetServiceRequestName(), *this);
    }
