...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API DeleteBucketAnalyticsConfigurationRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBucketAnalyticsConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBucketAnalyticsConfigurationRequest>(GetServiceRequestName(), *this);
    }
