...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API PutObjectLegalHoldRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutObjectLegalHoldRequest> Clone() const
    {
      return Aws::MakeUnique<PutObjectLegalHoldRequest>(GetServiceRequestName(), *this);
    }
