...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API DeleteBucketMetricsConfigurationRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBucketMetricsConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBucketMetricsConfigurationRequest>(GetServiceRequestName(), *this);
    }
