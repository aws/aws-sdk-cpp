...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListBucketIntelligentTieringConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListBucketIntelligentTieringConfigurationsRequest>(GetServiceRequestName(), *this);
    }
