...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API DeleteObjectTaggingRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteObjectTaggingRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteObjectTaggingRequest>(GetServiceRequestName(), *this);
    }
