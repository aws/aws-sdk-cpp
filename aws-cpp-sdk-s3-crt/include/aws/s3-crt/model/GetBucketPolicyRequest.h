...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetBucketPolicyRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketPolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketPolicyRequest>(GetServiceRequestName(), *this);
    }
