...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API HeadBucketRequest : public S3CrtRequest
  {
  public:
    HeadBucketRequest();
    ...
    */
    virtual Aws::UniquePtr<HeadBucketRequest> Clone() const
    {
      return Aws::MakeUnique<HeadBucketRequest>(GetServiceRequestName(), *this);
    }
