...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API DeleteBucketIntelligentTieringConfigurationRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteBucketIntelligentTieringConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteBucketIntelligentTieringConfigurationRequest>(GetServiceRequestName(), *this);
    }
