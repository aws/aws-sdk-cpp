...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetObjectAttributesRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetObjectAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<GetObjectAttributesRequest>(GetServiceRequestName(), *this);
    }
