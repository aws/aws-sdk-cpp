...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API PutBucketVersioningRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutBucketVersioningRequest> Clone() const
    {
      return Aws::MakeUnique<PutBucketVersioningRequest>(GetServiceRequestName(), *this);
    }
