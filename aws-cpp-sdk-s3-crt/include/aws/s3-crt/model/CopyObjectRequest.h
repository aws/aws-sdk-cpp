...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API CopyObjectRequest : public S3CrtRequest
  {
  public:
    CopyObjectRequest();
    ...
    */
    virtual Aws::UniquePtr<CopyObjectRequest> Clone() const
    {
      return Aws::MakeUnique<CopyObjectRequest>(GetServiceRequestName(), *this);
    }
