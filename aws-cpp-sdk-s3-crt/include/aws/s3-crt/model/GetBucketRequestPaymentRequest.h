...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetBucketRequestPaymentRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketRequestPaymentRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketRequestPaymentRequest>(GetServiceRequestName(), *this);
    }
