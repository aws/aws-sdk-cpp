...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetBucketInventoryConfigurationRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketInventoryConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketInventoryConfigurationRequest>(GetServiceRequestName(), *this);
    }
