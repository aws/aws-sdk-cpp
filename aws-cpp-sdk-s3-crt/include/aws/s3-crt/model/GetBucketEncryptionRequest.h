...
namespace Model
{
  ...
  /**
   */
  class AWS_S3CRT_API GetBucketEncryptionRequest : public S3CrtRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBucketEncryptionRequest> Clone() const
    {
      return Aws::MakeUnique<GetBucketEncryptionRequest>(GetServiceRequestName(), *this);
    }
