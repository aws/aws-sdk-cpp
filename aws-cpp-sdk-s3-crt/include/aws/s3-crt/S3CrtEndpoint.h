...
namespace S3CrtEndpoint
{
   ...
   */
  AWS_S3CRT_API Aws::String ForRegion(const Aws::String& regionName, bool useDualStack = false, bool USEast1UseRegionalEndpoint = false);
   ...
   * @param useDualStack Using dual-stack endpoint if true
   */
  AWS_S3CRT_API Aws::String ForAccessPointArn(const S3CrtARN& arn, const Aws::String& regionNameOverride = "", bool useDualStack = false);
   ...
   * @param regionNameOverride Override region name in ARN if it's not empty
   */
  AWS_S3CRT_API Aws::String ForOutpostsArn(const S3CrtARN& arn, const Aws::String& regionNameOverride = "");
} // namespace S3CrtEndpoint
} // namespace S3Crt
} // namespace Aws
