...
namespace S3CrtEndpoint
{
  ...
  Aws::String ForAccessPointArn(const S3CrtARN& arn, const Aws::String& regionNameOverride, bool useDualStack)
  {
  ...
  Aws::String ForOutpostsArn(const S3CrtARN& arn, const Aws::String& regionNameOverride)
  {
    const Aws::String& region = regionNameOverride.empty() ? arn.GetRegion() : regionNameOverride;
    auto hash = Aws::Utils::HashingUtils::HashString(region.c_str());
