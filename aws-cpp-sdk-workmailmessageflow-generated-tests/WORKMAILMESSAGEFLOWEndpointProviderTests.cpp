...
static const char* ALLOCATION_TAG = "AWSWorkMailMessageFlowEndpointProviderTests";
...
using WorkMailMessageFlowResolveEndpointOutcome = Aws::WorkMailMessageFlow::Endpoint::WorkMailMessageFlowEndpointProvider::WorkMailMessageFlowResolveEndpointOutcome;
...
void ValidateOutcome(const WorkMailMessageFlowResolveEndpointOutcome& outcome, const WorkMailMessageFlowEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(WorkMailMessageFlowEndpointProviderTests, EndpointProviderTest)
{
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const WorkMailMessageFlowEndpointProviderEndpointTestCase::OperationParamsFromTest>>
