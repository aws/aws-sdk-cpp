...
using ResolveEndpointOutcome = Aws::DatabaseMigrationService::Endpoint::DatabaseMigrationServiceEndpointProvider::DatabaseMigrationServiceResolveEndpointOutcome;
...
DatabaseMigrationServiceClient::DatabaseMigrationServiceClient(const Client::ClientConfiguration& clientConfiguration,
                                                               std::shared_ptr<Endpoint::DatabaseMigrationServiceEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<DatabaseMigrationServiceErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<DatabaseMigrationService::Endpoint::DatabaseMigrationServiceEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
