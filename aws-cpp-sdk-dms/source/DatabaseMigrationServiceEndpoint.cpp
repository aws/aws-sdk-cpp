  ...
  Aws::String ForRegion(Region region)
  {
    switch(region)
    {
     case Region::US_EAST_1:
        return "dms.us-east-1.amazonaws.com";
     case Region::US_WEST_1:
        return "dms.us-west-1.amazonaws.com";
     case Region::US_WEST_2:
        return "dms.us-west-2.amazonaws.com";
     case Region::EU_WEST_1:
        return "dms.eu-west-1.amazonaws.com";
     case Region::EU_CENTRAL_1:
        return "dms.eu-central-1.amazonaws.com";
     case Region::AP_SOUTHEAST_1:
        return "dms.ap-southeast-1.amazonaws.com";
     case Region::AP_SOUTHEAST_2:
        return "dms.ap-southeast-2.amazonaws.com";
     case Region::AP_NORTHEAST_1:
        return "dms.ap-northeast-1.amazonaws.com";
     case Region::AP_NORTHEAST_2:
        return "dms.ap-northeast-2.amazonaws.com";
     case Region::SA_EAST_1:
        return "dms.sa-east-1.amazonaws.com";
     case Region::AP_SOUTH_1:
        return "dms.ap-south-1.amazonaws.com";
     default:
        return "dms.us-east-1.amazonaws.com";
    }
  }
