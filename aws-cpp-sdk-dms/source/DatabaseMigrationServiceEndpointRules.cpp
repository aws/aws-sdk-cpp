...
Aws::String DatabaseMigrationServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(DatabaseMigrationServiceEndpointRules::Rules.begin(), DatabaseMigrationServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> DatabaseMigrationServiceEndpointRules::Rules = {
...
'p','s',':','/','/','d','m','s','.','u','s','-','i','s','o','b','-','e','a','s','t','-','1','.','s',
...
'h','t','t','p','s',':','/','/','d','m','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
