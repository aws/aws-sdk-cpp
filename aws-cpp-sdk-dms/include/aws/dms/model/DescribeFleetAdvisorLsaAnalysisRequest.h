...
namespace Model
{
  ...
  /**
   */
  class AWS_DATABASEMIGRATIONSERVICE_API DescribeFleetAdvisorLsaAnalysisRequest : public DatabaseMigrationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFleetAdvisorLsaAnalysisRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFleetAdvisorLsaAnalysisRequest>(GetServiceRequestName(), *this);
    }
