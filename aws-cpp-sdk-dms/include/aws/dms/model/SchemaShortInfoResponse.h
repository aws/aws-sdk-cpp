...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DATABASEMIGRATIONSERVICE_API SchemaShortInfoResponse
  {
  public:
    SchemaShortInfoResponse();
    SchemaShortInfoResponse(Aws::Utils::Json::JsonView jsonValue);
    SchemaShortInfoResponse& operator=(Aws::Utils::Json::JsonView jsonValue);
