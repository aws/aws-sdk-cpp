...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteReplicationSubnetGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteReplicationSubnetGroupRequest>(GetServiceRequestName(), *this);
    }
