...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DATABASEMIGRATIONSERVICE_API MoveReplicationTaskRequest : public DatabaseMigrationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<MoveReplicationTaskRequest> Clone() const
    {
      return Aws::MakeUnique<MoveReplicationTaskRequest>(GetServiceRequestName(), *this);
    }
