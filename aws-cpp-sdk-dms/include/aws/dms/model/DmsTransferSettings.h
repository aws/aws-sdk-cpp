...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p> The IAM role that has permission to access the Amazon S3 bucket. When
     * specified as part of request syntax, such as for the <code>CreateEndpoint</code>
     * and <code>ModifyEndpoint</code> actions, the role must allow the
