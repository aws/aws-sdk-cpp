...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DATABASEMIGRATIONSERVICE_API CancelReplicationTaskAssessmentRunRequest : public DatabaseMigrationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelReplicationTaskAssessmentRunRequest> Clone() const
    {
      return Aws::MakeUnique<CancelReplicationTaskAssessmentRunRequest>(GetServiceRequestName(), *this);
    }
