...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFleetAdvisorDatabasesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFleetAdvisorDatabasesRequest>(GetServiceRequestName(), *this);
    }
