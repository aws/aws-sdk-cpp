...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFleetAdvisorCollectorsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFleetAdvisorCollectorsRequest>(GetServiceRequestName(), *this);
    }
