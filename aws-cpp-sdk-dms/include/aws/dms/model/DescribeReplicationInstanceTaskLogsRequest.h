...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReplicationInstanceTaskLogsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReplicationInstanceTaskLogsRequest>(GetServiceRequestName(), *this);
    }
