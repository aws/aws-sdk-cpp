...
namespace Model
{
  ...
  public:
    ...
    ReplicationPendingModifiedValues(const Aws::Utils::Json::JsonValue& jsonValue);
     ...
     * instance. </p>
     */
    inline ReplicationPendingModifiedValues& WithAllocatedStorage(long value) { SetAllocatedStorage(value); return *this;}
