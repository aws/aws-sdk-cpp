...
namespace Model
{
  ...
  /**
   */
  class AWS_DATABASEMIGRATIONSERVICE_API DescribeFleetAdvisorSchemaObjectSummaryRequest : public DatabaseMigrationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFleetAdvisorSchemaObjectSummaryRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFleetAdvisorSchemaObjectSummaryRequest>(GetServiceRequestName(), *this);
    }
