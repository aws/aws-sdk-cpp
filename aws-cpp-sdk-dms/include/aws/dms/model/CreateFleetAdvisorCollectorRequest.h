...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateFleetAdvisorCollectorRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFleetAdvisorCollectorRequest>(GetServiceRequestName(), *this);
    }
