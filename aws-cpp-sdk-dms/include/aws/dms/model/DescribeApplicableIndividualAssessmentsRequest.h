...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeApplicableIndividualAssessmentsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeApplicableIndividualAssessmentsRequest>(GetServiceRequestName(), *this);
    }
