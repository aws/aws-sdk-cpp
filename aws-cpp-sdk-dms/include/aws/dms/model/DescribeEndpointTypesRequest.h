...
namespace Model
{
  ...
  public:
     ...
     * engine-name | endpoint-type</p>
     */
    inline DescribeEndpointTypesRequest& WithFilters(Aws::Vector<Filter>&& value) { SetFilters(value); return *this;}
     ...
     * engine-name | endpoint-type</p>
     */
    inline DescribeEndpointTypesRequest& AddFilters(Filter&& value) { m_filtersHasBeenSet = true; m_filters.push_back(value); return *this; }
     ...
     * retrieved. </p> <p>Default: 100</p> <p>Constraints: Minimum 20, maximum 100.</p>
     */
    inline DescribeEndpointTypesRequest& WithMaxRecords(long value) { SetMaxRecords(value); return *this;}
     ...
     * to the value specified by <code>MaxRecords</code>. </p>
     */
    inline DescribeEndpointTypesRequest& WithMarker(Aws::String&& value) { SetMarker(value); return *this;}
