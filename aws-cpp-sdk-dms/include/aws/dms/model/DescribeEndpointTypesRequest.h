...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEndpointTypesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEndpointTypesRequest>(GetServiceRequestName(), *this);
    }
    ...
    /**
     * <p>Filters applied to the endpoint types.</p> <p>Valid filter names: engine-name
     * | endpoint-type</p>
     */
