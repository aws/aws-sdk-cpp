...
namespace Model
{
  ...
  /**
   */
  class AWS_DATABASEMIGRATIONSERVICE_API DeleteFleetAdvisorCollectorRequest : public DatabaseMigrationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFleetAdvisorCollectorRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFleetAdvisorCollectorRequest>(GetServiceRequestName(), *this);
    }
