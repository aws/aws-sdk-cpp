...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ModifyReplicationSubnetGroupRequest> Clone() const
    {
      return Aws::MakeUnique<ModifyReplicationSubnetGroupRequest>(GetServiceRequestName(), *this);
    }
