...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DATABASEMIGRATIONSERVICE_API DeleteReplicationTaskAssessmentRunRequest : public DatabaseMigrationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteReplicationTaskAssessmentRunRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteReplicationTaskAssessmentRunRequest>(GetServiceRequestName(), *this);
    }
