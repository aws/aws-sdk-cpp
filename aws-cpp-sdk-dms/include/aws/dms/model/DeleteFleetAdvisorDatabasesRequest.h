...
namespace Model
{
  ...
  /**
   */
  class AWS_DATABASEMIGRATIONSERVICE_API DeleteFleetAdvisorDatabasesRequest : public DatabaseMigrationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteFleetAdvisorDatabasesRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteFleetAdvisorDatabasesRequest>(GetServiceRequestName(), *this);
    }
