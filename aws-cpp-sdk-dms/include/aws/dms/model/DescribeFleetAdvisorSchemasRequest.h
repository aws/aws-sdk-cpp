...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFleetAdvisorSchemasRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFleetAdvisorSchemasRequest>(GetServiceRequestName(), *this);
    }
