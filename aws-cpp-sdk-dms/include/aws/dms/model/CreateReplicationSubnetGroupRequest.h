...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateReplicationSubnetGroupRequest> Clone() const
    {
      return Aws::MakeUnique<CreateReplicationSubnetGroupRequest>(GetServiceRequestName(), *this);
    }
