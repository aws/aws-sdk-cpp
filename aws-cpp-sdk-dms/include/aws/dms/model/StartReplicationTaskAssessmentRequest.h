...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartReplicationTaskAssessmentRequest> Clone() const
    {
      return Aws::MakeUnique<StartReplicationTaskAssessmentRequest>(GetServiceRequestName(), *this);
    }
