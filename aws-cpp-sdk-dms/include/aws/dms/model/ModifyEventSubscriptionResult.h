...
namespace Model
{
  ...
  public:
    ...
    ModifyEventSubscriptionResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ModifyEventSubscriptionResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
