...
namespace Model
{
  ...
  /**
   */
  class AWS_DATABASEMIGRATIONSERVICE_API DescribeCertificatesRequest : public DatabaseMigrationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeCertificatesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeCertificatesRequest>(GetServiceRequestName(), *this);
    }
