...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The name of the AWS DMS event notification subscription. This name must be
     ...
     * <p>If you specify multiple values, they must be of the same type. For example,
     * if you specify a database instance ID, then all of the other values must be
     * database instance IDs.</p>
     */
