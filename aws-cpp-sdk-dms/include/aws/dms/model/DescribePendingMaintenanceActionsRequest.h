...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DATABASEMIGRATIONSERVICE_API DescribePendingMaintenanceActionsRequest : public DatabaseMigrationServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePendingMaintenanceActionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePendingMaintenanceActionsRequest>(GetServiceRequestName(), *this);
    }
