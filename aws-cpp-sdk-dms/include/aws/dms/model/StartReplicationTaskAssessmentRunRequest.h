...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartReplicationTaskAssessmentRunRequest> Clone() const
    {
      return Aws::MakeUnique<StartReplicationTaskAssessmentRunRequest>(GetServiceRequestName(), *this);
    }
