...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeReplicationTaskAssessmentResultsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeReplicationTaskAssessmentResultsRequest>(GetServiceRequestName(), *this);
    }
