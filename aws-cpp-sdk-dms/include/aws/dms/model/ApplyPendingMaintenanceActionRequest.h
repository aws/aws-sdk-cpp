...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ApplyPendingMaintenanceActionRequest> Clone() const
    {
      return Aws::MakeUnique<ApplyPendingMaintenanceActionRequest>(GetServiceRequestName(), *this);
    }
