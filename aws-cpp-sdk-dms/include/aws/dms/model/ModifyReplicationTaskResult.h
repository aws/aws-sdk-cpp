...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DATABASEMIGRATIONSERVICE_API ModifyReplicationTaskResult
  {
  public:
    ModifyReplicationTaskResult();
    ModifyReplicationTaskResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ModifyReplicationTaskResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p>The replication task that was modified.</p>
     */
    inline ModifyReplicationTaskResult& WithReplicationTask(ReplicationTask&& value) { SetReplicationTask(value); return *this;}
