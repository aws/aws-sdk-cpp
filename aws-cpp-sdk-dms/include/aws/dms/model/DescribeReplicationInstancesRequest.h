...
namespace Model
{
  ...
  public:
     ...
     * retrieved. </p> <p>Default: 100</p> <p>Constraints: Minimum 20, maximum 100.</p>
     */
    inline DescribeReplicationInstancesRequest& WithMaxRecords(long value) { SetMaxRecords(value); return *this;}
     ...
     * to the value specified by <code>MaxRecords</code>. </p>
     */
    inline DescribeReplicationInstancesRequest& WithMarker(Aws::String&& value) { SetMarker(value); return *this;}
