...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/TestConnectionMessage">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<TestConnectionRequest> Clone() const
    {
      return Aws::MakeUnique<TestConnectionRequest>(GetServiceRequestName(), *this);
    }
