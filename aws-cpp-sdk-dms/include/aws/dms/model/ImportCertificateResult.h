...
namespace Model
{
  class AWS_DATABASEMIGRATIONSERVICE_API ImportCertificateResult
  {
  public:
     ...
     * <p>The certificate to be uploaded.</p>
     */
    inline ImportCertificateResult& WithCertificate(Certificate&& value) { SetCertificate(value); return *this;}
