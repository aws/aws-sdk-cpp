...
namespace DatabaseMigrationService
{
  ...
  class AWS_DATABASEMIGRATIONSERVICE_API DatabaseMigrationServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DatabaseMigrationServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                       std::shared_ptr<Endpoint::DatabaseMigrationServiceEndpointProvider> endpointProvider = Aws::MakeShared<DatabaseMigrationService::Endpoint::DatabaseMigrationServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DatabaseMigrationServiceEndpointProvider> m_endpointProvider;
  };
