...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/redshiftserverless-2021-04-21/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class AWS_REDSHIFTSERVERLESS_API ResourceNotFoundException
  {
  public:
