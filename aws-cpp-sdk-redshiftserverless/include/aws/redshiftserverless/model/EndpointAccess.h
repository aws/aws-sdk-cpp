...
#include <aws/redshiftserverless/model/VpcSecurityGroupMembership.h>
#include <utility>
...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/redshiftserverless-2021-04-21/EndpointAccess">AWS
   * API Reference</a></p>
   */
