...
#include <aws/redshiftserverless/model/LogExport.h>
#include <utility>
...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFTSERVERLESS_API UpdateNamespaceRequest : public RedshiftServerlessRequest
  {
  public:
  ...
  private:
    ...
    bool m_adminUserPasswordHasBeenSet;
