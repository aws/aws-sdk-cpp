...
namespace Model
{
  ...
  /**
   */
  class AWS_CONTROLTOWER_API GetControlOperationRequest : public ControlTowerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetControlOperationRequest> Clone() const
    {
      return Aws::MakeUnique<GetControlOperationRequest>(GetServiceRequestName(), *this);
    }
