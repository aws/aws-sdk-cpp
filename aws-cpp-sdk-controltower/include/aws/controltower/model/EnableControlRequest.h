...
namespace Model
{
  ...
  /**
   */
  class AWS_CONTROLTOWER_API EnableControlRequest : public ControlTowerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<EnableControlRequest> Clone() const
    {
      return Aws::MakeUnique<EnableControlRequest>(GetServiceRequestName(), *this);
    }
