  ...
  class AWS_CONTROLTOWER_API ControlTowerClient : public Aws::Client::AWSJsonClient
  {
    public:
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ControlTowerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::ControlTowerEndpointProvider> endpointProvider = Aws::MakeShared<ControlTower::Endpoint::ControlTowerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ControlTowerEndpointProvider> m_endpointProvider;
  };
