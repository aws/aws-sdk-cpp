...
Aws::String ControlTowerEndpointRules::GetRulesAsString()
{
    return Aws::String(ControlTowerEndpointRules::Rules.begin(), ControlTowerEndpointRules::Rules.end());
}

const Aws::Vector<char> ControlTowerEndpointRules::Rules = {
...
'p','s',':','/','/','c','o','n','t','r','o','l','t','o','w','e','r','-','f','i','p','s','.','{','R',
...
'o','n','t','r','o','l','t','o','w','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
