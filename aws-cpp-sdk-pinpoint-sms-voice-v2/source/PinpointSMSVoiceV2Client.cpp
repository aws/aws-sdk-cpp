...
using ResolveEndpointOutcome = Aws::PinpointSMSVoiceV2::Endpoint::PinpointSMSVoiceV2EndpointProvider::PinpointSMSVoiceV2ResolveEndpointOutcome;
...
PinpointSMSVoiceV2Client::PinpointSMSVoiceV2Client(const Client::ClientConfiguration& clientConfiguration,
                                                   std::shared_ptr<Endpoint::PinpointSMSVoiceV2EndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<PinpointSMSVoiceV2ErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<PinpointSMSVoiceV2::Endpoint::PinpointSMSVoiceV2EndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
