...
namespace PinpointSMSVoiceV2
{
  ...
  class AWS_PINPOINTSMSVOICEV2_API PinpointSMSVoiceV2Client : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        PinpointSMSVoiceV2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                 std::shared_ptr<Endpoint::PinpointSMSVoiceV2EndpointProvider> endpointProvider = Aws::MakeShared<PinpointSMSVoiceV2::Endpoint::PinpointSMSVoiceV2EndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::PinpointSMSVoiceV2EndpointProvider> m_endpointProvider;
  };
