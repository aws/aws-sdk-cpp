...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API DescribeSenderIdsRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSenderIdsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSenderIdsRequest>(GetServiceRequestName(), *this);
    }
