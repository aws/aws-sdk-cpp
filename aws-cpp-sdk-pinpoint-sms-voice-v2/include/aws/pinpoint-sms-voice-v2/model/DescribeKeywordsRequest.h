...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API DescribeKeywordsRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeKeywordsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeKeywordsRequest>(GetServiceRequestName(), *this);
    }
