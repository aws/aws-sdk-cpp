...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API DeleteOptedOutNumberRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteOptedOutNumberRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteOptedOutNumberRequest>(GetServiceRequestName(), *this);
    }
