...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API CreateOptOutListRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateOptOutListRequest> Clone() const
    {
      return Aws::MakeUnique<CreateOptOutListRequest>(GetServiceRequestName(), *this);
    }
