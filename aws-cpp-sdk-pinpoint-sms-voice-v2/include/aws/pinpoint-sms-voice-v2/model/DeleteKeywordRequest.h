...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API DeleteKeywordRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteKeywordRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteKeywordRequest>(GetServiceRequestName(), *this);
    }
