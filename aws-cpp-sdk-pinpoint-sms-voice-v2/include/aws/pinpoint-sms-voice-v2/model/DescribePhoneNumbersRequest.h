...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API DescribePhoneNumbersRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePhoneNumbersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePhoneNumbersRequest>(GetServiceRequestName(), *this);
    }
