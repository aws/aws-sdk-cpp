...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API AssociateOriginationIdentityRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateOriginationIdentityRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateOriginationIdentityRequest>(GetServiceRequestName(), *this);
    }
