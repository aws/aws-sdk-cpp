...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API DisassociateOriginationIdentityRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateOriginationIdentityRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateOriginationIdentityRequest>(GetServiceRequestName(), *this);
    }
