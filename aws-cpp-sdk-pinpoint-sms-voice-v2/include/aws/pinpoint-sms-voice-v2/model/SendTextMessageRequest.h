...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API SendTextMessageRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SendTextMessageRequest> Clone() const
    {
      return Aws::MakeUnique<SendTextMessageRequest>(GetServiceRequestName(), *this);
    }
