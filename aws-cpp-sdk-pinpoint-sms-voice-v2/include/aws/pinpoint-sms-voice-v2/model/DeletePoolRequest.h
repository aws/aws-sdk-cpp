...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API DeletePoolRequest : public PinpointSMSVoiceV2Request
  {
  public:
    DeletePoolRequest();
    ...
    */
    virtual Aws::UniquePtr<DeletePoolRequest> Clone() const
    {
      return Aws::MakeUnique<DeletePoolRequest>(GetServiceRequestName(), *this);
    }
