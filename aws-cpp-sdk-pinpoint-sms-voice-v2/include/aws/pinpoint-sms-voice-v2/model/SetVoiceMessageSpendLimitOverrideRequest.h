...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API SetVoiceMessageSpendLimitOverrideRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SetVoiceMessageSpendLimitOverrideRequest> Clone() const
    {
      return Aws::MakeUnique<SetVoiceMessageSpendLimitOverrideRequest>(GetServiceRequestName(), *this);
    }
