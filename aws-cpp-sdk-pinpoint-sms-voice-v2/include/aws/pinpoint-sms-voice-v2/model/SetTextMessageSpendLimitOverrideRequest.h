...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API SetTextMessageSpendLimitOverrideRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SetTextMessageSpendLimitOverrideRequest> Clone() const
    {
      return Aws::MakeUnique<SetTextMessageSpendLimitOverrideRequest>(GetServiceRequestName(), *this);
    }
