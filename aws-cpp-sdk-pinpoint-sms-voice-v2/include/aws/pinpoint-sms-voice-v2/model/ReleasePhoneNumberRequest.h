...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API ReleasePhoneNumberRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ReleasePhoneNumberRequest> Clone() const
    {
      return Aws::MakeUnique<ReleasePhoneNumberRequest>(GetServiceRequestName(), *this);
    }
