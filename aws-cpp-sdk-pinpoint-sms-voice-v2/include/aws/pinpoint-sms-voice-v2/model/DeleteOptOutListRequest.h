...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API DeleteOptOutListRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteOptOutListRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteOptOutListRequest>(GetServiceRequestName(), *this);
    }
