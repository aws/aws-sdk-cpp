...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API DescribeConfigurationSetsRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConfigurationSetsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConfigurationSetsRequest>(GetServiceRequestName(), *this);
    }
