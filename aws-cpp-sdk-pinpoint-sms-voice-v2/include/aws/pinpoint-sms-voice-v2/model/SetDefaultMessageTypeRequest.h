...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API SetDefaultMessageTypeRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SetDefaultMessageTypeRequest> Clone() const
    {
      return Aws::MakeUnique<SetDefaultMessageTypeRequest>(GetServiceRequestName(), *this);
    }
