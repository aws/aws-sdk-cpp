...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API ListPoolOriginationIdentitiesRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPoolOriginationIdentitiesRequest> Clone() const
    {
      return Aws::MakeUnique<ListPoolOriginationIdentitiesRequest>(GetServiceRequestName(), *this);
    }
