...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API CreateEventDestinationRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateEventDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateEventDestinationRequest>(GetServiceRequestName(), *this);
    }
