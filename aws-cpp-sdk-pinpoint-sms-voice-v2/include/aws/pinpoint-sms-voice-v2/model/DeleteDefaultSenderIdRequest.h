...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API DeleteDefaultSenderIdRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDefaultSenderIdRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDefaultSenderIdRequest>(GetServiceRequestName(), *this);
    }
