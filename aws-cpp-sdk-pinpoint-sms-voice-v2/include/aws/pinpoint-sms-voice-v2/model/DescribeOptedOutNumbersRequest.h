...
namespace Model
{
  ...
  /**
   */
  class AWS_PINPOINTSMSVOICEV2_API DescribeOptedOutNumbersRequest : public PinpointSMSVoiceV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOptedOutNumbersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOptedOutNumbersRequest>(GetServiceRequestName(), *this);
    }
