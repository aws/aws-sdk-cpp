...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_PINPOINTSMSVOICEV2_API ConfigurationSetFilter
  {
  public:
    ConfigurationSetFilter();
    ConfigurationSetFilter(Aws::Utils::Json::JsonView jsonValue);
    ConfigurationSetFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
