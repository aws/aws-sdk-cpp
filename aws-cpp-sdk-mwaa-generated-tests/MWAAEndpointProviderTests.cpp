...
using MWAAResolveEndpointOutcome = Aws::MWAA::Endpoint::MWAAEndpointProvider::MWAAResolveEndpointOutcome;
...
void ValidateOutcome(const MWAAResolveEndpointOutcome& outcome, const MWAAEndpointProviderEndpointTestCase::Expect& expect)
{
