...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API DeleteMobileDeviceAccessOverrideRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteMobileDeviceAccessOverrideRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteMobileDeviceAccessOverrideRequest>(GetServiceRequestName(), *this);
    }
