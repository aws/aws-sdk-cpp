...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API GetMailboxDetailsRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMailboxDetailsRequest> Clone() const
    {
      return Aws::MakeUnique<GetMailboxDetailsRequest>(GetServiceRequestName(), *this);
    }
