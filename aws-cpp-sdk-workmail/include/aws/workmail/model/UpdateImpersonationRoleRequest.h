...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API UpdateImpersonationRoleRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateImpersonationRoleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateImpersonationRoleRequest>(GetServiceRequestName(), *this);
    }
