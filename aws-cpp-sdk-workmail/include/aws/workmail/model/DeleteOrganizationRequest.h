...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API DeleteOrganizationRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteOrganizationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteOrganizationRequest>(GetServiceRequestName(), *this);
    }
