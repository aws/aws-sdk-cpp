...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API UpdateDefaultMailDomainRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDefaultMailDomainRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDefaultMailDomainRequest>(GetServiceRequestName(), *this);
    }
