...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API UpdateMobileDeviceAccessRuleRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateMobileDeviceAccessRuleRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateMobileDeviceAccessRuleRequest>(GetServiceRequestName(), *this);
    }
