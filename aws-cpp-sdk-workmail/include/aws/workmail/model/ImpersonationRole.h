...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WORKMAIL_API ImpersonationRole
  {
  public:
    ImpersonationRole();
    ImpersonationRole(Aws::Utils::Json::JsonView jsonValue);
    ImpersonationRole& operator=(Aws::Utils::Json::JsonView jsonValue);
