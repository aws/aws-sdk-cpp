...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutEmailMonitoringConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<PutEmailMonitoringConfigurationRequest>(GetServiceRequestName(), *this);
    }
