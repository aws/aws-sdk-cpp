...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API TestAvailabilityConfigurationRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<TestAvailabilityConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<TestAvailabilityConfigurationRequest>(GetServiceRequestName(), *this);
    }
