...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMobileDeviceAccessOverrideRequest> Clone() const
    {
      return Aws::MakeUnique<GetMobileDeviceAccessOverrideRequest>(GetServiceRequestName(), *this);
    }
