...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API ListImpersonationRolesRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListImpersonationRolesRequest> Clone() const
    {
      return Aws::MakeUnique<ListImpersonationRolesRequest>(GetServiceRequestName(), *this);
    }
