...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API DescribeMailboxExportJobRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMailboxExportJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMailboxExportJobRequest>(GetServiceRequestName(), *this);
    }
