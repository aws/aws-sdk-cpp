...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API DeleteMobileDeviceAccessRuleRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteMobileDeviceAccessRuleRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteMobileDeviceAccessRuleRequest>(GetServiceRequestName(), *this);
    }
