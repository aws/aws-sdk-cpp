...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API CancelMailboxExportJobRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelMailboxExportJobRequest> Clone() const
    {
      return Aws::MakeUnique<CancelMailboxExportJobRequest>(GetServiceRequestName(), *this);
    }
