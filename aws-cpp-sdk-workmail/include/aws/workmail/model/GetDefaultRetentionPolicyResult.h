...
namespace Model
{
  class AWS_WORKMAIL_API GetDefaultRetentionPolicyResult
  {
  public:
    ...
    GetDefaultRetentionPolicyResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
