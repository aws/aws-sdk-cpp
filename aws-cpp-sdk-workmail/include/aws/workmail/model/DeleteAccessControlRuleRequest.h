...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API DeleteAccessControlRuleRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAccessControlRuleRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAccessControlRuleRequest>(GetServiceRequestName(), *this);
    }
