...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API DescribeResourceRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeResourceRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeResourceRequest>(GetServiceRequestName(), *this);
    }
