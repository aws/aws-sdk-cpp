...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API CreateImpersonationRoleRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateImpersonationRoleRequest> Clone() const
    {
      return Aws::MakeUnique<CreateImpersonationRoleRequest>(GetServiceRequestName(), *this);
    }
