...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateMemberFromGroupRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateMemberFromGroupRequest>(GetServiceRequestName(), *this);
    }
