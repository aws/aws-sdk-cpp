...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMobileDeviceAccessRulesRequest> Clone() const
    {
      return Aws::MakeUnique<ListMobileDeviceAccessRulesRequest>(GetServiceRequestName(), *this);
    }
