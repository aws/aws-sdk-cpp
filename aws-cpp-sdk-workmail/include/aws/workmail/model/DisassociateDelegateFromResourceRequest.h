...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateDelegateFromResourceRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateDelegateFromResourceRequest>(GetServiceRequestName(), *this);
    }
