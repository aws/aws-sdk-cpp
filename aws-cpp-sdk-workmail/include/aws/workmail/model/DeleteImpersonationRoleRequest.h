...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API DeleteImpersonationRoleRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteImpersonationRoleRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteImpersonationRoleRequest>(GetServiceRequestName(), *this);
    }
