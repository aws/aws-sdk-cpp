...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API UpdateAvailabilityConfigurationRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAvailabilityConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAvailabilityConfigurationRequest>(GetServiceRequestName(), *this);
    }
