...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API GetMobileDeviceAccessEffectRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetMobileDeviceAccessEffectRequest> Clone() const
    {
      return Aws::MakeUnique<GetMobileDeviceAccessEffectRequest>(GetServiceRequestName(), *this);
    }
