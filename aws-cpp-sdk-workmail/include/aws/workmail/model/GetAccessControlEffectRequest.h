...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API GetAccessControlEffectRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAccessControlEffectRequest> Clone() const
    {
      return Aws::MakeUnique<GetAccessControlEffectRequest>(GetServiceRequestName(), *this);
    }
