...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateMobileDeviceAccessRuleRequest> Clone() const
    {
      return Aws::MakeUnique<CreateMobileDeviceAccessRuleRequest>(GetServiceRequestName(), *this);
    }
