...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API AssumeImpersonationRoleRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<AssumeImpersonationRoleRequest> Clone() const
    {
      return Aws::MakeUnique<AssumeImpersonationRoleRequest>(GetServiceRequestName(), *this);
    }
