...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API PutInboundDmarcSettingsRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutInboundDmarcSettingsRequest> Clone() const
    {
      return Aws::MakeUnique<PutInboundDmarcSettingsRequest>(GetServiceRequestName(), *this);
    }
