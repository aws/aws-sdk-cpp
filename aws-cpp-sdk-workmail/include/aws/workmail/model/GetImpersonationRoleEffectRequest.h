...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API GetImpersonationRoleEffectRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetImpersonationRoleEffectRequest> Clone() const
    {
      return Aws::MakeUnique<GetImpersonationRoleEffectRequest>(GetServiceRequestName(), *this);
    }
