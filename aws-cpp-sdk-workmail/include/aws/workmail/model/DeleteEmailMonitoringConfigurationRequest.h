...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API DeleteEmailMonitoringConfigurationRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEmailMonitoringConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEmailMonitoringConfigurationRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DeleteEmailMonitoringConfiguration"; }
