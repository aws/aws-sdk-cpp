...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateDelegateToResourceRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateDelegateToResourceRequest>(GetServiceRequestName(), *this);
    }
