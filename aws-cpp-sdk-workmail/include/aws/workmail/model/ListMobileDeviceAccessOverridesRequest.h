...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API ListMobileDeviceAccessOverridesRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMobileDeviceAccessOverridesRequest> Clone() const
    {
      return Aws::MakeUnique<ListMobileDeviceAccessOverridesRequest>(GetServiceRequestName(), *this);
    }
