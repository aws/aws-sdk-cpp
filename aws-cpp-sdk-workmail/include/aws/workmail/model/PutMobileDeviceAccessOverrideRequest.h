...
namespace Model
{
  ...
  /**
   */
  class AWS_WORKMAIL_API PutMobileDeviceAccessOverrideRequest : public WorkMailRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutMobileDeviceAccessOverrideRequest> Clone() const
    {
      return Aws::MakeUnique<PutMobileDeviceAccessOverrideRequest>(GetServiceRequestName(), *this);
    }
