...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateAvailabilityConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<CreateAvailabilityConfigurationRequest>(GetServiceRequestName(), *this);
    }
