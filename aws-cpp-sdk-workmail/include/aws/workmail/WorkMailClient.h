...
namespace WorkMail
{
  ...
  class AWS_WORKMAIL_API WorkMailClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        WorkMailClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                       std::shared_ptr<Endpoint::WorkMailEndpointProvider> endpointProvider = Aws::MakeShared<WorkMail::Endpoint::WorkMailEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::WorkMailEndpointProvider> m_endpointProvider;
  };
