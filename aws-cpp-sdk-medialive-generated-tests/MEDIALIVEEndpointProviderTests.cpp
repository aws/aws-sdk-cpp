...
static const char* ALLOCATION_TAG = "AWSMediaLiveEndpointProviderTests";
using MediaLiveEndpointProvider = Aws::MediaLive::Endpoint::MediaLiveEndpointProvider;
using EndpointParameters = Aws::Vector<Aws::Endpoint::EndpointParameter>;
using MediaLiveResolveEndpointOutcome = Aws::MediaLive::Endpoint::MediaLiveEndpointProvider::MediaLiveResolveEndpointOutcome;
...
class MediaLiveEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct MediaLiveEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<MediaLiveEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
  ...
  {"For region us-iso-east-1 with FIPS enabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://medialive-fips.us-iso-east-1.c2s.ic.gov",
       {/*properties*/},
  ...
  {"For region us-iso-east-1 with FIPS disabled and DualStack disabled", // documentation
    ...
    {}, // tags
    {{/*epUrl*/"https://medialive.us-iso-east-1.c2s.ic.gov",
       {/*properties*/},
       {/*headers*/}}, {/*No error*/}}, // expect
    {} // operationInput
  },
...
void ValidateOutcome(const MediaLiveResolveEndpointOutcome& outcome, const MediaLiveEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(MediaLiveEndpointProviderTests, EndpointProviderTest)
{
    ...
    const MediaLiveEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<MediaLiveEndpointProvider> endpointProvider = Aws::MakeShared<MediaLiveEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize MediaLiveEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const MediaLiveEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         MediaLiveEndpointProviderTests,
