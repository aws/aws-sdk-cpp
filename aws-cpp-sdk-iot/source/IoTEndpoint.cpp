  ...
  Aws::String ForRegion(Region region)
  {
    switch(region)
    {
     ...
     case Region::US_WEST_1:
        return "iot.us-west-1.amazonaws.com";
     case Region::US_WEST_2:
        return "iot.us-west-2.amazonaws.com";
     case Region::EU_WEST_1:
        return "iot.eu-west-1.amazonaws.com";
     case Region::EU_CENTRAL_1:
        return "iot.eu-central-1.amazonaws.com";
     case Region::AP_SOUTHEAST_1:
        return "iot.ap-southeast-1.amazonaws.com";
     case Region::AP_SOUTHEAST_2:
        return "iot.ap-southeast-2.amazonaws.com";
     case Region::AP_NORTHEAST_1:
        return "iot.ap-northeast-1.amazonaws.com";
