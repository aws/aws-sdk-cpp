...
namespace IoT
{
const size_t IoTEndpointRules::RulesBlobStrLen = 3441;
const size_t IoTEndpointRules::RulesBlobSize = 3442;

using RulesBlobT = Aws::Array<const char, IoTEndpointRules::RulesBlobSize>;
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','i','o','t','.','{','R','e','g','i','o','n',
...
const char* IoTEndpointRules::GetRulesBlob()
{
