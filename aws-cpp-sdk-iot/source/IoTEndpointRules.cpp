...
Aws::String IoTEndpointRules::GetRulesAsString()
{
    return Aws::String(IoTEndpointRules::Rules.begin(), IoTEndpointRules::Rules.end());
}

const Aws::Vector<char> IoTEndpointRules::Rules = {
