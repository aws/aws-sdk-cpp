...
ListPoliciesResult::ListPoliciesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListPoliciesResult& ListPoliciesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
