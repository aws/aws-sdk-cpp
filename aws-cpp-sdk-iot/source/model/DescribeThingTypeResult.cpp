...
DescribeThingTypeResult::DescribeThingTypeResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeThingTypeResult& DescribeThingTypeResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
