...
Aws::String ListPrincipalPoliciesRequest::SerializePayload() const
{
  return "";
}

Aws::Http::HeaderValueCollection ListPrincipalPoliciesRequest::GetRequestSpecificHeaders() const
{
...
void ListPrincipalPoliciesRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
