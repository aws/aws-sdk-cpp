...
ListCACertificatesResult::ListCACertificatesResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListCACertificatesResult& ListCACertificatesResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
