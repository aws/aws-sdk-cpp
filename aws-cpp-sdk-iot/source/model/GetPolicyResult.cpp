...
GetPolicyResult::GetPolicyResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetPolicyResult& GetPolicyResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
