...
Aws::String ListTargetsForSecurityProfileRequest::SerializePayload() const
{
  return {};
}

void ListTargetsForSecurityProfileRequest::AddQueryStringParameters(URI& uri) const
{
    Aws::StringStream ss;
