...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API RegisterCertificateWithoutCARequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RegisterCertificateWithoutCARequest> Clone() const
    {
      return Aws::MakeUnique<RegisterCertificateWithoutCARequest>(GetServiceRequestName(), *this);
    }
