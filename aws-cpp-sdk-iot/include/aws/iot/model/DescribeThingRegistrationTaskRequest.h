...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeThingRegistrationTaskRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeThingRegistrationTaskRequest>(GetServiceRequestName(), *this);
    }
