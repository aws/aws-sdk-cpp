...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DeleteJobTemplateRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteJobTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteJobTemplateRequest>(GetServiceRequestName(), *this);
    }
