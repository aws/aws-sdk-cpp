...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListProvisioningTemplateVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListProvisioningTemplateVersionsRequest>(GetServiceRequestName(), *this);
    }
