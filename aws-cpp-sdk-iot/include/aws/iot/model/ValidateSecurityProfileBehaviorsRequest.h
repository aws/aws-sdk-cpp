...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ValidateSecurityProfileBehaviorsRequest> Clone() const
    {
      return Aws::MakeUnique<ValidateSecurityProfileBehaviorsRequest>(GetServiceRequestName(), *this);
    }
