...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartDetectMitigationActionsTaskRequest> Clone() const
    {
      return Aws::MakeUnique<StartDetectMitigationActionsTaskRequest>(GetServiceRequestName(), *this);
    }
