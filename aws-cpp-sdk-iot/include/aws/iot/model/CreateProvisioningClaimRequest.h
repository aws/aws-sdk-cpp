...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API CreateProvisioningClaimRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateProvisioningClaimRequest> Clone() const
    {
      return Aws::MakeUnique<CreateProvisioningClaimRequest>(GetServiceRequestName(), *this);
    }
