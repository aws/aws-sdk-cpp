...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_IOT_API ListOutgoingCertificatesRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListOutgoingCertificatesRequest> Clone() const
    {
      return Aws::MakeUnique<ListOutgoingCertificatesRequest>(GetServiceRequestName(), *this);
    }
