...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteProvisioningTemplateVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteProvisioningTemplateVersionRequest>(GetServiceRequestName(), *this);
    }
