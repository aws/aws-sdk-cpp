...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListAuditMitigationActionsExecutionsRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAuditMitigationActionsExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAuditMitigationActionsExecutionsRequest>(GetServiceRequestName(), *this);
    }
