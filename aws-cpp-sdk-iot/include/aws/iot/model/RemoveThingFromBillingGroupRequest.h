...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveThingFromBillingGroupRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveThingFromBillingGroupRequest>(GetServiceRequestName(), *this);
    }
