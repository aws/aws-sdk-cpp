...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_IOT_API DeleteRegistrationCodeRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRegistrationCodeRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRegistrationCodeRequest>(GetServiceRequestName(), *this);
    }
