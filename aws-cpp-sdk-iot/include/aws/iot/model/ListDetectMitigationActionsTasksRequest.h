...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListDetectMitigationActionsTasksRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDetectMitigationActionsTasksRequest> Clone() const
    {
      return Aws::MakeUnique<ListDetectMitigationActionsTasksRequest>(GetServiceRequestName(), *this);
    }
