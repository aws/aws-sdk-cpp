...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DescribeAuditSuppressionRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAuditSuppressionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAuditSuppressionRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DescribeAuditSuppression"; }
