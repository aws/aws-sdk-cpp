...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DeleteRoleAliasRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRoleAliasRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRoleAliasRequest>(GetServiceRequestName(), *this);
    }
