...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API CreateProvisioningTemplateRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateProvisioningTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<CreateProvisioningTemplateRequest>(GetServiceRequestName(), *this);
    }
