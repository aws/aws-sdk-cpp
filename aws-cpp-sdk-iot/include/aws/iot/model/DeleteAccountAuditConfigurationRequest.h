...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DeleteAccountAuditConfigurationRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAccountAuditConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAccountAuditConfigurationRequest>(GetServiceRequestName(), *this);
    }
