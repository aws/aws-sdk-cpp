...
namespace Model
{
   ...
   */
  class AWS_IOT_API GetPolicyVersionRequest : public IoTRequest
  {
  public:
     ...
     * <p>The name of the policy.</p>
     */
    inline GetPolicyVersionRequest& WithPolicyName(Aws::String&& value) { SetPolicyName(value); return *this;}
     ...
     * <p>The policy version ID.</p>
     */
    inline GetPolicyVersionRequest& WithPolicyVersionId(Aws::String&& value) { SetPolicyVersionId(value); return *this;}
