...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DeleteAuditSuppressionRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAuditSuppressionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAuditSuppressionRequest>(GetServiceRequestName(), *this);
    }
