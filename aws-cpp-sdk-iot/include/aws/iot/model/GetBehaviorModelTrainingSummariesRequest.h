...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetBehaviorModelTrainingSummariesRequest> Clone() const
    {
      return Aws::MakeUnique<GetBehaviorModelTrainingSummariesRequest>(GetServiceRequestName(), *this);
    }
