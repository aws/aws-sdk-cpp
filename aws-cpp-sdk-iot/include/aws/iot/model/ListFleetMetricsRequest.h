...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListFleetMetricsRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFleetMetricsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFleetMetricsRequest>(GetServiceRequestName(), *this);
    }
