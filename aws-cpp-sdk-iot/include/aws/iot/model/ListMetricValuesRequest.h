...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListMetricValuesRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMetricValuesRequest> Clone() const
    {
      return Aws::MakeUnique<ListMetricValuesRequest>(GetServiceRequestName(), *this);
    }
