...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListRelatedResourcesForAuditFindingRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRelatedResourcesForAuditFindingRequest> Clone() const
    {
      return Aws::MakeUnique<ListRelatedResourcesForAuditFindingRequest>(GetServiceRequestName(), *this);
    }
