...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_IOT_API ListThingPrincipalsRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListThingPrincipalsRequest> Clone() const
    {
      return Aws::MakeUnique<ListThingPrincipalsRequest>(GetServiceRequestName(), *this);
    }
