...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API CreateDimensionRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateDimensionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateDimensionRequest>(GetServiceRequestName(), *this);
    }
