...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateProvisioningTemplateVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateProvisioningTemplateVersionRequest>(GetServiceRequestName(), *this);
    }
