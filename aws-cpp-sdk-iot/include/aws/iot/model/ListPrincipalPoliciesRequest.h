...
namespace Model
{
  ...
  /**
   * <p>The input for the ListPrincipalPolicies operation.</p><p><h3>See Also:</h3>  
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/iot-2015-05-28/ListPrincipalPoliciesRequest">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListPrincipalPolicies"; }
