...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DescribeFleetMetricRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFleetMetricRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFleetMetricRequest>(GetServiceRequestName(), *this);
    }
