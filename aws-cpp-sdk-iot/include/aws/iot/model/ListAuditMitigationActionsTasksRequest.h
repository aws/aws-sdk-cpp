...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListAuditMitigationActionsTasksRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAuditMitigationActionsTasksRequest> Clone() const
    {
      return Aws::MakeUnique<ListAuditMitigationActionsTasksRequest>(GetServiceRequestName(), *this);
    }
