...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API CancelAuditTaskRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelAuditTaskRequest> Clone() const
    {
      return Aws::MakeUnique<CancelAuditTaskRequest>(GetServiceRequestName(), *this);
    }
