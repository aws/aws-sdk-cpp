...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSecurityProfilesForTargetRequest> Clone() const
    {
      return Aws::MakeUnique<ListSecurityProfilesForTargetRequest>(GetServiceRequestName(), *this);
    }
