...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListThingRegistrationTaskReportsRequest> Clone() const
    {
      return Aws::MakeUnique<ListThingRegistrationTaskReportsRequest>(GetServiceRequestName(), *this);
    }
