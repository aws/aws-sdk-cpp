...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API CreateFleetMetricRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateFleetMetricRequest> Clone() const
    {
      return Aws::MakeUnique<CreateFleetMetricRequest>(GetServiceRequestName(), *this);
    }
