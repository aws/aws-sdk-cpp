...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DescribeJobRequest : public IoTRequest
  {
  public:
    DescribeJobRequest();
    ...
    */
    virtual Aws::UniquePtr<DescribeJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeJobRequest>(GetServiceRequestName(), *this);
    }
