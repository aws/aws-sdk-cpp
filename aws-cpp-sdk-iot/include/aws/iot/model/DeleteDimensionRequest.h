...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DeleteDimensionRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDimensionRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDimensionRequest>(GetServiceRequestName(), *this);
    }
