...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAccountAuditConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAccountAuditConfigurationRequest>(GetServiceRequestName(), *this);
    }
