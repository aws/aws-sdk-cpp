...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DescribeManagedJobTemplateRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeManagedJobTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeManagedJobTemplateRequest>(GetServiceRequestName(), *this);
    }
