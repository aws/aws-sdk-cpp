...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListJobExecutionsForJobRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListJobExecutionsForJobRequest> Clone() const
    {
      return Aws::MakeUnique<ListJobExecutionsForJobRequest>(GetServiceRequestName(), *this);
    }
