...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateAccountAuditConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateAccountAuditConfigurationRequest>(GetServiceRequestName(), *this);
    }
