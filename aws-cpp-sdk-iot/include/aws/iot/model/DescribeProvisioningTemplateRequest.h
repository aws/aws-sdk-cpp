...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeProvisioningTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeProvisioningTemplateRequest>(GetServiceRequestName(), *this);
    }
