...
namespace Model
{
  ...
  public:
    ...
    ListThingTypesResult(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ListThingTypesResult& operator=(const AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
     ...
     * <p>The thing types.</p>
     */
    inline void SetThingTypes(Aws::Vector<ThingTypeDefinition>&& value) { m_thingTypes = value; }
     ...
     * <p>The thing types.</p>
     */
    inline ListThingTypesResult& WithThingTypes(Aws::Vector<ThingTypeDefinition>&& value) { SetThingTypes(value); return *this;}
     ...
     * <p>The thing types.</p>
     */
    inline ListThingTypesResult& AddThingTypes(ThingTypeDefinition&& value) { m_thingTypes.push_back(value); return *this; }
     ...
     * additional results.</p>
     */
    inline ListThingTypesResult& WithNextToken(Aws::String&& value) { SetNextToken(value); return *this;}
