...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListMitigationActionsRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMitigationActionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMitigationActionsRequest>(GetServiceRequestName(), *this);
    }
