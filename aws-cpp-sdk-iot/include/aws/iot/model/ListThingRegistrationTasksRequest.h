...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListThingRegistrationTasksRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListThingRegistrationTasksRequest> Clone() const
    {
      return Aws::MakeUnique<ListThingRegistrationTasksRequest>(GetServiceRequestName(), *this);
    }
