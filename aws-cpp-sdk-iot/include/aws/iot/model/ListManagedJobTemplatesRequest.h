...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListManagedJobTemplatesRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListManagedJobTemplatesRequest> Clone() const
    {
      return Aws::MakeUnique<ListManagedJobTemplatesRequest>(GetServiceRequestName(), *this);
    }
