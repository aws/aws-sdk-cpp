...
{
  /**
   * <p>The output from the ListPolicyPrincipals operation.</p><p><h3>See Also:</h3> 
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/iot-2015-05-28/ListPolicyPrincipalsResponse">AWS
   * API Reference</a></p>
   */
