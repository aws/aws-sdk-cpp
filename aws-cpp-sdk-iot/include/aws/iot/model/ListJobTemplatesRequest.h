...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListJobTemplatesRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListJobTemplatesRequest> Clone() const
    {
      return Aws::MakeUnique<ListJobTemplatesRequest>(GetServiceRequestName(), *this);
    }
