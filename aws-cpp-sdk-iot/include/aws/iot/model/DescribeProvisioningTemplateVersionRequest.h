...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeProvisioningTemplateVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeProvisioningTemplateVersionRequest>(GetServiceRequestName(), *this);
    }
