...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListThingsInBillingGroupRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListThingsInBillingGroupRequest> Clone() const
    {
      return Aws::MakeUnique<ListThingsInBillingGroupRequest>(GetServiceRequestName(), *this);
    }
