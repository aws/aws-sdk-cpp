...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListAuditSuppressionsRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAuditSuppressionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAuditSuppressionsRequest>(GetServiceRequestName(), *this);
    }
