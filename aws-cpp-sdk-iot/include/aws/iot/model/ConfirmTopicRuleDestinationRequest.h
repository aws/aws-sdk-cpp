...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ConfirmTopicRuleDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<ConfirmTopicRuleDestinationRequest>(GetServiceRequestName(), *this);
    }
