...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DeleteScheduledAuditRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteScheduledAuditRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteScheduledAuditRequest>(GetServiceRequestName(), *this);
    }
