...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DeleteDomainConfigurationRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteDomainConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDomainConfigurationRequest>(GetServiceRequestName(), *this);
    }
