...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListSecurityProfilesRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSecurityProfilesRequest> Clone() const
    {
      return Aws::MakeUnique<ListSecurityProfilesRequest>(GetServiceRequestName(), *this);
    }
