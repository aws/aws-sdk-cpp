...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API CancelAuditMitigationActionsTaskRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CancelAuditMitigationActionsTaskRequest> Clone() const
    {
      return Aws::MakeUnique<CancelAuditMitigationActionsTaskRequest>(GetServiceRequestName(), *this);
    }
