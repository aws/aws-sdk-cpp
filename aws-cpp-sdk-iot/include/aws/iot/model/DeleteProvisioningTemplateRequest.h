...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DeleteProvisioningTemplateRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteProvisioningTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteProvisioningTemplateRequest>(GetServiceRequestName(), *this);
    }
