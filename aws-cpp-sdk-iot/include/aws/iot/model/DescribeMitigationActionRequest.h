...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DescribeMitigationActionRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMitigationActionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMitigationActionRequest>(GetServiceRequestName(), *this);
    }
