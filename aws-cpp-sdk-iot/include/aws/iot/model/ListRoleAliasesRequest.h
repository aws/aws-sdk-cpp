...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListRoleAliasesRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRoleAliasesRequest> Clone() const
    {
      return Aws::MakeUnique<ListRoleAliasesRequest>(GetServiceRequestName(), *this);
    }
