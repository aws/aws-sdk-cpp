...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutVerificationStateOnViolationRequest> Clone() const
    {
      return Aws::MakeUnique<PutVerificationStateOnViolationRequest>(GetServiceRequestName(), *this);
    }
