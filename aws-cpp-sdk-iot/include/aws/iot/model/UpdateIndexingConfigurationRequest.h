...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateIndexingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateIndexingConfigurationRequest>(GetServiceRequestName(), *this);
    }
