...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartAuditMitigationActionsTaskRequest> Clone() const
    {
      return Aws::MakeUnique<StartAuditMitigationActionsTaskRequest>(GetServiceRequestName(), *this);
    }
