...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DescribeDomainConfigurationRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDomainConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDomainConfigurationRequest>(GetServiceRequestName(), *this);
    }
