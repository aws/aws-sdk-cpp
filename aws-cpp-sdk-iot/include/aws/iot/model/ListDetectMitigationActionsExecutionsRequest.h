...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListDetectMitigationActionsExecutionsRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDetectMitigationActionsExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDetectMitigationActionsExecutionsRequest>(GetServiceRequestName(), *this);
    }
