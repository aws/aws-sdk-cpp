...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API ListTargetsForSecurityProfileRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTargetsForSecurityProfileRequest> Clone() const
    {
      return Aws::MakeUnique<ListTargetsForSecurityProfileRequest>(GetServiceRequestName(), *this);
    }
