...
namespace Model
{
  ...
  /**
   */
  class AWS_IOT_API DescribeAuditTaskRequest : public IoTRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAuditTaskRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAuditTaskRequest>(GetServiceRequestName(), *this);
    }
