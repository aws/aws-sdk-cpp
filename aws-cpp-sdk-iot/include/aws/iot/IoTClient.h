...
namespace IoT
{
  ...
  class AWS_IOT_API IoTClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IoTClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                  std::shared_ptr<Endpoint::IoTEndpointProvider> endpointProvider = Aws::MakeShared<IoT::Endpoint::IoTEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IoTEndpointProvider> m_endpointProvider;
  };
