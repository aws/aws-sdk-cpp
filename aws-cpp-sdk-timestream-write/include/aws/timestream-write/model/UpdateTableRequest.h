...
namespace Model
{
  ...
  /**
   */
  class AWS_TIMESTREAMWRITE_API UpdateTableRequest : public TimestreamWriteRequest
  {
  public:
    UpdateTableRequest();
    ...
    */
    virtual Aws::UniquePtr<UpdateTableRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateTableRequest>(GetServiceRequestName(), *this);
    }
