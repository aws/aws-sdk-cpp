...
namespace Model
{
  ...
  /**
   */
  class AWS_TIMESTREAMWRITE_API DescribeDatabaseRequest : public TimestreamWriteRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDatabaseRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDatabaseRequest>(GetServiceRequestName(), *this);
    }
