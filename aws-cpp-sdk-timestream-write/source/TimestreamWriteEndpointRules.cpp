...
{
const size_t TimestreamWriteEndpointRules::RulesBlobStrLen = 3456;
const size_t TimestreamWriteEndpointRules::RulesBlobSize = 3457;

using RulesBlobT = Aws::Array<const char, TimestreamWriteEndpointRules::RulesBlobSize>;
...
'i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','i','n','g','e',
's','t','.','t','i','m','e','s','t','r','e','a','m','-','f','i','p','s','.','{','R','e','g','i','o',
...
'/','i','n','g','e','s','t','.','t','i','m','e','s','t','r','e','a','m','.','{','R','e','g','i','o',
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','i','n',
'g','e','s','t','.','t','i','m','e','s','t','r','e','a','m','.','{','R','e','g','i','o','n','}','.',
...
const char* TimestreamWriteEndpointRules::GetRulesBlob()
{
