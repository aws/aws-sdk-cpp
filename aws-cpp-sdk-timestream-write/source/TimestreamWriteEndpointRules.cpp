...
Aws::String TimestreamWriteEndpointRules::GetRulesAsString()
{
    return Aws::String(TimestreamWriteEndpointRules::Rules.begin(), TimestreamWriteEndpointRules::Rules.end());
}

const Aws::Vector<char> TimestreamWriteEndpointRules::Rules = {
