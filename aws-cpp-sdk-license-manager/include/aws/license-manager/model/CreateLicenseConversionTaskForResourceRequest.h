...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLicenseConversionTaskForResourceRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLicenseConversionTaskForResourceRequest>(GetServiceRequestName(), *this);
    }
