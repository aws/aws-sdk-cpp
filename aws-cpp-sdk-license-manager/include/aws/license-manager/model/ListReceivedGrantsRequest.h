...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API ListReceivedGrantsRequest : public LicenseManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListReceivedGrantsRequest> Clone() const
    {
      return Aws::MakeUnique<ListReceivedGrantsRequest>(GetServiceRequestName(), *this);
    }
