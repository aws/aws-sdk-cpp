...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetLicenseManagerReportGeneratorRequest> Clone() const
    {
      return Aws::MakeUnique<GetLicenseManagerReportGeneratorRequest>(GetServiceRequestName(), *this);
    }
