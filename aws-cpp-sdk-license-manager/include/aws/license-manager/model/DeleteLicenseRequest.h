...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API DeleteLicenseRequest : public LicenseManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLicenseRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLicenseRequest>(GetServiceRequestName(), *this);
    }
