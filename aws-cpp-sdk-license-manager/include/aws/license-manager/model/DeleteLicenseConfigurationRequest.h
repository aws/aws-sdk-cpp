...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API DeleteLicenseConfigurationRequest : public LicenseManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLicenseConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLicenseConfigurationRequest>(GetServiceRequestName(), *this);
    }
