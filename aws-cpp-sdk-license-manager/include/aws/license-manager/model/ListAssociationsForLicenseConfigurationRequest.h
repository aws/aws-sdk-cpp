...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAssociationsForLicenseConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<ListAssociationsForLicenseConfigurationRequest>(GetServiceRequestName(), *this);
    }
