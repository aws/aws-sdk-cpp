...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API GetGrantRequest : public LicenseManagerRequest
  {
  public:
    GetGrantRequest();
    ...
    */
    virtual Aws::UniquePtr<GetGrantRequest> Clone() const
    {
      return Aws::MakeUnique<GetGrantRequest>(GetServiceRequestName(), *this);
    }
