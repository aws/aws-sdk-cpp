...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API ListReceivedGrantsForOrganizationRequest : public LicenseManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListReceivedGrantsForOrganizationRequest> Clone() const
    {
      return Aws::MakeUnique<ListReceivedGrantsForOrganizationRequest>(GetServiceRequestName(), *this);
    }
