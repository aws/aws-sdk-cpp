...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLicenseSpecificationsForResourceRequest> Clone() const
    {
      return Aws::MakeUnique<ListLicenseSpecificationsForResourceRequest>(GetServiceRequestName(), *this);
    }
