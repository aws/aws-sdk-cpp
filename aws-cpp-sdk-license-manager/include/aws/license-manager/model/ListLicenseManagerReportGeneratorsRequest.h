...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLicenseManagerReportGeneratorsRequest> Clone() const
    {
      return Aws::MakeUnique<ListLicenseManagerReportGeneratorsRequest>(GetServiceRequestName(), *this);
    }
