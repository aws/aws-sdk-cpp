...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API DeleteTokenRequest : public LicenseManagerRequest
  {
  public:
    DeleteTokenRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteTokenRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTokenRequest>(GetServiceRequestName(), *this);
    }
