...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API ListDistributedGrantsRequest : public LicenseManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDistributedGrantsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDistributedGrantsRequest>(GetServiceRequestName(), *this);
    }
