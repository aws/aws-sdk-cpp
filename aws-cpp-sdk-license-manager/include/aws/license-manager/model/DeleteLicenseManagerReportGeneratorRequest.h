...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLicenseManagerReportGeneratorRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLicenseManagerReportGeneratorRequest>(GetServiceRequestName(), *this);
    }
