...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateLicenseManagerReportGeneratorRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLicenseManagerReportGeneratorRequest>(GetServiceRequestName(), *this);
    }
