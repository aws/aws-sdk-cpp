...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API GetLicenseRequest : public LicenseManagerRequest
  {
  public:
    GetLicenseRequest();
    ...
    */
    virtual Aws::UniquePtr<GetLicenseRequest> Clone() const
    {
      return Aws::MakeUnique<GetLicenseRequest>(GetServiceRequestName(), *this);
    }
