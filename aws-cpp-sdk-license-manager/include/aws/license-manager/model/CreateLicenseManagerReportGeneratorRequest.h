...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API CreateLicenseManagerReportGeneratorRequest : public LicenseManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLicenseManagerReportGeneratorRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLicenseManagerReportGeneratorRequest>(GetServiceRequestName(), *this);
    }
