...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListUsageForLicenseConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<ListUsageForLicenseConfigurationRequest>(GetServiceRequestName(), *this);
    }
