...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API GetAccessTokenRequest : public LicenseManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAccessTokenRequest> Clone() const
    {
      return Aws::MakeUnique<GetAccessTokenRequest>(GetServiceRequestName(), *this);
    }
