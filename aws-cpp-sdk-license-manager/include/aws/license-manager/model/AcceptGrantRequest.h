...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API AcceptGrantRequest : public LicenseManagerRequest
  {
  public:
    AcceptGrantRequest();
    ...
    */
    virtual Aws::UniquePtr<AcceptGrantRequest> Clone() const
    {
      return Aws::MakeUnique<AcceptGrantRequest>(GetServiceRequestName(), *this);
    }
