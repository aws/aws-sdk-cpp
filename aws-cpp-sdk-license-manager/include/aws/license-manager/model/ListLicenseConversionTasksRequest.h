...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API ListLicenseConversionTasksRequest : public LicenseManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLicenseConversionTasksRequest> Clone() const
    {
      return Aws::MakeUnique<ListLicenseConversionTasksRequest>(GetServiceRequestName(), *this);
    }
