...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API ListReceivedLicensesRequest : public LicenseManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListReceivedLicensesRequest> Clone() const
    {
      return Aws::MakeUnique<ListReceivedLicensesRequest>(GetServiceRequestName(), *this);
    }
