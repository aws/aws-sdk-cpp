...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateLicenseSpecificationsForResourceRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLicenseSpecificationsForResourceRequest>(GetServiceRequestName(), *this);
    }
