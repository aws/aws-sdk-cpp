...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API RejectGrantRequest : public LicenseManagerRequest
  {
  public:
    RejectGrantRequest();
    ...
    */
    virtual Aws::UniquePtr<RejectGrantRequest> Clone() const
    {
      return Aws::MakeUnique<RejectGrantRequest>(GetServiceRequestName(), *this);
    }
