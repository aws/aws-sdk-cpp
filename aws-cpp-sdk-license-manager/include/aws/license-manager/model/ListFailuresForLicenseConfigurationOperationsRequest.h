...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API ListFailuresForLicenseConfigurationOperationsRequest : public LicenseManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFailuresForLicenseConfigurationOperationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFailuresForLicenseConfigurationOperationsRequest>(GetServiceRequestName(), *this);
    }
