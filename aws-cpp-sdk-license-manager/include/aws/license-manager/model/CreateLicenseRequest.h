...
namespace Model
{
  ...
  /**
   */
  class AWS_LICENSEMANAGER_API CreateLicenseRequest : public LicenseManagerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLicenseRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLicenseRequest>(GetServiceRequestName(), *this);
    }
