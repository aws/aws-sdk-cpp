...
namespace LicenseManager
{
  ...
  class AWS_LICENSEMANAGER_API LicenseManagerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        LicenseManagerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::LicenseManagerEndpointProvider> endpointProvider = Aws::MakeShared<LicenseManager::Endpoint::LicenseManagerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::LicenseManagerEndpointProvider> m_endpointProvider;
  };
