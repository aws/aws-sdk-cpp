...
ListLicenseVersionsResult::ListLicenseVersionsResult()
{
}

ListLicenseVersionsResult::ListLicenseVersionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListLicenseVersionsResult& ListLicenseVersionsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
