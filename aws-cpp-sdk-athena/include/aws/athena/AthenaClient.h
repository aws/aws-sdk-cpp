...
namespace Model
{
        ...
        typedef Aws::Utils::Outcome<CreateDataCatalogResult, Aws::Client::AWSError<AthenaErrors>> CreateDataCatalogOutcome;
        ...
        typedef Aws::Utils::Outcome<DeleteDataCatalogResult, Aws::Client::AWSError<AthenaErrors>> DeleteDataCatalogOutcome;
        ...
        typedef Aws::Utils::Outcome<GetDataCatalogResult, Aws::Client::AWSError<AthenaErrors>> GetDataCatalogOutcome;
        typedef Aws::Utils::Outcome<GetDatabaseResult, Aws::Client::AWSError<AthenaErrors>> GetDatabaseOutcome;
        ...
        typedef Aws::Utils::Outcome<GetTableMetadataResult, Aws::Client::AWSError<AthenaErrors>> GetTableMetadataOutcome;
        typedef Aws::Utils::Outcome<GetWorkGroupResult, Aws::Client::AWSError<AthenaErrors>> GetWorkGroupOutcome;
        typedef Aws::Utils::Outcome<ListDataCatalogsResult, Aws::Client::AWSError<AthenaErrors>> ListDataCatalogsOutcome;
        typedef Aws::Utils::Outcome<ListDatabasesResult, Aws::Client::AWSError<AthenaErrors>> ListDatabasesOutcome;
        ...
        typedef Aws::Utils::Outcome<ListTableMetadataResult, Aws::Client::AWSError<AthenaErrors>> ListTableMetadataOutcome;
        ...
        typedef Aws::Utils::Outcome<UpdateDataCatalogResult, Aws::Client::AWSError<AthenaErrors>> UpdateDataCatalogOutcome;
