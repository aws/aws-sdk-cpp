...
namespace Athena
{
  ...
  class AWS_ATHENA_API AthenaClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        AthenaClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                     std::shared_ptr<Endpoint::AthenaEndpointProvider> endpointProvider = Aws::MakeShared<Athena::Endpoint::AthenaEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::AthenaEndpointProvider> m_endpointProvider;
  };
