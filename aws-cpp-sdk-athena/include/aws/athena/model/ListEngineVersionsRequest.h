...
namespace Model
{
  ...
  /**
   */
  class AWS_ATHENA_API ListEngineVersionsRequest : public AthenaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListEngineVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListEngineVersionsRequest>(GetServiceRequestName(), *this);
    }
