...
namespace Model
{
  ...
  /**
   */
  class AWS_ATHENA_API ListNotebookMetadataRequest : public AthenaRequest
  {
  public:
     ...
     * for.</p>
     */
    inline ListNotebookMetadataRequest& WithWorkGroup(const char* value) { SetWorkGroup(value); return *this;}
