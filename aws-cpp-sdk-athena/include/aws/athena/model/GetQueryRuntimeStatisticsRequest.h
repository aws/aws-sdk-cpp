...
namespace Model
{
  ...
  /**
   */
  class AWS_ATHENA_API GetQueryRuntimeStatisticsRequest : public AthenaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetQueryRuntimeStatisticsRequest> Clone() const
    {
      return Aws::MakeUnique<GetQueryRuntimeStatisticsRequest>(GetServiceRequestName(), *this);
    }
