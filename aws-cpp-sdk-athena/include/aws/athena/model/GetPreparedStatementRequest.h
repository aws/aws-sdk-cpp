...
namespace Model
{
  ...
  /**
   */
  class AWS_ATHENA_API GetPreparedStatementRequest : public AthenaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetPreparedStatementRequest> Clone() const
    {
      return Aws::MakeUnique<GetPreparedStatementRequest>(GetServiceRequestName(), *this);
    }
