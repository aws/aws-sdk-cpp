...
namespace Model
{
  ...
  /**
   */
  class AWS_ATHENA_API UpdateNamedQueryRequest : public AthenaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateNamedQueryRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateNamedQueryRequest>(GetServiceRequestName(), *this);
    }
