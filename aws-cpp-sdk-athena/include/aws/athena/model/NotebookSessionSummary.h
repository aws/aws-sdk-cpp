...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ATHENA_API NotebookSessionSummary
  {
  public:
    NotebookSessionSummary();
    NotebookSessionSummary(Aws::Utils::Json::JsonView jsonValue);
    NotebookSessionSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
