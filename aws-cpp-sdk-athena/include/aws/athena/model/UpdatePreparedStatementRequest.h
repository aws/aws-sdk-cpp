...
namespace Model
{
  ...
  /**
   */
  class AWS_ATHENA_API UpdatePreparedStatementRequest : public AthenaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdatePreparedStatementRequest> Clone() const
    {
      return Aws::MakeUnique<UpdatePreparedStatementRequest>(GetServiceRequestName(), *this);
    }
