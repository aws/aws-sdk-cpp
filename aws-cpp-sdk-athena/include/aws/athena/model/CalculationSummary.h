...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_ATHENA_API CalculationSummary
  {
  public:
    CalculationSummary();
    CalculationSummary(Aws::Utils::Json::JsonView jsonValue);
    CalculationSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
