...
namespace Model
{
  ...
  /**
   */
  class AWS_ATHENA_API BatchGetPreparedStatementRequest : public AthenaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetPreparedStatementRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetPreparedStatementRequest>(GetServiceRequestName(), *this);
    }
