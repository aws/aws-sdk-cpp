...
namespace Model
{
  ...
  /**
   */
  class AWS_ATHENA_API CreatePreparedStatementRequest : public AthenaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreatePreparedStatementRequest> Clone() const
    {
      return Aws::MakeUnique<CreatePreparedStatementRequest>(GetServiceRequestName(), *this);
    }
