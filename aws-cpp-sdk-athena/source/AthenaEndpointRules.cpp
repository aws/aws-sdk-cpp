...
Aws::String AthenaEndpointRules::GetRulesAsString()
{
    return Aws::String(AthenaEndpointRules::Rules.begin(), AthenaEndpointRules::Rules.end());
}

const Aws::Vector<char> AthenaEndpointRules::Rules = {
