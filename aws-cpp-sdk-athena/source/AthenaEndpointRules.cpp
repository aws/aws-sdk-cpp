...
namespace Athena
{
const size_t AthenaEndpointRules::RulesBlobStrLen = 3392;
const size_t AthenaEndpointRules::RulesBlobSize = 3393;

using RulesBlobT = Aws::Array<const char, AthenaEndpointRules::RulesBlobSize>;
...
't','t','p','s',':','/','/','a','t','h','e','n','a','-','f','i','p','s','.','{','R','e','g','i','o',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','a','t','h','e','n','a','-','f','i','p','s','.',
...
'"','h','t','t','p','s',':','/','/','a','t','h','e','n','a','.','{','R','e','g','i','o','n','}','.',
...
const char* AthenaEndpointRules::GetRulesBlob()
{
