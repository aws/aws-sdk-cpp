...
using ResolveEndpointOutcome = Aws::ServiceQuotas::Endpoint::ServiceQuotasEndpointProvider::ServiceQuotasResolveEndpointOutcome;
...
ServiceQuotasClient::ServiceQuotasClient(const Client::ClientConfiguration& clientConfiguration,
                                         std::shared_ptr<Endpoint::ServiceQuotasEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ServiceQuotasErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ServiceQuotas::Endpoint::ServiceQuotasEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
