...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteServiceQuotaIncreaseRequestFromTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteServiceQuotaIncreaseRequestFromTemplateRequest>(GetServiceRequestName(), *this);
    }
