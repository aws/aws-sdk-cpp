...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAssociationForServiceQuotaTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetAssociationForServiceQuotaTemplateRequest>(GetServiceRequestName(), *this);
    }
