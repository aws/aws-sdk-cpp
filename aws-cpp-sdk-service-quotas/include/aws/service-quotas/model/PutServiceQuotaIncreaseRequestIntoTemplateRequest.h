...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutServiceQuotaIncreaseRequestIntoTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<PutServiceQuotaIncreaseRequestIntoTemplateRequest>(GetServiceRequestName(), *this);
    }
