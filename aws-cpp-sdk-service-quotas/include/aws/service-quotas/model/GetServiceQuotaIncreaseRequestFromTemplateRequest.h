...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetServiceQuotaIncreaseRequestFromTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<GetServiceQuotaIncreaseRequestFromTemplateRequest>(GetServiceRequestName(), *this);
    }
