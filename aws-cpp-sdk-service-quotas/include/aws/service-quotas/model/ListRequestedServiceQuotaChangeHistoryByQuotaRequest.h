...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRequestedServiceQuotaChangeHistoryByQuotaRequest> Clone() const
    {
      return Aws::MakeUnique<ListRequestedServiceQuotaChangeHistoryByQuotaRequest>(GetServiceRequestName(), *this);
    }
