...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<RequestServiceQuotaIncreaseRequest> Clone() const
    {
      return Aws::MakeUnique<RequestServiceQuotaIncreaseRequest>(GetServiceRequestName(), *this);
    }
