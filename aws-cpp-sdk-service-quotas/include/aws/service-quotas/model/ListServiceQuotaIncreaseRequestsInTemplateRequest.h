...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListServiceQuotaIncreaseRequestsInTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<ListServiceQuotaIncreaseRequestsInTemplateRequest>(GetServiceRequestName(), *this);
    }
