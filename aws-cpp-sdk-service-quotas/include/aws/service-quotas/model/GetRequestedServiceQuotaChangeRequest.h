...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRequestedServiceQuotaChangeRequest> Clone() const
    {
      return Aws::MakeUnique<GetRequestedServiceQuotaChangeRequest>(GetServiceRequestName(), *this);
    }
