...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateServiceQuotaTemplateRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateServiceQuotaTemplateRequest>(GetServiceRequestName(), *this);
    }
