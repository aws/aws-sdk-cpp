...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRequestedServiceQuotaChangeHistoryRequest> Clone() const
    {
      return Aws::MakeUnique<ListRequestedServiceQuotaChangeHistoryRequest>(GetServiceRequestName(), *this);
    }
