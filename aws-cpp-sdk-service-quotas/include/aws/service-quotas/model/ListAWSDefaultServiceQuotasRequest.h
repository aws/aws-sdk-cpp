...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAWSDefaultServiceQuotasRequest> Clone() const
    {
      return Aws::MakeUnique<ListAWSDefaultServiceQuotasRequest>(GetServiceRequestName(), *this);
    }
