...
namespace ServiceQuotas
{
  ...
  class AWS_SERVICEQUOTAS_API ServiceQuotasClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ServiceQuotasClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::ServiceQuotasEndpointProvider> endpointProvider = Aws::MakeShared<ServiceQuotas::Endpoint::ServiceQuotasEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ServiceQuotasEndpointProvider> m_endpointProvider;
  };
