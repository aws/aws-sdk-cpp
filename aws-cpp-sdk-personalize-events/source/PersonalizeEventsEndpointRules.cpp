...
Aws::String PersonalizeEventsEndpointRules::GetRulesAsString()
{
    return Aws::String(PersonalizeEventsEndpointRules::Rules.begin(), PersonalizeEventsEndpointRules::Rules.end());
}

const Aws::Vector<char> PersonalizeEventsEndpointRules::Rules = {
...
'/','/','p','e','r','s','o','n','a','l','i','z','e','-','e','v','e','n','t','s','.','{','R','e','g',
