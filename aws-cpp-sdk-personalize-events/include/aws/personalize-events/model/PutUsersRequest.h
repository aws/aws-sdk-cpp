...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZEEVENTS_API PutUsersRequest : public PersonalizeEventsRequest
  {
  public:
    PutUsersRequest();
    ...
    */
    virtual Aws::UniquePtr<PutUsersRequest> Clone() const
    {
      return Aws::MakeUnique<PutUsersRequest>(GetServiceRequestName(), *this);
    }
