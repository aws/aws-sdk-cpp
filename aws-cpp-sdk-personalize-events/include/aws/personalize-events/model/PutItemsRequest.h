...
namespace Model
{
  ...
  /**
   */
  class AWS_PERSONALIZEEVENTS_API PutItemsRequest : public PersonalizeEventsRequest
  {
  public:
    PutItemsRequest();
    ...
    */
    virtual Aws::UniquePtr<PutItemsRequest> Clone() const
    {
      return Aws::MakeUnique<PutItemsRequest>(GetServiceRequestName(), *this);
    }
