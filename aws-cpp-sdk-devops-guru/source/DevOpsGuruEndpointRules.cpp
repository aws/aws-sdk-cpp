...
Aws::String DevOpsGuruEndpointRules::GetRulesAsString()
{
    return Aws::String(DevOpsGuruEndpointRules::Rules.begin(), DevOpsGuruEndpointRules::Rules.end());
}

const Aws::Vector<char> DevOpsGuruEndpointRules::Rules = {
...
's',':','/','/','d','e','v','o','p','s','-','g','u','r','u','-','f','i','p','s','.','{','R','e','g',
...
'p','s','-','g','u','r','u','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
