...
namespace DevOpsGuru
{
  ...
  class AWS_DEVOPSGURU_API DevOpsGuruClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        DevOpsGuruClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::DevOpsGuruEndpointProvider> endpointProvider = Aws::MakeShared<DevOpsGuru::Endpoint::DevOpsGuruEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::DevOpsGuruEndpointProvider> m_endpointProvider;
  };
