...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVOPSGURU_API ListMonitoredResourcesRequest : public DevOpsGuruRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMonitoredResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListMonitoredResourcesRequest>(GetServiceRequestName(), *this);
    }
