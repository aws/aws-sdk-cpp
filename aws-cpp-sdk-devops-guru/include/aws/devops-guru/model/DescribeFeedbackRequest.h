...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVOPSGURU_API DescribeFeedbackRequest : public DevOpsGuruRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFeedbackRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFeedbackRequest>(GetServiceRequestName(), *this);
    }
