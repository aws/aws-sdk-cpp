...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVOPSGURU_API DeleteInsightRequest : public DevOpsGuruRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteInsightRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteInsightRequest>(GetServiceRequestName(), *this);
    }
