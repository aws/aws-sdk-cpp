...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVOPSGURU_API RemoveNotificationChannelRequest : public DevOpsGuruRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RemoveNotificationChannelRequest> Clone() const
    {
      return Aws::MakeUnique<RemoveNotificationChannelRequest>(GetServiceRequestName(), *this);
    }
