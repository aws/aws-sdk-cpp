...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DEVOPSGURU_API ServiceResourceCost
  {
  public:
    ServiceResourceCost();
    ServiceResourceCost(Aws::Utils::Json::JsonView jsonValue);
    ServiceResourceCost& operator=(Aws::Utils::Json::JsonView jsonValue);
