...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DEVOPSGURU_API ResourceNotFoundException
  {
  public:
    ...
    /**
     * <p> The ID of the AWS resource that could not be found. </p>
     */
    ...
    /**
     * <p> The type of the AWS resource that could not be found. </p>
     */
