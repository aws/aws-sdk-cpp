...
namespace Model
{
  ...
  /**
   * <p> The dimension of a Amazon CloudWatch metric that is used when DevOps Guru
   * analyzes the resources in your account for operational problems and anomalous
   * behaviour. A dimension is a name/value pair that is part of the identity of a
