...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeResourceCollectionHealthRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeResourceCollectionHealthRequest>(GetServiceRequestName(), *this);
    }
