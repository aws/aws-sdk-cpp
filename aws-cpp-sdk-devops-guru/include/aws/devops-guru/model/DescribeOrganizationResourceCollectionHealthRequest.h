...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOrganizationResourceCollectionHealthRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOrganizationResourceCollectionHealthRequest>(GetServiceRequestName(), *this);
    }
