...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVOPSGURU_API DescribeOrganizationOverviewRequest : public DevOpsGuruRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOrganizationOverviewRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOrganizationOverviewRequest>(GetServiceRequestName(), *this);
    }
