...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_DEVOPSGURU_API CostEstimationTimeRange
  {
  public:
    CostEstimationTimeRange();
    CostEstimationTimeRange(Aws::Utils::Json::JsonView jsonValue);
    CostEstimationTimeRange& operator=(Aws::Utils::Json::JsonView jsonValue);
