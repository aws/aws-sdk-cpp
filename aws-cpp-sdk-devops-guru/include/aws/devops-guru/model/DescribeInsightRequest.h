...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVOPSGURU_API DescribeInsightRequest : public DevOpsGuruRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeInsightRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeInsightRequest>(GetServiceRequestName(), *this);
    }
