...
namespace Model
{
  ...
  /**
   */
  class AWS_DEVOPSGURU_API SearchOrganizationInsightsRequest : public DevOpsGuruRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SearchOrganizationInsightsRequest> Clone() const
    {
      return Aws::MakeUnique<SearchOrganizationInsightsRequest>(GetServiceRequestName(), *this);
    }
