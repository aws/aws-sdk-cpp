...
{
  AWS_LOGSTREAM_FATAL(AWS_REQUEST_TAG, "GetServiceRequestName has been called on a base abstract request class!");
  AWS_ASSERT(!"An unexpected pure virtual call attempted!");
