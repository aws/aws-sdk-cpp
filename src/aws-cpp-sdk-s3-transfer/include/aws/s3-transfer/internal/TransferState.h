...
// fulfilled exactly once, inside the finish callback. The meta request deliberately lives on the
// handle instead (see HandleImpls.h): with nothing here pointing back at it, the callbacks can hold
// this state by shared_ptr, and a transfer outlives a handle the customer dropped.
