...
Aws::String MobileEndpointRules::GetRulesAsString()
{
    return Aws::String(MobileEndpointRules::Rules.begin(), MobileEndpointRules::Rules.end());
}

const Aws::Vector<char> MobileEndpointRules::Rules = {
...
'"','h','t','t','p','s',':','/','/','m','o','b','i','l','e','-','f','i','p','s','.','{','R','e','g',
...
':','/','/','m','o','b','i','l','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','o','b','i','l','e','.','{','R','e','g',
'i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u','l','t','#','d','n','s',
'S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','}',',',
'"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y','p','e','"',':','"','e','n','d',
'p','o','i','n','t','"','}',']','}',']','}'};
