...
namespace Mobile
{
  ...
  class AWS_MOBILE_API MobileClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MobileClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                     std::shared_ptr<Endpoint::MobileEndpointProvider> endpointProvider = Aws::MakeShared<Mobile::Endpoint::MobileEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MobileEndpointProvider> m_endpointProvider;
  };
