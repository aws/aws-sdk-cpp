...
namespace IoTSecureTunneling
{
  ...
  class AWS_IOTSECURETUNNELING_API IoTSecureTunnelingClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        IoTSecureTunnelingClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                 std::shared_ptr<Endpoint::IoTSecureTunnelingEndpointProvider> endpointProvider = Aws::MakeShared<IoTSecureTunneling::Endpoint::IoTSecureTunnelingEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::IoTSecureTunnelingEndpointProvider> m_endpointProvider;
  };
