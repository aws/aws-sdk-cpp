...
using ResolveEndpointOutcome = Aws::IoTSecureTunneling::Endpoint::IoTSecureTunnelingEndpointProvider::IoTSecureTunnelingResolveEndpointOutcome;
...
IoTSecureTunnelingClient::IoTSecureTunnelingClient(const Client::ClientConfiguration& clientConfiguration,
                                                   std::shared_ptr<Endpoint::IoTSecureTunnelingEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<IoTSecureTunnelingErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<IoTSecureTunneling::Endpoint::IoTSecureTunnelingEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
