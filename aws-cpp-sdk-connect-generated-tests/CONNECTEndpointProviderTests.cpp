...
using ConnectResolveEndpointOutcome = Aws::Connect::Endpoint::ConnectEndpointProvider::ConnectResolveEndpointOutcome;
...
void ValidateOutcome(const ConnectResolveEndpointOutcome& outcome, const ConnectEndpointProviderEndpointTestCase::Expect& expect)
{
