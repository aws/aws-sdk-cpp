...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFTSERVERLESS_API RestoreFromRecoveryPointRequest : public RedshiftServerlessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RestoreFromRecoveryPointRequest> Clone() const
    {
      return Aws::MakeUnique<RestoreFromRecoveryPointRequest>(GetServiceRequestName(), *this);
    }
