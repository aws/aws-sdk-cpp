...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFTSERVERLESS_API DeleteUsageLimitRequest : public RedshiftServerlessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteUsageLimitRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteUsageLimitRequest>(GetServiceRequestName(), *this);
    }
