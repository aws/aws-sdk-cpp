...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFTSERVERLESS_API DeleteEndpointAccessRequest : public RedshiftServerlessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteEndpointAccessRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteEndpointAccessRequest>(GetServiceRequestName(), *this);
    }
