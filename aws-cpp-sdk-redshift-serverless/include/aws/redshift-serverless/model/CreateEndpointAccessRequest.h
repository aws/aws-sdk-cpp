...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFTSERVERLESS_API CreateEndpointAccessRequest : public RedshiftServerlessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateEndpointAccessRequest> Clone() const
    {
      return Aws::MakeUnique<CreateEndpointAccessRequest>(GetServiceRequestName(), *this);
    }
