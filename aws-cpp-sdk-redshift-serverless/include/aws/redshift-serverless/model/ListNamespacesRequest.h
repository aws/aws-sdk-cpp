...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFTSERVERLESS_API ListNamespacesRequest : public RedshiftServerlessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListNamespacesRequest> Clone() const
    {
      return Aws::MakeUnique<ListNamespacesRequest>(GetServiceRequestName(), *this);
    }
