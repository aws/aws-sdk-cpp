...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFTSERVERLESS_API DeleteNamespaceRequest : public RedshiftServerlessRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteNamespaceRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteNamespaceRequest>(GetServiceRequestName(), *this);
    }
