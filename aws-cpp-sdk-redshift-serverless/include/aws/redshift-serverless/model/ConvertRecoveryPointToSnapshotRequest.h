...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ConvertRecoveryPointToSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<ConvertRecoveryPointToSnapshotRequest>(GetServiceRequestName(), *this);
    }
