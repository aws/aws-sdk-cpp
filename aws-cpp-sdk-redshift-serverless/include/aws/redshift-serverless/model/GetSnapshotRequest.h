...
namespace Model
{
  ...
  /**
   */
  class AWS_REDSHIFTSERVERLESS_API GetSnapshotRequest : public RedshiftServerlessRequest
  {
  public:
    GetSnapshotRequest();
    ...
    */
    virtual Aws::UniquePtr<GetSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<GetSnapshotRequest>(GetServiceRequestName(), *this);
    }
