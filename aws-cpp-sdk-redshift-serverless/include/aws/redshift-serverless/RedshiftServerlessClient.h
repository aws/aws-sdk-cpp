...
namespace RedshiftServerless
{
  ...
  class AWS_REDSHIFTSERVERLESS_API RedshiftServerlessClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        RedshiftServerlessClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                 std::shared_ptr<Endpoint::RedshiftServerlessEndpointProvider> endpointProvider = Aws::MakeShared<RedshiftServerless::Endpoint::RedshiftServerlessEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::RedshiftServerlessEndpointProvider> m_endpointProvider;
  };
