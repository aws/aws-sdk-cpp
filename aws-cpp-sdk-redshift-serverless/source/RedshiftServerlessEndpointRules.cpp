...
Aws::String RedshiftServerlessEndpointRules::GetRulesAsString()
{
    return Aws::String(RedshiftServerlessEndpointRules::Rules.begin(), RedshiftServerlessEndpointRules::Rules.end());
}

const Aws::Vector<char> RedshiftServerlessEndpointRules::Rules = {
...
'l','"',':','"','h','t','t','p','s',':','/','/','r','e','d','s','h','i','f','t','-','s','e','r','v',
'e','r','l','e','s','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'i','f','t','-','s','e','r','v','e','r','l','e','s','s','.','{','R','e','g','i','o','n','}','.','{',
