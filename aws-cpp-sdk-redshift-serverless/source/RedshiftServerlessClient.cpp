...
using ResolveEndpointOutcome = Aws::RedshiftServerless::Endpoint::RedshiftServerlessEndpointProvider::RedshiftServerlessResolveEndpointOutcome;
...
RedshiftServerlessClient::RedshiftServerlessClient(const Client::ClientConfiguration& clientConfiguration,
                                                   std::shared_ptr<Endpoint::RedshiftServerlessEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<RedshiftServerlessErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<RedshiftServerless::Endpoint::RedshiftServerlessEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
