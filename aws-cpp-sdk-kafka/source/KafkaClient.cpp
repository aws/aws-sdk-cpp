...
using ResolveEndpointOutcome = Aws::Kafka::Endpoint::KafkaEndpointProvider::KafkaResolveEndpointOutcome;
...
KafkaClient::KafkaClient(const Client::ClientConfiguration& clientConfiguration,
                         std::shared_ptr<Endpoint::KafkaEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<KafkaErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<Kafka::Endpoint::KafkaEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
