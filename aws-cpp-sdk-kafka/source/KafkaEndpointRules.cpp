...
Aws::String KafkaEndpointRules::GetRulesAsString()
{
    return Aws::String(KafkaEndpointRules::Rules.begin(), KafkaEndpointRules::Rules.end());
}

const Aws::Vector<char> KafkaEndpointRules::Rules = {
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','k','a',
'f','k','a','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
':','/','/','k','a','f','k','a','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
'i','o','n','R','e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r',
'o','p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}',
'}',',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}'};
