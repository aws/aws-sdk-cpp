...
namespace Kafka
{
  ...
  class AWS_KAFKA_API KafkaClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        KafkaClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                    std::shared_ptr<Endpoint::KafkaEndpointProvider> endpointProvider = Aws::MakeShared<Kafka::Endpoint::KafkaEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::KafkaEndpointProvider> m_endpointProvider;
  };
