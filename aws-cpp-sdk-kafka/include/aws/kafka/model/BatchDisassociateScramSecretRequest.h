...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_KAFKA_API BatchDisassociateScramSecretRequest : public KafkaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDisassociateScramSecretRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDisassociateScramSecretRequest>(GetServiceRequestName(), *this);
    }
