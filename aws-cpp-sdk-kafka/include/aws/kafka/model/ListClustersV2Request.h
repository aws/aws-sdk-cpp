...
namespace Model
{
  ...
  /**
   */
  class AWS_KAFKA_API ListClustersV2Request : public KafkaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListClustersV2Request> Clone() const
    {
      return Aws::MakeUnique<ListClustersV2Request>(GetServiceRequestName(), *this);
    }
