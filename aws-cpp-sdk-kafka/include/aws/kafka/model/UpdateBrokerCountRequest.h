...
namespace Model
{
  ...
  /**
   */
  class AWS_KAFKA_API UpdateBrokerCountRequest : public KafkaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateBrokerCountRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateBrokerCountRequest>(GetServiceRequestName(), *this);
    }
