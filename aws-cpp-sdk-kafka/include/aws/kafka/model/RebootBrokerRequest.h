...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_KAFKA_API RebootBrokerRequest : public KafkaRequest
  {
  public:
    RebootBrokerRequest();
    ...
    */
    virtual Aws::UniquePtr<RebootBrokerRequest> Clone() const
    {
      return Aws::MakeUnique<RebootBrokerRequest>(GetServiceRequestName(), *this);
    }
