...
namespace Model
{
  ...
  /**
   */
  class AWS_KAFKA_API UpdateSecurityRequest : public KafkaRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateSecurityRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateSecurityRequest>(GetServiceRequestName(), *this);
    }
