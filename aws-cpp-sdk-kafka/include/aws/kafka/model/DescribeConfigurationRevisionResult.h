...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>Contents of the server.properties file. When using the API, you must ensure
     * that the contents of the file are base64 encoded. 
 When using the AWS
     * Management Console, the SDK, or the AWS CLI, the contents of server.properties
