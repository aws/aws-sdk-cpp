...
namespace Model
{
  ...
  /**
   */
  class AWS_S3OUTPOSTS_API ListSharedEndpointsRequest : public S3OutpostsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSharedEndpointsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSharedEndpointsRequest>(GetServiceRequestName(), *this);
    }
