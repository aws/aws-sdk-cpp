...
namespace S3Outposts
{
  ...
  class AWS_S3OUTPOSTS_API S3OutpostsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        S3OutpostsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::S3OutpostsEndpointProvider> endpointProvider = Aws::MakeShared<S3Outposts::Endpoint::S3OutpostsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::S3OutpostsEndpointProvider> m_endpointProvider;
  };
