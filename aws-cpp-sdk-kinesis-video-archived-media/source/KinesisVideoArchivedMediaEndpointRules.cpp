...
Aws::String KinesisVideoArchivedMediaEndpointRules::GetRulesAsString()
{
    return Aws::String(KinesisVideoArchivedMediaEndpointRules::Rules.begin(), KinesisVideoArchivedMediaEndpointRules::Rules.end());
}

const Aws::Vector<char> KinesisVideoArchivedMediaEndpointRules::Rules = {
