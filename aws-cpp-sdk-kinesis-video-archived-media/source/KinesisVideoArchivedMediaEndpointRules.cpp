...
{
const size_t KinesisVideoArchivedMediaEndpointRules::RulesBlobStrLen = 3478;
const size_t KinesisVideoArchivedMediaEndpointRules::RulesBlobSize = 3479;

using RulesBlobT = Aws::Array<const char, KinesisVideoArchivedMediaEndpointRules::RulesBlobSize>;
...
const char* KinesisVideoArchivedMediaEndpointRules::GetRulesBlob()
{
