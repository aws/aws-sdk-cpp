    ...
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * requirements for providing data through HLS:</p> <ul> <li> <p>The media must
         * contain h.264 encoded video and, optionally, AAC encoded audio. Specifically,
         * the codec id of track 1 should be <code>V_MPEG/ISO/AVC</code>. Optionally, the
         * codec id of track 2 should be <code>A_AAC</code>.</p> </li> <li> <p>Data
         * retention must be greater than 0.</p> </li> <li> <p>The video track of each
         * fragment must contain codec private data in the Advanced Video Coding (AVC) for
         * H.264 format (<a href="https://www.iso.org/standard/55980.html">MPEG-4
         * specification ISO/IEC 14496-15</a>). For information about adapting stream data
         * to a given format, see <a
         ...
         * fragments in the fragmented MPEG-4 form (also called fMP4 or CMAF), rather than
         * the MPEG-2 form (also called TS chunks, which the HLS specification also
         * supports). For more information about HLS fragment types, see the <a
         ...
         * href="https://docs.aws.amazon.com/cli/latest/reference/">--endpoint-url
         * parameter</a>. </p> </note><p><h3>See Also:</h3>   <a
