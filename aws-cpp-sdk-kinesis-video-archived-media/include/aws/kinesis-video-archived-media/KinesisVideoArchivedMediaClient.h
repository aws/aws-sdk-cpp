...
namespace KinesisVideoArchivedMedia
{
  ...
  class AWS_KINESISVIDEOARCHIVEDMEDIA_API KinesisVideoArchivedMediaClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        KinesisVideoArchivedMediaClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                        std::shared_ptr<Endpoint::KinesisVideoArchivedMediaEndpointProvider> endpointProvider = Aws::MakeShared<KinesisVideoArchivedMedia::Endpoint::KinesisVideoArchivedMediaEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::KinesisVideoArchivedMediaEndpointProvider> m_endpointProvider;
  };
