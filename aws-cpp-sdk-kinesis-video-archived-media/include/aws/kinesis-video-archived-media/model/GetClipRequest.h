...
namespace Model
{
  ...
  /**
   */
  class AWS_KINESISVIDEOARCHIVEDMEDIA_API GetClipRequest : public KinesisVideoArchivedMediaRequest
  {
  public:
    GetClipRequest();
    ...
    */
    virtual Aws::UniquePtr<GetClipRequest> Clone() const
    {
      return Aws::MakeUnique<GetClipRequest>(GetServiceRequestName(), *this);
    }
