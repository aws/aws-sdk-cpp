...
namespace Model
{
  ...
  /**
   * <p>The range of time stamps for which to return fragments.</p><p><h3>See
   * Also:</h3>   <a
  ...
  public:
    ...
    /**
     * <p>The starting time stamp in the range of time stamps for which to return
     * fragments.</p>
     */
    ...
    /**
     * <p>The ending time stamp in the range of time stamps for which to return
     * fragments.</p>
     */
