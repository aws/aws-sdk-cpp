...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The start of the time stamp range for the requested media.</p> <p>If the
    ...
    /**
     * <p>The end of the time stamp range for the requested media. This value must be
     ...
     * <code>EndTimestamp</code> is compared to the (starting) time stamp of the
