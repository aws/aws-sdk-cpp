...
namespace ElasticTranscoder
{
  ...
  class AWS_ELASTICTRANSCODER_API ElasticTranscoderClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ElasticTranscoderClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                std::shared_ptr<Endpoint::ElasticTranscoderEndpointProvider> endpointProvider = Aws::MakeShared<ElasticTranscoder::Endpoint::ElasticTranscoderEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ElasticTranscoderEndpointProvider> m_endpointProvider;
  };
