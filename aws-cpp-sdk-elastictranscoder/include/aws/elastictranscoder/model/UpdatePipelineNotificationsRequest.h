...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdatePipelineNotificationsRequest> Clone() const
    {
      return Aws::MakeUnique<UpdatePipelineNotificationsRequest>(GetServiceRequestName(), *this);
    }
