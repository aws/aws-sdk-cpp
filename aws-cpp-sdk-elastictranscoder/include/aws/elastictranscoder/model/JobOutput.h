...
namespace Model
{
  ...
  */
  ...
  public:
    JobOutput();
    JobOutput(const Aws::Utils::Json::JsonValue& jsonValue);
    ...
    */
    ...
    /*
     <p>The encryption settings, if any, that you want Elastic Transcoder to apply to your output files. If you choose to use encryption, you must specify a mode to use. If you choose not to use encryption, Elastic Transcoder will write an unencrypted file to your Amazon S3 bucket.</p>
    */
