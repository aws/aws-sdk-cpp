  ...
  */
  ...
  public:
    ...
    */
    ...
    /*
     <p>The current status of the pipeline:</p> <ul> <li> <code>Active</code>: The pipeline is processing jobs.</li> <li> <code>Paused</code>: The pipeline is not currently processing jobs.</li> </ul>
    */
