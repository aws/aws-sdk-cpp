...
namespace Model
{
  ...
  public:
     ...
     * art:</p> <p> <ul> <li> <code>Fit:</code> Elastic Transcoder scales the output
     ...
     * option, Elastic Transcoder does not scale the art up.</li> <li>
     * <code>ShrinkToFill</code> Elastic Transcoder scales the output art down so that
