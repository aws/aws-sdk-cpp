...
namespace Model
{
  ...
  public:
     ...
     * <i>description</i>-<code>{language}</code>, where:</p> <ul>
     ...
     * with the two- or three-letter code for the language of the caption in the output
     * file names.</li> </ul> <p>If you don&apos;t include <code>{language}</code> in
     * the file name pattern, Elastic Transcoder automatically appends
     ...
     * segment files.</p> <p>For example, suppose you&apos;re transcoding into srt
