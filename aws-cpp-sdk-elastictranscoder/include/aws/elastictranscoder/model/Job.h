...
namespace Model
{
  ...
  public:
     ...
     * make one output.</p>
     */
    inline Job& WithInputs(Aws::Vector<JobInput>&& value) { SetInputs(value); return *this;}
     ...
     * make one output.</p>
     */
    inline Job& AddInputs(JobInput&& value) { m_inputsHasBeenSet = true; m_inputs.push_back(value); return *this; }
