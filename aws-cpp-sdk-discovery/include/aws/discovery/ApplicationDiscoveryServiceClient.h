...
namespace ApplicationDiscoveryService
{
  ...
  class AWS_APPLICATIONDISCOVERYSERVICE_API ApplicationDiscoveryServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ApplicationDiscoveryServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                          std::shared_ptr<Endpoint::ApplicationDiscoveryServiceEndpointProvider> endpointProvider = Aws::MakeShared<ApplicationDiscoveryService::Endpoint::ApplicationDiscoveryServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ApplicationDiscoveryServiceEndpointProvider> m_endpointProvider;
  };
