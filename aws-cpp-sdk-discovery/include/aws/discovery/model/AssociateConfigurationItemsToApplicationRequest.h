...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AssociateConfigurationItemsToApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<AssociateConfigurationItemsToApplicationRequest>(GetServiceRequestName(), *this);
    }
