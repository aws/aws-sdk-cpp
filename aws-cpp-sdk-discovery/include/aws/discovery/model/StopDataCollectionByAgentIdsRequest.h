...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StopDataCollectionByAgentIdsRequest> Clone() const
    {
      return Aws::MakeUnique<StopDataCollectionByAgentIdsRequest>(GetServiceRequestName(), *this);
    }
