...
namespace Model
{
  ...
  /**
   */
  class AWS_APPLICATIONDISCOVERYSERVICE_API DisassociateConfigurationItemsFromApplicationRequest : public ApplicationDiscoveryServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DisassociateConfigurationItemsFromApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<DisassociateConfigurationItemsFromApplicationRequest>(GetServiceRequestName(), *this);
    }
