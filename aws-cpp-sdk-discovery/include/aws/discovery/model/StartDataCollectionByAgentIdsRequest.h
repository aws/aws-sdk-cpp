...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartDataCollectionByAgentIdsRequest> Clone() const
    {
      return Aws::MakeUnique<StartDataCollectionByAgentIdsRequest>(GetServiceRequestName(), *this);
    }
