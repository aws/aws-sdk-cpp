...
using SSOResolveEndpointOutcome = Aws::SSO::Endpoint::SSOEndpointProvider::SSOResolveEndpointOutcome;
...
void ValidateOutcome(const SSOResolveEndpointOutcome& outcome, const SSOEndpointProviderEndpointTestCase::Expect& expect)
{
