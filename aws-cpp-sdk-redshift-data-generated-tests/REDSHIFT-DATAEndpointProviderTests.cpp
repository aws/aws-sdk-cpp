...
static const char* ALLOCATION_TAG = "AWSRedshiftDataAPIServiceEndpointProviderTests";
...
using RedshiftDataAPIServiceResolveEndpointOutcome = Aws::RedshiftDataAPIService::Endpoint::RedshiftDataAPIServiceEndpointProvider::RedshiftDataAPIServiceResolveEndpointOutcome;
...
class RedshiftDataAPIServiceEndpointProviderTests :public ::testing::TestWithParam<size_t>
{
public:
...
struct RedshiftDataAPIServiceEndpointProviderEndpointTestCase
{
...
static const Aws::Vector<RedshiftDataAPIServiceEndpointProviderEndpointTestCase> TEST_CASES = {
  /*TEST CASE 0*/
...
void ValidateOutcome(const RedshiftDataAPIServiceResolveEndpointOutcome& outcome, const RedshiftDataAPIServiceEndpointProviderEndpointTestCase::Expect& expect)
{
...
TEST_P(RedshiftDataAPIServiceEndpointProviderTests, EndpointProviderTest)
{
    ...
    const RedshiftDataAPIServiceEndpointProviderEndpointTestCase& TEST_CASE = TEST_CASES.at(TEST_CASE_IDX);
    SCOPED_TRACE(Aws::String("\nTEST CASE # ") + Aws::Utils::StringUtils::to_string(TEST_CASE_IDX) + ": " + TEST_CASE.documentation);

    std::shared_ptr<RedshiftDataAPIServiceEndpointProvider> endpointProvider = Aws::MakeShared<RedshiftDataAPIServiceEndpointProvider>(ALLOCATION_TAG);
    ASSERT_TRUE(endpointProvider) << "Failed to allocate/initialize RedshiftDataAPIServiceEndpointProvider";
    ...
    for(const auto& operation : TEST_CASE.operationInput)
    {
         ...
         */
        const Aws::Vector<std::reference_wrapper<const RedshiftDataAPIServiceEndpointProviderEndpointTestCase::OperationParamsFromTest>>
...
INSTANTIATE_TEST_SUITE_P(EndpointTestsFromModel,
                         RedshiftDataAPIServiceEndpointProviderTests,
