...
{
  AWS_MAKE_CALLABLE_OPERATION(GenerateDataSet, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(GenerateDataSet, request, handler, context, m_executor.get());
}
...
{
  AWS_MAKE_CALLABLE_OPERATION(StartSupportDataExport, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(StartSupportDataExport, request, handler, context, m_executor.get());
}
