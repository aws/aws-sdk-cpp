...
namespace MarketplaceCommerceAnalytics
{
  ...
  class AWS_MARKETPLACECOMMERCEANALYTICS_API MarketplaceCommerceAnalyticsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        MarketplaceCommerceAnalyticsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                           std::shared_ptr<Endpoint::MarketplaceCommerceAnalyticsEndpointProvider> endpointProvider = Aws::MakeShared<MarketplaceCommerceAnalytics::Endpoint::MarketplaceCommerceAnalyticsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::MarketplaceCommerceAnalyticsEndpointProvider> m_endpointProvider;
  };
