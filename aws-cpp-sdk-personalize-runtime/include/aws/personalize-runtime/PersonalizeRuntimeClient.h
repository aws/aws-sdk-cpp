...
namespace PersonalizeRuntime
{
  ...
  class AWS_PERSONALIZERUNTIME_API PersonalizeRuntimeClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        PersonalizeRuntimeClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                 std::shared_ptr<Endpoint::PersonalizeRuntimeEndpointProvider> endpointProvider = Aws::MakeShared<PersonalizeRuntime::Endpoint::PersonalizeRuntimeEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::PersonalizeRuntimeEndpointProvider> m_endpointProvider;
  };
