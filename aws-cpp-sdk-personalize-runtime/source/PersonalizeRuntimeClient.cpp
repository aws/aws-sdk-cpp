...
{
  AWS_MAKE_CALLABLE_OPERATION(GetPersonalizedRanking, request, m_executor.get());
}
...
{
  AWS_MAKE_ASYNC_OPERATION(GetPersonalizedRanking, request, handler, context, m_executor.get());
}
