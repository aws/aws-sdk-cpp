...
using ResolveEndpointOutcome = Aws::PersonalizeRuntime::Endpoint::PersonalizeRuntimeEndpointProvider::PersonalizeRuntimeResolveEndpointOutcome;
...
PersonalizeRuntimeClient::PersonalizeRuntimeClient(const Client::ClientConfiguration& clientConfiguration,
                                                   std::shared_ptr<Endpoint::PersonalizeRuntimeEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<PersonalizeRuntimeErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<PersonalizeRuntime::Endpoint::PersonalizeRuntimeEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
