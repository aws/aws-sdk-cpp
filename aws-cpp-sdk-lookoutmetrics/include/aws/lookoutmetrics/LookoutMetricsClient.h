...
namespace LookoutMetrics
{
  ...
  class AWS_LOOKOUTMETRICS_API LookoutMetricsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        LookoutMetricsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                             std::shared_ptr<Endpoint::LookoutMetricsEndpointProvider> endpointProvider = Aws::MakeShared<LookoutMetrics::Endpoint::LookoutMetricsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::LookoutMetricsEndpointProvider> m_endpointProvider;
  };
