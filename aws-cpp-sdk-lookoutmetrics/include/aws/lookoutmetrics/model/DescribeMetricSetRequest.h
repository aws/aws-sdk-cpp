...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API DescribeMetricSetRequest : public LookoutMetricsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeMetricSetRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeMetricSetRequest>(GetServiceRequestName(), *this);
    }
