...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API ListAnomalyDetectorsRequest : public LookoutMetricsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAnomalyDetectorsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAnomalyDetectorsRequest>(GetServiceRequestName(), *this);
    }
