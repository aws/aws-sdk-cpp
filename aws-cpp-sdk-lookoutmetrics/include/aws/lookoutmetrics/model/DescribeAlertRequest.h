...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API DescribeAlertRequest : public LookoutMetricsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAlertRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAlertRequest>(GetServiceRequestName(), *this);
    }
