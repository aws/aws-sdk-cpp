...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API ListAnomalyGroupRelatedMetricsRequest : public LookoutMetricsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAnomalyGroupRelatedMetricsRequest> Clone() const
    {
      return Aws::MakeUnique<ListAnomalyGroupRelatedMetricsRequest>(GetServiceRequestName(), *this);
    }
