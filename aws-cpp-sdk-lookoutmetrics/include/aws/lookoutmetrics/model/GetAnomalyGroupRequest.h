...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API GetAnomalyGroupRequest : public LookoutMetricsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAnomalyGroupRequest> Clone() const
    {
      return Aws::MakeUnique<GetAnomalyGroupRequest>(GetServiceRequestName(), *this);
    }
