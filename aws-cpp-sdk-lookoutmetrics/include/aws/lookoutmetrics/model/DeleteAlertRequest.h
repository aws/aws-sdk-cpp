...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API DeleteAlertRequest : public LookoutMetricsRequest
  {
  public:
    DeleteAlertRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteAlertRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAlertRequest>(GetServiceRequestName(), *this);
    }
