...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API ListMetricSetsRequest : public LookoutMetricsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMetricSetsRequest> Clone() const
    {
      return Aws::MakeUnique<ListMetricSetsRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "ListMetricSets"; }
     ...
     * the next request. Tokens expire after 24 hours.</p>
     */
    inline ListMetricSetsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
