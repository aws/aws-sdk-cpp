...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API GetDataQualityMetricsRequest : public LookoutMetricsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDataQualityMetricsRequest> Clone() const
    {
      return Aws::MakeUnique<GetDataQualityMetricsRequest>(GetServiceRequestName(), *this);
    }
