...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API DescribeAnomalyDetectionExecutionsRequest : public LookoutMetricsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAnomalyDetectionExecutionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAnomalyDetectionExecutionsRequest>(GetServiceRequestName(), *this);
    }
