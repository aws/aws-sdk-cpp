...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API BackTestAnomalyDetectorRequest : public LookoutMetricsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BackTestAnomalyDetectorRequest> Clone() const
    {
      return Aws::MakeUnique<BackTestAnomalyDetectorRequest>(GetServiceRequestName(), *this);
    }
