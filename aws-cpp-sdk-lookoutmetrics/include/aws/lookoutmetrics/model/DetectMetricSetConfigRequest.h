...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API DetectMetricSetConfigRequest : public LookoutMetricsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DetectMetricSetConfigRequest> Clone() const
    {
      return Aws::MakeUnique<DetectMetricSetConfigRequest>(GetServiceRequestName(), *this);
    }
