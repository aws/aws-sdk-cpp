...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API GetSampleDataRequest : public LookoutMetricsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetSampleDataRequest> Clone() const
    {
      return Aws::MakeUnique<GetSampleDataRequest>(GetServiceRequestName(), *this);
    }
