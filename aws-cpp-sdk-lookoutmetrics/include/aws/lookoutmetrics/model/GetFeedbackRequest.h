...
namespace Model
{
  ...
  /**
   */
  class AWS_LOOKOUTMETRICS_API GetFeedbackRequest : public LookoutMetricsRequest
  {
  public:
    GetFeedbackRequest();
    ...
    */
    virtual Aws::UniquePtr<GetFeedbackRequest> Clone() const
    {
      return Aws::MakeUnique<GetFeedbackRequest>(GetServiceRequestName(), *this);
    }
