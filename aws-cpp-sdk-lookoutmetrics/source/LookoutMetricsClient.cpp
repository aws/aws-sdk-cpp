...
using ResolveEndpointOutcome = Aws::LookoutMetrics::Endpoint::LookoutMetricsEndpointProvider::LookoutMetricsResolveEndpointOutcome;
...
LookoutMetricsClient::LookoutMetricsClient(const Client::ClientConfiguration& clientConfiguration,
                                           std::shared_ptr<Endpoint::LookoutMetricsEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<LookoutMetricsErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<LookoutMetrics::Endpoint::LookoutMetricsEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
