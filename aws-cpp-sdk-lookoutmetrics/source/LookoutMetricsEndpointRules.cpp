...
{
const size_t LookoutMetricsEndpointRules::RulesBlobStrLen = 3486;
const size_t LookoutMetricsEndpointRules::RulesBlobSize = 3487;

using RulesBlobT = Aws::Array<const char, LookoutMetricsEndpointRules::RulesBlobSize>;
...
't','m','e','t','r','i','c','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'h','t','t','p','s',':','/','/','l','o','o','k','o','u','t','m','e','t','r','i','c','s','-','f','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','l','o','o','k','o','u','t','m','e','t','r','i','c',
...
't','p','s',':','/','/','l','o','o','k','o','u','t','m','e','t','r','i','c','s','.','{','R','e','g',
...
const char* LookoutMetricsEndpointRules::GetRulesBlob()
{
