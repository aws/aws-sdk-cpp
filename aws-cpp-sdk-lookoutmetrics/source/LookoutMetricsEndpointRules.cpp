...
Aws::String LookoutMetricsEndpointRules::GetRulesAsString()
{
    return Aws::String(LookoutMetricsEndpointRules::Rules.begin(), LookoutMetricsEndpointRules::Rules.end());
}

const Aws::Vector<char> LookoutMetricsEndpointRules::Rules = {
