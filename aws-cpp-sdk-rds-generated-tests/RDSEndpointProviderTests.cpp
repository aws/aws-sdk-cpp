...
using RDSResolveEndpointOutcome = Aws::RDS::Endpoint::RDSEndpointProvider::RDSResolveEndpointOutcome;
...
void ValidateOutcome(const RDSResolveEndpointOutcome& outcome, const RDSEndpointProviderEndpointTestCase::Expect& expect)
{
