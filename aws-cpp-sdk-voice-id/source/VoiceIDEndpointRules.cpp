...
Aws::String VoiceIDEndpointRules::GetRulesAsString()
{
    return Aws::String(VoiceIDEndpointRules::Rules.begin(), VoiceIDEndpointRules::Rules.end());
}

const Aws::Vector<char> VoiceIDEndpointRules::Rules = {
...
'/','v','o','i','c','e','i','d','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','v','o',
'i','c','e','i','d','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
