...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSpeakerEnrollmentJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSpeakerEnrollmentJobRequest>(GetServiceRequestName(), *this);
    }
