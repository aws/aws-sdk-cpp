...
namespace Model
{
  ...
  /**
   */
  class AWS_VOICEID_API DescribeSpeakerRequest : public VoiceIDRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSpeakerRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSpeakerRequest>(GetServiceRequestName(), *this);
    }
