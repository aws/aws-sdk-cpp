...
namespace Model
{
  ...
  /**
   */
  class AWS_VOICEID_API ListFraudsterRegistrationJobsRequest : public VoiceIDRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListFraudsterRegistrationJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListFraudsterRegistrationJobsRequest>(GetServiceRequestName(), *this);
    }
