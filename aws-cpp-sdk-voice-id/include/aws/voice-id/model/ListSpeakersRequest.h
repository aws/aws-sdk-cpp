...
namespace Model
{
  ...
  /**
   */
  class AWS_VOICEID_API ListSpeakersRequest : public VoiceIDRequest
  {
  public:
    ListSpeakersRequest();
    ...
    */
    virtual Aws::UniquePtr<ListSpeakersRequest> Clone() const
    {
      return Aws::MakeUnique<ListSpeakersRequest>(GetServiceRequestName(), *this);
    }
