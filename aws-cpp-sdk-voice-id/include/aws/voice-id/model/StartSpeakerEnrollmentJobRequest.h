...
namespace Model
{
  ...
  /**
   */
  class AWS_VOICEID_API StartSpeakerEnrollmentJobRequest : public VoiceIDRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartSpeakerEnrollmentJobRequest> Clone() const
    {
      return Aws::MakeUnique<StartSpeakerEnrollmentJobRequest>(GetServiceRequestName(), *this);
    }
