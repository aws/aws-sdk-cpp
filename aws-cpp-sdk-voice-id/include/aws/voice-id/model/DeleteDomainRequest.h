...
namespace Model
{
  ...
  /**
   */
  class AWS_VOICEID_API DeleteDomainRequest : public VoiceIDRequest
  {
  public:
    DeleteDomainRequest();
    ...
    */
    virtual Aws::UniquePtr<DeleteDomainRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteDomainRequest>(GetServiceRequestName(), *this);
    }
