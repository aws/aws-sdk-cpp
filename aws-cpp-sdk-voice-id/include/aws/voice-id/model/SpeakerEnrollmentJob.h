...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_VOICEID_API SpeakerEnrollmentJob
  {
  public:
    SpeakerEnrollmentJob();
    SpeakerEnrollmentJob(Aws::Utils::Json::JsonView jsonValue);
    SpeakerEnrollmentJob& operator=(Aws::Utils::Json::JsonView jsonValue);
