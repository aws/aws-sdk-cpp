...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeFraudsterRegistrationJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeFraudsterRegistrationJobRequest>(GetServiceRequestName(), *this);
    }
