...
namespace Model
{
  ...
  /**
   */
  class AWS_VOICEID_API DeleteSpeakerRequest : public VoiceIDRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteSpeakerRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteSpeakerRequest>(GetServiceRequestName(), *this);
    }
