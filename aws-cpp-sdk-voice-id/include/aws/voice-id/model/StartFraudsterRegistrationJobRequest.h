...
namespace Model
{
  ...
  /**
   */
  class AWS_VOICEID_API StartFraudsterRegistrationJobRequest : public VoiceIDRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartFraudsterRegistrationJobRequest> Clone() const
    {
      return Aws::MakeUnique<StartFraudsterRegistrationJobRequest>(GetServiceRequestName(), *this);
    }
