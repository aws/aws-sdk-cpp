...
namespace Model
{
  ...
  /**
   */
  class AWS_VOICEID_API ListSpeakerEnrollmentJobsRequest : public VoiceIDRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListSpeakerEnrollmentJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListSpeakerEnrollmentJobsRequest>(GetServiceRequestName(), *this);
    }
