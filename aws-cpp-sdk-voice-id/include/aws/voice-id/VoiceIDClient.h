...
namespace VoiceID
{
  ...
  class AWS_VOICEID_API VoiceIDClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        VoiceIDClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                      std::shared_ptr<Endpoint::VoiceIDEndpointProvider> endpointProvider = Aws::MakeShared<VoiceID::Endpoint::VoiceIDEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::VoiceIDEndpointProvider> m_endpointProvider;
  };
