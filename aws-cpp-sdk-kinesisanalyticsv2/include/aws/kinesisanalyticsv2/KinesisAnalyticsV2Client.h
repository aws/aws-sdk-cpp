...
namespace KinesisAnalyticsV2
{
  ...
  class AWS_KINESISANALYTICSV2_API KinesisAnalyticsV2Client : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        KinesisAnalyticsV2Client(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                                 std::shared_ptr<Endpoint::KinesisAnalyticsV2EndpointProvider> endpointProvider = Aws::MakeShared<KinesisAnalyticsV2::Endpoint::KinesisAnalyticsV2EndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::KinesisAnalyticsV2EndpointProvider> m_endpointProvider;
  };
