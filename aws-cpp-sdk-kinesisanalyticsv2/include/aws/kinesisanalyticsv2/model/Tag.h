...
namespace Model
{
  ...
  {
  public:
    AWS_KINESISANALYTICSV2_API Tag();
    AWS_KINESISANALYTICSV2_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_KINESISANALYTICSV2_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
