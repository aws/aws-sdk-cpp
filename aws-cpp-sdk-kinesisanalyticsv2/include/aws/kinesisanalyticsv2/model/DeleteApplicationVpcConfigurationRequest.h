...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteApplicationVpcConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteApplicationVpcConfigurationRequest>(GetServiceRequestName(), *this);
    }
