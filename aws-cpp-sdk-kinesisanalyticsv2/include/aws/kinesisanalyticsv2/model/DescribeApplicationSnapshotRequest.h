...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeApplicationSnapshotRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeApplicationSnapshotRequest>(GetServiceRequestName(), *this);
    }
