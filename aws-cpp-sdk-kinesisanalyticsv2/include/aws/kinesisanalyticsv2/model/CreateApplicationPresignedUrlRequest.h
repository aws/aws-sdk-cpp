...
namespace Model
{
  ...
  /**
   */
  class AWS_KINESISANALYTICSV2_API CreateApplicationPresignedUrlRequest : public KinesisAnalyticsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateApplicationPresignedUrlRequest> Clone() const
    {
      return Aws::MakeUnique<CreateApplicationPresignedUrlRequest>(GetServiceRequestName(), *this);
    }
