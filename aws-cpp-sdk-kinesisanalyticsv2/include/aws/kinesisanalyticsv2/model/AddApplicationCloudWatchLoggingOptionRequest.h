...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AddApplicationCloudWatchLoggingOptionRequest> Clone() const
    {
      return Aws::MakeUnique<AddApplicationCloudWatchLoggingOptionRequest>(GetServiceRequestName(), *this);
    }
