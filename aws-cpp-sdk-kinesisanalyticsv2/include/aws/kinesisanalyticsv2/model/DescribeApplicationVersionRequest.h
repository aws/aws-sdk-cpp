...
namespace Model
{
  ...
  /**
   */
  class AWS_KINESISANALYTICSV2_API DescribeApplicationVersionRequest : public KinesisAnalyticsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeApplicationVersionRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeApplicationVersionRequest>(GetServiceRequestName(), *this);
    }
