...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<AddApplicationVpcConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<AddApplicationVpcConfigurationRequest>(GetServiceRequestName(), *this);
    }
