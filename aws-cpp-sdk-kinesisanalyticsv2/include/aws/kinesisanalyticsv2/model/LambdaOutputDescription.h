...
namespace Model
{
  ...
  /**
   * <p>For an SQL-based Amazon Kinesis Data Analytics application output, describes
   * the AWS Lambda function that is configured as its destination. </p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/LambdaOutputDescription">AWS
   * API Reference</a></p>
   */
  class AWS_KINESISANALYTICSV2_API LambdaOutputDescription
  {
  public:
