...
namespace Model
{
  ...
  /**
   */
  class AWS_KINESISANALYTICSV2_API ListApplicationVersionsRequest : public KinesisAnalyticsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListApplicationVersionsRequest> Clone() const
    {
      return Aws::MakeUnique<ListApplicationVersionsRequest>(GetServiceRequestName(), *this);
    }
