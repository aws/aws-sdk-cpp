...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteApplicationInputProcessingConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteApplicationInputProcessingConfigurationRequest>(GetServiceRequestName(), *this);
    }
