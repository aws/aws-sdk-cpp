...
namespace Model
{
  ...
  /**
   */
  class AWS_KINESISANALYTICSV2_API RollbackApplicationRequest : public KinesisAnalyticsV2Request
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<RollbackApplicationRequest> Clone() const
    {
      return Aws::MakeUnique<RollbackApplicationRequest>(GetServiceRequestName(), *this);
    }
