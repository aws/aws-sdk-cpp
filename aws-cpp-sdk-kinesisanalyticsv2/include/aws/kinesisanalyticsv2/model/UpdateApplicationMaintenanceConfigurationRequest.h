...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateApplicationMaintenanceConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateApplicationMaintenanceConfigurationRequest>(GetServiceRequestName(), *this);
    }
