...
using ResolveEndpointOutcome = Aws::KinesisAnalyticsV2::Endpoint::KinesisAnalyticsV2EndpointProvider::KinesisAnalyticsV2ResolveEndpointOutcome;
...
KinesisAnalyticsV2Client::KinesisAnalyticsV2Client(const Client::ClientConfiguration& clientConfiguration,
                                                   std::shared_ptr<Endpoint::KinesisAnalyticsV2EndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<KinesisAnalyticsV2ErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<KinesisAnalyticsV2::Endpoint::KinesisAnalyticsV2EndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
