...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListPiiEntitiesDetectionJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListPiiEntitiesDetectionJobsRequest>(GetServiceRequestName(), *this);
    }
