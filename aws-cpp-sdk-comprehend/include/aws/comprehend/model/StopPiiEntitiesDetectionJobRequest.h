...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StopPiiEntitiesDetectionJobRequest> Clone() const
    {
      return Aws::MakeUnique<StopPiiEntitiesDetectionJobRequest>(GetServiceRequestName(), *this);
    }
