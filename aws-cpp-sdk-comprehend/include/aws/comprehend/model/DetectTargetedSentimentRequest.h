...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPREHEND_API DetectTargetedSentimentRequest : public ComprehendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DetectTargetedSentimentRequest> Clone() const
    {
      return Aws::MakeUnique<DetectTargetedSentimentRequest>(GetServiceRequestName(), *this);
    }
    ...
    inline virtual const char* GetServiceRequestName() const override { return "DetectTargetedSentiment"; }
