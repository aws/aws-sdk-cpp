...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPREHEND_API ImportModelRequest : public ComprehendRequest
  {
  public:
    ImportModelRequest();
    ...
    */
    virtual Aws::UniquePtr<ImportModelRequest> Clone() const
    {
      return Aws::MakeUnique<ImportModelRequest>(GetServiceRequestName(), *this);
    }
