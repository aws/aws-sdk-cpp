...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDocumentClassificationJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDocumentClassificationJobRequest>(GetServiceRequestName(), *this);
    }
