...
namespace Model
{
  ...
  public:
    ...
    BatchDetectKeyPhrasesItemResult(const Aws::Utils::Json::JsonValue& jsonValue);
    BatchDetectKeyPhrasesItemResult& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
