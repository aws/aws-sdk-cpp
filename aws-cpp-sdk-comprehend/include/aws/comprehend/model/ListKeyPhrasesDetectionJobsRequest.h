...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPREHEND_API ListKeyPhrasesDetectionJobsRequest : public ComprehendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListKeyPhrasesDetectionJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListKeyPhrasesDetectionJobsRequest>(GetServiceRequestName(), *this);
    }
