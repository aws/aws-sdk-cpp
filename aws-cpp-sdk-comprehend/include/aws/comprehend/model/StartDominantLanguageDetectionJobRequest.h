...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StartDominantLanguageDetectionJobRequest> Clone() const
    {
      return Aws::MakeUnique<StartDominantLanguageDetectionJobRequest>(GetServiceRequestName(), *this);
    }
