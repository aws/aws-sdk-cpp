...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPREHEND_API BatchDetectTargetedSentimentRequest : public ComprehendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDetectTargetedSentimentRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDetectTargetedSentimentRequest>(GetServiceRequestName(), *this);
    }
