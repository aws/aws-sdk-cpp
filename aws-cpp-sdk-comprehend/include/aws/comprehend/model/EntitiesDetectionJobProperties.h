...
namespace Model
{
  ...
  public:
    ...
    EntitiesDetectionJobProperties(const Aws::Utils::Json::JsonValue& jsonValue);
    EntitiesDetectionJobProperties& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
