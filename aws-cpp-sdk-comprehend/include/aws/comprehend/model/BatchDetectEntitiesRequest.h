...
namespace Model
{
  ...
  public:
     ...
     * language.</p>
     */
    inline BatchDetectEntitiesRequest& WithLanguageCode(const Aws::String& value) { SetLanguageCode(value); return *this;}

    /**
     * <p>The language of the input documents. All documents must be in the same
     * language.</p>
     */
    inline BatchDetectEntitiesRequest& WithLanguageCode(Aws::String&& value) { SetLanguageCode(std::move(value)); return *this;}

    /**
     * <p>The language of the input documents. All documents must be in the same
     * language.</p>
     */
    inline BatchDetectEntitiesRequest& WithLanguageCode(const char* value) { SetLanguageCode(value); return *this;}
