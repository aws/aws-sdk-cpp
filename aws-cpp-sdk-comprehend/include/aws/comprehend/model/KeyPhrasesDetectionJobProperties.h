...
namespace Model
{
  ...
  public:
    ...
    KeyPhrasesDetectionJobProperties(const Aws::Utils::Json::JsonValue& jsonValue);
    KeyPhrasesDetectionJobProperties& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
