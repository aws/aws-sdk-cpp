...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeSentimentDetectionJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeSentimentDetectionJobRequest>(GetServiceRequestName(), *this);
    }
