...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeKeyPhrasesDetectionJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeKeyPhrasesDetectionJobRequest>(GetServiceRequestName(), *this);
    }
