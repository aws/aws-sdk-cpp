...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDominantLanguageDetectionJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDominantLanguageDetectionJobRequest>(GetServiceRequestName(), *this);
    }
