...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<StopTrainingDocumentClassifierRequest> Clone() const
    {
      return Aws::MakeUnique<StopTrainingDocumentClassifierRequest>(GetServiceRequestName(), *this);
    }
