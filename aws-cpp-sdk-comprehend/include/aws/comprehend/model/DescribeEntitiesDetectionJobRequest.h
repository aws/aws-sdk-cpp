...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeEntitiesDetectionJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeEntitiesDetectionJobRequest>(GetServiceRequestName(), *this);
    }
