...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPREHEND_API StartTargetedSentimentDetectionJobRequest : public ComprehendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartTargetedSentimentDetectionJobRequest> Clone() const
    {
      return Aws::MakeUnique<StartTargetedSentimentDetectionJobRequest>(GetServiceRequestName(), *this);
    }
