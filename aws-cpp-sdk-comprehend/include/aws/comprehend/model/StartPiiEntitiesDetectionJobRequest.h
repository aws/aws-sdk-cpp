...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPREHEND_API StartPiiEntitiesDetectionJobRequest : public ComprehendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartPiiEntitiesDetectionJobRequest> Clone() const
    {
      return Aws::MakeUnique<StartPiiEntitiesDetectionJobRequest>(GetServiceRequestName(), *this);
    }
