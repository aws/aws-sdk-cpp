...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDetectDominantLanguageRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDetectDominantLanguageRequest>(GetServiceRequestName(), *this);
    }
