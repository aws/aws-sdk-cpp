...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPREHEND_API ListTargetedSentimentDetectionJobsRequest : public ComprehendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTargetedSentimentDetectionJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListTargetedSentimentDetectionJobsRequest>(GetServiceRequestName(), *this);
    }
