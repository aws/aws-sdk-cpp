...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_COMPREHEND_API EventsDetectionJobFilter
  {
  public:
    EventsDetectionJobFilter();
    EventsDetectionJobFilter(Aws::Utils::Json::JsonView jsonValue);
    EventsDetectionJobFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
