...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPREHEND_API DescribePiiEntitiesDetectionJobRequest : public ComprehendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePiiEntitiesDetectionJobRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePiiEntitiesDetectionJobRequest>(GetServiceRequestName(), *this);
    }
