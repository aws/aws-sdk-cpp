...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPREHEND_API StartDocumentClassificationJobRequest : public ComprehendRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartDocumentClassificationJobRequest> Clone() const
    {
      return Aws::MakeUnique<StartDocumentClassificationJobRequest>(GetServiceRequestName(), *this);
    }
