...
namespace Model
{
  ...
  public:
    ...
    DominantLanguageDetectionJobFilter(const Aws::Utils::Json::JsonValue& jsonValue);
    DominantLanguageDetectionJobFilter& operator=(const Aws::Utils::Json::JsonValue& jsonValue);
