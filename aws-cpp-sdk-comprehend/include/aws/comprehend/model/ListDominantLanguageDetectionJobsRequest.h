...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListDominantLanguageDetectionJobsRequest> Clone() const
    {
      return Aws::MakeUnique<ListDominantLanguageDetectionJobsRequest>(GetServiceRequestName(), *this);
    }
