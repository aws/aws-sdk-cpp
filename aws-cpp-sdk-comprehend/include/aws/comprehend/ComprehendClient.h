...
namespace Comprehend
{
  ...
  class AWS_COMPREHEND_API ComprehendClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ComprehendClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::ComprehendEndpointProvider> endpointProvider = Aws::MakeShared<Comprehend::Endpoint::ComprehendEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ComprehendEndpointProvider> m_endpointProvider;
  };
