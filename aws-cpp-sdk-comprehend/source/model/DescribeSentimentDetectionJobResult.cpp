...
DescribeSentimentDetectionJobResult::DescribeSentimentDetectionJobResult()
{
}

DescribeSentimentDetectionJobResult::DescribeSentimentDetectionJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
