...
DescribeEventsDetectionJobResult::DescribeEventsDetectionJobResult()
{
}

DescribeEventsDetectionJobResult::DescribeEventsDetectionJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
