...
DetectTargetedSentimentResult::DetectTargetedSentimentResult()
{
}

DetectTargetedSentimentResult::DetectTargetedSentimentResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
