...
BatchDetectTargetedSentimentResult::BatchDetectTargetedSentimentResult()
{
}

BatchDetectTargetedSentimentResult::BatchDetectTargetedSentimentResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
