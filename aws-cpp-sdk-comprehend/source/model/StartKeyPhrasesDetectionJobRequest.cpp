...
Aws::String StartKeyPhrasesDetectionJobRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection StartKeyPhrasesDetectionJobRequest::GetRequestSpecificHeaders() const
{
  ...
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "Comprehend_20171127.StartKeyPhrasesDetectionJob"));
  return headers;
