...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ExportServerEngineAttributeRequest> Clone() const
    {
      return Aws::MakeUnique<ExportServerEngineAttributeRequest>(GetServiceRequestName(), *this);
    }
