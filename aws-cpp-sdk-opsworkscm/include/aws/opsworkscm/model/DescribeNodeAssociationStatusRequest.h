...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeNodeAssociationStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeNodeAssociationStatusRequest>(GetServiceRequestName(), *this);
    }
