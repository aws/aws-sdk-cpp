...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateServerEngineAttributesRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateServerEngineAttributesRequest>(GetServiceRequestName(), *this);
    }
