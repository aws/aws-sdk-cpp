...
namespace OpsWorksCM
{
  ...
  class AWS_OPSWORKSCM_API OpsWorksCMClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        OpsWorksCMClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                         std::shared_ptr<Endpoint::OpsWorksCMEndpointProvider> endpointProvider = Aws::MakeShared<OpsWorksCM::Endpoint::OpsWorksCMEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::OpsWorksCMEndpointProvider> m_endpointProvider;
  };
