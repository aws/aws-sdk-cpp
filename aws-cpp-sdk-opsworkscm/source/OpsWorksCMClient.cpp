...
using ResolveEndpointOutcome = Aws::OpsWorksCM::Endpoint::OpsWorksCMEndpointProvider::OpsWorksCMResolveEndpointOutcome;
...
OpsWorksCMClient::OpsWorksCMClient(const Client::ClientConfiguration& clientConfiguration,
                                   std::shared_ptr<Endpoint::OpsWorksCMEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<OpsWorksCMErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<OpsWorksCM::Endpoint::OpsWorksCMEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
