...
Aws::String OpsWorksCMEndpointRules::GetRulesAsString()
{
    return Aws::String(OpsWorksCMEndpointRules::Rules.begin(), OpsWorksCMEndpointRules::Rules.end());
}

const Aws::Vector<char> OpsWorksCMEndpointRules::Rules = {
