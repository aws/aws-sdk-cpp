...
{
const size_t OpsWorksCMEndpointRules::RulesBlobStrLen = 3474;
const size_t OpsWorksCMEndpointRules::RulesBlobSize = 3475;

using RulesBlobT = Aws::Array<const char, OpsWorksCMEndpointRules::RulesBlobSize>;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','o','p','s','w','o','r',
'k','s','-','c','m','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'p','s',':','/','/','o','p','s','w','o','r','k','s','-','c','m','-','f','i','p','s','.','{','R','e',
...
't','p','s',':','/','/','o','p','s','w','o','r','k','s','-','c','m','.','{','R','e','g','i','o','n',
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','o','p','s',
'w','o','r','k','s','-','c','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
'i','o','n','R','e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r',
'o','p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}',
'}',',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* OpsWorksCMEndpointRules::GetRulesBlob()
{
