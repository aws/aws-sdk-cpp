...
DescribeServersResult::DescribeServersResult(const AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeServersResult& DescribeServersResult::operator =(const AmazonWebServiceResult<JsonValue>& result)
{
