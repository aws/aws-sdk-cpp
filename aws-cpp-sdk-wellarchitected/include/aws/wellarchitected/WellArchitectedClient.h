...
namespace WellArchitected
{
  ...
  class AWS_WELLARCHITECTED_API WellArchitectedClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        WellArchitectedClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                              std::shared_ptr<Endpoint::WellArchitectedEndpointProvider> endpointProvider = Aws::MakeShared<WellArchitected::Endpoint::WellArchitectedEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::WellArchitectedEndpointProvider> m_endpointProvider;
  };
