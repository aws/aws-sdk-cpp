...
namespace Model
{
  ...
  /**
   */
  class AWS_WELLARCHITECTED_API ListCheckSummariesRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListCheckSummariesRequest> Clone() const
    {
      return Aws::MakeUnique<ListCheckSummariesRequest>(GetServiceRequestName(), *this);
    }
