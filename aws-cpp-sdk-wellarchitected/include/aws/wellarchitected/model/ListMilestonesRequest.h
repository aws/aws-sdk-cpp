...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API ListMilestonesRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListMilestonesRequest> Clone() const
    {
      return Aws::MakeUnique<ListMilestonesRequest>(GetServiceRequestName(), *this);
    }
