...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API UpdateShareInvitationRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateShareInvitationRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateShareInvitationRequest>(GetServiceRequestName(), *this);
    }
