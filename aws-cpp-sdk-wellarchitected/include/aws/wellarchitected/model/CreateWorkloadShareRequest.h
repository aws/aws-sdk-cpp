...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API CreateWorkloadShareRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateWorkloadShareRequest> Clone() const
    {
      return Aws::MakeUnique<CreateWorkloadShareRequest>(GetServiceRequestName(), *this);
    }
