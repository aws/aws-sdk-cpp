...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API DeleteWorkloadShareRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWorkloadShareRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWorkloadShareRequest>(GetServiceRequestName(), *this);
    }
