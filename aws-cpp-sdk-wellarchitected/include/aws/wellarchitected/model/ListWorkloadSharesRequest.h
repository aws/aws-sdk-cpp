...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API ListWorkloadSharesRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWorkloadSharesRequest> Clone() const
    {
      return Aws::MakeUnique<ListWorkloadSharesRequest>(GetServiceRequestName(), *this);
    }
