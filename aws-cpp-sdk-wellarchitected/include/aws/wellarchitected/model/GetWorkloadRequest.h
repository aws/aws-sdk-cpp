...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API GetWorkloadRequest : public WellArchitectedRequest
  {
  public:
    GetWorkloadRequest();
    ...
    */
    virtual Aws::UniquePtr<GetWorkloadRequest> Clone() const
    {
      return Aws::MakeUnique<GetWorkloadRequest>(GetServiceRequestName(), *this);
    }
