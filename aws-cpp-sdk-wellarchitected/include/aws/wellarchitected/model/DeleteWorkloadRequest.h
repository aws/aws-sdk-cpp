...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API DeleteWorkloadRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteWorkloadRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteWorkloadRequest>(GetServiceRequestName(), *this);
    }
