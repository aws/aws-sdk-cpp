...
namespace Model
{
  ...
  /**
   */
  class AWS_WELLARCHITECTED_API ExportLensRequest : public WellArchitectedRequest
  {
  public:
    ExportLensRequest();
    ...
    */
    virtual Aws::UniquePtr<ExportLensRequest> Clone() const
    {
      return Aws::MakeUnique<ExportLensRequest>(GetServiceRequestName(), *this);
    }
