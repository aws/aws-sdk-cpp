...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API ListWorkloadsRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListWorkloadsRequest> Clone() const
    {
      return Aws::MakeUnique<ListWorkloadsRequest>(GetServiceRequestName(), *this);
    }
