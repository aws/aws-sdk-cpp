...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API GetLensReviewRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetLensReviewRequest> Clone() const
    {
      return Aws::MakeUnique<GetLensReviewRequest>(GetServiceRequestName(), *this);
    }
