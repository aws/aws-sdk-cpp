...
namespace Model
{
  ...
  /**
   */
  class AWS_WELLARCHITECTED_API UpgradeLensReviewRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpgradeLensReviewRequest> Clone() const
    {
      return Aws::MakeUnique<UpgradeLensReviewRequest>(GetServiceRequestName(), *this);
    }
