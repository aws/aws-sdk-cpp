...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API GetAnswerRequest : public WellArchitectedRequest
  {
  public:
    GetAnswerRequest();
    ...
    */
    virtual Aws::UniquePtr<GetAnswerRequest> Clone() const
    {
      return Aws::MakeUnique<GetAnswerRequest>(GetServiceRequestName(), *this);
    }
