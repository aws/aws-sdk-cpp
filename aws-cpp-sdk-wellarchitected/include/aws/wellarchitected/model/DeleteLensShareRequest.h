...
namespace Model
{
  ...
  /**
   */
  class AWS_WELLARCHITECTED_API DeleteLensShareRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteLensShareRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteLensShareRequest>(GetServiceRequestName(), *this);
    }
