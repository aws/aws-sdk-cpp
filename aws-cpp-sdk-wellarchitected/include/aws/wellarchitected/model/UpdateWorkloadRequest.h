...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API UpdateWorkloadRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateWorkloadRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateWorkloadRequest>(GetServiceRequestName(), *this);
    }
