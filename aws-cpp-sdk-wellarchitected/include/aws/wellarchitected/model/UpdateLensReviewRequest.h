...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_WELLARCHITECTED_API UpdateLensReviewRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateLensReviewRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateLensReviewRequest>(GetServiceRequestName(), *this);
    }
