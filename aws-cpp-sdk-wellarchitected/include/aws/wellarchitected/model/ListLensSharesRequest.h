...
namespace Model
{
  ...
  /**
   */
  class AWS_WELLARCHITECTED_API ListLensSharesRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListLensSharesRequest> Clone() const
    {
      return Aws::MakeUnique<ListLensSharesRequest>(GetServiceRequestName(), *this);
    }
