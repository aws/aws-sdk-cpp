...
namespace Model
{
  ...
  /**
   */
  class AWS_WELLARCHITECTED_API CreateLensVersionRequest : public WellArchitectedRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<CreateLensVersionRequest> Clone() const
    {
      return Aws::MakeUnique<CreateLensVersionRequest>(GetServiceRequestName(), *this);
    }
