...
namespace Model
{
  ...
  /**
   * <p>Input to get lens review report.</p><p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetLensReviewReportRequest> Clone() const
    {
      return Aws::MakeUnique<GetLensReviewReportRequest>(GetServiceRequestName(), *this);
    }
