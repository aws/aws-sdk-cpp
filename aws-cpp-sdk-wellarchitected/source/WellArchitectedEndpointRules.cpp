...
{
const size_t WellArchitectedEndpointRules::RulesBlobStrLen = 3490;
const size_t WellArchitectedEndpointRules::RulesBlobSize = 3491;

using RulesBlobT = Aws::Array<const char, WellArchitectedEndpointRules::RulesBlobSize>;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','w','e','l','l','a','r',
'c','h','i','t','e','c','t','e','d','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','w','e','l','l','a','r','c','h','i','t','e',
'c','t','e','d','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
...
const char* WellArchitectedEndpointRules::GetRulesBlob()
{
