...
Aws::String SSMIncidentsEndpointRules::GetRulesAsString()
{
    return Aws::String(SSMIncidentsEndpointRules::Rules.begin(), SSMIncidentsEndpointRules::Rules.end());
}

const Aws::Vector<char> SSMIncidentsEndpointRules::Rules = {
...
't','p','s',':','/','/','s','s','m','-','i','n','c','i','d','e','n','t','s','-','f','i','p','s','.',
...
'"','h','t','t','p','s',':','/','/','s','s','m','-','i','n','c','i','d','e','n','t','s','.','{','R',
