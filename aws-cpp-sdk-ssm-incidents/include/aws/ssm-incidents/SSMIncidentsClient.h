...
namespace SSMIncidents
{
  ...
  class AWS_SSMINCIDENTS_API SSMIncidentsClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        SSMIncidentsClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                           std::shared_ptr<Endpoint::SSMIncidentsEndpointProvider> endpointProvider = Aws::MakeShared<SSMIncidents::Endpoint::SSMIncidentsEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::SSMIncidentsEndpointProvider> m_endpointProvider;
  };
