...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMINCIDENTS_API ListRelatedItemsRequest : public SSMIncidentsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRelatedItemsRequest> Clone() const
    {
      return Aws::MakeUnique<ListRelatedItemsRequest>(GetServiceRequestName(), *this);
    }
