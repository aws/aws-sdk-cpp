...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMINCIDENTS_API GetIncidentRecordRequest : public SSMIncidentsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetIncidentRecordRequest> Clone() const
    {
      return Aws::MakeUnique<GetIncidentRecordRequest>(GetServiceRequestName(), *this);
    }
