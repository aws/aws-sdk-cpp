...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMINCIDENTS_API DeleteTimelineEventRequest : public SSMIncidentsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteTimelineEventRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteTimelineEventRequest>(GetServiceRequestName(), *this);
    }
