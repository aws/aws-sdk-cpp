...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMINCIDENTS_API DeleteResponsePlanRequest : public SSMIncidentsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteResponsePlanRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteResponsePlanRequest>(GetServiceRequestName(), *this);
    }
