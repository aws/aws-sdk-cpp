...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMINCIDENTS_API ListTimelineEventsRequest : public SSMIncidentsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListTimelineEventsRequest> Clone() const
    {
      return Aws::MakeUnique<ListTimelineEventsRequest>(GetServiceRequestName(), *this);
    }
