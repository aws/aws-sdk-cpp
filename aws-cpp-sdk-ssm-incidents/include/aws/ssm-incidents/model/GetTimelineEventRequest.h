...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMINCIDENTS_API GetTimelineEventRequest : public SSMIncidentsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetTimelineEventRequest> Clone() const
    {
      return Aws::MakeUnique<GetTimelineEventRequest>(GetServiceRequestName(), *this);
    }
