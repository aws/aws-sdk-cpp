...
namespace Model
{
  ...
  /**
   */
  class AWS_SSMINCIDENTS_API UpdateDeletionProtectionRequest : public SSMIncidentsRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateDeletionProtectionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateDeletionProtectionRequest>(GetServiceRequestName(), *this);
    }
