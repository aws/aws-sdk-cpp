...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPUTEOPTIMIZER_API DescribeRecommendationExportJobsRequest : public ComputeOptimizerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRecommendationExportJobsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRecommendationExportJobsRequest>(GetServiceRequestName(), *this);
    }
