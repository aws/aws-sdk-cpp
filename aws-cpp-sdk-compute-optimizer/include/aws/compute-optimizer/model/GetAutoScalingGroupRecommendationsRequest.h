...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAutoScalingGroupRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetAutoScalingGroupRecommendationsRequest>(GetServiceRequestName(), *this);
    }
