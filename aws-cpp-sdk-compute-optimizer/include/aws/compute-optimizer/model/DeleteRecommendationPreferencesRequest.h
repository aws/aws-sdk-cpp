...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRecommendationPreferencesRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRecommendationPreferencesRequest>(GetServiceRequestName(), *this);
    }
