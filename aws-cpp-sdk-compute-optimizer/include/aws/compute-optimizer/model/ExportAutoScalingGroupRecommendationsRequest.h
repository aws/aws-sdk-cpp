...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPUTEOPTIMIZER_API ExportAutoScalingGroupRecommendationsRequest : public ComputeOptimizerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ExportAutoScalingGroupRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<ExportAutoScalingGroupRecommendationsRequest>(GetServiceRequestName(), *this);
    }
