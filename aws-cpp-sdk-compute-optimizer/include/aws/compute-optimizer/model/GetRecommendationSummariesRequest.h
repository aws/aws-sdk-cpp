...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPUTEOPTIMIZER_API GetRecommendationSummariesRequest : public ComputeOptimizerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRecommendationSummariesRequest> Clone() const
    {
      return Aws::MakeUnique<GetRecommendationSummariesRequest>(GetServiceRequestName(), *this);
    }
