...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ExportEC2InstanceRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<ExportEC2InstanceRecommendationsRequest>(GetServiceRequestName(), *this);
    }
