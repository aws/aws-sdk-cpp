...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPUTEOPTIMIZER_API ExportLambdaFunctionRecommendationsRequest : public ComputeOptimizerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ExportLambdaFunctionRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<ExportLambdaFunctionRecommendationsRequest>(GetServiceRequestName(), *this);
    }
