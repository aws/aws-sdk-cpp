...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPUTEOPTIMIZER_API ExportEBSVolumeRecommendationsRequest : public ComputeOptimizerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ExportEBSVolumeRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<ExportEBSVolumeRecommendationsRequest>(GetServiceRequestName(), *this);
    }
