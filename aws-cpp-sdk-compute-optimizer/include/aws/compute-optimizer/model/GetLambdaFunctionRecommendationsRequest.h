...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetLambdaFunctionRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetLambdaFunctionRecommendationsRequest>(GetServiceRequestName(), *this);
    }
