...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPUTEOPTIMIZER_API GetLambdaFunctionRecommendationsRequest : public ComputeOptimizerRequest
  {
  public:
    ...
    /**
     * <p>The IDs of the AWS accounts for which to return function recommendations.</p>
     * <p>If your account is the management account of an organization, use this
     * parameter to specify the member accounts for which you want to return function
