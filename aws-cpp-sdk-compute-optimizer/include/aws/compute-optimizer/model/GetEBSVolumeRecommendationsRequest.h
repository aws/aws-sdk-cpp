...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPUTEOPTIMIZER_API GetEBSVolumeRecommendationsRequest : public ComputeOptimizerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEBSVolumeRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetEBSVolumeRecommendationsRequest>(GetServiceRequestName(), *this);
    }
