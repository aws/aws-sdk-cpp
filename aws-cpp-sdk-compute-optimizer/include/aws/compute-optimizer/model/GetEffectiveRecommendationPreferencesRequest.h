...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPUTEOPTIMIZER_API GetEffectiveRecommendationPreferencesRequest : public ComputeOptimizerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEffectiveRecommendationPreferencesRequest> Clone() const
    {
      return Aws::MakeUnique<GetEffectiveRecommendationPreferencesRequest>(GetServiceRequestName(), *this);
    }
