...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPUTEOPTIMIZER_API GetEnrollmentStatusesForOrganizationRequest : public ComputeOptimizerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEnrollmentStatusesForOrganizationRequest> Clone() const
    {
      return Aws::MakeUnique<GetEnrollmentStatusesForOrganizationRequest>(GetServiceRequestName(), *this);
    }
