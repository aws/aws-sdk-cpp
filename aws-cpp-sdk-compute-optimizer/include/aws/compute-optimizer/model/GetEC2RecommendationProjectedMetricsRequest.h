...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEC2RecommendationProjectedMetricsRequest> Clone() const
    {
      return Aws::MakeUnique<GetEC2RecommendationProjectedMetricsRequest>(GetServiceRequestName(), *this);
    }
