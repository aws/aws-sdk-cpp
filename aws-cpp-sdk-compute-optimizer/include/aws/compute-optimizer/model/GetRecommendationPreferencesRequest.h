...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetRecommendationPreferencesRequest> Clone() const
    {
      return Aws::MakeUnique<GetRecommendationPreferencesRequest>(GetServiceRequestName(), *this);
    }
