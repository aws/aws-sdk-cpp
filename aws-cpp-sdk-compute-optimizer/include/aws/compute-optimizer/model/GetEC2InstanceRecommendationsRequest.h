...
namespace Model
{
  ...
  /**
   */
  class AWS_COMPUTEOPTIMIZER_API GetEC2InstanceRecommendationsRequest : public ComputeOptimizerRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetEC2InstanceRecommendationsRequest> Clone() const
    {
      return Aws::MakeUnique<GetEC2InstanceRecommendationsRequest>(GetServiceRequestName(), *this);
    }
