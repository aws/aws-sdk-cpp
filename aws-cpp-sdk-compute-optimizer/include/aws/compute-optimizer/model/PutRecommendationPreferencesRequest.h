...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutRecommendationPreferencesRequest> Clone() const
    {
      return Aws::MakeUnique<PutRecommendationPreferencesRequest>(GetServiceRequestName(), *this);
    }
