...
namespace ComputeOptimizer
{
  ...
  class AWS_COMPUTEOPTIMIZER_API ComputeOptimizerClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ComputeOptimizerClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                               std::shared_ptr<Endpoint::ComputeOptimizerEndpointProvider> endpointProvider = Aws::MakeShared<ComputeOptimizer::Endpoint::ComputeOptimizerEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ComputeOptimizerEndpointProvider> m_endpointProvider;
  };
