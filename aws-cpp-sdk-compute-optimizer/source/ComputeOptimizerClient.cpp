...
using ResolveEndpointOutcome = Aws::ComputeOptimizer::Endpoint::ComputeOptimizerEndpointProvider::ComputeOptimizerResolveEndpointOutcome;
...
ComputeOptimizerClient::ComputeOptimizerClient(const Client::ClientConfiguration& clientConfiguration,
                                               std::shared_ptr<Endpoint::ComputeOptimizerEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<ComputeOptimizerErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<ComputeOptimizer::Endpoint::ComputeOptimizerEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
