...
using SNSResolveEndpointOutcome = Aws::SNS::Endpoint::SNSEndpointProvider::SNSResolveEndpointOutcome;
...
void ValidateOutcome(const SNSResolveEndpointOutcome& outcome, const SNSEndpointProviderEndpointTestCase::Expect& expect)
{
