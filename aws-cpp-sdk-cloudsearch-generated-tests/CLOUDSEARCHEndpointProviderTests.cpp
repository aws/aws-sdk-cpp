...
using CloudSearchResolveEndpointOutcome = Aws::CloudSearch::Endpoint::CloudSearchEndpointProvider::CloudSearchResolveEndpointOutcome;
...
void ValidateOutcome(const CloudSearchResolveEndpointOutcome& outcome, const CloudSearchEndpointProviderEndpointTestCase::Expect& expect)
{
