...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConfigurationRecordersRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConfigurationRecordersRequest>(GetServiceRequestName(), *this);
    }
