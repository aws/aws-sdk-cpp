...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribePendingAggregationRequestsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribePendingAggregationRequestsRequest>(GetServiceRequestName(), *this);
    }
