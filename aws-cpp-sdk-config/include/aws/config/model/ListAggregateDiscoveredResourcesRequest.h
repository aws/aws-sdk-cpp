...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListAggregateDiscoveredResourcesRequest> Clone() const
    {
      return Aws::MakeUnique<ListAggregateDiscoveredResourcesRequest>(GetServiceRequestName(), *this);
    }
