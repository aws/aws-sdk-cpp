...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API GetAggregateConformancePackComplianceSummaryRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAggregateConformancePackComplianceSummaryRequest> Clone() const
    {
      return Aws::MakeUnique<GetAggregateConformancePackComplianceSummaryRequest>(GetServiceRequestName(), *this);
    }
