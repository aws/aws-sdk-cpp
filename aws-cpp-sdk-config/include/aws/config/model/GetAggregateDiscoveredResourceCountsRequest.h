...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAggregateDiscoveredResourceCountsRequest> Clone() const
    {
      return Aws::MakeUnique<GetAggregateDiscoveredResourceCountsRequest>(GetServiceRequestName(), *this);
    }
