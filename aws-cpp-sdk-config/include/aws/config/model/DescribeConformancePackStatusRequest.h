...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API DescribeConformancePackStatusRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConformancePackStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConformancePackStatusRequest>(GetServiceRequestName(), *this);
    }
