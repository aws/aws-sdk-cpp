...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeletePendingAggregationRequestRequest> Clone() const
    {
      return Aws::MakeUnique<DeletePendingAggregationRequestRequest>(GetServiceRequestName(), *this);
    }
