...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeComplianceByResourceRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeComplianceByResourceRequest>(GetServiceRequestName(), *this);
    }
