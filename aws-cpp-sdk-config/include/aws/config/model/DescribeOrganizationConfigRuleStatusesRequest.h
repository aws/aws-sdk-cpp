...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOrganizationConfigRuleStatusesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOrganizationConfigRuleStatusesRequest>(GetServiceRequestName(), *this);
    }
