...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API SelectAggregateResourceConfigRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<SelectAggregateResourceConfigRequest> Clone() const
    {
      return Aws::MakeUnique<SelectAggregateResourceConfigRequest>(GetServiceRequestName(), *this);
    }
