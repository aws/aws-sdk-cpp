...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API DeleteStoredQueryRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteStoredQueryRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteStoredQueryRequest>(GetServiceRequestName(), *this);
    }
