...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeDeliveryChannelStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeDeliveryChannelStatusRequest>(GetServiceRequestName(), *this);
    }
