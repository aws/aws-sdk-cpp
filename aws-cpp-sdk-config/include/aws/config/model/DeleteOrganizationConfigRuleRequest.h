...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteOrganizationConfigRuleRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteOrganizationConfigRuleRequest>(GetServiceRequestName(), *this);
    }
