...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<ListConformancePackComplianceScoresRequest> Clone() const
    {
      return Aws::MakeUnique<ListConformancePackComplianceScoresRequest>(GetServiceRequestName(), *this);
    }
