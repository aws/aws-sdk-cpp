...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAggregateComplianceByConfigRulesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAggregateComplianceByConfigRulesRequest>(GetServiceRequestName(), *this);
    }
