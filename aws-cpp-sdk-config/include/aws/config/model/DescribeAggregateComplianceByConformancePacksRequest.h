...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API DescribeAggregateComplianceByConformancePacksRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeAggregateComplianceByConformancePacksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeAggregateComplianceByConformancePacksRequest>(GetServiceRequestName(), *this);
    }
