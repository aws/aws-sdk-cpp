...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRetentionConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRetentionConfigurationsRequest>(GetServiceRequestName(), *this);
    }
