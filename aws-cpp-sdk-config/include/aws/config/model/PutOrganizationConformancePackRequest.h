...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutOrganizationConformancePackRequest> Clone() const
    {
      return Aws::MakeUnique<PutOrganizationConformancePackRequest>(GetServiceRequestName(), *this);
    }
