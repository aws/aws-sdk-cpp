...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRemediationExceptionsRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRemediationExceptionsRequest>(GetServiceRequestName(), *this);
    }
