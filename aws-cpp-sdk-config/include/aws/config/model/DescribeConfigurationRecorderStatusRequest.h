...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConfigurationRecorderStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConfigurationRecorderStatusRequest>(GetServiceRequestName(), *this);
    }
