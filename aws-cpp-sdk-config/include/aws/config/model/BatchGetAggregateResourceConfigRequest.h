...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetAggregateResourceConfigRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetAggregateResourceConfigRequest>(GetServiceRequestName(), *this);
    }
