...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API GetCustomRulePolicyRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetCustomRulePolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetCustomRulePolicyRequest>(GetServiceRequestName(), *this);
    }
