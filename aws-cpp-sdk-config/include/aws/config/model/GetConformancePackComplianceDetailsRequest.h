...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API GetConformancePackComplianceDetailsRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetConformancePackComplianceDetailsRequest> Clone() const
    {
      return Aws::MakeUnique<GetConformancePackComplianceDetailsRequest>(GetServiceRequestName(), *this);
    }
