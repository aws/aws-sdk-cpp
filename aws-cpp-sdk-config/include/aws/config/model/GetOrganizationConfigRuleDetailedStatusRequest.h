...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetOrganizationConfigRuleDetailedStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetOrganizationConfigRuleDetailedStatusRequest>(GetServiceRequestName(), *this);
    }
