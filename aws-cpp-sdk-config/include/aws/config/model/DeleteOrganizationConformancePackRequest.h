...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteOrganizationConformancePackRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteOrganizationConformancePackRequest>(GetServiceRequestName(), *this);
    }
