...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API PutStoredQueryRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutStoredQueryRequest> Clone() const
    {
      return Aws::MakeUnique<PutStoredQueryRequest>(GetServiceRequestName(), *this);
    }
