...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API DescribeOrganizationConformancePackStatusesRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOrganizationConformancePackStatusesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOrganizationConformancePackStatusesRequest>(GetServiceRequestName(), *this);
    }
