...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRemediationConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRemediationConfigurationRequest>(GetServiceRequestName(), *this);
    }
