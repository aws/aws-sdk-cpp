...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeComplianceByConfigRuleRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeComplianceByConfigRuleRequest>(GetServiceRequestName(), *this);
    }
