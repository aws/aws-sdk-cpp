...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetComplianceDetailsByConfigRuleRequest> Clone() const
    {
      return Aws::MakeUnique<GetComplianceDetailsByConfigRuleRequest>(GetServiceRequestName(), *this);
    }
