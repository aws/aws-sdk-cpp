...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAggregateComplianceDetailsByConfigRuleRequest> Clone() const
    {
      return Aws::MakeUnique<GetAggregateComplianceDetailsByConfigRuleRequest>(GetServiceRequestName(), *this);
    }
