...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API GetStoredQueryRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetStoredQueryRequest> Clone() const
    {
      return Aws::MakeUnique<GetStoredQueryRequest>(GetServiceRequestName(), *this);
    }
