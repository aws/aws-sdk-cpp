...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONFIGSERVICE_API StartConfigurationRecorderRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<StartConfigurationRecorderRequest> Clone() const
    {
      return Aws::MakeUnique<StartConfigurationRecorderRequest>(GetServiceRequestName(), *this);
    }
