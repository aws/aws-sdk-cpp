...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRemediationExecutionStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRemediationExecutionStatusRequest>(GetServiceRequestName(), *this);
    }
