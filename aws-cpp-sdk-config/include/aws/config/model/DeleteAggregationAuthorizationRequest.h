...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteAggregationAuthorizationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteAggregationAuthorizationRequest>(GetServiceRequestName(), *this);
    }
