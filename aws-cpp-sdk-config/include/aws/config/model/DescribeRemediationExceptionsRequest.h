...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API DescribeRemediationExceptionsRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRemediationExceptionsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRemediationExceptionsRequest>(GetServiceRequestName(), *this);
    }
