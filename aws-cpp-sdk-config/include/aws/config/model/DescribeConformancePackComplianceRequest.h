...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConformancePackComplianceRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConformancePackComplianceRequest>(GetServiceRequestName(), *this);
    }
