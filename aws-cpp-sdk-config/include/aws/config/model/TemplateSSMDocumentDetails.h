...
namespace Model
{
   ...
   * content, and then provide the <code>DocumentName</code> (and optionally
   * <code>DocumentVersion</code>) in the <a
   * href="https://docs.aws.amazon.com/config/latest/APIReference/API_PutConformancePack.html">PutConformancePack
   * API</a>.</p> <p>The <code>TemplateSSMDocumentDetails</code> object contains the
   * name of the SSM document and the version of the SSM document.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/TemplateSSMDocumentDetails">AWS
   * API Reference</a></p>
   */
  class AWS_CONFIGSERVICE_API TemplateSSMDocumentDetails
  {
  public:
    TemplateSSMDocumentDetails();
    TemplateSSMDocumentDetails(Aws::Utils::Json::JsonView jsonValue);
    TemplateSSMDocumentDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
     ...
     * region or account, you must provide the ARN.</p>
     */
