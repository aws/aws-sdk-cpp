...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetConformancePackComplianceSummaryRequest> Clone() const
    {
      return Aws::MakeUnique<GetConformancePackComplianceSummaryRequest>(GetServiceRequestName(), *this);
    }
