...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutAggregationAuthorizationRequest> Clone() const
    {
      return Aws::MakeUnique<PutAggregationAuthorizationRequest>(GetServiceRequestName(), *this);
    }
