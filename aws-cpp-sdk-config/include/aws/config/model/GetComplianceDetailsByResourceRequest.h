...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetComplianceDetailsByResourceRequest> Clone() const
    {
      return Aws::MakeUnique<GetComplianceDetailsByResourceRequest>(GetServiceRequestName(), *this);
    }
