...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetComplianceSummaryByResourceTypeRequest> Clone() const
    {
      return Aws::MakeUnique<GetComplianceSummaryByResourceTypeRequest>(GetServiceRequestName(), *this);
    }
