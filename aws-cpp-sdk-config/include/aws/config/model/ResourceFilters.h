...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONFIGSERVICE_API ResourceFilters
  {
  public:
    ResourceFilters();
    ResourceFilters(Aws::Utils::Json::JsonView jsonValue);
    ResourceFilters& operator=(Aws::Utils::Json::JsonView jsonValue);
