...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetOrganizationCustomRulePolicyRequest> Clone() const
    {
      return Aws::MakeUnique<GetOrganizationCustomRulePolicyRequest>(GetServiceRequestName(), *this);
    }
