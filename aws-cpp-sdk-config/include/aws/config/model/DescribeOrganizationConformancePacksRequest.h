...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API DescribeOrganizationConformancePacksRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOrganizationConformancePacksRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOrganizationConformancePacksRequest>(GetServiceRequestName(), *this);
    }
