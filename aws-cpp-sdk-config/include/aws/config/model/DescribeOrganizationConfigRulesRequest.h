...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeOrganizationConfigRulesRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeOrganizationConfigRulesRequest>(GetServiceRequestName(), *this);
    }
