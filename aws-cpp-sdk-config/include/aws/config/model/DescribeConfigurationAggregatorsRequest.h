...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConfigurationAggregatorsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConfigurationAggregatorsRequest>(GetServiceRequestName(), *this);
    }
