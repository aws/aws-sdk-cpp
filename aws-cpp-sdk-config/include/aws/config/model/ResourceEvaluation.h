...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CONFIGSERVICE_API ResourceEvaluation
  {
  public:
    ResourceEvaluation();
    ResourceEvaluation(Aws::Utils::Json::JsonView jsonValue);
    ResourceEvaluation& operator=(Aws::Utils::Json::JsonView jsonValue);
