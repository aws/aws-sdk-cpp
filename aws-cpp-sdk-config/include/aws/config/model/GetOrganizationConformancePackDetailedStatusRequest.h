...
namespace Model
{
  ...
  /**
   */
  class AWS_CONFIGSERVICE_API GetOrganizationConformancePackDetailedStatusRequest : public ConfigServiceRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<GetOrganizationConformancePackDetailedStatusRequest> Clone() const
    {
      return Aws::MakeUnique<GetOrganizationConformancePackDetailedStatusRequest>(GetServiceRequestName(), *this);
    }
