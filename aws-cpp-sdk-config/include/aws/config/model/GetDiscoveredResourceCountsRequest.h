...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetDiscoveredResourceCountsRequest> Clone() const
    {
      return Aws::MakeUnique<GetDiscoveredResourceCountsRequest>(GetServiceRequestName(), *this);
    }
