...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteConfigurationRecorderRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteConfigurationRecorderRequest>(GetServiceRequestName(), *this);
    }
