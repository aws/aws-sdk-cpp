...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConfigurationAggregatorSourcesStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConfigurationAggregatorSourcesStatusRequest>(GetServiceRequestName(), *this);
    }
