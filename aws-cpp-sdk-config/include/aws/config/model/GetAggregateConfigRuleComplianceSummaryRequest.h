...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<GetAggregateConfigRuleComplianceSummaryRequest> Clone() const
    {
      return Aws::MakeUnique<GetAggregateConfigRuleComplianceSummaryRequest>(GetServiceRequestName(), *this);
    }
