...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<PutRemediationConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<PutRemediationConfigurationsRequest>(GetServiceRequestName(), *this);
    }
