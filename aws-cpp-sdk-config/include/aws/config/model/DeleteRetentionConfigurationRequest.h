...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRetentionConfigurationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRetentionConfigurationRequest>(GetServiceRequestName(), *this);
    }
