...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeRemediationConfigurationsRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeRemediationConfigurationsRequest>(GetServiceRequestName(), *this);
    }
