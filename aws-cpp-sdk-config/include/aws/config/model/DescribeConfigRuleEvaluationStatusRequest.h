...
namespace Model
{
  ...
  public:
    ...
    */
    virtual Aws::UniquePtr<DescribeConfigRuleEvaluationStatusRequest> Clone() const
    {
      return Aws::MakeUnique<DescribeConfigRuleEvaluationStatusRequest>(GetServiceRequestName(), *this);
    }
