...
namespace ConfigService
{
  ...
  class AWS_CONFIGSERVICE_API ConfigServiceClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        ConfigServiceClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::ConfigServiceEndpointProvider> endpointProvider = Aws::MakeShared<ConfigService::Endpoint::ConfigServiceEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::ConfigServiceEndpointProvider> m_endpointProvider;
  };
