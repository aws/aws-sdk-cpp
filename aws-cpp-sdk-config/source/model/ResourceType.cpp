  ...
  namespace ConfigService
  {
    namespace Model
    {
      namespace ResourceTypeMapper
      {
        ...
        static const int AWS_ECS_PrimaryTaskSet_HASH = HashingUtils::HashString("AWS::ECS::PrimaryTaskSet");
        ...
        static const int AWS_EKS_Nodegroup_HASH = HashingUtils::HashString("AWS::EKS::Nodegroup");
        ...
        static const int AWS_KinesisAnalytics_Application_HASH = HashingUtils::HashString("AWS::KinesisAnalytics::Application");
        static const int AWS_KinesisAnalytics_ApplicationOutput_HASH = HashingUtils::HashString("AWS::KinesisAnalytics::ApplicationOutput");
        static const int AWS_KinesisAnalytics_ApplicationReferenceDataSource_HASH = HashingUtils::HashString("AWS::KinesisAnalytics::ApplicationReferenceDataSource");
        static const int AWS_KinesisAnalyticsV2_Application_HASH = HashingUtils::HashString("AWS::KinesisAnalyticsV2::Application");
        static const int AWS_KinesisAnalyticsV2_ApplicationCloudWatchLoggingOption_HASH = HashingUtils::HashString("AWS::KinesisAnalyticsV2::ApplicationCloudWatchLoggingOption");
        static const int AWS_KinesisAnalyticsV2_ApplicationOutput_HASH = HashingUtils::HashString("AWS::KinesisAnalyticsV2::ApplicationOutput");
        static const int AWS_KinesisAnalyticsV2_ApplicationReferenceDataSource_HASH = HashingUtils::HashString("AWS::KinesisAnalyticsV2::ApplicationReferenceDataSource");
        ...
        ResourceType GetResourceTypeForName(const Aws::String& name)
        {
          ...
          if (hashCode == AWS_ACM_Certificate_HASH)
          {
          ...
          else if (hashCode == AWS_EC2_CustomerGateway_HASH)
          {
          ...
          else if (hashCode == AWS_ECS_PrimaryTaskSet_HASH)
          {
            return ResourceType::AWS_ECS_PrimaryTaskSet;
          }
          ...
          {
            return ResourceType::AWS_ECS_TaskSet;
          }
          else if (hashCode == AWS_EKS_Cluster_HASH)
          {
            return ResourceType::AWS_EKS_Cluster;
          }
          else if (hashCode == AWS_EKS_Nodegroup_HASH)
          {
            return ResourceType::AWS_EKS_Nodegroup;
          }
          ...
          else if (hashCode == AWS_KinesisAnalytics_Application_HASH)
          {
            return ResourceType::AWS_KinesisAnalytics_Application;
          }
          else if (hashCode == AWS_KinesisAnalytics_ApplicationOutput_HASH)
          {
            return ResourceType::AWS_KinesisAnalytics_ApplicationOutput;
          }
          else if (hashCode == AWS_KinesisAnalytics_ApplicationReferenceDataSource_HASH)
          {
            return ResourceType::AWS_KinesisAnalytics_ApplicationReferenceDataSource;
          }
          else if (hashCode == AWS_KinesisAnalyticsV2_Application_HASH)
          {
            return ResourceType::AWS_KinesisAnalyticsV2_Application;
          }
          else if (hashCode == AWS_KinesisAnalyticsV2_ApplicationCloudWatchLoggingOption_HASH)
          {
            return ResourceType::AWS_KinesisAnalyticsV2_ApplicationCloudWatchLoggingOption;
          }
          else if (hashCode == AWS_KinesisAnalyticsV2_ApplicationOutput_HASH)
          {
            return ResourceType::AWS_KinesisAnalyticsV2_ApplicationOutput;
          }
          else if (hashCode == AWS_KinesisAnalyticsV2_ApplicationReferenceDataSource_HASH)
          {
            return ResourceType::AWS_KinesisAnalyticsV2_ApplicationReferenceDataSource;
          }
          else if (hashCode == AWS_KinesisFirehose_DeliveryStream_HASH)
          {
            return ResourceType::AWS_KinesisFirehose_DeliveryStream;
          }
        ...
        Aws::String GetNameForResourceType(ResourceType enumValue)
        {
          ...
          case ResourceType::AWS_ECS_PrimaryTaskSet:
          ...
          case ResourceType::AWS_EKS_Nodegroup:
          ...
          case ResourceType::AWS_KinesisAnalytics_Application:
            return "AWS::KinesisAnalytics::Application";
          case ResourceType::AWS_KinesisAnalytics_ApplicationOutput:
            return "AWS::KinesisAnalytics::ApplicationOutput";
          case ResourceType::AWS_KinesisAnalytics_ApplicationReferenceDataSource:
          ...
          case ResourceType::AWS_KinesisAnalyticsV2_ApplicationCloudWatchLoggingOption:
            return "AWS::KinesisAnalyticsV2::ApplicationCloudWatchLoggingOption";
          case ResourceType::AWS_KinesisAnalyticsV2_ApplicationOutput:
            return "AWS::KinesisAnalyticsV2::ApplicationOutput";
          case ResourceType::AWS_KinesisAnalyticsV2_ApplicationReferenceDataSource:
