...
GetConformancePackComplianceDetailsResult::GetConformancePackComplianceDetailsResult()
{
}
...
GetConformancePackComplianceDetailsResult& GetConformancePackComplianceDetailsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  ...
  {
    Array<JsonView> conformancePackRuleEvaluationResultsJsonList = jsonValue.GetArray("ConformancePackRuleEvaluationResults");
