...
Aws::String ConfigServiceEndpointRules::GetRulesAsString()
{
    return Aws::String(ConfigServiceEndpointRules::Rules.begin(), ConfigServiceEndpointRules::Rules.end());
}

const Aws::Vector<char> ConfigServiceEndpointRules::Rules = {
