...
using ResolveEndpointOutcome = Aws::CloudWatchRUM::Endpoint::CloudWatchRUMEndpointProvider::CloudWatchRUMResolveEndpointOutcome;
...
CloudWatchRUMClient::CloudWatchRUMClient(const Client::ClientConfiguration& clientConfiguration,
                                         std::shared_ptr<Endpoint::CloudWatchRUMEndpointProvider> endpointProvider) :
    ...
    m_endpointProvider(std::move(endpointProvider))
{
  ...
  BASECLASS(clientConfiguration,
            ...
            Aws::MakeShared<CloudWatchRUMErrorMarshaller>(ALLOCATION_TAG)),
  m_executor(clientConfiguration.executor),
  m_endpointProvider(Aws::MakeShared<CloudWatchRUM::Endpoint::CloudWatchRUMEndpointProvider>(ALLOCATION_TAG))
{
  init(clientConfiguration);
}
