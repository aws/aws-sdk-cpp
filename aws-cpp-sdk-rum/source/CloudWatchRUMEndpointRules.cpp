...
Aws::String CloudWatchRUMEndpointRules::GetRulesAsString()
{
    return Aws::String(CloudWatchRUMEndpointRules::Rules.begin(), CloudWatchRUMEndpointRules::Rules.end());
}

const Aws::Vector<char> CloudWatchRUMEndpointRules::Rules = {
