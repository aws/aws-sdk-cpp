...
namespace CloudWatchRUM
{
  ...
  class AWS_CLOUDWATCHRUM_API CloudWatchRUMClient : public Aws::Client::AWSJsonClient
  {
      ...
      static const char* ALLOCATION_TAG;
        ...
        */
        CloudWatchRUMClient(const Aws::Client::ClientConfiguration& clientConfiguration = Aws::Client::ClientConfiguration(),
                            std::shared_ptr<Endpoint::CloudWatchRUMEndpointProvider> endpointProvider = Aws::MakeShared<CloudWatchRUM::Endpoint::CloudWatchRUMEndpointProvider>(ALLOCATION_TAG));
    ...
    private:
      ...
      std::shared_ptr<Endpoint::CloudWatchRUMEndpointProvider> m_endpointProvider;
  };
