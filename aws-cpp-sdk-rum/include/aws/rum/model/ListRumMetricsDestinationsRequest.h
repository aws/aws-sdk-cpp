...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHRUM_API ListRumMetricsDestinationsRequest : public CloudWatchRUMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<ListRumMetricsDestinationsRequest> Clone() const
    {
      return Aws::MakeUnique<ListRumMetricsDestinationsRequest>(GetServiceRequestName(), *this);
    }
