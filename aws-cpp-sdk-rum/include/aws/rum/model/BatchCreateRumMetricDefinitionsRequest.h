...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHRUM_API BatchCreateRumMetricDefinitionsRequest : public CloudWatchRUMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchCreateRumMetricDefinitionsRequest> Clone() const
    {
      return Aws::MakeUnique<BatchCreateRumMetricDefinitionsRequest>(GetServiceRequestName(), *this);
    }
