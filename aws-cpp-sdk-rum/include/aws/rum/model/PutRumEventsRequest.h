...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHRUM_API PutRumEventsRequest : public CloudWatchRUMRequest
  {
  public:
    PutRumEventsRequest();
    ...
    */
    virtual Aws::UniquePtr<PutRumEventsRequest> Clone() const
    {
      return Aws::MakeUnique<PutRumEventsRequest>(GetServiceRequestName(), *this);
    }
