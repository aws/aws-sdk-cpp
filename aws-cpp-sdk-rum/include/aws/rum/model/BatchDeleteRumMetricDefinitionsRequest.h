...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHRUM_API BatchDeleteRumMetricDefinitionsRequest : public CloudWatchRUMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchDeleteRumMetricDefinitionsRequest> Clone() const
    {
      return Aws::MakeUnique<BatchDeleteRumMetricDefinitionsRequest>(GetServiceRequestName(), *this);
    }
