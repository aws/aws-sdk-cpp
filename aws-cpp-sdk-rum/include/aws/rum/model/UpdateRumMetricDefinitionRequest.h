...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHRUM_API UpdateRumMetricDefinitionRequest : public CloudWatchRUMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<UpdateRumMetricDefinitionRequest> Clone() const
    {
      return Aws::MakeUnique<UpdateRumMetricDefinitionRequest>(GetServiceRequestName(), *this);
    }
