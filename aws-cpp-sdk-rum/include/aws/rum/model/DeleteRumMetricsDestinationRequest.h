...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHRUM_API DeleteRumMetricsDestinationRequest : public CloudWatchRUMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<DeleteRumMetricsDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<DeleteRumMetricsDestinationRequest>(GetServiceRequestName(), *this);
    }
