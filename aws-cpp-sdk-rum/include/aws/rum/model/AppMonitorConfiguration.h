...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class AWS_CLOUDWATCHRUM_API AppMonitorConfiguration
  {
  public:
    AppMonitorConfiguration();
    AppMonitorConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AppMonitorConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
