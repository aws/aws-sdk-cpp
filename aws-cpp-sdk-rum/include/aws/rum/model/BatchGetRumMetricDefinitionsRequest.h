...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHRUM_API BatchGetRumMetricDefinitionsRequest : public CloudWatchRUMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<BatchGetRumMetricDefinitionsRequest> Clone() const
    {
      return Aws::MakeUnique<BatchGetRumMetricDefinitionsRequest>(GetServiceRequestName(), *this);
    }
