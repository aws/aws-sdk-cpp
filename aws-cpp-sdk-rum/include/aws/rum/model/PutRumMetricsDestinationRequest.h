...
namespace Model
{
  ...
  /**
   */
  class AWS_CLOUDWATCHRUM_API PutRumMetricsDestinationRequest : public CloudWatchRUMRequest
  {
  public:
    ...
    */
    virtual Aws::UniquePtr<PutRumMetricsDestinationRequest> Clone() const
    {
      return Aws::MakeUnique<PutRumMetricsDestinationRequest>(GetServiceRequestName(), *this);
    }
